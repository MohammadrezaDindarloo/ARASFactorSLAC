...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl1(
  ...
  const Scalar _tmp56 = _tmp18 + _tmp9;
  ...
  const Scalar _tmp74 = Scalar(1.0) / (_tmp59 * _tmp70 - _tmp73);
  const Scalar _tmp75 = _tmp74 * (-_tmp62 * _tmp70 + _tmp72);
  const Scalar _tmp76 = -_tmp59 * _tmp72 + _tmp62 * _tmp73;
  const Scalar _tmp77 = _tmp61 * _tmp74;
  const Scalar _tmp78 = _tmp49 * _tmp71;
  const Scalar _tmp79 = _tmp51 * _tmp60 - _tmp59 * _tmp78 - _tmp76 * _tmp77;
  ...
  const Scalar _tmp85 = -_tmp49 * _tmp51 - _tmp61 * _tmp75 + _tmp78 - _tmp79 * _tmp84;
  const Scalar _tmp86 = Scalar(1.0) / (_tmp85);
  const Scalar _tmp87 = _tmp80 * _tmp84 + _tmp83;
  const Scalar _tmp88 = 0;
  const Scalar _tmp89 = _tmp86 * _tmp88;
  const Scalar _tmp90 = _tmp70 * _tmp77;
  const Scalar _tmp91 =
  ...
  const Scalar _tmp94 = _tmp92 * (_tmp52 * _tmp58 * _tmp93 - _tmp54 * _tmp56 * _tmp93);
  const Scalar _tmp95 = -_tmp63 * _tmp73 + _tmp66 * _tmp70 + _tmp70 * _tmp94;
  const Scalar _tmp96 = _tmp41 * _tmp49 - _tmp45 * _tmp60 + _tmp49 * _tmp94 - _tmp77 * _tmp95;
  ...
  const Scalar _tmp107 = _tmp106 * _tmp84 - Scalar(1.0) * _tmp75;
  const Scalar _tmp108 = _tmp86 * _tmp96;
  const Scalar _tmp109 = _tmp85 * _tmp97;
  const Scalar _tmp110 = _tmp109 * (-_tmp105 * _tmp95 - _tmp107 * _tmp108);
  const Scalar _tmp111 = _tmp107 + _tmp110;
  const Scalar _tmp112 = _tmp61 * _tmp86;
  const Scalar _tmp113 = -_tmp111 * _tmp112 + Scalar(1.0);
  const Scalar _tmp114 = _tmp70 * _tmp74;
  const Scalar _tmp115 = _tmp49 * _tmp86;
  const Scalar _tmp116 = _tmp102 * fh1;
  const Scalar _tmp117 = _tmp59 * _tmp74;
  const Scalar _tmp118 = _tmp117 * _tmp76 + _tmp59 * _tmp71;
  const Scalar _tmp119 = -_tmp118 * _tmp84 + _tmp59 * _tmp75 - _tmp71;
  const Scalar _tmp120 = _tmp109 * (-_tmp108 * _tmp119 + _tmp117 * _tmp95 - _tmp94);
  const Scalar _tmp121 = _tmp119 + _tmp120;
  const Scalar _tmp122 = -_tmp112 * _tmp121 - _tmp59;
  const Scalar _tmp123 = _tmp103 * fh1;
  const Scalar _tmp124 = -_tmp104 * _tmp92 * (_tmp49 * _tmp98 - _tmp90 * _tmp98) -
                         _tmp116 * _tmp92 * (_tmp111 * _tmp115 + _tmp113 * _tmp114) -
                         _tmp123 * _tmp92 * (_tmp114 * _tmp122 + _tmp115 * _tmp121 + Scalar(1.0)) -
                         _tmp39 * _tmp92 * (_tmp49 * _tmp89 - _tmp89 * _tmp90);
  const Scalar _tmp125 = Scalar(1.0) / (_tmp124);
  const Scalar _tmp126 = _tmp38 * fh1;
  const Scalar _tmp127 = _tmp103 * _tmp126 + Scalar(2.3544) * _tmp26 + _tmp30 * fv1;
  ...
  const Scalar _tmp133 = _tmp79 * _tmp86;
  const Scalar _tmp134 = _tmp130 * _tmp87;
  const Scalar _tmp135 = -_tmp128 * _tmp134 - _tmp133 * _tmp88 + _tmp81;
  const Scalar _tmp136 = Scalar(1.0) * _tmp82;
  const Scalar _tmp137 = _tmp128 * _tmp130;
  const Scalar _tmp138 = _tmp118 + _tmp120 * _tmp137 - _tmp121 * _tmp133;
  const Scalar _tmp139 = _tmp109 * _tmp131;
  const Scalar _tmp140 = _tmp128 * _tmp139 - _tmp79 * _tmp98;
  const Scalar _tmp141 = -_tmp102 * _tmp126 - Scalar(2.3544) * _tmp16 - _tmp19 * fv1;
  const Scalar _tmp142 = _tmp82 * (_tmp129 * _tmp131 + Scalar(1.0));
  const Scalar _tmp143 = _tmp131 * _tmp84;
  const Scalar _tmp144 = -_tmp106 + _tmp110 * _tmp137 - _tmp111 * _tmp133;
  const Scalar _tmp145 = std::asinh(
      _tmp125 * (Scalar(1.0) * _tmp104 * (-_tmp136 * _tmp140 + _tmp139) +
                 Scalar(1.0) * _tmp116 * (_tmp110 * _tmp131 - _tmp136 * _tmp144) +
                 Scalar(1.0) * _tmp123 * (_tmp120 * _tmp131 - _tmp136 * _tmp138) +
                 Scalar(1.0) * _tmp127 * (_tmp131 * _tmp132 - _tmp131) +
                 Scalar(1.0) * _tmp141 * (-Scalar(1.0) * _tmp142 + _tmp143) +
                 Scalar(1.0) * _tmp39 * (-_tmp131 * _tmp87 - _tmp135 * _tmp136 + Scalar(1.0))));
  const Scalar _tmp146 = Scalar(9.6622558468725703) * _tmp124;
  const Scalar _tmp147 = _tmp39 * _tmp89;
  const Scalar _tmp148 = _tmp104 * _tmp98;
  const Scalar _tmp149 =
      _tmp113 * _tmp116 * _tmp74 + _tmp122 * _tmp123 * _tmp74 - _tmp147 * _tmp77 - _tmp148 * _tmp77;
  const Scalar _tmp150 = Scalar(1.0) / (_tmp149);
  const Scalar _tmp151 = _tmp127 * _tmp131;
  const Scalar _tmp152 =
      std::asinh(_tmp150 * (_tmp104 * _tmp140 * _tmp82 + _tmp116 * _tmp144 * _tmp82 +
                            _tmp123 * _tmp138 * _tmp82 - _tmp132 * _tmp151 +
                            _tmp135 * _tmp39 * _tmp82 + _tmp141 * _tmp142));
  const Scalar _tmp153 = Scalar(9.6622558468725703) * _tmp149;
  const Scalar _tmp154 =
      _tmp111 * _tmp116 * _tmp86 + _tmp121 * _tmp123 * _tmp86 + _tmp147 + _tmp148;
  const Scalar _tmp155 = Scalar(1.0) / (_tmp154);
  const Scalar _tmp156 = std::asinh(_tmp155 * (-_tmp104 * _tmp139 - _tmp110 * _tmp116 * _tmp130 -
                                               _tmp120 * _tmp123 * _tmp130 + _tmp134 * _tmp39 -
  ...
  _res(1, 0) =
      -_tmp146 *
          (Scalar(4.967784) * _tmp125 + std::cosh(Scalar(1.0) * _tmp145) -
           std::cosh(
               ...
               (-_tmp145 * _tmp146 -
                Scalar(125.0) *
                    std::sqrt(Scalar(
                        ...
                        Scalar(0.77439999999999998) *
                            std::pow(Scalar(-Scalar(0.0090909090909090905) * _tmp57 - 1),
                                     Scalar(2))))))) +
      _tmp71 + position_vector(2, 0);
  _res(2, 0) =
      -_tmp153 *
          (Scalar(4.967784) * _tmp150 + std::cosh(Scalar(1.0) * _tmp152) -
           std::cosh(
               Scalar(0.1034955) * _tmp150 *
               (-_tmp152 * _tmp153 -
                Scalar(125.0) * std::sqrt(Scalar(
                                    Scalar(0.77439999999999998) *
                                        std::pow(Scalar(1 - Scalar(0.0090909090909090905) * _tmp67),
                                                 Scalar(2)) +
