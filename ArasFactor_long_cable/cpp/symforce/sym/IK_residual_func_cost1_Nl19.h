...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl19(
  ...
  const Scalar _tmp61 = _tmp51 * _tmp59 - _tmp59 * _tmp60;
  ...
  const Scalar _tmp66 = _tmp44 + _tmp6;
  ...
  const Scalar _tmp73 = Scalar(1.0) / (_tmp59 * _tmp70 - _tmp72);
  const Scalar _tmp74 = _tmp71 * _tmp73;
  const Scalar _tmp75 = _tmp32 + _tmp50;
  const Scalar _tmp76 = _tmp51 * _tmp70;
  const Scalar _tmp77 = -_tmp59 * _tmp76 + _tmp60 * _tmp72;
  const Scalar _tmp78 = -_tmp49 * _tmp76 + _tmp62 * _tmp75 - _tmp74 * _tmp77;
  ...
  const Scalar _tmp83 = _tmp82 * (-_tmp55 + _tmp79);
  const Scalar _tmp84 = _tmp49 * _tmp51 - _tmp49 * _tmp75 - _tmp61 * _tmp74 - _tmp78 * _tmp83;
  const Scalar _tmp85 = Scalar(1.0) / (_tmp84);
  const Scalar _tmp86 = _tmp79 + _tmp80 * _tmp83;
  const Scalar _tmp87 = 0;
  const Scalar _tmp88 = _tmp85 * _tmp87;
  const Scalar _tmp89 = _tmp59 * _tmp73;
  const Scalar _tmp90 = _tmp71 * _tmp85;
  ...
  const Scalar _tmp96 = -_tmp61 * _tmp94 + _tmp83 * _tmp95;
  const Scalar _tmp97 = Scalar(1.0) / (_tmp92);
  const Scalar _tmp98 = _tmp93 * (-_tmp63 * _tmp68 * _tmp97 + _tmp65 * _tmp66 * _tmp97);
  const Scalar _tmp99 = _tmp52 * _tmp59 - _tmp55 * _tmp72 + _tmp59 * _tmp98;
  const Scalar _tmp100 = _tmp41 * _tmp49 - _tmp45 * _tmp62 + _tmp49 * _tmp98 - _tmp74 * _tmp99;
  ...
  const Scalar _tmp106 = _tmp49 * _tmp85;
  const Scalar _tmp107 = -_tmp105 * _tmp90 + Scalar(1.0);
  ...
  const Scalar _tmp112 = _tmp93 * fh1;
  const Scalar _tmp113 = Scalar(1.0) * _tmp102;
  const Scalar _tmp114 = _tmp102 * _tmp71 * _tmp94;
  const Scalar _tmp115 = _tmp109 * _tmp110;
  const Scalar _tmp116 = fh1 * (_tmp111 * _tmp18 - _tmp115 * _tmp28);
  const Scalar _tmp117 = _tmp70 * _tmp73;
  const Scalar _tmp118 = _tmp117 * _tmp77 + _tmp76;
  const Scalar _tmp119 = _tmp117 * _tmp61 - _tmp118 * _tmp83 - _tmp51;
  const Scalar _tmp120 = _tmp103 * (-_tmp101 * _tmp119 + _tmp117 * _tmp99 - _tmp98);
  const Scalar _tmp121 = _tmp119 + _tmp120;
  const Scalar _tmp122 = -_tmp121 * _tmp90 - _tmp70;
  const Scalar _tmp123 = -_tmp111 * _tmp112 * (_tmp105 * _tmp106 + _tmp107 * _tmp89) -
                         _tmp112 * _tmp115 * (_tmp106 * _tmp121 + _tmp122 * _tmp89 + Scalar(1.0)) -
                         _tmp116 * _tmp93 * (_tmp113 * _tmp49 - _tmp114 * _tmp59) -
                         _tmp38 * _tmp93 * (_tmp49 * _tmp88 - _tmp89 * _tmp91);
  const Scalar _tmp124 = Scalar(1.0) / (_tmp123);
  const Scalar _tmp125 = _tmp41 + _tmp81;
  const Scalar _tmp126 = _tmp125 * _tmp83;
  const Scalar _tmp127 = Scalar(1.0) / (-_tmp126 - _tmp45 + _tmp79);
  const Scalar _tmp128 = Scalar(1.0) * _tmp127;
  const Scalar _tmp129 = _tmp103 * _tmp128;
  const Scalar _tmp130 = -_tmp113 * _tmp78 + _tmp125 * _tmp129;
  const Scalar _tmp131 = Scalar(1.0) * _tmp82;
  const Scalar _tmp132 = _tmp37 * fh1;
  const Scalar _tmp133 = _tmp115 * _tmp132 + Scalar(2.3544) * _tmp12 + _tmp18 * fv1;
  const Scalar _tmp134 = _tmp125 * _tmp82;
  const Scalar _tmp135 = _tmp78 * _tmp85;
  const Scalar _tmp136 = _tmp125 * _tmp127;
  const Scalar _tmp137 = _tmp104 * _tmp136 - _tmp105 * _tmp135 - _tmp95;
  const Scalar _tmp138 = Scalar(1.0) * fh1;
  const Scalar _tmp139 = _tmp127 * _tmp86;
  const Scalar _tmp140 = -_tmp125 * _tmp139 - _tmp135 * _tmp87 + _tmp81;
  const Scalar _tmp141 = _tmp126 * _tmp128 + Scalar(1.0);
  const Scalar _tmp142 = _tmp128 * _tmp83;
  const Scalar _tmp143 = -_tmp111 * _tmp132 - Scalar(2.3544) * _tmp25 - _tmp28 * fv1;
  const Scalar _tmp144 = _tmp118 + _tmp120 * _tmp136 - _tmp121 * _tmp135;
  const Scalar _tmp145 = std::asinh(
      _tmp124 * (_tmp111 * _tmp138 * (_tmp104 * _tmp128 - _tmp131 * _tmp137) +
                 _tmp115 * _tmp138 * (_tmp120 * _tmp128 - _tmp131 * _tmp144) +
                 Scalar(1.0) * _tmp116 * (_tmp129 - _tmp130 * _tmp131) +
                 Scalar(1.0) * _tmp133 * (_tmp128 * _tmp134 - _tmp128) +
                 Scalar(1.0) * _tmp143 * (-_tmp131 * _tmp141 + _tmp142) +
                 Scalar(1.0) * _tmp38 * (-_tmp128 * _tmp86 - _tmp131 * _tmp140 + Scalar(1.0))));
  const Scalar _tmp146 = Scalar(9.6622558468725703) * _tmp123;
  const Scalar _tmp147 = _tmp73 * fh1;
  const Scalar _tmp148 = _tmp107 * _tmp111 * _tmp147 - _tmp114 * _tmp116 +
                         _tmp115 * _tmp122 * _tmp147 - _tmp38 * _tmp73 * _tmp91;
  const Scalar _tmp149 = Scalar(1.0) / (_tmp148);
  const Scalar _tmp150 = _tmp82 * fh1;
  const Scalar _tmp151 = _tmp128 * _tmp133;
  const Scalar _tmp152 =
      std::asinh(_tmp149 * (_tmp111 * _tmp137 * _tmp150 + _tmp115 * _tmp144 * _tmp150 +
                            _tmp116 * _tmp130 * _tmp82 - _tmp134 * _tmp151 +
                            _tmp140 * _tmp38 * _tmp82 + _tmp141 * _tmp143 * _tmp82));
  const Scalar _tmp153 = Scalar(9.6622558468725703) * _tmp148;
  const Scalar _tmp154 = _tmp85 * fh1;
  const Scalar _tmp155 = _tmp105 * _tmp111 * _tmp154 + _tmp113 * _tmp116 +
                         _tmp115 * _tmp121 * _tmp154 + _tmp38 * _tmp88;
  const Scalar _tmp156 = Scalar(1.0) / (_tmp155);
  const Scalar _tmp157 = _tmp127 * fh1;
  const Scalar _tmp158 =
      std::asinh(_tmp156 * (-_tmp104 * _tmp111 * _tmp157 - _tmp115 * _tmp120 * _tmp157 -
                            _tmp116 * _tmp129 + _tmp139 * _tmp38 - _tmp142 * _tmp143 + _tmp151));
  ...
  _res(1, 0) =
      -_tmp146 *
          (Scalar(4.967784) * _tmp124 + std::cosh(Scalar(1.0) * _tmp145) -
           std::cosh(Scalar(0.1034955) * _tmp124 *
                     (-_tmp145 * _tmp146 -
                      Scalar(125.0) *
                          std::sqrt(Scalar(
                              Scalar(0.77439999999999998) *
  ...
  _res(3, 0) =
      -_tmp159 *
          (Scalar(4.967784) * _tmp156 + std::cosh(Scalar(1.0) * _tmp158) -
           std::cosh(
