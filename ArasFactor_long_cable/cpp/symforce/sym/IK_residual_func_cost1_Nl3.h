...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl3(
  ...
  const Scalar _tmp124 = -_tmp108 * _tmp50 * (_tmp100 * _tmp99 + _tmp102 * _tmp103 + Scalar(1.0)) -
                         _tmp109 * _tmp50 * (-_tmp112 * _tmp113 + _tmp112 * _tmp85) -
                         _tmp116 * _tmp50 * (-_tmp113 * _tmp114 + _tmp114 * _tmp85) -
                         _tmp123 * _tmp50 * (_tmp100 * _tmp121 + _tmp103 * _tmp122);
  ...
  const Scalar _tmp131 = -_tmp114 * _tmp90 + _tmp130 * _tmp97;
  ...
  const Scalar _tmp136 = -_tmp134 * _tmp99 + _tmp135 * _tmp98 + _tmp70;
  const Scalar _tmp137 = _tmp129 * _tmp75;
  const Scalar _tmp138 = _tmp73 * (_tmp127 * _tmp129 + Scalar(1.0));
  const Scalar _tmp139 = _tmp38 * fh1;
  const Scalar _tmp140 = -_tmp115 * _tmp139 - Scalar(2.3544) * _tmp16 - _tmp19 * fv1;
  const Scalar _tmp141 = -_tmp118 + _tmp120 * _tmp135 - _tmp121 * _tmp134;
  const Scalar _tmp142 = _tmp107 * _tmp139 + Scalar(2.3544) * _tmp26 + _tmp30 * fv1;
  const Scalar _tmp143 = _tmp110 * _tmp128;
  const Scalar _tmp144 = _tmp73 * (-_tmp111 * _tmp134 - _tmp126 * _tmp143 + _tmp72);
  const Scalar _tmp145 =
      std::asinh(_tmp125 * (Scalar(1.0) * _tmp108 * (_tmp129 * _tmp98 - _tmp132 * _tmp136) +
                            Scalar(1.0) * _tmp109 *
                                (-_tmp110 * _tmp129 - Scalar(1.0) * _tmp144 + Scalar(1.0)) +
                            Scalar(1.0) * _tmp116 * (-_tmp131 * _tmp132 + _tmp133) +
                            Scalar(1.0) * _tmp123 * (_tmp120 * _tmp129 - _tmp132 * _tmp141) +
                            Scalar(1.0) * _tmp140 * (_tmp137 - Scalar(1.0) * _tmp138) +
                            Scalar(1.0) * _tmp142 * (-_tmp129 + _tmp130 * _tmp73)));
  const Scalar _tmp146 = Scalar(9.6622558468725703) * _tmp124;
  const Scalar _tmp147 = _tmp129 * _tmp142;
  const Scalar _tmp148 = _tmp109 * _tmp112;
  const Scalar _tmp149 = _tmp114 * _tmp116;
  const Scalar _tmp150 =
      _tmp102 * _tmp108 * _tmp62 + _tmp122 * _tmp123 * _tmp62 - _tmp148 * _tmp88 - _tmp149 * _tmp88;
  const Scalar _tmp151 = Scalar(1.0) / (_tmp150);
  const Scalar _tmp152 = std::asinh(
      _tmp151 * (_tmp108 * _tmp136 * _tmp73 + _tmp109 * _tmp144 + _tmp116 * _tmp131 * _tmp73 +
                 _tmp123 * _tmp141 * _tmp73 - _tmp126 * _tmp147 * _tmp73 + _tmp138 * _tmp140));
  const Scalar _tmp153 = Scalar(9.6622558468725703) * _tmp150;
  const Scalar _tmp154 = _tmp108 * _tmp92 * _tmp99 + _tmp121 * _tmp123 * _tmp92 + _tmp148 + _tmp149;
  const Scalar _tmp155 = Scalar(1.0) / (_tmp154);
  const Scalar _tmp156 =
      std::asinh(_tmp155 * (-_tmp108 * _tmp128 * _tmp98 + _tmp109 * _tmp143 - _tmp116 * _tmp133 -
                            _tmp120 * _tmp123 * _tmp128 - _tmp137 * _tmp140 + _tmp147));
                ...
                Scalar(125.0) * std::sqrt(Scalar(
                                    Scalar(0.77439999999999998) *
                                        std::pow(Scalar(1 - Scalar(0.0090909090909090905) * _tmp41),
                                                 Scalar(2)) +
                                    std::pow(Scalar(1 - Scalar(0.0080000000000000002) * _tmp45),
                                             Scalar(2))))))) +
