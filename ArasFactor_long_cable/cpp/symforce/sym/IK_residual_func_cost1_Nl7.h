...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl7(
  ...
  const Scalar _tmp44 = _tmp38 + _tmp5;
  ...
  const Scalar _tmp55 = _tmp39 + position_vector(1, 0);
  const Scalar _tmp56 = _tmp55 + Scalar(110.0);
  const Scalar _tmp57 = _tmp48 + position_vector(0, 0);
  ...
  const Scalar _tmp63 = _tmp47 + position_vector(0, 0);
  ...
  const Scalar _tmp72 = _tmp66 * _tmp67;
  const Scalar _tmp73 = -_tmp60 * _tmp69 + _tmp71 * _tmp72;
  const Scalar _tmp74 = Scalar(1.0) / (_tmp60 * _tmp68 - _tmp72);
  const Scalar _tmp75 = Scalar(1.0) * _tmp74;
  const Scalar _tmp76 = _tmp73 * _tmp75;
  const Scalar _tmp77 = -_tmp68 * _tmp71 + _tmp69;
  ...
  const Scalar _tmp90 = -_tmp73 * _tmp88 - _tmp84 * _tmp89 + _tmp85 * _tmp86;
  const Scalar _tmp91 = -_tmp50 * _tmp90 + _tmp62 * _tmp84 - _tmp77 * _tmp88 - _tmp84 * _tmp85;
  const Scalar _tmp92 = Scalar(1.0) / (_tmp91);
  const Scalar _tmp93 =
      std::sqrt(Scalar(std::pow(_tmp56, Scalar(2)) + std::pow(_tmp58, Scalar(2))));
  const Scalar _tmp94 = Scalar(1.0) / (_tmp93);
  const Scalar _tmp95 = _tmp59 * _tmp93;
  const Scalar _tmp96 = _tmp95 * (-_tmp39 * _tmp58 * _tmp94 + _tmp48 * _tmp56 * _tmp94);
  const Scalar _tmp97 = _tmp74 * (_tmp44 * _tmp68 - _tmp47 * _tmp72 + _tmp68 * _tmp96);
  const Scalar _tmp98 = _tmp42 * _tmp84 - _tmp52 * _tmp86 + _tmp84 * _tmp96 - _tmp87 * _tmp97;
  const Scalar _tmp99 = _tmp92 * _tmp98;
  const Scalar _tmp100 = Scalar(1.0) / (_tmp98);
  const Scalar _tmp101 = _tmp100 * _tmp91;
  const Scalar _tmp102 = _tmp101 * (-_tmp78 * _tmp99 - Scalar(1.0) * _tmp97);
  const Scalar _tmp103 = _tmp43 * _tmp53;
  const Scalar _tmp104 = _tmp102 + _tmp78;
  const Scalar _tmp105 = _tmp90 * _tmp92;
  const Scalar _tmp106 = _tmp102 * _tmp103 - _tmp104 * _tmp105 - _tmp76;
  const Scalar _tmp107 = Scalar(1.0) * _tmp45;
  const Scalar _tmp108 = _tmp19 + Scalar(110.0);
  ...
  const Scalar _tmp113 = _tmp40 * _tmp50 + _tmp49;
  const Scalar _tmp114 = _tmp113 * _tmp53;
  const Scalar _tmp115 = 0;
  const Scalar _tmp116 = -_tmp105 * _tmp115 - _tmp114 * _tmp43 + _tmp41;
  const Scalar _tmp117 = Scalar(19.620000000000001) - fv1;
  const Scalar _tmp118 = _tmp43 * _tmp45;
  const Scalar _tmp119 = _tmp109 * _tmp110;
  const Scalar _tmp120 = _tmp37 * fh1;
  const Scalar _tmp121 = _tmp119 * _tmp120 + Scalar(2.3544) * _tmp26 + _tmp29 * fv1;
  const Scalar _tmp122 = -_tmp111 * _tmp120 - Scalar(2.3544) * _tmp12 - _tmp18 * fv1;
  const Scalar _tmp123 = _tmp51 * _tmp54 + Scalar(1.0);
  const Scalar _tmp124 = _tmp50 * _tmp54;
  const Scalar _tmp125 = Scalar(1.0) * _tmp100;
  const Scalar _tmp126 = _tmp101 * _tmp54;
  const Scalar _tmp127 = -_tmp125 * _tmp90 + _tmp126 * _tmp43;
  const Scalar _tmp128 = fh1 * (_tmp111 * _tmp29 - _tmp119 * _tmp18);
  const Scalar _tmp129 = _tmp60 * _tmp74;
  const Scalar _tmp130 = _tmp129 * _tmp73 + _tmp89;
  const Scalar _tmp131 = _tmp129 * _tmp77 - _tmp130 * _tmp50 - _tmp62;
  const Scalar _tmp132 = _tmp101 * (-_tmp131 * _tmp99 + _tmp60 * _tmp97 - _tmp96);
  const Scalar _tmp133 = _tmp131 + _tmp132;
  const Scalar _tmp134 = _tmp103 * _tmp132 - _tmp105 * _tmp133 + _tmp130;
  const Scalar _tmp135 = _tmp119 * fh1;
  const Scalar _tmp136 = _tmp84 * _tmp92;
  const Scalar _tmp137 = _tmp87 * _tmp92;
  const Scalar _tmp138 = -_tmp104 * _tmp137 + Scalar(1.0);
  const Scalar _tmp139 = _tmp68 * _tmp74;
  const Scalar _tmp140 = _tmp100 * _tmp75 * _tmp87;
  const Scalar _tmp141 = _tmp115 * _tmp92;
  const Scalar _tmp142 = -_tmp133 * _tmp137 - _tmp60;
  const Scalar _tmp143 = -_tmp112 * _tmp95 * (_tmp104 * _tmp136 + _tmp138 * _tmp139) -
                         _tmp117 * _tmp95 * (-_tmp141 * _tmp68 * _tmp88 + _tmp141 * _tmp84) -
                         _tmp128 * _tmp95 * (_tmp125 * _tmp84 - _tmp140 * _tmp68) -
                         _tmp135 * _tmp95 * (_tmp133 * _tmp136 + _tmp139 * _tmp142 + Scalar(1.0));
  const Scalar _tmp144 = Scalar(1.0) / (_tmp143);
  const Scalar _tmp145 = std::asinh(
      _tmp144 * (Scalar(1.0) * _tmp112 * (_tmp102 * _tmp54 - _tmp106 * _tmp107) +
                 Scalar(1.0) * _tmp117 * (-_tmp107 * _tmp116 - _tmp113 * _tmp54 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp121 * (_tmp118 * _tmp54 - _tmp54) +
                 Scalar(1.0) * _tmp122 * (-_tmp107 * _tmp123 + _tmp124) +
                 Scalar(1.0) * _tmp128 * (-_tmp107 * _tmp127 + _tmp126) +
                 Scalar(1.0) * _tmp135 * (-_tmp107 * _tmp134 + _tmp132 * _tmp54)));
  const Scalar _tmp146 = Scalar(9.6622558468725703) * _tmp143;
  const Scalar _tmp147 = _tmp117 * _tmp141;
  const Scalar _tmp148 = _tmp112 * _tmp138 * _tmp74 - _tmp128 * _tmp140 +
                         _tmp135 * _tmp142 * _tmp74 - _tmp147 * _tmp88;
  const Scalar _tmp149 = Scalar(1.0) / (_tmp148);
  const Scalar _tmp150 = _tmp121 * _tmp54;
  const Scalar _tmp151 =
      std::asinh(_tmp149 * (_tmp106 * _tmp112 * _tmp45 + _tmp116 * _tmp117 * _tmp45 -
                            _tmp118 * _tmp150 + _tmp122 * _tmp123 * _tmp45 +
                            _tmp127 * _tmp128 * _tmp45 + _tmp134 * _tmp135 * _tmp45));
  const Scalar _tmp152 = Scalar(9.6622558468725703) * _tmp148;
  const Scalar _tmp153 =
      _tmp104 * _tmp112 * _tmp92 + _tmp125 * _tmp128 + _tmp133 * _tmp135 * _tmp92 + _tmp147;
  const Scalar _tmp154 = Scalar(1.0) / (_tmp153);
  const Scalar _tmp155 =
      std::asinh(_tmp154 * (-_tmp102 * _tmp112 * _tmp53 + _tmp114 * _tmp117 - _tmp122 * _tmp124 -
                            _tmp126 * _tmp128 - _tmp132 * _tmp135 * _tmp53 + _tmp150));
           ...
           std::cosh(Scalar(0.1034955) * _tmp144 *
                     (-_tmp145 * _tmp146 -
                      Scalar(125.0) *
                          std::sqrt(Scalar(
                              Scalar(0.77439999999999998) *
                                  std::pow(Scalar(-Scalar(0.0090909090909090905) * _tmp55 - 1),
                                           Scalar(2)) +
                ...
                Scalar(125.0) * std::sqrt(Scalar(
                                    Scalar(0.77439999999999998) *
                                        std::pow(Scalar(1 - Scalar(0.0090909090909090905) * _tmp79),
                                                 Scalar(2)) +
                                    std::pow(Scalar(1 - Scalar(0.0080000000000000002) * _tmp81),
                                             Scalar(2))))))) +
