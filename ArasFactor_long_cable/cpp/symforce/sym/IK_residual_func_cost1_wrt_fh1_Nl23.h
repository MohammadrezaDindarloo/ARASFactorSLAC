...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1WrtFh1Nl23(
  ...
  const Scalar _tmp43 = -Scalar(0.010999999999999999) * _tmp2 -
                        Scalar(0.010999999999999999) * _tmp20 + Scalar(-0.010999999999999999);
  const Scalar _tmp44 = -Scalar(0.20999999999999999) * _tmp11 + Scalar(0.20999999999999999) * _tmp9;
  const Scalar _tmp45 = _tmp43 - _tmp44;
  const Scalar _tmp46 = _tmp42 + _tmp45;
  const Scalar _tmp47 = _tmp46 * fh1;
  const Scalar _tmp48 = Scalar(2.3544) * _tmp12 + _tmp18 * fv1 + _tmp41 * _tmp47;
  ...
  const Scalar _tmp60 = _tmp17 + _tmp5;
  const Scalar _tmp61 = Scalar(1.0) * _tmp60;
  const Scalar _tmp62 = _tmp57 * (-_tmp59 + _tmp61);
  ...
  const Scalar _tmp67 = _tmp55 * _tmp57;
  ...
  const Scalar _tmp72 = _tmp56 + position_vector(1, 0);
  const Scalar _tmp73 = _tmp72 + Scalar(110.0);
  const Scalar _tmp74 = _tmp59 + position_vector(0, 0);
  ...
  const Scalar _tmp78 = _tmp50 + position_vector(1, 0);
  const Scalar _tmp79 = _tmp78 + Scalar(-110.0);
  const Scalar _tmp80 = _tmp60 + position_vector(0, 0);
  const Scalar _tmp81 = _tmp80 + Scalar(-125.0);
  const Scalar _tmp82 = Scalar(1.0) / (_tmp81);
  const Scalar _tmp83 = _tmp79 * _tmp82;
  const Scalar _tmp84 = _tmp42 + _tmp70;
  const Scalar _tmp85 = _tmp75 * _tmp76;
  const Scalar _tmp86 = _tmp84 * _tmp85;
  const Scalar _tmp87 = _tmp71 * _tmp77 - _tmp83 * _tmp86;
  const Scalar _tmp88 = Scalar(1.0) / (-_tmp77 + _tmp83 * _tmp85);
  const Scalar _tmp89 = Scalar(1.0) * _tmp88;
  const Scalar _tmp90 = _tmp87 * _tmp89;
  const Scalar _tmp91 = -_tmp71 * _tmp85 + _tmp86;
  const Scalar _tmp92 = _tmp62 * _tmp90 - _tmp89 * _tmp91;
  const Scalar _tmp93 = _tmp54 + position_vector(1, 0);
  const Scalar _tmp94 = _tmp93 + Scalar(110.0);
  const Scalar _tmp95 = _tmp64 + position_vector(0, 0);
  ...
  const Scalar _tmp100 = _tmp83 * _tmp98 - _tmp99;
  const Scalar _tmp101 = _tmp100 * _tmp88;
  const Scalar _tmp102 = _tmp45 + _tmp69;
  const Scalar _tmp103 = _tmp83 * _tmp84;
  const Scalar _tmp104 = -_tmp101 * _tmp87 + _tmp102 * _tmp99 - _tmp103 * _tmp98;
  const Scalar _tmp105 = -_tmp101 * _tmp91 - _tmp102 * _tmp98 - _tmp104 * _tmp62 + _tmp84 * _tmp98;
  ...
  const Scalar _tmp109 = _tmp107 * _tmp82;
  const Scalar _tmp110 = _tmp109 * (-_tmp108 * _tmp50 * _tmp81 + _tmp108 * _tmp60 * _tmp79);
  const Scalar _tmp111 = _tmp110 * _tmp85 + _tmp56 * _tmp85 - _tmp59 * _tmp77;
  const Scalar _tmp112 = -_tmp101 * _tmp111 + _tmp110 * _tmp98 + _tmp54 * _tmp98 - _tmp64 * _tmp99;
  ...
  const Scalar _tmp119 = _tmp55 * _tmp65;
  const Scalar _tmp120 = _tmp116 * _tmp119 - _tmp117 * _tmp118 - _tmp90;
  const Scalar _tmp121 = Scalar(1.0) * _tmp57;
  const Scalar _tmp122 = _tmp39 * _tmp40;
  const Scalar _tmp123 = Scalar(1.0) * _tmp122 * (_tmp116 * _tmp66 - _tmp120 * _tmp121);
  const Scalar _tmp124 = _tmp83 * _tmp88;
  const Scalar _tmp125 = _tmp103 + _tmp124 * _tmp87;
  const Scalar _tmp126 = _tmp124 * _tmp91 - _tmp125 * _tmp62 - _tmp84;
  const Scalar _tmp127 = _tmp115 * (-_tmp110 + _tmp111 * _tmp124 - _tmp113 * _tmp126);
  const Scalar _tmp128 = _tmp126 + _tmp127;
  const Scalar _tmp129 = -_tmp118 * _tmp128 + _tmp119 * _tmp127 + _tmp125;
  const Scalar _tmp130 = Scalar(1.0) * _tmp41 * (-_tmp121 * _tmp129 + _tmp127 * _tmp66);
  const Scalar _tmp131 = -_tmp122 * _tmp47 - Scalar(2.3544) * _tmp25 - _tmp28 * fv1;
  const Scalar _tmp132 = _tmp63 * _tmp66 + Scalar(1.0);
  const Scalar _tmp133 = _tmp62 * _tmp66;
  const Scalar _tmp134 = -Scalar(1.0) * _tmp121 * _tmp132 + Scalar(1.0) * _tmp133;
  const Scalar _tmp135 = Scalar(19.620000000000001) - fv1;
  const Scalar _tmp136 = _tmp51 * _tmp62 + _tmp61;
  const Scalar _tmp137 = _tmp136 * _tmp65;
  const Scalar _tmp138 = 0;
  const Scalar _tmp139 = _tmp106 * _tmp138;
  const Scalar _tmp140 = -_tmp104 * _tmp139 - _tmp137 * _tmp55 + _tmp52;
  const Scalar _tmp141 = _tmp122 * _tmp18 - _tmp28 * _tmp41;
  const Scalar _tmp142 = _tmp115 * _tmp66;
  const Scalar _tmp143 = Scalar(1.0) * _tmp114;
  const Scalar _tmp144 = _tmp57 * (-_tmp104 * _tmp143 + _tmp142 * _tmp55);
  const Scalar _tmp145 = Scalar(1.0) * _tmp141 * (_tmp142 - Scalar(1.0) * _tmp144);
  const Scalar _tmp146 =
      _tmp123 * fh1 + _tmp130 * fh1 + _tmp131 * _tmp134 +
      Scalar(1.0) * _tmp135 * (-_tmp121 * _tmp140 - _tmp136 * _tmp66 + Scalar(1.0)) +
      _tmp145 * fh1 + _tmp48 * _tmp68;
  const Scalar _tmp147 = _tmp109 * _tmp141 * (-_tmp101 * _tmp143 * _tmp85 + _tmp143 * _tmp98);
  const Scalar _tmp148 = _tmp100 * _tmp106;
  const Scalar _tmp149 = _tmp138 * _tmp148 * _tmp88;
  const Scalar _tmp150 = _tmp106 * _tmp117;
  const Scalar _tmp151 = _tmp88 * (-_tmp117 * _tmp148 + Scalar(1.0));
  const Scalar _tmp152 = _tmp109 * _tmp122 * (_tmp150 * _tmp98 + _tmp151 * _tmp85);
  const Scalar _tmp153 = _tmp106 * _tmp128;
  const Scalar _tmp154 = _tmp88 * (-_tmp128 * _tmp148 - _tmp83);
  const Scalar _tmp155 = _tmp109 * _tmp41 * (_tmp153 * _tmp98 + _tmp154 * _tmp85 + Scalar(1.0));
  const Scalar _tmp156 = -_tmp109 * _tmp135 * (_tmp139 * _tmp98 - _tmp149 * _tmp85) -
      ...
      Scalar(125.0) *
          std::sqrt(
              Scalar(Scalar(0.77439999999999998) *
                     ...
                     std::pow(Scalar(1 - Scalar(0.0080000000000000002) * _tmp80), Scalar(2))));
  ...
  const Scalar _tmp168 = _tmp122 * _tmp46;
  const Scalar _tmp169 = _tmp41 * _tmp46;
  const Scalar _tmp170 = (-_tmp146 * _tmp167 + _tmp157 * (_tmp123 + _tmp130 - _tmp134 * _tmp168 +
                                                          _tmp145 + _tmp169 * _tmp68)) /
                         std::sqrt(Scalar(std::pow(_tmp146, Scalar(2)) * _tmp166 + 1));
  const Scalar _tmp171 = _tmp154 * _tmp41;
  const Scalar _tmp172 = _tmp122 * _tmp151;
  const Scalar _tmp173 = _tmp141 * _tmp143;
  const Scalar _tmp174 = _tmp173 * fh1;
  const Scalar _tmp175 = -_tmp101 * _tmp174 - _tmp135 * _tmp149 + _tmp171 * fh1 + _tmp172 * fh1;
  const Scalar _tmp176 = Scalar(1.0) / (_tmp175);
  const Scalar _tmp177 = _tmp41 * _tmp57;
  const Scalar _tmp178 = _tmp129 * _tmp177;
  const Scalar _tmp179 = _tmp141 * _tmp144;
  const Scalar _tmp180 = _tmp120 * _tmp122 * _tmp57;
  const Scalar _tmp181 = _tmp132 * _tmp57;
  const Scalar _tmp182 = _tmp48 * _tmp66;
  const Scalar _tmp183 = _tmp131 * _tmp181 + _tmp135 * _tmp140 * _tmp57 + _tmp178 * fh1 +
                         _tmp179 * fh1 + _tmp180 * fh1 - _tmp182 * _tmp67;
  ...
  const Scalar _tmp190 = -_tmp101 * _tmp173 + _tmp171 + _tmp172;
  ...
  const Scalar _tmp194 = (_tmp176 * (-_tmp168 * _tmp181 - _tmp177 * _tmp46 * _tmp55 * _tmp66 +
                                     _tmp178 + _tmp179 + _tmp180) -
                          _tmp183 * _tmp193) /
                         std::sqrt(Scalar(std::pow(_tmp183, Scalar(2)) * _tmp192 + 1));
  const Scalar _tmp195 = _tmp153 * _tmp41;
  const Scalar _tmp196 = _tmp122 * _tmp150;
  const Scalar _tmp197 = _tmp135 * _tmp139 + _tmp174 + _tmp195 * fh1 + _tmp196 * fh1;
  const Scalar _tmp198 = Scalar(1.0) / (_tmp197);
  const Scalar _tmp199 = _tmp141 * _tmp142;
  const Scalar _tmp200 = _tmp127 * _tmp41 * _tmp65;
  const Scalar _tmp201 = _tmp116 * _tmp122 * _tmp65;
  const Scalar _tmp202 = -_tmp131 * _tmp133 + _tmp135 * _tmp137 + _tmp182 - _tmp199 * fh1 -
  ...
  const Scalar _tmp213 =
      (_tmp198 * (_tmp133 * _tmp168 + _tmp169 * _tmp66 - _tmp199 - _tmp200 - _tmp201) -
       _tmp202 * _tmp212) /
      ...
      -_tmp160 * (-Scalar(4.967784) * _tmp167 + Scalar(1.0) * _tmp170 * std::sinh(_tmp159) -
                  (-Scalar(0.1034955) * _tmp161 * _tmp167 +
                   _tmp162 * (-_tmp158 * _tmp165 - _tmp160 * _tmp170)) *
                      std::sinh(_tmp163)) -
      _tmp165 * (Scalar(4.967784) * _tmp157 + std::cosh(_tmp159) - std::cosh(_tmp163));
  _res(2, 0) =
      ...
      -_tmp205 * (-Scalar(4.967784) * _tmp212 + Scalar(1.0) * _tmp213 * std::sinh(_tmp204) -
                  (-Scalar(0.1034955) * _tmp206 * _tmp212 +
                   _tmp207 * (-_tmp203 * _tmp210 - _tmp205 * _tmp213)) *
                      std::sinh(_tmp208)) -
      _tmp210 * (Scalar(4.967784) * _tmp198 + std::cosh(_tmp204) - std::cosh(_tmp208));
