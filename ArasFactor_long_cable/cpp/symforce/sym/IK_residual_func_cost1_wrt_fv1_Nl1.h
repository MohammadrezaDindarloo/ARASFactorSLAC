...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1WrtFv1Nl1(
  ...
  const Scalar _tmp36 = _tmp13 + _tmp19;
  ...
  const Scalar _tmp56 = _tmp10 + _tmp36;
  ...
  const Scalar _tmp87 = -_tmp45 * _tmp50 - _tmp63 * _tmp76 + _tmp79 - _tmp80 * _tmp86;
  ...
  const Scalar _tmp95 = _tmp94 * (_tmp45 * _tmp91 - _tmp60 * _tmp92);
  const Scalar _tmp96 = Scalar(1.0) / (_tmp93);
  const Scalar _tmp97 = _tmp94 * (_tmp65 * _tmp71 * _tmp96 - _tmp67 * _tmp69 * _tmp96);
  const Scalar _tmp98 = -_tmp53 * _tmp64 + _tmp56 * _tmp60 + _tmp60 * _tmp97;
  const Scalar _tmp99 = _tmp37 * _tmp45 - _tmp41 * _tmp74 + _tmp45 * _tmp97 - _tmp76 * _tmp98;
  ...
  const Scalar _tmp110 = -_tmp108 * _tmp63 + _tmp109 * _tmp73 * _tmp78 * _tmp85;
  const Scalar _tmp111 = _tmp88 * _tmp99;
  const Scalar _tmp112 = _tmp100 * _tmp87;
  const Scalar _tmp113 = _tmp112 * (-_tmp108 * _tmp98 - _tmp110 * _tmp111);
  const Scalar _tmp114 = _tmp110 + _tmp113;
  const Scalar _tmp115 = _tmp75 * _tmp88;
  const Scalar _tmp116 = -_tmp114 * _tmp115 + Scalar(1.0);
  const Scalar _tmp117 = _tmp60 * _tmp73;
  const Scalar _tmp118 = _tmp45 * _tmp88;
  const Scalar _tmp119 = _tmp105 * fh1;
  const Scalar _tmp120 = _tmp72 * _tmp73;
  const Scalar _tmp121 = _tmp120 * _tmp78 + _tmp77;
  const Scalar _tmp122 = _tmp120 * _tmp63 - _tmp121 * _tmp86 - _tmp62;
  const Scalar _tmp123 = _tmp112 * (-_tmp111 * _tmp122 + _tmp120 * _tmp98 - _tmp97);
  const Scalar _tmp124 = _tmp122 + _tmp123;
  const Scalar _tmp125 = -_tmp115 * _tmp124 - _tmp72;
  const Scalar _tmp126 = _tmp106 * fh1;
  const Scalar _tmp127 = -_tmp107 * _tmp94 * (_tmp101 * _tmp45 - _tmp101 * _tmp60 * _tmp76) -
                         _tmp119 * _tmp94 * (_tmp114 * _tmp118 + _tmp116 * _tmp117) -
                         _tmp126 * _tmp94 * (_tmp117 * _tmp125 + _tmp118 * _tmp124 + Scalar(1.0)) -
                         _tmp35 * _tmp95;
  const Scalar _tmp128 = Scalar(1.0) / (_tmp127);
  const Scalar _tmp129 = fh1 * (_tmp51 + _tmp61);
  const Scalar _tmp130 = _tmp106 * _tmp129 + Scalar(2.3544) * _tmp28 + _tmp32 * fv1;
  const Scalar _tmp131 = _tmp37 + _tmp82;
  const Scalar _tmp132 = _tmp131 * _tmp86;
  const Scalar _tmp133 = Scalar(1.0) / (-_tmp132 - _tmp41 + _tmp84);
  const Scalar _tmp134 = Scalar(1.0) * _tmp133;
  const Scalar _tmp135 = _tmp131 * _tmp134;
  const Scalar _tmp136 = -Scalar(1.0) * _tmp134 + Scalar(1.0) * _tmp135 * _tmp83;
  const Scalar _tmp137 = _tmp80 * _tmp88;
  const Scalar _tmp138 = _tmp133 * _tmp89;
  const Scalar _tmp139 = _tmp83 * (-_tmp131 * _tmp138 - _tmp137 * _tmp90 + _tmp82);
  const Scalar _tmp140 = -Scalar(1.0) * _tmp134 * _tmp89 - Scalar(1.0) * _tmp139 + Scalar(1.0);
  const Scalar _tmp141 = _tmp131 * _tmp133;
  const Scalar _tmp142 = _tmp121 + _tmp123 * _tmp141 - _tmp124 * _tmp137;
  const Scalar _tmp143 = -_tmp101 * _tmp80 + _tmp112 * _tmp135;
  const Scalar _tmp144 = _tmp112 * _tmp134;
  const Scalar _tmp145 = -_tmp105 * _tmp129 - Scalar(2.3544) * _tmp17 - _tmp21 * fv1;
  const Scalar _tmp146 = _tmp132 * _tmp134 + Scalar(1.0);
  const Scalar _tmp147 = _tmp134 * _tmp86;
  const Scalar _tmp148 = -Scalar(1.0) * _tmp109 * _tmp146 + Scalar(1.0) * _tmp147;
  const Scalar _tmp149 = -_tmp108 * _tmp78 + _tmp113 * _tmp141 - _tmp114 * _tmp137;
  const Scalar _tmp150 = Scalar(1.0) * _tmp107 * (-_tmp109 * _tmp143 + _tmp144) +
                         Scalar(1.0) * _tmp119 * (-_tmp109 * _tmp149 + _tmp113 * _tmp134) +
                         Scalar(1.0) * _tmp126 * (-_tmp109 * _tmp142 + _tmp123 * _tmp134) +
                         _tmp130 * _tmp136 + _tmp140 * _tmp35 + _tmp145 * _tmp148;
  ...
  const Scalar _tmp153 =
      ...
      Scalar(125.0) *
          std::sqrt(
              Scalar(std::pow(Scalar(1 - Scalar(0.0080000000000000002) * _tmp66), Scalar(2)) +
  ...
  const Scalar _tmp160 = _tmp13 + _tmp18 + _tmp9;
  const Scalar _tmp161 =
      (_tmp128 * (_tmp136 * _tmp32 - _tmp140 + _tmp148 * _tmp160) - _tmp150 * _tmp159) /
      std::sqrt(Scalar(std::pow(_tmp150, Scalar(2)) * _tmp158 + 1));
  const Scalar _tmp162 = _tmp35 * _tmp91;
  const Scalar _tmp163 = _tmp101 * _tmp107;
  const Scalar _tmp164 =
      _tmp116 * _tmp119 * _tmp73 + _tmp125 * _tmp126 * _tmp73 - _tmp162 * _tmp76 - _tmp163 * _tmp76;
  const Scalar _tmp165 = Scalar(1.0) / (_tmp164);
  const Scalar _tmp166 = _tmp130 * _tmp134;
  const Scalar _tmp167 = _tmp131 * _tmp83;
  const Scalar _tmp168 = _tmp146 * _tmp83;
  const Scalar _tmp169 = _tmp107 * _tmp143 * _tmp83 + _tmp119 * _tmp149 * _tmp83 +
                         _tmp126 * _tmp142 * _tmp83 + _tmp139 * _tmp35 + _tmp145 * _tmp168 -
                         _tmp166 * _tmp167;
  ...
  const Scalar _tmp177 = _tmp134 * _tmp32;
  const Scalar _tmp178 =
      (_tmp165 * (-_tmp139 + _tmp160 * _tmp168 - _tmp167 * _tmp177) - _tmp169 * _tmp176) /
      std::sqrt(Scalar(std::pow(_tmp169, Scalar(2)) * _tmp175 + 1));
  const Scalar _tmp179 = Scalar(9.6622558468725703) * _tmp91;
  const Scalar _tmp180 = _tmp179 * _tmp76;
  const Scalar _tmp181 = Scalar(1.0) * _tmp170;
  const Scalar _tmp182 =
      _tmp114 * _tmp119 * _tmp88 + _tmp124 * _tmp126 * _tmp88 + _tmp162 + _tmp163;
  const Scalar _tmp183 = Scalar(1.0) / (_tmp182);
  const Scalar _tmp184 = -_tmp107 * _tmp144 - _tmp113 * _tmp119 * _tmp133 -
                         _tmp123 * _tmp126 * _tmp133 + _tmp138 * _tmp35 - _tmp145 * _tmp147 +
                         _tmp166;
  ...
  const Scalar _tmp193 = (_tmp183 * (-_tmp138 - _tmp147 * _tmp160 + _tmp177) + _tmp184 * _tmp192) /
  ...
  _res(2, 0) =
      -_tmp171 * (-Scalar(4.967784) * _tmp176 + Scalar(1.0) * _tmp178 * std::sinh(_tmp181) -
                  (-Scalar(0.1034955) * _tmp172 * _tmp176 +
                   _tmp173 * (-_tmp170 * _tmp180 - _tmp171 * _tmp178)) *
                      std::sinh(_tmp174)) -
      _tmp180 * (Scalar(4.967784) * _tmp165 - std::cosh(_tmp174) + std::cosh(_tmp181));
  _res(3, 0) = _tmp179 * (Scalar(4.967784) * _tmp183 - std::cosh(_tmp189) + std::cosh(_tmp190)) -
               _tmp186 * (Scalar(4.967784) * _tmp192 + Scalar(1.0) * _tmp193 * std::sinh(_tmp190) -
                          (Scalar(0.1034955) * _tmp187 * _tmp192 +
                           _tmp188 * (_tmp179 * _tmp185 - _tmp186 * _tmp193)) *
                              std::sinh(_tmp189));
