...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1WrtFv1Nl17(
  ...
  const Scalar _tmp22 = _tmp14 * _tmp3;
  ...
  const Scalar _tmp87 = _tmp34 + _tmp51;
  const Scalar _tmp88 = -_tmp64 * _tmp83 - _tmp69 * _tmp86 + _tmp84 * _tmp87;
  const Scalar _tmp89 = _tmp68 * _tmp72;
  const Scalar _tmp90 = -_tmp53 * _tmp86 - _tmp82 * _tmp87 + _tmp83 - _tmp88 * _tmp89;
  ...
  const Scalar _tmp96 = _tmp41 * _tmp49 - _tmp45 * _tmp54 + _tmp49 * _tmp95;
  const Scalar _tmp97 = _tmp75 * _tmp82 - _tmp78 * _tmp84 + _tmp82 * _tmp95 - _tmp86 * _tmp96;
  ...
  const Scalar _tmp108 = _tmp20 + Scalar(-125.0);
  ...
  const Scalar _tmp113 = _tmp67 + _tmp70 * _tmp89;
  const Scalar _tmp114 = 0;
  const Scalar _tmp115 = _tmp114 * _tmp91;
  const Scalar _tmp116 = _tmp103 * _tmp114;
  const Scalar _tmp117 = _tmp94 * (-_tmp105 * _tmp116 + _tmp115 * _tmp82);
  const Scalar _tmp118 = _tmp64 * _tmp65;
  const Scalar _tmp119 = _tmp118 * _tmp69 + _tmp38 * _tmp64;
  const Scalar _tmp120 = _tmp118 * _tmp53 - _tmp119 * _tmp89 - _tmp38;
  ...
  const Scalar _tmp127 = fh1 * (_tmp110 * _tmp19 - _tmp124 * _tmp30);
  const Scalar _tmp128 = -_tmp111 * _tmp94 * (_tmp102 * _tmp106 + _tmp104 * _tmp105) -
                         ...
                         _tmp127 * _tmp94 * (-_tmp126 * _tmp49 * _tmp86 + _tmp126 * _tmp82);
  const Scalar _tmp129 = Scalar(1.0) / (_tmp128);
  const Scalar _tmp130 = fh1 * (_tmp33 + _tmp37);
  const Scalar _tmp131 = Scalar(2.3544) * _tmp12 + _tmp124 * _tmp130 + _tmp19 * fv1;
  const Scalar _tmp132 = _tmp71 + _tmp75;
  const Scalar _tmp133 = _tmp132 * _tmp89;
  const Scalar _tmp134 = Scalar(1.0) / (-_tmp133 + _tmp67 - _tmp78);
  ...
  const Scalar _tmp138 = _tmp100 * _tmp135;
  const Scalar _tmp139 = -_tmp126 * _tmp88 + _tmp132 * _tmp138;
  const Scalar _tmp140 = _tmp88 * _tmp91;
  const Scalar _tmp141 = _tmp132 * _tmp134;
  const Scalar _tmp142 = _tmp119 + _tmp121 * _tmp141 - _tmp122 * _tmp140;
  const Scalar _tmp143 = -_tmp110 * _tmp130 - Scalar(2.3544) * _tmp24 - _tmp30 * fv1;
  const Scalar _tmp144 = _tmp72 * (_tmp133 * _tmp135 + Scalar(1.0));
  const Scalar _tmp145 = _tmp135 * _tmp89;
  const Scalar _tmp146 = -Scalar(1.0) * _tmp144 + Scalar(1.0) * _tmp145;
  const Scalar _tmp147 = _tmp101 * _tmp141 - _tmp102 * _tmp140 - _tmp66 * _tmp69;
  const Scalar _tmp148 = _tmp113 * _tmp134;
  const Scalar _tmp149 = _tmp72 * (-_tmp114 * _tmp140 - _tmp132 * _tmp148 + _tmp71);
  const Scalar _tmp150 = -Scalar(1.0) * _tmp113 * _tmp135 - Scalar(1.0) * _tmp149 + Scalar(1.0);
  const Scalar _tmp151 =
      Scalar(1.0) * _tmp111 * (_tmp101 * _tmp135 - _tmp147 * _tmp73) + _tmp112 * _tmp150 +
      Scalar(1.0) * _tmp125 * (_tmp121 * _tmp135 - _tmp142 * _tmp73) +
      Scalar(1.0) * _tmp127 * (_tmp138 - _tmp139 * _tmp73) + _tmp131 * _tmp137 + _tmp143 * _tmp146;
  ...
  const Scalar _tmp161 = _tmp25 + _tmp39 + _tmp55;
  const Scalar _tmp162 =
      (_tmp129 * (_tmp137 * _tmp19 + _tmp146 * _tmp161 - _tmp150) - _tmp151 * _tmp160) /
      std::sqrt(Scalar(std::pow(_tmp151, Scalar(2)) * _tmp159 + 1));
  const Scalar _tmp163 = _tmp116 * _tmp65;
  const Scalar _tmp164 = _tmp126 * _tmp127;
  const Scalar _tmp165 = _tmp104 * _tmp111 * _tmp65 - _tmp112 * _tmp163 +
                         _tmp123 * _tmp125 * _tmp65 - _tmp164 * _tmp86;
  const Scalar _tmp166 = Scalar(1.0) / (_tmp165);
  const Scalar _tmp167 = _tmp131 * _tmp135;
  const Scalar _tmp168 = _tmp111 * _tmp147 * _tmp72 + _tmp112 * _tmp149 +
                         _tmp125 * _tmp142 * _tmp72 + _tmp127 * _tmp139 * _tmp72 -
                         _tmp136 * _tmp167 + _tmp143 * _tmp144;
  ...
  const Scalar _tmp179 =
      (_tmp166 * (-_tmp136 * _tmp178 + _tmp144 * _tmp161 - _tmp149) - _tmp168 * _tmp177) /
      std::sqrt(Scalar(std::pow(_tmp168, Scalar(2)) * _tmp176 + 1));
  const Scalar _tmp180 = -_tmp101 * _tmp111 * _tmp134 + _tmp112 * _tmp148 -
                         _tmp121 * _tmp125 * _tmp134 - _tmp127 * _tmp138 - _tmp143 * _tmp145 +
                         _tmp167;
  const Scalar _tmp181 =
      _tmp102 * _tmp111 * _tmp91 + _tmp112 * _tmp115 + _tmp122 * _tmp125 * _tmp91 + _tmp164;
  ...
  const Scalar _tmp188 = (_tmp180 * _tmp187 + _tmp182 * (-_tmp145 * _tmp161 - _tmp148 + _tmp178)) /
                         std::sqrt(Scalar(std::pow(_tmp180, Scalar(2)) * _tmp186 + 1));
  const Scalar _tmp189 = Scalar(9.6622558468725703) * _tmp115;
      ...
      -_tmp153 * (-Scalar(4.967784) * _tmp160 + Scalar(1.0) * _tmp162 * std::sinh(_tmp157) -
                  (-Scalar(0.1034955) * _tmp154 * _tmp160 +
                   _tmp155 * (-_tmp152 * _tmp158 - _tmp153 * _tmp162)) *
                      std::sinh(_tmp156)) -
      _tmp158 * (Scalar(4.967784) * _tmp129 - std::cosh(_tmp156) + std::cosh(_tmp157));
  _res(2, 0) =
      -_tmp171 * (-Scalar(4.967784) * _tmp177 + Scalar(1.0) * _tmp179 * std::sinh(_tmp170) -
                  (-Scalar(0.1034955) * _tmp172 * _tmp177 +
                   _tmp173 * (-_tmp169 * _tmp175 - _tmp171 * _tmp179)) *
                      std::sinh(_tmp174)) -
      _tmp175 * (Scalar(4.967784) * _tmp166 + std::cosh(_tmp170) - std::cosh(_tmp174));
  _res(3, 0) = -_tmp184 * (Scalar(4.967784) * _tmp187 + Scalar(1.0) * _tmp188 * std::sinh(_tmp192) -
                           (Scalar(0.1034955) * _tmp185 * _tmp187 +
                            _tmp190 * (_tmp183 * _tmp189 - _tmp184 * _tmp188)) *
                               std::sinh(_tmp191)) +
               _tmp189 * (Scalar(4.967784) * _tmp182 - std::cosh(_tmp191) + std::cosh(_tmp192));
