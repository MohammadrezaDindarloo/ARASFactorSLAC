...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl0(
  ...
  const Scalar _tmp61 = _tmp34 + _tmp40;
  ...
  const Scalar _tmp67 = Scalar(1.0) * _tmp48;
  const Scalar _tmp68 = -_tmp67;
  const Scalar _tmp69 = Scalar(1.0) / (_tmp53 + _tmp68);
  const Scalar _tmp70 = Scalar(1.0) * _tmp43;
  const Scalar _tmp71 = _tmp69 * (-_tmp56 + _tmp70);
  const Scalar _tmp72 = _tmp41 * _tmp60 - _tmp60 * _tmp61;
  const Scalar _tmp73 = -_tmp41 + _tmp65 * _tmp72 - _tmp66 * _tmp71;
  const Scalar _tmp74 = _tmp34 + _tmp38;
  const Scalar _tmp75 = _tmp20 + _tmp28;
  ...
  const Scalar _tmp84 = _tmp51 * _tmp82 - _tmp83;
  const Scalar _tmp85 = _tmp64 * _tmp84;
  const Scalar _tmp86 = -_tmp52 * _tmp82 - _tmp63 * _tmp85 + _tmp74 * _tmp83;
  const Scalar _tmp87 = _tmp41 * _tmp82 - _tmp71 * _tmp86 - _tmp72 * _tmp85 - _tmp74 * _tmp82;
  ...
  const Scalar _tmp93 = _tmp53 * _tmp60 - _tmp56 * _tmp62 + _tmp60 * _tmp92;
  ...
  const Scalar _tmp103 = _tmp60 * _tmp64;
  ...
  const Scalar _tmp110 = _tmp60 * _tmp85;
  ...
  const Scalar _tmp115 = -_tmp113 * _tmp72 + _tmp114 * _tmp71;
  ...
  const Scalar _tmp123 = -_tmp108 * _tmp91 * (_tmp100 * _tmp99 + _tmp102 * _tmp103 + Scalar(1.0)) -
                         ...
                         _tmp120 * _tmp91 * (-_tmp110 * _tmp122 + _tmp122 * _tmp82);
  const Scalar _tmp124 = Scalar(1.0) / (_tmp123);
  const Scalar _tmp125 = _tmp68 + _tmp78;
  const Scalar _tmp126 = _tmp125 * _tmp71;
  const Scalar _tmp127 = Scalar(1.0) / (-_tmp126 + _tmp70 - _tmp75);
  ...
  const Scalar _tmp131 = _tmp128 * _tmp71;
  const Scalar _tmp132 = _tmp39 * fh1;
  const Scalar _tmp133 = -_tmp111 * _tmp132 - Scalar(2.3544) * _tmp15 - _tmp18 * fv1;
  const Scalar _tmp134 = _tmp107 * _tmp132 + Scalar(2.3544) * _tmp26 + _tmp29 * fv1;
  const Scalar _tmp135 = _tmp125 * _tmp69;
  const Scalar _tmp136 = _tmp128 * _tmp97;
  const Scalar _tmp137 = -_tmp109 * _tmp86 + _tmp125 * _tmp136;
  ...
  const Scalar _tmp141 = _tmp138 * _tmp98 - _tmp139 * _tmp99 + _tmp66;
  const Scalar _tmp142 = _tmp121 * _tmp127;
  const Scalar _tmp143 = -_tmp122 * _tmp86 - _tmp125 * _tmp142 + _tmp68;
  const Scalar _tmp144 = std::asinh(
      _tmp124 * (Scalar(1.0) * _tmp108 * (_tmp128 * _tmp98 - _tmp130 * _tmp141) +
                 Scalar(1.0) * _tmp112 * (-_tmp130 * _tmp137 + _tmp136) +
                 Scalar(1.0) * _tmp119 * (_tmp116 * _tmp128 - _tmp130 * _tmp140) +
                 Scalar(1.0) * _tmp120 * (-_tmp121 * _tmp128 - _tmp130 * _tmp143 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp133 * (-_tmp129 * _tmp130 + _tmp131) +
  ...
  const Scalar _tmp147 =
      Scalar(12100.0) * std::pow(Scalar(1 - Scalar(0.0090909090909090905) * _tmp54), Scalar(2)) +
      Scalar(15625.0) * std::pow(Scalar(1 - Scalar(0.0080000000000000002) * _tmp57), Scalar(2));
  const Scalar _tmp148 = _tmp109 * _tmp112;
  const Scalar _tmp149 = _tmp120 * _tmp122;
  const Scalar _tmp150 =
      _tmp102 * _tmp108 * _tmp64 + _tmp118 * _tmp119 * _tmp64 - _tmp148 * _tmp85 - _tmp149 * _tmp85;
  const Scalar _tmp151 = Scalar(1.0) / (_tmp150);
  const Scalar _tmp152 = _tmp128 * _tmp134;
  const Scalar _tmp153 =
      std::asinh(_tmp151 * (_tmp108 * _tmp141 * _tmp69 + _tmp112 * _tmp137 * _tmp69 +
                            _tmp119 * _tmp140 * _tmp69 + _tmp120 * _tmp143 * _tmp69 +
                            _tmp129 * _tmp133 * _tmp69 - _tmp135 * _tmp152));
  const Scalar _tmp154 = Scalar(9.6622558468725703) * _tmp150;
  const Scalar _tmp155 = _tmp108 * _tmp88 * _tmp99 + _tmp117 * _tmp119 * _tmp88 + _tmp148 + _tmp149;
  ...
  const Scalar _tmp158 = std::asinh(_tmp156 * (-_tmp108 * _tmp127 * _tmp98 - _tmp112 * _tmp136 -
                                               _tmp116 * _tmp119 * _tmp127 + _tmp120 * _tmp142 -
  ...
  _res(1, 0) =
      _tmp145 *
          (-std::sinh(Scalar(1.0) * _tmp144) -
           std::sinh(Scalar(0.1034955) * _tmp124 * (-_tmp144 * _tmp145 - std::sqrt(_tmp146)))) -
      Scalar(48.0) * std::sqrt(Scalar(
  ...
  _res(2, 0) =
      ...
      Scalar(48.0) * std::sqrt(Scalar(
                         ...
                         std::pow(Scalar(-Scalar(0.020833333333333332) * _tmp61 -
                                         Scalar(0.020833333333333332) * position_vector(2, 0) + 1),
                                  Scalar(2))));
  _res(3, 0) =
      _tmp159 *
