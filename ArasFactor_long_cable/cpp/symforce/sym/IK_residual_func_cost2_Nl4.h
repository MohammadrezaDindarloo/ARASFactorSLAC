...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl4(
  ...
  const Scalar _tmp67 = _tmp46 + Scalar(-110.0);
  const Scalar _tmp68 = _tmp44 + Scalar(125.0);
  const Scalar _tmp69 =
  ...
  const Scalar _tmp73 = _tmp72 * (_tmp43 * _tmp67 * _tmp70 - _tmp45 * _tmp68 * _tmp70);
  ...
  const Scalar _tmp80 = _tmp49 * _tmp57 - _tmp53 * _tmp58 + _tmp57 * _tmp73 - _tmp75 * _tmp79;
  ...
  const Scalar _tmp85 = _tmp31 + Scalar(125.0);
  ...
  const Scalar _tmp89 = fh1 * (-_tmp19 * _tmp88 + _tmp30 * _tmp87);
  const Scalar _tmp90 = Scalar(19.620000000000001) - fv1;
  const Scalar _tmp91 = _tmp35 + _tmp41;
  const Scalar _tmp92 = _tmp42 * _tmp57;
  const Scalar _tmp93 = _tmp35 + _tmp39;
  const Scalar _tmp94 = _tmp42 * _tmp66;
  const Scalar _tmp95 = _tmp74 * _tmp93 - _tmp76 * _tmp94;
  const Scalar _tmp96 = _tmp58 * _tmp91 - _tmp76 * _tmp92 - _tmp79 * _tmp95;
  ...
  const Scalar _tmp104 = -_tmp102 * _tmp96 - _tmp103 * _tmp79 - _tmp57 * _tmp91 + _tmp92;
  ...
  const Scalar _tmp110 = _tmp101 * _tmp109 * _tmp77 * _tmp95 - _tmp103 * _tmp108;
  const Scalar _tmp111 = _tmp105 * _tmp80;
  const Scalar _tmp112 = _tmp104 * _tmp81;
  const Scalar _tmp113 = _tmp112 * (-_tmp108 * _tmp75 - _tmp110 * _tmp111);
  const Scalar _tmp114 = _tmp110 + _tmp113;
  const Scalar _tmp115 = _tmp105 * _tmp78;
  const Scalar _tmp116 = -_tmp114 * _tmp115 + Scalar(1.0);
  const Scalar _tmp117 = _tmp66 * _tmp77;
  const Scalar _tmp118 = _tmp105 * _tmp57;
  const Scalar _tmp119 = _tmp87 * fh1;
  const Scalar _tmp120 = _tmp76 * _tmp77;
  const Scalar _tmp121 = _tmp120 * _tmp95 + _tmp42 * _tmp76;
  const Scalar _tmp122 = -_tmp102 * _tmp121 + _tmp103 * _tmp120 - _tmp42;
  const Scalar _tmp123 = _tmp112 * (-_tmp111 * _tmp122 + _tmp120 * _tmp75 - _tmp73);
  const Scalar _tmp124 = _tmp122 + _tmp123;
  const Scalar _tmp125 = -_tmp115 * _tmp124 - _tmp76;
  const Scalar _tmp126 = _tmp88 * fh1;
  const Scalar _tmp127 = -_tmp119 * _tmp72 * (_tmp114 * _tmp118 + _tmp116 * _tmp117) -
                         _tmp126 * _tmp72 * (_tmp117 * _tmp125 + _tmp118 * _tmp124 + Scalar(1.0)) -
                         _tmp72 * _tmp89 * (_tmp57 * _tmp82 - _tmp82 * _tmp83) -
                         _tmp72 * _tmp90 * (_tmp107 * _tmp57 - _tmp107 * _tmp83);
  const Scalar _tmp128 = Scalar(1.0) / (_tmp127);
  const Scalar _tmp129 = _tmp40 * fh1;
  const Scalar _tmp130 = _tmp129 * _tmp88 + Scalar(2.3544) * _tmp27 + _tmp30 * fv1;
  const Scalar _tmp131 = _tmp49 + _tmp98;
  const Scalar _tmp132 = _tmp102 * _tmp131;
  const Scalar _tmp133 = Scalar(1.0) / (_tmp100 - _tmp132 - _tmp53);
  const Scalar _tmp134 = Scalar(1.0) * _tmp133;
  const Scalar _tmp135 = _tmp131 * _tmp99;
  const Scalar _tmp136 = _tmp105 * _tmp96;
  const Scalar _tmp137 = _tmp131 * _tmp133;
  const Scalar _tmp138 = _tmp121 + _tmp123 * _tmp137 - _tmp124 * _tmp136;
  const Scalar _tmp139 = -_tmp108 * _tmp95 + _tmp113 * _tmp137 - _tmp114 * _tmp136;
  const Scalar _tmp140 = -_tmp129 * _tmp87 - Scalar(2.3544) * _tmp16 - _tmp19 * fv1;
  const Scalar _tmp141 = _tmp132 * _tmp134 + Scalar(1.0);
  const Scalar _tmp142 = _tmp102 * _tmp134;
  const Scalar _tmp143 = _tmp112 * _tmp134;
  const Scalar _tmp144 = _tmp131 * _tmp143 - _tmp82 * _tmp96;
  const Scalar _tmp145 = _tmp106 * _tmp133;
  const Scalar _tmp146 = -_tmp107 * _tmp96 - _tmp131 * _tmp145 + _tmp98;
  const Scalar _tmp147 = std::asinh(
      _tmp128 * (Scalar(1.0) * _tmp119 * (-_tmp109 * _tmp139 + _tmp113 * _tmp134) +
                 Scalar(1.0) * _tmp126 * (-_tmp109 * _tmp138 + _tmp123 * _tmp134) +
                 Scalar(1.0) * _tmp130 * (_tmp134 * _tmp135 - _tmp134) +
                 Scalar(1.0) * _tmp140 * (-_tmp109 * _tmp141 + _tmp142) +
                 Scalar(1.0) * _tmp89 * (-_tmp109 * _tmp144 + _tmp143) +
                 Scalar(1.0) * _tmp90 * (-_tmp106 * _tmp134 - _tmp109 * _tmp146 + Scalar(1.0))));
  const Scalar _tmp148 = Scalar(9.6622558468725703) * _tmp127;
  const Scalar _tmp149 = _tmp130 * _tmp134;
  const Scalar _tmp150 = _tmp107 * _tmp90;
  const Scalar _tmp151 = _tmp82 * _tmp89;
  const Scalar _tmp152 =
      _tmp116 * _tmp119 * _tmp77 + _tmp125 * _tmp126 * _tmp77 - _tmp150 * _tmp79 - _tmp151 * _tmp79;
  const Scalar _tmp153 = Scalar(1.0) / (_tmp152);
  const Scalar _tmp154 =
      std::asinh(_tmp153 * (_tmp119 * _tmp139 * _tmp99 + _tmp126 * _tmp138 * _tmp99 -
                            _tmp135 * _tmp149 + _tmp140 * _tmp141 * _tmp99 +
                            _tmp144 * _tmp89 * _tmp99 + _tmp146 * _tmp90 * _tmp99));
  const Scalar _tmp155 = Scalar(9.6622558468725703) * _tmp152;
  const Scalar _tmp156 =
      Scalar(15625.0) * std::pow(Scalar(1 - Scalar(0.0080000000000000002) * _tmp63), Scalar(2)) +
      Scalar(12100.0) * std::pow(Scalar(-Scalar(0.0090909090909090905) * _tmp60 - 1), Scalar(2));
  const Scalar _tmp157 =
      _tmp105 * _tmp114 * _tmp119 + _tmp105 * _tmp124 * _tmp126 + _tmp150 + _tmp151;
  const Scalar _tmp158 = Scalar(1.0) / (_tmp157);
  const Scalar _tmp159 =
      std::asinh(_tmp158 * (-_tmp113 * _tmp119 * _tmp133 - _tmp123 * _tmp126 * _tmp133 -
                            _tmp140 * _tmp142 - _tmp143 * _tmp89 + _tmp145 * _tmp90 + _tmp149));
