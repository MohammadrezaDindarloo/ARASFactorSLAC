...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl7(
  ...
  const Scalar _tmp61 = _tmp42 + Scalar(110.0);
  ...
  const Scalar _tmp75 = -_tmp65 * _tmp71 + _tmp73 * _tmp74;
  const Scalar _tmp76 = Scalar(1.0) / (_tmp64 * _tmp71 - _tmp74);
  const Scalar _tmp77 = Scalar(1.0) * _tmp76;
  const Scalar _tmp78 = _tmp75 * _tmp77;
  const Scalar _tmp79 = _tmp39 * _tmp71 - _tmp71 * _tmp73;
  const Scalar _tmp80 = _tmp56 * _tmp78 - _tmp77 * _tmp79;
  const Scalar _tmp81 = _tmp49 + position_vector(1, 0);
  ...
  const Scalar _tmp87 = _tmp33 + _tmp72;
  const Scalar _tmp88 = _tmp82 * _tmp85;
  const Scalar _tmp89 = _tmp64 * _tmp86 - _tmp88;
  const Scalar _tmp90 = _tmp76 * _tmp89;
  const Scalar _tmp91 = -_tmp65 * _tmp86 - _tmp75 * _tmp90 + _tmp87 * _tmp88;
  const Scalar _tmp92 = _tmp39 * _tmp86 - _tmp56 * _tmp91 - _tmp79 * _tmp90 - _tmp86 * _tmp87;
  ...
  const Scalar _tmp97 = _tmp96 * (-_tmp41 * _tmp62 * _tmp95 + _tmp44 * _tmp61 * _tmp95);
  const Scalar _tmp98 = _tmp51 * _tmp71 - _tmp54 * _tmp74 + _tmp71 * _tmp97;
  const Scalar _tmp99 = _tmp49 * _tmp86 - _tmp58 * _tmp88 + _tmp86 * _tmp97 - _tmp90 * _tmp98;
  const Scalar _tmp100 = _tmp93 * _tmp99;
  const Scalar _tmp101 = Scalar(1.0) / (_tmp99);
  const Scalar _tmp102 = _tmp101 * _tmp92;
  const Scalar _tmp103 = _tmp102 * (-_tmp100 * _tmp80 - _tmp77 * _tmp98);
  const Scalar _tmp104 = _tmp50 * _tmp59;
  const Scalar _tmp105 = _tmp103 + _tmp80;
  const Scalar _tmp106 = _tmp91 * _tmp93;
  const Scalar _tmp107 = _tmp103 * _tmp104 - _tmp105 * _tmp106 - _tmp78;
  ...
  const Scalar _tmp114 = _tmp47 * _tmp56 + _tmp55;
  const Scalar _tmp115 = _tmp114 * _tmp59;
  const Scalar _tmp116 = 0;
  const Scalar _tmp117 = -_tmp106 * _tmp116 - _tmp115 * _tmp50 + _tmp48;
  ...
  const Scalar _tmp122 = _tmp120 * _tmp121 + Scalar(2.3544) * _tmp24 + _tmp28 * fv1;
  const Scalar _tmp123 = -_tmp112 * _tmp121 - Scalar(2.3544) * _tmp12 - _tmp18 * fv1;
  const Scalar _tmp124 = _tmp57 * _tmp60 + Scalar(1.0);
  const Scalar _tmp125 = _tmp56 * _tmp60;
  const Scalar _tmp126 = Scalar(1.0) * _tmp101;
  const Scalar _tmp127 = _tmp102 * _tmp60;
  const Scalar _tmp128 = -_tmp126 * _tmp91 + _tmp127 * _tmp50;
  const Scalar _tmp129 = fh1 * (_tmp112 * _tmp28 - _tmp120 * _tmp18);
  const Scalar _tmp130 = _tmp64 * _tmp76;
  const Scalar _tmp131 = _tmp130 * _tmp75 + _tmp65;
  const Scalar _tmp132 = _tmp130 * _tmp79 - _tmp131 * _tmp56 - _tmp39;
  const Scalar _tmp133 = _tmp102 * (-_tmp100 * _tmp132 + _tmp130 * _tmp98 - _tmp97);
  const Scalar _tmp134 = _tmp132 + _tmp133;
  const Scalar _tmp135 = _tmp104 * _tmp133 - _tmp106 * _tmp134 + _tmp131;
  const Scalar _tmp136 = _tmp120 * fh1;
  const Scalar _tmp137 = _tmp86 * _tmp93;
  const Scalar _tmp138 = _tmp89 * _tmp93;
  const Scalar _tmp139 = -_tmp105 * _tmp138 + Scalar(1.0);
  const Scalar _tmp140 = _tmp71 * _tmp76;
  const Scalar _tmp141 = _tmp71 * _tmp90;
  const Scalar _tmp142 = _tmp116 * _tmp93;
  const Scalar _tmp143 = -_tmp134 * _tmp138 - _tmp64;
  const Scalar _tmp144 = -_tmp113 * _tmp96 * (_tmp105 * _tmp137 + _tmp139 * _tmp140) -
                         _tmp118 * _tmp96 * (-_tmp141 * _tmp142 + _tmp142 * _tmp86) -
                         _tmp129 * _tmp96 * (-_tmp126 * _tmp141 + _tmp126 * _tmp86) -
                         _tmp136 * _tmp96 * (_tmp134 * _tmp137 + _tmp140 * _tmp143 + Scalar(1.0));
  const Scalar _tmp145 = Scalar(1.0) / (_tmp144);
  const Scalar _tmp146 = std::asinh(
      _tmp145 * (Scalar(1.0) * _tmp113 * (_tmp103 * _tmp60 - _tmp107 * _tmp108) +
                 Scalar(1.0) * _tmp118 * (-_tmp108 * _tmp117 - _tmp114 * _tmp60 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp122 * (_tmp119 * _tmp60 - _tmp60) +
                 Scalar(1.0) * _tmp123 * (-_tmp108 * _tmp124 + _tmp125) +
                 Scalar(1.0) * _tmp129 * (-_tmp108 * _tmp128 + _tmp127) +
                 Scalar(1.0) * _tmp136 * (-_tmp108 * _tmp135 + _tmp133 * _tmp60)));
  const Scalar _tmp147 = Scalar(9.6622558468725703) * _tmp144;
  const Scalar _tmp148 = _tmp118 * _tmp142;
  const Scalar _tmp149 = _tmp126 * _tmp129;
  const Scalar _tmp150 =
      _tmp113 * _tmp139 * _tmp76 + _tmp136 * _tmp143 * _tmp76 - _tmp148 * _tmp90 - _tmp149 * _tmp90;
  const Scalar _tmp151 = Scalar(1.0) / (_tmp150);
  const Scalar _tmp152 = _tmp122 * _tmp60;
  const Scalar _tmp153 =
      std::asinh(_tmp151 * (_tmp107 * _tmp113 * _tmp52 + _tmp117 * _tmp118 * _tmp52 -
                            _tmp119 * _tmp152 + _tmp123 * _tmp124 * _tmp52 +
                            _tmp128 * _tmp129 * _tmp52 + _tmp135 * _tmp136 * _tmp52));
  ...
  const Scalar _tmp156 =
      _tmp105 * _tmp113 * _tmp93 + _tmp134 * _tmp136 * _tmp93 + _tmp148 + _tmp149;
  const Scalar _tmp157 = Scalar(1.0) / (_tmp156);
  const Scalar _tmp158 =
      std::asinh(_tmp157 * (-_tmp103 * _tmp113 * _tmp59 + _tmp115 * _tmp118 - _tmp123 * _tmp125 -
                            _tmp127 * _tmp129 - _tmp133 * _tmp136 * _tmp59 + _tmp152));
  const Scalar _tmp159 =
      Scalar(12100.0) * std::pow(Scalar(1 - Scalar(0.0090909090909090905) * _tmp81), Scalar(2)) +
