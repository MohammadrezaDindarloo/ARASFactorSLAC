...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl0(
  ...
  const Scalar _tmp105 = _tmp103 * _tmp83;
  ...
  _res(1, 0) = std::exp(_tmp100 * _tmp74 * (_tmp82 * _tmp98 + _tmp85 * _tmp99) +
                        _tmp101 * _tmp74 * (_tmp104 * _tmp65 - _tmp105 * _tmp85) +
                        _tmp74 * _tmp92 * (_tmp81 * _tmp82 + _tmp84 * _tmp85 + Scalar(1.0)) +
                        _tmp74 * _tmp95 * (-_tmp43 * _tmp69 * _tmp93 + _tmp65 * _tmp93));
  _res(2, 0) = std::exp(-_tmp100 * _tmp49 * _tmp99 + _tmp101 * _tmp105 * _tmp49 + _tmp106 * _tmp69 -
                        _tmp49 * _tmp84 * _tmp92);
  _res(3, 0) =
      std::exp(-_tmp100 * _tmp71 * _tmp98 - _tmp101 * _tmp104 - _tmp106 - _tmp71 * _tmp81 * _tmp92);
