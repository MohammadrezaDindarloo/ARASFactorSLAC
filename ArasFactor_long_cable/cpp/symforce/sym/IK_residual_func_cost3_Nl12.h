...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl12(
  ...
  const Scalar _tmp63 = _tmp32 * _tmp46 - _tmp50;
  const Scalar _tmp64 = Scalar(1.0) / (_tmp46 * _tmp60 - _tmp59);
  ...
  const Scalar _tmp69 = -_tmp51 * _tmp60 + _tmp61;
  const Scalar _tmp70 = -_tmp32 * _tmp37 + _tmp49 - _tmp65 * _tmp69 -
  ...
  const Scalar _tmp78 = _tmp76 * (-_tmp39 * _tmp44 * _tmp77 + _tmp41 * _tmp43 * _tmp77);
  const Scalar _tmp79 = _tmp52 * _tmp60 - _tmp55 * _tmp59 + _tmp60 * _tmp78;
  const Scalar _tmp80 = -_tmp17 * _tmp50 + _tmp28 * _tmp32 + _tmp32 * _tmp78 - _tmp65 * _tmp79;
  const Scalar _tmp81 = Scalar(1.0) / (_tmp80);
  const Scalar _tmp82 = Scalar(1.0) * _tmp81;
  const Scalar _tmp83 = _tmp20 + _tmp27;
  const Scalar _tmp84 = _tmp29 + _tmp83;
  const Scalar _tmp85 = _tmp54 + _tmp9;
  ...
  const Scalar _tmp90 = fh1 * (-_tmp83 * _tmp88 + _tmp85 * _tmp89);
  const Scalar _tmp91 = Scalar(1.0) * _tmp64;
  const Scalar _tmp92 = _tmp62 * _tmp68 * _tmp91 - _tmp69 * _tmp91;
  const Scalar _tmp93 = _tmp71 * _tmp80;
  const Scalar _tmp94 = _tmp70 * _tmp81;
  const Scalar _tmp95 = _tmp92 + _tmp94 * (-_tmp79 * _tmp91 - _tmp92 * _tmp93);
  const Scalar _tmp96 = _tmp63 * _tmp71;
  const Scalar _tmp97 = -_tmp95 * _tmp96 + Scalar(1.0);
  const Scalar _tmp98 = _tmp60 * _tmp64;
  const Scalar _tmp99 = _tmp32 * _tmp71;
  const Scalar _tmp100 = _tmp89 * fh1;
  const Scalar _tmp101 = _tmp46 * _tmp64;
  const Scalar _tmp102 = _tmp101 * _tmp69 - _tmp48 - _tmp68 * (_tmp101 * _tmp62 + _tmp46 * _tmp48);
  const Scalar _tmp103 = _tmp102 + _tmp94 * (_tmp101 * _tmp79 - _tmp102 * _tmp93 - _tmp78);
  const Scalar _tmp104 = -_tmp103 * _tmp96 - _tmp46;
  const Scalar _tmp105 = _tmp88 * fh1;
  const Scalar _tmp106 = _tmp0 * _tmp73;
  ...
  _res(1, 0) = std::exp(_tmp0 * _tmp76 * (_tmp32 * _tmp73 - _tmp73 * _tmp74) +
                        _tmp100 * _tmp76 * (_tmp95 * _tmp99 + _tmp97 * _tmp98) +
                        _tmp105 * _tmp76 * (_tmp103 * _tmp99 + _tmp104 * _tmp98 + Scalar(1.0)) +
                        _tmp76 * _tmp90 * (_tmp32 * _tmp82 - _tmp74 * _tmp82));
  _res(2, 0) = std::exp(-_tmp100 * _tmp64 * _tmp97 - _tmp104 * _tmp105 * _tmp64 + _tmp106 * _tmp65 +
                        _tmp107 * _tmp65);
  _res(3, 0) =
      std::exp(-_tmp100 * _tmp71 * _tmp95 - _tmp103 * _tmp105 * _tmp71 - _tmp106 - _tmp107);
