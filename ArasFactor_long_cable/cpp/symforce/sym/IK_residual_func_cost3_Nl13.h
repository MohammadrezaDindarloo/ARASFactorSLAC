...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl13(
  ...
  const Scalar _tmp28 = _tmp24 - _tmp25;
  const Scalar _tmp29 = _tmp21 + _tmp28;
  const Scalar _tmp30 = Scalar(1.0) * _tmp29;
  const Scalar _tmp31 = (-_tmp27 + _tmp30) / (-_tmp17 + _tmp18);
  ...
  const Scalar _tmp45 = Scalar(0.20999999999999999) * _tmp10 + Scalar(0.20999999999999999) * _tmp8;
  ...
  const Scalar _tmp53 = _tmp44 * (_tmp37 * _tmp52 - _tmp42 * _tmp51);
  const Scalar _tmp54 = _tmp44 * (-_tmp43 * _tmp52 + _tmp51);
  const Scalar _tmp55 = Scalar(1.0) * _tmp31 * _tmp53 - Scalar(1.0) * _tmp54;
  const Scalar _tmp56 = _tmp46 + _tmp47 + _tmp48;
  ...
  const Scalar _tmp68 = -_tmp31 * (-_tmp42 * _tmp67 - _tmp53 * _tmp66 + _tmp56 * _tmp64) -
                        _tmp54 * _tmp66 - _tmp56 * _tmp65 + _tmp67;
  const Scalar _tmp69 = Scalar(1.0) / (_tmp68);
  const Scalar _tmp70 =
      std::sqrt(Scalar(std::pow(_tmp39, Scalar(2)) + std::pow(_tmp40, Scalar(2))));
  const Scalar _tmp71 = Scalar(1.0) / (_tmp70);
  const Scalar _tmp72 = _tmp41 * _tmp70;
  const Scalar _tmp73 = _tmp72 * (-_tmp16 * _tmp40 * _tmp71 + _tmp29 * _tmp39 * _tmp71);
  const Scalar _tmp74 = _tmp44 * (_tmp18 * _tmp43 - _tmp27 * _tmp37 + _tmp43 * _tmp73);
  const Scalar _tmp75 = _tmp58 * _tmp65 - _tmp60 * _tmp64 + _tmp65 * _tmp73 - _tmp66 * _tmp74;
  const Scalar _tmp76 = _tmp69 * _tmp75;
  const Scalar _tmp77 = Scalar(1.0) / (_tmp75);
  const Scalar _tmp78 = _tmp68 * _tmp77;
  const Scalar _tmp79 = _tmp55 + _tmp78 * (-_tmp55 * _tmp76 - Scalar(1.0) * _tmp74);
  ...
  const Scalar _tmp84 = _tmp4 + _tmp57;
  ...
  const Scalar _tmp91 = -_tmp31 * (_tmp42 * _tmp50 + _tmp42 * _tmp53) + _tmp42 * _tmp54 - _tmp50;
  const Scalar _tmp92 = _tmp78 * (_tmp42 * _tmp74 - _tmp73 - _tmp76 * _tmp91) + _tmp91;
  const Scalar _tmp93 = -_tmp42 - _tmp81 * _tmp92;
  const Scalar _tmp94 = _tmp87 * _tmp88;
  const Scalar _tmp95 = Scalar(19.620000000000001) - fv1;
  const Scalar _tmp96 = _tmp17 * _tmp31 + _tmp30;
  ...
  const Scalar _tmp101 = fh1 * (-_tmp84 * _tmp94 + _tmp86 * _tmp89);
  const Scalar _tmp102 = _tmp44 * fh1;
  const Scalar _tmp103 = _tmp100 * _tmp101;
  const Scalar _tmp104 = _tmp69 * fh1;

  // Output terms (1)
  Eigen::Matrix<Scalar, 4, 1> _res;

  _res(0, 0) = std::exp(-fh1);
  _res(1, 0) = std::exp(_tmp101 * _tmp72 * (_tmp100 * _tmp65 - _tmp100 * _tmp66 * _tmp83) +
                        _tmp72 * _tmp95 * (_tmp65 * _tmp99 - _tmp83 * _tmp98) +
                        _tmp89 * _tmp90 * (_tmp79 * _tmp80 + _tmp82 * _tmp83) +
                        _tmp90 * _tmp94 * (_tmp80 * _tmp92 + _tmp83 * _tmp93 + Scalar(1.0)));
  _res(2, 0) = std::exp(-_tmp102 * _tmp82 * _tmp89 - _tmp102 * _tmp93 * _tmp94 +
                        _tmp103 * _tmp44 * _tmp66 + _tmp44 * _tmp95 * _tmp98);
  _res(3, 0) =
      std::exp(-_tmp103 - _tmp104 * _tmp79 * _tmp89 - _tmp104 * _tmp92 * _tmp94 - _tmp95 * _tmp99);
