...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl14(
  ...
  const Scalar _tmp52 = position_vector(0, 0) + Scalar(-125.0);
  ...
  const Scalar _tmp61 = _tmp30 * _tmp31;
  const Scalar _tmp62 = _tmp32 * _tmp58 - _tmp61;
  const Scalar _tmp63 = _tmp60 * _tmp62;
  const Scalar _tmp64 = _tmp39 * _tmp58;
  const Scalar _tmp65 = -_tmp48 * _tmp64 + _tmp49 * _tmp59;
  ...
  const Scalar _tmp69 = -_tmp32 * _tmp37 + _tmp32 * _tmp39 - _tmp50 * _tmp63 -
                        _tmp68 * (-_tmp32 * _tmp64 + _tmp37 * _tmp61 - _tmp63 * _tmp65);
  const Scalar _tmp70 = Scalar(1.0) / (_tmp69);
  const Scalar _tmp71 = _tmp66 * _tmp68 + _tmp67;
  const Scalar _tmp72 = 0;
  const Scalar _tmp73 = _tmp48 * _tmp63;
  const Scalar _tmp74 =
  ...
  const Scalar _tmp77 = _tmp75 * (_tmp51 * _tmp57 * _tmp76 - _tmp53 * _tmp56 * _tmp76);
  const Scalar _tmp78 = _tmp41 * _tmp48 - _tmp45 * _tmp59 + _tmp48 * _tmp77;
  const Scalar _tmp79 = Scalar(1.0) * _tmp60;
  const Scalar _tmp80 = -_tmp50 * _tmp79 + _tmp65 * _tmp68 * _tmp79;
  const Scalar _tmp81 = -_tmp18 * _tmp61 + _tmp28 * _tmp32 + _tmp32 * _tmp77 - _tmp63 * _tmp78;
  const Scalar _tmp82 = _tmp70 * _tmp81;
  const Scalar _tmp83 = Scalar(1.0) / (_tmp81);
  const Scalar _tmp84 = _tmp69 * _tmp83;
  const Scalar _tmp85 = _tmp80 + _tmp84 * (-_tmp78 * _tmp79 - _tmp80 * _tmp82);
  const Scalar _tmp86 = _tmp62 * _tmp70;
  const Scalar _tmp87 = -_tmp85 * _tmp86 + Scalar(1.0);
  const Scalar _tmp88 = _tmp48 * _tmp60;
  const Scalar _tmp89 = _tmp32 * _tmp70;
  const Scalar _tmp90 = _tmp22 + _tmp55;
  ...
  const Scalar _tmp101 = _tmp100 * _tmp50 - _tmp39 - _tmp68 * (_tmp100 * _tmp65 + _tmp64);
  const Scalar _tmp102 = _tmp101 + _tmp84 * (_tmp100 * _tmp78 - _tmp101 * _tmp82 - _tmp77);
  const Scalar _tmp103 = -_tmp102 * _tmp86 - _tmp58;
  ...
  _res(1, 0) = std::exp(_tmp0 * _tmp75 * (_tmp32 * _tmp72 - _tmp72 * _tmp73) +
                        _tmp104 * _tmp75 * (_tmp102 * _tmp89 + _tmp103 * _tmp88 + Scalar(1.0)) +
                        _tmp75 * _tmp96 * (_tmp85 * _tmp89 + _tmp87 * _tmp88) +
                        _tmp75 * _tmp99 * (_tmp32 * _tmp97 - _tmp73 * _tmp97));
  _res(2, 0) = std::exp(-_tmp103 * _tmp104 * _tmp60 + _tmp105 * _tmp63 + _tmp106 * _tmp63 -
                        _tmp60 * _tmp87 * _tmp96);
  _res(3, 0) = std::exp(-_tmp102 * _tmp104 * _tmp70 - _tmp105 - _tmp106 - _tmp70 * _tmp85 * _tmp96);
