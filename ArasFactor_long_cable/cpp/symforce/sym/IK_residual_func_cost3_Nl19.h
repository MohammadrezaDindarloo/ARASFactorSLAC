...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl19(
  ...
  const Scalar _tmp46 = _tmp33 + _tmp34 + _tmp35;
  const Scalar _tmp47 = _tmp37 * _tmp45 - _tmp45 * _tmp46;
  ...
  const Scalar _tmp57 = _tmp40 * _tmp44;
  const Scalar _tmp58 = Scalar(1.0) / (_tmp45 * _tmp56 - _tmp57);
  const Scalar _tmp59 = _tmp20 * _tmp31;
  const Scalar _tmp60 = _tmp32 * _tmp56 - _tmp59;
  const Scalar _tmp61 = _tmp58 * _tmp60;
  const Scalar _tmp62 = _tmp33 + _tmp36;
  const Scalar _tmp63 = _tmp32 * _tmp37;
  const Scalar _tmp64 = _tmp37 * _tmp56;
  const Scalar _tmp65 = -_tmp45 * _tmp64 + _tmp46 * _tmp57;
  const Scalar _tmp66 = Scalar(1.0) * _tmp52;
  const Scalar _tmp67 = Scalar(1.0) * _tmp49;
  const Scalar _tmp68 = (-_tmp42 + _tmp66) / (_tmp38 - _tmp67);
  const Scalar _tmp69 = -_tmp32 * _tmp62 - _tmp47 * _tmp61 + _tmp63 -
                        _tmp68 * (-_tmp56 * _tmp63 + _tmp59 * _tmp62 - _tmp61 * _tmp65);
  const Scalar _tmp70 = Scalar(1.0) / (_tmp69);
  const Scalar _tmp71 = _tmp66 + _tmp67 * _tmp68;
  const Scalar _tmp72 = 0;
  const Scalar _tmp73 = _tmp45 * _tmp61;
  const Scalar _tmp74 =
  ...
  const Scalar _tmp77 = -_tmp47 * _tmp76 + _tmp65 * _tmp68 * _tmp76;
  const Scalar _tmp78 = Scalar(1.0) / (_tmp74);
  const Scalar _tmp79 = _tmp75 * (-_tmp49 * _tmp54 * _tmp78 + _tmp50 * _tmp52 * _tmp78);
  const Scalar _tmp80 = _tmp38 * _tmp45 - _tmp42 * _tmp57 + _tmp45 * _tmp79;
  const Scalar _tmp81 = _tmp18 * _tmp32 - _tmp28 * _tmp59 + _tmp32 * _tmp79 - _tmp61 * _tmp80;
  ...
  const Scalar _tmp86 = _tmp32 * _tmp70;
  const Scalar _tmp87 = _tmp60 * _tmp70;
  const Scalar _tmp88 = -_tmp85 * _tmp87 + Scalar(1.0);
  const Scalar _tmp89 = _tmp45 * _tmp58;
  const Scalar _tmp90 = _tmp41 + _tmp51;
  const Scalar _tmp91 = _tmp53 + _tmp90;
  const Scalar _tmp92 = _tmp48 + _tmp5;
  ...
  const Scalar _tmp99 = fh1 * (_tmp90 * _tmp95 - _tmp92 * _tmp98);
  const Scalar _tmp100 = _tmp56 * _tmp58;
  const Scalar _tmp101 = _tmp100 * _tmp47 - _tmp37 - _tmp68 * (_tmp100 * _tmp65 + _tmp64);
  const Scalar _tmp102 = _tmp101 + _tmp84 * (_tmp100 * _tmp80 - _tmp101 * _tmp82 - _tmp79);
  const Scalar _tmp103 = -_tmp102 * _tmp87 - _tmp56;
  const Scalar _tmp104 = _tmp0 * _tmp72;
  ...
  _res(1, 0) = std::exp(_tmp0 * _tmp75 * (_tmp32 * _tmp72 - _tmp72 * _tmp73) +
                        _tmp75 * _tmp99 * (_tmp32 * _tmp97 - _tmp73 * _tmp97) +
                        _tmp95 * _tmp96 * (_tmp85 * _tmp86 + _tmp88 * _tmp89) +
                        _tmp96 * _tmp98 * (_tmp102 * _tmp86 + _tmp103 * _tmp89 + Scalar(1.0)));
  _res(2, 0) = std::exp(-_tmp103 * _tmp105 * _tmp98 + _tmp104 * _tmp61 - _tmp105 * _tmp88 * _tmp95 +
                        _tmp106 * _tmp61);
  _res(3, 0) =
      std::exp(-_tmp102 * _tmp107 * _tmp98 - _tmp104 - _tmp106 - _tmp107 * _tmp85 * _tmp95);
