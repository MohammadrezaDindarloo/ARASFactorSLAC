...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl23(
  ...
  const Scalar _tmp54 = _tmp53 * (-_tmp32 * _tmp37 * _tmp52 + _tmp34 * _tmp36 * _tmp52);
  const Scalar _tmp55 = _tmp18 * _tmp29;
  const Scalar _tmp56 = _tmp16 * _tmp30 - _tmp26 * _tmp55 + _tmp30 * _tmp54;
  const Scalar _tmp57 = Scalar(1.0) / (_tmp30 * _tmp39 - _tmp55);
  ...
  const Scalar _tmp66 = _tmp31 + _tmp40;
  ...
  const Scalar _tmp73 = _tmp30 * _tmp57;
  const Scalar _tmp74 = Scalar(1.0) * _tmp32;
  const Scalar _tmp75 = Scalar(1.0) * _tmp36;
  const Scalar _tmp76 = (-_tmp26 + _tmp75) / (_tmp16 - _tmp74);
  ...
  const Scalar _tmp82 = Scalar(0.20999999999999999) * _tmp21 - Scalar(0.20999999999999999) * _tmp22;
  ...
  const Scalar _tmp87 = -_tmp30 * _tmp84 + _tmp86;
  ...
  const Scalar _tmp102 = _tmp53 * fh1;
  ...
  _res(1, 0) = std::exp(_tmp102 * _tmp69 * (_tmp100 * _tmp99 + _tmp101 * _tmp73) +
                        _tmp102 * _tmp70 * (_tmp100 * _tmp105 + _tmp106 * _tmp73 + Scalar(1.0)) +
                        _tmp53 * _tmp71 * (-_tmp30 * _tmp62 + _tmp48 * _tmp63) +
                        _tmp53 * _tmp72 * (_tmp48 * _tmp95 - _tmp73 * _tmp94));
  _res(2, 0) = std::exp(-_tmp101 * _tmp107 * _tmp69 - _tmp106 * _tmp107 * _tmp70 +
                        _tmp57 * _tmp72 * _tmp94 + _tmp62 * _tmp71);
  _res(3, 0) = std::exp(-_tmp105 * _tmp108 * _tmp70 - _tmp108 * _tmp69 * _tmp99 - _tmp63 * _tmp71 -
                        _tmp72 * _tmp95);
