...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl9(
  ...
  const Scalar _tmp24 = _tmp1 * _tmp14;
  const Scalar _tmp25 = _tmp10 * _tmp8;
  const Scalar _tmp26 =
      -Scalar(0.010999999999999999) * _tmp24 - Scalar(0.010999999999999999) * _tmp25;
  const Scalar _tmp27 = Scalar(0.20999999999999999) * _tmp13 - Scalar(0.20999999999999999) * _tmp15;
  ...
  const Scalar _tmp51 = _tmp23 + _tmp44;
  ...
  const Scalar _tmp75 = _tmp61 * _tmp70;
  ...
  const Scalar _tmp80 = _tmp60 * _tmp67 * _tmp79 - _tmp68 * _tmp79;
  const Scalar _tmp81 = Scalar(1.0) / (_tmp77);
  const Scalar _tmp82 = _tmp78 * (-_tmp41 * _tmp47 * _tmp81 + _tmp43 * _tmp45 * _tmp81);
  const Scalar _tmp83 = -_tmp51 * _tmp59 + _tmp53 * _tmp56 + _tmp56 * _tmp82;
  const Scalar _tmp84 = _tmp18 * _tmp33 - _tmp29 * _tmp39 + _tmp33 * _tmp82 - _tmp63 * _tmp83;
  const Scalar _tmp85 = _tmp70 * _tmp84;
  const Scalar _tmp86 = Scalar(1.0) / (_tmp84);
  const Scalar _tmp87 = _tmp69 * _tmp86;
  const Scalar _tmp88 = _tmp80 + _tmp87 * (-_tmp79 * _tmp83 - _tmp80 * _tmp85);
  const Scalar _tmp89 = _tmp33 * _tmp70;
  const Scalar _tmp90 = -_tmp75 * _tmp88 + Scalar(1.0);
  const Scalar _tmp91 = _tmp40 + _tmp6;
  const Scalar _tmp92 = _tmp19 + _tmp91;
  const Scalar _tmp93 = _tmp22 + _tmp28;
  ...
  const Scalar _tmp97 = _tmp78 * fh1;
  ...
  const Scalar _tmp103 = _tmp102 + _tmp87 * (_tmp101 * _tmp83 - _tmp102 * _tmp85 - _tmp82);
  const Scalar _tmp104 = -_tmp103 * _tmp75 - _tmp49;
  const Scalar _tmp105 = _tmp100 * _tmp98;
  const Scalar _tmp106 = _tmp62 * fh1;
  ...
  _res(1, 0) = std::exp(_tmp0 * _tmp78 * (_tmp33 * _tmp73 - _tmp74 * _tmp76) +
                        _tmp100 * _tmp78 * (_tmp33 * _tmp98 - _tmp56 * _tmp63 * _tmp98) +
                        _tmp96 * _tmp97 * (_tmp74 * _tmp90 + _tmp88 * _tmp89) +
                        _tmp97 * _tmp99 * (_tmp103 * _tmp89 + _tmp104 * _tmp74 + Scalar(1.0)));
  _res(2, 0) = std::exp(_tmp0 * _tmp62 * _tmp76 - _tmp104 * _tmp106 * _tmp99 + _tmp105 * _tmp63 -
                        _tmp106 * _tmp90 * _tmp96);
  _res(3, 0) =
      std::exp(-_tmp0 * _tmp73 - _tmp103 * _tmp107 * _tmp99 - _tmp105 - _tmp107 * _tmp88 * _tmp96);
