...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl11(
  ...
  const Scalar _tmp47 = _tmp16 + _tmp8;
  ...
  const Scalar _tmp93 = _tmp75 * _tmp92 * (_tmp82 * _tmp86 + _tmp84 * _tmp85 + Scalar(1.0));
  ...
  const Scalar _tmp99 = _tmp75 * _tmp98 * (_tmp85 * _tmp97 + _tmp86 * _tmp96);
  const Scalar _tmp100 = _tmp87 * _tmp98 - _tmp89 * _tmp92;
  const Scalar _tmp101 = Scalar(1.0) * _tmp80;
  const Scalar _tmp102 = _tmp45 * _tmp70;
  const Scalar _tmp103 = _tmp100 * _tmp75 * (-_tmp101 * _tmp102 + _tmp101 * _tmp65);
  const Scalar _tmp104 = Scalar(19.620000000000001) - fv1;
  const Scalar _tmp105 = _tmp52 * _tmp54 + _tmp53;
  ...
  const Scalar _tmp110 = _tmp50 * _tmp84 * _tmp92;
  const Scalar _tmp111 = _tmp50 * _tmp97 * _tmp98;
  const Scalar _tmp112 = _tmp72 * _tmp82 * _tmp92;
  const Scalar _tmp113 = _tmp72 * _tmp96 * _tmp98;
  ...
  _res(1, 0) = -(-_tmp103 - _tmp93 - _tmp99) *
               std::exp(_tmp103 * fh1 + _tmp104 * _tmp75 * (-_tmp102 * _tmp106 + _tmp106 * _tmp65) +
                        _tmp93 * fh1 + _tmp99 * fh1);
  _res(2, 0) = -(-_tmp107 * _tmp70 + _tmp110 + _tmp111) *
               std::exp(_tmp108 * _tmp70 + _tmp109 * _tmp70 - _tmp110 * fh1 - _tmp111 * fh1);
  _res(3, 0) =
      -(_tmp107 + _tmp112 + _tmp113) * std::exp(-_tmp108 - _tmp109 - _tmp112 * fh1 - _tmp113 * fh1);
