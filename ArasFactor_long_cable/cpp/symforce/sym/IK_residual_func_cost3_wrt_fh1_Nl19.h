...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl19(
  ...
  const Scalar _tmp76 = -_tmp48 * _tmp75 + _tmp65 * _tmp68 * _tmp75;
  const Scalar _tmp77 = Scalar(1.0) / (_tmp73);
  const Scalar _tmp78 = _tmp74 * (-_tmp50 * _tmp55 * _tmp77 + _tmp51 * _tmp53 * _tmp77);
  const Scalar _tmp79 = _tmp38 * _tmp45 - _tmp42 * _tmp58 + _tmp45 * _tmp78;
  const Scalar _tmp80 = _tmp18 * _tmp32 - _tmp28 * _tmp60 + _tmp32 * _tmp78 - _tmp62 * _tmp79;
  ...
  const Scalar _tmp85 = _tmp32 * _tmp70;
  const Scalar _tmp86 = _tmp61 * _tmp70;
  const Scalar _tmp87 = _tmp59 * (-_tmp84 * _tmp86 + Scalar(1.0));
  const Scalar _tmp88 = _tmp41 + _tmp52;
  const Scalar _tmp89 = _tmp54 + _tmp88;
  const Scalar _tmp90 = _tmp49 + _tmp5;
  const Scalar _tmp91 = _tmp39 + _tmp90;
  const Scalar _tmp92 = std::pow(Scalar(std::pow(_tmp89, Scalar(2)) + std::pow(_tmp91, Scalar(2))),
                                 Scalar(Scalar(-1) / Scalar(2)));
  const Scalar _tmp93 = _tmp91 * _tmp92;
  const Scalar _tmp94 = _tmp74 * _tmp93 * (_tmp45 * _tmp87 + _tmp84 * _tmp85);
  const Scalar _tmp95 = _tmp89 * _tmp92;
  const Scalar _tmp96 = _tmp88 * _tmp93 - _tmp90 * _tmp95;
  const Scalar _tmp97 = Scalar(1.0) * _tmp82;
  const Scalar _tmp98 = _tmp61 * _tmp75 * _tmp82;
  const Scalar _tmp99 = _tmp74 * _tmp96 * (_tmp32 * _tmp97 - _tmp45 * _tmp98);
  const Scalar _tmp100 = _tmp57 * _tmp59;
  const Scalar _tmp101 = _tmp100 * _tmp48 - _tmp37 - _tmp68 * (_tmp100 * _tmp65 + _tmp37 * _tmp57);
  const Scalar _tmp102 = _tmp101 + _tmp83 * (_tmp100 * _tmp79 - _tmp101 * _tmp81 - _tmp78);
  const Scalar _tmp103 = _tmp59 * (-_tmp102 * _tmp86 - _tmp57);
  const Scalar _tmp104 = _tmp74 * _tmp95 * (_tmp102 * _tmp85 + _tmp103 * _tmp45 + Scalar(1.0));
  const Scalar _tmp105 = _tmp0 * _tmp72;
  const Scalar _tmp106 = _tmp103 * _tmp95;
  const Scalar _tmp107 = _tmp96 * _tmp98;
  const Scalar _tmp108 = _tmp87 * _tmp93;
  const Scalar _tmp109 = _tmp70 * _tmp84 * _tmp93;
  const Scalar _tmp110 = _tmp96 * _tmp97;
  const Scalar _tmp111 = _tmp102 * _tmp70 * _tmp95;
  ...
  _res(1, 0) = -(-_tmp104 - _tmp94 - _tmp99) *
               std::exp(_tmp0 * _tmp74 * (_tmp32 * _tmp72 - _tmp45 * _tmp62 * _tmp72) +
                        _tmp104 * fh1 + _tmp94 * fh1 + _tmp99 * fh1);
  _res(2, 0) = -(_tmp106 - _tmp107 + _tmp108) *
               std::exp(_tmp105 * _tmp62 - _tmp106 * fh1 + _tmp107 * fh1 - _tmp108 * fh1);
  _res(3, 0) = -(_tmp109 + _tmp110 + _tmp111) *
               std::exp(-_tmp105 - _tmp109 * fh1 - _tmp110 * fh1 - _tmp111 * fh1);
