...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl2(
  ...
  const Scalar _tmp32 = _tmp16 + _tmp5;
  ...
  const Scalar _tmp44 = Scalar(1.0) * _tmp36;
  const Scalar _tmp45 = (-_tmp27 + _tmp44) / (_tmp17 - _tmp43);
  ...
  const Scalar _tmp58 = _tmp39 * _tmp57 - _tmp56;
  ...
  const Scalar _tmp67 = _tmp41 * (_tmp31 * _tmp64 - _tmp39 * _tmp66);
  const Scalar _tmp68 = _tmp57 * _tmp65;
  const Scalar _tmp69 = _tmp41 * (-_tmp40 * _tmp64 + _tmp66);
  const Scalar _tmp70 = -_tmp45 * (-_tmp39 * _tmp68 + _tmp56 * _tmp63 - _tmp58 * _tmp67) -
                        _tmp57 * _tmp63 - _tmp58 * _tmp69 + _tmp68;
  ...
  const Scalar _tmp77 = _tmp26 + _tmp51;
  const Scalar _tmp78 = _tmp48 + _tmp6;
  const Scalar _tmp79 = _tmp18 + _tmp78;
  const Scalar _tmp80 = _tmp53 + _tmp77;
  ...
  const Scalar _tmp84 = _tmp77 * _tmp82 - _tmp78 * _tmp83;
  const Scalar _tmp85 = Scalar(1.0) / (_tmp75);
  const Scalar _tmp86 = _tmp76 * (-_tmp32 * _tmp37 * _tmp85 + _tmp34 * _tmp36 * _tmp85);
  const Scalar _tmp87 = _tmp41 * (_tmp17 * _tmp40 - _tmp27 * _tmp31 + _tmp40 * _tmp86);
  const Scalar _tmp88 = _tmp49 * _tmp57 - _tmp52 * _tmp56 + _tmp57 * _tmp86 - _tmp58 * _tmp87;
  const Scalar _tmp89 = Scalar(1.0) / (_tmp88);
  const Scalar _tmp90 = Scalar(1.0) * _tmp89;
  const Scalar _tmp91 = _tmp76 * _tmp84 * (-_tmp42 * _tmp58 * _tmp90 + _tmp57 * _tmp90);
  const Scalar _tmp92 = _tmp39 * _tmp69 - _tmp45 * (_tmp39 * _tmp65 + _tmp39 * _tmp67) - _tmp65;
  const Scalar _tmp93 = _tmp71 * _tmp88;
  const Scalar _tmp94 = _tmp70 * _tmp89;
  const Scalar _tmp95 = _tmp92 + _tmp94 * (_tmp39 * _tmp87 - _tmp86 - _tmp92 * _tmp93);
  const Scalar _tmp96 = -_tmp39 - _tmp72 * _tmp95;
  const Scalar _tmp97 = _tmp71 * _tmp95;
  const Scalar _tmp98 = _tmp76 * _tmp83 * (_tmp42 * _tmp96 + _tmp57 * _tmp97 + Scalar(1.0));
  const Scalar _tmp99 = Scalar(1.0) * _tmp45 * _tmp67 - Scalar(1.0) * _tmp69;
  const Scalar _tmp100 = _tmp94 * (-Scalar(1.0) * _tmp87 - _tmp93 * _tmp99) + _tmp99;
  const Scalar _tmp101 = _tmp100 * _tmp71;
  const Scalar _tmp102 = -_tmp100 * _tmp72 + Scalar(1.0);
  const Scalar _tmp103 = _tmp76 * _tmp82 * (_tmp101 * _tmp57 + _tmp102 * _tmp42);
  const Scalar _tmp104 = _tmp41 * _tmp83 * _tmp96;
  const Scalar _tmp105 = _tmp102 * _tmp41 * _tmp82;
  const Scalar _tmp106 = _tmp84 * _tmp90;
  const Scalar _tmp107 = _tmp106 * fh1;
  const Scalar _tmp108 = _tmp41 * _tmp58;
  const Scalar _tmp109 = _tmp83 * _tmp97;
  const Scalar _tmp110 = _tmp101 * _tmp82;

  // Output terms (1)
  Eigen::Matrix<Scalar, 4, 1> _res;

  _res(0, 0) = -std::exp(-fh1);
  _res(1, 0) = -(-_tmp103 - _tmp91 - _tmp98) *
               std::exp(_tmp0 * _tmp76 * (-_tmp42 * _tmp73 + _tmp57 * _tmp74) + _tmp103 * fh1 +
                        _tmp91 * fh1 + _tmp98 * fh1);
  _res(2, 0) =
      -(_tmp104 + _tmp105 - _tmp106 * _tmp108) *
      std::exp(_tmp0 * _tmp41 * _tmp73 - _tmp104 * fh1 - _tmp105 * fh1 + _tmp107 * _tmp108);
  _res(3, 0) = -(_tmp106 + _tmp109 + _tmp110) *
               std::exp(-_tmp0 * _tmp74 - _tmp107 - _tmp109 * fh1 - _tmp110 * fh1);
