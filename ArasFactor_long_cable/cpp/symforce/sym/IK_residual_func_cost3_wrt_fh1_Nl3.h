...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl3(
  ...
  const Scalar _tmp33 = _tmp17 * _tmp30;
  ...
  const Scalar _tmp44 = Scalar(1.0) / (_tmp33 * _tmp43 - _tmp42);
  const Scalar _tmp45 =
  ...
  const Scalar _tmp52 = _tmp44 * (-_tmp43 * _tmp48 + _tmp51);
  const Scalar _tmp53 = -_tmp33 * _tmp51 + _tmp42 * _tmp48;
  const Scalar _tmp54 = _tmp44 * _tmp53;
  const Scalar _tmp55 = Scalar(1.0) * _tmp15;
  const Scalar _tmp56 = Scalar(1.0) * _tmp25;
  const Scalar _tmp57 = (-_tmp38 + _tmp56) / (_tmp35 - _tmp55);
  const Scalar _tmp58 = _tmp33 * _tmp52 - _tmp50 - _tmp57 * (_tmp33 * _tmp50 + _tmp33 * _tmp54);
  ...
  const Scalar _tmp69 = _tmp33 * _tmp68 - _tmp67;
  const Scalar _tmp70 = -_tmp47 + _tmp49;
  const Scalar _tmp71 = _tmp44 * _tmp69;
  const Scalar _tmp72 = _tmp50 * _tmp68;
  const Scalar _tmp73 = -_tmp52 * _tmp69 -
                        _tmp57 * (-_tmp33 * _tmp72 - _tmp53 * _tmp71 + _tmp67 * _tmp70) -
                        _tmp68 * _tmp70 + _tmp72;
  const Scalar _tmp74 = Scalar(1.0) / (_tmp73);
  const Scalar _tmp75 = _tmp32 * _tmp43 + _tmp35 * _tmp43 - _tmp38 * _tmp42;
  const Scalar _tmp76 = _tmp32 * _tmp68 + _tmp60 * _tmp68 - _tmp64 * _tmp67 - _tmp71 * _tmp75;
  const Scalar _tmp77 = _tmp74 * _tmp76;
  const Scalar _tmp78 = _tmp44 * _tmp75;
  const Scalar _tmp79 = Scalar(1.0) / (_tmp76);
  const Scalar _tmp80 = _tmp73 * _tmp79;
  const Scalar _tmp81 = _tmp58 + _tmp80 * (-_tmp32 + _tmp33 * _tmp78 - _tmp58 * _tmp77);
  const Scalar _tmp82 = _tmp68 * _tmp74;
  const Scalar _tmp83 = _tmp69 * _tmp74;
  const Scalar _tmp84 = _tmp44 * (-_tmp33 - _tmp81 * _tmp83);
  const Scalar _tmp85 = _tmp37 + _tmp63;
  const Scalar _tmp86 = _tmp39 + _tmp85;
  const Scalar _tmp87 = _tmp34 + _tmp59;
  ...
  const Scalar _tmp91 = _tmp31 * _tmp90 * (_tmp43 * _tmp84 + _tmp81 * _tmp82 + Scalar(1.0));
  const Scalar _tmp92 = Scalar(19.620000000000001) - fv1;
  const Scalar _tmp93 = _tmp55 * _tmp57 + _tmp56;
  const Scalar _tmp94 = 0;
  const Scalar _tmp95 = _tmp43 * _tmp71;
  const Scalar _tmp96 = _tmp88 * _tmp89;
  const Scalar _tmp97 = _tmp85 * _tmp96 - _tmp87 * _tmp90;
  const Scalar _tmp98 = Scalar(1.0) * _tmp79;
  const Scalar _tmp99 = _tmp31 * _tmp97 * (_tmp68 * _tmp98 - _tmp95 * _tmp98);
  const Scalar _tmp100 = -Scalar(1.0) * _tmp52 + Scalar(1.0) * _tmp54 * _tmp57;
  const Scalar _tmp101 = _tmp100 + _tmp80 * (-_tmp100 * _tmp77 - Scalar(1.0) * _tmp78);
  const Scalar _tmp102 = _tmp44 * (-_tmp101 * _tmp83 + Scalar(1.0));
  const Scalar _tmp103 = _tmp31 * _tmp96 * (_tmp101 * _tmp82 + _tmp102 * _tmp43);
  ...
  const Scalar _tmp108 = _tmp102 * _tmp96;
  const Scalar _tmp109 = _tmp74 * _tmp81 * _tmp90;
  const Scalar _tmp110 = _tmp101 * _tmp74 * _tmp96;

  // Output terms (1)
  Eigen::Matrix<Scalar, 4, 1> _res;

  _res(0, 0) = -std::exp(-fh1);
  _res(1, 0) = -(-_tmp103 - _tmp91 - _tmp99) *
               std::exp(_tmp103 * fh1 + _tmp31 * _tmp92 * (_tmp68 * _tmp94 - _tmp94 * _tmp95) +
                        _tmp91 * fh1 + _tmp99 * fh1);
  _res(2, 0) = -(_tmp105 - _tmp106 * _tmp71 + _tmp108) *
               std::exp(_tmp104 * _tmp71 - _tmp105 * fh1 + _tmp107 * _tmp71 - _tmp108 * fh1);
  _res(3, 0) =
