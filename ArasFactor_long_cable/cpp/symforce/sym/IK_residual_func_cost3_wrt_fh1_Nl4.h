...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl4(
  ...
  const Scalar _tmp71 = _tmp34 * _tmp63 * (_tmp44 * _tmp68 - _tmp68 * _tmp70);
  ...
  const Scalar _tmp82 = -_tmp51 * _tmp81 + _tmp58 * _tmp80;
  const Scalar _tmp83 = Scalar(1.0) * _tmp48;
  const Scalar _tmp84 = Scalar(1.0) * _tmp46;
  const Scalar _tmp85 = (-_tmp55 + _tmp83) / (_tmp53 - _tmp84);
  const Scalar _tmp86 = -_tmp59 * _tmp80 + _tmp81;
  const Scalar _tmp87 = -_tmp44 * _tmp77 - _tmp69 * _tmp86 + _tmp79 -
                        _tmp85 * (_tmp45 * _tmp77 - _tmp51 * _tmp79 - _tmp69 * _tmp82);
  const Scalar _tmp88 = Scalar(1.0) / (_tmp87);
  const Scalar _tmp89 = _tmp83 + _tmp84 * _tmp85;
  const Scalar _tmp90 = 0;
  const Scalar _tmp91 = _tmp60 * _tmp86;
  const Scalar _tmp92 = _tmp60 * _tmp82;
  const Scalar _tmp93 = Scalar(1.0) * _tmp85 * _tmp92 - Scalar(1.0) * _tmp91;
  const Scalar _tmp94 = _tmp66 * _tmp88;
  const Scalar _tmp95 = _tmp67 * _tmp87;
  const Scalar _tmp96 = _tmp93 + _tmp95 * (-Scalar(1.0) * _tmp65 - _tmp93 * _tmp94);
  const Scalar _tmp97 = _tmp52 * _tmp88;
  const Scalar _tmp98 = _tmp60 * (-_tmp96 * _tmp97 + Scalar(1.0));
  const Scalar _tmp99 = _tmp88 * _tmp96;
  const Scalar _tmp100 = _tmp32 * _tmp63 * (_tmp44 * _tmp99 + _tmp59 * _tmp98);
  const Scalar _tmp101 = _tmp51 * _tmp91 - _tmp78 - _tmp85 * (_tmp51 * _tmp78 + _tmp51 * _tmp92);
  const Scalar _tmp102 = _tmp101 + _tmp95 * (-_tmp101 * _tmp94 + _tmp51 * _tmp65 - _tmp64);
  const Scalar _tmp103 = _tmp60 * (-_tmp102 * _tmp97 - _tmp51);
  const Scalar _tmp104 = _tmp102 * _tmp88;
  const Scalar _tmp105 = _tmp33 * _tmp63 * (_tmp103 * _tmp59 + _tmp104 * _tmp44 + Scalar(1.0));
  const Scalar _tmp106 = _tmp72 * _tmp90;
  const Scalar _tmp107 = _tmp32 * _tmp98;
  const Scalar _tmp108 = _tmp34 * _tmp68;
  const Scalar _tmp109 = _tmp108 * fh1;
  const Scalar _tmp110 = _tmp103 * _tmp33;
  const Scalar _tmp111 = _tmp104 * _tmp33;
  const Scalar _tmp112 = _tmp32 * _tmp99;
  ...
  _res(1, 0) = -(-_tmp100 - _tmp105 - _tmp71) *
               std::exp(_tmp100 * fh1 + _tmp105 * fh1 +
                        _tmp63 * _tmp72 * (_tmp44 * _tmp90 - _tmp70 * _tmp90) + _tmp71 * fh1);
  _res(2, 0) = -(_tmp107 - _tmp108 * _tmp69 + _tmp110) *
               std::exp(_tmp106 * _tmp69 - _tmp107 * fh1 + _tmp109 * _tmp69 - _tmp110 * fh1);
  _res(3, 0) =
