...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl5(
  ...
  const Scalar _tmp14 = 2 * _tmp2 * _tmp9;
  ...
  const Scalar _tmp53 = _tmp52 * (-_tmp43 * _tmp48 * _tmp50 + _tmp45 * _tmp47 * _tmp50);
  const Scalar _tmp54 = _tmp36 * _tmp40;
  const Scalar _tmp55 = _tmp18 + _tmp42;
  const Scalar _tmp56 = _tmp44 + _tmp55;
  const Scalar _tmp57 = _tmp4 + _tmp46;
  ...
  const Scalar _tmp63 = _tmp45 * _tmp51;
  const Scalar _tmp64 = _tmp41 * _tmp63 - _tmp54;
  const Scalar _tmp65 = Scalar(1.0) / (_tmp60 * _tmp63 - _tmp61);
  const Scalar _tmp66 = _tmp64 * _tmp65;
  const Scalar _tmp67 = _tmp35 * _tmp41 - _tmp37 * _tmp54 + _tmp41 * _tmp53 - _tmp62 * _tmp66;
  const Scalar _tmp68 = Scalar(1.0) / (_tmp67);
  const Scalar _tmp69 = Scalar(1.0) * _tmp68;
  const Scalar _tmp70 = _tmp60 * _tmp66;
  const Scalar _tmp71 = _tmp34 * _tmp52 * (_tmp41 * _tmp69 - _tmp69 * _tmp70);
  ...
  const Scalar _tmp75 = -Scalar(0.20999999999999999) * _tmp11 + Scalar(0.20999999999999999) * _tmp8;
  ...
  const Scalar _tmp82 = _tmp61 * _tmp81 - _tmp63 * _tmp80;
  const Scalar _tmp83 = Scalar(1.0) * _tmp43;
  const Scalar _tmp84 = Scalar(1.0) * _tmp47;
  const Scalar _tmp85 = (-_tmp57 + _tmp84) / (_tmp55 - _tmp83);
  const Scalar _tmp86 = -_tmp60 * _tmp81 + _tmp80;
  const Scalar _tmp87 = -_tmp41 * _tmp77 - _tmp66 * _tmp86 + _tmp79 -
                        _tmp85 * (_tmp54 * _tmp77 - _tmp63 * _tmp79 - _tmp66 * _tmp82);
  const Scalar _tmp88 = Scalar(1.0) / (_tmp87);
  const Scalar _tmp89 = _tmp83 * _tmp85 + _tmp84;
  const Scalar _tmp90 = 0;
  const Scalar _tmp91 = _tmp63 * _tmp65;
  const Scalar _tmp92 = -_tmp78 - _tmp85 * (_tmp63 * _tmp78 + _tmp82 * _tmp91) + _tmp86 * _tmp91;
  const Scalar _tmp93 = _tmp67 * _tmp88;
  const Scalar _tmp94 = _tmp68 * _tmp87;
  const Scalar _tmp95 = _tmp92 + _tmp94 * (-_tmp53 + _tmp62 * _tmp91 - _tmp92 * _tmp93);
  const Scalar _tmp96 = _tmp41 * _tmp88;
  const Scalar _tmp97 = _tmp64 * _tmp88;
  const Scalar _tmp98 = _tmp65 * (-_tmp63 - _tmp95 * _tmp97);
  const Scalar _tmp99 = _tmp33 * _tmp52 * (_tmp60 * _tmp98 + _tmp95 * _tmp96 + Scalar(1.0));
  const Scalar _tmp100 = Scalar(1.0) * _tmp65;
  const Scalar _tmp101 = _tmp100 * _tmp82 * _tmp85 - _tmp100 * _tmp86;
  const Scalar _tmp102 = _tmp101 + _tmp94 * (-_tmp100 * _tmp62 - _tmp101 * _tmp93);
  const Scalar _tmp103 = _tmp65 * (-_tmp102 * _tmp97 + Scalar(1.0));
  const Scalar _tmp104 = _tmp32 * _tmp52 * (_tmp102 * _tmp96 + _tmp103 * _tmp60);
  const Scalar _tmp105 = _tmp34 * _tmp69;
  const Scalar _tmp106 = _tmp105 * fh1;
  const Scalar _tmp107 = _tmp33 * _tmp98;
  const Scalar _tmp108 = _tmp72 * _tmp90;
  const Scalar _tmp109 = _tmp103 * _tmp32;
  const Scalar _tmp110 = _tmp33 * _tmp88 * _tmp95;
  const Scalar _tmp111 = _tmp102 * _tmp32 * _tmp88;

  // Output terms (1)
  Eigen::Matrix<Scalar, 4, 1> _res;

  _res(0, 0) = -std::exp(-fh1);
  _res(1, 0) = -(-_tmp104 - _tmp71 - _tmp99) *
               std::exp(_tmp104 * fh1 + _tmp52 * _tmp72 * (_tmp41 * _tmp90 - _tmp70 * _tmp90) +
