...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl6(
  ...
  const Scalar _tmp97 = _tmp74 * _tmp94 * (_tmp30 * _tmp95 - _tmp95 * _tmp96);
  const Scalar _tmp98 = _tmp45 * _tmp62;
  const Scalar _tmp99 = -_tmp46 - _tmp66 * (_tmp58 + _tmp59 * _tmp98) + _tmp67 * _tmp98;
  const Scalar _tmp100 = _tmp80 * (-_tmp75 + _tmp76 * _tmp98 - _tmp78 * _tmp99) + _tmp99;
  const Scalar _tmp101 = _tmp100 * _tmp69;
  const Scalar _tmp102 = -_tmp100 * _tmp83 - _tmp45;
  const Scalar _tmp103 = _tmp74 * _tmp93 * (_tmp101 * _tmp30 + _tmp102 * _tmp85 + Scalar(1.0));
  const Scalar _tmp104 = Scalar(19.620000000000001) - fv1;
  const Scalar _tmp105 = _tmp64 + _tmp65 * _tmp66;
  const Scalar _tmp106 = 0;
  const Scalar _tmp107 = _tmp102 * _tmp62 * _tmp93;
  ...
  const Scalar _tmp113 = _tmp101 * _tmp93;

  // Output terms (1)
  Eigen::Matrix<Scalar, 4, 1> _res;

  _res(0, 0) = -std::exp(-fh1);
  _res(1, 0) = -(-_tmp103 - _tmp92 - _tmp97) *
               std::exp(_tmp103 * fh1 + _tmp104 * _tmp74 * (_tmp106 * _tmp30 - _tmp106 * _tmp96) +
