...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl7(
  ...
  const Scalar _tmp18 = Scalar(0.20999999999999999) * _tmp6 - Scalar(0.20999999999999999) * _tmp8;
  ...
  const Scalar _tmp30 = Scalar(0.20999999999999999) * _tmp11 + Scalar(0.20999999999999999) * _tmp12;
  ...
  const Scalar _tmp47 = -_tmp36 * _tmp45 + _tmp46;
  ...
  const Scalar _tmp60 = _tmp29 * _tmp57 - _tmp59;
  const Scalar _tmp61 = _tmp58 * _tmp60;
  const Scalar _tmp62 = _tmp36 * _tmp48 - _tmp46 * _tmp57;
  const Scalar _tmp63 = _tmp34 * _tmp57;
  const Scalar _tmp64 = Scalar(1.0) * _tmp50;
  const Scalar _tmp65 = Scalar(1.0) * _tmp54;
  const Scalar _tmp66 = (-_tmp38 + _tmp65) / (_tmp42 - _tmp64);
  const Scalar _tmp67 = _tmp29 * _tmp34 - _tmp29 * _tmp35 - _tmp47 * _tmp61 -
                        _tmp66 * (-_tmp29 * _tmp63 + _tmp35 * _tmp59 - _tmp61 * _tmp62);
  const Scalar _tmp68 = Scalar(1.0) / (_tmp67);
  const Scalar _tmp69 = Scalar(1.0) * _tmp58;
  const Scalar _tmp70 = -_tmp47 * _tmp69 + _tmp62 * _tmp66 * _tmp69;
  const Scalar _tmp71 =
      std::sqrt(Scalar(std::pow(_tmp52, Scalar(2)) + std::pow(_tmp55, Scalar(2))));
  const Scalar _tmp72 = Scalar(1.0) / (_tmp71);
  const Scalar _tmp73 = _tmp56 * _tmp71;
  const Scalar _tmp74 = _tmp73 * (-_tmp50 * _tmp55 * _tmp72 + _tmp52 * _tmp54 * _tmp72);
  const Scalar _tmp75 = -_tmp38 * _tmp48 + _tmp42 * _tmp45 + _tmp45 * _tmp74;
  const Scalar _tmp76 = _tmp15 * _tmp29 - _tmp25 * _tmp59 + _tmp29 * _tmp74 - _tmp61 * _tmp75;
  ...
  const Scalar _tmp82 = _tmp60 * _tmp68;
  const Scalar _tmp83 = _tmp58 * (-_tmp80 * _tmp82 + Scalar(1.0));
  const Scalar _tmp84 = _tmp14 + _tmp49;
  const Scalar _tmp85 = _tmp51 + _tmp84;
  const Scalar _tmp86 = _tmp24 + _tmp53;
  ...
  const Scalar _tmp90 = _tmp73 * _tmp89 * (_tmp29 * _tmp81 + _tmp45 * _tmp83);
  const Scalar _tmp91 = _tmp87 * _tmp88;
  const Scalar _tmp92 = -_tmp84 * _tmp91 + _tmp86 * _tmp89;
  const Scalar _tmp93 = Scalar(1.0) * _tmp78;
  const Scalar _tmp94 = _tmp45 * _tmp61;
  const Scalar _tmp95 = _tmp73 * _tmp92 * (_tmp29 * _tmp93 - _tmp93 * _tmp94);
  const Scalar _tmp96 = Scalar(19.620000000000001) - fv1;
  const Scalar _tmp97 = _tmp64 * _tmp66 + _tmp65;
  const Scalar _tmp98 = 0;
  const Scalar _tmp99 = _tmp57 * _tmp58;
  const Scalar _tmp100 = -_tmp34 + _tmp47 * _tmp99 - _tmp66 * (_tmp62 * _tmp99 + _tmp63);
  const Scalar _tmp101 = _tmp100 + _tmp79 * (-_tmp100 * _tmp77 - _tmp74 + _tmp75 * _tmp99);
  const Scalar _tmp102 = _tmp101 * _tmp68;
  const Scalar _tmp103 = _tmp58 * (-_tmp101 * _tmp82 - _tmp57);
  const Scalar _tmp104 = _tmp73 * _tmp91 * (_tmp102 * _tmp29 + _tmp103 * _tmp45 + Scalar(1.0));
  const Scalar _tmp105 = _tmp96 * _tmp98;
  const Scalar _tmp106 = _tmp83 * _tmp89;
  const Scalar _tmp107 = _tmp103 * _tmp91;
  const Scalar _tmp108 = _tmp92 * _tmp93;
  const Scalar _tmp109 = _tmp108 * fh1;
  const Scalar _tmp110 = _tmp81 * _tmp89;
  const Scalar _tmp111 = _tmp102 * _tmp91;

  // Output terms (1)
  Eigen::Matrix<Scalar, 4, 1> _res;

  _res(0, 0) = -std::exp(-fh1);
  _res(1, 0) = -(-_tmp104 - _tmp90 - _tmp95) *
               std::exp(_tmp104 * fh1 + _tmp73 * _tmp96 * (_tmp29 * _tmp98 - _tmp94 * _tmp98) +
                        _tmp90 * fh1 + _tmp95 * fh1);
  _res(2, 0) = -(_tmp106 + _tmp107 - _tmp108 * _tmp61) *
               std::exp(_tmp105 * _tmp61 - _tmp106 * fh1 - _tmp107 * fh1 + _tmp109 * _tmp61);
  _res(3, 0) =
      -(_tmp108 + _tmp110 + _tmp111) * std::exp(-_tmp105 - _tmp109 - _tmp110 * fh1 - _tmp111 * fh1);
