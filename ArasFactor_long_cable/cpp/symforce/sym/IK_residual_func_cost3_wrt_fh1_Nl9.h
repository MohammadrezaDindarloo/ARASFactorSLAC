...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl9(
  ...
  const Scalar _tmp39 = _tmp20 * _tmp32;
  ...
  const Scalar _tmp44 = _tmp24 + _tmp27;
  ...
  const Scalar _tmp50 = _tmp34 + _tmp35 + _tmp36;
  ...
  const Scalar _tmp61 = _tmp33 * _tmp49 - _tmp39;
  const Scalar _tmp62 = Scalar(1.0) / (_tmp49 * _tmp56 - _tmp59);
  ...
  const Scalar _tmp69 = -_tmp33 * _tmp38 - _tmp63 * _tmp68 + _tmp64 -
                        _tmp67 * (_tmp38 * _tmp39 - _tmp49 * _tmp64 - _tmp60 * _tmp63);
  const Scalar _tmp70 = Scalar(1.0) / (_tmp69);
  const Scalar _tmp71 = _tmp65 * _tmp67 + _tmp66;
  const Scalar _tmp72 = 0;
  const Scalar _tmp73 = _tmp70 * _tmp72;
  const Scalar _tmp74 = _tmp61 * _tmp70;
  ...
  const Scalar _tmp79 = _tmp60 * _tmp67 * _tmp78 - _tmp68 * _tmp78;
  const Scalar _tmp80 = Scalar(1.0) / (_tmp76);
  const Scalar _tmp81 = _tmp77 * (-_tmp41 * _tmp47 * _tmp80 + _tmp43 * _tmp45 * _tmp80);
  const Scalar _tmp82 = -_tmp51 * _tmp59 + _tmp53 * _tmp56 + _tmp56 * _tmp81;
  const Scalar _tmp83 = _tmp18 * _tmp33 - _tmp29 * _tmp39 + _tmp33 * _tmp81 - _tmp63 * _tmp82;
  const Scalar _tmp84 = _tmp70 * _tmp83;
  const Scalar _tmp85 = Scalar(1.0) / (_tmp83);
  const Scalar _tmp86 = _tmp69 * _tmp85;
  const Scalar _tmp87 = _tmp79 + _tmp86 * (-_tmp78 * _tmp82 - _tmp79 * _tmp84);
  const Scalar _tmp88 = _tmp70 * _tmp87;
  const Scalar _tmp89 = _tmp62 * (-_tmp74 * _tmp87 + Scalar(1.0));
  const Scalar _tmp90 = _tmp17 + _tmp9;
  const Scalar _tmp91 = _tmp19 + _tmp90;
  const Scalar _tmp92 = _tmp22 + _tmp44;
  ...
  const Scalar _tmp96 = _tmp77 * _tmp95 * (_tmp33 * _tmp88 + _tmp56 * _tmp89);
  const Scalar _tmp97 = _tmp93 * _tmp94;
  const Scalar _tmp98 = -_tmp90 * _tmp97 + _tmp92 * _tmp95;
  const Scalar _tmp99 = Scalar(1.0) * _tmp85;
  const Scalar _tmp100 = _tmp77 * _tmp98 * (_tmp33 * _tmp99 - _tmp56 * _tmp63 * _tmp99);
  const Scalar _tmp101 = _tmp49 * _tmp62;
  const Scalar _tmp102 = _tmp101 * _tmp68 - _tmp50 - _tmp67 * (_tmp101 * _tmp60 + _tmp49 * _tmp50);
  const Scalar _tmp103 = _tmp102 + _tmp86 * (_tmp101 * _tmp82 - _tmp102 * _tmp84 - _tmp81);
  const Scalar _tmp104 = _tmp103 * _tmp70;
  const Scalar _tmp105 = _tmp62 * (-_tmp103 * _tmp74 - _tmp49);
  const Scalar _tmp106 = _tmp77 * _tmp97 * (_tmp104 * _tmp33 + _tmp105 * _tmp56 + Scalar(1.0));
  const Scalar _tmp107 = _tmp98 * _tmp99;
  const Scalar _tmp108 = _tmp107 * fh1;
  const Scalar _tmp109 = _tmp105 * _tmp97;
  const Scalar _tmp110 = _tmp89 * _tmp95;
  const Scalar _tmp111 = _tmp104 * _tmp97;
  const Scalar _tmp112 = _tmp88 * _tmp95;

  // Output terms (1)
  Eigen::Matrix<Scalar, 4, 1> _res;

  _res(0, 0) = -std::exp(-fh1);
  _res(1, 0) = -(-_tmp100 - _tmp106 - _tmp96) *
               std::exp(_tmp0 * _tmp77 * (_tmp33 * _tmp73 - _tmp56 * _tmp75) + _tmp100 * fh1 +
                        _tmp106 * fh1 + _tmp96 * fh1);
  _res(2, 0) = -(-_tmp107 * _tmp63 + _tmp109 + _tmp110) *
               std::exp(_tmp0 * _tmp75 + _tmp108 * _tmp63 - _tmp109 * fh1 - _tmp110 * fh1);
  _res(3, 0) = -(_tmp107 + _tmp111 + _tmp112) *
               std::exp(-_tmp0 * _tmp73 - _tmp108 - _tmp111 * fh1 - _tmp112 * fh1);
