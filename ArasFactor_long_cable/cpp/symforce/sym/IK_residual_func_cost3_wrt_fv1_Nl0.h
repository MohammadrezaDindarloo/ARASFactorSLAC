...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl0(
  ...
  const Scalar _tmp29 = Scalar(0.20999999999999999) * _tmp1 + Scalar(0.20999999999999999) * _tmp21 +
  ...
  const Scalar _tmp40 = _tmp18 + _tmp23;
  ...
  const Scalar _tmp47 = _tmp39 * _tmp42;
  ...
  const Scalar _tmp74 = _tmp27 * _tmp72;
  const Scalar _tmp75 = _tmp74 * (_tmp24 * _tmp34 * _tmp73 - _tmp26 * _tmp32 * _tmp73);
  const Scalar _tmp76 = _tmp37 * _tmp43 - _tmp40 * _tmp47 + _tmp43 * _tmp75;
  ...
  const Scalar _tmp86 = _tmp31 + _tmp61;
  const Scalar _tmp87 = _tmp33 + _tmp86;
  const Scalar _tmp88 = _tmp19 + _tmp57;
  ...
  const Scalar _tmp94 = _tmp68 * _tmp79 * _tmp93;
  ...
  const Scalar _tmp98 = _tmp48 * _tmp53 * _tmp93 - _tmp54 * _tmp93;
  const Scalar _tmp99 = _tmp80 * (-_tmp76 * _tmp93 - _tmp78 * _tmp98) + _tmp98;
  ...
  const Scalar _tmp103 = _tmp51 * _tmp53 + _tmp52;
  const Scalar _tmp104 = 0;
  const Scalar _tmp105 = _tmp104 * _tmp69;
  const Scalar _tmp106 = _tmp74 * (_tmp104 * _tmp65 - _tmp105 * _tmp43);
  ...
  _res(1, 0) =
      -_tmp106 *
      std::exp(_tmp101 * _tmp74 * (_tmp100 * _tmp85 + _tmp82 * _tmp99) + _tmp102 * _tmp106 +
               _tmp74 * _tmp92 * (_tmp81 * _tmp82 + _tmp84 * _tmp85 + Scalar(1.0)) +
               _tmp74 * _tmp97 * (-_tmp43 * _tmp94 + _tmp65 * _tmp95));
  _res(2, 0) = -_tmp105 * std::exp(-_tmp100 * _tmp101 * _tmp49 + _tmp107 * _tmp69 -
                                   _tmp49 * _tmp84 * _tmp92 + _tmp94 * _tmp97);
  _res(3, 0) = _tmp104 * std::exp(-_tmp101 * _tmp71 * _tmp99 - _tmp107 - _tmp71 * _tmp81 * _tmp92 -
                                  _tmp95 * _tmp97);
