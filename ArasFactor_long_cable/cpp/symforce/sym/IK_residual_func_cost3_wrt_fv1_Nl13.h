...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl13(
  ...
  const Scalar _tmp52 = (-_tmp39 + _tmp51) / (_tmp41 - _tmp50);
  ...
  const Scalar _tmp57 = _tmp33 + _tmp34 + _tmp35;
  ...
  const Scalar _tmp76 = -_tmp39 * _tmp48 + _tmp41 * _tmp45 + _tmp45 * _tmp75;
  ...
  const Scalar _tmp86 = _tmp4 + _tmp58;
  ...
  const Scalar _tmp93 = _tmp31 * _tmp53;
  const Scalar _tmp94 = -_tmp37 - _tmp52 * (_tmp31 * _tmp37 + _tmp49 * _tmp93) + _tmp55 * _tmp93;
  const Scalar _tmp95 = _tmp80 * (-_tmp75 + _tmp76 * _tmp93 - _tmp78 * _tmp94) + _tmp94;
  const Scalar _tmp96 = -_tmp31 - _tmp83 * _tmp95;
  ...
  const Scalar _tmp102 = _tmp74 * (_tmp100 * _tmp66 - _tmp101 * _tmp45);
  const Scalar _tmp103 = Scalar(1.0) * _tmp79;
  const Scalar _tmp104 = fh1 * (-_tmp86 * _tmp97 + _tmp88 * _tmp91);
  const Scalar _tmp105 = _tmp53 * fh1;
  ...
  _res(1, 0) =
      -_tmp102 * std::exp(_tmp102 * _tmp98 +
                          _tmp104 * _tmp74 * (-_tmp103 * _tmp45 * _tmp68 + _tmp103 * _tmp66) +
                          _tmp91 * _tmp92 * (_tmp81 * _tmp82 + _tmp84 * _tmp85) +
                          _tmp92 * _tmp97 * (_tmp82 * _tmp95 + _tmp85 * _tmp96 + Scalar(1.0)));
  _res(2, 0) = -_tmp101 * std::exp(-_tmp105 * _tmp84 * _tmp91 - _tmp105 * _tmp96 * _tmp97 +
                                   _tmp106 * _tmp68 + _tmp107 * _tmp68);
  _res(3, 0) = _tmp100 *
               std::exp(-_tmp106 - _tmp107 - _tmp108 * _tmp81 * _tmp91 - _tmp108 * _tmp95 * _tmp97);
