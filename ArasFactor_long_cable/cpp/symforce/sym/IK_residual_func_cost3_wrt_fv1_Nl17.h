...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl17(
  ...
  const Scalar _tmp57 = (-_tmp27 + _tmp55) / (_tmp16 - _tmp56);
  ...
  const Scalar _tmp61 = _tmp15 + _tmp32;
  const Scalar _tmp62 = _tmp17 + _tmp61;
  const Scalar _tmp63 = _tmp20 + _tmp37;
  ...
  const Scalar _tmp71 = _tmp42 * _tmp49;
  const Scalar _tmp72 = _tmp49 * _tmp66 - _tmp53 * _tmp69 -
                        _tmp57 * (-_tmp58 * _tmp69 - _tmp66 * _tmp71 + _tmp67 * _tmp70) -
                        _tmp66 * _tmp70;
  ...
  const Scalar _tmp77 = _tmp76 * (-_tmp34 * _tmp40 * _tmp75 + _tmp36 * _tmp38 * _tmp75);
  const Scalar _tmp78 = _tmp44 * (_tmp16 * _tmp43 - _tmp27 * _tmp31 + _tmp43 * _tmp77);
  const Scalar _tmp79 = _tmp61 * _tmp66 - _tmp63 * _tmp67 + _tmp66 * _tmp77 - _tmp68 * _tmp78;
  ...
  const Scalar _tmp88 = _tmp33 + _tmp8;
  const Scalar _tmp89 = _tmp35 + _tmp88;
  const Scalar _tmp90 = _tmp19 + _tmp26;
  ...
  const Scalar _tmp96 = _tmp55 + _tmp56 * _tmp57;
  const Scalar _tmp97 = 0;
  const Scalar _tmp98 = _tmp69 * _tmp97;
  const Scalar _tmp99 = _tmp76 * (-_tmp43 * _tmp98 + _tmp66 * _tmp97);
  const Scalar _tmp100 = _tmp42 * _tmp54 - _tmp49 - _tmp57 * (_tmp42 * _tmp59 + _tmp71);
  const Scalar _tmp101 = _tmp100 + _tmp82 * (-_tmp100 * _tmp80 + _tmp42 * _tmp78 - _tmp77);
  const Scalar _tmp102 = -_tmp101 * _tmp84 - _tmp42;
  const Scalar _tmp103 = _tmp91 * _tmp92;
  const Scalar _tmp104 = Scalar(1.0) * _tmp81;
  const Scalar _tmp105 = fh1 * (-_tmp103 * _tmp88 + _tmp90 * _tmp93);
  const Scalar _tmp106 = _tmp44 * fh1;
  const Scalar _tmp107 = _tmp95 * _tmp97;
  const Scalar _tmp108 = _tmp104 * _tmp105;
  const Scalar _tmp109 = _tmp73 * fh1;
  ...
  _res(0, 0) = 0;
  _res(1, 0) =
      -_tmp99 * std::exp(_tmp103 * _tmp94 * (_tmp101 * _tmp87 + _tmp102 * _tmp86 + Scalar(1.0)) +
                         _tmp105 * _tmp76 * (-_tmp104 * _tmp43 * _tmp69 + _tmp104 * _tmp66) +
                         _tmp93 * _tmp94 * (_tmp83 * _tmp87 + _tmp85 * _tmp86) + _tmp95 * _tmp99);
  _res(2, 0) = -_tmp98 * std::exp(-_tmp102 * _tmp103 * _tmp106 - _tmp106 * _tmp85 * _tmp93 +
                                  _tmp107 * _tmp69 + _tmp108 * _tmp69);
  _res(3, 0) = _tmp97 * std::exp(-_tmp101 * _tmp103 * _tmp109 - _tmp107 - _tmp108 -
                                 _tmp109 * _tmp83 * _tmp93);
