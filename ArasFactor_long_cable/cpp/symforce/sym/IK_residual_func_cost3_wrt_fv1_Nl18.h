...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl18(
  ...
  const Scalar _tmp95 = _tmp73 * _tmp79 * _tmp94;
  const Scalar _tmp96 = _tmp89 * _tmp90;
  const Scalar _tmp97 = fh1 * (_tmp86 * _tmp96 - _tmp88 * _tmp91);
  const Scalar _tmp98 = Scalar(19.620000000000001) - fv1;
  const Scalar _tmp99 = _tmp57 * _tmp59 + _tmp58;
  const Scalar _tmp100 = 0;
  const Scalar _tmp101 = _tmp100 * _tmp74;
  const Scalar _tmp102 = _tmp42 * (_tmp100 * _tmp69 - _tmp101 * _tmp39);
  const Scalar _tmp103 = -_tmp55 * _tmp94 + _tmp56 * _tmp59 * _tmp94;
  const Scalar _tmp104 = _tmp103 + _tmp80 * (-_tmp103 * _tmp78 - _tmp45 * _tmp94);
  const Scalar _tmp105 = -_tmp104 * _tmp82 + Scalar(1.0);
  const Scalar _tmp106 = _tmp96 * fh1;
  ...
  _res(1, 0) =
      -_tmp102 *
      std::exp(_tmp102 * _tmp98 + _tmp106 * _tmp42 * (_tmp104 * _tmp85 + _tmp105 * _tmp84) +
               _tmp42 * _tmp92 * (_tmp81 * _tmp85 + _tmp83 * _tmp84 + Scalar(1.0)) +
               _tmp42 * _tmp97 * (-_tmp39 * _tmp95 + _tmp69 * _tmp93));
  _res(2, 0) = -_tmp101 * std::exp(-_tmp105 * _tmp106 * _tmp46 + _tmp107 * _tmp74 -
                                   _tmp46 * _tmp83 * _tmp92 + _tmp95 * _tmp97);
  _res(3, 0) = _tmp100 * std::exp(-_tmp104 * _tmp106 * _tmp76 - _tmp107 - _tmp76 * _tmp81 * _tmp92 -
                                  _tmp93 * _tmp97);
