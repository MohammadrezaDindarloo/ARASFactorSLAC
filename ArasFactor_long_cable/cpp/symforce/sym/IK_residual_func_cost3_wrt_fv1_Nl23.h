...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl23(
  ...
  const Scalar _tmp57 = _tmp56 * (-_tmp33 * _tmp38 * _tmp55 + _tmp35 * _tmp37 * _tmp55);
  const Scalar _tmp58 = _tmp41 * (_tmp16 * _tmp30 - _tmp26 * _tmp31 + _tmp30 * _tmp57);
  const Scalar _tmp59 = _tmp43 * _tmp50 - _tmp46 * _tmp51 + _tmp50 * _tmp57 - _tmp52 * _tmp58;
  const Scalar _tmp60 = Scalar(1.0) / (_tmp59);
  const Scalar _tmp61 = Scalar(1.0) * _tmp60;
  const Scalar _tmp62 = _tmp36 + _tmp45;
  ...
  const Scalar _tmp70 = Scalar(19.620000000000001) - fv1;
  ...
  const Scalar _tmp79 = -_tmp30 * _tmp76 + _tmp78;
  const Scalar _tmp80 = _tmp72 + _tmp73 - _tmp74;
  const Scalar _tmp81 = _tmp31 * _tmp76 - _tmp40 * _tmp78;
  const Scalar _tmp82 = _tmp50 * _tmp77;
  const Scalar _tmp83 = Scalar(1.0) * _tmp33;
  const Scalar _tmp84 = Scalar(1.0) * _tmp37;
  const Scalar _tmp85 = (-_tmp26 + _tmp84) / (_tmp16 - _tmp83);
  const Scalar _tmp86 = -_tmp50 * _tmp80 - _tmp53 * _tmp79 + _tmp82 -
                        _tmp85 * (-_tmp40 * _tmp82 + _tmp51 * _tmp80 - _tmp53 * _tmp81);
  const Scalar _tmp87 = Scalar(1.0) / (_tmp86);
  const Scalar _tmp88 = _tmp83 * _tmp85 + _tmp84;
  const Scalar _tmp89 = 0;
  const Scalar _tmp90 = _tmp53 * _tmp89;
  const Scalar _tmp91 = _tmp56 * (-_tmp30 * _tmp90 + _tmp50 * _tmp89);
  const Scalar _tmp92 = _tmp41 * _tmp81;
  const Scalar _tmp93 = _tmp41 * _tmp79;
  const Scalar _tmp94 = Scalar(1.0) * _tmp85 * _tmp92 - Scalar(1.0) * _tmp93;
  const Scalar _tmp95 = _tmp59 * _tmp87;
  const Scalar _tmp96 = _tmp60 * _tmp86;
  const Scalar _tmp97 = _tmp94 + _tmp96 * (-Scalar(1.0) * _tmp58 - _tmp94 * _tmp95);
  const Scalar _tmp98 = _tmp50 * _tmp87;
  const Scalar _tmp99 = _tmp52 * _tmp87;
  const Scalar _tmp100 = -_tmp97 * _tmp99 + Scalar(1.0);
  const Scalar _tmp101 = _tmp30 * _tmp41;
  const Scalar _tmp102 = _tmp67 * fh1;
  const Scalar _tmp103 = _tmp40 * _tmp93 - _tmp77 - _tmp85 * (_tmp40 * _tmp77 + _tmp40 * _tmp92);
  const Scalar _tmp104 = _tmp103 + _tmp96 * (-_tmp103 * _tmp95 + _tmp40 * _tmp58 - _tmp57);
  const Scalar _tmp105 = -_tmp104 * _tmp99 - _tmp40;
  const Scalar _tmp106 = _tmp68 * fh1;
  const Scalar _tmp107 = _tmp70 * _tmp89;
  ...
  _res(1, 0) =
      -_tmp91 *
      std::exp(_tmp102 * _tmp56 * (_tmp100 * _tmp101 + _tmp97 * _tmp98) +
               _tmp106 * _tmp56 * (_tmp101 * _tmp105 + _tmp104 * _tmp98 + Scalar(1.0)) +
               _tmp56 * _tmp69 * (-_tmp30 * _tmp53 * _tmp61 + _tmp50 * _tmp61) + _tmp70 * _tmp91);
  _res(2, 0) = -_tmp90 * std::exp(-_tmp100 * _tmp102 * _tmp41 - _tmp105 * _tmp106 * _tmp41 +
                                  _tmp107 * _tmp53 + _tmp108 * _tmp53);
  _res(3, 0) = _tmp89 * std::exp(-_tmp102 * _tmp87 * _tmp97 - _tmp104 * _tmp106 * _tmp87 - _tmp107 -
                                 _tmp108);
