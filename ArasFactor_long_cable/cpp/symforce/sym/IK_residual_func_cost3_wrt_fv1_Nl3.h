...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl3(
  ...
  const Scalar _tmp45 = -Scalar(0.010999999999999999) * _tmp18 -
  ...
  const Scalar _tmp59 = _tmp13 - _tmp9;
  ...
  const Scalar _tmp84 = -_tmp33 - _tmp81 * _tmp83;
  const Scalar _tmp85 = _tmp43 * _tmp44;
  const Scalar _tmp86 = _tmp37 + _tmp63;
  ...
  const Scalar _tmp94 = _tmp55 * _tmp57 + _tmp56;
  const Scalar _tmp95 = 0;
  const Scalar _tmp96 = _tmp71 * _tmp95;
  const Scalar _tmp97 = _tmp31 * (-_tmp43 * _tmp96 + _tmp68 * _tmp95);
  ...
  const Scalar _tmp101 = -Scalar(1.0) * _tmp52 + Scalar(1.0) * _tmp54 * _tmp57;
  const Scalar _tmp102 = _tmp101 + _tmp80 * (-_tmp101 * _tmp77 - Scalar(1.0) * _tmp78);
  const Scalar _tmp103 = -_tmp102 * _tmp83 + Scalar(1.0);
  const Scalar _tmp104 = _tmp99 * fh1;
  ...
  _res(0, 0) = 0;
  _res(1, 0) =
      -_tmp97 * std::exp(_tmp100 * _tmp31 * (-_tmp43 * _tmp71 * _tmp98 + _tmp68 * _tmp98) +
                         _tmp104 * _tmp31 * (_tmp102 * _tmp82 + _tmp103 * _tmp85) +
                         _tmp31 * _tmp92 * (_tmp81 * _tmp82 + _tmp84 * _tmp85 + Scalar(1.0)) +
                         _tmp93 * _tmp97);
  _res(2, 0) = -_tmp96 * std::exp(-_tmp103 * _tmp104 * _tmp44 + _tmp105 * _tmp71 +
                                  _tmp106 * _tmp71 - _tmp44 * _tmp84 * _tmp92);
  _res(3, 0) =
      _tmp95 * std::exp(-_tmp102 * _tmp104 * _tmp74 - _tmp105 - _tmp106 - _tmp74 * _tmp81 * _tmp92);
