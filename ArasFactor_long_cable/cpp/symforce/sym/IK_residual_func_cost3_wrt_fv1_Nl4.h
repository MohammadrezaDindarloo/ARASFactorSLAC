...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl4(
  ...
  const Scalar _tmp56 = Scalar(1.0) / (_tmp40 * _tmp55 - _tmp53);
  const Scalar _tmp57 = _tmp30 * _tmp55 - _tmp31;
  ...
  const Scalar _tmp62 = _tmp36 + _tmp44;
  const Scalar _tmp63 = _tmp32 + _tmp41;
  const Scalar _tmp64 = _tmp34 + _tmp63;
  const Scalar _tmp65 = _tmp46 + _tmp62;
  ...
  const Scalar _tmp80 = -_tmp40 * _tmp79 + _tmp53 * _tmp78;
  ...
  const Scalar _tmp84 = _tmp40 * _tmp76 - _tmp40 * _tmp78;
  const Scalar _tmp85 = -_tmp30 * _tmp75 - _tmp58 * _tmp84 + _tmp77 -
                        _tmp83 * (_tmp31 * _tmp75 - _tmp55 * _tmp77 - _tmp58 * _tmp80);
  const Scalar _tmp86 = Scalar(1.0) / (_tmp85);
  const Scalar _tmp87 = _tmp81 + _tmp82 * _tmp83;
  const Scalar _tmp88 = 0;
  const Scalar _tmp89 = _tmp58 * _tmp88;
  const Scalar _tmp90 = _tmp51 * (_tmp30 * _tmp88 - _tmp40 * _tmp89);
  const Scalar _tmp91 = Scalar(1.0) * _tmp56;
  const Scalar _tmp92 = _tmp80 * _tmp83 * _tmp91 - _tmp84 * _tmp91;
  const Scalar _tmp93 = _tmp59 * _tmp86;
  const Scalar _tmp94 = _tmp60 * _tmp85;
  const Scalar _tmp95 = _tmp92 + _tmp94 * (-_tmp54 * _tmp91 - _tmp92 * _tmp93);
  const Scalar _tmp96 = _tmp57 * _tmp86;
  const Scalar _tmp97 = -_tmp95 * _tmp96 + Scalar(1.0);
  const Scalar _tmp98 = _tmp40 * _tmp56;
  const Scalar _tmp99 = _tmp30 * _tmp86;
  const Scalar _tmp100 = _tmp67 * fh1;
  const Scalar _tmp101 = _tmp55 * _tmp56;
  const Scalar _tmp102 = _tmp101 * _tmp84 - _tmp76 - _tmp83 * (_tmp101 * _tmp80 + _tmp79);
  const Scalar _tmp103 = _tmp102 + _tmp94 * (_tmp101 * _tmp54 - _tmp102 * _tmp93 - _tmp52);
  const Scalar _tmp104 = -_tmp103 * _tmp96 - _tmp55;
  ...
  _res(1, 0) =
      -_tmp90 *
      std::exp(_tmp100 * _tmp51 * (_tmp95 * _tmp99 + _tmp97 * _tmp98) +
               _tmp105 * _tmp51 * (_tmp103 * _tmp99 + _tmp104 * _tmp98 + Scalar(1.0)) +
               _tmp51 * _tmp69 * (_tmp30 * _tmp61 - _tmp40 * _tmp58 * _tmp61) + _tmp70 * _tmp90);
  _res(2, 0) = -_tmp89 * std::exp(-_tmp100 * _tmp56 * _tmp97 - _tmp104 * _tmp105 * _tmp56 +
