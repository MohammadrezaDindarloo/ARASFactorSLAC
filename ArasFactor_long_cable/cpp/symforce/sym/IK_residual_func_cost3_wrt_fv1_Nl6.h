...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl6(
  ...
  const Scalar _tmp96 = _tmp46 * _tmp55;
  const Scalar _tmp97 = -_tmp48 - _tmp54 * (_tmp46 * _tmp48 + _tmp51 * _tmp96) + _tmp57 * _tmp96;
  const Scalar _tmp98 = _tmp80 * (-_tmp75 + _tmp76 * _tmp96 - _tmp78 * _tmp97) + _tmp97;
  const Scalar _tmp99 = -_tmp46 - _tmp83 * _tmp98;
  const Scalar _tmp100 = Scalar(19.620000000000001) - fv1;
  const Scalar _tmp101 = _tmp52 + _tmp53 * _tmp54;
  const Scalar _tmp102 = 0;
  const Scalar _tmp103 = _tmp102 * _tmp69;
  const Scalar _tmp104 = _tmp74 * (_tmp102 * _tmp65 - _tmp103 * _tmp49);
  ...
  _res(1, 0) =
      -_tmp104 *
      std::exp(_tmp100 * _tmp104 + _tmp74 * _tmp95 * (-_tmp49 * _tmp69 * _tmp93 + _tmp65 * _tmp93) +
               _tmp91 * _tmp92 * (_tmp81 * _tmp82 + _tmp84 * _tmp85) +
               _tmp92 * _tmp94 * (_tmp82 * _tmp98 + _tmp85 * _tmp99 + Scalar(1.0)));
  _res(2, 0) = -_tmp103 * std::exp(-_tmp105 * _tmp84 * _tmp91 - _tmp105 * _tmp94 * _tmp99 +
                                   _tmp106 * _tmp69 + _tmp107 * _tmp69);
  _res(3, 0) = _tmp102 *
               std::exp(-_tmp106 - _tmp107 - _tmp108 * _tmp81 * _tmp91 - _tmp108 * _tmp94 * _tmp98);
