...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl10(
  ...
  const Scalar _tmp65 = _tmp5 + _tmp52;
  ...
  const Scalar _tmp74 = Scalar(1.0) / (_tmp61 * _tmp72 - _tmp73);
  ...
  const Scalar _tmp79 = -_tmp62 * _tmp72 + _tmp63 * _tmp73;
  const Scalar _tmp80 = _tmp49 * _tmp75 - _tmp72 * _tmp78 - _tmp77 * _tmp79;
  ...
  const Scalar _tmp87 = -_tmp47 * _tmp49 - _tmp64 * _tmp77 + _tmp78 - _tmp80 * _tmp86;
  ...
  const Scalar _tmp95 = _tmp93 * (-_tmp65 * _tmp70 * _tmp94 + _tmp67 * _tmp68 * _tmp94);
  const Scalar _tmp96 = _tmp53 * _tmp61 - _tmp57 * _tmp73 + _tmp61 * _tmp95;
  const Scalar _tmp97 = _tmp39 * _tmp47 - _tmp43 * _tmp75 + _tmp47 * _tmp95 - _tmp77 * _tmp96;
  ...
  const Scalar _tmp105 = fh1 * (_tmp103 * _tmp29 - _tmp104 * _tmp19);
  const Scalar _tmp106 = Scalar(1.0) * _tmp74;
  const Scalar _tmp107 = Scalar(1.0) * _tmp83;
  const Scalar _tmp108 = -_tmp106 * _tmp64 + _tmp107 * _tmp74 * _tmp79 * _tmp85;
  ...
  const Scalar _tmp112 = _tmp88 * (_tmp108 + _tmp111);
  const Scalar _tmp113 = -_tmp112 * _tmp76 + Scalar(1.0);
  const Scalar _tmp114 = _tmp61 * _tmp74;
  const Scalar _tmp115 = _tmp103 * fh1;
  const Scalar _tmp116 = _tmp72 * _tmp74;
  const Scalar _tmp117 = _tmp116 * _tmp79 + _tmp51 * _tmp72;
  const Scalar _tmp118 = _tmp116 * _tmp64 - _tmp117 * _tmp86 - _tmp51;
  const Scalar _tmp119 = _tmp110 * (-_tmp109 * _tmp118 + _tmp116 * _tmp96 - _tmp95);
  const Scalar _tmp120 = _tmp88 * (_tmp118 + _tmp119);
  const Scalar _tmp121 = -_tmp120 * _tmp76 - _tmp72;
  const Scalar _tmp122 = _tmp104 * fh1;
  const Scalar _tmp123 = -_tmp105 * _tmp93 * (_tmp47 * _tmp99 - _tmp91 * _tmp99) -
                         _tmp115 * _tmp93 * (_tmp112 * _tmp47 + _tmp113 * _tmp114) -
                         _tmp122 * _tmp93 * (_tmp114 * _tmp121 + _tmp120 * _tmp47 + Scalar(1.0)) -
                         _tmp38 * _tmp93 * (_tmp47 * _tmp90 - _tmp90 * _tmp91);
  const Scalar _tmp124 = Scalar(1.0) / (_tmp123);
  const Scalar _tmp125 = _tmp39 + _tmp82;
  ...
  const Scalar _tmp132 = -_tmp103 * _tmp131 - Scalar(2.3544) * _tmp13 - _tmp19 * fv1;
  const Scalar _tmp133 = _tmp110 * _tmp128;
  const Scalar _tmp134 = _tmp125 * _tmp133 - _tmp80 * _tmp99;
  const Scalar _tmp135 = _tmp125 * _tmp127;
  const Scalar _tmp136 = _tmp117 + _tmp119 * _tmp135 - _tmp120 * _tmp80;
  const Scalar _tmp137 = _tmp125 * _tmp83;
  const Scalar _tmp138 = _tmp104 * _tmp131 + Scalar(2.3544) * _tmp25 + _tmp29 * fv1;
  const Scalar _tmp139 = _tmp127 * _tmp89;
  const Scalar _tmp140 = -_tmp125 * _tmp139 - _tmp80 * _tmp90 + _tmp82;
  const Scalar _tmp141 = -_tmp106 * _tmp79 + _tmp111 * _tmp135 - _tmp112 * _tmp80;
  const Scalar _tmp142 = std::asinh(
      _tmp124 * (Scalar(1.0) * _tmp105 * (-_tmp107 * _tmp134 + _tmp133) +
                 Scalar(1.0) * _tmp115 * (-_tmp107 * _tmp141 + _tmp111 * _tmp128) +
                 Scalar(1.0) * _tmp122 * (-_tmp107 * _tmp136 + _tmp119 * _tmp128) +
                 Scalar(1.0) * _tmp132 * (-_tmp107 * _tmp130 + _tmp129) +
                 Scalar(1.0) * _tmp138 * (_tmp128 * _tmp137 - _tmp128) +
                 Scalar(1.0) * _tmp38 * (-_tmp107 * _tmp140 - _tmp128 * _tmp89 + Scalar(1.0))));
  const Scalar _tmp143 = Scalar(9.6622558468725703) * _tmp123;
  const Scalar _tmp144 = _tmp105 * _tmp99;
  const Scalar _tmp145 = _tmp38 * _tmp90;
  const Scalar _tmp146 =
      _tmp113 * _tmp115 * _tmp74 + _tmp121 * _tmp122 * _tmp74 - _tmp144 * _tmp77 - _tmp145 * _tmp77;
  const Scalar _tmp147 = Scalar(1.0) / (_tmp146);
  const Scalar _tmp148 = _tmp128 * _tmp138;
  const Scalar _tmp149 =
      std::asinh(_tmp147 * (_tmp105 * _tmp134 * _tmp83 + _tmp115 * _tmp141 * _tmp83 +
                            _tmp122 * _tmp136 * _tmp83 + _tmp130 * _tmp132 * _tmp83 -
                            _tmp137 * _tmp148 + _tmp140 * _tmp38 * _tmp83));
  const Scalar _tmp150 = Scalar(9.6622558468725703) * _tmp146;
  const Scalar _tmp151 = _tmp112 * _tmp115 + _tmp120 * _tmp122 + _tmp144 + _tmp145;
  const Scalar _tmp152 = Scalar(1.0) / (_tmp151);
  const Scalar _tmp153 = std::asinh(_tmp152 * (-_tmp105 * _tmp133 - _tmp111 * _tmp115 * _tmp127 -
                                               _tmp119 * _tmp122 * _tmp127 - _tmp129 * _tmp132 +
                                               _tmp139 * _tmp38 + _tmp148));
                ...
                Scalar(125.0) * std::sqrt(Scalar(
                                    Scalar(0.77439999999999998) *
                                        std::pow(Scalar(1 - Scalar(0.0090909090909090905) * _tmp66),
                                                 Scalar(2)) +
                                    std::pow(Scalar(-Scalar(0.0080000000000000002) * _tmp69 - 1),
                                             Scalar(2))))))) +
      _tmp51 + position_vector(2, 0);
  _res(2, 0) =
      -_tmp150 *
          (Scalar(4.967784) * _tmp147 + std::cosh(Scalar(1.0) * _tmp149) -
           std::cosh(Scalar(0.1034955) * _tmp147 *
                     (-_tmp149 * _tmp150 -
                      Scalar(125.0) *
                          std::sqrt(Scalar(
                              Scalar(0.77439999999999998) *
                                  std::pow(Scalar(-Scalar(0.0090909090909090905) * _tmp54 - 1),
                                           Scalar(2)) +
                              std::pow(Scalar(-Scalar(0.0080000000000000002) * _tmp58 - 1),
                                       Scalar(2))))))) +
