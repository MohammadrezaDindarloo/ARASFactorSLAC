...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl12(
  ...
  const Scalar _tmp36 = _tmp28 + Scalar(-110.0);
  const Scalar _tmp37 = _tmp18 + Scalar(-125.0);
  ...
  const Scalar _tmp41 = Scalar(2.3544) * _tmp10 + _tmp17 * fv1 + _tmp39 * _tmp40;
  ...
  const Scalar _tmp63 = _tmp47 + position_vector(1, 0);
  const Scalar _tmp64 = _tmp63 + Scalar(110.0);
  const Scalar _tmp65 = _tmp54 + position_vector(0, 0);
  ...
  const Scalar _tmp69 = _tmp44 + position_vector(1, 0);
  ...
  const Scalar _tmp77 = _tmp76 * (-_tmp44 * _tmp72 * _tmp74 + _tmp55 * _tmp70 * _tmp74);
  const Scalar _tmp78 = _tmp64 * _tmp67;
  const Scalar _tmp79 = _tmp47 * _tmp68 - _tmp54 * _tmp78 + _tmp68 * _tmp77;
  const Scalar _tmp80 = _tmp70 * _tmp75;
  const Scalar _tmp81 = Scalar(1.0) / (_tmp68 * _tmp80 - _tmp78);
  ...
  const Scalar _tmp88 = _tmp78 * _tmp84 - _tmp80 * _tmp87;
  const Scalar _tmp89 = Scalar(1.0) * _tmp48;
  const Scalar _tmp90 = -_tmp68 * _tmp84 + _tmp87;
  const Scalar _tmp91 = _tmp57 * _tmp81 * _tmp88 * _tmp89 - _tmp82 * _tmp90;
  const Scalar _tmp92 = _tmp34 + _tmp85;
  const Scalar _tmp93 = _tmp52 + position_vector(0, 0);
  const Scalar _tmp94 = _tmp93 + Scalar(125.0);
  const Scalar _tmp95 = _tmp49 + position_vector(1, 0);
  ...
  const Scalar _tmp101 = -_tmp100 + _tmp80 * _tmp98;
  const Scalar _tmp102 = _tmp101 * _tmp81;
  const Scalar _tmp103 = _tmp100 * _tmp92 - _tmp102 * _tmp88 - _tmp80 * _tmp99;
  const Scalar _tmp104 = -_tmp102 * _tmp90 - _tmp103 * _tmp58 - _tmp92 * _tmp98 + _tmp99;
  const Scalar _tmp105 = Scalar(1.0) / (_tmp104);
  const Scalar _tmp106 = -_tmp100 * _tmp52 - _tmp102 * _tmp79 + _tmp49 * _tmp98 + _tmp77 * _tmp98;
  ...
  const Scalar _tmp111 = _tmp50 * _tmp60;
  const Scalar _tmp112 = _tmp105 * (_tmp110 + _tmp91);
  const Scalar _tmp113 = -_tmp103 * _tmp112 + _tmp110 * _tmp111 - _tmp82 * _tmp88;
  const Scalar _tmp114 = _tmp36 * _tmp38;
  const Scalar _tmp115 = _tmp114 * fh1;
  const Scalar _tmp116 = _tmp109 * _tmp61;
  const Scalar _tmp117 = Scalar(1.0) * _tmp108;
  const Scalar _tmp118 = -_tmp103 * _tmp117 + _tmp109 * _tmp62;
  const Scalar _tmp119 = fh1 * (_tmp114 * _tmp17 - _tmp27 * _tmp39);
  const Scalar _tmp120 = Scalar(19.620000000000001) - fv1;
  const Scalar _tmp121 = _tmp45 * _tmp58 + _tmp56;
  const Scalar _tmp122 = 0;
  const Scalar _tmp123 = _tmp121 * _tmp60;
  const Scalar _tmp124 = -_tmp103 * _tmp122 - _tmp123 * _tmp50 + _tmp46;
  const Scalar _tmp125 = _tmp58 * _tmp61;
  const Scalar _tmp126 = _tmp59 * _tmp61 + Scalar(1.0);
  const Scalar _tmp127 = -_tmp114 * _tmp40 - Scalar(2.3544) * _tmp23 - _tmp27 * fv1;
  const Scalar _tmp128 = _tmp80 * _tmp81;
  const Scalar _tmp129 = _tmp128 * _tmp88 + _tmp80 * _tmp86;
  const Scalar _tmp130 = _tmp128 * _tmp90 - _tmp129 * _tmp58 - _tmp86;
  const Scalar _tmp131 = _tmp109 * (-_tmp107 * _tmp130 + _tmp128 * _tmp79 - _tmp77);
  const Scalar _tmp132 = _tmp105 * (_tmp130 + _tmp131);
  const Scalar _tmp133 = -_tmp103 * _tmp132 + _tmp111 * _tmp131 + _tmp129;
  const Scalar _tmp134 = _tmp39 * fh1;
  const Scalar _tmp135 = _tmp101 * _tmp108 * _tmp82;
  const Scalar _tmp136 = -_tmp101 * _tmp112 + Scalar(1.0);
  const Scalar _tmp137 = _tmp68 * _tmp81;
  const Scalar _tmp138 = -_tmp101 * _tmp132 - _tmp80;
  const Scalar _tmp139 = -_tmp115 * _tmp76 * (_tmp112 * _tmp98 + _tmp136 * _tmp137) -
                         _tmp119 * _tmp76 * (_tmp117 * _tmp98 - _tmp135 * _tmp68) -
                         _tmp120 * _tmp76 * (-_tmp102 * _tmp122 * _tmp68 + _tmp122 * _tmp98) -
                         _tmp134 * _tmp76 * (_tmp132 * _tmp98 + _tmp137 * _tmp138 + Scalar(1.0));
  const Scalar _tmp140 = Scalar(1.0) / (_tmp139);
  const Scalar _tmp141 = std::asinh(
      _tmp140 * (Scalar(1.0) * _tmp115 * (_tmp110 * _tmp61 - _tmp113 * _tmp89) +
                 Scalar(1.0) * _tmp119 * (_tmp116 - _tmp118 * _tmp89) +
                 Scalar(1.0) * _tmp120 * (-_tmp121 * _tmp61 - _tmp124 * _tmp89 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp127 * (_tmp125 - _tmp126 * _tmp89) +
                 Scalar(1.0) * _tmp134 * (_tmp131 * _tmp61 - _tmp133 * _tmp89) +
                 Scalar(1.0) * _tmp41 * (_tmp48 * _tmp62 - _tmp61)));
  const Scalar _tmp142 = Scalar(9.6622558468725703) * _tmp139;
  const Scalar _tmp143 = _tmp120 * _tmp122;
  const Scalar _tmp144 = -_tmp102 * _tmp143 + _tmp115 * _tmp136 * _tmp81 - _tmp119 * _tmp135 +
                         _tmp134 * _tmp138 * _tmp81;
  const Scalar _tmp145 = Scalar(1.0) / (_tmp144);
  const Scalar _tmp146 = _tmp41 * _tmp61;
  const Scalar _tmp147 =
      std::asinh(_tmp145 * (_tmp113 * _tmp115 * _tmp48 + _tmp118 * _tmp119 * _tmp48 +
                            _tmp120 * _tmp124 * _tmp48 + _tmp126 * _tmp127 * _tmp48 +
                            _tmp133 * _tmp134 * _tmp48 - _tmp146 * _tmp48 * _tmp50));
  const Scalar _tmp148 = Scalar(9.6622558468725703) * _tmp144;
  const Scalar _tmp149 = _tmp112 * _tmp115 + _tmp117 * _tmp119 + _tmp132 * _tmp134 + _tmp143;
  const Scalar _tmp150 = Scalar(1.0) / (_tmp149);
  const Scalar _tmp151 =
      std::asinh(_tmp150 * (-_tmp110 * _tmp115 * _tmp60 - _tmp116 * _tmp119 + _tmp120 * _tmp123 -
                            _tmp125 * _tmp127 - _tmp131 * _tmp134 * _tmp60 + _tmp146));
  ...
  _res(1, 0) =
      -_tmp142 *
          (Scalar(4.967784) * _tmp140 + std::cosh(Scalar(1.0) * _tmp141) -
           std::cosh(Scalar(0.1034955) * _tmp140 *
                     (-_tmp141 * _tmp142 -
                      Scalar(125.0) *
                          std::sqrt(Scalar(
                              Scalar(0.77439999999999998) *
                                  std::pow(Scalar(-Scalar(0.0090909090909090905) * _tmp69 - 1),
                                           Scalar(2)) +
  ...
  _res(2, 0) =
      -_tmp148 *
          (Scalar(4.967784) * _tmp145 + std::cosh(Scalar(1.0) * _tmp147) -
           std::cosh(
               ...
               (-_tmp147 * _tmp148 -
                Scalar(125.0) *
                    std::sqrt(Scalar(
                        ...
                        Scalar(0.77439999999999998) *
                            std::pow(Scalar(-Scalar(0.0090909090909090905) * _tmp63 - 1),
                                     Scalar(2))))))) +
           ...
           std::cosh(
               ...
               (-_tmp151 * _tmp152 -
                Scalar(125.0) * std::sqrt(Scalar(
                                    Scalar(0.77439999999999998) *
                                        std::pow(Scalar(1 - Scalar(0.0090909090909090905) * _tmp95),
                                                 Scalar(2)) +
                                    std::pow(Scalar(-Scalar(0.0080000000000000002) * _tmp93 - 1),
                                             Scalar(2))))))) +
