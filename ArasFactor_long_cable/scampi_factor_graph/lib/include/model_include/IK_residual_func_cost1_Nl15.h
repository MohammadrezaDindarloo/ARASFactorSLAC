...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl15(
  ...
  const Scalar _tmp84 = Scalar(19.620000000000001) - fv1;
  ...
  const Scalar _tmp99 = _tmp72 * (_tmp67 * _tmp86 - _tmp67 * _tmp89);
  const Scalar _tmp100 = _tmp47 * _tmp86 - _tmp47 * _tmp88 - _tmp71 * _tmp99 - _tmp92 * _tmp98;
  ...
  const Scalar _tmp105 = _tmp69 * _tmp72;
  const Scalar _tmp106 = _tmp105 * _tmp91 + _tmp90;
  const Scalar _tmp107 = -_tmp106 * _tmp98 + _tmp69 * _tmp99 - _tmp86;
  const Scalar _tmp108 = _tmp101 * _tmp74;
  const Scalar _tmp109 = _tmp100 * _tmp75;
  const Scalar _tmp110 = _tmp109 * (_tmp105 * _tmp68 - _tmp107 * _tmp108 - _tmp58);
  const Scalar _tmp111 = _tmp107 + _tmp110;
  const Scalar _tmp112 = _tmp101 * _tmp71;
  const Scalar _tmp113 = -_tmp111 * _tmp112 - _tmp69;
  const Scalar _tmp114 = _tmp67 * _tmp72;
  const Scalar _tmp115 = _tmp101 * _tmp47;
  const Scalar _tmp116 = _tmp81 * fh1;
  const Scalar _tmp117 = Scalar(1.0) * _tmp95;
  const Scalar _tmp118 = _tmp117 * _tmp72 * _tmp91 * _tmp97 - Scalar(1.0) * _tmp99;
  const Scalar _tmp119 = Scalar(1.0) * _tmp72;
  const Scalar _tmp120 = _tmp109 * (-_tmp108 * _tmp118 - _tmp119 * _tmp68);
  const Scalar _tmp121 = _tmp118 + _tmp120;
  const Scalar _tmp122 = -_tmp112 * _tmp121 + Scalar(1.0);
  const Scalar _tmp123 = _tmp82 * fh1;
  const Scalar _tmp124 = -_tmp116 * _tmp57 * (_tmp111 * _tmp115 + _tmp113 * _tmp114 + Scalar(1.0)) -
                         _tmp123 * _tmp57 * (_tmp114 * _tmp122 + _tmp115 * _tmp121) -
                         _tmp57 * _tmp83 * (_tmp47 * _tmp76 - _tmp76 * _tmp77) -
                         _tmp57 * _tmp84 * (_tmp104 * _tmp47 - _tmp104 * _tmp77);
  const Scalar _tmp125 = Scalar(1.0) / (_tmp124);
  const Scalar _tmp126 = _tmp38 + _tmp94;
  const Scalar _tmp127 = _tmp126 * _tmp98;
  const Scalar _tmp128 = Scalar(1.0) / (-_tmp127 - _tmp43 + _tmp96);
  const Scalar _tmp129 = Scalar(1.0) * _tmp128;
  const Scalar _tmp130 = _tmp101 * _tmp92;
  const Scalar _tmp131 = _tmp102 * _tmp128;
  const Scalar _tmp132 = -_tmp103 * _tmp130 - _tmp126 * _tmp131 + _tmp94;
  const Scalar _tmp133 = _tmp126 * _tmp128;
  const Scalar _tmp134 = -_tmp119 * _tmp91 + _tmp120 * _tmp133 - _tmp121 * _tmp130;
  const Scalar _tmp135 = _tmp109 * _tmp129;
  const Scalar _tmp136 = _tmp126 * _tmp135 - _tmp76 * _tmp92;
  const Scalar _tmp137 = _tmp35 * fh1;
  const Scalar _tmp138 = Scalar(2.3544) * _tmp11 + _tmp137 * _tmp81 + _tmp17 * fv1;
  const Scalar _tmp139 = _tmp126 * _tmp95;
  const Scalar _tmp140 = _tmp127 * _tmp129 + Scalar(1.0);
  const Scalar _tmp141 = _tmp129 * _tmp98;
  const Scalar _tmp142 = -_tmp137 * _tmp82 - Scalar(2.3544) * _tmp22 - _tmp27 * fv1;
  const Scalar _tmp143 = _tmp106 + _tmp110 * _tmp133 - _tmp111 * _tmp130;
  const Scalar _tmp144 = std::asinh(
      _tmp125 * (Scalar(1.0) * _tmp116 * (_tmp110 * _tmp129 - _tmp117 * _tmp143) +
                 Scalar(1.0) * _tmp123 * (-_tmp117 * _tmp134 + _tmp120 * _tmp129) +
                 Scalar(1.0) * _tmp138 * (_tmp129 * _tmp139 - _tmp129) +
                 Scalar(1.0) * _tmp142 * (-_tmp117 * _tmp140 + _tmp141) +
                 Scalar(1.0) * _tmp83 * (-_tmp117 * _tmp136 + _tmp135) +
                 Scalar(1.0) * _tmp84 * (-_tmp102 * _tmp129 - _tmp117 * _tmp132 + Scalar(1.0))));
  const Scalar _tmp145 = Scalar(9.6622558468725703) * _tmp124;
  const Scalar _tmp146 = _tmp129 * _tmp138;
  const Scalar _tmp147 = _tmp76 * _tmp83;
  const Scalar _tmp148 = _tmp104 * _tmp84;
  const Scalar _tmp149 =
      _tmp113 * _tmp116 * _tmp72 + _tmp122 * _tmp123 * _tmp72 - _tmp147 * _tmp73 - _tmp148 * _tmp73;
  const Scalar _tmp150 = Scalar(1.0) / (_tmp149);
  const Scalar _tmp151 =
      std::asinh(_tmp150 * (_tmp116 * _tmp143 * _tmp95 + _tmp123 * _tmp134 * _tmp95 +
                            _tmp132 * _tmp84 * _tmp95 + _tmp136 * _tmp83 * _tmp95 -
                            _tmp139 * _tmp146 + _tmp140 * _tmp142 * _tmp95));
  const Scalar _tmp152 = Scalar(9.6622558468725703) * _tmp149;
  const Scalar _tmp153 =
      _tmp101 * _tmp111 * _tmp116 + _tmp101 * _tmp121 * _tmp123 + _tmp147 + _tmp148;
  const Scalar _tmp154 = Scalar(1.0) / (_tmp153);
  const Scalar _tmp155 =
      std::asinh(_tmp154 * (-_tmp110 * _tmp116 * _tmp128 - _tmp120 * _tmp123 * _tmp128 +
                            _tmp131 * _tmp84 - _tmp135 * _tmp83 - _tmp141 * _tmp142 + _tmp146));
