...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl23(
  ...
  const Scalar _tmp42 = Scalar(2.3544) * _tmp15 + _tmp18 * fv1 + _tmp40 * _tmp41;
  ...
  const Scalar _tmp64 = _tmp50 + position_vector(1, 0);
  ...
  const Scalar _tmp76 = _tmp67 * _tmp68;
  const Scalar _tmp77 = Scalar(1.0) / (-_tmp69 + _tmp75 * _tmp76);
  const Scalar _tmp78 = -_tmp32;
  const Scalar _tmp79 = _tmp33 + _tmp34;
  const Scalar _tmp80 = _tmp78 + _tmp79;
  const Scalar _tmp81 = _tmp32 + _tmp79;
  const Scalar _tmp82 = _tmp76 * _tmp81;
  const Scalar _tmp83 = _tmp69 * _tmp80 - _tmp75 * _tmp82;
  const Scalar _tmp84 = Scalar(1.0) * _tmp51;
  const Scalar _tmp85 = -_tmp76 * _tmp80 + _tmp82;
  const Scalar _tmp86 = Scalar(1.0) * _tmp77;
  const Scalar _tmp87 = _tmp57 * _tmp77 * _tmp83 * _tmp84 - _tmp85 * _tmp86;
  ...
  const Scalar _tmp95 = _tmp75 * _tmp93 - _tmp94;
  const Scalar _tmp96 = _tmp77 * _tmp95;
  const Scalar _tmp97 = _tmp35 + _tmp78;
  const Scalar _tmp98 = _tmp81 * _tmp93;
  const Scalar _tmp99 = -_tmp75 * _tmp98 - _tmp83 * _tmp96 + _tmp94 * _tmp97;
  ...
  const Scalar _tmp104 = _tmp102 * _tmp74;
  const Scalar _tmp105 = _tmp104 * (-_tmp103 * _tmp44 * _tmp73 + _tmp103 * _tmp55 * _tmp71);
  const Scalar _tmp106 = _tmp105 * _tmp76 + _tmp50 * _tmp76 - _tmp54 * _tmp69;
  ...
  const Scalar _tmp115 = _tmp111 * _tmp114 - _tmp112 * _tmp113 - _tmp83 * _tmp86;
  const Scalar _tmp116 = _tmp38 * _tmp39;
  const Scalar _tmp117 = _tmp116 * fh1;
  const Scalar _tmp118 = _tmp75 * _tmp77;
  const Scalar _tmp119 = _tmp118 * _tmp83 + _tmp75 * _tmp81;
  const Scalar _tmp120 = _tmp118 * _tmp85 - _tmp119 * _tmp58 - _tmp81;
  const Scalar _tmp121 = _tmp110 * (-_tmp105 + _tmp106 * _tmp118 - _tmp108 * _tmp120);
  const Scalar _tmp122 = _tmp120 + _tmp121;
  const Scalar _tmp123 = -_tmp113 * _tmp122 + _tmp114 * _tmp121 + _tmp119;
  const Scalar _tmp124 = _tmp40 * fh1;
  const Scalar _tmp125 = -_tmp116 * _tmp41 - Scalar(2.3544) * _tmp24 - _tmp28 * fv1;
  const Scalar _tmp126 = _tmp59 * _tmp62 + Scalar(1.0);
  ...
  const Scalar _tmp131 = -_tmp129 * _tmp49 - _tmp130 * _tmp99 + _tmp46;
  ...
  const Scalar _tmp135 = fh1 * (_tmp116 * _tmp18 - _tmp28 * _tmp40);
  ...
  const Scalar _tmp140 = _tmp76 * _tmp77;
  const Scalar _tmp141 = -_tmp122 * _tmp138 - _tmp75;
  const Scalar _tmp142 = -_tmp104 * _tmp117 * (_tmp112 * _tmp137 + _tmp139 * _tmp140) -
                         _tmp104 * _tmp124 * (_tmp122 * _tmp137 + _tmp140 * _tmp141 + Scalar(1.0)) -
                         _tmp104 * _tmp127 * (-_tmp130 * _tmp76 * _tmp96 + _tmp130 * _tmp93) -
                         _tmp104 * _tmp135 * (_tmp133 * _tmp93 - _tmp136 * _tmp76);
  const Scalar _tmp143 = Scalar(1.0) / (_tmp142);
  const Scalar _tmp144 = std::asinh(
      _tmp143 * (Scalar(1.0) * _tmp117 * (_tmp111 * _tmp62 - _tmp115 * _tmp84) +
                 Scalar(1.0) * _tmp124 * (_tmp121 * _tmp62 - _tmp123 * _tmp84) +
                 Scalar(1.0) * _tmp125 * (-_tmp126 * _tmp84 + _tmp58 * _tmp62) +
                 Scalar(1.0) * _tmp127 * (-_tmp128 * _tmp62 - _tmp131 * _tmp84 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp135 * (_tmp132 - _tmp134 * _tmp84) +
                 Scalar(1.0) * _tmp42 * (_tmp62 * _tmp63 - _tmp62)));
  const Scalar _tmp145 = Scalar(9.6622558468725703) * _tmp142;
  const Scalar _tmp146 = _tmp127 * _tmp130;
  const Scalar _tmp147 = _tmp117 * _tmp139 * _tmp77 + _tmp124 * _tmp141 * _tmp77 -
                         _tmp135 * _tmp136 - _tmp146 * _tmp96;
  const Scalar _tmp148 = Scalar(1.0) / (_tmp147);
  const Scalar _tmp149 = _tmp125 * _tmp51;
  const Scalar _tmp150 = _tmp42 * _tmp62;
  const Scalar _tmp151 = std::asinh(
      _tmp148 * (_tmp115 * _tmp117 * _tmp51 + _tmp123 * _tmp124 * _tmp51 + _tmp126 * _tmp149 +
                 _tmp127 * _tmp131 * _tmp51 + _tmp134 * _tmp135 * _tmp51 - _tmp150 * _tmp63));
  const Scalar _tmp152 = Scalar(9.6622558468725703) * _tmp147;
  const Scalar _tmp153 =
      _tmp101 * _tmp112 * _tmp117 + _tmp101 * _tmp122 * _tmp124 + _tmp133 * _tmp135 + _tmp146;
  const Scalar _tmp154 = Scalar(1.0) / (_tmp153);
  const Scalar _tmp155 = std::asinh(
      _tmp154 * (-_tmp111 * _tmp117 * _tmp61 - _tmp121 * _tmp124 * _tmp61 + _tmp127 * _tmp129 -
                 _tmp132 * _tmp135 - _tmp149 * _tmp57 * _tmp62 + _tmp150));
           ...
           std::cosh(
               ...
               (-_tmp144 * _tmp145 -
                Scalar(125.0) * std::sqrt(Scalar(
                                    Scalar(0.77439999999999998) *
                                        std::pow(Scalar(1 - Scalar(0.0090909090909090905) * _tmp70),
                                                 Scalar(2)) +
                                    std::pow(Scalar(1 - Scalar(0.0080000000000000002) * _tmp72),
                                             Scalar(2))))))) +
      _tmp81 + position_vector(2, 0);
  _res(2, 0) =
      -_tmp152 *
          (Scalar(4.967784) * _tmp148 + std::cosh(Scalar(1.0) * _tmp151) -
           std::cosh(
