...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1WrtFv1Nl0(
  ...
  const Scalar _tmp40 = _tmp23 + _tmp31;
  ...
  const Scalar _tmp77 = _tmp74 * (_tmp51 * _tmp73 - _tmp61 * _tmp76);
  const Scalar _tmp78 = _tmp39 * _tmp63 - _tmp47 * _tmp76 - _tmp72 * _tmp77;
  ...
  const Scalar _tmp84 = -_tmp39 * _tmp47 + _tmp47 * _tmp50 - _tmp62 * _tmp75 - _tmp78 * _tmp83;
  const Scalar _tmp85 = Scalar(1.0) / (_tmp84);
  const Scalar _tmp86 = _tmp71 * _tmp77 + _tmp76;
  const Scalar _tmp87 = _tmp71 * _tmp74;
  const Scalar _tmp88 = -_tmp50 + _tmp62 * _tmp87 - _tmp83 * _tmp86;
  const Scalar _tmp89 =
  ...
  const Scalar _tmp94 = -_tmp40 * _tmp63 + _tmp43 * _tmp47 + _tmp47 * _tmp92 - _tmp75 * _tmp93;
  const Scalar _tmp95 = _tmp85 * _tmp94;
  const Scalar _tmp96 = Scalar(1.0) / (_tmp94);
  const Scalar _tmp97 = _tmp84 * _tmp96;
  const Scalar _tmp98 = _tmp97 * (_tmp87 * _tmp93 - _tmp88 * _tmp95 - _tmp92);
  ...
  const Scalar _tmp121 = _tmp91 * (_tmp119 * _tmp47 - _tmp120 * _tmp61);
  const Scalar _tmp122 = -_tmp106 * _tmp91 * (_tmp100 * _tmp101 + _tmp47 * _tmp99 + Scalar(1.0)) -
                         _tmp109 * _tmp91 * (_tmp107 * _tmp47 - _tmp107 * _tmp61 * _tmp75) -
                         _tmp116 * _tmp91 * (_tmp101 * _tmp115 + _tmp114 * _tmp47) -
                         _tmp117 * _tmp121;
  const Scalar _tmp123 = Scalar(1.0) / (_tmp122);
  const Scalar _tmp124 = fh1 * (_tmp38 + _tmp48);
  const Scalar _tmp125 = -_tmp108 * _tmp124 - Scalar(2.3544) * _tmp17 - _tmp21 * fv1;
  const Scalar _tmp126 = _tmp43 + _tmp80;
  const Scalar _tmp127 = _tmp126 * _tmp83;
  const Scalar _tmp128 = Scalar(1.0) / (-_tmp127 - _tmp40 + _tmp82);
  ...
  const Scalar _tmp134 = _tmp105 * _tmp124 + Scalar(2.3544) * _tmp27 + _tmp32 * fv1;
  ...
  const Scalar _tmp140 = -_tmp111 + _tmp113 * _tmp139 - _tmp114 * _tmp78;
  const Scalar _tmp141 = _tmp139 * _tmp98 - _tmp78 * _tmp99 + _tmp86;
  const Scalar _tmp142 = _tmp118 * _tmp128;
  const Scalar _tmp143 = _tmp81 * (-_tmp119 * _tmp78 - _tmp126 * _tmp142 + _tmp80);
  ...
  const Scalar _tmp145 = Scalar(1.0) * _tmp106 * (_tmp129 * _tmp98 - _tmp131 * _tmp141) +
                         Scalar(1.0) * _tmp109 * (-_tmp131 * _tmp138 + _tmp137) +
                         Scalar(1.0) * _tmp116 * (_tmp113 * _tmp129 - _tmp131 * _tmp140) +
                         _tmp117 * _tmp144 + _tmp125 * _tmp133 + _tmp134 * _tmp136;
  const Scalar _tmp146 = std::asinh(_tmp123 * _tmp145);
  const Scalar _tmp147 = Scalar(1.0) * _tmp146;
  const Scalar _tmp148 = _tmp18 + _tmp52;
  const Scalar _tmp149 = std::pow(_tmp122, Scalar(-2));
  const Scalar _tmp150 = _tmp121 * _tmp149;
  const Scalar _tmp151 =
      (_tmp123 * (_tmp133 * _tmp148 + _tmp136 * _tmp32 - _tmp144) - _tmp145 * _tmp150) /
  ...
  const Scalar _tmp154 = Scalar(9.6622558468725703) * _tmp121;
  const Scalar _tmp155 = Scalar(0.1034955) * _tmp123;
  const Scalar _tmp156 = _tmp153 * _tmp155;
  const Scalar _tmp157 = _tmp130 * _tmp81;
  const Scalar _tmp158 = _tmp129 * _tmp134;
  const Scalar _tmp159 = _tmp106 * _tmp141 * _tmp81 + _tmp109 * _tmp138 * _tmp81 +
                         _tmp116 * _tmp140 * _tmp81 + _tmp117 * _tmp143 + _tmp125 * _tmp157 -
                         _tmp135 * _tmp158;
  const Scalar _tmp160 = _tmp107 * _tmp109;
  const Scalar _tmp161 = _tmp117 * _tmp119;
  const Scalar _tmp162 =
      _tmp100 * _tmp106 * _tmp74 + _tmp115 * _tmp116 * _tmp74 - _tmp160 * _tmp75 - _tmp161 * _tmp75;
  ...
  const Scalar _tmp171 = _tmp129 * _tmp32;
  const Scalar _tmp172 =
      (-_tmp159 * _tmp170 + _tmp163 * (-_tmp135 * _tmp171 - _tmp143 + _tmp148 * _tmp157)) /
  ...
  const Scalar _tmp176 = _tmp106 * _tmp99 + _tmp114 * _tmp116 + _tmp160 + _tmp161;
  const Scalar _tmp177 = Scalar(1.0) / (_tmp176);
  const Scalar _tmp178 = -_tmp106 * _tmp128 * _tmp98 - _tmp109 * _tmp137 -
                         _tmp113 * _tmp116 * _tmp128 + _tmp117 * _tmp142 - _tmp125 * _tmp132 +
                         _tmp158;
  ...
  const Scalar _tmp183 = (_tmp177 * (-_tmp132 * _tmp148 - _tmp142 + _tmp171) + _tmp178 * _tmp182) /
                          ...
                          Scalar(125.0) *
                              std::sqrt(Scalar(
                                  ...
                                  std::pow(Scalar(-Scalar(0.0080000000000000002) * _tmp33 - 1),
                                           Scalar(2)))))));
  _res(1, 0) =
      -_tmp152 * (-Scalar(4.967784) * _tmp150 + Scalar(1.0) * _tmp151 * std::sinh(_tmp147) -
                  (-Scalar(0.1034955) * _tmp150 * _tmp153 +
                   _tmp155 * (-_tmp146 * _tmp154 - _tmp151 * _tmp152)) *
                      std::sinh(_tmp156)) -
      _tmp154 * (Scalar(4.967784) * _tmp123 + std::cosh(_tmp147) - std::cosh(_tmp156));
  _res(2, 0) =
      -_tmp165 * (-Scalar(4.967784) * _tmp170 + Scalar(1.0) * _tmp172 * std::sinh(_tmp175) -
                  (-Scalar(0.1034955) * _tmp166 * _tmp170 +
                   _tmp167 * (-_tmp164 * _tmp174 - _tmp165 * _tmp172)) *
                      std::sinh(_tmp168)) -
      _tmp174 * (Scalar(4.967784) * _tmp163 - std::cosh(_tmp168) + std::cosh(_tmp175));
  _res(3, 0) = _tmp173 * (Scalar(4.967784) * _tmp177 + std::cosh(_tmp180) - std::cosh(_tmp187)) -
               _tmp184 * (Scalar(4.967784) * _tmp182 + Scalar(1.0) * _tmp183 * std::sinh(_tmp180) -
                          (Scalar(0.1034955) * _tmp182 * _tmp185 +
                           _tmp186 * (_tmp173 * _tmp179 - _tmp183 * _tmp184)) *
                              std::sinh(_tmp187));
