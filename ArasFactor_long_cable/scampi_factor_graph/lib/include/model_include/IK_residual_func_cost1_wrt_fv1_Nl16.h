...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1WrtFv1Nl16(
  ...
  const Scalar _tmp51 = _tmp38 + Scalar(-110.0);
  const Scalar _tmp52 = _tmp35 + Scalar(125.0);
  const Scalar _tmp53 = Scalar(1.0) / (_tmp52);
  const Scalar _tmp54 = _tmp51 * _tmp53;
  const Scalar _tmp55 = _tmp49 * _tmp54 - _tmp50;
  const Scalar _tmp56 = _tmp36 + _tmp40;
  const Scalar _tmp57 = _tmp56 + position_vector(1, 0);
  const Scalar _tmp58 = _tmp57 + Scalar(110.0);
  const Scalar _tmp59 = _tmp33 + _tmp44;
  ...
  const Scalar _tmp65 = Scalar(1.0) / (_tmp54 * _tmp63 - _tmp64);
  const Scalar _tmp66 =
  ...
  const Scalar _tmp69 = _tmp68 * (_tmp34 * _tmp51 * _tmp67 - _tmp37 * _tmp52 * _tmp67);
  const Scalar _tmp70 = _tmp65 * (_tmp56 * _tmp63 - _tmp59 * _tmp64 + _tmp63 * _tmp69);
  const Scalar _tmp71 = _tmp41 * _tmp49 - _tmp45 * _tmp50 + _tmp49 * _tmp69 - _tmp55 * _tmp70;
  ...
  const Scalar _tmp85 = _tmp83 * (-_tmp59 + _tmp84);
  const Scalar _tmp86 = Scalar(0.20999999999999999) * _tmp10 - Scalar(0.20999999999999999) * _tmp12;
  const Scalar _tmp87 = -_tmp86;
  const Scalar _tmp88 = -Scalar(0.010999999999999999) * _tmp22 -
  ...
  const Scalar _tmp95 = _tmp65 * (-_tmp63 * _tmp94 + _tmp64 * _tmp91);
  const Scalar _tmp96 = Scalar(1.0) * _tmp95;
  const Scalar _tmp97 = _tmp65 * (-_tmp63 * _tmp91 + _tmp63 * _tmp93);
  const Scalar _tmp98 = _tmp85 * _tmp96 - Scalar(1.0) * _tmp97;
  const Scalar _tmp99 = _tmp86 + _tmp90;
  const Scalar _tmp100 = _tmp49 * _tmp93;
  const Scalar _tmp101 = -_tmp100 * _tmp54 + _tmp50 * _tmp99 - _tmp55 * _tmp95;
  const Scalar _tmp102 = _tmp100 - _tmp101 * _tmp85 - _tmp49 * _tmp99 - _tmp55 * _tmp97;
  const Scalar _tmp103 = Scalar(1.0) / (_tmp102);
  const Scalar _tmp104 = _tmp103 * _tmp71;
  const Scalar _tmp105 = _tmp102 * _tmp72;
  const Scalar _tmp106 = _tmp105 * (-_tmp104 * _tmp98 - Scalar(1.0) * _tmp70);
  const Scalar _tmp107 = _tmp106 + _tmp98;
  const Scalar _tmp108 = _tmp103 * _tmp55;
  const Scalar _tmp109 = -_tmp107 * _tmp108 + Scalar(1.0);
  const Scalar _tmp110 = _tmp103 * _tmp49;
  const Scalar _tmp111 = _tmp79 * fh1;
  const Scalar _tmp112 = Scalar(19.620000000000001) - fv1;
  const Scalar _tmp113 = _tmp81 * _tmp85 + _tmp84;
  const Scalar _tmp114 = 0;
  const Scalar _tmp115 = _tmp108 * _tmp114;
  const Scalar _tmp116 = _tmp103 * _tmp114;
  const Scalar _tmp117 = _tmp68 * (-_tmp115 * _tmp74 + _tmp116 * _tmp49);
  const Scalar _tmp118 = _tmp54 * _tmp95 + _tmp94;
  const Scalar _tmp119 = -_tmp118 * _tmp85 + _tmp54 * _tmp97 - _tmp93;
  const Scalar _tmp120 = _tmp105 * (-_tmp104 * _tmp119 + _tmp54 * _tmp70 - _tmp69);
  const Scalar _tmp121 = _tmp119 + _tmp120;
  const Scalar _tmp122 = -_tmp108 * _tmp121 - _tmp54;
  const Scalar _tmp123 = _tmp78 * fh1;
  const Scalar _tmp124 = -_tmp111 * _tmp68 * (_tmp107 * _tmp110 + _tmp109 * _tmp74) -
                         _tmp112 * _tmp117 -
                         _tmp123 * _tmp68 * (_tmp110 * _tmp121 + _tmp122 * _tmp74 + Scalar(1.0)) -
                         _tmp68 * _tmp80 * (_tmp49 * _tmp73 - _tmp55 * _tmp73 * _tmp74);
  const Scalar _tmp125 = Scalar(1.0) / (_tmp124);
  const Scalar _tmp126 = _tmp41 + _tmp82;
  const Scalar _tmp127 = _tmp126 * _tmp85;
  const Scalar _tmp128 = Scalar(1.0) / (-_tmp127 - _tmp45 + _tmp84);
  const Scalar _tmp129 = _tmp126 * _tmp128;
  const Scalar _tmp130 = _tmp101 * _tmp103;
  ...
  const Scalar _tmp134 = fh1 * (_tmp86 + _tmp92);
  const Scalar _tmp135 = -_tmp134 * _tmp79 - Scalar(2.3544) * _tmp26 - _tmp30 * fv1;
  const Scalar _tmp136 = _tmp83 * (_tmp127 * _tmp133 + Scalar(1.0));
  const Scalar _tmp137 = _tmp133 * _tmp85;
  const Scalar _tmp138 = -Scalar(1.0) * _tmp136 + Scalar(1.0) * _tmp137;
  const Scalar _tmp139 = _tmp106 * _tmp129 - _tmp107 * _tmp130 - _tmp96;
  const Scalar _tmp140 = Scalar(2.3544) * _tmp13 + _tmp134 * _tmp78 + _tmp19 * fv1;
  const Scalar _tmp141 = _tmp126 * _tmp83;
  const Scalar _tmp142 = Scalar(1.0) * _tmp133 * _tmp141 - Scalar(1.0) * _tmp133;
  const Scalar _tmp143 = _tmp105 * _tmp133;
  const Scalar _tmp144 = -_tmp101 * _tmp73 + _tmp126 * _tmp143;
  const Scalar _tmp145 = _tmp113 * _tmp128;
  const Scalar _tmp146 = _tmp83 * (-_tmp114 * _tmp130 - _tmp126 * _tmp145 + _tmp82);
  const Scalar _tmp147 = -Scalar(1.0) * _tmp145 - Scalar(1.0) * _tmp146 + Scalar(1.0);
  const Scalar _tmp148 =
      Scalar(1.0) * _tmp111 * (_tmp106 * _tmp133 - _tmp132 * _tmp139) + _tmp112 * _tmp147 +
      Scalar(1.0) * _tmp123 * (_tmp120 * _tmp133 - _tmp131 * _tmp132) + _tmp135 * _tmp138 +
      _tmp140 * _tmp142 + Scalar(1.0) * _tmp80 * (-_tmp132 * _tmp144 + _tmp143);
  ...
  const Scalar _tmp158 = _tmp27 + _tmp36 + _tmp39;
  const Scalar _tmp159 =
      (_tmp125 * (_tmp138 * _tmp158 + _tmp142 * _tmp19 - _tmp147) - _tmp148 * _tmp157) /
      std::sqrt(Scalar(std::pow(_tmp148, Scalar(2)) * _tmp156 + 1));
  const Scalar _tmp160 = _tmp65 * fh1;
  const Scalar _tmp161 = _tmp115 * _tmp65;
  const Scalar _tmp162 = _tmp73 * _tmp80;
  const Scalar _tmp163 = _tmp109 * _tmp160 * _tmp79 - _tmp112 * _tmp161 +
                         _tmp122 * _tmp160 * _tmp78 - _tmp162 * _tmp55 * _tmp65;
  const Scalar _tmp164 = Scalar(1.0) / (_tmp163);
  const Scalar _tmp165 = _tmp133 * _tmp140;
  const Scalar _tmp166 = _tmp111 * _tmp139 * _tmp83 + _tmp112 * _tmp146 +
                         _tmp123 * _tmp131 * _tmp83 + _tmp135 * _tmp136 - _tmp141 * _tmp165 +
                         _tmp144 * _tmp80 * _tmp83;
  ...
  const Scalar _tmp177 =
      (_tmp164 * (_tmp136 * _tmp158 - _tmp141 * _tmp176 - _tmp146) - _tmp166 * _tmp175) /
      std::sqrt(Scalar(std::pow(_tmp166, Scalar(2)) * _tmp174 + 1));
  const Scalar _tmp178 =
      _tmp103 * _tmp107 * _tmp111 + _tmp103 * _tmp121 * _tmp123 + _tmp112 * _tmp116 + _tmp162;
  const Scalar _tmp179 = Scalar(1.0) / (_tmp178);
  const Scalar _tmp180 = -_tmp106 * _tmp111 * _tmp128 + _tmp112 * _tmp145 -
                         _tmp120 * _tmp123 * _tmp128 - _tmp135 * _tmp137 - _tmp143 * _tmp80 +
                         _tmp165;
  ...
  const Scalar _tmp187 = Scalar(9.6622558468725703) * _tmp116;
  const Scalar _tmp188 = std::pow(_tmp178, Scalar(-2));
  const Scalar _tmp189 = _tmp116 * _tmp188;
  const Scalar _tmp190 = (_tmp179 * (-_tmp137 * _tmp158 - _tmp145 + _tmp176) + _tmp180 * _tmp189) /
                              ...
                              std::sqrt(Scalar(
                                  ...
                                  Scalar(0.77439999999999998) *
                                      std::pow(Scalar(1 - Scalar(0.0090909090909090905) * _tmp31),
                                               Scalar(2)))))));
  _res(1, 0) =
      -_tmp150 * (-Scalar(4.967784) * _tmp157 + Scalar(1.0) * _tmp159 * std::sinh(_tmp154) -
                  (-Scalar(0.1034955) * _tmp151 * _tmp157 +
                   _tmp152 * (-_tmp149 * _tmp155 - _tmp150 * _tmp159)) *
                      std::sinh(_tmp153)) -
      _tmp155 * (Scalar(4.967784) * _tmp125 - std::cosh(_tmp153) + std::cosh(_tmp154));
  _res(2, 0) =
      -_tmp168 * (-Scalar(4.967784) * _tmp175 + Scalar(1.0) * _tmp177 * std::sinh(_tmp172) -
                  (-Scalar(0.1034955) * _tmp169 * _tmp175 +
                   _tmp170 * (-_tmp167 * _tmp173 - _tmp168 * _tmp177)) *
                      std::sinh(_tmp171)) -
      _tmp173 * (Scalar(4.967784) * _tmp164 - std::cosh(_tmp171) + std::cosh(_tmp172));
  _res(3, 0) = -_tmp182 * (Scalar(4.967784) * _tmp189 + Scalar(1.0) * _tmp190 * std::sinh(_tmp186) -
                           (Scalar(0.1034955) * _tmp183 * _tmp189 +
                            _tmp184 * (_tmp181 * _tmp187 - _tmp182 * _tmp190)) *
                               std::sinh(_tmp185)) +
               _tmp187 * (Scalar(4.967784) * _tmp179 - std::cosh(_tmp185) + std::cosh(_tmp186));
