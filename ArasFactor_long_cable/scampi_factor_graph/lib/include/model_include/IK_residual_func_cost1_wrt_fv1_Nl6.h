...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1WrtFv1Nl6(
  ...
  const Scalar _tmp72 = -_tmp60 * _tmp71 + _tmp62 * _tmp70;
  const Scalar _tmp73 = _tmp42 * _tmp43;
  const Scalar _tmp74 = _tmp44 * _tmp59 - _tmp73;
  const Scalar _tmp75 = Scalar(1.0) / (_tmp59 * _tmp71 - _tmp70);
  const Scalar _tmp76 = _tmp74 * _tmp75;
  const Scalar _tmp77 = -_tmp44 * _tmp60 + _tmp49 * _tmp73 - _tmp72 * _tmp76;
  ...
  const Scalar _tmp83 = _tmp51 * _tmp71 - _tmp62 * _tmp71;
  const Scalar _tmp84 = -_tmp44 * _tmp49 + _tmp44 * _tmp51 - _tmp76 * _tmp83 - _tmp77 * _tmp82;
  ...
  const Scalar _tmp92 = _tmp91 * (-_tmp52 * _tmp57 * _tmp90 + _tmp54 * _tmp55 * _tmp90);
  const Scalar _tmp93 = _tmp63 * _tmp71 - _tmp66 * _tmp70 + _tmp71 * _tmp92;
  const Scalar _tmp94 = -_tmp35 * _tmp73 + _tmp40 * _tmp44 + _tmp44 * _tmp92 - _tmp76 * _tmp93;
  ...
  const Scalar _tmp100 = -_tmp74 * _tmp99 + Scalar(1.0);
  const Scalar _tmp101 = _tmp71 * _tmp75;
  const Scalar _tmp102 = _tmp21 + Scalar(110.0);
  ...
  const Scalar _tmp110 = fh1 * (_tmp105 * _tmp30 - _tmp109 * _tmp20);
  const Scalar _tmp111 = _tmp59 * _tmp75;
  const Scalar _tmp112 = _tmp111 * _tmp72 + _tmp60;
  const Scalar _tmp113 = _tmp111 * _tmp83 - _tmp112 * _tmp82 - _tmp51;
  const Scalar _tmp114 = _tmp97 * (_tmp111 * _tmp93 - _tmp113 * _tmp95 - _tmp92);
  const Scalar _tmp115 = _tmp85 * (_tmp113 + _tmp114);
  const Scalar _tmp116 = -_tmp115 * _tmp74 - _tmp59;
  ...
  const Scalar _tmp121 = _tmp91 * (-_tmp108 * _tmp120 + _tmp120 * _tmp44);
  const Scalar _tmp122 = -_tmp106 * _tmp91 * (_tmp100 * _tmp101 + _tmp44 * _tmp99) -
                         _tmp110 * _tmp91 * (-_tmp107 * _tmp108 + _tmp107 * _tmp44) -
                         _tmp117 * _tmp91 * (_tmp101 * _tmp116 + _tmp115 * _tmp44 + Scalar(1.0)) -
                         _tmp118 * _tmp121;
  const Scalar _tmp123 = Scalar(1.0) / (_tmp122);
  const Scalar _tmp124 = _tmp40 + _tmp79;
  const Scalar _tmp125 = _tmp124 * _tmp82;
  const Scalar _tmp126 = Scalar(1.0) / (-_tmp125 - _tmp35 + _tmp81);
  const Scalar _tmp127 = _tmp124 * _tmp126;
  const Scalar _tmp128 = _tmp112 + _tmp114 * _tmp127 - _tmp115 * _tmp77;
  const Scalar _tmp129 = Scalar(1.0) * _tmp80;
  const Scalar _tmp130 = Scalar(1.0) * _tmp126;
  const Scalar _tmp131 = fh1 * (_tmp50 + _tmp61);
  const Scalar _tmp132 = _tmp109 * _tmp131 + Scalar(2.3544) * _tmp26 + _tmp30 * fv1;
  const Scalar _tmp133 = _tmp124 * _tmp130;
  const Scalar _tmp134 = -Scalar(1.0) * _tmp130 + Scalar(1.0) * _tmp133 * _tmp80;
  const Scalar _tmp135 = -_tmp105 * _tmp131 - Scalar(2.3544) * _tmp13 - _tmp20 * fv1;
  const Scalar _tmp136 = _tmp125 * _tmp130 + Scalar(1.0);
  const Scalar _tmp137 = _tmp130 * _tmp82;
  const Scalar _tmp138 = -Scalar(1.0) * _tmp129 * _tmp136 + Scalar(1.0) * _tmp137;
  const Scalar _tmp139 = -_tmp107 * _tmp77 + _tmp133 * _tmp97;
  const Scalar _tmp140 = _tmp130 * _tmp97;
  const Scalar _tmp141 = _tmp119 * _tmp126;
  const Scalar _tmp142 = _tmp80 * (-_tmp120 * _tmp77 - _tmp124 * _tmp141 + _tmp79);
  const Scalar _tmp143 = -Scalar(1.0) * _tmp141 - Scalar(1.0) * _tmp142 + Scalar(1.0);
  const Scalar _tmp144 = _tmp127 * _tmp98 - _tmp77 * _tmp99 - _tmp87;
  const Scalar _tmp145 = Scalar(1.0) * _tmp106 * (-_tmp129 * _tmp144 + _tmp130 * _tmp98) +
                         Scalar(1.0) * _tmp110 * (-_tmp129 * _tmp139 + _tmp140) +
                         Scalar(1.0) * _tmp117 * (_tmp114 * _tmp130 - _tmp128 * _tmp129) +
                         _tmp118 * _tmp143 + _tmp132 * _tmp134 + _tmp135 * _tmp138;
  const Scalar _tmp146 = std::asinh(_tmp123 * _tmp145);
  const Scalar _tmp147 = Scalar(1.0) * _tmp146;
  const Scalar _tmp148 = std::pow(_tmp122, Scalar(-2));
  const Scalar _tmp149 = _tmp121 * _tmp148;
  const Scalar _tmp150 = _tmp14 + _tmp18 + _tmp38;
  const Scalar _tmp151 =
      (_tmp123 * (_tmp134 * _tmp30 + _tmp138 * _tmp150 - _tmp143) - _tmp145 * _tmp149) /
  ...
  const Scalar _tmp156 = Scalar(9.6622558468725703) * _tmp121;
  const Scalar _tmp157 = _tmp75 * fh1;
  const Scalar _tmp158 = _tmp107 * _tmp110;
  const Scalar _tmp159 = _tmp118 * _tmp120;
  const Scalar _tmp160 = _tmp100 * _tmp105 * _tmp157 + _tmp109 * _tmp116 * _tmp157 -
                         _tmp158 * _tmp76 - _tmp159 * _tmp76;
  const Scalar _tmp161 = Scalar(1.0) / (_tmp160);
  const Scalar _tmp162 = _tmp136 * _tmp80;
  const Scalar _tmp163 = _tmp130 * _tmp132;
  const Scalar _tmp164 = _tmp124 * _tmp80;
  const Scalar _tmp165 = _tmp106 * _tmp144 * _tmp80 + _tmp110 * _tmp139 * _tmp80 +
                         _tmp117 * _tmp128 * _tmp80 + _tmp118 * _tmp142 + _tmp135 * _tmp162 -
                         _tmp163 * _tmp164;
  ...
  const Scalar _tmp169 = _tmp120 * _tmp168 * _tmp76;
  const Scalar _tmp170 = _tmp130 * _tmp30;
  const Scalar _tmp171 =
      (_tmp161 * (-_tmp142 + _tmp150 * _tmp162 - _tmp164 * _tmp170) - _tmp165 * _tmp169) /
  ...
  const Scalar _tmp178 = _tmp106 * _tmp99 + _tmp115 * _tmp117 + _tmp158 + _tmp159;
  const Scalar _tmp179 = std::pow(_tmp178, Scalar(-2));
  const Scalar _tmp180 = _tmp120 * _tmp179;
  const Scalar _tmp181 = -_tmp106 * _tmp126 * _tmp98 - _tmp110 * _tmp140 -
                         _tmp114 * _tmp117 * _tmp126 + _tmp118 * _tmp141 - _tmp135 * _tmp137 +
                         _tmp163;
  ...
  const Scalar _tmp185 = (_tmp180 * _tmp181 + _tmp182 * (-_tmp137 * _tmp150 - _tmp141 + _tmp170)) /
                              ...
                              std::sqrt(Scalar(
                                  ...
                                  Scalar(0.77439999999999998) *
                                      std::pow(Scalar(-Scalar(0.0090909090909090905) * _tmp21 - 1),
                                               Scalar(2)))))));
  _res(1, 0) =
      -_tmp152 * (-Scalar(4.967784) * _tmp149 + Scalar(1.0) * _tmp151 * std::sinh(_tmp147) -
                  (-Scalar(0.1034955) * _tmp149 * _tmp153 +
                   _tmp154 * (-_tmp146 * _tmp156 - _tmp151 * _tmp152)) *
                      std::sinh(_tmp155)) -
      _tmp156 * (Scalar(4.967784) * _tmp123 + std::cosh(_tmp147) - std::cosh(_tmp155));
  _res(2, 0) =
      -_tmp172 * (-Scalar(4.967784) * _tmp169 + Scalar(1.0) * _tmp171 * std::sinh(_tmp167) -
                  (-Scalar(0.1034955) * _tmp169 * _tmp173 +
                   _tmp176 * (-_tmp166 * _tmp175 - _tmp171 * _tmp172)) *
                      std::sinh(_tmp177)) -
      _tmp175 * (Scalar(4.967784) * _tmp161 + std::cosh(_tmp167) - std::cosh(_tmp177));
  _res(3, 0) = _tmp174 * (Scalar(4.967784) * _tmp182 + std::cosh(_tmp184) - std::cosh(_tmp189)) -
               _tmp186 * (Scalar(4.967784) * _tmp180 + Scalar(1.0) * _tmp185 * std::sinh(_tmp184) -
                          (Scalar(0.1034955) * _tmp180 * _tmp188 +
                           _tmp187 * (_tmp174 * _tmp183 - _tmp185 * _tmp186)) *
                              std::sinh(_tmp189));
