...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl18(
  ...
  const Scalar _tmp41 = _tmp30 + Scalar(-110.0);
  ...
  const Scalar _tmp45 = Scalar(2.3544) * _tmp12 + _tmp18 * fv1 + _tmp43 * _tmp44;
  const Scalar _tmp46 = _tmp25 - _tmp27;
  ...
  const Scalar _tmp56 = _tmp54 + _tmp6;
  ...
  const Scalar _tmp66 = _tmp55 + position_vector(0, 0);
  ...
  const Scalar _tmp70 = _tmp47 + position_vector(1, 0);
  ...
  const Scalar _tmp78 = _tmp77 * (-_tmp47 * _tmp73 * _tmp75 + _tmp56 * _tmp71 * _tmp75);
  const Scalar _tmp79 = _tmp65 * _tmp68;
  const Scalar _tmp80 = _tmp52 * _tmp69 - _tmp55 * _tmp79 + _tmp69 * _tmp78;
  const Scalar _tmp81 = _tmp71 * _tmp76;
  const Scalar _tmp82 = Scalar(1.0) / (_tmp69 * _tmp81 - _tmp79);
  ...
  const Scalar _tmp89 = _tmp79 * _tmp85 - _tmp81 * _tmp87;
  const Scalar _tmp90 = _tmp81 * _tmp86 + _tmp83 * _tmp89;
  const Scalar _tmp91 = -_tmp58 * _tmp90 + _tmp83 * _tmp88 - _tmp86;
  const Scalar _tmp92 = _tmp50 + position_vector(1, 0);
  const Scalar _tmp93 = _tmp92 + Scalar(-110.0);
  const Scalar _tmp94 = _tmp60 + position_vector(0, 0);
  const Scalar _tmp95 = _tmp94 + Scalar(-125.0);
  ...
  const Scalar _tmp99 = _tmp34 + _tmp38;
  const Scalar _tmp100 = _tmp93 * _tmp96;
  const Scalar _tmp101 = -_tmp100 + _tmp81 * _tmp97;
  const Scalar _tmp102 = _tmp101 * _tmp82;
  const Scalar _tmp103 = _tmp100 * _tmp99 - _tmp102 * _tmp89 - _tmp81 * _tmp98;
  const Scalar _tmp104 = -_tmp102 * _tmp88 - _tmp103 * _tmp58 - _tmp97 * _tmp99 + _tmp98;
  const Scalar _tmp105 = Scalar(1.0) / (_tmp104);
  const Scalar _tmp106 = -_tmp100 * _tmp60 - _tmp102 * _tmp80 + _tmp50 * _tmp97 + _tmp78 * _tmp97;
  const Scalar _tmp107 = _tmp105 * _tmp106;
  const Scalar _tmp108 = Scalar(1.0) / (_tmp106);
  const Scalar _tmp109 = _tmp104 * _tmp108;
  const Scalar _tmp110 = _tmp109 * (-_tmp107 * _tmp91 - _tmp78 + _tmp80 * _tmp83);
  const Scalar _tmp111 = _tmp110 + _tmp91;
  const Scalar _tmp112 = _tmp103 * _tmp105;
  const Scalar _tmp113 = _tmp51 * _tmp61;
  const Scalar _tmp114 = _tmp110 * _tmp113 - _tmp111 * _tmp112 + _tmp90;
  const Scalar _tmp115 = Scalar(1.0) * _tmp53;
  const Scalar _tmp116 = _tmp43 * fh1;
  const Scalar _tmp117 = Scalar(1.0) * _tmp82;
  const Scalar _tmp118 = _tmp117 * _tmp89;
  const Scalar _tmp119 = -_tmp117 * _tmp88 + _tmp118 * _tmp58;
  const Scalar _tmp120 = _tmp109 * (-_tmp107 * _tmp119 - _tmp117 * _tmp80);
  const Scalar _tmp121 = _tmp119 + _tmp120;
  const Scalar _tmp122 = -_tmp112 * _tmp121 + _tmp113 * _tmp120 - _tmp118;
  const Scalar _tmp123 = _tmp41 * _tmp42;
  const Scalar _tmp124 = _tmp123 * fh1;
  const Scalar _tmp125 = _tmp109 * _tmp62;
  const Scalar _tmp126 = Scalar(1.0) * _tmp108;
  const Scalar _tmp127 = -_tmp103 * _tmp126 + _tmp125 * _tmp51;
  const Scalar _tmp128 = fh1 * (_tmp123 * _tmp18 - _tmp29 * _tmp43);
  const Scalar _tmp129 = -_tmp123 * _tmp44 - Scalar(2.3544) * _tmp24 - _tmp29 * fv1;
  const Scalar _tmp130 = _tmp59 * _tmp62 + Scalar(1.0);
  const Scalar _tmp131 = _tmp58 * _tmp62;
  const Scalar _tmp132 = Scalar(19.620000000000001) - fv1;
  const Scalar _tmp133 = _tmp48 * _tmp58 + _tmp57;
  const Scalar _tmp134 = 0;
  const Scalar _tmp135 = _tmp133 * _tmp61;
  const Scalar _tmp136 = -_tmp112 * _tmp134 - _tmp135 * _tmp51 + _tmp49;
  const Scalar _tmp137 = _tmp101 * _tmp105;
  const Scalar _tmp138 = -_tmp111 * _tmp137 - _tmp81;
  const Scalar _tmp139 = _tmp69 * _tmp82;
  const Scalar _tmp140 = _tmp105 * _tmp97;
  const Scalar _tmp141 = _tmp101 * _tmp108 * _tmp117;
  const Scalar _tmp142 = _tmp105 * _tmp134;
  const Scalar _tmp143 = -_tmp121 * _tmp137 + Scalar(1.0);
  const Scalar _tmp144 = -_tmp116 * _tmp77 * (_tmp111 * _tmp140 + _tmp138 * _tmp139 + Scalar(1.0)) -
                         _tmp124 * _tmp77 * (_tmp121 * _tmp140 + _tmp139 * _tmp143) -
                         _tmp128 * _tmp77 * (_tmp126 * _tmp97 - _tmp141 * _tmp69) -
                         _tmp132 * _tmp77 * (-_tmp102 * _tmp142 * _tmp69 + _tmp142 * _tmp97);
  const Scalar _tmp145 = Scalar(1.0) / (_tmp144);
  const Scalar _tmp146 = std::asinh(
      _tmp145 * (Scalar(1.0) * _tmp116 * (_tmp110 * _tmp62 - _tmp114 * _tmp115) +
                 Scalar(1.0) * _tmp124 * (-_tmp115 * _tmp122 + _tmp120 * _tmp62) +
                 Scalar(1.0) * _tmp128 * (-_tmp115 * _tmp127 + _tmp125) +
                 Scalar(1.0) * _tmp129 * (-_tmp115 * _tmp130 + _tmp131) +
                 Scalar(1.0) * _tmp132 * (-_tmp115 * _tmp136 - _tmp133 * _tmp62 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp45 * (_tmp62 * _tmp63 - _tmp62)));
  const Scalar _tmp147 = Scalar(9.6622558468725703) * _tmp144;
  const Scalar _tmp148 =
      Scalar(12100.0) * std::pow(Scalar(-Scalar(0.0090909090909090905) * _tmp70 - 1), Scalar(2)) +
      Scalar(15625.0) * std::pow(Scalar(-Scalar(0.0080000000000000002) * _tmp72 - 1), Scalar(2));
  const Scalar _tmp149 = _tmp45 * _tmp62;
  const Scalar _tmp150 = _tmp132 * _tmp142;
  const Scalar _tmp151 = -_tmp102 * _tmp150 + _tmp116 * _tmp138 * _tmp82 +
                         _tmp124 * _tmp143 * _tmp82 - _tmp128 * _tmp141;
  const Scalar _tmp152 = Scalar(1.0) / (_tmp151);
  const Scalar _tmp153 =
      std::asinh(_tmp152 * (_tmp114 * _tmp116 * _tmp53 + _tmp122 * _tmp124 * _tmp53 +
                            _tmp127 * _tmp128 * _tmp53 + _tmp129 * _tmp130 * _tmp53 +
                            _tmp132 * _tmp136 * _tmp53 - _tmp149 * _tmp63));
  ...
  const Scalar _tmp155 =
      ...
      Scalar(12100.0) * std::pow(Scalar(-Scalar(0.0090909090909090905) * _tmp64 - 1), Scalar(2));
  const Scalar _tmp156 =
      _tmp105 * _tmp111 * _tmp116 + _tmp105 * _tmp121 * _tmp124 + _tmp126 * _tmp128 + _tmp150;
  const Scalar _tmp157 = Scalar(1.0) / (_tmp156);
  const Scalar _tmp158 =
      std::asinh(_tmp157 * (-_tmp110 * _tmp116 * _tmp61 - _tmp120 * _tmp124 * _tmp61 -
                            _tmp125 * _tmp128 - _tmp129 * _tmp131 + _tmp132 * _tmp135 + _tmp149));
  const Scalar _tmp159 =
      Scalar(12100.0) * std::pow(Scalar(1 - Scalar(0.0090909090909090905) * _tmp92), Scalar(2)) +
      Scalar(15625.0) * std::pow(Scalar(1 - Scalar(0.0080000000000000002) * _tmp94), Scalar(2));
  ...
  _res(2, 0) =
      ...
      Scalar(48.0) * std::sqrt(Scalar(
                         ...
                         std::pow(Scalar(-Scalar(0.020833333333333332) * _tmp85 -
                                         Scalar(0.020833333333333332) * position_vector(2, 0) + 1),
                                  Scalar(2))));
  _res(3, 0) =
      _tmp160 *
