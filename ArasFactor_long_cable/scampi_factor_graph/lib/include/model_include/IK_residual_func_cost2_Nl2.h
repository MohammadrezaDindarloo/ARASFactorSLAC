...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl2(
  ...
  const Scalar _tmp47 = Scalar(19.620000000000001) - fv1;
  const Scalar _tmp48 = _tmp43 + _tmp6;
  ...
  const Scalar _tmp56 = _tmp45 + Scalar(-110.0);
  const Scalar _tmp57 = _tmp42 + Scalar(-125.0);
  ...
  const Scalar _tmp69 = _tmp63 * _tmp68 + _tmp66;
  ...
  const Scalar _tmp74 = _tmp22 + _tmp40;
  ...
  const Scalar _tmp80 = _tmp59 * _tmp79 - _tmp78;
  const Scalar _tmp81 = _tmp36 + _tmp37;
  const Scalar _tmp82 = _tmp35 + _tmp81;
  const Scalar _tmp83 = _tmp34 + _tmp38;
  const Scalar _tmp84 = _tmp34 + _tmp81;
  const Scalar _tmp85 = _tmp59 * _tmp84;
  const Scalar _tmp86 = _tmp61 * (_tmp55 * _tmp83 - _tmp60 * _tmp85);
  const Scalar _tmp87 = _tmp78 * _tmp82 - _tmp79 * _tmp85 - _tmp80 * _tmp86;
  const Scalar _tmp88 = _tmp61 * (-_tmp60 * _tmp83 + _tmp60 * _tmp84);
  const Scalar _tmp89 = -_tmp68 * _tmp87 - _tmp79 * _tmp82 + _tmp79 * _tmp84 - _tmp80 * _tmp88;
  ...
  const Scalar _tmp97 = _tmp95 * (_tmp41 * _tmp56 * _tmp96 - _tmp44 * _tmp57 * _tmp96);
  const Scalar _tmp98 = _tmp61 * (_tmp48 * _tmp60 - _tmp51 * _tmp55 + _tmp60 * _tmp97);
  const Scalar _tmp99 = _tmp71 * _tmp79 - _tmp74 * _tmp78 + _tmp79 * _tmp97 - _tmp80 * _tmp98;
  const Scalar _tmp100 = Scalar(1.0) / (_tmp99);
  const Scalar _tmp101 = Scalar(1.0) * _tmp100;
  const Scalar _tmp102 = _tmp19 + Scalar(110.0);
  const Scalar _tmp103 = _tmp30 + Scalar(125.0);
  ...
  const Scalar _tmp108 = _tmp59 * _tmp86 + _tmp85;
  const Scalar _tmp109 = -_tmp108 * _tmp68 + _tmp59 * _tmp88 - _tmp84;
  const Scalar _tmp110 = _tmp90 * _tmp99;
  const Scalar _tmp111 = _tmp100 * _tmp89;
  const Scalar _tmp112 = _tmp111 * (-_tmp109 * _tmp110 + _tmp59 * _tmp98 - _tmp97);
  const Scalar _tmp113 = _tmp109 + _tmp112;
  const Scalar _tmp114 = -_tmp113 * _tmp91 - _tmp59;
  const Scalar _tmp115 = _tmp79 * _tmp90;
  const Scalar _tmp116 = _tmp106 * fh1;
  const Scalar _tmp117 = Scalar(1.0) * _tmp65;
  const Scalar _tmp118 = _tmp117 * _tmp67 * _tmp86 - Scalar(1.0) * _tmp88;
  const Scalar _tmp119 = _tmp111 * (-_tmp110 * _tmp118 - Scalar(1.0) * _tmp98);
  const Scalar _tmp120 = _tmp118 + _tmp119;
  const Scalar _tmp121 = -_tmp120 * _tmp91 + Scalar(1.0);
  const Scalar _tmp122 = _tmp105 * fh1;
  const Scalar _tmp123 = -_tmp107 * _tmp95 * (-_tmp101 * _tmp62 * _tmp80 + _tmp101 * _tmp79) -
                         _tmp116 * _tmp95 * (_tmp113 * _tmp115 + _tmp114 * _tmp62 + Scalar(1.0)) -
                         _tmp122 * _tmp95 * (_tmp115 * _tmp120 + _tmp121 * _tmp62) -
                         _tmp47 * _tmp95 * (-_tmp62 * _tmp92 + _tmp79 * _tmp93);
  const Scalar _tmp124 = Scalar(1.0) / (_tmp123);
  const Scalar _tmp125 = _tmp39 * fh1;
  const Scalar _tmp126 = _tmp106 * _tmp125 + Scalar(2.3544) * _tmp25 + _tmp29 * fv1;
  const Scalar _tmp127 = _tmp64 + _tmp71;
  const Scalar _tmp128 = _tmp127 * _tmp68;
  const Scalar _tmp129 = Scalar(1.0) / (-_tmp128 + _tmp66 - _tmp74);
  const Scalar _tmp130 = Scalar(1.0) * _tmp129;
  const Scalar _tmp131 = _tmp127 * _tmp130;
  const Scalar _tmp132 = _tmp87 * _tmp90;
  const Scalar _tmp133 = _tmp129 * _tmp69;
  const Scalar _tmp134 = -_tmp127 * _tmp133 - _tmp132 * _tmp70 + _tmp64;
  const Scalar _tmp135 = _tmp130 * _tmp68;
  const Scalar _tmp136 = _tmp128 * _tmp130 + Scalar(1.0);
  const Scalar _tmp137 = -_tmp105 * _tmp125 - Scalar(2.3544) * _tmp15 - _tmp18 * fv1;
  const Scalar _tmp138 = _tmp127 * _tmp129;
  const Scalar _tmp139 = _tmp108 + _tmp112 * _tmp138 - _tmp113 * _tmp132;
  const Scalar _tmp140 = -_tmp101 * _tmp87 + _tmp111 * _tmp131;
  const Scalar _tmp141 = _tmp111 * _tmp130;
  const Scalar _tmp142 = _tmp119 * _tmp138 - _tmp120 * _tmp132 - Scalar(1.0) * _tmp86;
  const Scalar _tmp143 = std::asinh(
      _tmp124 * (Scalar(1.0) * _tmp107 * (-_tmp117 * _tmp140 + _tmp141) +
                 Scalar(1.0) * _tmp116 * (_tmp112 * _tmp130 - _tmp117 * _tmp139) +
                 Scalar(1.0) * _tmp122 * (-_tmp117 * _tmp142 + _tmp119 * _tmp130) +
                 Scalar(1.0) * _tmp126 * (-_tmp130 + _tmp131 * _tmp65) +
                 Scalar(1.0) * _tmp137 * (-_tmp117 * _tmp136 + _tmp135) +
                 Scalar(1.0) * _tmp47 * (-_tmp117 * _tmp134 - _tmp130 * _tmp69 + Scalar(1.0))));
  const Scalar _tmp144 = Scalar(9.6622558468725703) * _tmp123;
  const Scalar _tmp145 = _tmp101 * _tmp107;
  const Scalar _tmp146 = _tmp114 * _tmp116 * _tmp61 + _tmp121 * _tmp122 * _tmp61 -
                         _tmp145 * _tmp61 * _tmp80 - _tmp47 * _tmp61 * _tmp92;
  const Scalar _tmp147 = Scalar(1.0) / (_tmp146);
  const Scalar _tmp148 = _tmp126 * _tmp130;
  const Scalar _tmp149 =
      std::asinh(_tmp147 * (_tmp107 * _tmp140 * _tmp65 + _tmp116 * _tmp139 * _tmp65 +
                            _tmp122 * _tmp142 * _tmp65 - _tmp127 * _tmp148 * _tmp65 +
                            _tmp134 * _tmp47 * _tmp65 + _tmp136 * _tmp137 * _tmp65));
  ...
  const Scalar _tmp152 =
      ...
      Scalar(15625.0) * std::pow(Scalar(-Scalar(0.0080000000000000002) * _tmp75 - 1), Scalar(2));
  const Scalar _tmp153 =
      _tmp113 * _tmp116 * _tmp90 + _tmp120 * _tmp122 * _tmp90 + _tmp145 + _tmp47 * _tmp93;
  const Scalar _tmp154 = Scalar(1.0) / (_tmp153);
  const Scalar _tmp155 = std::asinh(_tmp154 * (-_tmp107 * _tmp141 - _tmp112 * _tmp116 * _tmp129 -
                                               _tmp119 * _tmp122 * _tmp129 + _tmp133 * _tmp47 -
                                               _tmp135 * _tmp137 + _tmp148));
  ...
  _res(2, 0) =
      _tmp150 *
          (-std::sinh(Scalar(1.0) * _tmp149) -
           std::sinh(Scalar(0.1034955) * _tmp147 * (-_tmp149 * _tmp150 - std::sqrt(_tmp151)))) -
      Scalar(48.0) * std::sqrt(Scalar(
  ...
  _res(3, 0) =
      ...
      Scalar(48.0) * std::sqrt(Scalar(
                         ...
                         std::pow(Scalar(-Scalar(0.020833333333333332) * _tmp82 -
                                         Scalar(0.020833333333333332) * position_vector(2, 0) + 1),
                                  Scalar(2))));
