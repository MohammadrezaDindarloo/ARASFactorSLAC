...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl3(
  ...
  const Scalar _tmp53 = _tmp52 * (-_tmp42 * _tmp48 * _tmp50 + _tmp44 * _tmp46 * _tmp50);
  ...
  const Scalar _tmp58 = _tmp41 + _tmp9;
  ...
  const Scalar _tmp66 = -_tmp54 * _tmp62 + _tmp65;
  const Scalar _tmp67 = _tmp60 * _tmp61;
  const Scalar _tmp68 = _tmp44 * _tmp51;
  const Scalar _tmp69 = Scalar(1.0) / (_tmp62 * _tmp68 - _tmp67);
  const Scalar _tmp70 = _tmp68 * _tmp69;
  const Scalar _tmp71 = _tmp54 * _tmp67 - _tmp65 * _tmp68;
  const Scalar _tmp72 = _tmp64 * _tmp68 + _tmp70 * _tmp71;
  ...
  const Scalar _tmp78 = -_tmp64 + _tmp66 * _tmp70 - _tmp72 * _tmp77;
  const Scalar _tmp79 = _tmp18 + _tmp8;
  ...
  const Scalar _tmp90 = _tmp36 + _tmp63;
  const Scalar _tmp91 = _tmp64 * _tmp87;
  ...
  const Scalar _tmp95 = _tmp53 * _tmp62 - _tmp55 * _tmp67 + _tmp58 * _tmp62;
  const Scalar _tmp96 = _tmp53 * _tmp87 + _tmp79 * _tmp87 - _tmp82 * _tmp86 - _tmp89 * _tmp95;
  const Scalar _tmp97 = _tmp94 * _tmp96;
  const Scalar _tmp98 = Scalar(1.0) / (_tmp96);
  const Scalar _tmp99 = _tmp93 * _tmp98;
  const Scalar _tmp100 = _tmp99 * (-_tmp53 + _tmp70 * _tmp95 - _tmp78 * _tmp97);
  ...
  const Scalar _tmp105 = _tmp62 * _tmp69;
  ...
  const Scalar _tmp117 = _tmp116 * _tmp88 * _tmp98;
  const Scalar _tmp118 = _tmp107 * _tmp108;
  const Scalar _tmp119 = fh1 * (-_tmp109 * _tmp19 + _tmp118 * _tmp30);
  const Scalar _tmp120 = _tmp116 * _tmp71;
  const Scalar _tmp121 = -_tmp116 * _tmp66 + _tmp120 * _tmp77;
  const Scalar _tmp122 = _tmp99 * (-_tmp116 * _tmp95 - _tmp121 * _tmp97);
  const Scalar _tmp123 = _tmp121 + _tmp122;
  const Scalar _tmp124 = -_tmp103 * _tmp123 + Scalar(1.0);
  const Scalar _tmp125 = _tmp118 * fh1;
  const Scalar _tmp126 = -_tmp110 * _tmp52 * (_tmp101 * _tmp102 + _tmp104 * _tmp105 + Scalar(1.0)) -
                         _tmp111 * _tmp52 * (-_tmp114 * _tmp62 * _tmp89 + _tmp114 * _tmp87) -
                         _tmp119 * _tmp52 * (_tmp115 * _tmp87 - _tmp117 * _tmp62) -
                         _tmp125 * _tmp52 * (_tmp102 * _tmp123 + _tmp105 * _tmp124);
  ...
  const Scalar _tmp133 = -_tmp115 * _tmp92 + _tmp132 * _tmp99;
  ...
  const Scalar _tmp138 = _tmp100 * _tmp137 - _tmp101 * _tmp136 + _tmp72;
  const Scalar _tmp139 = _tmp131 * _tmp77;
  const Scalar _tmp140 = _tmp75 * (_tmp129 * _tmp131 + Scalar(1.0));
  const Scalar _tmp141 = _tmp40 * fh1;
  const Scalar _tmp142 = -_tmp118 * _tmp141 - Scalar(2.3544) * _tmp13 - _tmp19 * fv1;
  const Scalar _tmp143 = -_tmp120 + _tmp122 * _tmp137 - _tmp123 * _tmp136;
  const Scalar _tmp144 = _tmp109 * _tmp141 + Scalar(2.3544) * _tmp26 + _tmp30 * fv1;
  const Scalar _tmp145 = _tmp112 * _tmp130;
  const Scalar _tmp146 = _tmp75 * (-_tmp113 * _tmp136 - _tmp128 * _tmp145 + _tmp74);
  const Scalar _tmp147 =
      std::asinh(_tmp127 * (Scalar(1.0) * _tmp110 * (_tmp100 * _tmp131 - _tmp134 * _tmp138) +
                            Scalar(1.0) * _tmp111 *
                                (-_tmp112 * _tmp131 - Scalar(1.0) * _tmp146 + Scalar(1.0)) +
                            Scalar(1.0) * _tmp119 * (-_tmp133 * _tmp134 + _tmp135) +
                            Scalar(1.0) * _tmp125 * (_tmp122 * _tmp131 - _tmp134 * _tmp143) +
                            Scalar(1.0) * _tmp142 * (_tmp139 - Scalar(1.0) * _tmp140) +
                            Scalar(1.0) * _tmp144 * (-_tmp131 + _tmp132 * _tmp75)));
  ...
  const Scalar _tmp150 =
      Scalar(12100.0) * std::pow(Scalar(1 - Scalar(0.0090909090909090905) * _tmp59), Scalar(2)) +
      Scalar(15625.0) * std::pow(Scalar(-Scalar(0.0080000000000000002) * _tmp56 - 1), Scalar(2));
  const Scalar _tmp151 = _tmp131 * _tmp144;
  const Scalar _tmp152 = _tmp111 * _tmp114;
  const Scalar _tmp153 = _tmp104 * _tmp110 * _tmp69 - _tmp117 * _tmp119 +
                         _tmp124 * _tmp125 * _tmp69 - _tmp152 * _tmp89;
  const Scalar _tmp154 = Scalar(1.0) / (_tmp153);
  const Scalar _tmp155 = std::asinh(
      _tmp154 * (_tmp110 * _tmp138 * _tmp75 + _tmp111 * _tmp146 + _tmp119 * _tmp133 * _tmp75 +
                 _tmp125 * _tmp143 * _tmp75 - _tmp128 * _tmp151 * _tmp75 + _tmp140 * _tmp142));
  const Scalar _tmp156 = Scalar(9.6622558468725703) * _tmp153;
  const Scalar _tmp157 =
      _tmp101 * _tmp110 * _tmp94 + _tmp115 * _tmp119 + _tmp123 * _tmp125 * _tmp94 + _tmp152;
  const Scalar _tmp158 = Scalar(1.0) / (_tmp157);
  const Scalar _tmp159 =
      std::asinh(_tmp158 * (-_tmp100 * _tmp110 * _tmp130 + _tmp111 * _tmp145 - _tmp119 * _tmp135 -
                            _tmp122 * _tmp125 * _tmp130 - _tmp139 * _tmp142 + _tmp151));
  ...
  _res(1, 0) =
      _tmp149 *
          (-std::sinh(Scalar(1.0) * _tmp147) -
           std::sinh(Scalar(0.1034955) * _tmp127 * (-_tmp147 * _tmp149 - std::sqrt(_tmp148)))) -
      Scalar(48.0) * std::sqrt(Scalar(
  ...
  _res(2, 0) =
      _tmp156 *
          (-std::sinh(Scalar(1.0) * _tmp155) -
           std::sinh(Scalar(0.1034955) * _tmp154 * (-std::sqrt(_tmp150) - _tmp155 * _tmp156))) -
      Scalar(48.0) * std::sqrt(Scalar(
                         Scalar(0.00043402777777777775) * _tmp150 +
                         std::pow(Scalar(-Scalar(0.020833333333333332) * _tmp54 -
                                         Scalar(0.020833333333333332) * position_vector(2, 0) + 1),
                                  Scalar(2))));
  _res(3, 0) =
      _tmp160 *
