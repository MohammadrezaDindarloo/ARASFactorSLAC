...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl8(
  ...
  const Scalar _tmp68 = _tmp33 + _tmp37;
  const Scalar _tmp69 = _tmp48 * _tmp68;
  const Scalar _tmp70 = -_tmp48 * _tmp67 + _tmp69;
  const Scalar _tmp71 = _tmp61 * _tmp67 - _tmp63 * _tmp69;
  ...
  const Scalar _tmp78 = _tmp64 * _tmp71 * _tmp73 * _tmp77 - _tmp65 * _tmp70;
  const Scalar _tmp79 = _tmp33 + _tmp66;
  const Scalar _tmp80 = _tmp43 + _tmp52;
  const Scalar _tmp81 = _tmp80 + position_vector(0, 0);
  const Scalar _tmp82 = _tmp81 + Scalar(125.0);
  const Scalar _tmp83 = _tmp39 + _tmp5;
  ...
  const Scalar _tmp88 = _tmp63 * _tmp68;
  const Scalar _tmp89 = _tmp85 * _tmp86;
  const Scalar _tmp90 = _tmp63 * _tmp87 - _tmp89;
  const Scalar _tmp91 = _tmp64 * _tmp90;
  const Scalar _tmp92 = -_tmp71 * _tmp91 + _tmp79 * _tmp89 - _tmp87 * _tmp88;
  const Scalar _tmp93 = _tmp73 * _tmp76;
  const Scalar _tmp94 = _tmp68 * _tmp87 - _tmp70 * _tmp91 - _tmp79 * _tmp87 - _tmp92 * _tmp93;
  const Scalar _tmp95 = Scalar(1.0) / (_tmp94);
  const Scalar _tmp96 = _tmp60 * _tmp87 - _tmp62 * _tmp91 - _tmp80 * _tmp89 + _tmp83 * _tmp87;
  const Scalar _tmp97 = _tmp95 * _tmp96;
  const Scalar _tmp98 = Scalar(1.0) / (_tmp96);
  const Scalar _tmp99 = _tmp94 * _tmp98;
  const Scalar _tmp100 = _tmp99 * (-_tmp62 * _tmp65 - _tmp78 * _tmp97);
  ...
  const Scalar _tmp106 = _tmp19 + Scalar(110.0);
  const Scalar _tmp107 = _tmp29 + Scalar(-125.0);
  ...
  const Scalar _tmp112 = _tmp48 * _tmp91;
  const Scalar _tmp113 = _tmp107 * _tmp108;
  const Scalar _tmp114 = fh1 * (_tmp109 * _tmp28 - _tmp113 * _tmp18);
  const Scalar _tmp115 = _tmp63 * _tmp64;
  const Scalar _tmp116 = _tmp115 * _tmp71 + _tmp88;
  const Scalar _tmp117 = _tmp115 * _tmp70 - _tmp116 * _tmp93 - _tmp68;
  const Scalar _tmp118 = _tmp99 * (_tmp115 * _tmp62 - _tmp117 * _tmp97 - _tmp60);
  const Scalar _tmp119 = _tmp117 + _tmp118;
  const Scalar _tmp120 = -_tmp103 * _tmp119 - _tmp63;
  const Scalar _tmp121 = _tmp113 * fh1;
  const Scalar _tmp122 = Scalar(19.620000000000001) - fv1;
  const Scalar _tmp123 = _tmp72 + _tmp74 * _tmp93;
  const Scalar _tmp124 = 0;
  const Scalar _tmp125 = _tmp124 * _tmp95;
  const Scalar _tmp126 = -_tmp110 * _tmp59 * (_tmp101 * _tmp102 + _tmp104 * _tmp105) -
                         _tmp114 * _tmp59 * (-_tmp111 * _tmp112 + _tmp111 * _tmp87) -
                         _tmp121 * _tmp59 * (_tmp102 * _tmp119 + _tmp105 * _tmp120 + Scalar(1.0)) -
                         _tmp122 * _tmp59 * (-_tmp112 * _tmp125 + _tmp125 * _tmp87);
  const Scalar _tmp127 = Scalar(1.0) / (_tmp126);
  const Scalar _tmp128 = _tmp92 * _tmp95;
  const Scalar _tmp129 = _tmp75 + _tmp83;
  const Scalar _tmp130 = _tmp129 * _tmp93;
  const Scalar _tmp131 = Scalar(1.0) / (-_tmp130 + _tmp72 - _tmp80);
  const Scalar _tmp132 = _tmp129 * _tmp131;
  const Scalar _tmp133 = _tmp100 * _tmp132 - _tmp101 * _tmp128 - _tmp65 * _tmp71;
  const Scalar _tmp134 = Scalar(1.0) * _tmp131;
  const Scalar _tmp135 = _tmp116 + _tmp118 * _tmp132 - _tmp119 * _tmp128;
  const Scalar _tmp136 = _tmp129 * _tmp76;
  const Scalar _tmp137 = _tmp38 * fh1;
  const Scalar _tmp138 = _tmp113 * _tmp137 + Scalar(2.3544) * _tmp24 + _tmp28 * fv1;
  const Scalar _tmp139 = _tmp134 * _tmp99;
  const Scalar _tmp140 = -_tmp111 * _tmp92 + _tmp129 * _tmp139;
  const Scalar _tmp141 = _tmp130 * _tmp134 + Scalar(1.0);
  const Scalar _tmp142 = -_tmp109 * _tmp137 - Scalar(2.3544) * _tmp12 - _tmp18 * fv1;
  const Scalar _tmp143 = _tmp123 * _tmp131;
  const Scalar _tmp144 = -_tmp124 * _tmp128 - _tmp129 * _tmp143 + _tmp75;
  const Scalar _tmp145 = std::asinh(
      _tmp127 * (Scalar(1.0) * _tmp110 * (_tmp100 * _tmp134 - _tmp133 * _tmp77) +
                 Scalar(1.0) * _tmp114 * (_tmp139 - _tmp140 * _tmp77) +
                 Scalar(1.0) * _tmp121 * (_tmp118 * _tmp134 - _tmp135 * _tmp77) +
                 Scalar(1.0) * _tmp122 * (-_tmp123 * _tmp134 - _tmp144 * _tmp77 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp138 * (_tmp134 * _tmp136 - _tmp134) +
                 Scalar(1.0) * _tmp142 * (_tmp134 * _tmp93 - _tmp141 * _tmp77)));
  ...
  const Scalar _tmp148 = _tmp142 * _tmp76;
  const Scalar _tmp149 = _tmp134 * _tmp138;
  const Scalar _tmp150 = _tmp122 * _tmp125;
  const Scalar _tmp151 = _tmp111 * _tmp114;
  const Scalar _tmp152 =
      _tmp104 * _tmp110 * _tmp64 + _tmp120 * _tmp121 * _tmp64 - _tmp150 * _tmp91 - _tmp151 * _tmp91;
  const Scalar _tmp153 = Scalar(1.0) / (_tmp152);
  const Scalar _tmp154 =
      std::asinh(_tmp153 * (_tmp110 * _tmp133 * _tmp76 + _tmp114 * _tmp140 * _tmp76 +
                            _tmp121 * _tmp135 * _tmp76 + _tmp122 * _tmp144 * _tmp76 -
                            _tmp136 * _tmp149 + _tmp141 * _tmp148));
  ...
  const Scalar _tmp158 = _tmp95 * fh1;
  const Scalar _tmp159 =
      _tmp101 * _tmp109 * _tmp158 + _tmp113 * _tmp119 * _tmp158 + _tmp150 + _tmp151;
  const Scalar _tmp160 = Scalar(1.0) / (_tmp159);
  const Scalar _tmp161 = std::asinh(_tmp160 * (-_tmp100 * _tmp110 * _tmp131 - _tmp114 * _tmp139 -
                                               _tmp118 * _tmp121 * _tmp131 + _tmp122 * _tmp143 -
                                               _tmp134 * _tmp148 * _tmp73 + _tmp149));
  ...
  _res(2, 0) =
      ...
      Scalar(48.0) * std::sqrt(Scalar(
                         ...
                         std::pow(Scalar(-Scalar(0.020833333333333332) * _tmp67 -
                                         Scalar(0.020833333333333332) * position_vector(2, 0) + 1),
                                  Scalar(2))));
  _res(3, 0) =
      _tmp162 *
          (-std::sinh(Scalar(1.0) * _tmp161) -
           std::sinh(Scalar(0.1034955) * _tmp160 * (-std::sqrt(_tmp157) - _tmp161 * _tmp162))) -
      Scalar(48.0) * std::sqrt(Scalar(
