...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2WrtFv1Nl3(
  ...
  const Scalar _tmp64 = -_tmp52 * _tmp60 + _tmp63;
  const Scalar _tmp65 = _tmp58 * _tmp59;
  const Scalar _tmp66 = _tmp38 * _tmp45;
  const Scalar _tmp67 = Scalar(1.0) / (_tmp60 * _tmp66 - _tmp65);
  const Scalar _tmp68 = _tmp66 * _tmp67;
  const Scalar _tmp69 = _tmp52 * _tmp65 - _tmp63 * _tmp66;
  ...
  const Scalar _tmp75 = _tmp73 * (-_tmp53 + _tmp74);
  const Scalar _tmp76 = -_tmp62 + _tmp64 * _tmp68 - _tmp70 * _tmp75;
  const Scalar _tmp77 = _tmp14 + _tmp19 + _tmp8;
  ...
  const Scalar _tmp94 = _tmp47 * _tmp60 - _tmp53 * _tmp65 + _tmp56 * _tmp60;
  ...
  const Scalar _tmp115 = _tmp46 * (_tmp113 * _tmp85 - _tmp114 * _tmp60);
  ...
  const Scalar _tmp127 = -_tmp109 * _tmp46 * (_tmp100 * _tmp101 + _tmp103 * _tmp104 + Scalar(1.0)) -
                         _tmp110 * _tmp115 -
                         _tmp120 * _tmp46 * (_tmp116 * _tmp85 - _tmp118 * _tmp60) -
  ...
  const Scalar _tmp134 = -_tmp116 * _tmp91 + _tmp129 * _tmp133;
  const Scalar _tmp135 = Scalar(1.0) * _tmp73;
  const Scalar _tmp136 = _tmp91 * _tmp93;
  const Scalar _tmp137 = _tmp129 * _tmp131;
  const Scalar _tmp138 = -_tmp100 * _tmp136 + _tmp137 * _tmp99 + _tmp70;
  const Scalar _tmp139 = fh1 * (_tmp51 + _tmp88);
  const Scalar _tmp140 = -_tmp119 * _tmp139 - Scalar(2.3544) * _tmp17 - _tmp21 * fv1;
  const Scalar _tmp141 = _tmp132 * _tmp75;
  const Scalar _tmp142 = _tmp73 * (_tmp130 * _tmp132 + Scalar(1.0));
  const Scalar _tmp143 = Scalar(1.0) * _tmp141 - Scalar(1.0) * _tmp142;
  const Scalar _tmp144 = -_tmp121 + _tmp123 * _tmp137 - _tmp124 * _tmp136;
  const Scalar _tmp145 = _tmp108 * _tmp139 + Scalar(2.3544) * _tmp28 + _tmp32 * fv1;
  const Scalar _tmp146 = _tmp129 * _tmp73;
  const Scalar _tmp147 = Scalar(1.0) * _tmp132 * _tmp146 - Scalar(1.0) * _tmp132;
  const Scalar _tmp148 = _tmp111 * _tmp131;
  const Scalar _tmp149 = _tmp73 * (-_tmp112 * _tmp136 - _tmp129 * _tmp148 + _tmp72);
  const Scalar _tmp150 = -Scalar(1.0) * _tmp148 - Scalar(1.0) * _tmp149 + Scalar(1.0);
  const Scalar _tmp151 = Scalar(1.0) * _tmp109 * (_tmp132 * _tmp99 - _tmp135 * _tmp138) +
                         _tmp110 * _tmp150 + Scalar(1.0) * _tmp120 * (_tmp133 - _tmp134 * _tmp135) +
                         Scalar(1.0) * _tmp126 * (_tmp123 * _tmp132 - _tmp135 * _tmp144) +
                         _tmp140 * _tmp143 + _tmp145 * _tmp147;
  ...
  const Scalar _tmp161 = _tmp18 + _tmp35;
  const Scalar _tmp162 =
      (_tmp128 * (_tmp143 * _tmp161 + _tmp147 * _tmp32 - _tmp150) - _tmp151 * _tmp160) /
      std::sqrt(Scalar(std::pow(_tmp151, Scalar(2)) * _tmp159 + 1));
  const Scalar _tmp163 = _tmp132 * _tmp145;
  const Scalar _tmp164 = _tmp109 * _tmp138 * _tmp73 + _tmp110 * _tmp149 +
                         _tmp120 * _tmp134 * _tmp73 + _tmp126 * _tmp144 * _tmp73 +
                         _tmp140 * _tmp142 - _tmp146 * _tmp163;
  ...
  const Scalar _tmp174 =
      (-_tmp164 * _tmp172 + _tmp167 * (_tmp142 * _tmp161 - _tmp146 * _tmp173 - _tmp149)) /
  ...
  const Scalar _tmp180 = -_tmp109 * _tmp131 * _tmp99 + _tmp110 * _tmp148 - _tmp120 * _tmp133 -
                         _tmp123 * _tmp126 * _tmp131 - _tmp140 * _tmp141 + _tmp163;
  ...
  const Scalar _tmp187 = (_tmp180 * _tmp186 + _tmp182 * (-_tmp141 * _tmp161 - _tmp148 + _tmp173)) /
