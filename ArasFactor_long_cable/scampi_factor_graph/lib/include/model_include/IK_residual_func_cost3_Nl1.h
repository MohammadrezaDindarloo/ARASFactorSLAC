...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl1(
  ...
  const Scalar _tmp75 = _tmp73 * (_tmp50 * _tmp56 * _tmp74 - _tmp51 * _tmp54 * _tmp74);
  const Scalar _tmp76 = -_tmp38 * _tmp48 + _tmp42 * _tmp45 + _tmp45 * _tmp75;
  const Scalar _tmp77 = _tmp16 * _tmp30 - _tmp26 * _tmp59 + _tmp30 * _tmp75 - _tmp61 * _tmp76;
  const Scalar _tmp78 = Scalar(1.0) / (_tmp77);
  const Scalar _tmp79 = Scalar(1.0) * _tmp78;
  const Scalar _tmp80 = _tmp37 + _tmp49;
  const Scalar _tmp81 = _tmp41 + _tmp53;
  const Scalar _tmp82 = _tmp55 + _tmp81;
  const Scalar _tmp83 = _tmp39 + _tmp80;
  ...
  const Scalar _tmp89 = -_tmp47 * _tmp88 + _tmp63 * _tmp66 * _tmp88;
  const Scalar _tmp90 = _tmp68 * _tmp77;
  const Scalar _tmp91 = _tmp67 * _tmp78;
  const Scalar _tmp92 = _tmp89 + _tmp91 * (-_tmp76 * _tmp88 - _tmp89 * _tmp90);
  const Scalar _tmp93 = _tmp60 * _tmp68;
  const Scalar _tmp94 = -_tmp92 * _tmp93 + Scalar(1.0);
  const Scalar _tmp95 = _tmp45 * _tmp58;
  const Scalar _tmp96 = _tmp30 * _tmp68;
  const Scalar _tmp97 = _tmp73 * fh1;
  const Scalar _tmp98 = _tmp57 * _tmp58;
  const Scalar _tmp99 = -_tmp46 + _tmp47 * _tmp98 - _tmp66 * (_tmp62 + _tmp63 * _tmp98);
  const Scalar _tmp100 = _tmp91 * (-_tmp75 + _tmp76 * _tmp98 - _tmp90 * _tmp99) + _tmp99;
  const Scalar _tmp101 = -_tmp100 * _tmp93 - _tmp57;
  const Scalar _tmp102 = _tmp58 * fh1;
  const Scalar _tmp103 = _tmp0 * _tmp70;
  const Scalar _tmp104 = _tmp79 * _tmp87;
  ...
  _res(1, 0) = std::exp(_tmp0 * _tmp73 * (_tmp30 * _tmp70 - _tmp70 * _tmp71) +
                        _tmp73 * _tmp87 * (_tmp30 * _tmp79 - _tmp71 * _tmp79) +
                        _tmp85 * _tmp97 * (_tmp92 * _tmp96 + _tmp94 * _tmp95) +
                        _tmp86 * _tmp97 * (_tmp100 * _tmp96 + _tmp101 * _tmp95 + Scalar(1.0)));
  _res(2, 0) = std::exp(-_tmp101 * _tmp102 * _tmp86 - _tmp102 * _tmp85 * _tmp94 + _tmp103 * _tmp61 +
                        _tmp104 * _tmp61);
  _res(3, 0) =
      std::exp(-_tmp100 * _tmp105 * _tmp86 - _tmp103 - _tmp104 - _tmp105 * _tmp85 * _tmp92);
