...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl15(
  ...
  const Scalar _tmp65 = _tmp21 + _tmp44;
  ...
  const Scalar _tmp81 = _tmp51 * _tmp79 - _tmp52 * _tmp80;
  const Scalar _tmp82 = Scalar(1.0) * _tmp33;
  const Scalar _tmp83 = Scalar(1.0) * _tmp35;
  const Scalar _tmp84 = (-_tmp45 + _tmp82) / (_tmp46 - _tmp83);
  const Scalar _tmp85 = _tmp52 * _tmp76 - _tmp52 * _tmp79;
  const Scalar _tmp86 = _tmp32 * _tmp76 - _tmp32 * _tmp78 - _tmp58 * _tmp85 -
                        _tmp84 * (-_tmp32 * _tmp80 + _tmp55 * _tmp78 - _tmp58 * _tmp81);
  const Scalar _tmp87 = Scalar(1.0) / (_tmp86);
  const Scalar _tmp88 = _tmp82 + _tmp83 * _tmp84;
  const Scalar _tmp89 = 0;
  const Scalar _tmp90 = _tmp54 * _tmp57;
  const Scalar _tmp91 = -_tmp76 - _tmp84 * (_tmp80 + _tmp81 * _tmp90) + _tmp85 * _tmp90;
  const Scalar _tmp92 = _tmp59 * _tmp87;
  const Scalar _tmp93 = _tmp60 * _tmp86;
  const Scalar _tmp94 = _tmp91 + _tmp93 * (-_tmp43 + _tmp53 * _tmp90 - _tmp91 * _tmp92);
  const Scalar _tmp95 = _tmp56 * _tmp87;
  const Scalar _tmp96 = -_tmp54 - _tmp94 * _tmp95;
  const Scalar _tmp97 = _tmp52 * _tmp57;
  const Scalar _tmp98 = _tmp32 * _tmp87;
  const Scalar _tmp99 = _tmp68 * fh1;
  const Scalar _tmp100 = Scalar(1.0) * _tmp57;
  const Scalar _tmp101 = _tmp100 * _tmp81 * _tmp84 - _tmp100 * _tmp85;
  const Scalar _tmp102 = _tmp101 + _tmp93 * (-_tmp100 * _tmp53 - _tmp101 * _tmp92);
  const Scalar _tmp103 = -_tmp102 * _tmp95 + Scalar(1.0);
  const Scalar _tmp104 = _tmp69 * fh1;
  const Scalar _tmp105 = _tmp61 * _tmp70;
  const Scalar _tmp106 = _tmp71 * _tmp89;

  // Output terms (1)
  Eigen::Matrix<Scalar, 4, 1> _res;

  _res(0, 0) = std::exp(-fh1);
  _res(1, 0) = std::exp(_tmp104 * _tmp42 * (_tmp102 * _tmp98 + _tmp103 * _tmp97) +
                        _tmp42 * _tmp70 * (_tmp32 * _tmp61 - _tmp61 * _tmp62) +
                        _tmp42 * _tmp71 * (_tmp32 * _tmp89 - _tmp62 * _tmp89) +
                        _tmp42 * _tmp99 * (_tmp94 * _tmp98 + _tmp96 * _tmp97 + Scalar(1.0)));
  _res(2, 0) = std::exp(-_tmp103 * _tmp104 * _tmp57 + _tmp105 * _tmp58 + _tmp106 * _tmp58 -
                        _tmp57 * _tmp96 * _tmp99);
  _res(3, 0) = std::exp(-_tmp102 * _tmp104 * _tmp87 - _tmp105 - _tmp106 - _tmp87 * _tmp94 * _tmp99);
