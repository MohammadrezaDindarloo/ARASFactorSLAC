...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl16(
  ...
  const Scalar _tmp20 = -Scalar(0.20999999999999999) * _tmp10 + Scalar(0.20999999999999999) * _tmp7;
  ...
  const Scalar _tmp74 = Scalar(0.20999999999999999) * _tmp12 + Scalar(0.20999999999999999) * _tmp14;
  ...
  const Scalar _tmp79 = -_tmp41 * _tmp78 + _tmp52 * _tmp76;
  const Scalar _tmp80 = Scalar(1.0) * _tmp42;
  const Scalar _tmp81 = Scalar(1.0) * _tmp45;
  const Scalar _tmp82 = (-_tmp37 + _tmp81) / (_tmp34 - _tmp80);
  const Scalar _tmp83 = Scalar(1.0) * _tmp55;
  const Scalar _tmp84 = -_tmp41 * _tmp76 + _tmp41 * _tmp77;
  const Scalar _tmp85 = _tmp79 * _tmp82 * _tmp83 - _tmp83 * _tmp84;
  const Scalar _tmp86 = _tmp71 + _tmp75;
  const Scalar _tmp87 = _tmp32 * _tmp77;
  const Scalar _tmp88 = -_tmp32 * _tmp86 - _tmp58 * _tmp84 -
                        _tmp82 * (-_tmp54 * _tmp87 + _tmp56 * _tmp86 - _tmp58 * _tmp79) + _tmp87;
  const Scalar _tmp89 = Scalar(1.0) / (_tmp88);
  const Scalar _tmp90 = _tmp59 * _tmp89;
  const Scalar _tmp91 = _tmp60 * _tmp88;
  const Scalar _tmp92 = _tmp85 + _tmp91 * (-_tmp53 * _tmp83 - _tmp85 * _tmp90);
  const Scalar _tmp93 = _tmp57 * _tmp89;
  const Scalar _tmp94 = -_tmp92 * _tmp93 + Scalar(1.0);
  const Scalar _tmp95 = _tmp41 * _tmp55;
  const Scalar _tmp96 = _tmp32 * _tmp89;
  const Scalar _tmp97 = _tmp69 * fh1;
  const Scalar _tmp98 = Scalar(19.620000000000001) - fv1;
  const Scalar _tmp99 = _tmp80 * _tmp82 + _tmp81;
  const Scalar _tmp100 = 0;
  const Scalar _tmp101 = _tmp54 * _tmp55;
  const Scalar _tmp102 = _tmp101 * _tmp84 - _tmp77 - _tmp82 * (_tmp101 * _tmp79 + _tmp78);
  const Scalar _tmp103 = _tmp102 + _tmp91 * (_tmp101 * _tmp53 - _tmp102 * _tmp90 - _tmp51);
  const Scalar _tmp104 = -_tmp103 * _tmp93 - _tmp54;
  ...
  _res(1, 0) = std::exp(_tmp105 * _tmp50 * (_tmp103 * _tmp96 + _tmp104 * _tmp95 + Scalar(1.0)) +
                        _tmp50 * _tmp70 * (_tmp32 * _tmp61 - _tmp61 * _tmp62) +
                        _tmp50 * _tmp97 * (_tmp92 * _tmp96 + _tmp94 * _tmp95) +
                        _tmp50 * _tmp98 * (_tmp100 * _tmp32 - _tmp100 * _tmp62));
  _res(2, 0) = std::exp(-_tmp104 * _tmp105 * _tmp55 + _tmp106 * _tmp58 + _tmp107 * _tmp58 -
                        _tmp55 * _tmp94 * _tmp97);
  _res(3, 0) = std::exp(-_tmp103 * _tmp105 * _tmp89 - _tmp106 - _tmp107 - _tmp89 * _tmp92 * _tmp97);
