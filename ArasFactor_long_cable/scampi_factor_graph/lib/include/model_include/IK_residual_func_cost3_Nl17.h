...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl17(
  ...
  const Scalar _tmp71 = _tmp47 + _tmp51;
  ...
  const Scalar _tmp98 = _tmp43 * _tmp70;
  const Scalar _tmp99 = _tmp42 * _tmp54 - _tmp49 - _tmp57 * (_tmp42 * _tmp49 + _tmp42 * _tmp59);
  const Scalar _tmp100 = _tmp82 * (_tmp42 * _tmp78 - _tmp77 - _tmp80 * _tmp99) + _tmp99;
  const Scalar _tmp101 = -_tmp100 * _tmp84 - _tmp42;
  const Scalar _tmp102 = _tmp91 * _tmp92;
  const Scalar _tmp103 = Scalar(1.0) * _tmp81;
  const Scalar _tmp104 = fh1 * (-_tmp102 * _tmp88 + _tmp90 * _tmp93);
  ...
  _res(1, 0) = std::exp(_tmp102 * _tmp94 * (_tmp100 * _tmp87 + _tmp101 * _tmp86 + Scalar(1.0)) +
                        _tmp104 * _tmp76 * (_tmp103 * _tmp66 - _tmp103 * _tmp98) +
                        _tmp76 * _tmp95 * (_tmp66 * _tmp97 - _tmp97 * _tmp98) +
                        _tmp93 * _tmp94 * (_tmp83 * _tmp87 + _tmp85 * _tmp86));
  _res(2, 0) = std::exp(-_tmp101 * _tmp102 * _tmp105 - _tmp105 * _tmp85 * _tmp93 +
                        _tmp106 * _tmp70 + _tmp107 * _tmp70);
  _res(3, 0) =
      std::exp(-_tmp100 * _tmp102 * _tmp108 - _tmp106 - _tmp107 - _tmp108 * _tmp83 * _tmp93);
