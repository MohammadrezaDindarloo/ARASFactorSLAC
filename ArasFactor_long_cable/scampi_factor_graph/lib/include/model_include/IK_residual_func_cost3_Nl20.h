...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl20(
  ...
  const Scalar _tmp62 = _tmp16 + _tmp8;
  ...
  const Scalar _tmp67 = _tmp31 * _tmp65 - _tmp66;
  const Scalar _tmp68 = _tmp37 * _tmp65 -
                        _tmp54 * (-_tmp38 * _tmp65 - _tmp51 * _tmp67 + _tmp57 * _tmp66) -
                        _tmp55 * _tmp67 - _tmp57 * _tmp65;
  const Scalar _tmp69 = Scalar(1.0) / (_tmp68);
  const Scalar _tmp70 =
      std::sqrt(Scalar(std::pow(_tmp19, Scalar(2)) + std::pow(_tmp30, Scalar(2))));
  const Scalar _tmp71 = Scalar(1.0) / (_tmp70);
  const Scalar _tmp72 = _tmp20 * _tmp70;
  const Scalar _tmp73 = _tmp72 * (_tmp17 * _tmp30 * _tmp71 - _tmp19 * _tmp28 * _tmp71);
  const Scalar _tmp74 = _tmp49 * (_tmp40 * _tmp47 - _tmp43 * _tmp48 + _tmp47 * _tmp73);
  const Scalar _tmp75 = _tmp59 * _tmp65 - _tmp62 * _tmp66 + _tmp65 * _tmp73 - _tmp67 * _tmp74;
  const Scalar _tmp76 = _tmp69 * _tmp75;
  const Scalar _tmp77 = Scalar(1.0) / (_tmp75);
  const Scalar _tmp78 = _tmp68 * _tmp77;
  const Scalar _tmp79 = _tmp56 + _tmp78 * (_tmp31 * _tmp74 - _tmp56 * _tmp76 - _tmp73);
  const Scalar _tmp80 = _tmp67 * _tmp69;
  const Scalar _tmp81 = -_tmp31 - _tmp79 * _tmp80;
  const Scalar _tmp82 = _tmp47 * _tmp49;
  const Scalar _tmp83 = _tmp65 * _tmp69;
  const Scalar _tmp84 = _tmp42 + _tmp8;
  const Scalar _tmp85 = _tmp44 + _tmp84;
  const Scalar _tmp86 = _tmp39 + _tmp58;
  ...
  const Scalar _tmp91 = Scalar(19.620000000000001) - fv1;
  const Scalar _tmp92 = _tmp52 * _tmp54 + _tmp53;
  const Scalar _tmp93 = 0;
  const Scalar _tmp94 = _tmp80 * _tmp93;
  const Scalar _tmp95 = _tmp69 * _tmp93;
  const Scalar _tmp96 = Scalar(1.0) * _tmp51 * _tmp54 - Scalar(1.0) * _tmp55;
  const Scalar _tmp97 = _tmp78 * (-Scalar(1.0) * _tmp74 - _tmp76 * _tmp96) + _tmp96;
  const Scalar _tmp98 = -_tmp80 * _tmp97 + Scalar(1.0);
  const Scalar _tmp99 = _tmp87 * _tmp88;
  const Scalar _tmp100 = _tmp99 * fh1;
  const Scalar _tmp101 = Scalar(1.0) * _tmp77;
  const Scalar _tmp102 = fh1 * (_tmp84 * _tmp99 - _tmp86 * _tmp89);
  ...
  _res(1, 0) = std::exp(_tmp100 * _tmp72 * (_tmp82 * _tmp98 + _tmp83 * _tmp97) +
                        _tmp102 * _tmp72 * (_tmp101 * _tmp65 - _tmp101 * _tmp67 * _tmp82) +
                        _tmp72 * _tmp90 * (_tmp79 * _tmp83 + _tmp81 * _tmp82 + Scalar(1.0)) +
                        _tmp72 * _tmp91 * (_tmp65 * _tmp95 - _tmp82 * _tmp94));
  _res(2, 0) = std::exp(-_tmp100 * _tmp49 * _tmp98 + _tmp103 * _tmp49 * _tmp67 -
                        _tmp49 * _tmp81 * _tmp90 + _tmp49 * _tmp91 * _tmp94);
  _res(3, 0) =
      std::exp(-_tmp100 * _tmp69 * _tmp97 - _tmp103 - _tmp69 * _tmp79 * _tmp90 - _tmp91 * _tmp95);
