...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl3(
  ...
  const Scalar _tmp102 = -_tmp101 * _tmp83 + Scalar(1.0);
  ...
  _res(1, 0) = std::exp(_tmp103 * _tmp31 * (_tmp101 * _tmp82 + _tmp102 * _tmp85) +
                        _tmp31 * _tmp92 * (_tmp81 * _tmp82 + _tmp84 * _tmp85 + Scalar(1.0)) +
                        _tmp31 * _tmp93 * (_tmp68 * _tmp95 - _tmp95 * _tmp96) +
                        _tmp31 * _tmp99 * (_tmp68 * _tmp97 - _tmp96 * _tmp97));
  _res(2, 0) = std::exp(-_tmp102 * _tmp103 * _tmp44 + _tmp104 * _tmp71 + _tmp105 * _tmp71 -
                        _tmp44 * _tmp84 * _tmp92);
  _res(3, 0) = std::exp(-_tmp101 * _tmp103 * _tmp74 - _tmp104 - _tmp105 - _tmp74 * _tmp81 * _tmp92);
