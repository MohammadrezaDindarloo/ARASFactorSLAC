...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl5(
  ...
  const Scalar _tmp94 = -_tmp76 - _tmp83 * (_tmp55 * _tmp76 + _tmp80 * _tmp93) + _tmp84 * _tmp93;
  const Scalar _tmp95 = _tmp59 * _tmp86;
  const Scalar _tmp96 = _tmp60 * _tmp85;
  const Scalar _tmp97 = _tmp94 + _tmp96 * (-_tmp45 + _tmp54 * _tmp93 - _tmp94 * _tmp95);
  const Scalar _tmp98 = _tmp31 * _tmp86;
  const Scalar _tmp99 = -_tmp55 - _tmp91 * _tmp97;
  ...
  const Scalar _tmp103 = _tmp102 + _tmp96 * (-_tmp101 * _tmp54 - _tmp102 * _tmp95);
  const Scalar _tmp104 = -_tmp103 * _tmp91 + Scalar(1.0);
  const Scalar _tmp105 = _tmp61 * _tmp69;
  const Scalar _tmp106 = _tmp57 * fh1;
  const Scalar _tmp107 = _tmp86 * fh1;

  // Output terms (1)
  Eigen::Matrix<Scalar, 4, 1> _res;

  _res(0, 0) = std::exp(-fh1);
  _res(1, 0) = std::exp(_tmp100 * _tmp67 * (_tmp103 * _tmp98 + _tmp104 * _tmp90) +
                        _tmp100 * _tmp68 * (_tmp90 * _tmp99 + _tmp97 * _tmp98 + Scalar(1.0)) +
                        _tmp44 * _tmp69 * (_tmp31 * _tmp61 - _tmp52 * _tmp58 * _tmp61) +
                        _tmp44 * _tmp70 * (_tmp31 * _tmp89 - _tmp90 * _tmp92));
  _res(2, 0) = std::exp(-_tmp104 * _tmp106 * _tmp67 + _tmp105 * _tmp58 - _tmp106 * _tmp68 * _tmp99 +
                        _tmp57 * _tmp70 * _tmp92);
  _res(3, 0) =
      std::exp(-_tmp103 * _tmp107 * _tmp67 - _tmp105 - _tmp107 * _tmp68 * _tmp97 - _tmp70 * _tmp89);
