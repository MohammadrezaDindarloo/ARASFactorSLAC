...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl6(
  ...
  _res(1, 0) = std::exp(_tmp101 * _tmp74 * (_tmp100 * _tmp85 + _tmp82 * _tmp99 + Scalar(1.0)) +
                        _tmp102 * _tmp74 * (_tmp104 * _tmp65 - _tmp104 * _tmp94) +
                        _tmp74 * _tmp92 * (_tmp81 * _tmp82 + _tmp84 * _tmp85) +
                        _tmp74 * _tmp96 * (_tmp65 * _tmp93 - _tmp93 * _tmp94));
  _res(2, 0) = std::exp(-_tmp100 * _tmp101 * _tmp55 + _tmp105 * _tmp69 + _tmp106 * _tmp69 -
                        _tmp55 * _tmp84 * _tmp92);
  _res(3, 0) = std::exp(-_tmp101 * _tmp71 * _tmp99 - _tmp105 - _tmp106 - _tmp71 * _tmp81 * _tmp92);
