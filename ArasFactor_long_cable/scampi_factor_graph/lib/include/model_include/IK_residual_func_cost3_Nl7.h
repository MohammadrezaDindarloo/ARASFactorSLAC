...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl7(
  ...
  const Scalar _tmp46 = -Scalar(0.010999999999999999) * _tmp21 -
  ...
  const Scalar _tmp52 = _tmp44 * (_tmp37 * _tmp51 - _tmp42 * _tmp50);
  const Scalar _tmp53 = _tmp44 * (-_tmp43 * _tmp51 + _tmp50);
  const Scalar _tmp54 = Scalar(1.0) * _tmp31 * _tmp52 - Scalar(1.0) * _tmp53;
  ...
  const Scalar _tmp64 = _tmp45 + _tmp46 + _tmp47;
  const Scalar _tmp65 = _tmp56 * _tmp61;
  const Scalar _tmp66 = _tmp42 * _tmp62 - _tmp65;
  const Scalar _tmp67 = -_tmp31 * (-_tmp42 * _tmp63 - _tmp52 * _tmp66 + _tmp64 * _tmp65) -
                        _tmp53 * _tmp66 - _tmp62 * _tmp64 + _tmp63;
  const Scalar _tmp68 = Scalar(1.0) / (_tmp67);
  const Scalar _tmp69 =
      std::sqrt(Scalar(std::pow(_tmp39, Scalar(2)) + std::pow(_tmp40, Scalar(2))));
  const Scalar _tmp70 = Scalar(1.0) / (_tmp69);
  const Scalar _tmp71 = _tmp41 * _tmp69;
  const Scalar _tmp72 = _tmp71 * (-_tmp16 * _tmp40 * _tmp70 + _tmp29 * _tmp39 * _tmp70);
  const Scalar _tmp73 = _tmp44 * (_tmp19 * _tmp43 - _tmp27 * _tmp37 + _tmp43 * _tmp72);
  const Scalar _tmp74 = _tmp55 * _tmp62 - _tmp58 * _tmp65 + _tmp62 * _tmp72 - _tmp66 * _tmp73;
  const Scalar _tmp75 = _tmp68 * _tmp74;
  const Scalar _tmp76 = Scalar(1.0) / (_tmp74);
  const Scalar _tmp77 = _tmp67 * _tmp76;
  const Scalar _tmp78 = _tmp54 + _tmp77 * (-_tmp54 * _tmp75 - Scalar(1.0) * _tmp73);
  const Scalar _tmp79 = _tmp62 * _tmp68;
  const Scalar _tmp80 = _tmp66 * _tmp68;
  ...
  const Scalar _tmp91 = _tmp66 * _tmp82;
  const Scalar _tmp92 = _tmp86 * _tmp87;
  const Scalar _tmp93 = fh1 * (-_tmp83 * _tmp92 + _tmp85 * _tmp88);
  const Scalar _tmp94 = Scalar(19.620000000000001) - fv1;
  const Scalar _tmp95 = _tmp17 * _tmp31 + _tmp30;
  const Scalar _tmp96 = 0;
  const Scalar _tmp97 = -_tmp31 * (_tmp42 * _tmp49 + _tmp42 * _tmp52) + _tmp42 * _tmp53 - _tmp49;
  const Scalar _tmp98 = _tmp77 * (_tmp42 * _tmp73 - _tmp72 - _tmp75 * _tmp97) + _tmp97;
  const Scalar _tmp99 = -_tmp42 - _tmp80 * _tmp98;
  const Scalar _tmp100 = _tmp94 * _tmp96;
  const Scalar _tmp101 = _tmp44 * _tmp66;
  const Scalar _tmp102 = _tmp44 * fh1;
  const Scalar _tmp103 = _tmp90 * _tmp93;
  const Scalar _tmp104 = _tmp68 * fh1;

  // Output terms (1)
  Eigen::Matrix<Scalar, 4, 1> _res;

  _res(0, 0) = std::exp(-fh1);
  _res(1, 0) = std::exp(_tmp71 * _tmp93 * (_tmp62 * _tmp90 - _tmp90 * _tmp91) +
                        _tmp71 * _tmp94 * (_tmp62 * _tmp96 - _tmp91 * _tmp96) +
                        _tmp88 * _tmp89 * (_tmp78 * _tmp79 + _tmp81 * _tmp82) +
                        _tmp89 * _tmp92 * (_tmp79 * _tmp98 + _tmp82 * _tmp99 + Scalar(1.0)));
  _res(2, 0) = std::exp(_tmp100 * _tmp101 + _tmp101 * _tmp103 - _tmp102 * _tmp81 * _tmp88 -
                        _tmp102 * _tmp92 * _tmp99);
  _res(3, 0) = std::exp(-_tmp100 - _tmp103 - _tmp104 * _tmp78 * _tmp88 - _tmp104 * _tmp92 * _tmp98);
