...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl8(
  ...
  const Scalar _tmp98 = -_tmp56 + _tmp58 * _tmp97 - _tmp62 * (_tmp47 * _tmp56 + _tmp59 * _tmp97);
  const Scalar _tmp99 = _tmp80 * (-_tmp44 + _tmp46 * _tmp97 - _tmp78 * _tmp98) + _tmp98;
  const Scalar _tmp100 = -_tmp47 - _tmp83 * _tmp99;
  const Scalar _tmp101 = _tmp95 * fh1;
  const Scalar _tmp102 = Scalar(19.620000000000001) - fv1;
  const Scalar _tmp103 = _tmp60 + _tmp61 * _tmp62;
  const Scalar _tmp104 = 0;
  const Scalar _tmp105 = _tmp102 * _tmp104;
  const Scalar _tmp106 = _tmp93 * _tmp96;

  // Output terms (1)
  Eigen::Matrix<Scalar, 4, 1> _res;

  _res(0, 0) = std::exp(-fh1);
  _res(1, 0) = std::exp(_tmp101 * _tmp43 * (_tmp100 * _tmp85 + _tmp82 * _tmp99 + Scalar(1.0)) +
                        _tmp102 * _tmp43 * (_tmp104 * _tmp70 - _tmp104 * _tmp94) +
                        _tmp43 * _tmp92 * (_tmp81 * _tmp82 + _tmp84 * _tmp85) +
                        _tmp43 * _tmp96 * (_tmp70 * _tmp93 - _tmp93 * _tmp94));
  _res(2, 0) = std::exp(-_tmp100 * _tmp101 * _tmp48 + _tmp105 * _tmp74 + _tmp106 * _tmp74 -
                        _tmp48 * _tmp84 * _tmp92);
