...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl10(
  ...
  const Scalar _tmp52 = _tmp33 - _tmp34 + _tmp37;
  const Scalar _tmp53 = -_tmp50 * _tmp52 + _tmp51;
  const Scalar _tmp54 = _tmp40 + _tmp5;
  ...
  const Scalar _tmp60 = _tmp43 * _tmp49;
  const Scalar _tmp61 = Scalar(1.0) / (_tmp50 * _tmp59 - _tmp60);
  const Scalar _tmp62 = _tmp19 * _tmp30;
  const Scalar _tmp63 = _tmp31 * _tmp59 - _tmp62;
  const Scalar _tmp64 = _tmp61 * _tmp63;
  const Scalar _tmp65 = _tmp31 * _tmp38;
  const Scalar _tmp66 = -_tmp51 * _tmp59 + _tmp52 * _tmp60;
  const Scalar _tmp67 = Scalar(1.0) * _tmp54;
  const Scalar _tmp68 = Scalar(1.0) * _tmp56;
  const Scalar _tmp69 = (-_tmp46 + _tmp68) / (_tmp41 - _tmp67);
  const Scalar _tmp70 = -_tmp31 * _tmp36 - _tmp53 * _tmp64 + _tmp65 -
                        _tmp69 * (_tmp36 * _tmp62 - _tmp59 * _tmp65 - _tmp64 * _tmp66);
  ...
  const Scalar _tmp76 = _tmp26 + _tmp44;
  const Scalar _tmp77 = _tmp16 + _tmp39;
  const Scalar _tmp78 = _tmp42 + _tmp77;
  const Scalar _tmp79 = _tmp28 + _tmp76;
  ...
  const Scalar _tmp83 = _tmp76 * _tmp81 - _tmp77 * _tmp82;
  const Scalar _tmp84 = Scalar(1.0) / (_tmp74);
  const Scalar _tmp85 = _tmp75 * (-_tmp54 * _tmp57 * _tmp84 + _tmp55 * _tmp56 * _tmp84);
  const Scalar _tmp86 = _tmp41 * _tmp50 - _tmp46 * _tmp60 + _tmp50 * _tmp85;
  const Scalar _tmp87 = _tmp17 * _tmp31 - _tmp27 * _tmp62 + _tmp31 * _tmp85 - _tmp64 * _tmp86;
  ...
  const Scalar _tmp92 = _tmp75 * _tmp83 * (_tmp31 * _tmp89 - _tmp50 * _tmp91);
  const Scalar _tmp93 = -_tmp53 * _tmp90 + _tmp66 * _tmp69 * _tmp90;
  const Scalar _tmp94 = _tmp71 * _tmp87;
  const Scalar _tmp95 = _tmp70 * _tmp88;
  const Scalar _tmp96 = _tmp93 + _tmp95 * (-_tmp86 * _tmp90 - _tmp93 * _tmp94);
  const Scalar _tmp97 = _tmp63 * _tmp71;
  const Scalar _tmp98 = _tmp61 * (-_tmp96 * _tmp97 + Scalar(1.0));
  const Scalar _tmp99 = _tmp31 * _tmp71;
  const Scalar _tmp100 = _tmp75 * _tmp81 * (_tmp50 * _tmp98 + _tmp96 * _tmp99);
  const Scalar _tmp101 = _tmp59 * _tmp61;
  const Scalar _tmp102 = _tmp101 * _tmp53 - _tmp38 - _tmp69 * (_tmp101 * _tmp66 + _tmp38 * _tmp59);
  const Scalar _tmp103 = _tmp102 + _tmp95 * (_tmp101 * _tmp86 - _tmp102 * _tmp94 - _tmp85);
  const Scalar _tmp104 = _tmp61 * (-_tmp103 * _tmp97 - _tmp59);
  const Scalar _tmp105 = _tmp75 * _tmp82 * (_tmp103 * _tmp99 + _tmp104 * _tmp50 + Scalar(1.0));
  const Scalar _tmp106 = _tmp104 * _tmp82;
  const Scalar _tmp107 = _tmp83 * _tmp91;
  const Scalar _tmp108 = _tmp0 * _tmp73;
  const Scalar _tmp109 = _tmp81 * _tmp98;
  const Scalar _tmp110 = _tmp83 * _tmp89;
  const Scalar _tmp111 = _tmp71 * _tmp81 * _tmp96;
  const Scalar _tmp112 = _tmp103 * _tmp71 * _tmp82;

  // Output terms (1)
  Eigen::Matrix<Scalar, 4, 1> _res;

  _res(0, 0) = -std::exp(-fh1);
  _res(1, 0) = -(-_tmp100 - _tmp105 - _tmp92) *
               std::exp(_tmp0 * _tmp75 * (_tmp31 * _tmp73 - _tmp50 * _tmp64 * _tmp73) +
                        _tmp100 * fh1 + _tmp105 * fh1 + _tmp92 * fh1);
  _res(2, 0) = -(_tmp106 - _tmp107 + _tmp109) *
               std::exp(-_tmp106 * fh1 + _tmp107 * fh1 + _tmp108 * _tmp64 - _tmp109 * fh1);
