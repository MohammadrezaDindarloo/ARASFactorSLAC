...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl12(
  ...
  const Scalar _tmp51 = _tmp32 * _tmp46 - _tmp50;
  ...
  const Scalar _tmp61 = Scalar(1.0) / (_tmp46 * _tmp60 - _tmp59);
  const Scalar _tmp62 = _tmp34 + _tmp47;
  const Scalar _tmp63 = _tmp48 * _tmp60;
  const Scalar _tmp64 = _tmp61 * (-_tmp46 * _tmp63 + _tmp59 * _tmp62);
  const Scalar _tmp65 = Scalar(1.0) * _tmp39;
  const Scalar _tmp66 = Scalar(1.0) * _tmp43;
  const Scalar _tmp67 = (-_tmp55 + _tmp66) / (_tmp52 - _tmp65);
  const Scalar _tmp68 = _tmp61 * (-_tmp60 * _tmp62 + _tmp63);
  const Scalar _tmp69 = -_tmp32 * _tmp37 + _tmp49 - _tmp51 * _tmp68 -
                        _tmp67 * (_tmp37 * _tmp50 - _tmp46 * _tmp49 - _tmp51 * _tmp64);
  const Scalar _tmp70 = Scalar(1.0) / (_tmp69);
  const Scalar _tmp71 = _tmp65 * _tmp67 + _tmp66;
  const Scalar _tmp72 = 0;
  const Scalar _tmp73 = _tmp70 * _tmp72;
  const Scalar _tmp74 = _tmp51 * _tmp70;
  ...
  const Scalar _tmp78 = _tmp20 + _tmp27;
  const Scalar _tmp79 = _tmp29 + _tmp78;
  const Scalar _tmp80 = _tmp54 + _tmp9;
  ...
  const Scalar _tmp85 = -_tmp78 * _tmp83 + _tmp80 * _tmp84;
  const Scalar _tmp86 = Scalar(1.0) / (_tmp76);
  const Scalar _tmp87 = _tmp77 * (-_tmp39 * _tmp44 * _tmp86 + _tmp41 * _tmp43 * _tmp86);
  const Scalar _tmp88 = _tmp61 * (_tmp52 * _tmp60 - _tmp55 * _tmp59 + _tmp60 * _tmp87);
  const Scalar _tmp89 = -_tmp17 * _tmp50 + _tmp28 * _tmp32 + _tmp32 * _tmp87 - _tmp51 * _tmp88;
  const Scalar _tmp90 = Scalar(1.0) / (_tmp89);
  const Scalar _tmp91 = Scalar(1.0) * _tmp90;
  const Scalar _tmp92 = _tmp51 * _tmp61;
  const Scalar _tmp93 = _tmp77 * _tmp85 * (_tmp32 * _tmp91 - _tmp60 * _tmp91 * _tmp92);
  const Scalar _tmp94 = Scalar(1.0) * _tmp64 * _tmp67 - Scalar(1.0) * _tmp68;
  const Scalar _tmp95 = _tmp70 * _tmp89;
  const Scalar _tmp96 = _tmp69 * _tmp90;
  const Scalar _tmp97 = _tmp94 + _tmp96 * (-Scalar(1.0) * _tmp88 - _tmp94 * _tmp95);
  const Scalar _tmp98 = _tmp61 * (-_tmp74 * _tmp97 + Scalar(1.0));
  const Scalar _tmp99 = _tmp70 * _tmp97;
  const Scalar _tmp100 = _tmp77 * _tmp84 * (_tmp32 * _tmp99 + _tmp60 * _tmp98);
  const Scalar _tmp101 = _tmp46 * _tmp68 - _tmp48 - _tmp67 * (_tmp46 * _tmp48 + _tmp46 * _tmp64);
  const Scalar _tmp102 = _tmp101 + _tmp96 * (-_tmp101 * _tmp95 + _tmp46 * _tmp88 - _tmp87);
  const Scalar _tmp103 = _tmp102 * _tmp70;
  const Scalar _tmp104 = _tmp61 * (-_tmp102 * _tmp74 - _tmp46);
  const Scalar _tmp105 = _tmp77 * _tmp83 * (_tmp103 * _tmp32 + _tmp104 * _tmp60 + Scalar(1.0));
  const Scalar _tmp106 = _tmp104 * _tmp83;
  const Scalar _tmp107 = _tmp85 * _tmp91;
  const Scalar _tmp108 = _tmp107 * fh1;
  const Scalar _tmp109 = _tmp84 * _tmp98;
  const Scalar _tmp110 = _tmp103 * _tmp83;
  ...
  _res(1, 0) = -(-_tmp100 - _tmp105 - _tmp93) *
               std::exp(_tmp0 * _tmp77 * (_tmp32 * _tmp73 - _tmp60 * _tmp75) + _tmp100 * fh1 +
                        _tmp105 * fh1 + _tmp93 * fh1);
  _res(2, 0) = -(_tmp106 - _tmp107 * _tmp92 + _tmp109) *
               std::exp(_tmp0 * _tmp75 - _tmp106 * fh1 + _tmp108 * _tmp92 - _tmp109 * fh1);
  _res(3, 0) = -(_tmp107 + _tmp110 + _tmp111) *
               std::exp(-_tmp0 * _tmp73 - _tmp108 - _tmp110 * fh1 - _tmp111 * fh1);
