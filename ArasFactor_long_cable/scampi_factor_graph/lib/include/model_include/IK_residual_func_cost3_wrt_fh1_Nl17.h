...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl17(
  ...
  const Scalar _tmp44 = Scalar(1.0) / (_tmp31 * _tmp43 - _tmp32);
  ...
  const Scalar _tmp53 = -_tmp31 * _tmp52 + _tmp50;
  const Scalar _tmp54 = Scalar(1.0) * _tmp44;
  const Scalar _tmp55 = _tmp32 * _tmp52 - _tmp43 * _tmp50;
  const Scalar _tmp56 = Scalar(1.0) * _tmp39;
  const Scalar _tmp57 = Scalar(1.0) * _tmp35;
  const Scalar _tmp58 = (-_tmp27 + _tmp56) / (_tmp16 - _tmp57);
  const Scalar _tmp59 = -_tmp53 * _tmp54 + _tmp54 * _tmp55 * _tmp58;
  const Scalar _tmp60 = _tmp15 + _tmp33;
  const Scalar _tmp61 = _tmp17 + _tmp60;
  const Scalar _tmp62 = _tmp20 + _tmp38;
  ...
  const Scalar _tmp67 = _tmp43 * _tmp65 - _tmp66;
  const Scalar _tmp68 = _tmp44 * _tmp67;
  const Scalar _tmp69 = _tmp48 + _tmp51;
  const Scalar _tmp70 = _tmp43 * _tmp49;
  const Scalar _tmp71 = _tmp49 * _tmp65 - _tmp53 * _tmp68 -
                        _tmp58 * (-_tmp55 * _tmp68 - _tmp65 * _tmp70 + _tmp66 * _tmp69) -
                        _tmp65 * _tmp69;
  ...
  const Scalar _tmp76 = _tmp75 * (-_tmp35 * _tmp41 * _tmp74 + _tmp37 * _tmp39 * _tmp74);
  const Scalar _tmp77 = _tmp16 * _tmp31 - _tmp27 * _tmp32 + _tmp31 * _tmp76;
  const Scalar _tmp78 = _tmp60 * _tmp65 - _tmp62 * _tmp66 + _tmp65 * _tmp76 - _tmp68 * _tmp77;
  const Scalar _tmp79 = _tmp72 * _tmp78;
  const Scalar _tmp80 = Scalar(1.0) / (_tmp78);
  const Scalar _tmp81 = _tmp71 * _tmp80;
  const Scalar _tmp82 = _tmp59 + _tmp81 * (-_tmp54 * _tmp77 - _tmp59 * _tmp79);
  const Scalar _tmp83 = _tmp67 * _tmp72;
  const Scalar _tmp84 = _tmp44 * (-_tmp82 * _tmp83 + Scalar(1.0));
  ...
  const Scalar _tmp92 = _tmp75 * _tmp91 * (_tmp31 * _tmp84 + _tmp65 * _tmp85);
  const Scalar _tmp93 = Scalar(19.620000000000001) - fv1;
  const Scalar _tmp94 = _tmp56 + _tmp57 * _tmp58;
  const Scalar _tmp95 = 0;
  const Scalar _tmp96 = _tmp72 * _tmp95;
  const Scalar _tmp97 = _tmp44 * _tmp83 * _tmp95;
  const Scalar _tmp98 = _tmp43 * _tmp44;
  const Scalar _tmp99 = -_tmp49 + _tmp53 * _tmp98 - _tmp58 * (_tmp55 * _tmp98 + _tmp70);
  const Scalar _tmp100 = _tmp81 * (-_tmp76 + _tmp77 * _tmp98 - _tmp79 * _tmp99) + _tmp99;
  const Scalar _tmp101 = _tmp100 * _tmp72;
  const Scalar _tmp102 = _tmp44 * (-_tmp100 * _tmp83 - _tmp43);
  const Scalar _tmp103 = _tmp89 * _tmp90;
  const Scalar _tmp104 = _tmp103 * _tmp75 * (_tmp101 * _tmp65 + _tmp102 * _tmp31 + Scalar(1.0));
  const Scalar _tmp105 = -_tmp103 * _tmp86 + _tmp88 * _tmp91;
  const Scalar _tmp106 = _tmp54 * _tmp67 * _tmp80;
  const Scalar _tmp107 = Scalar(1.0) * _tmp80;
  const Scalar _tmp108 = _tmp105 * _tmp75 * (-_tmp106 * _tmp31 + _tmp107 * _tmp65);
  const Scalar _tmp109 = _tmp84 * _tmp91;
  const Scalar _tmp110 = _tmp102 * _tmp103;
  const Scalar _tmp111 = _tmp105 * _tmp106;
  const Scalar _tmp112 = _tmp85 * _tmp91;
  const Scalar _tmp113 = _tmp101 * _tmp103;
  ...
  _res(1, 0) = -(-_tmp104 - _tmp108 - _tmp92) *
               std::exp(_tmp104 * fh1 + _tmp108 * fh1 +
                        _tmp75 * _tmp93 * (-_tmp31 * _tmp97 + _tmp65 * _tmp96) + _tmp92 * fh1);
  _res(2, 0) = -(_tmp109 + _tmp110 - _tmp111) *
               std::exp(-_tmp109 * fh1 - _tmp110 * fh1 + _tmp111 * fh1 + _tmp93 * _tmp97);
  _res(3, 0) = -(_tmp112 + _tmp113 + _tmp114) *
               std::exp(-_tmp112 * fh1 - _tmp113 * fh1 - _tmp114 * fh1 - _tmp93 * _tmp96);
