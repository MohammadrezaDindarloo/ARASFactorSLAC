...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl18(
  ...
  const Scalar _tmp31 = _tmp17 * _tmp29;
  ...
  const Scalar _tmp45 = _tmp44 * (-_tmp33 * _tmp38 * _tmp43 + _tmp34 * _tmp36 * _tmp43);
  const Scalar _tmp46 = _tmp15 * _tmp30 - _tmp26 * _tmp31 + _tmp30 * _tmp45;
  ...
  const Scalar _tmp50 = -Scalar(0.010999999999999999) * _tmp23 -
  ...
  const Scalar _tmp56 = -_tmp30 * _tmp53 + _tmp55;
  const Scalar _tmp57 = _tmp31 * _tmp53 - _tmp40 * _tmp55;
  const Scalar _tmp58 = Scalar(1.0) * _tmp33;
  const Scalar _tmp59 = Scalar(1.0) * _tmp36;
  const Scalar _tmp60 = (-_tmp26 + _tmp59) / (_tmp15 - _tmp58);
  const Scalar _tmp61 = _tmp47 * _tmp56 - _tmp54 - _tmp60 * (_tmp40 * _tmp54 + _tmp47 * _tmp57);
  ...
  const Scalar _tmp66 = _tmp18 + _tmp25;
  ...
  const Scalar _tmp71 = _tmp40 * _tmp69 - _tmp70;
  const Scalar _tmp72 = _tmp41 * _tmp71;
  const Scalar _tmp73 = _tmp45 * _tmp69 - _tmp46 * _tmp72 + _tmp63 * _tmp69 - _tmp66 * _tmp70;
  const Scalar _tmp74 = _tmp54 * _tmp69;
  const Scalar _tmp75 = _tmp48 + _tmp52;
  const Scalar _tmp76 = -_tmp56 * _tmp72 -
                        _tmp60 * (-_tmp40 * _tmp74 - _tmp57 * _tmp72 + _tmp70 * _tmp75) -
                        _tmp69 * _tmp75 + _tmp74;
  ...
  const Scalar _tmp81 = _tmp61 + _tmp80 * (-_tmp45 + _tmp46 * _tmp47 - _tmp61 * _tmp78);
  const Scalar _tmp82 = _tmp71 * _tmp77;
  const Scalar _tmp83 = _tmp41 * (-_tmp40 - _tmp81 * _tmp82);
  const Scalar _tmp84 = _tmp77 * _tmp81;
  const Scalar _tmp85 = _tmp18 + _tmp35;
  const Scalar _tmp86 = _tmp37 + _tmp85;
  const Scalar _tmp87 = _tmp32 + _tmp62;
  ...
  const Scalar _tmp91 = _tmp44 * _tmp90 * (_tmp30 * _tmp83 + _tmp69 * _tmp84 + Scalar(1.0));
  const Scalar _tmp92 = _tmp88 * _tmp89;
  const Scalar _tmp93 = _tmp85 * _tmp92 - _tmp87 * _tmp90;
  const Scalar _tmp94 = Scalar(1.0) * _tmp79;
  const Scalar _tmp95 = _tmp30 * _tmp72;
  const Scalar _tmp96 = _tmp44 * _tmp93 * (_tmp69 * _tmp94 - _tmp94 * _tmp95);
  const Scalar _tmp97 = Scalar(19.620000000000001) - fv1;
  const Scalar _tmp98 = _tmp58 * _tmp60 + _tmp59;
  const Scalar _tmp99 = 0;
  const Scalar _tmp100 = Scalar(1.0) * _tmp41;
  const Scalar _tmp101 = -_tmp100 * _tmp56 + _tmp100 * _tmp57 * _tmp60;
  const Scalar _tmp102 = _tmp101 + _tmp80 * (-_tmp100 * _tmp46 - _tmp101 * _tmp78);
  const Scalar _tmp103 = _tmp41 * (-_tmp102 * _tmp82 + Scalar(1.0));
  const Scalar _tmp104 = _tmp102 * _tmp77;
  const Scalar _tmp105 = _tmp44 * _tmp92 * (_tmp103 * _tmp30 + _tmp104 * _tmp69);
  ...
  const Scalar _tmp110 = _tmp103 * _tmp92;
  const Scalar _tmp111 = _tmp84 * _tmp90;
  const Scalar _tmp112 = _tmp104 * _tmp92;
  ...
  _res(1, 0) = -(-_tmp105 - _tmp91 - _tmp96) *
               std::exp(_tmp105 * fh1 + _tmp44 * _tmp97 * (_tmp69 * _tmp99 - _tmp95 * _tmp99) +
                        _tmp91 * fh1 + _tmp96 * fh1);
  _res(2, 0) = -(-_tmp106 * _tmp72 + _tmp108 + _tmp110) *
               std::exp(_tmp107 * _tmp72 - _tmp108 * fh1 + _tmp109 * _tmp72 - _tmp110 * fh1);
  _res(3, 0) =
      -(_tmp106 + _tmp111 + _tmp112) * std::exp(-_tmp107 - _tmp109 - _tmp111 * fh1 - _tmp112 * fh1);
