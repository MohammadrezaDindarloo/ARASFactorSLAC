...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl21(
  ...
  const Scalar _tmp62 = Scalar(1.0) / (_tmp48 * _tmp57 - _tmp59);
  const Scalar _tmp63 = _tmp61 * _tmp62;
  const Scalar _tmp64 = Scalar(1.0) * _tmp46;
  const Scalar _tmp65 = Scalar(1.0) * _tmp42;
  const Scalar _tmp66 = (-_tmp54 + _tmp65) / (_tmp51 - _tmp64);
  const Scalar _tmp67 = _tmp38 * _tmp57 - _tmp57 * _tmp58;
  const Scalar _tmp68 = _tmp32 * _tmp38 - _tmp32 * _tmp39 - _tmp63 * _tmp67 -
                        _tmp66 * (-_tmp32 * _tmp49 + _tmp39 * _tmp40 - _tmp60 * _tmp63);
  const Scalar _tmp69 = Scalar(1.0) / (_tmp68);
  const Scalar _tmp70 = Scalar(1.0) * _tmp62;
  const Scalar _tmp71 = _tmp60 * _tmp66 * _tmp70 - _tmp67 * _tmp70;
  const Scalar _tmp72 =
      std::sqrt(Scalar(std::pow(_tmp44, Scalar(2)) + std::pow(_tmp47, Scalar(2))));
  const Scalar _tmp73 = Scalar(1.0) / (_tmp72);
  const Scalar _tmp74 = _tmp45 * _tmp72;
  const Scalar _tmp75 = _tmp74 * (_tmp42 * _tmp47 * _tmp73 - _tmp44 * _tmp46 * _tmp73);
  const Scalar _tmp76 = _tmp51 * _tmp57 - _tmp54 * _tmp59 + _tmp57 * _tmp75;
  const Scalar _tmp77 = _tmp17 * _tmp32 - _tmp28 * _tmp40 + _tmp32 * _tmp75 - _tmp63 * _tmp76;
  ...
  const Scalar _tmp86 = _tmp50 + _tmp9;
  ...
  const Scalar _tmp92 = _tmp74 * _tmp91 * (_tmp32 * _tmp82 + _tmp84 * _tmp85);
  const Scalar _tmp93 = _tmp48 * _tmp62;
  const Scalar _tmp94 = -_tmp38 - _tmp66 * (_tmp49 + _tmp60 * _tmp93) + _tmp67 * _tmp93;
  const Scalar _tmp95 = _tmp80 * (-_tmp75 + _tmp76 * _tmp93 - _tmp78 * _tmp94) + _tmp94;
  const Scalar _tmp96 = -_tmp48 - _tmp83 * _tmp95;
  const Scalar _tmp97 = _tmp69 * _tmp95;
  const Scalar _tmp98 = _tmp89 * _tmp90;
  const Scalar _tmp99 = _tmp74 * _tmp98 * (_tmp32 * _tmp97 + _tmp85 * _tmp96 + Scalar(1.0));
  const Scalar _tmp100 = -_tmp86 * _tmp98 + _tmp88 * _tmp91;
  const Scalar _tmp101 = Scalar(1.0) * _tmp79;
  const Scalar _tmp102 = _tmp57 * _tmp63;
  const Scalar _tmp103 = _tmp100 * _tmp74 * (-_tmp101 * _tmp102 + _tmp101 * _tmp32);
  const Scalar _tmp104 = Scalar(19.620000000000001) - fv1;
  const Scalar _tmp105 = _tmp64 * _tmp66 + _tmp65;
  const Scalar _tmp106 = 0;
  const Scalar _tmp107 = _tmp62 * _tmp96 * _tmp98;
  const Scalar _tmp108 = _tmp100 * _tmp101;
  ...
  _res(1, 0) = -(-_tmp103 - _tmp92 - _tmp99) *
               std::exp(_tmp103 * fh1 + _tmp104 * _tmp74 * (-_tmp102 * _tmp106 + _tmp106 * _tmp32) +
