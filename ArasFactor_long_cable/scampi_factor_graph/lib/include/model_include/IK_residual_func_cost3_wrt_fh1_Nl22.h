...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl22(
  ...
  const Scalar _tmp54 = _tmp23 + _tmp33;
  const Scalar _tmp55 = _tmp36 + _tmp54;
  const Scalar _tmp56 = _tmp15 + _tmp38;
  ...
  const Scalar _tmp62 = _tmp37 * _tmp43;
  const Scalar _tmp63 = _tmp46 * _tmp51;
  const Scalar _tmp64 = _tmp44 * _tmp63 - _tmp62;
  const Scalar _tmp65 = Scalar(1.0) / (_tmp59 * _tmp63 - _tmp60);
  const Scalar _tmp66 = _tmp64 * _tmp65;
  const Scalar _tmp67 = _tmp35 * _tmp44 - _tmp40 * _tmp62 + _tmp44 * _tmp53 - _tmp61 * _tmp66;
  const Scalar _tmp68 = Scalar(1.0) / (_tmp67);
  const Scalar _tmp69 = Scalar(1.0) * _tmp68;
  const Scalar _tmp70 = _tmp32 * _tmp52 * (_tmp44 * _tmp69 - _tmp59 * _tmp66 * _tmp69);
  const Scalar _tmp71 = Scalar(0.20999999999999999) * _tmp12 - Scalar(0.20999999999999999) * _tmp13;
  const Scalar _tmp72 = -Scalar(0.010999999999999999) * _tmp17 -
  ...
  const Scalar _tmp79 = _tmp60 * _tmp76 - _tmp63 * _tmp78;
  const Scalar _tmp80 = _tmp44 * _tmp77;
  const Scalar _tmp81 = Scalar(1.0) * _tmp47;
  const Scalar _tmp82 = Scalar(1.0) * _tmp45;
  const Scalar _tmp83 = (-_tmp56 + _tmp81) / (_tmp54 - _tmp82);
  const Scalar _tmp84 = -_tmp59 * _tmp76 + _tmp78;
  const Scalar _tmp85 = -_tmp44 * _tmp75 - _tmp66 * _tmp84 + _tmp80 -
                        _tmp83 * (_tmp62 * _tmp75 - _tmp63 * _tmp80 - _tmp66 * _tmp79);
  const Scalar _tmp86 = Scalar(1.0) / (_tmp85);
  const Scalar _tmp87 = _tmp63 * _tmp65;
  const Scalar _tmp88 = -_tmp77 - _tmp83 * (_tmp63 * _tmp77 + _tmp79 * _tmp87) + _tmp84 * _tmp87;
  const Scalar _tmp89 = _tmp67 * _tmp86;
  const Scalar _tmp90 = _tmp68 * _tmp85;
  const Scalar _tmp91 = _tmp88 + _tmp90 * (-_tmp53 + _tmp61 * _tmp87 - _tmp88 * _tmp89);
  const Scalar _tmp92 = _tmp86 * _tmp91;
  const Scalar _tmp93 = _tmp64 * _tmp86;
  const Scalar _tmp94 = _tmp65 * (-_tmp63 - _tmp91 * _tmp93);
  const Scalar _tmp95 = _tmp31 * _tmp52 * (_tmp44 * _tmp92 + _tmp59 * _tmp94 + Scalar(1.0));
  const Scalar _tmp96 = Scalar(19.620000000000001) - fv1;
  const Scalar _tmp97 = _tmp81 + _tmp82 * _tmp83;
  const Scalar _tmp98 = 0;
  const Scalar _tmp99 = _tmp65 * _tmp93 * _tmp98;
  const Scalar _tmp100 = _tmp86 * _tmp98;
  const Scalar _tmp101 = Scalar(1.0) * _tmp65;
  const Scalar _tmp102 = _tmp101 * _tmp79 * _tmp83 - _tmp101 * _tmp84;
  const Scalar _tmp103 = _tmp102 + _tmp90 * (-_tmp101 * _tmp61 - _tmp102 * _tmp89);
  const Scalar _tmp104 = _tmp103 * _tmp86;
  const Scalar _tmp105 = _tmp65 * (-_tmp103 * _tmp93 + Scalar(1.0));
  const Scalar _tmp106 = _tmp30 * _tmp52 * (_tmp104 * _tmp44 + _tmp105 * _tmp59);
  const Scalar _tmp107 = _tmp32 * _tmp69;
  const Scalar _tmp108 = _tmp107 * fh1;
  const Scalar _tmp109 = _tmp105 * _tmp30;
  const Scalar _tmp110 = _tmp31 * _tmp94;
  const Scalar _tmp111 = _tmp31 * _tmp92;
  const Scalar _tmp112 = _tmp104 * _tmp30;

  // Output terms (1)
  Eigen::Matrix<Scalar, 4, 1> _res;

  _res(0, 0) = -std::exp(-fh1);
  _res(1, 0) = -(-_tmp106 - _tmp70 - _tmp95) *
               std::exp(_tmp106 * fh1 + _tmp52 * _tmp96 * (_tmp100 * _tmp44 - _tmp59 * _tmp99) +
                        _tmp70 * fh1 + _tmp95 * fh1);
  _res(2, 0) = -(-_tmp107 * _tmp66 + _tmp109 + _tmp110) *
               std::exp(_tmp108 * _tmp66 - _tmp109 * fh1 - _tmp110 * fh1 + _tmp96 * _tmp99);
  _res(3, 0) = -(_tmp107 + _tmp111 + _tmp112) *
               std::exp(-_tmp100 * _tmp96 - _tmp108 - _tmp111 * fh1 - _tmp112 * fh1);
