...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl8(
  ...
  const Scalar _tmp50 = _tmp49 * (-_tmp41 * _tmp45 * _tmp47 + _tmp42 * _tmp43 * _tmp47);
  const Scalar _tmp51 = _tmp35 * _tmp39;
  const Scalar _tmp52 = _tmp33 * _tmp40 - _tmp37 * _tmp51 + _tmp40 * _tmp50;
  ...
  const Scalar _tmp64 = -_tmp40 * _tmp60 + _tmp63;
  const Scalar _tmp65 = _tmp51 * _tmp60 - _tmp53 * _tmp63;
  const Scalar _tmp66 = Scalar(1.0) * _tmp43;
  const Scalar _tmp67 = Scalar(1.0) * _tmp41;
  const Scalar _tmp68 = (-_tmp37 + _tmp66) / (_tmp33 - _tmp67);
  const Scalar _tmp69 = -_tmp55 * _tmp64 + _tmp55 * _tmp65 * _tmp68;
  const Scalar _tmp70 = _tmp58 + _tmp61;
  const Scalar _tmp71 = _tmp31 * _tmp62;
  const Scalar _tmp72 = _tmp29 * _tmp30;
  const Scalar _tmp73 = _tmp31 * _tmp53 - _tmp72;
  const Scalar _tmp74 = _tmp54 * _tmp73;
  const Scalar _tmp75 = -_tmp31 * _tmp70 - _tmp64 * _tmp74 -
                        _tmp68 * (-_tmp53 * _tmp71 - _tmp65 * _tmp74 + _tmp70 * _tmp72) + _tmp71;
  const Scalar _tmp76 = Scalar(1.0) / (_tmp75);
  const Scalar _tmp77 = -_tmp16 * _tmp72 + _tmp27 * _tmp31 + _tmp31 * _tmp50 - _tmp52 * _tmp74;
  const Scalar _tmp78 = _tmp76 * _tmp77;
  const Scalar _tmp79 = Scalar(1.0) / (_tmp77);
  const Scalar _tmp80 = _tmp75 * _tmp79;
  const Scalar _tmp81 = _tmp69 + _tmp80 * (-_tmp52 * _tmp55 - _tmp69 * _tmp78);
  const Scalar _tmp82 = _tmp76 * _tmp81;
  const Scalar _tmp83 = _tmp73 * _tmp76;
  const Scalar _tmp84 = _tmp54 * (-_tmp81 * _tmp83 + Scalar(1.0));
  const Scalar _tmp85 = _tmp19 + _tmp32;
  const Scalar _tmp86 = _tmp34 + _tmp85;
  const Scalar _tmp87 = _tmp36 + _tmp4;
  ...
  const Scalar _tmp91 = _tmp49 * _tmp90 * (_tmp31 * _tmp82 + _tmp40 * _tmp84);
  const Scalar _tmp92 = _tmp88 * _tmp89;
  const Scalar _tmp93 = -_tmp85 * _tmp92 + _tmp87 * _tmp90;
  const Scalar _tmp94 = Scalar(1.0) * _tmp79;
  const Scalar _tmp95 = _tmp49 * _tmp93 * (_tmp31 * _tmp94 - _tmp40 * _tmp74 * _tmp94);
  const Scalar _tmp96 = _tmp53 * _tmp54;
  const Scalar _tmp97 = -_tmp62 + _tmp64 * _tmp96 - _tmp68 * (_tmp53 * _tmp62 + _tmp65 * _tmp96);
  const Scalar _tmp98 = _tmp80 * (-_tmp50 + _tmp52 * _tmp96 - _tmp78 * _tmp97) + _tmp97;
  const Scalar _tmp99 = _tmp76 * _tmp98;
  const Scalar _tmp100 = _tmp54 * (-_tmp53 - _tmp83 * _tmp98);
  const Scalar _tmp101 = _tmp49 * _tmp92 * (_tmp100 * _tmp40 + _tmp31 * _tmp99 + Scalar(1.0));
  ...
  const Scalar _tmp106 = _tmp104 * _tmp54 * _tmp83;
  const Scalar _tmp107 = _tmp93 * _tmp94;
  const Scalar _tmp108 = _tmp107 * fh1;
  const Scalar _tmp109 = _tmp84 * _tmp90;
  const Scalar _tmp110 = _tmp100 * _tmp92;
  ...
  _res(1, 0) = -(-_tmp101 - _tmp91 - _tmp95) *
               std::exp(_tmp101 * fh1 + _tmp102 * _tmp49 * (_tmp105 * _tmp31 - _tmp106 * _tmp40) +
                        _tmp91 * fh1 + _tmp95 * fh1);
  _res(2, 0) = -(-_tmp107 * _tmp74 + _tmp109 + _tmp110) *
               std::exp(_tmp102 * _tmp106 + _tmp108 * _tmp74 - _tmp109 * fh1 - _tmp110 * fh1);
