...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl10(
  ...
  const Scalar _tmp73 = _tmp56 * _tmp58;
  ...
  const Scalar _tmp77 = _tmp76 * (_tmp31 * _tmp72 - _tmp72 * _tmp74);
  const Scalar _tmp78 = Scalar(1.0) / (_tmp75);
  const Scalar _tmp79 = _tmp76 * (-_tmp38 * _tmp43 * _tmp78 + _tmp39 * _tmp41 * _tmp78);
  const Scalar _tmp80 = _tmp58 * (_tmp49 * _tmp56 - _tmp53 * _tmp57 + _tmp56 * _tmp79);
  const Scalar _tmp81 = _tmp17 * _tmp31 - _tmp27 * _tmp46 + _tmp31 * _tmp79 - _tmp47 * _tmp80;
  const Scalar _tmp82 = Scalar(1.0) / (_tmp81);
  const Scalar _tmp83 = Scalar(1.0) * _tmp82;
  const Scalar _tmp84 = _tmp21 + _tmp52;
  const Scalar _tmp85 = _tmp48 + _tmp9;
  const Scalar _tmp86 = _tmp50 + _tmp85;
  const Scalar _tmp87 = _tmp28 + _tmp84;
  const Scalar _tmp88 = std::pow(Scalar(std::pow(_tmp86, Scalar(2)) + std::pow(_tmp87, Scalar(2))),
                                 Scalar(Scalar(-1) / Scalar(2)));
  const Scalar _tmp89 = _tmp86 * _tmp88;
  const Scalar _tmp90 = _tmp87 * _tmp88;
  const Scalar _tmp91 = fh1 * (_tmp84 * _tmp89 - _tmp85 * _tmp90);
  const Scalar _tmp92 = -Scalar(1.0) * _tmp63 + Scalar(1.0) * _tmp65 * _tmp68;
  const Scalar _tmp93 = _tmp70 * _tmp81;
  const Scalar _tmp94 = _tmp69 * _tmp82;
  const Scalar _tmp95 = _tmp92 + _tmp94 * (-Scalar(1.0) * _tmp80 - _tmp92 * _tmp93);
  const Scalar _tmp96 = _tmp47 * _tmp70;
  const Scalar _tmp97 = -_tmp95 * _tmp96 + Scalar(1.0);
  const Scalar _tmp98 = _tmp31 * _tmp70;
  const Scalar _tmp99 = _tmp89 * fh1;
  const Scalar _tmp100 = _tmp45 * _tmp63 - _tmp60 - _tmp68 * (_tmp45 * _tmp60 + _tmp45 * _tmp65);
  const Scalar _tmp101 = _tmp100 + _tmp94 * (-_tmp100 * _tmp93 + _tmp45 * _tmp80 - _tmp79);
  const Scalar _tmp102 = -_tmp101 * _tmp96 - _tmp45;
  const Scalar _tmp103 = _tmp90 * fh1;
  const Scalar _tmp104 = _tmp83 * _tmp91;
  const Scalar _tmp105 = _tmp47 * _tmp58;
  ...
  _res(1, 0) =
      -_tmp77 * std::exp(_tmp0 * _tmp77 +
                         _tmp103 * _tmp76 * (_tmp101 * _tmp98 + _tmp102 * _tmp73 + Scalar(1.0)) +
                         _tmp76 * _tmp91 * (_tmp31 * _tmp83 - _tmp74 * _tmp83) +
                         _tmp76 * _tmp99 * (_tmp73 * _tmp97 + _tmp95 * _tmp98));
  _res(2, 0) = -_tmp105 * _tmp72 *
               std::exp(-_tmp102 * _tmp103 * _tmp58 + _tmp104 * _tmp105 + _tmp105 * _tmp106 -
                        _tmp58 * _tmp97 * _tmp99);
  _res(3, 0) =
      _tmp72 * std::exp(-_tmp101 * _tmp103 * _tmp70 - _tmp104 - _tmp106 - _tmp70 * _tmp95 * _tmp99);
