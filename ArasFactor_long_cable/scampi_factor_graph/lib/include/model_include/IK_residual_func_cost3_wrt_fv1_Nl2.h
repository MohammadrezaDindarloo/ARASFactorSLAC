...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl2(
  ...
  const Scalar _tmp41 = _tmp18 + _tmp24;
  ...
  const Scalar _tmp46 = _tmp36 * _tmp45 - _tmp37;
  ...
  const Scalar _tmp58 = _tmp10 - _tmp14 + _tmp7;
  const Scalar _tmp59 = _tmp15 + _tmp7;
  const Scalar _tmp60 = _tmp56 * _tmp59;
  const Scalar _tmp61 = _tmp57 * (-_tmp45 * _tmp60 + _tmp55 * _tmp58);
  const Scalar _tmp62 = _tmp36 * _tmp59;
  const Scalar _tmp63 = Scalar(1.0) * _tmp39;
  const Scalar _tmp64 = Scalar(1.0) * _tmp41;
  const Scalar _tmp65 = (-_tmp52 + _tmp64) / (_tmp48 - _tmp63);
  const Scalar _tmp66 = _tmp57 * (-_tmp56 * _tmp58 + _tmp60);
  const Scalar _tmp67 = -_tmp16 * _tmp36 - _tmp46 * _tmp66 + _tmp62 -
                        _tmp65 * (_tmp16 * _tmp37 - _tmp45 * _tmp62 - _tmp46 * _tmp61);
  ...
  const Scalar _tmp75 = _tmp74 * (_tmp36 * _tmp70 - _tmp70 * _tmp72);
  const Scalar _tmp76 = Scalar(1.0) / (_tmp73);
  const Scalar _tmp77 = _tmp74 * (-_tmp39 * _tmp43 * _tmp76 + _tmp40 * _tmp41 * _tmp76);
  const Scalar _tmp78 = _tmp57 * (_tmp48 * _tmp56 - _tmp52 * _tmp55 + _tmp56 * _tmp77);
  const Scalar _tmp79 = -_tmp25 * _tmp37 + _tmp32 * _tmp36 + _tmp36 * _tmp77 - _tmp46 * _tmp78;
  const Scalar _tmp80 = Scalar(1.0) / (_tmp79);
  const Scalar _tmp81 = Scalar(1.0) * _tmp80;
  const Scalar _tmp82 = _tmp19 + _tmp51;
  const Scalar _tmp83 = _tmp31 + _tmp47;
  const Scalar _tmp84 = _tmp49 + _tmp83;
  const Scalar _tmp85 = _tmp26 + _tmp82;
  ...
  const Scalar _tmp90 = _tmp45 * _tmp66 - _tmp59 - _tmp65 * (_tmp45 * _tmp59 + _tmp45 * _tmp61);
  const Scalar _tmp91 = _tmp68 * _tmp79;
  const Scalar _tmp92 = _tmp67 * _tmp80;
  const Scalar _tmp93 = _tmp90 + _tmp92 * (_tmp45 * _tmp78 - _tmp77 - _tmp90 * _tmp91);
  const Scalar _tmp94 = _tmp46 * _tmp68;
  const Scalar _tmp95 = -_tmp45 - _tmp93 * _tmp94;
  const Scalar _tmp96 = _tmp36 * _tmp68;
  ...
  const Scalar _tmp102 = _tmp0 * _tmp70;
  const Scalar _tmp103 = _tmp46 * _tmp57;
  ...
  _res(0, 0) = 0;
  _res(1, 0) =
      -_tmp75 * std::exp(_tmp0 * _tmp75 + _tmp74 * _tmp89 * (_tmp36 * _tmp81 - _tmp72 * _tmp81) +
