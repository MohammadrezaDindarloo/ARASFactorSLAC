...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl21(
  ...
  const Scalar _tmp39 = -_tmp16 * _tmp35 + _tmp38;
  ...
  const Scalar _tmp46 = position_vector(1, 0) + Scalar(110.0);
  const Scalar _tmp47 = _tmp45 + _tmp46;
  const Scalar _tmp48 = _tmp43 * _tmp47;
  const Scalar _tmp49 = _tmp26 * _tmp34;
  const Scalar _tmp50 = Scalar(1.0) / (_tmp35 * _tmp48 - _tmp49);
  const Scalar _tmp51 = Scalar(1.0) * _tmp50;
  const Scalar _tmp52 = _tmp16 * _tmp49 - _tmp38 * _tmp48;
  const Scalar _tmp53 = Scalar(1.0) * _tmp45;
  const Scalar _tmp54 = Scalar(1.0) * _tmp41;
  const Scalar _tmp55 = (-_tmp31 + _tmp54) / (_tmp24 - _tmp53);
  const Scalar _tmp56 = -_tmp39 * _tmp51 + _tmp51 * _tmp52 * _tmp55;
  ...
  const Scalar _tmp66 = _tmp10 - _tmp14 + _tmp36;
  const Scalar _tmp67 = _tmp59 * _tmp64;
  const Scalar _tmp68 = _tmp48 * _tmp65 - _tmp67;
  const Scalar _tmp69 = _tmp50 * _tmp68;
  const Scalar _tmp70 = _tmp37 * _tmp48;
  const Scalar _tmp71 = _tmp37 * _tmp65 - _tmp39 * _tmp69 -
                        _tmp55 * (-_tmp52 * _tmp69 - _tmp65 * _tmp70 + _tmp66 * _tmp67) -
                        _tmp65 * _tmp66;
  ...
  const Scalar _tmp75 = _tmp43 * _tmp73;
  const Scalar _tmp76 = _tmp75 * (_tmp41 * _tmp47 * _tmp74 - _tmp42 * _tmp45 * _tmp74);
  const Scalar _tmp77 = _tmp24 * _tmp35 - _tmp31 * _tmp49 + _tmp35 * _tmp76;
  const Scalar _tmp78 = _tmp58 * _tmp65 - _tmp61 * _tmp67 + _tmp65 * _tmp76 - _tmp69 * _tmp77;
  const Scalar _tmp79 = _tmp72 * _tmp78;
  const Scalar _tmp80 = Scalar(1.0) / (_tmp78);
  const Scalar _tmp81 = _tmp71 * _tmp80;
  const Scalar _tmp82 = _tmp56 + _tmp81 * (-_tmp51 * _tmp77 - _tmp56 * _tmp79);
  const Scalar _tmp83 = _tmp65 * _tmp72;
  const Scalar _tmp84 = _tmp68 * _tmp72;
  const Scalar _tmp85 = -_tmp82 * _tmp84 + Scalar(1.0);
  const Scalar _tmp86 = _tmp35 * _tmp50;
  const Scalar _tmp87 = _tmp27 + _tmp60;
  const Scalar _tmp88 = _tmp62 + _tmp87;
  const Scalar _tmp89 = _tmp23 + _tmp57;
  ...
  const Scalar _tmp94 = _tmp48 * _tmp50;
  const Scalar _tmp95 = -_tmp37 + _tmp39 * _tmp94 - _tmp55 * (_tmp52 * _tmp94 + _tmp70);
  ...
  const Scalar _tmp100 = fh1 * (_tmp87 * _tmp92 - _tmp89 * _tmp98);
  const Scalar _tmp101 = Scalar(19.620000000000001) - fv1;
  const Scalar _tmp102 = _tmp53 * _tmp55 + _tmp54;
  const Scalar _tmp103 = 0;
  const Scalar _tmp104 = _tmp103 * _tmp69;
  const Scalar _tmp105 = _tmp75 * (_tmp103 * _tmp65 - _tmp104 * _tmp35);
  const Scalar _tmp106 = _tmp50 * fh1;
  ...
  _res(0, 0) = 0;
  _res(1, 0) = -_tmp105 *
               std::exp(_tmp100 * _tmp75 * (-_tmp35 * _tmp69 * _tmp99 + _tmp65 * _tmp99) +
                        _tmp101 * _tmp105 + _tmp92 * _tmp93 * (_tmp82 * _tmp83 + _tmp85 * _tmp86) +
                        _tmp93 * _tmp98 * (_tmp83 * _tmp96 + _tmp86 * _tmp97 + Scalar(1.0)));
  _res(2, 0) = -_tmp104 * std::exp(-_tmp106 * _tmp85 * _tmp92 - _tmp106 * _tmp97 * _tmp98 +
                                   _tmp107 * _tmp69 + _tmp108 * _tmp69);
  _res(3, 0) = _tmp103 *
               std::exp(-_tmp107 - _tmp108 - _tmp109 * _tmp82 * _tmp92 - _tmp109 * _tmp96 * _tmp98);
