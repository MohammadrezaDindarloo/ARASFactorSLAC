...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl22(
  ...
  const Scalar _tmp62 = _tmp35 + _tmp46;
  const Scalar _tmp63 = _tmp31 + _tmp43;
  ...
  const Scalar _tmp73 = Scalar(0.20999999999999999) * _tmp12 + Scalar(0.20999999999999999) * _tmp13;
  ...
  const Scalar _tmp78 = _tmp52 * _tmp76 - _tmp54 * _tmp77;
  const Scalar _tmp79 = Scalar(1.0) * _tmp36;
  const Scalar _tmp80 = Scalar(1.0) * _tmp32;
  const Scalar _tmp81 = (-_tmp47 + _tmp79) / (_tmp44 - _tmp80);
  const Scalar _tmp82 = -_tmp51 * _tmp76 + _tmp77;
  const Scalar _tmp83 = _tmp70 * _tmp82 - _tmp74 - _tmp81 * (_tmp54 * _tmp74 + _tmp70 * _tmp78);
  const Scalar _tmp84 = _tmp72 + _tmp75;
  const Scalar _tmp85 = _tmp30 * _tmp74;
  const Scalar _tmp86 = -_tmp30 * _tmp84 - _tmp58 * _tmp82 -
                        _tmp81 * (-_tmp54 * _tmp85 + _tmp56 * _tmp84 - _tmp58 * _tmp78) + _tmp85;
  const Scalar _tmp87 = Scalar(1.0) / (_tmp86);
  const Scalar _tmp88 = _tmp59 * _tmp87;
  const Scalar _tmp89 = _tmp60 * _tmp86;
  const Scalar _tmp90 = _tmp83 + _tmp89 * (-_tmp42 + _tmp53 * _tmp70 - _tmp83 * _tmp88);
  const Scalar _tmp91 = _tmp30 * _tmp87;
  const Scalar _tmp92 = _tmp57 * _tmp87;
  const Scalar _tmp93 = -_tmp54 - _tmp90 * _tmp92;
  const Scalar _tmp94 = _tmp51 * _tmp55;
  const Scalar _tmp95 = _tmp41 * fh1;
  const Scalar _tmp96 = Scalar(19.620000000000001) - fv1;
  const Scalar _tmp97 = _tmp79 + _tmp80 * _tmp81;
  const Scalar _tmp98 = 0;
  const Scalar _tmp99 = _tmp58 * _tmp98;
  const Scalar _tmp100 = _tmp41 * (_tmp30 * _tmp98 - _tmp51 * _tmp99);
  const Scalar _tmp101 = Scalar(1.0) * _tmp55;
  const Scalar _tmp102 = _tmp101 * _tmp78 * _tmp81 - _tmp101 * _tmp82;
  const Scalar _tmp103 = _tmp102 + _tmp89 * (-_tmp101 * _tmp53 - _tmp102 * _tmp88);
  const Scalar _tmp104 = -_tmp103 * _tmp92 + Scalar(1.0);
  const Scalar _tmp105 = _tmp96 * _tmp98;
  const Scalar _tmp106 = _tmp61 * _tmp69;
  const Scalar _tmp107 = _tmp55 * fh1;
  ...
  _res(1, 0) =
      -_tmp100 *
      std::exp(_tmp100 * _tmp96 + _tmp41 * _tmp69 * (_tmp30 * _tmp61 - _tmp51 * _tmp58 * _tmp61) +
               _tmp67 * _tmp95 * (_tmp103 * _tmp91 + _tmp104 * _tmp94) +
               _tmp68 * _tmp95 * (_tmp90 * _tmp91 + _tmp93 * _tmp94 + Scalar(1.0)));
  _res(2, 0) = -_tmp99 * std::exp(-_tmp104 * _tmp107 * _tmp67 + _tmp105 * _tmp58 +
                                  _tmp106 * _tmp58 - _tmp107 * _tmp68 * _tmp93);
  _res(3, 0) = _tmp98 * std::exp(-_tmp103 * _tmp108 * _tmp67 - _tmp105 - _tmp106 -
                                 _tmp108 * _tmp68 * _tmp90);
