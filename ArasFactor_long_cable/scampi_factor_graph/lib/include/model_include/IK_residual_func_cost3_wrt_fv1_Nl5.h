...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl5(
  ...
  const Scalar _tmp80 = _tmp53 * _tmp79 - _tmp55 * _tmp78;
  const Scalar _tmp81 = Scalar(1.0) * _tmp33;
  const Scalar _tmp82 = Scalar(1.0) * _tmp38;
  const Scalar _tmp83 = (-_tmp49 + _tmp82) / (_tmp47 - _tmp81);
  const Scalar _tmp84 = -_tmp52 * _tmp79 + _tmp78;
  const Scalar _tmp85 = -_tmp31 * _tmp74 - _tmp58 * _tmp84 + _tmp77 -
                        _tmp83 * (_tmp46 * _tmp74 - _tmp55 * _tmp77 - _tmp58 * _tmp80);
  ...
  const Scalar _tmp93 = _tmp44 * (_tmp31 * _tmp89 - _tmp90 * _tmp92);
  const Scalar _tmp94 = _tmp55 * _tmp57;
  const Scalar _tmp95 = -_tmp76 - _tmp83 * (_tmp55 * _tmp76 + _tmp80 * _tmp94) + _tmp84 * _tmp94;
  const Scalar _tmp96 = _tmp59 * _tmp86;
  const Scalar _tmp97 = _tmp60 * _tmp85;
  const Scalar _tmp98 = _tmp95 + _tmp97 * (-_tmp45 + _tmp54 * _tmp94 - _tmp95 * _tmp96);
  const Scalar _tmp99 = _tmp31 * _tmp86;
  const Scalar _tmp100 = -_tmp55 - _tmp91 * _tmp98;
  const Scalar _tmp101 = _tmp68 * fh1;
  const Scalar _tmp102 = Scalar(1.0) * _tmp57;
  const Scalar _tmp103 = _tmp102 * _tmp80 * _tmp83 - _tmp102 * _tmp84;
  const Scalar _tmp104 = _tmp103 + _tmp97 * (-_tmp102 * _tmp54 - _tmp103 * _tmp96);
  const Scalar _tmp105 = -_tmp104 * _tmp91 + Scalar(1.0);
  const Scalar _tmp106 = _tmp67 * fh1;
  const Scalar _tmp107 = _tmp61 * _tmp69;
  const Scalar _tmp108 = _tmp57 * _tmp92;
  ...
  _res(1, 0) =
      -_tmp93 *
      std::exp(_tmp101 * _tmp44 * (_tmp100 * _tmp90 + _tmp98 * _tmp99 + Scalar(1.0)) +
               _tmp106 * _tmp44 * (_tmp104 * _tmp99 + _tmp105 * _tmp90) +
               _tmp44 * _tmp69 * (_tmp31 * _tmp61 - _tmp52 * _tmp58 * _tmp61) + _tmp70 * _tmp93);
  _res(2, 0) = -_tmp108 * std::exp(-_tmp100 * _tmp101 * _tmp57 - _tmp105 * _tmp106 * _tmp57 +
                                   _tmp107 * _tmp58 + _tmp108 * _tmp70);
  _res(3, 0) = _tmp89 * std::exp(-_tmp101 * _tmp86 * _tmp98 - _tmp104 * _tmp106 * _tmp86 - _tmp107 -
                                 _tmp70 * _tmp89);
