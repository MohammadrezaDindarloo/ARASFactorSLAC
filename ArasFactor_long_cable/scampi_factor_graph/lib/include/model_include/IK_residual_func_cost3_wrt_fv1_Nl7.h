...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl7(
  ...
  const Scalar _tmp38 = _tmp27 + _tmp31;
  ...
  const Scalar _tmp46 = _tmp14 + _tmp7;
  const Scalar _tmp47 = _tmp43 * _tmp44;
  const Scalar _tmp48 = -_tmp37 * _tmp45 + _tmp46 * _tmp47;
  const Scalar _tmp49 = Scalar(1.0) * _tmp24;
  const Scalar _tmp50 = Scalar(1.0) * _tmp32;
  const Scalar _tmp51 = (-_tmp38 + _tmp50) / (_tmp41 - _tmp49);
  const Scalar _tmp52 = Scalar(1.0) / (_tmp36 * _tmp45 - _tmp47);
  const Scalar _tmp53 = Scalar(1.0) * _tmp52;
  const Scalar _tmp54 = _tmp15 * _tmp45 - _tmp45 * _tmp46;
  const Scalar _tmp55 = _tmp48 * _tmp51 * _tmp53 - _tmp53 * _tmp54;
  const Scalar _tmp56 = _tmp18 + _tmp40;
  const Scalar _tmp57 = _tmp42 + _tmp56;
  const Scalar _tmp58 = _tmp29 + _tmp30;
  ...
  const Scalar _tmp66 = _tmp36 * _tmp63 - _tmp65;
  const Scalar _tmp67 = _tmp52 * _tmp66;
  const Scalar _tmp68 = _tmp15 * _tmp63 -
                        _tmp51 * (-_tmp37 * _tmp63 - _tmp48 * _tmp67 + _tmp64 * _tmp65) -
                        _tmp54 * _tmp67 - _tmp63 * _tmp64;
  const Scalar _tmp69 = Scalar(1.0) / (_tmp68);
  const Scalar _tmp70 =
      std::sqrt(Scalar(std::pow(_tmp26, Scalar(2)) + std::pow(_tmp34, Scalar(2))));
  const Scalar _tmp71 = Scalar(1.0) / (_tmp70);
  const Scalar _tmp72 = _tmp35 * _tmp70;
  const Scalar _tmp73 = _tmp72 * (-_tmp24 * _tmp34 * _tmp71 + _tmp26 * _tmp32 * _tmp71);
  const Scalar _tmp74 = -_tmp38 * _tmp47 + _tmp41 * _tmp45 + _tmp45 * _tmp73;
  const Scalar _tmp75 = _tmp56 * _tmp63 - _tmp59 * _tmp65 + _tmp63 * _tmp73 - _tmp67 * _tmp74;
  ...
  const Scalar _tmp90 = _tmp72 * fh1;
  const Scalar _tmp91 = Scalar(1.0) * _tmp77;
  const Scalar _tmp92 = _tmp87 * _tmp88;
  const Scalar _tmp93 = fh1 * (-_tmp84 * _tmp92 + _tmp86 * _tmp89);
  const Scalar _tmp94 = Scalar(19.620000000000001) - fv1;
  const Scalar _tmp95 = _tmp49 * _tmp51 + _tmp50;
  const Scalar _tmp96 = 0;
  const Scalar _tmp97 = _tmp67 * _tmp96;
  const Scalar _tmp98 = _tmp72 * (-_tmp45 * _tmp97 + _tmp63 * _tmp96);
  const Scalar _tmp99 = _tmp36 * _tmp52;
  const Scalar _tmp100 = -_tmp15 - _tmp51 * (_tmp37 + _tmp48 * _tmp99) + _tmp54 * _tmp99;
  const Scalar _tmp101 = _tmp100 + _tmp78 * (-_tmp100 * _tmp76 - _tmp73 + _tmp74 * _tmp99);
  const Scalar _tmp102 = -_tmp101 * _tmp81 - _tmp36;
  const Scalar _tmp103 = _tmp94 * _tmp96;
  const Scalar _tmp104 = _tmp52 * fh1;
  const Scalar _tmp105 = _tmp91 * _tmp93;
  const Scalar _tmp106 = _tmp69 * fh1;
  ...
  _res(0, 0) = 0;
  _res(1, 0) =
      -_tmp98 * std::exp(_tmp72 * _tmp93 * (-_tmp45 * _tmp67 * _tmp91 + _tmp63 * _tmp91) +
                         _tmp89 * _tmp90 * (_tmp79 * _tmp80 + _tmp82 * _tmp83) +
                         _tmp90 * _tmp92 * (_tmp101 * _tmp80 + _tmp102 * _tmp83 + Scalar(1.0)) +
                         _tmp94 * _tmp98);
  _res(2, 0) = -_tmp97 * std::exp(-_tmp102 * _tmp104 * _tmp92 + _tmp103 * _tmp67 -
                                  _tmp104 * _tmp82 * _tmp89 + _tmp105 * _tmp67);
  _res(3, 0) = _tmp96 * std::exp(-_tmp101 * _tmp106 * _tmp92 - _tmp103 - _tmp105 -
