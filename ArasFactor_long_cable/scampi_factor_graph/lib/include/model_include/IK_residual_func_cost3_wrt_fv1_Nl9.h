...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl9(
  ...
  const Scalar _tmp50 = _tmp33 * _tmp49 - _tmp39;
  const Scalar _tmp51 = _tmp17 + _tmp5;
  const Scalar _tmp52 = _tmp42 + _tmp51;
  const Scalar _tmp53 = _tmp23 + _tmp44;
  ...
  const Scalar _tmp58 = Scalar(1.0) / (_tmp49 * _tmp57 - _tmp56);
  const Scalar _tmp59 = _tmp34 + _tmp35 + _tmp36;
  const Scalar _tmp60 = _tmp57 * _tmp59;
  const Scalar _tmp61 = _tmp34 + _tmp37;
  const Scalar _tmp62 = _tmp58 * (-_tmp49 * _tmp60 + _tmp56 * _tmp61);
  const Scalar _tmp63 = _tmp33 * _tmp59;
  const Scalar _tmp64 = Scalar(1.0) * _tmp41;
  const Scalar _tmp65 = Scalar(1.0) * _tmp45;
  const Scalar _tmp66 = (-_tmp53 + _tmp65) / (_tmp51 - _tmp64);
  const Scalar _tmp67 = _tmp58 * (-_tmp57 * _tmp61 + _tmp60);
  const Scalar _tmp68 = -_tmp33 * _tmp38 - _tmp50 * _tmp67 + _tmp63 -
                        _tmp66 * (_tmp38 * _tmp39 - _tmp49 * _tmp63 - _tmp50 * _tmp62);
  ...
  const Scalar _tmp78 = _tmp77 * (_tmp33 * _tmp72 - _tmp73 * _tmp75);
  const Scalar _tmp79 = Scalar(1.0) * _tmp62 * _tmp66 - Scalar(1.0) * _tmp67;
  const Scalar _tmp80 = Scalar(1.0) / (_tmp76);
  const Scalar _tmp81 = _tmp77 * (-_tmp41 * _tmp47 * _tmp80 + _tmp43 * _tmp45 * _tmp80);
  const Scalar _tmp82 = _tmp58 * (_tmp51 * _tmp57 - _tmp53 * _tmp56 + _tmp57 * _tmp81);
  const Scalar _tmp83 = _tmp18 * _tmp33 - _tmp29 * _tmp39 + _tmp33 * _tmp81 - _tmp50 * _tmp82;
  ...
  const Scalar _tmp88 = _tmp33 * _tmp69;
  const Scalar _tmp89 = -_tmp74 * _tmp87 + Scalar(1.0);
  const Scalar _tmp90 = _tmp40 + _tmp6;
  const Scalar _tmp91 = _tmp19 + _tmp90;
  const Scalar _tmp92 = _tmp22 + _tmp28;
  ...
  const Scalar _tmp96 = _tmp77 * fh1;
  ...
  const Scalar _tmp100 = _tmp49 * _tmp67 - _tmp59 - _tmp66 * (_tmp49 * _tmp59 + _tmp49 * _tmp62);
  const Scalar _tmp101 = _tmp100 + _tmp86 * (-_tmp100 * _tmp84 + _tmp49 * _tmp82 - _tmp81);
  const Scalar _tmp102 = -_tmp101 * _tmp74 - _tmp49;
  const Scalar _tmp103 = _tmp97 * _tmp99;
  const Scalar _tmp104 = _tmp58 * _tmp75;
  const Scalar _tmp105 = _tmp58 * fh1;
  ...
  _res(1, 0) =
      -_tmp78 *
      std::exp(_tmp0 * _tmp78 + _tmp77 * _tmp99 * (_tmp33 * _tmp97 - _tmp50 * _tmp73 * _tmp97) +
               _tmp95 * _tmp96 * (_tmp73 * _tmp89 + _tmp87 * _tmp88) +
               _tmp96 * _tmp98 * (_tmp101 * _tmp88 + _tmp102 * _tmp73 + Scalar(1.0)));
  _res(2, 0) = -_tmp104 * std::exp(_tmp0 * _tmp104 - _tmp102 * _tmp105 * _tmp98 +
                                   _tmp103 * _tmp50 * _tmp58 - _tmp105 * _tmp89 * _tmp95);
  _res(3, 0) = _tmp72 * std::exp(-_tmp0 * _tmp72 - _tmp101 * _tmp106 * _tmp98 - _tmp103 -
