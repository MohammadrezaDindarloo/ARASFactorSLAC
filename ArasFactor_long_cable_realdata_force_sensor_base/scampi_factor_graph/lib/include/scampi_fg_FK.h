...
namespace gtsam
{
    ...
    class FK_factor_graoh_cost2 : public NoiseModelFactorN<double, double, gtsam::Rot3, gtsam::Pose3, gtsam::Point3, gtsam::Point3, gtsam::Point3, gtsam::Point3, gtsam::Vector4>
    {
    ...
    public:
        // Constructor
        FK_factor_graoh_cost2(Key key1, Key key2, Key key3, Key key4, Key key5, Key key6, Key key7, Key key8, Key key9, Eigen::Vector4d encoder_, const SharedNoiseModel &model) 
        ...
        {   
            Eigen::Matrix<double, 4, 1> Fkresidual_func = sym::FkResidualFuncCost2(fh1, fv1, SymforceFromGtsam(DeltaRot), SymPoseFromGtsam(transformation), encoder, offset, p_a, p_b, p_c, p_d, sym::kDefaultEpsilon<double>);
            if(H1)
            {
                Eigen::Matrix<double, 4, 1> Fkresidual_func_wrt_fh1 = sym::FkResidualFuncCost2WrtFh1(fh1, fv1, SymforceFromGtsam(DeltaRot), SymPoseFromGtsam(transformation), encoder, offset, p_a, p_b, p_c, p_d, sym::kDefaultEpsilon<double>);
                *H1 = (Matrix(4, 1) << Fkresidual_func_wrt_fh1).finished();
            }
            if(H2)
            {
                Eigen::Matrix<double, 4, 1> Fkresidual_func_wrt_fv1 = sym::FkResidualFuncCost2WrtFv1(fh1, fv1, SymforceFromGtsam(DeltaRot), SymPoseFromGtsam(transformation), encoder, offset, p_a, p_b, p_c, p_d, sym::kDefaultEpsilon<double>);
                *H2 = (Matrix(4, 1) << Fkresidual_func_wrt_fv1).finished();
            }
            if(H3)
            {
                Eigen::Matrix<double, 4, 3> Fkresidual_func_wrt_Deltarot = sym::FkResidualFuncCost2WrtDeltarot(fh1, fv1, SymforceFromGtsam(DeltaRot), SymPoseFromGtsam(transformation), encoder, offset, p_a, p_b, p_c, p_d, sym::kDefaultEpsilon<double>);
                *H3 = (Matrix(4, 3) << Fkresidual_func_wrt_Deltarot).finished();
            }
            if(H4)
            {
                Eigen::Matrix<double, 4, 6> Fkresidual_func_wrt_trsansformation = sym::FkResidualFuncCost2WrtTransformation(fh1, fv1, SymforceFromGtsam(DeltaRot), SymPoseFromGtsam(transformation), encoder, offset, p_a, p_b, p_c, p_d, sym::kDefaultEpsilon<double>);
                *H4 = (Matrix(4, 6) << Fkresidual_func_wrt_trsansformation).finished();
            }
            if(H5)
            {
                Eigen::Matrix<double, 4, 3> Fkresidual_func_wrt_pa = sym::FkResidualFuncCost2WrtPa(fh1, fv1, SymforceFromGtsam(DeltaRot), SymPoseFromGtsam(transformation), encoder, offset, p_a, p_b, p_c, p_d, sym::kDefaultEpsilon<double>);
                *H5 = (Matrix(4, 3) << Fkresidual_func_wrt_pa).finished();
            }
            if(H6)
            {
                Eigen::Matrix<double, 4, 3> Fkresidual_func_wrt_pb = sym::FkResidualFuncCost2WrtPb(fh1, fv1, SymforceFromGtsam(DeltaRot), SymPoseFromGtsam(transformation), encoder, offset, p_a, p_b, p_c, p_d, sym::kDefaultEpsilon<double>);
                *H6 = (Matrix(4, 3) << Fkresidual_func_wrt_pb).finished();
            }
            if(H7)
            {
                Eigen::Matrix<double, 4, 3> Fkresidual_func_wrt_pc = sym::FkResidualFuncCost2WrtPc(fh1, fv1, SymforceFromGtsam(DeltaRot), SymPoseFromGtsam(transformation), encoder, offset, p_a, p_b, p_c, p_d, sym::kDefaultEpsilon<double>);
                *H7 = (Matrix(4, 3) << Fkresidual_func_wrt_pc).finished();
            }
            if(H8)
            {
                Eigen::Matrix<double, 4, 3> Fkresidual_func_wrt_pd = sym::FkResidualFuncCost2WrtPd(fh1, fv1, SymforceFromGtsam(DeltaRot), SymPoseFromGtsam(transformation), encoder, offset, p_a, p_b, p_c, p_d, sym::kDefaultEpsilon<double>);
                *H8 = (Matrix(4, 3) << Fkresidual_func_wrt_pd).finished();
            }
            if(H9)
            {
