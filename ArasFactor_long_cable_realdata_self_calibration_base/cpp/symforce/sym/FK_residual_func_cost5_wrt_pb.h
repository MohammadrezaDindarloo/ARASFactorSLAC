...
Eigen::Matrix<Scalar, 4, 3> FkResidualFuncCost5WrtPb(
  ...
  const Scalar _tmp12 = -_TransformationMatrix[4] - Scalar(0.20999999999999999) * _tmp1 +
                        ...
                        Scalar(0.010999999999999999) * _tmp9 + p_b(0, 0);
  ...
  const Scalar _tmp16 =
      ...
      Scalar(0.20999999999999999) * _tmp3 + p_b(1, 0);
  const Scalar _tmp17 =
      ...
      Scalar(0.20999999999999999) * _tmp9 + p_b(2, 0) + Scalar(0.010999999999999999);
  ...
  _res(1, 0) = _tmp12 * _tmp18;
  _res(1, 1) = _tmp16 * _tmp18;
  _res(1, 2) = _tmp17 * _tmp18;
