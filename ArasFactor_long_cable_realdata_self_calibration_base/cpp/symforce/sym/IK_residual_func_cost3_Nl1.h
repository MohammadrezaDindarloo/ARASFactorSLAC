...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl1(
  ...
  _res(1, 0) = std::exp(_tmp30 * _tmp91 * (-_tmp46 * _tmp68 * _tmp89 + _tmp65 * _tmp89) +
                        _tmp30 * _tmp95 * (_tmp65 * _tmp99 - _tmp81 * _tmp98) +
                        _tmp87 * _tmp88 * (_tmp77 * _tmp78 + _tmp80 * _tmp81 + Scalar(1.0)) +
                        _tmp88 * _tmp90 * (_tmp78 * _tmp93 + _tmp81 * _tmp94));
  _res(2, 0) = std::exp(-_tmp100 * _tmp80 * _tmp87 - _tmp100 * _tmp90 * _tmp94 + _tmp101 * _tmp68 +
                        _tmp48 * _tmp95 * _tmp98);
  _res(3, 0) =
      std::exp(-_tmp101 - _tmp102 * _tmp77 * _tmp87 - _tmp102 * _tmp90 * _tmp93 - _tmp95 * _tmp99);
