...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl11(
  ...
  const Scalar _tmp52 = _tmp39 * _tmp47 - _tmp41 * _tmp50;
  ...
  const Scalar _tmp72 = _tmp38 * _tmp65 - _tmp40 * _tmp68 - _tmp59 * _tmp66 + _tmp62 * _tmp65;
  ...
  const Scalar _tmp81 = _tmp4 + _tmp58;
  ...
  const Scalar _tmp87 = _tmp37 * fh1;
  const Scalar _tmp88 = _tmp41 * _tmp42;
  const Scalar _tmp89 = -_tmp49 + _tmp51 * _tmp88 - _tmp55 * (_tmp41 * _tmp49 + _tmp52 * _tmp88);
  const Scalar _tmp90 = _tmp75 * (-_tmp38 + _tmp40 * _tmp88 - _tmp73 * _tmp89) + _tmp89;
  const Scalar _tmp91 = -_tmp41 - _tmp77 * _tmp90;
  ...
  const Scalar _tmp98 = fh1 * (_tmp81 * _tmp86 - _tmp83 * _tmp92);
  ...
  _res(1, 0) = std::exp(_tmp37 * _tmp93 * (_tmp65 * _tmp95 - _tmp95 * _tmp96) +
                        _tmp37 * _tmp98 * (_tmp65 * _tmp97 - _tmp96 * _tmp97) +
                        _tmp86 * _tmp87 * (_tmp76 * _tmp80 + _tmp78 * _tmp79) +
                        _tmp87 * _tmp92 * (_tmp79 * _tmp91 + _tmp80 * _tmp90 + Scalar(1.0)));
  _res(2, 0) = std::exp(-_tmp100 * _tmp78 * _tmp86 - _tmp100 * _tmp91 * _tmp92 + _tmp101 * _tmp68 +
                        _tmp68 * _tmp99);
  _res(3, 0) = std::exp(-_tmp101 - _tmp102 * _tmp76 * _tmp86 - _tmp102 * _tmp90 * _tmp92 - _tmp99);
