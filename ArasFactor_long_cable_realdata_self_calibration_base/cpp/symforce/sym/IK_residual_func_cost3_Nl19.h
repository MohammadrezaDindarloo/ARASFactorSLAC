...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl19(
  ...
  const Scalar _tmp54 = -_tmp40 * _tmp51 + _tmp41 * _tmp53;
  ...
  const Scalar _tmp58 = _tmp40 * _tmp50 - _tmp40 * _tmp53;
  const Scalar _tmp59 = _tmp45 * _tmp58 - _tmp50 - _tmp57 * (_tmp45 * _tmp54 + _tmp51);
  ...
  const Scalar _tmp92 = _tmp40 * _tmp69;
  const Scalar _tmp93 = Scalar(1.0) * _tmp75;
  const Scalar _tmp94 = _tmp85 * _tmp86;
  const Scalar _tmp95 = fh1 * (_tmp82 * _tmp94 - _tmp84 * _tmp87);
  const Scalar _tmp96 = Scalar(1.0) * _tmp44;
  const Scalar _tmp97 = _tmp54 * _tmp57 * _tmp96 - _tmp58 * _tmp96;
  const Scalar _tmp98 = _tmp76 * (-_tmp42 * _tmp96 - _tmp74 * _tmp97) + _tmp97;
  const Scalar _tmp99 = -_tmp79 * _tmp98 + Scalar(1.0);
  ...
  _res(1, 0) = std::exp(_tmp100 * _tmp31 * (_tmp78 * _tmp98 + _tmp81 * _tmp99) +
                        _tmp31 * _tmp88 * (_tmp77 * _tmp78 + _tmp80 * _tmp81 + Scalar(1.0)) +
                        _tmp31 * _tmp89 * (_tmp66 * _tmp91 - _tmp91 * _tmp92) +
                        _tmp31 * _tmp95 * (_tmp66 * _tmp93 - _tmp92 * _tmp93));
  _res(2, 0) = std::exp(-_tmp100 * _tmp44 * _tmp99 + _tmp101 * _tmp69 + _tmp102 * _tmp69 -
                        _tmp44 * _tmp80 * _tmp88);
  _res(3, 0) = std::exp(-_tmp100 * _tmp72 * _tmp98 - _tmp101 - _tmp102 - _tmp72 * _tmp77 * _tmp88);
