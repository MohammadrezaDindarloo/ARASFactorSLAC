...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl5(
  ...
  const Scalar _tmp35 = _tmp17 + _tmp24;
  const Scalar _tmp36 = _tmp35 - p_c(1, 0) + position_vector(1, 0);
  const Scalar _tmp37 = std::pow(Scalar(std::pow(_tmp34, Scalar(2)) + std::pow(_tmp36, Scalar(2))),
                                 Scalar(Scalar(-1) / Scalar(2)));
  const Scalar _tmp38 = _tmp34 * _tmp37;
  const Scalar _tmp39 = _tmp36 * _tmp37;
  const Scalar _tmp40 = _tmp31 * _tmp38 - _tmp33 * _tmp39 + _tmp35 * _tmp38;
  ...
  const Scalar _tmp51 = -_tmp38 * _tmp48 + _tmp50;
  const Scalar _tmp52 = _tmp41 * _tmp49;
  const Scalar _tmp53 = _tmp39 * _tmp48 - _tmp41 * _tmp50;
  const Scalar _tmp54 = Scalar(1.0) * _tmp25;
  const Scalar _tmp55 = Scalar(1.0) * _tmp15;
  const Scalar _tmp56 = (-_tmp33 + _tmp55) / (_tmp35 - _tmp54);
  ...
  const Scalar _tmp68 = _tmp41 * _tmp65 - _tmp67;
  ...
  const Scalar _tmp72 = _tmp31 * _tmp65 - _tmp40 * _tmp69 - _tmp59 * _tmp67 + _tmp62 * _tmp65;
  const Scalar _tmp73 = _tmp71 * _tmp72;
  const Scalar _tmp74 = Scalar(1.0) / (_tmp72);
  const Scalar _tmp75 = _tmp70 * _tmp74;
  const Scalar _tmp76 = _tmp57 + _tmp75 * (-_tmp31 + _tmp40 * _tmp43 - _tmp57 * _tmp73);
  ...
  const Scalar _tmp81 = _tmp14 + _tmp58;
  const Scalar _tmp82 = _tmp81 - p_a(0, 0) + position_vector(0, 0);
  const Scalar _tmp83 = _tmp18 + _tmp61;
  ...
  const Scalar _tmp89 = _tmp68 * _tmp74 * _tmp88;
  ...
  const Scalar _tmp93 = -_tmp51 * _tmp88 + _tmp53 * _tmp56 * _tmp88;
  const Scalar _tmp94 = _tmp75 * (-_tmp40 * _tmp88 - _tmp73 * _tmp93) + _tmp93;
  const Scalar _tmp95 = -_tmp77 * _tmp94 + Scalar(1.0);
  const Scalar _tmp96 = Scalar(333.54000000000002) - fv1;
  const Scalar _tmp97 = _tmp54 * _tmp56 + _tmp55;
  ...
  _res(1, 0) = std::exp(_tmp30 * _tmp92 * (-_tmp38 * _tmp89 + _tmp65 * _tmp90) +
                        _tmp30 * _tmp96 * (-_tmp38 * _tmp69 * _tmp98 + _tmp65 * _tmp98) +
                        _tmp86 * _tmp87 * (_tmp76 * _tmp80 + _tmp78 * _tmp79 + Scalar(1.0)) +
                        _tmp87 * _tmp91 * (_tmp79 * _tmp95 + _tmp80 * _tmp94));
  _res(2, 0) = std::exp(_tmp100 * _tmp69 - _tmp78 * _tmp86 * _tmp99 + _tmp89 * _tmp92 -
                        _tmp91 * _tmp95 * _tmp99);
  _res(3, 0) =
      std::exp(-_tmp100 - _tmp101 * _tmp76 * _tmp86 - _tmp101 * _tmp91 * _tmp94 - _tmp90 * _tmp92);
