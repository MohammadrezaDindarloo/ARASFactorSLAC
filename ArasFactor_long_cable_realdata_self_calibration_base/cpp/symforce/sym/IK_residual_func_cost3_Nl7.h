...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl7(
  ...
  const Scalar _tmp32 = _tmp31 - p_d(1, 0) + position_vector(1, 0);
  ...
  const Scalar _tmp43 = _tmp11 - _tmp14 + _tmp8;
  const Scalar _tmp44 = _tmp25 * _tmp33;
  const Scalar _tmp45 = _tmp43 * _tmp44;
  const Scalar _tmp46 = _tmp16 * _tmp34 - _tmp42 * _tmp45;
  const Scalar _tmp47 = Scalar(1.0) / (-_tmp34 + _tmp42 * _tmp44);
  ...
  const Scalar _tmp62 = _tmp15 + _tmp7;
  const Scalar _tmp63 = _tmp58 * _tmp59;
  const Scalar _tmp64 = _tmp42 * _tmp60 - _tmp63;
  const Scalar _tmp65 = _tmp47 * _tmp64;
  const Scalar _tmp66 = -_tmp51 * (-_tmp42 * _tmp61 - _tmp46 * _tmp65 + _tmp62 * _tmp63) -
                        _tmp52 * _tmp65 - _tmp60 * _tmp62 + _tmp61;
  const Scalar _tmp67 = Scalar(1.0) / (_tmp66);
  const Scalar _tmp68 =
      std::sqrt(Scalar(std::pow(_tmp37, Scalar(2)) + std::pow(_tmp41, Scalar(2))));
  const Scalar _tmp69 = Scalar(1.0) / (_tmp68);
  const Scalar _tmp70 = _tmp38 * _tmp68;
  const Scalar _tmp71 = _tmp70 * (_tmp36 * _tmp41 * _tmp69 - _tmp37 * _tmp40 * _tmp69);
  const Scalar _tmp72 = -_tmp24 * _tmp34 + _tmp31 * _tmp44 + _tmp44 * _tmp71;
  const Scalar _tmp73 = -_tmp55 * _tmp63 + _tmp57 * _tmp60 + _tmp60 * _tmp71 - _tmp65 * _tmp72;
  ...
  const Scalar _tmp82 = _tmp35 + _tmp54;
  ...
  const Scalar _tmp89 = _tmp48 * _tmp64 * _tmp75;
  ...
  const Scalar _tmp93 = _tmp42 * _tmp47;
  const Scalar _tmp94 = -_tmp43 - _tmp51 * (_tmp42 * _tmp43 + _tmp46 * _tmp93) + _tmp52 * _tmp93;
  const Scalar _tmp95 = _tmp76 * (-_tmp71 + _tmp72 * _tmp93 - _tmp74 * _tmp94) + _tmp94;
  const Scalar _tmp96 = -_tmp42 - _tmp78 * _tmp95;
  const Scalar _tmp97 = _tmp91 * fh1;
  const Scalar _tmp98 = Scalar(333.54000000000002) - fv1;
  const Scalar _tmp99 = _tmp49 * _tmp51 + _tmp50;
  ...
  _res(1, 0) = std::exp(_tmp70 * _tmp88 * (_tmp77 * _tmp81 + _tmp79 * _tmp80) +
                        _tmp70 * _tmp92 * (-_tmp44 * _tmp89 + _tmp60 * _tmp90) +
                        _tmp70 * _tmp97 * (_tmp80 * _tmp96 + _tmp81 * _tmp95 + Scalar(1.0)) +
                        _tmp70 * _tmp98 * (-_tmp100 * _tmp44 * _tmp65 + _tmp100 * _tmp60));
  _res(2, 0) = std::exp(_tmp101 * _tmp65 - _tmp47 * _tmp79 * _tmp88 - _tmp47 * _tmp96 * _tmp97 +
                        _tmp89 * _tmp92);
  _res(3, 0) =
      std::exp(-_tmp101 - _tmp67 * _tmp77 * _tmp88 - _tmp67 * _tmp95 * _tmp97 - _tmp90 * _tmp92);
