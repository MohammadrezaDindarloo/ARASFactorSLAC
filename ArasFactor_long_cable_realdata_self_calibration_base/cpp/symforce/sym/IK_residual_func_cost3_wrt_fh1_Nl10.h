...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl10(
  ...
  const Scalar _tmp33 = -Scalar(0.010999999999999999) * _tmp18 -
  ...
  const Scalar _tmp45 = _tmp16 - p_d(0, 0) + position_vector(0, 0);
  const Scalar _tmp46 = Scalar(1.0) / (_tmp45);
  const Scalar _tmp47 = _tmp25 - p_d(1, 0) + position_vector(1, 0);
  const Scalar _tmp48 = _tmp46 * _tmp47;
  const Scalar _tmp49 = _tmp42 * _tmp43;
  const Scalar _tmp50 = _tmp44 * _tmp48 - _tmp49;
  const Scalar _tmp51 = _tmp33 - _tmp34;
  const Scalar _tmp52 = -_tmp35 + _tmp51;
  const Scalar _tmp53 = _tmp30 - p_a(0, 0) + position_vector(0, 0);
  const Scalar _tmp54 = _tmp28 - p_a(1, 0) + position_vector(1, 0);
  const Scalar _tmp55 = std::pow(Scalar(std::pow(_tmp53, Scalar(2)) + std::pow(_tmp54, Scalar(2))),
                                 Scalar(Scalar(-1) / Scalar(2)));
  const Scalar _tmp56 = _tmp53 * _tmp55;
  const Scalar _tmp57 = _tmp35 + _tmp51;
  const Scalar _tmp58 = _tmp56 * _tmp57;
  const Scalar _tmp59 = _tmp54 * _tmp55;
  const Scalar _tmp60 = Scalar(1.0) / (_tmp48 * _tmp56 - _tmp59);
  const Scalar _tmp61 = _tmp60 * (-_tmp52 * _tmp56 + _tmp58);
  const Scalar _tmp62 = _tmp44 * _tmp57;
  const Scalar _tmp63 = -_tmp48 * _tmp58 + _tmp52 * _tmp59;
  const Scalar _tmp64 = _tmp50 * _tmp60;
  const Scalar _tmp65 = -_tmp31 * (_tmp36 * _tmp49 - _tmp48 * _tmp62 - _tmp63 * _tmp64) -
                        _tmp36 * _tmp44 - _tmp50 * _tmp61 + _tmp62;
  const Scalar _tmp66 = Scalar(1.0) / (_tmp65);
  const Scalar _tmp67 = 0;
  const Scalar _tmp68 = _tmp56 * _tmp64;
  const Scalar _tmp69 =
  ...
  const Scalar _tmp72 = Scalar(1.0) * _tmp31 * _tmp71 - Scalar(1.0) * _tmp61;
  const Scalar _tmp73 = Scalar(1.0) / (_tmp69);
  const Scalar _tmp74 = _tmp70 * (_tmp16 * _tmp47 * _tmp73 - _tmp25 * _tmp45 * _tmp73);
  const Scalar _tmp75 = _tmp28 * _tmp56 - _tmp30 * _tmp59 + _tmp56 * _tmp74;
  const Scalar _tmp76 = -_tmp38 * _tmp49 + _tmp41 * _tmp44 + _tmp44 * _tmp74 - _tmp64 * _tmp75;
  ...
  const Scalar _tmp83 = _tmp50 * _tmp66;
  const Scalar _tmp84 = _tmp60 * (-_tmp81 * _tmp83 + Scalar(1.0));
  const Scalar _tmp85 = _tmp29 + _tmp37;
  const Scalar _tmp86 = _tmp85 - p_b(0, 0) + position_vector(0, 0);
  const Scalar _tmp87 = _tmp27 + _tmp40;
  ...
  const Scalar _tmp91 = _tmp70 * _tmp90 * (_tmp44 * _tmp82 + _tmp56 * _tmp84);
  const Scalar _tmp92 = -_tmp31 * (_tmp48 * _tmp57 + _tmp48 * _tmp71) + _tmp48 * _tmp61 - _tmp57;
  const Scalar _tmp93 = _tmp80 * (_tmp48 * _tmp78 - _tmp74 - _tmp77 * _tmp92) + _tmp92;
  const Scalar _tmp94 = _tmp66 * _tmp93;
  const Scalar _tmp95 = _tmp60 * (-_tmp48 - _tmp83 * _tmp93);
  const Scalar _tmp96 = _tmp86 * _tmp89;
  const Scalar _tmp97 = _tmp70 * _tmp96 * (_tmp44 * _tmp94 + _tmp56 * _tmp95 + Scalar(1.0));
  const Scalar _tmp98 = _tmp85 * _tmp90 - _tmp87 * _tmp96;
  const Scalar _tmp99 = Scalar(1.0) * _tmp79;
  const Scalar _tmp100 = _tmp70 * _tmp98 * (_tmp44 * _tmp99 - _tmp68 * _tmp99);
  ...
  const Scalar _tmp107 = _tmp82 * _tmp90;

  // Output terms (1)
  Eigen::Matrix<Scalar, 4, 1> _res;

  _res(0, 0) = -std::exp(-fh1);
  _res(1, 0) = -(-_tmp100 - _tmp91 - _tmp97) *
               std::exp(_tmp0 * _tmp70 * (_tmp44 * _tmp67 - _tmp67 * _tmp68) + _tmp100 * fh1 +
                        _tmp91 * fh1 + _tmp97 * fh1);
  _res(2, 0) = -(_tmp101 - _tmp102 * _tmp64 + _tmp105) *
               std::exp(-_tmp101 * fh1 + _tmp103 * _tmp64 + _tmp104 * _tmp64 - _tmp105 * fh1);
  _res(3, 0) =
