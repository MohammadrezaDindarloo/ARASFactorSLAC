...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl19(
  ...
  const Scalar _tmp45 = _tmp44 - p_a(0, 0) + position_vector(0, 0);
  ...
  const Scalar _tmp54 = _tmp35 * _tmp42 - _tmp50 * _tmp53;
  const Scalar _tmp55 = _tmp28 * _tmp50 - _tmp34;
  const Scalar _tmp56 = Scalar(1.0) / (-_tmp42 + _tmp50 * _tmp52);
  const Scalar _tmp57 = _tmp55 * _tmp56;
  const Scalar _tmp58 = _tmp28 * _tmp51;
  const Scalar _tmp59 = Scalar(1.0) * _tmp44;
  const Scalar _tmp60 = Scalar(1.0) * _tmp48;
  const Scalar _tmp61 = (-_tmp39 + _tmp59) / (_tmp37 - _tmp60);
  const Scalar _tmp62 = -_tmp35 * _tmp52 + _tmp53;
  const Scalar _tmp63 = -_tmp28 * _tmp33 - _tmp57 * _tmp62 + _tmp58 -
                        _tmp61 * (_tmp33 * _tmp34 - _tmp50 * _tmp58 - _tmp54 * _tmp57);
  ...
  const Scalar _tmp67 = _tmp46 * _tmp65;
  const Scalar _tmp68 = _tmp67 * (_tmp44 * _tmp49 * _tmp66 - _tmp45 * _tmp48 * _tmp66);
  const Scalar _tmp69 = _tmp37 * _tmp52 - _tmp39 * _tmp42 + _tmp52 * _tmp68;
  const Scalar _tmp70 = _tmp50 * _tmp56;
  const Scalar _tmp71 = -_tmp51 - _tmp61 * (_tmp50 * _tmp51 + _tmp54 * _tmp70) + _tmp62 * _tmp70;
  const Scalar _tmp72 = -_tmp16 * _tmp34 + _tmp25 * _tmp28 + _tmp28 * _tmp68 - _tmp57 * _tmp69;
  ...
  const Scalar _tmp78 = _tmp55 * _tmp64;
  const Scalar _tmp79 = _tmp56 * (-_tmp50 - _tmp76 * _tmp78);
  const Scalar _tmp80 = _tmp43 + _tmp6;
  const Scalar _tmp81 = _tmp80 - p_d(0, 0) + position_vector(0, 0);
  const Scalar _tmp82 = _tmp36 + _tmp47;
  const Scalar _tmp83 = _tmp82 - p_d(1, 0) + position_vector(1, 0);
  const Scalar _tmp84 = std::pow(Scalar(std::pow(_tmp81, Scalar(2)) + std::pow(_tmp83, Scalar(2))),
                                 Scalar(Scalar(-1) / Scalar(2)));
  const Scalar _tmp85 = _tmp81 * _tmp84;
  const Scalar _tmp86 = _tmp67 * _tmp85 * (_tmp28 * _tmp77 + _tmp52 * _tmp79 + Scalar(1.0));
  const Scalar _tmp87 = Scalar(333.54000000000002) - fv1;
  const Scalar _tmp88 = _tmp59 + _tmp60 * _tmp61;
  ...
  const Scalar _tmp94 = _tmp67 * _tmp92 * (_tmp28 * _tmp93 - _tmp90 * _tmp93);
  const Scalar _tmp95 = Scalar(1.0) * _tmp56;
  const Scalar _tmp96 = _tmp54 * _tmp61 * _tmp95 - _tmp62 * _tmp95;
  const Scalar _tmp97 = _tmp75 * (-_tmp69 * _tmp95 - _tmp73 * _tmp96) + _tmp96;
  const Scalar _tmp98 = _tmp56 * (-_tmp78 * _tmp97 + Scalar(1.0));
  const Scalar _tmp99 = _tmp64 * _tmp97;
  const Scalar _tmp100 = _tmp67 * _tmp91 * (_tmp28 * _tmp99 + _tmp52 * _tmp98);
  const Scalar _tmp101 = _tmp91 * _tmp98;
  const Scalar _tmp102 = _tmp92 * _tmp93;
  const Scalar _tmp103 = _tmp102 * fh1;
  const Scalar _tmp104 = _tmp79 * _tmp85;
  const Scalar _tmp105 = _tmp87 * _tmp89;
  const Scalar _tmp106 = _tmp91 * _tmp99;
  ...
  _res(1, 0) = -(-_tmp100 - _tmp86 - _tmp94) *
               std::exp(_tmp100 * fh1 + _tmp67 * _tmp87 * (_tmp28 * _tmp89 - _tmp89 * _tmp90) +
