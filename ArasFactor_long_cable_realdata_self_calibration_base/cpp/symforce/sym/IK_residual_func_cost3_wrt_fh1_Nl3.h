...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl3(
  ...
  const Scalar _tmp28 = Scalar(0.20999999999999999) * _tmp1 + Scalar(0.20999999999999999) * _tmp19 +
  ...
  const Scalar _tmp34 = _tmp20 + _tmp21;
  ...
  const Scalar _tmp64 = _tmp40 * _tmp61 - _tmp63;
  const Scalar _tmp65 = _tmp46 * _tmp64;
  const Scalar _tmp66 = -_tmp50 * (-_tmp40 * _tmp62 - _tmp45 * _tmp65 + _tmp53 * _tmp63) -
                        _tmp51 * _tmp65 - _tmp53 * _tmp61 + _tmp62;
  ...
  const Scalar _tmp72 = -_tmp23 * _tmp33 + _tmp30 * _tmp43 + _tmp43 * _tmp71;
  ...
  const Scalar _tmp77 = _tmp52 + _tmp76 * (-_tmp47 * _tmp72 - _tmp52 * _tmp74);
  const Scalar _tmp78 = _tmp61 * _tmp67;
  const Scalar _tmp79 = _tmp64 * _tmp67;
  const Scalar _tmp80 = _tmp46 * (-_tmp77 * _tmp79 + Scalar(1.0));
  const Scalar _tmp81 = _tmp22 + _tmp54;
  ...
  const Scalar _tmp91 = _tmp47 * _tmp64 * _tmp75;
  const Scalar _tmp92 = _tmp70 * _tmp89 * (-_tmp43 * _tmp91 + _tmp61 * _tmp90);
  const Scalar _tmp93 = Scalar(333.54000000000002) - fv1;
  const Scalar _tmp94 = _tmp48 * _tmp50 + _tmp49;
  const Scalar _tmp95 = 0;
  const Scalar _tmp96 = _tmp46 * _tmp79 * _tmp95;
  const Scalar _tmp97 = _tmp67 * _tmp95;
  const Scalar _tmp98 = _tmp40 * _tmp46;
  const Scalar _tmp99 = -_tmp42 - _tmp50 * (_tmp40 * _tmp42 + _tmp45 * _tmp98) + _tmp51 * _tmp98;
  const Scalar _tmp100 = _tmp76 * (-_tmp71 + _tmp72 * _tmp98 - _tmp74 * _tmp99) + _tmp99;
  const Scalar _tmp101 = _tmp46 * (-_tmp100 * _tmp79 - _tmp40);
  const Scalar _tmp102 = _tmp70 * _tmp88 * (_tmp100 * _tmp78 + _tmp101 * _tmp43 + Scalar(1.0));
  const Scalar _tmp103 = _tmp89 * _tmp91;
  const Scalar _tmp104 = _tmp101 * _tmp88;
  const Scalar _tmp105 = _tmp80 * _tmp86;
  const Scalar _tmp106 = _tmp89 * _tmp90;
  const Scalar _tmp107 = _tmp100 * _tmp67 * _tmp88;
  const Scalar _tmp108 = _tmp67 * _tmp77 * _tmp86;

  // Output terms (1)
  Eigen::Matrix<Scalar, 4, 1> _res;

  _res(0, 0) = -std::exp(-fh1);
  _res(1, 0) = -(-_tmp102 - _tmp87 - _tmp92) *
               std::exp(_tmp102 * fh1 + _tmp70 * _tmp93 * (-_tmp43 * _tmp96 + _tmp61 * _tmp97) +
                        _tmp87 * fh1 + _tmp92 * fh1);
  _res(2, 0) = -(-_tmp103 + _tmp104 + _tmp105) *
               std::exp(_tmp103 * fh1 - _tmp104 * fh1 - _tmp105 * fh1 + _tmp93 * _tmp96);
  _res(3, 0) = -(_tmp106 + _tmp107 + _tmp108) *
               std::exp(-_tmp106 * fh1 - _tmp107 * fh1 - _tmp108 * fh1 - _tmp93 * _tmp97);
