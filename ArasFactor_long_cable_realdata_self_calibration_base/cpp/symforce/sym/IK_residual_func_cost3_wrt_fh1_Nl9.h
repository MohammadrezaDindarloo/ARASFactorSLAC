...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl9(
  ...
  const Scalar _tmp39 = Scalar(1.0) * _tmp30;
  const Scalar _tmp40 = (-_tmp16 + _tmp39) / (_tmp25 - _tmp38);
  ...
  const Scalar _tmp49 = _tmp29 * _tmp46 - _tmp36 * _tmp48;
  const Scalar _tmp50 = _tmp37 * _tmp49;
  const Scalar _tmp51 = -_tmp28 * _tmp46 + _tmp48;
  const Scalar _tmp52 = _tmp37 * _tmp51;
  const Scalar _tmp53 = Scalar(1.0) * _tmp40 * _tmp50 - Scalar(1.0) * _tmp52;
  ...
  const Scalar _tmp63 = _tmp36 * _tmp62 - _tmp61;
  const Scalar _tmp64 = _tmp37 * _tmp63;
  const Scalar _tmp65 = _tmp36 * _tmp47;
  const Scalar _tmp66 = _tmp42 + _tmp43 - _tmp44;
  const Scalar _tmp67 = -_tmp40 * (-_tmp49 * _tmp64 + _tmp61 * _tmp66 - _tmp62 * _tmp65) +
                        _tmp47 * _tmp62 - _tmp51 * _tmp64 - _tmp62 * _tmp66;
  const Scalar _tmp68 = Scalar(1.0) / (_tmp67);
  const Scalar _tmp69 =
      std::sqrt(Scalar(std::pow(_tmp31, Scalar(2)) + std::pow(_tmp35, Scalar(2))));
  const Scalar _tmp70 = Scalar(1.0) / (_tmp69);
  const Scalar _tmp71 = _tmp32 * _tmp69;
  const Scalar _tmp72 = _tmp71 * (_tmp30 * _tmp35 * _tmp70 - _tmp31 * _tmp34 * _tmp70);
  const Scalar _tmp73 = _tmp37 * (-_tmp16 * _tmp29 + _tmp25 * _tmp28 + _tmp28 * _tmp72);
  const Scalar _tmp74 = _tmp55 * _tmp62 - _tmp58 * _tmp61 + _tmp62 * _tmp72 - _tmp63 * _tmp73;
  ...
  const Scalar _tmp80 = _tmp37 * (-_tmp78 * _tmp79 + Scalar(1.0));
  const Scalar _tmp81 = _tmp68 * _tmp78;
  const Scalar _tmp82 = _tmp4 + _tmp57;
  const Scalar _tmp83 = _tmp82 - p_b(0, 0) + position_vector(0, 0);
  ...
  const Scalar _tmp88 = _tmp71 * _tmp87 * (_tmp28 * _tmp80 + _tmp62 * _tmp81);
  const Scalar _tmp89 = _tmp36 * _tmp52 - _tmp40 * (_tmp36 * _tmp50 + _tmp65) - _tmp47;
  const Scalar _tmp90 = _tmp77 * (_tmp36 * _tmp73 - _tmp72 - _tmp75 * _tmp89) + _tmp89;
  const Scalar _tmp91 = _tmp68 * _tmp90;
  const Scalar _tmp92 = _tmp37 * (-_tmp36 - _tmp79 * _tmp90);
  const Scalar _tmp93 = _tmp83 * _tmp86;
  const Scalar _tmp94 = _tmp71 * _tmp93 * (_tmp28 * _tmp92 + _tmp62 * _tmp91 + Scalar(1.0));
  const Scalar _tmp95 = Scalar(333.54000000000002) - fv1;
  const Scalar _tmp96 = _tmp38 * _tmp40 + _tmp39;
  const Scalar _tmp97 = 0;
  const Scalar _tmp98 = _tmp37 * _tmp79 * _tmp97;
  const Scalar _tmp99 = _tmp68 * _tmp97;
  const Scalar _tmp100 = _tmp82 * _tmp87 - _tmp84 * _tmp93;
  const Scalar _tmp101 = Scalar(1.0) * _tmp76;
  const Scalar _tmp102 = _tmp100 * _tmp71 * (-_tmp101 * _tmp28 * _tmp64 + _tmp101 * _tmp62);
  ...
  _res(1, 0) = -(-_tmp102 - _tmp88 - _tmp94) *
               std::exp(_tmp102 * fh1 + _tmp71 * _tmp95 * (-_tmp28 * _tmp98 + _tmp62 * _tmp99) +
                        _tmp88 * fh1 + _tmp94 * fh1);
  _res(2, 0) = -(_tmp103 - _tmp104 * _tmp64 + _tmp106) *
               std::exp(-_tmp103 * fh1 + _tmp105 * _tmp64 - _tmp106 * fh1 + _tmp95 * _tmp98);
  _res(3, 0) = -(_tmp104 + _tmp107 + _tmp108) *
               std::exp(-_tmp105 - _tmp107 * fh1 - _tmp108 * fh1 - _tmp95 * _tmp99);
