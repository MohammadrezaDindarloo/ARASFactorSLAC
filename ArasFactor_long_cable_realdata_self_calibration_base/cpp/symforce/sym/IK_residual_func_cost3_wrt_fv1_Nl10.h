...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl10(
  ...
  const Scalar _tmp36 = (-_tmp17 + _tmp33) / (_tmp27 - _tmp35);
  const Scalar _tmp37 = _tmp33 + _tmp35 * _tmp36;
  const Scalar _tmp38 = -Scalar(0.010999999999999999) * _tmp19 -
  ...
  const Scalar _tmp42 = _tmp31 + _tmp5;
  ...
  const Scalar _tmp51 = _tmp40 + _tmp49;
  const Scalar _tmp52 = _tmp30 * _tmp51;
  const Scalar _tmp53 = -_tmp30 * _tmp50 + _tmp52;
  const Scalar _tmp54 = _tmp32 - p_d(0, 0) + position_vector(0, 0);
  const Scalar _tmp55 = Scalar(1.0) / (_tmp54);
  const Scalar _tmp56 = _tmp34 - p_d(1, 0) + position_vector(1, 0);
  const Scalar _tmp57 = _tmp55 * _tmp56;
  const Scalar _tmp58 = _tmp28 * _tmp29;
  const Scalar _tmp59 = Scalar(1.0) / (_tmp30 * _tmp57 - _tmp58);
  const Scalar _tmp60 = _tmp46 * _tmp47;
  const Scalar _tmp61 = _tmp48 * _tmp57 - _tmp60;
  const Scalar _tmp62 = _tmp59 * _tmp61;
  const Scalar _tmp63 = _tmp48 * _tmp51;
  const Scalar _tmp64 = _tmp50 * _tmp58 - _tmp52 * _tmp57;
  const Scalar _tmp65 = -_tmp36 * (_tmp41 * _tmp60 - _tmp57 * _tmp63 - _tmp62 * _tmp64) -
                        _tmp41 * _tmp48 - _tmp53 * _tmp62 + _tmp63;
  ...
  const Scalar _tmp71 = _tmp70 * (-_tmp30 * _tmp68 + _tmp48 * _tmp67);
  const Scalar _tmp72 = Scalar(1.0) * _tmp59;
  const Scalar _tmp73 = _tmp36 * _tmp64 * _tmp72 - _tmp53 * _tmp72;
  const Scalar _tmp74 = Scalar(1.0) / (_tmp69);
  const Scalar _tmp75 = _tmp70 * (_tmp32 * _tmp56 * _tmp74 - _tmp34 * _tmp54 * _tmp74);
  const Scalar _tmp76 = -_tmp17 * _tmp58 + _tmp27 * _tmp30 + _tmp30 * _tmp75;
  const Scalar _tmp77 = -_tmp42 * _tmp60 + _tmp45 * _tmp48 + _tmp48 * _tmp75 - _tmp62 * _tmp76;
  ...
  const Scalar _tmp82 = _tmp48 * _tmp66;
  const Scalar _tmp83 = _tmp61 * _tmp66;
  ...
  const Scalar _tmp88 = _tmp21 + _tmp44;
  ...
  const Scalar _tmp94 = -_tmp36 * (_tmp51 * _tmp57 + _tmp64 * _tmp93) - _tmp51 + _tmp53 * _tmp93;
  const Scalar _tmp95 = _tmp80 * (-_tmp75 + _tmp76 * _tmp93 - _tmp78 * _tmp94) + _tmp94;
  const Scalar _tmp96 = -_tmp57 - _tmp83 * _tmp95;
  const Scalar _tmp97 = _tmp87 * _tmp90;
  const Scalar _tmp98 = _tmp61 * _tmp72 * _tmp79;
  ...
  _res(0, 0) = 0;
  _res(1, 0) =
      -_tmp71 * std::exp(_tmp0 * _tmp71 + _tmp100 * _tmp70 * (-_tmp30 * _tmp98 + _tmp48 * _tmp99) +
                         _tmp91 * _tmp92 * (_tmp81 * _tmp82 + _tmp84 * _tmp85) +
                         _tmp92 * _tmp97 * (_tmp82 * _tmp95 + _tmp85 * _tmp96 + Scalar(1.0)));
  _res(2, 0) = -_tmp68 * std::exp(_tmp100 * _tmp98 - _tmp101 * _tmp84 * _tmp91 -
                                  _tmp101 * _tmp96 * _tmp97 + _tmp102 * _tmp62);
  _res(3, 0) = _tmp67 * std::exp(-_tmp100 * _tmp99 - _tmp102 - _tmp103 * _tmp81 * _tmp91 -
                                 _tmp103 * _tmp95 * _tmp97);
