...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl23(
  ...
  const Scalar _tmp32 = _tmp16 + _tmp8;
  ...
  const Scalar _tmp38 = Scalar(1.0) / (_tmp30 * _tmp37 - _tmp31);
  ...
  const Scalar _tmp54 = _tmp50 - _tmp51 + _tmp53;
  ...
  const Scalar _tmp60 = _tmp31 * _tmp58 - _tmp37 * _tmp59;
  ...
  const Scalar _tmp64 = -_tmp30 * _tmp58 + _tmp59;
  const Scalar _tmp65 = -_tmp47 * _tmp54 - _tmp49 * _tmp64 + _tmp57 -
                        _tmp63 * (-_tmp37 * _tmp57 + _tmp46 * _tmp54 - _tmp49 * _tmp60);
  ...
  const Scalar _tmp74 = _tmp71 * (_tmp32 * _tmp36 * _tmp73 - _tmp33 * _tmp35 * _tmp73);
  const Scalar _tmp75 = -_tmp17 * _tmp31 + _tmp27 * _tmp30 + _tmp30 * _tmp74;
  const Scalar _tmp76 = Scalar(1.0) * _tmp38;
  const Scalar _tmp77 = _tmp60 * _tmp63 * _tmp76 - _tmp64 * _tmp76;
  const Scalar _tmp78 = _tmp40 * _tmp47 - _tmp43 * _tmp46 + _tmp47 * _tmp74 - _tmp49 * _tmp75;
  ...
  const Scalar _tmp97 = _tmp37 * _tmp38;
  const Scalar _tmp98 = -_tmp56 - _tmp63 * (_tmp37 * _tmp56 + _tmp60 * _tmp97) + _tmp64 * _tmp97;
  const Scalar _tmp99 = _tmp81 * (-_tmp74 + _tmp75 * _tmp97 - _tmp79 * _tmp98) + _tmp98;
  const Scalar _tmp100 = -_tmp37 - _tmp83 * _tmp99;
  const Scalar _tmp101 = _tmp38 * fh1;
  ...
  _res(1, 0) =
      -_tmp72 *
      std::exp(_tmp0 * _tmp72 + _tmp71 * _tmp96 * (-_tmp30 * _tmp49 * _tmp94 + _tmp47 * _tmp94) +
               _tmp92 * _tmp93 * (_tmp82 * _tmp86 + _tmp84 * _tmp85) +
               _tmp93 * _tmp95 * (_tmp100 * _tmp85 + _tmp86 * _tmp99 + Scalar(1.0)));
  _res(2, 0) = -_tmp69 * std::exp(-_tmp100 * _tmp101 * _tmp95 - _tmp101 * _tmp84 * _tmp92 +
                                  _tmp102 * _tmp49 + _tmp103 * _tmp49);
  _res(3, 0) =
      _tmp68 * std::exp(-_tmp102 - _tmp103 - _tmp104 * _tmp82 * _tmp92 - _tmp104 * _tmp95 * _tmp99);
