 ...
 *
 * Symbolic function: IK_residual_func_cost3_wrt_pa_Nl1
 *
 * Args:
 *     fh1: Scalar
 *     fv1: Scalar
...
Eigen::Matrix<Scalar, 4, 3> IkResidualFuncCost3WrtPaNl1(
  ...
  const Scalar _tmp38 = _tmp18 + _tmp5;
  const Scalar _tmp39 = _tmp38 - p_d(0, 0) + position_vector(0, 0);
  const Scalar _tmp40 = -_tmp23 + _tmp26;
  ...
  const Scalar _tmp46 = -_tmp37 * _tmp44 + _tmp44 * _tmp45;
  const Scalar _tmp47 = _tmp15 + _tmp4;
  ...
  const Scalar _tmp57 = _tmp31 * _tmp53 - _tmp56;
  const Scalar _tmp58 = _tmp55 * _tmp57;
  const Scalar _tmp59 = _tmp45 * _tmp53;
  const Scalar _tmp60 = _tmp37 * _tmp54 - _tmp44 * _tmp59;
  ...
  const Scalar _tmp65 = -_tmp31 * _tmp36 - _tmp46 * _tmp58 + _tmp61 -
                        _tmp64 * (_tmp36 * _tmp56 - _tmp53 * _tmp61 - _tmp58 * _tmp60);
  const Scalar _tmp66 = Scalar(1.0) / (_tmp65);
  const Scalar _tmp67 =
      std::sqrt(Scalar(std::pow(_tmp48, Scalar(2)) + std::pow(_tmp52, Scalar(2))));
  const Scalar _tmp68 = Scalar(1.0) / (_tmp67);
  const Scalar _tmp69 = _tmp49 * _tmp67;
  const Scalar _tmp70 = _tmp69 * (_tmp47 * _tmp52 * _tmp68 - _tmp48 * _tmp51 * _tmp68);
  const Scalar _tmp71 = _tmp53 * _tmp55;
  const Scalar _tmp72 = -_tmp45 + _tmp46 * _tmp71 - _tmp64 * (_tmp59 + _tmp60 * _tmp71);
  const Scalar _tmp73 = -_tmp38 * _tmp54 + _tmp41 * _tmp44 + _tmp44 * _tmp70;
  const Scalar _tmp74 = -_tmp19 * _tmp56 + _tmp28 * _tmp31 + _tmp31 * _tmp70 - _tmp58 * _tmp73;
  const Scalar _tmp75 = _tmp66 * _tmp74;
  const Scalar _tmp76 = Scalar(1.0) / (_tmp74);
  const Scalar _tmp77 = _tmp65 * _tmp76;
  const Scalar _tmp78 = _tmp72 + _tmp77 * (-_tmp70 + _tmp71 * _tmp73 - _tmp72 * _tmp75);
  const Scalar _tmp79 = _tmp66 * _tmp78;
  const Scalar _tmp80 = _tmp57 * _tmp66;
  const Scalar _tmp81 = _tmp55 * (-_tmp53 - _tmp78 * _tmp80);
  const Scalar _tmp82 = _tmp31 * _tmp79 + _tmp44 * _tmp81 + Scalar(1.0);
  ...
  const Scalar _tmp94 = fh1 * (-_tmp17 * _tmp92 + _tmp85 * _tmp93);
  const Scalar _tmp95 = Scalar(1.0) * _tmp76;
  const Scalar _tmp96 = _tmp44 * _tmp58;
  const Scalar _tmp97 = _tmp69 * (_tmp31 * _tmp95 - _tmp95 * _tmp96);
  const Scalar _tmp98 = Scalar(1.0) * _tmp55;
  const Scalar _tmp99 = -_tmp46 * _tmp98 + _tmp60 * _tmp64 * _tmp98;
  const Scalar _tmp100 = _tmp77 * (-_tmp73 * _tmp98 - _tmp75 * _tmp99) + _tmp99;
  const Scalar _tmp101 = _tmp55 * (-_tmp100 * _tmp80 + Scalar(1.0));
  const Scalar _tmp102 = _tmp100 * _tmp66;
  const Scalar _tmp103 = _tmp101 * _tmp44 + _tmp102 * _tmp31;
  const Scalar _tmp104 = _tmp103 * _tmp90;
  const Scalar _tmp105 = Scalar(333.54000000000002) - fv1;
  const Scalar _tmp106 = _tmp62 + _tmp63 * _tmp64;
  const Scalar _tmp107 = 0;
  const Scalar _tmp108 =
      std::exp(_tmp104 * _tmp85 + _tmp105 * _tmp69 * (_tmp107 * _tmp31 - _tmp107 * _tmp96) +
               _tmp17 * _tmp91 + _tmp94 * _tmp97);
  const Scalar _tmp109 = std::pow(_tmp87, Scalar(Scalar(-3) / Scalar(2)));
  const Scalar _tmp110 = _tmp109 * _tmp84;
  const Scalar _tmp111 = _tmp109 * _tmp16;
  const Scalar _tmp112 = _tmp17 * _tmp85;
  const Scalar _tmp113 = -_tmp110 * _tmp83 + _tmp111 * _tmp112 + _tmp92;
  const Scalar _tmp114 = _tmp97 * fh1;
  const Scalar _tmp115 = _tmp109 * fh1;
  const Scalar _tmp116 = _tmp115 * _tmp83;
  const Scalar _tmp117 = _tmp69 * _tmp82;
  const Scalar _tmp118 = _tmp112 * _tmp115;
  const Scalar _tmp119 = _tmp103 * _tmp69;
  const Scalar _tmp120 = _tmp105 * _tmp107;
  const Scalar _tmp121 = _tmp101 * _tmp89;
  const Scalar _tmp122 = _tmp81 * _tmp89;
  const Scalar _tmp123 = _tmp94 * _tmp95;
  const Scalar _tmp124 =
      std::exp(_tmp120 * _tmp58 - _tmp121 * _tmp85 - _tmp122 * _tmp17 + _tmp123 * _tmp58);
  const Scalar _tmp125 = _tmp95 * fh1;
  const Scalar _tmp126 = _tmp113 * _tmp125;
  const Scalar _tmp127 = _tmp102 * _tmp89;
  const Scalar _tmp128 = _tmp79 * _tmp89;
  const Scalar _tmp129 = std::exp(-_tmp120 - _tmp123 - _tmp127 * _tmp85 - _tmp128 * _tmp17);
  const Scalar _tmp130 = _tmp115 * _tmp86;
  const Scalar _tmp131 = -_tmp110 * _tmp112 + _tmp111 * _tmp86 - _tmp93;
  ...
  _res(0, 0) = 0;
  _res(1, 0) = -_tmp108 * (-_tmp113 * _tmp114 - _tmp116 * _tmp117 - _tmp118 * _tmp119 + _tmp91);
  _res(2, 0) = -_tmp124 * (_tmp101 * _tmp118 + _tmp116 * _tmp81 - _tmp122 - _tmp126 * _tmp58);
  _res(3, 0) = -_tmp129 * (_tmp102 * _tmp118 + _tmp116 * _tmp79 + _tmp126 - _tmp128);
  _res(0, 1) = 0;
  _res(1, 1) = -_tmp108 * (_tmp104 - _tmp114 * _tmp131 - _tmp117 * _tmp118 - _tmp119 * _tmp130);
  _res(2, 1) = -_tmp124 * (_tmp101 * _tmp130 + _tmp118 * _tmp81 - _tmp121 - _tmp132 * _tmp58);
  _res(3, 1) = -_tmp129 * (_tmp102 * _tmp130 + _tmp118 * _tmp79 - _tmp127 + _tmp132);
  _res(0, 2) = 0;
  _res(1, 2) = 0;
  _res(2, 2) = 0;
  _res(3, 2) = 0;
