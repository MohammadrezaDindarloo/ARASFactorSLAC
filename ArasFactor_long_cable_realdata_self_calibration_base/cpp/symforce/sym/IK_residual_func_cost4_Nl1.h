 ...
 *
 * Symbolic function: IK_residual_func_cost4_Nl1
 *
 * Args:
 *     fh1: Scalar
 *     fv1: Scalar
...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost4Nl1(
  ...
  const Scalar _tmp46 = _tmp17 + _tmp8;
  ...
  const Scalar _tmp70 = -_tmp54;
  const Scalar _tmp71 = _tmp55 + _tmp56;
  const Scalar _tmp72 = _tmp70 + _tmp71;
  const Scalar _tmp73 = _tmp58 * _tmp67;
  const Scalar _tmp74 = _tmp69 * (-_tmp59 * _tmp73 + _tmp68 * _tmp72);
  const Scalar _tmp75 = _tmp58 * _tmp59 + _tmp59 * _tmp74;
  const Scalar _tmp76 = Scalar(1.0) * _tmp46;
  const Scalar _tmp77 = -_tmp76;
  const Scalar _tmp78 = Scalar(1.0) / (_tmp63 + _tmp77);
  const Scalar _tmp79 = Scalar(1.0) * _tmp43;
  const Scalar _tmp80 = -_tmp60 + _tmp79;
  const Scalar _tmp81 = _tmp78 * _tmp80;
  const Scalar _tmp82 = _tmp69 * (-_tmp67 * _tmp72 + _tmp73);
  const Scalar _tmp83 = -_tmp58 + _tmp59 * _tmp82 - _tmp75 * _tmp81;
  const Scalar _tmp84 = _tmp54 + _tmp71;
  const Scalar _tmp85 = _tmp40 * _tmp41;
  const Scalar _tmp86 = _tmp42 * _tmp59 - _tmp85;
  const Scalar _tmp87 = _tmp42 * _tmp58;
  const Scalar _tmp88 = -_tmp59 * _tmp87 - _tmp74 * _tmp86 + _tmp84 * _tmp85;
  const Scalar _tmp89 = -_tmp42 * _tmp84 - _tmp81 * _tmp88 - _tmp82 * _tmp86 + _tmp87;
  const Scalar _tmp90 = Scalar(1.0) / (_tmp89);
  const Scalar _tmp91 = _tmp69 * (_tmp53 * _tmp67 - _tmp60 * _tmp68 + _tmp63 * _tmp67);
  const Scalar _tmp92 = -_tmp34 * _tmp85 + _tmp38 * _tmp42 + _tmp42 * _tmp53 - _tmp86 * _tmp91;
  const Scalar _tmp93 = _tmp90 * _tmp92;
  const Scalar _tmp94 = Scalar(1.0) / (_tmp92);
  const Scalar _tmp95 = _tmp89 * _tmp94;
  const Scalar _tmp96 = _tmp95 * (-_tmp53 + _tmp59 * _tmp91 - _tmp83 * _tmp93);
  const Scalar _tmp97 = _tmp90 * (_tmp83 + _tmp96);
  const Scalar _tmp98 = -_tmp59 - _tmp86 * _tmp97;
  const Scalar _tmp99 = _tmp67 * _tmp69;
  const Scalar _tmp100 = _tmp30 - p_a(0, 0);
  const Scalar _tmp101 = _tmp19 - p_a(1, 0);
  ...
  const Scalar _tmp106 = _tmp86 * _tmp99;
  const Scalar _tmp107 = _tmp101 * _tmp102;
  const Scalar _tmp108 = fh1 * (-_tmp103 * _tmp18 + _tmp107 * _tmp29);
  const Scalar _tmp109 = Scalar(1.0) * _tmp78;
  const Scalar _tmp110 = _tmp109 * _tmp74 * _tmp80 - Scalar(1.0) * _tmp82;
  const Scalar _tmp111 = _tmp95 * (-_tmp110 * _tmp93 - Scalar(1.0) * _tmp91);
  const Scalar _tmp112 = _tmp90 * (_tmp110 + _tmp111);
  ...
  const Scalar _tmp118 = -_tmp104 * _tmp52 * (_tmp42 * _tmp97 + _tmp98 * _tmp99 + Scalar(1.0)) -
                         _tmp108 * _tmp52 * (-_tmp105 * _tmp106 + _tmp105 * _tmp42) -
                         _tmp114 * _tmp52 * (_tmp112 * _tmp42 + _tmp113 * _tmp99) -
                         _tmp115 * _tmp52 * (-_tmp106 * _tmp117 + _tmp117 * _tmp42);
  const Scalar _tmp119 = Scalar(1.0) / (_tmp118);
  const Scalar _tmp120 = _tmp38 + _tmp77;
  const Scalar _tmp121 = _tmp120 * _tmp81;
  const Scalar _tmp122 = Scalar(1.0) / (-_tmp121 - _tmp34 + _tmp79);
  const Scalar _tmp123 = Scalar(1.0) * _tmp122;
  const Scalar _tmp124 = _tmp123 * _tmp95;
  const Scalar _tmp125 = _tmp120 * _tmp123;
  const Scalar _tmp126 = -_tmp105 * _tmp88 + _tmp125 * _tmp95;
  const Scalar _tmp127 = fh1 * (_tmp57 + _tmp70);
  const Scalar _tmp128 = -_tmp107 * _tmp127 - Scalar(40.024799999999999) * _tmp12 - _tmp18 * fv1;
  const Scalar _tmp129 = _tmp121 * _tmp123 + Scalar(1.0);
  const Scalar _tmp130 = _tmp123 * _tmp81;
  const Scalar _tmp131 = _tmp103 * _tmp127 + Scalar(40.024799999999999) * _tmp25 + _tmp29 * fv1;
  const Scalar _tmp132 = _tmp120 * _tmp122;
  const Scalar _tmp133 = _tmp111 * _tmp132 - _tmp112 * _tmp88 - Scalar(1.0) * _tmp74;
  const Scalar _tmp134 = _tmp132 * _tmp96 + _tmp75 - _tmp88 * _tmp97;
  const Scalar _tmp135 = _tmp116 * _tmp122;
  const Scalar _tmp136 = _tmp78 * (-_tmp117 * _tmp88 - _tmp120 * _tmp135 + _tmp77);
  const Scalar _tmp137 =
      std::asinh(_tmp119 * (Scalar(1.0) * _tmp104 * (-_tmp109 * _tmp134 + _tmp123 * _tmp96) +
                            Scalar(1.0) * _tmp108 * (-_tmp109 * _tmp126 + _tmp124) +
                            Scalar(1.0) * _tmp114 * (-_tmp109 * _tmp133 + _tmp111 * _tmp123) +
                            Scalar(1.0) * _tmp115 *
                                (-_tmp116 * _tmp123 - Scalar(1.0) * _tmp136 + Scalar(1.0)) +
                            Scalar(1.0) * _tmp128 * (-_tmp109 * _tmp129 + _tmp130) +
                            Scalar(1.0) * _tmp131 * (-_tmp123 + _tmp125 * _tmp78)));
  const Scalar _tmp138 = Scalar(1.4083112389913199) * _tmp118;
  const Scalar _tmp139 = _tmp115 * _tmp117;
  const Scalar _tmp140 = _tmp69 * _tmp86;
  const Scalar _tmp141 = _tmp105 * _tmp108;
  const Scalar _tmp142 = _tmp104 * _tmp69 * _tmp98 + _tmp113 * _tmp114 * _tmp69 -
  ...
  const Scalar _tmp145 =
      std::asinh(_tmp143 * (_tmp104 * _tmp134 * _tmp78 + _tmp108 * _tmp126 * _tmp78 +
                            _tmp114 * _tmp133 * _tmp78 + _tmp115 * _tmp136 -
                            _tmp120 * _tmp144 * _tmp78 + _tmp128 * _tmp129 * _tmp78));
  const Scalar _tmp146 = Scalar(1.4083112389913199) * _tmp142;
  const Scalar _tmp147 = _tmp104 * _tmp97 + _tmp112 * _tmp114 + _tmp139 + _tmp141;
  const Scalar _tmp148 = Scalar(1.0) / (_tmp147);
  const Scalar _tmp149 = std::asinh(_tmp148 * (-_tmp104 * _tmp122 * _tmp96 - _tmp108 * _tmp124 -
                                               _tmp111 * _tmp114 * _tmp122 + _tmp115 * _tmp135 -
                                               _tmp128 * _tmp130 + _tmp144));
