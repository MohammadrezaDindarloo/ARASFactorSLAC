 ...
 *
 * Symbolic function: IK_residual_func_cost4_Nl16
 *
 * Args:
 *     fh1: Scalar
 *     fv1: Scalar
...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost4Nl16(
  ...
  const Scalar _tmp32 = -_tmp21 + _tmp25;
  ...
  const Scalar _tmp80 = Scalar(1.0) / (_tmp68 * _tmp76 - _tmp79);
  const Scalar _tmp81 = _tmp80 * (-_tmp68 * _tmp77 + _tmp78 * _tmp79);
  const Scalar _tmp82 = -_tmp59 * _tmp69 + _tmp61 * _tmp62 - _tmp70 * _tmp81;
  const Scalar _tmp83 = _tmp80 * (-_tmp76 * _tmp78 + _tmp77);
  const Scalar _tmp84 = -_tmp44 * _tmp82 + _tmp51 * _tmp59 - _tmp59 * _tmp61 - _tmp70 * _tmp83;
  ...
  const Scalar _tmp92 = _tmp90 * (_tmp33 * _tmp67 * _tmp91 - _tmp36 * _tmp64 * _tmp91);
  const Scalar _tmp93 = _tmp80 * (_tmp40 * _tmp76 - _tmp43 * _tmp79 + _tmp76 * _tmp92);
  const Scalar _tmp94 = -_tmp52 * _tmp62 + _tmp55 * _tmp59 + _tmp59 * _tmp92 - _tmp70 * _tmp93;
  const Scalar _tmp95 = Scalar(1.0) / (_tmp94);
  const Scalar _tmp96 = Scalar(1.0) * _tmp95;
  const Scalar _tmp97 = _tmp28 - p_c(0, 0);
  const Scalar _tmp98 = _tmp18 - p_c(1, 0);
  ...
  const Scalar _tmp102 = fh1 * (-_tmp100 * _tmp17 + _tmp101 * _tmp27);
  const Scalar _tmp103 = _tmp68 * _tmp81 + _tmp69;
  const Scalar _tmp104 = -_tmp103 * _tmp44 - _tmp51 + _tmp68 * _tmp83;
  const Scalar _tmp105 = _tmp85 * _tmp94;
  const Scalar _tmp106 = _tmp84 * _tmp95;
  const Scalar _tmp107 = _tmp106 * (-_tmp104 * _tmp105 + _tmp68 * _tmp93 - _tmp92);
  const Scalar _tmp108 = _tmp104 + _tmp107;
  const Scalar _tmp109 = _tmp59 * _tmp85;
  const Scalar _tmp110 = _tmp70 * _tmp85;
  const Scalar _tmp111 = -_tmp108 * _tmp110 - _tmp68;
  const Scalar _tmp112 = _tmp100 * fh1;
  const Scalar _tmp113 = Scalar(1.0) * _tmp81;
  const Scalar _tmp114 = _tmp113 * _tmp44 - Scalar(1.0) * _tmp83;
  const Scalar _tmp115 = _tmp106 * (-_tmp105 * _tmp114 - Scalar(1.0) * _tmp93);
  const Scalar _tmp116 = _tmp114 + _tmp115;
  const Scalar _tmp117 = -_tmp110 * _tmp116 + Scalar(1.0);
  const Scalar _tmp118 = _tmp101 * fh1;
  const Scalar _tmp119 = -_tmp102 * _tmp90 * (_tmp59 * _tmp96 - _tmp88 * _tmp96) -
                         _tmp112 * _tmp90 * (_tmp108 * _tmp109 + _tmp111 * _tmp87 + Scalar(1.0)) -
                         _tmp118 * _tmp90 * (_tmp109 * _tmp116 + _tmp117 * _tmp87) -
                         _tmp31 * _tmp90 * (_tmp59 * _tmp86 - _tmp86 * _tmp88);
  const Scalar _tmp120 = Scalar(1.0) / (_tmp119);
  const Scalar _tmp121 = _tmp38 + _tmp55;
  const Scalar _tmp122 = _tmp121 * _tmp44;
  const Scalar _tmp123 = Scalar(1.0) / (-_tmp122 + _tmp34 - _tmp52);
  const Scalar _tmp124 = Scalar(1.0) * _tmp123;
  const Scalar _tmp125 = _tmp121 * _tmp123;
  const Scalar _tmp126 = _tmp82 * _tmp85;
  const Scalar _tmp127 = _tmp103 + _tmp107 * _tmp125 - _tmp108 * _tmp126;
  const Scalar _tmp128 = Scalar(1.0) * _tmp41;
  const Scalar _tmp129 = _tmp106 * _tmp124;
  const Scalar _tmp130 = _tmp121 * _tmp129 - _tmp82 * _tmp96;
  const Scalar _tmp131 = -_tmp113 + _tmp115 * _tmp125 - _tmp116 * _tmp126;
  const Scalar _tmp132 = fh1 * (_tmp46 + _tmp50);
  const Scalar _tmp133 = _tmp100 * _tmp132 + Scalar(40.024799999999999) * _tmp24 + _tmp27 * fv1;
  const Scalar _tmp134 = _tmp121 * _tmp41;
  const Scalar _tmp135 = -_tmp101 * _tmp132 - Scalar(40.024799999999999) * _tmp11 - _tmp17 * fv1;
  const Scalar _tmp136 = _tmp122 * _tmp124 + Scalar(1.0);
  const Scalar _tmp137 = _tmp124 * _tmp44;
  const Scalar _tmp138 = _tmp123 * _tmp45;
  const Scalar _tmp139 = -_tmp121 * _tmp138 + _tmp38 - _tmp82 * _tmp86;
  const Scalar _tmp140 = std::asinh(
      _tmp120 * (Scalar(1.0) * _tmp102 * (-_tmp128 * _tmp130 + _tmp129) +
                 Scalar(1.0) * _tmp112 * (_tmp107 * _tmp124 - _tmp127 * _tmp128) +
                 Scalar(1.0) * _tmp118 * (_tmp115 * _tmp124 - _tmp128 * _tmp131) +
                 Scalar(1.0) * _tmp133 * (_tmp124 * _tmp134 - _tmp124) +
                 Scalar(1.0) * _tmp135 * (-_tmp128 * _tmp136 + _tmp137) +
                 Scalar(1.0) * _tmp31 * (-_tmp124 * _tmp45 - _tmp128 * _tmp139 + Scalar(1.0))));
  const Scalar _tmp141 = Scalar(1.4083112389913199) * _tmp119;
  const Scalar _tmp142 = _tmp124 * _tmp133;
  const Scalar _tmp143 = _tmp31 * _tmp86;
  const Scalar _tmp144 = _tmp70 * _tmp80;
  const Scalar _tmp145 = _tmp102 * _tmp96;
  const Scalar _tmp146 = _tmp111 * _tmp112 * _tmp80 + _tmp117 * _tmp118 * _tmp80 -
                         _tmp143 * _tmp144 - _tmp144 * _tmp145;
  const Scalar _tmp147 = Scalar(1.0) / (_tmp146);
  const Scalar _tmp148 =
      std::asinh(_tmp147 * (_tmp102 * _tmp130 * _tmp41 + _tmp112 * _tmp127 * _tmp41 +
                            _tmp118 * _tmp131 * _tmp41 - _tmp134 * _tmp142 +
                            _tmp135 * _tmp136 * _tmp41 + _tmp139 * _tmp31 * _tmp41));
  const Scalar _tmp149 = Scalar(1.4083112389913199) * _tmp146;
  const Scalar _tmp150 =
      _tmp108 * _tmp112 * _tmp85 + _tmp116 * _tmp118 * _tmp85 + _tmp143 + _tmp145;
  const Scalar _tmp151 = Scalar(1.0) / (_tmp150);
  const Scalar _tmp152 = std::asinh(_tmp151 * (-_tmp102 * _tmp129 - _tmp107 * _tmp112 * _tmp123 -
                                               _tmp115 * _tmp118 * _tmp123 - _tmp135 * _tmp137 +
                                               _tmp138 * _tmp31 + _tmp142));
  ...
  _res(1, 0) =
      _tmp141 * (-std::sinh(Scalar(1.0) * _tmp140) -
                 std::sinh(Scalar(0.71007031138673404) * _tmp120 *
                           (-_tmp140 * _tmp141 -
                            std::sqrt(Scalar(std::pow(Scalar(-_tmp63 + p_d(0, 0)), Scalar(2)) +
  ...
  _res(3, 0) =
      _tmp153 * (-std::sinh(Scalar(1.0) * _tmp152) -
                 std::sinh(Scalar(0.71007031138673404) * _tmp151 *
                           (-_tmp152 * _tmp153 -
                            std::sqrt(Scalar(std::pow(Scalar(-_tmp53 + p_b(0, 0)), Scalar(2)) +
