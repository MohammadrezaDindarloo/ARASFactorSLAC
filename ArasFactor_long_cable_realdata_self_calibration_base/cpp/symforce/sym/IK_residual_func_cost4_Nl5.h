 ...
 *
 * Symbolic function: IK_residual_func_cost4_Nl5
 *
 * Args:
 *     fh1: Scalar
 *     fv1: Scalar
...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost4Nl5(
  ...
  const Scalar _tmp33 = _tmp17 + _tmp5;
  ...
  const Scalar _tmp38 = _tmp30 - p_a(0, 0);
  const Scalar _tmp39 = _tmp19 - p_a(1, 0);
  ...
  const Scalar _tmp47 = fh1 * (_tmp43 + _tmp46);
  const Scalar _tmp48 = Scalar(40.024799999999999) * _tmp25 + _tmp29 * fv1 + _tmp41 * _tmp47;
  const Scalar _tmp49 = Scalar(1.0) * _tmp36;
  const Scalar _tmp50 = _tmp21 + _tmp28;
  const Scalar _tmp51 = Scalar(1.0) * _tmp33;
  ...
  const Scalar _tmp56 = _tmp5 + _tmp53;
  const Scalar _tmp57 = Scalar(1.0) / (_tmp52 + _tmp56);
  const Scalar _tmp58 = _tmp21 + _tmp35;
  ...
  const Scalar _tmp65 = -Scalar(40.024799999999999) * _tmp15 - _tmp18 * fv1 - _tmp47 * _tmp64;
  ...
  const Scalar _tmp70 = _tmp49 + _tmp51 * _tmp59;
  ...
  const Scalar _tmp78 = _tmp37 - p_d(0, 0);
  const Scalar _tmp79 = Scalar(1.0) / (_tmp78);
  const Scalar _tmp80 = _tmp34 - p_d(1, 0);
  const Scalar _tmp81 = _tmp79 * _tmp80;
  const Scalar _tmp82 = _tmp44 + _tmp45;
  const Scalar _tmp83 = _tmp43 + _tmp82;
  const Scalar _tmp84 = _tmp73 * _tmp76;
  const Scalar _tmp85 = _tmp83 * _tmp84;
  const Scalar _tmp86 = _tmp58 + position_vector(0, 0);
  const Scalar _tmp87 = _tmp86 - p_c(0, 0);
  const Scalar _tmp88 = _tmp56 + position_vector(1, 0);
  ...
  const Scalar _tmp93 = _tmp42 + _tmp82;
  const Scalar _tmp94 = _tmp89 * _tmp90;
  const Scalar _tmp95 = -_tmp81 * _tmp92 + _tmp93 * _tmp94;
  const Scalar _tmp96 = -_tmp77 + _tmp81 * _tmp84;
  const Scalar _tmp97 = Scalar(1.0) / (_tmp81 * _tmp91 - _tmp94);
  ...
  const Scalar _tmp101 = -_tmp100 * _tmp98 - _tmp59 * _tmp99 - _tmp71 * _tmp84 + _tmp85;
  const Scalar _tmp102 = Scalar(1.0) / (_tmp101);
  const Scalar _tmp103 = 0;
  const Scalar _tmp104 = _tmp61 * _tmp70;
  const Scalar _tmp105 = -_tmp103 * _tmp99 - _tmp104 * _tmp55 + _tmp52;
  ...
  const Scalar _tmp109 = _tmp108 * (-_tmp107 * _tmp33 * _tmp78 + _tmp107 * _tmp36 * _tmp80);
  const Scalar _tmp110 = _tmp109 * _tmp91 + _tmp56 * _tmp91 - _tmp58 * _tmp94;
  const Scalar _tmp111 = _tmp81 * _tmp97;
  const Scalar _tmp112 = _tmp111 * _tmp95 + _tmp81 * _tmp83;
  const Scalar _tmp113 = _tmp100 * _tmp111 - _tmp112 * _tmp59 - _tmp83;
  const Scalar _tmp114 = _tmp109 * _tmp84 - _tmp110 * _tmp98 - _tmp50 * _tmp77 + _tmp54 * _tmp84;
  ...
  const Scalar _tmp121 = _tmp102 * _tmp99;
  const Scalar _tmp122 = _tmp112 + _tmp118 * _tmp119 - _tmp120 * _tmp121;
  const Scalar _tmp123 = _tmp41 * fh1;
  const Scalar _tmp124 = _tmp117 * _tmp62;
  const Scalar _tmp125 = Scalar(1.0) * _tmp116;
  const Scalar _tmp126 = _tmp124 * _tmp55 - _tmp125 * _tmp99;
  const Scalar _tmp127 = fh1 * (-_tmp18 * _tmp41 + _tmp29 * _tmp64);
  const Scalar _tmp128 = Scalar(1.0) * _tmp97;
  const Scalar _tmp129 = _tmp128 * _tmp95;
  const Scalar _tmp130 = -_tmp100 * _tmp128 + _tmp129 * _tmp59;
  const Scalar _tmp131 = _tmp117 * (-_tmp110 * _tmp128 - _tmp115 * _tmp130);
  const Scalar _tmp132 = _tmp130 + _tmp131;
  const Scalar _tmp133 = _tmp119 * _tmp131 - _tmp121 * _tmp132 - _tmp129;
  const Scalar _tmp134 = _tmp64 * fh1;
  const Scalar _tmp135 = _tmp102 * _tmp96;
  const Scalar _tmp136 = -_tmp120 * _tmp135 - _tmp81;
  const Scalar _tmp137 = _tmp91 * _tmp97;
  const Scalar _tmp138 = _tmp102 * _tmp84;
  const Scalar _tmp139 = _tmp91 * _tmp98;
  const Scalar _tmp140 = -_tmp132 * _tmp135 + Scalar(1.0);
  const Scalar _tmp141 =
      -_tmp108 * _tmp123 * (_tmp120 * _tmp138 + _tmp136 * _tmp137 + Scalar(1.0)) -
      _tmp108 * _tmp127 * (-_tmp125 * _tmp139 + _tmp125 * _tmp84) -
      _tmp108 * _tmp134 * (_tmp132 * _tmp138 + _tmp137 * _tmp140) -
      _tmp108 * _tmp69 * (-_tmp103 * _tmp139 + _tmp103 * _tmp84);
  const Scalar _tmp142 = Scalar(1.0) / (_tmp141);
  const Scalar _tmp143 = std::asinh(
      _tmp142 * (Scalar(1.0) * _tmp123 * (_tmp118 * _tmp62 - _tmp122 * _tmp67) +
                 Scalar(1.0) * _tmp127 * (_tmp124 - _tmp126 * _tmp67) +
                 Scalar(1.0) * _tmp134 * (_tmp131 * _tmp62 - _tmp133 * _tmp67) +
                 Scalar(1.0) * _tmp48 * (_tmp62 * _tmp63 - _tmp62) +
                 Scalar(1.0) * _tmp65 * (-_tmp66 * _tmp67 + _tmp68) +
                 Scalar(1.0) * _tmp69 * (-_tmp105 * _tmp67 - _tmp62 * _tmp70 + Scalar(1.0))));
  const Scalar _tmp144 = Scalar(1.4083112389913199) * _tmp141;
  const Scalar _tmp145 = _tmp48 * _tmp62;
  const Scalar _tmp146 = _tmp125 * _tmp127;
  const Scalar _tmp147 = _tmp103 * _tmp69;
  const Scalar _tmp148 =
      _tmp123 * _tmp136 * _tmp97 + _tmp134 * _tmp140 * _tmp97 - _tmp146 * _tmp98 - _tmp147 * _tmp98;
  const Scalar _tmp149 = Scalar(1.0) / (_tmp148);
  const Scalar _tmp150 =
      std::asinh(_tmp149 * (_tmp105 * _tmp57 * _tmp69 + _tmp122 * _tmp123 * _tmp57 +
                            _tmp126 * _tmp127 * _tmp57 + _tmp133 * _tmp134 * _tmp57 -
                            _tmp145 * _tmp63 + _tmp57 * _tmp65 * _tmp66));
  const Scalar _tmp151 = Scalar(1.4083112389913199) * _tmp148;
  const Scalar _tmp152 =
      _tmp102 * _tmp120 * _tmp123 + _tmp102 * _tmp132 * _tmp134 + _tmp146 + _tmp147;
  const Scalar _tmp153 = Scalar(1.0) / (_tmp152);
  const Scalar _tmp154 =
      std::asinh(_tmp153 * (_tmp104 * _tmp69 - _tmp118 * _tmp123 * _tmp61 - _tmp124 * _tmp127 -
                            _tmp131 * _tmp134 * _tmp61 + _tmp145 - _tmp65 * _tmp68));
  ...
  _res(1, 0) =
      _tmp144 * (-std::sinh(Scalar(1.0) * _tmp143) -
                 std::sinh(Scalar(0.71007031138673404) * _tmp142 *
                           (-_tmp143 * _tmp144 -
                            std::sqrt(Scalar(std::pow(Scalar(-_tmp34 + p_d(1, 0)), Scalar(2)) +
  ...
  _res(2, 0) =
      _tmp151 * (-std::sinh(Scalar(1.0) * _tmp150) -
                 std::sinh(Scalar(0.71007031138673404) * _tmp149 *
                           (-_tmp150 * _tmp151 -
                            std::sqrt(Scalar(std::pow(Scalar(-_tmp86 + p_c(0, 0)), Scalar(2)) +
