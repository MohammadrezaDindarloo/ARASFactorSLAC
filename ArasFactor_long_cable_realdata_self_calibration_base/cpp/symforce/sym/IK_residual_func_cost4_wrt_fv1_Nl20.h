 ...
 *
 * Symbolic function: IK_residual_func_cost4_wrt_fv1_Nl20
 *
 * Args:
 *     fh1: Scalar
 *     fv1: Scalar
...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost4WrtFv1Nl20(
  ...
  const Scalar _tmp55 = _tmp41 + _tmp45;
  const Scalar _tmp56 = _tmp54 * _tmp55;
  const Scalar _tmp57 = -_tmp46 * _tmp54 + _tmp56;
  const Scalar _tmp58 = _tmp40 - p_b(0, 0);
  const Scalar _tmp59 = Scalar(1.0) / (_tmp58);
  const Scalar _tmp60 = _tmp37 - p_b(1, 0);
  const Scalar _tmp61 = _tmp59 * _tmp60;
  const Scalar _tmp62 = _tmp52 * _tmp53;
  const Scalar _tmp63 = Scalar(1.0) / (_tmp54 * _tmp61 - _tmp62);
  const Scalar _tmp64 = Scalar(1.0) * _tmp63;
  const Scalar _tmp65 = Scalar(1.0) * _tmp36;
  const Scalar _tmp66 = -_tmp65;
  const Scalar _tmp67 = Scalar(1.0) / (_tmp50 + _tmp66);
  const Scalar _tmp68 = Scalar(1.0) * _tmp39;
  const Scalar _tmp69 = _tmp67 * (-_tmp47 + _tmp68);
  const Scalar _tmp70 = _tmp46 * _tmp62 - _tmp56 * _tmp61;
  const Scalar _tmp71 = _tmp64 * _tmp70;
  const Scalar _tmp72 = -_tmp57 * _tmp64 + _tmp69 * _tmp71;
  const Scalar _tmp73 = _tmp23 + _tmp30;
  const Scalar _tmp74 = _tmp73 + position_vector(0, 0);
  const Scalar _tmp75 = _tmp74 - p_c(0, 0);
  const Scalar _tmp76 = _tmp13 + _tmp18 + _tmp7;
  ...
  const Scalar _tmp84 = _tmp55 * _tmp80;
  const Scalar _tmp85 = _tmp43 + _tmp44;
  const Scalar _tmp86 = _tmp41 + _tmp85;
  const Scalar _tmp87 = -_tmp61 * _tmp84 - _tmp70 * _tmp83 + _tmp81 * _tmp86;
  const Scalar _tmp88 = -_tmp57 * _tmp83 - _tmp69 * _tmp87 - _tmp80 * _tmp86 + _tmp84;
  ...
  const Scalar _tmp93 = _tmp92 * (-_tmp36 * _tmp58 * _tmp91 + _tmp39 * _tmp60 * _tmp91);
  const Scalar _tmp94 = -_tmp47 * _tmp62 + _tmp50 * _tmp54 + _tmp54 * _tmp93;
  const Scalar _tmp95 = -_tmp73 * _tmp81 + _tmp76 * _tmp80 + _tmp80 * _tmp93 - _tmp83 * _tmp94;
  ...
  const Scalar _tmp104 = _tmp54 * _tmp63;
  ...
  const Scalar _tmp127 = -_tmp109 * _tmp92 * (_tmp100 * _tmp101 + _tmp103 * _tmp104) -
                         ...
                         _tmp120 * _tmp92 * (_tmp118 * _tmp80 - _tmp119 * _tmp54) -
                         _tmp121 * _tmp126;
  const Scalar _tmp128 = Scalar(1.0) / (_tmp127);
  const Scalar _tmp129 = _tmp66 + _tmp76;
  const Scalar _tmp130 = _tmp129 * _tmp69;
  const Scalar _tmp131 = Scalar(1.0) / (-_tmp130 + _tmp68 - _tmp73);
  const Scalar _tmp132 = Scalar(1.0) * _tmp131;
  const Scalar _tmp133 = _tmp87 * _tmp89;
  const Scalar _tmp134 = _tmp129 * _tmp131;
  const Scalar _tmp135 = -_tmp100 * _tmp133 + _tmp134 * _tmp99 - _tmp71;
  const Scalar _tmp136 = Scalar(1.0) * _tmp67;
  const Scalar _tmp137 = fh1 * (_tmp42 + _tmp85);
  const Scalar _tmp138 = _tmp116 * _tmp137 + Scalar(40.024799999999999) * _tmp27 + _tmp31 * fv1;
  const Scalar _tmp139 = _tmp129 * _tmp67;
  const Scalar _tmp140 = Scalar(1.0) * _tmp132 * _tmp139 - Scalar(1.0) * _tmp132;
  const Scalar _tmp141 = _tmp111 + _tmp113 * _tmp134 - _tmp114 * _tmp133;
  const Scalar _tmp142 = -_tmp108 * _tmp137 - Scalar(40.024799999999999) * _tmp16 - _tmp20 * fv1;
  const Scalar _tmp143 = _tmp132 * _tmp69;
  const Scalar _tmp144 = _tmp130 * _tmp132 + Scalar(1.0);
  const Scalar _tmp145 = -Scalar(1.0) * _tmp136 * _tmp144 + Scalar(1.0) * _tmp143;
  const Scalar _tmp146 = _tmp122 * _tmp131;
  const Scalar _tmp147 = _tmp67 * (-_tmp123 * _tmp133 - _tmp129 * _tmp146 + _tmp66);
  const Scalar _tmp148 = -Scalar(1.0) * _tmp122 * _tmp132 - Scalar(1.0) * _tmp147 + Scalar(1.0);
  const Scalar _tmp149 = _tmp132 * _tmp98;
  const Scalar _tmp150 = -_tmp118 * _tmp87 + _tmp129 * _tmp149;
  const Scalar _tmp151 = Scalar(1.0) * _tmp109 * (_tmp132 * _tmp99 - _tmp135 * _tmp136) +
                         Scalar(1.0) * _tmp117 * (_tmp113 * _tmp132 - _tmp136 * _tmp141) +
  ...
  const Scalar _tmp161 = _tmp17 + _tmp35;
  const Scalar _tmp162 =
      (_tmp128 * (_tmp140 * _tmp31 + _tmp145 * _tmp161 - _tmp148) - _tmp151 * _tmp160) /
      std::sqrt(Scalar(std::pow(_tmp151, Scalar(2)) * _tmp159 + 1));
  const Scalar _tmp163 = _tmp132 * _tmp138;
  const Scalar _tmp164 = _tmp144 * _tmp67;
  const Scalar _tmp165 = _tmp109 * _tmp135 * _tmp67 + _tmp117 * _tmp141 * _tmp67 +
                         _tmp120 * _tmp150 * _tmp67 + _tmp121 * _tmp147 - _tmp139 * _tmp163 +
                         _tmp142 * _tmp164;
  const Scalar _tmp166 = _tmp121 * _tmp124;
  const Scalar _tmp167 = _tmp103 * _tmp109 * _tmp63 + _tmp115 * _tmp117 * _tmp63 -
                         _tmp119 * _tmp120 - _tmp166 * _tmp83;
  ...
  const Scalar _tmp172 =
      -_tmp169 * _tmp171 - std::sqrt(Scalar(std::pow(Scalar(-_tmp48 + p_a(0, 0)), Scalar(2)) +
  ...
  const Scalar _tmp179 = _tmp132 * _tmp31;
  const Scalar _tmp180 =
      (-_tmp165 * _tmp178 + _tmp168 * (-_tmp139 * _tmp179 - _tmp147 + _tmp161 * _tmp164)) /
      std::sqrt(Scalar(std::pow(_tmp165, Scalar(2)) * _tmp177 + 1));
  const Scalar _tmp181 = -_tmp109 * _tmp131 * _tmp99 - _tmp113 * _tmp117 * _tmp131 -
                         _tmp120 * _tmp149 + _tmp121 * _tmp146 - _tmp142 * _tmp143 + _tmp163;
  const Scalar _tmp182 =
      _tmp100 * _tmp109 * _tmp89 + _tmp114 * _tmp117 * _tmp89 + _tmp118 * _tmp120 + _tmp166;
  ...
  const Scalar _tmp188 = (_tmp181 * _tmp187 + _tmp183 * (-_tmp143 * _tmp161 - _tmp146 + _tmp179)) /
  ...
  _res(3, 0) = -_tmp175 * (-std::sinh(_tmp191) - std::sinh(_tmp192)) +
               _tmp185 * (-Scalar(1.0) * _tmp188 * std::cosh(_tmp192) -
                          (Scalar(0.71007031138673404) * _tmp187 * _tmp190 +
                           _tmp189 * (_tmp175 * _tmp184 - _tmp185 * _tmp188)) *
                              std::cosh(_tmp191));
