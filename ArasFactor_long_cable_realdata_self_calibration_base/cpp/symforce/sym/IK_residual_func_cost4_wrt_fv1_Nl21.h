 ...
 *
 * Symbolic function: IK_residual_func_cost4_wrt_fv1_Nl21
 *
 * Args:
 *     fh1: Scalar
 *     fv1: Scalar
...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost4WrtFv1Nl21(
  ...
  const Scalar _tmp66 = _tmp13 + _tmp18 + _tmp7;
  ...
  const Scalar _tmp71 = _tmp55 + _tmp59;
  const Scalar _tmp72 = _tmp70 * _tmp71;
  const Scalar _tmp73 = -_tmp62 * _tmp70 + _tmp72;
  const Scalar _tmp74 = _tmp68 * _tmp69;
  const Scalar _tmp75 = Scalar(1.0) / (_tmp44 * _tmp70 - _tmp74);
  const Scalar _tmp76 = _tmp54 * _tmp75;
  const Scalar _tmp77 = -_tmp44 * _tmp72 + _tmp62 * _tmp74;
  const Scalar _tmp78 = _tmp52 * _tmp71;
  const Scalar _tmp79 = -_tmp44 * _tmp78 + _tmp53 * _tmp60 - _tmp76 * _tmp77;
  const Scalar _tmp80 = Scalar(1.0) * _tmp41;
  const Scalar _tmp81 = -_tmp80;
  const Scalar _tmp82 = Scalar(1.0) / (_tmp66 + _tmp81);
  const Scalar _tmp83 = Scalar(1.0) * _tmp35;
  const Scalar _tmp84 = _tmp82 * (-_tmp63 + _tmp83);
  const Scalar _tmp85 = -_tmp52 * _tmp60 - _tmp73 * _tmp76 + _tmp78 - _tmp79 * _tmp84;
  const Scalar _tmp86 = Scalar(1.0) / (_tmp85);
  const Scalar _tmp87 =
      std::sqrt(Scalar(std::pow(_tmp37, Scalar(2)) + std::pow(_tmp43, Scalar(2))));
  const Scalar _tmp88 = Scalar(1.0) / (_tmp87);
  const Scalar _tmp89 = _tmp38 * _tmp87;
  const Scalar _tmp90 = _tmp89 * (_tmp35 * _tmp43 * _tmp88 - _tmp37 * _tmp41 * _tmp88);
  const Scalar _tmp91 = -_tmp63 * _tmp74 + _tmp66 * _tmp70 + _tmp70 * _tmp90;
  const Scalar _tmp92 = Scalar(1.0) * _tmp75;
  const Scalar _tmp93 = _tmp77 * _tmp92;
  const Scalar _tmp94 = -_tmp73 * _tmp92 + _tmp84 * _tmp93;
  const Scalar _tmp95 = -_tmp45 * _tmp53 + _tmp48 * _tmp52 + _tmp52 * _tmp90 - _tmp76 * _tmp91;
  ...
  const Scalar _tmp102 = _tmp70 * _tmp75;
  ...
  const Scalar _tmp109 = _tmp54 * _tmp92 * _tmp97;
  const Scalar _tmp110 = _tmp103 * _tmp105;
  const Scalar _tmp111 = fh1 * (_tmp106 * _tmp31 - _tmp110 * _tmp20);
  const Scalar _tmp112 = Scalar(333.54000000000002) - fv1;
  const Scalar _tmp113 = _tmp80 * _tmp84 + _tmp83;
  const Scalar _tmp114 = 0;
  const Scalar _tmp115 = _tmp114 * _tmp76;
  const Scalar _tmp116 = _tmp89 * (_tmp114 * _tmp52 - _tmp115 * _tmp70);
  const Scalar _tmp117 = _tmp44 * _tmp75;
  const Scalar _tmp118 = _tmp117 * _tmp77 + _tmp44 * _tmp71;
  const Scalar _tmp119 = _tmp117 * _tmp73 - _tmp118 * _tmp84 - _tmp71;
  const Scalar _tmp120 = _tmp98 * (_tmp117 * _tmp91 - _tmp119 * _tmp96 - _tmp90);
  const Scalar _tmp121 = _tmp86 * (_tmp119 + _tmp120);
  const Scalar _tmp122 = -_tmp121 * _tmp54 - _tmp44;
  const Scalar _tmp123 = _tmp110 * fh1;
  const Scalar _tmp124 = -_tmp107 * _tmp89 * (_tmp100 * _tmp52 + _tmp101 * _tmp102) -
                         _tmp111 * _tmp89 * (_tmp108 * _tmp52 - _tmp109 * _tmp70) -
                         _tmp112 * _tmp116 -
                         _tmp123 * _tmp89 * (_tmp102 * _tmp122 + _tmp121 * _tmp52 + Scalar(1.0));
  const Scalar _tmp125 = Scalar(1.0) / (_tmp124);
  const Scalar _tmp126 = fh1 * (_tmp56 + _tmp61);
  const Scalar _tmp127 = _tmp110 * _tmp126 + Scalar(40.024799999999999) * _tmp27 + _tmp31 * fv1;
  const Scalar _tmp128 = _tmp48 + _tmp81;
  const Scalar _tmp129 = _tmp128 * _tmp84;
  const Scalar _tmp130 = Scalar(1.0) / (-_tmp129 - _tmp45 + _tmp83);
  const Scalar _tmp131 = Scalar(1.0) * _tmp130;
  const Scalar _tmp132 = _tmp128 * _tmp82;
  const Scalar _tmp133 = Scalar(1.0) * _tmp131 * _tmp132 - Scalar(1.0) * _tmp131;
  const Scalar _tmp134 = _tmp113 * _tmp130;
  const Scalar _tmp135 = _tmp82 * (-_tmp114 * _tmp79 - _tmp128 * _tmp134 + _tmp81);
  const Scalar _tmp136 = -Scalar(1.0) * _tmp113 * _tmp131 - Scalar(1.0) * _tmp135 + Scalar(1.0);
  const Scalar _tmp137 = _tmp131 * _tmp98;
  const Scalar _tmp138 = -_tmp108 * _tmp79 + _tmp128 * _tmp137;
  const Scalar _tmp139 = Scalar(1.0) * _tmp82;
  const Scalar _tmp140 = _tmp128 * _tmp130;
  const Scalar _tmp141 = _tmp118 + _tmp120 * _tmp140 - _tmp121 * _tmp79;
  const Scalar _tmp142 = Scalar(1.0) * fh1;
  const Scalar _tmp143 = -_tmp100 * _tmp79 + _tmp140 * _tmp99 - _tmp93;
  const Scalar _tmp144 = -_tmp106 * _tmp126 - Scalar(40.024799999999999) * _tmp16 - _tmp20 * fv1;
  const Scalar _tmp145 = _tmp131 * _tmp84;
  const Scalar _tmp146 = _tmp82 * (_tmp129 * _tmp131 + Scalar(1.0));
  const Scalar _tmp147 = Scalar(1.0) * _tmp145 - Scalar(1.0) * _tmp146;
  const Scalar _tmp148 = _tmp106 * _tmp142 * (_tmp131 * _tmp99 - _tmp139 * _tmp143) +
                         _tmp110 * _tmp142 * (_tmp120 * _tmp131 - _tmp139 * _tmp141) +
                         Scalar(1.0) * _tmp111 * (_tmp137 - _tmp138 * _tmp139) + _tmp112 * _tmp136 +
                         _tmp127 * _tmp133 + _tmp144 * _tmp147;
  const Scalar _tmp149 = std::asinh(_tmp125 * _tmp148);
  const Scalar _tmp150 = Scalar(1.0) * _tmp149;
  const Scalar _tmp151 = Scalar(1.4083112389913199) * _tmp124;
  const Scalar _tmp152 =
      -_tmp149 * _tmp151 - std::sqrt(Scalar(std::pow(Scalar(-_tmp36 + p_b(0, 0)), Scalar(2)) +
  ...
  const Scalar _tmp155 = Scalar(1.4083112389913199) * _tmp116;
  const Scalar _tmp156 = _tmp17 + _tmp40;
  const Scalar _tmp157 = std::pow(_tmp124, Scalar(-2));
  const Scalar _tmp158 = _tmp116 * _tmp157;
  const Scalar _tmp159 =
      (_tmp125 * (_tmp133 * _tmp31 - _tmp136 + _tmp147 * _tmp156) - _tmp148 * _tmp158) /
      std::sqrt(Scalar(std::pow(_tmp148, Scalar(2)) * _tmp157 + 1));
  const Scalar _tmp160 = _tmp127 * _tmp131;
  const Scalar _tmp161 = _tmp107 * _tmp143 * _tmp82 + _tmp111 * _tmp138 * _tmp82 +
                         _tmp112 * _tmp135 + _tmp123 * _tmp141 * _tmp82 - _tmp132 * _tmp160 +
                         _tmp144 * _tmp146;
  const Scalar _tmp162 = _tmp112 * _tmp114;
  const Scalar _tmp163 = _tmp101 * _tmp107 * _tmp75 - _tmp109 * _tmp111 +
  ...
  const Scalar _tmp167 =
      -_tmp165 * _tmp166 - std::sqrt(Scalar(std::pow(Scalar(-_tmp64 + p_c(0, 0)), Scalar(2)) +
  ...
  const Scalar _tmp171 = Scalar(1.4083112389913199) * _tmp114;
  ...
  const Scalar _tmp176 =
      (-_tmp161 * _tmp175 + _tmp164 * (-_tmp132 * _tmp173 - _tmp135 + _tmp146 * _tmp156)) /
      std::sqrt(Scalar(std::pow(_tmp161, Scalar(2)) * _tmp174 + 1));
  const Scalar _tmp177 = -_tmp107 * _tmp130 * _tmp99 - _tmp111 * _tmp137 + _tmp112 * _tmp134 -
                         _tmp120 * _tmp123 * _tmp130 - _tmp144 * _tmp145 + _tmp160;
  const Scalar _tmp178 = _tmp100 * _tmp107 + _tmp108 * _tmp111 + _tmp121 * _tmp123 + _tmp162;
  ...
  const Scalar _tmp183 = _tmp114 * _tmp182;
  const Scalar _tmp184 = (_tmp177 * _tmp183 + _tmp179 * (-_tmp134 - _tmp145 * _tmp156 + _tmp173)) /
  ...
  const Scalar _tmp186 =
      -_tmp180 * _tmp185 - std::sqrt(Scalar(std::pow(Scalar(-_tmp46 + p_a(0, 0)), Scalar(2)) +
