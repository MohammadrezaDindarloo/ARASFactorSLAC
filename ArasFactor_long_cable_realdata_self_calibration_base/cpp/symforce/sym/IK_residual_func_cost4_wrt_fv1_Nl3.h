 ...
 *
 * Symbolic function: IK_residual_func_cost4_wrt_fv1_Nl3
 *
 * Args:
 *     fh1: Scalar
 *     fv1: Scalar
...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost4WrtFv1Nl3(
  ...
  const Scalar _tmp47 = _tmp35 + position_vector(0, 0);
  ...
  const Scalar _tmp53 = _tmp37 + position_vector(0, 0);
  ...
  const Scalar _tmp59 = _tmp48 * _tmp51;
  ...
  const Scalar _tmp69 = _tmp60 * (_tmp52 * _tmp65 - _tmp59 * _tmp68);
  const Scalar _tmp70 = _tmp60 * (-_tmp59 * _tmp65 + _tmp59 * _tmp67);
  const Scalar _tmp71 = _tmp39 * _tmp46 * _tmp69 - Scalar(1.0) * _tmp70;
  const Scalar _tmp72 = -_tmp61;
  const Scalar _tmp73 = _tmp66 + _tmp72;
  const Scalar _tmp74 = _tmp24 + _tmp36;
  const Scalar _tmp75 = _tmp74 + position_vector(0, 0);
  const Scalar _tmp76 = _tmp75 - p_b(0, 0);
  const Scalar _tmp77 = _tmp40 + _tmp8;
  ...
  const Scalar _tmp85 = -_tmp58 * _tmp82 - _tmp69 * _tmp84 + _tmp73 * _tmp83;
  const Scalar _tmp86 = _tmp39 * _tmp45;
  const Scalar _tmp87 = -_tmp70 * _tmp84 - _tmp73 * _tmp81 + _tmp82 - _tmp85 * _tmp86;
  ...
  const Scalar _tmp92 = _tmp91 * (_tmp37 * _tmp57 * _tmp90 - _tmp41 * _tmp54 * _tmp90);
  const Scalar _tmp93 = _tmp60 * (-_tmp35 * _tmp52 + _tmp44 * _tmp59 + _tmp59 * _tmp92);
  const Scalar _tmp94 = -_tmp74 * _tmp83 + _tmp77 * _tmp81 + _tmp81 * _tmp92 - _tmp84 * _tmp93;
  const Scalar _tmp95 = _tmp88 * _tmp94;
  const Scalar _tmp96 = Scalar(1.0) / (_tmp94);
  const Scalar _tmp97 = _tmp87 * _tmp96;
  const Scalar _tmp98 = _tmp97 * (-_tmp71 * _tmp95 - Scalar(1.0) * _tmp93);
  const Scalar _tmp99 = _tmp71 + _tmp98;
  const Scalar _tmp100 = _tmp81 * _tmp88;
  const Scalar _tmp101 = _tmp84 * _tmp88;
  const Scalar _tmp102 = -_tmp101 * _tmp99 + Scalar(1.0);
  const Scalar _tmp103 = _tmp59 * _tmp60;
  const Scalar _tmp104 = _tmp22 - p_a(1, 0);
  ...
  const Scalar _tmp110 = _tmp103 * _tmp84;
  ...
  const Scalar _tmp114 = _tmp38 + _tmp42 * _tmp86;
  const Scalar _tmp115 = 0;
  const Scalar _tmp116 = _tmp91 * (-_tmp110 * _tmp115 + _tmp115 * _tmp81);
  const Scalar _tmp117 = _tmp58 * _tmp69 + _tmp68;
  const Scalar _tmp118 = -_tmp117 * _tmp86 + _tmp58 * _tmp70 - _tmp67;
  const Scalar _tmp119 = _tmp97 * (-_tmp118 * _tmp95 + _tmp58 * _tmp93 - _tmp92);
  ...
  const Scalar _tmp123 = -_tmp108 * _tmp91 * (_tmp100 * _tmp99 + _tmp102 * _tmp103) -
                         _tmp112 * _tmp91 * (-_tmp109 * _tmp110 + _tmp109 * _tmp81) -
                         _tmp113 * _tmp116 -
                         _tmp122 * _tmp91 * (_tmp100 * _tmp120 + _tmp103 * _tmp121 + Scalar(1.0));
  const Scalar _tmp124 = Scalar(1.0) / (_tmp123);
  const Scalar _tmp125 = fh1 * (_tmp64 + _tmp72);
  const Scalar _tmp126 = _tmp111 * _tmp125 + Scalar(40.024799999999999) * _tmp29 + _tmp32 * fv1;
  const Scalar _tmp127 = _tmp43 + _tmp77;
  const Scalar _tmp128 = _tmp127 * _tmp86;
  const Scalar _tmp129 = Scalar(1.0) / (-_tmp128 + _tmp38 - _tmp74);
  const Scalar _tmp130 = Scalar(1.0) * _tmp129;
  const Scalar _tmp131 = _tmp127 * _tmp45;
  const Scalar _tmp132 = Scalar(1.0) * _tmp130 * _tmp131 - Scalar(1.0) * _tmp130;
  const Scalar _tmp133 = _tmp114 * _tmp129;
  const Scalar _tmp134 = _tmp45 * (-_tmp115 * _tmp85 - _tmp127 * _tmp133 + _tmp43);
  const Scalar _tmp135 = -Scalar(1.0) * _tmp114 * _tmp130 - Scalar(1.0) * _tmp134 + Scalar(1.0);
  const Scalar _tmp136 = _tmp127 * _tmp129;
  const Scalar _tmp137 = _tmp85 * _tmp88;
  const Scalar _tmp138 = _tmp136 * _tmp98 - _tmp137 * _tmp99 - Scalar(1.0) * _tmp69;
  const Scalar _tmp139 = _tmp130 * _tmp97;
  const Scalar _tmp140 = -_tmp109 * _tmp85 + _tmp127 * _tmp139;
  const Scalar _tmp141 = -_tmp107 * _tmp125 - Scalar(40.024799999999999) * _tmp14 - _tmp21 * fv1;
  const Scalar _tmp142 = _tmp130 * _tmp86;
  const Scalar _tmp143 = _tmp45 * (_tmp128 * _tmp130 + Scalar(1.0));
  const Scalar _tmp144 = Scalar(1.0) * _tmp142 - Scalar(1.0) * _tmp143;
  const Scalar _tmp145 = _tmp117 + _tmp119 * _tmp136 - _tmp120 * _tmp137;
  const Scalar _tmp146 = Scalar(1.0) * _tmp108 * (_tmp130 * _tmp98 - _tmp138 * _tmp46) +
                         Scalar(1.0) * _tmp112 * (_tmp139 - _tmp140 * _tmp46) + _tmp113 * _tmp135 +
                         Scalar(1.0) * _tmp122 * (_tmp119 * _tmp130 - _tmp145 * _tmp46) +
                         _tmp126 * _tmp132 + _tmp141 * _tmp144;
  const Scalar _tmp147 = std::asinh(_tmp124 * _tmp146);
  const Scalar _tmp148 = Scalar(1.4083112389913199) * _tmp123;
  const Scalar _tmp149 =
      -_tmp147 * _tmp148 - std::sqrt(Scalar(std::pow(Scalar(-_tmp53 + p_c(0, 0)), Scalar(2)) +
  ...
  const Scalar _tmp153 =
      (_tmp124 * (_tmp132 * _tmp32 - _tmp135 + _tmp144 * _tmp152) - _tmp146 * _tmp151) /
      std::sqrt(Scalar(std::pow(_tmp146, Scalar(2)) * _tmp150 + 1));
  const Scalar _tmp154 = Scalar(1.4083112389913199) * _tmp116;
  ...
  const Scalar _tmp159 = _tmp108 * _tmp138 * _tmp45 + _tmp112 * _tmp140 * _tmp45 +
                         _tmp113 * _tmp134 + _tmp122 * _tmp145 * _tmp45 - _tmp131 * _tmp158 +
                         _tmp141 * _tmp143;
  const Scalar _tmp160 = _tmp109 * _tmp112;
  const Scalar _tmp161 = _tmp60 * _tmp84;
  const Scalar _tmp162 = _tmp113 * _tmp115;
  const Scalar _tmp163 = _tmp102 * _tmp108 * _tmp60 + _tmp121 * _tmp122 * _tmp60 -
  ...
  const Scalar _tmp167 = Scalar(1.4083112389913199) * _tmp163;
  const Scalar _tmp168 =
      -_tmp165 * _tmp167 - std::sqrt(Scalar(std::pow(Scalar(-_tmp47 + p_d(0, 0)), Scalar(2)) +
                                            std::pow(Scalar(-_tmp49 + p_d(1, 0)), Scalar(2))));
  const Scalar _tmp169 = Scalar(0.71007031138673404) * _tmp164;
  const Scalar _tmp170 = _tmp168 * _tmp169;
  const Scalar _tmp171 = Scalar(1.4083112389913199) * _tmp115;
  const Scalar _tmp172 = _tmp161 * _tmp171;
  const Scalar _tmp173 = std::pow(_tmp163, Scalar(-2));
  const Scalar _tmp174 = _tmp130 * _tmp32;
  const Scalar _tmp175 = _tmp115 * _tmp161 * _tmp173;
  const Scalar _tmp176 =
      (-_tmp159 * _tmp175 + _tmp164 * (-_tmp131 * _tmp174 - _tmp134 + _tmp143 * _tmp152)) /
      std::sqrt(Scalar(std::pow(_tmp159, Scalar(2)) * _tmp173 + 1));
  const Scalar _tmp177 = -_tmp108 * _tmp129 * _tmp98 - _tmp112 * _tmp139 + _tmp113 * _tmp133 -
                         _tmp119 * _tmp122 * _tmp129 - _tmp141 * _tmp142 + _tmp158;
  const Scalar _tmp178 = _tmp108 * _tmp88 * _tmp99 + _tmp120 * _tmp122 * _tmp88 + _tmp160 + _tmp162;
  ...
  const Scalar _tmp182 =
      -_tmp180 * _tmp181 - std::sqrt(Scalar(std::pow(Scalar(-_tmp75 + p_b(0, 0)), Scalar(2)) +
  ...
  const Scalar _tmp188 = (_tmp177 * _tmp187 + _tmp179 * (-_tmp133 - _tmp142 * _tmp152 + _tmp174)) /
  ...
  _res(1, 0) = _tmp148 * (-Scalar(1.0) * _tmp153 * std::cosh(_tmp157) -
                          (-Scalar(0.71007031138673404) * _tmp149 * _tmp151 +
                           _tmp155 * (-_tmp147 * _tmp154 - _tmp148 * _tmp153)) *
                              std::cosh(_tmp156)) +
               _tmp154 * (-std::sinh(_tmp156) - std::sinh(_tmp157));
