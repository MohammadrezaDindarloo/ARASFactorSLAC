...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl0(
  ...
  const Scalar _tmp50 = _tmp49 * (_tmp40 * _tmp45 * _tmp47 - _tmp42 * _tmp43 * _tmp47);
  ...
  const Scalar _tmp57 = _tmp13 + _tmp18;
  ...
  const Scalar _tmp64 = -_tmp52 * _tmp62 + _tmp62 * _tmp63;
  const Scalar _tmp65 = _tmp45 * _tmp48;
  ...
  const Scalar _tmp70 = _tmp52 * _tmp66 - _tmp62 * _tmp69;
  ...
  const Scalar _tmp78 = _tmp35 + _tmp51;
  const Scalar _tmp79 = _tmp24 + _tmp53;
  const Scalar _tmp80 = _tmp79 + position_vector(0, 0);
  const Scalar _tmp81 = _tmp80 - p_d(0, 0);
  const Scalar _tmp82 = _tmp10 + _tmp57;
  ...
  const Scalar _tmp93 = _tmp50 * _tmp62 - _tmp54 * _tmp66 + _tmp58 * _tmp62;
  const Scalar _tmp94 = _tmp50 * _tmp86 - _tmp79 * _tmp87 + _tmp82 * _tmp86 - _tmp89 * _tmp93;
  const Scalar _tmp95 = _tmp92 * _tmp94;
  const Scalar _tmp96 = Scalar(1.0) / (_tmp94);
  const Scalar _tmp97 = _tmp91 * _tmp96;
  const Scalar _tmp98 = _tmp97 * (-_tmp50 + _tmp68 * _tmp93 - _tmp77 * _tmp95);
  ...
  const Scalar _tmp104 = _tmp32 - p_a(0, 0);
  const Scalar _tmp105 = _tmp21 - p_a(1, 0);
  ...
  const Scalar _tmp113 = _tmp62 * _tmp89;
  const Scalar _tmp114 = Scalar(1.0) * _tmp67;
  const Scalar _tmp115 = _tmp114 * _tmp70;
  const Scalar _tmp116 = -_tmp114 * _tmp64 + _tmp115 * _tmp76;
  ...
  const Scalar _tmp123 = fh1 * (-_tmp107 * _tmp20 + _tmp120 * _tmp31);
  const Scalar _tmp124 = -_tmp108 * _tmp49 * (_tmp101 * _tmp102 + _tmp103 * _tmp99 + Scalar(1.0)) -
                         _tmp109 * _tmp49 * (-_tmp112 * _tmp113 + _tmp112 * _tmp86) -
                         _tmp121 * _tmp49 * (_tmp102 * _tmp119 + _tmp103 * _tmp118) -
                         _tmp123 * _tmp49 * (-_tmp113 * _tmp122 + _tmp122 * _tmp86);
  const Scalar _tmp125 = Scalar(1.0) / (_tmp124);
  const Scalar _tmp126 = _tmp39 * fh1;
  const Scalar _tmp127 = _tmp107 * _tmp126 + Scalar(40.024799999999999) * _tmp27 + _tmp31 * fv1;
  const Scalar _tmp128 = _tmp73 + _tmp82;
  const Scalar _tmp129 = _tmp128 * _tmp76;
  const Scalar _tmp130 = Scalar(1.0) / (-_tmp129 + _tmp75 - _tmp79);
  const Scalar _tmp131 = Scalar(1.0) * _tmp130;
  const Scalar _tmp132 = _tmp128 * _tmp74;
  const Scalar _tmp133 = _tmp90 * _tmp92;
  const Scalar _tmp134 = _tmp110 * _tmp130;
  const Scalar _tmp135 = -_tmp111 * _tmp133 - _tmp128 * _tmp134 + _tmp73;
  const Scalar _tmp136 = Scalar(1.0) * _tmp74;
  const Scalar _tmp137 = -_tmp120 * _tmp126 - Scalar(40.024799999999999) * _tmp17 - _tmp20 * fv1;
  const Scalar _tmp138 = _tmp129 * _tmp131 + Scalar(1.0);
  const Scalar _tmp139 = _tmp131 * _tmp76;
  const Scalar _tmp140 = _tmp131 * _tmp97;
  const Scalar _tmp141 = -_tmp122 * _tmp90 + _tmp128 * _tmp140;
  const Scalar _tmp142 = _tmp128 * _tmp130;
  const Scalar _tmp143 = -_tmp115 + _tmp117 * _tmp142 - _tmp118 * _tmp133;
  const Scalar _tmp144 = -_tmp133 * _tmp99 + _tmp142 * _tmp98 + _tmp71;
  const Scalar _tmp145 = std::asinh(
      _tmp125 * (Scalar(1.0) * _tmp108 * (_tmp131 * _tmp98 - _tmp136 * _tmp144) +
                 Scalar(1.0) * _tmp109 * (-_tmp110 * _tmp131 - _tmp135 * _tmp136 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp121 * (_tmp117 * _tmp131 - _tmp136 * _tmp143) +
                 Scalar(1.0) * _tmp123 * (-_tmp136 * _tmp141 + _tmp140) +
                 Scalar(1.0) * _tmp127 * (_tmp131 * _tmp132 - _tmp131) +
                 Scalar(1.0) * _tmp137 * (-_tmp136 * _tmp138 + _tmp139)));
  const Scalar _tmp146 = Scalar(1.4083112389913199) * _tmp124;
  const Scalar _tmp147 = Scalar(0.71007031138673404) * _tmp125;
  const Scalar _tmp148 = _tmp109 * _tmp112;
  const Scalar _tmp149 = _tmp122 * _tmp123;
  const Scalar _tmp150 =
      _tmp101 * _tmp108 * _tmp67 + _tmp119 * _tmp121 * _tmp67 - _tmp148 * _tmp89 - _tmp149 * _tmp89;
  const Scalar _tmp151 = Scalar(1.0) / (_tmp150);
  const Scalar _tmp152 = _tmp127 * _tmp131;
  const Scalar _tmp153 =
      std::asinh(_tmp151 * (_tmp108 * _tmp144 * _tmp74 + _tmp109 * _tmp135 * _tmp74 +
                            _tmp121 * _tmp143 * _tmp74 + _tmp123 * _tmp141 * _tmp74 -
                            _tmp132 * _tmp152 + _tmp137 * _tmp138 * _tmp74));
  const Scalar _tmp154 = Scalar(1.4083112389913199) * _tmp150;
  const Scalar _tmp155 = Scalar(0.71007031138673404) * _tmp151;
  const Scalar _tmp156 = _tmp108 * _tmp92 * _tmp99 + _tmp118 * _tmp121 * _tmp92 + _tmp148 + _tmp149;
  const Scalar _tmp157 = Scalar(1.0) / (_tmp156);
  const Scalar _tmp158 = std::asinh(_tmp157 * (-_tmp108 * _tmp130 * _tmp98 + _tmp109 * _tmp134 -
                                               _tmp117 * _tmp121 * _tmp130 - _tmp123 * _tmp140 -
                                               _tmp137 * _tmp139 + _tmp152));
