...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl20(
  ...
  const Scalar _tmp33 = Scalar(0.20999999999999999) * _tmp15 + Scalar(0.20999999999999999) * _tmp16;
  const Scalar _tmp34 =
  ...
  const Scalar _tmp58 = _tmp44 + _tmp9;
  ...
  const Scalar _tmp64 = _tmp63 * (-_tmp39 * _tmp49 + _tmp52);
  const Scalar _tmp65 = Scalar(1.0) * _tmp54;
  const Scalar _tmp66 = -_tmp41 + _tmp65;
  const Scalar _tmp67 = Scalar(1.0) * _tmp58;
  const Scalar _tmp68 = -_tmp67;
  const Scalar _tmp69 = Scalar(1.0) / (_tmp45 + _tmp68);
  const Scalar _tmp70 = Scalar(1.0) * _tmp69;
  const Scalar _tmp71 = _tmp63 * (_tmp39 * _tmp62 - _tmp52 * _tmp61);
  const Scalar _tmp72 = -Scalar(1.0) * _tmp64 + _tmp66 * _tmp70 * _tmp71;
  const Scalar _tmp73 = _tmp22 + _tmp53;
  const Scalar _tmp74 = _tmp73 + position_vector(0, 0);
  const Scalar _tmp75 = _tmp74 - p_c(0, 0);
  const Scalar _tmp76 = _tmp19 + _tmp9;
  ...
  const Scalar _tmp83 = _tmp51 * _tmp80;
  const Scalar _tmp84 = _tmp33 + _tmp50;
  const Scalar _tmp85 = -_tmp61 * _tmp83 - _tmp71 * _tmp82 + _tmp81 * _tmp84;
  const Scalar _tmp86 = _tmp66 * _tmp69;
  const Scalar _tmp87 = -_tmp64 * _tmp82 - _tmp80 * _tmp84 + _tmp83 - _tmp85 * _tmp86;
  ...
  const Scalar _tmp93 = _tmp63 * (-_tmp41 * _tmp62 + _tmp45 * _tmp49 + _tmp49 * _tmp92);
  const Scalar _tmp94 = -_tmp73 * _tmp81 + _tmp76 * _tmp80 + _tmp80 * _tmp92 - _tmp82 * _tmp93;
  ...
  const Scalar _tmp100 = _tmp80 * _tmp88;
  const Scalar _tmp101 = _tmp82 * _tmp88;
  ...
  const Scalar _tmp109 = _tmp51 * _tmp61 + _tmp61 * _tmp71;
  const Scalar _tmp110 = -_tmp109 * _tmp86 - _tmp51 + _tmp61 * _tmp64;
  const Scalar _tmp111 = _tmp97 * (-_tmp110 * _tmp95 + _tmp61 * _tmp93 - _tmp92);
  const Scalar _tmp112 = _tmp110 + _tmp111;
  const Scalar _tmp113 = -_tmp101 * _tmp112 - _tmp61;
  const Scalar _tmp114 = _tmp104 * _tmp106;
  const Scalar _tmp115 = _tmp114 * fh1;
  const Scalar _tmp116 = Scalar(1.0) * _tmp96;
  const Scalar _tmp117 = fh1 * (_tmp107 * _tmp30 - _tmp114 * _tmp20);
  const Scalar _tmp118 = Scalar(333.54000000000002) - fv1;
  const Scalar _tmp119 = _tmp65 + _tmp67 * _tmp86;
  ...
  const Scalar _tmp123 = -_tmp108 * _tmp91 * (_tmp100 * _tmp99 + _tmp102 * _tmp103) -
                         _tmp115 * _tmp91 * (_tmp100 * _tmp112 + _tmp103 * _tmp113 + Scalar(1.0)) -
                         _tmp117 * _tmp91 * (-_tmp103 * _tmp116 * _tmp82 + _tmp116 * _tmp80) -
                         _tmp118 * _tmp91 * (-_tmp103 * _tmp121 + _tmp122 * _tmp80);
  const Scalar _tmp124 = Scalar(1.0) / (_tmp123);
  const Scalar _tmp125 = Scalar(0.71007031138673404) * _tmp124;
  const Scalar _tmp126 = _tmp68 + _tmp76;
  const Scalar _tmp127 = _tmp126 * _tmp86;
  const Scalar _tmp128 = Scalar(1.0) / (-_tmp127 + _tmp65 - _tmp73);
  const Scalar _tmp129 = Scalar(1.0) * _tmp128;
  const Scalar _tmp130 = _tmp85 * _tmp88;
  const Scalar _tmp131 = _tmp126 * _tmp128;
  const Scalar _tmp132 = -_tmp130 * _tmp99 + _tmp131 * _tmp98 - Scalar(1.0) * _tmp71;
  const Scalar _tmp133 = _tmp126 * _tmp69;
  const Scalar _tmp134 = _tmp37 * fh1;
  const Scalar _tmp135 = _tmp114 * _tmp134 + Scalar(40.024799999999999) * _tmp25 + _tmp30 * fv1;
  const Scalar _tmp136 = _tmp109 + _tmp111 * _tmp131 - _tmp112 * _tmp130;
  const Scalar _tmp137 = -_tmp107 * _tmp134 - Scalar(40.024799999999999) * _tmp17 - _tmp20 * fv1;
  const Scalar _tmp138 = _tmp127 * _tmp129 + Scalar(1.0);
  const Scalar _tmp139 = _tmp119 * _tmp128;
  const Scalar _tmp140 = -_tmp120 * _tmp130 - _tmp126 * _tmp139 + _tmp68;
  const Scalar _tmp141 = _tmp129 * _tmp97;
  const Scalar _tmp142 = -_tmp116 * _tmp85 + _tmp126 * _tmp141;
  const Scalar _tmp143 = std::asinh(
      _tmp124 * (Scalar(1.0) * _tmp108 * (_tmp129 * _tmp98 - _tmp132 * _tmp70) +
                 Scalar(1.0) * _tmp115 * (_tmp111 * _tmp129 - _tmp136 * _tmp70) +
                 Scalar(1.0) * _tmp117 * (_tmp141 - _tmp142 * _tmp70) +
                 Scalar(1.0) * _tmp118 * (-_tmp119 * _tmp129 - _tmp140 * _tmp70 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp135 * (_tmp129 * _tmp133 - _tmp129) +
                 Scalar(1.0) * _tmp137 * (_tmp129 * _tmp86 - _tmp138 * _tmp70)));
  const Scalar _tmp144 = Scalar(1.4083112389913199) * _tmp123;
  const Scalar _tmp145 = _tmp129 * _tmp135;
  const Scalar _tmp146 = _tmp69 * fh1;
  const Scalar _tmp147 = _tmp137 * _tmp69;
  const Scalar _tmp148 = _tmp116 * _tmp117;
  const Scalar _tmp149 = _tmp102 * _tmp108 * _tmp63 + _tmp113 * _tmp115 * _tmp63 -
                         _tmp118 * _tmp121 * _tmp63 - _tmp148 * _tmp63 * _tmp82;
  const Scalar _tmp150 = Scalar(1.0) / (_tmp149);
  const Scalar _tmp151 =
      std::asinh(_tmp150 * (_tmp107 * _tmp132 * _tmp146 + _tmp114 * _tmp136 * _tmp146 +
                            _tmp117 * _tmp142 * _tmp69 + _tmp118 * _tmp140 * _tmp69 -
                            _tmp133 * _tmp145 + _tmp138 * _tmp147));
  const Scalar _tmp152 = Scalar(0.71007031138673404) * _tmp150;
  const Scalar _tmp153 = Scalar(1.4083112389913199) * _tmp149;
  const Scalar _tmp154 = _tmp88 * fh1;
  const Scalar _tmp155 =
      _tmp107 * _tmp154 * _tmp99 + _tmp112 * _tmp114 * _tmp154 + _tmp118 * _tmp122 + _tmp148;
  const Scalar _tmp156 = Scalar(1.0) / (_tmp155);
  const Scalar _tmp157 = std::asinh(
      _tmp156 * (-_tmp108 * _tmp128 * _tmp98 - _tmp111 * _tmp115 * _tmp128 - _tmp117 * _tmp141 +
                 _tmp118 * _tmp139 - _tmp129 * _tmp147 * _tmp66 + _tmp145));
  const Scalar _tmp158 = Scalar(0.71007031138673404) * _tmp156;
  ...
  _res(2, 0) =
      -_tmp153 *
          (_tmp152 * p_a(2, 0) + std::cosh(Scalar(1.0) * _tmp151) -
           std::cosh(_tmp152 *
                     (-_tmp151 * _tmp153 -
