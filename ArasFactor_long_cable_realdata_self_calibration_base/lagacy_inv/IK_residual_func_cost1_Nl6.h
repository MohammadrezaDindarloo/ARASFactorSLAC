...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl6(
  ...
  const Scalar _tmp34 = -Scalar(0.010999999999999999) * _tmp11 -
  ...
  const Scalar _tmp63 = _tmp32 + _tmp60;
  const Scalar _tmp64 = _tmp32 + _tmp36;
  const Scalar _tmp65 = _tmp10 + _tmp52;
  const Scalar _tmp66 = _tmp65 + position_vector(1, 0);
  const Scalar _tmp67 = _tmp66 - p_c(1, 0);
  const Scalar _tmp68 = _tmp22 + _tmp48;
  ...
  const Scalar _tmp74 = _tmp47 * _tmp61;
  ...
  const Scalar _tmp78 = -_tmp47 * _tmp62 + _tmp57 * _tmp63 - _tmp75 * _tmp77;
  ...
  const Scalar _tmp83 = _tmp82 * (-_tmp68 + _tmp79);
  const Scalar _tmp84 = _tmp61 * _tmp73 - _tmp64 * _tmp73;
  const Scalar _tmp85 = -_tmp58 * _tmp63 + _tmp62 - _tmp77 * _tmp84 - _tmp78 * _tmp83;
  ...
  const Scalar _tmp91 = _tmp47 * _tmp76;
  const Scalar _tmp92 = _tmp74 + _tmp75 * _tmp91;
  const Scalar _tmp93 = -_tmp61 - _tmp83 * _tmp92 + _tmp84 * _tmp91;
  const Scalar _tmp94 = _tmp65 * _tmp73 - _tmp68 * _tmp72 + _tmp73 * _tmp90;
  const Scalar _tmp95 = -_tmp49 * _tmp57 + _tmp53 * _tmp58 + _tmp58 * _tmp90 - _tmp77 * _tmp94;
  ...
  const Scalar _tmp101 = -_tmp100 * _tmp59 - _tmp47;
  const Scalar _tmp102 = _tmp73 * _tmp76;
  const Scalar _tmp103 = _tmp30 - p_b(0, 0);
  const Scalar _tmp104 = _tmp20 - p_b(1, 0);
  ...
  const Scalar _tmp113 = -_tmp112 * _tmp59 + Scalar(1.0);
  const Scalar _tmp114 = _tmp104 * _tmp105;
  const Scalar _tmp115 = _tmp114 * fh1;
  const Scalar _tmp116 = Scalar(333.54000000000002) - fv1;
  const Scalar _tmp117 = _tmp79 + _tmp80 * _tmp83;
  const Scalar _tmp118 = 0;
  const Scalar _tmp119 = Scalar(1.0) * _tmp97;
  const Scalar _tmp120 = _tmp108 * _tmp59 * _tmp97;
  const Scalar _tmp121 = fh1 * (-_tmp106 * _tmp19 + _tmp114 * _tmp29);
  const Scalar _tmp122 = -_tmp107 * _tmp89 * (_tmp100 * _tmp58 + _tmp101 * _tmp102 + Scalar(1.0)) -
                         _tmp115 * _tmp89 * (_tmp102 * _tmp113 + _tmp112 * _tmp58) -
                         _tmp116 * _tmp89 * (_tmp118 * _tmp58 - _tmp118 * _tmp73 * _tmp77) -
                         _tmp121 * _tmp89 * (_tmp119 * _tmp58 - _tmp120 * _tmp73);
  const Scalar _tmp123 = Scalar(1.0) / (_tmp122);
  const Scalar _tmp124 = _tmp53 + _tmp81;
  const Scalar _tmp125 = _tmp124 * _tmp83;
  const Scalar _tmp126 = Scalar(1.0) / (-_tmp125 - _tmp49 + _tmp79);
  const Scalar _tmp127 = _tmp117 * _tmp126;
  const Scalar _tmp128 = -_tmp118 * _tmp78 - _tmp124 * _tmp127 + _tmp81;
  const Scalar _tmp129 = Scalar(1.0) * _tmp82;
  const Scalar _tmp130 = Scalar(1.0) * _tmp126;
  const Scalar _tmp131 = _tmp124 * _tmp126;
  const Scalar _tmp132 = -_tmp100 * _tmp78 + _tmp131 * _tmp99 + _tmp92;
  const Scalar _tmp133 = _tmp124 * _tmp82;
  const Scalar _tmp134 = _tmp37 * fh1;
  const Scalar _tmp135 = _tmp106 * _tmp134 + Scalar(40.024799999999999) * _tmp25 + _tmp29 * fv1;
  const Scalar _tmp136 = _tmp130 * _tmp98;
  const Scalar _tmp137 = -_tmp119 * _tmp78 + _tmp124 * _tmp136;
  const Scalar _tmp138 = -_tmp109 + _tmp111 * _tmp131 - _tmp112 * _tmp78;
  const Scalar _tmp139 = -_tmp114 * _tmp134 - Scalar(40.024799999999999) * _tmp16 - _tmp19 * fv1;
  const Scalar _tmp140 = _tmp125 * _tmp130 + Scalar(1.0);
  const Scalar _tmp141 = _tmp130 * _tmp83;
  const Scalar _tmp142 = std::asinh(
      _tmp123 * (Scalar(1.0) * _tmp107 * (-_tmp129 * _tmp132 + _tmp130 * _tmp99) +
                 Scalar(1.0) * _tmp115 * (_tmp111 * _tmp130 - _tmp129 * _tmp138) +
                 Scalar(1.0) * _tmp116 * (-_tmp117 * _tmp130 - _tmp128 * _tmp129 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp121 * (-_tmp129 * _tmp137 + _tmp136) +
                 Scalar(1.0) * _tmp135 * (_tmp130 * _tmp133 - _tmp130) +
                 Scalar(1.0) * _tmp139 * (-_tmp129 * _tmp140 + _tmp141)));
  const Scalar _tmp143 = Scalar(0.71007031138673404) * _tmp123;
  const Scalar _tmp144 = Scalar(1.4083112389913199) * _tmp122;
  const Scalar _tmp145 = _tmp130 * _tmp135;
  const Scalar _tmp146 = _tmp116 * _tmp118;
  const Scalar _tmp147 = _tmp101 * _tmp107 * _tmp76 + _tmp113 * _tmp115 * _tmp76 -
                         _tmp120 * _tmp121 - _tmp146 * _tmp77;
  const Scalar _tmp148 = Scalar(1.0) / (_tmp147);
  const Scalar _tmp149 =
      std::asinh(_tmp148 * (_tmp107 * _tmp132 * _tmp82 + _tmp115 * _tmp138 * _tmp82 +
                            _tmp116 * _tmp128 * _tmp82 + _tmp121 * _tmp137 * _tmp82 -
                            _tmp133 * _tmp145 + _tmp139 * _tmp140 * _tmp82));
  const Scalar _tmp150 = Scalar(1.4083112389913199) * _tmp147;
  const Scalar _tmp151 = Scalar(0.71007031138673404) * _tmp148;
  const Scalar _tmp152 = _tmp100 * _tmp107 + _tmp112 * _tmp115 + _tmp119 * _tmp121 + _tmp146;
  const Scalar _tmp153 = Scalar(1.0) / (_tmp152);
  const Scalar _tmp154 =
      std::asinh(_tmp153 * (-_tmp107 * _tmp126 * _tmp99 - _tmp111 * _tmp115 * _tmp126 +
                            _tmp116 * _tmp127 - _tmp121 * _tmp136 - _tmp139 * _tmp141 + _tmp145));
  const Scalar _tmp155 = Scalar(1.4083112389913199) * _tmp152;
  const Scalar _tmp156 = Scalar(0.71007031138673404) * _tmp153;
  ...
  _res(2, 0) =
      -_tmp150 *
          (_tmp151 * p_c(2, 0) + std::cosh(Scalar(1.0) * _tmp149) -
           std::cosh(_tmp151 *
                     (-_tmp149 * _tmp150 -
  ...
  _res(3, 0) =
      -_tmp155 *
          (_tmp156 * p_d(2, 0) + std::cosh(Scalar(1.0) * _tmp154) -
           std::cosh(_tmp156 *
                     (-_tmp154 * _tmp155 -
                      std::sqrt(Scalar(std::pow(Scalar(-_tmp50 + p_d(0, 0)), Scalar(2)) +
