...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1WrtFv1Nl2(
  ...
  const Scalar _tmp47 = _tmp14 + _tmp19;
  ...
  const Scalar _tmp59 = _tmp47 + _tmp8;
  ...
  const Scalar _tmp71 = -_tmp36 * _tmp66 + _tmp39 * _tmp43 + _tmp43 * _tmp55 - _tmp65 * _tmp70;
  ...
  const Scalar _tmp85 = Scalar(0.20999999999999999) * _tmp15 + Scalar(0.20999999999999999) * _tmp16;
  ...
  const Scalar _tmp96 = -_tmp43 * _tmp94 + _tmp66 * _tmp89 - _tmp70 * _tmp95;
  ...
  const Scalar _tmp102 = -_tmp101 * _tmp96 + _tmp43 * _tmp87 - _tmp43 * _tmp89 - _tmp70 * _tmp93;
  ...
  const Scalar _tmp110 = _tmp54 * (_tmp106 * _tmp43 - _tmp107 * _tmp109);
  ...
  const Scalar _tmp119 = _tmp103 * _tmp43;
  ...
  const Scalar _tmp127 = -_tmp110 * _tmp82 -
                         ...
                         _tmp54 * _tmp81 * (_tmp43 * _tmp73 - _tmp64 * _tmp75);
  const Scalar _tmp128 = Scalar(1.0) / (_tmp127);
  const Scalar _tmp129 = fh1 * (_tmp88 + _tmp90);
  const Scalar _tmp130 = _tmp129 * _tmp79 + Scalar(40.024799999999999) * _tmp28 + _tmp32 * fv1;
  const Scalar _tmp131 = _tmp39 + _tmp98;
  const Scalar _tmp132 = _tmp101 * _tmp131;
  const Scalar _tmp133 = Scalar(1.0) / (_tmp100 - _tmp132 - _tmp36);
  ...
  const Scalar _tmp144 = -_tmp129 * _tmp80 - Scalar(40.024799999999999) * _tmp17 - _tmp21 * fv1;
  ...
  const Scalar _tmp154 = Scalar(0.71007031138673404) * _tmp128;
  const Scalar _tmp155 = Scalar(1.4083112389913199) * _tmp127;
  const Scalar _tmp156 =
      -_tmp152 * _tmp155 - std::sqrt(Scalar(std::pow(Scalar(-_tmp45 + p_c(0, 0)), Scalar(2)) +
  ...
  const Scalar _tmp162 = _tmp14 + _tmp18 + _tmp7;
  const Scalar _tmp163 =
      (_tmp128 * (_tmp136 * _tmp32 - _tmp140 + _tmp147 * _tmp162) - _tmp151 * _tmp160) /
      std::sqrt(Scalar(std::pow(_tmp151, Scalar(2)) * _tmp159 + 1));
  const Scalar _tmp164 = _tmp109 * _tmp69;
  const Scalar _tmp165 =
      _tmp118 * _tmp120 * _tmp69 + _tmp125 * _tmp126 * _tmp69 - _tmp164 * _tmp82 - _tmp75 * _tmp81;
  const Scalar _tmp166 = Scalar(1.0) / (_tmp165);
  const Scalar _tmp167 = _tmp130 * _tmp134;
  const Scalar _tmp168 = _tmp120 * _tmp148 * _tmp99 + _tmp126 * _tmp142 * _tmp99 -
                         _tmp135 * _tmp167 + _tmp139 * _tmp82 + _tmp144 * _tmp146 +
  ...
  const Scalar _tmp173 =
      -_tmp169 * _tmp172 - std::sqrt(Scalar(std::pow(Scalar(-_tmp57 + p_b(0, 0)), Scalar(2)) +
  ...
  const Scalar _tmp179 =
      (_tmp166 * (-_tmp135 * _tmp176 - _tmp139 + _tmp146 * _tmp162) - _tmp168 * _tmp178) /
      std::sqrt(Scalar(std::pow(_tmp168, Scalar(2)) * _tmp177 + 1));
  const Scalar _tmp180 = Scalar(0.71007031138673404) * _tmp178;
  const Scalar _tmp181 = _tmp103 * _tmp117 * _tmp120 + _tmp103 * _tmp124 * _tmp126 +
  ...
  const Scalar _tmp184 = -_tmp116 * _tmp120 * _tmp133 - _tmp123 * _tmp126 * _tmp133 +
                         _tmp138 * _tmp82 - _tmp144 * _tmp145 - _tmp149 * _tmp81 + _tmp167;
  const Scalar _tmp185 = std::asinh(_tmp182 * _tmp184);
  const Scalar _tmp186 = Scalar(1.4083112389913199) * _tmp181;
  const Scalar _tmp187 =
      -_tmp185 * _tmp186 - std::sqrt(Scalar(std::pow(Scalar(-_tmp37 + p_d(0, 0)), Scalar(2)) +
                                            std::pow(Scalar(-_tmp40 + p_d(1, 0)), Scalar(2))));
  const Scalar _tmp188 = _tmp183 * _tmp187;
  const Scalar _tmp189 = Scalar(1.0) * _tmp185;
  const Scalar _tmp190 = Scalar(1.4083112389913199) * _tmp106;
  ...
  const Scalar _tmp194 = (_tmp182 * (-_tmp138 - _tmp145 * _tmp162 + _tmp176) + _tmp184 * _tmp192) /
  ...
  _res(1, 0) =
      -_tmp155 * (-_tmp161 * p_c(2, 0) + Scalar(1.0) * _tmp163 * std::sinh(_tmp153) -
                  (_tmp154 * (-_tmp152 * _tmp158 - _tmp155 * _tmp163) - _tmp156 * _tmp161) *
                      std::sinh(_tmp157)) -
      _tmp158 * (_tmp154 * p_c(2, 0) + std::cosh(_tmp153) - std::cosh(_tmp157));
  _res(2, 0) =
      -_tmp172 * (Scalar(1.0) * _tmp179 * std::sinh(_tmp170) - _tmp180 * p_b(2, 0) -
                  (_tmp171 * (-_tmp169 * _tmp175 - _tmp172 * _tmp179) - _tmp173 * _tmp180) *
                      std::sinh(_tmp174)) -
      _tmp175 * (_tmp171 * p_b(2, 0) + std::cosh(_tmp170) - std::cosh(_tmp174));
  _res(3, 0) = -_tmp186 * (_tmp193 * p_d(2, 0) + Scalar(1.0) * _tmp194 * std::sinh(_tmp189) -
                           (_tmp183 * (_tmp185 * _tmp190 - _tmp186 * _tmp194) + _tmp187 * _tmp193) *
                               std::sinh(_tmp188)) +
               _tmp190 * (_tmp183 * p_d(2, 0) - std::cosh(_tmp188) + std::cosh(_tmp189));
