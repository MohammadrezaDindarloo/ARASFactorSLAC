...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl14(
  ...
  const Scalar _tmp41 = _tmp27 + _tmp31;
  ...
  const Scalar _tmp46 = _tmp45 * (-_tmp16 * _tmp35 + _tmp37);
  const Scalar _tmp47 = Scalar(1.0) * _tmp41;
  const Scalar _tmp48 = Scalar(1.0) * _tmp38;
  const Scalar _tmp49 = (-_tmp25 + _tmp48) / (_tmp32 - _tmp47);
  const Scalar _tmp50 = _tmp16 * _tmp44 - _tmp37 * _tmp43;
  ...
  const Scalar _tmp63 = _tmp36 * _tmp43;
  const Scalar _tmp64 = _tmp43 * _tmp61 - _tmp62;
  const Scalar _tmp65 = _tmp45 * _tmp64;
  const Scalar _tmp66 = _tmp36 * _tmp61 - _tmp46 * _tmp64 -
                        _tmp49 * (-_tmp50 * _tmp65 + _tmp53 * _tmp62 - _tmp61 * _tmp63) -
                        _tmp53 * _tmp61;
  ...
  const Scalar _tmp71 = _tmp70 * (_tmp38 * _tmp42 * _tmp69 - _tmp39 * _tmp41 * _tmp69);
  const Scalar _tmp72 = -_tmp25 * _tmp44 + _tmp32 * _tmp35 + _tmp35 * _tmp71;
  const Scalar _tmp73 = -_tmp55 * _tmp62 + _tmp58 * _tmp61 + _tmp61 * _tmp71 - _tmp65 * _tmp72;
  const Scalar _tmp74 = _tmp67 * _tmp73;
  const Scalar _tmp75 = _tmp45 * _tmp72;
  ...
  const Scalar _tmp81 = _tmp35 * _tmp45;
  const Scalar _tmp82 = _tmp61 * _tmp67;
  const Scalar _tmp83 = _tmp27 + _tmp57;
  ...
  const Scalar _tmp94 = -_tmp36 + _tmp43 * _tmp46 - _tmp49 * (_tmp43 * _tmp51 + _tmp63);
  const Scalar _tmp95 = _tmp77 * (_tmp43 * _tmp75 - _tmp71 - _tmp74 * _tmp94) + _tmp94;
  const Scalar _tmp96 = -_tmp43 - _tmp79 * _tmp95;
  const Scalar _tmp97 = _tmp86 * _tmp87;
  const Scalar _tmp98 = _tmp97 * fh1;
  const Scalar _tmp99 = Scalar(1.0) * _tmp76;
  const Scalar _tmp100 = fh1 * (-_tmp83 * _tmp97 + _tmp85 * _tmp88);
  ...
  _res(1, 0) = std::exp(_tmp100 * _tmp70 * (_tmp61 * _tmp99 - _tmp93 * _tmp99) +
                        _tmp70 * _tmp89 * (_tmp78 * _tmp82 + _tmp80 * _tmp81) +
                        _tmp70 * _tmp90 * (_tmp61 * _tmp92 - _tmp92 * _tmp93) +
                        _tmp70 * _tmp98 * (_tmp81 * _tmp96 + _tmp82 * _tmp95 + Scalar(1.0)));
  _res(2, 0) = std::exp(_tmp101 * _tmp65 + _tmp102 * _tmp65 - _tmp45 * _tmp80 * _tmp89 -
                        _tmp45 * _tmp96 * _tmp98);
  _res(3, 0) = std::exp(-_tmp101 - _tmp102 - _tmp67 * _tmp78 * _tmp89 - _tmp67 * _tmp95 * _tmp98);
