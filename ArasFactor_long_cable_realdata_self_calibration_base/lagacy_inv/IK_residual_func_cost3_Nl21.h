...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl21(
  ...
  const Scalar _tmp25 = _tmp15 - p_c(1, 0) + position_vector(1, 0);
  ...
  const Scalar _tmp29 = _tmp20 - _tmp21;
  ...
  const Scalar _tmp40 = _tmp15 * _tmp27 - _tmp23 * _tmp28 + _tmp27 * _tmp39;
  const Scalar _tmp41 = _tmp34 * _tmp37;
  const Scalar _tmp42 = Scalar(1.0) / (_tmp27 * _tmp41 - _tmp28);
  const Scalar _tmp43 = Scalar(1.0) * _tmp42;
  const Scalar _tmp44 =
      -Scalar(0.010999999999999999) * _tmp11 - Scalar(0.010999999999999999) * _tmp16;
  const Scalar _tmp45 = Scalar(0.20999999999999999) * _tmp18 - Scalar(0.20999999999999999) * _tmp19;
  ...
  const Scalar _tmp51 = -_tmp27 * _tmp47 + _tmp50;
  const Scalar _tmp52 = _tmp28 * _tmp47 - _tmp41 * _tmp50;
  const Scalar _tmp53 = Scalar(1.0) * _tmp33;
  const Scalar _tmp54 = Scalar(1.0) * _tmp30;
  const Scalar _tmp55 = (-_tmp23 + _tmp54) / (_tmp15 - _tmp53);
  const Scalar _tmp56 = -_tmp43 * _tmp51 + _tmp43 * _tmp52 * _tmp55;
  const Scalar _tmp57 = -_tmp45 + _tmp48;
  const Scalar _tmp58 = -_tmp17;
  const Scalar _tmp59 = _tmp29 + _tmp58;
  const Scalar _tmp60 = _tmp59 - p_a(0, 0) + position_vector(0, 0);
  const Scalar _tmp61 = -_tmp6;
  const Scalar _tmp62 = _tmp32 + _tmp61;
  const Scalar _tmp63 = _tmp62 - p_a(1, 0) + position_vector(1, 0);
  ...
  const Scalar _tmp67 = _tmp41 * _tmp65 - _tmp66;
  const Scalar _tmp68 = _tmp42 * _tmp67;
  const Scalar _tmp69 = _tmp49 * _tmp65;
  const Scalar _tmp70 = -_tmp51 * _tmp68 -
                        _tmp55 * (-_tmp41 * _tmp69 - _tmp52 * _tmp68 + _tmp57 * _tmp66) -
                        _tmp57 * _tmp65 + _tmp69;
  const Scalar _tmp71 = Scalar(1.0) / (_tmp70);
  const Scalar _tmp72 = _tmp39 * _tmp65 - _tmp40 * _tmp68 - _tmp59 * _tmp66 + _tmp62 * _tmp65;
  const Scalar _tmp73 = _tmp71 * _tmp72;
  const Scalar _tmp74 = Scalar(1.0) / (_tmp72);
  const Scalar _tmp75 = _tmp70 * _tmp74;
  const Scalar _tmp76 = _tmp56 + _tmp75 * (-_tmp40 * _tmp43 - _tmp56 * _tmp73);
  ...
  const Scalar _tmp81 = _tmp22 + _tmp58;
  ...
  const Scalar _tmp89 = _tmp43 * _tmp67 * _tmp74;
  const Scalar _tmp90 = _tmp82 * _tmp85;
  const Scalar _tmp91 = fh1 * (_tmp81 * _tmp86 - _tmp83 * _tmp90);
  ...
  const Scalar _tmp97 = _tmp41 * _tmp42;
  const Scalar _tmp98 = -_tmp49 + _tmp51 * _tmp97 - _tmp55 * (_tmp41 * _tmp49 + _tmp52 * _tmp97);
  const Scalar _tmp99 = _tmp75 * (-_tmp39 + _tmp40 * _tmp97 - _tmp73 * _tmp98) + _tmp98;
  const Scalar _tmp100 = -_tmp41 - _tmp77 * _tmp99;
  const Scalar _tmp101 = _tmp90 * fh1;

  // Output terms (1)
  Eigen::Matrix<Scalar, 4, 1> _res;

  _res(0, 0) = std::exp(-fh1);
  _res(1, 0) = std::exp(_tmp101 * _tmp38 * (_tmp100 * _tmp79 + _tmp80 * _tmp99 + Scalar(1.0)) +
                        _tmp38 * _tmp87 * (_tmp76 * _tmp80 + _tmp78 * _tmp79) +
                        _tmp38 * _tmp91 * (-_tmp27 * _tmp89 + _tmp65 * _tmp88) +
                        _tmp38 * _tmp92 * (_tmp65 * _tmp96 - _tmp79 * _tmp95));
  _res(2, 0) = std::exp(-_tmp100 * _tmp101 * _tmp42 - _tmp42 * _tmp78 * _tmp87 +
                        _tmp42 * _tmp92 * _tmp95 + _tmp89 * _tmp91);
  _res(3, 0) = std::exp(-_tmp101 * _tmp71 * _tmp99 - _tmp71 * _tmp76 * _tmp87 - _tmp88 * _tmp91 -
                        _tmp92 * _tmp96);
