...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl4(
  ...
  const Scalar _tmp45 = (-_tmp32 + _tmp43) / (_tmp36 - _tmp44);
  ...
  const Scalar _tmp55 = -_tmp30 * _tmp54 + _tmp40 * _tmp52;
  ...
  const Scalar _tmp65 = _tmp30 * _tmp53;
  const Scalar _tmp66 = _tmp48 + _tmp51;
  const Scalar _tmp67 = -_tmp39 * _tmp52 + _tmp54;
  const Scalar _tmp68 = -_tmp45 * (-_tmp55 * _tmp64 - _tmp61 * _tmp65 + _tmp62 * _tmp66) +
                        _tmp53 * _tmp61 - _tmp61 * _tmp66 - _tmp64 * _tmp67;
  const Scalar _tmp69 = Scalar(1.0) / (_tmp68);
  const Scalar _tmp70 = _tmp63 * _tmp69;
  const Scalar _tmp71 = _tmp47 * _tmp70;
  const Scalar _tmp72 = _tmp47 * _tmp69;
  const Scalar _tmp73 =
  ...
  const Scalar _tmp76 = _tmp45 * _tmp55 * _tmp75 - _tmp67 * _tmp75;
  const Scalar _tmp77 = Scalar(1.0) / (_tmp73);
  const Scalar _tmp78 = _tmp74 * (_tmp18 * _tmp29 * _tmp77 - _tmp19 * _tmp28 * _tmp77);
  const Scalar _tmp79 = -_tmp32 * _tmp40 + _tmp36 * _tmp39 + _tmp39 * _tmp78;
  const Scalar _tmp80 = -_tmp56 * _tmp62 + _tmp58 * _tmp61 + _tmp61 * _tmp78 - _tmp64 * _tmp79;
  ...
  const Scalar _tmp85 = -_tmp70 * _tmp84 + Scalar(1.0);
  const Scalar _tmp86 = _tmp61 * _tmp69;
  const Scalar _tmp87 = _tmp31 + _tmp6;
  const Scalar _tmp88 = _tmp87 - p_a(0, 0) + position_vector(0, 0);
  const Scalar _tmp89 = _tmp27 + _tmp34;
  const Scalar _tmp90 = _tmp89 - p_a(1, 0) + position_vector(1, 0);
  ...
  const Scalar _tmp94 = _tmp30 * _tmp41;
  const Scalar _tmp95 = -_tmp45 * (_tmp55 * _tmp94 + _tmp65) - _tmp53 + _tmp67 * _tmp94;
  ...
  _res(1, 0) = std::exp(_tmp0 * _tmp74 * (-_tmp42 * _tmp71 + _tmp61 * _tmp72) +
                        _tmp100 * _tmp74 * (-_tmp39 * _tmp64 * _tmp99 + _tmp61 * _tmp99) +
                        _tmp92 * _tmp93 * (_tmp42 * _tmp85 + _tmp84 * _tmp86) +
                        _tmp93 * _tmp98 * (_tmp42 * _tmp97 + _tmp86 * _tmp96 + Scalar(1.0)));
  _res(2, 0) = std::exp(_tmp0 * _tmp41 * _tmp71 + _tmp101 * _tmp64 - _tmp102 * _tmp85 * _tmp92 -
                        _tmp102 * _tmp97 * _tmp98);
  _res(3, 0) =
      std::exp(-_tmp0 * _tmp72 - _tmp101 - _tmp103 * _tmp84 * _tmp92 - _tmp103 * _tmp96 * _tmp98);
