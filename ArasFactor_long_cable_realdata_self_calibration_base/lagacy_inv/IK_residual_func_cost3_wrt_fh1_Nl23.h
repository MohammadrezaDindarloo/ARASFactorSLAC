...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl23(
  ...
  const Scalar _tmp36 = _tmp10 + _tmp14 + _tmp7;
  const Scalar _tmp37 = _tmp35 * _tmp36;
  const Scalar _tmp38 = _tmp15 + _tmp7;
  const Scalar _tmp39 = _tmp18 + _tmp24;
  ...
  const Scalar _tmp50 = _tmp27 + _tmp41;
  const Scalar _tmp51 = _tmp50 - p_c(1, 0) + position_vector(1, 0);
  const Scalar _tmp52 = _tmp49 * _tmp51;
  const Scalar _tmp53 = _tmp40 * _tmp44;
  const Scalar _tmp54 = _tmp36 * _tmp53;
  const Scalar _tmp55 = _tmp38 * _tmp45 - _tmp52 * _tmp54;
  const Scalar _tmp56 = Scalar(1.0) / (-_tmp45 + _tmp52 * _tmp53);
  ...
  const Scalar _tmp63 = -_tmp38 * _tmp53 + _tmp54;
  const Scalar _tmp64 = -_tmp16 * _tmp35 + _tmp37 - _tmp59 * _tmp63 -
                        _tmp62 * (_tmp16 * _tmp57 - _tmp37 * _tmp52 - _tmp55 * _tmp59);
  const Scalar _tmp65 = Scalar(1.0) / (_tmp64);
  const Scalar _tmp66 = _tmp60 * _tmp62 + _tmp61;
  const Scalar _tmp67 = 0;
  const Scalar _tmp68 = _tmp53 * _tmp59;
  const Scalar _tmp69 =
  ...
  const Scalar _tmp72 = _tmp70 * (_tmp47 * _tmp51 * _tmp71 - _tmp48 * _tmp50 * _tmp71);
  const Scalar _tmp73 = -_tmp39 * _tmp45 + _tmp42 * _tmp53 + _tmp53 * _tmp72;
  const Scalar _tmp74 = Scalar(1.0) * _tmp56;
  const Scalar _tmp75 = _tmp55 * _tmp62 * _tmp74 - _tmp63 * _tmp74;
  const Scalar _tmp76 = -_tmp25 * _tmp57 + _tmp32 * _tmp35 + _tmp35 * _tmp72 - _tmp59 * _tmp73;
  ...
  const Scalar _tmp81 = _tmp58 * _tmp65;
  const Scalar _tmp82 = _tmp56 * (-_tmp80 * _tmp81 + Scalar(1.0));
  const Scalar _tmp83 = _tmp65 * _tmp80;
  const Scalar _tmp84 = _tmp19 + _tmp46;
  const Scalar _tmp85 = _tmp84 - p_d(0, 0) + position_vector(0, 0);
  const Scalar _tmp86 = _tmp27 + _tmp31;
  const Scalar _tmp87 = _tmp86 - p_d(1, 0) + position_vector(1, 0);
  const Scalar _tmp88 = std::pow(Scalar(std::pow(_tmp85, Scalar(2)) + std::pow(_tmp87, Scalar(2))),
                                 Scalar(Scalar(-1) / Scalar(2)));
  const Scalar _tmp89 = _tmp87 * _tmp88;
  const Scalar _tmp90 = _tmp70 * _tmp89 * (_tmp35 * _tmp83 + _tmp53 * _tmp82);
  const Scalar _tmp91 = _tmp85 * _tmp88;
  const Scalar _tmp92 = _tmp84 * _tmp89 - _tmp86 * _tmp91;
  const Scalar _tmp93 = Scalar(1.0) * _tmp78;
  const Scalar _tmp94 = _tmp70 * _tmp92 * (_tmp35 * _tmp93 - _tmp68 * _tmp93);
  const Scalar _tmp95 = _tmp52 * _tmp56;
  const Scalar _tmp96 = -_tmp36 - _tmp62 * (_tmp36 * _tmp52 + _tmp55 * _tmp95) + _tmp63 * _tmp95;
  const Scalar _tmp97 = _tmp79 * (-_tmp72 + _tmp73 * _tmp95 - _tmp77 * _tmp96) + _tmp96;
  const Scalar _tmp98 = _tmp56 * (-_tmp52 - _tmp81 * _tmp97);
  const Scalar _tmp99 = _tmp65 * _tmp97;
  const Scalar _tmp100 = _tmp70 * _tmp91 * (_tmp35 * _tmp99 + _tmp53 * _tmp98 + Scalar(1.0));
  const Scalar _tmp101 = _tmp82 * _tmp89;
  const Scalar _tmp102 = _tmp91 * _tmp98;
  const Scalar _tmp103 = _tmp0 * _tmp67;
  const Scalar _tmp104 = _tmp92 * _tmp93;
  const Scalar _tmp105 = _tmp104 * fh1;
  const Scalar _tmp106 = _tmp83 * _tmp89;
  ...
  _res(1, 0) = -(-_tmp100 - _tmp90 - _tmp94) *
               std::exp(_tmp0 * _tmp70 * (_tmp35 * _tmp67 - _tmp67 * _tmp68) + _tmp100 * fh1 +
                        _tmp90 * fh1 + _tmp94 * fh1);
  _res(2, 0) = -(_tmp101 + _tmp102 - _tmp104 * _tmp59) *
               std::exp(-_tmp101 * fh1 - _tmp102 * fh1 + _tmp103 * _tmp59 + _tmp105 * _tmp59);
  _res(3, 0) =
