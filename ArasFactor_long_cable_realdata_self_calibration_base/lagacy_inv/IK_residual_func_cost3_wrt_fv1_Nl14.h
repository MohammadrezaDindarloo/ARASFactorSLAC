...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl14(
  ...
  const Scalar _tmp38 = -_tmp16 * _tmp35 + _tmp37;
  ...
  const Scalar _tmp42 = _tmp27 + _tmp31;
  const Scalar _tmp43 = _tmp42 - p_b(1, 0) + position_vector(1, 0);
  const Scalar _tmp44 = _tmp41 * _tmp43;
  const Scalar _tmp45 = _tmp33 * _tmp34;
  const Scalar _tmp46 = Scalar(1.0) / (_tmp35 * _tmp44 - _tmp45);
  const Scalar _tmp47 = Scalar(1.0) * _tmp46;
  const Scalar _tmp48 = _tmp16 * _tmp45 - _tmp37 * _tmp44;
  const Scalar _tmp49 = Scalar(1.0) * _tmp42;
  const Scalar _tmp50 = Scalar(1.0) * _tmp39;
  const Scalar _tmp51 = (-_tmp25 + _tmp50) / (_tmp32 - _tmp49);
  const Scalar _tmp52 = -_tmp38 * _tmp47 + _tmp47 * _tmp48 * _tmp51;
  ...
  const Scalar _tmp57 = _tmp29 + _tmp30;
  ...
  const Scalar _tmp63 = _tmp36 * _tmp44;
  const Scalar _tmp64 = _tmp44 * _tmp61 - _tmp62;
  const Scalar _tmp65 = _tmp46 * _tmp64;
  const Scalar _tmp66 = _tmp36 * _tmp61 - _tmp38 * _tmp65 -
                        _tmp51 * (-_tmp48 * _tmp65 + _tmp53 * _tmp62 - _tmp61 * _tmp63) -
                        _tmp53 * _tmp61;
  ...
  const Scalar _tmp71 = _tmp70 * (_tmp39 * _tmp43 * _tmp69 - _tmp40 * _tmp42 * _tmp69);
  const Scalar _tmp72 = -_tmp25 * _tmp45 + _tmp32 * _tmp35 + _tmp35 * _tmp71;
  const Scalar _tmp73 = -_tmp55 * _tmp62 + _tmp58 * _tmp61 + _tmp61 * _tmp71 - _tmp65 * _tmp72;
  ...
  const Scalar _tmp80 = _tmp35 * _tmp46;
  ...
  const Scalar _tmp93 = _tmp70 * (-_tmp35 * _tmp92 + _tmp61 * _tmp91);
  const Scalar _tmp94 = _tmp44 * _tmp46;
  const Scalar _tmp95 = -_tmp36 + _tmp38 * _tmp94 - _tmp51 * (_tmp48 * _tmp94 + _tmp63);
  const Scalar _tmp96 = _tmp76 * (-_tmp71 + _tmp72 * _tmp94 - _tmp74 * _tmp95) + _tmp95;
  const Scalar _tmp97 = -_tmp44 - _tmp78 * _tmp96;
  const Scalar _tmp98 = _tmp85 * _tmp86;
  const Scalar _tmp99 = Scalar(1.0) * _tmp75;
  const Scalar _tmp100 = fh1 * (-_tmp82 * _tmp98 + _tmp84 * _tmp87);
  const Scalar _tmp101 = _tmp46 * fh1;
  ...
  _res(0, 0) = 0;
  _res(1, 0) =
      -_tmp93 * std::exp(_tmp100 * _tmp70 * (-_tmp35 * _tmp65 * _tmp99 + _tmp61 * _tmp99) +
