 ...
 *
 * Symbolic function: IK_residual_func_cost4_Nl7
 *
 * Args:
 *     fh1: Scalar
 *     fv1: Scalar
...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost4Nl7(
  ...
  const Scalar _tmp45 = _tmp33 + position_vector(0, 0);
  const Scalar _tmp46 = _tmp45 - p_d(0, 0);
  const Scalar _tmp47 = _tmp42 + position_vector(1, 0);
  ...
  const Scalar _tmp51 = _tmp34 + position_vector(0, 0);
  ...
  const Scalar _tmp58 = Scalar(1.0) / (-_tmp50 + _tmp56 * _tmp57);
  const Scalar _tmp59 = Scalar(0.20999999999999999) * _tmp12 + Scalar(0.20999999999999999) * _tmp13;
  const Scalar _tmp60 = -Scalar(0.010999999999999999) * _tmp25 -
  ...
  const Scalar _tmp67 = _tmp58 * (_tmp50 * _tmp63 - _tmp57 * _tmp66);
  const Scalar _tmp68 = _tmp58 * (-_tmp57 * _tmp63 + _tmp57 * _tmp65);
  const Scalar _tmp69 = _tmp36 * _tmp44 * _tmp67 - Scalar(1.0) * _tmp68;
  const Scalar _tmp70 = _tmp19 + _tmp27;
  const Scalar _tmp71 = _tmp70 + position_vector(0, 0);
  const Scalar _tmp72 = _tmp71 - p_c(0, 0);
  const Scalar _tmp73 = _tmp41 + _tmp7;
  ...
  const Scalar _tmp78 = _tmp60 + _tmp61;
  const Scalar _tmp79 = _tmp59 + _tmp78;
  const Scalar _tmp80 = _tmp75 * _tmp76;
  const Scalar _tmp81 = _tmp56 * _tmp77 - _tmp80;
  const Scalar _tmp82 = -_tmp66 * _tmp77 - _tmp67 * _tmp81 + _tmp79 * _tmp80;
  const Scalar _tmp83 = _tmp36 * _tmp43;
  const Scalar _tmp84 = _tmp65 * _tmp77 - _tmp68 * _tmp81 - _tmp77 * _tmp79 - _tmp82 * _tmp83;
  ...
  const Scalar _tmp88 = _tmp53 * _tmp86;
  const Scalar _tmp89 = _tmp88 * (_tmp34 * _tmp55 * _tmp87 - _tmp38 * _tmp52 * _tmp87);
  const Scalar _tmp90 = _tmp58 * (-_tmp33 * _tmp50 + _tmp42 * _tmp57 + _tmp57 * _tmp89);
  const Scalar _tmp91 = -_tmp70 * _tmp80 + _tmp73 * _tmp77 + _tmp77 * _tmp89 - _tmp81 * _tmp90;
  const Scalar _tmp92 = _tmp85 * _tmp91;
  const Scalar _tmp93 = Scalar(1.0) / (_tmp91);
  const Scalar _tmp94 = _tmp84 * _tmp93;
  const Scalar _tmp95 = _tmp94 * (-_tmp69 * _tmp92 - Scalar(1.0) * _tmp90);
  const Scalar _tmp96 = _tmp69 + _tmp95;
  const Scalar _tmp97 = _tmp81 * _tmp85;
  const Scalar _tmp98 = -_tmp96 * _tmp97 + Scalar(1.0);
  const Scalar _tmp99 = _tmp57 * _tmp58;
  const Scalar _tmp100 = _tmp77 * _tmp85;
  const Scalar _tmp101 = _tmp29 - p_b(0, 0);
  const Scalar _tmp102 = _tmp18 - p_b(1, 0);
  ...
  const Scalar _tmp107 = _tmp101 * _tmp103;
  const Scalar _tmp108 = fh1 * (_tmp104 * _tmp28 - _tmp107 * _tmp17);
  const Scalar _tmp109 = _tmp56 * _tmp67 + _tmp66;
  const Scalar _tmp110 = -_tmp109 * _tmp83 + _tmp56 * _tmp68 - _tmp65;
  const Scalar _tmp111 = _tmp94 * (-_tmp110 * _tmp92 + _tmp56 * _tmp90 - _tmp89);
  const Scalar _tmp112 = _tmp110 + _tmp111;
  const Scalar _tmp113 = -_tmp112 * _tmp97 - _tmp56;
  const Scalar _tmp114 = _tmp107 * fh1;
  const Scalar _tmp115 = Scalar(333.54000000000002) - fv1;
  const Scalar _tmp116 = _tmp35 + _tmp39 * _tmp83;
  const Scalar _tmp117 = 0;
  const Scalar _tmp118 = _tmp117 * _tmp97;
  const Scalar _tmp119 = _tmp117 * _tmp85;
  const Scalar _tmp120 = -_tmp105 * _tmp88 * (_tmp100 * _tmp96 + _tmp98 * _tmp99) -
                         _tmp108 * _tmp88 * (_tmp106 * _tmp77 - _tmp106 * _tmp81 * _tmp99) -
                         _tmp114 * _tmp88 * (_tmp100 * _tmp112 + _tmp113 * _tmp99 + Scalar(1.0)) -
                         _tmp115 * _tmp88 * (-_tmp118 * _tmp99 + _tmp119 * _tmp77);
  const Scalar _tmp121 = Scalar(1.0) / (_tmp120);
  const Scalar _tmp122 = _tmp40 + _tmp73;
  const Scalar _tmp123 = _tmp122 * _tmp83;
  const Scalar _tmp124 = Scalar(1.0) / (-_tmp123 + _tmp35 - _tmp70);
  const Scalar _tmp125 = Scalar(1.0) * _tmp124;
  const Scalar _tmp126 = _tmp122 * _tmp124;
  const Scalar _tmp127 = _tmp82 * _tmp85;
  const Scalar _tmp128 = _tmp126 * _tmp95 - _tmp127 * _tmp96 - Scalar(1.0) * _tmp67;
  const Scalar _tmp129 = _tmp122 * _tmp125;
  const Scalar _tmp130 = fh1 * (_tmp64 + _tmp78);
  const Scalar _tmp131 = _tmp107 * _tmp130 + Scalar(40.024799999999999) * _tmp23 + _tmp28 * fv1;
  const Scalar _tmp132 = _tmp125 * _tmp94;
  const Scalar _tmp133 = -_tmp106 * _tmp82 + _tmp129 * _tmp94;
  const Scalar _tmp134 = _tmp116 * _tmp124;
  const Scalar _tmp135 = -_tmp117 * _tmp127 - _tmp122 * _tmp134 + _tmp40;
  const Scalar _tmp136 = -_tmp104 * _tmp130 - Scalar(40.024799999999999) * _tmp14 - _tmp17 * fv1;
  const Scalar _tmp137 = _tmp123 * _tmp125 + Scalar(1.0);
  const Scalar _tmp138 = _tmp125 * _tmp83;
  const Scalar _tmp139 = _tmp109 + _tmp111 * _tmp126 - _tmp112 * _tmp127;
  const Scalar _tmp140 = std::asinh(
      _tmp121 * (Scalar(1.0) * _tmp105 * (_tmp125 * _tmp95 - _tmp128 * _tmp44) +
                 Scalar(1.0) * _tmp108 * (_tmp132 - _tmp133 * _tmp44) +
                 Scalar(1.0) * _tmp114 * (_tmp111 * _tmp125 - _tmp139 * _tmp44) +
                 Scalar(1.0) * _tmp115 * (-_tmp116 * _tmp125 - _tmp135 * _tmp44 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp131 * (-_tmp125 + _tmp129 * _tmp43) +
                 Scalar(1.0) * _tmp136 * (-_tmp137 * _tmp44 + _tmp138)));
  const Scalar _tmp141 = Scalar(1.4083112389913199) * _tmp120;
  const Scalar _tmp142 = _tmp106 * _tmp108;
  const Scalar _tmp143 = _tmp105 * _tmp58 * _tmp98 + _tmp113 * _tmp114 * _tmp58 -
                         _tmp115 * _tmp118 * _tmp58 - _tmp142 * _tmp58 * _tmp81;
  const Scalar _tmp144 = Scalar(1.0) / (_tmp143);
  const Scalar _tmp145 = _tmp125 * _tmp131;
  const Scalar _tmp146 =
      std::asinh(_tmp144 * (_tmp105 * _tmp128 * _tmp43 + _tmp108 * _tmp133 * _tmp43 +
                            _tmp114 * _tmp139 * _tmp43 + _tmp115 * _tmp135 * _tmp43 -
                            _tmp122 * _tmp145 * _tmp43 + _tmp136 * _tmp137 * _tmp43));
  const Scalar _tmp147 = Scalar(1.4083112389913199) * _tmp143;
  const Scalar _tmp148 =
      _tmp105 * _tmp85 * _tmp96 + _tmp112 * _tmp114 * _tmp85 + _tmp115 * _tmp119 + _tmp142;
  const Scalar _tmp149 = Scalar(1.0) / (_tmp148);
  const Scalar _tmp150 = std::asinh(_tmp149 * (-_tmp105 * _tmp124 * _tmp95 - _tmp108 * _tmp132 -
                                               _tmp111 * _tmp114 * _tmp124 + _tmp115 * _tmp134 -
  ...
  _res(1, 0) =
      _tmp141 * (-std::sinh(Scalar(1.0) * _tmp140) -
                 std::sinh(Scalar(0.71007031138673404) * _tmp121 *
                           (-_tmp140 * _tmp141 -
                            std::sqrt(Scalar(std::pow(Scalar(-_tmp51 + p_a(0, 0)), Scalar(2)) +
  ...
  _res(2, 0) =
      _tmp147 * (-std::sinh(Scalar(1.0) * _tmp146) -
                 std::sinh(Scalar(0.71007031138673404) * _tmp144 *
                           (-_tmp146 * _tmp147 -
                            std::sqrt(Scalar(std::pow(Scalar(-_tmp45 + p_d(0, 0)), Scalar(2)) +
