 ...
 *
 * Symbolic function: IK_residual_func_cost4_Nl8
 *
 * Args:
 *     fh1: Scalar
 *     fv1: Scalar
...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost4Nl8(
  ...
  const Scalar _tmp36 = _tmp17 + _tmp5;
  ...
  const Scalar _tmp43 = _tmp42 * (_tmp33 * _tmp38 * _tmp40 - _tmp35 * _tmp36 * _tmp40);
  ...
  const Scalar _tmp67 = _tmp66 * (_tmp43 * _tmp64 - _tmp57 * _tmp65 + _tmp60 * _tmp64);
  const Scalar _tmp68 = _tmp43 * _tmp53 - _tmp45 * _tmp54 + _tmp49 * _tmp53 - _tmp56 * _tmp67;
  const Scalar _tmp69 = Scalar(1.0) / (_tmp68);
  const Scalar _tmp70 = Scalar(1.0) * _tmp69;
  const Scalar _tmp71 = _tmp56 * _tmp66;
  const Scalar _tmp72 = _tmp64 * _tmp71;
  const Scalar _tmp73 = _tmp29 - p_b(0, 0);
  const Scalar _tmp74 = _tmp19 - p_b(1, 0);
  ...
  const Scalar _tmp78 = fh1 * (-_tmp18 * _tmp77 + _tmp28 * _tmp76);
  const Scalar _tmp79 = Scalar(0.20999999999999999) * _tmp10 + Scalar(0.20999999999999999) * _tmp8;
  const Scalar _tmp80 =
      -Scalar(0.010999999999999999) * _tmp2 - Scalar(0.010999999999999999) * _tmp20;
  const Scalar _tmp81 = Scalar(0.20999999999999999) * _tmp22 - Scalar(0.20999999999999999) * _tmp23;
  ...
  const Scalar _tmp87 = _tmp55 * _tmp83;
  const Scalar _tmp88 = -_tmp79;
  const Scalar _tmp89 = _tmp85 + _tmp88;
  const Scalar _tmp90 = -_tmp64 * _tmp87 + _tmp65 * _tmp89;
  const Scalar _tmp91 = _tmp54 * _tmp86 - _tmp55 * _tmp84 - _tmp71 * _tmp90;
  const Scalar _tmp92 = Scalar(1.0) * _tmp36;
  const Scalar _tmp93 = -_tmp92;
  const Scalar _tmp94 = Scalar(1.0) / (_tmp60 + _tmp93);
  const Scalar _tmp95 = Scalar(1.0) * _tmp33;
  const Scalar _tmp96 = -_tmp57 + _tmp95;
  const Scalar _tmp97 = _tmp94 * _tmp96;
  const Scalar _tmp98 = _tmp64 * _tmp83 - _tmp64 * _tmp89;
  const Scalar _tmp99 = -_tmp53 * _tmp86 - _tmp71 * _tmp98 + _tmp84 - _tmp91 * _tmp97;
  const Scalar _tmp100 = Scalar(1.0) / (_tmp99);
  const Scalar _tmp101 = Scalar(1.0) * _tmp94;
  const Scalar _tmp102 = Scalar(1.0) * _tmp66;
  const Scalar _tmp103 = _tmp101 * _tmp66 * _tmp90 * _tmp96 - _tmp102 * _tmp98;
  const Scalar _tmp104 = _tmp100 * _tmp68;
  const Scalar _tmp105 = _tmp69 * _tmp99;
  const Scalar _tmp106 = _tmp105 * (-_tmp103 * _tmp104 - Scalar(1.0) * _tmp67);
  const Scalar _tmp107 = _tmp100 * (_tmp103 + _tmp106);
  const Scalar _tmp108 = -_tmp107 * _tmp56 + Scalar(1.0);
  const Scalar _tmp109 = _tmp64 * _tmp66;
  const Scalar _tmp110 = _tmp76 * fh1;
  const Scalar _tmp111 = Scalar(333.54000000000002) - fv1;
  const Scalar _tmp112 = _tmp92 * _tmp97 + _tmp95;
  const Scalar _tmp113 = 0;
  const Scalar _tmp114 = _tmp55 * _tmp66;
  const Scalar _tmp115 = _tmp114 * _tmp90 + _tmp87;
  const Scalar _tmp116 = _tmp114 * _tmp98 - _tmp115 * _tmp97 - _tmp83;
  const Scalar _tmp117 = _tmp105 * (-_tmp104 * _tmp116 - _tmp43 + _tmp55 * _tmp67);
  const Scalar _tmp118 = _tmp100 * (_tmp116 + _tmp117);
  const Scalar _tmp119 = -_tmp118 * _tmp56 - _tmp55;
  const Scalar _tmp120 = _tmp77 * fh1;
  const Scalar _tmp121 = -_tmp110 * _tmp42 * (_tmp107 * _tmp53 + _tmp108 * _tmp109) -
                         _tmp111 * _tmp42 * (_tmp113 * _tmp53 - _tmp113 * _tmp72) -
                         _tmp120 * _tmp42 * (_tmp109 * _tmp119 + _tmp118 * _tmp53 + Scalar(1.0)) -
                         _tmp42 * _tmp78 * (_tmp53 * _tmp70 - _tmp70 * _tmp72);
  const Scalar _tmp122 = Scalar(1.0) / (_tmp121);
  const Scalar _tmp123 = _tmp49 + _tmp93;
  const Scalar _tmp124 = _tmp123 * _tmp97;
  const Scalar _tmp125 = Scalar(1.0) / (-_tmp124 - _tmp45 + _tmp95);
  const Scalar _tmp126 = _tmp112 * _tmp125;
  const Scalar _tmp127 = -_tmp113 * _tmp91 - _tmp123 * _tmp126 + _tmp93;
  const Scalar _tmp128 = Scalar(1.0) * _tmp125;
  const Scalar _tmp129 = _tmp123 * _tmp125;
  const Scalar _tmp130 = -_tmp102 * _tmp90 + _tmp106 * _tmp129 - _tmp107 * _tmp91;
  const Scalar _tmp131 = _tmp105 * _tmp128;
  const Scalar _tmp132 = _tmp123 * _tmp131 - _tmp70 * _tmp91;
  const Scalar _tmp133 = _tmp123 * _tmp94;
  const Scalar _tmp134 = fh1 * (_tmp82 + _tmp88);
  const Scalar _tmp135 = _tmp134 * _tmp77 + Scalar(40.024799999999999) * _tmp24 + _tmp28 * fv1;
  const Scalar _tmp136 = _tmp115 + _tmp117 * _tmp129 - _tmp118 * _tmp91;
  const Scalar _tmp137 = -Scalar(40.024799999999999) * _tmp11 - _tmp134 * _tmp76 - _tmp18 * fv1;
  const Scalar _tmp138 = _tmp124 * _tmp128 + Scalar(1.0);
  const Scalar _tmp139 = std::asinh(
      _tmp122 * (Scalar(1.0) * _tmp110 * (-_tmp101 * _tmp130 + _tmp106 * _tmp128) +
                 Scalar(1.0) * _tmp111 * (-_tmp101 * _tmp127 - _tmp112 * _tmp128 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp120 * (-_tmp101 * _tmp136 + _tmp117 * _tmp128) +
                 Scalar(1.0) * _tmp135 * (_tmp128 * _tmp133 - _tmp128) +
                 Scalar(1.0) * _tmp137 * (-_tmp101 * _tmp138 + _tmp128 * _tmp97) +
                 Scalar(1.0) * _tmp78 * (-_tmp101 * _tmp132 + _tmp131)));
  const Scalar _tmp140 = Scalar(1.4083112389913199) * _tmp121;
  const Scalar _tmp141 = _tmp128 * _tmp135;
  const Scalar _tmp142 = _tmp137 * _tmp94;
  const Scalar _tmp143 = _tmp94 * fh1;
  const Scalar _tmp144 = _tmp70 * _tmp78;
  const Scalar _tmp145 = _tmp111 * _tmp113;
  const Scalar _tmp146 =
      _tmp108 * _tmp110 * _tmp66 + _tmp119 * _tmp120 * _tmp66 - _tmp144 * _tmp71 - _tmp145 * _tmp71;
  const Scalar _tmp147 = Scalar(1.0) / (_tmp146);
  const Scalar _tmp148 =
      std::asinh(_tmp147 * (_tmp111 * _tmp127 * _tmp94 + _tmp130 * _tmp143 * _tmp76 +
                            _tmp132 * _tmp78 * _tmp94 - _tmp133 * _tmp141 +
                            _tmp136 * _tmp143 * _tmp77 + _tmp138 * _tmp142));
  const Scalar _tmp149 = Scalar(1.4083112389913199) * _tmp146;
  const Scalar _tmp150 = _tmp107 * _tmp110 + _tmp118 * _tmp120 + _tmp144 + _tmp145;
  const Scalar _tmp151 = Scalar(1.0) / (_tmp150);
  const Scalar _tmp152 = std::asinh(
      _tmp151 * (-_tmp106 * _tmp110 * _tmp125 + _tmp111 * _tmp126 - _tmp117 * _tmp120 * _tmp125 -
                 _tmp128 * _tmp142 * _tmp96 - _tmp131 * _tmp78 + _tmp141));
  ...
  _res(1, 0) =
      _tmp140 * (-std::sinh(Scalar(1.0) * _tmp139) -
                 std::sinh(Scalar(0.71007031138673404) * _tmp122 *
                           (-_tmp139 * _tmp140 -
                            std::sqrt(Scalar(std::pow(Scalar(-_tmp34 + p_c(0, 0)), Scalar(2)) +
  ...
  _res(3, 0) =
      _tmp153 * (-std::sinh(Scalar(1.0) * _tmp152) -
                 std::sinh(Scalar(0.71007031138673404) * _tmp151 *
                           (-_tmp152 * _tmp153 -
                            std::sqrt(Scalar(std::pow(Scalar(-_tmp46 + p_d(0, 0)), Scalar(2)) +
