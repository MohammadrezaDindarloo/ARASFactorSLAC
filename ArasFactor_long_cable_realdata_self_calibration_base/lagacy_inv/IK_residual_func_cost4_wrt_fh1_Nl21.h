 ...
 *
 * Symbolic function: IK_residual_func_cost4_wrt_fh1_Nl21
 *
 * Args:
 *     fh1: Scalar
 *     fv1: Scalar
...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost4WrtFh1Nl21(
  ...
  const Scalar _tmp33 =
      -_tmp32 * fh1 - std::sqrt(Scalar(std::pow(Scalar(-_tmp18 + p_d(1, 0)), Scalar(2)) +
  ...
  const Scalar _tmp46 = _tmp19 + _tmp43;
  ...
  const Scalar _tmp82 = -_tmp57 * _tmp79 + _tmp58 * _tmp77;
  const Scalar _tmp83 = _tmp67 * _tmp78;
  const Scalar _tmp84 = -_tmp57 * _tmp83 + _tmp68 * _tmp75 - _tmp81 * _tmp82;
  const Scalar _tmp85 = Scalar(1.0) * _tmp40;
  const Scalar _tmp86 = -_tmp85;
  const Scalar _tmp87 = Scalar(1.0) / (_tmp49 + _tmp86);
  const Scalar _tmp88 = Scalar(1.0) * _tmp44;
  const Scalar _tmp89 = _tmp87 * (-_tmp46 + _tmp88);
  const Scalar _tmp90 = -_tmp67 * _tmp75 - _tmp80 * _tmp81 + _tmp83 - _tmp84 * _tmp89;
  ...
  const Scalar _tmp95 = _tmp94 * (-_tmp40 * _tmp54 * _tmp93 + _tmp44 * _tmp56 * _tmp93);
  const Scalar _tmp96 = -_tmp46 * _tmp58 + _tmp49 * _tmp53 + _tmp53 * _tmp95;
  const Scalar _tmp97 = Scalar(1.0) * _tmp59;
  const Scalar _tmp98 = _tmp82 * _tmp97;
  const Scalar _tmp99 = -_tmp80 * _tmp97 + _tmp89 * _tmp98;
  const Scalar _tmp100 = -_tmp60 * _tmp68 + _tmp63 * _tmp67 + _tmp67 * _tmp95 - _tmp81 * _tmp96;
  ...
  const Scalar _tmp107 = _tmp28 - p_d(0, 0);
  ...
  const Scalar _tmp111 = _tmp110 * _tmp94 * (_tmp105 * _tmp67 + _tmp106 * _tmp53);
  ...
  const Scalar _tmp115 = _tmp53 * _tmp81;
  const Scalar _tmp116 = _tmp113 * _tmp94 * (-_tmp114 * _tmp115 + _tmp114 * _tmp67);
  const Scalar _tmp117 = Scalar(333.54000000000002) - fv1;
  const Scalar _tmp118 = _tmp85 * _tmp89 + _tmp88;
  const Scalar _tmp119 = 0;
  const Scalar _tmp120 = _tmp57 * _tmp59;
  const Scalar _tmp121 = _tmp120 * _tmp82 + _tmp57 * _tmp78;
  const Scalar _tmp122 = _tmp120 * _tmp80 - _tmp121 * _tmp89 - _tmp78;
  const Scalar _tmp123 = _tmp103 * (-_tmp101 * _tmp122 + _tmp120 * _tmp96 - _tmp95);
  const Scalar _tmp124 = _tmp91 * (_tmp122 + _tmp123);
  const Scalar _tmp125 = _tmp59 * (-_tmp124 * _tmp69 - _tmp57);
  const Scalar _tmp126 = _tmp112 * _tmp94 * (_tmp124 * _tmp67 + _tmp125 * _tmp53 + Scalar(1.0));
  const Scalar _tmp127 = -_tmp111 * fh1 - _tmp116 * fh1 -
                         _tmp117 * _tmp94 * (-_tmp115 * _tmp119 + _tmp119 * _tmp67) - _tmp126 * fh1;
  const Scalar _tmp128 = Scalar(1.0) / (_tmp127);
  const Scalar _tmp129 = _tmp70 + _tmp74;
  const Scalar _tmp130 = _tmp129 * fh1;
  const Scalar _tmp131 = _tmp112 * _tmp130 + Scalar(40.024799999999999) * _tmp22 + _tmp27 * fv1;
  ...
  const Scalar _tmp138 = _tmp118 * _tmp134;
  const Scalar _tmp139 = -_tmp119 * _tmp84 - _tmp132 * _tmp138 + _tmp86;
  const Scalar _tmp140 = Scalar(1.0) * _tmp87;
  const Scalar _tmp141 = _tmp103 * _tmp135;
  const Scalar _tmp142 = -_tmp114 * _tmp84 + _tmp132 * _tmp141;
  const Scalar _tmp143 = Scalar(1.0) * _tmp113 * (-_tmp140 * _tmp142 + _tmp141);
  const Scalar _tmp144 = _tmp132 * _tmp134;
  const Scalar _tmp145 = _tmp121 + _tmp123 * _tmp144 - _tmp124 * _tmp84;
  const Scalar _tmp146 = Scalar(1.0) * _tmp112 * (_tmp123 * _tmp135 - _tmp140 * _tmp145);
  const Scalar _tmp147 = _tmp104 * _tmp144 - _tmp105 * _tmp84 - _tmp98;
  const Scalar _tmp148 = Scalar(1.0) * _tmp110 * (_tmp104 * _tmp135 - _tmp140 * _tmp147);
  const Scalar _tmp149 = -_tmp110 * _tmp130 - Scalar(40.024799999999999) * _tmp14 - _tmp17 * fv1;
  ...
  const Scalar _tmp153 =
      Scalar(1.0) * _tmp117 * (-_tmp118 * _tmp135 - _tmp139 * _tmp140 + Scalar(1.0)) +
      _tmp131 * _tmp137 + _tmp143 * fh1 + _tmp146 * fh1 + _tmp148 * fh1 + _tmp149 * _tmp152;
  const Scalar _tmp154 = std::asinh(_tmp128 * _tmp153);
  const Scalar _tmp155 = Scalar(1.4083112389913199) * _tmp154;
  const Scalar _tmp156 =
      -_tmp127 * _tmp155 - std::sqrt(Scalar(std::pow(Scalar(-_tmp41 + p_b(1, 0)), Scalar(2)) +
                                            std::pow(Scalar(-_tmp45 + p_b(0, 0)), Scalar(2))));
  const Scalar _tmp157 = std::pow(_tmp127, Scalar(-2));
  const Scalar _tmp158 = -_tmp111 - _tmp116 - _tmp126;
  const Scalar _tmp159 = _tmp157 * _tmp158;
  const Scalar _tmp160 = Scalar(1.4083112389913199) * _tmp127;
  const Scalar _tmp161 = _tmp110 * _tmp129;
  const Scalar _tmp162 = _tmp112 * _tmp129;
  const Scalar _tmp163 =
      (_tmp128 * (_tmp137 * _tmp162 + _tmp143 + _tmp146 + _tmp148 - _tmp152 * _tmp161) -
       _tmp153 * _tmp159) /
      std::sqrt(Scalar(std::pow(_tmp153, Scalar(2)) * _tmp157 + 1));
  const Scalar _tmp164 = Scalar(0.71007031138673404) * _tmp128;
  const Scalar _tmp165 = _tmp156 * _tmp164;
  const Scalar _tmp166 = Scalar(1.0) * _tmp154;
  const Scalar _tmp167 = _tmp110 * _tmp147 * _tmp87;
  const Scalar _tmp168 = _tmp131 * _tmp135;
  const Scalar _tmp169 = _tmp112 * _tmp87;
  const Scalar _tmp170 = _tmp145 * _tmp169;
  const Scalar _tmp171 = _tmp113 * _tmp142 * _tmp87;
  const Scalar _tmp172 = _tmp151 * _tmp87;
  const Scalar _tmp173 = _tmp117 * _tmp139 * _tmp87 - _tmp136 * _tmp168 + _tmp149 * _tmp172 +
                         _tmp167 * fh1 + _tmp170 * fh1 + _tmp171 * fh1;
  const Scalar _tmp174 = _tmp106 * _tmp110;
  const Scalar _tmp175 = _tmp117 * _tmp119;
  const Scalar _tmp176 = _tmp112 * _tmp125;
  const Scalar _tmp177 = _tmp113 * _tmp114;
  const Scalar _tmp178 = _tmp177 * fh1;
  const Scalar _tmp179 = _tmp174 * fh1 - _tmp175 * _tmp81 + _tmp176 * fh1 - _tmp178 * _tmp81;
  ...
  const Scalar _tmp187 = _tmp174 + _tmp176 - _tmp177 * _tmp81;
  const Scalar _tmp188 = _tmp186 * _tmp187;
  const Scalar _tmp189 = Scalar(1.4083112389913199) * _tmp187;
  const Scalar _tmp190 =
      (-_tmp173 * _tmp188 + _tmp180 * (-_tmp129 * _tmp132 * _tmp135 * _tmp169 - _tmp161 * _tmp172 +
                                       _tmp167 + _tmp170 + _tmp171)) /
      std::sqrt(Scalar(std::pow(_tmp173, Scalar(2)) * _tmp186 + 1));
  const Scalar _tmp191 = Scalar(1.0) * _tmp181;
  const Scalar _tmp192 = _tmp112 * _tmp123 * _tmp134;
  const Scalar _tmp193 = _tmp113 * _tmp141;
  const Scalar _tmp194 = _tmp104 * _tmp110 * _tmp134;
  const Scalar _tmp195 = _tmp117 * _tmp138 - _tmp149 * _tmp150 + _tmp168 - _tmp192 * fh1 -
                         _tmp193 * fh1 - _tmp194 * fh1;
  const Scalar _tmp196 = _tmp105 * _tmp110;
  const Scalar _tmp197 = _tmp112 * _tmp124;
  ...
  const Scalar _tmp203 =
      -_tmp200 * _tmp202 - std::sqrt(Scalar(std::pow(Scalar(-_tmp61 + p_a(0, 0)), Scalar(2)) +
  ...
  const Scalar _tmp206 = _tmp177 + _tmp196 + _tmp197;
  ...
  const Scalar _tmp210 = (-_tmp195 * _tmp209 + _tmp199 * (_tmp135 * _tmp162 + _tmp150 * _tmp161 -
  ...
  _res(1, 0) = Scalar(1.4083112389913199) * _tmp158 * (-std::sinh(_tmp165) - std::sinh(_tmp166)) +
               _tmp160 * (-Scalar(1.0) * _tmp163 * std::cosh(_tmp166) -
                          (-Scalar(0.71007031138673404) * _tmp156 * _tmp159 +
                           _tmp164 * (-_tmp155 * _tmp158 - _tmp160 * _tmp163)) *
                              std::cosh(_tmp165));
