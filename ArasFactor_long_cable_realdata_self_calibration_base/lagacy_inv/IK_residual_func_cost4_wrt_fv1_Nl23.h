 ...
 *
 * Symbolic function: IK_residual_func_cost4_wrt_fv1_Nl23
 *
 * Args:
 *     fh1: Scalar
 *     fv1: Scalar
...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost4WrtFv1Nl23(
  ...
  const Scalar _tmp35 = _tmp13 + _tmp18 + _tmp7;
  ...
  const Scalar _tmp42 = _tmp19 + _tmp38;
  const Scalar _tmp43 = _tmp37 + _tmp42;
  const Scalar _tmp44 = _tmp28 - _tmp29;
  const Scalar _tmp45 = _tmp23 + _tmp44;
  const Scalar _tmp46 = _tmp23 + _tmp30;
  const Scalar _tmp47 = Scalar(1.0) * _tmp46;
  const Scalar _tmp48 = _tmp41 * (-_tmp45 + _tmp47);
  const Scalar _tmp49 = _tmp36 * _tmp48 + _tmp47;
  const Scalar _tmp50 = _tmp43 * _tmp48;
  const Scalar _tmp51 = _tmp24 + _tmp44;
  const Scalar _tmp52 = Scalar(1.0) / (_tmp47 - _tmp50 - _tmp51);
  const Scalar _tmp53 = _tmp49 * _tmp52;
  const Scalar _tmp54 = 0;
  const Scalar _tmp55 = Scalar(0.20999999999999999) * _tmp14 + Scalar(0.20999999999999999) * _tmp15;
  ...
  const Scalar _tmp61 = _tmp51 + position_vector(0, 0);
  const Scalar _tmp62 = _tmp61 - p_a(0, 0);
  const Scalar _tmp63 = _tmp42 + position_vector(1, 0);
  ...
  const Scalar _tmp71 = _tmp45 + position_vector(0, 0);
  ...
  const Scalar _tmp80 = _tmp35 + position_vector(1, 0);
  ...
  const Scalar _tmp85 = _tmp70 * _tmp76 - _tmp82 * _tmp84;
  const Scalar _tmp86 = Scalar(1.0) / (-_tmp76 + _tmp82 * _tmp83);
  const Scalar _tmp87 = _tmp64 * _tmp65;
  const Scalar _tmp88 = _tmp66 * _tmp82 - _tmp87;
  const Scalar _tmp89 = _tmp86 * _tmp88;
  const Scalar _tmp90 = _tmp60 * _tmp87 - _tmp69 * _tmp82 - _tmp85 * _tmp89;
  const Scalar _tmp91 = -_tmp70 * _tmp83 + _tmp84;
  const Scalar _tmp92 = -_tmp48 * _tmp90 - _tmp60 * _tmp66 + _tmp69 - _tmp89 * _tmp91;
  const Scalar _tmp93 = Scalar(1.0) / (_tmp92);
  const Scalar _tmp94 = _tmp90 * _tmp93;
  const Scalar _tmp95 = _tmp41 * (_tmp37 - _tmp43 * _tmp53 - _tmp54 * _tmp94);
  const Scalar _tmp96 = -Scalar(1.0) * _tmp53 - Scalar(1.0) * _tmp95 + Scalar(1.0);
  const Scalar _tmp97 = _tmp32 - p_d(0, 0);
  const Scalar _tmp98 = _tmp21 - p_d(1, 0);
  const Scalar _tmp99 = std::pow(Scalar(std::pow(_tmp97, Scalar(2)) + std::pow(_tmp98, Scalar(2))),
                                 Scalar(Scalar(-1) / Scalar(2)));
  const Scalar _tmp100 = _tmp97 * _tmp99;
  const Scalar _tmp101 = fh1 * (_tmp55 + _tmp59);
  const Scalar _tmp102 = _tmp100 * _tmp101 + Scalar(40.024799999999999) * _tmp27 + _tmp31 * fv1;
  const Scalar _tmp103 = Scalar(1.0) * _tmp52;
  const Scalar _tmp104 = _tmp41 * _tmp43;
  const Scalar _tmp105 = Scalar(1.0) * _tmp103 * _tmp104 - Scalar(1.0) * _tmp103;
  const Scalar _tmp106 = _tmp82 * _tmp86;
  const Scalar _tmp107 = _tmp106 * _tmp85 + _tmp68 * _tmp82;
  const Scalar _tmp108 = _tmp106 * _tmp91 - _tmp107 * _tmp48 - _tmp68;
  ...
  const Scalar _tmp111 = _tmp109 * _tmp79;
  const Scalar _tmp112 = _tmp111 * (-_tmp110 * _tmp35 * _tmp78 + _tmp110 * _tmp46 * _tmp81);
  const Scalar _tmp113 = _tmp112 * _tmp83 + _tmp40 * _tmp83 - _tmp45 * _tmp76;
  const Scalar _tmp114 = _tmp112 * _tmp66 - _tmp113 * _tmp89 + _tmp42 * _tmp66 - _tmp51 * _tmp87;
  ...
  const Scalar _tmp120 = _tmp43 * _tmp52;
  const Scalar _tmp121 = _tmp107 + _tmp118 * _tmp120 - _tmp119 * _tmp94;
  const Scalar _tmp122 = Scalar(1.0) * _tmp41;
  const Scalar _tmp123 = _tmp100 * fh1;
  const Scalar _tmp124 = Scalar(1.0) * _tmp86;
  const Scalar _tmp125 = _tmp124 * _tmp85;
  const Scalar _tmp126 = -_tmp124 * _tmp91 + _tmp125 * _tmp48;
  const Scalar _tmp127 = _tmp117 * (-_tmp113 * _tmp124 - _tmp115 * _tmp126);
  const Scalar _tmp128 = _tmp126 + _tmp127;
  const Scalar _tmp129 = _tmp120 * _tmp127 - _tmp125 - _tmp128 * _tmp94;
  const Scalar _tmp130 = _tmp98 * _tmp99;
  const Scalar _tmp131 = _tmp130 * fh1;
  const Scalar _tmp132 = -_tmp101 * _tmp130 - Scalar(40.024799999999999) * _tmp16 - _tmp20 * fv1;
  const Scalar _tmp133 = _tmp41 * (_tmp103 * _tmp50 + Scalar(1.0));
  const Scalar _tmp134 = _tmp103 * _tmp48;
  const Scalar _tmp135 = -Scalar(1.0) * _tmp133 + Scalar(1.0) * _tmp134;
  const Scalar _tmp136 = Scalar(1.0) * _tmp116;
  const Scalar _tmp137 = _tmp103 * _tmp117;
  const Scalar _tmp138 = -_tmp136 * _tmp90 + _tmp137 * _tmp43;
  const Scalar _tmp139 = fh1 * (-_tmp100 * _tmp20 + _tmp130 * _tmp31);
  const Scalar _tmp140 =
      _tmp102 * _tmp105 + Scalar(1.0) * _tmp123 * (_tmp103 * _tmp118 - _tmp121 * _tmp122) +
      Scalar(1.0) * _tmp131 * (_tmp103 * _tmp127 - _tmp122 * _tmp129) + _tmp132 * _tmp135 +
      Scalar(1.0) * _tmp139 * (-_tmp122 * _tmp138 + _tmp137) + _tmp34 * _tmp96;
  const Scalar _tmp141 = _tmp54 * _tmp93;
  const Scalar _tmp142 = _tmp83 * _tmp89;
  const Scalar _tmp143 = _tmp111 * (-_tmp141 * _tmp142 + _tmp141 * _tmp66);
  const Scalar _tmp144 = _tmp88 * _tmp93;
  const Scalar _tmp145 = -_tmp128 * _tmp144 + Scalar(1.0);
  const Scalar _tmp146 = _tmp83 * _tmp86;
  const Scalar _tmp147 = _tmp66 * _tmp93;
  const Scalar _tmp148 = -_tmp119 * _tmp144 - _tmp82;
  const Scalar _tmp149 =
      -_tmp111 * _tmp123 * (_tmp119 * _tmp147 + _tmp146 * _tmp148 + Scalar(1.0)) -
      _tmp111 * _tmp131 * (_tmp128 * _tmp147 + _tmp145 * _tmp146) -
      _tmp111 * _tmp139 * (-_tmp136 * _tmp142 + _tmp136 * _tmp66) - _tmp143 * _tmp34;
  ...
  const Scalar _tmp155 = _tmp17 + _tmp39;
  const Scalar _tmp156 =
      (-_tmp140 * _tmp154 + _tmp150 * (_tmp105 * _tmp31 + _tmp135 * _tmp155 - _tmp96)) /
      std::sqrt(Scalar(std::pow(_tmp140, Scalar(2)) * _tmp153 + 1));
  const Scalar _tmp157 = Scalar(1.4083112389913199) * _tmp149;
  const Scalar _tmp158 =
      -_tmp151 * _tmp157 - std::sqrt(Scalar(std::pow(Scalar(-_tmp77 + p_c(0, 0)), Scalar(2)) +
  ...
  const Scalar _tmp161 = Scalar(1.4083112389913199) * _tmp143;
  const Scalar _tmp162 = _tmp102 * _tmp103;
  const Scalar _tmp163 = -_tmp104 * _tmp162 + _tmp121 * _tmp123 * _tmp41 +
                         _tmp129 * _tmp131 * _tmp41 + _tmp132 * _tmp133 +
                         _tmp138 * _tmp139 * _tmp41 + _tmp34 * _tmp95;
  const Scalar _tmp164 = _tmp141 * _tmp34;
  const Scalar _tmp165 = _tmp136 * _tmp139;
  const Scalar _tmp166 =
      _tmp123 * _tmp148 * _tmp86 + _tmp131 * _tmp145 * _tmp86 - _tmp164 * _tmp89 - _tmp165 * _tmp89;
  ...
  const Scalar _tmp171 =
      -_tmp168 * _tmp170 - std::sqrt(Scalar(std::pow(Scalar(-_tmp71 + p_b(0, 0)), Scalar(2)) +
  ...
  const Scalar _tmp177 = _tmp141 * _tmp176 * _tmp89;
  const Scalar _tmp178 = _tmp103 * _tmp31;
  const Scalar _tmp179 =
      (-_tmp163 * _tmp177 + _tmp167 * (-_tmp104 * _tmp178 + _tmp133 * _tmp155 - _tmp95)) /
      std::sqrt(Scalar(std::pow(_tmp163, Scalar(2)) * _tmp176 + 1));
  const Scalar _tmp180 = -_tmp118 * _tmp123 * _tmp52 - _tmp127 * _tmp131 * _tmp52 -
                         _tmp132 * _tmp134 - _tmp137 * _tmp139 + _tmp162 + _tmp34 * _tmp53;
  const Scalar _tmp181 =
      _tmp119 * _tmp123 * _tmp93 + _tmp128 * _tmp131 * _tmp93 + _tmp164 + _tmp165;
  ...
  const Scalar _tmp187 = (_tmp180 * _tmp186 + _tmp182 * (-_tmp134 * _tmp155 + _tmp178 - _tmp53)) /
                         std::sqrt(Scalar(std::pow(_tmp180, Scalar(2)) * _tmp185 + 1));
  const Scalar _tmp188 = Scalar(1.4083112389913199) * _tmp181;
  const Scalar _tmp189 = Scalar(0.71007031138673404) * _tmp182;
  const Scalar _tmp190 =
      -_tmp183 * _tmp188 - std::sqrt(Scalar(std::pow(Scalar(-_tmp61 + p_a(0, 0)), Scalar(2)) +
  ...
  _res(1, 0) = _tmp157 * (-Scalar(1.0) * _tmp156 * std::cosh(_tmp152) -
                          (-Scalar(0.71007031138673404) * _tmp154 * _tmp158 +
