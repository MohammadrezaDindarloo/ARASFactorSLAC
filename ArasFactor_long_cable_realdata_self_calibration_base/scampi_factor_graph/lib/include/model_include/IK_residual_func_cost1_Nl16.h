...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl16(
  ...
  const Scalar _tmp85 = -_tmp72 * _tmp74 + _tmp73;
  const Scalar _tmp86 = _tmp64 * _tmp76;
  const Scalar _tmp87 = _tmp39 * _tmp49 - _tmp49 * _tmp51 - _tmp78 * _tmp84 - _tmp85 * _tmp86;
  const Scalar _tmp88 = Scalar(1.0) / (_tmp87);
  const Scalar _tmp89 = _tmp79 * _tmp84 + _tmp82;
  const Scalar _tmp90 = 0;
  const Scalar _tmp91 = _tmp88 * _tmp90;
  const Scalar _tmp92 = _tmp72 * _tmp86;
  const Scalar _tmp93 =
  ...
  const Scalar _tmp98 = -_tmp41 * _tmp52 + _tmp45 * _tmp49 + _tmp49 * _tmp96 - _tmp86 * _tmp97;
  const Scalar _tmp99 = Scalar(1.0) / (_tmp98);
  const Scalar _tmp100 = Scalar(1.0) * _tmp99;
  const Scalar _tmp101 = _tmp29 - p_c(0, 0);
  const Scalar _tmp102 = _tmp19 - p_c(1, 0);
  ...
  const Scalar _tmp107 = _tmp62 * _tmp76;
  const Scalar _tmp108 = _tmp62 * _tmp77 + _tmp63;
  const Scalar _tmp109 = _tmp107 * _tmp85 - _tmp108 * _tmp84 - _tmp39;
  const Scalar _tmp110 = _tmp88 * _tmp98;
  const Scalar _tmp111 = _tmp87 * _tmp99;
  const Scalar _tmp112 = _tmp111 * (_tmp107 * _tmp97 - _tmp109 * _tmp110 - _tmp96);
  const Scalar _tmp113 = _tmp109 + _tmp112;
  const Scalar _tmp114 = _tmp49 * _tmp88;
  const Scalar _tmp115 = _tmp64 * _tmp88;
  const Scalar _tmp116 = -_tmp113 * _tmp115 - _tmp62;
  const Scalar _tmp117 = _tmp72 * _tmp76;
  const Scalar _tmp118 = _tmp104 * fh1;
  const Scalar _tmp119 = Scalar(1.0) * _tmp76;
  const Scalar _tmp120 = Scalar(1.0) * _tmp81;
  const Scalar _tmp121 = -_tmp119 * _tmp85 + _tmp120 * _tmp77 * _tmp83;
  const Scalar _tmp122 = _tmp111 * (-_tmp110 * _tmp121 - _tmp119 * _tmp97);
  const Scalar _tmp123 = _tmp121 + _tmp122;
  const Scalar _tmp124 = -_tmp115 * _tmp123 + Scalar(1.0);
  const Scalar _tmp125 = _tmp105 * fh1;
  const Scalar _tmp126 = -_tmp106 * _tmp94 * (_tmp100 * _tmp49 - _tmp100 * _tmp92) -
                         _tmp118 * _tmp94 * (_tmp113 * _tmp114 + _tmp116 * _tmp117 + Scalar(1.0)) -
                         _tmp125 * _tmp94 * (_tmp114 * _tmp123 + _tmp117 * _tmp124) -
                         _tmp37 * _tmp94 * (_tmp49 * _tmp91 - _tmp91 * _tmp92);
  const Scalar _tmp127 = Scalar(1.0) / (_tmp126);
  const Scalar _tmp128 = Scalar(0.71007031138673404) * _tmp127;
  const Scalar _tmp129 = _tmp45 + _tmp80;
  const Scalar _tmp130 = _tmp129 * _tmp84;
  const Scalar _tmp131 = Scalar(1.0) / (-_tmp130 - _tmp41 + _tmp82);
  const Scalar _tmp132 = Scalar(1.0) * _tmp131;
  const Scalar _tmp133 = _tmp129 * _tmp131;
  const Scalar _tmp134 = _tmp78 * _tmp88;
  const Scalar _tmp135 = _tmp108 + _tmp112 * _tmp133 - _tmp113 * _tmp134;
  const Scalar _tmp136 = _tmp111 * _tmp132;
  const Scalar _tmp137 = -_tmp100 * _tmp78 + _tmp129 * _tmp136;
  const Scalar _tmp138 = _tmp122 * _tmp133 - _tmp123 * _tmp134 - Scalar(1.0) * _tmp77;
  const Scalar _tmp139 = _tmp36 * fh1;
  const Scalar _tmp140 = _tmp104 * _tmp139 + Scalar(40.024799999999999) * _tmp24 + _tmp28 * fv1;
  const Scalar _tmp141 = _tmp129 * _tmp81;
  const Scalar _tmp142 = -_tmp105 * _tmp139 - Scalar(40.024799999999999) * _tmp12 - _tmp18 * fv1;
  const Scalar _tmp143 = _tmp130 * _tmp132 + Scalar(1.0);
  const Scalar _tmp144 = _tmp132 * _tmp84;
  const Scalar _tmp145 = _tmp131 * _tmp89;
  const Scalar _tmp146 = -_tmp129 * _tmp145 - _tmp134 * _tmp90 + _tmp80;
  const Scalar _tmp147 = std::asinh(
      _tmp127 * (Scalar(1.0) * _tmp106 * (-_tmp120 * _tmp137 + _tmp136) +
                 Scalar(1.0) * _tmp118 * (_tmp112 * _tmp132 - _tmp120 * _tmp135) +
                 Scalar(1.0) * _tmp125 * (-_tmp120 * _tmp138 + _tmp122 * _tmp132) +
                 Scalar(1.0) * _tmp140 * (_tmp132 * _tmp141 - _tmp132) +
                 Scalar(1.0) * _tmp142 * (-_tmp120 * _tmp143 + _tmp144) +
                 Scalar(1.0) * _tmp37 * (-_tmp120 * _tmp146 - _tmp132 * _tmp89 + Scalar(1.0))));
  const Scalar _tmp148 = Scalar(1.4083112389913199) * _tmp126;
  const Scalar _tmp149 = _tmp132 * _tmp140;
  const Scalar _tmp150 = _tmp37 * _tmp91;
  const Scalar _tmp151 = _tmp100 * _tmp106;
  const Scalar _tmp152 =
      _tmp116 * _tmp118 * _tmp76 + _tmp124 * _tmp125 * _tmp76 - _tmp150 * _tmp86 - _tmp151 * _tmp86;
  const Scalar _tmp153 = Scalar(1.0) / (_tmp152);
  const Scalar _tmp154 =
      std::asinh(_tmp153 * (_tmp106 * _tmp137 * _tmp81 + _tmp118 * _tmp135 * _tmp81 +
                            _tmp125 * _tmp138 * _tmp81 - _tmp141 * _tmp149 +
                            _tmp142 * _tmp143 * _tmp81 + _tmp146 * _tmp37 * _tmp81));
  const Scalar _tmp155 = Scalar(1.4083112389913199) * _tmp152;
  const Scalar _tmp156 = Scalar(0.71007031138673404) * _tmp153;
  const Scalar _tmp157 =
      _tmp113 * _tmp118 * _tmp88 + _tmp123 * _tmp125 * _tmp88 + _tmp150 + _tmp151;
  const Scalar _tmp158 = Scalar(1.0) / (_tmp157);
  const Scalar _tmp159 = std::asinh(_tmp158 * (-_tmp106 * _tmp136 - _tmp112 * _tmp118 * _tmp131 -
                                               _tmp122 * _tmp125 * _tmp131 - _tmp142 * _tmp144 +
                                               _tmp145 * _tmp37 + _tmp149));
  ...
  _res(1, 0) =
      -_tmp148 *
          (_tmp128 * p_d(2, 0) + std::cosh(Scalar(1.0) * _tmp147) -
           std::cosh(_tmp128 *
                     (-_tmp147 * _tmp148 -
                      std::sqrt(Scalar(std::pow(Scalar(-_tmp55 + p_d(0, 0)), Scalar(2)) +
  ...
  _res(2, 0) =
      -_tmp155 *
          (_tmp156 * p_a(2, 0) + std::cosh(Scalar(1.0) * _tmp154) -
           std::cosh(_tmp156 *
                     (-_tmp154 * _tmp155 -
                      std::sqrt(Scalar(std::pow(Scalar(-_tmp66 + p_a(0, 0)), Scalar(2)) +
