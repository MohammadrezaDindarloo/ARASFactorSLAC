...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl2(
  ...
  const Scalar _tmp25 = Scalar(0.20999999999999999) * _tmp12 + Scalar(0.20999999999999999) * _tmp24;
  ...
  const Scalar _tmp53 = _tmp43 + _tmp9;
  ...
  const Scalar _tmp91 = _tmp34 + _tmp38;
  const Scalar _tmp92 = _tmp69 * _tmp88;
  const Scalar _tmp93 = -_tmp69 * _tmp91 + _tmp92;
  const Scalar _tmp94 = _tmp68 * _tmp91 - _tmp71 * _tmp92;
  const Scalar _tmp95 = -_tmp71 * _tmp89 + _tmp73 * _tmp90 - _tmp75 * _tmp94;
  ...
  const Scalar _tmp100 = _tmp98 * (-_tmp61 + _tmp99);
  const Scalar _tmp101 = -_tmp100 * _tmp95 - _tmp48 * _tmp90 - _tmp75 * _tmp93 + _tmp89;
  ...
  const Scalar _tmp106 = _tmp105 * _tmp94 + _tmp71 * _tmp88;
  const Scalar _tmp107 = -_tmp100 * _tmp106 + _tmp105 * _tmp93 - _tmp88;
  const Scalar _tmp108 = _tmp102 * _tmp76;
  const Scalar _tmp109 = _tmp101 * _tmp77;
  const Scalar _tmp110 = _tmp109 * (_tmp105 * _tmp70 - _tmp107 * _tmp108 - _tmp60);
  const Scalar _tmp111 = _tmp107 + _tmp110;
  const Scalar _tmp112 = _tmp102 * _tmp74;
  const Scalar _tmp113 = -_tmp111 * _tmp112 - _tmp71;
  const Scalar _tmp114 = _tmp69 * _tmp72;
  const Scalar _tmp115 = _tmp102 * _tmp48;
  const Scalar _tmp116 = _tmp83 * fh1;
  const Scalar _tmp117 = Scalar(1.0) * _tmp72;
  const Scalar _tmp118 = _tmp117 * _tmp94;
  const Scalar _tmp119 = _tmp100 * _tmp118 - _tmp117 * _tmp93;
  const Scalar _tmp120 = _tmp109 * (-_tmp108 * _tmp119 - _tmp117 * _tmp70);
  const Scalar _tmp121 = _tmp119 + _tmp120;
  const Scalar _tmp122 = -_tmp112 * _tmp121 + Scalar(1.0);
  const Scalar _tmp123 = _tmp84 * fh1;
  const Scalar _tmp124 = -_tmp116 * _tmp59 * (_tmp111 * _tmp115 + _tmp113 * _tmp114 + Scalar(1.0)) -
                         _tmp123 * _tmp59 * (_tmp114 * _tmp122 + _tmp115 * _tmp121) -
                         _tmp59 * _tmp85 * (_tmp48 * _tmp78 - _tmp78 * _tmp79) -
                         _tmp59 * _tmp86 * (_tmp104 * _tmp48 - _tmp104 * _tmp79);
  const Scalar _tmp125 = Scalar(1.0) / (_tmp124);
  const Scalar _tmp126 = _tmp39 * fh1;
  const Scalar _tmp127 = _tmp126 * _tmp83 + Scalar(40.024799999999999) * _tmp28 + _tmp31 * fv1;
  const Scalar _tmp128 = _tmp44 + _tmp97;
  const Scalar _tmp129 = _tmp100 * _tmp128;
  const Scalar _tmp130 = Scalar(1.0) / (-_tmp129 - _tmp40 + _tmp99);
  const Scalar _tmp131 = Scalar(1.0) * _tmp130;
  const Scalar _tmp132 = _tmp128 * _tmp98;
  const Scalar _tmp133 = _tmp103 * _tmp130;
  const Scalar _tmp134 = -_tmp104 * _tmp95 - _tmp128 * _tmp133 + _tmp97;
  const Scalar _tmp135 = Scalar(1.0) * _tmp98;
  const Scalar _tmp136 = _tmp128 * _tmp130;
  const Scalar _tmp137 = _tmp102 * _tmp95;
  const Scalar _tmp138 = -_tmp118 + _tmp120 * _tmp136 - _tmp121 * _tmp137;
  const Scalar _tmp139 = -_tmp126 * _tmp84 - Scalar(40.024799999999999) * _tmp17 - _tmp20 * fv1;
  const Scalar _tmp140 = _tmp100 * _tmp131;
  const Scalar _tmp141 = _tmp98 * (_tmp129 * _tmp131 + Scalar(1.0));
  const Scalar _tmp142 = _tmp106 + _tmp110 * _tmp136 - _tmp111 * _tmp137;
  const Scalar _tmp143 = _tmp109 * _tmp131;
  const Scalar _tmp144 = _tmp128 * _tmp143 - _tmp78 * _tmp95;
  const Scalar _tmp145 = std::asinh(
      _tmp125 * (Scalar(1.0) * _tmp116 * (_tmp110 * _tmp131 - _tmp135 * _tmp142) +
                 Scalar(1.0) * _tmp123 * (_tmp120 * _tmp131 - _tmp135 * _tmp138) +
                 Scalar(1.0) * _tmp127 * (_tmp131 * _tmp132 - _tmp131) +
                 Scalar(1.0) * _tmp139 * (_tmp140 - Scalar(1.0) * _tmp141) +
                 Scalar(1.0) * _tmp85 * (-_tmp135 * _tmp144 + _tmp143) +
                 Scalar(1.0) * _tmp86 * (-_tmp103 * _tmp131 - _tmp134 * _tmp135 + Scalar(1.0))));
  const Scalar _tmp146 = Scalar(0.71007031138673404) * _tmp125;
  const Scalar _tmp147 = Scalar(1.4083112389913199) * _tmp124;
  const Scalar _tmp148 = _tmp78 * _tmp85;
  const Scalar _tmp149 = _tmp104 * _tmp86;
  const Scalar _tmp150 =
      _tmp113 * _tmp116 * _tmp72 + _tmp122 * _tmp123 * _tmp72 - _tmp148 * _tmp75 - _tmp149 * _tmp75;
  const Scalar _tmp151 = Scalar(1.0) / (_tmp150);
  const Scalar _tmp152 = _tmp127 * _tmp131;
  const Scalar _tmp153 = std::asinh(
      _tmp151 * (_tmp116 * _tmp142 * _tmp98 + _tmp123 * _tmp138 * _tmp98 - _tmp132 * _tmp152 +
                 _tmp134 * _tmp86 * _tmp98 + _tmp139 * _tmp141 + _tmp144 * _tmp85 * _tmp98));
  const Scalar _tmp154 = Scalar(0.71007031138673404) * _tmp151;
  const Scalar _tmp155 = Scalar(1.4083112389913199) * _tmp150;
  const Scalar _tmp156 =
      _tmp102 * _tmp111 * _tmp116 + _tmp102 * _tmp121 * _tmp123 + _tmp148 + _tmp149;
  const Scalar _tmp157 = Scalar(1.0) / (_tmp156);
  const Scalar _tmp158 = Scalar(0.71007031138673404) * _tmp157;
  const Scalar _tmp159 =
      std::asinh(_tmp157 * (-_tmp110 * _tmp116 * _tmp130 - _tmp120 * _tmp123 * _tmp130 +
                            _tmp133 * _tmp86 - _tmp139 * _tmp140 - _tmp143 * _tmp85 + _tmp152));
  ...
  _res(1, 0) =
      -_tmp147 *
          (_tmp146 * p_c(2, 0) + std::cosh(Scalar(1.0) * _tmp145) -
           std::cosh(_tmp146 *
                     (-_tmp145 * _tmp147 -
  ...
  _res(2, 0) =
      -_tmp155 *
          (_tmp154 * p_b(2, 0) + std::cosh(Scalar(1.0) * _tmp153) -
           std::cosh(_tmp154 *
                     (-_tmp153 * _tmp155 -
                      std::sqrt(Scalar(std::pow(Scalar(-_tmp62 + p_b(0, 0)), Scalar(2)) +
