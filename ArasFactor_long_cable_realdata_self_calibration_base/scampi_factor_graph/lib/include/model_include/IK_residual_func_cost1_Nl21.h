...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl21(
  ...
  const Scalar _tmp44 = _tmp40 + position_vector(1, 0);
  ...
  const Scalar _tmp62 = _tmp40 * _tmp47 - _tmp41 * _tmp48 + _tmp47 * _tmp61;
  ...
  const Scalar _tmp70 = _tmp64 * (-_tmp47 * _tmp66 + _tmp69);
  ...
  const Scalar _tmp78 = -Scalar(1.0) * _tmp70 + _tmp75 * _tmp77;
  const Scalar _tmp79 = _tmp34 + _tmp67;
  const Scalar _tmp80 = _tmp23 + _tmp49;
  ...
  const Scalar _tmp93 = -_tmp70 * _tmp89 - _tmp75 * _tmp92 - _tmp79 * _tmp87 + _tmp91;
  ...
  const Scalar _tmp106 = _tmp20 - p_d(1, 0);
  ...
  const Scalar _tmp111 = _tmp47 * _tmp90;
  const Scalar _tmp112 = _tmp105 * _tmp107;
  const Scalar _tmp113 = fh1 * (_tmp108 * _tmp30 - _tmp112 * _tmp19);
  ...
  const Scalar _tmp119 = -_tmp118 * _tmp75 + _tmp63 * _tmp70 - _tmp68;
  ...
  const Scalar _tmp124 = -_tmp109 * _tmp60 * (_tmp100 * _tmp104 + _tmp102 * _tmp103) -
                         _tmp113 * _tmp60 * (-_tmp110 * _tmp111 + _tmp110 * _tmp87) -
                         _tmp114 * _tmp60 * (-_tmp111 * _tmp116 + _tmp116 * _tmp87) -
  ...
  const Scalar _tmp132 = _tmp112 * _tmp131 + Scalar(40.024799999999999) * _tmp26 + _tmp30 * fv1;
  ...
  const Scalar _tmp142 = -_tmp108 * _tmp131 - Scalar(40.024799999999999) * _tmp16 - _tmp19 * fv1;
  ...
  _res(1, 0) =
      -_tmp147 *
          (_tmp146 * p_b(2, 0) + std::cosh(Scalar(1.0) * _tmp145) -
           std::cosh(_tmp146 *
                     (-_tmp145 * _tmp147 -
                      std::sqrt(Scalar(std::pow(Scalar(-_tmp51 + p_b(0, 0)), Scalar(2)) +
