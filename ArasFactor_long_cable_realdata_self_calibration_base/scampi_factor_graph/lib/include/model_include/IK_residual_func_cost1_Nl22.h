...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl22(
  ...
  const Scalar _tmp33 = -Scalar(0.010999999999999999) * _tmp26 -
  ...
  const Scalar _tmp58 = _tmp47 + _tmp7;
  ...
  const Scalar _tmp72 = _tmp32 + _tmp39;
  const Scalar _tmp73 = _tmp69 * _tmp70;
  const Scalar _tmp74 = Scalar(1.0) / (_tmp61 * _tmp71 - _tmp73);
  const Scalar _tmp75 = _tmp74 * (-_tmp63 * _tmp71 + _tmp71 * _tmp72);
  const Scalar _tmp76 = _tmp52 * _tmp72;
  const Scalar _tmp77 = _tmp61 * _tmp72;
  const Scalar _tmp78 = _tmp63 * _tmp73 - _tmp71 * _tmp77;
  const Scalar _tmp79 = _tmp62 * _tmp74;
  const Scalar _tmp80 = _tmp40 * _tmp53 - _tmp61 * _tmp76 - _tmp78 * _tmp79;
  ...
  const Scalar _tmp85 = _tmp84 * (-_tmp64 + _tmp81);
  const Scalar _tmp86 = -_tmp40 * _tmp52 - _tmp62 * _tmp75 + _tmp76 - _tmp80 * _tmp85;
  ...
  const Scalar _tmp95 = _tmp93 * (_tmp54 * _tmp60 * _tmp94 - _tmp56 * _tmp58 * _tmp94);
  const Scalar _tmp96 = -_tmp64 * _tmp73 + _tmp67 * _tmp71 + _tmp71 * _tmp95;
  const Scalar _tmp97 = Scalar(1.0) * _tmp74;
  const Scalar _tmp98 = _tmp78 * _tmp97;
  const Scalar _tmp99 = -Scalar(1.0) * _tmp75 + _tmp85 * _tmp98;
  const Scalar _tmp100 = -_tmp43 * _tmp53 + _tmp48 * _tmp52 + _tmp52 * _tmp95 - _tmp79 * _tmp96;
  ...
  const Scalar _tmp106 = _tmp52 * _tmp87;
  const Scalar _tmp107 = _tmp62 * _tmp87;
  ...
  const Scalar _tmp117 = fh1 * (_tmp113 * _tmp29 - _tmp116 * _tmp19);
  const Scalar _tmp118 = _tmp61 * _tmp74;
  const Scalar _tmp119 = _tmp118 * _tmp78 + _tmp77;
  const Scalar _tmp120 = -_tmp119 * _tmp85 + _tmp61 * _tmp75 - _tmp72;
  const Scalar _tmp121 = _tmp103 * (-_tmp101 * _tmp120 + _tmp118 * _tmp96 - _tmp95);
  const Scalar _tmp122 = _tmp120 + _tmp121;
  const Scalar _tmp123 = -_tmp107 * _tmp122 - _tmp61;
  const Scalar _tmp124 = _tmp116 * fh1;
  const Scalar _tmp125 = -_tmp114 * _tmp93 * (_tmp105 * _tmp106 + _tmp108 * _tmp109) -
                         _tmp117 * _tmp93 * (_tmp115 * _tmp52 - _tmp115 * _tmp91) -
                         _tmp124 * _tmp93 * (_tmp106 * _tmp122 + _tmp109 * _tmp123 + Scalar(1.0)) -
                         _tmp37 * _tmp93 * (_tmp52 * _tmp90 - _tmp90 * _tmp91);
  const Scalar _tmp126 = Scalar(1.0) / (_tmp125);
  const Scalar _tmp127 = _tmp48 + _tmp83;
  const Scalar _tmp128 = _tmp127 * _tmp85;
  const Scalar _tmp129 = Scalar(1.0) / (-_tmp128 - _tmp43 + _tmp81);
  const Scalar _tmp130 = Scalar(1.0) * _tmp129;
  const Scalar _tmp131 = _tmp127 * _tmp129;
  const Scalar _tmp132 = _tmp80 * _tmp87;
  const Scalar _tmp133 = _tmp104 * _tmp131 - _tmp105 * _tmp132 - _tmp98;
  const Scalar _tmp134 = Scalar(1.0) * _tmp84;
  const Scalar _tmp135 = _tmp36 * fh1;
  const Scalar _tmp136 = -_tmp113 * _tmp135 - Scalar(40.024799999999999) * _tmp16 - _tmp19 * fv1;
  const Scalar _tmp137 = _tmp128 * _tmp130 + Scalar(1.0);
  const Scalar _tmp138 = _tmp130 * _tmp85;
  const Scalar _tmp139 = _tmp119 + _tmp121 * _tmp131 - _tmp122 * _tmp132;
  const Scalar _tmp140 = _tmp103 * _tmp130;
  const Scalar _tmp141 = -_tmp115 * _tmp80 + _tmp127 * _tmp140;
  const Scalar _tmp142 = _tmp129 * _tmp88;
  const Scalar _tmp143 = -_tmp127 * _tmp142 - _tmp132 * _tmp89 + _tmp83;
  const Scalar _tmp144 = _tmp127 * _tmp84;
  const Scalar _tmp145 = _tmp116 * _tmp135 + Scalar(40.024799999999999) * _tmp24 + _tmp29 * fv1;
  const Scalar _tmp146 = std::asinh(
      _tmp126 * (Scalar(1.0) * _tmp114 * (_tmp104 * _tmp130 - _tmp133 * _tmp134) +
                 Scalar(1.0) * _tmp117 * (-_tmp134 * _tmp141 + _tmp140) +
                 Scalar(1.0) * _tmp124 * (_tmp121 * _tmp130 - _tmp134 * _tmp139) +
                 Scalar(1.0) * _tmp136 * (-_tmp134 * _tmp137 + _tmp138) +
                 Scalar(1.0) * _tmp145 * (_tmp130 * _tmp144 - _tmp130) +
                 Scalar(1.0) * _tmp37 * (-_tmp130 * _tmp88 - _tmp134 * _tmp143 + Scalar(1.0))));
  const Scalar _tmp147 = Scalar(1.4083112389913199) * _tmp125;
  const Scalar _tmp148 = Scalar(0.71007031138673404) * _tmp126;
  const Scalar _tmp149 = _tmp130 * _tmp145;
  const Scalar _tmp150 = _tmp115 * _tmp117;
  const Scalar _tmp151 = _tmp37 * _tmp90;
  const Scalar _tmp152 =
      _tmp108 * _tmp114 * _tmp74 + _tmp123 * _tmp124 * _tmp74 - _tmp150 * _tmp79 - _tmp151 * _tmp79;
  const Scalar _tmp153 = Scalar(1.0) / (_tmp152);
  const Scalar _tmp154 =
      std::asinh(_tmp153 * (_tmp114 * _tmp133 * _tmp84 + _tmp117 * _tmp141 * _tmp84 +
                            _tmp124 * _tmp139 * _tmp84 + _tmp136 * _tmp137 * _tmp84 +
                            _tmp143 * _tmp37 * _tmp84 - _tmp144 * _tmp149));
  const Scalar _tmp155 = Scalar(1.4083112389913199) * _tmp152;
  const Scalar _tmp156 = Scalar(0.71007031138673404) * _tmp153;
  const Scalar _tmp157 =
      _tmp105 * _tmp114 * _tmp87 + _tmp122 * _tmp124 * _tmp87 + _tmp150 + _tmp151;
  const Scalar _tmp158 = Scalar(1.0) / (_tmp157);
  const Scalar _tmp159 = std::asinh(_tmp158 * (-_tmp104 * _tmp114 * _tmp129 - _tmp117 * _tmp140 -
                                               _tmp121 * _tmp124 * _tmp129 - _tmp136 * _tmp138 +
                                               _tmp142 * _tmp37 + _tmp149));
  ...
  _res(0, 0) =
      -_tmp31 * (_tmp2 * p_d(2, 0) + std::cosh(Scalar(1.0) * _tmp1) -
                 std::cosh(_tmp2 *
                           (-_tmp1 * _tmp31 -
  ...
  _res(2, 0) =
      -_tmp155 *
          (_tmp156 * p_a(2, 0) + std::cosh(Scalar(1.0) * _tmp154) -
           std::cosh(_tmp156 *
                     (-_tmp154 * _tmp155 -
