...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl22(
  ...
  const Scalar _tmp47 = _tmp10 + _tmp15;
  ...
  const Scalar _tmp53 = _tmp34 + _tmp40;
  const Scalar _tmp54 = _tmp21 + _tmp42;
  const Scalar _tmp55 = _tmp54 + position_vector(0, 0);
  const Scalar _tmp56 = _tmp55 - p_a(0, 0);
  const Scalar _tmp57 = _tmp16 + _tmp46;
  ...
  const Scalar _tmp66 = _tmp20 + _tmp27;
  const Scalar _tmp67 = _tmp66 + position_vector(0, 0);
  const Scalar _tmp68 = _tmp67 - p_c(0, 0);
  const Scalar _tmp69 = Scalar(1.0) / (_tmp68);
  const Scalar _tmp70 = _tmp47 + _tmp5;
  const Scalar _tmp71 = _tmp70 + position_vector(1, 0);
  const Scalar _tmp72 = _tmp71 - p_c(1, 0);
  const Scalar _tmp73 = _tmp69 * _tmp72;
  const Scalar _tmp74 = _tmp52 * _tmp73 - _tmp65;
  const Scalar _tmp75 = _tmp59 * _tmp60;
  const Scalar _tmp76 = Scalar(1.0) / (_tmp61 * _tmp73 - _tmp75);
  const Scalar _tmp77 = _tmp74 * _tmp76;
  const Scalar _tmp78 = _tmp52 * _tmp62;
  const Scalar _tmp79 = _tmp53 * _tmp75 - _tmp63 * _tmp73;
  const Scalar _tmp80 = _tmp41 * _tmp65 - _tmp73 * _tmp78 - _tmp77 * _tmp79;
  ...
  const Scalar _tmp87 = -_tmp41 * _tmp52 - _tmp64 * _tmp77 + _tmp78 - _tmp80 * _tmp86;
  const Scalar _tmp88 = Scalar(1.0) / (_tmp87);
  const Scalar _tmp89 = _tmp81 * _tmp86 + _tmp84;
  const Scalar _tmp90 = 0;
  const Scalar _tmp91 = _tmp61 * _tmp77;
  const Scalar _tmp92 =
  ...
  const Scalar _tmp95 = _tmp93 * (_tmp66 * _tmp72 * _tmp94 - _tmp68 * _tmp70 * _tmp94);
  const Scalar _tmp96 = -_tmp54 * _tmp75 + _tmp57 * _tmp61 + _tmp61 * _tmp95;
  const Scalar _tmp97 = Scalar(1.0) * _tmp76;
  const Scalar _tmp98 = Scalar(1.0) * _tmp83;
  const Scalar _tmp99 = -_tmp64 * _tmp97 + _tmp76 * _tmp79 * _tmp85 * _tmp98;
  const Scalar _tmp100 = -_tmp43 * _tmp65 + _tmp48 * _tmp52 + _tmp52 * _tmp95 - _tmp77 * _tmp96;
  ...
  const Scalar _tmp106 = -_tmp105 * _tmp74 + Scalar(1.0);
  const Scalar _tmp107 = _tmp61 * _tmp76;
  ...
  const Scalar _tmp115 = fh1 * (_tmp111 * _tmp28 - _tmp114 * _tmp17);
  const Scalar _tmp116 = _tmp73 * _tmp76;
  const Scalar _tmp117 = _tmp116 * _tmp79 + _tmp62 * _tmp73;
  const Scalar _tmp118 = _tmp116 * _tmp64 - _tmp117 * _tmp86 - _tmp62;
  const Scalar _tmp119 = _tmp103 * (-_tmp101 * _tmp118 + _tmp116 * _tmp96 - _tmp95);
  const Scalar _tmp120 = _tmp88 * (_tmp118 + _tmp119);
  const Scalar _tmp121 = -_tmp120 * _tmp74 - _tmp73;
  const Scalar _tmp122 = _tmp114 * fh1;
  const Scalar _tmp123 = -_tmp112 * _tmp93 * (_tmp105 * _tmp52 + _tmp106 * _tmp107) -
                         _tmp115 * _tmp93 * (_tmp113 * _tmp52 - _tmp113 * _tmp91) -
                         _tmp122 * _tmp93 * (_tmp107 * _tmp121 + _tmp120 * _tmp52 + Scalar(1.0)) -
                         _tmp39 * _tmp93 * (_tmp52 * _tmp90 - _tmp90 * _tmp91);
  const Scalar _tmp124 = Scalar(1.0) / (_tmp123);
  const Scalar _tmp125 = _tmp48 + _tmp82;
  const Scalar _tmp126 = _tmp125 * _tmp86;
  const Scalar _tmp127 = Scalar(1.0) / (-_tmp126 - _tmp43 + _tmp84);
  const Scalar _tmp128 = Scalar(1.0) * _tmp127;
  const Scalar _tmp129 = _tmp125 * _tmp127;
  const Scalar _tmp130 = _tmp104 * _tmp129 - _tmp105 * _tmp80 - _tmp79 * _tmp97;
  const Scalar _tmp131 = _tmp38 * fh1;
  const Scalar _tmp132 = -_tmp111 * _tmp131 - Scalar(40.024799999999999) * _tmp14 - _tmp17 * fv1;
  const Scalar _tmp133 = _tmp126 * _tmp128 + Scalar(1.0);
  const Scalar _tmp134 = _tmp128 * _tmp86;
  const Scalar _tmp135 = _tmp117 + _tmp119 * _tmp129 - _tmp120 * _tmp80;
  const Scalar _tmp136 = _tmp103 * _tmp128;
  const Scalar _tmp137 = _tmp125 * _tmp128;
  const Scalar _tmp138 = _tmp103 * _tmp137 - _tmp113 * _tmp80;
  const Scalar _tmp139 = _tmp127 * _tmp89;
  const Scalar _tmp140 = -_tmp125 * _tmp139 - _tmp80 * _tmp90 + _tmp82;
  const Scalar _tmp141 = _tmp114 * _tmp131 + Scalar(40.024799999999999) * _tmp24 + _tmp28 * fv1;
  const Scalar _tmp142 = std::asinh(
      _tmp124 * (Scalar(1.0) * _tmp112 * (_tmp104 * _tmp128 - _tmp130 * _tmp98) +
                 Scalar(1.0) * _tmp115 * (_tmp136 - _tmp138 * _tmp98) +
                 Scalar(1.0) * _tmp122 * (_tmp119 * _tmp128 - _tmp135 * _tmp98) +
                 Scalar(1.0) * _tmp132 * (-_tmp133 * _tmp98 + _tmp134) +
                 Scalar(1.0) * _tmp141 * (-_tmp128 + _tmp137 * _tmp83) +
                 Scalar(1.0) * _tmp39 * (-_tmp128 * _tmp89 - _tmp140 * _tmp98 + Scalar(1.0))));
  const Scalar _tmp143 = Scalar(1.4083112389913199) * _tmp123;
  const Scalar _tmp144 = std::pow(Scalar(-_tmp67 + p_c(0, 0)), Scalar(2)) +
                         std::pow(Scalar(-_tmp71 + p_c(1, 0)), Scalar(2));
  const Scalar _tmp145 = std::pow(Scalar(-_tmp55 + p_a(0, 0)), Scalar(2)) +
                         std::pow(Scalar(-_tmp58 + p_a(1, 0)), Scalar(2));
  const Scalar _tmp146 = _tmp128 * _tmp141;
  const Scalar _tmp147 = _tmp113 * _tmp115;
  const Scalar _tmp148 = _tmp39 * _tmp90;
  const Scalar _tmp149 =
      _tmp106 * _tmp112 * _tmp76 + _tmp121 * _tmp122 * _tmp76 - _tmp147 * _tmp77 - _tmp148 * _tmp77;
  const Scalar _tmp150 = Scalar(1.0) / (_tmp149);
  const Scalar _tmp151 =
      std::asinh(_tmp150 * (_tmp112 * _tmp130 * _tmp83 + _tmp115 * _tmp138 * _tmp83 +
                            _tmp122 * _tmp135 * _tmp83 - _tmp125 * _tmp146 * _tmp83 +
                            _tmp132 * _tmp133 * _tmp83 + _tmp140 * _tmp39 * _tmp83));
  const Scalar _tmp152 = Scalar(1.4083112389913199) * _tmp149;
  const Scalar _tmp153 = _tmp105 * _tmp112 + _tmp120 * _tmp122 + _tmp147 + _tmp148;
  const Scalar _tmp154 = Scalar(1.0) / (_tmp153);
  const Scalar _tmp155 = std::asinh(_tmp154 * (-_tmp104 * _tmp112 * _tmp127 - _tmp115 * _tmp136 -
                                               _tmp119 * _tmp122 * _tmp127 - _tmp132 * _tmp134 +
                                               _tmp139 * _tmp39 + _tmp146));
  const Scalar _tmp156 = std::pow(Scalar(-_tmp44 + p_b(0, 0)), Scalar(2)) +
  ...
  _res(1, 0) =
      _tmp143 * (-std::sinh(Scalar(1.0) * _tmp142) -
                 std::sinh(Scalar(0.71007031138673404) * _tmp124 *
                           (-_tmp142 * _tmp143 - std::sqrt(_tmp144)))) -
      std::sqrt(Scalar(_tmp144 +
                       std::pow(Scalar(-_tmp62 + p_c(2, 0) - position_vector(2, 0)), Scalar(2))));
  _res(2, 0) =
      ...
      std::sqrt(Scalar(_tmp145 +
                       std::pow(Scalar(-_tmp53 + p_a(2, 0) - position_vector(2, 0)), Scalar(2))));
  _res(3, 0) =
      ...
      std::sqrt(Scalar(_tmp156 +
                       std::pow(Scalar(-_tmp41 + p_b(2, 0) - position_vector(2, 0)), Scalar(2))));
