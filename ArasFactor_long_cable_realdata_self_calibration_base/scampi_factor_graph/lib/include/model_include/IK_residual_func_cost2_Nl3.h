...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl3(
  ...
  const Scalar _tmp59 = _tmp44 - p_c(1, 0);
  ...
  const Scalar _tmp65 = _tmp34 + _tmp38;
  const Scalar _tmp66 = _tmp41 * _tmp60;
  const Scalar _tmp67 = _tmp56 * _tmp65 - _tmp61 * _tmp66;
  const Scalar _tmp68 = Scalar(1.0) * _tmp43;
  const Scalar _tmp69 = -_tmp68;
  const Scalar _tmp70 = Scalar(1.0) / (_tmp52 + _tmp69);
  const Scalar _tmp71 = Scalar(1.0) * _tmp70;
  const Scalar _tmp72 = _tmp41 * _tmp61 - _tmp61 * _tmp65;
  const Scalar _tmp73 = Scalar(1.0) * _tmp62;
  const Scalar _tmp74 = _tmp62 * _tmp64 * _tmp67 * _tmp71 - _tmp72 * _tmp73;
  const Scalar _tmp75 = _tmp35 + _tmp40;
  const Scalar _tmp76 = _tmp21 + _tmp45;
  const Scalar _tmp77 = _tmp76 + position_vector(0, 0);
  const Scalar _tmp78 = _tmp77 - p_b(0, 0);
  const Scalar _tmp79 = _tmp42 + _tmp6;
  ...
  const Scalar _tmp88 = -_tmp60 * _tmp84 - _tmp67 * _tmp87 + _tmp75 * _tmp85;
  const Scalar _tmp89 = _tmp64 * _tmp70;
  const Scalar _tmp90 = -_tmp72 * _tmp87 - _tmp75 * _tmp83 + _tmp84 - _tmp88 * _tmp89;
  ...
  const Scalar _tmp95 = _tmp94 * (-_tmp43 * _tmp57 * _tmp93 + _tmp46 * _tmp59 * _tmp93);
  const Scalar _tmp96 = -_tmp49 * _tmp56 + _tmp52 * _tmp61 + _tmp61 * _tmp95;
  ...
  const Scalar _tmp104 = _tmp86 * _tmp91;
  const Scalar _tmp105 = -_tmp102 * _tmp104 + Scalar(1.0);
  const Scalar _tmp106 = _tmp61 * _tmp62;
  ...
  const Scalar _tmp113 = _tmp61 * _tmp87;
  const Scalar _tmp114 = _tmp108 * _tmp109;
  const Scalar _tmp115 = fh1 * (_tmp110 * _tmp29 - _tmp114 * _tmp18);
  const Scalar _tmp116 = Scalar(333.54000000000002) - fv1;
  const Scalar _tmp117 = _tmp63 + _tmp68 * _tmp89;
  const Scalar _tmp118 = 0;
  const Scalar _tmp119 = _tmp60 * _tmp62;
  const Scalar _tmp120 = _tmp119 * _tmp67 + _tmp66;
  const Scalar _tmp121 = _tmp119 * _tmp72 - _tmp120 * _tmp89 - _tmp41;
  const Scalar _tmp122 = _tmp100 * (_tmp119 * _tmp96 - _tmp121 * _tmp98 - _tmp95);
  const Scalar _tmp123 = _tmp121 + _tmp122;
  const Scalar _tmp124 = -_tmp104 * _tmp123 - _tmp60;
  const Scalar _tmp125 = _tmp114 * fh1;
  const Scalar _tmp126 = -_tmp111 * _tmp94 * (_tmp102 * _tmp103 + _tmp105 * _tmp106) -
                         _tmp115 * _tmp94 * (-_tmp112 * _tmp113 + _tmp112 * _tmp83) -
                         _tmp116 * _tmp94 * (-_tmp113 * _tmp118 + _tmp118 * _tmp83) -
                         _tmp125 * _tmp94 * (_tmp103 * _tmp123 + _tmp106 * _tmp124 + Scalar(1.0));
  const Scalar _tmp127 = Scalar(1.0) / (_tmp126);
  const Scalar _tmp128 = _tmp69 + _tmp79;
  const Scalar _tmp129 = _tmp128 * _tmp89;
  const Scalar _tmp130 = Scalar(1.0) / (-_tmp129 + _tmp63 - _tmp76);
  const Scalar _tmp131 = Scalar(1.0) * _tmp130;
  const Scalar _tmp132 = _tmp128 * _tmp70;
  const Scalar _tmp133 = _tmp39 * fh1;
  const Scalar _tmp134 = _tmp114 * _tmp133 + Scalar(40.024799999999999) * _tmp24 + _tmp29 * fv1;
  const Scalar _tmp135 = _tmp117 * _tmp130;
  const Scalar _tmp136 = _tmp70 * (-_tmp118 * _tmp88 - _tmp128 * _tmp135 + _tmp69);
  const Scalar _tmp137 = _tmp128 * _tmp130;
  const Scalar _tmp138 = _tmp88 * _tmp91;
  const Scalar _tmp139 = _tmp101 * _tmp137 - _tmp102 * _tmp138 - _tmp67 * _tmp73;
  const Scalar _tmp140 = _tmp100 * _tmp131;
  const Scalar _tmp141 = -_tmp112 * _tmp88 + _tmp128 * _tmp140;
  const Scalar _tmp142 = -_tmp110 * _tmp133 - Scalar(40.024799999999999) * _tmp12 - _tmp18 * fv1;
  const Scalar _tmp143 = _tmp131 * _tmp89;
  const Scalar _tmp144 = _tmp129 * _tmp131 + Scalar(1.0);
  const Scalar _tmp145 = _tmp120 + _tmp122 * _tmp137 - _tmp123 * _tmp138;
  const Scalar _tmp146 =
      std::asinh(_tmp127 * (Scalar(1.0) * _tmp111 * (_tmp101 * _tmp131 - _tmp139 * _tmp71) +
                            Scalar(1.0) * _tmp115 * (_tmp140 - _tmp141 * _tmp71) +
                            Scalar(1.0) * _tmp116 *
                                (-_tmp117 * _tmp131 - Scalar(1.0) * _tmp136 + Scalar(1.0)) +
                            Scalar(1.0) * _tmp125 * (_tmp122 * _tmp131 - _tmp145 * _tmp71) +
                            Scalar(1.0) * _tmp134 * (_tmp131 * _tmp132 - _tmp131) +
                            Scalar(1.0) * _tmp142 * (_tmp143 - _tmp144 * _tmp71)));
  ...
  const Scalar _tmp151 =
      _tmp105 * _tmp111 * _tmp62 + _tmp124 * _tmp125 * _tmp62 - _tmp149 * _tmp87 - _tmp150 * _tmp87;
  const Scalar _tmp152 = Scalar(1.0) / (_tmp151);
  const Scalar _tmp153 = std::asinh(
      _tmp152 * (_tmp111 * _tmp139 * _tmp70 + _tmp115 * _tmp141 * _tmp70 + _tmp116 * _tmp136 +
                 _tmp125 * _tmp145 * _tmp70 - _tmp132 * _tmp148 + _tmp142 * _tmp144 * _tmp70));
  const Scalar _tmp154 = std::pow(Scalar(-_tmp50 + p_d(0, 0)), Scalar(2)) +
                         std::pow(Scalar(-_tmp53 + p_d(1, 0)), Scalar(2));
  const Scalar _tmp155 = Scalar(1.4083112389913199) * _tmp151;
  const Scalar _tmp156 = std::pow(Scalar(-_tmp77 + p_b(0, 0)), Scalar(2)) +
                         std::pow(Scalar(-_tmp80 + p_b(1, 0)), Scalar(2));
  const Scalar _tmp157 =
      _tmp102 * _tmp111 * _tmp91 + _tmp123 * _tmp125 * _tmp91 + _tmp149 + _tmp150;
  const Scalar _tmp158 = Scalar(1.0) / (_tmp157);
  const Scalar _tmp159 =
      std::asinh(_tmp158 * (-_tmp101 * _tmp111 * _tmp130 - _tmp115 * _tmp140 + _tmp116 * _tmp135 -
                            _tmp122 * _tmp125 * _tmp130 - _tmp142 * _tmp143 + _tmp148));
