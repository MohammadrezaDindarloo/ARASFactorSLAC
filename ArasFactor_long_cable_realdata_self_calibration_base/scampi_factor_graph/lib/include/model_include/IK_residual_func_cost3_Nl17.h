...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl17(
  ...
  const Scalar _tmp55 = _tmp14 + _tmp43;
  const Scalar _tmp56 = _tmp22 + _tmp34;
  const Scalar _tmp57 = _tmp56 - p_a(0, 0) + position_vector(0, 0);
  const Scalar _tmp58 = _tmp26 + _tmp39;
  ...
  const Scalar _tmp63 = _tmp42 * _tmp61 - _tmp62;
  const Scalar _tmp64 = _tmp51 * _tmp63;
  const Scalar _tmp65 = _tmp44 * _tmp61;
  const Scalar _tmp66 = -_tmp50 * (-_tmp42 * _tmp65 - _tmp47 * _tmp64 + _tmp55 * _tmp62) -
  ...
  const Scalar _tmp72 = -_tmp23 * _tmp33 + _tmp30 * _tmp45 + _tmp45 * _tmp71;
  ...
  const Scalar _tmp77 = _tmp54 + _tmp76 * (-_tmp52 * _tmp72 - _tmp54 * _tmp74);
  ...
  const Scalar _tmp95 = -_tmp44 - _tmp50 * (_tmp42 * _tmp44 + _tmp47 * _tmp94) + _tmp53 * _tmp94;
  const Scalar _tmp96 = _tmp76 * (-_tmp71 + _tmp72 * _tmp94 - _tmp74 * _tmp95) + _tmp95;
  ...
  const Scalar _tmp101 = fh1 * (_tmp82 * _tmp87 - _tmp84 * _tmp98);
  ...
  _res(1, 0) = std::exp(_tmp101 * _tmp70 * (-_tmp100 * _tmp45 * _tmp64 + _tmp100 * _tmp61) +
                        _tmp70 * _tmp88 * (_tmp77 * _tmp81 + _tmp79 * _tmp80) +
                        _tmp70 * _tmp89 * (_tmp61 * _tmp93 - _tmp80 * _tmp92) +
                        _tmp70 * _tmp99 * (_tmp80 * _tmp97 + _tmp81 * _tmp96 + Scalar(1.0)));
  _res(2, 0) = std::exp(_tmp102 * _tmp64 - _tmp51 * _tmp79 * _tmp88 + _tmp51 * _tmp89 * _tmp92 -
                        _tmp51 * _tmp97 * _tmp99);
  _res(3, 0) =
      std::exp(-_tmp102 - _tmp67 * _tmp77 * _tmp88 - _tmp67 * _tmp96 * _tmp99 - _tmp89 * _tmp93);
