...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl9(
  ...
  const Scalar _tmp95 = _tmp45 * _tmp47 + _tmp46;
  const Scalar _tmp96 = 0;
  const Scalar _tmp97 = Scalar(1.0) * _tmp74;
  const Scalar _tmp98 = _tmp49 * _tmp61 * _tmp74;
  ...
  _res(1, 0) = std::exp(_tmp69 * _tmp87 * (_tmp76 * _tmp80 + _tmp78 * _tmp79) +
                        _tmp69 * _tmp93 * (_tmp79 * _tmp91 + _tmp80 * _tmp90 + Scalar(1.0)) +
                        _tmp69 * _tmp94 * (-_tmp42 * _tmp62 * _tmp96 + _tmp60 * _tmp96) +
                        _tmp69 * _tmp99 * (-_tmp42 * _tmp98 + _tmp60 * _tmp97));
  _res(2, 0) = std::exp(_tmp100 * _tmp62 - _tmp48 * _tmp78 * _tmp87 - _tmp48 * _tmp91 * _tmp93 +
                        _tmp98 * _tmp99);
  _res(3, 0) =
      std::exp(-_tmp100 - _tmp66 * _tmp76 * _tmp87 - _tmp66 * _tmp90 * _tmp93 - _tmp97 * _tmp99);
