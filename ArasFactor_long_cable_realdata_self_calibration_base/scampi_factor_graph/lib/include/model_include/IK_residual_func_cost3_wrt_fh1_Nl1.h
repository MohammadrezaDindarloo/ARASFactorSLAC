...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl1(
  ...
  const Scalar _tmp28 = Scalar(0.20999999999999999) * _tmp8 - Scalar(0.20999999999999999) * _tmp9;
  const Scalar _tmp29 =
  ...
  const Scalar _tmp42 = _tmp28 + _tmp29 - _tmp30;
  ...
  const Scalar _tmp53 = _tmp27 * _tmp51 - _tmp52;
  const Scalar _tmp54 = _tmp39 * _tmp40;
  const Scalar _tmp55 = Scalar(1.0) / (_tmp41 * _tmp51 - _tmp54);
  const Scalar _tmp56 = _tmp53 * _tmp55;
  const Scalar _tmp57 = _tmp42 * _tmp51;
  const Scalar _tmp58 = _tmp33 * _tmp54 - _tmp41 * _tmp57;
  const Scalar _tmp59 = _tmp27 * _tmp42;
  ...
  const Scalar _tmp63 = -_tmp27 * _tmp32 - _tmp43 * _tmp56 + _tmp59 -
                        _tmp62 * (_tmp32 * _tmp52 - _tmp51 * _tmp59 - _tmp56 * _tmp58);
  ...
  const Scalar _tmp68 = _tmp67 * (_tmp45 * _tmp50 * _tmp66 - _tmp46 * _tmp49 * _tmp66);
  const Scalar _tmp69 = _tmp55 * _tmp58;
  const Scalar _tmp70 = _tmp43 * _tmp55;
  const Scalar _tmp71 = -_tmp42 + _tmp51 * _tmp70 - _tmp62 * (_tmp51 * _tmp69 + _tmp57);
  const Scalar _tmp72 = _tmp55 * (-_tmp35 * _tmp54 + _tmp38 * _tmp41 + _tmp41 * _tmp68);
  const Scalar _tmp73 = -_tmp15 * _tmp52 + _tmp24 * _tmp27 + _tmp27 * _tmp68 - _tmp53 * _tmp72;
  const Scalar _tmp74 = _tmp64 * _tmp73;
  const Scalar _tmp75 = Scalar(1.0) / (_tmp73);
  const Scalar _tmp76 = _tmp63 * _tmp75;
  const Scalar _tmp77 = _tmp71 + _tmp76 * (_tmp51 * _tmp72 - _tmp68 - _tmp71 * _tmp74);
  const Scalar _tmp78 = _tmp64 * _tmp77;
  const Scalar _tmp79 = _tmp53 * _tmp64;
  const Scalar _tmp80 = _tmp55 * (-_tmp51 - _tmp77 * _tmp79);
  const Scalar _tmp81 = _tmp34 + _tmp44;
  const Scalar _tmp82 = _tmp81 - p_a(0, 0) + position_vector(0, 0);
  const Scalar _tmp83 = _tmp37 + _tmp48;
  ...
  const Scalar _tmp87 = _tmp67 * _tmp86 * (_tmp27 * _tmp78 + _tmp41 * _tmp80 + Scalar(1.0));
  const Scalar _tmp88 = _tmp84 * _tmp85;
  const Scalar _tmp89 = _tmp81 * _tmp88 - _tmp83 * _tmp86;
  const Scalar _tmp90 = Scalar(1.0) * _tmp75;
  const Scalar _tmp91 = _tmp67 * _tmp89 * (_tmp27 * _tmp90 - _tmp41 * _tmp56 * _tmp90);
  const Scalar _tmp92 = Scalar(1.0) * _tmp62 * _tmp69 - Scalar(1.0) * _tmp70;
  const Scalar _tmp93 = _tmp76 * (-Scalar(1.0) * _tmp72 - _tmp74 * _tmp92) + _tmp92;
  const Scalar _tmp94 = _tmp55 * (-_tmp79 * _tmp93 + Scalar(1.0));
  const Scalar _tmp95 = _tmp64 * _tmp93;
  const Scalar _tmp96 = _tmp67 * _tmp88 * (_tmp27 * _tmp95 + _tmp41 * _tmp94);
  const Scalar _tmp97 = Scalar(333.54000000000002) - fv1;
  const Scalar _tmp98 = _tmp60 + _tmp61 * _tmp62;
  const Scalar _tmp99 = 0;
  const Scalar _tmp100 = _tmp55 * _tmp79 * _tmp99;
  const Scalar _tmp101 = _tmp64 * _tmp99;
  const Scalar _tmp102 = _tmp88 * _tmp94;
  const Scalar _tmp103 = _tmp80 * _tmp86;
  const Scalar _tmp104 = _tmp89 * _tmp90;
  const Scalar _tmp105 = _tmp104 * fh1;
  const Scalar _tmp106 = _tmp88 * _tmp95;
  ...
  _res(1, 0) = -(-_tmp87 - _tmp91 - _tmp96) *
               std::exp(_tmp67 * _tmp97 * (-_tmp100 * _tmp41 + _tmp101 * _tmp27) + _tmp87 * fh1 +
                        _tmp91 * fh1 + _tmp96 * fh1);
  _res(2, 0) = -(_tmp102 + _tmp103 - _tmp104 * _tmp56) *
               std::exp(_tmp100 * _tmp97 - _tmp102 * fh1 - _tmp103 * fh1 + _tmp105 * _tmp56);
