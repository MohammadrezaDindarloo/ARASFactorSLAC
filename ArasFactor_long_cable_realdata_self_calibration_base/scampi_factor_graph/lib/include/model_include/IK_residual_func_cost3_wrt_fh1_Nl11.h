...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl11(
  ...
  const Scalar _tmp50 = -_tmp27 * _tmp47 + _tmp27 * _tmp49;
  const Scalar _tmp51 = _tmp35 * _tmp49;
  const Scalar _tmp52 = -_tmp27 * _tmp51 + _tmp36 * _tmp47;
  ...
  const Scalar _tmp56 = -_tmp43 * _tmp50 + _tmp43 * _tmp52 * _tmp55;
  const Scalar _tmp57 = -_tmp46 + _tmp48;
  const Scalar _tmp58 = _tmp10 - _tmp13;
  const Scalar _tmp59 = _tmp28 + _tmp58;
  const Scalar _tmp60 = _tmp59 - p_a(0, 0) + position_vector(0, 0);
  const Scalar _tmp61 = -_tmp19 + _tmp22;
  ...
  const Scalar _tmp69 = _tmp49 * _tmp65 - _tmp50 * _tmp68 -
                        _tmp55 * (-_tmp51 * _tmp65 - _tmp52 * _tmp68 + _tmp57 * _tmp66) -
                        _tmp57 * _tmp65;
  const Scalar _tmp70 = Scalar(1.0) / (_tmp69);
  const Scalar _tmp71 = _tmp41 * _tmp65 - _tmp42 * _tmp68 - _tmp59 * _tmp66 + _tmp62 * _tmp65;
  const Scalar _tmp72 = _tmp70 * _tmp71;
  const Scalar _tmp73 = Scalar(1.0) / (_tmp71);
  const Scalar _tmp74 = _tmp69 * _tmp73;
  const Scalar _tmp75 = _tmp56 + _tmp74 * (-_tmp42 * _tmp43 - _tmp56 * _tmp72);
  const Scalar _tmp76 = _tmp67 * _tmp70;
  const Scalar _tmp77 = _tmp37 * (-_tmp75 * _tmp76 + Scalar(1.0));
  const Scalar _tmp78 = _tmp70 * _tmp75;
  const Scalar _tmp79 = _tmp4 + _tmp58;
  const Scalar _tmp80 = _tmp79 - p_b(0, 0) + position_vector(0, 0);
  const Scalar _tmp81 = _tmp17 + _tmp61;
  const Scalar _tmp82 = _tmp81 - p_b(1, 0) + position_vector(1, 0);
  const Scalar _tmp83 = std::pow(Scalar(std::pow(_tmp80, Scalar(2)) + std::pow(_tmp82, Scalar(2))),
                                 Scalar(Scalar(-1) / Scalar(2)));
  const Scalar _tmp84 = _tmp82 * _tmp83;
  const Scalar _tmp85 = _tmp40 * _tmp84 * (_tmp27 * _tmp77 + _tmp65 * _tmp78);
  const Scalar _tmp86 = _tmp35 * _tmp37;
  const Scalar _tmp87 = -_tmp49 + _tmp50 * _tmp86 - _tmp55 * (_tmp51 + _tmp52 * _tmp86);
  const Scalar _tmp88 = _tmp74 * (-_tmp41 + _tmp42 * _tmp86 - _tmp72 * _tmp87) + _tmp87;
  const Scalar _tmp89 = _tmp70 * _tmp88;
  const Scalar _tmp90 = _tmp37 * (-_tmp35 - _tmp76 * _tmp88);
  const Scalar _tmp91 = _tmp80 * _tmp83;
  const Scalar _tmp92 = _tmp40 * _tmp91 * (_tmp27 * _tmp90 + _tmp65 * _tmp89 + Scalar(1.0));
  ...
  const Scalar _tmp97 = _tmp79 * _tmp84 - _tmp81 * _tmp91;
  const Scalar _tmp98 = Scalar(1.0) * _tmp73;
  const Scalar _tmp99 = _tmp40 * _tmp97 * (_tmp65 * _tmp98 - _tmp96 * _tmp98);
  const Scalar _tmp100 = _tmp97 * _tmp98;
  const Scalar _tmp101 = _tmp100 * fh1;
  const Scalar _tmp102 = _tmp90 * _tmp91;
  const Scalar _tmp103 = _tmp77 * _tmp84;
  ...
  _res(1, 0) = -(-_tmp85 - _tmp92 - _tmp99) *
               std::exp(_tmp40 * _tmp93 * (_tmp65 * _tmp95 - _tmp95 * _tmp96) + _tmp85 * fh1 +
