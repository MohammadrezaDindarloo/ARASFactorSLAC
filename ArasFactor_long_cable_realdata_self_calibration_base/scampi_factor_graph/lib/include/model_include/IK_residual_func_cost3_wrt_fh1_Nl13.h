...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl13(
  ...
  const Scalar _tmp46 = _tmp14 + _tmp37;
  ...
  const Scalar _tmp52 = _tmp32 + _tmp35;
  const Scalar _tmp53 = _tmp40 * _tmp44;
  const Scalar _tmp54 = _tmp52 * _tmp53;
  const Scalar _tmp55 = _tmp36 * _tmp45 - _tmp51 * _tmp54;
  const Scalar _tmp56 = _tmp28 * _tmp51 - _tmp34;
  const Scalar _tmp57 = Scalar(1.0) / (-_tmp45 + _tmp51 * _tmp53);
  const Scalar _tmp58 = _tmp56 * _tmp57;
  const Scalar _tmp59 = _tmp28 * _tmp52;
  ...
  const Scalar _tmp63 = -_tmp36 * _tmp53 + _tmp54;
  const Scalar _tmp64 = -_tmp28 * _tmp33 - _tmp58 * _tmp63 + _tmp59 -
                        _tmp62 * (_tmp33 * _tmp34 - _tmp51 * _tmp59 - _tmp55 * _tmp58);
  const Scalar _tmp65 = Scalar(1.0) / (_tmp64);
  const Scalar _tmp66 = Scalar(1.0) * _tmp57;
  const Scalar _tmp67 = _tmp55 * _tmp62 * _tmp66 - _tmp63 * _tmp66;
  const Scalar _tmp68 =
      std::sqrt(Scalar(std::pow(_tmp47, Scalar(2)) + std::pow(_tmp50, Scalar(2))));
  const Scalar _tmp69 = Scalar(1.0) / (_tmp68);
  const Scalar _tmp70 = _tmp48 * _tmp68;
  const Scalar _tmp71 = _tmp70 * (_tmp46 * _tmp50 * _tmp69 - _tmp47 * _tmp49 * _tmp69);
  const Scalar _tmp72 = -_tmp39 * _tmp45 + _tmp42 * _tmp53 + _tmp53 * _tmp71;
  const Scalar _tmp73 = -_tmp15 * _tmp34 + _tmp25 * _tmp28 + _tmp28 * _tmp71 - _tmp58 * _tmp72;
  ...
  const Scalar _tmp80 = _tmp57 * (-_tmp77 * _tmp79 + Scalar(1.0));
  const Scalar _tmp81 = _tmp38 + _tmp4;
  const Scalar _tmp82 = _tmp81 - p_c(0, 0) + position_vector(0, 0);
  const Scalar _tmp83 = _tmp18 + _tmp24;
  ...
  const Scalar _tmp87 = _tmp70 * _tmp86 * (_tmp28 * _tmp78 + _tmp53 * _tmp80);
  const Scalar _tmp88 = _tmp51 * _tmp57;
  const Scalar _tmp89 = -_tmp52 - _tmp62 * (_tmp51 * _tmp52 + _tmp55 * _tmp88) + _tmp63 * _tmp88;
  const Scalar _tmp90 = _tmp76 * (-_tmp71 + _tmp72 * _tmp88 - _tmp74 * _tmp89) + _tmp89;
  const Scalar _tmp91 = _tmp57 * (-_tmp51 - _tmp79 * _tmp90);
  const Scalar _tmp92 = _tmp65 * _tmp90;
  const Scalar _tmp93 = _tmp82 * _tmp85;
  const Scalar _tmp94 = _tmp70 * _tmp93 * (_tmp28 * _tmp92 + _tmp53 * _tmp91 + Scalar(1.0));
  const Scalar _tmp95 = Scalar(333.54000000000002) - fv1;
  const Scalar _tmp96 = _tmp60 * _tmp62 + _tmp61;
  const Scalar _tmp97 = 0;
  const Scalar _tmp98 = _tmp53 * _tmp58;
  const Scalar _tmp99 = _tmp81 * _tmp86 - _tmp83 * _tmp93;
  const Scalar _tmp100 = Scalar(1.0) * _tmp75;
  const Scalar _tmp101 = _tmp70 * _tmp99 * (_tmp100 * _tmp28 - _tmp100 * _tmp98);
  ...
  const Scalar _tmp106 = _tmp80 * _tmp86;
  ...
  _res(1, 0) = -(-_tmp101 - _tmp87 - _tmp94) *
               std::exp(_tmp101 * fh1 + _tmp70 * _tmp95 * (_tmp28 * _tmp97 - _tmp97 * _tmp98) +
