...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl2(
  ...
  const Scalar _tmp27 = _tmp16 - p_a(1, 0) + position_vector(1, 0);
  ...
  const Scalar _tmp40 = _tmp18 + _tmp32;
  const Scalar _tmp41 = _tmp40 - p_c(0, 0) + position_vector(0, 0);
  const Scalar _tmp42 = _tmp35 + _tmp6;
  ...
  const Scalar _tmp52 = _tmp18 + _tmp24;
  const Scalar _tmp53 = _tmp52 - p_b(0, 0) + position_vector(0, 0);
  const Scalar _tmp54 = _tmp15 + _tmp6;
  ...
  const Scalar _tmp61 = -_tmp33 * _tmp49 + _tmp36 * _tmp39 + _tmp39 * _tmp48 - _tmp51 * _tmp60;
  const Scalar _tmp62 = Scalar(1.0) / (_tmp61);
  const Scalar _tmp63 = Scalar(1.0) * _tmp62;
  const Scalar _tmp64 = _tmp51 * _tmp59;
  const Scalar _tmp65 = _tmp31 * _tmp47 * (_tmp39 * _tmp63 - _tmp58 * _tmp63 * _tmp64);
  ...
  const Scalar _tmp75 = _tmp59 * (-_tmp58 * _tmp73 + _tmp74);
  const Scalar _tmp76 = _tmp50 * _tmp71;
  const Scalar _tmp77 = _tmp59 * (-_tmp50 * _tmp74 + _tmp57 * _tmp73);
  const Scalar _tmp78 = Scalar(1.0) * _tmp42;
  const Scalar _tmp79 = Scalar(1.0) * _tmp40;
  const Scalar _tmp80 = (-_tmp52 + _tmp79) / (_tmp54 - _tmp78);
  const Scalar _tmp81 = _tmp39 * _tmp71 - _tmp39 * _tmp72 - _tmp51 * _tmp75 -
                        _tmp80 * (-_tmp39 * _tmp76 + _tmp49 * _tmp72 - _tmp51 * _tmp77);
  const Scalar _tmp82 = Scalar(1.0) / (_tmp81);
  const Scalar _tmp83 = _tmp78 * _tmp80 + _tmp79;
  ...
  const Scalar _tmp88 = _tmp50 * _tmp75 - _tmp71 - _tmp80 * (_tmp50 * _tmp77 + _tmp76);
  const Scalar _tmp89 = _tmp61 * _tmp82;
  const Scalar _tmp90 = _tmp62 * _tmp81;
  const Scalar _tmp91 = _tmp88 + _tmp90 * (-_tmp48 + _tmp50 * _tmp60 - _tmp88 * _tmp89);
  const Scalar _tmp92 = _tmp59 * (-_tmp50 - _tmp86 * _tmp91);
  const Scalar _tmp93 = _tmp82 * _tmp91;
  const Scalar _tmp94 = _tmp29 * _tmp47 * (_tmp39 * _tmp93 + _tmp58 * _tmp92 + Scalar(1.0));
  const Scalar _tmp95 = -Scalar(1.0) * _tmp75 + Scalar(1.0) * _tmp77 * _tmp80;
  const Scalar _tmp96 = _tmp90 * (-Scalar(1.0) * _tmp60 - _tmp89 * _tmp95) + _tmp95;
  const Scalar _tmp97 = _tmp59 * (-_tmp86 * _tmp96 + Scalar(1.0));
  const Scalar _tmp98 = _tmp82 * _tmp96;
  const Scalar _tmp99 = _tmp30 * _tmp47 * (_tmp39 * _tmp98 + _tmp58 * _tmp97);
  const Scalar _tmp100 = _tmp31 * _tmp63;
  const Scalar _tmp101 = _tmp100 * fh1;
  const Scalar _tmp102 = _tmp29 * _tmp92;
  const Scalar _tmp103 = _tmp30 * _tmp97;
  const Scalar _tmp104 = _tmp29 * _tmp93;
  const Scalar _tmp105 = _tmp30 * _tmp98;

  // Output terms (1)
  Eigen::Matrix<Scalar, 4, 1> _res;

  _res(0, 0) = -std::exp(-fh1);
  _res(1, 0) = -(-_tmp65 - _tmp94 - _tmp99) *
               std::exp(_tmp47 * _tmp66 * (_tmp39 * _tmp85 - _tmp58 * _tmp87) + _tmp65 * fh1 +
                        _tmp94 * fh1 + _tmp99 * fh1);
  _res(2, 0) = -(-_tmp100 * _tmp64 + _tmp102 + _tmp103) *
               std::exp(_tmp101 * _tmp64 - _tmp102 * fh1 - _tmp103 * fh1 + _tmp66 * _tmp87);
  _res(3, 0) = -(_tmp100 + _tmp104 + _tmp105) *
               std::exp(-_tmp101 - _tmp104 * fh1 - _tmp105 * fh1 - _tmp66 * _tmp85);
