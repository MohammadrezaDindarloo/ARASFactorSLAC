...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl7(
  ...
  const Scalar _tmp46 = _tmp29 * _tmp43 - _tmp37 * _tmp45;
  const Scalar _tmp47 = Scalar(1.0) * _tmp38;
  const Scalar _tmp48 = Scalar(1.0) * _tmp35;
  const Scalar _tmp49 = Scalar(1.0) * _tmp31;
  const Scalar _tmp50 = (-_tmp16 + _tmp49) / (_tmp25 - _tmp48);
  const Scalar _tmp51 = -_tmp28 * _tmp43 + _tmp45;
  const Scalar _tmp52 = _tmp46 * _tmp47 * _tmp50 - _tmp47 * _tmp51;
  const Scalar _tmp53 = _tmp15 + _tmp4;
  const Scalar _tmp54 = _tmp53 - p_c(0, 0) + position_vector(0, 0);
  const Scalar _tmp55 = _tmp22 + _tmp23;
  ...
  const Scalar _tmp61 = _tmp39 + _tmp40 + _tmp41;
  const Scalar _tmp62 = _tmp57 * _tmp58;
  const Scalar _tmp63 = _tmp37 * _tmp59 - _tmp62;
  const Scalar _tmp64 = _tmp38 * _tmp63;
  const Scalar _tmp65 = -_tmp50 * (-_tmp37 * _tmp60 - _tmp46 * _tmp64 + _tmp61 * _tmp62) -
                        _tmp51 * _tmp64 - _tmp59 * _tmp61 + _tmp60;
  const Scalar _tmp66 = Scalar(1.0) / (_tmp65);
  const Scalar _tmp67 =
      std::sqrt(Scalar(std::pow(_tmp32, Scalar(2)) + std::pow(_tmp36, Scalar(2))));
  const Scalar _tmp68 = Scalar(1.0) / (_tmp67);
  const Scalar _tmp69 = _tmp33 * _tmp67;
  const Scalar _tmp70 = _tmp69 * (_tmp31 * _tmp36 * _tmp68 - _tmp32 * _tmp35 * _tmp68);
  const Scalar _tmp71 = -_tmp16 * _tmp29 + _tmp25 * _tmp28 + _tmp28 * _tmp70;
  const Scalar _tmp72 = -_tmp53 * _tmp62 + _tmp56 * _tmp59 + _tmp59 * _tmp70 - _tmp64 * _tmp71;
  const Scalar _tmp73 = _tmp66 * _tmp72;
  const Scalar _tmp74 = Scalar(1.0) / (_tmp72);
  const Scalar _tmp75 = _tmp65 * _tmp74;
  const Scalar _tmp76 = _tmp52 + _tmp75 * (-_tmp47 * _tmp71 - _tmp52 * _tmp73);
  const Scalar _tmp77 = _tmp63 * _tmp66;
  const Scalar _tmp78 = _tmp38 * (-_tmp76 * _tmp77 + Scalar(1.0));
  const Scalar _tmp79 = _tmp66 * _tmp76;
  const Scalar _tmp80 = _tmp30 + _tmp4;
  const Scalar _tmp81 = _tmp80 - p_b(0, 0) + position_vector(0, 0);
  const Scalar _tmp82 = _tmp34 + _tmp55;
  ...
  const Scalar _tmp86 = _tmp69 * _tmp85 * (_tmp28 * _tmp78 + _tmp59 * _tmp79);
  ...
  const Scalar _tmp91 = _tmp69 * _tmp88 * (_tmp59 * _tmp89 - _tmp89 * _tmp90);
  const Scalar _tmp92 = _tmp37 * _tmp38;
  const Scalar _tmp93 = -_tmp44 - _tmp50 * (_tmp37 * _tmp44 + _tmp46 * _tmp92) + _tmp51 * _tmp92;
  const Scalar _tmp94 = _tmp75 * (-_tmp70 + _tmp71 * _tmp92 - _tmp73 * _tmp93) + _tmp93;
  const Scalar _tmp95 = _tmp38 * (-_tmp37 - _tmp77 * _tmp94);
  const Scalar _tmp96 = _tmp66 * _tmp94;
  const Scalar _tmp97 = _tmp69 * _tmp87 * (_tmp28 * _tmp95 + _tmp59 * _tmp96 + Scalar(1.0));
  const Scalar _tmp98 = Scalar(333.54000000000002) - fv1;
  const Scalar _tmp99 = _tmp48 * _tmp50 + _tmp49;
  const Scalar _tmp100 = 0;
  const Scalar _tmp101 = _tmp100 * _tmp98;
  const Scalar _tmp102 = _tmp88 * _tmp89;
  const Scalar _tmp103 = _tmp102 * fh1;
  const Scalar _tmp104 = _tmp87 * _tmp95;
  ...
  _res(1, 0) = -(-_tmp86 - _tmp91 - _tmp97) *
               std::exp(_tmp69 * _tmp98 * (_tmp100 * _tmp59 - _tmp100 * _tmp90) + _tmp86 * fh1 +
                        _tmp91 * fh1 + _tmp97 * fh1);
  _res(2, 0) = -(-_tmp102 * _tmp64 + _tmp104 + _tmp105) *
               std::exp(_tmp101 * _tmp64 + _tmp103 * _tmp64 - _tmp104 * fh1 - _tmp105 * fh1);
  _res(3, 0) =
