...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl8(
  ...
  const Scalar _tmp50 = _tmp14 + _tmp41;
  const Scalar _tmp51 = _tmp50 - p_a(0, 0) + position_vector(0, 0);
  const Scalar _tmp52 = _tmp19 + _tmp44;
  ...
  const Scalar _tmp57 = _tmp40 * _tmp55 - _tmp50 * _tmp56 + _tmp52 * _tmp55;
  const Scalar _tmp58 = _tmp35 * _tmp38;
  const Scalar _tmp59 = Scalar(1.0) / (_tmp55 * _tmp58 - _tmp56);
  const Scalar _tmp60 = _tmp48 * _tmp58 - _tmp49;
  const Scalar _tmp61 = _tmp59 * _tmp60;
  const Scalar _tmp62 = _tmp40 * _tmp48 - _tmp42 * _tmp49 + _tmp45 * _tmp48 - _tmp57 * _tmp61;
  ...
  const Scalar _tmp67 = _tmp30 * _tmp39 * (_tmp48 * _tmp64 - _tmp55 * _tmp66);
  ...
  const Scalar _tmp76 = _tmp56 * _tmp75 - _tmp58 * _tmp73;
  const Scalar _tmp77 = Scalar(1.0) * _tmp32;
  const Scalar _tmp78 = Scalar(1.0) * _tmp34;
  const Scalar _tmp79 = (-_tmp50 + _tmp77) / (_tmp52 - _tmp78);
  const Scalar _tmp80 = -_tmp55 * _tmp75 + _tmp73;
  const Scalar _tmp81 = _tmp65 * _tmp76 * _tmp79 - _tmp65 * _tmp80;
  const Scalar _tmp82 = _tmp71 + _tmp74;
  const Scalar _tmp83 = _tmp58 * _tmp72;
  const Scalar _tmp84 = _tmp48 * _tmp72 - _tmp48 * _tmp82 - _tmp61 * _tmp80 -
                        _tmp79 * (-_tmp48 * _tmp83 + _tmp49 * _tmp82 - _tmp61 * _tmp76);
  const Scalar _tmp85 = Scalar(1.0) / (_tmp84);
  const Scalar _tmp86 = _tmp62 * _tmp85;
  const Scalar _tmp87 = _tmp63 * _tmp84;
  const Scalar _tmp88 = _tmp81 + _tmp87 * (-_tmp57 * _tmp65 - _tmp81 * _tmp86);
  const Scalar _tmp89 = _tmp60 * _tmp85;
  const Scalar _tmp90 = _tmp59 * (-_tmp88 * _tmp89 + Scalar(1.0));
  const Scalar _tmp91 = _tmp85 * _tmp88;
  const Scalar _tmp92 = _tmp28 * _tmp39 * (_tmp48 * _tmp91 + _tmp55 * _tmp90);
  const Scalar _tmp93 = Scalar(333.54000000000002) - fv1;
  const Scalar _tmp94 = _tmp77 + _tmp78 * _tmp79;
  const Scalar _tmp95 = 0;
  const Scalar _tmp96 = _tmp59 * _tmp89 * _tmp95;
  const Scalar _tmp97 = _tmp85 * _tmp95;
  const Scalar _tmp98 = _tmp58 * _tmp59;
  const Scalar _tmp99 = -_tmp72 - _tmp79 * (_tmp76 * _tmp98 + _tmp83) + _tmp80 * _tmp98;
  const Scalar _tmp100 = _tmp87 * (-_tmp40 + _tmp57 * _tmp98 - _tmp86 * _tmp99) + _tmp99;
  const Scalar _tmp101 = _tmp59 * (-_tmp100 * _tmp89 - _tmp58);
  const Scalar _tmp102 = _tmp100 * _tmp85;
  const Scalar _tmp103 = _tmp29 * _tmp39 * (_tmp101 * _tmp55 + _tmp102 * _tmp48 + Scalar(1.0));
  const Scalar _tmp104 = _tmp101 * _tmp29;
  const Scalar _tmp105 = _tmp28 * _tmp90;
  const Scalar _tmp106 = _tmp30 * _tmp66;
  const Scalar _tmp107 = _tmp28 * _tmp91;
  const Scalar _tmp108 = _tmp30 * _tmp64;
  const Scalar _tmp109 = _tmp102 * _tmp29;

  // Output terms (1)
  Eigen::Matrix<Scalar, 4, 1> _res;

  _res(0, 0) = -std::exp(-fh1);
  _res(1, 0) = -(-_tmp103 - _tmp67 - _tmp92) *
               std::exp(_tmp103 * fh1 + _tmp39 * _tmp93 * (_tmp48 * _tmp97 - _tmp55 * _tmp96) +
                        _tmp67 * fh1 + _tmp92 * fh1);
  _res(2, 0) = -(_tmp104 + _tmp105 - _tmp106) *
               std::exp(-_tmp104 * fh1 - _tmp105 * fh1 + _tmp106 * fh1 + _tmp93 * _tmp96);
  _res(3, 0) = -(_tmp107 + _tmp108 + _tmp109) *
               std::exp(-_tmp107 * fh1 - _tmp108 * fh1 - _tmp109 * fh1 - _tmp93 * _tmp97);
