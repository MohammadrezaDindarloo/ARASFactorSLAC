...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl0(
  ...
  const Scalar _tmp46 = -_tmp36 * _tmp43 + _tmp45;
  const Scalar _tmp47 = _tmp26 * _tmp29;
  const Scalar _tmp48 = _tmp41 * _tmp42;
  const Scalar _tmp49 = Scalar(1.0) / (_tmp43 * _tmp47 - _tmp48);
  const Scalar _tmp50 = _tmp47 * _tmp49;
  const Scalar _tmp51 = _tmp44 * _tmp47;
  const Scalar _tmp52 = _tmp36 * _tmp48 - _tmp45 * _tmp47;
  const Scalar _tmp53 = Scalar(1.0) * _tmp25;
  const Scalar _tmp54 = Scalar(1.0) * _tmp15;
  const Scalar _tmp55 = (-_tmp38 + _tmp54) / (_tmp40 - _tmp53);
  const Scalar _tmp56 = -_tmp44 + _tmp46 * _tmp50 - _tmp55 * (_tmp50 * _tmp52 + _tmp51);
  ...
  const Scalar _tmp66 = _tmp31 * _tmp43 - _tmp38 * _tmp48 + _tmp40 * _tmp43;
  const Scalar _tmp67 = _tmp47 * _tmp65 - _tmp64;
  const Scalar _tmp68 = _tmp49 * _tmp67;
  const Scalar _tmp69 = _tmp31 * _tmp65 - _tmp58 * _tmp64 + _tmp61 * _tmp65 - _tmp66 * _tmp68;
  const Scalar _tmp70 = _tmp32 + _tmp33 - _tmp34;
  const Scalar _tmp71 = _tmp44 * _tmp65 - _tmp46 * _tmp68 -
  ...
  const Scalar _tmp76 = _tmp56 + _tmp75 * (-_tmp31 + _tmp50 * _tmp66 - _tmp56 * _tmp73);
  const Scalar _tmp77 = _tmp67 * _tmp72;
  const Scalar _tmp78 = -_tmp47 - _tmp76 * _tmp77;
  const Scalar _tmp79 = _tmp43 * _tmp49;
  const Scalar _tmp80 = _tmp65 * _tmp72;
  const Scalar _tmp81 = _tmp14 + _tmp57;
  const Scalar _tmp82 = _tmp81 - p_a(0, 0) + position_vector(0, 0);
  const Scalar _tmp83 = _tmp19 + _tmp60;
  ...
  const Scalar _tmp92 = _tmp30 * (-_tmp43 * _tmp91 + _tmp65 * _tmp90);
  const Scalar _tmp93 = Scalar(1.0) * _tmp49;
  const Scalar _tmp94 = -_tmp46 * _tmp93 + _tmp52 * _tmp55 * _tmp93;
  const Scalar _tmp95 = _tmp75 * (-_tmp66 * _tmp93 - _tmp73 * _tmp94) + _tmp94;
  ...
  const Scalar _tmp100 = _tmp49 * fh1;
  ...
  _res(0, 0) = 0;
  _res(1, 0) =
      -_tmp92 * std::exp(_tmp30 * _tmp99 * (-_tmp43 * _tmp68 * _tmp98 + _tmp65 * _tmp98) +
                         _tmp86 * _tmp87 * (_tmp76 * _tmp80 + _tmp78 * _tmp79 + Scalar(1.0)) +
                         _tmp87 * _tmp97 * (_tmp79 * _tmp96 + _tmp80 * _tmp95) + _tmp88 * _tmp92);
  _res(2, 0) = -_tmp91 * std::exp(-_tmp100 * _tmp78 * _tmp86 - _tmp100 * _tmp96 * _tmp97 +
                                  _tmp101 * _tmp68 + _tmp102 * _tmp68);
  _res(3, 0) =
      _tmp90 * std::exp(-_tmp101 - _tmp102 - _tmp103 * _tmp76 * _tmp86 - _tmp103 * _tmp95 * _tmp97);
