...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl11(
  ...
  const Scalar _tmp97 = _tmp37 * (-_tmp27 * _tmp96 + _tmp65 * _tmp95);
  ...
  _res(0, 0) = 0;
  _res(1, 0) =
      -_tmp97 * std::exp(_tmp37 * _tmp99 * (-_tmp27 * _tmp68 * _tmp98 + _tmp65 * _tmp98) +
                         _tmp86 * _tmp87 * (_tmp76 * _tmp80 + _tmp78 * _tmp79) +
                         _tmp87 * _tmp92 * (_tmp79 * _tmp91 + _tmp80 * _tmp90 + Scalar(1.0)) +
                         _tmp93 * _tmp97);
  _res(2, 0) = -_tmp96 * std::exp(_tmp100 * _tmp68 - _tmp101 * _tmp78 * _tmp86 -
                                  _tmp101 * _tmp91 * _tmp92 + _tmp102 * _tmp68);
  _res(3, 0) =
      _tmp95 * std::exp(-_tmp100 - _tmp102 - _tmp103 * _tmp76 * _tmp86 - _tmp103 * _tmp90 * _tmp92);
