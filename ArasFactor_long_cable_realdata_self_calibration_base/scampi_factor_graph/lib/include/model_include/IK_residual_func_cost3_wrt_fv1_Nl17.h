...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl17(
  ...
  const Scalar _tmp35 = _tmp18 + _tmp21;
  ...
  const Scalar _tmp41 = _tmp40 - p_d(1, 0) + position_vector(1, 0);
  const Scalar _tmp42 = _tmp38 * _tmp41;
  const Scalar _tmp43 = _tmp4 - _tmp9;
  const Scalar _tmp44 = _tmp13 + _tmp43;
  const Scalar _tmp45 = _tmp24 * _tmp32;
  const Scalar _tmp46 = _tmp44 * _tmp45;
  const Scalar _tmp47 = _tmp15 * _tmp33 - _tmp42 * _tmp46;
  const Scalar _tmp48 = Scalar(1.0) * _tmp36;
  const Scalar _tmp49 = Scalar(1.0) * _tmp40;
  const Scalar _tmp50 = (-_tmp23 + _tmp48) / (_tmp30 - _tmp49);
  const Scalar _tmp51 = Scalar(1.0) / (-_tmp33 + _tmp42 * _tmp45);
  const Scalar _tmp52 = Scalar(1.0) * _tmp51;
  const Scalar _tmp53 = -_tmp15 * _tmp45 + _tmp46;
  const Scalar _tmp54 = _tmp47 * _tmp50 * _tmp52 - _tmp52 * _tmp53;
  const Scalar _tmp55 =
  ...
  const Scalar _tmp58 = _tmp57 * (_tmp36 * _tmp41 * _tmp56 - _tmp37 * _tmp40 * _tmp56);
  const Scalar _tmp59 = _tmp22 + _tmp34;
  ...
  const Scalar _tmp65 = -_tmp23 * _tmp33 + _tmp30 * _tmp45 + _tmp45 * _tmp58;
  const Scalar _tmp66 = _tmp62 * _tmp63;
  const Scalar _tmp67 = _tmp42 * _tmp64 - _tmp66;
  const Scalar _tmp68 = _tmp51 * _tmp67;
  const Scalar _tmp69 = _tmp58 * _tmp64 - _tmp59 * _tmp66 + _tmp61 * _tmp64 - _tmp65 * _tmp68;
  const Scalar _tmp70 = _tmp14 + _tmp43;
  const Scalar _tmp71 = _tmp42 * _tmp44;
  const Scalar _tmp72 = _tmp44 * _tmp64 -
                        _tmp50 * (-_tmp47 * _tmp68 - _tmp64 * _tmp71 + _tmp66 * _tmp70) -
                        _tmp53 * _tmp68 - _tmp64 * _tmp70;
  const Scalar _tmp73 = Scalar(1.0) / (_tmp72);
  const Scalar _tmp74 = _tmp69 * _tmp73;
  const Scalar _tmp75 = Scalar(1.0) / (_tmp69);
  const Scalar _tmp76 = _tmp72 * _tmp75;
  const Scalar _tmp77 = _tmp54 + _tmp76 * (-_tmp52 * _tmp65 - _tmp54 * _tmp74);
  const Scalar _tmp78 = _tmp67 * _tmp73;
  const Scalar _tmp79 = -_tmp77 * _tmp78 + Scalar(1.0);
  const Scalar _tmp80 = _tmp45 * _tmp51;
  const Scalar _tmp81 = _tmp64 * _tmp73;
  const Scalar _tmp82 = _tmp17 + _tmp35;
  const Scalar _tmp83 = _tmp82 - p_c(0, 0) + position_vector(0, 0);
  const Scalar _tmp84 = _tmp25 + _tmp29;
  const Scalar _tmp85 = _tmp84 - p_c(1, 0) + position_vector(1, 0);
  const Scalar _tmp86 = std::pow(Scalar(std::pow(_tmp83, Scalar(2)) + std::pow(_tmp85, Scalar(2))),
                                 Scalar(Scalar(-1) / Scalar(2)));
  const Scalar _tmp87 = _tmp85 * _tmp86;
  const Scalar _tmp88 = _tmp57 * fh1;
  const Scalar _tmp89 = Scalar(333.54000000000002) - fv1;
  const Scalar _tmp90 = _tmp48 + _tmp49 * _tmp50;
  const Scalar _tmp91 = 0;
  const Scalar _tmp92 = _tmp68 * _tmp91;
  const Scalar _tmp93 = _tmp57 * (-_tmp45 * _tmp92 + _tmp64 * _tmp91);
  const Scalar _tmp94 = _tmp42 * _tmp51;
  const Scalar _tmp95 = -_tmp44 - _tmp50 * (_tmp47 * _tmp94 + _tmp71) + _tmp53 * _tmp94;
  const Scalar _tmp96 = _tmp76 * (-_tmp58 + _tmp65 * _tmp94 - _tmp74 * _tmp95) + _tmp95;
  const Scalar _tmp97 = -_tmp42 - _tmp78 * _tmp96;
  ...
  _res(0, 0) = 0;
  _res(1, 0) =
      -_tmp93 * std::exp(_tmp100 * _tmp57 * (-_tmp45 * _tmp68 * _tmp99 + _tmp64 * _tmp99) +
                         _tmp87 * _tmp88 * (_tmp77 * _tmp81 + _tmp79 * _tmp80) +
                         _tmp88 * _tmp98 * (_tmp80 * _tmp97 + _tmp81 * _tmp96 + Scalar(1.0)) +
                         _tmp89 * _tmp93);
  _res(2, 0) = -_tmp92 * std::exp(-_tmp101 * _tmp79 * _tmp87 - _tmp101 * _tmp97 * _tmp98 +
                                  _tmp102 * _tmp68 + _tmp103 * _tmp68);
  _res(3, 0) =
      _tmp91 * std::exp(-_tmp102 - _tmp103 - _tmp104 * _tmp77 * _tmp87 - _tmp104 * _tmp96 * _tmp98);
