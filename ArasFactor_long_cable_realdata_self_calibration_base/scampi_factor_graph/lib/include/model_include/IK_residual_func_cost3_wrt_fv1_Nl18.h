...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl18(
  ...
  const Scalar _tmp26 = Scalar(0.20999999999999999) * _tmp10 + Scalar(0.20999999999999999) * _tmp17;
  ...
  const Scalar _tmp49 = (-_tmp24 + _tmp48) / (_tmp31 - _tmp47);
  const Scalar _tmp50 = Scalar(1.0) / (-_tmp34 + _tmp42 * _tmp44);
  ...
  const Scalar _tmp62 = _tmp42 * _tmp61 - _tmp60;
  const Scalar _tmp63 = _tmp50 * _tmp62;
  const Scalar _tmp64 = _tmp43 * _tmp61;
  const Scalar _tmp65 = _tmp15 + _tmp7;
  const Scalar _tmp66 = -_tmp49 * (-_tmp42 * _tmp64 - _tmp46 * _tmp63 + _tmp60 * _tmp65) -
                        _tmp52 * _tmp63 - _tmp61 * _tmp65 + _tmp64;
  ...
  const Scalar _tmp81 = _tmp44 * _tmp50;
  const Scalar _tmp82 = _tmp35 + _tmp56;
  ...
  const Scalar _tmp89 = _tmp51 * _tmp62 * _tmp75;
  ...
  const Scalar _tmp94 = -_tmp43 - _tmp49 * (_tmp42 * _tmp43 + _tmp46 * _tmp93) + _tmp52 * _tmp93;
  const Scalar _tmp95 = _tmp76 * (-_tmp71 + _tmp72 * _tmp93 - _tmp74 * _tmp94) + _tmp94;
  const Scalar _tmp96 = -_tmp42 - _tmp79 * _tmp95;
  const Scalar _tmp97 = _tmp91 * fh1;
  const Scalar _tmp98 = Scalar(333.54000000000002) - fv1;
  const Scalar _tmp99 = _tmp47 * _tmp49 + _tmp48;
  const Scalar _tmp100 = 0;
  const Scalar _tmp101 = _tmp100 * _tmp63;
  const Scalar _tmp102 = _tmp70 * (_tmp100 * _tmp61 - _tmp101 * _tmp44);
  ...
  _res(0, 0) = 0;
  _res(1, 0) =
      -_tmp102 * std::exp(_tmp102 * _tmp98 + _tmp70 * _tmp88 * (_tmp77 * _tmp78 + _tmp80 * _tmp81) +
                          _tmp70 * _tmp92 * (-_tmp44 * _tmp89 + _tmp61 * _tmp90) +
                          _tmp70 * _tmp97 * (_tmp78 * _tmp95 + _tmp81 * _tmp96 + Scalar(1.0)));
  _res(2, 0) = -_tmp101 * std::exp(_tmp103 * _tmp63 - _tmp50 * _tmp80 * _tmp88 -
                                   _tmp50 * _tmp96 * _tmp97 + _tmp89 * _tmp92);
