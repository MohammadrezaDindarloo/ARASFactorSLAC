...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl19(
  ...
  const Scalar _tmp42 = _tmp32 * _tmp40 + _tmp34 * _tmp40 - _tmp36 * _tmp41;
  const Scalar _tmp43 = _tmp27 * _tmp30;
  ...
  const Scalar _tmp53 = _tmp40 * _tmp50;
  const Scalar _tmp54 = _tmp41 * _tmp52 - _tmp43 * _tmp53;
  const Scalar _tmp55 = Scalar(1.0) * _tmp16;
  const Scalar _tmp56 = Scalar(1.0) * _tmp26;
  const Scalar _tmp57 = (-_tmp36 + _tmp55) / (_tmp34 - _tmp56);
  const Scalar _tmp58 = -_tmp40 * _tmp52 + _tmp53;
  const Scalar _tmp59 = _tmp45 * _tmp58 - _tmp50 - _tmp57 * (_tmp43 * _tmp50 + _tmp45 * _tmp54);
  const Scalar _tmp60 = _tmp49 + _tmp51;
  const Scalar _tmp61 = _tmp35 + _tmp7;
  const Scalar _tmp62 = _tmp61 - p_b(0, 0) + position_vector(0, 0);
  const Scalar _tmp63 = _tmp20 + _tmp33;
  ...
  const Scalar _tmp71 = -_tmp57 * (-_tmp43 * _tmp70 - _tmp54 * _tmp69 + _tmp60 * _tmp67) -
                        _tmp58 * _tmp69 - _tmp60 * _tmp66 + _tmp70;
  const Scalar _tmp72 = Scalar(1.0) / (_tmp71);
  const Scalar _tmp73 = _tmp32 * _tmp66 - _tmp42 * _tmp69 - _tmp61 * _tmp67 + _tmp63 * _tmp66;
  const Scalar _tmp74 = _tmp72 * _tmp73;
  const Scalar _tmp75 = Scalar(1.0) / (_tmp73);
  const Scalar _tmp76 = _tmp71 * _tmp75;
  const Scalar _tmp77 = _tmp59 + _tmp76 * (-_tmp32 + _tmp42 * _tmp45 - _tmp59 * _tmp74);
  const Scalar _tmp78 = _tmp66 * _tmp72;
  const Scalar _tmp79 = _tmp68 * _tmp72;
  const Scalar _tmp80 = -_tmp43 - _tmp77 * _tmp79;
  const Scalar _tmp81 = _tmp40 * _tmp44;
  const Scalar _tmp82 = _tmp15 + _tmp6;
  const Scalar _tmp83 = _tmp82 - p_d(0, 0) + position_vector(0, 0);
  ...
  const Scalar _tmp90 = _tmp55 + _tmp56 * _tmp57;
  const Scalar _tmp91 = 0;
  const Scalar _tmp92 = _tmp79 * _tmp91;
  const Scalar _tmp93 = _tmp72 * _tmp91;
  const Scalar _tmp94 = _tmp31 * (_tmp66 * _tmp93 - _tmp81 * _tmp92);
  const Scalar _tmp95 = Scalar(1.0) * _tmp44;
  const Scalar _tmp96 = _tmp68 * _tmp75 * _tmp95;
  const Scalar _tmp97 = Scalar(1.0) * _tmp75;
  const Scalar _tmp98 = _tmp85 * _tmp86;
  const Scalar _tmp99 = fh1 * (_tmp82 * _tmp98 - _tmp84 * _tmp87);
  const Scalar _tmp100 = _tmp54 * _tmp57 * _tmp95 - _tmp58 * _tmp95;
  const Scalar _tmp101 = _tmp100 + _tmp76 * (-_tmp100 * _tmp74 - _tmp42 * _tmp95);
  const Scalar _tmp102 = -_tmp101 * _tmp79 + Scalar(1.0);
  const Scalar _tmp103 = _tmp98 * fh1;
  const Scalar _tmp104 = _tmp44 * _tmp92;
  ...
  _res(0, 0) = 0;
  _res(1, 0) =
      -_tmp94 * std::exp(_tmp103 * _tmp31 * (_tmp101 * _tmp78 + _tmp102 * _tmp81) +
                         _tmp31 * _tmp88 * (_tmp77 * _tmp78 + _tmp80 * _tmp81 + Scalar(1.0)) +
                         _tmp31 * _tmp99 * (-_tmp40 * _tmp96 + _tmp66 * _tmp97) + _tmp89 * _tmp94);
  _res(2, 0) = -_tmp104 * std::exp(-_tmp102 * _tmp103 * _tmp44 + _tmp104 * _tmp89 -
                                   _tmp44 * _tmp80 * _tmp88 + _tmp96 * _tmp99);
  _res(3, 0) = _tmp93 * std::exp(-_tmp101 * _tmp103 * _tmp72 - _tmp72 * _tmp77 * _tmp88 -
                                 _tmp89 * _tmp93 - _tmp97 * _tmp99);
