...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl21(
  ...
  const Scalar _tmp78 = _tmp64 * _tmp69;
  ...
  const Scalar _tmp97 = -_tmp27 - _tmp75 * _tmp96;
  const Scalar _tmp98 = _tmp37 * fh1;
  const Scalar _tmp99 = _tmp37 * _tmp92;
  const Scalar _tmp100 = _tmp86 * _tmp88;
  const Scalar _tmp101 = _tmp69 * fh1;
  ...
  _res(0, 0) = 0;
  _res(1, 0) =
      -_tmp94 * std::exp(_tmp40 * _tmp88 * (_tmp64 * _tmp86 - _tmp66 * _tmp77 * _tmp86) +
                         _tmp84 * _tmp85 * (_tmp74 * _tmp78 + _tmp76 * _tmp77) +
                         _tmp85 * _tmp87 * (_tmp77 * _tmp97 + _tmp78 * _tmp96 + Scalar(1.0)) +
                         _tmp89 * _tmp94);
  _res(2, 0) = -_tmp99 * std::exp(_tmp100 * _tmp37 * _tmp66 - _tmp76 * _tmp84 * _tmp98 -
                                  _tmp87 * _tmp97 * _tmp98 + _tmp89 * _tmp99);
  _res(3, 0) = _tmp93 * std::exp(-_tmp100 - _tmp101 * _tmp74 * _tmp84 - _tmp101 * _tmp87 * _tmp96 -
                                 _tmp89 * _tmp93);
