...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl6(
  ...
  const Scalar _tmp40 = _tmp34 + _tmp35 + _tmp36;
  ...
  const Scalar _tmp50 = -_tmp39 * _tmp49 + _tmp40 * _tmp48;
  const Scalar _tmp51 = Scalar(1.0) / (_tmp29 * _tmp49 - _tmp48);
  const Scalar _tmp52 = _tmp29 * _tmp51;
  const Scalar _tmp53 = Scalar(1.0) * _tmp16;
  const Scalar _tmp54 = Scalar(1.0) * _tmp27;
  const Scalar _tmp55 = (-_tmp45 + _tmp53) / (_tmp42 - _tmp54);
  const Scalar _tmp56 = _tmp38 * _tmp49 - _tmp40 * _tmp49;
  const Scalar _tmp57 = -_tmp38 + _tmp52 * _tmp56 - _tmp55 * (_tmp39 + _tmp50 * _tmp52);
  ...
  const Scalar _tmp66 = _tmp29 * _tmp63 - _tmp65;
  const Scalar _tmp67 = _tmp51 * _tmp66;
  const Scalar _tmp68 = _tmp38 * _tmp63 -
                        _tmp55 * (-_tmp39 * _tmp63 - _tmp50 * _tmp67 + _tmp64 * _tmp65) -
                        _tmp56 * _tmp67 - _tmp63 * _tmp64;
  const Scalar _tmp69 = Scalar(1.0) / (_tmp68);
  const Scalar _tmp70 = _tmp33 * _tmp49 + _tmp42 * _tmp49 - _tmp45 * _tmp48;
  const Scalar _tmp71 = _tmp33 * _tmp63 - _tmp58 * _tmp65 + _tmp60 * _tmp63 - _tmp67 * _tmp70;
  const Scalar _tmp72 = _tmp69 * _tmp71;
  const Scalar _tmp73 = Scalar(1.0) / (_tmp71);
  const Scalar _tmp74 = _tmp68 * _tmp73;
  const Scalar _tmp75 = _tmp57 + _tmp74 * (-_tmp33 + _tmp52 * _tmp70 - _tmp57 * _tmp72);
  const Scalar _tmp76 = _tmp66 * _tmp69;
  const Scalar _tmp77 = -_tmp29 - _tmp75 * _tmp76;
  const Scalar _tmp78 = _tmp49 * _tmp51;
  const Scalar _tmp79 = _tmp63 * _tmp69;
  const Scalar _tmp80 = _tmp15 + _tmp4;
  const Scalar _tmp81 = _tmp80 - p_b(0, 0) + position_vector(0, 0);
  const Scalar _tmp82 = _tmp21 + _tmp41;
  ...
  const Scalar _tmp86 = _tmp32 * fh1;
  const Scalar _tmp87 = Scalar(1.0) * _tmp51;
  const Scalar _tmp88 = _tmp50 * _tmp55 * _tmp87 - _tmp56 * _tmp87;
  const Scalar _tmp89 = _tmp74 * (-_tmp70 * _tmp87 - _tmp72 * _tmp88) + _tmp88;
  const Scalar _tmp90 = -_tmp76 * _tmp89 + Scalar(1.0);
  const Scalar _tmp91 = _tmp83 * _tmp84;
  const Scalar _tmp92 = Scalar(333.54000000000002) - fv1;
  const Scalar _tmp93 = _tmp53 + _tmp54 * _tmp55;
  const Scalar _tmp94 = 0;
  const Scalar _tmp95 = _tmp67 * _tmp94;
  const Scalar _tmp96 = _tmp32 * (-_tmp49 * _tmp95 + _tmp63 * _tmp94);
  const Scalar _tmp97 = Scalar(1.0) * _tmp73;
  const Scalar _tmp98 = _tmp66 * _tmp73 * _tmp87;
  const Scalar _tmp99 = fh1 * (_tmp80 * _tmp91 - _tmp82 * _tmp85);
  ...
  _res(0, 0) = 0;
  _res(1, 0) =
      -_tmp96 * std::exp(_tmp32 * _tmp99 * (-_tmp49 * _tmp98 + _tmp63 * _tmp97) +
                         _tmp85 * _tmp86 * (_tmp75 * _tmp79 + _tmp77 * _tmp78 + Scalar(1.0)) +
                         _tmp86 * _tmp91 * (_tmp78 * _tmp90 + _tmp79 * _tmp89) + _tmp92 * _tmp96);
  _res(2, 0) = -_tmp95 * std::exp(-_tmp100 * _tmp77 * _tmp85 - _tmp100 * _tmp90 * _tmp91 +
                                  _tmp101 * _tmp67 + _tmp98 * _tmp99);
  _res(3, 0) = _tmp94 * std::exp(-_tmp101 - _tmp102 * _tmp75 * _tmp85 - _tmp102 * _tmp89 * _tmp91 -
                                 _tmp97 * _tmp99);
