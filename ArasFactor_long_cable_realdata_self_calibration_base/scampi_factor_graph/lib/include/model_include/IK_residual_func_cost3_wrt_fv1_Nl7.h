...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl7(
  ...
  const Scalar _tmp43 = _tmp10 - _tmp14 + _tmp7;
  ...
  const Scalar _tmp102 = _tmp70 * (_tmp100 * _tmp60 - _tmp101 * _tmp44);
  ...
  _res(0, 0) = 0;
  _res(1, 0) =
      -_tmp102 * std::exp(_tmp102 * _tmp98 + _tmp70 * _tmp88 * (_tmp77 * _tmp81 + _tmp79 * _tmp80) +
                          _tmp70 * _tmp92 * (-_tmp44 * _tmp89 + _tmp60 * _tmp90) +
                          _tmp70 * _tmp97 * (_tmp80 * _tmp96 + _tmp81 * _tmp95 + Scalar(1.0)));
  _res(2, 0) = -_tmp101 * std::exp(_tmp103 * _tmp65 - _tmp47 * _tmp79 * _tmp88 -
                                   _tmp47 * _tmp96 * _tmp97 + _tmp89 * _tmp92);
  _res(3, 0) = _tmp100 * std::exp(-_tmp103 - _tmp67 * _tmp77 * _tmp88 - _tmp67 * _tmp95 * _tmp97 -
                                  _tmp90 * _tmp92);
