...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl8(
  ...
  const Scalar _tmp49 = _tmp38 * _tmp47 - _tmp41 * _tmp48 + _tmp44 * _tmp47;
  const Scalar _tmp50 = _tmp33 * _tmp36;
  const Scalar _tmp51 = _tmp28 * _tmp50 - _tmp39;
  const Scalar _tmp52 = Scalar(1.0) / (_tmp47 * _tmp50 - _tmp48);
  const Scalar _tmp53 = _tmp51 * _tmp52;
  const Scalar _tmp54 = -_tmp15 * _tmp39 + _tmp25 * _tmp28 + _tmp28 * _tmp38 - _tmp49 * _tmp53;
  ...
  const Scalar _tmp65 = Scalar(1.0) * _tmp30;
  const Scalar _tmp66 = Scalar(1.0) * _tmp32;
  const Scalar _tmp67 = (-_tmp41 + _tmp65) / (_tmp44 - _tmp66);
  ...
  const Scalar _tmp76 = _tmp48 * _tmp75 - _tmp50 * _tmp73;
  const Scalar _tmp77 = _tmp52 * _tmp76;
  const Scalar _tmp78 = _tmp52 * (-_tmp47 * _tmp75 + _tmp73);
  const Scalar _tmp79 = Scalar(1.0) * _tmp67 * _tmp77 - Scalar(1.0) * _tmp78;
  const Scalar _tmp80 = _tmp71 + _tmp74;
  const Scalar _tmp81 = _tmp50 * _tmp72;
  const Scalar _tmp82 = _tmp28 * _tmp72 - _tmp28 * _tmp80 - _tmp51 * _tmp78 -
                        _tmp67 * (-_tmp28 * _tmp81 + _tmp39 * _tmp80 - _tmp53 * _tmp76);
  const Scalar _tmp83 = Scalar(1.0) / (_tmp82);
  const Scalar _tmp84 = _tmp54 * _tmp83;
  const Scalar _tmp85 = _tmp49 * _tmp52;
  const Scalar _tmp86 = _tmp55 * _tmp82;
  const Scalar _tmp87 = _tmp79 + _tmp86 * (-_tmp79 * _tmp84 - Scalar(1.0) * _tmp85);
  const Scalar _tmp88 = _tmp51 * _tmp83;
  const Scalar _tmp89 = -_tmp87 * _tmp88 + Scalar(1.0);
  const Scalar _tmp90 = _tmp47 * _tmp52;
  const Scalar _tmp91 = _tmp28 * _tmp83;
  const Scalar _tmp92 = _tmp37 * fh1;
  const Scalar _tmp93 = Scalar(333.54000000000002) - fv1;
  const Scalar _tmp94 = _tmp65 + _tmp66 * _tmp67;
  const Scalar _tmp95 = 0;
  const Scalar _tmp96 = _tmp53 * _tmp95;
  const Scalar _tmp97 = _tmp37 * (_tmp28 * _tmp95 - _tmp47 * _tmp96);
  const Scalar _tmp98 = _tmp50 * _tmp78 - _tmp67 * (_tmp50 * _tmp77 + _tmp81) - _tmp72;
  const Scalar _tmp99 = _tmp86 * (-_tmp38 + _tmp50 * _tmp85 - _tmp84 * _tmp98) + _tmp98;
  const Scalar _tmp100 = -_tmp50 - _tmp88 * _tmp99;
  ...
  _res(0, 0) = 0;
  _res(1, 0) =
      -_tmp97 * std::exp(_tmp37 * _tmp64 * (_tmp28 * _tmp56 - _tmp47 * _tmp53 * _tmp56) +
                         _tmp62 * _tmp92 * (_tmp87 * _tmp91 + _tmp89 * _tmp90) +
                         _tmp63 * _tmp92 * (_tmp100 * _tmp90 + _tmp91 * _tmp99 + Scalar(1.0)) +
                         _tmp93 * _tmp97);
  _res(2, 0) = -_tmp96 * std::exp(-_tmp100 * _tmp101 * _tmp63 - _tmp101 * _tmp62 * _tmp89 +
                                  _tmp102 * _tmp53 + _tmp103 * _tmp53);
  _res(3, 0) =
      _tmp95 * std::exp(-_tmp102 - _tmp103 - _tmp104 * _tmp62 * _tmp87 - _tmp104 * _tmp63 * _tmp99);
