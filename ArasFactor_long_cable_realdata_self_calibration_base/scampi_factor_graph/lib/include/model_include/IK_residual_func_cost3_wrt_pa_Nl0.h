 ...
 *
 * Symbolic function: IK_residual_func_cost3_wrt_pa_Nl0
 *
 * Args:
 *     fh1: Scalar
 *     fv1: Scalar
...
Eigen::Matrix<Scalar, 4, 3> IkResidualFuncCost3WrtPaNl0(
  ...
  const Scalar _tmp52 = -_tmp31 * _tmp49 + _tmp51;
  const Scalar _tmp53 = _tmp38 * _tmp40;
  const Scalar _tmp54 = -_tmp38 * _tmp51 + _tmp39 * _tmp49;
  const Scalar _tmp55 = Scalar(1.0) * _tmp36;
  const Scalar _tmp56 = Scalar(1.0) * _tmp32;
  const Scalar _tmp57 = (-_tmp19 + _tmp56) / (_tmp28 - _tmp55);
  const Scalar _tmp58 = -_tmp50 + _tmp52 * _tmp53 - _tmp57 * (_tmp38 * _tmp50 + _tmp53 * _tmp54);
  const Scalar _tmp59 = _tmp45 + _tmp46 - _tmp47;
  const Scalar _tmp60 = _tmp18 + _tmp5;
  const Scalar _tmp61 = _tmp60 - p_d(0, 0) + position_vector(0, 0);
  const Scalar _tmp62 = -_tmp21;
  ...
  const Scalar _tmp69 = _tmp38 * _tmp66 - _tmp68;
  const Scalar _tmp70 = _tmp40 * _tmp69;
  const Scalar _tmp71 = -_tmp52 * _tmp70 -
                        _tmp57 * (-_tmp38 * _tmp67 - _tmp54 * _tmp70 + _tmp59 * _tmp68) -
                        _tmp59 * _tmp66 + _tmp67;
  const Scalar _tmp72 = Scalar(1.0) / (_tmp71);
  const Scalar _tmp73 = -_tmp19 * _tmp39 + _tmp28 * _tmp31 + _tmp31 * _tmp44;
  const Scalar _tmp74 = _tmp44 * _tmp66 - _tmp60 * _tmp68 + _tmp63 * _tmp66 - _tmp70 * _tmp73;
  const Scalar _tmp75 = _tmp72 * _tmp74;
  const Scalar _tmp76 = Scalar(1.0) / (_tmp74);
  const Scalar _tmp77 = _tmp71 * _tmp76;
  const Scalar _tmp78 = _tmp58 + _tmp77 * (-_tmp44 + _tmp53 * _tmp73 - _tmp58 * _tmp75);
  const Scalar _tmp79 = _tmp69 * _tmp72;
  const Scalar _tmp80 = _tmp40 * (-_tmp38 - _tmp78 * _tmp79);
  const Scalar _tmp81 = _tmp72 * _tmp78;
  const Scalar _tmp82 = _tmp31 * _tmp80 + _tmp66 * _tmp81 + Scalar(1.0);
  const Scalar _tmp83 = std::pow(_tmp17, Scalar(2));
  const Scalar _tmp84 = _tmp35 + _tmp62;
  ...
  const Scalar _tmp95 = _tmp31 * _tmp70;
  const Scalar _tmp96 = Scalar(1.0) * _tmp40;
  const Scalar _tmp97 = -_tmp52 * _tmp96 + _tmp54 * _tmp57 * _tmp96;
  const Scalar _tmp98 = _tmp77 * (-_tmp73 * _tmp96 - _tmp75 * _tmp97) + _tmp97;
  const Scalar _tmp99 = _tmp72 * _tmp98;
  const Scalar _tmp100 = _tmp40 * (-_tmp79 * _tmp98 + Scalar(1.0));
  const Scalar _tmp101 = _tmp100 * _tmp31 + _tmp66 * _tmp99;
  const Scalar _tmp102 = _tmp101 * _tmp90;
  const Scalar _tmp103 = _tmp84 * _tmp88;
  const Scalar _tmp104 = _tmp16 * _tmp88;
  const Scalar _tmp105 = fh1 * (-_tmp103 * _tmp17 + _tmp104 * _tmp85);
  const Scalar _tmp106 = Scalar(1.0) * _tmp76;
  const Scalar _tmp107 = _tmp43 * (_tmp106 * _tmp66 - _tmp106 * _tmp95);
  const Scalar _tmp108 = std::exp(_tmp102 * _tmp85 + _tmp105 * _tmp107 + _tmp17 * _tmp91 +
                                  _tmp43 * _tmp92 * (_tmp66 * _tmp94 - _tmp94 * _tmp95));
  const Scalar _tmp109 = _tmp101 * _tmp43;
  ...
  const Scalar _tmp118 = _tmp103 + _tmp110 * _tmp117 - _tmp116 * _tmp83;
  const Scalar _tmp119 = _tmp107 * fh1;
  const Scalar _tmp120 = _tmp100 * _tmp89;
  const Scalar _tmp121 = _tmp92 * _tmp94;
  const Scalar _tmp122 = _tmp80 * _tmp89;
  const Scalar _tmp123 = _tmp105 * _tmp106;
  const Scalar _tmp124 =
      std::exp(-_tmp120 * _tmp85 + _tmp121 * _tmp70 - _tmp122 * _tmp17 + _tmp123 * _tmp70);
  const Scalar _tmp125 = _tmp106 * fh1;
  const Scalar _tmp126 = _tmp118 * _tmp125;
  const Scalar _tmp127 = _tmp81 * _tmp89;
  const Scalar _tmp128 = _tmp89 * _tmp99;
  const Scalar _tmp129 = std::exp(-_tmp121 - _tmp123 - _tmp127 * _tmp17 - _tmp128 * _tmp85);
  const Scalar _tmp130 = -_tmp104 - _tmp110 * _tmp116 + _tmp117 * _tmp86;
  const Scalar _tmp131 = _tmp112 * _tmp86;
  ...
  _res(0, 0) = 0;
  _res(1, 0) = -_tmp108 * (-_tmp109 * _tmp113 - _tmp114 * _tmp115 - _tmp118 * _tmp119 + _tmp91);
  _res(2, 0) = -_tmp124 * (_tmp100 * _tmp113 + _tmp114 * _tmp80 - _tmp122 - _tmp126 * _tmp70);
  _res(3, 0) = -_tmp129 * (_tmp113 * _tmp99 + _tmp114 * _tmp81 + _tmp126 - _tmp127);
  _res(0, 1) = 0;
  _res(1, 1) = -_tmp108 * (_tmp102 - _tmp109 * _tmp131 - _tmp113 * _tmp115 - _tmp119 * _tmp130);
  _res(2, 1) = -_tmp124 * (_tmp100 * _tmp131 + _tmp113 * _tmp80 - _tmp120 - _tmp132 * _tmp70);
  _res(3, 1) = -_tmp129 * (_tmp113 * _tmp81 - _tmp128 + _tmp131 * _tmp99 + _tmp132);
  _res(0, 2) = 0;
  _res(1, 2) = 0;
  _res(2, 2) = 0;
  _res(3, 2) = 0;
