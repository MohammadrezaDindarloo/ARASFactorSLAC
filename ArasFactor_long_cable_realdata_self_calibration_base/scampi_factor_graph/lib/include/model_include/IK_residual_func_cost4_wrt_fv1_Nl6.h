 ...
 *
 * Symbolic function: IK_residual_func_cost4_wrt_fv1_Nl6
 *
 * Args:
 *     fh1: Scalar
 *     fv1: Scalar
...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost4WrtFv1Nl6(
  ...
  const Scalar _tmp29 = Scalar(0.20999999999999999) * _tmp11 - Scalar(0.20999999999999999) * _tmp13;
  ...
  const Scalar _tmp47 = _tmp46 * (_tmp35 * _tmp42 * _tmp45 - _tmp37 * _tmp40 * _tmp45);
  ...
  const Scalar _tmp51 = Scalar(0.20999999999999999) * _tmp15 + Scalar(0.20999999999999999) * _tmp16;
  ...
  const Scalar _tmp67 = -_tmp54 * _tmp66 + _tmp56 * _tmp65;
  const Scalar _tmp68 = Scalar(1.0) / (_tmp43 * _tmp66 - _tmp65);
  const Scalar _tmp69 = _tmp43 * _tmp68;
  const Scalar _tmp70 = _tmp54 + _tmp67 * _tmp69;
  ...
  const Scalar _tmp75 = _tmp73 * (-_tmp61 + _tmp74);
  const Scalar _tmp76 = _tmp53 * _tmp66 - _tmp56 * _tmp66;
  const Scalar _tmp77 = -_tmp53 + _tmp69 * _tmp76 - _tmp70 * _tmp75;
  const Scalar _tmp78 = _tmp34 + _tmp60;
  const Scalar _tmp79 = _tmp78 + position_vector(0, 0);
  const Scalar _tmp80 = _tmp79 - p_d(0, 0);
  const Scalar _tmp81 = _tmp39 + _tmp7;
  const Scalar _tmp82 = _tmp19 + _tmp81;
  const Scalar _tmp83 = _tmp82 + position_vector(1, 0);
  const Scalar _tmp84 = _tmp83 - p_d(1, 0);
  const Scalar _tmp85 = std::pow(Scalar(std::pow(_tmp80, Scalar(2)) + std::pow(_tmp84, Scalar(2))),
                                 Scalar(Scalar(-1) / Scalar(2)));
  const Scalar _tmp86 = _tmp80 * _tmp85;
  const Scalar _tmp87 = _tmp49 + _tmp55;
  const Scalar _tmp88 = _tmp84 * _tmp85;
  const Scalar _tmp89 = _tmp43 * _tmp86 - _tmp88;
  const Scalar _tmp90 = _tmp68 * _tmp89;
  const Scalar _tmp91 = -_tmp54 * _tmp86 - _tmp67 * _tmp90 + _tmp87 * _tmp88;
  const Scalar _tmp92 = _tmp53 * _tmp86 - _tmp75 * _tmp91 - _tmp76 * _tmp90 - _tmp86 * _tmp87;
  const Scalar _tmp93 = Scalar(1.0) / (_tmp92);
  const Scalar _tmp94 = _tmp47 * _tmp66 + _tmp57 * _tmp66 - _tmp61 * _tmp65;
  const Scalar _tmp95 = _tmp47 * _tmp86 - _tmp78 * _tmp88 + _tmp82 * _tmp86 - _tmp90 * _tmp94;
  const Scalar _tmp96 = _tmp93 * _tmp95;
  const Scalar _tmp97 = Scalar(1.0) / (_tmp95);
  const Scalar _tmp98 = _tmp92 * _tmp97;
  const Scalar _tmp99 = _tmp98 * (-_tmp47 + _tmp69 * _tmp94 - _tmp77 * _tmp96);
  ...
  const Scalar _tmp104 = _tmp86 * _tmp93;
  const Scalar _tmp105 = _tmp32 - p_b(0, 0);
  const Scalar _tmp106 = _tmp22 - p_b(1, 0);
  ...
  const Scalar _tmp123 = _tmp46 * (_tmp121 * _tmp86 - _tmp122 * _tmp66);
  const Scalar _tmp124 = Scalar(1.0) * _tmp97;
  const Scalar _tmp125 = _tmp110 * _tmp89 * _tmp97;
  const Scalar _tmp126 = fh1 * (-_tmp108 * _tmp21 + _tmp116 * _tmp31);
  const Scalar _tmp127 = -_tmp109 * _tmp46 * (_tmp100 * _tmp104 + _tmp102 * _tmp103 + Scalar(1.0)) -
                         ...
                         _tmp118 * _tmp123 -
                         _tmp126 * _tmp46 * (_tmp124 * _tmp86 - _tmp125 * _tmp66);
  const Scalar _tmp128 = Scalar(1.0) / (_tmp127);
  const Scalar _tmp129 = _tmp91 * _tmp93;
  const Scalar _tmp130 = _tmp72 + _tmp82;
  const Scalar _tmp131 = _tmp130 * _tmp75;
  const Scalar _tmp132 = Scalar(1.0) / (-_tmp131 + _tmp74 - _tmp78);
  const Scalar _tmp133 = _tmp119 * _tmp132;
  const Scalar _tmp134 = _tmp73 * (-_tmp120 * _tmp129 - _tmp130 * _tmp133 + _tmp72);
  const Scalar _tmp135 = -Scalar(1.0) * _tmp133 - Scalar(1.0) * _tmp134 + Scalar(1.0);
  const Scalar _tmp136 = _tmp130 * _tmp132;
  const Scalar _tmp137 = -_tmp100 * _tmp129 + _tmp136 * _tmp99 + _tmp70;
  const Scalar _tmp138 = Scalar(1.0) * _tmp73;
  const Scalar _tmp139 = Scalar(1.0) * _tmp132;
  const Scalar _tmp140 = fh1 * (_tmp48 + _tmp52);
  const Scalar _tmp141 = _tmp108 * _tmp140 + Scalar(40.024799999999999) * _tmp27 + _tmp31 * fv1;
  const Scalar _tmp142 = _tmp130 * _tmp73;
  const Scalar _tmp143 = Scalar(1.0) * _tmp139 * _tmp142 - Scalar(1.0) * _tmp139;
  const Scalar _tmp144 = _tmp139 * _tmp98;
  const Scalar _tmp145 = -_tmp124 * _tmp91 + _tmp130 * _tmp144;
  const Scalar _tmp146 = -_tmp111 + _tmp113 * _tmp136 - _tmp114 * _tmp129;
  const Scalar _tmp147 = -_tmp116 * _tmp140 - Scalar(40.024799999999999) * _tmp17 - _tmp21 * fv1;
  const Scalar _tmp148 = _tmp131 * _tmp139 + Scalar(1.0);
  const Scalar _tmp149 = _tmp139 * _tmp75;
  const Scalar _tmp150 = -Scalar(1.0) * _tmp138 * _tmp148 + Scalar(1.0) * _tmp149;
  const Scalar _tmp151 = Scalar(1.0) * _tmp109 * (-_tmp137 * _tmp138 + _tmp139 * _tmp99) +
                         Scalar(1.0) * _tmp117 * (_tmp113 * _tmp139 - _tmp138 * _tmp146) +
                         _tmp118 * _tmp135 +
                         Scalar(1.0) * _tmp126 * (-_tmp138 * _tmp145 + _tmp144) +
  ...
  const Scalar _tmp155 =
      -_tmp152 * _tmp154 - std::sqrt(Scalar(std::pow(Scalar(-_tmp36 + p_a(0, 0)), Scalar(2)) +
  ...
  const Scalar _tmp158 = Scalar(1.4083112389913199) * _tmp123;
  const Scalar _tmp159 = std::pow(_tmp127, Scalar(-2));
  const Scalar _tmp160 = _tmp123 * _tmp159;
  const Scalar _tmp161 = _tmp18 + _tmp81;
  const Scalar _tmp162 =
      (_tmp128 * (-_tmp135 + _tmp143 * _tmp31 + _tmp150 * _tmp161) - _tmp151 * _tmp160) /
      std::sqrt(Scalar(std::pow(_tmp151, Scalar(2)) * _tmp159 + 1));
  const Scalar _tmp163 = _tmp139 * _tmp141;
  const Scalar _tmp164 = _tmp148 * _tmp73;
  const Scalar _tmp165 = _tmp109 * _tmp137 * _tmp73 + _tmp117 * _tmp146 * _tmp73 +
                         _tmp118 * _tmp134 + _tmp126 * _tmp145 * _tmp73 - _tmp142 * _tmp163 +
                         _tmp147 * _tmp164;
  const Scalar _tmp166 = _tmp118 * _tmp121;
  const Scalar _tmp167 = _tmp102 * _tmp109 * _tmp68 + _tmp115 * _tmp117 * _tmp68 -
                         _tmp125 * _tmp126 - _tmp166 * _tmp90;
  ...
  const Scalar _tmp172 = _tmp139 * _tmp31;
  const Scalar _tmp173 = _tmp122 * _tmp171;
  const Scalar _tmp174 =
      (-_tmp165 * _tmp173 + _tmp168 * (-_tmp134 - _tmp142 * _tmp172 + _tmp161 * _tmp164)) /
      std::sqrt(Scalar(std::pow(_tmp165, Scalar(2)) * _tmp171 + 1));
  const Scalar _tmp175 = Scalar(1.4083112389913199) * _tmp167;
  const Scalar _tmp176 =
      -_tmp169 * _tmp175 - std::sqrt(Scalar(std::pow(Scalar(-_tmp58 + p_c(1, 0)), Scalar(2)) +
                                            std::pow(Scalar(-_tmp62 + p_c(0, 0)), Scalar(2))));
  const Scalar _tmp177 = Scalar(1.4083112389913199) * _tmp121;
  const Scalar _tmp178 = _tmp177 * _tmp90;
  const Scalar _tmp179 = Scalar(0.71007031138673404) * _tmp168;
  const Scalar _tmp180 = _tmp176 * _tmp179;
  const Scalar _tmp181 = -_tmp109 * _tmp132 * _tmp99 - _tmp113 * _tmp117 * _tmp132 +
                         _tmp118 * _tmp133 - _tmp126 * _tmp144 - _tmp147 * _tmp149 + _tmp163;
  const Scalar _tmp182 = _tmp93 * fh1;
  const Scalar _tmp183 =
      _tmp100 * _tmp108 * _tmp182 + _tmp114 * _tmp116 * _tmp182 + _tmp124 * _tmp126 + _tmp166;
  const Scalar _tmp184 = Scalar(1.0) / (_tmp183);
  const Scalar _tmp185 = std::asinh(_tmp181 * _tmp184);
  const Scalar _tmp186 = Scalar(1.0) * _tmp185;
  const Scalar _tmp187 = Scalar(1.4083112389913199) * _tmp183;
  const Scalar _tmp188 =
      -_tmp185 * _tmp187 - std::sqrt(Scalar(std::pow(Scalar(-_tmp79 + p_d(0, 0)), Scalar(2)) +
  ...
  const Scalar _tmp193 = (_tmp181 * _tmp192 + _tmp184 * (-_tmp133 - _tmp149 * _tmp161 + _tmp172)) /
  ...
  _res(2, 0) = _tmp175 * (-Scalar(1.0) * _tmp174 * std::cosh(_tmp170) -
                          (-Scalar(0.71007031138673404) * _tmp173 * _tmp176 +
                           _tmp179 * (-_tmp169 * _tmp178 - _tmp174 * _tmp175)) *
                              std::cosh(_tmp180)) +
               _tmp178 * (-std::sinh(_tmp170) - std::sinh(_tmp180));
  _res(3, 0) = -_tmp177 * (-std::sinh(_tmp186) - std::sinh(_tmp190)) +
               _tmp187 * (-Scalar(1.0) * _tmp193 * std::cosh(_tmp186) -
                          (Scalar(0.71007031138673404) * _tmp188 * _tmp192 +
