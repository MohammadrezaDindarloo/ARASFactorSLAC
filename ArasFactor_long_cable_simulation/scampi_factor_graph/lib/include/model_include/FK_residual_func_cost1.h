...
Eigen::Matrix<Scalar, 4, 1> FkResidualFuncCost1(
  ...
  const Scalar _tmp54 = _tmp22 + _tmp45;
  ...
  const Scalar _tmp84 = _tmp82 * (-_tmp54 + _tmp83);
  ...
  const Scalar _tmp97 = -_tmp54 * _tmp74 + _tmp58 * _tmp62 + _tmp62 * _tmp96;
  const Scalar _tmp98 = _tmp42 * _tmp50 - _tmp46 * _tmp64 + _tmp50 * _tmp96 - _tmp76 * _tmp97;
  ...
  const Scalar _tmp126 = _tmp42 + _tmp81;
  const Scalar _tmp127 = _tmp126 * _tmp84;
  const Scalar _tmp128 = Scalar(1.0) / (-_tmp127 - _tmp46 + _tmp83);
  ...
  const Scalar _tmp133 = _tmp101 * _tmp129;
  const Scalar _tmp134 = -_tmp119 * _tmp79 + _tmp126 * _tmp133;
  const Scalar _tmp135 = _tmp126 * _tmp128;
  const Scalar _tmp136 = _tmp112 + _tmp114 * _tmp135 - _tmp115 * _tmp79;
  const Scalar _tmp137 = _tmp102 * _tmp135 - _tmp103 * _tmp79 - _tmp93;
  const Scalar _tmp138 = _tmp126 * _tmp82;
  const Scalar _tmp139 = _tmp117 * _tmp124 + Scalar(40.024799999999999) * _tmp26 + _tmp30 * fv1;
  const Scalar _tmp140 = _tmp128 * _tmp87;
  const Scalar _tmp141 = -_tmp126 * _tmp140 - _tmp79 * _tmp88 + _tmp81;
  const Scalar _tmp142 = std::asinh(
      _tmp122 * (Scalar(1.0) * _tmp110 * (_tmp102 * _tmp129 - _tmp132 * _tmp137) +
                 Scalar(1.0) * _tmp118 * (_tmp114 * _tmp129 - _tmp132 * _tmp136) +
                 ...
                 Scalar(1.0) * _tmp40 * (-_tmp129 * _tmp87 - _tmp132 * _tmp141 + Scalar(1.0))));
  const Scalar _tmp143 = Scalar(1.4083112389913199) * _tmp121;
  const Scalar _tmp144 = _tmp129 * _tmp139;
  const Scalar _tmp145 = _tmp119 * _tmp120;
  const Scalar _tmp146 = _tmp40 * _tmp88;
  const Scalar _tmp147 =
      _tmp104 * _tmp110 * _tmp75 + _tmp116 * _tmp118 * _tmp75 - _tmp145 * _tmp76 - _tmp146 * _tmp76;
  const Scalar _tmp148 = Scalar(1.0) / (_tmp147);
  const Scalar _tmp149 =
      std::asinh(_tmp148 * (_tmp110 * _tmp137 * _tmp82 + _tmp118 * _tmp136 * _tmp82 +
                            _tmp120 * _tmp134 * _tmp82 + _tmp125 * _tmp131 * _tmp82 -
                            _tmp138 * _tmp144 + _tmp141 * _tmp40 * _tmp82));
  const Scalar _tmp150 = Scalar(0.71007031138673404) * _tmp148;
  const Scalar _tmp151 = Scalar(1.4083112389913199) * _tmp147;
  const Scalar _tmp152 = _tmp103 * _tmp110 + _tmp115 * _tmp118 + _tmp145 + _tmp146;
  const Scalar _tmp153 = Scalar(1.0) / (_tmp152);
  const Scalar _tmp154 =
      std::asinh(_tmp153 * (-_tmp102 * _tmp110 * _tmp128 - _tmp114 * _tmp118 * _tmp128 -
                            _tmp120 * _tmp133 - _tmp125 * _tmp130 + _tmp140 * _tmp40 + _tmp144));
