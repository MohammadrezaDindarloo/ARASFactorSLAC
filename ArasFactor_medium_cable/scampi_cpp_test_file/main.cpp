...
int main(int argc, char const *argv[])
{
  ...
  std::cout << std::endl << "sagging_1: " << std::endl << inverse_results[1].col(0)[0] - (inverse_results[5].col(0) - Pulley_a).norm() << std::endl;
  std::cout << std::endl << "sagging_2: " << std::endl << inverse_results[1].col(0)[1] - (inverse_results[5].col(1) - Pulley_b).norm() << std::endl;
  std::cout << std::endl << "sagging_3: " << std::endl << inverse_results[1].col(0)[2] - (inverse_results[5].col(2) - Pulley_c).norm() << std::endl;
  std::cout << std::endl << "sagging_4: " << std::endl << inverse_results[1].col(0)[3] - (inverse_results[5].col(3) - Pulley_d).norm() << std::endl;
  ...
  std::cout << std::endl << "p_platform_error in  mm: " << std::endl << (forward_result[1] - p_platform).norm() * 1000 << std::endl;
