...
Eigen::Matrix<Scalar, 4, 1> FkResidualFuncCost2(
  ...
  const Scalar _tmp59 = _tmp34 + _tmp49;
  const Scalar _tmp60 = _tmp20 + _tmp41;
  const Scalar _tmp61 = _TransformationMatrix[4] + _tmp60;
  const Scalar _tmp62 = _tmp61 - p_c(0, 0);
  const Scalar _tmp63 = _tmp44 + _tmp5;
  ...
  const Scalar _tmp68 = _tmp40 * _tmp67 - _tmp59 * _tmp67;
  ...
  const Scalar _tmp80 = _tmp50 * _tmp69 - _tmp58 * _tmp78 - _tmp74 * _tmp79;
  ...
  const Scalar _tmp86 = _tmp40 * _tmp58 - _tmp50 * _tmp58 - _tmp68 * _tmp77 - _tmp80 * _tmp85;
  ...
  const Scalar _tmp99 = _tmp51 * _tmp58 - _tmp54 * _tmp69 + _tmp58 * _tmp97 - _tmp77 * _tmp98;
  ...
  const Scalar _tmp114 = _tmp112 * _tmp68 - _tmp113 * _tmp85 - _tmp40;
  ...
  const Scalar _tmp124 = _tmp51 + _tmp82;
  const Scalar _tmp125 = _tmp124 * _tmp85;
  const Scalar _tmp126 = Scalar(1.0) / (-_tmp125 - _tmp54 + _tmp84);
  const Scalar _tmp127 = Scalar(1.0) * _tmp126;
  const Scalar _tmp128 = _tmp102 * _tmp127;
  const Scalar _tmp129 = _tmp124 * _tmp127;
  const Scalar _tmp130 = _tmp102 * _tmp129 - _tmp120 * _tmp80;
  const Scalar _tmp131 = Scalar(1.0) * _tmp83;
  const Scalar _tmp132 = _tmp124 * _tmp126;
  const Scalar _tmp133 = _tmp113 + _tmp115 * _tmp132 - _tmp116 * _tmp80;
  const Scalar _tmp134 = _tmp39 * fh1;
  const Scalar _tmp135 = -_tmp110 * _tmp134 - Scalar(5.1796800000000003) * _tmp15 - _tmp18 * fv1;
  const Scalar _tmp136 = _tmp127 * _tmp85;
  const Scalar _tmp137 = _tmp125 * _tmp127 + Scalar(1.0);
  const Scalar _tmp138 = _tmp103 * _tmp132 - _tmp104 * _tmp80 - _tmp94;
  const Scalar _tmp139 = _tmp126 * _tmp88;
  const Scalar _tmp140 = -_tmp124 * _tmp139 - _tmp80 * _tmp89 + _tmp82;
  const Scalar _tmp141 = _tmp118 * _tmp134 + Scalar(5.1796800000000003) * _tmp26 + _tmp29 * fv1;
  const Scalar _tmp142 = std::asinh(
      _tmp123 * (Scalar(1.0) * _tmp111 * (_tmp103 * _tmp127 - _tmp131 * _tmp138) +
                 Scalar(1.0) * _tmp119 * (_tmp115 * _tmp127 - _tmp131 * _tmp133) +
                 Scalar(1.0) * _tmp121 * (_tmp128 - _tmp130 * _tmp131) +
                 Scalar(1.0) * _tmp135 * (-_tmp131 * _tmp137 + _tmp136) +
                 Scalar(1.0) * _tmp141 * (-_tmp127 + _tmp129 * _tmp83) +
                 Scalar(1.0) * _tmp48 * (-_tmp127 * _tmp88 - _tmp131 * _tmp140 + Scalar(1.0))));
  const Scalar _tmp143 = Scalar(9.6622558468725703) * _tmp122;
  const Scalar _tmp144 = _tmp48 * _tmp89;
  const Scalar _tmp145 = _tmp120 * _tmp121;
  const Scalar _tmp146 =
      _tmp105 * _tmp111 * _tmp76 + _tmp117 * _tmp119 * _tmp76 - _tmp144 * _tmp77 - _tmp145 * _tmp77;
  const Scalar _tmp147 = Scalar(1.0) / (_tmp146);
  const Scalar _tmp148 = _tmp127 * _tmp141;
  const Scalar _tmp149 =
      std::asinh(_tmp147 * (_tmp111 * _tmp138 * _tmp83 + _tmp119 * _tmp133 * _tmp83 +
                            _tmp121 * _tmp130 * _tmp83 - _tmp124 * _tmp148 * _tmp83 +
                            _tmp135 * _tmp137 * _tmp83 + _tmp140 * _tmp48 * _tmp83));
  const Scalar _tmp150 = Scalar(9.6622558468725703) * _tmp146;
  const Scalar _tmp151 = std::pow(Scalar(-_tmp61 + p_c(0, 0)), Scalar(2)) +
  ...
  const Scalar _tmp153 = _tmp104 * _tmp111 + _tmp116 * _tmp119 + _tmp144 + _tmp145;
  const Scalar _tmp154 = Scalar(1.0) / (_tmp153);
  const Scalar _tmp155 =
      std::asinh(_tmp154 * (-_tmp103 * _tmp111 * _tmp126 - _tmp115 * _tmp119 * _tmp126 -
                            _tmp121 * _tmp128 - _tmp135 * _tmp136 + _tmp139 * _tmp48 + _tmp148));
  ...
  _res(1, 0) =
      _tmp143 *
          (-std::sinh(Scalar(1.0) * _tmp142) -
           std::sinh(Scalar(0.1034955) * _tmp123 * (-_tmp142 * _tmp143 - std::sqrt(_tmp47)))) -
      std::sqrt(Scalar(
          _tmp47 + std::pow(Scalar(-_TransformationMatrix[6] - _tmp40 + p_b(2, 0)), Scalar(2))));
  _res(2, 0) =
      _tmp150 *
          (-std::sinh(Scalar(1.0) * _tmp149) -
           std::sinh(Scalar(0.1034955) * _tmp147 * (-_tmp149 * _tmp150 - std::sqrt(_tmp151)))) -
      std::sqrt(Scalar(
          _tmp151 + std::pow(Scalar(-_TransformationMatrix[6] - _tmp59 + p_c(2, 0)), Scalar(2))));
  _res(3, 0) =
      _tmp156 *
          (-std::sinh(Scalar(1.0) * _tmp155) -
           std::sinh(Scalar(0.1034955) * _tmp154 * (-std::sqrt(_tmp152) - _tmp155 * _tmp156))) -
      std::sqrt(Scalar(
          _tmp152 + std::pow(Scalar(-_TransformationMatrix[6] - _tmp50 + p_d(2, 0)), Scalar(2))));
