...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl11(
  ...
  const Scalar _tmp71 = _tmp34 + _tmp60;
  const Scalar _tmp72 = _tmp68 * _tmp69;
  const Scalar _tmp73 = _tmp71 * _tmp72;
  const Scalar _tmp74 = -_tmp57 * _tmp73 + _tmp62 * _tmp70;
  const Scalar _tmp75 = Scalar(1.0) / (_tmp57 * _tmp72 - _tmp70);
  const Scalar _tmp76 = _tmp59 * _tmp75;
  const Scalar _tmp77 = _tmp58 * _tmp71;
  const Scalar _tmp78 = _tmp49 * _tmp61 - _tmp57 * _tmp77 - _tmp74 * _tmp76;
  ...
  const Scalar _tmp84 = -_tmp62 * _tmp72 + _tmp73;
  const Scalar _tmp85 = -_tmp58 * _tmp61 - _tmp76 * _tmp84 + _tmp77 - _tmp78 * _tmp83;
  ...
  const Scalar _tmp94 = _tmp63 * _tmp72 - _tmp66 * _tmp70 + _tmp72 * _tmp93;
  const Scalar _tmp95 = _tmp41 * _tmp58 - _tmp45 * _tmp49 + _tmp58 * _tmp93 - _tmp76 * _tmp94;
  ...
  const Scalar _tmp101 = -_tmp100 * _tmp59 + Scalar(1.0);
  const Scalar _tmp102 = _tmp72 * _tmp75;
  const Scalar _tmp103 = _tmp20 + Scalar(8.3885017487099702);
  const Scalar _tmp104 = _tmp31 + Scalar(-2.5193355532036801);
  ...
  const Scalar _tmp108 = _tmp57 * _tmp75;
  const Scalar _tmp109 = _tmp108 * _tmp74 + _tmp57 * _tmp71;
  const Scalar _tmp110 = _tmp108 * _tmp84 - _tmp109 * _tmp83 - _tmp71;
  const Scalar _tmp111 = _tmp98 * (_tmp108 * _tmp94 - _tmp110 * _tmp96 - _tmp93);
  const Scalar _tmp112 = _tmp86 * (_tmp110 + _tmp111);
  const Scalar _tmp113 = -_tmp112 * _tmp59 - _tmp57;
  const Scalar _tmp114 = _tmp104 * _tmp105;
  const Scalar _tmp115 = _tmp114 * fh1;
  const Scalar _tmp116 = Scalar(1.0) * _tmp97;
  const Scalar _tmp117 = _tmp59 * _tmp87 * _tmp97;
  const Scalar _tmp118 = fh1 * (_tmp106 * _tmp30 - _tmp114 * _tmp19);
  const Scalar _tmp119 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp120 = _tmp79 * _tmp83 + _tmp82;
  const Scalar _tmp121 = 0;
  const Scalar _tmp122 = -_tmp107 * _tmp92 * (_tmp100 * _tmp58 + _tmp101 * _tmp102) -
                         _tmp115 * _tmp92 * (_tmp102 * _tmp113 + _tmp112 * _tmp58 + Scalar(1.0)) -
                         _tmp118 * _tmp92 * (_tmp116 * _tmp58 - _tmp117 * _tmp72) -
                         _tmp119 * _tmp92 * (_tmp121 * _tmp58 - _tmp121 * _tmp72 * _tmp76);
  const Scalar _tmp123 = Scalar(1.0) / (_tmp122);
  const Scalar _tmp124 = _tmp41 + _tmp80;
  const Scalar _tmp125 = _tmp124 * _tmp83;
  const Scalar _tmp126 = Scalar(1.0) / (-_tmp125 - _tmp45 + _tmp82);
  const Scalar _tmp127 = Scalar(1.0) * _tmp126;
  const Scalar _tmp128 = _tmp120 * _tmp126;
  const Scalar _tmp129 = -_tmp121 * _tmp78 - _tmp124 * _tmp128 + _tmp80;
  ...
  const Scalar _tmp134 = -_tmp106 * _tmp133 - Scalar(5.1796800000000003) * _tmp16 - _tmp19 * fv1;
  const Scalar _tmp135 = _tmp124 * _tmp127;
  const Scalar _tmp136 = -_tmp116 * _tmp78 + _tmp135 * _tmp98;
  const Scalar _tmp137 = _tmp127 * _tmp98;
  const Scalar _tmp138 = _tmp124 * _tmp126;
  const Scalar _tmp139 = _tmp109 + _tmp111 * _tmp138 - _tmp112 * _tmp78;
  const Scalar _tmp140 = -_tmp100 * _tmp78 + _tmp138 * _tmp99 - _tmp88;
  const Scalar _tmp141 = _tmp114 * _tmp133 + Scalar(5.1796800000000003) * _tmp27 + _tmp30 * fv1;
  const Scalar _tmp142 = std::asinh(
      _tmp123 * (Scalar(1.0) * _tmp107 * (_tmp127 * _tmp99 - _tmp130 * _tmp140) +
                 Scalar(1.0) * _tmp115 * (_tmp111 * _tmp127 - _tmp130 * _tmp139) +
                 Scalar(1.0) * _tmp118 * (-_tmp130 * _tmp136 + _tmp137) +
                 Scalar(1.0) * _tmp119 * (-_tmp120 * _tmp127 - _tmp129 * _tmp130 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp134 * (-_tmp130 * _tmp132 + _tmp131) +
                 Scalar(1.0) * _tmp141 * (-_tmp127 + _tmp135 * _tmp81)));
  const Scalar _tmp143 = Scalar(9.6622558468725703) * _tmp122;
  const Scalar _tmp144 = _tmp119 * _tmp121;
  const Scalar _tmp145 = _tmp101 * _tmp107 * _tmp75 + _tmp113 * _tmp115 * _tmp75 -
                         _tmp117 * _tmp118 - _tmp144 * _tmp76;
  const Scalar _tmp146 = Scalar(1.0) / (_tmp145);
  const Scalar _tmp147 = _tmp127 * _tmp141;
  const Scalar _tmp148 =
      std::asinh(_tmp146 * (_tmp107 * _tmp140 * _tmp81 + _tmp115 * _tmp139 * _tmp81 +
                            _tmp118 * _tmp136 * _tmp81 + _tmp119 * _tmp129 * _tmp81 -
                            _tmp124 * _tmp147 * _tmp81 + _tmp132 * _tmp134 * _tmp81));
  const Scalar _tmp149 = Scalar(9.6622558468725703) * _tmp145;
  const Scalar _tmp150 = _tmp100 * _tmp107 + _tmp112 * _tmp115 + _tmp116 * _tmp118 + _tmp144;
  const Scalar _tmp151 = Scalar(1.0) / (_tmp150);
  const Scalar _tmp152 =
      std::asinh(_tmp151 * (-_tmp107 * _tmp126 * _tmp99 - _tmp111 * _tmp115 * _tmp126 -
                            _tmp118 * _tmp137 + _tmp119 * _tmp128 - _tmp131 * _tmp134 + _tmp147));
  ...
  _res(0, 0) =
      -_tmp33 *
          (Scalar(0.876505537412406) * _tmp0 + std::cosh(Scalar(1.0) * _tmp32) -
           std::cosh(
               ...
               (-_tmp32 * _tmp33 -
                Scalar(8.3885017487099702) *
                    std::sqrt(Scalar(
                        ...
                        std::pow(Scalar(-Scalar(0.11921079949155229) * _tmp20 - 1),
                                 Scalar(2))))))) +
  ...
  _res(2, 0) =
      -_tmp149 *
          (Scalar(0.86564762886483004) * _tmp146 + std::cosh(Scalar(1.0) * _tmp148) -
                      ...
                      Scalar(4.7744369927459998) *
                          std::sqrt(Scalar(
                              ...
                              Scalar(0.32387954179207445) *
                                  std::pow(Scalar(1 - Scalar(0.36803241838814449) * _tmp67),
                                           Scalar(2))))))) +
                ...
                Scalar(8.3196563720703107) *
                    std::sqrt(Scalar(
                        ...
                        Scalar(0.057067943527034905) *
                            std::pow(Scalar(-Scalar(0.50315118477277876) * _tmp46 - 1),
                                     Scalar(2))))))) +
