...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl13(
  ...
  const Scalar _tmp51 = _tmp19 + _tmp37;
  ...
  const Scalar _tmp56 = _tmp55 + Scalar(-2.5193355532036801);
  ...
  const Scalar _tmp60 = _tmp16 + _tmp41;
  ...
  const Scalar _tmp69 = _tmp50 * _tmp67 - _tmp60 * _tmp68 + _tmp63 * _tmp67;
  const Scalar _tmp70 = _tmp40 * _tmp48;
  const Scalar _tmp71 = _tmp58 * _tmp70 - _tmp59;
  const Scalar _tmp72 = Scalar(1.0) / (_tmp67 * _tmp70 - _tmp68);
  const Scalar _tmp73 = _tmp71 * _tmp72;
  const Scalar _tmp74 = _tmp50 * _tmp58 + _tmp51 * _tmp58 - _tmp54 * _tmp59 - _tmp69 * _tmp73;
  ...
  const Scalar _tmp89 = _tmp87 * (-_tmp60 + _tmp88);
  const Scalar _tmp90 = _tmp85 * _tmp89 + _tmp88;
  const Scalar _tmp91 = 0;
  const Scalar _tmp92 = _tmp32 - _tmp33;
  ...
  const Scalar _tmp98 = -_tmp67 * _tmp97 + _tmp68 * _tmp96;
  const Scalar _tmp99 = -_tmp58 * _tmp97 + _tmp59 * _tmp93 - _tmp73 * _tmp98;
  const Scalar _tmp100 = _tmp67 * _tmp95 - _tmp67 * _tmp96;
  const Scalar _tmp101 = -_tmp100 * _tmp73 - _tmp58 * _tmp93 + _tmp58 * _tmp95 - _tmp89 * _tmp99;
  ...
  const Scalar _tmp106 = -_tmp100 * _tmp104 + _tmp105 * _tmp89;
  const Scalar _tmp107 = _tmp102 * _tmp74;
  const Scalar _tmp108 = _tmp101 * _tmp75;
  const Scalar _tmp109 = _tmp108 * (-_tmp104 * _tmp69 - _tmp106 * _tmp107);
  const Scalar _tmp110 = _tmp106 + _tmp109;
  const Scalar _tmp111 = _tmp102 * _tmp58;
  const Scalar _tmp112 = _tmp102 * _tmp71;
  const Scalar _tmp113 = -_tmp110 * _tmp112 + Scalar(1.0);
  const Scalar _tmp114 = _tmp67 * _tmp72;
  const Scalar _tmp115 = _tmp81 * fh1;
  const Scalar _tmp116 = _tmp70 * _tmp72;
  const Scalar _tmp117 = _tmp116 * _tmp98 + _tmp97;
  const Scalar _tmp118 = _tmp100 * _tmp116 - _tmp117 * _tmp89 - _tmp95;
  const Scalar _tmp119 = _tmp108 * (-_tmp107 * _tmp118 + _tmp116 * _tmp69 - _tmp50);
  const Scalar _tmp120 = _tmp118 + _tmp119;
  const Scalar _tmp121 = -_tmp112 * _tmp120 - _tmp70;
  const Scalar _tmp122 = _tmp82 * fh1;
  const Scalar _tmp123 = -_tmp115 * _tmp49 * (_tmp110 * _tmp111 + _tmp113 * _tmp114) -
                         _tmp122 * _tmp49 * (_tmp111 * _tmp120 + _tmp114 * _tmp121 + Scalar(1.0)) -
                         _tmp49 * _tmp83 * (_tmp58 * _tmp76 - _tmp76 * _tmp77) -
                         _tmp49 * _tmp84 * (_tmp103 * _tmp58 - _tmp103 * _tmp77);
  const Scalar _tmp124 = Scalar(1.0) / (_tmp123);
  const Scalar _tmp125 = _tmp102 * _tmp99;
  const Scalar _tmp126 = _tmp51 + _tmp86;
  const Scalar _tmp127 = _tmp126 * _tmp89;
  const Scalar _tmp128 = Scalar(1.0) / (-_tmp127 - _tmp54 + _tmp88);
  const Scalar _tmp129 = _tmp126 * _tmp128;
  const Scalar _tmp130 = -_tmp105 + _tmp109 * _tmp129 - _tmp110 * _tmp125;
  const Scalar _tmp131 = Scalar(1.0) * _tmp87;
  const Scalar _tmp132 = Scalar(1.0) * _tmp128;
  const Scalar _tmp133 = _tmp108 * _tmp132;
  const Scalar _tmp134 = _tmp126 * _tmp133 - _tmp76 * _tmp99;
  const Scalar _tmp135 = _tmp35 * fh1;
  const Scalar _tmp136 = -_tmp135 * _tmp81 - Scalar(5.1796800000000003) * _tmp22 - _tmp27 * fv1;
  const Scalar _tmp137 = _tmp132 * _tmp89;
  const Scalar _tmp138 = _tmp127 * _tmp132 + Scalar(1.0);
  const Scalar _tmp139 = _tmp128 * _tmp90;
  const Scalar _tmp140 = -_tmp125 * _tmp91 - _tmp126 * _tmp139 + _tmp86;
  const Scalar _tmp141 = _tmp117 + _tmp119 * _tmp129 - _tmp120 * _tmp125;
  const Scalar _tmp142 = _tmp126 * _tmp87;
  const Scalar _tmp143 = Scalar(5.1796800000000003) * _tmp11 + _tmp135 * _tmp82 + _tmp17 * fv1;
  const Scalar _tmp144 = std::asinh(
      _tmp124 * (Scalar(1.0) * _tmp115 * (_tmp109 * _tmp132 - _tmp130 * _tmp131) +
                 Scalar(1.0) * _tmp122 * (_tmp119 * _tmp132 - _tmp131 * _tmp141) +
                 Scalar(1.0) * _tmp136 * (-_tmp131 * _tmp138 + _tmp137) +
                 Scalar(1.0) * _tmp143 * (_tmp132 * _tmp142 - _tmp132) +
                 Scalar(1.0) * _tmp83 * (-_tmp131 * _tmp134 + _tmp133) +
                 Scalar(1.0) * _tmp84 * (-_tmp131 * _tmp140 - _tmp132 * _tmp90 + Scalar(1.0))));
  const Scalar _tmp145 = Scalar(9.6622558468725703) * _tmp123;
  const Scalar _tmp146 = _tmp132 * _tmp143;
  const Scalar _tmp147 = _tmp76 * _tmp83;
  const Scalar _tmp148 = _tmp103 * _tmp84;
  const Scalar _tmp149 =
      _tmp113 * _tmp115 * _tmp72 + _tmp121 * _tmp122 * _tmp72 - _tmp147 * _tmp73 - _tmp148 * _tmp73;
  const Scalar _tmp150 = Scalar(1.0) / (_tmp149);
  const Scalar _tmp151 =
      std::asinh(_tmp150 * (_tmp115 * _tmp130 * _tmp87 + _tmp122 * _tmp141 * _tmp87 +
                            _tmp134 * _tmp83 * _tmp87 + _tmp136 * _tmp138 * _tmp87 +
                            _tmp140 * _tmp84 * _tmp87 - _tmp142 * _tmp146));
  const Scalar _tmp152 = Scalar(9.6622558468725703) * _tmp149;
  const Scalar _tmp153 =
      _tmp102 * _tmp110 * _tmp115 + _tmp102 * _tmp120 * _tmp122 + _tmp147 + _tmp148;
  const Scalar _tmp154 = Scalar(1.0) / (_tmp153);
  const Scalar _tmp155 =
      std::asinh(_tmp154 * (-_tmp109 * _tmp115 * _tmp128 - _tmp119 * _tmp122 * _tmp128 -
                            _tmp133 * _tmp83 - _tmp136 * _tmp137 + _tmp139 * _tmp84 + _tmp146));
  ...
  _res(1, 0) =
      -_tmp145 *
          (Scalar(0.87679799777269396) * _tmp124 + std::cosh(Scalar(1.0) * _tmp144) -
           std::cosh(
                ...
                Scalar(4.83288938413423) *
                    std::sqrt(Scalar(
                        ...
                        Scalar(0.13818785160942856) *
                            std::pow(Scalar(-Scalar(0.55661923802822921) * _tmp61 - 1),
                                     Scalar(2))))))) +
                ...
                Scalar(8.3885017487099702) *
                    std::sqrt(Scalar(
                        Scalar(0.090199313518583735) *
                            std::pow(Scalar(1 - Scalar(0.39693005512043167) * _tmp55), Scalar(2)) +
                        std::pow(Scalar(-Scalar(0.11921079949155229) * _tmp52 - 1),
                                 Scalar(2))))))) +
      _tmp93 + position_vector(2, 0);
