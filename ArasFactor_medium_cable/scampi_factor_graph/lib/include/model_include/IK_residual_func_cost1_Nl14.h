...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl14(
  ...
  const Scalar _tmp49 = _tmp16 + _tmp36;
  ...
  const Scalar _tmp54 = _tmp53 + Scalar(8.3885017487099702);
  const Scalar _tmp55 =
  ...
  const Scalar _tmp60 = -_tmp38 * _tmp47 + _tmp41 * _tmp48 + _tmp48 * _tmp59;
  const Scalar _tmp61 = _tmp54 * _tmp57;
  const Scalar _tmp62 = Scalar(1.0) / (-_tmp47 + _tmp48 * _tmp61);
  const Scalar _tmp63 = _tmp61 * _tmp62;
  const Scalar _tmp64 = -_tmp31;
  const Scalar _tmp65 = _tmp32 - _tmp33;
  const Scalar _tmp66 = _tmp64 + _tmp65;
  const Scalar _tmp67 = _tmp34 + _tmp64;
  const Scalar _tmp68 = _tmp61 * _tmp67;
  const Scalar _tmp69 = _tmp47 * _tmp66 - _tmp48 * _tmp68;
  const Scalar _tmp70 = _tmp63 * _tmp69 + _tmp68;
  const Scalar _tmp71 = Scalar(1.0) * _tmp52;
  ...
  const Scalar _tmp77 = _tmp62 * (-_tmp48 * _tmp66 + _tmp48 * _tmp67);
  const Scalar _tmp78 = _tmp61 * _tmp77 - _tmp67 - _tmp70 * _tmp76;
  const Scalar _tmp79 = _tmp37 + _tmp8;
  ...
  const Scalar _tmp90 = _tmp31 + _tmp65;
  const Scalar _tmp91 = -_tmp68 * _tmp86 - _tmp69 * _tmp89 + _tmp87 * _tmp90;
  const Scalar _tmp92 = _tmp67 * _tmp86 - _tmp76 * _tmp91 - _tmp77 * _tmp88 - _tmp86 * _tmp90;
  const Scalar _tmp93 = Scalar(1.0) / (_tmp92);
  const Scalar _tmp94 = _tmp59 * _tmp86 - _tmp60 * _tmp89 - _tmp79 * _tmp87 + _tmp82 * _tmp86;
  const Scalar _tmp95 = _tmp93 * _tmp94;
  const Scalar _tmp96 = Scalar(1.0) / (_tmp94);
  const Scalar _tmp97 = _tmp92 * _tmp96;
  const Scalar _tmp98 = _tmp97 * (-_tmp59 + _tmp60 * _tmp63 - _tmp78 * _tmp95);
  const Scalar _tmp99 = _tmp78 + _tmp98;
  const Scalar _tmp100 = _tmp86 * _tmp93;
  const Scalar _tmp101 = _tmp88 * _tmp93;
  const Scalar _tmp102 = -_tmp101 * _tmp99 - _tmp61;
  const Scalar _tmp103 = _tmp48 * _tmp62;
  const Scalar _tmp104 = _tmp18 + Scalar(-2.7171519410699099);
  const Scalar _tmp105 = _tmp28 + Scalar(-4.7744369927459998);
  ...
  const Scalar _tmp113 = _tmp48 * _tmp89;
  const Scalar _tmp114 = Scalar(1.0) * _tmp96;
  const Scalar _tmp115 = _tmp105 * _tmp106;
  const Scalar _tmp116 = fh1 * (-_tmp107 * _tmp27 + _tmp115 * _tmp17);
  const Scalar _tmp117 = Scalar(1.0) * _tmp73;
  const Scalar _tmp118 = _tmp117 * _tmp62 * _tmp69 * _tmp75 - Scalar(1.0) * _tmp77;
  const Scalar _tmp119 = Scalar(1.0) * _tmp62;
  const Scalar _tmp120 = _tmp97 * (-_tmp118 * _tmp95 - _tmp119 * _tmp60);
  const Scalar _tmp121 = _tmp118 + _tmp120;
  const Scalar _tmp122 = -_tmp101 * _tmp121 + Scalar(1.0);
  const Scalar _tmp123 = _tmp115 * fh1;
  const Scalar _tmp124 = -_tmp108 * _tmp58 * (_tmp100 * _tmp99 + _tmp102 * _tmp103 + Scalar(1.0)) -
                         _tmp109 * _tmp58 * (-_tmp112 * _tmp113 + _tmp112 * _tmp86) -
                         _tmp116 * _tmp58 * (-_tmp113 * _tmp114 + _tmp114 * _tmp86) -
                         _tmp123 * _tmp58 * (_tmp100 * _tmp121 + _tmp103 * _tmp122);
  const Scalar _tmp125 = Scalar(1.0) / (_tmp124);
  const Scalar _tmp126 = _tmp35 * fh1;
  const Scalar _tmp127 = -_tmp115 * _tmp126 - Scalar(5.1796800000000003) * _tmp22 - _tmp27 * fv1;
  const Scalar _tmp128 = _tmp72 + _tmp82;
  const Scalar _tmp129 = _tmp128 * _tmp76;
  const Scalar _tmp130 = Scalar(1.0) / (-_tmp129 + _tmp74 - _tmp79);
  const Scalar _tmp131 = Scalar(1.0) * _tmp130;
  const Scalar _tmp132 = _tmp73 * (_tmp129 * _tmp131 + Scalar(1.0));
  const Scalar _tmp133 = _tmp131 * _tmp76;
  const Scalar _tmp134 = _tmp128 * _tmp130;
  const Scalar _tmp135 = _tmp91 * _tmp93;
  const Scalar _tmp136 = _tmp134 * _tmp98 - _tmp135 * _tmp99 + _tmp70;
  const Scalar _tmp137 = _tmp110 * _tmp130;
  const Scalar _tmp138 = -_tmp111 * _tmp135 - _tmp128 * _tmp137 + _tmp72;
  const Scalar _tmp139 = -_tmp119 * _tmp69 + _tmp120 * _tmp134 - _tmp121 * _tmp135;
  const Scalar _tmp140 = _tmp131 * _tmp97;
  const Scalar _tmp141 = -_tmp114 * _tmp91 + _tmp128 * _tmp140;
  const Scalar _tmp142 = _tmp107 * _tmp126 + Scalar(5.1796800000000003) * _tmp11 + _tmp17 * fv1;
  const Scalar _tmp143 = _tmp128 * _tmp73;
  const Scalar _tmp144 = std::asinh(
      _tmp125 * (Scalar(1.0) * _tmp108 * (-_tmp117 * _tmp136 + _tmp131 * _tmp98) +
                 Scalar(1.0) * _tmp109 * (-_tmp110 * _tmp131 - _tmp117 * _tmp138 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp116 * (-_tmp117 * _tmp141 + _tmp140) +
                 Scalar(1.0) * _tmp123 * (-_tmp117 * _tmp139 + _tmp120 * _tmp131) +
                 Scalar(1.0) * _tmp127 * (-Scalar(1.0) * _tmp132 + _tmp133) +
  ...
  const Scalar _tmp148 =
      _tmp102 * _tmp108 * _tmp62 + _tmp122 * _tmp123 * _tmp62 - _tmp146 * _tmp89 - _tmp147 * _tmp89;
  const Scalar _tmp149 = Scalar(1.0) / (_tmp148);
  const Scalar _tmp150 = _tmp131 * _tmp142;
  const Scalar _tmp151 =
      std::asinh(_tmp149 * (_tmp108 * _tmp136 * _tmp73 + _tmp109 * _tmp138 * _tmp73 +
                            _tmp116 * _tmp141 * _tmp73 + _tmp123 * _tmp139 * _tmp73 +
                            _tmp127 * _tmp132 - _tmp143 * _tmp150));
  const Scalar _tmp152 = Scalar(9.6622558468725703) * _tmp148;
  const Scalar _tmp153 = _tmp108 * _tmp93 * _tmp99 + _tmp121 * _tmp123 * _tmp93 + _tmp146 + _tmp147;
  const Scalar _tmp154 = Scalar(1.0) / (_tmp153);
  const Scalar _tmp155 =
      std::asinh(_tmp154 * (-_tmp108 * _tmp130 * _tmp98 + _tmp109 * _tmp137 - _tmp116 * _tmp140 -
                            _tmp120 * _tmp123 * _tmp130 - _tmp127 * _tmp133 + _tmp150));
  ...
  _res(1, 0) =
      -_tmp145 *
          (Scalar(0.876505537412406) * _tmp125 + std::cosh(Scalar(1.0) * _tmp144) -
           std::cosh(
               ...
               (-_tmp144 * _tmp145 -
                Scalar(8.3885017487099702) *
                    std::sqrt(Scalar(
                        ...
                        std::pow(Scalar(-Scalar(0.11921079949155229) * _tmp53 - 1),
                                 Scalar(2))))))) +
