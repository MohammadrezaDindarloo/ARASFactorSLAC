...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl11(
  ...
  const Scalar _tmp31 = Scalar(6.347051629636093) *
  ...
  const Scalar _tmp65 = _tmp58 + position_vector(0, 0);
  ...
  const Scalar _tmp75 = _tmp74 + Scalar(-4.7744369927459998);
  const Scalar _tmp76 = _tmp52 + position_vector(0, 0);
  const Scalar _tmp77 = _tmp76 + Scalar(-2.7171519410699099);
  const Scalar _tmp78 = std::pow(Scalar(std::pow(_tmp75, Scalar(2)) + std::pow(_tmp77, Scalar(2))),
                                 Scalar(Scalar(-1) / Scalar(2)));
  const Scalar _tmp79 = _tmp75 * _tmp78;
  const Scalar _tmp80 = _tmp44 + Scalar(-4.83288938413423);
  const Scalar _tmp81 = _tmp41 + Scalar(1.7965602546229);
  const Scalar _tmp82 = Scalar(1.0) / (_tmp81);
  const Scalar _tmp83 = _tmp80 * _tmp82;
  const Scalar _tmp84 = _tmp63 + _tmp72;
  const Scalar _tmp85 = _tmp77 * _tmp78;
  const Scalar _tmp86 = _tmp84 * _tmp85;
  const Scalar _tmp87 = _tmp73 * _tmp79 - _tmp83 * _tmp86;
  const Scalar _tmp88 = _tmp70 * _tmp83 - _tmp71;
  const Scalar _tmp89 = Scalar(1.0) / (-_tmp79 + _tmp83 * _tmp85);
  const Scalar _tmp90 = _tmp88 * _tmp89;
  const Scalar _tmp91 = _tmp83 * _tmp84;
  const Scalar _tmp92 = _tmp64 * _tmp71 - _tmp70 * _tmp91 - _tmp87 * _tmp90;
  const Scalar _tmp93 = -_tmp73 * _tmp85 + _tmp86;
  const Scalar _tmp94 = -_tmp53 * _tmp92 - _tmp64 * _tmp70 + _tmp70 * _tmp84 - _tmp90 * _tmp93;
  const Scalar _tmp95 = Scalar(1.0) / (_tmp94);
  const Scalar _tmp96 = _tmp92 * _tmp95;
  const Scalar _tmp97 = _tmp49 - _tmp56 * _tmp61 - _tmp62 * _tmp96;
  const Scalar _tmp98 = Scalar(1.0) * _tmp51;
  const Scalar _tmp99 = _tmp53 * _tmp60;
  const Scalar _tmp100 = _tmp57 * _tmp60 + Scalar(1.0);
  const Scalar _tmp101 = _tmp19 + Scalar(8.3885017487099702);
  ...
  const Scalar _tmp106 = -_tmp104 * _tmp105 - Scalar(5.1796800000000003) * _tmp12 - _tmp18 * fv1;
  ...
  const Scalar _tmp110 = _tmp109 * (_tmp108 * _tmp40 * _tmp80 - _tmp108 * _tmp43 * _tmp81);
  const Scalar _tmp111 = _tmp110 * _tmp85 + _tmp50 * _tmp85 - _tmp52 * _tmp79;
  const Scalar _tmp112 = _tmp110 * _tmp70 - _tmp111 * _tmp90 + _tmp55 * _tmp70 - _tmp58 * _tmp71;
  const Scalar _tmp113 = Scalar(1.0) / (_tmp112);
  const Scalar _tmp114 = _tmp113 * _tmp94;
  const Scalar _tmp115 = _tmp56 * _tmp60;
  const Scalar _tmp116 = Scalar(1.0) * _tmp113;
  const Scalar _tmp117 = _tmp114 * _tmp115 - _tmp116 * _tmp92;
  const Scalar _tmp118 = _tmp114 * _tmp60;
  const Scalar _tmp119 = _tmp102 * _tmp103;
  const Scalar _tmp120 = fh1 * (_tmp104 * _tmp29 - _tmp119 * _tmp18);
  const Scalar _tmp121 = _tmp83 * _tmp89;
  const Scalar _tmp122 = _tmp121 * _tmp87 + _tmp91;
  const Scalar _tmp123 = _tmp121 * _tmp93 - _tmp122 * _tmp53 - _tmp84;
  ...
  const Scalar _tmp128 = _tmp122 + _tmp125 * _tmp126 - _tmp127 * _tmp96;
  const Scalar _tmp129 = _tmp119 * fh1;
  const Scalar _tmp130 = Scalar(1.0) * _tmp89;
  const Scalar _tmp131 = _tmp130 * _tmp87;
  const Scalar _tmp132 = -_tmp130 * _tmp93 + _tmp131 * _tmp53;
  const Scalar _tmp133 = _tmp114 * (-_tmp111 * _tmp130 - _tmp124 * _tmp132);
  const Scalar _tmp134 = _tmp132 + _tmp133;
  const Scalar _tmp135 = _tmp126 * _tmp133 - _tmp131 - _tmp134 * _tmp96;
  const Scalar _tmp136 = _tmp104 * fh1;
  const Scalar _tmp137 = _tmp105 * _tmp119 + Scalar(5.1796800000000003) * _tmp24 + _tmp29 * fv1;
  const Scalar _tmp138 = _tmp88 * _tmp95;
  const Scalar _tmp139 = -_tmp134 * _tmp138 + Scalar(1.0);
  const Scalar _tmp140 = _tmp85 * _tmp89;
  const Scalar _tmp141 = _tmp70 * _tmp95;
  const Scalar _tmp142 = -_tmp127 * _tmp138 - _tmp83;
  const Scalar _tmp143 = _tmp113 * _tmp130 * _tmp88;
  const Scalar _tmp144 = _tmp62 * _tmp95;
  const Scalar _tmp145 = _tmp138 * _tmp62;
  const Scalar _tmp146 = -_tmp109 * _tmp120 * (_tmp116 * _tmp70 - _tmp143 * _tmp85) -
                         _tmp109 * _tmp129 * (_tmp127 * _tmp141 + _tmp140 * _tmp142 + Scalar(1.0)) -
                         _tmp109 * _tmp136 * (_tmp134 * _tmp141 + _tmp139 * _tmp140) -
                         _tmp109 * _tmp46 * (-_tmp140 * _tmp145 + _tmp144 * _tmp70);
  const Scalar _tmp147 = Scalar(1.0) / (_tmp146);
  const Scalar _tmp148 = std::asinh(
      _tmp147 * (Scalar(1.0) * _tmp106 * (-_tmp100 * _tmp98 + _tmp99) +
                 Scalar(1.0) * _tmp120 * (-_tmp117 * _tmp98 + _tmp118) +
                 Scalar(1.0) * _tmp129 * (_tmp125 * _tmp60 - _tmp128 * _tmp98) +
                 Scalar(1.0) * _tmp136 * (_tmp133 * _tmp60 - _tmp135 * _tmp98) +
                 Scalar(1.0) * _tmp137 * (_tmp115 * _tmp51 - _tmp60) +
                 Scalar(1.0) * _tmp46 * (-_tmp54 * _tmp60 - _tmp97 * _tmp98 + Scalar(1.0))));
  const Scalar _tmp149 = Scalar(9.6622558468725703) * _tmp146;
  const Scalar _tmp150 = -_tmp120 * _tmp143 + _tmp129 * _tmp142 * _tmp89 +
                         _tmp136 * _tmp139 * _tmp89 - _tmp145 * _tmp46 * _tmp89;
  const Scalar _tmp151 = Scalar(1.0) / (_tmp150);
  const Scalar _tmp152 = _tmp137 * _tmp60;
  const Scalar _tmp153 =
      std::asinh(_tmp151 * (_tmp100 * _tmp106 * _tmp51 + _tmp117 * _tmp120 * _tmp51 +
                            _tmp128 * _tmp129 * _tmp51 + _tmp135 * _tmp136 * _tmp51 -
                            _tmp152 * _tmp51 * _tmp56 + _tmp46 * _tmp51 * _tmp97));
  const Scalar _tmp154 = Scalar(22.795248597701466) *
                             std::pow(Scalar(1 - Scalar(0.2094487793051498) * _tmp74), Scalar(2)) +
                         Scalar(7.3829146708599787) *
                             std::pow(Scalar(1 - Scalar(0.36803241838814449) * _tmp76), Scalar(2));
  const Scalar _tmp155 = Scalar(9.6622558468725703) * _tmp150;
  const Scalar _tmp156 = _tmp116 * _tmp120 + _tmp127 * _tmp129 * _tmp95 +
                         _tmp134 * _tmp136 * _tmp95 + _tmp144 * _tmp46;
  const Scalar _tmp157 = Scalar(1.0) / (_tmp156);
  const Scalar _tmp158 =
      std::asinh(_tmp157 * (-_tmp106 * _tmp99 - _tmp118 * _tmp120 - _tmp125 * _tmp129 * _tmp59 -
                            _tmp133 * _tmp136 * _tmp59 + _tmp152 + _tmp46 * _tmp61));
  ...
  const Scalar _tmp160 =
      ...
      Scalar(69.216682149330126) *
          std::pow(Scalar(-Scalar(0.12019727201198747) * _tmp67 - 1), Scalar(2));
  ...
  _res(0, 0) =
      ...
      Scalar(8.4690207536791995) *
          std::sqrt(Scalar(Scalar(0.013942273753185566) * _tmp31 +
  ...
  _res(1, 0) =
      ...
      Scalar(8.3701287145205097) *
          std::sqrt(Scalar(Scalar(0.014273672465547484) * _tmp45 +
                           std::pow(Scalar(-Scalar(0.11947247576553975) * _tmp84 -
  ...
  _res(2, 0) =
      ...
      Scalar(8.3641088633305802) *
          std::sqrt(Scalar(Scalar(0.014294226073078949) * _tmp154 +
                           std::pow(Scalar(-Scalar(0.11955846299229073) * _tmp73 -
  ...
  _res(3, 0) =
      ...
      Scalar(8.4718465805053693) *
          std::sqrt(Scalar(Scalar(0.013932974274013004) * _tmp160 +
                           std::pow(Scalar(-Scalar(0.11803802045956635) * _tmp64 -
