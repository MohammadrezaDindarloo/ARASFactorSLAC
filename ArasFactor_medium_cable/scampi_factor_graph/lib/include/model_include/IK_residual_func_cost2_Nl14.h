...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl14(
  ...
  const Scalar _tmp92 = _tmp35 + _tmp65;
  const Scalar _tmp93 = -_tmp62 * _tmp88 - _tmp70 * _tmp91 + _tmp89 * _tmp92;
  const Scalar _tmp94 = -_tmp77 * _tmp93 - _tmp78 * _tmp90 - _tmp87 * _tmp92 + _tmp88;
  const Scalar _tmp95 = Scalar(1.0) / (_tmp94);
  const Scalar _tmp96 = _tmp60 * _tmp87 - _tmp61 * _tmp91 - _tmp80 * _tmp89 + _tmp83 * _tmp87;
  const Scalar _tmp97 = _tmp95 * _tmp96;
  const Scalar _tmp98 = Scalar(1.0) / (_tmp96);
  const Scalar _tmp99 = _tmp94 * _tmp98;
  const Scalar _tmp100 = _tmp99 * (-_tmp60 + _tmp61 * _tmp64 - _tmp79 * _tmp97);
  ...
  const Scalar _tmp106 = _tmp18 + Scalar(-2.7171519410699099);
  ...
  const Scalar _tmp118 = fh1 * (-_tmp109 * _tmp27 + _tmp117 * _tmp17);
  const Scalar _tmp119 = Scalar(1.0) * _tmp74;
  const Scalar _tmp120 = _tmp119 * _tmp63 * _tmp70 * _tmp76 - Scalar(1.0) * _tmp78;
  const Scalar _tmp121 = Scalar(1.0) * _tmp63;
  const Scalar _tmp122 = _tmp99 * (-_tmp120 * _tmp97 - _tmp121 * _tmp61);
  const Scalar _tmp123 = _tmp120 + _tmp122;
  const Scalar _tmp124 = -_tmp103 * _tmp123 + Scalar(1.0);
  const Scalar _tmp125 = _tmp117 * fh1;
  const Scalar _tmp126 = -_tmp110 * _tmp59 * (_tmp101 * _tmp102 + _tmp104 * _tmp105 + Scalar(1.0)) -
                         _tmp111 * _tmp59 * (-_tmp114 * _tmp115 + _tmp114 * _tmp87) -
                         _tmp118 * _tmp59 * (-_tmp115 * _tmp116 + _tmp116 * _tmp87) -
                         _tmp125 * _tmp59 * (_tmp102 * _tmp123 + _tmp105 * _tmp124);
  const Scalar _tmp127 = Scalar(1.0) / (_tmp126);
  const Scalar _tmp128 = _tmp36 * fh1;
  const Scalar _tmp129 = -_tmp117 * _tmp128 - Scalar(5.1796800000000003) * _tmp22 - _tmp27 * fv1;
  ...
  const Scalar _tmp134 = _tmp74 * (_tmp131 * _tmp133 + Scalar(1.0));
  const Scalar _tmp135 = _tmp133 * _tmp77;
  const Scalar _tmp136 = _tmp130 * _tmp132;
  const Scalar _tmp137 = _tmp93 * _tmp95;
  const Scalar _tmp138 = _tmp100 * _tmp136 - _tmp101 * _tmp137 + _tmp71;
  const Scalar _tmp139 = _tmp112 * _tmp132;
  const Scalar _tmp140 = -_tmp113 * _tmp137 - _tmp130 * _tmp139 + _tmp73;
  const Scalar _tmp141 = -_tmp121 * _tmp70 + _tmp122 * _tmp136 - _tmp123 * _tmp137;
  const Scalar _tmp142 = _tmp133 * _tmp99;
  const Scalar _tmp143 = -_tmp116 * _tmp93 + _tmp130 * _tmp142;
  const Scalar _tmp144 = _tmp109 * _tmp128 + Scalar(5.1796800000000003) * _tmp11 + _tmp17 * fv1;
  const Scalar _tmp145 = _tmp130 * _tmp74;
  const Scalar _tmp146 = std::asinh(
      _tmp127 * (Scalar(1.0) * _tmp110 * (_tmp100 * _tmp133 - _tmp119 * _tmp138) +
                 Scalar(1.0) * _tmp111 * (-_tmp112 * _tmp133 - _tmp119 * _tmp140 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp118 * (-_tmp119 * _tmp143 + _tmp142) +
                 Scalar(1.0) * _tmp125 * (-_tmp119 * _tmp141 + _tmp122 * _tmp133) +
                 Scalar(1.0) * _tmp129 * (-Scalar(1.0) * _tmp134 + _tmp135) +
  ...
  const Scalar _tmp151 =
      _tmp104 * _tmp110 * _tmp63 + _tmp124 * _tmp125 * _tmp63 - _tmp149 * _tmp91 - _tmp150 * _tmp91;
  const Scalar _tmp152 = Scalar(1.0) / (_tmp151);
  const Scalar _tmp153 = _tmp133 * _tmp144;
  const Scalar _tmp154 =
      std::asinh(_tmp152 * (_tmp110 * _tmp138 * _tmp74 + _tmp111 * _tmp140 * _tmp74 +
                            _tmp118 * _tmp143 * _tmp74 + _tmp125 * _tmp141 * _tmp74 +
                            _tmp129 * _tmp134 - _tmp145 * _tmp153));
  ...
  const Scalar _tmp157 =
      _tmp101 * _tmp110 * _tmp95 + _tmp123 * _tmp125 * _tmp95 + _tmp149 + _tmp150;
  const Scalar _tmp158 = Scalar(1.0) / (_tmp157);
  const Scalar _tmp159 =
      std::asinh(_tmp158 * (-_tmp100 * _tmp110 * _tmp132 + _tmp111 * _tmp139 - _tmp118 * _tmp142 -
                            _tmp122 * _tmp125 * _tmp132 - _tmp129 * _tmp135 + _tmp153));
  ...
  _res(1, 0) =
      _tmp148 *
          (-std::sinh(Scalar(1.0) * _tmp146) -
           std::sinh(Scalar(0.1034955) * _tmp127 * (-_tmp146 * _tmp148 - std::sqrt(_tmp147)))) -
  ...
  _res(3, 0) =
      ...
      Scalar(8.3701287145205097) *
          std::sqrt(Scalar(Scalar(0.014273672465547484) * _tmp161 +
                           std::pow(Scalar(-Scalar(0.11947247576553975) * _tmp92 -
