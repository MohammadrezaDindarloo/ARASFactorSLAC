...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl15(
  ...
  const Scalar _tmp53 = -_tmp28 * _tmp47 + _tmp45;
  const Scalar _tmp54 = _tmp48 * _tmp49 * _tmp52 - _tmp49 * _tmp53;
  const Scalar _tmp55 = _tmp43 + _tmp46;
  const Scalar _tmp56 = _tmp14 + _tmp29;
  const Scalar _tmp57 = _tmp56 + position_vector(0, 0) + Scalar(1.9874742031097401);
  ...
  const Scalar _tmp64 = _tmp37 * _tmp61 - _tmp62;
  const Scalar _tmp65 = _tmp39 * _tmp64;
  const Scalar _tmp66 = -_tmp52 * (-_tmp37 * _tmp63 - _tmp48 * _tmp65 + _tmp55 * _tmp62) -
                        _tmp53 * _tmp65 - _tmp55 * _tmp61 + _tmp63;
  ...
  const Scalar _tmp71 = _tmp70 * (_tmp31 * _tmp36 * _tmp69 - _tmp32 * _tmp35 * _tmp69);
  const Scalar _tmp72 = -_tmp15 * _tmp38 + _tmp25 * _tmp28 + _tmp28 * _tmp71;
  const Scalar _tmp73 = -_tmp56 * _tmp62 + _tmp58 * _tmp61 + _tmp61 * _tmp71 - _tmp65 * _tmp72;
  ...
  const Scalar _tmp79 = _tmp39 * (-_tmp77 * _tmp78 + Scalar(1.0));
  ...
  const Scalar _tmp83 = _tmp30 + _tmp7;
  ...
  const Scalar _tmp89 = _tmp50 + _tmp51 * _tmp52;
  const Scalar _tmp90 = 0;
  const Scalar _tmp91 = _tmp67 * _tmp90;
  const Scalar _tmp92 = _tmp39 * _tmp78 * _tmp90;
  const Scalar _tmp93 = _tmp37 * _tmp39;
  const Scalar _tmp94 = -_tmp44 - _tmp52 * (_tmp37 * _tmp44 + _tmp48 * _tmp93) + _tmp53 * _tmp93;
  const Scalar _tmp95 = _tmp76 * (-_tmp71 + _tmp72 * _tmp93 - _tmp74 * _tmp94) + _tmp94;
  const Scalar _tmp96 = _tmp39 * (-_tmp37 - _tmp78 * _tmp95);
  const Scalar _tmp97 = _tmp67 * _tmp95;
  const Scalar _tmp98 = _tmp84 * _tmp85;
  const Scalar _tmp99 = _tmp70 * _tmp98 * (_tmp28 * _tmp96 + _tmp61 * _tmp97 + Scalar(1.0));
  const Scalar _tmp100 = -_tmp81 * _tmp98 + _tmp83 * _tmp86;
  const Scalar _tmp101 = Scalar(1.0) * _tmp75;
  const Scalar _tmp102 = _tmp100 * _tmp70 * (-_tmp101 * _tmp28 * _tmp65 + _tmp101 * _tmp61);
  ...
  _res(1, 0) = -(-_tmp102 - _tmp87 - _tmp99) *
               std::exp(_tmp102 * fh1 + _tmp70 * _tmp88 * (-_tmp28 * _tmp92 + _tmp61 * _tmp91) +
                        _tmp87 * fh1 + _tmp99 * fh1);
  _res(2, 0) = -(-_tmp103 * _tmp65 + _tmp105 + _tmp106) *
               std::exp(_tmp104 * _tmp65 - _tmp105 * fh1 - _tmp106 * fh1 + _tmp88 * _tmp92);
  _res(3, 0) = -(_tmp103 + _tmp107 + _tmp108) *
               std::exp(-_tmp104 - _tmp107 * fh1 - _tmp108 * fh1 - _tmp88 * _tmp91);
