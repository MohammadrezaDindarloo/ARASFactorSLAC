...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl5(
  ...
  const Scalar _tmp17 = _tmp16 + position_vector(1, 0) + Scalar(-4.83288938413423);
  ...
  const Scalar _tmp37 = _tmp34 + position_vector(0, 0) + Scalar(-2.7171519410699099);
  ...
  const Scalar _tmp41 = _tmp33 * _tmp40 - _tmp34 * _tmp39 + _tmp35 * _tmp40;
  const Scalar _tmp42 = Scalar(1.0) / (_tmp29 * _tmp40 - _tmp39);
  ...
  const Scalar _tmp51 = _tmp39 * _tmp49 - _tmp40 * _tmp50;
  const Scalar _tmp52 = Scalar(1.0) * _tmp16;
  const Scalar _tmp53 = Scalar(1.0) * _tmp26;
  const Scalar _tmp54 = (-_tmp34 + _tmp53) / (_tmp35 - _tmp52);
  const Scalar _tmp55 = _tmp40 * _tmp47 - _tmp40 * _tmp49;
  const Scalar _tmp56 = _tmp43 * _tmp55 - _tmp47 - _tmp54 * (_tmp43 * _tmp51 + _tmp50);
  ...
  const Scalar _tmp86 = _tmp32 * _tmp85 * (_tmp64 * _tmp79 + _tmp77 * _tmp78 + Scalar(1.0));
  const Scalar _tmp87 = Scalar(1.0) * _tmp42;
  const Scalar _tmp88 = _tmp51 * _tmp54 * _tmp87 - _tmp55 * _tmp87;
  const Scalar _tmp89 = _tmp74 * (-_tmp41 * _tmp87 - _tmp72 * _tmp88) + _tmp88;
  const Scalar _tmp90 = _tmp70 * _tmp89;
  const Scalar _tmp91 = -_tmp76 * _tmp89 + Scalar(1.0);
  const Scalar _tmp92 = _tmp83 * _tmp84;
  const Scalar _tmp93 = _tmp32 * _tmp92 * (_tmp64 * _tmp90 + _tmp78 * _tmp91);
  const Scalar _tmp94 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp95 = _tmp52 * _tmp54 + _tmp53;
  const Scalar _tmp96 = 0;
  const Scalar _tmp97 = _tmp40 * _tmp68;
  const Scalar _tmp98 = _tmp80 * _tmp92 - _tmp82 * _tmp85;
  const Scalar _tmp99 = Scalar(1.0) * _tmp73;
  const Scalar _tmp100 = _tmp32 * _tmp98 * (_tmp64 * _tmp99 - _tmp97 * _tmp99);
  const Scalar _tmp101 = _tmp98 * _tmp99;
  const Scalar _tmp102 = _tmp101 * fh1;
  const Scalar _tmp103 = _tmp42 * _tmp91 * _tmp92;
  const Scalar _tmp104 = _tmp94 * _tmp96;
  const Scalar _tmp105 = _tmp42 * _tmp77 * _tmp85;
  const Scalar _tmp106 = _tmp90 * _tmp92;
  ...
  _res(1, 0) = -(-_tmp100 - _tmp86 - _tmp93) *
               std::exp(_tmp100 * fh1 + _tmp32 * _tmp94 * (_tmp64 * _tmp96 - _tmp96 * _tmp97) +
                        _tmp86 * fh1 + _tmp93 * fh1);
  _res(2, 0) = -(-_tmp101 * _tmp68 + _tmp103 + _tmp105) *
               std::exp(_tmp102 * _tmp68 - _tmp103 * fh1 + _tmp104 * _tmp68 - _tmp105 * fh1);
  _res(3, 0) =
