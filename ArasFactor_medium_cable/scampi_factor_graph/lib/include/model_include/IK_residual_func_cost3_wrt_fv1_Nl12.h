...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl12(
  ...
  const Scalar _tmp43 = _tmp18 + _tmp33;
  ...
  const Scalar _tmp52 = _tmp36 * _tmp50;
  const Scalar _tmp53 = _tmp52 * (-_tmp31 * _tmp35 * _tmp51 + _tmp32 * _tmp34 * _tmp51);
  const Scalar _tmp54 = _tmp16 * _tmp38 - _tmp26 * _tmp29 + _tmp38 * _tmp53;
  ...
  const Scalar _tmp61 = _tmp58 + position_vector(0, 0) + Scalar(-2.7171519410699099);
  ...
  const Scalar _tmp73 = -_tmp38 * _tmp70 + _tmp38 * _tmp72;
  const Scalar _tmp74 = Scalar(1.0) * _tmp39;
  const Scalar _tmp75 = _tmp37 * _tmp72;
  const Scalar _tmp76 = _tmp29 * _tmp70 - _tmp38 * _tmp75;
  const Scalar _tmp77 = Scalar(1.0) * _tmp31;
  const Scalar _tmp78 = Scalar(1.0) * _tmp34;
  const Scalar _tmp79 = (-_tmp26 + _tmp78) / (_tmp16 - _tmp77);
  const Scalar _tmp80 = -_tmp73 * _tmp74 + _tmp74 * _tmp76 * _tmp79;
  const Scalar _tmp81 = _tmp68 + _tmp71;
  const Scalar _tmp82 = _tmp47 * _tmp72 - _tmp47 * _tmp81 - _tmp49 * _tmp73 -
                        _tmp79 * (_tmp46 * _tmp81 - _tmp47 * _tmp75 - _tmp49 * _tmp76);
  const Scalar _tmp83 = Scalar(1.0) / (_tmp82);
  const Scalar _tmp84 = _tmp55 * _tmp83;
  const Scalar _tmp85 = _tmp56 * _tmp82;
  const Scalar _tmp86 = _tmp80 + _tmp85 * (-_tmp54 * _tmp74 - _tmp80 * _tmp84);
  const Scalar _tmp87 = _tmp48 * _tmp83;
  const Scalar _tmp88 = -_tmp86 * _tmp87 + Scalar(1.0);
  const Scalar _tmp89 = _tmp38 * _tmp39;
  const Scalar _tmp90 = _tmp47 * _tmp83;
  ...
  const Scalar _tmp96 = _tmp52 * (-_tmp38 * _tmp95 + _tmp47 * _tmp94);
  const Scalar _tmp97 = _tmp37 * _tmp39;
  const Scalar _tmp98 = -_tmp72 + _tmp73 * _tmp97 - _tmp79 * (_tmp75 + _tmp76 * _tmp97);
  const Scalar _tmp99 = _tmp85 * (-_tmp53 + _tmp54 * _tmp97 - _tmp84 * _tmp98) + _tmp98;
  const Scalar _tmp100 = -_tmp37 - _tmp87 * _tmp99;
  const Scalar _tmp101 = _tmp64 * fh1;
  const Scalar _tmp102 = _tmp92 * _tmp94;
  const Scalar _tmp103 = _tmp57 * _tmp65;
  ...
  _res(0, 0) = 0;
  _res(1, 0) =
      -_tmp96 * std::exp(_tmp101 * _tmp52 * (_tmp100 * _tmp89 + _tmp90 * _tmp99 + Scalar(1.0)) +
                         _tmp52 * _tmp65 * (-_tmp38 * _tmp49 * _tmp57 + _tmp47 * _tmp57) +
                         _tmp52 * _tmp91 * (_tmp86 * _tmp90 + _tmp88 * _tmp89) + _tmp92 * _tmp96);
  _res(2, 0) = -_tmp95 * std::exp(-_tmp100 * _tmp101 * _tmp39 + _tmp102 * _tmp49 +
                                  _tmp103 * _tmp49 - _tmp39 * _tmp88 * _tmp91);
  _res(3, 0) =
      _tmp94 * std::exp(-_tmp101 * _tmp83 * _tmp99 - _tmp102 - _tmp103 - _tmp83 * _tmp86 * _tmp91);
