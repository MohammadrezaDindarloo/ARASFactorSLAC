...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl4(
  ...
  const Scalar _tmp37 = _tmp32 + position_vector(1, 0) + Scalar(-4.83288938413423);
  const Scalar _tmp38 =
      std::sqrt(Scalar(std::pow(_tmp36, Scalar(2)) + std::pow(_tmp37, Scalar(2))));
  const Scalar _tmp39 = Scalar(1.0) / (_tmp38);
  const Scalar _tmp40 = Scalar(1.0) / (_tmp36);
  const Scalar _tmp41 = _tmp38 * _tmp40;
  const Scalar _tmp42 = _tmp41 * (-_tmp32 * _tmp36 * _tmp39 + _tmp35 * _tmp37 * _tmp39);
  const Scalar _tmp43 = _tmp16 * _tmp28 - _tmp25 * _tmp29 + _tmp28 * _tmp42;
  const Scalar _tmp44 = _tmp37 * _tmp40;
  const Scalar _tmp45 = Scalar(1.0) / (_tmp28 * _tmp44 - _tmp29);
  ...
  const Scalar _tmp54 = _tmp28 * _tmp50;
  const Scalar _tmp55 = _tmp29 * _tmp53 - _tmp44 * _tmp54;
  const Scalar _tmp56 = Scalar(1.0) * _tmp35;
  const Scalar _tmp57 = Scalar(1.0) * _tmp32;
  const Scalar _tmp58 = (-_tmp25 + _tmp56) / (_tmp16 - _tmp57);
  const Scalar _tmp59 = -_tmp28 * _tmp53 + _tmp54;
  const Scalar _tmp60 = _tmp46 * _tmp59 - _tmp50 - _tmp58 * (_tmp46 * _tmp55 + _tmp51);
  const Scalar _tmp61 = _tmp31 + _tmp8;
  const Scalar _tmp62 = _tmp61 + position_vector(1, 0) + Scalar(-4.7744369927459998);
  const Scalar _tmp63 = _tmp19 + _tmp34;
  const Scalar _tmp64 = _tmp63 + position_vector(0, 0) + Scalar(-2.7171519410699099);
  ...
  const Scalar _tmp88 = _tmp41 * fh1;
  const Scalar _tmp89 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp90 = _tmp56 + _tmp57 * _tmp58;
  const Scalar _tmp91 = 0;
  const Scalar _tmp92 = _tmp72 * _tmp91;
  const Scalar _tmp93 = _tmp79 * _tmp91;
  const Scalar _tmp94 = _tmp41 * (_tmp66 * _tmp92 - _tmp81 * _tmp93);
  ...
  const Scalar _tmp99 = _tmp55 * _tmp58 * _tmp98 - _tmp59 * _tmp98;
  const Scalar _tmp100 = _tmp76 * (-_tmp43 * _tmp98 - _tmp74 * _tmp99) + _tmp99;
  const Scalar _tmp101 = -_tmp100 * _tmp79 + Scalar(1.0);
  const Scalar _tmp102 = _tmp45 * fh1;
  const Scalar _tmp103 = _tmp95 * _tmp97;
  const Scalar _tmp104 = _tmp45 * _tmp93;
  const Scalar _tmp105 = _tmp72 * fh1;
  ...
  _res(0, 0) = 0;
  _res(1, 0) =
      -_tmp94 * std::exp(_tmp41 * _tmp97 * (-_tmp28 * _tmp70 * _tmp95 + _tmp66 * _tmp95) +
                         _tmp87 * _tmp88 * (_tmp77 * _tmp78 + _tmp80 * _tmp81 + Scalar(1.0)) +
                         _tmp88 * _tmp96 * (_tmp100 * _tmp78 + _tmp101 * _tmp81) + _tmp89 * _tmp94);
  _res(2, 0) = -_tmp104 * std::exp(-_tmp101 * _tmp102 * _tmp96 - _tmp102 * _tmp80 * _tmp87 +
                                   _tmp103 * _tmp70 + _tmp104 * _tmp89);
  _res(3, 0) = _tmp92 * std::exp(-_tmp100 * _tmp105 * _tmp96 - _tmp103 - _tmp105 * _tmp77 * _tmp87 -
                                 _tmp89 * _tmp92);
