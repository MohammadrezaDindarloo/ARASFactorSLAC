...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl8(
  ...
  const Scalar _tmp36 = _tmp35 + position_vector(0, 0) + Scalar(-2.7171519410699099);
  ...
  const Scalar _tmp41 = _tmp40 + position_vector(1, 0) + Scalar(-4.83288938413423);
  const Scalar _tmp42 = _tmp15 + _tmp7;
  ...
  const Scalar _tmp47 = _tmp38 * _tmp46 - _tmp45;
  ...
  const Scalar _tmp51 = _tmp37 * _tmp49;
  const Scalar _tmp52 = _tmp51 * (-_tmp32 * _tmp36 * _tmp50 + _tmp33 * _tmp35 * _tmp50);
  const Scalar _tmp53 = _tmp39 * (-_tmp16 * _tmp30 + _tmp26 * _tmp29 + _tmp29 * _tmp52);
  const Scalar _tmp54 = _tmp40 * _tmp46 - _tmp42 * _tmp45 + _tmp46 * _tmp52 - _tmp47 * _tmp53;
  ...
  const Scalar _tmp60 = _tmp57 + position_vector(1, 0) + Scalar(8.3885017487099702);
  ...
  const Scalar _tmp69 = _tmp65 + _tmp67 - _tmp68;
  const Scalar _tmp70 = _tmp65 + _tmp68;
  const Scalar _tmp71 = _tmp66 + _tmp70;
  const Scalar _tmp72 = -_tmp29 * _tmp69 + _tmp29 * _tmp71;
  const Scalar _tmp73 = _tmp39 * _tmp72;
  const Scalar _tmp74 = _tmp38 * _tmp71;
  const Scalar _tmp75 = -_tmp29 * _tmp74 + _tmp30 * _tmp69;
  const Scalar _tmp76 = _tmp39 * _tmp75;
  const Scalar _tmp77 = Scalar(1.0) * _tmp35;
  const Scalar _tmp78 = Scalar(1.0) * _tmp32;
  const Scalar _tmp79 = (-_tmp16 + _tmp77) / (_tmp26 - _tmp78);
  const Scalar _tmp80 = _tmp38 * _tmp73 - _tmp71 - _tmp79 * (_tmp38 * _tmp76 + _tmp74);
  const Scalar _tmp81 = _tmp67 + _tmp70;
  const Scalar _tmp82 = _tmp46 * _tmp71 - _tmp46 * _tmp81 - _tmp48 * _tmp72 -
                        _tmp79 * (_tmp45 * _tmp81 - _tmp46 * _tmp74 - _tmp48 * _tmp75);
  const Scalar _tmp83 = Scalar(1.0) / (_tmp82);
  const Scalar _tmp84 = _tmp54 * _tmp83;
  const Scalar _tmp85 = _tmp55 * _tmp82;
  const Scalar _tmp86 = _tmp80 + _tmp85 * (_tmp38 * _tmp53 - _tmp52 - _tmp80 * _tmp84);
  const Scalar _tmp87 = _tmp46 * _tmp83;
  const Scalar _tmp88 = _tmp47 * _tmp83;
  const Scalar _tmp89 = -_tmp38 - _tmp86 * _tmp88;
  const Scalar _tmp90 = _tmp29 * _tmp39;
  const Scalar _tmp91 = _tmp51 * fh1;
  const Scalar _tmp92 = -Scalar(1.0) * _tmp73 + Scalar(1.0) * _tmp76 * _tmp79;
  const Scalar _tmp93 = _tmp85 * (-Scalar(1.0) * _tmp53 - _tmp84 * _tmp92) + _tmp92;
  const Scalar _tmp94 = -_tmp88 * _tmp93 + Scalar(1.0);
  const Scalar _tmp95 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp96 = _tmp77 + _tmp78 * _tmp79;
  const Scalar _tmp97 = 0;
  const Scalar _tmp98 = _tmp88 * _tmp97;
  const Scalar _tmp99 = _tmp83 * _tmp97;
  const Scalar _tmp100 = _tmp51 * (_tmp46 * _tmp99 - _tmp90 * _tmp98);
  const Scalar _tmp101 = _tmp56 * _tmp64;
  const Scalar _tmp102 = _tmp39 * fh1;
  const Scalar _tmp103 = _tmp39 * _tmp98;
  const Scalar _tmp104 = _tmp83 * fh1;
  ...
  _res(1, 0) =
      -_tmp100 *
      std::exp(_tmp100 * _tmp95 + _tmp51 * _tmp64 * (-_tmp29 * _tmp48 * _tmp56 + _tmp46 * _tmp56) +
               _tmp62 * _tmp91 * (_tmp86 * _tmp87 + _tmp89 * _tmp90 + Scalar(1.0)) +
               _tmp63 * _tmp91 * (_tmp87 * _tmp93 + _tmp90 * _tmp94));
  _res(2, 0) = -_tmp103 * std::exp(_tmp101 * _tmp48 - _tmp102 * _tmp62 * _tmp89 -
                                   _tmp102 * _tmp63 * _tmp94 + _tmp103 * _tmp95);
  _res(3, 0) = _tmp99 * std::exp(-_tmp101 - _tmp104 * _tmp62 * _tmp86 - _tmp104 * _tmp63 * _tmp93 -
                                 _tmp95 * _tmp99);
