...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl3(
  ...
  const Scalar _tmp55 = _tmp39 + _tmp9;
  ...
  const Scalar _tmp61 = _tmp51 * _tmp59 - _tmp52 * _tmp60 + _tmp55 * _tmp59;
  ...
  const Scalar _tmp68 = _tmp59 * _tmp66 - _tmp59 * _tmp67;
  const Scalar _tmp69 = _tmp62 * _tmp66;
  const Scalar _tmp70 = -_tmp59 * _tmp69 + _tmp60 * _tmp67;
  ...
  const Scalar _tmp92 = _tmp66 * _tmp87 - _tmp68 * _tmp90 - _tmp77 * _tmp91 - _tmp79 * _tmp87;
  const Scalar _tmp93 = Scalar(1.0) / (_tmp92);
  const Scalar _tmp94 = _tmp51 * _tmp87 - _tmp61 * _tmp90 + _tmp80 * _tmp87 - _tmp83 * _tmp88;
  const Scalar _tmp95 = _tmp93 * _tmp94;
  const Scalar _tmp96 = Scalar(1.0) / (_tmp94);
  const Scalar _tmp97 = _tmp92 * _tmp96;
  const Scalar _tmp98 = _tmp97 * (-_tmp51 + _tmp61 * _tmp64 - _tmp78 * _tmp95);
  ...
  const Scalar _tmp103 = _tmp59 * _tmp63;
  ...
  const Scalar _tmp111 = -_tmp109 * _tmp68 + _tmp110 * _tmp63 * _tmp70 * _tmp76;
  const Scalar _tmp112 = _tmp97 * (-_tmp109 * _tmp61 - _tmp111 * _tmp95);
  ...
  const Scalar _tmp118 = _tmp72 * _tmp77 + _tmp75;
  const Scalar _tmp119 = 0;
  const Scalar _tmp120 = _tmp59 * _tmp90;
  const Scalar _tmp121 = Scalar(1.0) * _tmp96;
  const Scalar _tmp122 = fh1 * (-_tmp107 * _tmp19 + _tmp115 * _tmp30);
  const Scalar _tmp123 = -_tmp108 * _tmp50 * (_tmp100 * _tmp99 + _tmp102 * _tmp103 + Scalar(1.0)) -
                         _tmp116 * _tmp50 * (_tmp100 * _tmp113 + _tmp103 * _tmp114) -
                         _tmp117 * _tmp50 * (-_tmp119 * _tmp120 + _tmp119 * _tmp87) -
                         _tmp122 * _tmp50 * (-_tmp120 * _tmp121 + _tmp121 * _tmp87);
  const Scalar _tmp124 = Scalar(1.0) / (_tmp123);
  const Scalar _tmp125 = _tmp73 + _tmp80;
  const Scalar _tmp126 = _tmp125 * _tmp77;
  const Scalar _tmp127 = Scalar(1.0) / (-_tmp126 + _tmp75 - _tmp83);
  const Scalar _tmp128 = Scalar(1.0) * _tmp127;
  const Scalar _tmp129 = _tmp118 * _tmp127;
  const Scalar _tmp130 = -_tmp119 * _tmp91 - _tmp125 * _tmp129 + _tmp73;
  const Scalar _tmp131 = _tmp125 * _tmp127;
  const Scalar _tmp132 = _tmp91 * _tmp93;
  const Scalar _tmp133 = -_tmp109 * _tmp70 + _tmp112 * _tmp131 - _tmp113 * _tmp132;
  const Scalar _tmp134 = _tmp38 * fh1;
  const Scalar _tmp135 = _tmp107 * _tmp134 + Scalar(5.1796800000000003) * _tmp25 + _tmp30 * fv1;
  const Scalar _tmp136 = _tmp125 * _tmp74;
  const Scalar _tmp137 = _tmp128 * _tmp77;
  const Scalar _tmp138 = _tmp126 * _tmp128 + Scalar(1.0);
  const Scalar _tmp139 = -_tmp115 * _tmp134 - Scalar(5.1796800000000003) * _tmp13 - _tmp19 * fv1;
  const Scalar _tmp140 = _tmp131 * _tmp98 - _tmp132 * _tmp99 + _tmp71;
  const Scalar _tmp141 = _tmp128 * _tmp97;
  const Scalar _tmp142 = -_tmp121 * _tmp91 + _tmp125 * _tmp141;
  const Scalar _tmp143 = std::asinh(
      _tmp124 * (Scalar(1.0) * _tmp108 * (-_tmp110 * _tmp140 + _tmp128 * _tmp98) +
                 Scalar(1.0) * _tmp116 * (-_tmp110 * _tmp133 + _tmp112 * _tmp128) +
                 Scalar(1.0) * _tmp117 * (-_tmp110 * _tmp130 - _tmp118 * _tmp128 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp122 * (-_tmp110 * _tmp142 + _tmp141) +
                 Scalar(1.0) * _tmp135 * (_tmp128 * _tmp136 - _tmp128) +
                 Scalar(1.0) * _tmp139 * (-_tmp110 * _tmp138 + _tmp137)));
  ...
  const Scalar _tmp147 =
      _tmp102 * _tmp108 * _tmp63 + _tmp114 * _tmp116 * _tmp63 - _tmp145 * _tmp90 - _tmp146 * _tmp90;
  const Scalar _tmp148 = Scalar(1.0) / (_tmp147);
  const Scalar _tmp149 = _tmp128 * _tmp135;
  const Scalar _tmp150 =
      std::asinh(_tmp148 * (_tmp108 * _tmp140 * _tmp74 + _tmp116 * _tmp133 * _tmp74 +
                            _tmp117 * _tmp130 * _tmp74 + _tmp122 * _tmp142 * _tmp74 -
                            _tmp136 * _tmp149 + _tmp138 * _tmp139 * _tmp74));
  const Scalar _tmp151 = Scalar(9.6622558468725703) * _tmp147;
  const Scalar _tmp152 = _tmp108 * _tmp93 * _tmp99 + _tmp113 * _tmp116 * _tmp93 + _tmp145 + _tmp146;
  const Scalar _tmp153 = Scalar(1.0) / (_tmp152);
  const Scalar _tmp154 =
      std::asinh(_tmp153 * (-_tmp108 * _tmp127 * _tmp98 - _tmp112 * _tmp116 * _tmp127 +
                            _tmp117 * _tmp129 - _tmp122 * _tmp141 - _tmp137 * _tmp139 + _tmp149));
  ...
  _res(1, 0) =
      -_tmp144 *
          (Scalar(0.86564762886483004) * _tmp124 + std::cosh(Scalar(1.0) * _tmp143) -
  ...
  _res(3, 0) =
      -_tmp155 *
          (Scalar(0.876505537412406) * _tmp153 + std::cosh(Scalar(1.0) * _tmp154) -
           std::cosh(
               ...
               (-_tmp154 * _tmp155 -
                Scalar(8.3885017487099702) *
                    std::sqrt(Scalar(
                        ...
                        std::pow(Scalar(-Scalar(0.11921079949155229) * _tmp81 - 1),
                                 Scalar(2))))))) +
