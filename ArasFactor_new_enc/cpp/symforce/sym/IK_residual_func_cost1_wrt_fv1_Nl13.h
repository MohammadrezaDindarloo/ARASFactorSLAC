...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1WrtFv1Nl13(
  ...
  const Scalar _tmp61 = _tmp22 + _tmp27 + _tmp34;
  ...
  const Scalar _tmp67 = _tmp48 * _tmp65 - _tmp58 * _tmp66 + _tmp61 * _tmp65;
  const Scalar _tmp68 = _tmp38 * _tmp46;
  const Scalar _tmp69 = _tmp56 * _tmp68 - _tmp57;
  const Scalar _tmp70 = Scalar(1.0) / (_tmp65 * _tmp68 - _tmp66);
  const Scalar _tmp71 = _tmp69 * _tmp70;
  const Scalar _tmp72 = _tmp48 * _tmp56 + _tmp49 * _tmp56 - _tmp52 * _tmp57 - _tmp67 * _tmp71;
  ...
  const Scalar _tmp88 = _tmp82 * _tmp87 + _tmp85;
  ...
  const Scalar _tmp98 = _tmp68 * _tmp95;
  const Scalar _tmp99 = -_tmp65 * _tmp98 + _tmp66 * _tmp97;
  const Scalar _tmp100 = -_tmp56 * _tmp98 + _tmp57 * _tmp93 - _tmp71 * _tmp99;
  const Scalar _tmp101 = _tmp65 * _tmp95 - _tmp65 * _tmp97;
  const Scalar _tmp102 = -_tmp100 * _tmp87 - _tmp101 * _tmp71 - _tmp56 * _tmp93 + _tmp56 * _tmp95;
  const Scalar _tmp103 = Scalar(1.0) / (_tmp102);
  const Scalar _tmp104 = 0;
  const Scalar _tmp105 = _tmp104 * _tmp71;
  const Scalar _tmp106 = _tmp47 * (_tmp104 * _tmp56 - _tmp105 * _tmp65);
  const Scalar _tmp107 = Scalar(1.0) * _tmp70;
  const Scalar _tmp108 = Scalar(1.0) * _tmp84;
  const Scalar _tmp109 = -_tmp101 * _tmp107 + _tmp108 * _tmp70 * _tmp86 * _tmp99;
  ...
  const Scalar _tmp114 = _tmp103 * _tmp56;
  ...
  const Scalar _tmp121 = _tmp101 * _tmp119 - _tmp120 * _tmp87 - _tmp95;
  const Scalar _tmp122 = _tmp111 * (-_tmp110 * _tmp121 + _tmp119 * _tmp67 - _tmp48);
  ...
  const Scalar _tmp126 = -_tmp106 * _tmp81 -
                         _tmp118 * _tmp47 * (_tmp113 * _tmp114 + _tmp116 * _tmp117) -
                         _tmp125 * _tmp47 * (_tmp114 * _tmp123 + _tmp117 * _tmp124 + Scalar(1.0)) -
  ...
  const Scalar _tmp129 = _tmp49 + _tmp83;
  const Scalar _tmp130 = _tmp129 * _tmp87;
  const Scalar _tmp131 = Scalar(1.0) / (-_tmp130 - _tmp52 + _tmp85);
  const Scalar _tmp132 = _tmp129 * _tmp131;
  const Scalar _tmp133 = -_tmp107 * _tmp99 + _tmp112 * _tmp132 - _tmp113 * _tmp128;
  const Scalar _tmp134 = Scalar(1.0) * _tmp131;
  const Scalar _tmp135 = _tmp111 * _tmp134;
  const Scalar _tmp136 = -_tmp100 * _tmp74 + _tmp129 * _tmp135;
  const Scalar _tmp137 = fh1 * (_tmp89 + _tmp96);
  const Scalar _tmp138 = -_tmp137 * _tmp78 - Scalar(5.1796800000000003) * _tmp25 - _tmp30 * fv1;
  const Scalar _tmp139 = _tmp134 * _tmp87;
  const Scalar _tmp140 = _tmp84 * (_tmp130 * _tmp134 + Scalar(1.0));
  const Scalar _tmp141 = Scalar(1.0) * _tmp139 - Scalar(1.0) * _tmp140;
  const Scalar _tmp142 = _tmp131 * _tmp88;
  const Scalar _tmp143 = _tmp84 * (-_tmp100 * _tmp104 - _tmp129 * _tmp142 + _tmp83);
  const Scalar _tmp144 = -Scalar(1.0) * _tmp134 * _tmp88 - Scalar(1.0) * _tmp143 + Scalar(1.0);
  const Scalar _tmp145 = _tmp120 + _tmp122 * _tmp132 - _tmp123 * _tmp128;
  const Scalar _tmp146 = Scalar(5.1796800000000003) * _tmp13 + _tmp137 * _tmp79 + _tmp19 * fv1;
  const Scalar _tmp147 = _tmp129 * _tmp84;
  const Scalar _tmp148 = Scalar(1.0) * _tmp134 * _tmp147 - Scalar(1.0) * _tmp134;
  const Scalar _tmp149 = Scalar(1.0) * _tmp118 * (-_tmp108 * _tmp133 + _tmp112 * _tmp134) +
                         Scalar(1.0) * _tmp125 * (-_tmp108 * _tmp145 + _tmp122 * _tmp134) +
                         _tmp138 * _tmp141 + _tmp144 * _tmp81 + _tmp146 * _tmp148 +
  ...
  const Scalar _tmp156 = Scalar(9.6622558468725703) * _tmp106;
  const Scalar _tmp157 = _tmp26 + _tmp35;
  const Scalar _tmp158 = std::pow(_tmp126, Scalar(-2));
  const Scalar _tmp159 = _tmp106 * _tmp158;
  const Scalar _tmp160 =
      (_tmp127 * (_tmp141 * _tmp157 - _tmp144 + _tmp148 * _tmp19) - _tmp149 * _tmp159) /
      std::sqrt(Scalar(std::pow(_tmp149, Scalar(2)) * _tmp158 + 1));
  const Scalar _tmp161 = _tmp134 * _tmp146;
  const Scalar _tmp162 = _tmp118 * _tmp133 * _tmp84 + _tmp125 * _tmp145 * _tmp84 +
                         _tmp136 * _tmp80 * _tmp84 + _tmp138 * _tmp140 + _tmp143 * _tmp81 -
                         _tmp147 * _tmp161;
  const Scalar _tmp163 = _tmp74 * _tmp80;
  const Scalar _tmp164 = _tmp104 * _tmp81;
  const Scalar _tmp165 =
      _tmp116 * _tmp118 * _tmp70 + _tmp124 * _tmp125 * _tmp70 - _tmp163 * _tmp71 - _tmp164 * _tmp71;
  ...
  const Scalar _tmp173 = Scalar(9.6622558468725703) * _tmp104;
  const Scalar _tmp174 = _tmp173 * _tmp71;
  const Scalar _tmp175 = std::pow(_tmp165, Scalar(-2));
  const Scalar _tmp176 = _tmp105 * _tmp175;
  const Scalar _tmp177 = _tmp134 * _tmp19;
  const Scalar _tmp178 =
      (-_tmp162 * _tmp176 + _tmp166 * (_tmp140 * _tmp157 - _tmp143 - _tmp147 * _tmp177)) /
      std::sqrt(Scalar(std::pow(_tmp162, Scalar(2)) * _tmp175 + 1));
  const Scalar _tmp179 = -_tmp112 * _tmp118 * _tmp131 - _tmp122 * _tmp125 * _tmp131 -
                         _tmp135 * _tmp80 - _tmp138 * _tmp139 + _tmp142 * _tmp81 + _tmp161;
  const Scalar _tmp180 = _tmp103 * fh1;
  const Scalar _tmp181 =
      _tmp113 * _tmp180 * _tmp78 + _tmp123 * _tmp180 * _tmp79 + _tmp163 + _tmp164;
  const Scalar _tmp182 = Scalar(1.0) / (_tmp181);
  const Scalar _tmp183 = std::asinh(_tmp179 * _tmp182);
  ...
  const Scalar _tmp191 = (_tmp179 * _tmp190 + _tmp182 * (-_tmp139 * _tmp157 - _tmp142 + _tmp177)) /
  ...
  _res(1, 0) =
      -_tmp151 *
          (-Scalar(0.87679799777269396) * _tmp159 + Scalar(1.0) * _tmp160 * std::sinh(_tmp155) -
  ...
  _res(2, 0) =
      -_tmp169 *
          (-Scalar(0.86627065637365697) * _tmp176 + Scalar(1.0) * _tmp178 * std::sinh(_tmp168) -
           (-Scalar(0.1034955) * _tmp170 * _tmp176 +
            _tmp171 * (-_tmp167 * _tmp174 - _tmp169 * _tmp178)) *
               std::sinh(_tmp172)) -
      _tmp174 * (Scalar(0.86627065637365697) * _tmp166 + std::cosh(_tmp168) - std::cosh(_tmp172));
  _res(3, 0) =
      _tmp173 * (Scalar(0.876505537412406) * _tmp182 - std::cosh(_tmp187) + std::cosh(_tmp188)) -
      _tmp184 * (Scalar(0.876505537412406) * _tmp190 + Scalar(1.0) * _tmp191 * std::sinh(_tmp188) -
