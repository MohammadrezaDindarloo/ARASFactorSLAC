...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl10(
  ...
  const Scalar _tmp47 = _tmp43 + _tmp6;
  const Scalar _tmp48 = Scalar(1.0) / (_tmp46 + _tmp47);
  const Scalar _tmp49 = _tmp27 + _tmp39;
  ...
  const Scalar _tmp74 = _tmp33 + _tmp60;
  const Scalar _tmp75 = _tmp65 * _tmp66;
  const Scalar _tmp76 = _tmp74 * _tmp75;
  const Scalar _tmp77 = _tmp61 * _tmp67 - _tmp73 * _tmp76;
  const Scalar _tmp78 = _tmp53 + position_vector(1, 0);
  const Scalar _tmp79 = _tmp78 + Scalar(-4.7744369927459998);
  const Scalar _tmp80 = _tmp56 + position_vector(0, 0);
  const Scalar _tmp81 = _tmp80 + Scalar(-2.7171519410699099);
  ...
  const Scalar _tmp86 = Scalar(1.0) / (-_tmp67 + _tmp73 * _tmp75);
  const Scalar _tmp87 = _tmp85 * _tmp86;
  const Scalar _tmp88 = _tmp33 + _tmp37;
  const Scalar _tmp89 = _tmp73 * _tmp74;
  const Scalar _tmp90 = -_tmp77 * _tmp87 - _tmp83 * _tmp89 + _tmp84 * _tmp88;
  const Scalar _tmp91 = -_tmp61 * _tmp75 + _tmp76;
  const Scalar _tmp92 = -_tmp51 * _tmp90 + _tmp74 * _tmp83 - _tmp83 * _tmp88 - _tmp87 * _tmp91;
  const Scalar _tmp93 = Scalar(1.0) / (_tmp92);
  const Scalar _tmp94 = 0;
  const Scalar _tmp95 = _tmp46 - _tmp54 * _tmp59 - _tmp90 * _tmp94;
  const Scalar _tmp96 = Scalar(1.0) * _tmp48;
  const Scalar _tmp97 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp98 = _tmp51 * _tmp58;
  const Scalar _tmp99 = _tmp55 * _tmp58 + Scalar(1.0);
  const Scalar _tmp100 = _tmp19 + Scalar(8.3885017487099702);
  const Scalar _tmp101 = _tmp29 + Scalar(-2.5193355532036801);
  const Scalar _tmp102 =
      std::pow(Scalar(std::pow(_tmp100, Scalar(2)) + std::pow(_tmp101, Scalar(2))),
               Scalar(Scalar(-1) / Scalar(2)));
  const Scalar _tmp103 = _tmp100 * _tmp102;
  const Scalar _tmp104 = _tmp38 * fh1;
  const Scalar _tmp105 = -_tmp103 * _tmp104 - Scalar(5.1796800000000003) * _tmp12 - _tmp18 * fv1;
  ...
  const Scalar _tmp109 = _tmp108 * (_tmp107 * _tmp41 * _tmp69 - _tmp107 * _tmp44 * _tmp71);
  const Scalar _tmp110 = _tmp109 * _tmp75 + _tmp47 * _tmp75 - _tmp49 * _tmp67;
  const Scalar _tmp111 = Scalar(1.0) * _tmp86;
  const Scalar _tmp112 = -_tmp111 * _tmp91 + _tmp50 * _tmp77 * _tmp86 * _tmp96;
  const Scalar _tmp113 = _tmp109 * _tmp83 - _tmp110 * _tmp87 + _tmp53 * _tmp83 - _tmp56 * _tmp84;
  const Scalar _tmp114 = _tmp113 * _tmp93;
  const Scalar _tmp115 = Scalar(1.0) / (_tmp113);
  const Scalar _tmp116 = _tmp115 * _tmp92;
  const Scalar _tmp117 = _tmp116 * (-_tmp110 * _tmp111 - _tmp112 * _tmp114);
  const Scalar _tmp118 = _tmp54 * _tmp57;
  const Scalar _tmp119 = _tmp112 + _tmp117;
  const Scalar _tmp120 = _tmp90 * _tmp93;
  const Scalar _tmp121 = -_tmp111 * _tmp77 + _tmp117 * _tmp118 - _tmp119 * _tmp120;
  const Scalar _tmp122 = _tmp103 * fh1;
  const Scalar _tmp123 = _tmp73 * _tmp86;
  const Scalar _tmp124 = _tmp123 * _tmp77 + _tmp89;
  const Scalar _tmp125 = _tmp123 * _tmp91 - _tmp124 * _tmp51 - _tmp74;
  const Scalar _tmp126 = _tmp116 * (-_tmp109 + _tmp110 * _tmp123 - _tmp114 * _tmp125);
  const Scalar _tmp127 = _tmp125 + _tmp126;
  const Scalar _tmp128 = _tmp118 * _tmp126 - _tmp120 * _tmp127 + _tmp124;
  const Scalar _tmp129 = _tmp101 * _tmp102;
  const Scalar _tmp130 = _tmp129 * fh1;
  const Scalar _tmp131 = _tmp48 * _tmp54;
  const Scalar _tmp132 = _tmp104 * _tmp129 + Scalar(5.1796800000000003) * _tmp24 + _tmp28 * fv1;
  const Scalar _tmp133 = _tmp116 * _tmp58;
  const Scalar _tmp134 = Scalar(1.0) * _tmp115;
  const Scalar _tmp135 = _tmp133 * _tmp54 - _tmp134 * _tmp90;
  const Scalar _tmp136 = fh1 * (_tmp103 * _tmp28 - _tmp129 * _tmp18);
  const Scalar _tmp137 = _tmp75 * _tmp87;
  const Scalar _tmp138 = _tmp83 * _tmp93;
  const Scalar _tmp139 = _tmp85 * _tmp93;
  const Scalar _tmp140 = -_tmp127 * _tmp139 - _tmp73;
  const Scalar _tmp141 = _tmp75 * _tmp86;
  const Scalar _tmp142 = -_tmp119 * _tmp139 + Scalar(1.0);
  const Scalar _tmp143 = -_tmp108 * _tmp122 * (_tmp119 * _tmp138 + _tmp141 * _tmp142) -
                         _tmp108 * _tmp130 * (_tmp127 * _tmp138 + _tmp140 * _tmp141 + Scalar(1.0)) -
                         _tmp108 * _tmp136 * (-_tmp134 * _tmp137 + _tmp134 * _tmp83) -
                         _tmp108 * _tmp97 * (-_tmp137 * _tmp94 + _tmp83 * _tmp94);
  const Scalar _tmp144 = Scalar(1.0) / (_tmp143);
  const Scalar _tmp145 = std::asinh(
      _tmp144 * (Scalar(1.0) * _tmp105 * (-_tmp96 * _tmp99 + _tmp98) +
                 Scalar(1.0) * _tmp122 * (_tmp117 * _tmp58 - _tmp121 * _tmp96) +
                 Scalar(1.0) * _tmp130 * (_tmp126 * _tmp58 - _tmp128 * _tmp96) +
                 Scalar(1.0) * _tmp132 * (_tmp131 * _tmp58 - _tmp58) +
                 Scalar(1.0) * _tmp136 * (_tmp133 - _tmp135 * _tmp96) +
                 Scalar(1.0) * _tmp97 * (-_tmp52 * _tmp58 - _tmp95 * _tmp96 + Scalar(1.0))));
  ...
  const Scalar _tmp149 = _tmp134 * _tmp136;
  const Scalar _tmp150 =
      _tmp122 * _tmp142 * _tmp86 + _tmp130 * _tmp140 * _tmp86 - _tmp148 * _tmp87 - _tmp149 * _tmp87;
  const Scalar _tmp151 = Scalar(1.0) / (_tmp150);
  const Scalar _tmp152 = _tmp48 * fh1;
  const Scalar _tmp153 = _tmp132 * _tmp58;
  const Scalar _tmp154 =
      std::asinh(_tmp151 * (_tmp103 * _tmp121 * _tmp152 + _tmp105 * _tmp48 * _tmp99 +
                            _tmp128 * _tmp129 * _tmp152 - _tmp131 * _tmp153 +
                            _tmp135 * _tmp136 * _tmp48 + _tmp48 * _tmp95 * _tmp97));
  ...
  const Scalar _tmp157 =
      _tmp119 * _tmp122 * _tmp93 + _tmp127 * _tmp130 * _tmp93 + _tmp148 + _tmp149;
  const Scalar _tmp158 = Scalar(1.0) / (_tmp157);
  const Scalar _tmp159 = std::asinh(_tmp158 * (-_tmp105 * _tmp98 - _tmp117 * _tmp122 * _tmp57 -
                                               _tmp126 * _tmp130 * _tmp57 - _tmp133 * _tmp136 +
                                               _tmp153 + _tmp59 * _tmp97));
  const Scalar _tmp160 = Scalar(22.795248597701466) *
                             std::pow(Scalar(1 - Scalar(0.2094487793051498) * _tmp78), Scalar(2)) +
                         Scalar(7.3829146708599787) *
                             std::pow(Scalar(1 - Scalar(0.36803241838814449) * _tmp80), Scalar(2));
  ...
  _res(1, 0) =
      _tmp147 *
          (-std::sinh(Scalar(1.0) * _tmp145) -
           std::sinh(Scalar(0.1034955) * _tmp144 * (-_tmp145 * _tmp147 - std::sqrt(_tmp146)))) -
  ...
  _res(3, 0) =
      ...
      Scalar(8.3641088633305802) *
          std::sqrt(Scalar(Scalar(0.014294226073078949) * _tmp160 +
                           std::pow(Scalar(-Scalar(0.11955846299229073) * _tmp88 -
