...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl13(
  ...
  const Scalar _tmp40 = _tmp39 + Scalar(8.3885017487099702);
  ...
  const Scalar _tmp60 = _tmp40 * _tmp45;
  ...
  const Scalar _tmp70 = _tmp59 * _tmp68 - _tmp61 * _tmp69 + _tmp64 * _tmp68;
  const Scalar _tmp71 = _tmp50 * _tmp57;
  const Scalar _tmp72 = _tmp46 * _tmp71 - _tmp60;
  const Scalar _tmp73 = Scalar(1.0) / (_tmp68 * _tmp71 - _tmp69);
  const Scalar _tmp74 = _tmp72 * _tmp73;
  const Scalar _tmp75 = _tmp38 * _tmp46 - _tmp42 * _tmp60 + _tmp46 * _tmp59 - _tmp70 * _tmp74;
  ...
  const Scalar _tmp92 = _tmp86 * _tmp91 + _tmp89;
  const Scalar _tmp93 = 0;
  const Scalar _tmp94 = _tmp33 - _tmp34;
  const Scalar _tmp95 = _tmp32 + _tmp94;
  const Scalar _tmp96 = -_tmp32;
  const Scalar _tmp97 = _tmp94 + _tmp96;
  const Scalar _tmp98 = _tmp35 + _tmp96;
  const Scalar _tmp99 = _tmp71 * _tmp97;
  const Scalar _tmp100 = -_tmp68 * _tmp99 + _tmp69 * _tmp98;
  const Scalar _tmp101 = -_tmp100 * _tmp74 - _tmp46 * _tmp99 + _tmp60 * _tmp95;
  const Scalar _tmp102 = _tmp68 * _tmp97 - _tmp68 * _tmp98;
  const Scalar _tmp103 = -_tmp101 * _tmp91 - _tmp102 * _tmp74 - _tmp46 * _tmp95 + _tmp46 * _tmp97;
  ...
  const Scalar _tmp108 = _tmp100 * _tmp107 * _tmp73 * _tmp90 - _tmp102 * _tmp106;
  const Scalar _tmp109 = _tmp104 * _tmp75;
  const Scalar _tmp110 = _tmp103 * _tmp76;
  const Scalar _tmp111 = _tmp110 * (-_tmp106 * _tmp70 - _tmp108 * _tmp109);
  const Scalar _tmp112 = _tmp108 + _tmp111;
  const Scalar _tmp113 = _tmp104 * _tmp46;
  const Scalar _tmp114 = _tmp104 * _tmp72;
  const Scalar _tmp115 = -_tmp112 * _tmp114 + Scalar(1.0);
  const Scalar _tmp116 = _tmp68 * _tmp73;
  const Scalar _tmp117 = _tmp82 * fh1;
  const Scalar _tmp118 = _tmp71 * _tmp73;
  const Scalar _tmp119 = _tmp100 * _tmp118 + _tmp99;
  const Scalar _tmp120 = _tmp102 * _tmp118 - _tmp119 * _tmp91 - _tmp97;
  const Scalar _tmp121 = _tmp110 * (-_tmp109 * _tmp120 + _tmp118 * _tmp70 - _tmp59);
  const Scalar _tmp122 = _tmp120 + _tmp121;
  const Scalar _tmp123 = -_tmp114 * _tmp122 - _tmp71;
  const Scalar _tmp124 = _tmp83 * fh1;
  const Scalar _tmp125 = -_tmp117 * _tmp58 * (_tmp112 * _tmp113 + _tmp115 * _tmp116) -
                         _tmp124 * _tmp58 * (_tmp113 * _tmp122 + _tmp116 * _tmp123 + Scalar(1.0)) -
                         _tmp58 * _tmp84 * (_tmp46 * _tmp77 - _tmp77 * _tmp78) -
                         _tmp58 * _tmp85 * (_tmp105 * _tmp46 - _tmp105 * _tmp78);
  const Scalar _tmp126 = Scalar(1.0) / (_tmp125);
  const Scalar _tmp127 = _tmp101 * _tmp104;
  const Scalar _tmp128 = _tmp38 + _tmp87;
  const Scalar _tmp129 = _tmp128 * _tmp91;
  const Scalar _tmp130 = Scalar(1.0) / (-_tmp129 - _tmp42 + _tmp89);
  const Scalar _tmp131 = _tmp128 * _tmp130;
  const Scalar _tmp132 = -_tmp100 * _tmp106 + _tmp111 * _tmp131 - _tmp112 * _tmp127;
  const Scalar _tmp133 = Scalar(1.0) * _tmp130;
  const Scalar _tmp134 = _tmp110 * _tmp133;
  const Scalar _tmp135 = -_tmp101 * _tmp77 + _tmp128 * _tmp134;
  const Scalar _tmp136 = _tmp36 * fh1;
  const Scalar _tmp137 = -_tmp136 * _tmp82 - Scalar(5.1796800000000003) * _tmp22 - _tmp27 * fv1;
  const Scalar _tmp138 = _tmp133 * _tmp91;
  const Scalar _tmp139 = _tmp129 * _tmp133 + Scalar(1.0);
  const Scalar _tmp140 = _tmp130 * _tmp92;
  const Scalar _tmp141 = -_tmp127 * _tmp93 - _tmp128 * _tmp140 + _tmp87;
  const Scalar _tmp142 = _tmp119 + _tmp121 * _tmp131 - _tmp122 * _tmp127;
  const Scalar _tmp143 = _tmp128 * _tmp88;
  const Scalar _tmp144 = Scalar(5.1796800000000003) * _tmp11 + _tmp136 * _tmp83 + _tmp17 * fv1;
  const Scalar _tmp145 = std::asinh(
      _tmp126 * (Scalar(1.0) * _tmp117 * (-_tmp107 * _tmp132 + _tmp111 * _tmp133) +
                 Scalar(1.0) * _tmp124 * (-_tmp107 * _tmp142 + _tmp121 * _tmp133) +
                 Scalar(1.0) * _tmp137 * (-_tmp107 * _tmp139 + _tmp138) +
                 Scalar(1.0) * _tmp144 * (_tmp133 * _tmp143 - _tmp133) +
                 Scalar(1.0) * _tmp84 * (-_tmp107 * _tmp135 + _tmp134) +
                 Scalar(1.0) * _tmp85 * (-_tmp107 * _tmp141 - _tmp133 * _tmp92 + Scalar(1.0))));
  ...
  const Scalar _tmp149 = _tmp105 * _tmp85;
  const Scalar _tmp150 =
      _tmp115 * _tmp117 * _tmp73 + _tmp123 * _tmp124 * _tmp73 - _tmp148 * _tmp74 - _tmp149 * _tmp74;
  const Scalar _tmp151 = Scalar(1.0) / (_tmp150);
  const Scalar _tmp152 = _tmp88 * fh1;
  const Scalar _tmp153 = _tmp133 * _tmp144;
  const Scalar _tmp154 =
      std::asinh(_tmp151 * (_tmp132 * _tmp152 * _tmp82 + _tmp135 * _tmp84 * _tmp88 +
                            _tmp137 * _tmp139 * _tmp88 + _tmp141 * _tmp85 * _tmp88 +
                            _tmp142 * _tmp152 * _tmp83 - _tmp143 * _tmp153));
  ...
  const Scalar _tmp158 =
      _tmp104 * _tmp112 * _tmp117 + _tmp104 * _tmp122 * _tmp124 + _tmp148 + _tmp149;
  const Scalar _tmp159 = Scalar(1.0) / (_tmp158);
  const Scalar _tmp160 =
      std::asinh(_tmp159 * (-_tmp111 * _tmp117 * _tmp130 - _tmp121 * _tmp124 * _tmp130 -
                            _tmp134 * _tmp84 - _tmp137 * _tmp138 + _tmp140 * _tmp85 + _tmp153));
  ...
  _res(1, 0) =
      ...
      Scalar(8.4718465805053693) *
          std::sqrt(Scalar(Scalar(0.013932974274013004) * _tmp147 +
                           std::pow(Scalar(-Scalar(0.11803802045956635) * _tmp97 -
  ...
  _res(2, 0) =
      ...
      Scalar(8.3701287145205097) *
          std::sqrt(Scalar(Scalar(0.014273672465547484) * _tmp156 +
                           std::pow(Scalar(-Scalar(0.11947247576553975) * _tmp98 -
  ...
  _res(3, 0) =
      ...
      Scalar(8.4690207536791995) *
          std::sqrt(Scalar(Scalar(0.013942273753185566) * _tmp157 +
                           std::pow(Scalar(-Scalar(0.11807740576920533) * _tmp95 -
