...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2WrtFv1Nl1(
  ...
  const Scalar _tmp69 = -_tmp59 * _tmp65 + _tmp65 * _tmp68;
  ...
  const Scalar _tmp76 = _tmp36 + position_vector(0, 0);
  const Scalar _tmp77 = _tmp76 + Scalar(-2.5193355532036801);
  const Scalar _tmp78 = Scalar(1.0) / (_tmp77);
  const Scalar _tmp79 = _tmp39 + position_vector(1, 0);
  ...
  const Scalar _tmp85 = Scalar(1.0) / (_tmp65 * _tmp81 - _tmp84);
  const Scalar _tmp86 = _tmp83 * _tmp85;
  const Scalar _tmp87 = _tmp55 + _tmp67;
  const Scalar _tmp88 = _tmp68 * _tmp81;
  const Scalar _tmp89 = _tmp59 * _tmp84 - _tmp65 * _tmp88;
  const Scalar _tmp90 = _tmp75 * _tmp87 - _tmp82 * _tmp88 - _tmp86 * _tmp89;
  const Scalar _tmp91 = -_tmp46 * _tmp90 + _tmp68 * _tmp82 - _tmp69 * _tmp86 - _tmp82 * _tmp87;
  const Scalar _tmp92 = Scalar(1.0) / (_tmp91);
  const Scalar _tmp93 = _tmp90 * _tmp92;
  const Scalar _tmp94 = _tmp47 * _tmp52;
  const Scalar _tmp95 = _tmp43 * (_tmp41 - _tmp49 * _tmp94 - _tmp54 * _tmp93);
  const Scalar _tmp96 = -Scalar(1.0) * _tmp47 * _tmp53 - Scalar(1.0) * _tmp95 + Scalar(1.0);
  const Scalar _tmp97 = _tmp33 + Scalar(1.9874742031097401);
  const Scalar _tmp98 = _tmp22 + Scalar(8.3196563720703107);
  const Scalar _tmp99 = std::pow(Scalar(std::pow(_tmp97, Scalar(2)) + std::pow(_tmp98, Scalar(2))),
                                 Scalar(Scalar(-1) / Scalar(2)));
  const Scalar _tmp100 = _tmp98 * _tmp99;
  const Scalar _tmp101 = fh1 * (_tmp58 + _tmp66);
  const Scalar _tmp102 = -_tmp100 * _tmp101 - Scalar(5.1796800000000003) * _tmp14 - _tmp21 * fv1;
  const Scalar _tmp103 = _tmp50 * _tmp53 + Scalar(1.0);
  const Scalar _tmp104 = Scalar(1.0) * _tmp43;
  const Scalar _tmp105 = _tmp46 * _tmp53;
  const Scalar _tmp106 = -Scalar(1.0) * _tmp103 * _tmp104 + Scalar(1.0) * _tmp105;
  ...
  const Scalar _tmp109 = _tmp107 * _tmp78;
  const Scalar _tmp110 = _tmp109 * (_tmp108 * _tmp36 * _tmp80 - _tmp108 * _tmp39 * _tmp77);
  const Scalar _tmp111 = _tmp110 * _tmp65 + _tmp42 * _tmp65 - _tmp45 * _tmp84;
  const Scalar _tmp112 = _tmp110 * _tmp82 - _tmp111 * _tmp86 + _tmp48 * _tmp82 - _tmp51 * _tmp75;
  const Scalar _tmp113 = Scalar(1.0) / (_tmp112);
  const Scalar _tmp114 = Scalar(1.0) * _tmp113;
  const Scalar _tmp115 = _tmp113 * _tmp91;
  const Scalar _tmp116 = _tmp115 * _tmp53;
  const Scalar _tmp117 = -_tmp114 * _tmp90 + _tmp116 * _tmp49;
  const Scalar _tmp118 = _tmp97 * _tmp99;
  const Scalar _tmp119 = fh1 * (_tmp100 * _tmp32 - _tmp118 * _tmp21);
  const Scalar _tmp120 = _tmp101 * _tmp118 + Scalar(5.1796800000000003) * _tmp28 + _tmp32 * fv1;
  const Scalar _tmp121 = _tmp43 * _tmp49;
  const Scalar _tmp122 = Scalar(1.0) * _tmp121 * _tmp53 - Scalar(1.0) * _tmp53;
  const Scalar _tmp123 = Scalar(1.0) * _tmp85;
  const Scalar _tmp124 = _tmp123 * _tmp89;
  const Scalar _tmp125 = -_tmp123 * _tmp69 + _tmp124 * _tmp46;
  const Scalar _tmp126 = _tmp112 * _tmp92;
  const Scalar _tmp127 = _tmp115 * (-_tmp111 * _tmp123 - _tmp125 * _tmp126);
  const Scalar _tmp128 = _tmp125 + _tmp127;
  const Scalar _tmp129 = _tmp49 * _tmp52;
  const Scalar _tmp130 = -_tmp124 + _tmp127 * _tmp129 - _tmp128 * _tmp93;
  const Scalar _tmp131 = _tmp100 * fh1;
  const Scalar _tmp132 = _tmp81 * _tmp85;
  const Scalar _tmp133 = _tmp132 * _tmp89 + _tmp88;
  const Scalar _tmp134 = _tmp132 * _tmp69 - _tmp133 * _tmp46 - _tmp68;
  const Scalar _tmp135 = _tmp115 * (-_tmp110 + _tmp111 * _tmp132 - _tmp126 * _tmp134);
  const Scalar _tmp136 = _tmp134 + _tmp135;
  const Scalar _tmp137 = _tmp129 * _tmp135 + _tmp133 - _tmp136 * _tmp93;
  const Scalar _tmp138 = _tmp118 * fh1;
  const Scalar _tmp139 =
      _tmp102 * _tmp106 + Scalar(1.0) * _tmp119 * (-_tmp104 * _tmp117 + _tmp116) +
      _tmp120 * _tmp122 + Scalar(1.0) * _tmp131 * (-_tmp104 * _tmp130 + _tmp127 * _tmp53) +
      Scalar(1.0) * _tmp138 * (-_tmp104 * _tmp137 + _tmp135 * _tmp53) + _tmp35 * _tmp96;
  const Scalar _tmp140 = _tmp82 * _tmp92;
  const Scalar _tmp141 = _tmp83 * _tmp92;
  const Scalar _tmp142 = -_tmp128 * _tmp141 + Scalar(1.0);
  const Scalar _tmp143 = _tmp65 * _tmp85;
  const Scalar _tmp144 = _tmp54 * _tmp92;
  const Scalar _tmp145 = _tmp144 * _tmp86;
  const Scalar _tmp146 = _tmp109 * (_tmp144 * _tmp82 - _tmp145 * _tmp65);
  const Scalar _tmp147 = -_tmp136 * _tmp141 - _tmp81;
  const Scalar _tmp148 = -_tmp109 * _tmp119 * (-_tmp114 * _tmp65 * _tmp86 + _tmp114 * _tmp82) -
                         _tmp109 * _tmp131 * (_tmp128 * _tmp140 + _tmp142 * _tmp143) -
                         _tmp109 * _tmp138 * (_tmp136 * _tmp140 + _tmp143 * _tmp147 + Scalar(1.0)) -
                         _tmp146 * _tmp35;
  ...
  const Scalar _tmp159 = _tmp15 + _tmp19 + _tmp7;
  const Scalar _tmp160 =
      (-_tmp139 * _tmp158 + _tmp149 * (_tmp106 * _tmp159 + _tmp122 * _tmp32 - _tmp96)) /
      std::sqrt(Scalar(std::pow(_tmp139, Scalar(2)) * _tmp157 + 1));
  const Scalar _tmp161 = _tmp144 * _tmp35;
  const Scalar _tmp162 = _tmp114 * _tmp119;
  const Scalar _tmp163 =
      _tmp131 * _tmp142 * _tmp85 + _tmp138 * _tmp147 * _tmp85 - _tmp161 * _tmp86 - _tmp162 * _tmp86;
  const Scalar _tmp164 = Scalar(1.0) / (_tmp163);
  const Scalar _tmp165 = _tmp103 * _tmp43;
  const Scalar _tmp166 = _tmp120 * _tmp53;
  const Scalar _tmp167 = _tmp102 * _tmp165 + _tmp117 * _tmp119 * _tmp43 - _tmp121 * _tmp166 +
                         _tmp130 * _tmp131 * _tmp43 + _tmp137 * _tmp138 * _tmp43 + _tmp35 * _tmp95;
  ...
  const Scalar _tmp178 = _tmp32 * _tmp53;
  const Scalar _tmp179 =
      (_tmp164 * (-_tmp121 * _tmp178 + _tmp159 * _tmp165 - _tmp95) - _tmp167 * _tmp177) /
      std::sqrt(Scalar(std::pow(_tmp167, Scalar(2)) * _tmp176 + 1));
  const Scalar _tmp180 = -_tmp102 * _tmp105 - _tmp116 * _tmp119 - _tmp127 * _tmp131 * _tmp52 -
                         _tmp135 * _tmp138 * _tmp52 + _tmp166 + _tmp35 * _tmp94;
  const Scalar _tmp181 =
      _tmp128 * _tmp131 * _tmp92 + _tmp136 * _tmp138 * _tmp92 + _tmp161 + _tmp162;
  ...
  const Scalar _tmp190 = (_tmp180 * _tmp189 + _tmp182 * (-_tmp105 * _tmp159 + _tmp178 - _tmp94)) /
  ...
  _res(3, 0) = -_tmp174 * (-std::sinh(_tmp187) - std::sinh(_tmp191)) +
               _tmp184 * (-Scalar(1.0) * _tmp190 * std::cosh(_tmp191) -
                          (Scalar(0.1034955) * _tmp185 * _tmp189 +
                           _tmp186 * (_tmp174 * _tmp183 - _tmp184 * _tmp190)) *
                              std::cosh(_tmp187));
