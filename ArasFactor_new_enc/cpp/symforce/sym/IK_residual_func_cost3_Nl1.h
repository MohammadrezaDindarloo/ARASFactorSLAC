...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl1(
  ...
  const Scalar _tmp75 = (-_tmp41 + _tmp73) / (_tmp44 - _tmp74);
  const Scalar _tmp76 = Scalar(1.0) * _tmp52;
  const Scalar _tmp77 = _tmp47 * _tmp68 - _tmp47 * _tmp71;
  const Scalar _tmp78 = _tmp72 * _tmp75 * _tmp76 - _tmp76 * _tmp77;
  const Scalar _tmp79 = _tmp27 * _tmp68;
  const Scalar _tmp80 = _tmp66 + _tmp70;
  const Scalar _tmp81 = -_tmp27 * _tmp80 - _tmp53 * _tmp77 -
                        _tmp75 * (_tmp28 * _tmp80 - _tmp50 * _tmp79 - _tmp53 * _tmp72) + _tmp79;
  const Scalar _tmp82 = Scalar(1.0) / (_tmp81);
  const Scalar _tmp83 = _tmp54 * _tmp82;
  const Scalar _tmp84 = _tmp55 * _tmp81;
  const Scalar _tmp85 = _tmp78 + _tmp84 * (-_tmp49 * _tmp76 - _tmp78 * _tmp83);
  const Scalar _tmp86 = _tmp27 * _tmp82;
  const Scalar _tmp87 = _tmp51 * _tmp82;
  const Scalar _tmp88 = -_tmp85 * _tmp87 + Scalar(1.0);
  const Scalar _tmp89 = _tmp47 * _tmp52;
  const Scalar _tmp90 = _tmp62 * fh1;
  const Scalar _tmp91 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp92 = _tmp73 + _tmp74 * _tmp75;
  const Scalar _tmp93 = 0;
  const Scalar _tmp94 = _tmp82 * _tmp93;
  const Scalar _tmp95 = _tmp87 * _tmp93;
  const Scalar _tmp96 = _tmp50 * _tmp52;
  const Scalar _tmp97 = -_tmp68 - _tmp75 * (_tmp69 + _tmp72 * _tmp96) + _tmp77 * _tmp96;
  const Scalar _tmp98 = _tmp84 * (-_tmp39 + _tmp49 * _tmp96 - _tmp83 * _tmp97) + _tmp97;
  const Scalar _tmp99 = -_tmp50 - _tmp87 * _tmp98;
  const Scalar _tmp100 = _tmp63 * fh1;
  ...
  _res(1, 0) = std::exp(_tmp100 * _tmp38 * (_tmp86 * _tmp98 + _tmp89 * _tmp99 + Scalar(1.0)) +
                        _tmp38 * _tmp64 * (_tmp27 * _tmp56 - _tmp47 * _tmp53 * _tmp56) +
                        _tmp38 * _tmp90 * (_tmp85 * _tmp86 + _tmp88 * _tmp89) +
                        _tmp38 * _tmp91 * (_tmp27 * _tmp94 - _tmp89 * _tmp95));
  _res(2, 0) = std::exp(-_tmp100 * _tmp52 * _tmp99 + _tmp101 * _tmp53 - _tmp52 * _tmp88 * _tmp90 +
                        _tmp52 * _tmp91 * _tmp95);
  _res(3, 0) =
      std::exp(-_tmp100 * _tmp82 * _tmp98 - _tmp101 - _tmp82 * _tmp85 * _tmp90 - _tmp91 * _tmp94);
