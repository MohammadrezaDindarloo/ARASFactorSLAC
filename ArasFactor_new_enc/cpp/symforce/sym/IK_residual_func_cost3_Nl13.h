...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl13(
  ...
  const Scalar _tmp58 = _tmp17 + _tmp24;
  const Scalar _tmp59 = _tmp43 + _tmp6;
  ...
  const Scalar _tmp67 = -Scalar(0.010999999999999999) * _tmp22 -
  ...
  const Scalar _tmp75 = _tmp50 * _tmp73;
  const Scalar _tmp76 = -_tmp47 * _tmp75 + _tmp48 * _tmp74;
  const Scalar _tmp77 = Scalar(1.0) * _tmp30;
  const Scalar _tmp78 = Scalar(1.0) * _tmp33;
  const Scalar _tmp79 = (-_tmp41 + _tmp78) / (_tmp44 - _tmp77);
  const Scalar _tmp80 = _tmp47 * _tmp73 - _tmp47 * _tmp74;
  const Scalar _tmp81 = -_tmp28 * _tmp71 + _tmp28 * _tmp73 - _tmp53 * _tmp80 -
                        _tmp79 * (-_tmp28 * _tmp75 + _tmp40 * _tmp71 - _tmp53 * _tmp76);
  ...
  const Scalar _tmp87 = _tmp54 * _tmp82;
  const Scalar _tmp88 = _tmp55 * _tmp81;
  const Scalar _tmp89 = _tmp86 + _tmp88 * (-_tmp49 * _tmp85 - _tmp86 * _tmp87);
  const Scalar _tmp90 = _tmp28 * _tmp82;
  const Scalar _tmp91 = _tmp51 * _tmp82;
  const Scalar _tmp92 = -_tmp89 * _tmp91 + Scalar(1.0);
  const Scalar _tmp93 = _tmp47 * _tmp52;
  const Scalar _tmp94 = _tmp38 * fh1;
  const Scalar _tmp95 = _tmp50 * _tmp52;
  const Scalar _tmp96 = -_tmp73 - _tmp79 * (_tmp75 + _tmp76 * _tmp95) + _tmp80 * _tmp95;
  const Scalar _tmp97 = _tmp88 * (-_tmp39 + _tmp49 * _tmp95 - _tmp87 * _tmp96) + _tmp96;
  const Scalar _tmp98 = -_tmp50 - _tmp91 * _tmp97;
  const Scalar _tmp99 = _tmp52 * fh1;
  const Scalar _tmp100 = _tmp56 * _tmp65;
  const Scalar _tmp101 = _tmp66 * _tmp84;
  const Scalar _tmp102 = _tmp82 * fh1;

  // Output terms (1)
  Eigen::Matrix<Scalar, 4, 1> _res;

  _res(0, 0) = std::exp(-fh1);
  _res(1, 0) = std::exp(_tmp38 * _tmp65 * (_tmp28 * _tmp56 - _tmp56 * _tmp57) +
                        _tmp38 * _tmp66 * (_tmp28 * _tmp84 - _tmp57 * _tmp84) +
                        _tmp63 * _tmp94 * (_tmp89 * _tmp90 + _tmp92 * _tmp93) +
                        _tmp64 * _tmp94 * (_tmp90 * _tmp97 + _tmp93 * _tmp98 + Scalar(1.0)));
  _res(2, 0) = std::exp(_tmp100 * _tmp53 + _tmp101 * _tmp53 - _tmp63 * _tmp92 * _tmp99 -
                        _tmp64 * _tmp98 * _tmp99);
  _res(3, 0) = std::exp(-_tmp100 - _tmp101 - _tmp102 * _tmp63 * _tmp89 - _tmp102 * _tmp64 * _tmp97);
