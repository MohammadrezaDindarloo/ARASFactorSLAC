...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl15(
  ...
  const Scalar _tmp95 = _tmp29 * _tmp52;
  const Scalar _tmp96 = -_tmp34 - _tmp51 * (_tmp29 * _tmp34 + _tmp48 * _tmp95) + _tmp54 * _tmp95;
  const Scalar _tmp97 = _tmp77 * (-_tmp72 + _tmp73 * _tmp95 - _tmp75 * _tmp96) + _tmp96;
  const Scalar _tmp98 = -_tmp29 - _tmp79 * _tmp97;
  const Scalar _tmp99 = _tmp86 * _tmp87;
  const Scalar _tmp100 = _tmp99 * fh1;
  const Scalar _tmp101 = Scalar(1.0) * _tmp76;
  const Scalar _tmp102 = fh1 * (-_tmp83 * _tmp99 + _tmp85 * _tmp88);
  ...
  _res(1, 0) = std::exp(_tmp100 * _tmp71 * (_tmp81 * _tmp98 + _tmp82 * _tmp97 + Scalar(1.0)) +
                        _tmp102 * _tmp71 * (-_tmp101 * _tmp43 * _tmp66 + _tmp101 * _tmp62) +
                        _tmp71 * _tmp89 * (_tmp78 * _tmp82 + _tmp80 * _tmp81) +
                        _tmp71 * _tmp90 * (_tmp62 * _tmp93 - _tmp81 * _tmp94));
  _res(2, 0) = std::exp(-_tmp100 * _tmp52 * _tmp98 + _tmp103 * _tmp66 - _tmp52 * _tmp80 * _tmp89 +
                        _tmp52 * _tmp90 * _tmp94);
  _res(3, 0) =
      std::exp(-_tmp100 * _tmp68 * _tmp97 - _tmp103 - _tmp68 * _tmp78 * _tmp89 - _tmp90 * _tmp93);
