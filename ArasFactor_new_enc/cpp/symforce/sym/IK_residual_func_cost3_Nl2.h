...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl2(
  ...
  const Scalar _tmp86 = _tmp38 * fh1;
  ...
  const Scalar _tmp95 = _tmp51 * _tmp54 * _tmp91 - _tmp55 * _tmp91;
  const Scalar _tmp96 = _tmp74 * (-_tmp40 * _tmp91 - _tmp72 * _tmp95) + _tmp95;
  const Scalar _tmp97 = -_tmp77 * _tmp96 + Scalar(1.0);
  const Scalar _tmp98 = _tmp42 * fh1;
  const Scalar _tmp99 = _tmp87 * _tmp89;
  const Scalar _tmp100 = _tmp70 * fh1;

  // Output terms (1)
  Eigen::Matrix<Scalar, 4, 1> _res;

  _res(0, 0) = std::exp(-fh1);
  _res(1, 0) = std::exp(_tmp38 * _tmp87 * (-_tmp29 * _tmp68 * _tmp89 + _tmp64 * _tmp89) +
                        _tmp38 * _tmp94 * (-_tmp29 * _tmp92 + _tmp64 * _tmp90) +
                        _tmp85 * _tmp86 * (_tmp75 * _tmp76 + _tmp78 * _tmp79 + Scalar(1.0)) +
                        _tmp86 * _tmp93 * (_tmp76 * _tmp96 + _tmp79 * _tmp97));
  _res(2, 0) = std::exp(_tmp68 * _tmp99 - _tmp78 * _tmp85 * _tmp98 + _tmp92 * _tmp94 -
                        _tmp93 * _tmp97 * _tmp98);
  _res(3, 0) =
      std::exp(-_tmp100 * _tmp75 * _tmp85 - _tmp100 * _tmp93 * _tmp96 - _tmp90 * _tmp94 - _tmp99);
