...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl16(
  ...
  const Scalar _tmp21 = _tmp1 * _tmp9;
  ...
  const Scalar _tmp34 = _tmp33 + position_vector(1, 0) + Scalar(-4.83288938413423);
  const Scalar _tmp35 = _tmp16 + _tmp7;
  ...
  const Scalar _tmp39 = Scalar(1.0) / (_tmp30 * _tmp38 - _tmp31);
  const Scalar _tmp40 = _tmp19 + _tmp26;
  ...
  const Scalar _tmp44 = _tmp43 + position_vector(0, 0) + Scalar(-2.5193355532036801);
  ...
  const Scalar _tmp58 = _tmp30 * _tmp54;
  const Scalar _tmp59 = -_tmp30 * _tmp57 + _tmp58;
  const Scalar _tmp60 = _tmp38 * _tmp54;
  const Scalar _tmp61 = _tmp31 * _tmp57 - _tmp38 * _tmp58;
  const Scalar _tmp62 = Scalar(1.0) * _tmp33;
  const Scalar _tmp63 = Scalar(1.0) * _tmp35;
  const Scalar _tmp64 = (-_tmp17 + _tmp63) / (_tmp27 - _tmp62);
  const Scalar _tmp65 = _tmp46 * _tmp54 - _tmp46 * _tmp56 - _tmp49 * _tmp59 -
                        _tmp64 * (-_tmp46 * _tmp60 + _tmp47 * _tmp56 - _tmp49 * _tmp61);
  ...
  const Scalar _tmp70 =
      std::sqrt(Scalar(std::pow(_tmp34, Scalar(2)) + std::pow(_tmp36, Scalar(2))));
  ...
  const Scalar _tmp74 = _tmp71 * (-_tmp33 * _tmp36 * _tmp73 + _tmp34 * _tmp35 * _tmp73);
  const Scalar _tmp75 = -_tmp17 * _tmp31 + _tmp27 * _tmp30 + _tmp30 * _tmp74;
  const Scalar _tmp76 = Scalar(1.0) * _tmp39;
  const Scalar _tmp77 = -_tmp59 * _tmp76 + _tmp61 * _tmp64 * _tmp76;
  const Scalar _tmp78 = _tmp40 * _tmp46 - _tmp43 * _tmp47 + _tmp46 * _tmp74 - _tmp49 * _tmp75;
  ...
  const Scalar _tmp83 = _tmp46 * _tmp66;
  const Scalar _tmp84 = _tmp48 * _tmp66;
  const Scalar _tmp85 = -_tmp82 * _tmp84 + Scalar(1.0);
  const Scalar _tmp86 = _tmp30 * _tmp39;
  const Scalar _tmp87 = _tmp19 + _tmp32;
  const Scalar _tmp88 = _tmp87 + position_vector(1, 0) + Scalar(-4.7744369927459998);
  const Scalar _tmp89 = _tmp42 + _tmp7;
  const Scalar _tmp90 = _tmp89 + position_vector(0, 0) + Scalar(-2.7171519410699099);
  ...
  const Scalar _tmp97 = _tmp38 * _tmp39;
  const Scalar _tmp98 = -_tmp54 + _tmp59 * _tmp97 - _tmp64 * (_tmp60 + _tmp61 * _tmp97);
  const Scalar _tmp99 = _tmp81 * (-_tmp74 + _tmp75 * _tmp97 - _tmp79 * _tmp98) + _tmp98;
  const Scalar _tmp100 = -_tmp38 - _tmp84 * _tmp99;
  ...
  _res(1, 0) =
      -_tmp72 * std::exp(_tmp0 * _tmp72 +
                         _tmp101 * _tmp71 * (_tmp100 * _tmp86 + _tmp83 * _tmp99 + Scalar(1.0)) +
                         _tmp71 * _tmp93 * (_tmp82 * _tmp83 + _tmp85 * _tmp86) +
                         _tmp71 * _tmp96 * (-_tmp30 * _tmp49 * _tmp94 + _tmp46 * _tmp94));
  _res(2, 0) = -_tmp69 * std::exp(-_tmp100 * _tmp101 * _tmp39 + _tmp102 * _tmp49 +
                                  _tmp103 * _tmp49 - _tmp39 * _tmp85 * _tmp93);
  _res(3, 0) =
