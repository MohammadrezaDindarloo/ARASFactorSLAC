...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl3(
  ...
  const Scalar _tmp93 = _tmp40 * (_tmp64 * _tmp91 - _tmp91 * _tmp92);
  const Scalar _tmp94 = Scalar(1.0) * _tmp71;
  const Scalar _tmp95 = fh1 * (_tmp78 * _tmp88 - _tmp80 * _tmp83);
  const Scalar _tmp96 = _tmp37 * fh1;
  const Scalar _tmp97 = _tmp89 * _tmp91;
  const Scalar _tmp98 = _tmp37 * _tmp66;
  ...
  _res(0, 0) = 0;
  _res(1, 0) =
      -_tmp93 * std::exp(_tmp40 * _tmp95 * (_tmp64 * _tmp94 - _tmp92 * _tmp94) +
                         _tmp83 * _tmp84 * (_tmp73 * _tmp74 + _tmp76 * _tmp77 + Scalar(1.0)) +
                         _tmp84 * _tmp88 * (_tmp74 * _tmp86 + _tmp77 * _tmp87) + _tmp89 * _tmp93);
  _res(2, 0) = -_tmp91 * _tmp98 *
               std::exp(-_tmp76 * _tmp83 * _tmp96 - _tmp87 * _tmp88 * _tmp96 + _tmp97 * _tmp98 +
                        _tmp98 * _tmp99);
  _res(3, 0) =
      _tmp91 * std::exp(-_tmp100 * _tmp73 * _tmp83 - _tmp100 * _tmp86 * _tmp88 - _tmp97 - _tmp99);
