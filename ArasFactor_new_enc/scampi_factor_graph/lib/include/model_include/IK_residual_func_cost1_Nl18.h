...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl18(
  ...
  const Scalar _tmp52 = _tmp42 + _tmp5;
  ...
  const Scalar _tmp58 = Scalar(1.0) / (_tmp47 * _tmp57 - _tmp56);
  const Scalar _tmp59 =
      std::sqrt(Scalar(std::pow(_tmp41, Scalar(2)) + std::pow(_tmp45, Scalar(2))));
  const Scalar _tmp60 = Scalar(1.0) / (_tmp59);
  const Scalar _tmp61 = _tmp46 * _tmp59;
  const Scalar _tmp62 = _tmp61 * (-_tmp39 * _tmp45 * _tmp60 + _tmp41 * _tmp43 * _tmp60);
  const Scalar _tmp63 = _tmp58 * (_tmp49 * _tmp57 - _tmp52 * _tmp56 + _tmp57 * _tmp62);
  const Scalar _tmp64 = _tmp34 - _tmp35;
  const Scalar _tmp65 = _tmp32 + _tmp64;
  const Scalar _tmp66 = _tmp33 + _tmp64;
  const Scalar _tmp67 = _tmp58 * (-_tmp57 * _tmp65 + _tmp57 * _tmp66);
  const Scalar _tmp68 = _tmp47 * _tmp66;
  const Scalar _tmp69 = _tmp58 * (_tmp56 * _tmp65 - _tmp57 * _tmp68);
  ...
  const Scalar _tmp77 = _tmp32 + _tmp36;
  const Scalar _tmp78 = _tmp21 + _tmp48;
  ...
  const Scalar _tmp91 = _tmp62 * _tmp86 - _tmp63 * _tmp87 + _tmp78 * _tmp86 - _tmp81 * _tmp85;
  const Scalar _tmp92 = _tmp90 * _tmp91;
  const Scalar _tmp93 = Scalar(1.0) / (_tmp91);
  const Scalar _tmp94 = _tmp89 * _tmp93;
  const Scalar _tmp95 = _tmp94 * (_tmp47 * _tmp63 - _tmp62 - _tmp76 * _tmp92);
  ...
  const Scalar _tmp100 = _tmp57 * _tmp58;
  const Scalar _tmp101 = _tmp19 + Scalar(1.7965602546229);
  const Scalar _tmp102 = _tmp29 + Scalar(-4.83288938413423);
  ...
  const Scalar _tmp110 = _tmp108 * _tmp90;
  const Scalar _tmp111 = Scalar(1.0) * _tmp69;
  const Scalar _tmp112 = _tmp111 * _tmp75 - Scalar(1.0) * _tmp67;
  const Scalar _tmp113 = _tmp94 * (-_tmp112 * _tmp92 - Scalar(1.0) * _tmp63);
  ...
  const Scalar _tmp119 = fh1 * (-_tmp104 * _tmp28 + _tmp116 * _tmp18);
  const Scalar _tmp120 = -_tmp105 * _tmp61 * (_tmp100 * _tmp99 + _tmp96 * _tmp97 + Scalar(1.0)) -
                         _tmp106 * _tmp61 * (-_tmp100 * _tmp109 + _tmp110 * _tmp86) -
                         _tmp117 * _tmp61 * (_tmp100 * _tmp115 + _tmp114 * _tmp97) -
                         _tmp119 * _tmp61 * (-_tmp100 * _tmp118 * _tmp87 + _tmp118 * _tmp86);
  const Scalar _tmp121 = Scalar(1.0) / (_tmp120);
  const Scalar _tmp122 = _tmp72 + _tmp78;
  const Scalar _tmp123 = _tmp122 * _tmp75;
  const Scalar _tmp124 = Scalar(1.0) / (-_tmp123 + _tmp74 - _tmp81);
  const Scalar _tmp125 = _tmp122 * _tmp124;
  const Scalar _tmp126 = _tmp88 * _tmp90;
  const Scalar _tmp127 = -_tmp111 + _tmp113 * _tmp125 - _tmp114 * _tmp126;
  const Scalar _tmp128 = Scalar(1.0) * _tmp73;
  const Scalar _tmp129 = Scalar(1.0) * _tmp124;
  const Scalar _tmp130 = _tmp125 * _tmp95 - _tmp126 * _tmp96 + _tmp70;
  const Scalar _tmp131 = _tmp37 * fh1;
  const Scalar _tmp132 = -_tmp116 * _tmp131 - Scalar(5.1796800000000003) * _tmp24 - _tmp28 * fv1;
  const Scalar _tmp133 = _tmp123 * _tmp129 + Scalar(1.0);
  const Scalar _tmp134 = _tmp129 * _tmp75;
  const Scalar _tmp135 = _tmp104 * _tmp131 + Scalar(5.1796800000000003) * _tmp12 + _tmp18 * fv1;
  const Scalar _tmp136 = _tmp122 * _tmp73;
  const Scalar _tmp137 = _tmp129 * _tmp94;
  const Scalar _tmp138 = -_tmp118 * _tmp88 + _tmp122 * _tmp137;
  const Scalar _tmp139 = _tmp107 * _tmp124;
  const Scalar _tmp140 = -_tmp108 * _tmp126 - _tmp122 * _tmp139 + _tmp72;
  const Scalar _tmp141 = std::asinh(
      _tmp121 * (Scalar(1.0) * _tmp105 * (-_tmp128 * _tmp130 + _tmp129 * _tmp95) +
                 Scalar(1.0) * _tmp106 * (-_tmp107 * _tmp129 - _tmp128 * _tmp140 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp117 * (_tmp113 * _tmp129 - _tmp127 * _tmp128) +
                 Scalar(1.0) * _tmp119 * (-_tmp128 * _tmp138 + _tmp137) +
                 Scalar(1.0) * _tmp132 * (-_tmp128 * _tmp133 + _tmp134) +
  ...
  const Scalar _tmp144 = _tmp105 * _tmp58 * _tmp99 - _tmp106 * _tmp109 * _tmp58 +
                         _tmp115 * _tmp117 * _tmp58 - _tmp143 * _tmp58 * _tmp87;
  const Scalar _tmp145 = Scalar(1.0) / (_tmp144);
  const Scalar _tmp146 = _tmp129 * _tmp135;
  const Scalar _tmp147 =
      std::asinh(_tmp145 * (_tmp105 * _tmp130 * _tmp73 + _tmp106 * _tmp140 * _tmp73 +
                            _tmp117 * _tmp127 * _tmp73 + _tmp119 * _tmp138 * _tmp73 +
                            _tmp132 * _tmp133 * _tmp73 - _tmp136 * _tmp146));
  const Scalar _tmp148 = Scalar(9.6622558468725703) * _tmp144;
  const Scalar _tmp149 =
      _tmp105 * _tmp90 * _tmp96 + _tmp106 * _tmp110 + _tmp114 * _tmp117 * _tmp90 + _tmp143;
  const Scalar _tmp150 = Scalar(1.0) / (_tmp149);
  const Scalar _tmp151 = std::asinh(_tmp150 * (-_tmp105 * _tmp124 * _tmp95 + _tmp106 * _tmp139 -
                                               _tmp113 * _tmp117 * _tmp124 - _tmp119 * _tmp137 -
                                               _tmp132 * _tmp134 + _tmp146));
               ...
               (-_tmp147 * _tmp148 -
                Scalar(8.3885017487099702) *
                    std::sqrt(Scalar(
                        ...
                        std::pow(Scalar(-Scalar(0.11921079949155229) * _tmp50 - 1),
                                 Scalar(2))))))) +
