...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl20(
  ...
  const Scalar _tmp60 = _tmp32 + _tmp36;
  const Scalar _tmp61 = _tmp41 * _tmp45;
  ...
  const Scalar _tmp73 = -_tmp58 * _tmp72 + _tmp62 * _tmp70;
  const Scalar _tmp74 = Scalar(1.0) / (_tmp58 * _tmp71 - _tmp70);
  const Scalar _tmp75 = _tmp46 * _tmp58 - _tmp61;
  const Scalar _tmp76 = _tmp74 * _tmp75;
  const Scalar _tmp77 = -_tmp46 * _tmp59 + _tmp60 * _tmp61 - _tmp73 * _tmp76;
  const Scalar _tmp78 =
      std::sqrt(Scalar(std::pow(_tmp52, Scalar(2)) + std::pow(_tmp57, Scalar(2))));
  const Scalar _tmp79 = Scalar(1.0) / (_tmp78);
  const Scalar _tmp80 = _tmp53 * _tmp78;
  const Scalar _tmp81 = _tmp80 * (_tmp50 * _tmp57 * _tmp79 - _tmp52 * _tmp55 * _tmp79);
  const Scalar _tmp82 = _tmp63 * _tmp71 - _tmp66 * _tmp70 + _tmp71 * _tmp81;
  const Scalar _tmp83 = _tmp39 * _tmp46 - _tmp42 * _tmp61 + _tmp46 * _tmp81 - _tmp76 * _tmp82;
  const Scalar _tmp84 = Scalar(1.0) / (_tmp83);
  const Scalar _tmp85 = Scalar(1.0) * _tmp84;
  const Scalar _tmp86 = -_tmp62 * _tmp71 + _tmp72;
  const Scalar _tmp87 = Scalar(1.0) * _tmp55;
  const Scalar _tmp88 = -_tmp87;
  const Scalar _tmp89 = Scalar(1.0) / (_tmp63 + _tmp88);
  const Scalar _tmp90 = Scalar(1.0) * _tmp50;
  const Scalar _tmp91 = -_tmp66 + _tmp90;
  const Scalar _tmp92 = _tmp89 * _tmp91;
  const Scalar _tmp93 = _tmp46 * _tmp48 - _tmp46 * _tmp60 - _tmp76 * _tmp86 - _tmp77 * _tmp92;
  const Scalar _tmp94 = _tmp84 * _tmp93;
  const Scalar _tmp95 = _tmp39 + _tmp88;
  const Scalar _tmp96 = _tmp92 * _tmp95;
  const Scalar _tmp97 = Scalar(1.0) / (-_tmp42 + _tmp90 - _tmp96);
  const Scalar _tmp98 = Scalar(1.0) * _tmp97;
  const Scalar _tmp99 = _tmp95 * _tmp98;
  const Scalar _tmp100 = -_tmp77 * _tmp85 + _tmp94 * _tmp99;
  const Scalar _tmp101 = Scalar(1.0) * _tmp89;
  const Scalar _tmp102 = _tmp94 * _tmp98;
  const Scalar _tmp103 = _tmp19 + Scalar(1.7965602546229);
  const Scalar _tmp104 = _tmp29 + Scalar(-4.83288938413423);
  ...
  const Scalar _tmp108 = fh1 * (-_tmp106 * _tmp28 + _tmp107 * _tmp18);
  const Scalar _tmp109 = Scalar(1.0) * _tmp74;
  const Scalar _tmp110 = _tmp101 * _tmp73 * _tmp74 * _tmp91 - _tmp109 * _tmp86;
  const Scalar _tmp111 = Scalar(1.0) / (_tmp93);
  const Scalar _tmp112 = _tmp111 * _tmp83;
  const Scalar _tmp113 = _tmp94 * (-_tmp109 * _tmp82 - _tmp110 * _tmp112);
  const Scalar _tmp114 = _tmp95 * _tmp97;
  const Scalar _tmp115 = _tmp110 + _tmp113;
  const Scalar _tmp116 = _tmp111 * _tmp77;
  const Scalar _tmp117 = -_tmp109 * _tmp73 + _tmp113 * _tmp114 - _tmp115 * _tmp116;
  const Scalar _tmp118 = _tmp107 * fh1;
  const Scalar _tmp119 = _tmp92 * _tmp98;
  const Scalar _tmp120 = _tmp96 * _tmp98 + Scalar(1.0);
  const Scalar _tmp121 = _tmp37 * fh1;
  const Scalar _tmp122 = -_tmp107 * _tmp121 - Scalar(5.1796800000000003) * _tmp25 - _tmp28 * fv1;
  const Scalar _tmp123 = _tmp106 * _tmp121 + Scalar(5.1796800000000003) * _tmp11 + _tmp18 * fv1;
  ...
  const Scalar _tmp128 = _tmp89 * (-_tmp116 * _tmp127 - _tmp126 * _tmp95 + _tmp88);
  const Scalar _tmp129 = _tmp58 * _tmp74;
  const Scalar _tmp130 = _tmp129 * _tmp73 + _tmp59;
  const Scalar _tmp131 = _tmp129 * _tmp86 - _tmp130 * _tmp92 - _tmp48;
  const Scalar _tmp132 = _tmp94 * (-_tmp112 * _tmp131 + _tmp129 * _tmp82 - _tmp81);
  const Scalar _tmp133 = _tmp131 + _tmp132;
  const Scalar _tmp134 = _tmp114 * _tmp132 - _tmp116 * _tmp133 + _tmp130;
  const Scalar _tmp135 = _tmp106 * fh1;
  const Scalar _tmp136 = _tmp111 * _tmp46;
  const Scalar _tmp137 = _tmp111 * _tmp75;
  const Scalar _tmp138 = -_tmp115 * _tmp137 + Scalar(1.0);
  const Scalar _tmp139 = _tmp71 * _tmp74;
  const Scalar _tmp140 = _tmp109 * _tmp75 * _tmp84;
  const Scalar _tmp141 = _tmp111 * _tmp127;
  const Scalar _tmp142 = -_tmp133 * _tmp137 - _tmp58;
  const Scalar _tmp143 = -_tmp108 * _tmp80 * (-_tmp140 * _tmp71 + _tmp46 * _tmp85) -
                         _tmp118 * _tmp80 * (_tmp115 * _tmp136 + _tmp138 * _tmp139) -
                         _tmp124 * _tmp80 * (_tmp141 * _tmp46 - _tmp141 * _tmp71 * _tmp76) -
                         _tmp135 * _tmp80 * (_tmp133 * _tmp136 + _tmp139 * _tmp142 + Scalar(1.0));
  const Scalar _tmp144 = Scalar(1.0) / (_tmp143);
  const Scalar _tmp145 = std::asinh(
      _tmp144 * (Scalar(1.0) * _tmp108 * (-_tmp100 * _tmp101 + _tmp102) +
                 Scalar(1.0) * _tmp118 * (-_tmp101 * _tmp117 + _tmp113 * _tmp98) +
                 Scalar(1.0) * _tmp122 * (-_tmp101 * _tmp120 + _tmp119) +
                 Scalar(1.0) * _tmp123 * (_tmp89 * _tmp99 - _tmp98) +
                 Scalar(1.0) * _tmp124 * (-_tmp125 * _tmp98 - Scalar(1.0) * _tmp128 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp135 * (-_tmp101 * _tmp134 + _tmp132 * _tmp98)));
  const Scalar _tmp146 = Scalar(9.6622558468725703) * _tmp143;
  const Scalar _tmp147 = _tmp124 * _tmp141;
  const Scalar _tmp148 = -_tmp108 * _tmp140 + _tmp118 * _tmp138 * _tmp74 +
                         _tmp135 * _tmp142 * _tmp74 - _tmp147 * _tmp76;
  const Scalar _tmp149 = Scalar(1.0) / (_tmp148);
  const Scalar _tmp150 = _tmp123 * _tmp98;
  const Scalar _tmp151 =
      std::asinh(_tmp149 * (_tmp100 * _tmp108 * _tmp89 + _tmp117 * _tmp118 * _tmp89 +
                            _tmp120 * _tmp122 * _tmp89 + _tmp124 * _tmp128 +
                            _tmp134 * _tmp135 * _tmp89 - _tmp150 * _tmp89 * _tmp95));
  const Scalar _tmp152 = Scalar(9.6622558468725703) * _tmp148;
  const Scalar _tmp153 =
      _tmp108 * _tmp85 + _tmp111 * _tmp115 * _tmp118 + _tmp111 * _tmp133 * _tmp135 + _tmp147;
  const Scalar _tmp154 = Scalar(1.0) / (_tmp153);
  const Scalar _tmp155 =
      std::asinh(_tmp154 * (-_tmp102 * _tmp108 - _tmp113 * _tmp118 * _tmp97 - _tmp119 * _tmp122 +
                            _tmp124 * _tmp126 - _tmp132 * _tmp135 * _tmp97 + _tmp150));
  ...
  _res(1, 0) =
      -_tmp146 *
          (Scalar(0.876505537412406) * _tmp144 + std::cosh(Scalar(1.0) * _tmp145) -
           std::cosh(
                ...
                Scalar(8.3196563720703107) *
                    std::sqrt(Scalar(
                        ...
                        Scalar(0.057067943527034905) *
                            std::pow(Scalar(-Scalar(0.50315118477277876) * _tmp67 - 1),
                                     Scalar(2))))))) +
      _tmp62 + position_vector(2, 0);
  _res(3, 0) =
      -_tmp156 *
          (Scalar(0.86564762886483004) * _tmp154 + std::cosh(Scalar(1.0) * _tmp155) -
           std::cosh(Scalar(0.1034955) * _tmp154 *
                     (-_tmp155 * _tmp156 -
                      Scalar(4.7744369927459998) *
                          std::sqrt(Scalar(
                              std::pow(Scalar(1 - Scalar(0.2094487793051498) * _tmp40), Scalar(2)) +
                              Scalar(0.32387954179207445) *
                                  std::pow(Scalar(1 - Scalar(0.36803241838814449) * _tmp43),
                                           Scalar(2))))))) +
