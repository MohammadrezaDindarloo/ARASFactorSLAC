...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl5(
  ...
  const Scalar _tmp37 = Scalar(0.20999999999999999) * _tmp10 + Scalar(0.20999999999999999) * _tmp13;
  ...
  const Scalar _tmp52 = _tmp51 * (_tmp41 * _tmp45 * _tmp50 - _tmp43 * _tmp46 * _tmp50);
  const Scalar _tmp53 = _tmp23 + _tmp40;
  const Scalar _tmp54 = _tmp15 + _tmp18;
  const Scalar _tmp55 = _tmp54 + _tmp6;
  const Scalar _tmp56 = _tmp55 + position_vector(1, 0);
  const Scalar _tmp57 = _tmp56 + Scalar(-4.7744369927459998);
  const Scalar _tmp58 = _tmp53 + position_vector(0, 0);
  ...
  const Scalar _tmp63 = _tmp52 * _tmp62 - _tmp53 * _tmp61 + _tmp55 * _tmp62;
  ...
  const Scalar _tmp70 = _tmp61 * _tmp68 - _tmp62 * _tmp69;
  ...
  const Scalar _tmp93 = -_tmp48 * _tmp88 - _tmp70 * _tmp92 + _tmp89 * _tmp90;
  const Scalar _tmp94 = -_tmp77 * _tmp93 - _tmp78 * _tmp92 - _tmp87 * _tmp89 + _tmp88;
  const Scalar _tmp95 = Scalar(1.0) / (_tmp94);
  const Scalar _tmp96 = _tmp52 * _tmp87 - _tmp63 * _tmp92 + _tmp80 * _tmp87 - _tmp83 * _tmp90;
  const Scalar _tmp97 = _tmp95 * _tmp96;
  const Scalar _tmp98 = Scalar(1.0) / (_tmp96);
  const Scalar _tmp99 = _tmp94 * _tmp98;
  const Scalar _tmp100 = _tmp99 * (-_tmp52 + _tmp63 * _tmp65 - _tmp79 * _tmp97);
  const Scalar _tmp101 = _tmp100 + _tmp79;
  const Scalar _tmp102 = _tmp91 * _tmp95;
  const Scalar _tmp103 = -_tmp101 * _tmp102 - _tmp48;
  const Scalar _tmp104 = _tmp62 * _tmp64;
  const Scalar _tmp105 = _tmp87 * _tmp95;
  const Scalar _tmp106 = _tmp32 + Scalar(1.9874742031097401);
  const Scalar _tmp107 = _tmp21 + Scalar(8.3196563720703107);
  ...
  const Scalar _tmp113 = -_tmp111 * _tmp78 + _tmp112 * _tmp77;
  ...
  const Scalar _tmp125 = fh1 * (-_tmp109 * _tmp20 + _tmp117 * _tmp31);
  const Scalar _tmp126 = -_tmp110 * _tmp51 * (_tmp101 * _tmp105 + _tmp103 * _tmp104 + Scalar(1.0)) -
                         _tmp118 * _tmp51 * (_tmp104 * _tmp116 + _tmp105 * _tmp115) -
                         _tmp119 * _tmp51 * (-_tmp122 * _tmp123 + _tmp122 * _tmp87) -
                         _tmp125 * _tmp51 * (-_tmp123 * _tmp124 + _tmp124 * _tmp87);
  const Scalar _tmp127 = Scalar(1.0) / (_tmp126);
  const Scalar _tmp128 = _tmp73 + _tmp80;
  const Scalar _tmp129 = _tmp128 * _tmp77;
  const Scalar _tmp130 = Scalar(1.0) / (-_tmp129 + _tmp75 - _tmp83);
  const Scalar _tmp131 = Scalar(1.0) * _tmp130;
  const Scalar _tmp132 = _tmp128 * _tmp130;
  const Scalar _tmp133 = _tmp93 * _tmp95;
  const Scalar _tmp134 = -_tmp112 + _tmp114 * _tmp132 - _tmp115 * _tmp133;
  const Scalar _tmp135 = Scalar(1.0) * _tmp74;
  const Scalar _tmp136 = _tmp100 * _tmp132 - _tmp101 * _tmp133 + _tmp71;
  const Scalar _tmp137 = _tmp39 * fh1;
  const Scalar _tmp138 = _tmp109 * _tmp137 + Scalar(5.1796800000000003) * _tmp27 + _tmp31 * fv1;
  const Scalar _tmp139 = _tmp128 * _tmp74;
  const Scalar _tmp140 = _tmp131 * _tmp99;
  const Scalar _tmp141 = -_tmp124 * _tmp93 + _tmp128 * _tmp140;
  const Scalar _tmp142 = _tmp120 * _tmp130;
  const Scalar _tmp143 = -_tmp121 * _tmp133 - _tmp128 * _tmp142 + _tmp73;
  const Scalar _tmp144 = _tmp129 * _tmp131 + Scalar(1.0);
  const Scalar _tmp145 = -_tmp117 * _tmp137 - Scalar(5.1796800000000003) * _tmp14 - _tmp20 * fv1;
  const Scalar _tmp146 = std::asinh(
      _tmp127 * (Scalar(1.0) * _tmp110 * (_tmp100 * _tmp131 - _tmp135 * _tmp136) +
                 Scalar(1.0) * _tmp118 * (_tmp114 * _tmp131 - _tmp134 * _tmp135) +
                 Scalar(1.0) * _tmp119 * (-_tmp120 * _tmp131 - _tmp135 * _tmp143 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp125 * (-_tmp135 * _tmp141 + _tmp140) +
                 Scalar(1.0) * _tmp138 * (_tmp131 * _tmp139 - _tmp131) +
                 Scalar(1.0) * _tmp145 * (_tmp131 * _tmp77 - _tmp135 * _tmp144)));
  const Scalar _tmp147 = Scalar(9.6622558468725703) * _tmp126;
  const Scalar _tmp148 = _tmp124 * _tmp125;
  const Scalar _tmp149 = _tmp119 * _tmp122;
  const Scalar _tmp150 =
      _tmp103 * _tmp110 * _tmp64 + _tmp116 * _tmp118 * _tmp64 - _tmp148 * _tmp92 - _tmp149 * _tmp92;
  const Scalar _tmp151 = Scalar(1.0) / (_tmp150);
  const Scalar _tmp152 = _tmp131 * _tmp138;
  const Scalar _tmp153 = _tmp145 * _tmp74;
  const Scalar _tmp154 =
      std::asinh(_tmp151 * (_tmp110 * _tmp136 * _tmp74 + _tmp118 * _tmp134 * _tmp74 +
                            _tmp119 * _tmp143 * _tmp74 + _tmp125 * _tmp141 * _tmp74 -
                            _tmp139 * _tmp152 + _tmp144 * _tmp153));
  const Scalar _tmp155 = Scalar(9.6622558468725703) * _tmp150;
  const Scalar _tmp156 = _tmp95 * fh1;
  const Scalar _tmp157 =
      _tmp101 * _tmp109 * _tmp156 + _tmp115 * _tmp117 * _tmp156 + _tmp148 + _tmp149;
  const Scalar _tmp158 = Scalar(1.0) / (_tmp157);
  const Scalar _tmp159 = std::asinh(
      _tmp158 * (-_tmp100 * _tmp110 * _tmp130 - _tmp114 * _tmp118 * _tmp130 + _tmp119 * _tmp142 -
                 _tmp125 * _tmp140 - _tmp131 * _tmp153 * _tmp76 + _tmp152));
  ...
  _res(1, 0) =
      -_tmp147 *
          (Scalar(0.86627065637365697) * _tmp127 + std::cosh(Scalar(1.0) * _tmp146) -
           std::cosh(
  ...
  _res(2, 0) =
      -_tmp155 *
          (Scalar(0.86564762886483004) * _tmp151 + std::cosh(Scalar(1.0) * _tmp154) -
  ...
  _res(3, 0) =
      -_tmp160 *
          (Scalar(0.876505537412406) * _tmp158 + std::cosh(Scalar(1.0) * _tmp159) -
           std::cosh(
