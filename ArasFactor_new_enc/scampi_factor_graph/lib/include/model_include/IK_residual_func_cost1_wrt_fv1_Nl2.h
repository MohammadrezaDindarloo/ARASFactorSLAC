...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1WrtFv1Nl2(
  ...
  const Scalar _tmp38 = _tmp13 + _tmp7;
  ...
  const Scalar _tmp49 = _tmp40 + Scalar(-4.7744369927459998);
  const Scalar _tmp50 = _tmp37 + Scalar(-2.7171519410699099);
  const Scalar _tmp51 = Scalar(1.0) / (_tmp50);
  const Scalar _tmp52 = _tmp49 * _tmp51;
  const Scalar _tmp53 = Scalar(0.20999999999999999) * _tmp15 + Scalar(0.20999999999999999) * _tmp16;
  const Scalar _tmp54 = -Scalar(0.010999999999999999) * _tmp29 -
  ...
  const Scalar _tmp62 = -_tmp53;
  const Scalar _tmp63 = _tmp56 + _tmp62;
  const Scalar _tmp64 = _tmp13 + _tmp19 + _tmp8;
  ...
  const Scalar _tmp72 = _tmp52 * _tmp57;
  const Scalar _tmp73 = _tmp69 * _tmp70;
  const Scalar _tmp74 = _tmp63 * _tmp71 - _tmp72 * _tmp73;
  const Scalar _tmp75 = Scalar(1.0) / (_tmp52 * _tmp73 - _tmp71);
  const Scalar _tmp76 = _tmp48 * _tmp52 - _tmp61;
  const Scalar _tmp77 = _tmp75 * _tmp76;
  const Scalar _tmp78 = -_tmp52 * _tmp58 + _tmp60 * _tmp61 - _tmp74 * _tmp77;
  ...
  const Scalar _tmp84 = _tmp57 * _tmp73 - _tmp63 * _tmp73;
  const Scalar _tmp85 = -_tmp48 * _tmp60 + _tmp58 - _tmp77 * _tmp84 - _tmp78 * _tmp83;
  const Scalar _tmp86 = Scalar(1.0) / (_tmp85);
  const Scalar _tmp87 =
      std::sqrt(Scalar(std::pow(_tmp49, Scalar(2)) + std::pow(_tmp50, Scalar(2))));
  const Scalar _tmp88 = Scalar(1.0) / (_tmp87);
  const Scalar _tmp89 = _tmp51 * _tmp87;
  const Scalar _tmp90 = _tmp89 * (_tmp36 * _tmp49 * _tmp88 - _tmp39 * _tmp50 * _tmp88);
  const Scalar _tmp91 = _tmp64 * _tmp73 - _tmp67 * _tmp71 + _tmp73 * _tmp90;
  const Scalar _tmp92 = _tmp52 * _tmp75;
  const Scalar _tmp93 = _tmp72 + _tmp74 * _tmp92;
  const Scalar _tmp94 = -_tmp57 - _tmp83 * _tmp93 + _tmp84 * _tmp92;
  const Scalar _tmp95 = -_tmp41 * _tmp61 + _tmp44 * _tmp48 + _tmp48 * _tmp90 - _tmp77 * _tmp91;
  ...
  const Scalar _tmp101 = -_tmp100 * _tmp76 - _tmp52;
  const Scalar _tmp102 = _tmp73 * _tmp75;
  const Scalar _tmp103 = _tmp33 + Scalar(1.9874742031097401);
  const Scalar _tmp104 = _tmp22 + Scalar(8.3196563720703107);
  ...
  const Scalar _tmp112 = _tmp89 * (_tmp110 * _tmp48 - _tmp111 * _tmp73);
  const Scalar _tmp113 = Scalar(1.0) * _tmp97;
  const Scalar _tmp114 = _tmp104 * _tmp105;
  const Scalar _tmp115 = fh1 * (-_tmp106 * _tmp21 + _tmp114 * _tmp32);
  const Scalar _tmp116 = Scalar(1.0) * _tmp75;
  const Scalar _tmp117 = _tmp116 * _tmp74;
  const Scalar _tmp118 = -_tmp116 * _tmp84 + _tmp117 * _tmp83;
  const Scalar _tmp119 = _tmp98 * (-_tmp116 * _tmp91 - _tmp118 * _tmp96);
  ...
  const Scalar _tmp123 = -_tmp107 * _tmp89 * (_tmp100 * _tmp48 + _tmp101 * _tmp102 + Scalar(1.0)) -
                         _tmp108 * _tmp112 -
                         _tmp115 * _tmp89 * (_tmp113 * _tmp48 - _tmp113 * _tmp73 * _tmp77) -
                         _tmp122 * _tmp89 * (_tmp102 * _tmp121 + _tmp120 * _tmp48);
  const Scalar _tmp124 = Scalar(1.0) / (_tmp123);
  const Scalar _tmp125 = _tmp44 + _tmp80;
  ...
  const Scalar _tmp129 = -_tmp117 + _tmp119 * _tmp128 - _tmp120 * _tmp78;
  const Scalar _tmp130 = Scalar(1.0) * _tmp81;
  const Scalar _tmp131 = Scalar(1.0) * _tmp127;
  const Scalar _tmp132 = fh1 * (_tmp59 + _tmp62);
  const Scalar _tmp133 = -_tmp114 * _tmp132 - Scalar(5.1796800000000003) * _tmp17 - _tmp21 * fv1;
  const Scalar _tmp134 = _tmp131 * _tmp83;
  const Scalar _tmp135 = _tmp126 * _tmp131 + Scalar(1.0);
  const Scalar _tmp136 = -Scalar(1.0) * _tmp130 * _tmp135 + Scalar(1.0) * _tmp134;
  const Scalar _tmp137 = _tmp106 * _tmp132 + Scalar(5.1796800000000003) * _tmp27 + _tmp32 * fv1;
  const Scalar _tmp138 = _tmp125 * _tmp81;
  const Scalar _tmp139 = Scalar(1.0) * _tmp131 * _tmp138 - Scalar(1.0) * _tmp131;
  const Scalar _tmp140 = -_tmp100 * _tmp78 + _tmp128 * _tmp99 + _tmp93;
  const Scalar _tmp141 = _tmp109 * _tmp127;
  const Scalar _tmp142 = _tmp81 * (-_tmp110 * _tmp78 - _tmp125 * _tmp141 + _tmp80);
  const Scalar _tmp143 = -Scalar(1.0) * _tmp141 - Scalar(1.0) * _tmp142 + Scalar(1.0);
  const Scalar _tmp144 = _tmp131 * _tmp98;
  const Scalar _tmp145 = -_tmp113 * _tmp78 + _tmp125 * _tmp144;
  const Scalar _tmp146 = Scalar(1.0) * _tmp107 * (-_tmp130 * _tmp140 + _tmp131 * _tmp99) +
                         _tmp108 * _tmp143 +
                         Scalar(1.0) * _tmp115 * (-_tmp130 * _tmp145 + _tmp144) +
                         Scalar(1.0) * _tmp122 * (_tmp119 * _tmp131 - _tmp129 * _tmp130) +
      ...
      Scalar(4.7744369927459998) *
          std::sqrt(
              Scalar(Scalar(0.32387954179207445) *
                         std::pow(Scalar(1 - Scalar(0.36803241838814449) * _tmp37), Scalar(2)) +
  ...
  const Scalar _tmp152 = Scalar(9.6622558468725703) * _tmp112;
  const Scalar _tmp153 = std::pow(_tmp123, Scalar(-2));
  const Scalar _tmp154 = _tmp18 + _tmp38;
  const Scalar _tmp155 = _tmp112 * _tmp153;
  const Scalar _tmp156 =
      (_tmp124 * (_tmp136 * _tmp154 + _tmp139 * _tmp32 - _tmp143) - _tmp146 * _tmp155) /
  ...
  const Scalar _tmp160 =
      _tmp101 * _tmp107 * _tmp75 + _tmp121 * _tmp122 * _tmp75 - _tmp158 * _tmp77 - _tmp159 * _tmp77;
  const Scalar _tmp161 = Scalar(1.0) / (_tmp160);
  const Scalar _tmp162 = _tmp131 * _tmp137;
  const Scalar _tmp163 = _tmp135 * _tmp81;
  const Scalar _tmp164 = _tmp107 * _tmp140 * _tmp81 + _tmp108 * _tmp142 +
                         _tmp115 * _tmp145 * _tmp81 + _tmp122 * _tmp129 * _tmp81 +
  ...
  const Scalar _tmp172 = _tmp131 * _tmp32;
  const Scalar _tmp173 =
      (_tmp161 * (-_tmp138 * _tmp172 - _tmp142 + _tmp154 * _tmp163) - _tmp164 * _tmp171) /
  ...
  const Scalar _tmp177 = -_tmp107 * _tmp127 * _tmp99 + _tmp108 * _tmp141 - _tmp115 * _tmp144 -
                         _tmp119 * _tmp122 * _tmp127 - _tmp133 * _tmp134 + _tmp162;
  const Scalar _tmp178 = _tmp100 * _tmp107 + _tmp120 * _tmp122 + _tmp158 + _tmp159;
  ...
  const Scalar _tmp188 = (_tmp177 * _tmp187 + _tmp179 * (-_tmp134 * _tmp154 - _tmp141 + _tmp172)) /
  ...
  _res(1, 0) =
      -_tmp148 *
          (-Scalar(0.86564762886483004) * _tmp155 + Scalar(1.0) * _tmp156 * std::sinh(_tmp157) -
           (-Scalar(0.1034955) * _tmp149 * _tmp155 +
            _tmp150 * (-_tmp147 * _tmp152 - _tmp148 * _tmp156)) *
               std::sinh(_tmp151)) -
      _tmp152 * (Scalar(0.86564762886483004) * _tmp124 - std::cosh(_tmp151) + std::cosh(_tmp157));
  _res(2, 0) =
      -_tmp166 *
          (-Scalar(0.876505537412406) * _tmp171 + Scalar(1.0) * _tmp173 * std::sinh(_tmp176) -
           (-Scalar(0.1034955) * _tmp167 * _tmp171 +
            _tmp168 * (-_tmp165 * _tmp175 - _tmp166 * _tmp173)) *
               std::sinh(_tmp169)) -
      _tmp175 * (Scalar(0.876505537412406) * _tmp161 - std::cosh(_tmp169) + std::cosh(_tmp176));
  _res(3, 0) =
