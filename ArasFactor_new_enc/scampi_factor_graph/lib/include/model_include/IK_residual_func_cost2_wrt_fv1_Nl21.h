...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2WrtFv1Nl21(
  ...
  const Scalar _tmp60 = _tmp34 + _tmp38;
  const Scalar _tmp61 = _tmp43 * _tmp47;
  const Scalar _tmp62 = -_tmp48 * _tmp59 + _tmp60 * _tmp61;
  const Scalar _tmp63 = Scalar(1.0) / (_tmp48 * _tmp58 - _tmp61);
  const Scalar _tmp64 = _tmp58 * _tmp63;
  const Scalar _tmp65 = _tmp59 + _tmp62 * _tmp64;
  ...
  const Scalar _tmp70 = _tmp68 * (-_tmp44 + _tmp69);
  const Scalar _tmp71 = _tmp39 * _tmp48 - _tmp48 * _tmp60;
  const Scalar _tmp72 = -_tmp39 + _tmp64 * _tmp71 - _tmp65 * _tmp70;
  const Scalar _tmp73 =
      std::sqrt(Scalar(std::pow(_tmp52, Scalar(2)) + std::pow(_tmp57, Scalar(2))));
  const Scalar _tmp74 = Scalar(1.0) / (_tmp73);
  const Scalar _tmp75 = _tmp53 * _tmp73;
  const Scalar _tmp76 = _tmp75 * (_tmp50 * _tmp57 * _tmp74 - _tmp52 * _tmp55 * _tmp74);
  const Scalar _tmp77 = _tmp41 * _tmp48 - _tmp44 * _tmp61 + _tmp48 * _tmp76;
  const Scalar _tmp78 = _tmp28 + _tmp54;
  const Scalar _tmp79 = _tmp78 + position_vector(1, 0);
  const Scalar _tmp80 = _tmp79 + Scalar(8.3196563720703107);
  const Scalar _tmp81 = _tmp49 + _tmp6;
  ...
  const Scalar _tmp89 = _tmp76 * _tmp86 - _tmp77 * _tmp88 + _tmp78 * _tmp86 - _tmp81 * _tmp85;
  const Scalar _tmp90 = _tmp36 - _tmp37;
  const Scalar _tmp91 = _tmp35 + _tmp90;
  const Scalar _tmp92 = -_tmp59 * _tmp86 - _tmp62 * _tmp88 + _tmp85 * _tmp91;
  const Scalar _tmp93 = _tmp39 * _tmp86 - _tmp70 * _tmp92 - _tmp71 * _tmp88 - _tmp86 * _tmp91;
  ...
  const Scalar _tmp98 = _tmp97 * (_tmp64 * _tmp77 - _tmp72 * _tmp95 - _tmp76);
  const Scalar _tmp99 = _tmp67 + _tmp78;
  const Scalar _tmp100 = _tmp70 * _tmp99;
  const Scalar _tmp101 = Scalar(1.0) / (-_tmp100 + _tmp69 - _tmp81);
  const Scalar _tmp102 = _tmp101 * _tmp99;
  const Scalar _tmp103 = _tmp72 + _tmp98;
  const Scalar _tmp104 = _tmp92 * _tmp94;
  const Scalar _tmp105 = _tmp102 * _tmp98 - _tmp103 * _tmp104 + _tmp65;
  const Scalar _tmp106 = Scalar(1.0) * _tmp68;
  ...
  const Scalar _tmp113 = _tmp107 * _tmp97;
  const Scalar _tmp114 = Scalar(1.0) * _tmp96;
  const Scalar _tmp115 = _tmp113 * _tmp99 - _tmp114 * _tmp92;
  const Scalar _tmp116 = _tmp109 * _tmp110;
  const Scalar _tmp117 = fh1 * (-_tmp111 * _tmp29 + _tmp116 * _tmp18);
  const Scalar _tmp118 = Scalar(1.0) * _tmp63;
  const Scalar _tmp119 = _tmp118 * _tmp62;
  const Scalar _tmp120 = -_tmp118 * _tmp71 + _tmp119 * _tmp70;
  const Scalar _tmp121 = _tmp97 * (-_tmp118 * _tmp77 - _tmp120 * _tmp95);
  const Scalar _tmp122 = _tmp120 + _tmp121;
  const Scalar _tmp123 = _tmp102 * _tmp121 - _tmp104 * _tmp122 - _tmp119;
  const Scalar _tmp124 = _tmp116 * fh1;
  const Scalar _tmp125 = fh1 * (_tmp34 + _tmp90);
  const Scalar _tmp126 = _tmp111 * _tmp125 + Scalar(5.1796800000000003) * _tmp12 + _tmp18 * fv1;
  const Scalar _tmp127 = _tmp68 * _tmp99;
  const Scalar _tmp128 = Scalar(1.0) * _tmp107 * _tmp127 - Scalar(1.0) * _tmp107;
  const Scalar _tmp129 = -_tmp116 * _tmp125 - Scalar(5.1796800000000003) * _tmp24 - _tmp29 * fv1;
  const Scalar _tmp130 = _tmp107 * _tmp70;
  const Scalar _tmp131 = _tmp68 * (_tmp100 * _tmp107 + Scalar(1.0));
  ...
  const Scalar _tmp138 = _tmp68 * (-_tmp135 * _tmp99 - _tmp137 * _tmp92 + _tmp67);
  const Scalar _tmp139 = -Scalar(1.0) * _tmp107 * _tmp134 - Scalar(1.0) * _tmp138 + Scalar(1.0);
  const Scalar _tmp140 = Scalar(1.0) * _tmp112 * (-_tmp105 * _tmp106 + _tmp107 * _tmp98) +
                         Scalar(1.0) * _tmp117 * (-_tmp106 * _tmp115 + _tmp113) +
                         Scalar(1.0) * _tmp124 * (-_tmp106 * _tmp123 + _tmp107 * _tmp121) +
                         _tmp126 * _tmp128 + _tmp129 * _tmp132 + _tmp133 * _tmp139;
  const Scalar _tmp141 = _tmp48 * _tmp63;
  const Scalar _tmp142 = _tmp87 * _tmp94;
  const Scalar _tmp143 = _tmp136 * _tmp142;
  const Scalar _tmp144 = _tmp75 * (_tmp137 * _tmp86 - _tmp141 * _tmp143);
  const Scalar _tmp145 = -_tmp122 * _tmp142 + Scalar(1.0);
  const Scalar _tmp146 = _tmp86 * _tmp94;
  const Scalar _tmp147 = -_tmp103 * _tmp142 - _tmp58;
  const Scalar _tmp148 = _tmp118 * _tmp87 * _tmp96;
  const Scalar _tmp149 = -_tmp112 * _tmp75 * (_tmp103 * _tmp146 + _tmp141 * _tmp147 + Scalar(1.0)) -
                         _tmp117 * _tmp75 * (_tmp114 * _tmp86 - _tmp148 * _tmp48) -
                         _tmp124 * _tmp75 * (_tmp122 * _tmp146 + _tmp141 * _tmp145) -
                         _tmp133 * _tmp144;
  ...
  const Scalar _tmp155 = _tmp25 + _tmp27 + _tmp54;
  const Scalar _tmp156 =
      (-_tmp140 * _tmp154 + _tmp150 * (_tmp128 * _tmp18 + _tmp132 * _tmp155 - _tmp139)) /
  ...
  const Scalar _tmp161 = Scalar(9.6622558468725703) * _tmp144;
  const Scalar _tmp162 = _tmp143 * _tmp63;
  const Scalar _tmp163 = _tmp112 * _tmp147 * _tmp63 - _tmp117 * _tmp148 +
                         _tmp124 * _tmp145 * _tmp63 - _tmp133 * _tmp162;
  const Scalar _tmp164 = Scalar(1.0) / (_tmp163);
  const Scalar _tmp165 = _tmp107 * _tmp126;
  const Scalar _tmp166 = _tmp105 * _tmp112 * _tmp68 + _tmp115 * _tmp117 * _tmp68 +
                         _tmp123 * _tmp124 * _tmp68 - _tmp127 * _tmp165 + _tmp129 * _tmp131 +
                         _tmp133 * _tmp138;
  ...
  const Scalar _tmp172 = _tmp107 * _tmp18;
  const Scalar _tmp173 =
      (_tmp164 * (-_tmp127 * _tmp172 + _tmp131 * _tmp155 - _tmp138) - _tmp166 * _tmp171) /
      std::sqrt(Scalar(std::pow(_tmp166, Scalar(2)) * _tmp170 + 1));
  ...
  const Scalar _tmp178 = -_tmp101 * _tmp112 * _tmp98 - _tmp101 * _tmp121 * _tmp124 -
                         _tmp113 * _tmp117 - _tmp129 * _tmp130 + _tmp133 * _tmp135 + _tmp165;
  const Scalar _tmp179 = _tmp103 * _tmp112 * _tmp94 + _tmp114 * _tmp117 +
                         _tmp122 * _tmp124 * _tmp94 + _tmp133 * _tmp137;
  ...
  const Scalar _tmp184 =
      ...
      Scalar(8.3196563720703107) *
          std::sqrt(
              Scalar(std::pow(Scalar(-Scalar(0.12019727201198747) * _tmp79 - 1), Scalar(2)) +
  ...
  const Scalar _tmp187 = Scalar(9.6622558468725703) * _tmp137;
  const Scalar _tmp188 = std::pow(_tmp179, Scalar(-2));
  const Scalar _tmp189 = _tmp137 * _tmp188;
  const Scalar _tmp190 = (_tmp178 * _tmp189 + _tmp180 * (-_tmp130 * _tmp155 - _tmp135 + _tmp172)) /
  ...
  _res(2, 0) = _tmp168 * (-Scalar(1.0) * _tmp173 * std::cosh(_tmp177) -
                          (-Scalar(0.1034955) * _tmp169 * _tmp171 +
                           _tmp175 * (-_tmp167 * _tmp174 - _tmp168 * _tmp173)) *
                              std::cosh(_tmp176)) +
               _tmp174 * (-std::sinh(_tmp176) - std::sinh(_tmp177));
