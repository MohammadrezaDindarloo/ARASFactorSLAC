...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl12(
  ...
  const Scalar _tmp42 = _tmp18 + _tmp30;
  const Scalar _tmp43 = _tmp42 + position_vector(1, 0) + Scalar(8.3885017487099702);
  const Scalar _tmp44 = _tmp11 + _tmp14;
  const Scalar _tmp45 = _tmp33 + _tmp44;
  const Scalar _tmp46 = _tmp45 + position_vector(0, 0) + Scalar(-2.5193355532036801);
  ...
  const Scalar _tmp50 = _tmp40 * _tmp48 + _tmp42 * _tmp48 - _tmp45 * _tmp49;
  const Scalar _tmp51 = _tmp32 * _tmp38;
  const Scalar _tmp52 = Scalar(1.0) / (_tmp48 * _tmp51 - _tmp49);
  const Scalar _tmp53 = _tmp29 * _tmp51 - _tmp41;
  const Scalar _tmp54 = _tmp52 * _tmp53;
  const Scalar _tmp55 = -_tmp16 * _tmp41 + _tmp26 * _tmp29 + _tmp29 * _tmp40 - _tmp50 * _tmp54;
  ...
  const Scalar _tmp60 = _tmp18 + _tmp25;
  const Scalar _tmp61 = _tmp60 + position_vector(1, 0) + Scalar(-4.7744369927459998);
  const Scalar _tmp62 = _tmp59 + position_vector(0, 0) + Scalar(-2.7171519410699099);
  ...
  const Scalar _tmp77 = -_tmp48 * _tmp76 + _tmp49 * _tmp71;
  const Scalar _tmp78 = Scalar(1.0) * _tmp31;
  const Scalar _tmp79 = Scalar(1.0) * _tmp34;
  const Scalar _tmp80 = (-_tmp45 + _tmp79) / (_tmp42 - _tmp78);
  const Scalar _tmp81 = -_tmp74 * _tmp75 + _tmp75 * _tmp77 * _tmp80;
  const Scalar _tmp82 = _tmp69 + _tmp72;
  const Scalar _tmp83 = _tmp29 * _tmp73 - _tmp29 * _tmp82 - _tmp54 * _tmp74 -
                        _tmp80 * (-_tmp29 * _tmp76 + _tmp41 * _tmp82 - _tmp54 * _tmp77);
  const Scalar _tmp84 = Scalar(1.0) / (_tmp83);
  const Scalar _tmp85 = _tmp55 * _tmp84;
  const Scalar _tmp86 = _tmp56 * _tmp83;
  const Scalar _tmp87 = _tmp81 + _tmp86 * (-_tmp50 * _tmp75 - _tmp81 * _tmp85);
  const Scalar _tmp88 = _tmp53 * _tmp84;
  const Scalar _tmp89 = -_tmp87 * _tmp88 + Scalar(1.0);
  const Scalar _tmp90 = _tmp48 * _tmp52;
  const Scalar _tmp91 = _tmp29 * _tmp84;
  const Scalar _tmp92 = _tmp39 * fh1;
  const Scalar _tmp93 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp94 = _tmp78 * _tmp80 + _tmp79;
  const Scalar _tmp95 = 0;
  const Scalar _tmp96 = _tmp51 * _tmp52;
  const Scalar _tmp97 = -_tmp73 + _tmp74 * _tmp96 - _tmp80 * (_tmp76 + _tmp77 * _tmp96);
  const Scalar _tmp98 = _tmp86 * (-_tmp40 + _tmp50 * _tmp96 - _tmp85 * _tmp97) + _tmp97;
  const Scalar _tmp99 = -_tmp51 - _tmp88 * _tmp98;
  const Scalar _tmp100 = _tmp52 * fh1;
  const Scalar _tmp101 = _tmp93 * _tmp95;
  const Scalar _tmp102 = _tmp57 * _tmp66;
  const Scalar _tmp103 = _tmp84 * fh1;

  // Output terms (1)
  Eigen::Matrix<Scalar, 4, 1> _res;

  _res(0, 0) = std::exp(-fh1);
  _res(1, 0) = std::exp(_tmp39 * _tmp66 * (_tmp29 * _tmp57 - _tmp57 * _tmp58) +
                        _tmp39 * _tmp93 * (_tmp29 * _tmp95 - _tmp58 * _tmp95) +
                        _tmp64 * _tmp92 * (_tmp87 * _tmp91 + _tmp89 * _tmp90) +
                        _tmp65 * _tmp92 * (_tmp90 * _tmp99 + _tmp91 * _tmp98 + Scalar(1.0)));
  _res(2, 0) = std::exp(-_tmp100 * _tmp64 * _tmp89 - _tmp100 * _tmp65 * _tmp99 + _tmp101 * _tmp54 +
                        _tmp102 * _tmp54);
  _res(3, 0) = std::exp(-_tmp101 - _tmp102 - _tmp103 * _tmp64 * _tmp87 - _tmp103 * _tmp65 * _tmp98);
