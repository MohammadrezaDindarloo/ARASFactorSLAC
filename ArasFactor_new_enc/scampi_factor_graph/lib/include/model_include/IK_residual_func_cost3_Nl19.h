...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl19(
  ...
  const Scalar _tmp54 = _tmp15 + _tmp7;
  const Scalar _tmp55 = _tmp54 + position_vector(1, 0) + Scalar(8.3885017487099702);
  const Scalar _tmp56 = _tmp19 + _tmp25;
  const Scalar _tmp57 = _tmp56 + position_vector(0, 0) + Scalar(-2.5193355532036801);
  ...
  const Scalar _tmp62 = _tmp28 * _tmp60;
  const Scalar _tmp63 = _tmp62 * (-_tmp16 * _tmp27 * _tmp61 + _tmp17 * _tmp26 * _tmp61);
  const Scalar _tmp64 = _tmp55 * _tmp58;
  const Scalar _tmp65 = _tmp35 * _tmp42 - _tmp38 * _tmp41 + _tmp42 * _tmp63;
  const Scalar _tmp66 = _tmp29 * _tmp59 - _tmp64;
  const Scalar _tmp67 = _tmp47 * _tmp66;
  const Scalar _tmp68 = _tmp54 * _tmp59 - _tmp56 * _tmp64 + _tmp59 * _tmp63 - _tmp65 * _tmp67;
  const Scalar _tmp69 = _tmp31 + _tmp43;
  const Scalar _tmp70 = _tmp44 * _tmp59 -
                        _tmp51 * (-_tmp45 * _tmp59 - _tmp46 * _tmp67 + _tmp64 * _tmp69) -
                        _tmp52 * _tmp67 - _tmp59 * _tmp69;
  const Scalar _tmp71 = Scalar(1.0) / (_tmp70);
  const Scalar _tmp72 = _tmp68 * _tmp71;
  const Scalar _tmp73 = Scalar(1.0) / (_tmp68);
  const Scalar _tmp74 = _tmp70 * _tmp73;
  const Scalar _tmp75 = _tmp53 + _tmp74 * (_tmp48 * _tmp65 - _tmp53 * _tmp72 - _tmp63);
  ...
  const Scalar _tmp86 = _tmp62 * fh1;
  ...
  const Scalar _tmp92 = Scalar(1.0) * _tmp47;
  const Scalar _tmp93 = _tmp46 * _tmp51 * _tmp92 - _tmp52 * _tmp92;
  const Scalar _tmp94 = _tmp74 * (-_tmp65 * _tmp92 - _tmp72 * _tmp93) + _tmp93;
  const Scalar _tmp95 = -_tmp76 * _tmp94 + Scalar(1.0);
  const Scalar _tmp96 = _tmp83 * _tmp84;
  const Scalar _tmp97 = Scalar(1.0) * _tmp73;
  const Scalar _tmp98 = fh1 * (_tmp80 * _tmp96 - _tmp82 * _tmp85);
  const Scalar _tmp99 = _tmp97 * _tmp98;
  const Scalar _tmp100 = _tmp47 * fh1;
  ...
  _res(1, 0) = std::exp(_tmp62 * _tmp87 * (_tmp59 * _tmp90 - _tmp78 * _tmp91) +
                        _tmp62 * _tmp98 * (-_tmp42 * _tmp67 * _tmp97 + _tmp59 * _tmp97) +
                        _tmp85 * _tmp86 * (_tmp75 * _tmp79 + _tmp77 * _tmp78 + Scalar(1.0)) +
                        _tmp86 * _tmp96 * (_tmp78 * _tmp95 + _tmp79 * _tmp94));
  _res(2, 0) = std::exp(-_tmp100 * _tmp77 * _tmp85 - _tmp100 * _tmp95 * _tmp96 +
                        _tmp47 * _tmp87 * _tmp91 + _tmp67 * _tmp99);
  _res(3, 0) =
      std::exp(-_tmp101 * _tmp75 * _tmp85 - _tmp101 * _tmp94 * _tmp96 - _tmp87 * _tmp90 - _tmp99);
