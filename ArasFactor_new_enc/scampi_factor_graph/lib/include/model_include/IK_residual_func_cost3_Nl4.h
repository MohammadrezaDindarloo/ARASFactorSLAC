...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl4(
  ...
  const Scalar _tmp96 = fh1 * (_tmp82 * _tmp95 - _tmp84 * _tmp87);
  const Scalar _tmp97 = Scalar(1.0) * _tmp45;
  const Scalar _tmp98 = _tmp55 * _tmp58 * _tmp97 - _tmp59 * _tmp97;
  const Scalar _tmp99 = _tmp76 * (-_tmp43 * _tmp97 - _tmp74 * _tmp98) + _tmp98;
  ...
  _res(1, 0) = std::exp(_tmp101 * _tmp41 * (_tmp100 * _tmp81 + _tmp78 * _tmp99) +
                        _tmp41 * _tmp88 * (_tmp77 * _tmp78 + _tmp80 * _tmp81 + Scalar(1.0)) +
                        _tmp41 * _tmp89 * (_tmp66 * _tmp92 - _tmp81 * _tmp93) +
                        _tmp41 * _tmp96 * (-_tmp28 * _tmp70 * _tmp94 + _tmp66 * _tmp94));
  _res(2, 0) = std::exp(-_tmp100 * _tmp101 * _tmp45 + _tmp102 * _tmp70 - _tmp45 * _tmp80 * _tmp88 +
                        _tmp45 * _tmp89 * _tmp93);
  _res(3, 0) =
      std::exp(-_tmp101 * _tmp72 * _tmp99 - _tmp102 - _tmp72 * _tmp77 * _tmp88 - _tmp89 * _tmp92);
