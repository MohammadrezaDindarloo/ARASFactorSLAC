...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl16(
  ...
  const Scalar _tmp37 = (-_tmp17 + _tmp33) / (_tmp27 - _tmp36);
  const Scalar _tmp38 = _tmp33 + _tmp36 * _tmp37;
  const Scalar _tmp39 = 0;
  const Scalar _tmp40 = _tmp28 * _tmp29;
  const Scalar _tmp41 = _tmp35 + position_vector(1, 0) + Scalar(-4.83288938413423);
  const Scalar _tmp42 = _tmp32 + position_vector(0, 0) + Scalar(1.7965602546229);
  const Scalar _tmp43 = Scalar(1.0) / (_tmp42);
  const Scalar _tmp44 = _tmp41 * _tmp43;
  const Scalar _tmp45 = Scalar(1.0) / (_tmp30 * _tmp44 - _tmp40);
  const Scalar _tmp46 =
  ...
  const Scalar _tmp51 = _tmp19 + _tmp26;
  const Scalar _tmp52 = _tmp51 + position_vector(1, 0) + Scalar(8.3885017487099702);
  const Scalar _tmp53 = _tmp16 + _tmp5;
  ...
  const Scalar _tmp59 = _tmp48 + _tmp57;
  const Scalar _tmp60 = _tmp30 * _tmp50;
  const Scalar _tmp61 = -_tmp30 * _tmp59 + _tmp60;
  const Scalar _tmp62 = _tmp52 * _tmp55;
  const Scalar _tmp63 = _tmp44 * _tmp56 - _tmp62;
  const Scalar _tmp64 = _tmp45 * _tmp63;
  const Scalar _tmp65 = _tmp44 * _tmp50;
  const Scalar _tmp66 = _tmp40 * _tmp59 - _tmp44 * _tmp60;
  const Scalar _tmp67 = -_tmp37 * (-_tmp56 * _tmp65 + _tmp58 * _tmp62 - _tmp64 * _tmp66) +
                        _tmp50 * _tmp56 - _tmp56 * _tmp58 - _tmp61 * _tmp64;
  const Scalar _tmp68 = Scalar(1.0) / (_tmp67);
  const Scalar _tmp69 = _tmp63 * _tmp68;
  const Scalar _tmp70 = _tmp39 * _tmp45 * _tmp69;
  ...
  const Scalar _tmp75 = _tmp73 * (_tmp32 * _tmp41 * _tmp74 - _tmp35 * _tmp42 * _tmp74);
  const Scalar _tmp76 = -_tmp17 * _tmp40 + _tmp27 * _tmp30 + _tmp30 * _tmp75;
  const Scalar _tmp77 = Scalar(1.0) * _tmp45;
  const Scalar _tmp78 = _tmp37 * _tmp66 * _tmp77 - _tmp61 * _tmp77;
  const Scalar _tmp79 = _tmp51 * _tmp56 - _tmp53 * _tmp62 + _tmp56 * _tmp75 - _tmp64 * _tmp76;
  ...
  const Scalar _tmp85 = _tmp45 * (-_tmp69 * _tmp83 + Scalar(1.0));
  const Scalar _tmp86 = _tmp19 + _tmp34;
  const Scalar _tmp87 = _tmp86 + position_vector(1, 0) + Scalar(-4.7744369927459998);
  const Scalar _tmp88 = _tmp31 + _tmp5;
  const Scalar _tmp89 = _tmp88 + position_vector(0, 0) + Scalar(-2.7171519410699099);
  const Scalar _tmp90 = std::pow(Scalar(std::pow(_tmp87, Scalar(2)) + std::pow(_tmp89, Scalar(2))),
                                 Scalar(Scalar(-1) / Scalar(2)));
  const Scalar _tmp91 = _tmp87 * _tmp90;
  const Scalar _tmp92 = _tmp73 * _tmp91 * (_tmp30 * _tmp85 + _tmp56 * _tmp84);
  const Scalar _tmp93 = _tmp89 * _tmp90;
  const Scalar _tmp94 = -_tmp86 * _tmp93 + _tmp88 * _tmp91;
  const Scalar _tmp95 = Scalar(1.0) * _tmp81;
  const Scalar _tmp96 = _tmp73 * _tmp94 * (-_tmp30 * _tmp64 * _tmp95 + _tmp56 * _tmp95);
  const Scalar _tmp97 = _tmp44 * _tmp45;
  const Scalar _tmp98 = -_tmp37 * (_tmp65 + _tmp66 * _tmp97) - _tmp50 + _tmp61 * _tmp97;
  const Scalar _tmp99 = _tmp82 * (-_tmp75 + _tmp76 * _tmp97 - _tmp80 * _tmp98) + _tmp98;
  const Scalar _tmp100 = _tmp68 * _tmp99;
  const Scalar _tmp101 = _tmp45 * (-_tmp44 - _tmp69 * _tmp99);
  const Scalar _tmp102 = _tmp73 * _tmp93 * (_tmp100 * _tmp56 + _tmp101 * _tmp30 + Scalar(1.0));
  const Scalar _tmp103 = _tmp94 * _tmp95;
  const Scalar _tmp104 = _tmp103 * fh1;
  const Scalar _tmp105 = _tmp85 * _tmp91;
  const Scalar _tmp106 = _tmp101 * _tmp93;
  const Scalar _tmp107 = _tmp100 * _tmp93;
  const Scalar _tmp108 = _tmp84 * _tmp91;
  ...
  _res(1, 0) = -(-_tmp102 - _tmp92 - _tmp96) *
               std::exp(_tmp0 * _tmp73 * (-_tmp30 * _tmp70 + _tmp56 * _tmp71) + _tmp102 * fh1 +
                        _tmp92 * fh1 + _tmp96 * fh1);
  _res(2, 0) = -(-_tmp103 * _tmp64 + _tmp105 + _tmp106) *
               std::exp(_tmp0 * _tmp70 + _tmp104 * _tmp64 - _tmp105 * fh1 - _tmp106 * fh1);
