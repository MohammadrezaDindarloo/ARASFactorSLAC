...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl18(
  ...
  const Scalar _tmp41 = _tmp15 * _tmp28 - _tmp25 * _tmp40 + _tmp28 * _tmp39;
  const Scalar _tmp42 = _tmp31 * _tmp37;
  const Scalar _tmp43 = Scalar(1.0) / (_tmp28 * _tmp42 - _tmp40);
  ...
  const Scalar _tmp52 = -_tmp28 * _tmp50 + _tmp28 * _tmp51;
  const Scalar _tmp53 = _tmp42 * _tmp51;
  const Scalar _tmp54 = -_tmp28 * _tmp53 + _tmp40 * _tmp50;
  const Scalar _tmp55 = Scalar(1.0) * _tmp30;
  const Scalar _tmp56 = Scalar(1.0) * _tmp33;
  const Scalar _tmp57 = (-_tmp25 + _tmp56) / (_tmp15 - _tmp55);
  const Scalar _tmp58 = _tmp44 * _tmp52 - _tmp51 - _tmp57 * (_tmp44 * _tmp54 + _tmp53);
  const Scalar _tmp59 = _tmp45 + _tmp49;
  ...
  const Scalar _tmp63 = _tmp17 + _tmp24;
  ...
  const Scalar _tmp70 = _tmp51 * _tmp67 - _tmp52 * _tmp69 -
                        _tmp57 * (-_tmp53 * _tmp67 - _tmp54 * _tmp69 + _tmp59 * _tmp66) -
                        _tmp59 * _tmp67;
  const Scalar _tmp71 = Scalar(1.0) / (_tmp70);
  const Scalar _tmp72 = _tmp39 * _tmp67 - _tmp41 * _tmp69 + _tmp61 * _tmp67 - _tmp63 * _tmp66;
  const Scalar _tmp73 = _tmp71 * _tmp72;
  const Scalar _tmp74 = Scalar(1.0) / (_tmp72);
  const Scalar _tmp75 = _tmp70 * _tmp74;
  const Scalar _tmp76 = _tmp58 + _tmp75 * (-_tmp39 + _tmp41 * _tmp44 - _tmp58 * _tmp73);
  const Scalar _tmp77 = _tmp67 * _tmp71;
  const Scalar _tmp78 = _tmp68 * _tmp71;
  const Scalar _tmp79 = -_tmp42 - _tmp76 * _tmp78;
  const Scalar _tmp80 = _tmp28 * _tmp43;
  const Scalar _tmp81 = _tmp17 + _tmp32;
  const Scalar _tmp82 = _tmp81 + position_vector(0, 0) + Scalar(1.7965602546229);
  const Scalar _tmp83 = _tmp29 + _tmp60;
  ...
  const Scalar _tmp87 = _tmp38 * _tmp86 * (_tmp76 * _tmp77 + _tmp79 * _tmp80 + Scalar(1.0));
  ...
  const Scalar _tmp94 = -_tmp52 * _tmp93 + _tmp54 * _tmp57 * _tmp93;
  ...
  const Scalar _tmp98 = _tmp38 * _tmp97 * (_tmp77 * _tmp95 + _tmp80 * _tmp96);
  const Scalar _tmp99 = _tmp81 * _tmp97 - _tmp83 * _tmp86;
  const Scalar _tmp100 = Scalar(1.0) * _tmp74;
  const Scalar _tmp101 = _tmp38 * _tmp99 * (-_tmp100 * _tmp28 * _tmp69 + _tmp100 * _tmp67);
  const Scalar _tmp102 = _tmp43 * _tmp79 * _tmp86;
  const Scalar _tmp103 = _tmp100 * _tmp99;
  const Scalar _tmp104 = _tmp103 * fh1;
  const Scalar _tmp105 = _tmp43 * _tmp96 * _tmp97;
  const Scalar _tmp106 = _tmp71 * _tmp95 * _tmp97;
  const Scalar _tmp107 = _tmp71 * _tmp76 * _tmp86;
  ...
  _res(1, 0) = -(-_tmp101 - _tmp87 - _tmp98) *
               std::exp(_tmp101 * fh1 + _tmp38 * _tmp88 * (_tmp67 * _tmp92 - _tmp80 * _tmp91) +
                        _tmp87 * fh1 + _tmp98 * fh1);
  _res(2, 0) =
      -(_tmp102 - _tmp103 * _tmp69 + _tmp105) *
      std::exp(-_tmp102 * fh1 + _tmp104 * _tmp69 - _tmp105 * fh1 + _tmp43 * _tmp88 * _tmp91);
  _res(3, 0) = -(_tmp103 + _tmp106 + _tmp107) *
               std::exp(-_tmp104 - _tmp106 * fh1 - _tmp107 * fh1 - _tmp88 * _tmp92);
