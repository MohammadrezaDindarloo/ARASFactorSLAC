...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl22(
  ...
  const Scalar _tmp22 = Scalar(0.20999999999999999) * _tmp7 - Scalar(0.20999999999999999) * _tmp9;
  const Scalar _tmp23 = _tmp21 + _tmp22;
  const Scalar _tmp24 = _tmp18 + _tmp23;
  const Scalar _tmp25 = _tmp24 + position_vector(0, 0) + Scalar(1.7965602546229);
  const Scalar _tmp26 = _tmp15 + position_vector(1, 0) + Scalar(-4.83288938413423);
  const Scalar _tmp27 = std::pow(Scalar(std::pow(_tmp25, Scalar(2)) + std::pow(_tmp26, Scalar(2))),
                                 Scalar(Scalar(-1) / Scalar(2)));
  const Scalar _tmp28 = _tmp25 * _tmp27;
  const Scalar _tmp29 = _tmp26 * _tmp27;
  const Scalar _tmp30 = -_tmp15 * _tmp28 + _tmp24 * _tmp29;
  ...
  const Scalar _tmp37 = _tmp36 + position_vector(0, 0) + Scalar(-2.5193355532036801);
  ...
  const Scalar _tmp43 = _tmp17 + _tmp23;
  ...
  const Scalar _tmp47 = _tmp39 * _tmp46 - _tmp40;
  const Scalar _tmp48 = _tmp18 + _tmp35;
  const Scalar _tmp49 = _tmp14 + _tmp31;
  const Scalar _tmp50 = _tmp49 + position_vector(1, 0) + Scalar(8.3196563720703107);
  const Scalar _tmp51 = _tmp48 + position_vector(0, 0) + Scalar(1.9874742031097401);
  ...
  const Scalar _tmp57 = _tmp45 * _tmp55;
  const Scalar _tmp58 = _tmp57 * (-_tmp41 * _tmp44 * _tmp56 + _tmp42 * _tmp43 * _tmp56);
  const Scalar _tmp59 = Scalar(1.0) / (_tmp46 * _tmp54 - _tmp53);
  const Scalar _tmp60 = _tmp59 * (-_tmp48 * _tmp53 + _tmp49 * _tmp54 + _tmp54 * _tmp58);
  const Scalar _tmp61 = _tmp33 * _tmp39 - _tmp36 * _tmp40 + _tmp39 * _tmp58 - _tmp47 * _tmp60;
  ...
  const Scalar _tmp66 = _tmp30 * _tmp57 * (_tmp39 * _tmp63 - _tmp63 * _tmp65);
  const Scalar _tmp67 = Scalar(0.20999999999999999) * _tmp19 - Scalar(0.20999999999999999) * _tmp20;
  const Scalar _tmp68 =
      -Scalar(0.010999999999999999) * _tmp1 - Scalar(0.010999999999999999) * _tmp16;
  ...
  const Scalar _tmp75 = _tmp46 * _tmp72;
  const Scalar _tmp76 = _tmp53 * _tmp71 - _tmp54 * _tmp75;
  const Scalar _tmp77 = _tmp59 * _tmp76;
  const Scalar _tmp78 = Scalar(1.0) * _tmp43;
  const Scalar _tmp79 = Scalar(1.0) * _tmp41;
  const Scalar _tmp80 = (-_tmp48 + _tmp78) / (_tmp49 - _tmp79);
  const Scalar _tmp81 = _tmp46 * _tmp74 - _tmp72 - _tmp80 * (_tmp46 * _tmp77 + _tmp75);
  const Scalar _tmp82 = _tmp67 + _tmp70;
  const Scalar _tmp83 = _tmp39 * _tmp72 - _tmp39 * _tmp82 - _tmp64 * _tmp73 -
                        _tmp80 * (-_tmp39 * _tmp75 + _tmp40 * _tmp82 - _tmp64 * _tmp76);
  const Scalar _tmp84 = Scalar(1.0) / (_tmp83);
  const Scalar _tmp85 = _tmp61 * _tmp84;
  const Scalar _tmp86 = _tmp62 * _tmp83;
  const Scalar _tmp87 = _tmp81 + _tmp86 * (_tmp46 * _tmp60 - _tmp58 - _tmp81 * _tmp85);
  const Scalar _tmp88 = _tmp47 * _tmp84;
  const Scalar _tmp89 = -_tmp46 - _tmp87 * _tmp88;
  const Scalar _tmp90 = _tmp54 * _tmp59;
  const Scalar _tmp91 = _tmp84 * _tmp87;
  const Scalar _tmp92 = _tmp28 * _tmp57 * (_tmp39 * _tmp91 + _tmp89 * _tmp90 + Scalar(1.0));
  const Scalar _tmp93 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp94 = _tmp78 + _tmp79 * _tmp80;
  const Scalar _tmp95 = 0;
  const Scalar _tmp96 = -Scalar(1.0) * _tmp74 + Scalar(1.0) * _tmp77 * _tmp80;
  const Scalar _tmp97 = _tmp86 * (-Scalar(1.0) * _tmp60 - _tmp85 * _tmp96) + _tmp96;
  const Scalar _tmp98 = _tmp84 * _tmp97;
  const Scalar _tmp99 = -_tmp88 * _tmp97 + Scalar(1.0);
  const Scalar _tmp100 = _tmp29 * _tmp57 * (_tmp39 * _tmp98 + _tmp90 * _tmp99);
  const Scalar _tmp101 = _tmp93 * _tmp95;
  const Scalar _tmp102 = _tmp28 * _tmp59 * _tmp89;
  const Scalar _tmp103 = _tmp30 * _tmp63;
  const Scalar _tmp104 = _tmp103 * fh1;
  const Scalar _tmp105 = _tmp29 * _tmp59 * _tmp99;
  const Scalar _tmp106 = _tmp29 * _tmp98;
  const Scalar _tmp107 = _tmp28 * _tmp91;
  ...
  _res(1, 0) = -(-_tmp100 - _tmp66 - _tmp92) *
               std::exp(_tmp100 * fh1 + _tmp57 * _tmp93 * (_tmp39 * _tmp95 - _tmp65 * _tmp95) +
                        _tmp66 * fh1 + _tmp92 * fh1);
  _res(2, 0) = -(_tmp102 - _tmp103 * _tmp64 + _tmp105) *
               std::exp(_tmp101 * _tmp64 - _tmp102 * fh1 + _tmp104 * _tmp64 - _tmp105 * fh1);
  _res(3, 0) =
