...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl3(
  ...
  const Scalar _tmp43 = _tmp28 * _tmp41 - _tmp42;
  const Scalar _tmp44 = -_tmp11 + _tmp14;
  const Scalar _tmp45 = _tmp4 + _tmp44;
  const Scalar _tmp46 = _tmp45 + position_vector(1, 0) + Scalar(-4.83288938413423);
  ...
  const Scalar _tmp53 = Scalar(1.0) / (_tmp41 * _tmp52 - _tmp51);
  const Scalar _tmp54 = _tmp34 * _tmp41;
  const Scalar _tmp55 = -_tmp30 + _tmp33;
  const Scalar _tmp56 = _tmp53 * (_tmp51 * _tmp55 - _tmp52 * _tmp54);
  const Scalar _tmp57 = Scalar(1.0) * _tmp35;
  const Scalar _tmp58 = Scalar(1.0) * _tmp38;
  const Scalar _tmp59 = (-_tmp48 + _tmp58) / (_tmp45 - _tmp57);
  const Scalar _tmp60 = _tmp53 * (_tmp34 * _tmp52 - _tmp52 * _tmp55);
  const Scalar _tmp61 = -_tmp28 * _tmp32 + _tmp28 * _tmp34 - _tmp43 * _tmp60 -
                        _tmp59 * (-_tmp28 * _tmp54 + _tmp32 * _tmp42 - _tmp43 * _tmp56);
  ...
  const Scalar _tmp65 = _tmp40 * _tmp63;
  const Scalar _tmp66 = _tmp65 * (-_tmp35 * _tmp39 * _tmp64 + _tmp36 * _tmp38 * _tmp64);
  const Scalar _tmp67 = _tmp53 * (_tmp45 * _tmp52 - _tmp48 * _tmp51 + _tmp52 * _tmp66);
  const Scalar _tmp68 = -_tmp34 + _tmp41 * _tmp60 - _tmp59 * (_tmp41 * _tmp56 + _tmp54);
  const Scalar _tmp69 = _tmp16 * _tmp28 - _tmp25 * _tmp42 + _tmp28 * _tmp66 - _tmp43 * _tmp67;
  const Scalar _tmp70 = _tmp62 * _tmp69;
  const Scalar _tmp71 = Scalar(1.0) / (_tmp69);
  const Scalar _tmp72 = _tmp61 * _tmp71;
  const Scalar _tmp73 = _tmp68 + _tmp72 * (_tmp41 * _tmp67 - _tmp66 - _tmp68 * _tmp70);
  const Scalar _tmp74 = _tmp62 * _tmp73;
  const Scalar _tmp75 = _tmp43 * _tmp62;
  const Scalar _tmp76 = _tmp53 * (-_tmp41 - _tmp73 * _tmp75);
  const Scalar _tmp77 = _tmp24 + _tmp47;
  const Scalar _tmp78 = _tmp77 + position_vector(0, 0) + Scalar(1.9874742031097401);
  const Scalar _tmp79 = _tmp44 + _tmp5;
  const Scalar _tmp80 = _tmp79 + position_vector(1, 0) + Scalar(8.3196563720703107);
  const Scalar _tmp81 = std::pow(Scalar(std::pow(_tmp78, Scalar(2)) + std::pow(_tmp80, Scalar(2))),
                                 Scalar(Scalar(-1) / Scalar(2)));
  const Scalar _tmp82 = _tmp78 * _tmp81;
  const Scalar _tmp83 = _tmp65 * _tmp82 * (_tmp28 * _tmp74 + _tmp52 * _tmp76 + Scalar(1.0));
  const Scalar _tmp84 = Scalar(1.0) * _tmp56 * _tmp59 - Scalar(1.0) * _tmp60;
  const Scalar _tmp85 = _tmp72 * (-Scalar(1.0) * _tmp67 - _tmp70 * _tmp84) + _tmp84;
  const Scalar _tmp86 = _tmp53 * (-_tmp75 * _tmp85 + Scalar(1.0));
  const Scalar _tmp87 = _tmp62 * _tmp85;
  const Scalar _tmp88 = _tmp80 * _tmp81;
  const Scalar _tmp89 = _tmp65 * _tmp88 * (_tmp28 * _tmp87 + _tmp52 * _tmp86);
  const Scalar _tmp90 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp91 = _tmp57 * _tmp59 + _tmp58;
  const Scalar _tmp92 = 0;
  const Scalar _tmp93 = _tmp43 * _tmp53;
  const Scalar _tmp94 = _tmp52 * _tmp93;
  const Scalar _tmp95 = _tmp77 * _tmp88 - _tmp79 * _tmp82;
  const Scalar _tmp96 = Scalar(1.0) * _tmp71;
  const Scalar _tmp97 = _tmp65 * _tmp95 * (_tmp28 * _tmp96 - _tmp94 * _tmp96);
  const Scalar _tmp98 = _tmp86 * _tmp88;
  const Scalar _tmp99 = _tmp90 * _tmp92;
  const Scalar _tmp100 = _tmp95 * _tmp96;
  const Scalar _tmp101 = _tmp100 * fh1;
  const Scalar _tmp102 = _tmp76 * _tmp82;
  const Scalar _tmp103 = _tmp74 * _tmp82;
  ...
  _res(1, 0) = -(-_tmp83 - _tmp89 - _tmp97) *
               std::exp(_tmp65 * _tmp90 * (_tmp28 * _tmp92 - _tmp92 * _tmp94) + _tmp83 * fh1 +
                        _tmp89 * fh1 + _tmp97 * fh1);
  _res(2, 0) = -(-_tmp100 * _tmp93 + _tmp102 + _tmp98) *
               std::exp(_tmp101 * _tmp93 - _tmp102 * fh1 + _tmp93 * _tmp99 - _tmp98 * fh1);
  _res(3, 0) =
