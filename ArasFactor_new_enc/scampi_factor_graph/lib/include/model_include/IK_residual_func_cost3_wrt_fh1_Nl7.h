...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl7(
  ...
  const Scalar _tmp37 = _tmp36 + position_vector(1, 0) + Scalar(-4.83288938413423);
  const Scalar _tmp38 = _tmp21 - _tmp23;
  const Scalar _tmp39 = _tmp18 + _tmp38;
  const Scalar _tmp40 = _tmp39 + position_vector(0, 0) + Scalar(1.7965602546229);
  ...
  const Scalar _tmp45 = _tmp44 + position_vector(1, 0) + Scalar(8.3196563720703107);
  const Scalar _tmp46 = -_tmp18;
  const Scalar _tmp47 = _tmp38 + _tmp46;
  const Scalar _tmp48 = _tmp47 + position_vector(0, 0) + Scalar(1.9874742031097401);
  const Scalar _tmp49 = Scalar(1.0) / (_tmp48);
  const Scalar _tmp50 = _tmp45 * _tmp49;
  const Scalar _tmp51 = _tmp30 + _tmp31 - _tmp32;
  const Scalar _tmp52 = _tmp40 * _tmp41;
  const Scalar _tmp53 = _tmp51 * _tmp52;
  const Scalar _tmp54 = _tmp34 * _tmp42 - _tmp50 * _tmp53;
  const Scalar _tmp55 = _tmp17 * _tmp27;
  const Scalar _tmp56 = _tmp28 * _tmp50 - _tmp55;
  const Scalar _tmp57 = Scalar(1.0) / (-_tmp42 + _tmp50 * _tmp52);
  ...
  const Scalar _tmp63 = (-_tmp39 + _tmp62) / (_tmp36 - _tmp61);
  const Scalar _tmp64 = -_tmp34 * _tmp52 + _tmp53;
  const Scalar _tmp65 = _tmp28 * _tmp51 - _tmp28 * _tmp59 - _tmp58 * _tmp64 -
                        _tmp63 * (-_tmp28 * _tmp60 - _tmp54 * _tmp58 + _tmp55 * _tmp59);
  const Scalar _tmp66 = Scalar(1.0) / (_tmp65);
  const Scalar _tmp67 = _tmp61 * _tmp63 + _tmp62;
  const Scalar _tmp68 = 0;
  const Scalar _tmp69 = _tmp52 * _tmp58;
  const Scalar _tmp70 =
  ...
  const Scalar _tmp73 = _tmp71 * (-_tmp44 * _tmp48 * _tmp72 + _tmp45 * _tmp47 * _tmp72);
  const Scalar _tmp74 = _tmp36 * _tmp52 - _tmp39 * _tmp42 + _tmp52 * _tmp73;
  const Scalar _tmp75 = _tmp50 * _tmp57;
  const Scalar _tmp76 = -_tmp51 - _tmp63 * (_tmp54 * _tmp75 + _tmp60) + _tmp64 * _tmp75;
  const Scalar _tmp77 = _tmp16 * _tmp28 - _tmp25 * _tmp55 + _tmp28 * _tmp73 - _tmp58 * _tmp74;
  ...
  const Scalar _tmp82 = _tmp56 * _tmp66;
  const Scalar _tmp83 = _tmp57 * (-_tmp50 - _tmp81 * _tmp82);
  const Scalar _tmp84 = _tmp66 * _tmp81;
  const Scalar _tmp85 = _tmp24 + _tmp46;
  const Scalar _tmp86 = _tmp85 + position_vector(0, 0) + Scalar(-2.5193355532036801);
  const Scalar _tmp87 = _tmp43 + _tmp8;
  ...
  const Scalar _tmp91 = _tmp71 * _tmp90 * (_tmp28 * _tmp84 + _tmp52 * _tmp83 + Scalar(1.0));
  const Scalar _tmp92 = Scalar(1.0) * _tmp57;
  const Scalar _tmp93 = _tmp54 * _tmp63 * _tmp92 - _tmp64 * _tmp92;
  const Scalar _tmp94 = _tmp80 * (-_tmp74 * _tmp92 - _tmp78 * _tmp93) + _tmp93;
  const Scalar _tmp95 = _tmp66 * _tmp94;
  const Scalar _tmp96 = _tmp57 * (-_tmp82 * _tmp94 + Scalar(1.0));
  const Scalar _tmp97 = _tmp88 * _tmp89;
  const Scalar _tmp98 = _tmp71 * _tmp97 * (_tmp28 * _tmp95 + _tmp52 * _tmp96);
  const Scalar _tmp99 = _tmp85 * _tmp97 - _tmp87 * _tmp90;
  const Scalar _tmp100 = Scalar(1.0) * _tmp79;
  const Scalar _tmp101 = _tmp71 * _tmp99 * (_tmp100 * _tmp28 - _tmp100 * _tmp69);
  const Scalar _tmp102 = _tmp96 * _tmp97;
  const Scalar _tmp103 = _tmp83 * _tmp90;
  ...
  _res(1, 0) = -(-_tmp101 - _tmp91 - _tmp98) *
               std::exp(_tmp0 * _tmp71 * (_tmp28 * _tmp68 - _tmp68 * _tmp69) + _tmp101 * fh1 +
                        _tmp91 * fh1 + _tmp98 * fh1);
  _res(2, 0) = -(_tmp102 + _tmp103 - _tmp105 * _tmp58) *
               std::exp(-_tmp102 * fh1 - _tmp103 * fh1 + _tmp104 * _tmp58 + _tmp106 * _tmp58);
  _res(3, 0) =
