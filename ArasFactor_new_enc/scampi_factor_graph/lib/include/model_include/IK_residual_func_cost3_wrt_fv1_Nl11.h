...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl11(
  ...
  const Scalar _tmp25 = Scalar(0.20999999999999999) * _tmp20 + Scalar(0.20999999999999999) * _tmp8;
  const Scalar _tmp26 =
  ...
  const Scalar _tmp30 = _tmp29 + position_vector(0, 0) + Scalar(-2.7171519410699099);
  ...
  const Scalar _tmp38 = _tmp37 + position_vector(0, 0) + Scalar(1.7965602546229);
  ...
  const Scalar _tmp45 = _tmp15 * _tmp32 - _tmp40 * _tmp44;
  const Scalar _tmp46 = Scalar(1.0) * _tmp34;
  const Scalar _tmp47 = Scalar(1.0) * _tmp37;
  const Scalar _tmp48 = (-_tmp29 + _tmp47) / (_tmp23 - _tmp46);
  const Scalar _tmp49 = Scalar(1.0) / (-_tmp32 + _tmp40 * _tmp43);
  const Scalar _tmp50 = Scalar(1.0) * _tmp49;
  const Scalar _tmp51 = -_tmp15 * _tmp43 + _tmp44;
  const Scalar _tmp52 = _tmp45 * _tmp48 * _tmp50 - _tmp50 * _tmp51;
  const Scalar _tmp53 = _tmp10 - _tmp13 + _tmp41;
  const Scalar _tmp54 = _tmp26 - _tmp27;
  const Scalar _tmp55 = _tmp36 + _tmp54;
  const Scalar _tmp56 = _tmp55 + position_vector(0, 0) + Scalar(1.9874742031097401);
  const Scalar _tmp57 = _tmp19 - _tmp21;
  const Scalar _tmp58 = _tmp33 + _tmp57;
  const Scalar _tmp59 = _tmp58 + position_vector(1, 0) + Scalar(8.3196563720703107);
  ...
  const Scalar _tmp63 = _tmp40 * _tmp61 - _tmp62;
  const Scalar _tmp64 = _tmp49 * _tmp63;
  const Scalar _tmp65 = _tmp40 * _tmp42;
  const Scalar _tmp66 = _tmp42 * _tmp61 -
                        _tmp48 * (-_tmp45 * _tmp64 + _tmp53 * _tmp62 - _tmp61 * _tmp65) -
                        _tmp51 * _tmp64 - _tmp53 * _tmp61;
  const Scalar _tmp67 = Scalar(1.0) / (_tmp66);
  const Scalar _tmp68 =
      std::sqrt(Scalar(std::pow(_tmp35, Scalar(2)) + std::pow(_tmp38, Scalar(2))));
  const Scalar _tmp69 = Scalar(1.0) / (_tmp68);
  const Scalar _tmp70 = _tmp39 * _tmp68;
  const Scalar _tmp71 = _tmp70 * (-_tmp34 * _tmp38 * _tmp69 + _tmp35 * _tmp37 * _tmp69);
  const Scalar _tmp72 = _tmp23 * _tmp43 - _tmp29 * _tmp32 + _tmp43 * _tmp71;
  const Scalar _tmp73 = -_tmp55 * _tmp62 + _tmp58 * _tmp61 + _tmp61 * _tmp71 - _tmp64 * _tmp72;
  ...
  const Scalar _tmp82 = _tmp18 + _tmp57;
  const Scalar _tmp83 = _tmp82 + position_vector(1, 0) + Scalar(8.3885017487099702);
  const Scalar _tmp84 = _tmp25 + _tmp54;
  const Scalar _tmp85 = _tmp84 + position_vector(0, 0) + Scalar(-2.5193355532036801);
  ...
  const Scalar _tmp89 = _tmp40 * _tmp49;
  const Scalar _tmp90 = -_tmp42 - _tmp48 * (_tmp45 * _tmp89 + _tmp65) + _tmp51 * _tmp89;
  ...
  const Scalar _tmp102 = _tmp70 * (_tmp100 * _tmp61 - _tmp101 * _tmp80);
  ...
  _res(0, 0) = 0;
  _res(1, 0) =
      -_tmp102 * std::exp(_tmp102 * _tmp97 + _tmp70 * _tmp88 * (_tmp77 * _tmp81 + _tmp79 * _tmp80) +
                          _tmp70 * _tmp94 * (_tmp80 * _tmp92 + _tmp81 * _tmp91 + Scalar(1.0)) +
                          _tmp70 * _tmp96 * (-_tmp43 * _tmp64 * _tmp95 + _tmp61 * _tmp95));
  _res(2, 0) = -_tmp103 * std::exp(_tmp103 * _tmp97 + _tmp104 * _tmp64 - _tmp49 * _tmp79 * _tmp88 -
                                   _tmp49 * _tmp92 * _tmp94);
  _res(3, 0) = _tmp100 * std::exp(-_tmp100 * _tmp97 - _tmp104 - _tmp67 * _tmp77 * _tmp88 -
                                  _tmp67 * _tmp91 * _tmp94);
