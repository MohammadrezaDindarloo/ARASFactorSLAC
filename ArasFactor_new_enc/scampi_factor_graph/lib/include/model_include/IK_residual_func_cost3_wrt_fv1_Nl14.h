...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl14(
  ...
  const Scalar _tmp61 = _tmp20 + _tmp23;
  const Scalar _tmp62 = _tmp18 + _tmp61;
  const Scalar _tmp63 = _tmp62 + position_vector(1, 0) + Scalar(-4.83288938413423);
  ...
  const Scalar _tmp69 = _tmp40 * _tmp65 - _tmp41 * _tmp68 - _tmp59 * _tmp66 + _tmp62 * _tmp65;
  const Scalar _tmp70 = _tmp45 + _tmp49;
  const Scalar _tmp71 = _tmp51 * _tmp65 -
                        _tmp56 * (-_tmp52 * _tmp65 - _tmp53 * _tmp68 + _tmp66 * _tmp70) -
                        _tmp57 * _tmp68 - _tmp65 * _tmp70;
  ...
  const Scalar _tmp83 = _tmp31 + _tmp6;
  ...
  const Scalar _tmp92 = _tmp39 * (-_tmp30 * _tmp91 + _tmp65 * _tmp90);
  ...
  const Scalar _tmp98 = _tmp75 * (-_tmp41 * _tmp96 - _tmp73 * _tmp97) + _tmp97;
  ...
  _res(0, 0) = 0;
  _res(1, 0) =
      -_tmp92 * std::exp(_tmp39 * _tmp95 * (-_tmp30 * _tmp68 * _tmp93 + _tmp65 * _tmp93) +
                         _tmp86 * _tmp87 * (_tmp76 * _tmp77 + _tmp79 * _tmp80 + Scalar(1.0)) +
                         _tmp87 * _tmp94 * (_tmp77 * _tmp98 + _tmp80 * _tmp99) + _tmp88 * _tmp92);
  _res(2, 0) = -_tmp91 * std::exp(_tmp100 * _tmp68 - _tmp101 * _tmp79 * _tmp86 -
                                  _tmp101 * _tmp94 * _tmp99 + _tmp102 * _tmp68);
  _res(3, 0) =
      _tmp90 * std::exp(-_tmp100 - _tmp102 - _tmp103 * _tmp76 * _tmp86 - _tmp103 * _tmp94 * _tmp98);
