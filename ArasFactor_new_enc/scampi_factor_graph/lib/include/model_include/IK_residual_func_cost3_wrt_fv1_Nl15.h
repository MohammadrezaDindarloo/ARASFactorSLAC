...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl15(
  ...
  const Scalar _tmp28 = _tmp27 + position_vector(1, 0) + Scalar(8.3885017487099702);
  ...
  const Scalar _tmp37 = _tmp36 + position_vector(0, 0) + Scalar(1.7965602546229);
  const Scalar _tmp38 = -_tmp20;
  const Scalar _tmp39 = _tmp22 + _tmp25;
  ...
  const Scalar _tmp48 = -_tmp29 * _tmp44 + _tmp46 * _tmp47;
  const Scalar _tmp49 = Scalar(1.0) * _tmp17;
  const Scalar _tmp50 = Scalar(1.0) * _tmp27;
  const Scalar _tmp51 = (-_tmp36 + _tmp49) / (_tmp40 - _tmp50);
  const Scalar _tmp52 = Scalar(1.0) / (_tmp29 * _tmp43 - _tmp47);
  ...
  const Scalar _tmp65 = _tmp29 * _tmp62 - _tmp63;
  const Scalar _tmp66 = _tmp52 * _tmp65;
  const Scalar _tmp67 = -_tmp51 * (-_tmp29 * _tmp64 - _tmp48 * _tmp66 + _tmp56 * _tmp63) -
                        _tmp54 * _tmp66 - _tmp56 * _tmp62 + _tmp64;
  const Scalar _tmp68 = Scalar(1.0) / (_tmp67);
  const Scalar _tmp69 =
      std::sqrt(Scalar(std::pow(_tmp18, Scalar(2)) + std::pow(_tmp28, Scalar(2))));
  const Scalar _tmp70 = Scalar(1.0) / (_tmp69);
  const Scalar _tmp71 = _tmp19 * _tmp69;
  const Scalar _tmp72 = _tmp71 * (_tmp17 * _tmp28 * _tmp70 - _tmp18 * _tmp27 * _tmp70);
  const Scalar _tmp73 = -_tmp36 * _tmp47 + _tmp40 * _tmp43 + _tmp43 * _tmp72;
  const Scalar _tmp74 = -_tmp57 * _tmp63 + _tmp59 * _tmp62 + _tmp62 * _tmp72 - _tmp66 * _tmp73;
  const Scalar _tmp75 = _tmp68 * _tmp74;
  const Scalar _tmp76 = Scalar(1.0) / (_tmp74);
  const Scalar _tmp77 = _tmp67 * _tmp76;
  const Scalar _tmp78 = _tmp55 + _tmp77 * (-_tmp53 * _tmp73 - _tmp55 * _tmp75);
  const Scalar _tmp79 = _tmp65 * _tmp68;
  const Scalar _tmp80 = -_tmp78 * _tmp79 + Scalar(1.0);
  const Scalar _tmp81 = _tmp43 * _tmp52;
  const Scalar _tmp82 = _tmp62 * _tmp68;
  const Scalar _tmp83 = _tmp20 + _tmp39;
  const Scalar _tmp84 = _tmp83 + position_vector(1, 0) + Scalar(-4.7744369927459998);
  const Scalar _tmp85 = _tmp16 + _tmp8;
  const Scalar _tmp86 = _tmp85 + position_vector(0, 0) + Scalar(-2.7171519410699099);
  ...
  const Scalar _tmp91 = _tmp49 + _tmp50 * _tmp51;
  const Scalar _tmp92 = 0;
  const Scalar _tmp93 = _tmp68 * _tmp92;
  const Scalar _tmp94 = _tmp79 * _tmp92;
  const Scalar _tmp95 = _tmp71 * (_tmp62 * _tmp93 - _tmp81 * _tmp94);
  const Scalar _tmp96 = _tmp29 * _tmp52;
  const Scalar _tmp97 = -_tmp34 - _tmp51 * (_tmp29 * _tmp34 + _tmp48 * _tmp96) + _tmp54 * _tmp96;
  const Scalar _tmp98 = _tmp77 * (-_tmp72 + _tmp73 * _tmp96 - _tmp75 * _tmp97) + _tmp97;
  const Scalar _tmp99 = -_tmp29 - _tmp79 * _tmp98;
  const Scalar _tmp100 = _tmp86 * _tmp87;
  const Scalar _tmp101 = _tmp100 * fh1;
  const Scalar _tmp102 = Scalar(1.0) * _tmp76;
  const Scalar _tmp103 = fh1 * (-_tmp100 * _tmp83 + _tmp85 * _tmp88);
  const Scalar _tmp104 = _tmp52 * _tmp94;
  ...
  _res(0, 0) = 0;
  _res(1, 0) =
      -_tmp95 * std::exp(_tmp101 * _tmp71 * (_tmp81 * _tmp99 + _tmp82 * _tmp98 + Scalar(1.0)) +
                         _tmp103 * _tmp71 * (-_tmp102 * _tmp43 * _tmp66 + _tmp102 * _tmp62) +
                         _tmp71 * _tmp89 * (_tmp78 * _tmp82 + _tmp80 * _tmp81) + _tmp90 * _tmp95);
  _res(2, 0) = -_tmp104 * std::exp(-_tmp101 * _tmp52 * _tmp99 + _tmp104 * _tmp90 +
                                   _tmp105 * _tmp66 - _tmp52 * _tmp80 * _tmp89);
  _res(3, 0) = _tmp93 * std::exp(-_tmp101 * _tmp68 * _tmp98 - _tmp105 - _tmp68 * _tmp78 * _tmp89 -
                                 _tmp90 * _tmp93);
