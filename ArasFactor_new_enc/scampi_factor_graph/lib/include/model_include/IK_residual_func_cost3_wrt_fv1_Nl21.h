...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl21(
  ...
  const Scalar _tmp75 = _tmp74 * (_tmp30 * _tmp69 - _tmp70 * _tmp72);
  const Scalar _tmp76 = Scalar(1.0) * _tmp58;
  const Scalar _tmp77 = _tmp56 * _tmp63 * _tmp76 - _tmp64 * _tmp76;
  const Scalar _tmp78 = Scalar(1.0) / (_tmp73);
  const Scalar _tmp79 = _tmp74 * (_tmp47 * _tmp51 * _tmp78 - _tmp48 * _tmp50 * _tmp78);
  const Scalar _tmp80 = _tmp38 * _tmp44 - _tmp41 * _tmp55 + _tmp44 * _tmp79;
  const Scalar _tmp81 = -_tmp17 * _tmp36 + _tmp27 * _tmp30 + _tmp30 * _tmp79 - _tmp59 * _tmp80;
  ...
  const Scalar _tmp86 = -_tmp71 * _tmp85 + Scalar(1.0);
  const Scalar _tmp87 = _tmp30 * _tmp66;
  const Scalar _tmp88 = _tmp20 + _tmp37;
  const Scalar _tmp89 = _tmp88 + position_vector(1, 0) + Scalar(-4.83288938413423);
  ...
  const Scalar _tmp96 = -_tmp46 - _tmp63 * (_tmp53 + _tmp56 * _tmp95) + _tmp64 * _tmp95;
  const Scalar _tmp97 = _tmp84 * (-_tmp79 + _tmp80 * _tmp95 - _tmp82 * _tmp96) + _tmp96;
  const Scalar _tmp98 = -_tmp52 - _tmp71 * _tmp97;
  const Scalar _tmp99 = _tmp91 * _tmp92;
  const Scalar _tmp100 = _tmp99 * fh1;
  const Scalar _tmp101 = Scalar(1.0) * _tmp83;
  const Scalar _tmp102 = _tmp57 * _tmp76 * _tmp83;
  const Scalar _tmp103 = fh1 * (-_tmp88 * _tmp99 + _tmp90 * _tmp93);
  const Scalar _tmp104 = _tmp58 * _tmp72;
  ...
  _res(0, 0) = 0;
  _res(1, 0) =
      -_tmp75 * std::exp(_tmp0 * _tmp75 +
                         _tmp100 * _tmp74 * (_tmp70 * _tmp98 + _tmp87 * _tmp97 + Scalar(1.0)) +
                         _tmp103 * _tmp74 * (_tmp101 * _tmp30 - _tmp102 * _tmp44) +
                         _tmp74 * _tmp94 * (_tmp70 * _tmp86 + _tmp85 * _tmp87));
  _res(2, 0) = -_tmp104 * std::exp(_tmp0 * _tmp104 - _tmp100 * _tmp58 * _tmp98 + _tmp102 * _tmp103 -
                                   _tmp58 * _tmp86 * _tmp94);
  _res(3, 0) = _tmp69 * std::exp(-_tmp0 * _tmp69 - _tmp100 * _tmp66 * _tmp97 - _tmp101 * _tmp103 -
                                 _tmp66 * _tmp85 * _tmp94);
