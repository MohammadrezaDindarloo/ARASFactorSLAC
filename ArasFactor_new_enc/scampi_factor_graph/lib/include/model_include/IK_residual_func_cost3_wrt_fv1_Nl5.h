...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl5(
  ...
  const Scalar _tmp33 = _tmp32 * (-_tmp17 * _tmp27 * _tmp31 + _tmp18 * _tmp26 * _tmp31);
  ...
  const Scalar _tmp38 = _tmp35 + position_vector(0, 0) + Scalar(-2.7171519410699099);
  ...
  const Scalar _tmp42 = _tmp33 * _tmp41 - _tmp35 * _tmp40 + _tmp36 * _tmp41;
  const Scalar _tmp43 = Scalar(1.0) / (_tmp29 * _tmp41 - _tmp40);
  ...
  const Scalar _tmp52 = -_tmp29 * _tmp51 + _tmp40 * _tmp50;
  const Scalar _tmp53 = Scalar(1.0) * _tmp17;
  const Scalar _tmp54 = Scalar(1.0) * _tmp26;
  const Scalar _tmp55 = (-_tmp35 + _tmp54) / (_tmp36 - _tmp53);
  const Scalar _tmp56 = -_tmp41 * _tmp50 + _tmp51;
  const Scalar _tmp57 = _tmp44 * _tmp56 - _tmp49 - _tmp55 * (_tmp29 * _tmp49 + _tmp44 * _tmp52);
  ...
  const Scalar _tmp63 = _tmp62 + position_vector(0, 0) + Scalar(-2.5193355532036801);
  ...
  const Scalar _tmp67 = _tmp45 + _tmp46 - _tmp47;
  const Scalar _tmp68 = _tmp60 * _tmp64;
  const Scalar _tmp69 = _tmp29 * _tmp65 - _tmp68;
  const Scalar _tmp70 = _tmp43 * _tmp69;
  const Scalar _tmp71 = -_tmp55 * (-_tmp29 * _tmp66 - _tmp52 * _tmp70 + _tmp67 * _tmp68) -
                        _tmp56 * _tmp70 - _tmp65 * _tmp67 + _tmp66;
  const Scalar _tmp72 = Scalar(1.0) / (_tmp71);
  const Scalar _tmp73 = _tmp33 * _tmp65 - _tmp42 * _tmp70 + _tmp59 * _tmp65 - _tmp62 * _tmp68;
  const Scalar _tmp74 = _tmp72 * _tmp73;
  const Scalar _tmp75 = Scalar(1.0) / (_tmp73);
  const Scalar _tmp76 = _tmp71 * _tmp75;
  const Scalar _tmp77 = _tmp57 + _tmp76 * (-_tmp33 + _tmp42 * _tmp44 - _tmp57 * _tmp74);
  const Scalar _tmp78 = _tmp69 * _tmp72;
  const Scalar _tmp79 = -_tmp29 - _tmp77 * _tmp78;
  const Scalar _tmp80 = _tmp41 * _tmp43;
  const Scalar _tmp81 = _tmp65 * _tmp72;
  const Scalar _tmp82 = _tmp25 + _tmp61;
  const Scalar _tmp83 = _tmp82 + position_vector(0, 0) + Scalar(1.9874742031097401);
  const Scalar _tmp84 = _tmp58 + _tmp9;
  const Scalar _tmp85 = _tmp84 + position_vector(1, 0) + Scalar(8.3196563720703107);
  ...
  const Scalar _tmp90 = _tmp52 * _tmp55 * _tmp89 - _tmp56 * _tmp89;
  const Scalar _tmp91 = _tmp76 * (-_tmp42 * _tmp89 - _tmp74 * _tmp90) + _tmp90;
  ...
  const Scalar _tmp99 = _tmp32 * (-_tmp41 * _tmp98 + _tmp65 * _tmp97);
  const Scalar _tmp100 = Scalar(1.0) * _tmp75;
  const Scalar _tmp101 = fh1 * (_tmp82 * _tmp93 - _tmp84 * _tmp87);
  ...
  _res(0, 0) = 0;
  _res(1, 0) =
      -_tmp99 * std::exp(_tmp101 * _tmp32 * (-_tmp100 * _tmp41 * _tmp70 + _tmp100 * _tmp65) +
                         _tmp32 * _tmp88 * (_tmp77 * _tmp81 + _tmp79 * _tmp80 + Scalar(1.0)) +
                         _tmp32 * _tmp94 * (_tmp80 * _tmp92 + _tmp81 * _tmp91) + _tmp95 * _tmp99);
  _res(2, 0) = -_tmp98 * std::exp(_tmp102 * _tmp70 + _tmp103 * _tmp70 - _tmp43 * _tmp79 * _tmp88 -
                                  _tmp43 * _tmp92 * _tmp94);
  _res(3, 0) =
      _tmp97 * std::exp(-_tmp102 - _tmp103 - _tmp72 * _tmp77 * _tmp88 - _tmp72 * _tmp91 * _tmp94);
