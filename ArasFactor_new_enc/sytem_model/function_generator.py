...
def fkSolver(lc_cat_measure, rtation_init, params_, fk_result):
    ...
    def FK_residual_func_cost1_wrt_pulley(fh1: sf.Symbol('fh1'), fv1: sf.Symbol('fv1'), 
                       DeltaRot: sf.Rot3.symbolic("DeltaRot"),
                       position_vector: sf.Vector3.symbolic("position_vector"),
                       Rot_init: sf.Rot3.symbolic("Rot_init"), 
                       encoder: sf.V4.symbolic('encoder'),
        ...
        diff_position_vector = cost.jacobian(pulley)
        return sf.Matrix(diff_position_vector)
    resedual_func_codegen = codegen.Codegen.function(func=FK_residual_func_cost1_wrt_pulley, config=codegen.CppConfig(),)
    resedual_func_codegen_data = resedual_func_codegen.generate_function(output_dir=out_put_save_directory)
    ...
    def FK_residual_func_cost2_wrt_pulley(fh1: sf.Symbol('fh1'), fv1: sf.Symbol('fv1'), 
                       DeltaRot: sf.Rot3.symbolic("DeltaRot"),
                       position_vector: sf.Vector3.symbolic("position_vector"),
                       Rot_init: sf.Rot3.symbolic("Rot_init"), 
                       encoder: sf.V4.symbolic('encoder'),
        ...
        diff_position_vector = cost.jacobian(pulley)
        return sf.Matrix(diff_position_vector)
    resedual_func_codegen = codegen.Codegen.function(func=FK_residual_func_cost2_wrt_pulley, config=codegen.CppConfig(),)
    resedual_func_codegen_data = resedual_func_codegen.generate_function(output_dir=out_put_save_directory)
    ...
    def FK_residual_func_cost3_wrt_pulley(fh1: sf.Symbol('fh1'), fv1: sf.Symbol('fv1'), 
                       DeltaRot: sf.Rot3.symbolic("DeltaRot"),
                       position_vector: sf.Vector3.symbolic("position_vector"),
                       Rot_init: sf.Rot3.symbolic("Rot_init"), 
                       encoder: sf.V4.symbolic('encoder'),
        ...
        diff_position_vector = cost.jacobian(pulley)
        return sf.Matrix(diff_position_vector)
    resedual_func_codegen = codegen.Codegen.function(func=FK_residual_func_cost3_wrt_pulley, config=codegen.CppConfig(),)
    resedual_func_codegen_data = resedual_func_codegen.generate_function(output_dir=out_put_save_directory)
...
pulley_matrix = sf.M43.symbolic("pulley")
...
cale_robo_param_forward .setPulleyPoses(sf.Vector3(pulley_matrix[0,:].transpose()), sf.Vector3(pulley_matrix[1,:].transpose()), sf.Vector3(pulley_matrix[2,:].transpose()), sf.Vector3(pulley_matrix[3,:].transpose()))
