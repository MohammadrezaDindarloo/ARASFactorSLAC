...
Eigen::Matrix<Scalar, 4, 1> FkResidualFuncCost3(
  ...
  const Scalar _tmp46 = -Scalar(0.010999999999999999) * _tmp10 -
  ...
  const Scalar _tmp74 = _tmp72 * (-_tmp50 + _tmp73);
  ...
  const Scalar _tmp81 = _tmp53 + _tmp9;
  ...
  const Scalar _tmp92 = _tmp44 * _tmp58 - _tmp50 * _tmp64 + _tmp54 * _tmp58;
  ...
  const Scalar _tmp125 = _tmp106 * _tmp124 + Scalar(5.1796800000000003) * _tmp26 + _tmp29 * fv1;
  ...
  const Scalar _tmp136 = -_tmp114 * _tmp124 - Scalar(5.1796800000000003) * _tmp15 - _tmp18 * fv1;
  const Scalar _tmp137 = _tmp72 * (_tmp127 * _tmp129 + Scalar(1.0));
  ...
  const Scalar _tmp152 = _tmp91 * fh1;
  const Scalar _tmp153 =
      _tmp106 * _tmp152 * _tmp98 + _tmp112 * _tmp114 * _tmp152 + _tmp145 + _tmp146;
  ...
  _res(3, 0) =
      _tmp156 * (-std::sinh(Scalar(1.0) * _tmp155) -
                 std::sinh(Scalar(0.1034955) * _tmp154 *
                           (-_tmp155 * _tmp156 -
