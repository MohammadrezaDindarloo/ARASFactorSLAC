...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl19(
  ...
  const Scalar _tmp44 = _tmp40 + Scalar(8.3196563720703107);
  const Scalar _tmp45 = _tmp43 + Scalar(1.9874742031097401);
  ...
  const Scalar _tmp62 = _tmp48 * _tmp57 - _tmp58 * _tmp61;
  const Scalar _tmp63 = Scalar(1.0) / (_tmp47 * _tmp58 - _tmp57);
  ...
  const Scalar _tmp68 = Scalar(1.0) / (_tmp50 + _tmp67);
  const Scalar _tmp69 = Scalar(1.0) * _tmp42;
  const Scalar _tmp70 = -_tmp53 + _tmp69;
  const Scalar _tmp71 = _tmp68 * _tmp70;
  const Scalar _tmp72 = -_tmp48 * _tmp58 + _tmp58 * _tmp60;
  const Scalar _tmp73 = -_tmp60 + _tmp64 * _tmp72 - _tmp65 * _tmp71;
  const Scalar _tmp74 = _tmp32 + _tmp59;
  const Scalar _tmp75 = _tmp38 + _tmp49;
  const Scalar _tmp76 = _tmp75 + position_vector(1, 0);
  const Scalar _tmp77 = _tmp76 + Scalar(8.3885017487099702);
  const Scalar _tmp78 = _tmp41 + _tmp5;
  ...
  const Scalar _tmp84 = _tmp47 * _tmp82 - _tmp83;
  const Scalar _tmp85 = _tmp63 * _tmp84;
  const Scalar _tmp86 = -_tmp61 * _tmp82 - _tmp62 * _tmp85 + _tmp74 * _tmp83;
  const Scalar _tmp87 = _tmp60 * _tmp82 - _tmp71 * _tmp86 - _tmp72 * _tmp85 - _tmp74 * _tmp82;
  ...
  const Scalar _tmp92 = _tmp91 * (-_tmp39 * _tmp45 * _tmp90 + _tmp42 * _tmp44 * _tmp90);
  const Scalar _tmp93 = _tmp50 * _tmp58 - _tmp53 * _tmp57 + _tmp58 * _tmp92;
  const Scalar _tmp94 = _tmp75 * _tmp82 - _tmp78 * _tmp83 + _tmp82 * _tmp92 - _tmp85 * _tmp93;
  ...
  const Scalar _tmp101 = -_tmp100 * _tmp99 - _tmp47;
  const Scalar _tmp102 = _tmp58 * _tmp63;
  ...
  const Scalar _tmp110 = _tmp66 * _tmp71 + _tmp69;
  const Scalar _tmp111 = 0;
  const Scalar _tmp112 = _tmp111 * _tmp88;
  const Scalar _tmp113 = _tmp58 * _tmp85;
  const Scalar _tmp114 = Scalar(1.0) * _tmp63;
  const Scalar _tmp115 = Scalar(1.0) * _tmp68;
  const Scalar _tmp116 = -_tmp114 * _tmp72 + _tmp115 * _tmp62 * _tmp63 * _tmp70;
  const Scalar _tmp117 = _tmp97 * (-_tmp114 * _tmp93 - _tmp116 * _tmp95);
  const Scalar _tmp118 = _tmp116 + _tmp117;
  const Scalar _tmp119 = -_tmp100 * _tmp118 + Scalar(1.0);
  const Scalar _tmp120 = _tmp105 * _tmp106;
  const Scalar _tmp121 = _tmp120 * fh1;
  const Scalar _tmp122 = Scalar(1.0) * _tmp96;
  const Scalar _tmp123 = fh1 * (-_tmp107 * _tmp28 + _tmp120 * _tmp18);
  const Scalar _tmp124 = -_tmp108 * _tmp91 * (_tmp101 * _tmp102 + _tmp103 * _tmp99 + Scalar(1.0)) -
                         _tmp109 * _tmp91 * (-_tmp112 * _tmp113 + _tmp112 * _tmp82) -
                         _tmp121 * _tmp91 * (_tmp102 * _tmp119 + _tmp103 * _tmp118) -
                         _tmp123 * _tmp91 * (-_tmp113 * _tmp122 + _tmp122 * _tmp82);
  ...
  const Scalar _tmp132 = _tmp107 * _tmp131 + Scalar(5.1796800000000003) * _tmp12 + _tmp18 * fv1;
  const Scalar _tmp133 = -_tmp122 * _tmp86 + _tmp130 * _tmp97;
  const Scalar _tmp134 = _tmp129 * _tmp97;
  const Scalar _tmp135 = _tmp126 * _tmp128;
  const Scalar _tmp136 = _tmp86 * _tmp88;
  const Scalar _tmp137 = -_tmp114 * _tmp62 + _tmp117 * _tmp135 - _tmp118 * _tmp136;
  const Scalar _tmp138 = _tmp127 * _tmp129 + Scalar(1.0);
  const Scalar _tmp139 = -_tmp120 * _tmp131 - Scalar(5.1796800000000003) * _tmp25 - _tmp28 * fv1;
  const Scalar _tmp140 = _tmp135 * _tmp98 - _tmp136 * _tmp99 + _tmp65;
  const Scalar _tmp141 = _tmp110 * _tmp128;
  const Scalar _tmp142 = -_tmp111 * _tmp136 - _tmp126 * _tmp141 + _tmp67;
  const Scalar _tmp143 = std::asinh(
      _tmp125 * (Scalar(1.0) * _tmp108 * (-_tmp115 * _tmp140 + _tmp129 * _tmp98) +
                 Scalar(1.0) * _tmp109 * (-_tmp110 * _tmp129 - _tmp115 * _tmp142 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp121 * (-_tmp115 * _tmp137 + _tmp117 * _tmp129) +
                 Scalar(1.0) * _tmp123 * (-_tmp115 * _tmp133 + _tmp134) +
                 Scalar(1.0) * _tmp132 * (-_tmp129 + _tmp130 * _tmp68) +
                 Scalar(1.0) * _tmp139 * (-_tmp115 * _tmp138 + _tmp129 * _tmp71)));
  const Scalar _tmp144 = Scalar(9.6622558468725703) * _tmp124;
  const Scalar _tmp145 = _tmp122 * _tmp123;
  const Scalar _tmp146 = _tmp109 * _tmp112;
  const Scalar _tmp147 =
      _tmp101 * _tmp108 * _tmp63 + _tmp119 * _tmp121 * _tmp63 - _tmp145 * _tmp85 - _tmp146 * _tmp85;
  const Scalar _tmp148 = Scalar(1.0) / (_tmp147);
  const Scalar _tmp149 = _tmp139 * _tmp68;
  const Scalar _tmp150 = _tmp129 * _tmp132;
  const Scalar _tmp151 =
      std::asinh(_tmp148 * (_tmp108 * _tmp140 * _tmp68 + _tmp109 * _tmp142 * _tmp68 +
                            _tmp121 * _tmp137 * _tmp68 + _tmp123 * _tmp133 * _tmp68 -
                            _tmp126 * _tmp150 * _tmp68 + _tmp138 * _tmp149));
  const Scalar _tmp152 = Scalar(9.6622558468725703) * _tmp147;
  const Scalar _tmp153 = _tmp108 * _tmp88 * _tmp99 + _tmp118 * _tmp121 * _tmp88 + _tmp145 + _tmp146;
  const Scalar _tmp154 = Scalar(1.0) / (_tmp153);
  const Scalar _tmp155 = std::asinh(_tmp154 * (-_tmp108 * _tmp128 * _tmp98 + _tmp109 * _tmp141 -
                                               _tmp117 * _tmp121 * _tmp128 - _tmp123 * _tmp134 -
                                               _tmp129 * _tmp149 * _tmp70 + _tmp150));
  ...
  _res(1, 0) =
      -_tmp144 *
          (Scalar(0.87679799777269396) * _tmp125 + std::cosh(Scalar(1.0) * _tmp143) -
           std::cosh(
                ...
                Scalar(8.3196563720703107) *
                    std::sqrt(Scalar(
                        ...
                        Scalar(0.057067943527034905) *
                            std::pow(Scalar(-Scalar(0.50315118477277876) * _tmp43 - 1),
                                     Scalar(2))))))) +
      _tmp60 + position_vector(2, 0);
  _res(2, 0) =
      -_tmp152 *
          (Scalar(0.86564762886483004) * _tmp148 + std::cosh(Scalar(1.0) * _tmp151) -
           std::cosh(Scalar(0.1034955) * _tmp148 *
                     (-_tmp151 * _tmp152 -
                      Scalar(4.7744369927459998) *
                          std::sqrt(Scalar(
                              std::pow(Scalar(1 - Scalar(0.2094487793051498) * _tmp51), Scalar(2)) +
                              Scalar(0.32387954179207445) *
                                  std::pow(Scalar(1 - Scalar(0.36803241838814449) * _tmp54),
                                           Scalar(2))))))) +
               ...
               (-_tmp155 * _tmp156 -
                Scalar(8.3885017487099702) *
                    std::sqrt(Scalar(
                        ...
                        std::pow(Scalar(-Scalar(0.11921079949155229) * _tmp76 - 1),
                                 Scalar(2))))))) +
