...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl7(
  ...
  const Scalar _tmp64 = _tmp39 + Scalar(8.3196563720703107);
  const Scalar _tmp65 = _tmp42 + Scalar(1.9874742031097401);
  const Scalar _tmp66 = Scalar(1.0) / (_tmp65);
  const Scalar _tmp67 = _tmp64 * _tmp66;
  const Scalar _tmp68 = _tmp35 + _tmp53;
  const Scalar _tmp69 = _tmp61 * _tmp62;
  const Scalar _tmp70 = _tmp68 * _tmp69;
  const Scalar _tmp71 = _tmp55 * _tmp63 - _tmp67 * _tmp70;
  const Scalar _tmp72 = _tmp46 * _tmp51;
  const Scalar _tmp73 = _tmp52 * _tmp67 - _tmp72;
  const Scalar _tmp74 = Scalar(1.0) / (-_tmp63 + _tmp67 * _tmp69);
  const Scalar _tmp75 = _tmp73 * _tmp74;
  const Scalar _tmp76 = _tmp32 + _tmp54;
  const Scalar _tmp77 = _tmp67 * _tmp68;
  const Scalar _tmp78 = -_tmp52 * _tmp77 - _tmp71 * _tmp75 + _tmp72 * _tmp76;
  ...
  const Scalar _tmp84 = -_tmp55 * _tmp69 + _tmp70;
  const Scalar _tmp85 = _tmp52 * _tmp68 - _tmp52 * _tmp76 - _tmp75 * _tmp84 - _tmp78 * _tmp83;
  const Scalar _tmp86 = Scalar(1.0) / (_tmp85);
  const Scalar _tmp87 = _tmp79 * _tmp83 + _tmp82;
  const Scalar _tmp88 = 0;
  const Scalar _tmp89 = _tmp86 * _tmp88;
  const Scalar _tmp90 = _tmp69 * _tmp74;
  const Scalar _tmp91 = _tmp73 * _tmp86;
  ...
  const Scalar _tmp96 = _tmp94 * (-_tmp38 * _tmp65 * _tmp95 + _tmp41 * _tmp64 * _tmp95);
  const Scalar _tmp97 = _tmp56 * _tmp69 - _tmp59 * _tmp63 + _tmp69 * _tmp96;
  const Scalar _tmp98 = _tmp67 * _tmp74;
  const Scalar _tmp99 = _tmp71 * _tmp98 + _tmp77;
  const Scalar _tmp100 = -_tmp68 - _tmp83 * _tmp99 + _tmp84 * _tmp98;
  const Scalar _tmp101 = _tmp44 * _tmp52 - _tmp48 * _tmp72 + _tmp52 * _tmp96 - _tmp75 * _tmp97;
  ...
  const Scalar _tmp107 = -_tmp106 * _tmp91 - _tmp67;
  ...
  const Scalar _tmp123 = _tmp103 * _tmp114 * _tmp73;
  const Scalar _tmp124 = fh1 * (-_tmp112 * _tmp18 + _tmp120 * _tmp28);
  const Scalar _tmp125 = -_tmp113 * _tmp94 * (_tmp106 * _tmp108 + _tmp107 * _tmp90 + Scalar(1.0)) -
                         _tmp121 * _tmp94 * (_tmp108 * _tmp118 + _tmp119 * _tmp90) -
                         _tmp124 * _tmp94 * (_tmp122 * _tmp52 - _tmp123 * _tmp69) -
                         _tmp43 * _tmp94 * (_tmp52 * _tmp89 - _tmp90 * _tmp92);
  const Scalar _tmp126 = Scalar(1.0) / (_tmp125);
  const Scalar _tmp127 = _tmp78 * _tmp86;
  const Scalar _tmp128 = _tmp44 + _tmp80;
  ...
  const Scalar _tmp137 = -_tmp122 * _tmp78 + _tmp128 * _tmp136;
  const Scalar _tmp138 = _tmp36 * fh1;
  const Scalar _tmp139 = _tmp112 * _tmp138 + Scalar(5.1796800000000003) * _tmp24 + _tmp28 * fv1;
  const Scalar _tmp140 = _tmp128 * _tmp81;
  const Scalar _tmp141 = -_tmp120 * _tmp138 - Scalar(5.1796800000000003) * _tmp15 - _tmp18 * fv1;
  const Scalar _tmp142 = _tmp129 * _tmp134 + Scalar(1.0);
  const Scalar _tmp143 = _tmp134 * _tmp83;
  const Scalar _tmp144 = _tmp130 * _tmp87;
  const Scalar _tmp145 = -_tmp127 * _tmp88 - _tmp128 * _tmp144 + _tmp80;
  const Scalar _tmp146 = std::asinh(
      _tmp126 * (Scalar(1.0) * _tmp113 * (_tmp105 * _tmp134 - _tmp132 * _tmp133) +
                 ...
                 Scalar(1.0) * _tmp124 * (-_tmp133 * _tmp137 + _tmp136) +
                 Scalar(1.0) * _tmp139 * (_tmp134 * _tmp140 - _tmp134) +
                 Scalar(1.0) * _tmp141 * (-_tmp133 * _tmp142 + _tmp143) +
                 Scalar(1.0) * _tmp43 * (-_tmp133 * _tmp145 - _tmp134 * _tmp87 + Scalar(1.0))));
  const Scalar _tmp147 = Scalar(9.6622558468725703) * _tmp125;
  const Scalar _tmp148 = _tmp134 * _tmp139;
  const Scalar _tmp149 = _tmp107 * _tmp113 * _tmp74 + _tmp119 * _tmp121 * _tmp74 -
                         _tmp123 * _tmp124 - _tmp43 * _tmp74 * _tmp92;
  const Scalar _tmp150 = Scalar(1.0) / (_tmp149);
  const Scalar _tmp151 =
      std::asinh(_tmp150 * (_tmp113 * _tmp132 * _tmp81 + _tmp121 * _tmp135 * _tmp81 +
                            _tmp124 * _tmp137 * _tmp81 - _tmp140 * _tmp148 +
                            _tmp141 * _tmp142 * _tmp81 + _tmp145 * _tmp43 * _tmp81));
  const Scalar _tmp152 = Scalar(9.6622558468725703) * _tmp149;
  const Scalar _tmp153 =
      _tmp106 * _tmp113 * _tmp86 + _tmp118 * _tmp121 * _tmp86 + _tmp122 * _tmp124 + _tmp43 * _tmp89;
  const Scalar _tmp154 = Scalar(1.0) / (_tmp153);
  const Scalar _tmp155 =
      std::asinh(_tmp154 * (-_tmp105 * _tmp113 * _tmp130 - _tmp117 * _tmp121 * _tmp130 -
                            _tmp124 * _tmp136 - _tmp141 * _tmp143 + _tmp144 * _tmp43 + _tmp148));
  ...
  _res(1, 0) =
      -_tmp147 *
          (Scalar(0.87679799777269396) * _tmp126 + std::cosh(Scalar(1.0) * _tmp146) -
           std::cosh(
                ...
                Scalar(8.3196563720703107) *
                    std::sqrt(Scalar(
                        ...
                        Scalar(0.057067943527034905) *
                            std::pow(Scalar(-Scalar(0.50315118477277876) * _tmp42 - 1),
                                     Scalar(2))))))) +
           ...
           std::cosh(
               ...
               (-_tmp151 * _tmp152 -
                Scalar(4.83288938413423) *
                    std::sqrt(Scalar(
                        std::pow(Scalar(1 - Scalar(0.20691555724053495) * _tmp57), Scalar(2)) +
                        Scalar(0.13818785160942856) *
                            std::pow(Scalar(-Scalar(0.55661923802822921) * _tmp60 - 1),
                                     Scalar(2))))))) +
      _tmp55 + position_vector(2, 0);
  _res(3, 0) =
      -_tmp156 *
                      ...
                      Scalar(4.7744369927459998) *
                          std::sqrt(Scalar(
                              ...
                              Scalar(0.32387954179207445) *
                                  std::pow(Scalar(1 - Scalar(0.36803241838814449) * _tmp49),
                                           Scalar(2))))))) +
