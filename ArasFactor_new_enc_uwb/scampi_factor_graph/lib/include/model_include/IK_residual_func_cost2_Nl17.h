...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl17(
  ...
  const Scalar _tmp65 = -_tmp53 + _tmp61;
  ...
  const Scalar _tmp81 = _tmp32 + _tmp70;
  const Scalar _tmp82 = _tmp35 + _tmp69;
  const Scalar _tmp83 = _tmp57 * _tmp82;
  const Scalar _tmp84 = -_tmp47 * _tmp83 + _tmp58 * _tmp81;
  const Scalar _tmp85 = _tmp47 * _tmp79 - _tmp80;
  const Scalar _tmp86 = _tmp59 * _tmp85;
  const Scalar _tmp87 = _tmp79 * _tmp82;
  const Scalar _tmp88 = -_tmp47 * _tmp87 + _tmp71 * _tmp80 - _tmp84 * _tmp86;
  const Scalar _tmp89 = -_tmp57 * _tmp81 + _tmp83;
  const Scalar _tmp90 = -_tmp66 * _tmp88 - _tmp71 * _tmp79 - _tmp86 * _tmp89 + _tmp87;
  const Scalar _tmp91 = Scalar(1.0) / (_tmp90);
  const Scalar _tmp92 = _tmp85 * _tmp91;
  const Scalar _tmp93 = _tmp68 * _tmp92;
  const Scalar _tmp94 = _tmp68 * _tmp91;
  const Scalar _tmp95 =
  ...
  const Scalar _tmp98 = _tmp96 * (-_tmp39 * _tmp45 * _tmp97 + _tmp41 * _tmp43 * _tmp97);
  const Scalar _tmp99 = _tmp49 * _tmp57 - _tmp53 * _tmp58 + _tmp57 * _tmp98;
  const Scalar _tmp100 = -_tmp72 * _tmp80 + _tmp75 * _tmp79 + _tmp79 * _tmp98 - _tmp86 * _tmp99;
  ...
  const Scalar _tmp111 = -_tmp109 * _tmp89 + _tmp110 * _tmp59 * _tmp65 * _tmp84;
  const Scalar _tmp112 = _tmp100 * _tmp91;
  const Scalar _tmp113 = _tmp101 * _tmp90;
  const Scalar _tmp114 = _tmp113 * (-_tmp109 * _tmp99 - _tmp111 * _tmp112);
  ...
  const Scalar _tmp120 = _tmp119 * _tmp84 + _tmp47 * _tmp82;
  const Scalar _tmp121 = _tmp119 * _tmp89 - _tmp120 * _tmp66 - _tmp82;
  const Scalar _tmp122 = _tmp113 * (-_tmp112 * _tmp121 + _tmp119 * _tmp99 - _tmp98);
  const Scalar _tmp123 = _tmp121 + _tmp122;
  const Scalar _tmp124 = -_tmp123 * _tmp92 - _tmp47;
  const Scalar _tmp125 = _tmp107 * fh1;
  const Scalar _tmp126 = -_tmp108 * _tmp96 * (-_tmp102 * _tmp57 * _tmp86 + _tmp102 * _tmp79) -
                         _tmp118 * _tmp96 * (_tmp115 * _tmp117 + _tmp116 * _tmp60) -
                         _tmp125 * _tmp96 * (_tmp117 * _tmp123 + _tmp124 * _tmp60 + Scalar(1.0)) -
                         _tmp37 * _tmp96 * (-_tmp60 * _tmp93 + _tmp79 * _tmp94);
  const Scalar _tmp127 = Scalar(1.0) / (_tmp126);
  const Scalar _tmp128 = _tmp36 * fh1;
  const Scalar _tmp129 = _tmp107 * _tmp128 + Scalar(5.1796800000000003) * _tmp14 + _tmp17 * fv1;
  const Scalar _tmp130 = _tmp63 + _tmp75;
  const Scalar _tmp131 = _tmp130 * _tmp66;
  const Scalar _tmp132 = Scalar(1.0) / (-_tmp131 + _tmp61 - _tmp72);
  const Scalar _tmp133 = Scalar(1.0) * _tmp132;
  const Scalar _tmp134 = _tmp130 * _tmp64;
  const Scalar _tmp135 = -_tmp106 * _tmp128 - Scalar(5.1796800000000003) * _tmp24 - _tmp27 * fv1;
  const Scalar _tmp136 = _tmp131 * _tmp133 + Scalar(1.0);
  const Scalar _tmp137 = _tmp88 * _tmp91;
  const Scalar _tmp138 = _tmp132 * _tmp67;
  const Scalar _tmp139 = -_tmp130 * _tmp138 - _tmp137 * _tmp68 + _tmp63;
  const Scalar _tmp140 = _tmp130 * _tmp132;
  const Scalar _tmp141 = -_tmp109 * _tmp84 + _tmp114 * _tmp140 - _tmp115 * _tmp137;
  const Scalar _tmp142 = _tmp113 * _tmp133;
  const Scalar _tmp143 = -_tmp102 * _tmp88 + _tmp130 * _tmp142;
  const Scalar _tmp144 = _tmp120 + _tmp122 * _tmp140 - _tmp123 * _tmp137;
  const Scalar _tmp145 = std::asinh(
      _tmp127 * (Scalar(1.0) * _tmp108 * (-_tmp110 * _tmp143 + _tmp142) +
                 Scalar(1.0) * _tmp118 * (-_tmp110 * _tmp141 + _tmp114 * _tmp133) +
                 Scalar(1.0) * _tmp125 * (-_tmp110 * _tmp144 + _tmp122 * _tmp133) +
                 Scalar(1.0) * _tmp129 * (_tmp133 * _tmp134 - _tmp133) +
                 Scalar(1.0) * _tmp135 * (-_tmp110 * _tmp136 + _tmp133 * _tmp66) +
                 Scalar(1.0) * _tmp37 * (-_tmp110 * _tmp139 - _tmp133 * _tmp67 + Scalar(1.0))));
  ...
  const Scalar _tmp149 = _tmp116 * _tmp118 * _tmp59 + _tmp124 * _tmp125 * _tmp59 -
                         _tmp148 * _tmp86 - _tmp37 * _tmp59 * _tmp93;
  const Scalar _tmp150 = Scalar(1.0) / (_tmp149);
  const Scalar _tmp151 = Scalar(6.347051629636093) *
  ...
  const Scalar _tmp153 = _tmp135 * _tmp64;
  const Scalar _tmp154 =
      std::asinh(_tmp150 * (_tmp108 * _tmp143 * _tmp64 + _tmp118 * _tmp141 * _tmp64 +
                            _tmp125 * _tmp144 * _tmp64 - _tmp134 * _tmp152 + _tmp136 * _tmp153 +
                            _tmp139 * _tmp37 * _tmp64));
  const Scalar _tmp155 = Scalar(9.6622558468725703) * _tmp149;
  const Scalar _tmp156 =
      _tmp115 * _tmp118 * _tmp91 + _tmp123 * _tmp125 * _tmp91 + _tmp148 + _tmp37 * _tmp94;
  const Scalar _tmp157 = Scalar(1.0) / (_tmp156);
  const Scalar _tmp158 = std::asinh(
      _tmp157 * (-_tmp108 * _tmp142 - _tmp114 * _tmp118 * _tmp132 - _tmp122 * _tmp125 * _tmp132 -
                 _tmp133 * _tmp153 * _tmp65 + _tmp138 * _tmp37 + _tmp152));
  ...
  _res(1, 0) =
      _tmp147 *
          (-std::sinh(Scalar(1.0) * _tmp145) -
           std::sinh(Scalar(0.1034955) * _tmp127 * (-_tmp145 * _tmp147 - std::sqrt(_tmp146)))) -
      Scalar(8.3701287145205097) *
          std::sqrt(Scalar(Scalar(0.014273672465547484) * _tmp146 +
                           std::pow(Scalar(-Scalar(0.11947247576553975) * _tmp82 -
                                           Scalar(0.11947247576553975) * position_vector(2, 0) + 1),
                                    Scalar(2))));
  _res(2, 0) =
      _tmp155 *
          (-std::sinh(Scalar(1.0) * _tmp154) -
           std::sinh(Scalar(0.1034955) * _tmp150 * (-std::sqrt(_tmp151) - _tmp154 * _tmp155))) -
      Scalar(8.4690207536791995) *
          std::sqrt(Scalar(Scalar(0.013942273753185566) * _tmp151 +
                           std::pow(Scalar(-Scalar(0.11807740576920533) * _tmp81 -
