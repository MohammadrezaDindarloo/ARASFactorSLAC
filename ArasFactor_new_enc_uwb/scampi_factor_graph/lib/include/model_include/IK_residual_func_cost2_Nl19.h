...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl19(
  ...
  const Scalar _tmp46 = Scalar(69.216682149330126) *
  ...
  const Scalar _tmp47 = _tmp42 + Scalar(8.3196563720703107);
  const Scalar _tmp48 = _tmp45 + Scalar(1.9874742031097401);
  ...
  const Scalar _tmp61 = Scalar(1.0) / (_tmp50 * _tmp60 - _tmp59);
  const Scalar _tmp62 = _tmp34 + _tmp35;
  const Scalar _tmp63 = _tmp33 + _tmp62;
  const Scalar _tmp64 = _tmp39 * _tmp50;
  const Scalar _tmp65 = _tmp61 * (_tmp59 * _tmp63 - _tmp60 * _tmp64);
  const Scalar _tmp66 = _tmp50 * _tmp65 + _tmp64;
  const Scalar _tmp67 = Scalar(1.0) * _tmp41;
  const Scalar _tmp68 = -_tmp67;
  const Scalar _tmp69 = Scalar(1.0) / (_tmp51 + _tmp68);
  const Scalar _tmp70 = Scalar(1.0) * _tmp44;
  const Scalar _tmp71 = -_tmp55 + _tmp70;
  const Scalar _tmp72 = _tmp69 * _tmp71;
  const Scalar _tmp73 = _tmp61 * (_tmp39 * _tmp60 - _tmp60 * _tmp63);
  const Scalar _tmp74 = -_tmp39 + _tmp50 * _tmp73 - _tmp66 * _tmp72;
  const Scalar _tmp75 = _tmp38 + _tmp62;
  const Scalar _tmp76 = _tmp20 + _tmp40;
  const Scalar _tmp77 = _tmp76 + position_vector(1, 0);
  const Scalar _tmp78 = _tmp77 + Scalar(8.3885017487099702);
  const Scalar _tmp79 = _tmp43 + _tmp54;
  ...
  const Scalar _tmp85 = _tmp50 * _tmp83 - _tmp84;
  const Scalar _tmp86 = -_tmp64 * _tmp83 - _tmp65 * _tmp85 + _tmp75 * _tmp84;
  const Scalar _tmp87 = _tmp39 * _tmp83 - _tmp72 * _tmp86 - _tmp73 * _tmp85 - _tmp75 * _tmp83;
  ...
  const Scalar _tmp92 = _tmp91 * (-_tmp41 * _tmp48 * _tmp90 + _tmp44 * _tmp47 * _tmp90);
  const Scalar _tmp93 = _tmp61 * (_tmp51 * _tmp60 - _tmp55 * _tmp59 + _tmp60 * _tmp92);
  ...
  const Scalar _tmp98 = _tmp97 * (_tmp50 * _tmp93 - _tmp74 * _tmp95 - _tmp92);
  ...
  const Scalar _tmp104 = _tmp19 + Scalar(1.7965602546229);
  ...
  const Scalar _tmp110 = _tmp67 * _tmp72 + _tmp70;
  const Scalar _tmp111 = 0;
  const Scalar _tmp112 = _tmp111 * _tmp88;
  const Scalar _tmp113 = _tmp100 * _tmp111;
  const Scalar _tmp114 = Scalar(1.0) * _tmp69;
  const Scalar _tmp115 = _tmp114 * _tmp65 * _tmp71 - Scalar(1.0) * _tmp73;
  ...
  const Scalar _tmp122 = fh1 * (-_tmp107 * _tmp29 + _tmp119 * _tmp18);
  ...
  const Scalar _tmp125 = _tmp68 + _tmp76;
  const Scalar _tmp126 = _tmp125 * _tmp72;
  const Scalar _tmp127 = Scalar(1.0) / (-_tmp126 + _tmp70 - _tmp79);
  const Scalar _tmp128 = Scalar(1.0) * _tmp127;
  const Scalar _tmp129 = _tmp125 * _tmp128;
  const Scalar _tmp130 = _tmp37 * fh1;
  const Scalar _tmp131 = _tmp107 * _tmp130 + Scalar(5.1796800000000003) * _tmp12 + _tmp18 * fv1;
  ...
  const Scalar _tmp136 = _tmp116 * _tmp134 - _tmp117 * _tmp135 - Scalar(1.0) * _tmp65;
  const Scalar _tmp137 = _tmp126 * _tmp128 + Scalar(1.0);
  const Scalar _tmp138 = _tmp128 * _tmp72;
  const Scalar _tmp139 = -_tmp119 * _tmp130 - Scalar(5.1796800000000003) * _tmp26 - _tmp29 * fv1;
  const Scalar _tmp140 = _tmp134 * _tmp98 - _tmp135 * _tmp99 + _tmp66;
  const Scalar _tmp141 = _tmp110 * _tmp127;
  const Scalar _tmp142 = -_tmp111 * _tmp135 - _tmp125 * _tmp141 + _tmp68;
  const Scalar _tmp143 = std::asinh(
      _tmp124 * (Scalar(1.0) * _tmp108 * (-_tmp114 * _tmp140 + _tmp128 * _tmp98) +
                 Scalar(1.0) * _tmp109 * (-_tmp110 * _tmp128 - _tmp114 * _tmp142 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp120 * (-_tmp114 * _tmp136 + _tmp116 * _tmp128) +
                 Scalar(1.0) * _tmp122 * (-_tmp114 * _tmp132 + _tmp133) +
                 Scalar(1.0) * _tmp131 * (-_tmp128 + _tmp129 * _tmp69) +
                 Scalar(1.0) * _tmp139 * (-_tmp114 * _tmp137 + _tmp138)));
  ...
  const Scalar _tmp147 = _tmp101 * _tmp108 * _tmp61 - _tmp109 * _tmp113 * _tmp61 +
                         _tmp118 * _tmp120 * _tmp61 - _tmp146 * _tmp61 * _tmp85;
  const Scalar _tmp148 = Scalar(1.0) / (_tmp147);
  const Scalar _tmp149 = _tmp128 * _tmp131;
  const Scalar _tmp150 =
      std::asinh(_tmp148 * (_tmp108 * _tmp140 * _tmp69 + _tmp109 * _tmp142 * _tmp69 +
                            _tmp120 * _tmp136 * _tmp69 + _tmp122 * _tmp132 * _tmp69 -
                            _tmp125 * _tmp149 * _tmp69 + _tmp137 * _tmp139 * _tmp69));
  const Scalar _tmp151 = Scalar(9.6622558468725703) * _tmp147;
  const Scalar _tmp152 = _tmp88 * fh1;
  const Scalar _tmp153 =
      _tmp107 * _tmp152 * _tmp99 + _tmp109 * _tmp112 + _tmp117 * _tmp119 * _tmp152 + _tmp146;
  ...
  const Scalar _tmp156 = std::asinh(_tmp154 * (-_tmp108 * _tmp127 * _tmp98 + _tmp109 * _tmp141 -
  ...
  _res(1, 0) =
      _tmp144 *
          (-std::sinh(Scalar(1.0) * _tmp143) -
           std::sinh(Scalar(0.1034955) * _tmp124 * (-_tmp143 * _tmp144 - std::sqrt(_tmp46)))) -
      Scalar(8.4718465805053693) *
          std::sqrt(Scalar(Scalar(0.013932974274013004) * _tmp46 +
  ...
  _res(2, 0) =
      ...
      Scalar(8.3641088633305802) *
          std::sqrt(Scalar(Scalar(0.014294226073078949) * _tmp145 +
                           std::pow(Scalar(-Scalar(0.11955846299229073) * _tmp63 -
