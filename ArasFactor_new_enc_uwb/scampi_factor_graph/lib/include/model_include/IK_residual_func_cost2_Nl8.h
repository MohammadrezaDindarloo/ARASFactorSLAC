...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl8(
  ...
  const Scalar _tmp45 = _tmp16 + _tmp42;
  ...
  const Scalar _tmp55 = _tmp47 + _tmp49;
  ...
  const Scalar _tmp60 = _tmp48 + position_vector(0, 0);
  ...
  const Scalar _tmp65 = _tmp39 + position_vector(1, 0);
  ...
  const Scalar _tmp73 = _tmp72 * (-_tmp39 * _tmp68 * _tmp70 + _tmp50 * _tmp66 * _tmp70);
  const Scalar _tmp74 = _tmp45 * _tmp64 - _tmp48 * _tmp63 + _tmp64 * _tmp73;
  const Scalar _tmp75 = _tmp66 * _tmp71;
  const Scalar _tmp76 = Scalar(1.0) / (-_tmp63 + _tmp64 * _tmp75);
  const Scalar _tmp77 = _tmp43 + position_vector(1, 0);
  ...
  const Scalar _tmp84 = _tmp75 * _tmp83 - _tmp82;
  const Scalar _tmp85 = _tmp76 * _tmp84;
  const Scalar _tmp86 = _tmp43 * _tmp83 - _tmp55 * _tmp82 + _tmp73 * _tmp83 - _tmp74 * _tmp85;
  const Scalar _tmp87 = Scalar(1.0) / (_tmp86);
  const Scalar _tmp88 = _tmp32 + _tmp36;
  const Scalar _tmp89 = _tmp83 * _tmp88;
  const Scalar _tmp90 = _tmp34 - _tmp35;
  const Scalar _tmp91 = _tmp32 + _tmp90;
  const Scalar _tmp92 = _tmp33 + _tmp90;
  const Scalar _tmp93 = _tmp64 * _tmp88 - _tmp64 * _tmp92;
  const Scalar _tmp94 = _tmp75 * _tmp88;
  const Scalar _tmp95 = _tmp63 * _tmp92 - _tmp64 * _tmp94;
  const Scalar _tmp96 = -_tmp75 * _tmp89 + _tmp82 * _tmp91 - _tmp85 * _tmp95;
  const Scalar _tmp97 = -_tmp53 * _tmp96 - _tmp83 * _tmp91 - _tmp85 * _tmp93 + _tmp89;
  const Scalar _tmp98 = _tmp87 * _tmp97;
  const Scalar _tmp99 = _tmp57 * _tmp98;
  const Scalar _tmp100 = Scalar(1.0) * _tmp87;
  const Scalar _tmp101 = -_tmp100 * _tmp96 + _tmp44 * _tmp99;
  const Scalar _tmp102 = Scalar(1.0) * _tmp46;
  const Scalar _tmp103 = _tmp28 + Scalar(-2.5193355532036801);
  ...
  const Scalar _tmp108 = fh1 * (-_tmp106 * _tmp17 + _tmp107 * _tmp27);
  const Scalar _tmp109 = _tmp40 * _tmp53 + _tmp51;
  const Scalar _tmp110 = 0;
  const Scalar _tmp111 = Scalar(1.0) / (_tmp97);
  const Scalar _tmp112 = _tmp111 * _tmp96;
  const Scalar _tmp113 = _tmp109 * _tmp56;
  const Scalar _tmp114 = -_tmp110 * _tmp112 - _tmp113 * _tmp44 + _tmp41;
  const Scalar _tmp115 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp116 = _tmp75 * _tmp76;
  const Scalar _tmp117 = _tmp116 * _tmp95 + _tmp94;
  const Scalar _tmp118 = _tmp116 * _tmp93 - _tmp117 * _tmp53 - _tmp88;
  const Scalar _tmp119 = _tmp111 * _tmp86;
  const Scalar _tmp120 = _tmp98 * (_tmp116 * _tmp74 - _tmp118 * _tmp119 - _tmp73);
  const Scalar _tmp121 = _tmp44 * _tmp56;
  const Scalar _tmp122 = _tmp111 * (_tmp118 + _tmp120);
  const Scalar _tmp123 = _tmp117 + _tmp120 * _tmp121 - _tmp122 * _tmp96;
  const Scalar _tmp124 = _tmp106 * fh1;
  const Scalar _tmp125 = Scalar(1.0) * _tmp76;
  const Scalar _tmp126 = _tmp102 * _tmp52 * _tmp76 * _tmp95 - _tmp125 * _tmp93;
  const Scalar _tmp127 = _tmp98 * (-_tmp119 * _tmp126 - _tmp125 * _tmp74);
  const Scalar _tmp128 = _tmp126 + _tmp127;
  const Scalar _tmp129 = -_tmp112 * _tmp128 + _tmp121 * _tmp127 - _tmp125 * _tmp95;
  const Scalar _tmp130 = _tmp107 * fh1;
  const Scalar _tmp131 = _tmp44 * _tmp46;
  const Scalar _tmp132 = _tmp37 * fh1;
  const Scalar _tmp133 = _tmp106 * _tmp132 + Scalar(5.1796800000000003) * _tmp23 + _tmp27 * fv1;
  const Scalar _tmp134 = _tmp54 * _tmp57 + Scalar(1.0);
  const Scalar _tmp135 = _tmp53 * _tmp57;
  const Scalar _tmp136 = -_tmp107 * _tmp132 - Scalar(5.1796800000000003) * _tmp14 - _tmp17 * fv1;
  const Scalar _tmp137 = _tmp125 * _tmp84 * _tmp87;
  const Scalar _tmp138 = -_tmp122 * _tmp84 - _tmp75;
  const Scalar _tmp139 = _tmp64 * _tmp76;
  const Scalar _tmp140 = _tmp111 * _tmp128;
  const Scalar _tmp141 = -_tmp140 * _tmp84 + Scalar(1.0);
  const Scalar _tmp142 = _tmp110 * _tmp111;
  const Scalar _tmp143 = -_tmp108 * _tmp72 * (_tmp100 * _tmp83 - _tmp137 * _tmp64) -
                         _tmp115 * _tmp72 * (-_tmp142 * _tmp64 * _tmp85 + _tmp142 * _tmp83) -
                         _tmp124 * _tmp72 * (_tmp122 * _tmp83 + _tmp138 * _tmp139 + Scalar(1.0)) -
                         _tmp130 * _tmp72 * (_tmp139 * _tmp141 + _tmp140 * _tmp83);
  const Scalar _tmp144 = Scalar(1.0) / (_tmp143);
  const Scalar _tmp145 = std::asinh(
      _tmp144 * (Scalar(1.0) * _tmp108 * (-_tmp101 * _tmp102 + _tmp99) +
                 Scalar(1.0) * _tmp115 * (-_tmp102 * _tmp114 - _tmp109 * _tmp57 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp124 * (-_tmp102 * _tmp123 + _tmp120 * _tmp57) +
                 Scalar(1.0) * _tmp130 * (-_tmp102 * _tmp129 + _tmp127 * _tmp57) +
                 Scalar(1.0) * _tmp133 * (_tmp131 * _tmp57 - _tmp57) +
                 Scalar(1.0) * _tmp136 * (-_tmp102 * _tmp134 + _tmp135)));
  const Scalar _tmp146 = Scalar(22.795248597701466) *
                             std::pow(Scalar(1 - Scalar(0.2094487793051498) * _tmp65), Scalar(2)) +
  ...
  const Scalar _tmp148 = _tmp115 * _tmp142;
  const Scalar _tmp149 = -_tmp108 * _tmp137 + _tmp124 * _tmp138 * _tmp76 +
                         _tmp130 * _tmp141 * _tmp76 - _tmp148 * _tmp85;
  const Scalar _tmp150 = Scalar(1.0) / (_tmp149);
  const Scalar _tmp151 = _tmp133 * _tmp57;
  const Scalar _tmp152 =
      std::asinh(_tmp150 * (_tmp101 * _tmp108 * _tmp46 + _tmp114 * _tmp115 * _tmp46 +
                            _tmp123 * _tmp124 * _tmp46 + _tmp129 * _tmp130 * _tmp46 -
                            _tmp131 * _tmp151 + _tmp134 * _tmp136 * _tmp46));
  const Scalar _tmp153 =
      Scalar(69.216682149330126) *
          std::pow(Scalar(-Scalar(0.12019727201198747) * _tmp58 - 1), Scalar(2)) +
  ...
  const Scalar _tmp155 = _tmp100 * _tmp108 + _tmp122 * _tmp124 + _tmp130 * _tmp140 + _tmp148;
  const Scalar _tmp156 = Scalar(1.0) / (_tmp155);
  const Scalar _tmp157 = Scalar(23.356819799277336) *
                             std::pow(Scalar(1 - Scalar(0.20691555724053495) * _tmp77), Scalar(2)) +
                         Scalar(3.2276287484906994) *
                             std::pow(Scalar(-Scalar(0.55661923802822921) * _tmp79 - 1), Scalar(2));
  const Scalar _tmp158 =
      std::asinh(_tmp156 * (-_tmp108 * _tmp99 + _tmp113 * _tmp115 - _tmp120 * _tmp124 * _tmp56 -
                            _tmp127 * _tmp130 * _tmp56 - _tmp135 * _tmp136 + _tmp151));
  ...
  _res(2, 0) =
      ...
      Scalar(8.4718465805053693) *
          std::sqrt(Scalar(Scalar(0.013932974274013004) * _tmp153 +
                           std::pow(Scalar(-Scalar(0.11803802045956635) * _tmp92 -
