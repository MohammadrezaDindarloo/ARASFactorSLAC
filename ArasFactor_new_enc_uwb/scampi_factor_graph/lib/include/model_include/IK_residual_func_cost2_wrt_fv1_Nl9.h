...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2WrtFv1Nl9(
  ...
  const Scalar _tmp34 = _tmp18 + _tmp5;
  const Scalar _tmp35 = _tmp34 + position_vector(1, 0);
  const Scalar _tmp36 = _tmp35 + Scalar(-4.7744369927459998);
  ...
  const Scalar _tmp62 = -_tmp56;
  const Scalar _tmp63 = _tmp59 + _tmp62;
  const Scalar _tmp64 = _tmp55 * (-_tmp54 * _tmp63 + _tmp61);
  const Scalar _tmp65 = _tmp55 * (-_tmp42 * _tmp61 + _tmp53 * _tmp63);
  const Scalar _tmp66 = _tmp42 * _tmp60;
  ...
  const Scalar _tmp72 = _tmp70 * (-_tmp49 + _tmp71);
  const Scalar _tmp73 = _tmp42 * _tmp64 - _tmp60 - _tmp67 * _tmp72;
  const Scalar _tmp74 = _tmp57 - _tmp58;
  const Scalar _tmp75 = _tmp62 + _tmp74;
  const Scalar _tmp76 = _tmp28 + _tmp48;
  ...
  const Scalar _tmp86 = -_tmp65 * _tmp85 - _tmp66 * _tmp83 + _tmp75 * _tmp84;
  const Scalar _tmp87 = _tmp60 * _tmp83 - _tmp64 * _tmp85 - _tmp72 * _tmp86 - _tmp75 * _tmp83;
  const Scalar _tmp88 = Scalar(1.0) / (_tmp87);
  const Scalar _tmp89 =
      std::sqrt(Scalar(std::pow(_tmp36, Scalar(2)) + std::pow(_tmp40, Scalar(2))));
  const Scalar _tmp90 = Scalar(1.0) / (_tmp89);
  const Scalar _tmp91 = _tmp41 * _tmp89;
  const Scalar _tmp92 = _tmp91 * (-_tmp34 * _tmp40 * _tmp90 + _tmp36 * _tmp38 * _tmp90);
  const Scalar _tmp93 = _tmp55 * (_tmp45 * _tmp54 - _tmp49 * _tmp53 + _tmp54 * _tmp92);
  const Scalar _tmp94 = -_tmp76 * _tmp84 + _tmp79 * _tmp83 + _tmp83 * _tmp92 - _tmp85 * _tmp93;
  const Scalar _tmp95 = _tmp88 * _tmp94;
  const Scalar _tmp96 = Scalar(1.0) / (_tmp94);
  const Scalar _tmp97 = _tmp87 * _tmp96;
  const Scalar _tmp98 = _tmp97 * (_tmp42 * _tmp93 - _tmp73 * _tmp95 - _tmp92);
  const Scalar _tmp99 = _tmp73 + _tmp98;
  const Scalar _tmp100 = _tmp83 * _tmp88;
  const Scalar _tmp101 = _tmp85 * _tmp88;
  const Scalar _tmp102 = -_tmp101 * _tmp99 - _tmp42;
  const Scalar _tmp103 = _tmp54 * _tmp55;
  const Scalar _tmp104 = _tmp30 + Scalar(-2.5193355532036801);
  ...
  const Scalar _tmp123 = _tmp91 * (-_tmp103 * _tmp122 + _tmp121 * _tmp83);
  const Scalar _tmp124 = -_tmp108 * _tmp91 * (_tmp100 * _tmp99 + _tmp102 * _tmp103 + Scalar(1.0)) -
                         _tmp115 * _tmp91 * (_tmp100 * _tmp112 + _tmp103 * _tmp113) -
                         _tmp117 * _tmp91 * (-_tmp103 * _tmp116 * _tmp85 + _tmp116 * _tmp83) -
                         _tmp118 * _tmp123;
  const Scalar _tmp125 = Scalar(1.0) / (_tmp124);
  const Scalar _tmp126 = _tmp69 + _tmp79;
  const Scalar _tmp127 = _tmp126 * _tmp72;
  const Scalar _tmp128 = Scalar(1.0) / (-_tmp127 + _tmp71 - _tmp76);
  const Scalar _tmp129 = _tmp126 * _tmp128;
  const Scalar _tmp130 = _tmp86 * _tmp88;
  const Scalar _tmp131 = _tmp129 * _tmp98 - _tmp130 * _tmp99 + _tmp67;
  const Scalar _tmp132 = Scalar(1.0) * _tmp70;
  const Scalar _tmp133 = Scalar(1.0) * _tmp128;
  const Scalar _tmp134 = _tmp119 * _tmp128;
  const Scalar _tmp135 = _tmp70 * (-_tmp120 * _tmp130 - _tmp126 * _tmp134 + _tmp69);
  const Scalar _tmp136 = -Scalar(1.0) * _tmp119 * _tmp133 - Scalar(1.0) * _tmp135 + Scalar(1.0);
  const Scalar _tmp137 = _tmp133 * _tmp97;
  const Scalar _tmp138 = -_tmp116 * _tmp86 + _tmp126 * _tmp137;
  const Scalar _tmp139 = -_tmp109 + _tmp111 * _tmp129 - _tmp112 * _tmp130;
  const Scalar _tmp140 = fh1 * (_tmp56 + _tmp74);
  const Scalar _tmp141 = _tmp107 * _tmp140 + Scalar(5.1796800000000003) * _tmp25 + _tmp29 * fv1;
  const Scalar _tmp142 = _tmp126 * _tmp70;
  const Scalar _tmp143 = Scalar(1.0) * _tmp133 * _tmp142 - Scalar(1.0) * _tmp133;
  const Scalar _tmp144 = -Scalar(5.1796800000000003) * _tmp11 - _tmp114 * _tmp140 - _tmp19 * fv1;
  const Scalar _tmp145 = _tmp70 * (_tmp127 * _tmp133 + Scalar(1.0));
  ...
  const Scalar _tmp148 = Scalar(1.0) * _tmp108 * (-_tmp131 * _tmp132 + _tmp133 * _tmp98) +
                         Scalar(1.0) * _tmp115 * (_tmp111 * _tmp133 - _tmp132 * _tmp139) +
                         Scalar(1.0) * _tmp117 * (-_tmp132 * _tmp138 + _tmp137) +
                         _tmp118 * _tmp136 + _tmp141 * _tmp143 + _tmp144 * _tmp147;
  ...
  const Scalar _tmp152 =
      ...
      Scalar(4.7744369927459998) *
          std::sqrt(
              Scalar(std::pow(Scalar(1 - Scalar(0.2094487793051498) * _tmp35), Scalar(2)) +
  ...
  const Scalar _tmp157 = _tmp12 + _tmp43 + _tmp5;
  const Scalar _tmp158 = _tmp123 * _tmp156;
  const Scalar _tmp159 =
      (_tmp125 * (-_tmp136 + _tmp143 * _tmp29 + _tmp147 * _tmp157) - _tmp148 * _tmp158) /
      std::sqrt(Scalar(std::pow(_tmp148, Scalar(2)) * _tmp156 + 1));
  const Scalar _tmp160 = _tmp133 * _tmp141;
  const Scalar _tmp161 = _tmp108 * _tmp131 * _tmp70 + _tmp115 * _tmp139 * _tmp70 +
                         _tmp117 * _tmp138 * _tmp70 + _tmp118 * _tmp135 - _tmp142 * _tmp160 +
                         _tmp144 * _tmp145;
  const Scalar _tmp162 = _tmp116 * _tmp117;
  const Scalar _tmp163 = _tmp122 * _tmp55;
  const Scalar _tmp164 = _tmp102 * _tmp108 * _tmp55 + _tmp113 * _tmp115 * _tmp55 -
                         _tmp118 * _tmp163 - _tmp162 * _tmp55 * _tmp85;
  ...
  const Scalar _tmp169 =
      ...
      Scalar(4.83288938413423) *
          std::sqrt(
              Scalar(std::pow(Scalar(1 - Scalar(0.20691555724053495) * _tmp46), Scalar(2)) +
  ...
  const Scalar _tmp174 = _tmp133 * _tmp29;
  const Scalar _tmp175 = _tmp163 * _tmp173;
  const Scalar _tmp176 =
      (-_tmp161 * _tmp175 + _tmp165 * (-_tmp135 - _tmp142 * _tmp174 + _tmp145 * _tmp157)) /
      std::sqrt(Scalar(std::pow(_tmp161, Scalar(2)) * _tmp173 + 1));
  const Scalar _tmp177 =
      _tmp108 * _tmp88 * _tmp99 + _tmp112 * _tmp115 * _tmp88 + _tmp118 * _tmp121 + _tmp162;
  const Scalar _tmp178 = Scalar(1.0) / (_tmp177);
  const Scalar _tmp179 = -_tmp108 * _tmp128 * _tmp98 - _tmp111 * _tmp115 * _tmp128 -
                         _tmp117 * _tmp137 + _tmp118 * _tmp134 - _tmp144 * _tmp146 + _tmp160;
  ...
  const Scalar _tmp186 = Scalar(9.6622558468725703) * _tmp121;
  const Scalar _tmp187 = std::pow(_tmp177, Scalar(-2));
  const Scalar _tmp188 = _tmp121 * _tmp187;
  const Scalar _tmp189 = (_tmp178 * (-_tmp134 - _tmp146 * _tmp157 + _tmp174) + _tmp179 * _tmp188) /
