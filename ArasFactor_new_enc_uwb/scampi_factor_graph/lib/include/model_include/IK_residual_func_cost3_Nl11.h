...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl11(
  ...
  const Scalar _tmp46 = Scalar(1.0) / (-_tmp32 + _tmp40 * _tmp43);
  ...
  const Scalar _tmp65 = _tmp42 * _tmp61;
  const Scalar _tmp66 = -_tmp50 * (-_tmp40 * _tmp65 - _tmp45 * _tmp64 + _tmp53 * _tmp62) -
                        _tmp51 * _tmp64 - _tmp53 * _tmp61 + _tmp65;
  ...
  const Scalar _tmp80 = _tmp43 * _tmp46;
  ...
  const Scalar _tmp89 = _tmp40 * _tmp46;
  const Scalar _tmp90 = -_tmp42 - _tmp50 * (_tmp40 * _tmp42 + _tmp45 * _tmp89) + _tmp51 * _tmp89;
  ...
  const Scalar _tmp95 = _tmp43 * _tmp64;
  ...
  const Scalar _tmp102 = _tmp46 * fh1;
  ...
  _res(2, 0) = std::exp(_tmp100 * _tmp64 + _tmp101 * _tmp64 - _tmp102 * _tmp79 * _tmp87 -
