...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl22(
  ...
  const Scalar _tmp35 = _tmp31 + position_vector(0, 0) + Scalar(1.9874742031097401);
  ...
  const Scalar _tmp50 = -_tmp31 * _tmp37 + _tmp33 * _tmp38 + _tmp38 * _tmp49;
  const Scalar _tmp51 = _tmp41 * _tmp47;
  const Scalar _tmp52 = _tmp28 * _tmp51 - _tmp29;
  const Scalar _tmp53 = Scalar(1.0) / (-_tmp37 + _tmp38 * _tmp51);
  const Scalar _tmp54 = _tmp52 * _tmp53;
  const Scalar _tmp55 = _tmp16 * _tmp28 - _tmp25 * _tmp29 + _tmp28 * _tmp49 - _tmp50 * _tmp54;
  const Scalar _tmp56 = Scalar(1.0) / (_tmp55);
  const Scalar _tmp57 = Scalar(1.0) * _tmp56;
  const Scalar _tmp58 = _tmp38 * _tmp54;
  const Scalar _tmp59 = _tmp32 + _tmp39;
  ...
  const Scalar _tmp74 = -_tmp38 * _tmp71 + _tmp38 * _tmp73;
  const Scalar _tmp75 = _tmp51 * _tmp53;
  const Scalar _tmp76 = _tmp51 * _tmp73;
  const Scalar _tmp77 = _tmp37 * _tmp71 - _tmp38 * _tmp76;
  const Scalar _tmp78 = Scalar(1.0) * _tmp43;
  const Scalar _tmp79 = Scalar(1.0) * _tmp40;
  const Scalar _tmp80 = (-_tmp31 + _tmp78) / (_tmp33 - _tmp79);
  const Scalar _tmp81 = -_tmp73 + _tmp74 * _tmp75 - _tmp80 * (_tmp75 * _tmp77 + _tmp76);
  const Scalar _tmp82 = _tmp70 + _tmp72;
  const Scalar _tmp83 = _tmp28 * _tmp73 - _tmp28 * _tmp82 - _tmp54 * _tmp74 -
                        _tmp80 * (-_tmp28 * _tmp76 + _tmp29 * _tmp82 - _tmp54 * _tmp77);
  const Scalar _tmp84 = Scalar(1.0) / (_tmp83);
  const Scalar _tmp85 = _tmp55 * _tmp84;
  const Scalar _tmp86 = _tmp56 * _tmp83;
  const Scalar _tmp87 = _tmp81 + _tmp86 * (-_tmp49 + _tmp50 * _tmp75 - _tmp81 * _tmp85);
  const Scalar _tmp88 = _tmp52 * _tmp84;
  const Scalar _tmp89 = -_tmp51 - _tmp87 * _tmp88;
  const Scalar _tmp90 = _tmp38 * _tmp53;
  const Scalar _tmp91 = _tmp28 * _tmp84;
  ...
  const Scalar _tmp97 = -_tmp74 * _tmp96 + _tmp77 * _tmp80 * _tmp96;
  const Scalar _tmp98 = _tmp86 * (-_tmp50 * _tmp96 - _tmp85 * _tmp97) + _tmp97;
  const Scalar _tmp99 = -_tmp88 * _tmp98 + Scalar(1.0);
  const Scalar _tmp100 = _tmp65 * fh1;
  const Scalar _tmp101 = _tmp93 * _tmp95;
  const Scalar _tmp102 = _tmp57 * _tmp66;

  // Output terms (1)
  Eigen::Matrix<Scalar, 4, 1> _res;

  _res(0, 0) = std::exp(-fh1);
  _res(1, 0) = std::exp(_tmp100 * _tmp48 * (_tmp90 * _tmp99 + _tmp91 * _tmp98) +
                        _tmp48 * _tmp66 * (_tmp28 * _tmp57 - _tmp57 * _tmp58) +
                        _tmp48 * _tmp92 * (_tmp87 * _tmp91 + _tmp89 * _tmp90 + Scalar(1.0)) +
                        _tmp48 * _tmp93 * (_tmp28 * _tmp95 - _tmp58 * _tmp95));
  _res(2, 0) = std::exp(-_tmp100 * _tmp53 * _tmp99 + _tmp101 * _tmp54 + _tmp102 * _tmp54 -
                        _tmp53 * _tmp89 * _tmp92);
  _res(3, 0) = std::exp(-_tmp100 * _tmp84 * _tmp98 - _tmp101 - _tmp102 - _tmp84 * _tmp87 * _tmp92);
