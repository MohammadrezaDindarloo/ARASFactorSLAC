...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl5(
  ...
  _res(1, 0) = std::exp(_tmp100 * _tmp32 * (_tmp65 * _tmp99 - _tmp98 * _tmp99) +
                        _tmp32 * _tmp88 * (_tmp77 * _tmp81 + _tmp79 * _tmp80 + Scalar(1.0)) +
                        _tmp32 * _tmp94 * (_tmp80 * _tmp92 + _tmp81 * _tmp91) +
                        _tmp32 * _tmp95 * (_tmp65 * _tmp97 - _tmp97 * _tmp98));
  _res(2, 0) = std::exp(_tmp101 * _tmp70 + _tmp102 * _tmp70 - _tmp43 * _tmp79 * _tmp88 -
                        _tmp43 * _tmp92 * _tmp94);
  _res(3, 0) = std::exp(-_tmp101 - _tmp102 - _tmp72 * _tmp77 * _tmp88 - _tmp72 * _tmp91 * _tmp94);
