...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl8(
  ...
  const Scalar _tmp91 = _tmp62 * fh1;
  ...
  const Scalar _tmp97 = _tmp77 + _tmp78 * _tmp79;
  ...
  _res(1, 0) = std::exp(_tmp51 * _tmp64 * (-_tmp29 * _tmp48 * _tmp56 + _tmp46 * _tmp56) +
                        _tmp51 * _tmp91 * (_tmp86 * _tmp87 + _tmp89 * _tmp90 + Scalar(1.0)) +
                        _tmp51 * _tmp95 * (_tmp87 * _tmp93 + _tmp90 * _tmp94) +
                        _tmp51 * _tmp96 * (_tmp100 * _tmp46 - _tmp90 * _tmp99));
  _res(2, 0) = std::exp(_tmp101 * _tmp48 - _tmp39 * _tmp89 * _tmp91 - _tmp39 * _tmp94 * _tmp95 +
                        _tmp39 * _tmp96 * _tmp99);
  _res(3, 0) =
      std::exp(-_tmp100 * _tmp96 - _tmp101 - _tmp83 * _tmp86 * _tmp91 - _tmp83 * _tmp93 * _tmp95);
