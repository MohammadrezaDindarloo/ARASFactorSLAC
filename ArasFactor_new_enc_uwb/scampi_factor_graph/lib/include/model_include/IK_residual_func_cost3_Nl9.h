...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl9(
  ...
  const Scalar _tmp32 = _tmp31 + position_vector(1, 0) + Scalar(-4.83288938413423);
  ...
  const Scalar _tmp40 = _tmp39 + position_vector(1, 0) + Scalar(-4.7744369927459998);
  ...
  const Scalar _tmp45 = Scalar(1.0) / (_tmp34 * _tmp44 - _tmp38);
  const Scalar _tmp46 = _tmp44 * _tmp45;
  const Scalar _tmp47 = _tmp15 * _tmp44;
  const Scalar _tmp48 = -_tmp34 * _tmp47 + _tmp36 * _tmp38;
  ...
  const Scalar _tmp52 = -_tmp15 + _tmp37 * _tmp46 - _tmp51 * (_tmp46 * _tmp48 + _tmp47);
  const Scalar _tmp53 = _tmp10 - _tmp13 + _tmp35;
  ...
  const Scalar _tmp63 = _tmp44 * _tmp61 - _tmp62;
  const Scalar _tmp64 = _tmp45 * _tmp63;
  const Scalar _tmp65 = _tmp15 * _tmp61 - _tmp37 * _tmp64 -
  ...
  const Scalar _tmp70 = _tmp69 * (-_tmp39 * _tmp42 * _tmp68 + _tmp40 * _tmp41 * _tmp68);
  const Scalar _tmp71 = -_tmp24 * _tmp38 + _tmp31 * _tmp34 + _tmp34 * _tmp70;
  ...
  const Scalar _tmp79 = -_tmp44 - _tmp76 * _tmp78;
  const Scalar _tmp80 = _tmp34 * _tmp45;
  const Scalar _tmp81 = _tmp26 + _tmp57;
  const Scalar _tmp82 = _tmp81 + position_vector(1, 0) + Scalar(8.3885017487099702);
  const Scalar _tmp83 = _tmp17 + _tmp54;
  ...
  const Scalar _tmp89 = -_tmp37 * _tmp88 + _tmp48 * _tmp51 * _tmp88;
  ...
  const Scalar _tmp93 = _tmp63 * _tmp74 * _tmp88;
  ...
  _res(1, 0) = std::exp(_tmp69 * _tmp95 * (-_tmp34 * _tmp93 + _tmp61 * _tmp94) +
                        _tmp69 * _tmp96 * (-_tmp100 * _tmp80 + _tmp61 * _tmp99) +
                        _tmp86 * _tmp87 * (_tmp76 * _tmp77 + _tmp79 * _tmp80 + Scalar(1.0)) +
                        _tmp87 * _tmp92 * (_tmp77 * _tmp90 + _tmp80 * _tmp91));
  _res(2, 0) = std::exp(_tmp100 * _tmp45 * _tmp96 - _tmp101 * _tmp79 * _tmp86 -
                        _tmp101 * _tmp91 * _tmp92 + _tmp93 * _tmp95);
  _res(3, 0) = std::exp(-_tmp102 * _tmp76 * _tmp86 - _tmp102 * _tmp90 * _tmp92 - _tmp94 * _tmp95 -
                        _tmp96 * _tmp99);
