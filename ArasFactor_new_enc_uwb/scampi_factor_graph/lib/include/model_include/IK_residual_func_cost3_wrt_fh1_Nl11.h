...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl11(
  ...
  const Scalar _tmp40 = Scalar(0.20999999999999999) * _tmp8 + Scalar(0.20999999999999999) * _tmp9;
  ...
  const Scalar _tmp45 = -_tmp35 * _tmp44 + _tmp36 * _tmp41;
  const Scalar _tmp46 = Scalar(1.0) * _tmp29;
  const Scalar _tmp47 = Scalar(1.0) * _tmp32;
  const Scalar _tmp48 = (-_tmp24 + _tmp47) / (_tmp15 - _tmp46);
  const Scalar _tmp49 = Scalar(1.0) * _tmp37;
  const Scalar _tmp50 = -_tmp27 * _tmp41 + _tmp44;
  const Scalar _tmp51 = _tmp45 * _tmp48 * _tmp49 - _tmp49 * _tmp50;
  const Scalar _tmp52 = -_tmp40 + _tmp42;
  const Scalar _tmp53 = _tmp21 - _tmp22;
  const Scalar _tmp54 = _tmp31 + _tmp53;
  const Scalar _tmp55 = _tmp54 + position_vector(0, 0) + Scalar(1.9874742031097401);
  const Scalar _tmp56 = _tmp10 - _tmp13;
  const Scalar _tmp57 = _tmp28 + _tmp56;
  const Scalar _tmp58 = _tmp57 + position_vector(1, 0) + Scalar(8.3196563720703107);
  ...
  const Scalar _tmp62 = _tmp35 * _tmp60 - _tmp61;
  const Scalar _tmp63 = _tmp37 * _tmp62;
  const Scalar _tmp64 = _tmp35 * _tmp43;
  const Scalar _tmp65 = _tmp43 * _tmp60 -
                        _tmp48 * (-_tmp45 * _tmp63 + _tmp52 * _tmp61 - _tmp60 * _tmp64) -
                        _tmp50 * _tmp63 - _tmp52 * _tmp60;
  const Scalar _tmp66 = Scalar(1.0) / (_tmp65);
  const Scalar _tmp67 =
      std::sqrt(Scalar(std::pow(_tmp30, Scalar(2)) + std::pow(_tmp33, Scalar(2))));
  const Scalar _tmp68 = Scalar(1.0) / (_tmp67);
  const Scalar _tmp69 = _tmp34 * _tmp67;
  const Scalar _tmp70 = _tmp69 * (-_tmp29 * _tmp33 * _tmp68 + _tmp30 * _tmp32 * _tmp68);
  const Scalar _tmp71 = _tmp15 * _tmp27 - _tmp24 * _tmp36 + _tmp27 * _tmp70;
  const Scalar _tmp72 = -_tmp54 * _tmp61 + _tmp57 * _tmp60 + _tmp60 * _tmp70 - _tmp63 * _tmp71;
  ...
  const Scalar _tmp77 = _tmp62 * _tmp66;
  const Scalar _tmp78 = _tmp37 * (-_tmp76 * _tmp77 + Scalar(1.0));
  const Scalar _tmp79 = _tmp66 * _tmp76;
  const Scalar _tmp80 = _tmp56 + _tmp7;
  const Scalar _tmp81 = _tmp80 + position_vector(1, 0) + Scalar(8.3885017487099702);
  const Scalar _tmp82 = _tmp18 + _tmp53;
  const Scalar _tmp83 = _tmp82 + position_vector(0, 0) + Scalar(-2.5193355532036801);
  const Scalar _tmp84 = std::pow(Scalar(std::pow(_tmp81, Scalar(2)) + std::pow(_tmp83, Scalar(2))),
                                 Scalar(Scalar(-1) / Scalar(2)));
  const Scalar _tmp85 = _tmp81 * _tmp84;
  const Scalar _tmp86 = _tmp69 * _tmp85 * (_tmp27 * _tmp78 + _tmp60 * _tmp79);
  const Scalar _tmp87 = _tmp35 * _tmp37;
  const Scalar _tmp88 = -_tmp43 - _tmp48 * (_tmp45 * _tmp87 + _tmp64) + _tmp50 * _tmp87;
  const Scalar _tmp89 = _tmp75 * (-_tmp70 + _tmp71 * _tmp87 - _tmp73 * _tmp88) + _tmp88;
  const Scalar _tmp90 = _tmp66 * _tmp89;
  const Scalar _tmp91 = _tmp37 * (-_tmp35 - _tmp77 * _tmp89);
  const Scalar _tmp92 = _tmp83 * _tmp84;
  const Scalar _tmp93 = _tmp69 * _tmp92 * (_tmp27 * _tmp91 + _tmp60 * _tmp90 + Scalar(1.0));
  const Scalar _tmp94 = -_tmp80 * _tmp92 + _tmp82 * _tmp85;
  const Scalar _tmp95 = Scalar(1.0) * _tmp74;
  const Scalar _tmp96 = _tmp69 * _tmp94 * (-_tmp27 * _tmp63 * _tmp95 + _tmp60 * _tmp95);
  const Scalar _tmp97 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp98 = _tmp46 * _tmp48 + _tmp47;
  const Scalar _tmp99 = 0;
  const Scalar _tmp100 = _tmp66 * _tmp99;
  const Scalar _tmp101 = _tmp37 * _tmp77 * _tmp99;
  const Scalar _tmp102 = _tmp94 * _tmp95;
  const Scalar _tmp103 = _tmp102 * fh1;
  const Scalar _tmp104 = _tmp91 * _tmp92;
  const Scalar _tmp105 = _tmp78 * _tmp85;
  ...
  _res(1, 0) = -(-_tmp86 - _tmp93 - _tmp96) *
               std::exp(_tmp69 * _tmp97 * (_tmp100 * _tmp60 - _tmp101 * _tmp27) + _tmp86 * fh1 +
                        _tmp93 * fh1 + _tmp96 * fh1);
  _res(2, 0) = -(-_tmp102 * _tmp63 + _tmp104 + _tmp105) *
               std::exp(_tmp101 * _tmp97 + _tmp103 * _tmp63 - _tmp104 * fh1 - _tmp105 * fh1);
  _res(3, 0) = -(_tmp102 + _tmp106 + _tmp107) *
               std::exp(-_tmp100 * _tmp97 - _tmp103 - _tmp106 * fh1 - _tmp107 * fh1);
