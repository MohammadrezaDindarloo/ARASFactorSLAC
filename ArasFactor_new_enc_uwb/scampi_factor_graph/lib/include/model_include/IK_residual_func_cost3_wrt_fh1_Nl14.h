...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl14(
  ...
  const Scalar _tmp16 = _tmp15 + position_vector(0, 0) + Scalar(1.7965602546229);
  ...
  const Scalar _tmp26 = _tmp25 + position_vector(1, 0) + Scalar(-4.83288938413423);
  ...
  const Scalar _tmp34 = _tmp30 + position_vector(0, 0) + Scalar(1.9874742031097401);
  ...
  const Scalar _tmp40 = _tmp39 + position_vector(0, 0) + Scalar(-2.5193355532036801);
  ...
  const Scalar _tmp47 = _tmp46 * (_tmp39 * _tmp42 * _tmp44 - _tmp40 * _tmp41 * _tmp44);
  const Scalar _tmp48 = -_tmp30 * _tmp36 + _tmp32 * _tmp37 + _tmp37 * _tmp47;
  const Scalar _tmp49 = _tmp42 * _tmp45;
  const Scalar _tmp50 = Scalar(1.0) / (-_tmp36 + _tmp37 * _tmp49);
  ...
  const Scalar _tmp60 = _tmp36 * _tmp57 - _tmp49 * _tmp59;
  const Scalar _tmp61 = Scalar(1.0) * _tmp41;
  const Scalar _tmp62 = Scalar(1.0) * _tmp39;
  const Scalar _tmp63 = (-_tmp30 + _tmp62) / (_tmp32 - _tmp61);
  const Scalar _tmp64 = -_tmp37 * _tmp57 + _tmp59;
  const Scalar _tmp65 = _tmp51 * _tmp64 - _tmp58 - _tmp63 * (_tmp49 * _tmp58 + _tmp51 * _tmp60);
  const Scalar _tmp66 = _tmp28 * _tmp58;
  const Scalar _tmp67 = _tmp26 * _tmp27;
  const Scalar _tmp68 = _tmp28 * _tmp49 - _tmp67;
  const Scalar _tmp69 = _tmp50 * _tmp68;
  const Scalar _tmp70 = _tmp52 + _tmp56;
  const Scalar _tmp71 = -_tmp28 * _tmp70 -
                        _tmp63 * (-_tmp49 * _tmp66 - _tmp60 * _tmp69 + _tmp67 * _tmp70) -
                        _tmp64 * _tmp69 + _tmp66;
  const Scalar _tmp72 = Scalar(1.0) / (_tmp71);
  const Scalar _tmp73 = -_tmp15 * _tmp67 + _tmp25 * _tmp28 + _tmp28 * _tmp47 - _tmp48 * _tmp69;
  const Scalar _tmp74 = _tmp72 * _tmp73;
  const Scalar _tmp75 = Scalar(1.0) / (_tmp73);
  const Scalar _tmp76 = _tmp71 * _tmp75;
  const Scalar _tmp77 = _tmp65 + _tmp76 * (-_tmp47 + _tmp48 * _tmp51 - _tmp65 * _tmp74);
  const Scalar _tmp78 = _tmp72 * _tmp77;
  const Scalar _tmp79 = _tmp68 * _tmp72;
  const Scalar _tmp80 = _tmp50 * (-_tmp49 - _tmp77 * _tmp79);
  const Scalar _tmp81 = _tmp17 + _tmp24;
  const Scalar _tmp82 = _tmp81 + position_vector(1, 0) + Scalar(-4.7744369927459998);
  const Scalar _tmp83 = _tmp38 + _tmp6;
  const Scalar _tmp84 = _tmp83 + position_vector(0, 0) + Scalar(-2.7171519410699099);
  const Scalar _tmp85 = std::pow(Scalar(std::pow(_tmp82, Scalar(2)) + std::pow(_tmp84, Scalar(2))),
                                 Scalar(Scalar(-1) / Scalar(2)));
  const Scalar _tmp86 = _tmp84 * _tmp85;
  const Scalar _tmp87 = _tmp46 * _tmp86 * (_tmp28 * _tmp78 + _tmp37 * _tmp80 + Scalar(1.0));
  ...
  const Scalar _tmp92 = _tmp50 * _tmp79 * _tmp90;
  const Scalar _tmp93 = _tmp82 * _tmp85;
  const Scalar _tmp94 = -_tmp81 * _tmp86 + _tmp83 * _tmp93;
  const Scalar _tmp95 = Scalar(1.0) * _tmp75;
  const Scalar _tmp96 = _tmp46 * _tmp94 * (_tmp28 * _tmp95 - _tmp37 * _tmp69 * _tmp95);
  const Scalar _tmp97 = Scalar(1.0) * _tmp50;
  const Scalar _tmp98 = _tmp60 * _tmp63 * _tmp97 - _tmp64 * _tmp97;
  const Scalar _tmp99 = _tmp76 * (-_tmp48 * _tmp97 - _tmp74 * _tmp98) + _tmp98;
  const Scalar _tmp100 = _tmp50 * (-_tmp79 * _tmp99 + Scalar(1.0));
  const Scalar _tmp101 = _tmp72 * _tmp99;
  const Scalar _tmp102 = _tmp46 * _tmp93 * (_tmp100 * _tmp37 + _tmp101 * _tmp28);
  const Scalar _tmp103 = _tmp80 * _tmp86;
  ...
  _res(1, 0) = -(-_tmp102 - _tmp87 - _tmp96) *
               std::exp(_tmp102 * fh1 + _tmp46 * _tmp88 * (_tmp28 * _tmp91 - _tmp37 * _tmp92) +
                        _tmp87 * fh1 + _tmp96 * fh1);
  _res(2, 0) = -(_tmp103 + _tmp104 - _tmp105 * _tmp69) *
               std::exp(-_tmp103 * fh1 - _tmp104 * fh1 + _tmp106 * _tmp69 + _tmp88 * _tmp92);
