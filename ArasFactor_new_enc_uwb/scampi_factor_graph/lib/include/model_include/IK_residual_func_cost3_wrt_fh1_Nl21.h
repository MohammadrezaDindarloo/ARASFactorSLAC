...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl21(
  ...
  const Scalar _tmp37 = _tmp16 + _tmp5;
  const Scalar _tmp38 = _tmp37 + position_vector(0, 0) + Scalar(-2.5193355532036801);
  ...
  const Scalar _tmp46 = _tmp20 + _tmp40;
  const Scalar _tmp47 = _tmp46 + position_vector(1, 0) + Scalar(-4.7744369927459998);
  ...
  const Scalar _tmp55 = _tmp47 * _tmp51;
  const Scalar _tmp56 = -_tmp43 * _tmp53 + _tmp54 * _tmp55;
  const Scalar _tmp57 = _tmp30 * _tmp43 - _tmp36;
  const Scalar _tmp58 = Scalar(1.0) / (_tmp43 * _tmp52 - _tmp55);
  const Scalar _tmp59 = _tmp57 * _tmp58;
  const Scalar _tmp60 = _tmp43 * _tmp45;
  const Scalar _tmp61 = Scalar(1.0) * _tmp41;
  const Scalar _tmp62 = Scalar(1.0) * _tmp37;
  const Scalar _tmp63 = (-_tmp49 + _tmp62) / (_tmp46 - _tmp61);
  const Scalar _tmp64 = -_tmp52 * _tmp54 + _tmp53;
  const Scalar _tmp65 = -_tmp30 * _tmp35 + _tmp30 * _tmp45 - _tmp59 * _tmp64 -
                        _tmp63 * (-_tmp30 * _tmp60 + _tmp35 * _tmp36 - _tmp56 * _tmp59);
  ...
  const Scalar _tmp70 = _tmp57 * _tmp66;
  const Scalar _tmp71 = _tmp58 * _tmp68 * _tmp70;
  const Scalar _tmp72 =
  ...
  const Scalar _tmp75 = _tmp56 * _tmp63 * _tmp74 - _tmp64 * _tmp74;
  const Scalar _tmp76 = Scalar(1.0) / (_tmp72);
  const Scalar _tmp77 = _tmp73 * (_tmp37 * _tmp42 * _tmp76 - _tmp38 * _tmp41 * _tmp76);
  const Scalar _tmp78 = _tmp46 * _tmp52 - _tmp49 * _tmp55 + _tmp52 * _tmp77;
  const Scalar _tmp79 = -_tmp17 * _tmp36 + _tmp27 * _tmp30 + _tmp30 * _tmp77 - _tmp59 * _tmp78;
  const Scalar _tmp80 = _tmp66 * _tmp79;
  const Scalar _tmp81 = Scalar(1.0) / (_tmp79);
  const Scalar _tmp82 = _tmp65 * _tmp81;
  const Scalar _tmp83 = _tmp75 + _tmp82 * (-_tmp74 * _tmp78 - _tmp75 * _tmp80);
  const Scalar _tmp84 = _tmp58 * (-_tmp70 * _tmp83 + Scalar(1.0));
  const Scalar _tmp85 = _tmp30 * _tmp66;
  const Scalar _tmp86 = _tmp20 + _tmp26;
  const Scalar _tmp87 = _tmp86 + position_vector(1, 0) + Scalar(-4.83288938413423);
  const Scalar _tmp88 = _tmp48 + _tmp6;
  ...
  const Scalar _tmp92 = _tmp73 * _tmp91 * (_tmp52 * _tmp84 + _tmp83 * _tmp85);
  const Scalar _tmp93 = _tmp43 * _tmp58;
  const Scalar _tmp94 = -_tmp45 - _tmp63 * (_tmp56 * _tmp93 + _tmp60) + _tmp64 * _tmp93;
  const Scalar _tmp95 = _tmp82 * (-_tmp77 + _tmp78 * _tmp93 - _tmp80 * _tmp94) + _tmp94;
  const Scalar _tmp96 = _tmp58 * (-_tmp43 - _tmp70 * _tmp95);
  const Scalar _tmp97 = _tmp89 * _tmp90;
  const Scalar _tmp98 = _tmp73 * _tmp97 * (_tmp52 * _tmp96 + _tmp85 * _tmp95 + Scalar(1.0));
  const Scalar _tmp99 = -_tmp86 * _tmp97 + _tmp88 * _tmp91;
  const Scalar _tmp100 = Scalar(1.0) * _tmp81;
  const Scalar _tmp101 = _tmp57 * _tmp74 * _tmp81;
  const Scalar _tmp102 = _tmp73 * _tmp99 * (_tmp100 * _tmp30 - _tmp101 * _tmp52);
  const Scalar _tmp103 = _tmp84 * _tmp91;
  const Scalar _tmp104 = _tmp101 * _tmp99;
  const Scalar _tmp105 = _tmp96 * _tmp97;
  const Scalar _tmp106 = _tmp66 * _tmp95 * _tmp97;
  const Scalar _tmp107 = _tmp66 * _tmp83 * _tmp91;
  ...
  _res(1, 0) = -(-_tmp102 - _tmp92 - _tmp98) *
               std::exp(_tmp0 * _tmp73 * (_tmp30 * _tmp69 - _tmp52 * _tmp71) + _tmp102 * fh1 +
                        _tmp92 * fh1 + _tmp98 * fh1);
  _res(2, 0) = -(_tmp103 - _tmp104 + _tmp105) *
               std::exp(_tmp0 * _tmp71 - _tmp103 * fh1 + _tmp104 * fh1 - _tmp105 * fh1);
  _res(3, 0) = -(_tmp106 + _tmp107 + _tmp108) *
               std::exp(-_tmp0 * _tmp69 - _tmp106 * fh1 - _tmp107 * fh1 - _tmp108 * fh1);
