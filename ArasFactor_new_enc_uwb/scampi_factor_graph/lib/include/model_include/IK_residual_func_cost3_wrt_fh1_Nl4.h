...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl4(
  ...
  const Scalar _tmp38 = _tmp37 + position_vector(1, 0) + Scalar(8.3885017487099702);
  const Scalar _tmp39 = -_tmp17;
  const Scalar _tmp40 = _tmp23 + _tmp39;
  const Scalar _tmp41 = _tmp40 + position_vector(0, 0) + Scalar(-2.5193355532036801);
  ...
  const Scalar _tmp47 = _tmp20 - _tmp22;
  ...
  const Scalar _tmp54 = _tmp35 * _tmp43 - _tmp52 * _tmp53;
  const Scalar _tmp55 = Scalar(1.0) / (-_tmp43 + _tmp51 * _tmp53);
  const Scalar _tmp56 = _tmp16 * _tmp26;
  const Scalar _tmp57 = _tmp27 * _tmp51 - _tmp56;
  const Scalar _tmp58 = _tmp55 * _tmp57;
  const Scalar _tmp59 = Scalar(1.0) * _tmp48;
  const Scalar _tmp60 = Scalar(1.0) * _tmp45;
  const Scalar _tmp61 = (-_tmp40 + _tmp59) / (_tmp37 - _tmp60);
  const Scalar _tmp62 = _tmp55 * (_tmp31 * _tmp53 - _tmp35 * _tmp53);
  const Scalar _tmp63 = -_tmp27 * _tmp34 + _tmp32 - _tmp57 * _tmp62 -
                        _tmp61 * (-_tmp32 * _tmp51 + _tmp34 * _tmp56 - _tmp54 * _tmp58);
  ...
  const Scalar _tmp68 = _tmp67 * (-_tmp45 * _tmp49 * _tmp66 + _tmp46 * _tmp48 * _tmp66);
  const Scalar _tmp69 = _tmp37 * _tmp53 - _tmp40 * _tmp43 + _tmp53 * _tmp68;
  const Scalar _tmp70 = _tmp55 * _tmp69;
  const Scalar _tmp71 = _tmp54 * _tmp55;
  const Scalar _tmp72 = -_tmp31 + _tmp51 * _tmp62 - _tmp61 * (_tmp51 * _tmp71 + _tmp52);
  const Scalar _tmp73 = _tmp15 * _tmp27 - _tmp24 * _tmp56 + _tmp27 * _tmp68 - _tmp58 * _tmp69;
  const Scalar _tmp74 = _tmp64 * _tmp73;
  const Scalar _tmp75 = Scalar(1.0) / (_tmp73);
  const Scalar _tmp76 = _tmp63 * _tmp75;
  const Scalar _tmp77 = _tmp72 + _tmp76 * (_tmp51 * _tmp70 - _tmp68 - _tmp72 * _tmp74);
  const Scalar _tmp78 = _tmp64 * _tmp77;
  const Scalar _tmp79 = _tmp57 * _tmp64;
  const Scalar _tmp80 = _tmp55 * (-_tmp51 - _tmp77 * _tmp79);
  const Scalar _tmp81 = _tmp39 + _tmp47;
  const Scalar _tmp82 = _tmp81 + position_vector(0, 0) + Scalar(1.9874742031097401);
  const Scalar _tmp83 = _tmp36 + _tmp44;
  const Scalar _tmp84 = _tmp83 + position_vector(1, 0) + Scalar(8.3196563720703107);
  const Scalar _tmp85 = std::pow(Scalar(std::pow(_tmp82, Scalar(2)) + std::pow(_tmp84, Scalar(2))),
                                 Scalar(Scalar(-1) / Scalar(2)));
  const Scalar _tmp86 = _tmp82 * _tmp85;
  const Scalar _tmp87 = _tmp67 * _tmp86 * (_tmp27 * _tmp78 + _tmp53 * _tmp80 + Scalar(1.0));
  const Scalar _tmp88 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp89 = _tmp59 + _tmp60 * _tmp61;
  const Scalar _tmp90 = 0;
  const Scalar _tmp91 = _tmp64 * _tmp90;
  const Scalar _tmp92 = _tmp55 * _tmp79 * _tmp90;
  const Scalar _tmp93 = _tmp84 * _tmp85;
  const Scalar _tmp94 = _tmp81 * _tmp93 - _tmp83 * _tmp86;
  const Scalar _tmp95 = Scalar(1.0) * _tmp75;
  const Scalar _tmp96 = _tmp67 * _tmp94 * (_tmp27 * _tmp95 - _tmp53 * _tmp58 * _tmp95);
  const Scalar _tmp97 = Scalar(1.0) * _tmp61 * _tmp71 - Scalar(1.0) * _tmp62;
  const Scalar _tmp98 = _tmp76 * (-Scalar(1.0) * _tmp70 - _tmp74 * _tmp97) + _tmp97;
  const Scalar _tmp99 = _tmp55 * (-_tmp79 * _tmp98 + Scalar(1.0));
  const Scalar _tmp100 = _tmp64 * _tmp98;
  const Scalar _tmp101 = _tmp67 * _tmp93 * (_tmp100 * _tmp27 + _tmp53 * _tmp99);
  const Scalar _tmp102 = _tmp80 * _tmp86;
  const Scalar _tmp103 = _tmp94 * _tmp95;
  const Scalar _tmp104 = _tmp103 * fh1;
  const Scalar _tmp105 = _tmp93 * _tmp99;
  ...
  _res(1, 0) = -(-_tmp101 - _tmp87 - _tmp96) *
               std::exp(_tmp101 * fh1 + _tmp67 * _tmp88 * (_tmp27 * _tmp91 - _tmp53 * _tmp92) +
                        _tmp87 * fh1 + _tmp96 * fh1);
  _res(2, 0) = -(_tmp102 - _tmp103 * _tmp58 + _tmp105) *
               std::exp(-_tmp102 * fh1 + _tmp104 * _tmp58 - _tmp105 * fh1 + _tmp88 * _tmp92);
  _res(3, 0) = -(_tmp103 + _tmp106 + _tmp107) *
               std::exp(-_tmp104 - _tmp106 * fh1 - _tmp107 * fh1 - _tmp88 * _tmp91);
