...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl9(
  ...
  const Scalar _tmp45 = _tmp34 * _tmp42 - _tmp42 * _tmp44;
  const Scalar _tmp46 = _tmp40 * _tmp41;
  const Scalar _tmp47 = _tmp18 + _tmp38;
  const Scalar _tmp48 = _tmp47 + position_vector(1, 0) + Scalar(-4.7744369927459998);
  const Scalar _tmp49 = _tmp35 + _tmp4;
  ...
  const Scalar _tmp53 = Scalar(1.0) / (_tmp42 * _tmp52 - _tmp46);
  const Scalar _tmp54 = _tmp52 * _tmp53;
  const Scalar _tmp55 = _tmp34 * _tmp52;
  const Scalar _tmp56 = -_tmp42 * _tmp55 + _tmp44 * _tmp46;
  const Scalar _tmp57 = Scalar(1.0) * _tmp47;
  const Scalar _tmp58 = Scalar(1.0) * _tmp49;
  const Scalar _tmp59 = (-_tmp36 + _tmp58) / (_tmp39 - _tmp57);
  const Scalar _tmp60 = -_tmp34 + _tmp45 * _tmp54 - _tmp59 * (_tmp54 * _tmp56 + _tmp55);
  const Scalar _tmp61 = _tmp31 - _tmp32 + _tmp43;
  const Scalar _tmp62 = _tmp27 * _tmp28;
  const Scalar _tmp63 = _tmp29 * _tmp52 - _tmp62;
  const Scalar _tmp64 = _tmp53 * _tmp63;
  const Scalar _tmp65 = _tmp29 * _tmp34 - _tmp29 * _tmp61 - _tmp45 * _tmp64 -
  ...
  const Scalar _tmp70 = _tmp69 * (-_tmp47 * _tmp50 * _tmp68 + _tmp48 * _tmp49 * _tmp68);
  const Scalar _tmp71 = -_tmp36 * _tmp46 + _tmp39 * _tmp42 + _tmp42 * _tmp70;
  ...
  const Scalar _tmp80 = _tmp42 * _tmp53;
  const Scalar _tmp81 = _tmp18 + _tmp25;
  const Scalar _tmp82 = _tmp81 + position_vector(1, 0) + Scalar(8.3885017487099702);
  const Scalar _tmp83 = _tmp15 + _tmp4;
  const Scalar _tmp84 = _tmp83 + position_vector(0, 0) + Scalar(-2.5193355532036801);
  const Scalar _tmp85 = std::pow(Scalar(std::pow(_tmp82, Scalar(2)) + std::pow(_tmp84, Scalar(2))),
                                 Scalar(Scalar(-1) / Scalar(2)));
  const Scalar _tmp86 = _tmp84 * _tmp85;
  const Scalar _tmp87 = _tmp69 * _tmp86 * (_tmp29 * _tmp77 + _tmp79 * _tmp80 + Scalar(1.0));
  const Scalar _tmp88 = Scalar(1.0) * _tmp53;
  const Scalar _tmp89 = -_tmp45 * _tmp88 + _tmp56 * _tmp59 * _tmp88;
  ...
  const Scalar _tmp94 = _tmp69 * _tmp93 * (_tmp29 * _tmp92 + _tmp80 * _tmp91);
  const Scalar _tmp95 = -_tmp81 * _tmp86 + _tmp83 * _tmp93;
  const Scalar _tmp96 = _tmp63 * _tmp74 * _tmp88;
  const Scalar _tmp97 = Scalar(1.0) * _tmp74;
  const Scalar _tmp98 = _tmp69 * _tmp95 * (_tmp29 * _tmp97 - _tmp42 * _tmp96);
  ...
  const Scalar _tmp104 = _tmp53 * _tmp79 * _tmp86;
  const Scalar _tmp105 = _tmp53 * _tmp91 * _tmp93;
  const Scalar _tmp106 = _tmp95 * _tmp96;
  const Scalar _tmp107 = _tmp77 * _tmp86;
  const Scalar _tmp108 = _tmp92 * _tmp93;
  const Scalar _tmp109 = _tmp95 * _tmp97;
  ...
  _res(1, 0) = -(-_tmp87 - _tmp94 - _tmp98) *
               std::exp(_tmp69 * _tmp99 * (_tmp102 * _tmp29 - _tmp103 * _tmp80) + _tmp87 * fh1 +
                        _tmp94 * fh1 + _tmp98 * fh1);
  _res(2, 0) = -(_tmp104 + _tmp105 - _tmp106) *
               std::exp(_tmp103 * _tmp53 * _tmp99 - _tmp104 * fh1 - _tmp105 * fh1 + _tmp106 * fh1);
  _res(3, 0) = -(_tmp107 + _tmp108 + _tmp109) *
               std::exp(-_tmp102 * _tmp99 - _tmp107 * fh1 - _tmp108 * fh1 - _tmp109 * fh1);
