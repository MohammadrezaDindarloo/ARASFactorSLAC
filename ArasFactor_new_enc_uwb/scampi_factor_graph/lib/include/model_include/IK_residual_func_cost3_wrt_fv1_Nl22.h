...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl22(
  ...
  const Scalar _tmp32 = _tmp31 + position_vector(1, 0) + Scalar(-4.7744369927459998);
  ...
  const Scalar _tmp39 = _tmp38 + position_vector(1, 0) + Scalar(8.3885017487099702);
  ...
  const Scalar _tmp45 = _tmp37 * _tmp43 - _tmp44;
  ...
  const Scalar _tmp50 = _tmp49 * (-_tmp31 * _tmp35 * _tmp48 + _tmp32 * _tmp34 * _tmp48);
  const Scalar _tmp51 = -_tmp16 * _tmp46 + _tmp26 * _tmp29 + _tmp29 * _tmp50;
  const Scalar _tmp52 = Scalar(1.0) / (_tmp29 * _tmp37 - _tmp46);
  const Scalar _tmp53 = _tmp45 * _tmp52;
  const Scalar _tmp54 = _tmp38 * _tmp43 - _tmp40 * _tmp44 + _tmp43 * _tmp50 - _tmp51 * _tmp53;
  ...
  const Scalar _tmp60 = _tmp33 + _tmp5;
  const Scalar _tmp61 = _tmp60 + position_vector(0, 0) + Scalar(1.7965602546229);
  const Scalar _tmp62 = _tmp59 + position_vector(1, 0) + Scalar(-4.83288938413423);
  ...
  const Scalar _tmp74 = -_tmp29 * _tmp71 + _tmp29 * _tmp73;
  const Scalar _tmp75 = _tmp37 * _tmp52;
  const Scalar _tmp76 = _tmp37 * _tmp73;
  const Scalar _tmp77 = -_tmp29 * _tmp76 + _tmp46 * _tmp71;
  const Scalar _tmp78 = Scalar(1.0) * _tmp34;
  const Scalar _tmp79 = Scalar(1.0) * _tmp31;
  const Scalar _tmp80 = (-_tmp16 + _tmp78) / (_tmp26 - _tmp79);
  const Scalar _tmp81 = -_tmp73 + _tmp74 * _tmp75 - _tmp80 * (_tmp75 * _tmp77 + _tmp76);
  const Scalar _tmp82 = _tmp70 + _tmp72;
  const Scalar _tmp83 = _tmp43 * _tmp73 - _tmp43 * _tmp82 - _tmp53 * _tmp74 -
                        _tmp80 * (-_tmp43 * _tmp76 + _tmp44 * _tmp82 - _tmp53 * _tmp77);
  const Scalar _tmp84 = Scalar(1.0) / (_tmp83);
  const Scalar _tmp85 = _tmp54 * _tmp84;
  const Scalar _tmp86 = _tmp55 * _tmp83;
  const Scalar _tmp87 = _tmp81 + _tmp86 * (-_tmp50 + _tmp51 * _tmp75 - _tmp81 * _tmp85);
  const Scalar _tmp88 = _tmp45 * _tmp84;
  const Scalar _tmp89 = -_tmp37 - _tmp87 * _tmp88;
  const Scalar _tmp90 = _tmp29 * _tmp52;
  const Scalar _tmp91 = _tmp43 * _tmp84;
  ...
  const Scalar _tmp97 = _tmp49 * (-_tmp29 * _tmp96 + _tmp43 * _tmp95);
  const Scalar _tmp98 = -_tmp56 * _tmp74 + _tmp56 * _tmp77 * _tmp80;
  const Scalar _tmp99 = _tmp86 * (-_tmp51 * _tmp56 - _tmp85 * _tmp98) + _tmp98;
  const Scalar _tmp100 = -_tmp88 * _tmp99 + Scalar(1.0);
  ...
  _res(0, 0) = 0;
  _res(1, 0) =
      -_tmp97 * std::exp(_tmp101 * _tmp49 * (_tmp100 * _tmp90 + _tmp91 * _tmp99) +
                         _tmp49 * _tmp66 * (-_tmp29 * _tmp57 + _tmp43 * _tmp58) +
                         _tmp49 * _tmp92 * (_tmp87 * _tmp91 + _tmp89 * _tmp90 + Scalar(1.0)) +
                         _tmp93 * _tmp97);
  _res(2, 0) = -_tmp96 * std::exp(-_tmp100 * _tmp101 * _tmp52 + _tmp102 * _tmp53 -
                                  _tmp52 * _tmp89 * _tmp92 + _tmp57 * _tmp66);
  _res(3, 0) = _tmp95 * std::exp(-_tmp101 * _tmp84 * _tmp99 - _tmp102 - _tmp58 * _tmp66 -
                                 _tmp84 * _tmp87 * _tmp92);
