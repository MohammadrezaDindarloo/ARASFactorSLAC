...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl9(
  ...
  const Scalar _tmp43 = -_tmp38;
  const Scalar _tmp44 = _tmp41 + _tmp43;
  const Scalar _tmp45 = _tmp36 * _tmp42 - _tmp36 * _tmp44;
  const Scalar _tmp46 = _tmp37 * _tmp45;
  const Scalar _tmp47 = _tmp27 * _tmp42;
  const Scalar _tmp48 = _tmp35 * _tmp44 - _tmp36 * _tmp47;
  const Scalar _tmp49 = _tmp37 * _tmp48;
  const Scalar _tmp50 = Scalar(1.0) * _tmp15;
  const Scalar _tmp51 = Scalar(1.0) * _tmp24;
  const Scalar _tmp52 = (-_tmp32 + _tmp51) / (_tmp29 - _tmp50);
  const Scalar _tmp53 = _tmp27 * _tmp46 - _tmp42 - _tmp52 * (_tmp27 * _tmp49 + _tmp47);
  const Scalar _tmp54 = _tmp39 - _tmp40 + _tmp43;
  const Scalar _tmp55 = _tmp21 - _tmp22;
  ...
  const Scalar _tmp64 = _tmp27 * _tmp62 - _tmp63;
  const Scalar _tmp65 = _tmp37 * _tmp64;
  const Scalar _tmp66 = _tmp42 * _tmp62 - _tmp45 * _tmp65 -
                        _tmp52 * (-_tmp47 * _tmp62 - _tmp48 * _tmp65 + _tmp54 * _tmp63) -
                        _tmp54 * _tmp62;
  const Scalar _tmp67 = Scalar(1.0) / (_tmp66);
  const Scalar _tmp68 =
      std::sqrt(Scalar(std::pow(_tmp16, Scalar(2)) + std::pow(_tmp25, Scalar(2))));
  const Scalar _tmp69 = Scalar(1.0) / (_tmp68);
  const Scalar _tmp70 = _tmp26 * _tmp68;
  const Scalar _tmp71 = _tmp70 * (-_tmp15 * _tmp25 * _tmp69 + _tmp16 * _tmp24 * _tmp69);
  const Scalar _tmp72 = _tmp37 * (_tmp29 * _tmp36 - _tmp32 * _tmp35 + _tmp36 * _tmp71);
  const Scalar _tmp73 = -_tmp56 * _tmp63 + _tmp59 * _tmp62 + _tmp62 * _tmp71 - _tmp64 * _tmp72;
  const Scalar _tmp74 = _tmp67 * _tmp73;
  const Scalar _tmp75 = Scalar(1.0) / (_tmp73);
  const Scalar _tmp76 = _tmp66 * _tmp75;
  const Scalar _tmp77 = _tmp53 + _tmp76 * (_tmp27 * _tmp72 - _tmp53 * _tmp74 - _tmp71);
  ...
  const Scalar _tmp89 = -Scalar(1.0) * _tmp46 + Scalar(1.0) * _tmp49 * _tmp52;
  const Scalar _tmp90 = _tmp76 * (-Scalar(1.0) * _tmp72 - _tmp74 * _tmp89) + _tmp89;
  const Scalar _tmp91 = -_tmp79 * _tmp90 + Scalar(1.0);
  const Scalar _tmp92 = _tmp83 * _tmp86;
  const Scalar _tmp93 = _tmp92 * fh1;
  const Scalar _tmp94 = Scalar(1.0) * _tmp75;
  const Scalar _tmp95 = fh1 * (-_tmp82 * _tmp87 + _tmp84 * _tmp92);
  ...
  const Scalar _tmp101 = _tmp70 * (-_tmp100 * _tmp81 + _tmp62 * _tmp99);
  const Scalar _tmp102 = _tmp94 * _tmp95;
  const Scalar _tmp103 = _tmp100 * _tmp37;
  ...
  _res(1, 0) =
      -_tmp101 * std::exp(_tmp101 * _tmp96 +
                          ...
                          _tmp70 * _tmp93 * (_tmp78 * _tmp90 + _tmp81 * _tmp91) +
                          _tmp70 * _tmp95 * (-_tmp36 * _tmp65 * _tmp94 + _tmp62 * _tmp94));
  _res(2, 0) = -_tmp103 * std::exp(_tmp102 * _tmp65 + _tmp103 * _tmp96 - _tmp37 * _tmp80 * _tmp88 -
                                   _tmp37 * _tmp91 * _tmp93);
  _res(3, 0) = _tmp99 * std::exp(-_tmp102 - _tmp67 * _tmp77 * _tmp88 - _tmp67 * _tmp90 * _tmp93 -
                                 _tmp96 * _tmp99);
