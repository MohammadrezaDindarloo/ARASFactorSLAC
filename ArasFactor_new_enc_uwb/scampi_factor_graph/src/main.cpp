                                                    ...
                                                    Eigen::Matrix<double, 4, 3> pulley_position_estimate)
{
    ...
    fkSolver(params, cable_length_collection, cable_forces_collection, p_platform_collection, rot_init_platform_collection, delta_rot_platform_collection, pulley_position_estimate, &fk_results);
    ...
    MatrixXd optimizer_error_(1, 1);
    optimizer_error_(0,0) = fk_results.optimizer_error;
    results_list.push_back(optimizer_error_);
