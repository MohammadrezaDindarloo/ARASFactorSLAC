...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1WrtFv1Nl18(
  ...
  const Scalar _tmp38 = _tmp37 + Scalar(8.3885017487099702);
  ...
  const Scalar _tmp46 = _tmp20 + _tmp27 + _tmp34;
  ...
  const Scalar _tmp64 = _tmp55 * (_tmp45 * _tmp60 - _tmp54 * _tmp63);
  const Scalar _tmp65 = Scalar(1.0) * _tmp64;
  const Scalar _tmp66 = _tmp55 * (-_tmp54 * _tmp60 + _tmp54 * _tmp62);
  const Scalar _tmp67 = Scalar(1.0) * _tmp46;
  const Scalar _tmp68 = -_tmp67;
  const Scalar _tmp69 = Scalar(1.0) / (_tmp36 + _tmp68);
  const Scalar _tmp70 = Scalar(1.0) * _tmp49;
  const Scalar _tmp71 = _tmp69 * (-_tmp41 + _tmp70);
  const Scalar _tmp72 = _tmp65 * _tmp71 - Scalar(1.0) * _tmp66;
  const Scalar _tmp73 = _tmp57 + _tmp58;
  const Scalar _tmp74 = _tmp56 + _tmp73;
  const Scalar _tmp75 = _tmp19 + _tmp28;
  const Scalar _tmp76 = _tmp75 + position_vector(1, 0);
  const Scalar _tmp77 = _tmp76 + Scalar(-4.7744369927459998);
  const Scalar _tmp78 = _tmp40 + _tmp7;
  ...
  const Scalar _tmp85 = -_tmp63 * _tmp83 - _tmp64 * _tmp84 + _tmp74 * _tmp82;
  const Scalar _tmp86 = _tmp62 * _tmp83 - _tmp66 * _tmp84 - _tmp71 * _tmp85 - _tmp74 * _tmp83;
  ...
  const Scalar _tmp92 = _tmp55 * (_tmp36 * _tmp54 - _tmp41 * _tmp45 + _tmp54 * _tmp91);
  ...
  const Scalar _tmp98 = _tmp68 + _tmp75;
  const Scalar _tmp99 = _tmp71 * _tmp98;
  const Scalar _tmp100 = Scalar(1.0) / (_tmp70 - _tmp78 - _tmp99);
  const Scalar _tmp101 = _tmp100 * _tmp98;
  const Scalar _tmp102 = _tmp72 + _tmp97;
  const Scalar _tmp103 = _tmp85 * _tmp87;
  const Scalar _tmp104 = _tmp101 * _tmp97 - _tmp102 * _tmp103 - _tmp65;
  const Scalar _tmp105 = Scalar(1.0) * _tmp69;
  ...
  const Scalar _tmp112 = _tmp53 * _tmp64 + _tmp63;
  const Scalar _tmp113 = -_tmp112 * _tmp71 + _tmp53 * _tmp66 - _tmp62;
  ...
  const Scalar _tmp119 = fh1 * (_tmp61 + _tmp73);
  const Scalar _tmp120 = -_tmp110 * _tmp119 - Scalar(5.1796800000000003) * _tmp25 - _tmp29 * fv1;
  const Scalar _tmp121 = _tmp69 * (_tmp106 * _tmp99 + Scalar(1.0));
  const Scalar _tmp122 = _tmp106 * _tmp71;
  const Scalar _tmp123 = -Scalar(1.0) * _tmp121 + Scalar(1.0) * _tmp122;
  const Scalar _tmp124 = Scalar(5.1796800000000003) * _tmp11 + _tmp117 * _tmp119 + _tmp17 * fv1;
  const Scalar _tmp125 = _tmp106 * _tmp98;
  const Scalar _tmp126 = -Scalar(1.0) * _tmp106 + Scalar(1.0) * _tmp125 * _tmp69;
  const Scalar _tmp127 = Scalar(1.0) * _tmp95;
  const Scalar _tmp128 = _tmp125 * _tmp96 - _tmp127 * _tmp85;
  const Scalar _tmp129 = _tmp106 * _tmp96;
  const Scalar _tmp130 = fh1 * (_tmp110 * _tmp17 - _tmp117 * _tmp29);
  const Scalar _tmp131 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp132 = _tmp67 * _tmp71 + _tmp70;
  const Scalar _tmp133 = _tmp100 * _tmp132;
  const Scalar _tmp134 = 0;
  const Scalar _tmp135 = _tmp69 * (-_tmp103 * _tmp134 - _tmp133 * _tmp98 + _tmp68);
  ...
  const Scalar _tmp137 = Scalar(1.0) * _tmp111 * (-_tmp104 * _tmp105 + _tmp106 * _tmp97) +
                         ...
                         Scalar(1.0) * _tmp130 * (-_tmp105 * _tmp128 + _tmp129) + _tmp131 * _tmp136;
  ...
  const Scalar _tmp143 = _tmp141 * _tmp84;
  const Scalar _tmp144 = _tmp90 * (-_tmp142 * _tmp143 + _tmp142 * _tmp83);
  ...
  const Scalar _tmp146 = -_tmp111 * _tmp90 * (_tmp102 * _tmp138 + _tmp141 * _tmp145) -
                         ...
                         _tmp130 * _tmp90 * (-_tmp127 * _tmp143 + _tmp127 * _tmp83) -
                         _tmp131 * _tmp144;
  ...
  const Scalar _tmp151 = _tmp26 + _tmp35;
  const Scalar _tmp152 = _tmp144 * _tmp150;
  const Scalar _tmp153 =
      (-_tmp137 * _tmp152 + _tmp147 * (_tmp123 * _tmp151 + _tmp126 * _tmp17 - _tmp136)) /
      std::sqrt(Scalar(std::pow(_tmp137, Scalar(2)) * _tmp150 + 1));
  const Scalar _tmp154 = Scalar(9.6622558468725703) * _tmp146;
  const Scalar _tmp155 = Scalar(9.6622558468725703) * _tmp144;
  ...
  const Scalar _tmp160 = _tmp55 * _tmp84;
  const Scalar _tmp161 = _tmp131 * _tmp142;
  const Scalar _tmp162 = _tmp111 * _tmp145 * _tmp55 + _tmp118 * _tmp140 * _tmp55 -
                         _tmp159 * _tmp160 - _tmp160 * _tmp161;
  const Scalar _tmp163 = std::pow(_tmp162, Scalar(-2));
  const Scalar _tmp164 = _tmp142 * _tmp160 * _tmp163;
  const Scalar _tmp165 = Scalar(1.0) / (_tmp162);
  const Scalar _tmp166 = _tmp106 * _tmp124;
  const Scalar _tmp167 = _tmp69 * _tmp98;
  const Scalar _tmp168 = _tmp104 * _tmp111 * _tmp69 + _tmp116 * _tmp118 * _tmp69 +
                         _tmp120 * _tmp121 + _tmp128 * _tmp130 * _tmp69 + _tmp131 * _tmp135 -
                         _tmp166 * _tmp167;
  const Scalar _tmp169 = std::asinh(_tmp165 * _tmp168);
  const Scalar _tmp170 = Scalar(1.0) * _tmp169;
  const Scalar _tmp171 = _tmp106 * _tmp17;
  const Scalar _tmp172 =
      (-_tmp164 * _tmp168 + _tmp165 * (_tmp121 * _tmp151 - _tmp135 - _tmp167 * _tmp171)) /
  ...
  const Scalar _tmp175 = Scalar(9.6622558468725703) * _tmp142;
  ...
  const Scalar _tmp179 =
      _tmp102 * _tmp111 * _tmp87 + _tmp115 * _tmp118 * _tmp87 + _tmp159 + _tmp161;
  const Scalar _tmp180 = Scalar(1.0) / (_tmp179);
  const Scalar _tmp181 = -_tmp100 * _tmp111 * _tmp97 - _tmp100 * _tmp114 * _tmp118 -
                         _tmp120 * _tmp122 - _tmp129 * _tmp130 + _tmp131 * _tmp133 + _tmp166;
  ...
  const Scalar _tmp186 = (_tmp180 * (-_tmp122 * _tmp151 - _tmp133 + _tmp171) + _tmp181 * _tmp185) /
  ...
  _res(1, 0) =
      -_tmp154 *
          (-Scalar(0.87679799777269396) * _tmp152 + Scalar(1.0) * _tmp153 * std::sinh(_tmp149) -
           (-Scalar(0.1034955) * _tmp152 * _tmp157 +
            _tmp156 * (-_tmp148 * _tmp155 - _tmp153 * _tmp154)) *
               std::sinh(_tmp158)) -
      _tmp155 * (Scalar(0.87679799777269396) * _tmp147 + std::cosh(_tmp149) - std::cosh(_tmp158));
  _res(2, 0) =
      -_tmp173 *
          (-Scalar(0.876505537412406) * _tmp164 + Scalar(1.0) * _tmp172 * std::sinh(_tmp170) -
           (-Scalar(0.1034955) * _tmp164 * _tmp174 +
            _tmp177 * (-_tmp169 * _tmp176 - _tmp172 * _tmp173)) *
               std::sinh(_tmp178)) -
      _tmp176 * (Scalar(0.876505537412406) * _tmp165 + std::cosh(_tmp170) - std::cosh(_tmp178));
  _res(3, 0) =
      _tmp175 * (Scalar(0.86564762886483004) * _tmp180 + std::cosh(_tmp183) - std::cosh(_tmp190)) -
      _tmp187 *
          (Scalar(0.86564762886483004) * _tmp185 + Scalar(1.0) * _tmp186 * std::sinh(_tmp183) -
           (Scalar(0.1034955) * _tmp185 * _tmp188 +
            _tmp189 * (_tmp175 * _tmp182 - _tmp186 * _tmp187)) *
               std::sinh(_tmp190));
