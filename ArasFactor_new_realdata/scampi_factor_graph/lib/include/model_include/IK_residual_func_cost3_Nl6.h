...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl6(
  ...
  const Scalar _tmp48 = _tmp32 * _tmp46 + _tmp40 * _tmp46 - _tmp43 * _tmp47;
  const Scalar _tmp49 = _tmp17 * _tmp30;
  const Scalar _tmp50 = Scalar(1.0) / (_tmp46 * _tmp49 - _tmp47);
  const Scalar _tmp51 = _tmp36 * _tmp37;
  const Scalar _tmp52 = _tmp38 * _tmp49 - _tmp51;
  const Scalar _tmp53 = _tmp50 * _tmp52;
  const Scalar _tmp54 = _tmp32 * _tmp38 - _tmp33 * _tmp51 + _tmp35 * _tmp38 - _tmp48 * _tmp53;
  const Scalar _tmp55 = Scalar(1.0) / (_tmp54);
  const Scalar _tmp56 = Scalar(1.0) * _tmp55;
  const Scalar _tmp57 = _tmp46 * _tmp53;
  const Scalar _tmp58 = _tmp39 + _tmp5;
  ...
  const Scalar _tmp69 = Scalar(0.20999999999999999) * _tmp10 + Scalar(0.20999999999999999) * _tmp8;
  ...
  const Scalar _tmp74 = -_tmp46 * _tmp73 + _tmp47 * _tmp70;
  const Scalar _tmp75 = Scalar(1.0) * _tmp26;
  const Scalar _tmp76 = Scalar(1.0) * _tmp16;
  const Scalar _tmp77 = (-_tmp43 + _tmp75) / (_tmp40 - _tmp76);
  ...
  const Scalar _tmp81 = _tmp38 * _tmp72 - _tmp38 * _tmp80 - _tmp53 * _tmp78 -
                        _tmp77 * (-_tmp38 * _tmp73 + _tmp51 * _tmp80 - _tmp53 * _tmp74);
  const Scalar _tmp82 = Scalar(1.0) / (_tmp81);
  const Scalar _tmp83 = _tmp54 * _tmp82;
  const Scalar _tmp84 = _tmp55 * _tmp81;
  const Scalar _tmp85 = _tmp79 + _tmp84 * (-_tmp32 + _tmp48 * _tmp66 - _tmp79 * _tmp83);
  const Scalar _tmp86 = _tmp38 * _tmp82;
  const Scalar _tmp87 = _tmp52 * _tmp82;
  const Scalar _tmp88 = -_tmp49 - _tmp85 * _tmp87;
  const Scalar _tmp89 = _tmp46 * _tmp50;
  ...
  const Scalar _tmp97 = _tmp75 + _tmp76 * _tmp77;
  ...
  _res(1, 0) = std::exp(_tmp31 * _tmp65 * (_tmp38 * _tmp56 - _tmp56 * _tmp57) +
                        _tmp31 * _tmp90 * (_tmp85 * _tmp86 + _tmp88 * _tmp89 + Scalar(1.0)) +
                        _tmp31 * _tmp95 * (_tmp86 * _tmp93 + _tmp89 * _tmp94) +
                        _tmp31 * _tmp96 * (_tmp38 * _tmp98 - _tmp57 * _tmp98));
  _res(2, 0) = std::exp(_tmp100 * _tmp53 - _tmp50 * _tmp88 * _tmp90 - _tmp50 * _tmp94 * _tmp95 +
                        _tmp53 * _tmp99);
