...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl13(
  ...
  const Scalar _tmp17 = _tmp0 * _tmp7;
  ...
  const Scalar _tmp21 = Scalar(0.20999999999999999) * _tmp12 + Scalar(0.20999999999999999) * _tmp20;
  ...
  const Scalar _tmp30 = _tmp19 - _tmp21;
  ...
  const Scalar _tmp35 = _tmp34 + position_vector(0, 0) + Scalar(-2.5193355532036801);
  ...
  const Scalar _tmp57 = _tmp48 * _tmp55 - _tmp50 * _tmp56 + _tmp52 * _tmp55;
  ...
  const Scalar _tmp62 = _tmp31 * _tmp37 - _tmp34 * _tmp49 + _tmp37 * _tmp48 - _tmp57 * _tmp61;
  ...
  const Scalar _tmp68 = -Scalar(0.010999999999999999) * _tmp11 -
  ...
  const Scalar _tmp77 = -_tmp55 * _tmp76 + _tmp56 * _tmp75;
  const Scalar _tmp78 = Scalar(1.0) * _tmp39;
  const Scalar _tmp79 = Scalar(1.0) * _tmp42;
  const Scalar _tmp80 = (-_tmp50 + _tmp79) / (_tmp52 - _tmp78);
  const Scalar _tmp81 = _tmp59 * (_tmp55 * _tmp74 - _tmp55 * _tmp75);
  const Scalar _tmp82 = -_tmp37 * _tmp72 + _tmp37 * _tmp74 - _tmp60 * _tmp81 -
                        _tmp80 * (-_tmp37 * _tmp76 + _tmp49 * _tmp72 - _tmp61 * _tmp77);
  const Scalar _tmp83 = Scalar(1.0) / (_tmp82);
  const Scalar _tmp84 = _tmp78 * _tmp80 + _tmp79;
  const Scalar _tmp85 = 0;
  const Scalar _tmp86 = _tmp57 * _tmp59;
  const Scalar _tmp87 = _tmp59 * _tmp77;
  const Scalar _tmp88 = Scalar(1.0) * _tmp80 * _tmp87 - Scalar(1.0) * _tmp81;
  const Scalar _tmp89 = _tmp62 * _tmp83;
  const Scalar _tmp90 = _tmp63 * _tmp82;
  const Scalar _tmp91 = _tmp88 + _tmp90 * (-Scalar(1.0) * _tmp86 - _tmp88 * _tmp89);
  const Scalar _tmp92 = _tmp83 * _tmp91;
  const Scalar _tmp93 = _tmp60 * _tmp83;
  const Scalar _tmp94 = _tmp59 * (-_tmp91 * _tmp93 + Scalar(1.0));
  const Scalar _tmp95 = _tmp27 * _tmp47 * (_tmp37 * _tmp92 + _tmp55 * _tmp94);
  const Scalar _tmp96 = _tmp58 * _tmp81 - _tmp74 - _tmp80 * (_tmp58 * _tmp87 + _tmp76);
  const Scalar _tmp97 = _tmp90 * (-_tmp48 + _tmp58 * _tmp86 - _tmp89 * _tmp96) + _tmp96;
  const Scalar _tmp98 = _tmp83 * _tmp97;
  const Scalar _tmp99 = _tmp59 * (-_tmp58 - _tmp93 * _tmp97);
  const Scalar _tmp100 = _tmp28 * _tmp47 * (_tmp37 * _tmp98 + _tmp55 * _tmp99 + Scalar(1.0));
  const Scalar _tmp101 = _tmp27 * _tmp94;
  const Scalar _tmp102 = _tmp29 * _tmp64;
  const Scalar _tmp103 = _tmp102 * fh1;
  const Scalar _tmp104 = _tmp67 * _tmp85;
  const Scalar _tmp105 = _tmp28 * _tmp99;
  const Scalar _tmp106 = _tmp27 * _tmp92;
  ...
  _res(1, 0) = -(-_tmp100 - _tmp66 - _tmp95) *
               std::exp(_tmp100 * fh1 + _tmp47 * _tmp67 * (_tmp37 * _tmp85 - _tmp65 * _tmp85) +
                        _tmp66 * fh1 + _tmp95 * fh1);
  _res(2, 0) = -(_tmp101 - _tmp102 * _tmp61 + _tmp105) *
               std::exp(-_tmp101 * fh1 + _tmp103 * _tmp61 + _tmp104 * _tmp61 - _tmp105 * fh1);
  _res(3, 0) =
