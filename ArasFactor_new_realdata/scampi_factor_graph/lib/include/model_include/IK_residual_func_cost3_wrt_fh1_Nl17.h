...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl17(
  ...
  const Scalar _tmp39 = _tmp17 * _tmp28;
  ...
  const Scalar _tmp43 = (-_tmp26 + _tmp41) / (_tmp16 - _tmp42);
  ...
  const Scalar _tmp55 = _tmp54 + position_vector(1, 0) + Scalar(8.3196563720703107);
  ...
  const Scalar _tmp59 = _tmp46 + _tmp50;
  const Scalar _tmp60 = _tmp47 + _tmp48 + _tmp49;
  const Scalar _tmp61 = _tmp29 * _tmp60;
  const Scalar _tmp62 = -_tmp38 * _tmp61 + _tmp39 * _tmp59;
  const Scalar _tmp63 = _tmp38 * _tmp57 - _tmp58;
  const Scalar _tmp64 = _tmp40 * _tmp63;
  const Scalar _tmp65 = _tmp57 * _tmp60;
  const Scalar _tmp66 = -_tmp29 * _tmp59 + _tmp61;
  const Scalar _tmp67 = -_tmp43 * (-_tmp38 * _tmp65 + _tmp51 * _tmp58 - _tmp62 * _tmp64) -
                        _tmp51 * _tmp57 - _tmp64 * _tmp66 + _tmp65;
  const Scalar _tmp68 = Scalar(1.0) / (_tmp67);
  const Scalar _tmp69 = _tmp63 * _tmp68;
  const Scalar _tmp70 = _tmp40 * _tmp45 * _tmp69;
  ...
  const Scalar _tmp74 = _tmp18 + _tmp25;
  const Scalar _tmp75 = _tmp31 + _tmp8;
  const Scalar _tmp76 = _tmp75 + position_vector(1, 0) + Scalar(-4.7744369927459998);
  const Scalar _tmp77 = _tmp74 + position_vector(0, 0) + Scalar(-2.7171519410699099);
  ...
  const Scalar _tmp84 = _tmp16 * _tmp29 - _tmp26 * _tmp39 + _tmp29 * _tmp83;
  const Scalar _tmp85 = -_tmp52 * _tmp58 + _tmp54 * _tmp57 + _tmp57 * _tmp83 - _tmp64 * _tmp84;
  ...
  const Scalar _tmp90 = _tmp73 * _tmp81 * (-_tmp29 * _tmp89 + _tmp57 * _tmp87);
  const Scalar _tmp91 = _tmp43 * _tmp62 * _tmp88 - _tmp66 * _tmp88;
  const Scalar _tmp92 = _tmp68 * _tmp85;
  const Scalar _tmp93 = _tmp67 * _tmp86;
  const Scalar _tmp94 = _tmp91 + _tmp93 * (-_tmp84 * _tmp88 - _tmp91 * _tmp92);
  const Scalar _tmp95 = _tmp40 * (-_tmp69 * _tmp94 + Scalar(1.0));
  const Scalar _tmp96 = _tmp68 * _tmp94;
  const Scalar _tmp97 = _tmp73 * _tmp79 * (_tmp29 * _tmp95 + _tmp57 * _tmp96);
  const Scalar _tmp98 = _tmp38 * _tmp40;
  const Scalar _tmp99 = -_tmp43 * (_tmp38 * _tmp60 + _tmp62 * _tmp98) - _tmp60 + _tmp66 * _tmp98;
  const Scalar _tmp100 = _tmp93 * (-_tmp83 + _tmp84 * _tmp98 - _tmp92 * _tmp99) + _tmp99;
  const Scalar _tmp101 = _tmp40 * (-_tmp100 * _tmp69 - _tmp38);
  const Scalar _tmp102 = _tmp100 * _tmp68;
  const Scalar _tmp103 = _tmp73 * _tmp80 * (_tmp101 * _tmp29 + _tmp102 * _tmp57 + Scalar(1.0));
  const Scalar _tmp104 = _tmp101 * _tmp80;
  const Scalar _tmp105 = _tmp81 * _tmp89;
  const Scalar _tmp106 = _tmp79 * _tmp95;
  const Scalar _tmp107 = _tmp102 * _tmp80;
  const Scalar _tmp108 = _tmp79 * _tmp96;
  ...
  _res(1, 0) = -(-_tmp103 - _tmp90 - _tmp97) *
               std::exp(_tmp0 * _tmp73 * (-_tmp29 * _tmp70 + _tmp57 * _tmp71) + _tmp103 * fh1 +
                        _tmp90 * fh1 + _tmp97 * fh1);
  _res(2, 0) = -(_tmp104 - _tmp105 + _tmp106) *
               std::exp(_tmp0 * _tmp70 - _tmp104 * fh1 + _tmp105 * fh1 - _tmp106 * fh1);
  _res(3, 0) = -(_tmp107 + _tmp108 + _tmp109) *
               std::exp(-_tmp0 * _tmp71 - _tmp107 * fh1 - _tmp108 * fh1 - _tmp109 * fh1);
