...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl20(
  ...
  const Scalar _tmp43 = _tmp42 * (-_tmp16 * _tmp29 + _tmp25 * _tmp30 + _tmp30 * _tmp40);
  ...
  const Scalar _tmp51 = -_tmp30 * _tmp48 + _tmp50;
  ...
  const Scalar _tmp56 = _tmp29 * _tmp48 - _tmp41 * _tmp50;
  const Scalar _tmp57 = _tmp42 * _tmp56;
  const Scalar _tmp58 = -Scalar(1.0) * _tmp52 + Scalar(1.0) * _tmp55 * _tmp57;
  ...
  const Scalar _tmp62 = _tmp31 + _tmp7;
  ...
  const Scalar _tmp69 = _tmp49 * _tmp66;
  const Scalar _tmp70 = _tmp44 + _tmp45 + _tmp46;
  const Scalar _tmp71 = -_tmp51 * _tmp68 -
                        _tmp55 * (-_tmp41 * _tmp69 - _tmp56 * _tmp68 + _tmp65 * _tmp70) -
                        _tmp66 * _tmp70 + _tmp69;
  const Scalar _tmp72 = Scalar(1.0) / (_tmp71);
  const Scalar _tmp73 = _tmp40 * _tmp66 - _tmp43 * _tmp67 + _tmp60 * _tmp66 - _tmp62 * _tmp65;
  const Scalar _tmp74 = _tmp72 * _tmp73;
  const Scalar _tmp75 = Scalar(1.0) / (_tmp73);
  const Scalar _tmp76 = _tmp71 * _tmp75;
  const Scalar _tmp77 = _tmp58 + _tmp76 * (-Scalar(1.0) * _tmp43 - _tmp58 * _tmp74);
  ...
  const Scalar _tmp84 = _tmp18 + _tmp59;
  const Scalar _tmp85 = _tmp84 + position_vector(1, 0) + Scalar(-4.83288938413423);
  ...
  const Scalar _tmp96 = _tmp39 * (-_tmp30 * _tmp95 + _tmp66 * _tmp94);
  const Scalar _tmp97 = _tmp41 * _tmp52 - _tmp49 - _tmp55 * (_tmp41 * _tmp49 + _tmp41 * _tmp57);
  const Scalar _tmp98 = _tmp76 * (-_tmp40 + _tmp41 * _tmp43 - _tmp74 * _tmp97) + _tmp97;
  const Scalar _tmp99 = -_tmp41 - _tmp79 * _tmp98;
  const Scalar _tmp100 = _tmp92 * _tmp94;
  const Scalar _tmp101 = _tmp89 * _tmp91;
  const Scalar _tmp102 = _tmp42 * fh1;
  ...
  _res(0, 0) = 0;
  _res(1, 0) =
      -_tmp96 * std::exp(_tmp39 * _tmp91 * (-_tmp30 * _tmp68 * _tmp89 + _tmp66 * _tmp89) +
                         _tmp87 * _tmp88 * (_tmp77 * _tmp78 + _tmp80 * _tmp81) +
                         _tmp88 * _tmp90 * (_tmp78 * _tmp98 + _tmp81 * _tmp99 + Scalar(1.0)) +
                         _tmp92 * _tmp96);
  _res(2, 0) = -_tmp95 * std::exp(_tmp100 * _tmp68 + _tmp101 * _tmp68 - _tmp102 * _tmp80 * _tmp87 -
                                  _tmp102 * _tmp90 * _tmp99);
  _res(3, 0) =
      _tmp94 * std::exp(-_tmp100 - _tmp101 - _tmp103 * _tmp77 * _tmp87 - _tmp103 * _tmp90 * _tmp98);
