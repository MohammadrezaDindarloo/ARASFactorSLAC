...
Eigen::Matrix<Scalar, 4, 1> FkResidualFuncCost3(
  ...
  const Scalar _tmp35 = _tmp17 + _tmp7;
  ...
  const Scalar _tmp40 = -Scalar(0.010999999999999999) * _tmp20 -
  ...
  const Scalar _tmp56 = _tmp47 * _tmp52;
  const Scalar _tmp57 = _tmp36 - p_b(1, 0);
  const Scalar _tmp58 = _tmp34 - p_b(0, 0);
  const Scalar _tmp59 = Scalar(1.0) / (_tmp58);
  const Scalar _tmp60 = _tmp57 * _tmp59;
  const Scalar _tmp61 = _tmp53 * _tmp60 - _tmp56;
  ...
  const Scalar _tmp72 = _tmp38 + _tmp42;
  ...
  const Scalar _tmp76 = _tmp43 * _tmp56 - _tmp53 * _tmp74 - _tmp61 * _tmp75;
  ...
  const Scalar _tmp82 = -_tmp43 * _tmp53 + _tmp53 * _tmp55 - _tmp61 * _tmp73 - _tmp76 * _tmp81;
  ...
  const Scalar _tmp93 = _tmp89 * (_tmp33 * _tmp57 * _tmp92 - _tmp35 * _tmp58 * _tmp92);
  const Scalar _tmp94 = _tmp71 * (-_tmp62 * _tmp70 + _tmp65 * _tmp69 + _tmp69 * _tmp93);
  const Scalar _tmp95 = _tmp45 * _tmp53 - _tmp49 * _tmp56 + _tmp53 * _tmp93 - _tmp61 * _tmp94;
  ...
  const Scalar _tmp116 = -_tmp106 * _tmp89 * (_tmp100 * _tmp53 + _tmp101 * _tmp86) -
                         _tmp113 * _tmp89 * (_tmp110 * _tmp53 + _tmp111 * _tmp86 + Scalar(1.0)) -
                         _tmp115 * _tmp89 * (_tmp114 * _tmp53 - _tmp114 * _tmp87) -
                         _tmp37 * _tmp89 * (_tmp53 * _tmp85 - _tmp85 * _tmp87);
  const Scalar _tmp117 = Scalar(1.0) / (_tmp116);
  const Scalar _tmp118 = _tmp45 + _tmp78;
  const Scalar _tmp119 = _tmp118 * _tmp81;
  const Scalar _tmp120 = Scalar(1.0) / (-_tmp119 - _tmp49 + _tmp80);
  ...
  const Scalar _tmp127 = fh1 * (_tmp39 + _tmp54);
  ...
  const Scalar _tmp135 = _tmp112 * _tmp127 + Scalar(5.1796800000000003) * _tmp25 + _tmp29 * fv1;
  const Scalar _tmp136 = std::asinh(
      _tmp117 * (Scalar(1.0) * _tmp106 * (_tmp121 * _tmp99 - _tmp124 * _tmp131) +
                 ...
                 Scalar(1.0) * _tmp37 * (-_tmp121 * _tmp84 - _tmp124 * _tmp133 + Scalar(1.0))));
  const Scalar _tmp137 = Scalar(9.6622558468725703) * _tmp116;
  const Scalar _tmp138 = _tmp37 * _tmp85;
  ...
  const Scalar _tmp144 =
      std::asinh(_tmp142 * (_tmp106 * _tmp131 * _tmp79 + _tmp113 * _tmp126 * _tmp79 +
                            ...
                            _tmp133 * _tmp37 * _tmp79 - _tmp134 * _tmp143));
  ...
  const Scalar _tmp148 =
      std::asinh(_tmp147 * (-_tmp106 * _tmp120 * _tmp99 - _tmp109 * _tmp113 * _tmp120 -
                            _tmp115 * _tmp122 - _tmp128 * _tmp129 + _tmp132 * _tmp37 + _tmp143));
