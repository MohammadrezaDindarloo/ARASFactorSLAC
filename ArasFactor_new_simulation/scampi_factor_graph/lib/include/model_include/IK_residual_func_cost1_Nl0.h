...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl0(
  ...
  const Scalar _tmp64 = _tmp18 + _tmp9;
  ...
  const Scalar _tmp69 = _tmp33 + _tmp58;
  const Scalar _tmp70 = _tmp52 * _tmp56;
  const Scalar _tmp71 = -_tmp57 * _tmp68 + _tmp69 * _tmp70;
  const Scalar _tmp72 = _tmp47 * _tmp48;
  const Scalar _tmp73 = _tmp49 * _tmp67 - _tmp72;
  const Scalar _tmp74 = Scalar(1.0) / (_tmp57 * _tmp67 - _tmp70);
  const Scalar _tmp75 = _tmp73 * _tmp74;
  const Scalar _tmp76 = _tmp33 + _tmp37;
  const Scalar _tmp77 = -_tmp49 * _tmp68 - _tmp71 * _tmp75 + _tmp72 * _tmp76;
  const Scalar _tmp78 = Scalar(1.0) * _tmp64;
  const Scalar _tmp79 = -_tmp78;
  const Scalar _tmp80 = Scalar(1.0) / (_tmp50 + _tmp79);
  const Scalar _tmp81 = Scalar(1.0) * _tmp60;
  const Scalar _tmp82 = _tmp80 * (-_tmp53 + _tmp81);
  const Scalar _tmp83 = _tmp57 * _tmp59 - _tmp57 * _tmp69;
  const Scalar _tmp84 = _tmp49 * _tmp59 - _tmp49 * _tmp76 - _tmp75 * _tmp83 - _tmp77 * _tmp82;
  const Scalar _tmp85 = Scalar(1.0) / (_tmp84);
  const Scalar _tmp86 = _tmp78 * _tmp82 + _tmp81;
  const Scalar _tmp87 = 0;
  const Scalar _tmp88 =
      std::sqrt(Scalar(std::pow(_tmp62, Scalar(2)) + std::pow(_tmp66, Scalar(2))));
  const Scalar _tmp89 = _tmp63 * _tmp88;
  const Scalar _tmp90 = Scalar(1.0) / (_tmp88);
  const Scalar _tmp91 = _tmp89 * (_tmp60 * _tmp66 * _tmp90 - _tmp62 * _tmp64 * _tmp90);
  const Scalar _tmp92 = _tmp50 * _tmp57 - _tmp53 * _tmp70 + _tmp57 * _tmp91;
  const Scalar _tmp93 = Scalar(1.0) * _tmp74;
  const Scalar _tmp94 = _tmp71 * _tmp93;
  const Scalar _tmp95 = _tmp82 * _tmp94 - _tmp83 * _tmp93;
  const Scalar _tmp96 = -_tmp41 * _tmp72 + _tmp45 * _tmp49 + _tmp49 * _tmp91 - _tmp75 * _tmp92;
  const Scalar _tmp97 = _tmp85 * _tmp96;
  const Scalar _tmp98 = Scalar(1.0) / (_tmp96);
  const Scalar _tmp99 = _tmp84 * _tmp98;
  const Scalar _tmp100 = _tmp99 * (-_tmp92 * _tmp93 - _tmp95 * _tmp97);
  const Scalar _tmp101 = _tmp85 * (_tmp100 + _tmp95);
  const Scalar _tmp102 = -_tmp101 * _tmp73 + Scalar(1.0);
  const Scalar _tmp103 = _tmp57 * _tmp74;
  const Scalar _tmp104 = _tmp31 + Scalar(1.9874742031097401);
  const Scalar _tmp105 = _tmp20 + Scalar(8.3196563720703107);
  ...
  const Scalar _tmp110 = _tmp73 * _tmp93 * _tmp98;
  const Scalar _tmp111 = _tmp104 * _tmp106;
  const Scalar _tmp112 = fh1 * (_tmp107 * _tmp30 - _tmp111 * _tmp19);
  const Scalar _tmp113 = _tmp67 * _tmp74;
  const Scalar _tmp114 = _tmp113 * _tmp71 + _tmp68;
  const Scalar _tmp115 = _tmp113 * _tmp83 - _tmp114 * _tmp82 - _tmp59;
  const Scalar _tmp116 = _tmp99 * (_tmp113 * _tmp92 - _tmp115 * _tmp97 - _tmp91);
  const Scalar _tmp117 = _tmp85 * (_tmp115 + _tmp116);
  const Scalar _tmp118 = -_tmp117 * _tmp73 - _tmp67;
  const Scalar _tmp119 = _tmp111 * fh1;
  const Scalar _tmp120 = -_tmp108 * _tmp89 * (_tmp101 * _tmp49 + _tmp102 * _tmp103) -
                         _tmp112 * _tmp89 * (_tmp109 * _tmp49 - _tmp110 * _tmp57) -
                         _tmp119 * _tmp89 * (_tmp103 * _tmp118 + _tmp117 * _tmp49 + Scalar(1.0)) -
                         _tmp39 * _tmp89 * (_tmp49 * _tmp87 - _tmp57 * _tmp75 * _tmp87);
  const Scalar _tmp121 = Scalar(1.0) / (_tmp120);
  const Scalar _tmp122 = _tmp38 * fh1;
  const Scalar _tmp123 = _tmp111 * _tmp122 + Scalar(5.1796800000000003) * _tmp26 + _tmp30 * fv1;
  const Scalar _tmp124 = _tmp45 + _tmp79;
  const Scalar _tmp125 = _tmp124 * _tmp82;
  const Scalar _tmp126 = Scalar(1.0) / (-_tmp125 - _tmp41 + _tmp81);
  const Scalar _tmp127 = Scalar(1.0) * _tmp126;
  const Scalar _tmp128 = _tmp124 * _tmp80;
  const Scalar _tmp129 = _tmp124 * _tmp126;
  const Scalar _tmp130 = _tmp114 + _tmp116 * _tmp129 - _tmp117 * _tmp77;
  const Scalar _tmp131 = Scalar(1.0) * _tmp80;
  const Scalar _tmp132 = _tmp126 * _tmp86;
  const Scalar _tmp133 = _tmp80 * (-_tmp124 * _tmp132 - _tmp77 * _tmp87 + _tmp79);
  const Scalar _tmp134 = _tmp100 * _tmp129 - _tmp101 * _tmp77 - _tmp94;
  const Scalar _tmp135 = _tmp127 * _tmp99;
  const Scalar _tmp136 = -_tmp109 * _tmp77 + _tmp124 * _tmp135;
  const Scalar _tmp137 = _tmp125 * _tmp127 + Scalar(1.0);
  const Scalar _tmp138 = _tmp127 * _tmp82;
  const Scalar _tmp139 = -_tmp107 * _tmp122 - Scalar(5.1796800000000003) * _tmp16 - _tmp19 * fv1;
  const Scalar _tmp140 = std::asinh(
      _tmp121 * (Scalar(1.0) * _tmp108 * (_tmp100 * _tmp127 - _tmp131 * _tmp134) +
                 Scalar(1.0) * _tmp112 * (-_tmp131 * _tmp136 + _tmp135) +
                 Scalar(1.0) * _tmp119 * (_tmp116 * _tmp127 - _tmp130 * _tmp131) +
                 Scalar(1.0) * _tmp123 * (_tmp127 * _tmp128 - _tmp127) +
                 Scalar(1.0) * _tmp139 * (-_tmp131 * _tmp137 + _tmp138) +
                 Scalar(1.0) * _tmp39 * (-_tmp127 * _tmp86 - Scalar(1.0) * _tmp133 + Scalar(1.0))));
  const Scalar _tmp141 = Scalar(9.6622558468725703) * _tmp120;
  const Scalar _tmp142 = _tmp39 * _tmp87;
  const Scalar _tmp143 = _tmp102 * _tmp108 * _tmp74 - _tmp110 * _tmp112 +
                         _tmp118 * _tmp119 * _tmp74 - _tmp142 * _tmp75;
  const Scalar _tmp144 = Scalar(1.0) / (_tmp143);
  const Scalar _tmp145 = _tmp123 * _tmp127;
  const Scalar _tmp146 =
      std::asinh(_tmp144 * (_tmp108 * _tmp134 * _tmp80 + _tmp112 * _tmp136 * _tmp80 +
                            _tmp119 * _tmp130 * _tmp80 - _tmp128 * _tmp145 + _tmp133 * _tmp39 +
                            _tmp137 * _tmp139 * _tmp80));
  const Scalar _tmp147 = Scalar(9.6622558468725703) * _tmp143;
  const Scalar _tmp148 = _tmp101 * _tmp108 + _tmp109 * _tmp112 + _tmp117 * _tmp119 + _tmp142;
  const Scalar _tmp149 = Scalar(1.0) / (_tmp148);
  const Scalar _tmp150 = std::asinh(_tmp149 * (-_tmp100 * _tmp108 * _tmp126 - _tmp112 * _tmp135 -
                                               _tmp116 * _tmp119 * _tmp126 + _tmp132 * _tmp39 -
                                               _tmp138 * _tmp139 + _tmp145));
  ...
  _res(1, 0) =
      -_tmp141 *
          (Scalar(0.876505537412406) * _tmp121 + std::cosh(Scalar(1.0) * _tmp140) -
           std::cosh(
               ...
               (-_tmp140 * _tmp141 -
                Scalar(8.3885017487099702) *
                    std::sqrt(Scalar(
                        ...
                        std::pow(Scalar(-Scalar(0.11921079949155229) * _tmp65 - 1),
                                 Scalar(2))))))) +
      _tmp59 + position_vector(2, 0);
  _res(2, 0) =
      -_tmp147 *
          (Scalar(0.86564762886483004) * _tmp144 + std::cosh(Scalar(1.0) * _tmp146) -
