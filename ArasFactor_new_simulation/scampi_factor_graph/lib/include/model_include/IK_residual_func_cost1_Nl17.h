...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl17(
  ...
  const Scalar _tmp49 = _tmp48 + Scalar(8.3196563720703107);
  ...
  const Scalar _tmp56 = _tmp41 + _tmp8;
  const Scalar _tmp57 = _tmp56 + position_vector(0, 0);
  const Scalar _tmp58 = _tmp57 + Scalar(1.7965602546229);
  const Scalar _tmp59 = Scalar(1.0) / (_tmp58);
  const Scalar _tmp60 = _tmp55 * _tmp59;
  const Scalar _tmp61 = _tmp51 * _tmp60 - _tmp52;
  const Scalar _tmp62 = _tmp19 + _tmp46;
  const Scalar _tmp63 = _tmp62 + position_vector(1, 0);
  const Scalar _tmp64 = _tmp63 + Scalar(8.3885017487099702);
  const Scalar _tmp65 = _tmp16 + _tmp40;
  const Scalar _tmp66 = _tmp65 + position_vector(0, 0);
  const Scalar _tmp67 = _tmp66 + Scalar(-2.5193355532036801);
  ...
  const Scalar _tmp72 = _tmp31 + _tmp38;
  const Scalar _tmp73 = _tmp34 + _tmp37;
  const Scalar _tmp74 = _tmp69 * _tmp73;
  const Scalar _tmp75 = _tmp71 * (-_tmp60 * _tmp74 + _tmp70 * _tmp72);
  const Scalar _tmp76 = _tmp51 * _tmp73;
  const Scalar _tmp77 = _tmp39 * _tmp52 - _tmp60 * _tmp76 - _tmp61 * _tmp75;
  ...
  const Scalar _tmp84 = _tmp71 * (-_tmp69 * _tmp72 + _tmp74);
  const Scalar _tmp85 = -_tmp39 * _tmp51 - _tmp61 * _tmp84 + _tmp76 - _tmp77 * _tmp83;
  const Scalar _tmp86 = Scalar(1.0) / (_tmp85);
  const Scalar _tmp87 = _tmp78 * _tmp83 + _tmp81;
  const Scalar _tmp88 = 0;
  const Scalar _tmp89 = _tmp69 * _tmp71;
  ...
  const Scalar _tmp94 = _tmp92 * (-_tmp53 * _tmp58 * _tmp93 + _tmp55 * _tmp56 * _tmp93);
  const Scalar _tmp95 = _tmp71 * (_tmp62 * _tmp69 - _tmp65 * _tmp70 + _tmp69 * _tmp94);
  const Scalar _tmp96 = -_tmp42 * _tmp52 + _tmp47 * _tmp51 + _tmp51 * _tmp94 - _tmp61 * _tmp95;
  ...
  const Scalar _tmp104 = fh1 * (_tmp102 * _tmp17 - _tmp103 * _tmp27);
  const Scalar _tmp105 = Scalar(1.0) * _tmp80;
  const Scalar _tmp106 = _tmp105 * _tmp75 * _tmp82 - Scalar(1.0) * _tmp84;
  const Scalar _tmp107 = _tmp86 * _tmp96;
  const Scalar _tmp108 = _tmp85 * _tmp97;
  const Scalar _tmp109 = _tmp108 * (-_tmp106 * _tmp107 - Scalar(1.0) * _tmp95);
  const Scalar _tmp110 = _tmp86 * (_tmp106 + _tmp109);
  const Scalar _tmp111 = -_tmp110 * _tmp61 + Scalar(1.0);
  const Scalar _tmp112 = _tmp102 * fh1;
  const Scalar _tmp113 = _tmp60 * _tmp73 + _tmp60 * _tmp75;
  const Scalar _tmp114 = -_tmp113 * _tmp83 + _tmp60 * _tmp84 - _tmp73;
  const Scalar _tmp115 = _tmp108 * (-_tmp107 * _tmp114 + _tmp60 * _tmp95 - _tmp94);
  const Scalar _tmp116 = _tmp86 * (_tmp114 + _tmp115);
  const Scalar _tmp117 = -_tmp116 * _tmp61 - _tmp60;
  const Scalar _tmp118 = _tmp103 * fh1;
  const Scalar _tmp119 = -_tmp104 * _tmp92 * (_tmp51 * _tmp98 - _tmp90 * _tmp98) -
                         _tmp112 * _tmp92 * (_tmp110 * _tmp51 + _tmp111 * _tmp89) -
                         _tmp118 * _tmp92 * (_tmp116 * _tmp51 + _tmp117 * _tmp89 + Scalar(1.0)) -
                         _tmp36 * _tmp92 * (_tmp51 * _tmp88 - _tmp88 * _tmp90);
  const Scalar _tmp120 = Scalar(1.0) / (_tmp119);
  const Scalar _tmp121 = _tmp35 * fh1;
  const Scalar _tmp122 = _tmp103 * _tmp121 + Scalar(5.1796800000000003) * _tmp14 + _tmp17 * fv1;
  const Scalar _tmp123 = _tmp47 + _tmp79;
  const Scalar _tmp124 = _tmp123 * _tmp83;
  const Scalar _tmp125 = Scalar(1.0) / (-_tmp124 - _tmp42 + _tmp81);
  const Scalar _tmp126 = Scalar(1.0) * _tmp125;
  const Scalar _tmp127 = _tmp123 * _tmp126;
  const Scalar _tmp128 = -_tmp102 * _tmp121 - Scalar(5.1796800000000003) * _tmp24 - _tmp27 * fv1;
  const Scalar _tmp129 = _tmp80 * (_tmp124 * _tmp126 + Scalar(1.0));
  const Scalar _tmp130 = _tmp126 * _tmp83;
  const Scalar _tmp131 = _tmp125 * _tmp87;
  const Scalar _tmp132 = -_tmp123 * _tmp131 - _tmp77 * _tmp88 + _tmp79;
  const Scalar _tmp133 = _tmp123 * _tmp125;
  const Scalar _tmp134 = _tmp109 * _tmp133 - _tmp110 * _tmp77 - Scalar(1.0) * _tmp75;
  const Scalar _tmp135 = _tmp108 * _tmp127 - _tmp77 * _tmp98;
  const Scalar _tmp136 = _tmp108 * _tmp126;
  const Scalar _tmp137 = _tmp113 + _tmp115 * _tmp133 - _tmp116 * _tmp77;
  const Scalar _tmp138 = std::asinh(
      _tmp120 * (Scalar(1.0) * _tmp104 * (-_tmp105 * _tmp135 + _tmp136) +
                 Scalar(1.0) * _tmp112 * (-_tmp105 * _tmp134 + _tmp109 * _tmp126) +
                 Scalar(1.0) * _tmp118 * (-_tmp105 * _tmp137 + _tmp115 * _tmp126) +
                 Scalar(1.0) * _tmp122 * (-_tmp126 + _tmp127 * _tmp80) +
                 Scalar(1.0) * _tmp128 * (-Scalar(1.0) * _tmp129 + _tmp130) +
                 Scalar(1.0) * _tmp36 * (-_tmp105 * _tmp132 - _tmp126 * _tmp87 + Scalar(1.0))));
  const Scalar _tmp139 = Scalar(9.6622558468725703) * _tmp119;
  const Scalar _tmp140 = _tmp104 * _tmp98;
  const Scalar _tmp141 = _tmp61 * _tmp71;
  const Scalar _tmp142 = _tmp36 * _tmp88;
  const Scalar _tmp143 = _tmp111 * _tmp112 * _tmp71 + _tmp117 * _tmp118 * _tmp71 -
  ...
  const Scalar _tmp146 =
      std::asinh(_tmp144 * (_tmp104 * _tmp135 * _tmp80 + _tmp112 * _tmp134 * _tmp80 +
                            _tmp118 * _tmp137 * _tmp80 - _tmp123 * _tmp145 * _tmp80 +
                            _tmp128 * _tmp129 + _tmp132 * _tmp36 * _tmp80));
  const Scalar _tmp147 = Scalar(9.6622558468725703) * _tmp143;
  const Scalar _tmp148 = _tmp110 * _tmp112 + _tmp116 * _tmp118 + _tmp140 + _tmp142;
  const Scalar _tmp149 = Scalar(1.0) / (_tmp148);
  const Scalar _tmp150 = std::asinh(_tmp149 * (-_tmp104 * _tmp136 - _tmp109 * _tmp112 * _tmp125 -
                                               _tmp115 * _tmp118 * _tmp125 - _tmp128 * _tmp130 +
                                               _tmp131 * _tmp36 + _tmp145));
  ...
  _res(1, 0) =
      -_tmp139 *
          (Scalar(0.86627065637365697) * _tmp120 + std::cosh(Scalar(1.0) * _tmp138) -
           std::cosh(
               Scalar(0.1034955) * _tmp120 *
               (-_tmp138 * _tmp139 -
                Scalar(4.83288938413423) *
                    std::sqrt(Scalar(
                        std::pow(Scalar(1 - Scalar(0.20691555724053495) * _tmp54), Scalar(2)) +
                        Scalar(0.13818785160942856) *
                            std::pow(Scalar(-Scalar(0.55661923802822921) * _tmp57 - 1),
                                     Scalar(2))))))) +
      _tmp73 + position_vector(2, 0);
  _res(2, 0) =
      -_tmp147 *
          (Scalar(0.876505537412406) * _tmp144 + std::cosh(Scalar(1.0) * _tmp146) -
           std::cosh(
                ...
                Scalar(8.3885017487099702) *
                    std::sqrt(Scalar(
                        Scalar(0.090199313518583735) *
                            std::pow(Scalar(1 - Scalar(0.39693005512043167) * _tmp66), Scalar(2)) +
                        std::pow(Scalar(-Scalar(0.11921079949155229) * _tmp63 - 1),
                                 Scalar(2))))))) +
               ...
               (-_tmp150 * _tmp151 -
                Scalar(8.3196563720703107) *
                    std::sqrt(Scalar(
                        ...
                        std::pow(Scalar(-Scalar(0.12019727201198747) * _tmp48 - 1),
                                 Scalar(2))))))) +
