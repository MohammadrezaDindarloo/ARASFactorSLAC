...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1WrtFh1Nl5(
  ...
  const Scalar _tmp53 = _tmp25 + _tmp39;
  const Scalar _tmp54 = _tmp12 + _tmp42;
  const Scalar _tmp55 = _tmp54 + position_vector(1, 0);
  const Scalar _tmp56 = _tmp55 + Scalar(-4.7744369927459998);
  const Scalar _tmp57 = _tmp53 + position_vector(0, 0);
  ...
  const Scalar _tmp62 = _tmp52 * _tmp61 - _tmp53 * _tmp60 + _tmp54 * _tmp61;
  ...
  const Scalar _tmp73 = _tmp60 * _tmp71 - _tmp61 * _tmp72;
  const Scalar _tmp74 = _tmp64 * _tmp73 + _tmp72;
  ...
  const Scalar _tmp81 = _tmp61 * _tmp70 - _tmp61 * _tmp71;
  const Scalar _tmp82 = _tmp64 * _tmp81 - _tmp70 - _tmp74 * _tmp80;
  const Scalar _tmp83 = _tmp12 + _tmp21;
  const Scalar _tmp84 = _tmp83 + position_vector(1, 0);
  const Scalar _tmp85 = _tmp84 + Scalar(8.3885017487099702);
  const Scalar _tmp86 = _tmp25 + _tmp32;
  const Scalar _tmp87 = _tmp86 + position_vector(0, 0);
  const Scalar _tmp88 = _tmp87 + Scalar(-2.5193355532036801);
  ...
  const Scalar _tmp92 = _tmp67 - _tmp68;
  const Scalar _tmp93 = _tmp65 + _tmp92;
  const Scalar _tmp94 = _tmp85 * _tmp89;
  const Scalar _tmp95 = _tmp48 * _tmp90 - _tmp94;
  const Scalar _tmp96 = _tmp63 * _tmp95;
  const Scalar _tmp97 = -_tmp48 * _tmp91 - _tmp73 * _tmp96 + _tmp93 * _tmp94;
  const Scalar _tmp98 = -_tmp80 * _tmp97 - _tmp81 * _tmp96 - _tmp90 * _tmp93 + _tmp91;
  const Scalar _tmp99 = Scalar(1.0) / (_tmp98);
  const Scalar _tmp100 = _tmp52 * _tmp90 - _tmp62 * _tmp96 + _tmp83 * _tmp90 - _tmp86 * _tmp94;
  const Scalar _tmp101 = _tmp100 * _tmp99;
  const Scalar _tmp102 = Scalar(1.0) / (_tmp100);
  const Scalar _tmp103 = _tmp102 * _tmp98;
  const Scalar _tmp104 = _tmp103 * (-_tmp101 * _tmp82 - _tmp52 + _tmp62 * _tmp64);
  const Scalar _tmp105 = _tmp104 + _tmp82;
  const Scalar _tmp106 = _tmp95 * _tmp99;
  const Scalar _tmp107 = -_tmp105 * _tmp106 - _tmp48;
  const Scalar _tmp108 = _tmp61 * _tmp63;
  const Scalar _tmp109 = _tmp90 * _tmp99;
  ...
  const Scalar _tmp115 = Scalar(1.0) * _tmp63;
  const Scalar _tmp116 = Scalar(1.0) * _tmp77;
  const Scalar _tmp117 = -_tmp115 * _tmp81 + _tmp116 * _tmp63 * _tmp73 * _tmp79;
  const Scalar _tmp118 = _tmp103 * (-_tmp101 * _tmp117 - _tmp115 * _tmp62);
  ...
  const Scalar _tmp131 = _tmp128 * _tmp51 * (_tmp129 * _tmp90 - _tmp130 * _tmp61);
  const Scalar _tmp132 = -_tmp114 * fh1 - _tmp122 * fh1 -
                         _tmp123 * _tmp51 * (-_tmp108 * _tmp127 + _tmp126 * _tmp90) - _tmp131 * fh1;
  const Scalar _tmp133 = Scalar(1.0) / (_tmp132);
  const Scalar _tmp134 = _tmp76 + _tmp83;
  const Scalar _tmp135 = _tmp134 * _tmp80;
  const Scalar _tmp136 = Scalar(1.0) / (-_tmp135 + _tmp78 - _tmp86);
  const Scalar _tmp137 = Scalar(1.0) * _tmp136;
  const Scalar _tmp138 = _tmp134 * _tmp136;
  const Scalar _tmp139 = _tmp97 * _tmp99;
  const Scalar _tmp140 = -_tmp115 * _tmp73 + _tmp118 * _tmp138 - _tmp119 * _tmp139;
  const Scalar _tmp141 = Scalar(1.0) * _tmp121 * (-_tmp116 * _tmp140 + _tmp118 * _tmp137);
  const Scalar _tmp142 = _tmp104 * _tmp138 - _tmp105 * _tmp139 + _tmp74;
  const Scalar _tmp143 = Scalar(1.0) * _tmp113 * (_tmp104 * _tmp137 - _tmp116 * _tmp142);
  const Scalar _tmp144 = _tmp66 + _tmp92;
  const Scalar _tmp145 = _tmp144 * fh1;
  const Scalar _tmp146 = _tmp113 * _tmp145 + Scalar(5.1796800000000003) * _tmp29 + _tmp33 * fv1;
  const Scalar _tmp147 = _tmp134 * _tmp77;
  const Scalar _tmp148 = Scalar(1.0) * _tmp137 * _tmp147 - Scalar(1.0) * _tmp137;
  const Scalar _tmp149 = _tmp103 * _tmp137;
  const Scalar _tmp150 = _tmp77 * (-_tmp129 * _tmp97 + _tmp134 * _tmp149);
  const Scalar _tmp151 = Scalar(1.0) * _tmp128 * (_tmp149 - Scalar(1.0) * _tmp150);
  const Scalar _tmp152 = _tmp124 * _tmp136;
  const Scalar _tmp153 = -_tmp125 * _tmp139 - _tmp134 * _tmp152 + _tmp76;
  const Scalar _tmp154 = -_tmp121 * _tmp145 - Scalar(5.1796800000000003) * _tmp16 - _tmp22 * fv1;
  const Scalar _tmp155 = _tmp135 * _tmp137 + Scalar(1.0);
  const Scalar _tmp156 = _tmp137 * _tmp80;
  const Scalar _tmp157 = -Scalar(1.0) * _tmp116 * _tmp155 + Scalar(1.0) * _tmp156;
  const Scalar _tmp158 =
      Scalar(1.0) * _tmp123 * (-_tmp116 * _tmp153 - _tmp124 * _tmp137 + Scalar(1.0)) +
      _tmp141 * fh1 + _tmp143 * fh1 + _tmp146 * _tmp148 + _tmp151 * fh1 + _tmp154 * _tmp157;
  const Scalar _tmp159 = std::asinh(_tmp133 * _tmp158);
  const Scalar _tmp160 = Scalar(9.6622558468725703) * _tmp132;
  ...
  const Scalar _tmp165 = -_tmp114 - _tmp122 - _tmp131;
  ...
  const Scalar _tmp169 = _tmp113 * _tmp144;
  const Scalar _tmp170 = _tmp121 * _tmp144;
  const Scalar _tmp171 =
      (_tmp133 * (_tmp141 + _tmp143 + _tmp148 * _tmp169 + _tmp151 - _tmp157 * _tmp170) -
       _tmp158 * _tmp168) /
      std::sqrt(Scalar(std::pow(_tmp158, Scalar(2)) * _tmp167 + 1));
  const Scalar _tmp172 = _tmp128 * _tmp130;
  const Scalar _tmp173 = _tmp120 * _tmp121 * _tmp63;
  const Scalar _tmp174 = _tmp107 * _tmp113 * _tmp63;
  const Scalar _tmp175 =
      -_tmp123 * _tmp127 * _tmp63 - _tmp172 * fh1 + _tmp173 * fh1 + _tmp174 * fh1;
  const Scalar _tmp176 = Scalar(1.0) / (_tmp175);
  const Scalar _tmp177 = _tmp137 * _tmp146;
  const Scalar _tmp178 = _tmp155 * _tmp77;
  const Scalar _tmp179 = _tmp121 * _tmp140 * _tmp77;
  const Scalar _tmp180 = _tmp128 * _tmp150;
  const Scalar _tmp181 = _tmp113 * _tmp77;
  const Scalar _tmp182 = _tmp142 * _tmp181;
  const Scalar _tmp183 = _tmp123 * _tmp153 * _tmp77 - _tmp147 * _tmp177 + _tmp154 * _tmp178 +
  ...
  const Scalar _tmp187 = -_tmp172 + _tmp173 + _tmp174;
  const Scalar _tmp188 = _tmp186 * _tmp187;
  const Scalar _tmp189 = (_tmp176 * (-_tmp134 * _tmp137 * _tmp144 * _tmp181 - _tmp170 * _tmp178 +
  ...
  const Scalar _tmp192 = Scalar(9.6622558468725703) * _tmp175;
  const Scalar _tmp193 = Scalar(0.1034955) * _tmp176;
  const Scalar _tmp194 = _tmp191 * _tmp193;
  const Scalar _tmp195 = _tmp119 * _tmp121 * _tmp99;
  const Scalar _tmp196 = _tmp128 * _tmp129;
  const Scalar _tmp197 = _tmp105 * _tmp113 * _tmp99;
  const Scalar _tmp198 = _tmp123 * _tmp126 + _tmp195 * fh1 + _tmp196 * fh1 + _tmp197 * fh1;
  const Scalar _tmp199 = Scalar(1.0) / (_tmp198);
  const Scalar _tmp200 = _tmp104 * _tmp113 * _tmp136;
  const Scalar _tmp201 = _tmp128 * _tmp149;
  const Scalar _tmp202 = _tmp118 * _tmp121 * _tmp136;
  const Scalar _tmp203 = _tmp123 * _tmp152 - _tmp154 * _tmp156 + _tmp177 - _tmp200 * fh1 -
  ...
  const Scalar _tmp209 =
      (_tmp199 * (_tmp137 * _tmp169 + _tmp156 * _tmp170 - _tmp200 - _tmp201 - _tmp202) -
       _tmp203 * _tmp208) /
      ...
      Scalar(8.3885017487099702) *
          std::sqrt(
              Scalar(Scalar(0.090199313518583735) *
                         std::pow(Scalar(1 - Scalar(0.39693005512043167) * _tmp87), Scalar(2)) +
                     std::pow(Scalar(-Scalar(0.11921079949155229) * _tmp84 - 1), Scalar(2))));
  ...
  _res(1, 0) =
      -_tmp160 *
          (-Scalar(0.86627065637365697) * _tmp168 + Scalar(1.0) * _tmp171 * std::sinh(_tmp164) -
           (-Scalar(0.1034955) * _tmp161 * _tmp168 +
            _tmp162 * (-_tmp159 * _tmp166 - _tmp160 * _tmp171)) *
               std::sinh(_tmp163)) -
      _tmp166 * (Scalar(0.86627065637365697) * _tmp133 - std::cosh(_tmp163) + std::cosh(_tmp164));
  _res(2, 0) =
      -Scalar(9.6622558468725703) * _tmp187 *
          (Scalar(0.86564762886483004) * _tmp176 + std::cosh(_tmp185) - std::cosh(_tmp194)) -
      _tmp192 *
          (-Scalar(0.86564762886483004) * _tmp188 + Scalar(1.0) * _tmp189 * std::sinh(_tmp185) -
           (-Scalar(0.1034955) * _tmp188 * _tmp191 +
            _tmp193 * (-_tmp187 * _tmp190 - _tmp189 * _tmp192)) *
               std::sinh(_tmp194));
  _res(3, 0) =
      -Scalar(9.6622558468725703) * _tmp207 *
          (Scalar(0.876505537412406) * _tmp199 + std::cosh(_tmp205) - std::cosh(_tmp214)) -
      _tmp210 * (-Scalar(0.876505537412406) * _tmp208 + Scalar(1.0) * _tmp209 * std::sinh(_tmp205) -
                 (-Scalar(0.1034955) * _tmp208 * _tmp213 +
                  _tmp212 * (-_tmp207 * _tmp211 - _tmp209 * _tmp210)) *
                     std::sinh(_tmp214));
