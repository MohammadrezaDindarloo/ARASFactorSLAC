...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl9(
  ...
  const Scalar _tmp56 = _tmp45 + _tmp8;
  ...
  const Scalar _tmp64 = Scalar(1.0) / (_tmp50 * _tmp63 - _tmp55);
  const Scalar _tmp65 = _tmp63 * _tmp64;
  const Scalar _tmp66 = -_tmp51 * _tmp63 + _tmp53 * _tmp55;
  const Scalar _tmp67 = _tmp39 * _tmp63;
  ...
  const Scalar _tmp74 = -_tmp39 + _tmp54 * _tmp65 - _tmp68 * _tmp73;
  const Scalar _tmp75 = _tmp36 + _tmp52;
  ...
  const Scalar _tmp79 = _tmp16 + _tmp44;
  ...
  const Scalar _tmp87 = -_tmp66 * _tmp86 - _tmp67 * _tmp83 + _tmp75 * _tmp84;
  const Scalar _tmp88 = _tmp39 * _tmp83 - _tmp54 * _tmp86 - _tmp73 * _tmp87 - _tmp75 * _tmp83;
  ...
  const Scalar _tmp94 = _tmp64 * (-_tmp41 * _tmp55 + _tmp46 * _tmp50 + _tmp50 * _tmp93);
  ...
  const Scalar _tmp99 = _tmp98 * (_tmp63 * _tmp94 - _tmp74 * _tmp96 - _tmp93);
  ...
  const Scalar _tmp112 = -_tmp110 * _tmp54 + _tmp111 * _tmp73;
  ...
  const Scalar _tmp119 = fh1 * (-_tmp108 * _tmp17 + _tmp116 * _tmp28);
  ...
  const Scalar _tmp125 = -_tmp109 * _tmp92 * (_tmp100 * _tmp101 + _tmp103 * _tmp104 + Scalar(1.0)) -
                         ...
                         _tmp119 * _tmp92 * (-_tmp118 * _tmp50 * _tmp86 + _tmp118 * _tmp83) -
                         _tmp120 * _tmp92 * (-_tmp104 * _tmp124 + _tmp123 * _tmp83);
  const Scalar _tmp126 = Scalar(1.0) / (_tmp125);
  const Scalar _tmp127 = _tmp70 + _tmp79;
  const Scalar _tmp128 = _tmp127 * _tmp73;
  const Scalar _tmp129 = Scalar(1.0) / (-_tmp128 + _tmp72 - _tmp76);
  const Scalar _tmp130 = _tmp127 * _tmp129;
  const Scalar _tmp131 = _tmp87 * _tmp89;
  const Scalar _tmp132 = -_tmp100 * _tmp131 + _tmp130 * _tmp99 + _tmp68;
  const Scalar _tmp133 = Scalar(1.0) * _tmp71;
  const Scalar _tmp134 = Scalar(1.0) * _tmp129;
  const Scalar _tmp135 = _tmp121 * _tmp129;
  const Scalar _tmp136 = -_tmp122 * _tmp131 - _tmp127 * _tmp135 + _tmp70;
  const Scalar _tmp137 = _tmp134 * _tmp98;
  const Scalar _tmp138 = _tmp127 * _tmp134;
  const Scalar _tmp139 = -_tmp118 * _tmp87 + _tmp138 * _tmp98;
  const Scalar _tmp140 = -_tmp111 + _tmp113 * _tmp130 - _tmp114 * _tmp131;
  const Scalar _tmp141 = _tmp37 * fh1;
  const Scalar _tmp142 = _tmp108 * _tmp141 + Scalar(5.1796800000000003) * _tmp23 + _tmp28 * fv1;
  const Scalar _tmp143 = -_tmp116 * _tmp141 - Scalar(5.1796800000000003) * _tmp14 - _tmp17 * fv1;
  const Scalar _tmp144 = _tmp128 * _tmp134 + Scalar(1.0);
  const Scalar _tmp145 = _tmp134 * _tmp73;
  const Scalar _tmp146 = std::asinh(
      _tmp126 * (Scalar(1.0) * _tmp109 * (-_tmp132 * _tmp133 + _tmp134 * _tmp99) +
                 Scalar(1.0) * _tmp117 * (_tmp113 * _tmp134 - _tmp133 * _tmp140) +
                 Scalar(1.0) * _tmp119 * (-_tmp133 * _tmp139 + _tmp137) +
                 Scalar(1.0) * _tmp120 * (-_tmp121 * _tmp134 - _tmp133 * _tmp136 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp142 * (-_tmp134 + _tmp138 * _tmp71) +
                 Scalar(1.0) * _tmp143 * (-_tmp133 * _tmp144 + _tmp145)));
  ...
  const Scalar _tmp149 = _tmp134 * _tmp142;
  const Scalar _tmp150 = _tmp118 * _tmp119;
  const Scalar _tmp151 = _tmp103 * _tmp109 * _tmp64 + _tmp115 * _tmp117 * _tmp64 -
                         _tmp120 * _tmp124 * _tmp64 - _tmp150 * _tmp86;
  const Scalar _tmp152 = Scalar(1.0) / (_tmp151);
  const Scalar _tmp153 =
      std::asinh(_tmp152 * (_tmp109 * _tmp132 * _tmp71 + _tmp117 * _tmp140 * _tmp71 +
                            _tmp119 * _tmp139 * _tmp71 + _tmp120 * _tmp136 * _tmp71 -
                            _tmp127 * _tmp149 * _tmp71 + _tmp143 * _tmp144 * _tmp71));
  ...
  const Scalar _tmp156 =
      _tmp100 * _tmp109 * _tmp89 + _tmp114 * _tmp117 * _tmp89 + _tmp120 * _tmp123 + _tmp150;
  const Scalar _tmp157 = Scalar(1.0) / (_tmp156);
  const Scalar _tmp158 =
      std::asinh(_tmp157 * (-_tmp109 * _tmp129 * _tmp99 - _tmp113 * _tmp117 * _tmp129 -
                            _tmp119 * _tmp137 + _tmp120 * _tmp135 - _tmp143 * _tmp145 + _tmp149));
  ...
  _res(2, 0) =
      ...
      Scalar(8.3701287145205097) *
          std::sqrt(Scalar(Scalar(0.014273672465547484) * _tmp155 +
                           std::pow(Scalar(-Scalar(0.11947247576553975) * _tmp53 -
