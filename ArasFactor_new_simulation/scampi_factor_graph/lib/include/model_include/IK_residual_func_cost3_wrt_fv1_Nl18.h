...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl18(
  ...
  const Scalar _tmp91 = _tmp39 * (-_tmp29 * _tmp90 + _tmp66 * _tmp89);
  const Scalar _tmp92 = Scalar(1.0) * _tmp44;
  const Scalar _tmp93 = -_tmp52 * _tmp92 + _tmp54 * _tmp57 * _tmp92;
  const Scalar _tmp94 = _tmp74 * (-_tmp42 * _tmp92 - _tmp72 * _tmp93) + _tmp93;
  ...
  const Scalar _tmp99 = _tmp44 * fh1;
  ...
  _res(0, 0) = 0;
  _res(1, 0) =
      -_tmp91 * std::exp(_tmp39 * _tmp98 * (-_tmp29 * _tmp68 * _tmp97 + _tmp66 * _tmp97) +
                         _tmp85 * _tmp86 * (_tmp75 * _tmp76 + _tmp78 * _tmp79 + Scalar(1.0)) +
                         _tmp86 * _tmp96 * (_tmp76 * _tmp94 + _tmp79 * _tmp95) + _tmp87 * _tmp91);
  _res(2, 0) = -_tmp90 * std::exp(_tmp100 * _tmp68 + _tmp101 * _tmp68 - _tmp78 * _tmp85 * _tmp99 -
                                  _tmp95 * _tmp96 * _tmp99);
  _res(3, 0) =
      _tmp89 * std::exp(-_tmp100 - _tmp101 - _tmp102 * _tmp75 * _tmp85 - _tmp102 * _tmp94 * _tmp96);
