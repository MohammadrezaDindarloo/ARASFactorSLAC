...
namespace gtsam
{
    ...
    class FK_factor_graoh_cost3 : public NoiseModelFactorN<double, double, gtsam::Rot3, gtsam::Pose3, gtsam::Point3, gtsam::Point3, gtsam::Point3, gtsam::Point3>
    {
    ...
    public:
        // Constructor
        FK_factor_graoh_cost3(Key key1, Key key2, Key key3, Key key4, Key key5, Key key6, Key key7, Key key8, Eigen::Vector4d encoder_, const SharedNoiseModel &model) 
        : NoiseModelFactorN<double, double, gtsam::Rot3, gtsam::Pose3, gtsam::Point3, gtsam::Point3, gtsam::Point3, gtsam::Point3>(model, key1, key2, key3, key4, key5, key6, key7, key8), encoder(encoder_) {}
        ...
        Vector evaluateError(const double &fh1, const double &fv1, const gtsam::Rot3 &DeltaRot, const gtsam::Pose3 &transformation, const gtsam::Point3 &p_a, const gtsam::Point3 &p_b, const gtsam::Point3 &p_c, const gtsam::Point3 &p_d,
                             ...
                             OptionalMatrixType H8) const override
        {   
            Eigen::Matrix<double, 4, 1> Fkresidual_func = sym::FkResidualFuncCost3(fh1, fv1, SymforceFromGtsam(DeltaRot), SymPoseFromGtsam(transformation), encoder, p_a, p_b, p_c, p_d, sym::kDefaultEpsilon<double>);
            if(H1)
            {
                Eigen::Matrix<double, 4, 1> Fkresidual_func_wrt_fh1 = sym::FkResidualFuncCost3WrtFh1(fh1, fv1, SymforceFromGtsam(DeltaRot), SymPoseFromGtsam(transformation), encoder, p_a, p_b, p_c, p_d, sym::kDefaultEpsilon<double>);
                *H1 = (Matrix(4, 1) << Fkresidual_func_wrt_fh1).finished();
            }
            if(H2)
            {
                Eigen::Matrix<double, 4, 1> Fkresidual_func_wrt_fv1 = sym::FkResidualFuncCost3WrtFv1(fh1, fv1, SymforceFromGtsam(DeltaRot), SymPoseFromGtsam(transformation), encoder, p_a, p_b, p_c, p_d, sym::kDefaultEpsilon<double>);
                *H2 = (Matrix(4, 1) << Fkresidual_func_wrt_fv1).finished();
            }
            if(H3)
            {
                Eigen::Matrix<double, 4, 3> Fkresidual_func_wrt_Deltarot = sym::FkResidualFuncCost3WrtDeltarot(fh1, fv1, SymforceFromGtsam(DeltaRot), SymPoseFromGtsam(transformation), encoder, p_a, p_b, p_c, p_d, sym::kDefaultEpsilon<double>);
                *H3 = (Matrix(4, 3) << Fkresidual_func_wrt_Deltarot).finished();
            }
            if(H4)
            {
                Eigen::Matrix<double, 4, 6> Fkresidual_func_wrt_trsansformation = sym::FkResidualFuncCost3WrtTransformation(fh1, fv1, SymforceFromGtsam(DeltaRot), SymPoseFromGtsam(transformation), encoder, p_a, p_b, p_c, p_d, sym::kDefaultEpsilon<double>);
                *H4 = (Matrix(4, 6) << Fkresidual_func_wrt_trsansformation).finished();
            }
            if(H5)
            {
                Eigen::Matrix<double, 4, 3> Fkresidual_func_wrt_pa = sym::FkResidualFuncCost3WrtPa(fh1, fv1, SymforceFromGtsam(DeltaRot), SymPoseFromGtsam(transformation), encoder, p_a, p_b, p_c, p_d, sym::kDefaultEpsilon<double>);
                *H5 = (Matrix(4, 3) << Fkresidual_func_wrt_pa).finished();
            }
            if(H6)
            {
                Eigen::Matrix<double, 4, 3> Fkresidual_func_wrt_pb = sym::FkResidualFuncCost3WrtPb(fh1, fv1, SymforceFromGtsam(DeltaRot), SymPoseFromGtsam(transformation), encoder, p_a, p_b, p_c, p_d, sym::kDefaultEpsilon<double>);
                *H6 = (Matrix(4, 3) << Fkresidual_func_wrt_pb).finished();
            }
            if(H7)
            {
                Eigen::Matrix<double, 4, 3> Fkresidual_func_wrt_pc = sym::FkResidualFuncCost3WrtPc(fh1, fv1, SymforceFromGtsam(DeltaRot), SymPoseFromGtsam(transformation), encoder, p_a, p_b, p_c, p_d, sym::kDefaultEpsilon<double>);
                *H7 = (Matrix(4, 3) << Fkresidual_func_wrt_pc).finished();
            }
            if(H8)
            {
                Eigen::Matrix<double, 4, 3> Fkresidual_func_wrt_pd = sym::FkResidualFuncCost3WrtPd(fh1, fv1, SymforceFromGtsam(DeltaRot), SymPoseFromGtsam(transformation), encoder, p_a, p_b, p_c, p_d, sym::kDefaultEpsilon<double>);
                *H8 = (Matrix(4, 3) << Fkresidual_func_wrt_pd).finished();
            }
            return (Vector(4) << Fkresidual_func).finished();
        }
