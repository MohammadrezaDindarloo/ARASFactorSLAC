...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl15(
  ...
  const Scalar _tmp65 = -Scalar(5.1796800000000003) * _tmp24 - _tmp29 * fv1 - _tmp41 * _tmp64;
  ...
  const Scalar _tmp75 = _tmp33 - _tmp34;
  ...
  const Scalar _tmp117 = _tmp112 * (_tmp116 + _tmp92);
  const Scalar _tmp118 = _tmp54 * _tmp61;
  const Scalar _tmp119 = -_tmp110 * _tmp117 + _tmp116 * _tmp118 + _tmp91;
  const Scalar _tmp120 = _tmp40 * fh1;
  const Scalar _tmp121 = Scalar(1.0) * _tmp87;
  const Scalar _tmp122 = _tmp58 * _tmp67 * _tmp87 * _tmp89 - Scalar(1.0) * _tmp88;
  const Scalar _tmp123 = _tmp115 * (-_tmp104 * _tmp121 - _tmp113 * _tmp122);
  const Scalar _tmp124 = _tmp122 + _tmp123;
  const Scalar _tmp125 = _tmp110 * _tmp112;
  const Scalar _tmp126 = _tmp118 * _tmp123 - _tmp121 * _tmp89 - _tmp124 * _tmp125;
  ...
  const Scalar _tmp131 = fh1 * (_tmp19 * _tmp64 - _tmp29 * _tmp40);
  const Scalar _tmp132 = _tmp45 + _tmp50 * _tmp59;
  const Scalar _tmp133 = _tmp132 * _tmp61;
  const Scalar _tmp134 = 0;
  const Scalar _tmp135 = -_tmp125 * _tmp134 - _tmp133 * _tmp54 + _tmp51;
  ...
  const Scalar _tmp139 = _tmp112 * _tmp124;
  const Scalar _tmp140 = -_tmp105 * _tmp139 + Scalar(1.0);
  const Scalar _tmp141 = _tmp82 * _tmp87;
  const Scalar _tmp142 = -_tmp105 * _tmp117 - _tmp74;
  const Scalar _tmp143 = -_tmp101 * _tmp120 * (_tmp117 * _tmp98 + _tmp141 * _tmp142 + Scalar(1.0)) -
                         _tmp101 * _tmp127 * (_tmp139 * _tmp98 + _tmp140 * _tmp141) -
  ...
  const Scalar _tmp145 = std::asinh(
      _tmp144 * (Scalar(1.0) * _tmp120 * (_tmp116 * _tmp62 - _tmp119 * _tmp67) +
  ...
  const Scalar _tmp150 = -_tmp106 * _tmp148 - _tmp106 * _tmp149 + _tmp120 * _tmp142 * _tmp87 +
                         _tmp127 * _tmp140 * _tmp87;
  const Scalar _tmp151 = Scalar(1.0) / (_tmp150);
  const Scalar _tmp152 = _tmp42 * _tmp62;
  const Scalar _tmp153 =
      std::asinh(_tmp151 * (_tmp119 * _tmp120 * _tmp56 + _tmp126 * _tmp127 * _tmp56 +
                            _tmp130 * _tmp131 * _tmp56 + _tmp135 * _tmp136 * _tmp56 -
                            _tmp152 * _tmp63 + _tmp56 * _tmp65 * _tmp66));
  const Scalar _tmp154 = Scalar(0.1034955) * _tmp151;
  const Scalar _tmp155 = Scalar(9.6622558468725703) * _tmp150;
  const Scalar _tmp156 = _tmp117 * _tmp120 + _tmp127 * _tmp139 + _tmp148 + _tmp149;
  const Scalar _tmp157 = Scalar(1.0) / (_tmp156);
  const Scalar _tmp158 =
      std::asinh(_tmp157 * (-_tmp116 * _tmp120 * _tmp61 - _tmp123 * _tmp127 * _tmp61 -
                            _tmp129 * _tmp131 + _tmp133 * _tmp136 + _tmp152 - _tmp65 * _tmp68));
  ...
  _res(2, 0) =
      -_tmp155 *
          (_tmp154 * p_d(2, 0) + std::cosh(Scalar(1.0) * _tmp153) -
           std::cosh(_tmp154 *
                     (-_tmp153 * _tmp155 -
                      std::sqrt(Scalar(std::pow(Scalar(-_tmp77 + p_d(1, 0)), Scalar(2)) +
                                       std::pow(Scalar(-_tmp79 + p_d(0, 0)), Scalar(2))))))) +
      _tmp76 + p_init2;
  _res(3, 0) =
      _tmp108 -
      _tmp159 * (_tmp160 * p_a(2, 0) + std::cosh(Scalar(1.0) * _tmp158) -
                 std::cosh(_tmp160 *
                           (-_tmp158 * _tmp159 -
                            std::sqrt(Scalar(std::pow(Scalar(-_tmp93 + p_a(0, 0)), Scalar(2)) +
