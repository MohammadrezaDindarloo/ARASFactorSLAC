...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl20(
  ...
  const Scalar _tmp50 = _tmp22 + _tmp44;
  ...
  const Scalar _tmp69 = _tmp35 + _tmp66;
  const Scalar _tmp70 = -_tmp49 * _tmp68 + _tmp61 * _tmp69;
  ...
  const Scalar _tmp77 = _tmp49 * _tmp67 - _tmp49 * _tmp69;
  const Scalar _tmp78 = _tmp65 * _tmp77 - _tmp67 - _tmp71 * _tmp76;
  const Scalar _tmp79 = _tmp19 + _tmp7;
  const Scalar _tmp80 = _tmp79 + p_init0;
  const Scalar _tmp81 = _tmp80 - p_c(0, 0);
  const Scalar _tmp82 = _tmp22 + _tmp30;
  ...
  const Scalar _tmp91 = -_tmp68 * _tmp86 - _tmp70 * _tmp90 + _tmp87 * _tmp88;
  const Scalar _tmp92 = _tmp67 * _tmp86 - _tmp76 * _tmp91 - _tmp77 * _tmp90 - _tmp86 * _tmp87;
  const Scalar _tmp93 = Scalar(1.0) / (_tmp92);
  const Scalar _tmp94 = _tmp60 * _tmp86 - _tmp62 * _tmp90 - _tmp79 * _tmp88 + _tmp82 * _tmp86;
  const Scalar _tmp95 = _tmp93 * _tmp94;
  const Scalar _tmp96 = Scalar(1.0) / (_tmp94);
  const Scalar _tmp97 = _tmp92 * _tmp96;
  const Scalar _tmp98 = _tmp97 * (-_tmp60 + _tmp62 * _tmp65 - _tmp78 * _tmp95);
  const Scalar _tmp99 = _tmp73 + _tmp82;
  const Scalar _tmp100 = _tmp76 * _tmp99;
  const Scalar _tmp101 = Scalar(1.0) / (-_tmp100 + _tmp75 - _tmp79);
  const Scalar _tmp102 = _tmp101 * _tmp99;
  const Scalar _tmp103 = _tmp78 + _tmp98;
  const Scalar _tmp104 = _tmp91 * _tmp93;
  const Scalar _tmp105 = _tmp102 * _tmp98 - _tmp103 * _tmp104 + _tmp71;
  ...
  const Scalar _tmp113 = _tmp72 * _tmp76 + _tmp75;
  const Scalar _tmp114 = 0;
  const Scalar _tmp115 = _tmp101 * _tmp113;
  const Scalar _tmp116 = -_tmp104 * _tmp114 - _tmp115 * _tmp99 + _tmp73;
  const Scalar _tmp117 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp118 = _tmp107 * _tmp99;
  const Scalar _tmp119 = Scalar(1.0) * _tmp96;
  const Scalar _tmp120 = _tmp118 * _tmp97 - _tmp119 * _tmp91;
  const Scalar _tmp121 = _tmp107 * _tmp97;
  const Scalar _tmp122 = _tmp108 * _tmp110;
  const Scalar _tmp123 = fh1 * (-_tmp111 * _tmp31 + _tmp122 * _tmp20);
  const Scalar _tmp124 = _tmp107 * _tmp76;
  const Scalar _tmp125 = _tmp100 * _tmp107 + Scalar(1.0);
  const Scalar _tmp126 = _tmp39 * fh1;
  const Scalar _tmp127 = -_tmp122 * _tmp126 - Scalar(5.1796800000000003) * _tmp26 - _tmp31 * fv1;
  const Scalar _tmp128 = Scalar(1.0) * _tmp64;
  const Scalar _tmp129 = _tmp128 * _tmp70;
  const Scalar _tmp130 = -_tmp128 * _tmp77 + _tmp129 * _tmp76;
  const Scalar _tmp131 = _tmp97 * (-_tmp128 * _tmp62 - _tmp130 * _tmp95);
  const Scalar _tmp132 = _tmp130 + _tmp131;
  const Scalar _tmp133 = _tmp102 * _tmp131 - _tmp104 * _tmp132 - _tmp129;
  const Scalar _tmp134 = _tmp122 * fh1;
  const Scalar _tmp135 = _tmp111 * _tmp126 + Scalar(5.1796800000000003) * _tmp14 + _tmp20 * fv1;
  const Scalar _tmp136 = _tmp114 * _tmp93;
  const Scalar _tmp137 = _tmp49 * _tmp90;
  const Scalar _tmp138 = _tmp89 * _tmp93;
  const Scalar _tmp139 = -_tmp132 * _tmp138 + Scalar(1.0);
  const Scalar _tmp140 = _tmp49 * _tmp64;
  const Scalar _tmp141 = _tmp86 * _tmp93;
  const Scalar _tmp142 = -_tmp103 * _tmp138 - _tmp63;
  const Scalar _tmp143 = -_tmp112 * _tmp59 * (_tmp103 * _tmp141 + _tmp140 * _tmp142 + Scalar(1.0)) -
                         _tmp117 * _tmp59 * (-_tmp136 * _tmp137 + _tmp136 * _tmp86) -
                         _tmp123 * _tmp59 * (-_tmp119 * _tmp137 + _tmp119 * _tmp86) -
                         _tmp134 * _tmp59 * (_tmp132 * _tmp141 + _tmp139 * _tmp140);
  const Scalar _tmp144 = Scalar(1.0) / (_tmp143);
  const Scalar _tmp145 = std::asinh(
      _tmp144 * (Scalar(1.0) * _tmp112 * (-_tmp105 * _tmp106 + _tmp107 * _tmp98) +
                 Scalar(1.0) * _tmp117 * (-_tmp106 * _tmp116 - _tmp107 * _tmp113 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp123 * (-_tmp106 * _tmp120 + _tmp121) +
                 Scalar(1.0) * _tmp127 * (-_tmp106 * _tmp125 + _tmp124) +
                 Scalar(1.0) * _tmp134 * (-_tmp106 * _tmp133 + _tmp107 * _tmp131) +
                 Scalar(1.0) * _tmp135 * (-_tmp107 + _tmp118 * _tmp74)));
  const Scalar _tmp146 = Scalar(0.1034955) * _tmp144;
  const Scalar _tmp147 = Scalar(9.6622558468725703) * _tmp143;
  const Scalar _tmp148 = _tmp107 * _tmp135;
  const Scalar _tmp149 = _tmp119 * _tmp123;
  const Scalar _tmp150 = _tmp117 * _tmp136;
  const Scalar _tmp151 =
      _tmp112 * _tmp142 * _tmp64 + _tmp134 * _tmp139 * _tmp64 - _tmp149 * _tmp90 - _tmp150 * _tmp90;
  const Scalar _tmp152 = Scalar(1.0) / (_tmp151);
  const Scalar _tmp153 =
      std::asinh(_tmp152 * (_tmp105 * _tmp112 * _tmp74 + _tmp116 * _tmp117 * _tmp74 +
                            _tmp120 * _tmp123 * _tmp74 + _tmp125 * _tmp127 * _tmp74 +
                            _tmp133 * _tmp134 * _tmp74 - _tmp148 * _tmp74 * _tmp99));
  const Scalar _tmp154 = Scalar(9.6622558468725703) * _tmp151;
  const Scalar _tmp155 = Scalar(0.1034955) * _tmp152;
  const Scalar _tmp156 =
      _tmp103 * _tmp112 * _tmp93 + _tmp132 * _tmp134 * _tmp93 + _tmp149 + _tmp150;
  const Scalar _tmp157 = Scalar(1.0) / (_tmp156);
  const Scalar _tmp158 =
      std::asinh(_tmp157 * (-_tmp101 * _tmp112 * _tmp98 - _tmp101 * _tmp131 * _tmp134 +
                            _tmp115 * _tmp117 - _tmp121 * _tmp123 - _tmp124 * _tmp127 + _tmp148));
  ...
  _res(1, 0) =
      -_tmp147 *
          (_tmp146 * p_b(2, 0) + std::cosh(Scalar(1.0) * _tmp145) -
           std::cosh(_tmp146 *
                     (-_tmp145 * _tmp147 -
  ...
  _res(2, 0) =
      -_tmp154 *
          (_tmp155 * p_a(2, 0) + std::cosh(Scalar(1.0) * _tmp153) -
           std::cosh(_tmp155 *
                     (-_tmp153 * _tmp154 -
