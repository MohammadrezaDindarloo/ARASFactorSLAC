...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl23(
  ...
  const Scalar _tmp64 = _tmp33 + _tmp60;
  const Scalar _tmp65 = _tmp39 + _tmp52;
  const Scalar _tmp66 = _tmp65 + p_init1;
  const Scalar _tmp67 = _tmp66 - p_b(1, 0);
  const Scalar _tmp68 = _tmp48 + _tmp7;
  ...
  const Scalar _tmp74 = _tmp47 * _tmp62;
  ...
  const Scalar _tmp78 = -_tmp47 * _tmp63 + _tmp58 * _tmp61 - _tmp75 * _tmp77;
  ...
  const Scalar _tmp86 = -_tmp57 * _tmp61 + _tmp63 - _tmp77 * _tmp85 - _tmp78 * _tmp84;
  ...
  const Scalar _tmp96 = -_tmp49 * _tmp58 + _tmp53 * _tmp57 + _tmp57 * _tmp91 - _tmp77 * _tmp92;
  ...
  const Scalar _tmp121 = -_tmp120 * _tmp59 - _tmp47;
  const Scalar _tmp122 = _tmp114 * fh1;
  const Scalar _tmp123 = -_tmp108 * _tmp90 * (_tmp101 * _tmp57 + _tmp102 * _tmp103) -
                         _tmp109 * _tmp90 * (_tmp111 * _tmp57 - _tmp111 * _tmp73 * _tmp77) -
                         _tmp115 * _tmp90 * (_tmp112 * _tmp57 - _tmp113 * _tmp73) -
                         _tmp122 * _tmp90 * (_tmp103 * _tmp121 + _tmp120 * _tmp57 + Scalar(1.0));
  const Scalar _tmp124 = Scalar(1.0) / (_tmp123);
  const Scalar _tmp125 = Scalar(0.1034955) * _tmp124;
  const Scalar _tmp126 = _tmp53 + _tmp80;
  const Scalar _tmp127 = _tmp126 * _tmp84;
  const Scalar _tmp128 = Scalar(1.0) / (-_tmp127 - _tmp49 + _tmp82);
  ...
  const Scalar _tmp135 = -_tmp107 * _tmp134 - Scalar(5.1796800000000003) * _tmp27 - _tmp30 * fv1;
  const Scalar _tmp136 = _tmp126 * _tmp81;
  const Scalar _tmp137 = _tmp114 * _tmp134 + Scalar(5.1796800000000003) * _tmp14 + _tmp20 * fv1;
  ...
  const Scalar _tmp142 = -_tmp112 * _tmp78 + _tmp126 * _tmp141;
  const Scalar _tmp143 = std::asinh(
      _tmp124 * (Scalar(1.0) * _tmp108 * (_tmp100 * _tmp129 - _tmp138 * _tmp94) +
                 ...
                 Scalar(1.0) * _tmp115 * (_tmp141 - _tmp142 * _tmp94) +
  ...
  const Scalar _tmp145 = _tmp109 * _tmp111;
  const Scalar _tmp146 = _tmp102 * _tmp108 * _tmp76 - _tmp113 * _tmp115 +
                         _tmp121 * _tmp122 * _tmp76 - _tmp145 * _tmp77;
  const Scalar _tmp147 = Scalar(1.0) / (_tmp146);
  const Scalar _tmp148 = _tmp129 * _tmp137;
  const Scalar _tmp149 =
      std::asinh(_tmp147 * (_tmp108 * _tmp138 * _tmp81 + _tmp109 * _tmp140 * _tmp81 +
                            _tmp115 * _tmp142 * _tmp81 + _tmp122 * _tmp131 * _tmp81 +
                            _tmp132 * _tmp135 * _tmp81 - _tmp136 * _tmp148));
  const Scalar _tmp150 = Scalar(0.1034955) * _tmp147;
  const Scalar _tmp151 = Scalar(9.6622558468725703) * _tmp146;
  const Scalar _tmp152 = _tmp101 * _tmp108 + _tmp112 * _tmp115 + _tmp120 * _tmp122 + _tmp145;
  const Scalar _tmp153 = Scalar(1.0) / (_tmp152);
  const Scalar _tmp154 =
      std::asinh(_tmp153 * (-_tmp100 * _tmp108 * _tmp128 + _tmp109 * _tmp139 - _tmp115 * _tmp141 -
                            _tmp119 * _tmp122 * _tmp128 - _tmp133 * _tmp135 + _tmp148));
  ...
  _res(2, 0) =
      -_tmp151 *
          (_tmp150 * p_b(2, 0) + std::cosh(Scalar(1.0) * _tmp149) -
           std::cosh(_tmp150 *
                     (-_tmp149 * _tmp151 -
