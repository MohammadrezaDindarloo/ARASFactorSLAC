...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl5(
  ...
  const Scalar _tmp45 = _tmp40 + _tmp7;
  ...
  const Scalar _tmp54 = _tmp44 - p_d(1, 0);
  const Scalar _tmp55 = _tmp42 - p_d(0, 0);
  const Scalar _tmp56 = Scalar(1.0) / (_tmp55);
  const Scalar _tmp57 = _tmp54 * _tmp56;
  const Scalar _tmp58 = _tmp24 + _tmp48;
  ...
  const Scalar _tmp70 = _tmp56 * _tmp68;
  const Scalar _tmp71 = _tmp70 * (_tmp41 * _tmp54 * _tmp69 - _tmp43 * _tmp55 * _tmp69);
  const Scalar _tmp72 = _tmp51 * _tmp52;
  const Scalar _tmp73 = -_tmp45 * _tmp72 + _tmp49 * _tmp53 + _tmp53 * _tmp71;
  const Scalar _tmp74 = Scalar(1.0) / (_tmp53 * _tmp57 - _tmp72);
  const Scalar _tmp75 = _tmp67 * _tmp74;
  const Scalar _tmp76 = _tmp58 * _tmp65 - _tmp61 * _tmp66 + _tmp65 * _tmp71 - _tmp73 * _tmp75;
  ...
  const Scalar _tmp92 = _tmp34 + _tmp89;
  const Scalar _tmp93 = -_tmp53 * _tmp91 + _tmp72 * _tmp92;
  const Scalar _tmp94 = -_tmp65 * _tmp91 + _tmp66 * _tmp90 - _tmp75 * _tmp93;
  ...
  const Scalar _tmp101 = _tmp53 * _tmp88 - _tmp53 * _tmp92;
  const Scalar _tmp102 = -_tmp100 * _tmp94 - _tmp101 * _tmp75 + _tmp65 * _tmp88 - _tmp65 * _tmp90;
  ...
  const Scalar _tmp107 = _tmp53 * _tmp74;
  const Scalar _tmp108 = _tmp103 * _tmp67;
  const Scalar _tmp109 = _tmp105 * _tmp108;
  const Scalar _tmp110 = _tmp78 * _tmp93;
  const Scalar _tmp111 = _tmp100 * _tmp110 - _tmp101 * _tmp78;
  const Scalar _tmp112 = _tmp103 * _tmp76;
  const Scalar _tmp113 = _tmp102 * _tmp77;
  const Scalar _tmp114 = _tmp113 * (-_tmp111 * _tmp112 - _tmp73 * _tmp78);
  const Scalar _tmp115 = _tmp111 + _tmp114;
  const Scalar _tmp116 = _tmp103 * _tmp65;
  const Scalar _tmp117 = -_tmp108 * _tmp115 + Scalar(1.0);
  const Scalar _tmp118 = _tmp84 * fh1;
  const Scalar _tmp119 = _tmp57 * _tmp74;
  const Scalar _tmp120 = _tmp119 * _tmp93 + _tmp91;
  const Scalar _tmp121 = -_tmp100 * _tmp120 + _tmp101 * _tmp119 - _tmp88;
  const Scalar _tmp122 = _tmp113 * (-_tmp112 * _tmp121 + _tmp119 * _tmp73 - _tmp71);
  const Scalar _tmp123 = _tmp121 + _tmp122;
  const Scalar _tmp124 = -_tmp108 * _tmp123 - _tmp57;
  const Scalar _tmp125 = _tmp85 * fh1;
  const Scalar _tmp126 = -_tmp118 * _tmp70 * (_tmp107 * _tmp117 + _tmp115 * _tmp116) -
                         _tmp125 * _tmp70 * (_tmp107 * _tmp124 + _tmp116 * _tmp123 + Scalar(1.0)) -
                         _tmp70 * _tmp86 * (-_tmp53 * _tmp79 + _tmp65 * _tmp80) -
                         _tmp70 * _tmp87 * (_tmp106 * _tmp65 - _tmp107 * _tmp109);
  const Scalar _tmp127 = Scalar(1.0) / (_tmp126);
  const Scalar _tmp128 = _tmp58 + _tmp96;
  const Scalar _tmp129 = _tmp100 * _tmp128;
  const Scalar _tmp130 = Scalar(1.0) / (-_tmp129 - _tmp61 + _tmp98);
  const Scalar _tmp131 = _tmp104 * _tmp130;
  const Scalar _tmp132 = -_tmp106 * _tmp94 - _tmp128 * _tmp131 + _tmp96;
  ...
  const Scalar _tmp139 = _tmp113 * _tmp138 - _tmp80 * _tmp94;
  const Scalar _tmp140 = _tmp113 * _tmp134;
  const Scalar _tmp141 = _tmp39 * fh1;
  const Scalar _tmp142 = -_tmp141 * _tmp84 - Scalar(5.1796800000000003) * _tmp28 - _tmp31 * fv1;
  const Scalar _tmp143 = _tmp129 * _tmp134 + Scalar(1.0);
  const Scalar _tmp144 = Scalar(5.1796800000000003) * _tmp14 + _tmp141 * _tmp85 + _tmp20 * fv1;
  const Scalar _tmp145 = -_tmp110 + _tmp114 * _tmp136 - _tmp115 * _tmp135;
  const Scalar _tmp146 = std::asinh(
      _tmp127 * (Scalar(1.0) * _tmp118 * (_tmp114 * _tmp134 - _tmp133 * _tmp145) +
                 Scalar(1.0) * _tmp125 * (_tmp122 * _tmp134 - _tmp133 * _tmp137) +
                 Scalar(1.0) * _tmp142 * (_tmp100 * _tmp134 - _tmp133 * _tmp143) +
                 Scalar(1.0) * _tmp144 * (-_tmp134 + _tmp138 * _tmp97) +
                 Scalar(1.0) * _tmp86 * (-_tmp133 * _tmp139 + _tmp140) +
                 Scalar(1.0) * _tmp87 * (-_tmp104 * _tmp134 - _tmp132 * _tmp133 + Scalar(1.0))));
  const Scalar _tmp147 = Scalar(9.6622558468725703) * _tmp126;
  const Scalar _tmp148 = Scalar(0.1034955) * _tmp127;
  const Scalar _tmp149 = -_tmp109 * _tmp74 * _tmp87 + _tmp117 * _tmp118 * _tmp74 +
                         _tmp124 * _tmp125 * _tmp74 - _tmp79 * _tmp86;
  const Scalar _tmp150 = Scalar(1.0) / (_tmp149);
  const Scalar _tmp151 = _tmp142 * _tmp97;
  const Scalar _tmp152 = _tmp134 * _tmp144;
  const Scalar _tmp153 =
      std::asinh(_tmp150 * (_tmp118 * _tmp145 * _tmp97 + _tmp125 * _tmp137 * _tmp97 -
                            _tmp128 * _tmp152 * _tmp97 + _tmp132 * _tmp87 * _tmp97 +
                            _tmp139 * _tmp86 * _tmp97 + _tmp143 * _tmp151));
  const Scalar _tmp154 = Scalar(9.6622558468725703) * _tmp149;
  const Scalar _tmp155 = Scalar(0.1034955) * _tmp150;
  const Scalar _tmp156 = _tmp103 * _tmp115 * _tmp118 + _tmp103 * _tmp123 * _tmp125 +
                         _tmp106 * _tmp87 + _tmp80 * _tmp86;
  const Scalar _tmp157 = Scalar(1.0) / (_tmp156);
  const Scalar _tmp158 = Scalar(0.1034955) * _tmp157;
  const Scalar _tmp159 = std::asinh(
      _tmp157 * (-_tmp114 * _tmp118 * _tmp130 - _tmp122 * _tmp125 * _tmp130 + _tmp131 * _tmp87 -
                 _tmp134 * _tmp151 * _tmp99 - _tmp140 * _tmp86 + _tmp152));
  ...
  _res(1, 0) =
      -_tmp147 *
          (_tmp148 * p_d(2, 0) + std::cosh(Scalar(1.0) * _tmp146) -
           std::cosh(_tmp148 *
                     (-_tmp146 * _tmp147 -
                      std::sqrt(Scalar(std::pow(Scalar(-_tmp42 + p_d(0, 0)), Scalar(2)) +
