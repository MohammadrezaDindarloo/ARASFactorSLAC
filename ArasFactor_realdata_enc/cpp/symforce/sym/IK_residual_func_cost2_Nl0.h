...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl0(
  ...
  const Scalar _tmp58 = _tmp45 - p_b(1, 0);
  const Scalar _tmp59 = _tmp43 - p_b(0, 0);
  const Scalar _tmp60 =
  ...
  const Scalar _tmp64 = _tmp63 * (_tmp42 * _tmp58 * _tmp61 - _tmp44 * _tmp59 * _tmp61);
  const Scalar _tmp65 = -_tmp48 * _tmp56 + _tmp52 * _tmp57 + _tmp57 * _tmp64;
  const Scalar _tmp66 = _tmp58 * _tmp62;
  const Scalar _tmp67 = Scalar(1.0) / (-_tmp56 + _tmp57 * _tmp66);
  const Scalar _tmp68 = Scalar(1.0) * _tmp67;
  const Scalar _tmp69 = _tmp40 + _tmp7;
  const Scalar _tmp70 = _tmp41 * _tmp57 - _tmp57 * _tmp69;
  const Scalar _tmp71 = _tmp41 * _tmp66;
  const Scalar _tmp72 = _tmp56 * _tmp69 - _tmp57 * _tmp71;
  ...
  const Scalar _tmp78 = _tmp76 * (-_tmp48 + _tmp77);
  const Scalar _tmp79 = -_tmp68 * _tmp70 + _tmp73 * _tmp78;
  const Scalar _tmp80 = _tmp15 + _tmp7;
  const Scalar _tmp81 = _tmp29 + _tmp51;
  ...
  const Scalar _tmp90 = _tmp66 * _tmp88 - _tmp89;
  const Scalar _tmp91 = _tmp67 * _tmp90;
  const Scalar _tmp92 = -_tmp71 * _tmp88 - _tmp72 * _tmp91 + _tmp80 * _tmp89;
  const Scalar _tmp93 = _tmp41 * _tmp88 - _tmp70 * _tmp91 - _tmp78 * _tmp92 - _tmp80 * _tmp88;
  const Scalar _tmp94 = Scalar(1.0) / (_tmp93);
  const Scalar _tmp95 = _tmp64 * _tmp88 - _tmp65 * _tmp91 + _tmp81 * _tmp88 - _tmp84 * _tmp89;
  const Scalar _tmp96 = _tmp94 * _tmp95;
  const Scalar _tmp97 = Scalar(1.0) / (_tmp95);
  const Scalar _tmp98 = _tmp93 * _tmp97;
  const Scalar _tmp99 = _tmp98 * (-_tmp65 * _tmp68 - _tmp79 * _tmp96);
  ...
  const Scalar _tmp105 = _tmp27 - p_a(0, 0);
  ...
  const Scalar _tmp111 = _tmp74 * _tmp78 + _tmp77;
  const Scalar _tmp112 = 0;
  const Scalar _tmp113 = _tmp112 * _tmp94;
  const Scalar _tmp114 = _tmp66 * _tmp67;
  const Scalar _tmp115 = _tmp114 * _tmp72 + _tmp71;
  const Scalar _tmp116 = _tmp114 * _tmp70 - _tmp115 * _tmp78 - _tmp41;
  const Scalar _tmp117 = _tmp98 * (_tmp114 * _tmp65 - _tmp116 * _tmp96 - _tmp64);
  const Scalar _tmp118 = _tmp116 + _tmp117;
  const Scalar _tmp119 = -_tmp101 * _tmp118 - _tmp66;
  const Scalar _tmp120 = _tmp105 * _tmp107;
  const Scalar _tmp121 = _tmp120 * fh1;
  const Scalar _tmp122 = _tmp68 * _tmp90 * _tmp97;
  const Scalar _tmp123 = Scalar(1.0) * _tmp97;
  const Scalar _tmp124 = fh1 * (_tmp108 * _tmp26 - _tmp120 * _tmp34);
  const Scalar _tmp125 = -_tmp109 * _tmp63 * (_tmp100 * _tmp104 + _tmp102 * _tmp103) -
                         _tmp110 * _tmp63 * (-_tmp113 * _tmp57 * _tmp91 + _tmp113 * _tmp88) -
                         _tmp121 * _tmp63 * (_tmp103 * _tmp119 + _tmp104 * _tmp118 + Scalar(1.0)) -
                         _tmp124 * _tmp63 * (-_tmp122 * _tmp57 + _tmp123 * _tmp88);
  const Scalar _tmp126 = Scalar(1.0) / (_tmp125);
  const Scalar _tmp127 = _tmp92 * _tmp94;
  const Scalar _tmp128 = _tmp75 + _tmp81;
  const Scalar _tmp129 = _tmp128 * _tmp78;
  const Scalar _tmp130 = Scalar(1.0) / (-_tmp129 + _tmp77 - _tmp84);
  const Scalar _tmp131 = _tmp128 * _tmp130;
  const Scalar _tmp132 = -_tmp100 * _tmp127 + _tmp131 * _tmp99 - _tmp73;
  const Scalar _tmp133 = Scalar(1.0) * _tmp76;
  const Scalar _tmp134 = Scalar(1.0) * _tmp130;
  const Scalar _tmp135 = _tmp134 * _tmp98;
  const Scalar _tmp136 = -_tmp123 * _tmp92 + _tmp128 * _tmp135;
  const Scalar _tmp137 = _tmp111 * _tmp130;
  const Scalar _tmp138 = -_tmp112 * _tmp127 - _tmp128 * _tmp137 + _tmp75;
  const Scalar _tmp139 = _tmp16 * fh1;
  const Scalar _tmp140 = -_tmp108 * _tmp139 - Scalar(5.1796800000000003) * _tmp31 - _tmp34 * fv1;
  const Scalar _tmp141 = _tmp76 * (_tmp129 * _tmp134 + Scalar(1.0));
  const Scalar _tmp142 = _tmp134 * _tmp78;
  const Scalar _tmp143 = _tmp115 + _tmp117 * _tmp131 - _tmp118 * _tmp127;
  const Scalar _tmp144 = _tmp120 * _tmp139 + Scalar(5.1796800000000003) * _tmp20 + _tmp26 * fv1;
  const Scalar _tmp145 = _tmp128 * _tmp76;
  const Scalar _tmp146 = std::asinh(
      _tmp126 * (Scalar(1.0) * _tmp109 * (-_tmp132 * _tmp133 + _tmp134 * _tmp99) +
                 Scalar(1.0) * _tmp110 * (-_tmp111 * _tmp134 - _tmp133 * _tmp138 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp121 * (_tmp117 * _tmp134 - _tmp133 * _tmp143) +
  ...
  const Scalar _tmp148 = std::pow(Scalar(-_tmp49 + p_c(0, 0)), Scalar(2)) +
                         std::pow(Scalar(-_tmp53 + p_c(1, 0)), Scalar(2));
  const Scalar _tmp149 = _tmp110 * _tmp113;
  const Scalar _tmp150 = _tmp102 * _tmp109 * _tmp67 + _tmp119 * _tmp121 * _tmp67 -
                         _tmp122 * _tmp124 - _tmp149 * _tmp91;
  const Scalar _tmp151 = Scalar(1.0) / (_tmp150);
  const Scalar _tmp152 = _tmp134 * _tmp144;
  const Scalar _tmp153 =
      std::asinh(_tmp151 * (_tmp109 * _tmp132 * _tmp76 + _tmp110 * _tmp138 * _tmp76 +
                            _tmp121 * _tmp143 * _tmp76 + _tmp124 * _tmp136 * _tmp76 +
                            _tmp140 * _tmp141 - _tmp145 * _tmp152));
  const Scalar _tmp154 = Scalar(9.6622558468725703) * _tmp150;
  const Scalar _tmp155 =
      _tmp100 * _tmp109 * _tmp94 + _tmp118 * _tmp121 * _tmp94 + _tmp123 * _tmp124 + _tmp149;
  const Scalar _tmp156 = Scalar(1.0) / (_tmp155);
  const Scalar _tmp157 = std::asinh(_tmp156 * (-_tmp109 * _tmp130 * _tmp99 + _tmp110 * _tmp137 -
                                               _tmp117 * _tmp121 * _tmp130 - _tmp124 * _tmp135 -
                                               _tmp140 * _tmp142 + _tmp152));
  const Scalar _tmp158 = Scalar(9.6622558468725703) * _tmp155;
  const Scalar _tmp159 = std::pow(Scalar(-_tmp82 + p_d(1, 0)), Scalar(2)) +
  ...
  _res(1, 0) =
      ...
      std::sqrt(Scalar(_tmp46 + std::pow(Scalar(-_tmp41 + p_b(2, 0) - p_init2), Scalar(2))));
  _res(2, 0) =
      _tmp154 *
          (-std::sinh(Scalar(1.0) * _tmp153) -
           std::sinh(Scalar(0.1034955) * _tmp151 * (-std::sqrt(_tmp148) - _tmp153 * _tmp154))) -
      std::sqrt(Scalar(_tmp148 + std::pow(Scalar(-_tmp69 + p_c(2, 0) - p_init2), Scalar(2))));
  _res(3, 0) =
      _tmp158 *
          (-std::sinh(Scalar(1.0) * _tmp157) -
           std::sinh(Scalar(0.1034955) * _tmp156 * (-_tmp157 * _tmp158 - std::sqrt(_tmp159)))) -
      std::sqrt(Scalar(_tmp159 + std::pow(Scalar(-_tmp80 + p_d(2, 0) - p_init2), Scalar(2))));
