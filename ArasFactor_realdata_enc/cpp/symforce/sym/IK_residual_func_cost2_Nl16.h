...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl16(
  ...
  const Scalar _tmp52 = -_tmp13 + _tmp9;
  ...
  const Scalar _tmp67 = _tmp38 * _tmp62;
  ...
  const Scalar _tmp75 = -_tmp38 + _tmp54 * _tmp65 - _tmp68 * _tmp74;
  const Scalar _tmp76 = _tmp30 + _tmp44;
  const Scalar _tmp77 = _tmp76 + p_init1;
  const Scalar _tmp78 = _tmp77 - p_b(1, 0);
  const Scalar _tmp79 = _tmp17 + _tmp40;
  ...
  const Scalar _tmp87 = _tmp52 + _tmp6;
  const Scalar _tmp88 = -_tmp66 * _tmp86 - _tmp67 * _tmp83 + _tmp84 * _tmp87;
  const Scalar _tmp89 = _tmp38 * _tmp83 - _tmp54 * _tmp86 - _tmp74 * _tmp88 - _tmp83 * _tmp87;
  ...
  const Scalar _tmp95 = -_tmp41 * _tmp63 + _tmp46 * _tmp50 + _tmp50 * _tmp94;
  const Scalar _tmp96 = _tmp76 * _tmp83 - _tmp79 * _tmp84 + _tmp83 * _tmp94 - _tmp86 * _tmp95;
  ...
  const Scalar _tmp106 = _tmp25 - p_c(0, 0);
  ...
  const Scalar _tmp112 = _tmp111 * _tmp85 * _tmp98;
  const Scalar _tmp113 = Scalar(1.0) * _tmp98;
  const Scalar _tmp114 = _tmp107 * _tmp108;
  const Scalar _tmp115 = fh1 * (-_tmp109 * _tmp31 + _tmp114 * _tmp24);
  const Scalar _tmp116 = Scalar(1.0) * _tmp71;
  const Scalar _tmp117 = -_tmp111 * _tmp54 + _tmp116 * _tmp64 * _tmp66 * _tmp73;
  ...
  const Scalar _tmp123 = _tmp69 * _tmp74 + _tmp72;
  ...
  const Scalar _tmp126 = -_tmp110 * _tmp93 * (_tmp101 * _tmp102 + _tmp104 * _tmp105 + Scalar(1.0)) -
                         _tmp115 * _tmp93 * (-_tmp112 * _tmp50 + _tmp113 * _tmp83) -
                         _tmp121 * _tmp93 * (_tmp102 * _tmp119 + _tmp105 * _tmp120) -
                         _tmp122 * _tmp93 * (-_tmp125 * _tmp50 * _tmp86 + _tmp125 * _tmp83);
  const Scalar _tmp127 = Scalar(1.0) / (_tmp126);
  const Scalar _tmp128 = _tmp15 * fh1;
  const Scalar _tmp129 = -_tmp114 * _tmp128 - Scalar(5.1796800000000003) * _tmp27 - _tmp31 * fv1;
  ...
  const Scalar _tmp135 = _tmp133 * _tmp74;
  const Scalar _tmp136 = _tmp130 * _tmp132;
  const Scalar _tmp137 = _tmp88 * _tmp90;
  const Scalar _tmp138 = -_tmp111 * _tmp66 + _tmp118 * _tmp136 - _tmp119 * _tmp137;
  const Scalar _tmp139 = _tmp123 * _tmp132;
  const Scalar _tmp140 = -_tmp124 * _tmp137 - _tmp130 * _tmp139 + _tmp70;
  const Scalar _tmp141 = _tmp109 * _tmp128 + Scalar(5.1796800000000003) * _tmp18 + _tmp24 * fv1;
  const Scalar _tmp142 = _tmp130 * _tmp71;
  const Scalar _tmp143 = _tmp100 * _tmp136 - _tmp101 * _tmp137 + _tmp68;
  const Scalar _tmp144 = _tmp133 * _tmp99;
  const Scalar _tmp145 = -_tmp113 * _tmp88 + _tmp130 * _tmp144;
  const Scalar _tmp146 = std::asinh(
      _tmp127 * (Scalar(1.0) * _tmp110 * (_tmp100 * _tmp133 - _tmp116 * _tmp143) +
                 Scalar(1.0) * _tmp115 * (-_tmp116 * _tmp145 + _tmp144) +
                 Scalar(1.0) * _tmp121 * (-_tmp116 * _tmp138 + _tmp118 * _tmp133) +
                 Scalar(1.0) * _tmp122 * (-_tmp116 * _tmp140 - _tmp123 * _tmp133 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp129 * (-_tmp116 * _tmp134 + _tmp135) +
                 Scalar(1.0) * _tmp141 * (_tmp133 * _tmp142 - _tmp133)));
  const Scalar _tmp147 = Scalar(9.6622558468725703) * _tmp126;
  const Scalar _tmp148 = std::pow(Scalar(-_tmp56 + p_d(1, 0)), Scalar(2)) +
                         std::pow(Scalar(-_tmp59 + p_d(0, 0)), Scalar(2));
  const Scalar _tmp149 = std::pow(Scalar(-_tmp42 + p_a(0, 0)), Scalar(2)) +
                         std::pow(Scalar(-_tmp47 + p_a(1, 0)), Scalar(2));
  const Scalar _tmp150 = _tmp133 * _tmp141;
  const Scalar _tmp151 = _tmp122 * _tmp125;
  const Scalar _tmp152 = _tmp104 * _tmp110 * _tmp64 - _tmp112 * _tmp115 +
                         _tmp120 * _tmp121 * _tmp64 - _tmp151 * _tmp86;
  const Scalar _tmp153 = Scalar(1.0) / (_tmp152);
  const Scalar _tmp154 =
      std::asinh(_tmp153 * (_tmp110 * _tmp143 * _tmp71 + _tmp115 * _tmp145 * _tmp71 +
                            _tmp121 * _tmp138 * _tmp71 + _tmp122 * _tmp140 * _tmp71 +
                            _tmp129 * _tmp134 * _tmp71 - _tmp142 * _tmp150));
  const Scalar _tmp155 = Scalar(9.6622558468725703) * _tmp152;
  const Scalar _tmp156 =
      _tmp101 * _tmp110 * _tmp90 + _tmp113 * _tmp115 + _tmp119 * _tmp121 * _tmp90 + _tmp151;
  const Scalar _tmp157 = Scalar(1.0) / (_tmp156);
  const Scalar _tmp158 = std::asinh(_tmp157 * (-_tmp100 * _tmp110 * _tmp132 - _tmp115 * _tmp144 -
                                               _tmp118 * _tmp121 * _tmp132 + _tmp122 * _tmp139 -
                                               _tmp129 * _tmp135 + _tmp150));
  const Scalar _tmp159 = std::pow(Scalar(-_tmp77 + p_b(1, 0)), Scalar(2)) +
  ...
  _res(1, 0) =
      ...
      std::sqrt(Scalar(_tmp148 + std::pow(Scalar(-_tmp38 + p_d(2, 0) - p_init2), Scalar(2))));
  _res(2, 0) =
      _tmp155 *
          (-std::sinh(Scalar(1.0) * _tmp154) -
           std::sinh(Scalar(0.1034955) * _tmp153 * (-std::sqrt(_tmp149) - _tmp154 * _tmp155))) -
      std::sqrt(Scalar(_tmp149 + std::pow(Scalar(-_tmp53 + p_a(2, 0) - p_init2), Scalar(2))));
  _res(3, 0) =
      _tmp160 *
          (-std::sinh(Scalar(1.0) * _tmp158) -
           std::sinh(Scalar(0.1034955) * _tmp157 * (-_tmp158 * _tmp160 - std::sqrt(_tmp159)))) -
      std::sqrt(Scalar(_tmp159 + std::pow(Scalar(-_tmp87 + p_b(2, 0) - p_init2), Scalar(2))));
