...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2WrtFh1Nl15(
  ...
  const Scalar _tmp41 = -Scalar(0.010999999999999999) * _tmp16 -
  ...
  const Scalar _tmp58 = -_tmp44 * _tmp54 + _tmp57;
  ...
  const Scalar _tmp79 = _tmp48 * _tmp53;
  const Scalar _tmp80 = Scalar(1.0) / (_tmp54 * _tmp68 - _tmp79);
  const Scalar _tmp81 = _tmp78 * _tmp80;
  const Scalar _tmp82 = _tmp40 + _tmp55;
  const Scalar _tmp83 = _tmp56 * _tmp76;
  const Scalar _tmp84 = _tmp44 * _tmp79 - _tmp57 * _tmp68;
  const Scalar _tmp85 = -_tmp68 * _tmp83 + _tmp77 * _tmp82 - _tmp81 * _tmp84;
  const Scalar _tmp86 = Scalar(1.0) * _tmp60;
  const Scalar _tmp87 = -_tmp86;
  const Scalar _tmp88 = Scalar(1.0) / (_tmp46 + _tmp87);
  const Scalar _tmp89 = Scalar(1.0) * _tmp64;
  const Scalar _tmp90 = _tmp88 * (-_tmp50 + _tmp89);
  const Scalar _tmp91 = -_tmp58 * _tmp81 - _tmp76 * _tmp82 + _tmp83 - _tmp85 * _tmp90;
  const Scalar _tmp92 = Scalar(1.0) / (_tmp91);
  const Scalar _tmp93 = _tmp86 * _tmp90 + _tmp89;
  const Scalar _tmp94 = 0;
  const Scalar _tmp95 = _tmp92 * _tmp94;
  const Scalar _tmp96 = _tmp54 * _tmp81;
  const Scalar _tmp97 =
  ...
  const Scalar _tmp100 = _tmp98 * (-_tmp60 * _tmp66 * _tmp99 + _tmp62 * _tmp64 * _tmp99);
  const Scalar _tmp101 = _tmp100 * _tmp54 + _tmp46 * _tmp54 - _tmp50 * _tmp79;
  const Scalar _tmp102 = Scalar(1.0) * _tmp80;
  const Scalar _tmp103 = _tmp102 * _tmp84;
  const Scalar _tmp104 = -_tmp102 * _tmp58 + _tmp103 * _tmp90;
  const Scalar _tmp105 = _tmp100 * _tmp76 - _tmp101 * _tmp81 - _tmp69 * _tmp77 + _tmp72 * _tmp76;
  ...
  const Scalar _tmp113 = _tmp80 * (-_tmp110 * _tmp112 + Scalar(1.0));
  ...
  const Scalar _tmp118 = _tmp117 * _tmp98 * (_tmp111 * _tmp76 + _tmp113 * _tmp54);
  const Scalar _tmp119 = _tmp68 * _tmp80;
  const Scalar _tmp120 = _tmp119 * _tmp84 + _tmp56 * _tmp68;
  const Scalar _tmp121 = _tmp119 * _tmp58 - _tmp120 * _tmp90 - _tmp56;
  const Scalar _tmp122 = _tmp108 * (-_tmp100 + _tmp101 * _tmp119 - _tmp106 * _tmp121);
  const Scalar _tmp123 = _tmp121 + _tmp122;
  const Scalar _tmp124 = _tmp80 * (-_tmp112 * _tmp123 - _tmp68);
  const Scalar _tmp125 = _tmp123 * _tmp92;
  const Scalar _tmp126 = _tmp114 * _tmp116;
  const Scalar _tmp127 = _tmp126 * _tmp98 * (_tmp124 * _tmp54 + _tmp125 * _tmp76 + Scalar(1.0));
  const Scalar _tmp128 = _tmp117 * _tmp20 - _tmp126 * _tmp30;
  const Scalar _tmp129 = Scalar(1.0) * _tmp107;
  const Scalar _tmp130 = _tmp128 * _tmp98 * (_tmp129 * _tmp76 - _tmp129 * _tmp96);
  const Scalar _tmp131 = -_tmp118 * fh1 - _tmp127 * fh1 - _tmp130 * fh1 -
                         _tmp38 * _tmp98 * (_tmp76 * _tmp95 - _tmp95 * _tmp96);
  const Scalar _tmp132 = _tmp39 + _tmp43;
  const Scalar _tmp133 = _tmp132 * fh1;
  const Scalar _tmp134 = _tmp126 * _tmp133 + Scalar(5.1796800000000003) * _tmp14 + _tmp20 * fv1;
  const Scalar _tmp135 = _tmp72 + _tmp87;
  const Scalar _tmp136 = _tmp135 * _tmp90;
  const Scalar _tmp137 = Scalar(1.0) / (-_tmp136 - _tmp69 + _tmp89);
  const Scalar _tmp138 = Scalar(1.0) * _tmp137;
  const Scalar _tmp139 = _tmp135 * _tmp88;
  const Scalar _tmp140 = _tmp138 * _tmp139;
  const Scalar _tmp141 = -Scalar(1.0) * _tmp138 + Scalar(1.0) * _tmp140;
  const Scalar _tmp142 = -_tmp117 * _tmp133 - Scalar(5.1796800000000003) * _tmp26 - _tmp30 * fv1;
  const Scalar _tmp143 = _tmp136 * _tmp138 + Scalar(1.0);
  const Scalar _tmp144 = Scalar(1.0) * _tmp88;
  const Scalar _tmp145 = _tmp138 * _tmp90;
  const Scalar _tmp146 = -Scalar(1.0) * _tmp143 * _tmp144 + Scalar(1.0) * _tmp145;
  const Scalar _tmp147 = _tmp85 * _tmp92;
  const Scalar _tmp148 = _tmp135 * _tmp137;
  const Scalar _tmp149 = _tmp120 + _tmp122 * _tmp148 - _tmp123 * _tmp147;
  const Scalar _tmp150 = Scalar(1.0) * _tmp126 * (_tmp122 * _tmp138 - _tmp144 * _tmp149);
  const Scalar _tmp151 = -_tmp103 + _tmp109 * _tmp148 - _tmp110 * _tmp147;
  const Scalar _tmp152 = Scalar(1.0) * _tmp117 * (_tmp109 * _tmp138 - _tmp144 * _tmp151);
  const Scalar _tmp153 = _tmp108 * _tmp138;
  const Scalar _tmp154 = -_tmp129 * _tmp85 + _tmp135 * _tmp153;
  const Scalar _tmp155 = Scalar(1.0) * _tmp128 * (-_tmp144 * _tmp154 + _tmp153);
  const Scalar _tmp156 = _tmp137 * _tmp93;
  const Scalar _tmp157 = -_tmp135 * _tmp156 - _tmp147 * _tmp94 + _tmp87;
  const Scalar _tmp158 =
      _tmp134 * _tmp141 + _tmp142 * _tmp146 + _tmp150 * fh1 + _tmp152 * fh1 + _tmp155 * fh1 +
      Scalar(1.0) * _tmp38 * (-_tmp138 * _tmp93 - _tmp144 * _tmp157 + Scalar(1.0));
  ...
  const Scalar _tmp162 =
      -_tmp131 * _tmp161 - std::sqrt(Scalar(std::pow(Scalar(-_tmp61 + p_b(1, 0)), Scalar(2)) +
  ...
  const Scalar _tmp166 = -_tmp118 - _tmp127 - _tmp130;
  const Scalar _tmp167 = std::pow(_tmp131, Scalar(-2));
  const Scalar _tmp168 = _tmp117 * _tmp132;
  const Scalar _tmp169 = _tmp126 * _tmp132;
  const Scalar _tmp170 = _tmp166 * _tmp167;
  const Scalar _tmp171 = (-_tmp158 * _tmp170 + _tmp159 * (_tmp141 * _tmp169 - _tmp146 * _tmp168 +
  ...
  const Scalar _tmp173 = _tmp38 * _tmp95;
  ...
  const Scalar _tmp182 = _tmp126 * _tmp149 * _tmp88;
  const Scalar _tmp183 = _tmp117 * _tmp151 * _tmp88;
  const Scalar _tmp184 = _tmp128 * _tmp154 * _tmp88;
  const Scalar _tmp185 = -_tmp139 * _tmp181 + _tmp142 * _tmp180 + _tmp157 * _tmp38 * _tmp88 +
  ...
  const Scalar _tmp189 =
      -_tmp186 * _tmp188 - std::sqrt(Scalar(std::pow(Scalar(-_tmp47 + p_d(1, 0)), Scalar(2)) +
  ...
  const Scalar _tmp196 =
      (_tmp179 * (-_tmp140 * _tmp169 - _tmp168 * _tmp180 + _tmp182 + _tmp183 + _tmp184) -
       _tmp185 * _tmp195) /
      std::sqrt(Scalar(std::pow(_tmp185, Scalar(2)) * _tmp194 + 1));
  const Scalar _tmp197 = _tmp128 * _tmp153;
  const Scalar _tmp198 = _tmp109 * _tmp117 * _tmp137;
  const Scalar _tmp199 = _tmp122 * _tmp126 * _tmp137;
  const Scalar _tmp200 = -_tmp142 * _tmp145 + _tmp156 * _tmp38 + _tmp181 - _tmp197 * fh1 -
                         _tmp198 * fh1 - _tmp199 * fh1;
  const Scalar _tmp201 = _tmp111 * _tmp117;
  const Scalar _tmp202 = _tmp125 * _tmp126;
  ...
  const Scalar _tmp210 = (-_tmp200 * _tmp209 + _tmp204 * (_tmp138 * _tmp169 + _tmp145 * _tmp168 -
  ...
  const Scalar _tmp212 =
      -_tmp205 * _tmp211 - std::sqrt(Scalar(std::pow(Scalar(-_tmp70 + p_a(0, 0)), Scalar(2)) +
  ...
  _res(1, 0) = Scalar(9.6622558468725703) * _tmp166 * (-std::sinh(_tmp164) - std::sinh(_tmp165)) +
               _tmp172 * (-Scalar(1.0) * _tmp171 * std::cosh(_tmp165) -
