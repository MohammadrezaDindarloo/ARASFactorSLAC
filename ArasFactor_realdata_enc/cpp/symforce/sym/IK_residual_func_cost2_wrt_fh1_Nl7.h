...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2WrtFh1Nl7(
  ...
  const Scalar _tmp134 = _tmp85 + _tmp91;
  const Scalar _tmp135 = _tmp134 * fh1;
  const Scalar _tmp136 = -_tmp135 * _tmp42 - Scalar(5.1796800000000003) * _tmp24 - _tmp28 * fv1;
  const Scalar _tmp137 = _tmp48 + _tmp98;
  const Scalar _tmp138 = _tmp102 * _tmp137;
  const Scalar _tmp139 = Scalar(1.0) / (_tmp100 - _tmp138 - _tmp45);
  const Scalar _tmp140 = Scalar(1.0) * _tmp139;
  const Scalar _tmp141 = _tmp99 * (_tmp138 * _tmp140 + Scalar(1.0));
  const Scalar _tmp142 = _tmp102 * _tmp140;
  const Scalar _tmp143 = -Scalar(1.0) * _tmp141 + Scalar(1.0) * _tmp142;
  const Scalar _tmp144 = Scalar(5.1796800000000003) * _tmp11 + _tmp135 * _tmp41 + _tmp17 * fv1;
  const Scalar _tmp145 = _tmp137 * _tmp140;
  ...
  const Scalar _tmp149 = _tmp107 * _tmp109;
  const Scalar _tmp150 = -_tmp124 * _tmp94 + _tmp127 * _tmp148 - _tmp128 * _tmp149;
  const Scalar _tmp151 = Scalar(1.0) * _tmp42 * (-_tmp125 * _tmp150 + _tmp127 * _tmp140);
  const Scalar _tmp152 = _tmp112 * _tmp148 - _tmp113 * _tmp149 + _tmp96;
  const Scalar _tmp153 = Scalar(1.0) * _tmp41 * (_tmp112 * _tmp140 - _tmp125 * _tmp152);
  const Scalar _tmp154 = _tmp111 * _tmp140;
  const Scalar _tmp155 = -_tmp107 * _tmp83 + _tmp111 * _tmp145;
  const Scalar _tmp156 = Scalar(1.0) * _tmp43 * (-_tmp125 * _tmp155 + _tmp154);
  const Scalar _tmp157 = _tmp120 * _tmp139;
  const Scalar _tmp158 = -_tmp121 * _tmp149 - _tmp137 * _tmp157 + _tmp98;
  const Scalar _tmp159 =
      Scalar(1.0) * _tmp119 * (-_tmp120 * _tmp140 - _tmp125 * _tmp158 + Scalar(1.0)) +
      _tmp136 * _tmp143 + _tmp144 * _tmp147 + _tmp151 * fh1 + _tmp153 * fh1 + _tmp156 * fh1;
  const Scalar _tmp160 = std::pow(_tmp132, Scalar(-2));
  const Scalar _tmp161 = -_tmp118 - _tmp131 - _tmp84;
  const Scalar _tmp162 = _tmp160 * _tmp161;
  const Scalar _tmp163 = _tmp134 * _tmp42;
  const Scalar _tmp164 = _tmp134 * _tmp41;
  const Scalar _tmp165 = Scalar(1.0) / (_tmp132);
  const Scalar _tmp166 = (-_tmp159 * _tmp162 + _tmp165 * (-_tmp143 * _tmp163 + _tmp147 * _tmp164 +
                                                          _tmp151 + _tmp153 + _tmp156)) /
  ...
  const Scalar _tmp170 =
      -_tmp133 * _tmp167 - std::sqrt(Scalar(std::pow(Scalar(-_tmp56 + p_a(0, 0)), Scalar(2)) +
  ...
  const Scalar _tmp179 = _tmp150 * _tmp42 * _tmp99;
  const Scalar _tmp180 = _tmp140 * _tmp144;
  const Scalar _tmp181 = _tmp155 * _tmp43 * _tmp99;
  const Scalar _tmp182 = _tmp152 * _tmp41 * _tmp99;
  const Scalar _tmp183 = _tmp119 * _tmp158 * _tmp99 + _tmp136 * _tmp141 -
                         _tmp137 * _tmp180 * _tmp99 + _tmp179 * fh1 + _tmp181 * fh1 + _tmp182 * fh1;
  const Scalar _tmp184 = std::asinh(_tmp178 * _tmp183);
  const Scalar _tmp185 = Scalar(9.6622558468725703) * _tmp177;
  const Scalar _tmp186 =
      -_tmp184 * _tmp185 - std::sqrt(Scalar(std::pow(Scalar(-_tmp68 + p_d(1, 0)), Scalar(2)) +
  ...
  const Scalar _tmp190 = -_tmp173 * _tmp80 + _tmp175 + _tmp176;
  ...
  const Scalar _tmp194 =
      (_tmp178 * (-_tmp141 * _tmp163 - _tmp146 * _tmp164 + _tmp179 + _tmp181 + _tmp182) -
       _tmp183 * _tmp193) /
      std::sqrt(Scalar(std::pow(_tmp183, Scalar(2)) * _tmp192 + 1));
  const Scalar _tmp195 = _tmp117 * _tmp41;
  const Scalar _tmp196 = _tmp130 * _tmp42;
  const Scalar _tmp197 = _tmp119 * _tmp123 + _tmp174 + _tmp195 * fh1 + _tmp196 * fh1;
  const Scalar _tmp198 = Scalar(1.0) / (_tmp197);
  const Scalar _tmp199 = _tmp154 * _tmp43;
  const Scalar _tmp200 = _tmp127 * _tmp139 * _tmp42;
  const Scalar _tmp201 = _tmp112 * _tmp139 * _tmp41;
  const Scalar _tmp202 = _tmp119 * _tmp157 - _tmp136 * _tmp142 + _tmp180 - _tmp199 * fh1 -
  ...
  const Scalar _tmp206 =
      -_tmp203 * _tmp205 - std::sqrt(Scalar(std::pow(Scalar(-_tmp46 + p_c(0, 0)), Scalar(2)) +
  ...
  const Scalar _tmp213 =
      (_tmp198 * (_tmp140 * _tmp164 + _tmp142 * _tmp163 - _tmp199 - _tmp200 - _tmp201) -
       _tmp202 * _tmp212) /
  ...
  _res(1, 0) = _tmp133 * (-Scalar(1.0) * _tmp166 * std::cosh(_tmp172) -
                          (-Scalar(0.1034955) * _tmp162 * _tmp170 +
                           _tmp169 * (-_tmp133 * _tmp166 - _tmp167 * _tmp168)) *
                              std::cosh(_tmp171)) +
