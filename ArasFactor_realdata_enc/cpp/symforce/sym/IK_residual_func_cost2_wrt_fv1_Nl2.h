...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2WrtFv1Nl2(
  ...
  const Scalar _tmp49 = _tmp25 + _tmp26 + _tmp31;
  ...
  const Scalar _tmp59 = _tmp39 * _tmp56 - _tmp56 * _tmp58;
  ...
  const Scalar _tmp69 = _tmp51 * _tmp55;
  const Scalar _tmp70 = Scalar(1.0) / (_tmp56 * _tmp68 - _tmp69);
  const Scalar _tmp71 = _tmp42 * _tmp47;
  const Scalar _tmp72 = _tmp48 * _tmp68 - _tmp71;
  ...
  const Scalar _tmp77 = -_tmp56 * _tmp76 + _tmp58 * _tmp69;
  const Scalar _tmp78 = -_tmp48 * _tmp76 + _tmp71 * _tmp75 - _tmp73 * _tmp77;
  ...
  const Scalar _tmp84 = _tmp39 * _tmp48 - _tmp48 * _tmp75 - _tmp59 * _tmp73 - _tmp78 * _tmp83;
  const Scalar _tmp85 = Scalar(1.0) / (_tmp84);
  const Scalar _tmp86 = Scalar(1.0) * _tmp70;
  const Scalar _tmp87 = _tmp77 * _tmp86;
  const Scalar _tmp88 = -_tmp59 * _tmp86 + _tmp83 * _tmp87;
  const Scalar _tmp89 =
  ...
  const Scalar _tmp92 = _tmp91 * (-_tmp61 * _tmp66 * _tmp90 + _tmp63 * _tmp64 * _tmp90);
  const Scalar _tmp93 = _tmp49 * _tmp56 - _tmp52 * _tmp69 + _tmp56 * _tmp92;
  const Scalar _tmp94 = _tmp40 * _tmp48 - _tmp44 * _tmp71 + _tmp48 * _tmp92 - _tmp73 * _tmp93;
  ...
  const Scalar _tmp100 = -_tmp72 * _tmp99 + Scalar(1.0);
  const Scalar _tmp101 = _tmp56 * _tmp70;
  ...
  const Scalar _tmp108 = _tmp79 * _tmp83 + _tmp82;
  const Scalar _tmp109 = 0;
  const Scalar _tmp110 = _tmp109 * _tmp73;
  const Scalar _tmp111 = _tmp91 * (_tmp109 * _tmp48 - _tmp110 * _tmp56);
  const Scalar _tmp112 = _tmp68 * _tmp70;
  const Scalar _tmp113 = _tmp112 * _tmp77 + _tmp76;
  const Scalar _tmp114 = _tmp112 * _tmp59 - _tmp113 * _tmp83 - _tmp39;
  const Scalar _tmp115 = _tmp97 * (_tmp112 * _tmp93 - _tmp114 * _tmp95 - _tmp92);
  const Scalar _tmp116 = _tmp85 * (_tmp114 + _tmp115);
  const Scalar _tmp117 = -_tmp116 * _tmp72 - _tmp68;
  const Scalar _tmp118 = _tmp102 * _tmp104;
  const Scalar _tmp119 = _tmp118 * fh1;
  const Scalar _tmp120 = Scalar(1.0) * _tmp96;
  const Scalar _tmp121 = _tmp72 * _tmp86 * _tmp96;
  const Scalar _tmp122 = fh1 * (_tmp105 * _tmp21 - _tmp118 * _tmp33);
  const Scalar _tmp123 = -_tmp106 * _tmp91 * (_tmp100 * _tmp101 + _tmp48 * _tmp99) -
                         _tmp107 * _tmp111 -
                         _tmp119 * _tmp91 * (_tmp101 * _tmp117 + _tmp116 * _tmp48 + Scalar(1.0)) -
                         _tmp122 * _tmp91 * (_tmp120 * _tmp48 - _tmp121 * _tmp56);
  const Scalar _tmp124 = Scalar(1.0) / (_tmp123);
  const Scalar _tmp125 = _tmp40 + _tmp80;
  const Scalar _tmp126 = _tmp125 * _tmp83;
  const Scalar _tmp127 = Scalar(1.0) / (-_tmp126 - _tmp44 + _tmp82);
  const Scalar _tmp128 = Scalar(1.0) * _tmp127;
  const Scalar _tmp129 = _tmp125 * _tmp127;
  const Scalar _tmp130 = _tmp113 + _tmp115 * _tmp129 - _tmp116 * _tmp78;
  const Scalar _tmp131 = Scalar(1.0) * _tmp81;
  const Scalar _tmp132 = _tmp108 * _tmp127;
  const Scalar _tmp133 = _tmp81 * (-_tmp109 * _tmp78 - _tmp125 * _tmp132 + _tmp80);
  const Scalar _tmp134 = -Scalar(1.0) * _tmp132 - Scalar(1.0) * _tmp133 + Scalar(1.0);
  const Scalar _tmp135 = fh1 * (_tmp57 + _tmp74);
  const Scalar _tmp136 = _tmp118 * _tmp135 + Scalar(5.1796800000000003) * _tmp14 + _tmp21 * fv1;
  const Scalar _tmp137 = _tmp125 * _tmp81;
  const Scalar _tmp138 = Scalar(1.0) * _tmp128 * _tmp137 - Scalar(1.0) * _tmp128;
  const Scalar _tmp139 = -_tmp105 * _tmp135 - Scalar(5.1796800000000003) * _tmp29 - _tmp33 * fv1;
  const Scalar _tmp140 = _tmp126 * _tmp128 + Scalar(1.0);
  const Scalar _tmp141 = _tmp128 * _tmp83;
  const Scalar _tmp142 = -Scalar(1.0) * _tmp131 * _tmp140 + Scalar(1.0) * _tmp141;
  const Scalar _tmp143 = _tmp129 * _tmp98 - _tmp78 * _tmp99 - _tmp87;
  const Scalar _tmp144 = _tmp128 * _tmp97;
  const Scalar _tmp145 = -_tmp120 * _tmp78 + _tmp125 * _tmp144;
  const Scalar _tmp146 = Scalar(1.0) * _tmp106 * (_tmp128 * _tmp98 - _tmp131 * _tmp143) +
                         _tmp107 * _tmp134 +
                         Scalar(1.0) * _tmp119 * (_tmp115 * _tmp128 - _tmp130 * _tmp131) +
                         Scalar(1.0) * _tmp122 * (-_tmp131 * _tmp145 + _tmp144) +
                         _tmp136 * _tmp138 + _tmp139 * _tmp142;
  ...
  const Scalar _tmp150 =
      -_tmp147 * _tmp149 - std::sqrt(Scalar(std::pow(Scalar(-_tmp62 + p_c(1, 0)), Scalar(2)) +
                                            std::pow(Scalar(-_tmp65 + p_c(0, 0)), Scalar(2))));
  const Scalar _tmp151 = Scalar(0.1034955) * _tmp124;
  const Scalar _tmp152 = _tmp150 * _tmp151;
  const Scalar _tmp153 = Scalar(9.6622558468725703) * _tmp111;
  const Scalar _tmp154 = std::pow(_tmp123, Scalar(-2));
  const Scalar _tmp155 = _tmp111 * _tmp154;
  const Scalar _tmp156 = _tmp30 + _tmp60;
  const Scalar _tmp157 =
      (_tmp124 * (-_tmp134 + _tmp138 * _tmp21 + _tmp142 * _tmp156) - _tmp146 * _tmp155) /
      std::sqrt(Scalar(std::pow(_tmp146, Scalar(2)) * _tmp154 + 1));
  const Scalar _tmp158 = _tmp107 * _tmp109;
  const Scalar _tmp159 = _tmp100 * _tmp106 * _tmp70 + _tmp117 * _tmp119 * _tmp70 -
                         _tmp121 * _tmp122 - _tmp158 * _tmp73;
  const Scalar _tmp160 = Scalar(1.0) / (_tmp159);
  const Scalar _tmp161 = _tmp128 * _tmp136;
  const Scalar _tmp162 = _tmp140 * _tmp81;
  const Scalar _tmp163 = _tmp106 * _tmp143 * _tmp81 + _tmp107 * _tmp133 +
                         _tmp119 * _tmp130 * _tmp81 + _tmp122 * _tmp145 * _tmp81 -
                         _tmp137 * _tmp161 + _tmp139 * _tmp162;
  const Scalar _tmp164 = std::asinh(_tmp160 * _tmp163);
  const Scalar _tmp165 = Scalar(9.6622558468725703) * _tmp159;
  const Scalar _tmp166 =
      -_tmp164 * _tmp165 - std::sqrt(Scalar(std::pow(Scalar(-_tmp50 + p_b(1, 0)), Scalar(2)) +
  ...
  const Scalar _tmp170 = Scalar(9.6622558468725703) * _tmp109;
  const Scalar _tmp171 = _tmp170 * _tmp73;
  const Scalar _tmp172 = std::pow(_tmp159, Scalar(-2));
  const Scalar _tmp173 = _tmp128 * _tmp21;
  const Scalar _tmp174 = _tmp110 * _tmp172;
  const Scalar _tmp175 =
      (_tmp160 * (-_tmp133 - _tmp137 * _tmp173 + _tmp156 * _tmp162) - _tmp163 * _tmp174) /
      std::sqrt(Scalar(std::pow(_tmp163, Scalar(2)) * _tmp172 + 1));
  const Scalar _tmp176 = -_tmp106 * _tmp127 * _tmp98 + _tmp107 * _tmp132 -
                         _tmp115 * _tmp119 * _tmp127 - _tmp122 * _tmp144 - _tmp139 * _tmp141 +
                         _tmp161;
  const Scalar _tmp177 = _tmp106 * _tmp99 + _tmp116 * _tmp119 + _tmp120 * _tmp122 + _tmp158;
  ...
  const Scalar _tmp182 =
      -_tmp179 * _tmp181 - std::sqrt(Scalar(std::pow(Scalar(-_tmp41 + p_d(1, 0)), Scalar(2)) +
  ...
  const Scalar _tmp186 = _tmp109 * _tmp185;
  const Scalar _tmp187 = (_tmp176 * _tmp186 + _tmp178 * (-_tmp132 - _tmp141 * _tmp156 + _tmp173)) /
