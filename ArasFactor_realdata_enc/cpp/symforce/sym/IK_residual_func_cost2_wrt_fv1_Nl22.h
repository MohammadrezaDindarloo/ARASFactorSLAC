...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2WrtFv1Nl22(
  ...
  const Scalar _tmp53 = Scalar(0.20999999999999999) * _tmp11 - Scalar(0.20999999999999999) * _tmp13;
  const Scalar _tmp54 =
  ...
  const Scalar _tmp83 = _tmp72 * _tmp73;
  const Scalar _tmp84 = Scalar(1.0) / (_tmp74 * _tmp82 - _tmp83);
  const Scalar _tmp85 = _tmp59 * _tmp62;
  const Scalar _tmp86 = _tmp63 * _tmp82 - _tmp85;
  const Scalar _tmp87 = _tmp84 * _tmp86;
  const Scalar _tmp88 = _tmp68 * _tmp83 - _tmp75 * _tmp82;
  const Scalar _tmp89 = -_tmp64 * _tmp82 + _tmp66 * _tmp85 - _tmp87 * _tmp88;
  ...
  const Scalar _tmp95 = _tmp45 * _tmp74 - _tmp47 * _tmp83 + _tmp74 * _tmp94;
  const Scalar _tmp96 = -_tmp35 * _tmp85 + _tmp43 * _tmp63 + _tmp63 * _tmp94 - _tmp87 * _tmp95;
  ...
  const Scalar _tmp109 = fh1 * (_tmp56 + _tmp67);
  const Scalar _tmp110 = _tmp106 * _tmp109 + Scalar(5.1796800000000003) * _tmp14 + _tmp20 * fv1;
  ...
  const Scalar _tmp121 = _tmp102 * _tmp48 * _tmp84 * _tmp88 - _tmp120 * _tmp76;
  ...
  const Scalar _tmp128 = _tmp82 * _tmp84;
  const Scalar _tmp129 = _tmp128 * _tmp88 + _tmp57 * _tmp82;
  const Scalar _tmp130 = _tmp128 * _tmp76 - _tmp129 * _tmp49 - _tmp57;
  const Scalar _tmp131 = _tmp98 * (-_tmp122 * _tmp130 + _tmp128 * _tmp95 - _tmp94);
  const Scalar _tmp132 = _tmp114 * (_tmp130 + _tmp131);
  const Scalar _tmp133 = _tmp124 * _tmp131 + _tmp129 - _tmp132 * _tmp89;
  const Scalar _tmp134 = _tmp106 * fh1;
  const Scalar _tmp135 = -_tmp107 * _tmp109 - Scalar(5.1796800000000003) * _tmp27 - _tmp31 * fv1;
  const Scalar _tmp136 = _tmp49 * _tmp52;
  const Scalar _tmp137 = _tmp46 * (_tmp50 * _tmp52 + Scalar(1.0));
  ...
  const Scalar _tmp139 =
      ...
      Scalar(1.0) * _tmp134 * (-_tmp102 * _tmp133 + _tmp131 * _tmp52) + _tmp135 * _tmp138;
  const Scalar _tmp140 = _tmp116 * _tmp87;
  const Scalar _tmp141 = _tmp93 * (_tmp116 * _tmp63 - _tmp140 * _tmp74);
  const Scalar _tmp142 = -_tmp132 * _tmp86 - _tmp82;
  const Scalar _tmp143 = _tmp74 * _tmp84;
  const Scalar _tmp144 = -_tmp125 * _tmp86 + Scalar(1.0);
  const Scalar _tmp145 = -_tmp108 * _tmp93 * (_tmp100 * _tmp63 - _tmp100 * _tmp74 * _tmp87) -
                         _tmp113 * _tmp141 -
                         _tmp127 * _tmp93 * (_tmp125 * _tmp63 + _tmp143 * _tmp144) -
                         _tmp134 * _tmp93 * (_tmp132 * _tmp63 + _tmp142 * _tmp143 + Scalar(1.0));
  ...
  const Scalar _tmp150 =
      -_tmp147 * _tmp149 - std::sqrt(Scalar(std::pow(Scalar(-_tmp77 + p_c(1, 0)), Scalar(2)) +
  ...
  const Scalar _tmp154 = _tmp28 + _tmp42;
  const Scalar _tmp155 = std::pow(_tmp145, Scalar(-2));
  const Scalar _tmp156 = _tmp141 * _tmp155;
  const Scalar _tmp157 =
      (-_tmp139 * _tmp156 + _tmp146 * (_tmp112 * _tmp20 - _tmp119 + _tmp138 * _tmp154)) /
  ...
  const Scalar _tmp159 = _tmp101 * _tmp108 * _tmp46 - _tmp111 * _tmp158 + _tmp113 * _tmp118 +
                         _tmp126 * _tmp127 * _tmp46 + _tmp133 * _tmp134 * _tmp46 +
                         _tmp135 * _tmp137;
  const Scalar _tmp160 = _tmp113 * _tmp116;
  const Scalar _tmp161 = _tmp100 * _tmp108;
  const Scalar _tmp162 =
      _tmp127 * _tmp144 * _tmp84 + _tmp134 * _tmp142 * _tmp84 - _tmp160 * _tmp87 - _tmp161 * _tmp87;
  ...
  const Scalar _tmp174 = _tmp20 * _tmp52;
  const Scalar _tmp175 =
      (-_tmp159 * _tmp173 + _tmp163 * (-_tmp111 * _tmp174 - _tmp118 + _tmp137 * _tmp154)) /
      std::sqrt(Scalar(std::pow(_tmp159, Scalar(2)) * _tmp172 + 1));
  const Scalar _tmp176 = _tmp125 * _tmp127 + _tmp132 * _tmp134 + _tmp160 + _tmp161;
  const Scalar _tmp177 = Scalar(1.0) / (_tmp176);
  const Scalar _tmp178 = -_tmp108 * _tmp99 + _tmp113 * _tmp117 - _tmp123 * _tmp127 * _tmp51 -
                         _tmp131 * _tmp134 * _tmp51 - _tmp135 * _tmp136 + _tmp158;
  ...
  const Scalar _tmp186 = (_tmp177 * (-_tmp117 - _tmp136 * _tmp154 + _tmp174) + _tmp178 * _tmp185) /
  ...
  _res(3, 0) = -_tmp170 * (-std::sinh(_tmp183) - std::sinh(_tmp187)) +
               _tmp180 * (-Scalar(1.0) * _tmp186 * std::cosh(_tmp187) -
                          (Scalar(0.1034955) * _tmp181 * _tmp185 +
                           _tmp182 * (_tmp170 * _tmp179 - _tmp180 * _tmp186)) *
                              std::cosh(_tmp183));
