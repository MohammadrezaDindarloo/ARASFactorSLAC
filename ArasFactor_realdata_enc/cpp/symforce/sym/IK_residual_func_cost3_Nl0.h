...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl0(
  ...
  const Scalar _tmp50 = _tmp28 * _tmp47 - _tmp28 * _tmp49;
  ...
  const Scalar _tmp91 = _tmp28 * _tmp69;
  const Scalar _tmp92 = _tmp41 * _tmp42;
  const Scalar _tmp93 = -_tmp47 + _tmp50 * _tmp92 - _tmp55 * (_tmp51 + _tmp52 * _tmp92);
  const Scalar _tmp94 = _tmp75 * (-_tmp39 + _tmp40 * _tmp92 - _tmp73 * _tmp93) + _tmp93;
  const Scalar _tmp95 = -_tmp41 - _tmp77 * _tmp94;
  ...
  _res(1, 0) = std::exp(_tmp38 * _tmp88 * (_tmp65 * _tmp90 - _tmp90 * _tmp91) +
                        _tmp38 * _tmp98 * (_tmp65 * _tmp97 - _tmp91 * _tmp97) +
                        _tmp86 * _tmp87 * (_tmp76 * _tmp80 + _tmp78 * _tmp79) +
                        _tmp87 * _tmp96 * (_tmp79 * _tmp95 + _tmp80 * _tmp94 + Scalar(1.0)));
  _res(2, 0) = std::exp(_tmp100 * _tmp69 + _tmp101 * _tmp69 - _tmp78 * _tmp86 * _tmp99 -
                        _tmp95 * _tmp96 * _tmp99);
  _res(3, 0) = std::exp(-_tmp100 - _tmp101 - _tmp102 * _tmp76 * _tmp86 - _tmp102 * _tmp94 * _tmp96);
