...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl16(
  ...
  const Scalar _tmp44 = _tmp43 - p_d(0, 0) + p_init0;
  const Scalar _tmp45 = Scalar(1.0) / (_tmp44);
  const Scalar _tmp46 = _tmp41 * _tmp45;
  const Scalar _tmp47 = _tmp32 * _tmp33;
  const Scalar _tmp48 = Scalar(1.0) / (_tmp34 * _tmp46 - _tmp47);
  const Scalar _tmp49 = _tmp46 * _tmp48;
  const Scalar _tmp50 = -_tmp35 * _tmp46 + _tmp37 * _tmp47;
  const Scalar _tmp51 = _tmp15 * _tmp46;
  const Scalar _tmp52 = Scalar(1.0) * _tmp40;
  const Scalar _tmp53 = Scalar(1.0) * _tmp43;
  const Scalar _tmp54 = (-_tmp24 + _tmp53) / (_tmp31 - _tmp52);
  const Scalar _tmp55 = -_tmp15 + _tmp38 * _tmp49 - _tmp54 * (_tmp49 * _tmp50 + _tmp51);
  const Scalar _tmp56 = _tmp26 + _tmp30;
  const Scalar _tmp57 = _tmp56 - p_b(1, 0) + p_init1;
  const Scalar _tmp58 = _tmp17 + _tmp23;
  ...
  const Scalar _tmp63 = _tmp46 * _tmp61 - _tmp62;
  const Scalar _tmp64 = _tmp48 * _tmp63;
  const Scalar _tmp65 = _tmp10 + _tmp13 + _tmp36;
  const Scalar _tmp66 = _tmp15 * _tmp61 - _tmp38 * _tmp64 -
                        _tmp54 * (-_tmp50 * _tmp64 - _tmp51 * _tmp61 + _tmp62 * _tmp65) -
                        _tmp61 * _tmp65;
  ...
  const Scalar _tmp72 = -_tmp24 * _tmp47 + _tmp31 * _tmp34 + _tmp34 * _tmp71;
  const Scalar _tmp73 = _tmp56 * _tmp61 - _tmp58 * _tmp62 + _tmp61 * _tmp71 - _tmp64 * _tmp72;
  ...
  const Scalar _tmp80 = _tmp48 * (-_tmp46 - _tmp77 * _tmp79);
  const Scalar _tmp81 = _tmp17 + _tmp42;
  ...
  const Scalar _tmp87 = _tmp70 * _tmp86 * (_tmp34 * _tmp80 + _tmp77 * _tmp78 + Scalar(1.0));
  const Scalar _tmp88 = _tmp84 * _tmp85;
  const Scalar _tmp89 = _tmp81 * _tmp88 - _tmp83 * _tmp86;
  const Scalar _tmp90 = Scalar(1.0) * _tmp48;
  const Scalar _tmp91 = _tmp63 * _tmp75 * _tmp90;
  const Scalar _tmp92 = Scalar(1.0) * _tmp75;
  const Scalar _tmp93 = _tmp70 * _tmp89 * (-_tmp34 * _tmp91 + _tmp61 * _tmp92);
  const Scalar _tmp94 = -_tmp38 * _tmp90 + _tmp50 * _tmp54 * _tmp90;
  const Scalar _tmp95 = _tmp76 * (-_tmp72 * _tmp90 - _tmp74 * _tmp94) + _tmp94;
  const Scalar _tmp96 = _tmp48 * (-_tmp79 * _tmp95 + Scalar(1.0));
  const Scalar _tmp97 = _tmp70 * _tmp88 * (_tmp34 * _tmp96 + _tmp78 * _tmp95);
  const Scalar _tmp98 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp99 = _tmp52 * _tmp54 + _tmp53;
  const Scalar _tmp100 = 0;
  const Scalar _tmp101 = _tmp80 * _tmp86;
  const Scalar _tmp102 = _tmp88 * _tmp96;
  const Scalar _tmp103 = _tmp100 * _tmp98;
  const Scalar _tmp104 = _tmp89 * _tmp91;
  const Scalar _tmp105 = _tmp67 * _tmp77 * _tmp86;
  const Scalar _tmp106 = _tmp67 * _tmp88 * _tmp95;
  const Scalar _tmp107 = _tmp89 * _tmp92;

  // Output terms (1)
  Eigen::Matrix<Scalar, 4, 1> _res;

  _res(0, 0) = -std::exp(-fh1);
  _res(1, 0) = -(-_tmp87 - _tmp93 - _tmp97) *
               std::exp(_tmp70 * _tmp98 * (-_tmp100 * _tmp34 * _tmp64 + _tmp100 * _tmp61) +
                        _tmp87 * fh1 + _tmp93 * fh1 + _tmp97 * fh1);
  _res(2, 0) = -(_tmp101 + _tmp102 - _tmp104) *
               std::exp(-_tmp101 * fh1 - _tmp102 * fh1 + _tmp103 * _tmp64 + _tmp104 * fh1);
  _res(3, 0) = -(_tmp105 + _tmp106 + _tmp107) *
               std::exp(-_tmp103 - _tmp105 * fh1 - _tmp106 * fh1 - _tmp107 * fh1);
