...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl14(
  ...
  const Scalar _tmp37 = _tmp20 - p_c(0, 0);
  const Scalar _tmp38 = _tmp30 - p_c(1, 0);
  ...
  const Scalar _tmp75 = _tmp49 + p_init1;
  ...
  const Scalar _tmp81 = _tmp32 + _tmp67;
  const Scalar _tmp82 = _tmp70 * _tmp73;
  const Scalar _tmp83 = _tmp81 * _tmp82;
  const Scalar _tmp84 = _tmp68 * _tmp74 - _tmp80 * _tmp83;
  const Scalar _tmp85 = _tmp53 + p_init1;
  const Scalar _tmp86 = _tmp85 - p_d(1, 0);
  const Scalar _tmp87 = _tmp44 + p_init0;
  ...
  const Scalar _tmp92 = _tmp80 * _tmp90 - _tmp91;
  const Scalar _tmp93 = Scalar(1.0) / (-_tmp74 + _tmp80 * _tmp82);
  const Scalar _tmp94 = _tmp92 * _tmp93;
  const Scalar _tmp95 = _tmp81 * _tmp90;
  const Scalar _tmp96 = _tmp35 + _tmp66;
  const Scalar _tmp97 = -_tmp80 * _tmp95 - _tmp84 * _tmp94 + _tmp91 * _tmp96;
  const Scalar _tmp98 = -_tmp68 * _tmp82 + _tmp83;
  const Scalar _tmp99 = Scalar(1.0) * _tmp93;
  const Scalar _tmp100 = _tmp58 * _tmp64 * _tmp84 * _tmp93 - _tmp98 * _tmp99;
  const Scalar _tmp101 = -_tmp59 * _tmp97 - _tmp90 * _tmp96 - _tmp94 * _tmp98 + _tmp95;
  ...
  const Scalar _tmp106 = _tmp105 * (_tmp104 * _tmp46 * _tmp76 - _tmp104 * _tmp49 * _tmp78);
  const Scalar _tmp107 = _tmp93 * (_tmp106 * _tmp82 + _tmp55 * _tmp82 - _tmp57 * _tmp74);
  const Scalar _tmp108 = _tmp106 * _tmp90 - _tmp107 * _tmp92 - _tmp44 * _tmp91 + _tmp53 * _tmp90;
  const Scalar _tmp109 = _tmp102 * _tmp108;
  const Scalar _tmp110 = Scalar(1.0) / (_tmp108);
  const Scalar _tmp111 = _tmp101 * _tmp110;
  const Scalar _tmp112 = _tmp111 * (-_tmp100 * _tmp109 - Scalar(1.0) * _tmp107);
  const Scalar _tmp113 = _tmp102 * (_tmp100 + _tmp112);
  const Scalar _tmp114 = _tmp54 * _tmp61;
  const Scalar _tmp115 = _tmp112 * _tmp114 - _tmp113 * _tmp97 - _tmp84 * _tmp99;
  const Scalar _tmp116 = _tmp40 * fh1;
  const Scalar _tmp117 = _tmp111 * _tmp62;
  const Scalar _tmp118 = Scalar(1.0) * _tmp110;
  const Scalar _tmp119 = _tmp117 * _tmp54 - _tmp118 * _tmp97;
  const Scalar _tmp120 = _tmp37 * _tmp39;
  const Scalar _tmp121 = fh1 * (-_tmp120 * _tmp29 + _tmp19 * _tmp40);
  const Scalar _tmp122 = _tmp120 * _tmp41 + Scalar(5.1796800000000003) * _tmp13 + _tmp19 * fv1;
  const Scalar _tmp123 = _tmp54 * _tmp56;
  const Scalar _tmp124 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp125 = _tmp47 + _tmp50 * _tmp59;
  const Scalar _tmp126 = 0;
  const Scalar _tmp127 = _tmp125 * _tmp61;
  const Scalar _tmp128 = _tmp56 * (-_tmp126 * _tmp97 - _tmp127 * _tmp54 + _tmp51);
  const Scalar _tmp129 = _tmp80 * _tmp93;
  const Scalar _tmp130 = _tmp129 * _tmp84 + _tmp80 * _tmp81;
  const Scalar _tmp131 = _tmp129 * _tmp98 - _tmp130 * _tmp59 - _tmp81;
  const Scalar _tmp132 = _tmp111 * (-_tmp106 + _tmp107 * _tmp80 - _tmp109 * _tmp131);
  const Scalar _tmp133 = _tmp102 * (_tmp131 + _tmp132);
  const Scalar _tmp134 = _tmp114 * _tmp132 + _tmp130 - _tmp133 * _tmp97;
  const Scalar _tmp135 = _tmp120 * fh1;
  const Scalar _tmp136 = -_tmp133 * _tmp92 - _tmp80;
  const Scalar _tmp137 = _tmp82 * _tmp93;
  const Scalar _tmp138 = _tmp82 * _tmp94;
  const Scalar _tmp139 = -_tmp113 * _tmp92 + Scalar(1.0);
  const Scalar _tmp140 = -_tmp105 * _tmp116 * (_tmp113 * _tmp90 + _tmp137 * _tmp139) -
                         _tmp105 * _tmp121 * (-_tmp118 * _tmp138 + _tmp118 * _tmp90) -
                         _tmp105 * _tmp124 * (-_tmp126 * _tmp138 + _tmp126 * _tmp90) -
                         _tmp105 * _tmp135 * (_tmp133 * _tmp90 + _tmp136 * _tmp137 + Scalar(1.0));
  const Scalar _tmp141 = Scalar(1.0) / (_tmp140);
  const Scalar _tmp142 = std::asinh(
      _tmp141 * (Scalar(1.0) * _tmp116 * (_tmp112 * _tmp62 - _tmp115 * _tmp64) +
                 Scalar(1.0) * _tmp121 * (_tmp117 - _tmp119 * _tmp64) +
                 Scalar(1.0) * _tmp122 * (_tmp123 * _tmp62 - _tmp62) +
                 Scalar(1.0) * _tmp124 * (-_tmp125 * _tmp62 - Scalar(1.0) * _tmp128 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp135 * (_tmp132 * _tmp62 - _tmp134 * _tmp64) +
                 Scalar(1.0) * _tmp42 * (-_tmp63 * _tmp64 + _tmp65)));
  const Scalar _tmp143 = Scalar(0.1034955) * _tmp141;
  const Scalar _tmp144 = Scalar(9.6622558468725703) * _tmp140;
  const Scalar _tmp145 = _tmp124 * _tmp126;
  const Scalar _tmp146 = _tmp118 * _tmp121;
  const Scalar _tmp147 =
      _tmp116 * _tmp139 * _tmp93 + _tmp135 * _tmp136 * _tmp93 - _tmp145 * _tmp94 - _tmp146 * _tmp94;
  const Scalar _tmp148 = Scalar(1.0) / (_tmp147);
  const Scalar _tmp149 = _tmp122 * _tmp62;
  const Scalar _tmp150 = std::asinh(
      _tmp148 * (_tmp115 * _tmp116 * _tmp56 + _tmp119 * _tmp121 * _tmp56 - _tmp123 * _tmp149 +
                 _tmp124 * _tmp128 + _tmp134 * _tmp135 * _tmp56 + _tmp42 * _tmp56 * _tmp63));
  const Scalar _tmp151 = Scalar(9.6622558468725703) * _tmp147;
  const Scalar _tmp152 = Scalar(0.1034955) * _tmp148;
  const Scalar _tmp153 = _tmp113 * _tmp116 + _tmp133 * _tmp135 + _tmp145 + _tmp146;
  const Scalar _tmp154 = Scalar(1.0) / (_tmp153);
  const Scalar _tmp155 =
      std::asinh(_tmp154 * (-_tmp112 * _tmp116 * _tmp61 - _tmp117 * _tmp121 + _tmp124 * _tmp127 -
                            _tmp132 * _tmp135 * _tmp61 + _tmp149 - _tmp42 * _tmp65));
  ...
  _res(1, 0) =
      -_tmp144 *
          (_tmp143 * p_b(2, 0) + std::cosh(Scalar(1.0) * _tmp142) -
           std::cosh(_tmp143 *
                     (-_tmp142 * _tmp144 -
                      std::sqrt(Scalar(std::pow(Scalar(-_tmp75 + p_b(1, 0)), Scalar(2)) +
  ...
  _res(2, 0) =
      -_tmp151 *
          (_tmp152 * p_a(2, 0) + std::cosh(Scalar(1.0) * _tmp150) -
           std::cosh(_tmp152 *
                     (-_tmp150 * _tmp151 -
                      std::sqrt(Scalar(std::pow(Scalar(-_tmp69 + p_a(0, 0)), Scalar(2)) +
  ...
  _res(3, 0) =
      -_tmp156 *
          (_tmp157 * p_d(2, 0) + std::cosh(Scalar(1.0) * _tmp155) -
           std::cosh(_tmp157 *
                     (-_tmp155 * _tmp156 -
                      std::sqrt(Scalar(std::pow(Scalar(-_tmp85 + p_d(1, 0)), Scalar(2)) +
