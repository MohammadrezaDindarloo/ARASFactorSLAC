...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl16(
  ...
  const Scalar _tmp58 = _tmp10 + _tmp40;
  ...
  const Scalar _tmp74 = -_tmp38 + _tmp54 * _tmp65 - _tmp68 * _tmp73;
  const Scalar _tmp75 = _tmp28 + _tmp44;
  const Scalar _tmp76 = _tmp75 + p_init1;
  const Scalar _tmp77 = _tmp76 - p_b(1, 0);
  const Scalar _tmp78 = _tmp18 + _tmp39;
  ...
  const Scalar _tmp87 = -_tmp66 * _tmp85 - _tmp67 * _tmp82 + _tmp83 * _tmp86;
  const Scalar _tmp88 = _tmp38 * _tmp82 - _tmp54 * _tmp85 - _tmp73 * _tmp87 - _tmp82 * _tmp86;
  ...
  const Scalar _tmp104 = _tmp50 * _tmp64;
  const Scalar _tmp105 = _tmp20 - p_c(0, 0);
  const Scalar _tmp106 = _tmp30 - p_c(1, 0);
  ...
  const Scalar _tmp111 = _tmp110 * _tmp84 * _tmp97;
  const Scalar _tmp112 = Scalar(1.0) * _tmp97;
  const Scalar _tmp113 = _tmp106 * _tmp107;
  const Scalar _tmp114 = fh1 * (-_tmp108 * _tmp29 + _tmp113 * _tmp19);
  const Scalar _tmp115 = _tmp110 * _tmp66;
  const Scalar _tmp116 = -_tmp110 * _tmp54 + _tmp115 * _tmp73;
  const Scalar _tmp117 = _tmp98 * (-_tmp110 * _tmp94 - _tmp116 * _tmp96);
  ...
  const Scalar _tmp125 = -_tmp109 * _tmp92 * (_tmp100 * _tmp101 + _tmp103 * _tmp104 + Scalar(1.0)) -
                         _tmp114 * _tmp92 * (-_tmp111 * _tmp50 + _tmp112 * _tmp82) -
                         _tmp120 * _tmp92 * (_tmp101 * _tmp118 + _tmp104 * _tmp119) -
                         _tmp121 * _tmp92 * (-_tmp124 * _tmp50 * _tmp85 + _tmp124 * _tmp82);
  const Scalar _tmp126 = Scalar(1.0) / (_tmp125);
  const Scalar _tmp127 = _tmp36 * fh1;
  const Scalar _tmp128 = -_tmp113 * _tmp127 - Scalar(5.1796800000000003) * _tmp26 - _tmp29 * fv1;
  ...
  const Scalar _tmp139 = _tmp122 * _tmp131;
  const Scalar _tmp140 = -_tmp123 * _tmp137 - _tmp129 * _tmp139 + _tmp70;
  const Scalar _tmp141 = _tmp108 * _tmp127 + Scalar(5.1796800000000003) * _tmp13 + _tmp19 * fv1;
  const Scalar _tmp142 = _tmp129 * _tmp132;
  const Scalar _tmp143 = -_tmp100 * _tmp137 + _tmp136 * _tmp99 + _tmp68;
  const Scalar _tmp144 = _tmp132 * _tmp98;
  const Scalar _tmp145 = -_tmp112 * _tmp87 + _tmp142 * _tmp98;
  const Scalar _tmp146 = std::asinh(
      _tmp126 * (Scalar(1.0) * _tmp109 * (_tmp132 * _tmp99 - _tmp134 * _tmp143) +
                 Scalar(1.0) * _tmp114 * (-_tmp134 * _tmp145 + _tmp144) +
                 Scalar(1.0) * _tmp120 * (_tmp117 * _tmp132 - _tmp134 * _tmp138) +
                 Scalar(1.0) * _tmp121 * (-_tmp122 * _tmp132 - _tmp134 * _tmp140 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp128 * (-_tmp133 * _tmp134 + _tmp135) +
                 Scalar(1.0) * _tmp141 * (-_tmp132 + _tmp142 * _tmp71)));
  const Scalar _tmp147 = Scalar(9.6622558468725703) * _tmp125;
  const Scalar _tmp148 = Scalar(0.1034955) * _tmp126;
  const Scalar _tmp149 = _tmp64 * fh1;
  const Scalar _tmp150 = _tmp121 * _tmp124;
  const Scalar _tmp151 = _tmp103 * _tmp108 * _tmp149 - _tmp111 * _tmp114 +
                         _tmp113 * _tmp119 * _tmp149 - _tmp150 * _tmp85;
  const Scalar _tmp152 = Scalar(1.0) / (_tmp151);
  const Scalar _tmp153 = Scalar(0.1034955) * _tmp152;
  const Scalar _tmp154 = _tmp132 * _tmp141;
  const Scalar _tmp155 =
      std::asinh(_tmp152 * (_tmp109 * _tmp143 * _tmp71 + _tmp114 * _tmp145 * _tmp71 +
                            _tmp120 * _tmp138 * _tmp71 + _tmp121 * _tmp140 * _tmp71 +
                            _tmp128 * _tmp133 * _tmp71 - _tmp129 * _tmp154 * _tmp71));
  const Scalar _tmp156 = Scalar(9.6622558468725703) * _tmp151;
  const Scalar _tmp157 =
      _tmp100 * _tmp109 * _tmp89 + _tmp112 * _tmp114 + _tmp118 * _tmp120 * _tmp89 + _tmp150;
  const Scalar _tmp158 = Scalar(1.0) / (_tmp157);
  const Scalar _tmp159 = std::asinh(_tmp158 * (-_tmp109 * _tmp131 * _tmp99 - _tmp114 * _tmp144 -
                                               _tmp117 * _tmp120 * _tmp131 + _tmp121 * _tmp139 -
                                               _tmp128 * _tmp135 + _tmp154));
  const Scalar _tmp160 = Scalar(0.1034955) * _tmp158;
  ...
  _res(2, 0) =
      -_tmp156 *
          (_tmp153 * p_a(2, 0) + std::cosh(Scalar(1.0) * _tmp155) -
           std::cosh(_tmp153 *
                     (-_tmp155 * _tmp156 -
  ...
  _res(3, 0) =
      -_tmp161 *
          (_tmp160 * p_b(2, 0) + std::cosh(Scalar(1.0) * _tmp159) -
           std::cosh(_tmp160 *
                     (-_tmp159 * _tmp161 -
                      std::sqrt(Scalar(std::pow(Scalar(-_tmp76 + p_b(1, 0)), Scalar(2)) +
