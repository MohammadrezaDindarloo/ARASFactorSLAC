...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl8(
  ...
  const Scalar _tmp35 = -Scalar(0.010999999999999999) * _tmp16 -
  ...
  const Scalar _tmp43 = _tmp19 + _tmp9;
  ...
  const Scalar _tmp64 = _tmp59 * (-_tmp57 * _tmp61 + _tmp63);
  const Scalar _tmp65 = _tmp59 * (-_tmp47 * _tmp63 + _tmp58 * _tmp61);
  const Scalar _tmp66 = _tmp47 * _tmp62;
  const Scalar _tmp67 = _tmp47 * _tmp65 + _tmp66;
  const Scalar _tmp68 = Scalar(1.0) * _tmp40;
  const Scalar _tmp69 = -_tmp68;
  const Scalar _tmp70 = Scalar(1.0) / (_tmp53 + _tmp69);
  const Scalar _tmp71 = Scalar(1.0) * _tmp43;
  const Scalar _tmp72 = _tmp70 * (-_tmp49 + _tmp71);
  const Scalar _tmp73 = _tmp47 * _tmp64 - _tmp62 - _tmp67 * _tmp72;
  const Scalar _tmp74 = _tmp39 + _tmp52;
  const Scalar _tmp75 = _tmp74 + p_init1;
  const Scalar _tmp76 = _tmp75 - p_d(1, 0);
  const Scalar _tmp77 = _tmp48 + _tmp9;
  ...
  const Scalar _tmp82 = _tmp33 + _tmp60;
  const Scalar _tmp83 = _tmp76 * _tmp80;
  const Scalar _tmp84 = _tmp47 * _tmp81 - _tmp83;
  const Scalar _tmp85 = -_tmp65 * _tmp84 - _tmp66 * _tmp81 + _tmp82 * _tmp83;
  const Scalar _tmp86 = _tmp62 * _tmp81 - _tmp64 * _tmp84 - _tmp72 * _tmp85 - _tmp81 * _tmp82;
  ...
  const Scalar _tmp90 = _tmp46 * _tmp88;
  const Scalar _tmp91 = _tmp90 * (-_tmp40 * _tmp45 * _tmp89 + _tmp42 * _tmp43 * _tmp89);
  const Scalar _tmp92 = _tmp59 * (-_tmp49 * _tmp58 + _tmp53 * _tmp57 + _tmp57 * _tmp91);
  const Scalar _tmp93 = _tmp74 * _tmp81 - _tmp77 * _tmp83 + _tmp81 * _tmp91 - _tmp84 * _tmp92;
  const Scalar _tmp94 = _tmp87 * _tmp93;
  const Scalar _tmp95 = Scalar(1.0) / (_tmp93);
  const Scalar _tmp96 = _tmp86 * _tmp95;
  const Scalar _tmp97 = _tmp96 * (_tmp47 * _tmp92 - _tmp73 * _tmp94 - _tmp91);
  const Scalar _tmp98 = _tmp73 + _tmp97;
  const Scalar _tmp99 = _tmp81 * _tmp87;
  const Scalar _tmp100 = _tmp84 * _tmp87;
  const Scalar _tmp101 = -_tmp100 * _tmp98 - _tmp47;
  ...
  const Scalar _tmp109 = _tmp68 * _tmp72 + _tmp71;
  ...
  const Scalar _tmp115 = fh1 * (-_tmp106 * _tmp30 + _tmp114 * _tmp20);
  const Scalar _tmp116 = Scalar(1.0) * _tmp65;
  const Scalar _tmp117 = _tmp116 * _tmp72 - Scalar(1.0) * _tmp64;
  const Scalar _tmp118 = _tmp96 * (-_tmp117 * _tmp94 - Scalar(1.0) * _tmp92);
  const Scalar _tmp119 = _tmp117 + _tmp118;
  const Scalar _tmp120 = -_tmp100 * _tmp119 + Scalar(1.0);
  const Scalar _tmp121 = _tmp114 * fh1;
  const Scalar _tmp122 = -_tmp107 * _tmp90 * (_tmp101 * _tmp102 + _tmp98 * _tmp99 + Scalar(1.0)) -
                         _tmp108 * _tmp90 * (-_tmp102 * _tmp111 + _tmp112 * _tmp81) -
                         _tmp115 * _tmp90 * (-_tmp102 * _tmp113 * _tmp84 + _tmp113 * _tmp81) -
                         _tmp121 * _tmp90 * (_tmp102 * _tmp120 + _tmp119 * _tmp99);
  const Scalar _tmp123 = Scalar(1.0) / (_tmp122);
  const Scalar _tmp124 = _tmp85 * _tmp87;
  const Scalar _tmp125 = _tmp69 + _tmp74;
  const Scalar _tmp126 = _tmp125 * _tmp72;
  const Scalar _tmp127 = Scalar(1.0) / (-_tmp126 + _tmp71 - _tmp77);
  const Scalar _tmp128 = _tmp125 * _tmp127;
  const Scalar _tmp129 = -_tmp124 * _tmp98 + _tmp128 * _tmp97 + _tmp67;
  const Scalar _tmp130 = Scalar(1.0) * _tmp70;
  const Scalar _tmp131 = Scalar(1.0) * _tmp127;
  const Scalar _tmp132 = _tmp109 * _tmp127;
  const Scalar _tmp133 = _tmp70 * (-_tmp110 * _tmp124 - _tmp125 * _tmp132 + _tmp69);
  const Scalar _tmp134 = _tmp131 * _tmp96;
  const Scalar _tmp135 = -_tmp113 * _tmp85 + _tmp125 * _tmp134;
  const Scalar _tmp136 = -_tmp116 + _tmp118 * _tmp128 - _tmp119 * _tmp124;
  const Scalar _tmp137 = _tmp38 * fh1;
  const Scalar _tmp138 = _tmp106 * _tmp137 + Scalar(5.1796800000000003) * _tmp14 + _tmp20 * fv1;
  const Scalar _tmp139 = _tmp125 * _tmp70;
  const Scalar _tmp140 = _tmp131 * _tmp72;
  const Scalar _tmp141 = _tmp126 * _tmp131 + Scalar(1.0);
  const Scalar _tmp142 = -_tmp114 * _tmp137 - Scalar(5.1796800000000003) * _tmp25 - _tmp30 * fv1;
  const Scalar _tmp143 =
      std::asinh(_tmp123 * (Scalar(1.0) * _tmp107 * (-_tmp129 * _tmp130 + _tmp131 * _tmp97) +
                            Scalar(1.0) * _tmp108 *
                                (-_tmp109 * _tmp131 - Scalar(1.0) * _tmp133 + Scalar(1.0)) +
                            Scalar(1.0) * _tmp115 * (-_tmp130 * _tmp135 + _tmp134) +
                            Scalar(1.0) * _tmp121 * (_tmp118 * _tmp131 - _tmp130 * _tmp136) +
                            Scalar(1.0) * _tmp138 * (_tmp131 * _tmp139 - _tmp131) +
                            Scalar(1.0) * _tmp142 * (-_tmp130 * _tmp141 + _tmp140)));
  const Scalar _tmp144 = Scalar(9.6622558468725703) * _tmp122;
  const Scalar _tmp145 = Scalar(0.1034955) * _tmp123;
  const Scalar _tmp146 = _tmp131 * _tmp138;
  const Scalar _tmp147 = _tmp113 * _tmp115;
  const Scalar _tmp148 = _tmp59 * fh1;
  const Scalar _tmp149 = _tmp101 * _tmp106 * _tmp148 - _tmp108 * _tmp111 * _tmp59 +
                         _tmp114 * _tmp120 * _tmp148 - _tmp147 * _tmp59 * _tmp84;
  const Scalar _tmp150 = Scalar(1.0) / (_tmp149);
  const Scalar _tmp151 = std::asinh(
      _tmp150 * (_tmp107 * _tmp129 * _tmp70 + _tmp108 * _tmp133 + _tmp115 * _tmp135 * _tmp70 +
                 _tmp121 * _tmp136 * _tmp70 - _tmp139 * _tmp146 + _tmp141 * _tmp142 * _tmp70));
  const Scalar _tmp152 = Scalar(9.6622558468725703) * _tmp149;
  const Scalar _tmp153 = Scalar(0.1034955) * _tmp150;
  const Scalar _tmp154 =
      _tmp107 * _tmp87 * _tmp98 + _tmp108 * _tmp112 + _tmp119 * _tmp121 * _tmp87 + _tmp147;
  const Scalar _tmp155 = Scalar(1.0) / (_tmp154);
  const Scalar _tmp156 =
      std::asinh(_tmp155 * (-_tmp107 * _tmp127 * _tmp97 + _tmp108 * _tmp132 - _tmp115 * _tmp134 -
                            _tmp118 * _tmp121 * _tmp127 - _tmp140 * _tmp142 + _tmp146));
  ...
  _res(1, 0) =
      -_tmp144 *
          (_tmp145 * p_c(2, 0) + std::cosh(Scalar(1.0) * _tmp143) -
           std::cosh(_tmp145 *
                     (-_tmp143 * _tmp144 -
                      std::sqrt(Scalar(std::pow(Scalar(-_tmp41 + p_c(1, 0)), Scalar(2)) +
                                       std::pow(Scalar(-_tmp44 + p_c(0, 0)), Scalar(2))))))) +
      _tmp62 + p_init2;
  _res(2, 0) =
      -_tmp152 *
          (_tmp153 * p_a(2, 0) + std::cosh(Scalar(1.0) * _tmp151) -
           std::cosh(_tmp153 *
                     (-_tmp151 * _tmp152 -
  ...
  _res(3, 0) =
      -_tmp157 *
          (_tmp158 * p_d(2, 0) + std::cosh(Scalar(1.0) * _tmp156) -
           std::cosh(_tmp158 *
                     (-_tmp156 * _tmp157 -
                      std::sqrt(Scalar(std::pow(Scalar(-_tmp75 + p_d(1, 0)), Scalar(2)) +
