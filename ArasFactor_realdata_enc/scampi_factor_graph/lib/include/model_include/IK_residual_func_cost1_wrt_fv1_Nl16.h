...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1WrtFv1Nl16(
  ...
  const Scalar _tmp16 = _tmp4 * _tmp9;
  ...
  const Scalar _tmp49 = std::pow(Scalar(std::pow(_tmp42, Scalar(2)) + std::pow(_tmp48, Scalar(2))),
  ...
  const Scalar _tmp54 = -_tmp50 * _tmp53 + _tmp51;
  const Scalar _tmp55 = _tmp23 + _tmp45;
  const Scalar _tmp56 = _tmp55 + p_init1;
  const Scalar _tmp57 = _tmp56 - p_d(1, 0);
  const Scalar _tmp58 = _tmp11 + _tmp39;
  ...
  const Scalar _tmp66 = -_tmp51 * _tmp62 + _tmp53 * _tmp63;
  ...
  const Scalar _tmp74 = -_tmp37 + _tmp54 * _tmp65 - _tmp68 * _tmp73;
  const Scalar _tmp75 = _tmp30 + _tmp43;
  const Scalar _tmp76 = _tmp75 + p_init1;
  const Scalar _tmp77 = _tmp76 - p_b(1, 0);
  const Scalar _tmp78 = _tmp19 + _tmp38;
  ...
  const Scalar _tmp88 = -_tmp66 * _tmp85 - _tmp67 * _tmp82 + _tmp83 * _tmp87;
  const Scalar _tmp89 = _tmp37 * _tmp82 - _tmp54 * _tmp85 - _tmp73 * _tmp88 - _tmp82 * _tmp87;
  ...
  const Scalar _tmp95 = -_tmp40 * _tmp63 + _tmp46 * _tmp50 + _tmp50 * _tmp94;
  ...
  const Scalar _tmp103 = _tmp84 * _tmp90;
  const Scalar _tmp104 = -_tmp101 * _tmp103 - _tmp62;
  const Scalar _tmp105 = _tmp50 * _tmp64;
  ...
  const Scalar _tmp112 = _tmp111 * _tmp84 * _tmp98;
  const Scalar _tmp113 = Scalar(1.0) * _tmp98;
  const Scalar _tmp114 = _tmp107 * _tmp108;
  const Scalar _tmp115 = fh1 * (-_tmp109 * _tmp31 + _tmp114 * _tmp20);
  const Scalar _tmp116 = _tmp111 * _tmp66;
  const Scalar _tmp117 = -_tmp111 * _tmp54 + _tmp116 * _tmp73;
  const Scalar _tmp118 = _tmp99 * (-_tmp111 * _tmp95 - _tmp117 * _tmp97);
  ...
  const Scalar _tmp123 = _tmp69 * _tmp73 + _tmp72;
  const Scalar _tmp124 = 0;
  const Scalar _tmp125 = _tmp124 * _tmp90;
  const Scalar _tmp126 = _tmp125 * _tmp85;
  const Scalar _tmp127 = _tmp93 * (_tmp125 * _tmp82 - _tmp126 * _tmp50);
  const Scalar _tmp128 = -_tmp110 * _tmp93 * (_tmp101 * _tmp102 + _tmp104 * _tmp105 + Scalar(1.0)) -
                         _tmp115 * _tmp93 * (-_tmp112 * _tmp50 + _tmp113 * _tmp82) -
                         _tmp121 * _tmp93 * (_tmp102 * _tmp119 + _tmp105 * _tmp120) -
                         _tmp122 * _tmp127;
  const Scalar _tmp129 = Scalar(1.0) / (_tmp128);
  const Scalar _tmp130 = fh1 * (_tmp33 + _tmp86);
  const Scalar _tmp131 = -_tmp114 * _tmp130 - Scalar(5.1796800000000003) * _tmp26 - _tmp31 * fv1;
  const Scalar _tmp132 = _tmp70 + _tmp75;
  const Scalar _tmp133 = _tmp132 * _tmp73;
  const Scalar _tmp134 = Scalar(1.0) / (-_tmp133 + _tmp72 - _tmp78);
  ...
  const Scalar _tmp138 = _tmp135 * _tmp73;
  ...
  const Scalar _tmp142 = -_tmp116 + _tmp118 * _tmp140 - _tmp119 * _tmp141;
  const Scalar _tmp143 = _tmp123 * _tmp134;
  const Scalar _tmp144 = _tmp71 * (-_tmp124 * _tmp141 - _tmp132 * _tmp143 + _tmp70);
  const Scalar _tmp145 = -Scalar(1.0) * _tmp143 - Scalar(1.0) * _tmp144 + Scalar(1.0);
  const Scalar _tmp146 = _tmp109 * _tmp130 + Scalar(5.1796800000000003) * _tmp17 + _tmp20 * fv1;
  const Scalar _tmp147 = _tmp132 * _tmp71;
  const Scalar _tmp148 = Scalar(1.0) * _tmp135 * _tmp147 - Scalar(1.0) * _tmp135;
  const Scalar _tmp149 = _tmp100 * _tmp140 - _tmp101 * _tmp141 + _tmp68;
  const Scalar _tmp150 = _tmp135 * _tmp99;
  const Scalar _tmp151 = -_tmp113 * _tmp88 + _tmp132 * _tmp150;
  const Scalar _tmp152 = Scalar(1.0) * _tmp110 * (_tmp100 * _tmp135 - _tmp137 * _tmp149) +
                         Scalar(1.0) * _tmp115 * (-_tmp137 * _tmp151 + _tmp150) +
                         Scalar(1.0) * _tmp121 * (_tmp118 * _tmp135 - _tmp137 * _tmp142) +
                         _tmp122 * _tmp145 + _tmp131 * _tmp139 + _tmp146 * _tmp148;
  const Scalar _tmp153 = std::asinh(_tmp129 * _tmp152);
  const Scalar _tmp154 = Scalar(9.6622558468725703) * _tmp128;
  const Scalar _tmp155 =
      -_tmp153 * _tmp154 - std::sqrt(Scalar(std::pow(Scalar(-_tmp56 + p_d(1, 0)), Scalar(2)) +
  ...
  const Scalar _tmp160 = _tmp27 + _tmp43 + _tmp44;
  const Scalar _tmp161 =
      (_tmp129 * (_tmp139 * _tmp160 - _tmp145 + _tmp148 * _tmp20) - _tmp152 * _tmp159) /
  ...
  const Scalar _tmp166 = _tmp136 * _tmp71;
  const Scalar _tmp167 = _tmp110 * _tmp149 * _tmp71 + _tmp115 * _tmp151 * _tmp71 +
                         _tmp121 * _tmp142 * _tmp71 + _tmp122 * _tmp144 + _tmp131 * _tmp166 -
                         _tmp147 * _tmp165;
  const Scalar _tmp168 = _tmp122 * _tmp125;
  const Scalar _tmp169 = _tmp104 * _tmp110 * _tmp64 - _tmp112 * _tmp115 +
                         _tmp120 * _tmp121 * _tmp64 - _tmp168 * _tmp85;
  ...
  const Scalar _tmp173 =
      -_tmp171 * _tmp172 - std::sqrt(Scalar(std::pow(Scalar(-_tmp41 + p_a(0, 0)), Scalar(2)) +
  ...
  const Scalar _tmp180 =
      (-_tmp167 * _tmp177 + _tmp170 * (-_tmp144 - _tmp147 * _tmp179 + _tmp160 * _tmp166)) /
      std::sqrt(Scalar(std::pow(_tmp167, Scalar(2)) * _tmp176 + 1));
  const Scalar _tmp181 = Scalar(9.6622558468725703) * _tmp125;
  const Scalar _tmp182 = _tmp181 * _tmp85;
  const Scalar _tmp183 = Scalar(1.0) * _tmp171;
  const Scalar _tmp184 =
      _tmp101 * _tmp110 * _tmp90 + _tmp113 * _tmp115 + _tmp119 * _tmp121 * _tmp90 + _tmp168;
  const Scalar _tmp185 = Scalar(9.6622558468725703) * _tmp184;
  const Scalar _tmp186 = std::pow(_tmp184, Scalar(-2));
  const Scalar _tmp187 = -_tmp100 * _tmp110 * _tmp134 - _tmp115 * _tmp150 -
                         _tmp118 * _tmp121 * _tmp134 + _tmp122 * _tmp143 - _tmp131 * _tmp138 +
                         _tmp165;
  const Scalar _tmp188 = Scalar(1.0) / (_tmp184);
  const Scalar _tmp189 = _tmp125 * _tmp186;
  const Scalar _tmp190 = (_tmp187 * _tmp189 + _tmp188 * (-_tmp138 * _tmp160 - _tmp143 + _tmp179)) /
                         std::sqrt(Scalar(_tmp186 * std::pow(_tmp187, Scalar(2)) + 1));
  const Scalar _tmp191 = std::asinh(_tmp187 * _tmp188);
  const Scalar _tmp192 = Scalar(0.1034955) * _tmp188;
  const Scalar _tmp193 =
      -_tmp185 * _tmp191 - std::sqrt(Scalar(std::pow(Scalar(-_tmp76 + p_b(1, 0)), Scalar(2)) +
  ...
  _res(1, 0) =
      -_tmp154 * (Scalar(1.0) * _tmp161 * std::sinh(_tmp164) - _tmp163 * p_d(2, 0) -
                  (-_tmp155 * _tmp163 + _tmp156 * (-_tmp153 * _tmp162 - _tmp154 * _tmp161)) *
                      std::sinh(_tmp157)) -
      _tmp162 * (_tmp156 * p_d(2, 0) - std::cosh(_tmp157) + std::cosh(_tmp164));
  _res(2, 0) =
      -_tmp172 * (-_tmp178 * p_a(2, 0) + Scalar(1.0) * _tmp180 * std::sinh(_tmp183) -
                  (-_tmp173 * _tmp178 + _tmp174 * (-_tmp171 * _tmp182 - _tmp172 * _tmp180)) *
                      std::sinh(_tmp175)) -
      _tmp182 * (_tmp174 * p_a(2, 0) - std::cosh(_tmp175) + std::cosh(_tmp183));
  _res(3, 0) = _tmp181 * (_tmp192 * p_b(2, 0) - std::cosh(_tmp195) + std::cosh(_tmp196)) -
               _tmp185 * (Scalar(1.0) * _tmp190 * std::sinh(_tmp196) + _tmp194 * p_b(2, 0) -
                          (_tmp192 * (_tmp181 * _tmp191 - _tmp185 * _tmp190) + _tmp193 * _tmp194) *
                              std::sinh(_tmp195));
