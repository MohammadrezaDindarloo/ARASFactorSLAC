...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl17(
  ...
  const Scalar _tmp74 = Scalar(1.0) / (_tmp49 * _tmp72 - _tmp73);
  const Scalar _tmp75 = _tmp6 + _tmp63;
  const Scalar _tmp76 = _tmp38 * _tmp49;
  const Scalar _tmp77 = _tmp74 * (-_tmp72 * _tmp76 + _tmp73 * _tmp75);
  const Scalar _tmp78 = -_tmp49 * _tmp62 + _tmp60 * _tmp64 - _tmp61 * _tmp77;
  ...
  const Scalar _tmp85 = _tmp74 * (_tmp38 * _tmp72 - _tmp72 * _tmp75);
  const Scalar _tmp86 = -_tmp59 * _tmp64 - _tmp61 * _tmp85 + _tmp62 - _tmp78 * _tmp84;
  ...
  const Scalar _tmp91 = _tmp90 * (_tmp40 * _tmp46 * _tmp89 - _tmp43 * _tmp47 * _tmp89);
  const Scalar _tmp92 = _tmp74 * (_tmp65 * _tmp72 - _tmp68 * _tmp73 + _tmp72 * _tmp91);
  const Scalar _tmp93 = _tmp49 * _tmp77 + _tmp76;
  const Scalar _tmp94 = -_tmp38 + _tmp49 * _tmp85 - _tmp84 * _tmp93;
  const Scalar _tmp95 = -_tmp51 * _tmp60 + _tmp55 * _tmp59 + _tmp59 * _tmp91 - _tmp61 * _tmp92;
  const Scalar _tmp96 = _tmp87 * _tmp95;
  const Scalar _tmp97 = Scalar(1.0) / (_tmp95);
  const Scalar _tmp98 = _tmp86 * _tmp97;
  const Scalar _tmp99 = _tmp98 * (_tmp49 * _tmp92 - _tmp91 - _tmp94 * _tmp96);
  const Scalar _tmp100 = _tmp87 * (_tmp94 + _tmp99);
  const Scalar _tmp101 = -_tmp100 * _tmp61 - _tmp49;
  const Scalar _tmp102 = _tmp72 * _tmp74;
  const Scalar _tmp103 = _tmp25 - p_c(0, 0);
  const Scalar _tmp104 = _tmp32 - p_c(1, 0);
  ...
  const Scalar _tmp109 = _tmp102 * _tmp61;
  const Scalar _tmp110 = _tmp104 * _tmp105;
  const Scalar _tmp111 = fh1 * (-_tmp106 * _tmp31 + _tmp110 * _tmp24);
  const Scalar _tmp112 = Scalar(1.0) * _tmp81;
  const Scalar _tmp113 = _tmp112 * _tmp77 * _tmp83 - Scalar(1.0) * _tmp85;
  const Scalar _tmp114 = _tmp98 * (-_tmp113 * _tmp96 - Scalar(1.0) * _tmp92);
  const Scalar _tmp115 = _tmp87 * (_tmp113 + _tmp114);
  const Scalar _tmp116 = -_tmp115 * _tmp61 + Scalar(1.0);
  ...
  const Scalar _tmp121 = -_tmp107 * _tmp90 * (_tmp100 * _tmp59 + _tmp101 * _tmp102 + Scalar(1.0)) -
                         _tmp111 * _tmp90 * (-_tmp108 * _tmp109 + _tmp108 * _tmp59) -
                         _tmp117 * _tmp90 * (_tmp102 * _tmp116 + _tmp115 * _tmp59) -
                         _tmp118 * _tmp90 * (-_tmp109 * _tmp120 + _tmp120 * _tmp59);
  const Scalar _tmp122 = Scalar(1.0) / (_tmp121);
  const Scalar _tmp123 = _tmp15 * fh1;
  const Scalar _tmp124 = _tmp106 * _tmp123 + Scalar(5.1796800000000003) * _tmp19 + _tmp24 * fv1;
  const Scalar _tmp125 = _tmp55 + _tmp80;
  const Scalar _tmp126 = _tmp125 * _tmp84;
  const Scalar _tmp127 = Scalar(1.0) / (-_tmp126 - _tmp51 + _tmp82);
  const Scalar _tmp128 = Scalar(1.0) * _tmp127;
  const Scalar _tmp129 = _tmp125 * _tmp81;
  const Scalar _tmp130 = -_tmp110 * _tmp123 - Scalar(5.1796800000000003) * _tmp27 - _tmp31 * fv1;
  const Scalar _tmp131 = _tmp126 * _tmp128 + Scalar(1.0);
  const Scalar _tmp132 = _tmp128 * _tmp84;
  const Scalar _tmp133 = _tmp125 * _tmp127;
  const Scalar _tmp134 = -_tmp100 * _tmp78 + _tmp133 * _tmp99 + _tmp93;
  const Scalar _tmp135 = _tmp119 * _tmp127;
  const Scalar _tmp136 = -_tmp120 * _tmp78 - _tmp125 * _tmp135 + _tmp80;
  const Scalar _tmp137 = _tmp128 * _tmp98;
  const Scalar _tmp138 = -_tmp108 * _tmp78 + _tmp125 * _tmp137;
  const Scalar _tmp139 = _tmp114 * _tmp133 - _tmp115 * _tmp78 - Scalar(1.0) * _tmp77;
  const Scalar _tmp140 = std::asinh(
      _tmp122 * (Scalar(1.0) * _tmp107 * (-_tmp112 * _tmp134 + _tmp128 * _tmp99) +
                 Scalar(1.0) * _tmp111 * (-_tmp112 * _tmp138 + _tmp137) +
                 Scalar(1.0) * _tmp117 * (-_tmp112 * _tmp139 + _tmp114 * _tmp128) +
                 Scalar(1.0) * _tmp118 * (-_tmp112 * _tmp136 - _tmp119 * _tmp128 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp124 * (_tmp128 * _tmp129 - _tmp128) +
                 Scalar(1.0) * _tmp130 * (-_tmp112 * _tmp131 + _tmp132)));
  const Scalar _tmp141 = Scalar(9.6622558468725703) * _tmp121;
  const Scalar _tmp142 = std::pow(Scalar(-_tmp66 + p_b(1, 0)), Scalar(2)) +
  ...
  const Scalar _tmp146 = _tmp101 * _tmp107 * _tmp74 + _tmp116 * _tmp117 * _tmp74 -
                         _tmp143 * _tmp144 - _tmp144 * _tmp145;
  const Scalar _tmp147 = Scalar(1.0) / (_tmp146);
  const Scalar _tmp148 = _tmp124 * _tmp128;
  const Scalar _tmp149 =
      std::asinh(_tmp147 * (_tmp107 * _tmp134 * _tmp81 + _tmp111 * _tmp138 * _tmp81 +
                            _tmp117 * _tmp139 * _tmp81 + _tmp118 * _tmp136 * _tmp81 -
                            _tmp129 * _tmp148 + _tmp130 * _tmp131 * _tmp81));
  const Scalar _tmp150 = Scalar(9.6622558468725703) * _tmp146;
  const Scalar _tmp151 = _tmp100 * _tmp107 + _tmp115 * _tmp117 + _tmp143 + _tmp145;
  const Scalar _tmp152 = Scalar(1.0) / (_tmp151);
  const Scalar _tmp153 = std::asinh(_tmp152 * (-_tmp107 * _tmp127 * _tmp99 - _tmp111 * _tmp137 -
                                               _tmp114 * _tmp117 * _tmp127 + _tmp118 * _tmp135 -
                                               _tmp130 * _tmp132 + _tmp148));
  const Scalar _tmp154 = Scalar(9.6622558468725703) * _tmp151;
  const Scalar _tmp155 = std::pow(Scalar(-_tmp52 + p_a(0, 0)), Scalar(2)) +
  ...
  _res(1, 0) =
      _tmp141 *
          (-std::sinh(Scalar(1.0) * _tmp140) -
           std::sinh(Scalar(0.1034955) * _tmp122 * (-_tmp140 * _tmp141 - std::sqrt(_tmp45)))) -
      std::sqrt(Scalar(_tmp45 + std::pow(Scalar(-_tmp38 + p_d(2, 0) - p_init2), Scalar(2))));
  _res(2, 0) =
      _tmp150 *
          (-std::sinh(Scalar(1.0) * _tmp149) -
           std::sinh(Scalar(0.1034955) * _tmp147 * (-std::sqrt(_tmp142) - _tmp149 * _tmp150))) -
      std::sqrt(Scalar(_tmp142 + std::pow(Scalar(-_tmp75 + p_b(2, 0) - p_init2), Scalar(2))));
  _res(3, 0) =
      _tmp154 *
          (-std::sinh(Scalar(1.0) * _tmp153) -
           std::sinh(Scalar(0.1034955) * _tmp152 * (-_tmp153 * _tmp154 - std::sqrt(_tmp155)))) -
      std::sqrt(Scalar(_tmp155 + std::pow(Scalar(-_tmp64 + p_a(2, 0) - p_init2), Scalar(2))));
