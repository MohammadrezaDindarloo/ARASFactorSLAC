...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl18(
  ...
  const Scalar _tmp46 = std::pow(Scalar(-_tmp42 + p_a(0, 0)), Scalar(2)) +
  ...
  const Scalar _tmp52 = _tmp26 + _tmp31;
  ...
  const Scalar _tmp61 = Scalar(1.0) / (_tmp59 + _tmp60);
  const Scalar _tmp62 = _tmp40 + _tmp48;
  const Scalar _tmp63 = _tmp57 - _tmp62;
  const Scalar _tmp64 = _tmp61 * _tmp63;
  const Scalar _tmp65 = _tmp57 + _tmp58 * _tmp64;
  const Scalar _tmp66 = 0;
  const Scalar _tmp67 = _tmp60 + p_init1;
  const Scalar _tmp68 = _tmp67 - p_b(1, 0);
  const Scalar _tmp69 = _tmp62 + p_init0;
  ...
  const Scalar _tmp73 = _tmp10 + _tmp13;
  const Scalar _tmp74 = _tmp38 + _tmp73;
  const Scalar _tmp75 = _tmp39 * _tmp72 - _tmp72 * _tmp74;
  const Scalar _tmp76 = _tmp45 - p_a(1, 0);
  const Scalar _tmp77 = _tmp42 - p_a(0, 0);
  const Scalar _tmp78 = Scalar(1.0) / (_tmp77);
  const Scalar _tmp79 = _tmp76 * _tmp78;
  const Scalar _tmp80 = _tmp54 * _tmp55;
  const Scalar _tmp81 = _tmp56 * _tmp79 - _tmp80;
  const Scalar _tmp82 = _tmp68 * _tmp71;
  const Scalar _tmp83 = Scalar(1.0) / (_tmp72 * _tmp79 - _tmp82);
  const Scalar _tmp84 = _tmp81 * _tmp83;
  const Scalar _tmp85 = _tmp39 * _tmp56;
  const Scalar _tmp86 = _tmp7 + _tmp73;
  const Scalar _tmp87 = _tmp39 * _tmp79;
  const Scalar _tmp88 = _tmp83 * (-_tmp72 * _tmp87 + _tmp74 * _tmp82);
  const Scalar _tmp89 = -_tmp79 * _tmp85 + _tmp80 * _tmp86 - _tmp81 * _tmp88;
  const Scalar _tmp90 = -_tmp56 * _tmp86 - _tmp64 * _tmp89 - _tmp75 * _tmp84 + _tmp85;
  const Scalar _tmp91 = Scalar(1.0) / (_tmp90);
  const Scalar _tmp92 = _tmp66 * _tmp91;
  const Scalar _tmp93 = _tmp72 * _tmp83;
  const Scalar _tmp94 = _tmp81 * _tmp91;
  ...
  const Scalar _tmp99 = _tmp97 * (_tmp41 * _tmp76 * _tmp98 - _tmp44 * _tmp77 * _tmp98);
  const Scalar _tmp100 = _tmp60 * _tmp72 - _tmp62 * _tmp82 + _tmp72 * _tmp99;
  const Scalar _tmp101 = _tmp79 * _tmp83;
  const Scalar _tmp102 = _tmp79 * _tmp88 + _tmp87;
  const Scalar _tmp103 = _tmp101 * _tmp75 - _tmp102 * _tmp64 - _tmp39;
  const Scalar _tmp104 = -_tmp100 * _tmp84 - _tmp49 * _tmp80 + _tmp52 * _tmp56 + _tmp56 * _tmp99;
  ...
  const Scalar _tmp110 = _tmp56 * _tmp91;
  const Scalar _tmp111 = -_tmp109 * _tmp94 - _tmp79;
  const Scalar _tmp112 = _tmp33 - p_d(1, 0);
  const Scalar _tmp113 = _tmp25 - p_d(0, 0);
  ...
  const Scalar _tmp119 = fh1 * (-_tmp115 * _tmp32 + _tmp118 * _tmp24);
  const Scalar _tmp120 = Scalar(1.0) * _tmp83;
  const Scalar _tmp121 = Scalar(1.0) * _tmp61;
  const Scalar _tmp122 = -_tmp120 * _tmp75 + _tmp121 * _tmp63 * _tmp88;
  const Scalar _tmp123 = _tmp107 * (-_tmp100 * _tmp120 - _tmp105 * _tmp122);
  const Scalar _tmp124 = _tmp122 + _tmp123;
  const Scalar _tmp125 = -_tmp124 * _tmp94 + Scalar(1.0);
  const Scalar _tmp126 = _tmp118 * fh1;
  const Scalar _tmp127 = -_tmp116 * _tmp97 * (_tmp109 * _tmp110 + _tmp111 * _tmp93 + Scalar(1.0)) -
                         _tmp119 * _tmp97 * (_tmp117 * _tmp56 - _tmp117 * _tmp72 * _tmp84) -
                         _tmp126 * _tmp97 * (_tmp110 * _tmp124 + _tmp125 * _tmp93) -
                         _tmp47 * _tmp97 * (_tmp56 * _tmp92 - _tmp93 * _tmp95);
  const Scalar _tmp128 = Scalar(1.0) / (_tmp127);
  const Scalar _tmp129 = _tmp52 + _tmp59;
  const Scalar _tmp130 = _tmp129 * _tmp64;
  const Scalar _tmp131 = Scalar(1.0) / (-_tmp130 - _tmp49 + _tmp57);
  const Scalar _tmp132 = Scalar(1.0) * _tmp131;
  const Scalar _tmp133 = _tmp130 * _tmp132 + Scalar(1.0);
  const Scalar _tmp134 = _tmp132 * _tmp64;
  const Scalar _tmp135 = _tmp15 * fh1;
  const Scalar _tmp136 = -_tmp118 * _tmp135 - Scalar(5.1796800000000003) * _tmp29 - _tmp32 * fv1;
  const Scalar _tmp137 = _tmp129 * _tmp132;
  const Scalar _tmp138 = _tmp115 * _tmp135 + Scalar(5.1796800000000003) * _tmp19 + _tmp24 * fv1;
  const Scalar _tmp139 = _tmp89 * _tmp91;
  const Scalar _tmp140 = _tmp129 * _tmp131;
  const Scalar _tmp141 = _tmp102 + _tmp108 * _tmp140 - _tmp109 * _tmp139;
  const Scalar _tmp142 = _tmp107 * _tmp132;
  const Scalar _tmp143 = _tmp107 * _tmp137 - _tmp117 * _tmp89;
  const Scalar _tmp144 = _tmp123 * _tmp140 - _tmp124 * _tmp139 - Scalar(1.0) * _tmp88;
  const Scalar _tmp145 = _tmp131 * _tmp65;
  const Scalar _tmp146 = -_tmp129 * _tmp145 - _tmp139 * _tmp66 + _tmp59;
  const Scalar _tmp147 = std::asinh(
      _tmp128 * (Scalar(1.0) * _tmp116 * (_tmp108 * _tmp132 - _tmp121 * _tmp141) +
                 Scalar(1.0) * _tmp119 * (-_tmp121 * _tmp143 + _tmp142) +
                 Scalar(1.0) * _tmp126 * (-_tmp121 * _tmp144 + _tmp123 * _tmp132) +
                 Scalar(1.0) * _tmp136 * (-_tmp121 * _tmp133 + _tmp134) +
                 Scalar(1.0) * _tmp138 * (-_tmp132 + _tmp137 * _tmp61) +
                 Scalar(1.0) * _tmp47 * (-_tmp121 * _tmp146 - _tmp132 * _tmp65 + Scalar(1.0))));
  const Scalar _tmp148 = Scalar(9.6622558468725703) * _tmp127;
  const Scalar _tmp149 = _tmp83 * fh1;
  const Scalar _tmp150 = _tmp117 * _tmp119;
  const Scalar _tmp151 = _tmp111 * _tmp115 * _tmp149 + _tmp118 * _tmp125 * _tmp149 -
                         _tmp150 * _tmp84 - _tmp47 * _tmp83 * _tmp95;
  const Scalar _tmp152 = Scalar(1.0) / (_tmp151);
  const Scalar _tmp153 = _tmp132 * _tmp138;
  const Scalar _tmp154 =
      std::asinh(_tmp152 * (_tmp116 * _tmp141 * _tmp61 + _tmp119 * _tmp143 * _tmp61 +
                            _tmp126 * _tmp144 * _tmp61 - _tmp129 * _tmp153 * _tmp61 +
                            _tmp133 * _tmp136 * _tmp61 + _tmp146 * _tmp47 * _tmp61));
  const Scalar _tmp155 = Scalar(9.6622558468725703) * _tmp151;
  const Scalar _tmp156 = std::pow(Scalar(-_tmp67 + p_b(1, 0)), Scalar(2)) +
                         std::pow(Scalar(-_tmp69 + p_b(0, 0)), Scalar(2));
  const Scalar _tmp157 = std::pow(Scalar(-_tmp50 + p_c(0, 0)), Scalar(2)) +
                         std::pow(Scalar(-_tmp53 + p_c(1, 0)), Scalar(2));
  const Scalar _tmp158 =
      _tmp109 * _tmp116 * _tmp91 + _tmp124 * _tmp126 * _tmp91 + _tmp150 + _tmp47 * _tmp92;
  const Scalar _tmp159 = Scalar(1.0) / (_tmp158);
  const Scalar _tmp160 = std::asinh(_tmp159 * (-_tmp108 * _tmp116 * _tmp131 - _tmp119 * _tmp142 -
                                               _tmp123 * _tmp126 * _tmp131 - _tmp134 * _tmp136 +
                                               _tmp145 * _tmp47 + _tmp153));
  ...
  _res(1, 0) =
      _tmp148 *
          (-std::sinh(Scalar(1.0) * _tmp147) -
           std::sinh(Scalar(0.1034955) * _tmp128 * (-_tmp147 * _tmp148 - std::sqrt(_tmp46)))) -
      std::sqrt(Scalar(_tmp46 + std::pow(Scalar(-_tmp39 + p_a(2, 0) - p_init2), Scalar(2))));
  _res(2, 0) =
      _tmp155 *
          (-std::sinh(Scalar(1.0) * _tmp154) -
           std::sinh(Scalar(0.1034955) * _tmp152 * (-_tmp154 * _tmp155 - std::sqrt(_tmp156)))) -
      std::sqrt(Scalar(_tmp156 + std::pow(Scalar(-_tmp74 + p_b(2, 0) - p_init2), Scalar(2))));
  _res(3, 0) =
      _tmp161 *
          (-std::sinh(Scalar(1.0) * _tmp160) -
           std::sinh(Scalar(0.1034955) * _tmp159 * (-std::sqrt(_tmp157) - _tmp160 * _tmp161))) -
      std::sqrt(Scalar(_tmp157 + std::pow(Scalar(-_tmp86 + p_c(2, 0) - p_init2), Scalar(2))));
