...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl23(
  ...
  const Scalar _tmp56 = Scalar(1.0) / (-_tmp39 + _tmp42 - _tmp55);
  ...
  const Scalar _tmp73 = _tmp72 * (_tmp41 * _tmp68 * _tmp70 - _tmp44 * _tmp66 * _tmp70);
  ...
  const Scalar _tmp78 = _tmp15 + _tmp7;
  const Scalar _tmp79 = _tmp11 - _tmp14;
  const Scalar _tmp80 = _tmp7 + _tmp79;
  const Scalar _tmp81 = _tmp75 * _tmp78;
  const Scalar _tmp82 = -_tmp63 * _tmp81 + _tmp64 * _tmp80;
  const Scalar _tmp83 = _tmp77 * _tmp82 + _tmp81;
  const Scalar _tmp84 = _tmp63 * _tmp78 - _tmp63 * _tmp80;
  const Scalar _tmp85 = -_tmp54 * _tmp83 + _tmp77 * _tmp84 - _tmp78;
  const Scalar _tmp86 = _tmp79 + _tmp8;
  const Scalar _tmp87 = _tmp39 + p_init0;
  ...
  const Scalar _tmp95 = _tmp75 * _tmp93 - _tmp92;
  const Scalar _tmp96 = _tmp76 * _tmp95;
  const Scalar _tmp97 = -_tmp75 * _tmp94 - _tmp82 * _tmp96 + _tmp86 * _tmp92;
  const Scalar _tmp98 = -_tmp54 * _tmp97 - _tmp84 * _tmp96 - _tmp86 * _tmp93 + _tmp94;
  const Scalar _tmp99 = Scalar(1.0) / (_tmp98);
  const Scalar _tmp100 = -_tmp39 * _tmp92 + _tmp48 * _tmp93 + _tmp73 * _tmp93 - _tmp74 * _tmp96;
  const Scalar _tmp101 = _tmp100 * _tmp99;
  const Scalar _tmp102 = Scalar(1.0) / (_tmp100);
  const Scalar _tmp103 = _tmp102 * _tmp98;
  const Scalar _tmp104 = _tmp103 * (-_tmp101 * _tmp85 - _tmp73 + _tmp74 * _tmp77);
  const Scalar _tmp105 = _tmp49 * _tmp56;
  const Scalar _tmp106 = _tmp99 * (_tmp104 + _tmp85);
  const Scalar _tmp107 = _tmp104 * _tmp105 - _tmp106 * _tmp97 + _tmp83;
  const Scalar _tmp108 = Scalar(1.0) * _tmp51;
  const Scalar _tmp109 = _tmp33 - p_d(1, 0);
  const Scalar _tmp110 = _tmp26 - p_d(0, 0);
  ...
  const Scalar _tmp114 = _tmp55 * _tmp57 + Scalar(1.0);
  const Scalar _tmp115 = _tmp54 * _tmp57;
  const Scalar _tmp116 = _tmp109 * _tmp111;
  const Scalar _tmp117 = _tmp16 * fh1;
  const Scalar _tmp118 = -_tmp116 * _tmp117 - Scalar(5.1796800000000003) * _tmp28 - _tmp32 * fv1;
  const Scalar _tmp119 = _tmp49 * _tmp51;
  const Scalar _tmp120 = _tmp112 * _tmp117 + Scalar(5.1796800000000003) * _tmp22 + _tmp25 * fv1;
  const Scalar _tmp121 = Scalar(1.0) * _tmp76;
  const Scalar _tmp122 = _tmp108 * _tmp53 * _tmp76 * _tmp82 - _tmp121 * _tmp84;
  const Scalar _tmp123 = _tmp103 * (-_tmp101 * _tmp122 - _tmp121 * _tmp74);
  const Scalar _tmp124 = _tmp99 * (_tmp122 + _tmp123);
  const Scalar _tmp125 = _tmp105 * _tmp123 - _tmp121 * _tmp82 - _tmp124 * _tmp97;
  const Scalar _tmp126 = _tmp116 * fh1;
  const Scalar _tmp127 = _tmp42 + _tmp45 * _tmp54;
  const Scalar _tmp128 = 0;
  const Scalar _tmp129 = _tmp127 * _tmp56;
  const Scalar _tmp130 = -_tmp128 * _tmp97 - _tmp129 * _tmp49 + _tmp46;
  const Scalar _tmp131 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp132 = Scalar(1.0) * _tmp102;
  const Scalar _tmp133 = _tmp103 * _tmp57;
  const Scalar _tmp134 = -_tmp132 * _tmp97 + _tmp133 * _tmp49;
  const Scalar _tmp135 = fh1 * (-_tmp112 * _tmp32 + _tmp116 * _tmp25);
  const Scalar _tmp136 = -_tmp124 * _tmp95 + Scalar(1.0);
  const Scalar _tmp137 = _tmp63 * _tmp76;
  const Scalar _tmp138 = _tmp102 * _tmp121 * _tmp95;
  const Scalar _tmp139 = -_tmp106 * _tmp95 - _tmp75;
  const Scalar _tmp140 = -_tmp113 * _tmp72 * (_tmp106 * _tmp93 + _tmp137 * _tmp139 + Scalar(1.0)) -
                         _tmp126 * _tmp72 * (_tmp124 * _tmp93 + _tmp136 * _tmp137) -
                         _tmp131 * _tmp72 * (-_tmp128 * _tmp63 * _tmp96 + _tmp128 * _tmp93) -
                         _tmp135 * _tmp72 * (_tmp132 * _tmp93 - _tmp138 * _tmp63);
  const Scalar _tmp141 = Scalar(1.0) / (_tmp140);
  const Scalar _tmp142 = std::asinh(
      _tmp141 * (Scalar(1.0) * _tmp113 * (_tmp104 * _tmp57 - _tmp107 * _tmp108) +
                 Scalar(1.0) * _tmp118 * (-_tmp108 * _tmp114 + _tmp115) +
                 Scalar(1.0) * _tmp120 * (_tmp119 * _tmp57 - _tmp57) +
                 Scalar(1.0) * _tmp126 * (-_tmp108 * _tmp125 + _tmp123 * _tmp57) +
                 Scalar(1.0) * _tmp131 * (-_tmp108 * _tmp130 - _tmp127 * _tmp57 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp135 * (-_tmp108 * _tmp134 + _tmp133)));
  const Scalar _tmp143 = Scalar(9.6622558468725703) * _tmp140;
  const Scalar _tmp144 = std::pow(Scalar(-_tmp65 + p_c(0, 0)), Scalar(2)) +
                         std::pow(Scalar(-_tmp67 + p_c(1, 0)), Scalar(2));
  const Scalar _tmp145 = std::pow(Scalar(-_tmp58 + p_b(1, 0)), Scalar(2)) +
                         std::pow(Scalar(-_tmp60 + p_b(0, 0)), Scalar(2));
  const Scalar _tmp146 = _tmp128 * _tmp131;
  const Scalar _tmp147 = _tmp113 * _tmp139 * _tmp76 + _tmp126 * _tmp136 * _tmp76 -
                         _tmp135 * _tmp138 - _tmp146 * _tmp96;
  const Scalar _tmp148 = Scalar(1.0) / (_tmp147);
  const Scalar _tmp149 = _tmp120 * _tmp57;
  const Scalar _tmp150 =
      std::asinh(_tmp148 * (_tmp107 * _tmp113 * _tmp51 + _tmp114 * _tmp118 * _tmp51 -
                            _tmp119 * _tmp149 + _tmp125 * _tmp126 * _tmp51 +
                            _tmp130 * _tmp131 * _tmp51 + _tmp134 * _tmp135 * _tmp51));
  const Scalar _tmp151 = Scalar(9.6622558468725703) * _tmp147;
  const Scalar _tmp152 = std::pow(Scalar(-_tmp87 + p_a(0, 0)), Scalar(2)) +
                         std::pow(Scalar(-_tmp89 + p_a(1, 0)), Scalar(2));
  const Scalar _tmp153 = _tmp106 * _tmp113 + _tmp124 * _tmp126 + _tmp132 * _tmp135 + _tmp146;
  const Scalar _tmp154 = Scalar(1.0) / (_tmp153);
  const Scalar _tmp155 = std::asinh(_tmp154 * (-_tmp104 * _tmp113 * _tmp56 - _tmp115 * _tmp118 -
                                               _tmp123 * _tmp126 * _tmp56 + _tmp129 * _tmp131 -
                                               _tmp133 * _tmp135 + _tmp149));
  ...
  _res(1, 0) =
      ...
      std::sqrt(Scalar(_tmp144 + std::pow(Scalar(-_tmp78 + p_c(2, 0) - p_init2), Scalar(2))));
  _res(2, 0) =
      _tmp151 *
          (-std::sinh(Scalar(1.0) * _tmp150) -
           std::sinh(Scalar(0.1034955) * _tmp148 * (-std::sqrt(_tmp145) - _tmp150 * _tmp151))) -
      std::sqrt(Scalar(_tmp145 + std::pow(Scalar(-_tmp80 + p_b(2, 0) - p_init2), Scalar(2))));
  _res(3, 0) =
      _tmp156 *
          (-std::sinh(Scalar(1.0) * _tmp155) -
           std::sinh(Scalar(0.1034955) * _tmp154 * (-std::sqrt(_tmp152) - _tmp155 * _tmp156))) -
      std::sqrt(Scalar(_tmp152 + std::pow(Scalar(-_tmp86 + p_a(2, 0) - p_init2), Scalar(2))));
