...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl3(
  ...
  const Scalar _tmp32 = _tmp3 - _tmp7;
  ...
  const Scalar _tmp75 = _tmp74 * (_tmp62 * _tmp73 + _tmp65 * _tmp73 - _tmp68 * _tmp72);
  const Scalar _tmp76 = _tmp42 * _tmp49 - _tmp45 * _tmp50 + _tmp49 * _tmp62 - _tmp64 * _tmp75;
  ...
  const Scalar _tmp81 = _tmp28 - p_a(0, 0);
  const Scalar _tmp82 = _tmp36 - p_a(1, 0);
  ...
  const Scalar _tmp86 = fh1 * (_tmp27 * _tmp84 - _tmp35 * _tmp85);
  const Scalar _tmp87 = _tmp12 + _tmp15;
  const Scalar _tmp88 = _tmp8 + _tmp87;
  const Scalar _tmp89 = _tmp49 * _tmp88;
  const Scalar _tmp90 = _tmp87 + _tmp9;
  const Scalar _tmp91 = _tmp73 * _tmp88;
  const Scalar _tmp92 = _tmp16 + _tmp8;
  const Scalar _tmp93 = _tmp74 * (-_tmp73 * _tmp92 + _tmp91);
  const Scalar _tmp94 = _tmp74 * (-_tmp63 * _tmp91 + _tmp72 * _tmp92);
  const Scalar _tmp95 = _tmp50 * _tmp90 - _tmp63 * _tmp89 - _tmp64 * _tmp94;
  const Scalar _tmp96 = Scalar(1.0) * _tmp55;
  const Scalar _tmp97 = -_tmp96;
  const Scalar _tmp98 = Scalar(1.0) / (_tmp65 + _tmp97);
  const Scalar _tmp99 = Scalar(1.0) * _tmp52;
  const Scalar _tmp100 = -_tmp68 + _tmp99;
  const Scalar _tmp101 = _tmp100 * _tmp98;
  const Scalar _tmp102 = -_tmp101 * _tmp95 - _tmp49 * _tmp90 - _tmp64 * _tmp93 + _tmp89;
  const Scalar _tmp103 = Scalar(1.0) / (_tmp102);
  const Scalar _tmp104 = _tmp63 * _tmp88 + _tmp63 * _tmp94;
  const Scalar _tmp105 = -_tmp101 * _tmp104 + _tmp63 * _tmp93 - _tmp88;
  const Scalar _tmp106 = _tmp103 * _tmp76;
  const Scalar _tmp107 = _tmp102 * _tmp77;
  const Scalar _tmp108 = _tmp107 * (-_tmp105 * _tmp106 - _tmp62 + _tmp63 * _tmp75);
  const Scalar _tmp109 = _tmp103 * (_tmp105 + _tmp108);
  const Scalar _tmp110 = -_tmp109 * _tmp64 - _tmp63;
  const Scalar _tmp111 = _tmp85 * fh1;
  const Scalar _tmp112 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp113 = _tmp101 * _tmp96 + _tmp99;
  const Scalar _tmp114 = 0;
  const Scalar _tmp115 = Scalar(1.0) * _tmp98;
  const Scalar _tmp116 = _tmp100 * _tmp115 * _tmp94 - Scalar(1.0) * _tmp93;
  const Scalar _tmp117 = _tmp107 * (-_tmp106 * _tmp116 - Scalar(1.0) * _tmp75);
  const Scalar _tmp118 = _tmp103 * (_tmp116 + _tmp117);
  const Scalar _tmp119 = -_tmp118 * _tmp64 + Scalar(1.0);
  const Scalar _tmp120 = _tmp84 * fh1;
  const Scalar _tmp121 = -_tmp111 * _tmp61 * (_tmp109 * _tmp49 + _tmp110 * _tmp79 + Scalar(1.0)) -
                         _tmp112 * _tmp61 * (_tmp114 * _tmp49 - _tmp114 * _tmp80) -
                         _tmp120 * _tmp61 * (_tmp118 * _tmp49 + _tmp119 * _tmp79) -
                         _tmp61 * _tmp86 * (_tmp49 * _tmp78 - _tmp78 * _tmp80);
  const Scalar _tmp122 = Scalar(1.0) / (_tmp121);
  const Scalar _tmp123 = _tmp42 + _tmp97;
  const Scalar _tmp124 = _tmp101 * _tmp123;
  const Scalar _tmp125 = Scalar(1.0) / (-_tmp124 - _tmp45 + _tmp99);
  const Scalar _tmp126 = Scalar(1.0) * _tmp125;
  const Scalar _tmp127 = _tmp113 * _tmp125;
  const Scalar _tmp128 = -_tmp114 * _tmp95 - _tmp123 * _tmp127 + _tmp97;
  const Scalar _tmp129 = _tmp17 * fh1;
  const Scalar _tmp130 = _tmp129 * _tmp85 + Scalar(5.1796800000000003) * _tmp21 + _tmp27 * fv1;
  const Scalar _tmp131 = _tmp123 * _tmp126;
  const Scalar _tmp132 = -_tmp129 * _tmp84 - Scalar(5.1796800000000003) * _tmp32 - _tmp35 * fv1;
  const Scalar _tmp133 = _tmp124 * _tmp126 + Scalar(1.0);
  const Scalar _tmp134 = _tmp101 * _tmp126;
  const Scalar _tmp135 = _tmp123 * _tmp125;
  const Scalar _tmp136 = _tmp117 * _tmp135 - _tmp118 * _tmp95 - Scalar(1.0) * _tmp94;
  const Scalar _tmp137 = _tmp104 + _tmp108 * _tmp135 - _tmp109 * _tmp95;
  const Scalar _tmp138 = _tmp107 * _tmp131 - _tmp78 * _tmp95;
  const Scalar _tmp139 = _tmp107 * _tmp126;
  const Scalar _tmp140 = std::asinh(
      _tmp122 * (Scalar(1.0) * _tmp111 * (_tmp108 * _tmp126 - _tmp115 * _tmp137) +
                 Scalar(1.0) * _tmp112 * (-_tmp113 * _tmp126 - _tmp115 * _tmp128 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp120 * (-_tmp115 * _tmp136 + _tmp117 * _tmp126) +
                 Scalar(1.0) * _tmp130 * (-_tmp126 + _tmp131 * _tmp98) +
                 Scalar(1.0) * _tmp132 * (-_tmp115 * _tmp133 + _tmp134) +
                 Scalar(1.0) * _tmp86 * (-_tmp115 * _tmp138 + _tmp139)));
  const Scalar _tmp141 = Scalar(9.6622558468725703) * _tmp121;
  const Scalar _tmp142 = std::pow(Scalar(-_tmp53 + p_c(0, 0)), Scalar(2)) +
                         std::pow(Scalar(-_tmp56 + p_c(1, 0)), Scalar(2));
  const Scalar _tmp143 = std::pow(Scalar(-_tmp66 + p_d(1, 0)), Scalar(2)) +
                         std::pow(Scalar(-_tmp69 + p_d(0, 0)), Scalar(2));
  const Scalar _tmp144 = _tmp78 * _tmp86;
  const Scalar _tmp145 = _tmp64 * _tmp74;
  const Scalar _tmp146 = _tmp112 * _tmp114;
  const Scalar _tmp147 = _tmp110 * _tmp111 * _tmp74 + _tmp119 * _tmp120 * _tmp74 -
                         _tmp144 * _tmp145 - _tmp145 * _tmp146;
  const Scalar _tmp148 = Scalar(1.0) / (_tmp147);
  const Scalar _tmp149 = _tmp126 * _tmp130;
  const Scalar _tmp150 =
      std::asinh(_tmp148 * (_tmp111 * _tmp137 * _tmp98 + _tmp112 * _tmp128 * _tmp98 +
                            _tmp120 * _tmp136 * _tmp98 - _tmp123 * _tmp149 * _tmp98 +
                            _tmp132 * _tmp133 * _tmp98 + _tmp138 * _tmp86 * _tmp98));
  const Scalar _tmp151 = Scalar(9.6622558468725703) * _tmp147;
  const Scalar _tmp152 = _tmp109 * _tmp111 + _tmp118 * _tmp120 + _tmp144 + _tmp146;
  const Scalar _tmp153 = Scalar(1.0) / (_tmp152);
  const Scalar _tmp154 = std::asinh(_tmp153 * (-_tmp108 * _tmp111 * _tmp125 + _tmp112 * _tmp127 -
                                               _tmp117 * _tmp120 * _tmp125 - _tmp132 * _tmp134 -
                                               _tmp139 * _tmp86 + _tmp149));
  ...
  _res(1, 0) =
      _tmp141 *
          (-std::sinh(Scalar(1.0) * _tmp140) -
           std::sinh(Scalar(0.1034955) * _tmp122 * (-_tmp140 * _tmp141 - std::sqrt(_tmp142)))) -
      std::sqrt(Scalar(_tmp142 + std::pow(Scalar(-_tmp88 + p_c(2, 0) - p_init2), Scalar(2))));
  _res(2, 0) =
      _tmp151 *
          (-std::sinh(Scalar(1.0) * _tmp150) -
           std::sinh(Scalar(0.1034955) * _tmp148 * (-std::sqrt(_tmp143) - _tmp150 * _tmp151))) -
      std::sqrt(Scalar(_tmp143 + std::pow(Scalar(-_tmp92 + p_d(2, 0) - p_init2), Scalar(2))));
  _res(3, 0) =
      _tmp155 *
          (-std::sinh(Scalar(1.0) * _tmp154) -
           std::sinh(Scalar(0.1034955) * _tmp153 * (-_tmp154 * _tmp155 - std::sqrt(_tmp156)))) -
      std::sqrt(Scalar(_tmp156 + std::pow(Scalar(-_tmp90 + p_b(2, 0) - p_init2), Scalar(2))));
