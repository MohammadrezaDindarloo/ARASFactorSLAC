...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl5(
  ...
  const Scalar _tmp44 = _tmp28 + _tmp33;
  const Scalar _tmp45 = _tmp44 + p_init1;
  const Scalar _tmp46 = std::pow(Scalar(-_tmp43 + p_d(0, 0)), Scalar(2)) +
  ...
  const Scalar _tmp51 = _tmp18 + _tmp25;
  ...
  const Scalar _tmp56 = _tmp45 - p_d(1, 0);
  const Scalar _tmp57 = _tmp43 - p_d(0, 0);
  const Scalar _tmp58 =
  ...
  const Scalar _tmp62 = _tmp61 * (_tmp42 * _tmp56 * _tmp59 - _tmp44 * _tmp57 * _tmp59);
  const Scalar _tmp63 = _tmp50 * _tmp54;
  const Scalar _tmp64 = _tmp18 + _tmp41;
  const Scalar _tmp65 = _tmp64 + p_init0;
  const Scalar _tmp66 = _tmp65 - p_c(0, 0);
  const Scalar _tmp67 = _tmp28 + _tmp47;
  ...
  const Scalar _tmp73 = _tmp62 * _tmp72 - _tmp64 * _tmp71 + _tmp67 * _tmp72;
  const Scalar _tmp74 = _tmp56 * _tmp60;
  const Scalar _tmp75 = Scalar(1.0) / (-_tmp71 + _tmp72 * _tmp74);
  const Scalar _tmp76 = _tmp55 * _tmp74 - _tmp63;
  const Scalar _tmp77 = _tmp75 * _tmp76;
  const Scalar _tmp78 = _tmp48 * _tmp55 - _tmp51 * _tmp63 + _tmp55 * _tmp62 - _tmp73 * _tmp77;
  ...
  const Scalar _tmp89 = _tmp40 * _tmp55;
  const Scalar _tmp90 = _tmp11 + _tmp14;
  const Scalar _tmp91 = _tmp8 + _tmp90;
  const Scalar _tmp92 = _tmp7 + _tmp90;
  const Scalar _tmp93 = _tmp40 * _tmp72;
  const Scalar _tmp94 = _tmp71 * _tmp92 - _tmp74 * _tmp93;
  const Scalar _tmp95 = _tmp63 * _tmp91 - _tmp74 * _tmp89 - _tmp77 * _tmp94;
  ...
  const Scalar _tmp102 = _tmp75 * (-_tmp72 * _tmp92 + _tmp93);
  const Scalar _tmp103 = -_tmp101 * _tmp95 - _tmp102 * _tmp76 - _tmp55 * _tmp91 + _tmp89;
  ...
  const Scalar _tmp108 = Scalar(1.0) * _tmp98;
  const Scalar _tmp109 = _tmp100 * _tmp108 * _tmp75 * _tmp94 - Scalar(1.0) * _tmp102;
  const Scalar _tmp110 = _tmp104 * _tmp78;
  const Scalar _tmp111 = _tmp103 * _tmp79;
  const Scalar _tmp112 = _tmp111 * (-_tmp107 * _tmp73 - _tmp109 * _tmp110);
  const Scalar _tmp113 = _tmp109 + _tmp112;
  const Scalar _tmp114 = _tmp104 * _tmp55;
  const Scalar _tmp115 = _tmp104 * _tmp76;
  const Scalar _tmp116 = -_tmp113 * _tmp115 + Scalar(1.0);
  const Scalar _tmp117 = _tmp72 * _tmp75;
  const Scalar _tmp118 = _tmp85 * fh1;
  const Scalar _tmp119 = _tmp74 * _tmp75;
  const Scalar _tmp120 = _tmp119 * _tmp94 + _tmp40 * _tmp74;
  const Scalar _tmp121 = -_tmp101 * _tmp120 + _tmp102 * _tmp74 - _tmp40;
  const Scalar _tmp122 = _tmp111 * (-_tmp110 * _tmp121 + _tmp119 * _tmp73 - _tmp62);
  const Scalar _tmp123 = _tmp121 + _tmp122;
  const Scalar _tmp124 = -_tmp115 * _tmp123 - _tmp74;
  const Scalar _tmp125 = _tmp86 * fh1;
  const Scalar _tmp126 = -_tmp118 * _tmp61 * (_tmp113 * _tmp114 + _tmp116 * _tmp117) -
                         _tmp125 * _tmp61 * (_tmp114 * _tmp123 + _tmp117 * _tmp124 + Scalar(1.0)) -
                         _tmp61 * _tmp87 * (_tmp55 * _tmp80 - _tmp80 * _tmp81) -
                         _tmp61 * _tmp88 * (_tmp106 * _tmp55 - _tmp106 * _tmp81);
  const Scalar _tmp127 = Scalar(1.0) / (_tmp126);
  const Scalar _tmp128 = _tmp48 + _tmp97;
  const Scalar _tmp129 = _tmp101 * _tmp128;
  const Scalar _tmp130 = Scalar(1.0) / (-_tmp129 - _tmp51 + _tmp99);
  const Scalar _tmp131 = _tmp105 * _tmp130;
  const Scalar _tmp132 = -_tmp106 * _tmp95 - _tmp128 * _tmp131 + _tmp97;
  const Scalar _tmp133 = Scalar(1.0) * _tmp130;
  const Scalar _tmp134 = _tmp104 * _tmp95;
  const Scalar _tmp135 = _tmp128 * _tmp130;
  const Scalar _tmp136 = _tmp120 + _tmp122 * _tmp135 - _tmp123 * _tmp134;
  const Scalar _tmp137 = _tmp111 * _tmp133;
  const Scalar _tmp138 = _tmp128 * _tmp137 - _tmp80 * _tmp95;
  const Scalar _tmp139 = _tmp16 * fh1;
  const Scalar _tmp140 = -_tmp139 * _tmp85 - Scalar(5.1796800000000003) * _tmp31 - _tmp34 * fv1;
  const Scalar _tmp141 = _tmp129 * _tmp133 + Scalar(1.0);
  const Scalar _tmp142 = _tmp101 * _tmp133;
  const Scalar _tmp143 = _tmp139 * _tmp86 + Scalar(5.1796800000000003) * _tmp20 + _tmp26 * fv1;
  const Scalar _tmp144 = _tmp128 * _tmp98;
  const Scalar _tmp145 = -_tmp107 * _tmp94 + _tmp112 * _tmp135 - _tmp113 * _tmp134;
  const Scalar _tmp146 = std::asinh(
      _tmp127 * (Scalar(1.0) * _tmp118 * (-_tmp108 * _tmp145 + _tmp112 * _tmp133) +
                 Scalar(1.0) * _tmp125 * (-_tmp108 * _tmp136 + _tmp122 * _tmp133) +
                 Scalar(1.0) * _tmp140 * (-_tmp108 * _tmp141 + _tmp142) +
                 Scalar(1.0) * _tmp143 * (_tmp133 * _tmp144 - _tmp133) +
                 Scalar(1.0) * _tmp87 * (-_tmp108 * _tmp138 + _tmp137) +
                 Scalar(1.0) * _tmp88 * (-_tmp105 * _tmp133 - _tmp108 * _tmp132 + Scalar(1.0))));
  const Scalar _tmp147 = Scalar(9.6622558468725703) * _tmp126;
  const Scalar _tmp148 = std::pow(Scalar(-_tmp65 + p_c(0, 0)), Scalar(2)) +
                         std::pow(Scalar(-_tmp68 + p_c(1, 0)), Scalar(2));
  const Scalar _tmp149 = _tmp106 * _tmp88;
  const Scalar _tmp150 = _tmp80 * _tmp87;
  const Scalar _tmp151 =
      _tmp116 * _tmp118 * _tmp75 + _tmp124 * _tmp125 * _tmp75 - _tmp149 * _tmp77 - _tmp150 * _tmp77;
  const Scalar _tmp152 = Scalar(1.0) / (_tmp151);
  const Scalar _tmp153 = _tmp133 * _tmp143;
  const Scalar _tmp154 =
      std::asinh(_tmp152 * (_tmp118 * _tmp145 * _tmp98 + _tmp125 * _tmp136 * _tmp98 +
                            _tmp132 * _tmp88 * _tmp98 + _tmp138 * _tmp87 * _tmp98 +
                            _tmp140 * _tmp141 * _tmp98 - _tmp144 * _tmp153));
  const Scalar _tmp155 = Scalar(9.6622558468725703) * _tmp151;
  const Scalar _tmp156 =
      _tmp104 * _tmp113 * _tmp118 + _tmp104 * _tmp123 * _tmp125 + _tmp149 + _tmp150;
  const Scalar _tmp157 = Scalar(1.0) / (_tmp156);
  const Scalar _tmp158 =
      std::asinh(_tmp157 * (-_tmp112 * _tmp118 * _tmp130 - _tmp122 * _tmp125 * _tmp130 +
                            _tmp131 * _tmp88 - _tmp137 * _tmp87 - _tmp140 * _tmp142 + _tmp153));
  const Scalar _tmp159 = Scalar(9.6622558468725703) * _tmp156;
  const Scalar _tmp160 = std::pow(Scalar(-_tmp49 + p_b(1, 0)), Scalar(2)) +
  ...
  _res(1, 0) =
      _tmp147 *
          (-std::sinh(Scalar(1.0) * _tmp146) -
           std::sinh(Scalar(0.1034955) * _tmp127 * (-_tmp146 * _tmp147 - std::sqrt(_tmp46)))) -
      std::sqrt(Scalar(_tmp46 + std::pow(Scalar(-_tmp40 + p_d(2, 0) - p_init2), Scalar(2))));
  _res(2, 0) =
      _tmp155 *
          (-std::sinh(Scalar(1.0) * _tmp154) -
           std::sinh(Scalar(0.1034955) * _tmp152 * (-std::sqrt(_tmp148) - _tmp154 * _tmp155))) -
      std::sqrt(Scalar(_tmp148 + std::pow(Scalar(-_tmp92 + p_c(2, 0) - p_init2), Scalar(2))));
  _res(3, 0) =
      _tmp159 *
          (-std::sinh(Scalar(1.0) * _tmp158) -
           std::sinh(Scalar(0.1034955) * _tmp157 * (-_tmp158 * _tmp159 - std::sqrt(_tmp160)))) -
      std::sqrt(Scalar(_tmp160 + std::pow(Scalar(-_tmp91 + p_b(2, 0) - p_init2), Scalar(2))));
