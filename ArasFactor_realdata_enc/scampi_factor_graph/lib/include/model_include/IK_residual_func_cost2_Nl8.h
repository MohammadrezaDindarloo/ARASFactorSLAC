...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl8(
  ...
  const Scalar _tmp28 = Scalar(0.20999999999999999) * _tmp11 + Scalar(0.20999999999999999) * _tmp18;
  const Scalar _tmp29 = -_tmp28;
  const Scalar _tmp30 = _tmp3 - _tmp7;
  ...
  const Scalar _tmp36 = std::pow(Scalar(-_tmp27 + p_b(0, 0)), Scalar(2)) +
                        std::pow(Scalar(-_tmp35 + p_b(1, 0)), Scalar(2));
  ...
  const Scalar _tmp52 = _tmp16 + _tmp8;
  ...
  const Scalar _tmp58 = _tmp21 + _tmp24;
  ...
  const Scalar _tmp85 = _tmp40 + _tmp8;
  const Scalar _tmp86 = _tmp78 * _tmp82;
  const Scalar _tmp87 = _tmp63 * _tmp83 - _tmp86;
  const Scalar _tmp88 = _tmp65 * _tmp87;
  const Scalar _tmp89 = -_tmp63 * _tmp84 - _tmp67 * _tmp88 + _tmp85 * _tmp86;
  const Scalar _tmp90 = -_tmp54 * _tmp88 - _tmp74 * _tmp89 - _tmp83 * _tmp85 + _tmp84;
  ...
  const Scalar _tmp94 = _tmp62 * _tmp92;
  const Scalar _tmp95 = _tmp94 * (-_tmp55 * _tmp61 * _tmp93 + _tmp57 * _tmp59 * _tmp93);
  const Scalar _tmp96 = -_tmp43 * _tmp64 + _tmp47 * _tmp51 + _tmp51 * _tmp95;
  ...
  const Scalar _tmp105 = -_tmp102 * _tmp104 - _tmp63;
  const Scalar _tmp106 = _tmp51 * _tmp65;
  const Scalar _tmp107 = _tmp35 - p_b(1, 0);
  ...
  const Scalar _tmp119 = fh1 * (-_tmp110 * _tmp34 + _tmp118 * _tmp26);
  const Scalar _tmp120 = Scalar(1.0) * _tmp71;
  const Scalar _tmp121 = Scalar(1.0) * _tmp65;
  const Scalar _tmp122 = _tmp120 * _tmp65 * _tmp67 * _tmp73 - _tmp121 * _tmp54;
  ...
  const Scalar _tmp127 = -_tmp111 * _tmp94 * (_tmp102 * _tmp103 + _tmp105 * _tmp106 + Scalar(1.0)) -
                         _tmp112 * _tmp94 * (-_tmp106 * _tmp115 + _tmp116 * _tmp83) -
                         _tmp119 * _tmp94 * (-_tmp117 * _tmp51 * _tmp88 + _tmp117 * _tmp83) -
                         _tmp126 * _tmp94 * (_tmp103 * _tmp124 + _tmp106 * _tmp125);
  const Scalar _tmp128 = Scalar(1.0) / (_tmp127);
  const Scalar _tmp129 = _tmp89 * _tmp91;
  const Scalar _tmp130 = _tmp70 + _tmp76;
  const Scalar _tmp131 = _tmp130 * _tmp74;
  const Scalar _tmp132 = Scalar(1.0) / (-_tmp131 + _tmp72 - _tmp79);
  ...
  const Scalar _tmp136 = _tmp113 * _tmp132;
  const Scalar _tmp137 = -_tmp114 * _tmp129 - _tmp130 * _tmp136 + _tmp70;
  const Scalar _tmp138 = _tmp100 * _tmp135;
  const Scalar _tmp139 = _tmp130 * _tmp135;
  const Scalar _tmp140 = _tmp100 * _tmp139 - _tmp117 * _tmp89;
  const Scalar _tmp141 = -_tmp121 * _tmp67 + _tmp123 * _tmp133 - _tmp124 * _tmp129;
  const Scalar _tmp142 = _tmp17 * fh1;
  const Scalar _tmp143 = _tmp110 * _tmp142 + Scalar(5.1796800000000003) * _tmp20 + _tmp26 * fv1;
  const Scalar _tmp144 = _tmp131 * _tmp135 + Scalar(1.0);
  const Scalar _tmp145 = -_tmp118 * _tmp142 - Scalar(5.1796800000000003) * _tmp30 - _tmp34 * fv1;
  const Scalar _tmp146 = std::asinh(
      _tmp128 * (Scalar(1.0) * _tmp111 * (_tmp101 * _tmp135 - _tmp120 * _tmp134) +
                 Scalar(1.0) * _tmp112 * (-_tmp113 * _tmp135 - _tmp120 * _tmp137 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp119 * (-_tmp120 * _tmp140 + _tmp138) +
                 Scalar(1.0) * _tmp126 * (-_tmp120 * _tmp141 + _tmp123 * _tmp135) +
                 Scalar(1.0) * _tmp143 * (-_tmp135 + _tmp139 * _tmp71) +
                 Scalar(1.0) * _tmp145 * (-_tmp120 * _tmp144 + _tmp135 * _tmp74)));
  const Scalar _tmp147 = Scalar(9.6622558468725703) * _tmp127;
  const Scalar _tmp148 = std::pow(Scalar(-_tmp56 + p_c(1, 0)), Scalar(2)) +
                         std::pow(Scalar(-_tmp60 + p_c(0, 0)), Scalar(2));
  const Scalar _tmp149 = _tmp145 * _tmp71;
  const Scalar _tmp150 = _tmp135 * _tmp143;
  const Scalar _tmp151 = _tmp117 * _tmp119;
  const Scalar _tmp152 = _tmp105 * _tmp111 * _tmp65 - _tmp112 * _tmp115 * _tmp65 +
                         _tmp125 * _tmp126 * _tmp65 - _tmp151 * _tmp88;
  const Scalar _tmp153 = Scalar(1.0) / (_tmp152);
  const Scalar _tmp154 =
      std::asinh(_tmp153 * (_tmp111 * _tmp134 * _tmp71 + _tmp112 * _tmp137 * _tmp71 +
                            _tmp119 * _tmp140 * _tmp71 + _tmp126 * _tmp141 * _tmp71 -
                            _tmp130 * _tmp150 * _tmp71 + _tmp144 * _tmp149));
  const Scalar _tmp155 = Scalar(9.6622558468725703) * _tmp152;
  const Scalar _tmp156 = std::pow(Scalar(-_tmp44 + p_a(0, 0)), Scalar(2)) +
                         std::pow(Scalar(-_tmp48 + p_a(1, 0)), Scalar(2));
  const Scalar _tmp157 = std::pow(Scalar(-_tmp77 + p_d(1, 0)), Scalar(2)) +
                         std::pow(Scalar(-_tmp80 + p_d(0, 0)), Scalar(2));
  const Scalar _tmp158 =
      _tmp102 * _tmp111 * _tmp91 + _tmp112 * _tmp116 + _tmp124 * _tmp126 * _tmp91 + _tmp151;
  const Scalar _tmp159 = Scalar(1.0) / (_tmp158);
  const Scalar _tmp160 =
      std::asinh(_tmp159 * (-_tmp101 * _tmp111 * _tmp132 + _tmp112 * _tmp136 - _tmp119 * _tmp138 -
                            _tmp123 * _tmp126 * _tmp132 - _tmp135 * _tmp149 * _tmp73 + _tmp150));
  ...
  _res(0, 0) =
      ...
      std::sqrt(Scalar(_tmp36 + std::pow(Scalar(-_tmp17 + p_b(2, 0) - p_init2), Scalar(2))));
  _res(1, 0) =
      _tmp147 *
          (-std::sinh(Scalar(1.0) * _tmp146) -
           std::sinh(Scalar(0.1034955) * _tmp128 * (-_tmp146 * _tmp147 - std::sqrt(_tmp148)))) -
      std::sqrt(Scalar(_tmp148 + std::pow(Scalar(-_tmp52 + p_c(2, 0) - p_init2), Scalar(2))));
  _res(2, 0) =
      _tmp155 *
          (-std::sinh(Scalar(1.0) * _tmp154) -
           std::sinh(Scalar(0.1034955) * _tmp153 * (-_tmp154 * _tmp155 - std::sqrt(_tmp156)))) -
      std::sqrt(Scalar(_tmp156 + std::pow(Scalar(-_tmp41 + p_a(2, 0) - p_init2), Scalar(2))));
  _res(3, 0) =
      _tmp161 *
          (-std::sinh(Scalar(1.0) * _tmp160) -
           std::sinh(Scalar(0.1034955) * _tmp159 * (-std::sqrt(_tmp157) - _tmp160 * _tmp161))) -
      std::sqrt(Scalar(_tmp157 + std::pow(Scalar(-_tmp85 + p_d(2, 0) - p_init2), Scalar(2))));
