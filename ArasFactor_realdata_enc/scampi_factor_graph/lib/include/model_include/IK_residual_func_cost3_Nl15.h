...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl15(
  ...
  const Scalar _tmp36 = _tmp35 - p_d(0, 0) + p_init0;
  ...
  const Scalar _tmp44 = (-_tmp35 + _tmp43) / (_tmp31 - _tmp42);
  ...
  const Scalar _tmp51 = _tmp47 + _tmp49 + _tmp50;
  const Scalar _tmp52 = _tmp47 - _tmp50;
  const Scalar _tmp53 = _tmp48 + _tmp52;
  const Scalar _tmp54 = -_tmp38 * _tmp51 + _tmp38 * _tmp53;
  const Scalar _tmp55 = _tmp25 + _tmp33;
  const Scalar _tmp56 = _tmp55 - p_a(0, 0) + p_init0;
  const Scalar _tmp57 = _tmp30 + _tmp6;
  ...
  const Scalar _tmp65 = _tmp29 * _tmp53;
  const Scalar _tmp66 = -_tmp38 * _tmp65 + _tmp39 * _tmp51;
  const Scalar _tmp67 = -_tmp44 * (-_tmp60 * _tmp65 + _tmp61 * _tmp64 - _tmp63 * _tmp66) +
                        _tmp53 * _tmp60 - _tmp54 * _tmp63 - _tmp60 * _tmp64;
  ...
  const Scalar _tmp76 = _tmp31 * _tmp38 - _tmp35 * _tmp39 + _tmp38 * _tmp75;
  const Scalar _tmp77 = Scalar(1.0) * _tmp40;
  const Scalar _tmp78 = _tmp44 * _tmp66 * _tmp77 - _tmp54 * _tmp77;
  const Scalar _tmp79 = -_tmp55 * _tmp61 + _tmp57 * _tmp60 + _tmp60 * _tmp75 - _tmp63 * _tmp76;
  ...
  _res(1, 0) = std::exp(_tmp0 * _tmp73 * (-_tmp41 * _tmp70 + _tmp60 * _tmp71) +
                        _tmp73 * _tmp99 * (-_tmp38 * _tmp63 * _tmp98 + _tmp60 * _tmp98) +
                        _tmp91 * _tmp92 * (_tmp41 * _tmp85 + _tmp83 * _tmp84) +
                        _tmp92 * _tmp97 * (_tmp41 * _tmp96 + _tmp84 * _tmp95 + Scalar(1.0)));
  _res(2, 0) = std::exp(_tmp0 * _tmp40 * _tmp70 + _tmp100 * _tmp63 - _tmp101 * _tmp85 * _tmp91 -
                        _tmp101 * _tmp96 * _tmp97);
  _res(3, 0) =
      std::exp(-_tmp0 * _tmp71 - _tmp100 - _tmp102 * _tmp83 * _tmp91 - _tmp102 * _tmp95 * _tmp97);
