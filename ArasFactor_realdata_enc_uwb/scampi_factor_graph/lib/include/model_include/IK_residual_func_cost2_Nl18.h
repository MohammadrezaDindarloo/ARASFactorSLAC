...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl18(
  ...
  const Scalar _tmp52 = _tmp28 + _tmp30;
  ...
  const Scalar _tmp70 = _tmp45 - p_a(1, 0);
  const Scalar _tmp71 = _tmp42 - p_a(0, 0);
  const Scalar _tmp72 = Scalar(1.0) / (_tmp71);
  const Scalar _tmp73 = _tmp70 * _tmp72;
  const Scalar _tmp74 = _tmp55 * _tmp56;
  const Scalar _tmp75 = _tmp57 * _tmp73 - _tmp74;
  const Scalar _tmp76 = _tmp60 * _tmp64;
  const Scalar _tmp77 = Scalar(1.0) / (_tmp65 * _tmp73 - _tmp76);
  const Scalar _tmp78 = _tmp75 * _tmp77;
  const Scalar _tmp79 = _tmp39 * _tmp57;
  const Scalar _tmp80 = _tmp67 + _tmp8;
  const Scalar _tmp81 = -_tmp66 * _tmp73 + _tmp68 * _tmp76;
  const Scalar _tmp82 = -_tmp73 * _tmp79 + _tmp74 * _tmp80 - _tmp78 * _tmp81;
  ...
  const Scalar _tmp88 = -_tmp57 * _tmp80 - _tmp69 * _tmp78 + _tmp79 - _tmp82 * _tmp87;
  ...
  const Scalar _tmp97 = _tmp95 * (_tmp41 * _tmp70 * _tmp96 - _tmp44 * _tmp71 * _tmp96);
  const Scalar _tmp98 = _tmp58 * _tmp65 - _tmp61 * _tmp76 + _tmp65 * _tmp97;
  const Scalar _tmp99 = _tmp73 * _tmp77;
  const Scalar _tmp100 = _tmp39 * _tmp73 + _tmp81 * _tmp99;
  const Scalar _tmp101 = -_tmp100 * _tmp87 - _tmp39 + _tmp69 * _tmp99;
  const Scalar _tmp102 = -_tmp49 * _tmp74 + _tmp53 * _tmp57 + _tmp57 * _tmp97 - _tmp78 * _tmp98;
  ...
  const Scalar _tmp108 = _tmp57 * _tmp89;
  const Scalar _tmp109 = _tmp75 * _tmp89;
  const Scalar _tmp110 = -_tmp107 * _tmp109 - _tmp73;
  const Scalar _tmp111 = _tmp65 * _tmp77;
  const Scalar _tmp112 = _tmp33 - p_d(1, 0);
  const Scalar _tmp113 = _tmp26 - p_d(0, 0);
  ...
  const Scalar _tmp119 = fh1 * (-_tmp115 * _tmp32 + _tmp118 * _tmp25);
  const Scalar _tmp120 = Scalar(1.0) * _tmp77;
  const Scalar _tmp121 = _tmp120 * _tmp81;
  const Scalar _tmp122 = -_tmp120 * _tmp69 + _tmp121 * _tmp87;
  ...
  const Scalar _tmp127 = -_tmp116 * _tmp95 * (_tmp107 * _tmp108 + _tmp110 * _tmp111 + Scalar(1.0)) -
                         _tmp119 * _tmp95 * (_tmp117 * _tmp57 - _tmp117 * _tmp93) -
                         _tmp126 * _tmp95 * (_tmp108 * _tmp124 + _tmp111 * _tmp125) -
                         _tmp47 * _tmp95 * (_tmp57 * _tmp92 - _tmp92 * _tmp93);
  const Scalar _tmp128 = Scalar(1.0) / (_tmp127);
  const Scalar _tmp129 = _tmp53 + _tmp84;
  const Scalar _tmp130 = _tmp129 * _tmp87;
  const Scalar _tmp131 = Scalar(1.0) / (-_tmp130 - _tmp49 + _tmp86);
  ...
  const Scalar _tmp135 = _tmp132 * _tmp87;
  const Scalar _tmp136 = _tmp16 * fh1;
  const Scalar _tmp137 = -_tmp118 * _tmp136 - Scalar(3.29616) * _tmp29 - _tmp32 * fv1;
  const Scalar _tmp138 = _tmp129 * _tmp85;
  const Scalar _tmp139 = _tmp115 * _tmp136 + Scalar(3.29616) * _tmp22 + _tmp25 * fv1;
  const Scalar _tmp140 = _tmp82 * _tmp89;
  const Scalar _tmp141 = _tmp129 * _tmp131;
  const Scalar _tmp142 = _tmp100 + _tmp106 * _tmp141 - _tmp107 * _tmp140;
  const Scalar _tmp143 = _tmp105 * _tmp132;
  const Scalar _tmp144 = -_tmp117 * _tmp82 + _tmp129 * _tmp143;
  const Scalar _tmp145 = -_tmp121 + _tmp123 * _tmp141 - _tmp124 * _tmp140;
  const Scalar _tmp146 = _tmp131 * _tmp90;
  const Scalar _tmp147 = -_tmp129 * _tmp146 - _tmp140 * _tmp91 + _tmp84;
  const Scalar _tmp148 = std::asinh(
      _tmp128 * (Scalar(1.0) * _tmp116 * (_tmp106 * _tmp132 - _tmp134 * _tmp142) +
                 Scalar(1.0) * _tmp119 * (-_tmp134 * _tmp144 + _tmp143) +
                 Scalar(1.0) * _tmp126 * (_tmp123 * _tmp132 - _tmp134 * _tmp145) +
                 Scalar(1.0) * _tmp137 * (-_tmp133 * _tmp134 + _tmp135) +
                 Scalar(1.0) * _tmp139 * (_tmp132 * _tmp138 - _tmp132) +
                 Scalar(1.0) * _tmp47 * (-_tmp132 * _tmp90 - _tmp134 * _tmp147 + Scalar(1.0))));
  const Scalar _tmp149 = Scalar(9.6622558468725703) * _tmp127;
  const Scalar _tmp150 = std::pow(Scalar(-_tmp59 + p_b(1, 0)), Scalar(2)) +
                         std::pow(Scalar(-_tmp62 + p_b(0, 0)), Scalar(2));
  const Scalar _tmp151 = _tmp117 * _tmp119;
  const Scalar _tmp152 = _tmp47 * _tmp92;
  const Scalar _tmp153 =
      _tmp110 * _tmp116 * _tmp77 + _tmp125 * _tmp126 * _tmp77 - _tmp151 * _tmp78 - _tmp152 * _tmp78;
  const Scalar _tmp154 = Scalar(1.0) / (_tmp153);
  const Scalar _tmp155 = _tmp85 * fh1;
  const Scalar _tmp156 = _tmp132 * _tmp139;
  const Scalar _tmp157 =
      std::asinh(_tmp154 * (_tmp115 * _tmp142 * _tmp155 + _tmp118 * _tmp145 * _tmp155 +
                            _tmp119 * _tmp144 * _tmp85 + _tmp133 * _tmp137 * _tmp85 -
                            _tmp138 * _tmp156 + _tmp147 * _tmp47 * _tmp85));
  const Scalar _tmp158 = Scalar(9.6622558468725703) * _tmp153;
  const Scalar _tmp159 = std::pow(Scalar(-_tmp50 + p_c(0, 0)), Scalar(2)) +
                         std::pow(Scalar(-_tmp54 + p_c(1, 0)), Scalar(2));
  const Scalar _tmp160 =
      _tmp107 * _tmp116 * _tmp89 + _tmp124 * _tmp126 * _tmp89 + _tmp151 + _tmp152;
  const Scalar _tmp161 = Scalar(1.0) / (_tmp160);
  const Scalar _tmp162 = std::asinh(_tmp161 * (-_tmp106 * _tmp116 * _tmp131 - _tmp119 * _tmp143 -
                                               _tmp123 * _tmp126 * _tmp131 - _tmp135 * _tmp137 +
                                               _tmp146 * _tmp47 + _tmp156));
  ...
  _res(1, 0) =
      _tmp149 *
          (-std::sinh(Scalar(1.0) * _tmp148) -
           std::sinh(Scalar(0.1034955) * _tmp128 * (-_tmp148 * _tmp149 - std::sqrt(_tmp46)))) -
      std::sqrt(Scalar(_tmp46 + std::pow(Scalar(-_tmp39 + p_a(2, 0) - p_init2), Scalar(2))));
  _res(2, 0) =
      _tmp158 *
          (-std::sinh(Scalar(1.0) * _tmp157) -
           std::sinh(Scalar(0.1034955) * _tmp154 * (-std::sqrt(_tmp150) - _tmp157 * _tmp158))) -
      std::sqrt(Scalar(_tmp150 + std::pow(Scalar(-_tmp68 + p_b(2, 0) - p_init2), Scalar(2))));
  _res(3, 0) =
      _tmp163 *
          (-std::sinh(Scalar(1.0) * _tmp162) -
           std::sinh(Scalar(0.1034955) * _tmp161 * (-std::sqrt(_tmp159) - _tmp162 * _tmp163))) -
      std::sqrt(Scalar(_tmp159 + std::pow(Scalar(-_tmp80 + p_c(2, 0) - p_init2), Scalar(2))));
