...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl22(
  ...
  const Scalar _tmp12 = _tmp1 * _tmp7;
  ...
  const Scalar _tmp37 = -_tmp11 + _tmp35;
  ...
  const Scalar _tmp75 = _tmp73 * (-_tmp49 * _tmp52 * _tmp74 + _tmp50 * _tmp51 * _tmp74);
  const Scalar _tmp76 = _tmp54 * _tmp58;
  const Scalar _tmp77 = -_tmp15 + _tmp47 * _tmp76 - _tmp63 * (_tmp15 * _tmp54 + _tmp60 * _tmp76);
  const Scalar _tmp78 = -_tmp39 * _tmp57 + _tmp42 * _tmp45 + _tmp45 * _tmp75;
  const Scalar _tmp79 = _tmp23 * _tmp33 - _tmp30 * _tmp55 + _tmp33 * _tmp75 - _tmp59 * _tmp78;
  const Scalar _tmp80 = _tmp65 * _tmp79;
  const Scalar _tmp81 = Scalar(1.0) / (_tmp79);
  const Scalar _tmp82 = _tmp64 * _tmp81;
  const Scalar _tmp83 = _tmp77 + _tmp82 * (-_tmp75 + _tmp76 * _tmp78 - _tmp77 * _tmp80);
  const Scalar _tmp84 = _tmp33 * _tmp65;
  const Scalar _tmp85 = -_tmp54 - _tmp70 * _tmp83;
  const Scalar _tmp86 = _tmp41 + _tmp48;
  const Scalar _tmp87 = _tmp86 - p_d(1, 0) + p_init1;
  const Scalar _tmp88 = _tmp25 + _tmp38;
  ...
  const Scalar _tmp97 = -_tmp47 * _tmp96 + _tmp60 * _tmp63 * _tmp96;
  const Scalar _tmp98 = _tmp82 * (-_tmp78 * _tmp96 - _tmp80 * _tmp97) + _tmp97;
  const Scalar _tmp99 = -_tmp70 * _tmp98 + Scalar(1.0);
  ...
  _res(1, 0) = std::exp(_tmp0 * _tmp73 * (_tmp33 * _tmp68 - _tmp69 * _tmp71) +
                        _tmp100 * _tmp73 * (_tmp69 * _tmp99 + _tmp84 * _tmp98) +
                        _tmp73 * _tmp92 * (_tmp69 * _tmp85 + _tmp83 * _tmp84 + Scalar(1.0)) +
                        _tmp73 * _tmp95 * (_tmp33 * _tmp93 - _tmp45 * _tmp59 * _tmp93));
  _res(2, 0) = std::exp(_tmp0 * _tmp58 * _tmp71 - _tmp100 * _tmp58 * _tmp99 + _tmp101 * _tmp59 -
                        _tmp58 * _tmp85 * _tmp92);
  _res(3, 0) =
      std::exp(-_tmp0 * _tmp68 - _tmp100 * _tmp65 * _tmp98 - _tmp101 - _tmp65 * _tmp83 * _tmp92);
