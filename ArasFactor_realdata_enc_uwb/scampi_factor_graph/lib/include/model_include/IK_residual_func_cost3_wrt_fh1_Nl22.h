...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl22(
  ...
  const Scalar _tmp39 = _tmp32 - _tmp33 + _tmp37;
  ...
  const Scalar _tmp45 = _tmp44 - p_a(1, 0) + p_init1;
  ...
  const Scalar _tmp54 = _tmp53 - p_c(0, 0) + p_init0;
  const Scalar _tmp55 = Scalar(1.0) / (_tmp54);
  const Scalar _tmp56 = _tmp52 * _tmp55;
  const Scalar _tmp57 = _tmp18 * _tmp29;
  const Scalar _tmp58 = _tmp30 * _tmp56 - _tmp57;
  const Scalar _tmp59 = _tmp45 * _tmp46;
  const Scalar _tmp60 = Scalar(1.0) / (_tmp47 * _tmp56 - _tmp59);
  const Scalar _tmp61 = _tmp58 * _tmp60;
  const Scalar _tmp62 = _tmp39 * _tmp59 - _tmp48 * _tmp56;
  const Scalar _tmp63 = Scalar(1.0) * _tmp51;
  const Scalar _tmp64 = Scalar(1.0) * _tmp53;
  const Scalar _tmp65 = (-_tmp41 + _tmp64) / (_tmp44 - _tmp63);
  const Scalar _tmp66 = -_tmp30 * _tmp38 + _tmp36 - _tmp49 * _tmp61 -
                        _tmp65 * (-_tmp36 * _tmp56 + _tmp38 * _tmp57 - _tmp61 * _tmp62);
  ...
  const Scalar _tmp71 = _tmp58 * _tmp67;
  ...
  const Scalar _tmp76 = _tmp74 * (-_tmp51 * _tmp54 * _tmp75 + _tmp52 * _tmp53 * _tmp75);
  const Scalar _tmp77 = _tmp56 * _tmp60;
  const Scalar _tmp78 = -_tmp35 + _tmp49 * _tmp77 - _tmp65 * (_tmp35 * _tmp56 + _tmp62 * _tmp77);
  const Scalar _tmp79 = -_tmp41 * _tmp59 + _tmp44 * _tmp47 + _tmp47 * _tmp76;
  const Scalar _tmp80 = _tmp17 * _tmp30 - _tmp27 * _tmp57 + _tmp30 * _tmp76 - _tmp61 * _tmp79;
  ...
  const Scalar _tmp85 = _tmp30 * _tmp67;
  const Scalar _tmp86 = _tmp60 * (-_tmp56 - _tmp71 * _tmp84);
  const Scalar _tmp87 = _tmp43 + _tmp50;
  const Scalar _tmp88 = _tmp87 - p_d(1, 0) + p_init1;
  const Scalar _tmp89 = _tmp19 + _tmp40;
  ...
  const Scalar _tmp93 = _tmp74 * _tmp92 * (_tmp47 * _tmp86 + _tmp84 * _tmp85 + Scalar(1.0));
  const Scalar _tmp94 = _tmp88 * _tmp91;
  const Scalar _tmp95 = -_tmp87 * _tmp92 + _tmp89 * _tmp94;
  const Scalar _tmp96 = Scalar(1.0) * _tmp82;
  const Scalar _tmp97 = _tmp74 * _tmp95 * (_tmp30 * _tmp96 - _tmp47 * _tmp61 * _tmp96);
  const Scalar _tmp98 = Scalar(1.0) * _tmp60;
  const Scalar _tmp99 = -_tmp49 * _tmp98 + _tmp62 * _tmp65 * _tmp98;
  const Scalar _tmp100 = _tmp83 * (-_tmp79 * _tmp98 - _tmp81 * _tmp99) + _tmp99;
  const Scalar _tmp101 = _tmp60 * (-_tmp100 * _tmp71 + Scalar(1.0));
  const Scalar _tmp102 = _tmp74 * _tmp94 * (_tmp100 * _tmp85 + _tmp101 * _tmp47);
  ...
  const Scalar _tmp107 = _tmp67 * _tmp84 * _tmp92;
  const Scalar _tmp108 = _tmp100 * _tmp67 * _tmp94;
  ...
  _res(1, 0) = -(-_tmp102 - _tmp93 - _tmp97) *
               std::exp(_tmp0 * _tmp74 * (_tmp30 * _tmp70 - _tmp47 * _tmp72) + _tmp102 * fh1 +
