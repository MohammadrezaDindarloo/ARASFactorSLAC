...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl17(
  ...
  const Scalar _tmp44 = _tmp39 * (_tmp30 * _tmp37 - _tmp34 * _tmp38 + _tmp37 * _tmp43);
  const Scalar _tmp45 = -Scalar(0.010999999999999999) * _tmp1 -
                        Scalar(0.010999999999999999) * _tmp21 + Scalar(-0.010999999999999999);
  const Scalar _tmp46 = Scalar(0.20999999999999999) * _tmp18 - Scalar(0.20999999999999999) * _tmp19;
  ...
  const Scalar _tmp53 = _tmp39 * (-_tmp37 * _tmp52 + _tmp50);
  const Scalar _tmp54 = _tmp39 * (-_tmp27 * _tmp50 + _tmp38 * _tmp52);
  const Scalar _tmp55 = Scalar(1.0) * _tmp15;
  const Scalar _tmp56 = Scalar(1.0) * _tmp24;
  const Scalar _tmp57 = (-_tmp34 + _tmp56) / (_tmp30 - _tmp55);
  const Scalar _tmp58 = _tmp27 * _tmp53 - _tmp49 - _tmp57 * (_tmp27 * _tmp49 + _tmp27 * _tmp54);
  const Scalar _tmp59 = _tmp23 + _tmp32;
  const Scalar _tmp60 = _tmp59 - p_a(0, 0) + p_init0;
  const Scalar _tmp61 = _tmp14 + _tmp28;
  ...
  const Scalar _tmp68 = _tmp27 * _tmp64 - _tmp67;
  const Scalar _tmp69 = -_tmp53 * _tmp68 -
                        _tmp57 * (-_tmp27 * _tmp65 - _tmp54 * _tmp68 + _tmp66 * _tmp67) -
                        _tmp64 * _tmp66 + _tmp65;
  const Scalar _tmp70 = Scalar(1.0) / (_tmp69);
  const Scalar _tmp71 = _tmp43 * _tmp64 - _tmp44 * _tmp68 - _tmp59 * _tmp67 + _tmp61 * _tmp64;
  const Scalar _tmp72 = _tmp70 * _tmp71;
  const Scalar _tmp73 = Scalar(1.0) / (_tmp71);
  const Scalar _tmp74 = _tmp69 * _tmp73;
  const Scalar _tmp75 = _tmp58 + _tmp74 * (_tmp27 * _tmp44 - _tmp43 - _tmp58 * _tmp72);
  const Scalar _tmp76 = _tmp68 * _tmp70;
  const Scalar _tmp77 = -_tmp27 - _tmp75 * _tmp76;
  const Scalar _tmp78 = _tmp37 * _tmp39;
  const Scalar _tmp79 = _tmp64 * _tmp70;
  const Scalar _tmp80 = _tmp17 + _tmp33;
  const Scalar _tmp81 = _tmp80 - p_c(0, 0) + p_init0;
  const Scalar _tmp82 = _tmp29 + _tmp4;
  ...
  const Scalar _tmp88 = _tmp68 * _tmp78;
  const Scalar _tmp89 = _tmp83 * _tmp84;
  const Scalar _tmp90 = fh1 * (_tmp80 * _tmp89 - _tmp82 * _tmp85);
  const Scalar _tmp91 = -Scalar(1.0) * _tmp53 + Scalar(1.0) * _tmp54 * _tmp57;
  const Scalar _tmp92 = _tmp74 * (-Scalar(1.0) * _tmp44 - _tmp72 * _tmp91) + _tmp91;
  const Scalar _tmp93 = -_tmp76 * _tmp92 + Scalar(1.0);
  const Scalar _tmp94 = _tmp89 * fh1;
  const Scalar _tmp95 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp96 = _tmp55 * _tmp57 + _tmp56;
  const Scalar _tmp97 = 0;
  const Scalar _tmp98 = _tmp42 * (_tmp64 * _tmp97 - _tmp88 * _tmp97);
  const Scalar _tmp99 = _tmp95 * _tmp97;
  const Scalar _tmp100 = _tmp39 * _tmp68;
  const Scalar _tmp101 = _tmp87 * _tmp90;
  ...
  _res(0, 0) = 0;
  _res(1, 0) =
      -_tmp98 * std::exp(_tmp42 * _tmp86 * (_tmp75 * _tmp79 + _tmp77 * _tmp78 + Scalar(1.0)) +
                         _tmp42 * _tmp90 * (_tmp64 * _tmp87 - _tmp87 * _tmp88) +
                         _tmp42 * _tmp94 * (_tmp78 * _tmp93 + _tmp79 * _tmp92) + _tmp95 * _tmp98);
  _res(2, 0) = -_tmp100 * _tmp97 *
               std::exp(_tmp100 * _tmp101 + _tmp100 * _tmp99 - _tmp39 * _tmp77 * _tmp86 -
                        _tmp39 * _tmp93 * _tmp94);
  _res(3, 0) =
      _tmp97 * std::exp(-_tmp101 - _tmp70 * _tmp75 * _tmp86 - _tmp70 * _tmp92 * _tmp94 - _tmp99);
