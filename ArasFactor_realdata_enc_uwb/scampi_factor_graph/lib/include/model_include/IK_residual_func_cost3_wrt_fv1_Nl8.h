...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl8(
  ...
  const Scalar _tmp61 = _tmp14 + _tmp7;
  const Scalar _tmp62 = _tmp55 * _tmp58;
  const Scalar _tmp63 = _tmp45 * _tmp59 - _tmp62;
  const Scalar _tmp64 = _tmp47 * _tmp63;
  const Scalar _tmp65 = -_tmp37 * _tmp64 -
                        _tmp52 * (-_tmp45 * _tmp60 - _tmp49 * _tmp64 + _tmp61 * _tmp62) -
  ...
  const Scalar _tmp69 = _tmp44 * _tmp67;
  const Scalar _tmp70 = _tmp69 * (-_tmp39 * _tmp43 * _tmp68 + _tmp40 * _tmp42 * _tmp68);
  const Scalar _tmp71 = -_tmp24 * _tmp46 + _tmp31 * _tmp34 + _tmp34 * _tmp70;
  const Scalar _tmp72 = _tmp54 * _tmp59 - _tmp56 * _tmp62 + _tmp59 * _tmp70 - _tmp64 * _tmp71;
  ...
  const Scalar _tmp79 = -_tmp45 - _tmp76 * _tmp78;
  ...
  const Scalar _tmp93 = _tmp69 * (_tmp59 * _tmp92 - _tmp80 * _tmp91);
  const Scalar _tmp94 = Scalar(1.0) * _tmp74;
  const Scalar _tmp95 = _tmp82 * _tmp85;
  const Scalar _tmp96 = fh1 * (-_tmp81 * _tmp86 + _tmp83 * _tmp95);
  const Scalar _tmp97 = Scalar(1.0) * _tmp47;
  const Scalar _tmp98 = -_tmp37 * _tmp97 + _tmp49 * _tmp52 * _tmp97;
  const Scalar _tmp99 = _tmp75 * (-_tmp71 * _tmp97 - _tmp73 * _tmp98) + _tmp98;
  const Scalar _tmp100 = -_tmp78 * _tmp99 + Scalar(1.0);
  const Scalar _tmp101 = _tmp47 * _tmp91;
  ...
  _res(0, 0) = 0;
  _res(1, 0) =
      -_tmp93 * std::exp(_tmp69 * _tmp96 * (-_tmp34 * _tmp64 * _tmp94 + _tmp59 * _tmp94) +
                         _tmp86 * _tmp87 * (_tmp76 * _tmp77 + _tmp79 * _tmp80 + Scalar(1.0)) +
                         _tmp87 * _tmp95 * (_tmp100 * _tmp80 + _tmp77 * _tmp99) + _tmp88 * _tmp93);
  _res(2, 0) = -_tmp101 * std::exp(-_tmp100 * _tmp103 * _tmp95 + _tmp101 * _tmp88 +
                                   _tmp102 * _tmp64 - _tmp103 * _tmp79 * _tmp86);
  _res(3, 0) = _tmp92 * std::exp(-_tmp102 - _tmp104 * _tmp76 * _tmp86 - _tmp104 * _tmp95 * _tmp99 -
                                 _tmp88 * _tmp92);
