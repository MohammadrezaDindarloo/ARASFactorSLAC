...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl8(
  ...
  const Scalar _tmp74 = _tmp47 * _tmp64 - _tmp62 - _tmp67 * _tmp73;
  ...
  const Scalar _tmp83 = _tmp33 + _tmp60;
  const Scalar _tmp84 = _tmp77 * _tmp81;
  const Scalar _tmp85 = _tmp47 * _tmp82 - _tmp84;
  const Scalar _tmp86 = -_tmp65 * _tmp85 - _tmp66 * _tmp82 + _tmp83 * _tmp84;
  const Scalar _tmp87 = _tmp62 * _tmp82 - _tmp64 * _tmp85 - _tmp73 * _tmp86 - _tmp82 * _tmp83;
  ...
  const Scalar _tmp92 = _tmp91 * (-_tmp40 * _tmp45 * _tmp90 + _tmp42 * _tmp43 * _tmp90);
  const Scalar _tmp93 = _tmp59 * (-_tmp49 * _tmp58 + _tmp53 * _tmp57 + _tmp57 * _tmp92);
  const Scalar _tmp94 = _tmp75 * _tmp82 - _tmp78 * _tmp84 + _tmp82 * _tmp92 - _tmp85 * _tmp93;
  const Scalar _tmp95 = _tmp88 * _tmp94;
  const Scalar _tmp96 = Scalar(1.0) / (_tmp94);
  const Scalar _tmp97 = _tmp87 * _tmp96;
  const Scalar _tmp98 = _tmp97 * (_tmp47 * _tmp93 - _tmp74 * _tmp95 - _tmp92);
  const Scalar _tmp99 = _tmp74 + _tmp98;
  const Scalar _tmp100 = _tmp82 * _tmp88;
  const Scalar _tmp101 = _tmp85 * _tmp88;
  const Scalar _tmp102 = -_tmp101 * _tmp99 - _tmp47;
  ...
  const Scalar _tmp110 = _tmp68 * _tmp73 + _tmp71;
  const Scalar _tmp111 = 0;
  const Scalar _tmp112 = _tmp103 * _tmp85;
  const Scalar _tmp113 = Scalar(1.0) * _tmp96;
  const Scalar _tmp114 = _tmp104 * _tmp106;
  const Scalar _tmp115 = fh1 * (-_tmp107 * _tmp30 + _tmp114 * _tmp20);
  const Scalar _tmp116 = Scalar(1.0) * _tmp70;
  const Scalar _tmp117 = _tmp116 * _tmp65 * _tmp72 - Scalar(1.0) * _tmp64;
  const Scalar _tmp118 = _tmp97 * (-_tmp117 * _tmp95 - Scalar(1.0) * _tmp93);
  const Scalar _tmp119 = _tmp117 + _tmp118;
  const Scalar _tmp120 = -_tmp101 * _tmp119 + Scalar(1.0);
  const Scalar _tmp121 = _tmp114 * fh1;
  const Scalar _tmp122 = -_tmp108 * _tmp91 * (_tmp100 * _tmp99 + _tmp102 * _tmp103 + Scalar(1.0)) -
                         _tmp109 * _tmp91 * (-_tmp111 * _tmp112 + _tmp111 * _tmp82) -
                         _tmp115 * _tmp91 * (-_tmp112 * _tmp113 + _tmp113 * _tmp82) -
                         _tmp121 * _tmp91 * (_tmp100 * _tmp119 + _tmp103 * _tmp120);
  const Scalar _tmp123 = Scalar(1.0) / (_tmp122);
  const Scalar _tmp124 = _tmp86 * _tmp88;
  const Scalar _tmp125 = _tmp69 + _tmp75;
  const Scalar _tmp126 = _tmp125 * _tmp73;
  const Scalar _tmp127 = Scalar(1.0) / (-_tmp126 + _tmp71 - _tmp78);
  const Scalar _tmp128 = _tmp125 * _tmp127;
  const Scalar _tmp129 = -_tmp124 * _tmp99 + _tmp128 * _tmp98 + _tmp67;
  const Scalar _tmp130 = Scalar(1.0) * _tmp127;
  const Scalar _tmp131 = _tmp110 * _tmp127;
  const Scalar _tmp132 = -_tmp111 * _tmp86 - _tmp125 * _tmp131 + _tmp69;
  const Scalar _tmp133 = _tmp130 * _tmp97;
  const Scalar _tmp134 = _tmp125 * _tmp130;
  const Scalar _tmp135 = -_tmp113 * _tmp86 + _tmp134 * _tmp97;
  const Scalar _tmp136 = _tmp118 * _tmp128 - _tmp119 * _tmp124 - Scalar(1.0) * _tmp65;
  const Scalar _tmp137 = _tmp38 * fh1;
  const Scalar _tmp138 = _tmp107 * _tmp137 + Scalar(3.29616) * _tmp14 + _tmp20 * fv1;
  const Scalar _tmp139 = _tmp130 * _tmp73;
  const Scalar _tmp140 = _tmp126 * _tmp130 + Scalar(1.0);
  const Scalar _tmp141 = -_tmp114 * _tmp137 - Scalar(3.29616) * _tmp27 - _tmp30 * fv1;
  const Scalar _tmp142 = std::asinh(
      _tmp123 * (Scalar(1.0) * _tmp108 * (-_tmp116 * _tmp129 + _tmp130 * _tmp98) +
                 Scalar(1.0) * _tmp109 * (-_tmp110 * _tmp130 - _tmp116 * _tmp132 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp115 * (-_tmp116 * _tmp135 + _tmp133) +
                 Scalar(1.0) * _tmp121 * (-_tmp116 * _tmp136 + _tmp118 * _tmp130) +
                 Scalar(1.0) * _tmp138 * (-_tmp130 + _tmp134 * _tmp70) +
                 Scalar(1.0) * _tmp141 * (-_tmp116 * _tmp140 + _tmp139)));
  const Scalar _tmp143 = Scalar(0.1034955) * _tmp123;
  const Scalar _tmp144 = Scalar(9.6622558468725703) * _tmp122;
  const Scalar _tmp145 = _tmp130 * _tmp138;
  const Scalar _tmp146 = _tmp109 * _tmp111;
  const Scalar _tmp147 = _tmp59 * _tmp85;
  const Scalar _tmp148 = _tmp113 * _tmp115;
  const Scalar _tmp149 = _tmp102 * _tmp108 * _tmp59 + _tmp120 * _tmp121 * _tmp59 -
                         _tmp146 * _tmp147 - _tmp147 * _tmp148;
  const Scalar _tmp150 = Scalar(1.0) / (_tmp149);
  const Scalar _tmp151 =
      std::asinh(_tmp150 * (_tmp108 * _tmp129 * _tmp70 + _tmp109 * _tmp132 * _tmp70 +
                            _tmp115 * _tmp135 * _tmp70 + _tmp121 * _tmp136 * _tmp70 -
                            _tmp125 * _tmp145 * _tmp70 + _tmp140 * _tmp141 * _tmp70));
  const Scalar _tmp152 = Scalar(9.6622558468725703) * _tmp149;
  const Scalar _tmp153 = Scalar(0.1034955) * _tmp150;
  const Scalar _tmp154 = _tmp108 * _tmp88 * _tmp99 + _tmp119 * _tmp121 * _tmp88 + _tmp146 + _tmp148;
  const Scalar _tmp155 = Scalar(1.0) / (_tmp154);
  const Scalar _tmp156 =
      std::asinh(_tmp155 * (-_tmp108 * _tmp127 * _tmp98 + _tmp109 * _tmp131 - _tmp115 * _tmp133 -
                            _tmp118 * _tmp121 * _tmp127 - _tmp139 * _tmp141 + _tmp145));
  ...
  _res(1, 0) =
      -_tmp144 *
          (_tmp143 * p_c(2, 0) + std::cosh(Scalar(1.0) * _tmp142) -
           std::cosh(_tmp143 *
                     (-_tmp142 * _tmp144 -
  ...
  _res(3, 0) =
      -_tmp157 *
          (_tmp158 * p_d(2, 0) + std::cosh(Scalar(1.0) * _tmp156) -
           std::cosh(_tmp158 *
                     (-_tmp156 * _tmp157 -
                      std::sqrt(Scalar(std::pow(Scalar(-_tmp76 + p_d(1, 0)), Scalar(2)) +
