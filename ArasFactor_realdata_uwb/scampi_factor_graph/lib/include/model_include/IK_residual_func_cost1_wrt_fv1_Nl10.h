...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1WrtFv1Nl10(
  ...
  const Scalar _tmp57 = -Scalar(0.010999999999999999) * _tmp11 -
                        Scalar(0.010999999999999999) * _tmp22 + Scalar(-0.010999999999999999);
  const Scalar _tmp58 = Scalar(0.20999999999999999) * _tmp15 - Scalar(0.20999999999999999) * _tmp16;
  ...
  const Scalar _tmp66 = _tmp10 + _tmp35;
  const Scalar _tmp67 = _tmp66 + p_init0;
  const Scalar _tmp68 = _tmp67 - p_a(0, 0);
  const Scalar _tmp69 = _tmp24 + _tmp30 + _tmp38;
  ...
  const Scalar _tmp75 = _tmp45 * _tmp62;
  ...
  const Scalar _tmp83 = Scalar(1.0) * _tmp36;
  const Scalar _tmp84 = _tmp82 * (-_tmp66 + _tmp83);
  const Scalar _tmp85 = _tmp62 * _tmp74 - _tmp65 * _tmp74;
  const Scalar _tmp86 = -_tmp54 * _tmp60 + _tmp63 - _tmp78 * _tmp85 - _tmp79 * _tmp84;
  ...
  const Scalar _tmp91 = _tmp90 * (_tmp36 * _tmp42 * _tmp89 - _tmp40 * _tmp43 * _tmp89);
  const Scalar _tmp92 = -_tmp66 * _tmp73 + _tmp69 * _tmp74 + _tmp74 * _tmp91;
  const Scalar _tmp93 = _tmp45 * _tmp77;
  const Scalar _tmp94 = _tmp75 + _tmp76 * _tmp93;
  const Scalar _tmp95 = -_tmp62 - _tmp84 * _tmp94 + _tmp85 * _tmp93;
  const Scalar _tmp96 = -_tmp46 * _tmp53 + _tmp49 * _tmp54 + _tmp54 * _tmp91 - _tmp78 * _tmp92;
  ...
  const Scalar _tmp104 = _tmp33 - p_b(1, 0);
  const Scalar _tmp105 = _tmp21 - p_b(0, 0);
  ...
  const Scalar _tmp112 = _tmp99 * (-_tmp109 * _tmp92 - _tmp111 * _tmp97);
  const Scalar _tmp113 = _tmp111 + _tmp112;
  const Scalar _tmp114 = _tmp113 * _tmp87;
  const Scalar _tmp115 = -_tmp114 * _tmp55 + Scalar(1.0);
  const Scalar _tmp116 = _tmp104 * _tmp106;
  const Scalar _tmp117 = _tmp116 * fh1;
  const Scalar _tmp118 = Scalar(1.0) * _tmp98;
  const Scalar _tmp119 = _tmp109 * _tmp55 * _tmp98;
  const Scalar _tmp120 = fh1 * (-_tmp107 * _tmp32 + _tmp116 * _tmp20);
  const Scalar _tmp121 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp122 = _tmp80 * _tmp84 + _tmp83;
  const Scalar _tmp123 = 0;
  const Scalar _tmp124 = _tmp123 * _tmp87;
  const Scalar _tmp125 = _tmp124 * _tmp78;
  const Scalar _tmp126 = _tmp90 * (_tmp124 * _tmp54 - _tmp125 * _tmp74);
  const Scalar _tmp127 = -_tmp108 * _tmp90 * (_tmp101 * _tmp54 + _tmp102 * _tmp103 + Scalar(1.0)) -
                         _tmp117 * _tmp90 * (_tmp103 * _tmp115 + _tmp114 * _tmp54) -
                         _tmp120 * _tmp90 * (_tmp118 * _tmp54 - _tmp119 * _tmp74) -
                         _tmp121 * _tmp126;
  const Scalar _tmp128 = Scalar(1.0) / (_tmp127);
  const Scalar _tmp129 = _tmp49 + _tmp81;
  const Scalar _tmp130 = _tmp129 * _tmp84;
  const Scalar _tmp131 = Scalar(1.0) / (-_tmp130 - _tmp46 + _tmp83);
  const Scalar _tmp132 = _tmp122 * _tmp131;
  const Scalar _tmp133 = _tmp79 * _tmp87;
  const Scalar _tmp134 = _tmp82 * (-_tmp123 * _tmp133 - _tmp129 * _tmp132 + _tmp81);
  const Scalar _tmp135 = -Scalar(1.0) * _tmp132 - Scalar(1.0) * _tmp134 + Scalar(1.0);
  const Scalar _tmp136 = fh1 * (_tmp59 + _tmp64);
  const Scalar _tmp137 = _tmp107 * _tmp136 + Scalar(3.29616) * _tmp17 + _tmp20 * fv1;
  const Scalar _tmp138 = Scalar(1.0) * _tmp131;
  const Scalar _tmp139 = _tmp129 * _tmp82;
  const Scalar _tmp140 = Scalar(1.0) * _tmp138 * _tmp139 - Scalar(1.0) * _tmp138;
  const Scalar _tmp141 = _tmp138 * _tmp99;
  const Scalar _tmp142 = -_tmp118 * _tmp79 + _tmp129 * _tmp141;
  const Scalar _tmp143 = Scalar(1.0) * _tmp82;
  const Scalar _tmp144 = -_tmp116 * _tmp136 - Scalar(3.29616) * _tmp28 - _tmp32 * fv1;
  const Scalar _tmp145 = _tmp138 * _tmp84;
  const Scalar _tmp146 = _tmp130 * _tmp138 + Scalar(1.0);
  const Scalar _tmp147 = -Scalar(1.0) * _tmp143 * _tmp146 + Scalar(1.0) * _tmp145;
  const Scalar _tmp148 = _tmp129 * _tmp131;
  const Scalar _tmp149 = -_tmp110 + _tmp112 * _tmp148 - _tmp113 * _tmp133;
  const Scalar _tmp150 = _tmp100 * _tmp148 - _tmp101 * _tmp79 + _tmp94;
  const Scalar _tmp151 = Scalar(1.0) * _tmp108 * (_tmp100 * _tmp138 - _tmp143 * _tmp150) +
                         Scalar(1.0) * _tmp117 * (_tmp112 * _tmp138 - _tmp143 * _tmp149) +
                         Scalar(1.0) * _tmp120 * (_tmp141 - _tmp142 * _tmp143) + _tmp121 * _tmp135 +
                         _tmp137 * _tmp140 + _tmp144 * _tmp147;
  ...
  const Scalar _tmp161 = _tmp29 + _tmp39;
  const Scalar _tmp162 =
      (_tmp128 * (-_tmp135 + _tmp140 * _tmp20 + _tmp147 * _tmp161) - _tmp151 * _tmp160) /
  ...
  const Scalar _tmp165 = _tmp102 * _tmp108 * _tmp77 + _tmp115 * _tmp117 * _tmp77 -
                         _tmp119 * _tmp120 - _tmp164 * _tmp78;
  const Scalar _tmp166 = Scalar(1.0) / (_tmp165);
  const Scalar _tmp167 = Scalar(0.1034955) * _tmp166;
  const Scalar _tmp168 = _tmp137 * _tmp138;
  const Scalar _tmp169 = _tmp146 * _tmp82;
  const Scalar _tmp170 = _tmp108 * _tmp150 * _tmp82 + _tmp117 * _tmp149 * _tmp82 +
                         _tmp120 * _tmp142 * _tmp82 + _tmp121 * _tmp134 - _tmp139 * _tmp168 +
                         _tmp144 * _tmp169;
  const Scalar _tmp171 = std::asinh(_tmp166 * _tmp170);
  const Scalar _tmp172 = Scalar(9.6622558468725703) * _tmp165;
  const Scalar _tmp173 =
      -_tmp171 * _tmp172 - std::sqrt(Scalar(std::pow(Scalar(-_tmp67 + p_a(0, 0)), Scalar(2)) +
                                            std::pow(Scalar(-_tmp70 + p_a(1, 0)), Scalar(2))));
  const Scalar _tmp174 = _tmp167 * _tmp173;
  const Scalar _tmp175 = Scalar(1.0) * _tmp171;
  const Scalar _tmp176 = Scalar(9.6622558468725703) * _tmp124;
  const Scalar _tmp177 = _tmp176 * _tmp78;
  const Scalar _tmp178 = std::pow(_tmp165, Scalar(-2));
  const Scalar _tmp179 = _tmp125 * _tmp178;
  const Scalar _tmp180 = _tmp138 * _tmp20;
  const Scalar _tmp181 =
      (_tmp166 * (-_tmp134 - _tmp139 * _tmp180 + _tmp161 * _tmp169) - _tmp170 * _tmp179) /
      std::sqrt(Scalar(std::pow(_tmp170, Scalar(2)) * _tmp178 + 1));
  const Scalar _tmp182 = Scalar(0.1034955) * _tmp179;
  const Scalar _tmp183 = _tmp101 * _tmp108 + _tmp114 * _tmp117 + _tmp118 * _tmp120 + _tmp164;
  const Scalar _tmp184 = Scalar(1.0) / (_tmp183);
  const Scalar _tmp185 = -_tmp100 * _tmp108 * _tmp131 - _tmp112 * _tmp117 * _tmp131 -
                         _tmp120 * _tmp141 + _tmp121 * _tmp132 - _tmp144 * _tmp145 + _tmp168;
  ...
  const Scalar _tmp189 =
      -_tmp186 * _tmp188 - std::sqrt(Scalar(std::pow(Scalar(-_tmp47 + p_c(0, 0)), Scalar(2)) +
  ...
  const Scalar _tmp195 = (_tmp184 * (-_tmp132 - _tmp145 * _tmp161 + _tmp180) + _tmp185 * _tmp193) /
  ...
  _res(1, 0) =
      -_tmp153 * (Scalar(1.0) * _tmp162 * std::sinh(_tmp157) - _tmp163 * p_d(2, 0) -
  ...
  _res(3, 0) = _tmp176 * (_tmp190 * p_c(2, 0) + std::cosh(_tmp187) - std::cosh(_tmp191)) -
