...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl19(
  ...
  const Scalar _tmp18 = _tmp17 - p_b(1, 0) + p_init1;
  ...
  const Scalar _tmp28 = _tmp27 - p_b(0, 0) + p_init0;
  ...
  const Scalar _tmp43 = _tmp42 - p_a(0, 0) + p_init0;
  const Scalar _tmp44 = Scalar(1.0) / (_tmp43);
  const Scalar _tmp45 = _tmp40 * _tmp44;
  const Scalar _tmp46 = _tmp18 * _tmp29;
  const Scalar _tmp47 = _tmp30 * _tmp45 - _tmp46;
  const Scalar _tmp48 = _tmp19 + _tmp26;
  const Scalar _tmp49 = _tmp48 - p_c(0, 0) + p_init0;
  const Scalar _tmp50 = _tmp12 + _tmp15;
  const Scalar _tmp51 = _tmp50 + _tmp9;
  const Scalar _tmp52 = _tmp51 - p_c(1, 0) + p_init1;
  ...
  const Scalar _tmp58 = _tmp31 + _tmp32 + _tmp33;
  const Scalar _tmp59 = _tmp56 * (-_tmp45 * _tmp57 + _tmp55 * _tmp58);
  const Scalar _tmp60 = Scalar(1.0) * _tmp39;
  const Scalar _tmp61 = Scalar(1.0) * _tmp42;
  const Scalar _tmp62 = (-_tmp48 + _tmp61) / (_tmp51 - _tmp60);
  const Scalar _tmp63 = _tmp56 * (-_tmp54 * _tmp58 + _tmp57);
  const Scalar _tmp64 = -_tmp30 * _tmp37 + _tmp36 - _tmp47 * _tmp63 -
                        _tmp62 * (-_tmp36 * _tmp45 + _tmp37 * _tmp46 - _tmp47 * _tmp59);
  const Scalar _tmp65 = Scalar(1.0) / (_tmp64);
  const Scalar _tmp66 = _tmp60 * _tmp62 + _tmp61;
  const Scalar _tmp67 = 0;
  const Scalar _tmp68 = _tmp47 * _tmp56;
  ...
  const Scalar _tmp72 = _tmp38 + _tmp50;
  const Scalar _tmp73 = _tmp72 - p_d(1, 0) + p_init1;
  const Scalar _tmp74 = _tmp19 + _tmp41;
  const Scalar _tmp75 = _tmp74 - p_d(0, 0) + p_init0;
  ...
  const Scalar _tmp79 = -_tmp72 * _tmp77 + _tmp74 * _tmp78;
  const Scalar _tmp80 = Scalar(1.0) / (_tmp70);
  const Scalar _tmp81 = _tmp71 * (-_tmp39 * _tmp43 * _tmp80 + _tmp40 * _tmp42 * _tmp80);
  const Scalar _tmp82 = _tmp56 * (-_tmp48 * _tmp55 + _tmp51 * _tmp54 + _tmp54 * _tmp81);
  const Scalar _tmp83 = _tmp17 * _tmp30 - _tmp27 * _tmp46 + _tmp30 * _tmp81 - _tmp47 * _tmp82;
  const Scalar _tmp84 = Scalar(1.0) / (_tmp83);
  const Scalar _tmp85 = Scalar(1.0) * _tmp84;
  const Scalar _tmp86 = _tmp71 * _tmp79 * (_tmp30 * _tmp85 - _tmp69 * _tmp85);
  const Scalar _tmp87 = Scalar(1.0) * _tmp59 * _tmp62 - Scalar(1.0) * _tmp63;
  const Scalar _tmp88 = _tmp65 * _tmp83;
  const Scalar _tmp89 = _tmp64 * _tmp84;
  const Scalar _tmp90 = _tmp87 + _tmp89 * (-Scalar(1.0) * _tmp82 - _tmp87 * _tmp88);
  const Scalar _tmp91 = _tmp65 * _tmp90;
  const Scalar _tmp92 = _tmp47 * _tmp65;
  const Scalar _tmp93 = _tmp56 * (-_tmp90 * _tmp92 + Scalar(1.0));
  const Scalar _tmp94 = _tmp71 * _tmp78 * (_tmp30 * _tmp91 + _tmp54 * _tmp93);
  const Scalar _tmp95 = -_tmp35 + _tmp45 * _tmp63 - _tmp62 * (_tmp35 * _tmp45 + _tmp45 * _tmp59);
  const Scalar _tmp96 = _tmp89 * (_tmp45 * _tmp82 - _tmp81 - _tmp88 * _tmp95) + _tmp95;
  const Scalar _tmp97 = _tmp65 * _tmp96;
  const Scalar _tmp98 = _tmp56 * (-_tmp45 - _tmp92 * _tmp96);
  const Scalar _tmp99 = _tmp71 * _tmp77 * (_tmp30 * _tmp97 + _tmp54 * _tmp98 + Scalar(1.0));
  const Scalar _tmp100 = _tmp79 * _tmp85;
  const Scalar _tmp101 = _tmp100 * fh1;
  const Scalar _tmp102 = _tmp78 * _tmp93;
  const Scalar _tmp103 = _tmp77 * _tmp98;
  const Scalar _tmp104 = _tmp0 * _tmp67;
  const Scalar _tmp105 = _tmp78 * _tmp91;
  const Scalar _tmp106 = _tmp77 * _tmp97;
  ...
  _res(1, 0) =
      -(-_tmp86 - _tmp94 - _tmp99) * std::exp(_tmp0 * _tmp71 * (_tmp30 * _tmp67 - _tmp67 * _tmp69) +
                                              _tmp86 * fh1 + _tmp94 * fh1 + _tmp99 * fh1);
  _res(2, 0) = -(-_tmp100 * _tmp68 + _tmp102 + _tmp103) *
               std::exp(_tmp101 * _tmp68 - _tmp102 * fh1 - _tmp103 * fh1 + _tmp104 * _tmp68);
  _res(3, 0) =
