...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl5(
  ...
  const Scalar _tmp50 = _tmp4 + _tmp41;
  ...
  const Scalar _tmp57 = _tmp48 * _tmp56 - _tmp50 * _tmp55 + _tmp52 * _tmp56;
  const Scalar _tmp58 = _tmp40 * _tmp46;
  const Scalar _tmp59 = Scalar(1.0) / (-_tmp55 + _tmp56 * _tmp58);
  const Scalar _tmp60 = _tmp37 * _tmp58 - _tmp49;
  const Scalar _tmp61 = _tmp59 * _tmp60;
  const Scalar _tmp62 = _tmp32 * _tmp37 - _tmp34 * _tmp49 + _tmp37 * _tmp48 - _tmp57 * _tmp61;
  ...
  const Scalar _tmp77 = _tmp55 * _tmp75 - _tmp58 * _tmp76;
  ...
  const Scalar _tmp81 = -_tmp56 * _tmp75 + _tmp76;
  const Scalar _tmp82 = -_tmp37 * _tmp74 - _tmp61 * _tmp81 + _tmp73 -
                        _tmp80 * (_tmp49 * _tmp74 - _tmp58 * _tmp73 - _tmp61 * _tmp77);
  ...
  const Scalar _tmp87 = _tmp77 * _tmp80 * _tmp86 - _tmp81 * _tmp86;
  const Scalar _tmp88 = _tmp62 * _tmp83;
  const Scalar _tmp89 = _tmp63 * _tmp82;
  const Scalar _tmp90 = _tmp87 + _tmp89 * (-_tmp57 * _tmp86 - _tmp87 * _tmp88);
  const Scalar _tmp91 = _tmp83 * _tmp90;
  const Scalar _tmp92 = _tmp60 * _tmp83;
  const Scalar _tmp93 = -_tmp90 * _tmp92 + Scalar(1.0);
  const Scalar _tmp94 = _tmp56 * _tmp59;
  const Scalar _tmp95 = _tmp29 * _tmp47 * (_tmp37 * _tmp91 + _tmp93 * _tmp94);
  const Scalar _tmp96 = _tmp58 * _tmp59;
  const Scalar _tmp97 = -_tmp72 - _tmp80 * (_tmp58 * _tmp72 + _tmp77 * _tmp96) + _tmp81 * _tmp96;
  const Scalar _tmp98 = _tmp89 * (-_tmp48 + _tmp57 * _tmp96 - _tmp88 * _tmp97) + _tmp97;
  const Scalar _tmp99 = _tmp83 * _tmp98;
  const Scalar _tmp100 = -_tmp58 - _tmp92 * _tmp98;
  const Scalar _tmp101 = _tmp30 * _tmp47 * (_tmp100 * _tmp94 + _tmp37 * _tmp99 + Scalar(1.0));
  const Scalar _tmp102 = _tmp67 * _tmp85;
  const Scalar _tmp103 = _tmp100 * _tmp30 * _tmp59;
  const Scalar _tmp104 = _tmp29 * _tmp59 * _tmp93;
  const Scalar _tmp105 = _tmp31 * _tmp64;
  const Scalar _tmp106 = _tmp105 * fh1;
  const Scalar _tmp107 = _tmp29 * _tmp91;
  ...
  _res(1, 0) = -(-_tmp101 - _tmp66 - _tmp95) *
               std::exp(_tmp101 * fh1 + _tmp47 * _tmp67 * (_tmp37 * _tmp85 - _tmp65 * _tmp85) +
                        _tmp66 * fh1 + _tmp95 * fh1);
  _res(2, 0) = -(_tmp103 + _tmp104 - _tmp105 * _tmp61) *
               std::exp(_tmp102 * _tmp61 - _tmp103 * fh1 - _tmp104 * fh1 + _tmp106 * _tmp61);
  _res(3, 0) =
