...
Eigen::Matrix<Scalar, 4, 1> FkResidualFuncCost3WrtFv1(
  ...
  const Scalar _tmp19 = 2 * _tmp1 * _tmp3;
  ...
  const Scalar _tmp26 = _TransformationMatrix[5] + _tmp25 - p_c(1, 0);
  ...
  const Scalar _tmp31 = _TransformationMatrix[5] + _tmp30 - p_d(1, 0);
  const Scalar _tmp32 = -_tmp5;
  const Scalar _tmp33 = _tmp15 + _tmp32;
  const Scalar _tmp34 = _TransformationMatrix[4] + _tmp33 - p_d(0, 0);
  ...
  const Scalar _tmp39 = _TransformationMatrix[5] + _tmp38 - p_b(1, 0);
  const Scalar _tmp40 = _tmp11 - _tmp14;
  const Scalar _tmp41 = _tmp40 + _tmp5;
  const Scalar _tmp42 = _TransformationMatrix[4] + _tmp41 - p_b(0, 0);
  ...
  const Scalar _tmp48 = Scalar(1.0) / (_tmp28 * _tmp44 - _tmp47);
  ...
  const Scalar _tmp57 = _tmp28 * _tmp55 - _tmp28 * _tmp56;
  const Scalar _tmp58 = _tmp44 * _tmp55;
  const Scalar _tmp59 = -_tmp28 * _tmp58 + _tmp47 * _tmp56;
  const Scalar _tmp60 = Scalar(1.0) * _tmp38;
  const Scalar _tmp61 = Scalar(1.0) * _tmp41;
  const Scalar _tmp62 = (-_tmp16 + _tmp61) / (_tmp25 - _tmp60);
  const Scalar _tmp63 = -_tmp45 * _tmp53 + _tmp45 * _tmp55 - _tmp49 * _tmp57 -
                        _tmp62 * (_tmp36 * _tmp53 - _tmp45 * _tmp58 - _tmp49 * _tmp59);
  const Scalar _tmp64 = Scalar(1.0) / (_tmp63);
  const Scalar _tmp65 = _tmp60 * _tmp62 + _tmp61;
  ...
  const Scalar _tmp70 = _tmp69 * (-_tmp28 * _tmp67 + _tmp45 * _tmp66);
  const Scalar _tmp71 = Scalar(1.0) * _tmp48;
  const Scalar _tmp72 = -_tmp57 * _tmp71 + _tmp59 * _tmp62 * _tmp71;
  const Scalar _tmp73 = Scalar(1.0) / (_tmp68);
  const Scalar _tmp74 = _tmp69 * (-_tmp38 * _tmp42 * _tmp73 + _tmp39 * _tmp41 * _tmp73);
  const Scalar _tmp75 = -_tmp16 * _tmp47 + _tmp25 * _tmp28 + _tmp28 * _tmp74;
  const Scalar _tmp76 = _tmp30 * _tmp45 - _tmp33 * _tmp36 + _tmp45 * _tmp74 - _tmp49 * _tmp75;
  ...
  const Scalar _tmp81 = _tmp46 * _tmp64;
  const Scalar _tmp82 = -_tmp80 * _tmp81 + Scalar(1.0);
  const Scalar _tmp83 = _tmp28 * _tmp48;
  const Scalar _tmp84 = _tmp45 * _tmp64;
  ...
  _res(0, 0) = 0;
  _res(1, 0) =
      -_tmp70 * std::exp(_tmp0 * _tmp70 + _tmp69 * _tmp91 * (_tmp80 * _tmp84 + _tmp82 * _tmp83) +
                         _tmp69 * _tmp97 * (_tmp83 * _tmp95 + _tmp84 * _tmp94 + Scalar(1.0)) +
                         _tmp69 * _tmp99 * (-_tmp28 * _tmp49 * _tmp98 + _tmp45 * _tmp98));
  _res(2, 0) = -_tmp67 * std::exp(_tmp100 * _tmp49 + _tmp101 * _tmp49 - _tmp48 * _tmp82 * _tmp91 -
