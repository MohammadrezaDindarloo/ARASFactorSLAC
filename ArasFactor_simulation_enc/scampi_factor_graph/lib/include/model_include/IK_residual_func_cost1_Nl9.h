...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl9(
  ...
  const Scalar _tmp35 = -Scalar(0.010999999999999999) * _tmp12 -
  ...
  const Scalar _tmp70 = -_tmp49 * _tmp67 + _tmp50 * _tmp69;
  const Scalar _tmp71 = _tmp65 * _tmp70 + _tmp67;
  ...
  const Scalar _tmp77 = _tmp49 * _tmp66 - _tmp49 * _tmp69;
  const Scalar _tmp78 = _tmp65 * _tmp77 - _tmp66 - _tmp71 * _tmp76;
  const Scalar _tmp79 = _tmp11 + _tmp44;
  const Scalar _tmp80 = _tmp79 + p_init0;
  const Scalar _tmp81 = _tmp80 - p_a(0, 0);
  const Scalar _tmp82 = _tmp29 + _tmp39;
  ...
  const Scalar _tmp88 = _tmp63 * _tmp86 - _tmp87;
  const Scalar _tmp89 = _tmp64 * _tmp88;
  const Scalar _tmp90 = _tmp61 * _tmp86 - _tmp62 * _tmp89 - _tmp79 * _tmp87 + _tmp82 * _tmp86;
  const Scalar _tmp91 = _tmp34 + _tmp68;
  const Scalar _tmp92 = _tmp66 * _tmp86;
  const Scalar _tmp93 = -_tmp63 * _tmp92 - _tmp70 * _tmp89 + _tmp87 * _tmp91;
  const Scalar _tmp94 = -_tmp76 * _tmp93 - _tmp77 * _tmp89 - _tmp86 * _tmp91 + _tmp92;
  ...
  const Scalar _tmp99 = _tmp98 * (-_tmp61 + _tmp62 * _tmp65 - _tmp78 * _tmp96);
  ...
  const Scalar _tmp124 = _tmp110 * _tmp88 * _tmp97;
  const Scalar _tmp125 = fh1 * (-_tmp108 * _tmp30 + _tmp116 * _tmp20);
  const Scalar _tmp126 = -_tmp109 * _tmp60 * (_tmp100 * _tmp101 + _tmp103 * _tmp104 + Scalar(1.0)) -
                         _tmp117 * _tmp60 * (_tmp101 * _tmp114 + _tmp104 * _tmp115) -
                         _tmp118 * _tmp60 * (-_tmp104 * _tmp122 + _tmp121 * _tmp86) -
                         _tmp125 * _tmp60 * (_tmp123 * _tmp86 - _tmp124 * _tmp49);
  ...
  const Scalar _tmp135 = -_tmp120 * _tmp133 - _tmp129 * _tmp134 + _tmp73;
  const Scalar _tmp136 = Scalar(1.0) * _tmp74;
  const Scalar _tmp137 = _tmp130 * _tmp132 + Scalar(1.0);
  const Scalar _tmp138 = _tmp132 * _tmp76;
  const Scalar _tmp139 = _tmp38 * fh1;
  const Scalar _tmp140 = -_tmp116 * _tmp139 - Scalar(3.29616) * _tmp25 - _tmp30 * fv1;
  const Scalar _tmp141 = _tmp129 * _tmp74;
  const Scalar _tmp142 = _tmp108 * _tmp139 + Scalar(3.29616) * _tmp17 + _tmp20 * fv1;
  const Scalar _tmp143 = _tmp132 * _tmp98;
  const Scalar _tmp144 = -_tmp123 * _tmp93 + _tmp129 * _tmp143;
  const Scalar _tmp145 = _tmp129 * _tmp131;
  const Scalar _tmp146 = -_tmp111 + _tmp113 * _tmp145 - _tmp114 * _tmp133;
  const Scalar _tmp147 = -_tmp100 * _tmp133 + _tmp145 * _tmp99 + _tmp71;
  const Scalar _tmp148 = std::asinh(
      _tmp127 * (Scalar(1.0) * _tmp109 * (_tmp132 * _tmp99 - _tmp136 * _tmp147) +
                 Scalar(1.0) * _tmp117 * (_tmp113 * _tmp132 - _tmp136 * _tmp146) +
                 Scalar(1.0) * _tmp118 * (-_tmp119 * _tmp132 - _tmp135 * _tmp136 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp125 * (-_tmp136 * _tmp144 + _tmp143) +
                 Scalar(1.0) * _tmp140 * (-_tmp136 * _tmp137 + _tmp138) +
  ...
  const Scalar _tmp151 = _tmp103 * _tmp109 * _tmp64 + _tmp115 * _tmp117 * _tmp64 -
                         _tmp118 * _tmp122 * _tmp64 - _tmp124 * _tmp125;
  const Scalar _tmp152 = Scalar(1.0) / (_tmp151);
  const Scalar _tmp153 =
      std::asinh(_tmp152 * (_tmp109 * _tmp147 * _tmp74 + _tmp117 * _tmp146 * _tmp74 +
                            _tmp118 * _tmp135 * _tmp74 + _tmp125 * _tmp144 * _tmp74 +
                            _tmp137 * _tmp140 * _tmp74 - _tmp141 * _tmp150));
  const Scalar _tmp154 = Scalar(0.1034955) * _tmp152;
  const Scalar _tmp155 = Scalar(9.6622558468725703) * _tmp151;
  const Scalar _tmp156 = _tmp100 * _tmp109 * _tmp95 + _tmp114 * _tmp117 * _tmp95 +
                         _tmp118 * _tmp121 + _tmp123 * _tmp125;
  const Scalar _tmp157 = Scalar(1.0) / (_tmp156);
  const Scalar _tmp158 =
      std::asinh(_tmp157 * (-_tmp109 * _tmp131 * _tmp99 - _tmp113 * _tmp117 * _tmp131 +
                            _tmp118 * _tmp134 - _tmp125 * _tmp143 - _tmp138 * _tmp140 + _tmp150));
  ...
  _res(1, 0) =
      -_tmp149 *
          (_tmp128 * p_c(2, 0) + std::cosh(Scalar(1.0) * _tmp148) -
           std::cosh(_tmp128 *
                     (-_tmp148 * _tmp149 -
  ...
  _res(3, 0) =
      -_tmp159 *
          (_tmp160 * p_a(2, 0) + std::cosh(Scalar(1.0) * _tmp158) -
           std::cosh(_tmp160 *
                     (-_tmp158 * _tmp159 -
                      std::sqrt(Scalar(std::pow(Scalar(-_tmp80 + p_a(0, 0)), Scalar(2)) +
