...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl1(
  ...
  const Scalar _tmp25 = _tmp24 - p_d(1, 0) + p_init1;
  ...
  const Scalar _tmp31 = _tmp30 - p_d(0, 0) + p_init0;
  const Scalar _tmp32 = std::pow(Scalar(std::pow(_tmp25, Scalar(2)) + std::pow(_tmp31, Scalar(2))),
                                 Scalar(Scalar(-1) / Scalar(2)));
  const Scalar _tmp33 = _tmp31 * _tmp32;
  const Scalar _tmp34 = _tmp10 - _tmp13 + _tmp7;
  const Scalar _tmp35 = -_tmp15 * _tmp33 + _tmp33 * _tmp34;
  ...
  const Scalar _tmp48 = _tmp34 * _tmp44;
  const Scalar _tmp49 = _tmp15 * _tmp45 - _tmp33 * _tmp48;
  ...
  const Scalar _tmp53 = -_tmp35 * _tmp47 + _tmp47 * _tmp49 * _tmp52;
  const Scalar _tmp54 = _tmp26 + _tmp40;
  const Scalar _tmp55 = _tmp54 - p_c(0, 0) + p_init0;
  const Scalar _tmp56 = _tmp18 + _tmp23;
  ...
  const Scalar _tmp61 = _tmp44 * _tmp60 - _tmp59;
  const Scalar _tmp62 = _tmp46 * _tmp61;
  const Scalar _tmp63 = _tmp14 + _tmp7;
  const Scalar _tmp64 = _tmp34 * _tmp60 - _tmp35 * _tmp62 -
                        _tmp52 * (-_tmp48 * _tmp60 - _tmp49 * _tmp62 + _tmp59 * _tmp63) -
                        _tmp60 * _tmp63;
  ...
  const Scalar _tmp68 = _tmp43 * _tmp66;
  const Scalar _tmp69 = _tmp68 * (-_tmp37 * _tmp42 * _tmp67 + _tmp38 * _tmp41 * _tmp67);
  const Scalar _tmp70 = _tmp24 * _tmp33 - _tmp30 * _tmp45 + _tmp33 * _tmp69;
  const Scalar _tmp71 = -_tmp54 * _tmp59 + _tmp56 * _tmp60 + _tmp60 * _tmp69 - _tmp62 * _tmp70;
  const Scalar _tmp72 = _tmp65 * _tmp71;
  const Scalar _tmp73 = Scalar(1.0) / (_tmp71);
  const Scalar _tmp74 = _tmp64 * _tmp73;
  const Scalar _tmp75 = _tmp53 + _tmp74 * (-_tmp47 * _tmp70 - _tmp53 * _tmp72);
  const Scalar _tmp76 = _tmp61 * _tmp65;
  const Scalar _tmp77 = -_tmp75 * _tmp76 + Scalar(1.0);
  const Scalar _tmp78 = _tmp33 * _tmp46;
  const Scalar _tmp79 = _tmp60 * _tmp65;
  const Scalar _tmp80 = _tmp29 + _tmp39;
  const Scalar _tmp81 = _tmp80 - p_a(0, 0) + p_init0;
  const Scalar _tmp82 = _tmp19 + _tmp36;
  ...
  const Scalar _tmp86 = _tmp68 * _tmp85 * (_tmp75 * _tmp79 + _tmp77 * _tmp78);
  const Scalar _tmp87 = _tmp44 * _tmp46;
  const Scalar _tmp88 = -_tmp34 + _tmp35 * _tmp87 - _tmp52 * (_tmp48 + _tmp49 * _tmp87);
  const Scalar _tmp89 = _tmp74 * (-_tmp69 + _tmp70 * _tmp87 - _tmp72 * _tmp88) + _tmp88;
  const Scalar _tmp90 = -_tmp44 - _tmp76 * _tmp89;
  const Scalar _tmp91 = _tmp81 * _tmp84;
  const Scalar _tmp92 = _tmp68 * _tmp91 * (_tmp78 * _tmp90 + _tmp79 * _tmp89 + Scalar(1.0));
  const Scalar _tmp93 = _tmp80 * _tmp85 - _tmp82 * _tmp91;
  const Scalar _tmp94 = Scalar(1.0) * _tmp73;
  const Scalar _tmp95 = _tmp47 * _tmp61 * _tmp73;
  const Scalar _tmp96 = _tmp68 * _tmp93 * (-_tmp33 * _tmp95 + _tmp60 * _tmp94);
  ...
  const Scalar _tmp103 = _tmp46 * _tmp90 * _tmp91;
  const Scalar _tmp104 = _tmp46 * _tmp77 * _tmp85;
  const Scalar _tmp105 = _tmp65 * _tmp75 * _tmp85;
  const Scalar _tmp106 = _tmp93 * _tmp94;
  const Scalar _tmp107 = _tmp65 * _tmp89 * _tmp91;
  ...
  _res(1, 0) = -(-_tmp86 - _tmp92 - _tmp96) *
               std::exp(_tmp68 * _tmp97 * (_tmp100 * _tmp60 - _tmp101 * _tmp78) + _tmp86 * fh1 +
                        _tmp92 * fh1 + _tmp96 * fh1);
  _res(2, 0) = -(-_tmp102 + _tmp103 + _tmp104) *
               std::exp(_tmp101 * _tmp46 * _tmp97 + _tmp102 * fh1 - _tmp103 * fh1 - _tmp104 * fh1);
  _res(3, 0) = -(_tmp105 + _tmp106 + _tmp107) *
               std::exp(-_tmp100 * _tmp97 - _tmp105 * fh1 - _tmp106 * fh1 - _tmp107 * fh1);
