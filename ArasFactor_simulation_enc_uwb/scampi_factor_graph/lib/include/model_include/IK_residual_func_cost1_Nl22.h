...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl22(
  ...
  const Scalar _tmp46 = _tmp27 - _tmp29;
  ...
  const Scalar _tmp59 = _tmp47 + p_init1;
  const Scalar _tmp60 = _tmp59 - p_b(1, 0);
  const Scalar _tmp61 = _tmp40 + p_init0;
  ...
  const Scalar _tmp68 = _tmp51 + p_init0;
  ...
  const Scalar _tmp76 = _tmp43 + p_init1;
  const Scalar _tmp77 = _tmp76 - p_c(1, 0);
  const Scalar _tmp78 = _tmp41 + p_init0;
  ...
  const Scalar _tmp83 = _tmp64 * _tmp81 - _tmp82;
  const Scalar _tmp84 = _tmp71 * _tmp72;
  const Scalar _tmp85 = Scalar(1.0) / (_tmp73 * _tmp81 - _tmp84);
  const Scalar _tmp86 = _tmp83 * _tmp85;
  const Scalar _tmp87 = _tmp67 * _tmp84 - _tmp74 * _tmp81;
  const Scalar _tmp88 = _tmp58 * _tmp81;
  const Scalar _tmp89 = -_tmp64 * _tmp88 + _tmp66 * _tmp82 - _tmp86 * _tmp87;
  const Scalar _tmp90 = -_tmp53 * _tmp89 + _tmp58 * _tmp64 - _tmp64 * _tmp66 - _tmp75 * _tmp86;
  const Scalar _tmp91 =
      std::sqrt(Scalar(std::pow(_tmp77, Scalar(2)) + std::pow(_tmp79, Scalar(2))));
  const Scalar _tmp92 = Scalar(1.0) / (_tmp91);
  const Scalar _tmp93 = _tmp80 * _tmp91;
  const Scalar _tmp94 = _tmp93 * (_tmp41 * _tmp77 * _tmp92 - _tmp43 * _tmp79 * _tmp92);
  const Scalar _tmp95 = _tmp49 * _tmp73 - _tmp51 * _tmp84 + _tmp73 * _tmp94;
  const Scalar _tmp96 = -_tmp40 * _tmp82 + _tmp47 * _tmp64 + _tmp64 * _tmp94 - _tmp86 * _tmp95;
  ...
  const Scalar _tmp101 = -_tmp100 * _tmp89 + _tmp48 * _tmp99;
  ...
  const Scalar _tmp110 = _tmp106 * _tmp109 + Scalar(3.29616) * _tmp14 + _tmp20 * fv1;
  const Scalar _tmp111 = _tmp48 * _tmp50;
  const Scalar _tmp112 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp113 = _tmp42 + _tmp44 * _tmp53;
  const Scalar _tmp114 = 0;
  const Scalar _tmp115 = Scalar(1.0) / (_tmp90);
  const Scalar _tmp116 = _tmp115 * _tmp89;
  const Scalar _tmp117 = _tmp113 * _tmp55;
  const Scalar _tmp118 = -_tmp114 * _tmp116 - _tmp117 * _tmp48 + _tmp45;
  const Scalar _tmp119 = Scalar(1.0) * _tmp85;
  const Scalar _tmp120 = _tmp102 * _tmp52 * _tmp85 * _tmp87 - _tmp119 * _tmp75;
  const Scalar _tmp121 = _tmp115 * _tmp96;
  const Scalar _tmp122 = _tmp98 * (-_tmp119 * _tmp95 - _tmp120 * _tmp121);
  const Scalar _tmp123 = _tmp48 * _tmp55;
  const Scalar _tmp124 = _tmp120 + _tmp122;
  const Scalar _tmp125 = -_tmp116 * _tmp124 - _tmp119 * _tmp87 + _tmp122 * _tmp123;
  const Scalar _tmp126 = _tmp107 * fh1;
  const Scalar _tmp127 = _tmp53 * _tmp56;
  const Scalar _tmp128 = _tmp54 * _tmp56 + Scalar(1.0);
  const Scalar _tmp129 = -_tmp107 * _tmp109 - Scalar(3.29616) * _tmp26 - _tmp31 * fv1;
  const Scalar _tmp130 = _tmp81 * _tmp85;
  const Scalar _tmp131 = _tmp130 * _tmp87 + _tmp88;
  const Scalar _tmp132 = _tmp130 * _tmp75 - _tmp131 * _tmp53 - _tmp58;
  const Scalar _tmp133 = _tmp98 * (-_tmp121 * _tmp132 + _tmp130 * _tmp95 - _tmp94);
  const Scalar _tmp134 = _tmp132 + _tmp133;
  const Scalar _tmp135 = -_tmp116 * _tmp134 + _tmp123 * _tmp133 + _tmp131;
  const Scalar _tmp136 = _tmp106 * fh1;
  const Scalar _tmp137 = _tmp114 * _tmp115;
  const Scalar _tmp138 = _tmp73 * _tmp85;
  const Scalar _tmp139 = _tmp115 * _tmp83;
  const Scalar _tmp140 = _tmp114 * _tmp139;
  const Scalar _tmp141 = _tmp115 * _tmp64;
  const Scalar _tmp142 = -_tmp134 * _tmp139 - _tmp81;
  const Scalar _tmp143 = -_tmp124 * _tmp139 + Scalar(1.0);
  const Scalar _tmp144 = -_tmp108 * _tmp93 * (_tmp100 * _tmp64 - _tmp100 * _tmp73 * _tmp86) -
                         _tmp112 * _tmp93 * (_tmp137 * _tmp64 - _tmp138 * _tmp140) -
                         _tmp126 * _tmp93 * (_tmp124 * _tmp141 + _tmp138 * _tmp143) -
                         _tmp136 * _tmp93 * (_tmp134 * _tmp141 + _tmp138 * _tmp142 + Scalar(1.0));
  const Scalar _tmp145 = Scalar(1.0) / (_tmp144);
  const Scalar _tmp146 = std::asinh(
      _tmp145 * (Scalar(1.0) * _tmp108 * (-_tmp101 * _tmp102 + _tmp99) +
                 Scalar(1.0) * _tmp110 * (_tmp111 * _tmp56 - _tmp56) +
                 Scalar(1.0) * _tmp112 * (-_tmp102 * _tmp118 - _tmp113 * _tmp56 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp126 * (-_tmp102 * _tmp125 + _tmp122 * _tmp56) +
                 Scalar(1.0) * _tmp129 * (-_tmp102 * _tmp128 + _tmp127) +
                 Scalar(1.0) * _tmp136 * (-_tmp102 * _tmp135 + _tmp133 * _tmp56)));
  const Scalar _tmp147 = Scalar(9.6622558468725703) * _tmp144;
  const Scalar _tmp148 = Scalar(0.1034955) * _tmp145;
  const Scalar _tmp149 = _tmp100 * _tmp108;
  const Scalar _tmp150 = -_tmp112 * _tmp140 * _tmp85 + _tmp126 * _tmp143 * _tmp85 +
                         _tmp136 * _tmp142 * _tmp85 - _tmp149 * _tmp86;
  const Scalar _tmp151 = Scalar(1.0) / (_tmp150);
  const Scalar _tmp152 = Scalar(0.1034955) * _tmp151;
  const Scalar _tmp153 = _tmp110 * _tmp56;
  const Scalar _tmp154 =
      std::asinh(_tmp151 * (_tmp101 * _tmp108 * _tmp50 - _tmp111 * _tmp153 +
                            _tmp112 * _tmp118 * _tmp50 + _tmp125 * _tmp126 * _tmp50 +
                            _tmp128 * _tmp129 * _tmp50 + _tmp135 * _tmp136 * _tmp50));
  const Scalar _tmp155 = Scalar(9.6622558468725703) * _tmp150;
  const Scalar _tmp156 =
      _tmp112 * _tmp137 + _tmp115 * _tmp124 * _tmp126 + _tmp115 * _tmp134 * _tmp136 + _tmp149;
  const Scalar _tmp157 = Scalar(1.0) / (_tmp156);
  const Scalar _tmp158 = Scalar(0.1034955) * _tmp157;
  const Scalar _tmp159 =
      std::asinh(_tmp157 * (-_tmp108 * _tmp99 + _tmp112 * _tmp117 - _tmp122 * _tmp126 * _tmp55 -
                            _tmp127 * _tmp129 - _tmp133 * _tmp136 * _tmp55 + _tmp153));
  ...
  _res(1, 0) =
      -_tmp147 *
          (_tmp148 * p_c(2, 0) + std::cosh(Scalar(1.0) * _tmp146) -
           std::cosh(_tmp148 *
                     (-_tmp146 * _tmp147 -
                      std::sqrt(Scalar(std::pow(Scalar(-_tmp76 + p_c(1, 0)), Scalar(2)) +
                                       std::pow(Scalar(-_tmp78 + p_c(0, 0)), Scalar(2))))))) +
      _tmp58 + p_init2;
  _res(2, 0) =
      -_tmp155 *
          (_tmp152 * p_a(2, 0) + std::cosh(Scalar(1.0) * _tmp154) -
           std::cosh(_tmp152 *
                     (-_tmp154 * _tmp155 -
                      std::sqrt(Scalar(std::pow(Scalar(-_tmp68 + p_a(0, 0)), Scalar(2)) +
                                       std::pow(Scalar(-_tmp70 + p_a(1, 0)), Scalar(2))))))) +
      _tmp67 + p_init2;
  _res(3, 0) =
      -_tmp160 *
          (_tmp158 * p_b(2, 0) + std::cosh(Scalar(1.0) * _tmp159) -
           std::cosh(_tmp158 *
                     (-_tmp159 * _tmp160 -
