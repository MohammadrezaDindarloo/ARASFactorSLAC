...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1WrtFv1Nl15(
  ...
  const Scalar _tmp57 = Scalar(0.20999999999999999) * _tmp11 - Scalar(0.20999999999999999) * _tmp13;
  ...
  const Scalar _tmp63 = _tmp23 + _tmp49;
  ...
  const Scalar _tmp75 = Scalar(1.0) / (_tmp43 * _tmp70 - _tmp74);
  const Scalar _tmp76 = _tmp75 * (-_tmp62 * _tmp70 + _tmp73);
  const Scalar _tmp77 = _tmp58 + _tmp71;
  const Scalar _tmp78 = _tmp54 * _tmp72;
  const Scalar _tmp79 = -_tmp43 * _tmp73 + _tmp62 * _tmp74;
  const Scalar _tmp80 = _tmp56 * _tmp75;
  const Scalar _tmp81 = -_tmp43 * _tmp78 + _tmp55 * _tmp77 - _tmp79 * _tmp80;
  ...
  const Scalar _tmp86 = _tmp84 * (-_tmp66 + _tmp85);
  const Scalar _tmp87 = -_tmp54 * _tmp77 - _tmp56 * _tmp76 + _tmp78 - _tmp81 * _tmp86;
  const Scalar _tmp88 = Scalar(1.0) / (_tmp87);
  const Scalar _tmp89 = _tmp82 * _tmp86 + _tmp85;
  const Scalar _tmp90 = 0;
  const Scalar _tmp91 = _tmp88 * _tmp90;
  const Scalar _tmp92 = _tmp70 * _tmp80;
  const Scalar _tmp93 =
      std::sqrt(Scalar(std::pow(_tmp37, Scalar(2)) + std::pow(_tmp41, Scalar(2))));
  const Scalar _tmp94 = _tmp42 * _tmp93;
  const Scalar _tmp95 = _tmp94 * (_tmp54 * _tmp91 - _tmp91 * _tmp92);
  const Scalar _tmp96 = Scalar(1.0) / (_tmp93);
  const Scalar _tmp97 = _tmp94 * (-_tmp35 * _tmp41 * _tmp96 + _tmp37 * _tmp39 * _tmp96);
  const Scalar _tmp98 = _tmp63 * _tmp70 - _tmp66 * _tmp74 + _tmp70 * _tmp97;
  const Scalar _tmp99 = Scalar(1.0) * _tmp75;
  const Scalar _tmp100 = _tmp79 * _tmp99;
  const Scalar _tmp101 = _tmp100 * _tmp86 - Scalar(1.0) * _tmp76;
  const Scalar _tmp102 = -_tmp45 * _tmp55 + _tmp50 * _tmp54 + _tmp54 * _tmp97 - _tmp80 * _tmp98;
  ...
  const Scalar _tmp108 = _tmp54 * _tmp88;
  const Scalar _tmp109 = _tmp56 * _tmp88;
  const Scalar _tmp110 = -_tmp107 * _tmp109 + Scalar(1.0);
  const Scalar _tmp111 = _tmp70 * _tmp75;
  ...
  const Scalar _tmp117 = _tmp43 * _tmp75;
  const Scalar _tmp118 = _tmp117 * _tmp79 + _tmp43 * _tmp72;
  const Scalar _tmp119 = -_tmp118 * _tmp86 + _tmp43 * _tmp76 - _tmp72;
  const Scalar _tmp120 = _tmp105 * (-_tmp103 * _tmp119 + _tmp117 * _tmp98 - _tmp97);
  const Scalar _tmp121 = _tmp119 + _tmp120;
  const Scalar _tmp122 = -_tmp109 * _tmp121 - _tmp43;
  ...
  const Scalar _tmp127 = -_tmp116 * _tmp94 * (_tmp107 * _tmp108 + _tmp110 * _tmp111) -
                         ...
                         _tmp126 * _tmp94 * (_tmp125 * _tmp54 - _tmp125 * _tmp92) - _tmp33 * _tmp95;
  const Scalar _tmp128 = Scalar(1.0) / (_tmp127);
  const Scalar _tmp129 = Scalar(0.1034955) * _tmp128;
  const Scalar _tmp130 = fh1 * (_tmp57 + _tmp61);
  const Scalar _tmp131 = _tmp123 * _tmp130 + Scalar(3.29616) * _tmp14 + _tmp20 * fv1;
  const Scalar _tmp132 = _tmp50 + _tmp83;
  const Scalar _tmp133 = _tmp132 * _tmp86;
  const Scalar _tmp134 = Scalar(1.0) / (-_tmp133 - _tmp45 + _tmp85);
  const Scalar _tmp135 = Scalar(1.0) * _tmp134;
  const Scalar _tmp136 = _tmp132 * _tmp84;
  const Scalar _tmp137 = Scalar(1.0) * _tmp135 * _tmp136 - Scalar(1.0) * _tmp135;
  const Scalar _tmp138 = _tmp81 * _tmp88;
  const Scalar _tmp139 = _tmp132 * _tmp134;
  const Scalar _tmp140 = _tmp118 + _tmp120 * _tmp139 - _tmp121 * _tmp138;
  const Scalar _tmp141 = Scalar(1.0) * _tmp84;
  const Scalar _tmp142 = -_tmp115 * _tmp130 - Scalar(3.29616) * _tmp26 - _tmp31 * fv1;
  const Scalar _tmp143 = _tmp84 * (_tmp133 * _tmp135 + Scalar(1.0));
  const Scalar _tmp144 = _tmp135 * _tmp86;
  const Scalar _tmp145 = -Scalar(1.0) * _tmp143 + Scalar(1.0) * _tmp144;
  const Scalar _tmp146 = -_tmp100 + _tmp106 * _tmp139 - _tmp107 * _tmp138;
  const Scalar _tmp147 = _tmp105 * _tmp135;
  const Scalar _tmp148 = -_tmp125 * _tmp81 + _tmp132 * _tmp147;
  const Scalar _tmp149 = _tmp134 * _tmp89;
  const Scalar _tmp150 = _tmp84 * (-_tmp132 * _tmp149 - _tmp138 * _tmp90 + _tmp83);
  const Scalar _tmp151 = -Scalar(1.0) * _tmp149 - Scalar(1.0) * _tmp150 + Scalar(1.0);
  const Scalar _tmp152 = Scalar(1.0) * _tmp116 * (_tmp106 * _tmp135 - _tmp141 * _tmp146) +
                         Scalar(1.0) * _tmp124 * (_tmp120 * _tmp135 - _tmp140 * _tmp141) +
                         Scalar(1.0) * _tmp126 * (-_tmp141 * _tmp148 + _tmp147) +
                         _tmp131 * _tmp137 + _tmp142 * _tmp145 + _tmp151 * _tmp33;
  ...
  const Scalar _tmp162 = _tmp27 + _tmp34 + _tmp48;
  const Scalar _tmp163 =
      (_tmp128 * (_tmp137 * _tmp20 + _tmp145 * _tmp162 - _tmp151) - _tmp152 * _tmp160) /
  ...
  const Scalar _tmp166 =
      _tmp110 * _tmp116 * _tmp75 + _tmp122 * _tmp124 * _tmp75 - _tmp164 * _tmp80 - _tmp165 * _tmp80;
  const Scalar _tmp167 = Scalar(1.0) / (_tmp166);
  const Scalar _tmp168 = Scalar(0.1034955) * _tmp167;
  const Scalar _tmp169 = _tmp131 * _tmp135;
  const Scalar _tmp170 = _tmp116 * _tmp146 * _tmp84 + _tmp124 * _tmp140 * _tmp84 +
                         _tmp126 * _tmp148 * _tmp84 - _tmp136 * _tmp169 + _tmp142 * _tmp143 +
                         _tmp150 * _tmp33;
  const Scalar _tmp171 = std::asinh(_tmp167 * _tmp170);
  const Scalar _tmp172 = Scalar(9.6622558468725703) * _tmp166;
  const Scalar _tmp173 =
      -_tmp171 * _tmp172 - std::sqrt(Scalar(std::pow(Scalar(-_tmp64 + p_d(1, 0)), Scalar(2)) +
  ...
  const Scalar _tmp177 = _tmp176 * _tmp80;
  const Scalar _tmp178 = std::pow(_tmp166, Scalar(-2));
  const Scalar _tmp179 = _tmp178 * _tmp80 * _tmp91;
  const Scalar _tmp180 = _tmp135 * _tmp20;
  const Scalar _tmp181 =
      (_tmp167 * (-_tmp136 * _tmp180 + _tmp143 * _tmp162 - _tmp150) - _tmp170 * _tmp179) /
  ...
  const Scalar _tmp185 = -_tmp106 * _tmp116 * _tmp134 - _tmp120 * _tmp124 * _tmp134 -
                         _tmp126 * _tmp147 - _tmp142 * _tmp144 + _tmp149 * _tmp33 + _tmp169;
  const Scalar _tmp186 = std::asinh(_tmp184 * _tmp185);
  const Scalar _tmp187 = Scalar(9.6622558468725703) * _tmp183;
  const Scalar _tmp188 =
      -_tmp186 * _tmp187 - std::sqrt(Scalar(std::pow(Scalar(-_tmp46 + p_a(0, 0)), Scalar(2)) +
  ...
  const Scalar _tmp194 = (_tmp184 * (-_tmp144 * _tmp162 - _tmp149 + _tmp180) + _tmp185 * _tmp192) /
  ...
  _res(2, 0) =
      -_tmp172 * (Scalar(1.0) * _tmp181 * std::sinh(_tmp175) - _tmp182 * p_d(2, 0) -
                  (_tmp168 * (-_tmp171 * _tmp177 - _tmp172 * _tmp181) - _tmp173 * _tmp182) *
                      std::sinh(_tmp174)) -
      _tmp177 * (_tmp168 * p_d(2, 0) - std::cosh(_tmp174) + std::cosh(_tmp175));
  _res(3, 0) = _tmp176 * (_tmp189 * p_a(2, 0) - std::cosh(_tmp190) + std::cosh(_tmp195)) -
               _tmp187 * (_tmp193 * p_a(2, 0) + Scalar(1.0) * _tmp194 * std::sinh(_tmp195) -
