...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl13(
  ...
  const Scalar _tmp53 = _tmp18 + _tmp44;
  ...
  const Scalar _tmp64 = _tmp27 + _tmp39;
  ...
  const Scalar _tmp76 = Scalar(1.0) / (_tmp49 * _tmp71 - _tmp75);
  const Scalar _tmp77 = _tmp59 * _tmp76;
  const Scalar _tmp78 = _tmp15 + _tmp60;
  const Scalar _tmp79 = _tmp76 * (-_tmp49 * _tmp72 + _tmp73 * _tmp75);
  const Scalar _tmp80 = -_tmp49 * _tmp63 + _tmp58 * _tmp78 - _tmp59 * _tmp79;
  ...
  const Scalar _tmp87 = -_tmp57 * _tmp78 + _tmp63 - _tmp74 * _tmp77 - _tmp80 * _tmp86;
  ...
  const Scalar _tmp92 = _tmp91 * (-_tmp40 * _tmp47 * _tmp90 + _tmp42 * _tmp45 * _tmp90);
  const Scalar _tmp93 = _tmp64 * _tmp71 - _tmp67 * _tmp75 + _tmp71 * _tmp92;
  const Scalar _tmp94 = _tmp49 * _tmp76;
  const Scalar _tmp95 = _tmp49 * _tmp62 + _tmp49 * _tmp79;
  const Scalar _tmp96 = -_tmp62 + _tmp74 * _tmp94 - _tmp86 * _tmp95;
  const Scalar _tmp97 = _tmp50 * _tmp57 - _tmp53 * _tmp58 + _tmp57 * _tmp92 - _tmp77 * _tmp93;
  ...
  const Scalar _tmp105 = _tmp26 - p_c(0, 0);
  const Scalar _tmp106 = _tmp33 - p_c(1, 0);
  ...
  const Scalar _tmp117 = fh1 * (-_tmp108 * _tmp32 + _tmp116 * _tmp25);
  const Scalar _tmp118 = Scalar(1.0) * _tmp76;
  const Scalar _tmp119 = Scalar(1.0) * _tmp83;
  const Scalar _tmp120 = -_tmp118 * _tmp74 + _tmp119 * _tmp79 * _tmp85;
  ...
  const Scalar _tmp124 = -_tmp123 * _tmp59 + Scalar(1.0);
  const Scalar _tmp125 = _tmp116 * fh1;
  const Scalar _tmp126 = -_tmp109 * _tmp91 * (_tmp102 * _tmp57 + _tmp103 * _tmp104 + Scalar(1.0)) -
                         _tmp110 * _tmp91 * (-_tmp113 * _tmp114 + _tmp113 * _tmp57) -
                         _tmp117 * _tmp91 * (-_tmp114 * _tmp115 + _tmp115 * _tmp57) -
                         _tmp125 * _tmp91 * (_tmp104 * _tmp124 + _tmp123 * _tmp57);
  const Scalar _tmp127 = Scalar(1.0) / (_tmp126);
  const Scalar _tmp128 = _tmp50 + _tmp82;
  const Scalar _tmp129 = _tmp128 * _tmp86;
  const Scalar _tmp130 = Scalar(1.0) / (-_tmp129 - _tmp53 + _tmp84);
  const Scalar _tmp131 = _tmp111 * _tmp130;
  const Scalar _tmp132 = _tmp80 * _tmp88;
  const Scalar _tmp133 = -_tmp112 * _tmp132 - _tmp128 * _tmp131 + _tmp82;
  const Scalar _tmp134 = Scalar(1.0) * _tmp130;
  const Scalar _tmp135 = _tmp128 * _tmp130;
  const Scalar _tmp136 = _tmp101 * _tmp135 - _tmp102 * _tmp80 + _tmp95;
  const Scalar _tmp137 = _tmp128 * _tmp134;
  const Scalar _tmp138 = _tmp100 * _tmp137 - _tmp115 * _tmp80;
  const Scalar _tmp139 = _tmp100 * _tmp134;
  const Scalar _tmp140 = _tmp121 * _tmp135 - _tmp122 * _tmp132 - Scalar(1.0) * _tmp79;
  const Scalar _tmp141 = _tmp16 * fh1;
  const Scalar _tmp142 = -_tmp116 * _tmp141 - Scalar(3.29616) * _tmp28 - _tmp32 * fv1;
  const Scalar _tmp143 = _tmp129 * _tmp134 + Scalar(1.0);
  const Scalar _tmp144 = _tmp108 * _tmp141 + Scalar(3.29616) * _tmp19 + _tmp25 * fv1;
  const Scalar _tmp145 = std::asinh(
      _tmp127 * (Scalar(1.0) * _tmp109 * (_tmp101 * _tmp134 - _tmp119 * _tmp136) +
                 Scalar(1.0) * _tmp110 * (-_tmp111 * _tmp134 - _tmp119 * _tmp133 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp117 * (-_tmp119 * _tmp138 + _tmp139) +
                 Scalar(1.0) * _tmp125 * (-_tmp119 * _tmp140 + _tmp121 * _tmp134) +
                 Scalar(1.0) * _tmp142 * (-_tmp119 * _tmp143 + _tmp134 * _tmp86) +
                 Scalar(1.0) * _tmp144 * (-_tmp134 + _tmp137 * _tmp83)));
  const Scalar _tmp146 = Scalar(9.6622558468725703) * _tmp126;
  const Scalar _tmp147 = std::pow(Scalar(-_tmp41 + p_a(1, 0)), Scalar(2)) +
                         std::pow(Scalar(-_tmp46 + p_a(0, 0)), Scalar(2));
  const Scalar _tmp148 = _tmp115 * _tmp117;
  const Scalar _tmp149 = _tmp110 * _tmp113;
  const Scalar _tmp150 =
      _tmp103 * _tmp109 * _tmp76 + _tmp124 * _tmp125 * _tmp76 - _tmp148 * _tmp77 - _tmp149 * _tmp77;
  const Scalar _tmp151 = Scalar(1.0) / (_tmp150);
  const Scalar _tmp152 = _tmp142 * _tmp83;
  const Scalar _tmp153 = _tmp134 * _tmp144;
  const Scalar _tmp154 =
      std::asinh(_tmp151 * (_tmp109 * _tmp136 * _tmp83 + _tmp110 * _tmp133 * _tmp83 +
                            _tmp117 * _tmp138 * _tmp83 + _tmp125 * _tmp140 * _tmp83 -
                            _tmp128 * _tmp153 * _tmp83 + _tmp143 * _tmp152));
  const Scalar _tmp155 = Scalar(9.6622558468725703) * _tmp150;
  const Scalar _tmp156 = std::pow(Scalar(-_tmp65 + p_d(1, 0)), Scalar(2)) +
                         std::pow(Scalar(-_tmp68 + p_d(0, 0)), Scalar(2));
  const Scalar _tmp157 = _tmp102 * _tmp109 + _tmp123 * _tmp125 + _tmp148 + _tmp149;
  const Scalar _tmp158 = Scalar(1.0) / (_tmp157);
  const Scalar _tmp159 =
      std::asinh(_tmp158 * (-_tmp101 * _tmp109 * _tmp130 + _tmp110 * _tmp131 - _tmp117 * _tmp139 -
                            _tmp121 * _tmp125 * _tmp130 - _tmp134 * _tmp152 * _tmp85 + _tmp153));
  const Scalar _tmp160 = std::pow(Scalar(-_tmp51 + p_b(1, 0)), Scalar(2)) +
  ...
  _res(1, 0) =
      _tmp146 *
          (-std::sinh(Scalar(1.0) * _tmp145) -
           std::sinh(Scalar(0.1034955) * _tmp127 * (-_tmp145 * _tmp146 - std::sqrt(_tmp147)))) -
      std::sqrt(Scalar(_tmp147 + std::pow(Scalar(-_tmp62 + p_a(2, 0) - p_init2), Scalar(2))));
  _res(2, 0) =
      _tmp155 *
          (-std::sinh(Scalar(1.0) * _tmp154) -
           std::sinh(Scalar(0.1034955) * _tmp151 * (-_tmp154 * _tmp155 - std::sqrt(_tmp156)))) -
      std::sqrt(Scalar(_tmp156 + std::pow(Scalar(-_tmp73 + p_d(2, 0) - p_init2), Scalar(2))));
  _res(3, 0) =
      _tmp161 *
          (-std::sinh(Scalar(1.0) * _tmp159) -
           std::sinh(Scalar(0.1034955) * _tmp158 * (-_tmp159 * _tmp161 - std::sqrt(_tmp160)))) -
      std::sqrt(Scalar(_tmp160 + std::pow(Scalar(-_tmp78 + p_b(2, 0) - p_init2), Scalar(2))));
