...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl7(
  ...
  const Scalar _tmp89 = _tmp51 * fh1;
  ...
  const Scalar _tmp95 = Scalar(1.0) * _tmp73 * _tmp76 - Scalar(1.0) * _tmp77;
  const Scalar _tmp96 = _tmp84 * (-Scalar(1.0) * _tmp53 - _tmp83 * _tmp95) + _tmp95;
  const Scalar _tmp97 = -_tmp86 * _tmp96 + Scalar(1.0);
  const Scalar _tmp98 = _tmp56 * _tmp64;
  const Scalar _tmp99 = _tmp47 * fh1;
  const Scalar _tmp100 = _tmp82 * fh1;

  // Output terms (1)
  Eigen::Matrix<Scalar, 4, 1> _res;

  _res(0, 0) = std::exp(-fh1);
  _res(1, 0) = std::exp(_tmp51 * _tmp64 * (_tmp37 * _tmp56 - _tmp39 * _tmp48 * _tmp56) +
                        _tmp51 * _tmp90 * (_tmp37 * _tmp94 - _tmp48 * _tmp93) +
                        _tmp62 * _tmp89 * (_tmp48 * _tmp87 + _tmp85 * _tmp88 + Scalar(1.0)) +
                        _tmp63 * _tmp89 * (_tmp48 * _tmp97 + _tmp88 * _tmp96));
  _res(2, 0) = std::exp(_tmp39 * _tmp47 * _tmp98 + _tmp47 * _tmp90 * _tmp93 -
                        _tmp62 * _tmp87 * _tmp99 - _tmp63 * _tmp97 * _tmp99);
  _res(3, 0) =
      std::exp(-_tmp100 * _tmp62 * _tmp85 - _tmp100 * _tmp63 * _tmp96 - _tmp90 * _tmp94 - _tmp98);
