...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl23(
  ...
  const Scalar _tmp22 = _tmp13 * _tmp6;
  const Scalar _tmp23 =
  ...
  const Scalar _tmp42 = Scalar(1.0) / (_tmp29 * _tmp41 - _tmp30);
  const Scalar _tmp43 = _tmp42 * (_tmp17 * _tmp29 - _tmp26 * _tmp30 + _tmp29 * _tmp40);
  ...
  const Scalar _tmp51 = _tmp42 * (-_tmp29 * _tmp50 + _tmp48);
  const Scalar _tmp52 = _tmp42 * (_tmp30 * _tmp50 - _tmp41 * _tmp48);
  const Scalar _tmp53 = Scalar(1.0) * _tmp34;
  const Scalar _tmp54 = Scalar(1.0) * _tmp32;
  const Scalar _tmp55 = (-_tmp26 + _tmp54) / (_tmp17 - _tmp53);
  const Scalar _tmp56 = -Scalar(1.0) * _tmp51 + Scalar(1.0) * _tmp52 * _tmp55;
  const Scalar _tmp57 = -_tmp45 + _tmp49;
  ...
  const Scalar _tmp68 = _tmp41 * _tmp66 - _tmp65;
  const Scalar _tmp69 = -_tmp51 * _tmp68 -
                        _tmp55 * (-_tmp41 * _tmp67 - _tmp52 * _tmp68 + _tmp57 * _tmp65) -
                        _tmp57 * _tmp66 + _tmp67;
  const Scalar _tmp70 = Scalar(1.0) / (_tmp69);
  const Scalar _tmp71 = _tmp40 * _tmp66 - _tmp43 * _tmp68 - _tmp59 * _tmp65 + _tmp62 * _tmp66;
  const Scalar _tmp72 = _tmp70 * _tmp71;
  const Scalar _tmp73 = Scalar(1.0) / (_tmp71);
  const Scalar _tmp74 = _tmp69 * _tmp73;
  const Scalar _tmp75 = _tmp56 + _tmp74 * (-Scalar(1.0) * _tmp43 - _tmp56 * _tmp72);
  ...
  const Scalar _tmp80 = _tmp4 + _tmp61;
  const Scalar _tmp81 = _tmp80 - p_d(1, 0) + p_init1;
  const Scalar _tmp82 = _tmp31 + _tmp58;
  const Scalar _tmp83 = _tmp82 - p_d(0, 0) + p_init0;
  ...
  const Scalar _tmp91 = _tmp39 * (_tmp66 * _tmp89 - _tmp89 * _tmp90);
  ...
  const Scalar _tmp95 = _tmp41 * _tmp51 - _tmp47 - _tmp55 * (_tmp41 * _tmp47 + _tmp41 * _tmp52);
  const Scalar _tmp96 = _tmp74 * (-_tmp40 + _tmp41 * _tmp43 - _tmp72 * _tmp95) + _tmp95;
  const Scalar _tmp97 = -_tmp41 - _tmp76 * _tmp96;
  const Scalar _tmp98 = _tmp93 * fh1;
  const Scalar _tmp99 = _tmp87 * _tmp89;
  const Scalar _tmp100 = _tmp42 * _tmp68;
  ...
  _res(0, 0) = 0;
  _res(1, 0) =
      -_tmp91 * std::exp(_tmp39 * _tmp86 * (_tmp75 * _tmp79 + _tmp77 * _tmp78) +
                         _tmp39 * _tmp94 * (_tmp66 * _tmp92 - _tmp90 * _tmp92) +
                         _tmp39 * _tmp98 * (_tmp78 * _tmp97 + _tmp79 * _tmp96 + Scalar(1.0)) +
                         _tmp87 * _tmp91);
  _res(2, 0) = -_tmp100 * _tmp89 *
               std::exp(_tmp100 * _tmp101 + _tmp100 * _tmp99 - _tmp42 * _tmp77 * _tmp86 -
                        _tmp42 * _tmp97 * _tmp98);
  _res(3, 0) =
      _tmp89 * std::exp(-_tmp101 - _tmp70 * _tmp75 * _tmp86 - _tmp70 * _tmp96 * _tmp98 - _tmp99);
