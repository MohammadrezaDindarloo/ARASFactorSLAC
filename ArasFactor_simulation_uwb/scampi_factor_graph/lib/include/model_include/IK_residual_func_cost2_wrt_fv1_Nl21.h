...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2WrtFv1Nl21(
  ...
  const Scalar _tmp47 = _tmp22 + _tmp23 + _tmp28;
  ...
  const Scalar _tmp65 = -_tmp44 * _tmp51 + _tmp47 * _tmp52 + _tmp52 * _tmp64;
  const Scalar _tmp66 = _tmp56 * _tmp62;
  const Scalar _tmp67 = Scalar(1.0) / (-_tmp51 + _tmp52 * _tmp66);
  const Scalar _tmp68 = _tmp40 * _tmp41;
  const Scalar _tmp69 = _tmp42 * _tmp66 - _tmp68;
  const Scalar _tmp70 = _tmp67 * _tmp69;
  const Scalar _tmp71 = -_tmp34 * _tmp68 + _tmp38 * _tmp42 + _tmp42 * _tmp64 - _tmp65 * _tmp70;
  ...
  const Scalar _tmp89 = _tmp52 * _tmp87 - _tmp52 * _tmp88;
  const Scalar _tmp90 = _tmp66 * _tmp87;
  const Scalar _tmp91 = _tmp51 * _tmp88 - _tmp52 * _tmp90;
  const Scalar _tmp92 = _tmp74 * _tmp91;
  const Scalar _tmp93 = Scalar(1.0) * _tmp54;
  const Scalar _tmp94 = -_tmp93;
  const Scalar _tmp95 = Scalar(1.0) / (_tmp47 + _tmp94);
  const Scalar _tmp96 = Scalar(1.0) * _tmp57;
  const Scalar _tmp97 = _tmp95 * (-_tmp44 + _tmp96);
  const Scalar _tmp98 = -_tmp74 * _tmp89 + _tmp92 * _tmp97;
  ...
  const Scalar _tmp103 = -_tmp100 * _tmp42 + _tmp101 - _tmp102 * _tmp97 - _tmp70 * _tmp89;
  ...
  const Scalar _tmp118 = _tmp63 * (_tmp116 * _tmp42 - _tmp117 * _tmp52);
  const Scalar _tmp119 = _tmp66 * _tmp67;
  const Scalar _tmp120 = _tmp119 * _tmp91 + _tmp90;
  const Scalar _tmp121 = _tmp119 * _tmp89 - _tmp120 * _tmp97 - _tmp87;
  const Scalar _tmp122 = _tmp106 * (-_tmp105 * _tmp121 + _tmp119 * _tmp65 - _tmp64);
  const Scalar _tmp123 = _tmp121 + _tmp122;
  const Scalar _tmp124 = -_tmp110 * _tmp123 - _tmp66;
  const Scalar _tmp125 = _tmp79 * fh1;
  const Scalar _tmp126 = -_tmp113 * _tmp63 * (_tmp108 * _tmp109 + _tmp111 * _tmp112) -
                         _tmp114 * _tmp118 -
                         _tmp125 * _tmp63 * (_tmp109 * _tmp123 + _tmp112 * _tmp124 + Scalar(1.0)) -
                         _tmp63 * _tmp81 * (_tmp42 * _tmp73 - _tmp52 * _tmp75);
  const Scalar _tmp127 = Scalar(1.0) / (_tmp126);
  const Scalar _tmp128 = _tmp38 + _tmp94;
  const Scalar _tmp129 = _tmp128 * _tmp97;
  const Scalar _tmp130 = Scalar(1.0) / (-_tmp129 - _tmp34 + _tmp96);
  ...
  const Scalar _tmp137 = _tmp95 * (-_tmp102 * _tmp116 - _tmp128 * _tmp136 + _tmp94);
  const Scalar _tmp138 = -Scalar(1.0) * _tmp115 * _tmp131 - Scalar(1.0) * _tmp137 + Scalar(1.0);
  const Scalar _tmp139 = _tmp107 * _tmp133 - _tmp108 * _tmp132 - _tmp92;
  const Scalar _tmp140 = fh1 * (_tmp82 + _tmp99);
  const Scalar _tmp141 = -_tmp140 * _tmp80 - Scalar(3.29616) * _tmp26 - _tmp30 * fv1;
  const Scalar _tmp142 = _tmp131 * _tmp97;
  const Scalar _tmp143 = _tmp95 * (_tmp129 * _tmp131 + Scalar(1.0));
  const Scalar _tmp144 = Scalar(1.0) * _tmp142 - Scalar(1.0) * _tmp143;
  const Scalar _tmp145 = _tmp128 * _tmp131;
  const Scalar _tmp146 = -_tmp102 * _tmp73 + _tmp106 * _tmp145;
  const Scalar _tmp147 = _tmp106 * _tmp131;
  const Scalar _tmp148 = _tmp140 * _tmp79 + Scalar(3.29616) * _tmp16 + _tmp19 * fv1;
  const Scalar _tmp149 = -Scalar(1.0) * _tmp131 + Scalar(1.0) * _tmp145 * _tmp95;
  const Scalar _tmp150 =
      Scalar(1.0) * _tmp113 * (_tmp107 * _tmp131 - _tmp135 * _tmp139) + _tmp114 * _tmp138 +
      Scalar(1.0) * _tmp125 * (_tmp122 * _tmp131 - _tmp134 * _tmp135) + _tmp141 * _tmp144 +
      _tmp148 * _tmp149 + Scalar(1.0) * _tmp81 * (-_tmp135 * _tmp146 + _tmp147);
  const Scalar _tmp151 = std::asinh(_tmp127 * _tmp150);
  const Scalar _tmp152 = Scalar(9.6622558468725703) * _tmp126;
  const Scalar _tmp153 =
      -_tmp151 * _tmp152 - std::sqrt(Scalar(std::pow(Scalar(-_tmp55 + p_b(1, 0)), Scalar(2)) +
  ...
  const Scalar _tmp160 = _tmp27 + _tmp53;
  const Scalar _tmp161 =
      (_tmp127 * (-_tmp138 + _tmp144 * _tmp160 + _tmp149 * _tmp19) - _tmp150 * _tmp159) /
      std::sqrt(Scalar(std::pow(_tmp150, Scalar(2)) * _tmp158 + 1));
  const Scalar _tmp162 = _tmp114 * _tmp116;
  const Scalar _tmp163 =
      _tmp111 * _tmp113 * _tmp67 + _tmp124 * _tmp125 * _tmp67 - _tmp162 * _tmp70 - _tmp75 * _tmp81;
  const Scalar _tmp164 = Scalar(1.0) / (_tmp163);
  const Scalar _tmp165 = _tmp131 * _tmp148;
  const Scalar _tmp166 = _tmp128 * _tmp95;
  const Scalar _tmp167 = _tmp113 * _tmp139 * _tmp95 + _tmp114 * _tmp137 +
                         _tmp125 * _tmp134 * _tmp95 + _tmp141 * _tmp143 +
                         _tmp146 * _tmp81 * _tmp95 - _tmp165 * _tmp166;
  const Scalar _tmp168 = std::asinh(_tmp164 * _tmp167);
  const Scalar _tmp169 = Scalar(9.6622558468725703) * _tmp163;
  const Scalar _tmp170 =
      -_tmp168 * _tmp169 - std::sqrt(Scalar(std::pow(Scalar(-_tmp45 + p_c(0, 0)), Scalar(2)) +
  ...
  const Scalar _tmp179 =
      (_tmp164 * (-_tmp137 + _tmp143 * _tmp160 - _tmp166 * _tmp178) - _tmp167 * _tmp177) /
      std::sqrt(Scalar(std::pow(_tmp167, Scalar(2)) * _tmp176 + 1));
  const Scalar _tmp180 = -_tmp107 * _tmp113 * _tmp130 + _tmp114 * _tmp136 -
                         _tmp122 * _tmp125 * _tmp130 - _tmp141 * _tmp142 - _tmp147 * _tmp81 +
                         _tmp165;
  const Scalar _tmp181 =
      _tmp104 * _tmp108 * _tmp113 + _tmp104 * _tmp123 * _tmp125 + _tmp162 + _tmp73 * _tmp81;
  ...
  const Scalar _tmp185 =
      -_tmp183 * _tmp184 - std::sqrt(Scalar(std::pow(Scalar(-_tmp35 + p_a(0, 0)), Scalar(2)) +
  ...
  const Scalar _tmp191 = (_tmp180 * _tmp190 + _tmp182 * (-_tmp136 - _tmp142 * _tmp160 + _tmp178)) /
