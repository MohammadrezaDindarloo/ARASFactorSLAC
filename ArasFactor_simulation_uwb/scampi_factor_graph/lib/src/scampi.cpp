                              ...
                              gtsam::Rot3 DeltaRot, std::vector<Eigen::Matrix<double, 3, 1>> p_platform_collection, gtsam::Values *oprimization_result_LM)
{
    ...
    std::uniform_real_distribution<double> uwb_noise(-0.05, 0.05);
    ...
    {
        double encoder_data_1 = (b_in_w_collection[i][0] - p_in_w_collection[i][0]).norm() + uwb_noise(generator);
        double encoder_data_2 = (b_in_w_collection[i][1] - p_in_w_collection[i][1]).norm() + uwb_noise(generator);
        double encoder_data_3 = (b_in_w_collection[i][2] - p_in_w_collection[i][2]).norm() + uwb_noise(generator);
        double encoder_data_4 = (b_in_w_collection[i][3] - p_in_w_collection[i][3]).norm() + uwb_noise(generator);
