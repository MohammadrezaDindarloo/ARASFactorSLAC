...
Eigen::Matrix<Scalar, 4, 1> FkResidualFuncCost3(
  ...
  const Scalar _tmp80 = _tmp57 + _tmp7;
  ...
  _res(1, 0) = std::exp(_tmp30 * _tmp94 * (_tmp64 * _tmp92 - _tmp92 * _tmp93) +
                        _tmp30 * _tmp95 * (_tmp64 * _tmp97 - _tmp93 * _tmp97) +
                        _tmp85 * _tmp86 * (_tmp75 * _tmp79 + _tmp77 * _tmp78 + Scalar(1.0)) +
                        _tmp86 * _tmp91 * (_tmp78 * _tmp90 + _tmp79 * _tmp89));
