...
Eigen::Matrix<Scalar, 4, 3> FkResidualFuncCost3WrtPa(
  ...
  const Scalar _tmp51 = -_tmp31 * _tmp49 + _tmp31 * _tmp50;
  const Scalar _tmp52 = _tmp38 * _tmp40;
  const Scalar _tmp53 = _tmp38 * _tmp50;
  const Scalar _tmp54 = -_tmp31 * _tmp53 + _tmp39 * _tmp49;
  ...
  const Scalar _tmp58 = -_tmp50 + _tmp51 * _tmp52 - _tmp57 * (_tmp52 * _tmp54 + _tmp53);
  ...
  const Scalar _tmp78 = _tmp58 + _tmp77 * (-_tmp44 + _tmp52 * _tmp73 - _tmp58 * _tmp75);
  ...
  const Scalar _tmp93 = -_tmp51 * _tmp92 + _tmp54 * _tmp57 * _tmp92;
  const Scalar _tmp94 = _tmp77 * (-_tmp73 * _tmp92 - _tmp75 * _tmp93) + _tmp93;
  const Scalar _tmp95 = _tmp40 * (-_tmp79 * _tmp94 + Scalar(1.0));
  const Scalar _tmp96 = _tmp31 * _tmp95 + _tmp81 * _tmp94;
  const Scalar _tmp97 = _tmp90 * _tmp96;
  const Scalar _tmp98 = _tmp84 * _tmp88;
  const Scalar _tmp99 = _tmp16 * _tmp88;
  const Scalar _tmp100 = fh1 * (-_tmp17 * _tmp98 + _tmp85 * _tmp99);
  const Scalar _tmp101 = Scalar(1.0) * _tmp76;
  const Scalar _tmp102 = _tmp31 * _tmp70;
  const Scalar _tmp103 = _tmp43 * (-_tmp101 * _tmp102 + _tmp101 * _tmp66);
  const Scalar _tmp104 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp105 = _tmp55 * _tmp57 + _tmp56;
  const Scalar _tmp106 = 0;
  const Scalar _tmp107 =
      std::exp(_tmp100 * _tmp103 + _tmp104 * _tmp43 * (-_tmp102 * _tmp106 + _tmp106 * _tmp66) +
               _tmp17 * _tmp91 + _tmp85 * _tmp97);
  const Scalar _tmp108 = _tmp17 * _tmp85;
  ...
  const Scalar _tmp112 = _tmp43 * _tmp96;
  const Scalar _tmp113 = _tmp110 * _tmp83;
  const Scalar _tmp114 = _tmp43 * _tmp82;
  const Scalar _tmp115 = _tmp109 * _tmp84;
  const Scalar _tmp116 = _tmp109 * _tmp16;
  const Scalar _tmp117 = _tmp108 * _tmp116 - _tmp115 * _tmp83 + _tmp98;
  const Scalar _tmp118 = _tmp103 * fh1;
  const Scalar _tmp119 = _tmp89 * _tmp95;
  const Scalar _tmp120 = _tmp80 * _tmp89;
  const Scalar _tmp121 = _tmp100 * _tmp101;
  const Scalar _tmp122 = _tmp104 * _tmp106;
  const Scalar _tmp123 =
      std::exp(-_tmp119 * _tmp85 - _tmp120 * _tmp17 + _tmp121 * _tmp70 + _tmp122 * _tmp70);
  const Scalar _tmp124 = _tmp101 * fh1;
  const Scalar _tmp125 = _tmp117 * _tmp124;
  const Scalar _tmp126 = _tmp72 * _tmp89;
  const Scalar _tmp127 = _tmp126 * _tmp78;
  const Scalar _tmp128 = _tmp126 * _tmp94;
  const Scalar _tmp129 = std::exp(-_tmp121 - _tmp122 - _tmp127 * _tmp17 - _tmp128 * _tmp85);
  const Scalar _tmp130 = _tmp72 * _tmp78;
  const Scalar _tmp131 = _tmp72 * _tmp94;
  const Scalar _tmp132 = -_tmp108 * _tmp115 + _tmp116 * _tmp86 - _tmp99;
  const Scalar _tmp133 = _tmp110 * _tmp86;
  const Scalar _tmp134 = _tmp124 * _tmp132;

  // Output terms (1)
  Eigen::Matrix<Scalar, 4, 3> _res;

  _res(0, 0) = 0;
  _res(1, 0) = -_tmp107 * (-_tmp111 * _tmp112 - _tmp113 * _tmp114 - _tmp117 * _tmp118 + _tmp91);
  _res(2, 0) = -_tmp123 * (_tmp111 * _tmp95 + _tmp113 * _tmp80 - _tmp120 - _tmp125 * _tmp70);
  _res(3, 0) = -_tmp129 * (_tmp111 * _tmp131 + _tmp113 * _tmp130 + _tmp125 - _tmp127);
  _res(0, 1) = 0;
  _res(1, 1) = -_tmp107 * (-_tmp111 * _tmp114 - _tmp112 * _tmp133 - _tmp118 * _tmp132 + _tmp97);
  _res(2, 1) = -_tmp123 * (_tmp111 * _tmp80 - _tmp119 + _tmp133 * _tmp95 - _tmp134 * _tmp70);
  _res(3, 1) = -_tmp129 * (_tmp111 * _tmp130 - _tmp128 + _tmp131 * _tmp133 + _tmp134);
  _res(0, 2) = 0;
  _res(1, 2) = 0;
  _res(2, 2) = 0;
  _res(3, 2) = 0;
