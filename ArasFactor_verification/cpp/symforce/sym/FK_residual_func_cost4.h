...
Eigen::Matrix<Scalar, 4, 1> FkResidualFuncCost4(
  ...
  const Scalar _tmp67 = _tmp49 * _tmp64 - _tmp61 * _tmp63;
  const Scalar _tmp68 = _tmp60 * _tmp63 + _tmp66 * _tmp67;
  ...
  const Scalar _tmp74 = -_tmp60 + _tmp62 * _tmp66 - _tmp68 * _tmp73;
  const Scalar _tmp75 = -_tmp45;
  const Scalar _tmp76 = _tmp48 + _tmp75;
  const Scalar _tmp77 = _tmp22 + _tmp50;
  const Scalar _tmp78 = _tmp77 + position_vector(0, 0);
  const Scalar _tmp79 = _tmp78 - p_d(0, 0);
  const Scalar _tmp80 = _tmp17 + _tmp5;
  ...
  const Scalar _tmp87 = _tmp63 * _tmp84 - _tmp86;
  const Scalar _tmp88 = _tmp65 * _tmp87;
  const Scalar _tmp89 = -_tmp63 * _tmp85 - _tmp67 * _tmp88 + _tmp76 * _tmp86;
  const Scalar _tmp90 = -_tmp62 * _tmp88 - _tmp73 * _tmp89 - _tmp76 * _tmp84 + _tmp85;
  const Scalar _tmp91 = Scalar(1.0) / (_tmp90);
  const Scalar _tmp92 = _tmp44 * _tmp58 - _tmp51 * _tmp64 + _tmp54 * _tmp58;
  const Scalar _tmp93 = _tmp44 * _tmp84 - _tmp77 * _tmp86 + _tmp80 * _tmp84 - _tmp88 * _tmp92;
  const Scalar _tmp94 = _tmp91 * _tmp93;
  const Scalar _tmp95 = Scalar(1.0) / (_tmp93);
  const Scalar _tmp96 = _tmp90 * _tmp95;
  const Scalar _tmp97 = _tmp96 * (-_tmp44 + _tmp66 * _tmp92 - _tmp74 * _tmp94);
  ...
  const Scalar _tmp102 = _tmp84 * _tmp91;
  ...
  const Scalar _tmp110 = -_tmp108 * _tmp62 + _tmp109 * _tmp73;
  ...
  const Scalar _tmp120 = _tmp69 * _tmp73 + _tmp72;
  ...
  const Scalar _tmp122 = -_tmp107 * _tmp43 * (_tmp100 * _tmp101 + _tmp102 * _tmp98 + Scalar(1.0)) -
                         ...
                         _tmp118 * _tmp43 * (-_tmp116 * _tmp117 + _tmp116 * _tmp84) -
                         _tmp119 * _tmp43 * (-_tmp117 * _tmp121 + _tmp121 * _tmp84);
  const Scalar _tmp123 = Scalar(1.0) / (_tmp122);
  const Scalar _tmp124 = fh1 * (_tmp59 + _tmp75);
  const Scalar _tmp125 = _tmp106 * _tmp124 + Scalar(5.1796800000000003) * _tmp25 + _tmp29 * fv1;
  ...
  const Scalar _tmp132 = -_tmp121 * _tmp89 - _tmp126 * _tmp131 + _tmp70;
  ...
  const Scalar _tmp136 = -_tmp114 * _tmp124 - Scalar(5.1796800000000003) * _tmp12 - _tmp18 * fv1;
  const Scalar _tmp137 = _tmp71 * (_tmp127 * _tmp129 + Scalar(1.0));
  const Scalar _tmp138 = _tmp129 * _tmp73;
  ...
  const Scalar _tmp142 = _tmp139 * _tmp97 - _tmp140 * _tmp98 + _tmp68;
  ...
  const Scalar _tmp150 =
      std::asinh(_tmp148 * (_tmp107 * _tmp142 * _tmp71 + _tmp115 * _tmp141 * _tmp71 +
                            _tmp118 * _tmp135 * _tmp71 + _tmp119 * _tmp132 * _tmp71 -
                            _tmp130 * _tmp149 + _tmp136 * _tmp137));
