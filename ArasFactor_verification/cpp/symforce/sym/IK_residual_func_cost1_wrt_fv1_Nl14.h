...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1WrtFv1Nl14(
  ...
  const Scalar _tmp65 = -Scalar(0.20999999999999999) * _tmp11 + Scalar(0.20999999999999999) * _tmp9;
  ...
  const Scalar _tmp79 = _tmp60 * (-_tmp50 * _tmp67 + _tmp50 * _tmp69);
  ...
  const Scalar _tmp84 = _tmp22 + _tmp42;
  ...
  const Scalar _tmp106 = _tmp50 * _tmp60;
  ...
  const Scalar _tmp117 = _tmp56 * (_tmp115 * _tmp88 - _tmp116 * _tmp50);
  ...
  const Scalar _tmp128 = -_tmp111 * _tmp56 * (_tmp102 * _tmp103 + _tmp105 * _tmp106 + Scalar(1.0)) -
                         _tmp112 * _tmp117 -
                         _tmp120 * _tmp56 * (-_tmp118 * _tmp50 * _tmp92 + _tmp118 * _tmp88) -
  ...
  const Scalar _tmp131 = -_tmp119 * _tmp130 - Scalar(5.1796800000000003) * _tmp25 - _tmp30 * fv1;
  ...
  const Scalar _tmp148 = _tmp110 * _tmp130 + Scalar(5.1796800000000003) * _tmp12 + _tmp19 * fv1;
  ...
  const Scalar _tmp160 = _tmp26 + _tmp33 + _tmp41;
  const Scalar _tmp161 =
      (_tmp129 * (_tmp138 * _tmp160 - _tmp144 + _tmp150 * _tmp19) - _tmp151 * _tmp159) /
  ...
  const Scalar _tmp181 =
      (_tmp166 * (-_tmp143 - _tmp149 * _tmp180 + _tmp160 * _tmp167) - _tmp169 * _tmp179) /
  ...
  const Scalar _tmp185 = -_tmp101 * _tmp111 * _tmp134 + _tmp112 * _tmp142 - _tmp120 * _tmp146 -
  ...
  const Scalar _tmp189 = (_tmp184 * _tmp185 + _tmp186 * (-_tmp137 * _tmp160 - _tmp142 + _tmp180)) /
  ...
  _res(1, 0) =
      -_tmp153 *
          (-Scalar(0.876505537412406) * _tmp159 + Scalar(1.0) * _tmp161 * std::sinh(_tmp162) -
           (-Scalar(0.1034955) * _tmp154 * _tmp159 +
            _tmp155 * (-_tmp152 * _tmp157 - _tmp153 * _tmp161)) *
               std::sinh(_tmp156)) -
      _tmp157 * (Scalar(0.876505537412406) * _tmp129 - std::cosh(_tmp156) + std::cosh(_tmp162));
  _res(2, 0) =
      -_tmp172 *
          (-Scalar(0.87679799777269396) * _tmp179 + Scalar(1.0) * _tmp181 * std::sinh(_tmp171) -
           (-Scalar(0.1034955) * _tmp173 * _tmp179 +
            _tmp174 * (-_tmp170 * _tmp177 - _tmp172 * _tmp181)) *
               std::sinh(_tmp175)) -
      _tmp177 * (Scalar(0.87679799777269396) * _tmp166 + std::cosh(_tmp171) - std::cosh(_tmp175));
  _res(3, 0) =
      _tmp176 * (Scalar(0.86627065637365697) * _tmp186 + std::cosh(_tmp188) - std::cosh(_tmp193)) -
      _tmp190 *
          (Scalar(0.86627065637365697) * _tmp184 + Scalar(1.0) * _tmp189 * std::sinh(_tmp188) -
           (Scalar(0.1034955) * _tmp184 * _tmp191 +
            _tmp192 * (_tmp176 * _tmp187 - _tmp189 * _tmp190)) *
               std::sinh(_tmp193));
