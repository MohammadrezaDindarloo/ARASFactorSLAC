...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2WrtFv1Nl14(
  ...
  const Scalar _tmp34 = _tmp14 - _tmp17;
  ...
  const Scalar _tmp42 = _tmp35 + position_vector(0, 0);
  ...
  const Scalar _tmp47 = _tmp18 + _tmp33;
  ...
  const Scalar _tmp58 = -_tmp35 * _tmp45 + _tmp39 * _tmp46 + _tmp46 * _tmp57;
  ...
  const Scalar _tmp91 = _tmp59 * _tmp88 - _tmp90;
  const Scalar _tmp92 = _tmp60 * _tmp91;
  const Scalar _tmp93 = _tmp62 + _tmp66;
  const Scalar _tmp94 = -_tmp59 * _tmp89 - _tmp71 * _tmp92 + _tmp90 * _tmp93;
  const Scalar _tmp95 = -_tmp78 * _tmp94 - _tmp79 * _tmp91 - _tmp88 * _tmp93 + _tmp89;
  const Scalar _tmp96 = Scalar(1.0) / (_tmp95);
  const Scalar _tmp97 = _tmp57 * _tmp88 - _tmp58 * _tmp92 - _tmp81 * _tmp90 + _tmp84 * _tmp88;
  const Scalar _tmp98 = _tmp96 * _tmp97;
  const Scalar _tmp99 = Scalar(1.0) / (_tmp97);
  const Scalar _tmp100 = _tmp95 * _tmp99;
  const Scalar _tmp101 = _tmp100 * (-_tmp57 + _tmp58 * _tmp61 - _tmp80 * _tmp98);
  const Scalar _tmp102 = _tmp101 + _tmp80;
  const Scalar _tmp103 = _tmp88 * _tmp96;
  const Scalar _tmp104 = _tmp91 * _tmp96;
  const Scalar _tmp105 = -_tmp102 * _tmp104 - _tmp59;
  const Scalar _tmp106 = _tmp46 * _tmp60;
  const Scalar _tmp107 = _tmp20 + Scalar(-2.7171519410699099);
  const Scalar _tmp108 = _tmp31 + Scalar(-4.7744369927459998);
  ...
  const Scalar _tmp117 = _tmp56 * (_tmp115 * _tmp88 - _tmp116 * _tmp46);
  const Scalar _tmp118 = Scalar(1.0) * _tmp99;
  const Scalar _tmp119 = _tmp108 * _tmp109;
  const Scalar _tmp120 = fh1 * (-_tmp110 * _tmp30 + _tmp119 * _tmp19);
  const Scalar _tmp121 = Scalar(1.0) * _tmp75;
  const Scalar _tmp122 = _tmp121 * _tmp60 * _tmp71 * _tmp77 - Scalar(1.0) * _tmp79;
  const Scalar _tmp123 = Scalar(1.0) * _tmp60;
  const Scalar _tmp124 = _tmp100 * (-_tmp122 * _tmp98 - _tmp123 * _tmp58);
  const Scalar _tmp125 = _tmp122 + _tmp124;
  const Scalar _tmp126 = -_tmp104 * _tmp125 + Scalar(1.0);
  const Scalar _tmp127 = _tmp119 * fh1;
  const Scalar _tmp128 = -_tmp111 * _tmp56 * (_tmp102 * _tmp103 + _tmp105 * _tmp106 + Scalar(1.0)) -
                         _tmp112 * _tmp117 -
                         _tmp120 * _tmp56 * (-_tmp118 * _tmp46 * _tmp92 + _tmp118 * _tmp88) -
                         _tmp127 * _tmp56 * (_tmp103 * _tmp125 + _tmp106 * _tmp126);
  const Scalar _tmp129 = Scalar(1.0) / (_tmp128);
  const Scalar _tmp130 = fh1 * (_tmp62 + _tmp68);
  const Scalar _tmp131 = -_tmp119 * _tmp130 - Scalar(5.1796800000000003) * _tmp24 - _tmp30 * fv1;
  const Scalar _tmp132 = _tmp74 + _tmp84;
  const Scalar _tmp133 = _tmp132 * _tmp78;
  const Scalar _tmp134 = Scalar(1.0) / (-_tmp133 + _tmp76 - _tmp81);
  const Scalar _tmp135 = Scalar(1.0) * _tmp134;
  const Scalar _tmp136 = _tmp133 * _tmp135 + Scalar(1.0);
  const Scalar _tmp137 = _tmp135 * _tmp78;
  ...
  const Scalar _tmp141 = _tmp101 * _tmp139 - _tmp102 * _tmp140 + _tmp72;
  const Scalar _tmp142 = _tmp113 * _tmp134;
  const Scalar _tmp143 = _tmp75 * (-_tmp114 * _tmp140 - _tmp132 * _tmp142 + _tmp74);
  const Scalar _tmp144 = -Scalar(1.0) * _tmp142 - Scalar(1.0) * _tmp143 + Scalar(1.0);
  const Scalar _tmp145 = -_tmp123 * _tmp71 + _tmp124 * _tmp139 - _tmp125 * _tmp140;
  const Scalar _tmp146 = _tmp100 * _tmp135;
  const Scalar _tmp147 = -_tmp118 * _tmp94 + _tmp132 * _tmp146;
  const Scalar _tmp148 = _tmp110 * _tmp130 + Scalar(5.1796800000000003) * _tmp13 + _tmp19 * fv1;
  const Scalar _tmp149 = _tmp132 * _tmp75;
  const Scalar _tmp150 = Scalar(1.0) * _tmp135 * _tmp149 - Scalar(1.0) * _tmp135;
  const Scalar _tmp151 = Scalar(1.0) * _tmp111 * (_tmp101 * _tmp135 - _tmp121 * _tmp141) +
                         _tmp112 * _tmp144 +
                         Scalar(1.0) * _tmp120 * (-_tmp121 * _tmp147 + _tmp146) +
                         Scalar(1.0) * _tmp127 * (-_tmp121 * _tmp145 + _tmp124 * _tmp135) +
                         _tmp131 * _tmp138 + _tmp148 * _tmp150;
  ...
  const Scalar _tmp161 = _tmp25 + _tmp36 + _tmp37;
  const Scalar _tmp162 =
      (_tmp129 * (_tmp138 * _tmp161 - _tmp144 + _tmp150 * _tmp19) - _tmp151 * _tmp160) /
  ...
  const Scalar _tmp165 =
      _tmp105 * _tmp111 * _tmp60 + _tmp126 * _tmp127 * _tmp60 - _tmp163 * _tmp92 - _tmp164 * _tmp92;
  const Scalar _tmp166 = Scalar(1.0) / (_tmp165);
  const Scalar _tmp167 = _tmp136 * _tmp75;
  const Scalar _tmp168 = _tmp135 * _tmp148;
  const Scalar _tmp169 = _tmp111 * _tmp141 * _tmp75 + _tmp112 * _tmp143 +
                         _tmp120 * _tmp147 * _tmp75 + _tmp127 * _tmp145 * _tmp75 +
                         _tmp131 * _tmp167 - _tmp149 * _tmp168;
  ...
  const Scalar _tmp176 = Scalar(9.6622558468725703) * _tmp115;
  const Scalar _tmp177 = _tmp176 * _tmp92;
  const Scalar _tmp178 = std::pow(_tmp165, Scalar(-2));
  const Scalar _tmp179 = _tmp116 * _tmp178;
  const Scalar _tmp180 = _tmp135 * _tmp19;
  const Scalar _tmp181 =
      (_tmp166 * (-_tmp143 - _tmp149 * _tmp180 + _tmp161 * _tmp167) - _tmp169 * _tmp179) /
      std::sqrt(Scalar(std::pow(_tmp169, Scalar(2)) * _tmp178 + 1));
  const Scalar _tmp182 = -_tmp101 * _tmp111 * _tmp134 + _tmp112 * _tmp142 - _tmp120 * _tmp146 -
                         _tmp124 * _tmp127 * _tmp134 - _tmp131 * _tmp137 + _tmp168;
  const Scalar _tmp183 =
      _tmp102 * _tmp111 * _tmp96 + _tmp125 * _tmp127 * _tmp96 + _tmp163 + _tmp164;
  ...
  const Scalar _tmp189 = (_tmp182 * _tmp188 + _tmp184 * (-_tmp137 * _tmp161 - _tmp142 + _tmp180)) /
                         std::sqrt(Scalar(std::pow(_tmp182, Scalar(2)) * _tmp187 + 1));
  ...
  _res(3, 0) = -_tmp176 * (-std::sinh(_tmp186) - std::sinh(_tmp193)) +
