...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl14(
  ...
  const Scalar _tmp17 = _tmp16 + position_vector(0, 0) + Scalar(-2.5193355532036801);
  ...
  const Scalar _tmp27 = _tmp26 + position_vector(1, 0) + Scalar(8.3885017487099702);
  ...
  const Scalar _tmp38 = Scalar(1.0) / (_tmp28 * _tmp37 - _tmp36);
  const Scalar _tmp39 =
      std::sqrt(Scalar(std::pow(_tmp17, Scalar(2)) + std::pow(_tmp27, Scalar(2))));
  const Scalar _tmp40 = Scalar(1.0) / (_tmp39);
  const Scalar _tmp41 = _tmp18 * _tmp39;
  const Scalar _tmp42 = _tmp41 * (_tmp16 * _tmp27 * _tmp40 - _tmp17 * _tmp26 * _tmp40);
  const Scalar _tmp43 = _tmp38 * (_tmp30 * _tmp37 - _tmp33 * _tmp36 + _tmp37 * _tmp42);
  ...
  const Scalar _tmp50 = _tmp45 + _tmp46 + _tmp47;
  const Scalar _tmp51 = _tmp37 * _tmp50;
  const Scalar _tmp52 = _tmp38 * (-_tmp28 * _tmp51 + _tmp36 * _tmp49);
  const Scalar _tmp53 = Scalar(1.0) * _tmp26;
  const Scalar _tmp54 = Scalar(1.0) * _tmp16;
  const Scalar _tmp55 = (-_tmp33 + _tmp54) / (_tmp30 - _tmp53);
  const Scalar _tmp56 = _tmp38 * (-_tmp37 * _tmp49 + _tmp51);
  const Scalar _tmp57 = _tmp28 * _tmp56 - _tmp50 - _tmp55 * (_tmp28 * _tmp50 + _tmp28 * _tmp52);
  const Scalar _tmp58 = _tmp32 + _tmp6;
  const Scalar _tmp59 = _tmp58 + position_vector(0, 0) + Scalar(1.7965602546229);
  const Scalar _tmp60 = _tmp21 + _tmp24;
  const Scalar _tmp61 = _tmp29 + _tmp60;
  const Scalar _tmp62 = _tmp61 + position_vector(1, 0) + Scalar(-4.83288938413423);
  ...
  const Scalar _tmp67 = _tmp42 * _tmp64 - _tmp43 * _tmp66 - _tmp58 * _tmp65 + _tmp61 * _tmp64;
  const Scalar _tmp68 = _tmp50 * _tmp64;
  const Scalar _tmp69 = _tmp44 + _tmp48;
  const Scalar _tmp70 = -_tmp55 * (-_tmp28 * _tmp68 - _tmp52 * _tmp66 + _tmp65 * _tmp69) -
                        _tmp56 * _tmp66 - _tmp64 * _tmp69 + _tmp68;
  const Scalar _tmp71 = Scalar(1.0) / (_tmp70);
  const Scalar _tmp72 = _tmp67 * _tmp71;
  const Scalar _tmp73 = Scalar(1.0) / (_tmp67);
  const Scalar _tmp74 = _tmp70 * _tmp73;
  const Scalar _tmp75 = _tmp57 + _tmp74 * (_tmp28 * _tmp43 - _tmp42 - _tmp57 * _tmp72);
  const Scalar _tmp76 = _tmp64 * _tmp71;
  const Scalar _tmp77 = _tmp66 * _tmp71;
  const Scalar _tmp78 = -_tmp28 - _tmp75 * _tmp77;
  const Scalar _tmp79 = _tmp37 * _tmp38;
  const Scalar _tmp80 = _tmp15 + _tmp6;
  const Scalar _tmp81 = _tmp80 + position_vector(0, 0) + Scalar(-2.7171519410699099);
  const Scalar _tmp82 = _tmp19 + _tmp60;
  ...
  const Scalar _tmp86 = _tmp41 * fh1;
  ...
  const Scalar _tmp92 = Scalar(1.0) * _tmp73;
  const Scalar _tmp93 = _tmp83 * _tmp84;
  const Scalar _tmp94 = fh1 * (_tmp80 * _tmp93 - _tmp82 * _tmp85);
  const Scalar _tmp95 = Scalar(1.0) * _tmp52 * _tmp55 - Scalar(1.0) * _tmp56;
  const Scalar _tmp96 = _tmp74 * (-Scalar(1.0) * _tmp43 - _tmp72 * _tmp95) + _tmp95;
  const Scalar _tmp97 = -_tmp77 * _tmp96 + Scalar(1.0);
  const Scalar _tmp98 = _tmp38 * fh1;
  const Scalar _tmp99 = _tmp92 * _tmp94;
  const Scalar _tmp100 = _tmp71 * fh1;

  // Output terms (1)
  Eigen::Matrix<Scalar, 4, 1> _res;

  _res(0, 0) = std::exp(-fh1);
  _res(1, 0) = std::exp(_tmp41 * _tmp87 * (_tmp64 * _tmp90 - _tmp79 * _tmp91) +
                        _tmp41 * _tmp94 * (_tmp64 * _tmp92 - _tmp66 * _tmp79 * _tmp92) +
                        _tmp85 * _tmp86 * (_tmp75 * _tmp76 + _tmp78 * _tmp79 + Scalar(1.0)) +
                        _tmp86 * _tmp93 * (_tmp76 * _tmp96 + _tmp79 * _tmp97));
  _res(2, 0) = std::exp(_tmp38 * _tmp66 * _tmp99 + _tmp38 * _tmp87 * _tmp91 -
                        _tmp78 * _tmp85 * _tmp98 - _tmp93 * _tmp97 * _tmp98);
  _res(3, 0) =
      std::exp(-_tmp100 * _tmp75 * _tmp85 - _tmp100 * _tmp93 * _tmp96 - _tmp87 * _tmp90 - _tmp99);
