...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl2(
  ...
  const Scalar _tmp34 = _tmp33 + position_vector(0, 0) + Scalar(-2.7171519410699099);
  const Scalar _tmp35 =
  ...
  const Scalar _tmp40 = _tmp16 * _tmp29 - _tmp26 * _tmp30 + _tmp29 * _tmp39;
  ...
  const Scalar _tmp51 = -_tmp29 * _tmp50 + _tmp30 * _tmp49;
  const Scalar _tmp52 = Scalar(1.0) * _tmp31;
  const Scalar _tmp53 = Scalar(1.0) * _tmp33;
  const Scalar _tmp54 = (-_tmp26 + _tmp53) / (_tmp16 - _tmp52);
  const Scalar _tmp55 = _tmp29 * _tmp48 - _tmp29 * _tmp49;
  const Scalar _tmp56 = _tmp43 * _tmp55 - _tmp48 - _tmp54 * (_tmp43 * _tmp51 + _tmp50);
  ...
  const Scalar _tmp65 = _tmp44 + _tmp45 - _tmp46;
  const Scalar _tmp66 = _tmp62 * _tmp63;
  const Scalar _tmp67 = _tmp41 * _tmp64 - _tmp66;
  ...
  const Scalar _tmp71 = _tmp39 * _tmp64 - _tmp40 * _tmp68 - _tmp58 * _tmp66 + _tmp61 * _tmp64;
  const Scalar _tmp72 = _tmp70 * _tmp71;
  const Scalar _tmp73 = Scalar(1.0) / (_tmp71);
  const Scalar _tmp74 = _tmp69 * _tmp73;
  const Scalar _tmp75 = _tmp56 + _tmp74 * (-_tmp39 + _tmp40 * _tmp43 - _tmp56 * _tmp72);
  const Scalar _tmp76 = _tmp64 * _tmp70;
  const Scalar _tmp77 = _tmp67 * _tmp70;
  const Scalar _tmp78 = -_tmp41 - _tmp75 * _tmp77;
  const Scalar _tmp79 = _tmp29 * _tmp42;
  const Scalar _tmp80 = _tmp19 + _tmp57;
  const Scalar _tmp81 = _tmp80 + position_vector(0, 0) + Scalar(1.9874742031097401);
  const Scalar _tmp82 = _tmp5 + _tmp60;
  ...
  const Scalar _tmp91 = _tmp38 * (-_tmp29 * _tmp90 + _tmp64 * _tmp89);
  const Scalar _tmp92 = Scalar(1.0) * _tmp73;
  const Scalar _tmp93 = Scalar(1.0) * _tmp42;
  const Scalar _tmp94 = _tmp67 * _tmp73 * _tmp93;
  const Scalar _tmp95 = _tmp83 * _tmp84;
  const Scalar _tmp96 = fh1 * (_tmp80 * _tmp95 - _tmp82 * _tmp85);
  const Scalar _tmp97 = _tmp51 * _tmp54 * _tmp93 - _tmp55 * _tmp93;
  const Scalar _tmp98 = _tmp74 * (-_tmp40 * _tmp93 - _tmp72 * _tmp97) + _tmp97;
  ...
  _res(0, 0) = 0;
  _res(1, 0) =
      -_tmp91 * std::exp(_tmp100 * _tmp38 * (_tmp76 * _tmp98 + _tmp79 * _tmp99) +
                         _tmp38 * _tmp86 * (_tmp75 * _tmp76 + _tmp78 * _tmp79 + Scalar(1.0)) +
                         _tmp38 * _tmp96 * (-_tmp29 * _tmp94 + _tmp64 * _tmp92) + _tmp87 * _tmp91);
  _res(2, 0) = -_tmp90 * std::exp(-_tmp100 * _tmp42 * _tmp99 + _tmp101 * _tmp68 -
                                  _tmp42 * _tmp78 * _tmp86 + _tmp94 * _tmp96);
  _res(3, 0) = _tmp89 * std::exp(-_tmp100 * _tmp70 * _tmp98 - _tmp101 - _tmp70 * _tmp75 * _tmp86 -
                                 _tmp92 * _tmp96);
