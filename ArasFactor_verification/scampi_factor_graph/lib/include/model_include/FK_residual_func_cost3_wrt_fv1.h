...
Eigen::Matrix<Scalar, 4, 1> FkResidualFuncCost3WrtFv1(
  ...
  const Scalar _tmp37 = _tmp15 + _tmp7;
  ...
  const Scalar _tmp44 = _tmp32 + _tmp33 - _tmp34;
  ...
  const Scalar _tmp56 = -_tmp32 + _tmp35;
  ...
  const Scalar _tmp68 = _tmp44 * _tmp64 - _tmp45 * _tmp67 -
                        _tmp54 * (-_tmp50 * _tmp64 - _tmp51 * _tmp67 + _tmp56 * _tmp65) -
                        _tmp56 * _tmp64;
  const Scalar _tmp69 = Scalar(1.0) / (_tmp68);
  const Scalar _tmp70 = _tmp31 * _tmp43 - _tmp37 * _tmp47 + _tmp40 * _tmp43;
  const Scalar _tmp71 = _tmp31 * _tmp64 - _tmp58 * _tmp65 + _tmp61 * _tmp64 - _tmp67 * _tmp70;
  const Scalar _tmp72 = _tmp69 * _tmp71;
  const Scalar _tmp73 = Scalar(1.0) / (_tmp71);
  const Scalar _tmp74 = _tmp68 * _tmp73;
  const Scalar _tmp75 = _tmp55 + _tmp74 * (-_tmp31 + _tmp49 * _tmp70 - _tmp55 * _tmp72);
  const Scalar _tmp76 = _tmp66 * _tmp69;
  const Scalar _tmp77 = -_tmp46 - _tmp75 * _tmp76;
  const Scalar _tmp78 = _tmp43 * _tmp48;
  const Scalar _tmp79 = _tmp64 * _tmp69;
  const Scalar _tmp80 = _tmp57 + _tmp8;
  const Scalar _tmp81 = _tmp80 - p_a(0, 0) + position_vector(0, 0);
  const Scalar _tmp82 = _tmp24 + _tmp60;
  ...
  const Scalar _tmp88 = -_tmp45 * _tmp87 + _tmp51 * _tmp54 * _tmp87;
  ...
  const Scalar _tmp94 = fh1 * (_tmp80 * _tmp91 - _tmp82 * _tmp85);
  const Scalar _tmp95 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp96 = _tmp52 * _tmp54 + _tmp53;
  const Scalar _tmp97 = 0;
  const Scalar _tmp98 = _tmp67 * _tmp97;
  const Scalar _tmp99 = _tmp30 * (-_tmp43 * _tmp98 + _tmp64 * _tmp97);
  ...
  _res(1, 0) =
      -_tmp99 *
      std::exp(_tmp30 * _tmp86 * (_tmp75 * _tmp79 + _tmp77 * _tmp78 + Scalar(1.0)) +
               _tmp30 * _tmp92 * (_tmp78 * _tmp90 + _tmp79 * _tmp89) +
               _tmp30 * _tmp94 * (-_tmp43 * _tmp67 * _tmp93 + _tmp64 * _tmp93) + _tmp95 * _tmp99);
  _res(2, 0) = -_tmp98 * std::exp(_tmp100 * _tmp67 + _tmp101 * _tmp67 - _tmp48 * _tmp77 * _tmp86 -
                                  _tmp48 * _tmp90 * _tmp92);
  _res(3, 0) =
      _tmp97 * std::exp(-_tmp100 - _tmp101 - _tmp69 * _tmp75 * _tmp86 - _tmp69 * _tmp89 * _tmp92);
