 ...
 *
 * Symbolic function: FK_residual_func_cost5_wrt_pa
 *
 * Args:
 *     fh1: Scalar
 *     fv1: Scalar
...
Eigen::Matrix<Scalar, 4, 3> FkResidualFuncCost5WrtPa(
  ...
  const Scalar _tmp16 =
      ...
      Scalar(0.010999999999999999) * _tmp14 + Scalar(0.20999999999999999) * _tmp9 + p_a(1, 0) -
