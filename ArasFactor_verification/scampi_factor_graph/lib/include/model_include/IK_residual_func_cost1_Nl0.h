...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl0(
  ...
  const Scalar _tmp71 = -_tmp57 * _tmp67 + _tmp69 * _tmp70;
  const Scalar _tmp72 = _tmp45 * _tmp46;
  const Scalar _tmp73 = _tmp47 * _tmp57 - _tmp72;
  const Scalar _tmp74 = Scalar(1.0) / (_tmp57 * _tmp66 - _tmp70);
  const Scalar _tmp75 = _tmp73 * _tmp74;
  const Scalar _tmp76 = _tmp57 * _tmp58;
  const Scalar _tmp77 = _tmp34 + _tmp68;
  const Scalar _tmp78 = -_tmp47 * _tmp76 - _tmp71 * _tmp75 + _tmp72 * _tmp77;
  ...
  const Scalar _tmp84 = -_tmp66 * _tmp69 + _tmp67;
  const Scalar _tmp85 = _tmp47 * _tmp58 - _tmp47 * _tmp77 - _tmp75 * _tmp84 - _tmp78 * _tmp83;
  const Scalar _tmp86 = Scalar(1.0) / (_tmp85);
  const Scalar _tmp87 = _tmp79 * _tmp83 + _tmp82;
  const Scalar _tmp88 = 0;
  const Scalar _tmp89 = _tmp86 * _tmp88;
  const Scalar _tmp90 = _tmp66 * _tmp74;
  ...
  const Scalar _tmp96 = _tmp94 * (_tmp49 * _tmp56 * _tmp95 - _tmp51 * _tmp54 * _tmp95);
  const Scalar _tmp97 = _tmp59 * _tmp66 - _tmp62 * _tmp70 + _tmp66 * _tmp96;
  const Scalar _tmp98 = Scalar(1.0) * _tmp74;
  const Scalar _tmp99 = _tmp71 * _tmp98;
  const Scalar _tmp100 = _tmp83 * _tmp99 - _tmp84 * _tmp98;
  const Scalar _tmp101 = -_tmp40 * _tmp72 + _tmp43 * _tmp47 + _tmp47 * _tmp96 - _tmp75 * _tmp97;
  ...
  const Scalar _tmp107 = _tmp47 * _tmp86;
  const Scalar _tmp108 = -_tmp106 * _tmp91 + Scalar(1.0);
  const Scalar _tmp109 = _tmp31 + Scalar(1.9874742031097401);
  const Scalar _tmp110 = _tmp20 + Scalar(8.3196563720703107);
  ...
  const Scalar _tmp115 = _tmp103 * _tmp73 * _tmp98;
  const Scalar _tmp116 = _tmp109 * _tmp111;
  const Scalar _tmp117 = fh1 * (_tmp112 * _tmp30 - _tmp116 * _tmp19);
  const Scalar _tmp118 = _tmp57 * _tmp74;
  const Scalar _tmp119 = _tmp118 * _tmp71 + _tmp76;
  const Scalar _tmp120 = _tmp118 * _tmp84 - _tmp119 * _tmp83 - _tmp58;
  ...
  const Scalar _tmp125 = -_tmp113 * _tmp94 * (_tmp106 * _tmp107 + _tmp108 * _tmp90) -
                         _tmp117 * _tmp94 * (_tmp114 * _tmp47 - _tmp115 * _tmp66) -
                         _tmp124 * _tmp94 * (_tmp107 * _tmp122 + _tmp123 * _tmp90 + Scalar(1.0)) -
                         _tmp39 * _tmp94 * (_tmp47 * _tmp89 - _tmp90 * _tmp92);
  const Scalar _tmp126 = Scalar(1.0) / (_tmp125);
  const Scalar _tmp127 = _tmp38 * fh1;
  const Scalar _tmp128 = _tmp116 * _tmp127 + Scalar(3.29616) * _tmp27 + _tmp30 * fv1;
  const Scalar _tmp129 = _tmp43 + _tmp80;
  const Scalar _tmp130 = _tmp129 * _tmp83;
  const Scalar _tmp131 = Scalar(1.0) / (-_tmp130 - _tmp40 + _tmp82);
  const Scalar _tmp132 = Scalar(1.0) * _tmp131;
  const Scalar _tmp133 = _tmp129 * _tmp81;
  const Scalar _tmp134 = _tmp129 * _tmp131;
  const Scalar _tmp135 = _tmp78 * _tmp86;
  ...
  const Scalar _tmp139 = _tmp81 * (-_tmp129 * _tmp138 - _tmp78 * _tmp89 + _tmp80);
  const Scalar _tmp140 = _tmp105 * _tmp134 - _tmp106 * _tmp135 - _tmp99;
  const Scalar _tmp141 = _tmp104 * _tmp132;
  const Scalar _tmp142 = -_tmp114 * _tmp78 + _tmp129 * _tmp141;
  const Scalar _tmp143 = _tmp130 * _tmp132 + Scalar(1.0);
  const Scalar _tmp144 = _tmp132 * _tmp83;
  const Scalar _tmp145 = -_tmp112 * _tmp127 - Scalar(3.29616) * _tmp13 - _tmp19 * fv1;
  const Scalar _tmp146 = std::asinh(
      _tmp126 * (Scalar(1.0) * _tmp113 * (_tmp105 * _tmp132 - _tmp137 * _tmp140) +
                 Scalar(1.0) * _tmp117 * (-_tmp137 * _tmp142 + _tmp141) +
                 Scalar(1.0) * _tmp124 * (_tmp121 * _tmp132 - _tmp136 * _tmp137) +
                 Scalar(1.0) * _tmp128 * (_tmp132 * _tmp133 - _tmp132) +
                 Scalar(1.0) * _tmp145 * (-_tmp137 * _tmp143 + _tmp144) +
                 Scalar(1.0) * _tmp39 * (-_tmp132 * _tmp87 - Scalar(1.0) * _tmp139 + Scalar(1.0))));
  const Scalar _tmp147 = Scalar(9.6622558468725703) * _tmp125;
  const Scalar _tmp148 = _tmp108 * _tmp113 * _tmp74 - _tmp115 * _tmp117 +
                         _tmp123 * _tmp124 * _tmp74 - _tmp39 * _tmp74 * _tmp92;
  const Scalar _tmp149 = Scalar(1.0) / (_tmp148);
  const Scalar _tmp150 = _tmp128 * _tmp132;
  const Scalar _tmp151 =
      std::asinh(_tmp149 * (_tmp113 * _tmp140 * _tmp81 + _tmp117 * _tmp142 * _tmp81 +
                            _tmp124 * _tmp136 * _tmp81 - _tmp133 * _tmp150 + _tmp139 * _tmp39 +
                            _tmp143 * _tmp145 * _tmp81));
  const Scalar _tmp152 = Scalar(9.6622558468725703) * _tmp148;
  const Scalar _tmp153 =
      _tmp106 * _tmp113 * _tmp86 + _tmp114 * _tmp117 + _tmp122 * _tmp124 * _tmp86 + _tmp39 * _tmp89;
  const Scalar _tmp154 = Scalar(1.0) / (_tmp153);
  const Scalar _tmp155 = std::asinh(_tmp154 * (-_tmp105 * _tmp113 * _tmp131 - _tmp117 * _tmp141 -
                                               _tmp121 * _tmp124 * _tmp131 + _tmp138 * _tmp39 -
  ...
  _res(1, 0) =
      -_tmp147 *
          (Scalar(0.876505537412406) * _tmp126 + std::cosh(Scalar(1.0) * _tmp146) -
           std::cosh(
               ...
               (-_tmp146 * _tmp147 -
                Scalar(8.3885017487099702) *
                    std::sqrt(Scalar(
                        ...
                        std::pow(Scalar(-Scalar(0.11921079949155229) * _tmp55 - 1),
                                 Scalar(2))))))) +
                ...
                Scalar(4.83288938413423) *
                    std::sqrt(Scalar(
                        ...
                        Scalar(0.13818785160942856) *
                            std::pow(Scalar(-Scalar(0.55661923802822921) * _tmp41 - 1),
                                     Scalar(2))))))) +
