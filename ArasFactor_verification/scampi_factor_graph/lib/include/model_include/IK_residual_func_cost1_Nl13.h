...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl13(
  ...
  const Scalar _tmp59 = _tmp39 * _tmp44;
  const Scalar _tmp60 = _tmp16 + _tmp50;
  const Scalar _tmp61 = _tmp60 + position_vector(0, 0);
  const Scalar _tmp62 = _tmp61 + Scalar(1.7965602546229);
  const Scalar _tmp63 = _tmp20 + _tmp46;
  ...
  const Scalar _tmp69 = _tmp58 * _tmp67 - _tmp60 * _tmp68 + _tmp63 * _tmp67;
  const Scalar _tmp70 = _tmp49 * _tmp56;
  ...
  const Scalar _tmp74 = _tmp37 * _tmp45 - _tmp41 * _tmp59 + _tmp45 * _tmp58 - _tmp69 * _tmp73;
  ...
  const Scalar _tmp91 = -_tmp67 * _tmp90 + _tmp68 * _tmp89;
  const Scalar _tmp92 = -_tmp45 * _tmp90 + _tmp59 * _tmp86 - _tmp73 * _tmp91;
  const Scalar _tmp93 = Scalar(1.0) * _tmp47;
  const Scalar _tmp94 = -_tmp93;
  const Scalar _tmp95 = Scalar(1.0) / (_tmp63 + _tmp94);
  const Scalar _tmp96 = Scalar(1.0) * _tmp51;
  const Scalar _tmp97 = _tmp95 * (-_tmp60 + _tmp96);
  const Scalar _tmp98 = _tmp67 * _tmp88 - _tmp67 * _tmp89;
  const Scalar _tmp99 = -_tmp45 * _tmp86 + _tmp45 * _tmp88 - _tmp73 * _tmp98 - _tmp92 * _tmp97;
  ...
  const Scalar _tmp106 = -_tmp104 * _tmp98 + _tmp105 * _tmp97;
  const Scalar _tmp107 = _tmp100 * _tmp74;
  const Scalar _tmp108 = _tmp75 * _tmp99;
  const Scalar _tmp109 = _tmp108 * (-_tmp104 * _tmp69 - _tmp106 * _tmp107);
  const Scalar _tmp110 = _tmp106 + _tmp109;
  const Scalar _tmp111 = _tmp100 * _tmp45;
  const Scalar _tmp112 = _tmp100 * _tmp71;
  ...
  const Scalar _tmp117 = _tmp116 * _tmp91 + _tmp90;
  const Scalar _tmp118 = _tmp116 * _tmp98 - _tmp117 * _tmp97 - _tmp88;
  const Scalar _tmp119 = _tmp108 * (-_tmp107 * _tmp118 + _tmp116 * _tmp69 - _tmp58);
  const Scalar _tmp120 = _tmp118 + _tmp119;
  const Scalar _tmp121 = -_tmp112 * _tmp120 - _tmp70;
  const Scalar _tmp122 = _tmp82 * fh1;
  const Scalar _tmp123 = -_tmp115 * _tmp57 * (_tmp110 * _tmp111 + _tmp113 * _tmp114) -
                         _tmp122 * _tmp57 * (_tmp111 * _tmp120 + _tmp114 * _tmp121 + Scalar(1.0)) -
                         _tmp57 * _tmp83 * (_tmp45 * _tmp76 - _tmp76 * _tmp77) -
                         _tmp57 * _tmp84 * (_tmp103 * _tmp45 - _tmp103 * _tmp77);
  const Scalar _tmp124 = Scalar(1.0) / (_tmp123);
  const Scalar _tmp125 = _tmp100 * _tmp92;
  const Scalar _tmp126 = _tmp37 + _tmp94;
  const Scalar _tmp127 = _tmp126 * _tmp97;
  const Scalar _tmp128 = Scalar(1.0) / (-_tmp127 - _tmp41 + _tmp96);
  ...
  const Scalar _tmp134 = _tmp126 * _tmp133 - _tmp76 * _tmp92;
  const Scalar _tmp135 = _tmp101 * _tmp128;
  const Scalar _tmp136 = -_tmp102 * _tmp125 - _tmp126 * _tmp135 + _tmp94;
  const Scalar _tmp137 = _tmp35 * fh1;
  const Scalar _tmp138 = -_tmp137 * _tmp81 - Scalar(3.29616) * _tmp24 - _tmp27 * fv1;
  const Scalar _tmp139 = _tmp132 * _tmp97;
  const Scalar _tmp140 = _tmp127 * _tmp132 + Scalar(1.0);
  const Scalar _tmp141 = _tmp117 + _tmp119 * _tmp129 - _tmp120 * _tmp125;
  const Scalar _tmp142 = _tmp126 * _tmp95;
  const Scalar _tmp143 = Scalar(3.29616) * _tmp10 + _tmp137 * _tmp82 + _tmp17 * fv1;
  const Scalar _tmp144 = std::asinh(
      _tmp124 * (Scalar(1.0) * _tmp115 * (_tmp109 * _tmp132 - _tmp130 * _tmp131) +
                 ...
                 Scalar(1.0) * _tmp138 * (-_tmp131 * _tmp140 + _tmp139) +
                 Scalar(1.0) * _tmp143 * (_tmp132 * _tmp142 - _tmp132) +
                 Scalar(1.0) * _tmp83 * (-_tmp131 * _tmp134 + _tmp133) +
                 Scalar(1.0) * _tmp84 * (-_tmp101 * _tmp132 - _tmp131 * _tmp136 + Scalar(1.0))));
  const Scalar _tmp145 = Scalar(9.6622558468725703) * _tmp123;
  const Scalar _tmp146 = _tmp76 * _tmp83;
  const Scalar _tmp147 = _tmp103 * _tmp84;
  const Scalar _tmp148 =
      _tmp113 * _tmp115 * _tmp72 + _tmp121 * _tmp122 * _tmp72 - _tmp146 * _tmp73 - _tmp147 * _tmp73;
  const Scalar _tmp149 = Scalar(1.0) / (_tmp148);
  const Scalar _tmp150 = _tmp132 * _tmp143;
  const Scalar _tmp151 =
      std::asinh(_tmp149 * (_tmp115 * _tmp130 * _tmp95 + _tmp122 * _tmp141 * _tmp95 +
                            _tmp134 * _tmp83 * _tmp95 + _tmp136 * _tmp84 * _tmp95 +
                            _tmp138 * _tmp140 * _tmp95 - _tmp142 * _tmp150));
  const Scalar _tmp152 = Scalar(9.6622558468725703) * _tmp148;
  const Scalar _tmp153 =
      _tmp100 * _tmp110 * _tmp115 + _tmp100 * _tmp120 * _tmp122 + _tmp146 + _tmp147;
  const Scalar _tmp154 = Scalar(1.0) / (_tmp153);
  const Scalar _tmp155 =
      std::asinh(_tmp154 * (-_tmp109 * _tmp115 * _tmp128 - _tmp119 * _tmp122 * _tmp128 -
                            _tmp133 * _tmp83 + _tmp135 * _tmp84 - _tmp138 * _tmp139 + _tmp150));
           ...
           std::cosh(
               ...
               (-_tmp144 * _tmp145 -
                Scalar(8.3196563720703107) *
                    std::sqrt(Scalar(
                        std::pow(Scalar(-Scalar(0.12019727201198747) * _tmp48 - 1), Scalar(2)) +
  ...
  _res(2, 0) =
      -_tmp152 *
          (Scalar(0.86627065637365697) * _tmp149 + std::cosh(Scalar(1.0) * _tmp151) -
           std::cosh(
               ...
               (-_tmp155 * _tmp156 -
                Scalar(8.3885017487099702) *
                    std::sqrt(Scalar(
                        ...
                        std::pow(Scalar(-Scalar(0.11921079949155229) * _tmp38 - 1),
                                 Scalar(2))))))) +
