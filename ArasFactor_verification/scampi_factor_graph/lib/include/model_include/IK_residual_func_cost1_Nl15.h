...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl15(
  ...
  const Scalar _tmp52 = _tmp19 + _tmp37;
  ...
  const Scalar _tmp61 = _tmp34 + _tmp58;
  ...
  const Scalar _tmp66 = _tmp26 + _tmp36;
  ...
  const Scalar _tmp71 = _tmp55 * _tmp61;
  const Scalar _tmp72 = _tmp31 + _tmp59;
  const Scalar _tmp73 = _tmp68 * _tmp69;
  const Scalar _tmp74 = -_tmp70 * _tmp71 + _tmp72 * _tmp73;
  const Scalar _tmp75 = Scalar(1.0) / (_tmp55 * _tmp70 - _tmp73);
  const Scalar _tmp76 = _tmp57 * _tmp75;
  const Scalar _tmp77 = _tmp47 * _tmp60 - _tmp55 * _tmp62 - _tmp74 * _tmp76;
  ...
  const Scalar _tmp84 = _tmp61 * _tmp70 - _tmp70 * _tmp72;
  const Scalar _tmp85 = -_tmp56 * _tmp60 + _tmp62 - _tmp76 * _tmp84 - _tmp77 * _tmp83;
  const Scalar _tmp86 = Scalar(1.0) / (_tmp85);
  const Scalar _tmp87 = Scalar(1.0) * _tmp80;
  const Scalar _tmp88 = Scalar(1.0) * _tmp75;
  const Scalar _tmp89 = _tmp74 * _tmp75 * _tmp82 * _tmp87 - _tmp84 * _tmp88;
  const Scalar _tmp90 =
  ...
  const Scalar _tmp93 = _tmp92 * (_tmp48 * _tmp54 * _tmp91 - _tmp50 * _tmp52 * _tmp91);
  const Scalar _tmp94 = -_tmp63 * _tmp73 + _tmp66 * _tmp70 + _tmp70 * _tmp93;
  const Scalar _tmp95 = _tmp38 * _tmp56 - _tmp43 * _tmp47 + _tmp56 * _tmp93 - _tmp76 * _tmp94;
  ...
  const Scalar _tmp112 = _tmp55 * _tmp75;
  const Scalar _tmp113 = _tmp112 * _tmp74 + _tmp71;
  const Scalar _tmp114 = _tmp112 * _tmp84 - _tmp113 * _tmp83 - _tmp61;
  const Scalar _tmp115 = _tmp98 * (_tmp112 * _tmp94 - _tmp114 * _tmp96 - _tmp93);
  const Scalar _tmp116 = _tmp86 * (_tmp114 + _tmp115);
  const Scalar _tmp117 = -_tmp116 * _tmp57 - _tmp55;
  ...
  const Scalar _tmp129 = -_tmp120 * _tmp77 + _tmp128 * _tmp98;
  const Scalar _tmp130 = _tmp127 * _tmp98;
  const Scalar _tmp131 = _tmp35 * fh1;
  const Scalar _tmp132 = Scalar(3.29616) * _tmp11 + _tmp118 * _tmp131 + _tmp17 * fv1;
  const Scalar _tmp133 = _tmp109 * _tmp126;
  const Scalar _tmp134 = -_tmp110 * _tmp77 - _tmp124 * _tmp133 + _tmp79;
  const Scalar _tmp135 = -_tmp106 * _tmp131 - Scalar(3.29616) * _tmp22 - _tmp27 * fv1;
  const Scalar _tmp136 = _tmp125 * _tmp127 + Scalar(1.0);
  const Scalar _tmp137 = _tmp127 * _tmp83;
  const Scalar _tmp138 = _tmp124 * _tmp126;
  const Scalar _tmp139 = -_tmp100 * _tmp77 + _tmp138 * _tmp99 - _tmp74 * _tmp88;
  const Scalar _tmp140 = _tmp113 + _tmp115 * _tmp138 - _tmp116 * _tmp77;
  const Scalar _tmp141 = std::asinh(
      _tmp123 * (Scalar(1.0) * _tmp107 * (_tmp127 * _tmp99 - _tmp139 * _tmp87) +
                 Scalar(1.0) * _tmp108 * (-_tmp109 * _tmp127 - _tmp134 * _tmp87 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp119 * (_tmp115 * _tmp127 - _tmp140 * _tmp87) +
                 Scalar(1.0) * _tmp121 * (-_tmp129 * _tmp87 + _tmp130) +
                 Scalar(1.0) * _tmp132 * (-_tmp127 + _tmp128 * _tmp80) +
                 Scalar(1.0) * _tmp135 * (-_tmp136 * _tmp87 + _tmp137)));
  const Scalar _tmp142 = Scalar(9.6622558468725703) * _tmp122;
  const Scalar _tmp143 = _tmp127 * _tmp132;
  const Scalar _tmp144 = _tmp108 * _tmp110;
  const Scalar _tmp145 = _tmp120 * _tmp121;
  const Scalar _tmp146 =
      _tmp101 * _tmp107 * _tmp75 + _tmp117 * _tmp119 * _tmp75 - _tmp144 * _tmp76 - _tmp145 * _tmp76;
  const Scalar _tmp147 = Scalar(1.0) / (_tmp146);
  const Scalar _tmp148 =
      std::asinh(_tmp147 * (_tmp107 * _tmp139 * _tmp80 + _tmp108 * _tmp134 * _tmp80 +
                            _tmp119 * _tmp140 * _tmp80 + _tmp121 * _tmp129 * _tmp80 -
                            _tmp124 * _tmp143 * _tmp80 + _tmp135 * _tmp136 * _tmp80));
  const Scalar _tmp149 = Scalar(9.6622558468725703) * _tmp146;
  const Scalar _tmp150 = _tmp100 * _tmp107 + _tmp116 * _tmp119 + _tmp144 + _tmp145;
  const Scalar _tmp151 = Scalar(1.0) / (_tmp150);
  const Scalar _tmp152 = std::asinh(_tmp151 * (-_tmp107 * _tmp126 * _tmp99 + _tmp108 * _tmp133 -
                                               _tmp115 * _tmp119 * _tmp126 - _tmp121 * _tmp130 -
                                               _tmp135 * _tmp137 + _tmp143));
  ...
  _res(1, 0) =
      -_tmp142 *
          (Scalar(0.876505537412406) * _tmp123 + std::cosh(Scalar(1.0) * _tmp141) -
           std::cosh(
  ...
  _res(2, 0) =
      -_tmp149 *
          (Scalar(0.86627065637365697) * _tmp147 + std::cosh(Scalar(1.0) * _tmp148) -
           std::cosh(
                ...
                Scalar(4.83288938413423) *
                    std::sqrt(Scalar(
                        ...
                        Scalar(0.13818785160942856) *
                            std::pow(Scalar(-Scalar(0.55661923802822921) * _tmp64 - 1),
                                     Scalar(2))))))) +
