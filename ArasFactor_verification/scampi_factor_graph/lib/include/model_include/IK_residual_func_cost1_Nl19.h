...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl19(
  ...
  const Scalar _tmp78 = _tmp42 + _tmp5;
  ...
  const Scalar _tmp92 = _tmp91 * (-_tmp39 * _tmp45 * _tmp90 + _tmp41 * _tmp43 * _tmp90);
  ...
  const Scalar _tmp132 = _tmp107 * _tmp131 + Scalar(3.29616) * _tmp12 + _tmp18 * fv1;
  const Scalar _tmp133 = -_tmp122 * _tmp86 + _tmp130 * _tmp97;
  const Scalar _tmp134 = _tmp129 * _tmp97;
  const Scalar _tmp135 = _tmp68 * (_tmp127 * _tmp129 + Scalar(1.0));
  const Scalar _tmp136 = _tmp129 * _tmp71;
  const Scalar _tmp137 = -_tmp120 * _tmp131 - Scalar(3.29616) * _tmp25 - _tmp28 * fv1;
  const Scalar _tmp138 = _tmp126 * _tmp128;
  const Scalar _tmp139 = _tmp86 * _tmp88;
  const Scalar _tmp140 = -_tmp114 * _tmp62 + _tmp117 * _tmp138 - _tmp118 * _tmp139;
  const Scalar _tmp141 = _tmp138 * _tmp98 - _tmp139 * _tmp99 + _tmp65;
  const Scalar _tmp142 = _tmp110 * _tmp128;
  const Scalar _tmp143 = _tmp68 * (-_tmp111 * _tmp139 - _tmp126 * _tmp142 + _tmp67);
  const Scalar _tmp144 =
      std::asinh(_tmp125 * (Scalar(1.0) * _tmp108 * (-_tmp115 * _tmp141 + _tmp129 * _tmp98) +
                            Scalar(1.0) * _tmp109 *
                                (-_tmp110 * _tmp129 - Scalar(1.0) * _tmp143 + Scalar(1.0)) +
                            Scalar(1.0) * _tmp121 * (-_tmp115 * _tmp140 + _tmp117 * _tmp129) +
                            Scalar(1.0) * _tmp123 * (-_tmp115 * _tmp133 + _tmp134) +
                            Scalar(1.0) * _tmp132 * (-_tmp129 + _tmp130 * _tmp68) +
                            Scalar(1.0) * _tmp137 * (-Scalar(1.0) * _tmp135 + _tmp136)));
  const Scalar _tmp145 = Scalar(9.6622558468725703) * _tmp124;
  const Scalar _tmp146 = _tmp122 * _tmp123;
  const Scalar _tmp147 = _tmp109 * _tmp112;
  const Scalar _tmp148 =
      _tmp101 * _tmp108 * _tmp63 + _tmp119 * _tmp121 * _tmp63 - _tmp146 * _tmp85 - _tmp147 * _tmp85;
  const Scalar _tmp149 = Scalar(1.0) / (_tmp148);
  const Scalar _tmp150 = _tmp129 * _tmp132;
  const Scalar _tmp151 = std::asinh(
      _tmp149 * (_tmp108 * _tmp141 * _tmp68 + _tmp109 * _tmp143 + _tmp121 * _tmp140 * _tmp68 +
                 _tmp123 * _tmp133 * _tmp68 - _tmp126 * _tmp150 * _tmp68 + _tmp135 * _tmp137));
  const Scalar _tmp152 = Scalar(9.6622558468725703) * _tmp148;
  const Scalar _tmp153 = _tmp108 * _tmp88 * _tmp99 + _tmp118 * _tmp121 * _tmp88 + _tmp146 + _tmp147;
  const Scalar _tmp154 = Scalar(1.0) / (_tmp153);
  const Scalar _tmp155 = std::asinh(_tmp154 * (-_tmp108 * _tmp128 * _tmp98 + _tmp109 * _tmp142 -
                                               _tmp117 * _tmp121 * _tmp128 - _tmp123 * _tmp134 -
                                               _tmp136 * _tmp137 + _tmp150));
  ...
  _res(1, 0) =
      -_tmp145 *
          (Scalar(0.87679799777269396) * _tmp125 + std::cosh(Scalar(1.0) * _tmp144) -
           std::cosh(
