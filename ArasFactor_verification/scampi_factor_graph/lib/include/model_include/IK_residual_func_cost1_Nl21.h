...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl21(
  ...
  const Scalar _tmp51 = _tmp21 + _tmp46;
  ...
  const Scalar _tmp60 = _tmp32 + _tmp38;
  const Scalar _tmp61 = _tmp53 * _tmp57;
  const Scalar _tmp62 = -_tmp50 * _tmp59 + _tmp60 * _tmp61;
  const Scalar _tmp63 = Scalar(1.0) / (_tmp50 * _tmp58 - _tmp61);
  const Scalar _tmp64 = _tmp50 * _tmp63;
  const Scalar _tmp65 = _tmp39 * _tmp50 + _tmp62 * _tmp64;
  ...
  const Scalar _tmp70 = _tmp68 * (-_tmp54 + _tmp69);
  const Scalar _tmp71 = -_tmp58 * _tmp60 + _tmp59;
  const Scalar _tmp72 = -_tmp39 + _tmp64 * _tmp71 - _tmp65 * _tmp70;
  const Scalar _tmp73 = _tmp35 + _tmp37;
  const Scalar _tmp74 = _tmp40 + _tmp6;
  const Scalar _tmp75 = _tmp74 + position_vector(0, 0);
  const Scalar _tmp76 = _tmp75 + Scalar(1.9874742031097401);
  const Scalar _tmp77 = _tmp27 + _tmp45;
  ...
  const Scalar _tmp83 = _tmp50 * _tmp81 - _tmp82;
  const Scalar _tmp84 = _tmp63 * _tmp83;
  const Scalar _tmp85 = _tmp39 * _tmp81;
  const Scalar _tmp86 = -_tmp50 * _tmp85 - _tmp62 * _tmp84 + _tmp73 * _tmp82;
  const Scalar _tmp87 = -_tmp70 * _tmp86 - _tmp71 * _tmp84 - _tmp73 * _tmp81 + _tmp85;
  ...
  const Scalar _tmp92 = _tmp91 * (_tmp41 * _tmp49 * _tmp90 - _tmp43 * _tmp47 * _tmp90);
  const Scalar _tmp93 = _tmp51 * _tmp58 - _tmp54 * _tmp61 + _tmp58 * _tmp92;
  ...
  const Scalar _tmp98 = _tmp97 * (_tmp64 * _tmp93 - _tmp72 * _tmp95 - _tmp92);
  const Scalar _tmp99 = _tmp67 + _tmp77;
  const Scalar _tmp100 = _tmp70 * _tmp99;
  const Scalar _tmp101 = Scalar(1.0) / (-_tmp100 + _tmp69 - _tmp74);
  const Scalar _tmp102 = _tmp101 * _tmp99;
  const Scalar _tmp103 = _tmp88 * (_tmp72 + _tmp98);
  const Scalar _tmp104 = _tmp102 * _tmp98 - _tmp103 * _tmp86 + _tmp65;
  ...
  const Scalar _tmp108 = _tmp29 + Scalar(-4.83288938413423);
  ...
  const Scalar _tmp114 = _tmp112 * _tmp99 - _tmp113 * _tmp86;
  const Scalar _tmp115 = _tmp108 * _tmp109;
  const Scalar _tmp116 = fh1 * (-_tmp110 * _tmp28 + _tmp115 * _tmp18);
  const Scalar _tmp117 = Scalar(1.0) * _tmp63;
  const Scalar _tmp118 = _tmp117 * _tmp62;
  const Scalar _tmp119 = -_tmp117 * _tmp71 + _tmp118 * _tmp70;
  const Scalar _tmp120 = _tmp97 * (-_tmp117 * _tmp93 - _tmp119 * _tmp95);
  const Scalar _tmp121 = _tmp88 * (_tmp119 + _tmp120);
  const Scalar _tmp122 = _tmp102 * _tmp120 - _tmp118 - _tmp121 * _tmp86;
  const Scalar _tmp123 = _tmp115 * fh1;
  const Scalar _tmp124 = _tmp68 * _tmp99;
  const Scalar _tmp125 = _tmp36 * fh1;
  const Scalar _tmp126 = _tmp110 * _tmp125 + Scalar(3.29616) * _tmp12 + _tmp18 * fv1;
  const Scalar _tmp127 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp128 = _tmp66 * _tmp70 + _tmp69;
  const Scalar _tmp129 = _tmp101 * _tmp128;
  const Scalar _tmp130 = 0;
  const Scalar _tmp131 = _tmp68 * (-_tmp129 * _tmp99 - _tmp130 * _tmp86 + _tmp67);
  const Scalar _tmp132 = _tmp106 * _tmp70;
  const Scalar _tmp133 = _tmp68 * (_tmp100 * _tmp106 + Scalar(1.0));
  const Scalar _tmp134 = -_tmp115 * _tmp125 - Scalar(3.29616) * _tmp24 - _tmp28 * fv1;
  const Scalar _tmp135 = -_tmp121 * _tmp83 + Scalar(1.0);
  const Scalar _tmp136 = _tmp58 * _tmp63;
  const Scalar _tmp137 = -_tmp103 * _tmp83 - _tmp50;
  const Scalar _tmp138 = _tmp117 * _tmp83 * _tmp96;
  const Scalar _tmp139 = -_tmp111 * _tmp91 * (_tmp103 * _tmp81 + _tmp136 * _tmp137 + Scalar(1.0)) -
                         _tmp116 * _tmp91 * (_tmp113 * _tmp81 - _tmp138 * _tmp58) -
                         _tmp123 * _tmp91 * (_tmp121 * _tmp81 + _tmp135 * _tmp136) -
                         _tmp127 * _tmp91 * (-_tmp130 * _tmp58 * _tmp84 + _tmp130 * _tmp81);
  const Scalar _tmp140 = Scalar(1.0) / (_tmp139);
  const Scalar _tmp141 =
      std::asinh(_tmp140 * (Scalar(1.0) * _tmp111 * (-_tmp104 * _tmp105 + _tmp106 * _tmp98) +
                            Scalar(1.0) * _tmp116 * (-_tmp105 * _tmp114 + _tmp112) +
                            Scalar(1.0) * _tmp123 * (-_tmp105 * _tmp122 + _tmp106 * _tmp120) +
                            Scalar(1.0) * _tmp126 * (_tmp106 * _tmp124 - _tmp106) +
                            Scalar(1.0) * _tmp127 *
                                (-_tmp106 * _tmp128 - Scalar(1.0) * _tmp131 + Scalar(1.0)) +
                            Scalar(1.0) * _tmp134 * (_tmp132 - Scalar(1.0) * _tmp133)));
  const Scalar _tmp142 = Scalar(9.6622558468725703) * _tmp139;
  const Scalar _tmp143 = _tmp127 * _tmp130;
  const Scalar _tmp144 = _tmp111 * _tmp137 * _tmp63 - _tmp116 * _tmp138 +
                         _tmp123 * _tmp135 * _tmp63 - _tmp143 * _tmp84;
  const Scalar _tmp145 = Scalar(1.0) / (_tmp144);
  const Scalar _tmp146 = _tmp106 * _tmp126;
  const Scalar _tmp147 =
      std::asinh(_tmp145 * (_tmp104 * _tmp111 * _tmp68 + _tmp114 * _tmp116 * _tmp68 +
                            _tmp122 * _tmp123 * _tmp68 - _tmp124 * _tmp146 + _tmp127 * _tmp131 +
                            _tmp133 * _tmp134));
  const Scalar _tmp148 = Scalar(9.6622558468725703) * _tmp144;
  const Scalar _tmp149 = _tmp103 * _tmp111 + _tmp113 * _tmp116 + _tmp121 * _tmp123 + _tmp143;
  const Scalar _tmp150 = Scalar(1.0) / (_tmp149);
  const Scalar _tmp151 =
      std::asinh(_tmp150 * (-_tmp101 * _tmp111 * _tmp98 - _tmp101 * _tmp120 * _tmp123 -
                            _tmp112 * _tmp116 + _tmp127 * _tmp129 - _tmp132 * _tmp134 + _tmp146));
  ...
  _res(1, 0) =
      -_tmp142 *
          (Scalar(0.876505537412406) * _tmp140 + std::cosh(Scalar(1.0) * _tmp141) -
           std::cosh(
               ...
               (-_tmp141 * _tmp142 -
                Scalar(8.3885017487099702) *
                    std::sqrt(Scalar(
                        ...
                        std::pow(Scalar(-Scalar(0.11921079949155229) * _tmp48 - 1),
                                 Scalar(2))))))) +
