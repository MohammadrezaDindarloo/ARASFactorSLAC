...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl22(
  ...
  const Scalar _tmp28 = Scalar(0.20999999999999999) * _tmp2 + Scalar(0.20999999999999999) * _tmp27 +
  ...
  const Scalar _tmp51 = _tmp22 + _tmp39;
  ...
  const Scalar _tmp75 = _tmp40 * _tmp48 - _tmp44 * _tmp49 + _tmp48 * _tmp69 - _tmp70 * _tmp74;
  const Scalar _tmp76 = Scalar(1.0) / (_tmp75);
  const Scalar _tmp77 = Scalar(1.0) * _tmp76;
  const Scalar _tmp78 = _tmp58 * _tmp74;
  const Scalar _tmp79 = _tmp20 + Scalar(1.7965602546229);
  const Scalar _tmp80 = _tmp31 + Scalar(-4.83288938413423);
  ...
  const Scalar _tmp101 = _tmp100 * _tmp49 - _tmp48 * _tmp91 - _tmp74 * _tmp92;
  const Scalar _tmp102 = -_tmp100 * _tmp48 - _tmp101 * _tmp98 + _tmp48 * _tmp88 - _tmp74 * _tmp89;
  const Scalar _tmp103 = Scalar(1.0) / (_tmp102);
  const Scalar _tmp104 = _tmp103 * _tmp75;
  const Scalar _tmp105 = _tmp102 * _tmp76;
  const Scalar _tmp106 = _tmp105 * (-_tmp104 * _tmp99 - _tmp69 + _tmp70 * _tmp90);
  const Scalar _tmp107 = _tmp106 + _tmp99;
  const Scalar _tmp108 = _tmp103 * _tmp72;
  const Scalar _tmp109 = -_tmp107 * _tmp108 - _tmp71;
  const Scalar _tmp110 = _tmp58 * _tmp73;
  const Scalar _tmp111 = _tmp103 * _tmp48;
  ...
  const Scalar _tmp119 = -_tmp117 * _tmp89 + _tmp118 * _tmp98;
  const Scalar _tmp120 = _tmp105 * (-_tmp104 * _tmp119 - _tmp117 * _tmp70);
  const Scalar _tmp121 = _tmp119 + _tmp120;
  const Scalar _tmp122 = -_tmp108 * _tmp121 + Scalar(1.0);
  const Scalar _tmp123 = _tmp83 * fh1;
  const Scalar _tmp124 = -_tmp112 * _tmp68 * (_tmp107 * _tmp111 + _tmp109 * _tmp110 + Scalar(1.0)) -
                         _tmp113 * _tmp68 * (_tmp116 * _tmp48 - _tmp116 * _tmp78) -
                         _tmp123 * _tmp68 * (_tmp110 * _tmp122 + _tmp111 * _tmp121) -
  ...
  const Scalar _tmp128 = Scalar(1.0) / (-_tmp127 - _tmp44 + _tmp97);
  const Scalar _tmp129 = Scalar(1.0) * _tmp128;
  const Scalar _tmp130 = _tmp105 * _tmp129;
  const Scalar _tmp131 = -_tmp101 * _tmp77 + _tmp126 * _tmp130;
  const Scalar _tmp132 = Scalar(1.0) * _tmp96;
  const Scalar _tmp133 = _tmp126 * _tmp96;
  const Scalar _tmp134 = _tmp38 * fh1;
  const Scalar _tmp135 = Scalar(3.29616) * _tmp13 + _tmp134 * _tmp82 + _tmp19 * fv1;
  ...
  const Scalar _tmp139 = _tmp114 * _tmp128;
  const Scalar _tmp140 = -_tmp115 * _tmp136 - _tmp126 * _tmp139 + _tmp95;
  const Scalar _tmp141 = _tmp127 * _tmp129 + Scalar(1.0);
  const Scalar _tmp142 = _tmp129 * _tmp98;
  const Scalar _tmp143 = -_tmp134 * _tmp83 - Scalar(3.29616) * _tmp25 - _tmp30 * fv1;
  const Scalar _tmp144 = _tmp106 * _tmp137 - _tmp107 * _tmp136 + _tmp93;
  const Scalar _tmp145 = std::asinh(
      _tmp125 * (Scalar(1.0) * _tmp112 * (_tmp106 * _tmp129 - _tmp132 * _tmp144) +
                 Scalar(1.0) * _tmp113 * (-_tmp114 * _tmp129 - _tmp132 * _tmp140 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp123 * (_tmp120 * _tmp129 - _tmp132 * _tmp138) +
                 Scalar(1.0) * _tmp135 * (_tmp129 * _tmp133 - _tmp129) +
                 Scalar(1.0) * _tmp143 * (-_tmp132 * _tmp141 + _tmp142) +
  ...
  const Scalar _tmp149 =
      _tmp109 * _tmp112 * _tmp73 + _tmp122 * _tmp123 * _tmp73 - _tmp147 * _tmp74 - _tmp148 * _tmp74;
  const Scalar _tmp150 = Scalar(1.0) / (_tmp149);
  const Scalar _tmp151 = _tmp129 * _tmp135;
  const Scalar _tmp152 =
      std::asinh(_tmp150 * (_tmp112 * _tmp144 * _tmp96 + _tmp113 * _tmp140 * _tmp96 +
                            _tmp123 * _tmp138 * _tmp96 + _tmp131 * _tmp84 * _tmp96 -
                            _tmp133 * _tmp151 + _tmp141 * _tmp143 * _tmp96));
  const Scalar _tmp153 = Scalar(9.6622558468725703) * _tmp149;
  const Scalar _tmp154 =
      _tmp103 * _tmp107 * _tmp112 + _tmp103 * _tmp121 * _tmp123 + _tmp147 + _tmp148;
  const Scalar _tmp155 = Scalar(1.0) / (_tmp154);
  const Scalar _tmp156 = std::asinh(_tmp155 * (-_tmp106 * _tmp112 * _tmp128 + _tmp113 * _tmp139 -
                                               _tmp120 * _tmp123 * _tmp128 - _tmp130 * _tmp84 -
                ...
                Scalar(8.3196563720703107) *
                    std::sqrt(Scalar(
                        ...
                        Scalar(0.057067943527034905) *
                            std::pow(Scalar(-Scalar(0.50315118477277876) * _tmp54 - 1),
                                     Scalar(2))))))) +
               ...
               (-_tmp156 * _tmp157 -
                Scalar(8.3885017487099702) *
                    std::sqrt(Scalar(
                        ...
                        std::pow(Scalar(-Scalar(0.11921079949155229) * _tmp41 - 1),
                                 Scalar(2))))))) +
      position_vector(2, 0);
