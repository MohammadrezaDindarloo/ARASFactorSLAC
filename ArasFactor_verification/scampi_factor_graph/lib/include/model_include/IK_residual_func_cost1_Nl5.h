...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl5(
  ...
  const Scalar _tmp51 = _tmp50 * (-_tmp39 * _tmp45 * _tmp49 + _tmp41 * _tmp43 * _tmp49);
  const Scalar _tmp52 = _tmp22 + _tmp42;
  ...
  const Scalar _tmp57 = _tmp52 + position_vector(0, 0);
  ...
  const Scalar _tmp62 = _tmp51 * _tmp61 - _tmp52 * _tmp60 + _tmp54 * _tmp61;
  const Scalar _tmp63 = Scalar(1.0) / (_tmp47 * _tmp61 - _tmp60);
  const Scalar _tmp64 = _tmp47 * _tmp63;
  const Scalar _tmp65 = _tmp35 + _tmp36;
  const Scalar _tmp66 = _tmp34 + _tmp65;
  const Scalar _tmp67 = _tmp33 + _tmp65;
  const Scalar _tmp68 = _tmp61 * _tmp66;
  const Scalar _tmp69 = -_tmp47 * _tmp68 + _tmp60 * _tmp67;
  const Scalar _tmp70 = _tmp47 * _tmp66 + _tmp64 * _tmp69;
  const Scalar _tmp71 = Scalar(1.0) * _tmp39;
  const Scalar _tmp72 = -_tmp71;
  const Scalar _tmp73 = Scalar(1.0) / (_tmp54 + _tmp72);
  const Scalar _tmp74 = Scalar(1.0) * _tmp43;
  const Scalar _tmp75 = -_tmp52 + _tmp74;
  const Scalar _tmp76 = _tmp73 * _tmp75;
  const Scalar _tmp77 = -_tmp61 * _tmp67 + _tmp68;
  const Scalar _tmp78 = _tmp64 * _tmp77 - _tmp66 - _tmp70 * _tmp76;
  const Scalar _tmp79 = _tmp53 + _tmp7;
  const Scalar _tmp80 = _tmp79 + position_vector(1, 0);
  const Scalar _tmp81 = _tmp80 + Scalar(8.3885017487099702);
  const Scalar _tmp82 = _tmp22 + _tmp29;
  ...
  const Scalar _tmp112 = -_tmp110 * _tmp77 + _tmp111 * _tmp63 * _tmp69 * _tmp75;
  const Scalar _tmp113 = _tmp98 * (-_tmp110 * _tmp62 - _tmp112 * _tmp96);
  ...
  const Scalar _tmp119 = _tmp71 * _tmp76 + _tmp74;
  ...
  const Scalar _tmp124 = fh1 * (-_tmp108 * _tmp19 + _tmp116 * _tmp30);
  const Scalar _tmp125 = -_tmp109 * _tmp50 * (_tmp100 * _tmp104 + _tmp102 * _tmp103 + Scalar(1.0)) -
                         _tmp117 * _tmp50 * (_tmp103 * _tmp115 + _tmp104 * _tmp114) -
                         _tmp118 * _tmp50 * (-_tmp103 * _tmp122 + _tmp121 * _tmp86) -
                         _tmp124 * _tmp50 * (-_tmp123 * _tmp61 * _tmp91 + _tmp123 * _tmp86);
  ...
  const Scalar _tmp133 = -_tmp110 * _tmp69 + _tmp113 * _tmp131 - _tmp114 * _tmp132;
  const Scalar _tmp134 = _tmp38 * fh1;
  const Scalar _tmp135 = _tmp108 * _tmp134 + Scalar(3.29616) * _tmp26 + _tmp30 * fv1;
  const Scalar _tmp136 = _tmp127 * _tmp73;
  const Scalar _tmp137 = -_tmp100 * _tmp132 + _tmp131 * _tmp99 + _tmp70;
  const Scalar _tmp138 = _tmp130 * _tmp98;
  const Scalar _tmp139 = -_tmp123 * _tmp92 + _tmp127 * _tmp138;
  const Scalar _tmp140 = _tmp119 * _tmp129;
  const Scalar _tmp141 = -_tmp120 * _tmp132 - _tmp127 * _tmp140 + _tmp72;
  const Scalar _tmp142 = _tmp128 * _tmp130 + Scalar(1.0);
  const Scalar _tmp143 = _tmp130 * _tmp76;
  const Scalar _tmp144 = -_tmp116 * _tmp134 - Scalar(3.29616) * _tmp16 - _tmp19 * fv1;
  const Scalar _tmp145 = std::asinh(
      _tmp126 * (Scalar(1.0) * _tmp109 * (-_tmp111 * _tmp137 + _tmp130 * _tmp99) +
                 Scalar(1.0) * _tmp117 * (-_tmp111 * _tmp133 + _tmp113 * _tmp130) +
                 Scalar(1.0) * _tmp118 * (-_tmp111 * _tmp141 - _tmp119 * _tmp130 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp124 * (-_tmp111 * _tmp139 + _tmp138) +
                 Scalar(1.0) * _tmp135 * (_tmp130 * _tmp136 - _tmp130) +
                 Scalar(1.0) * _tmp144 * (-_tmp111 * _tmp142 + _tmp143)));
  ...
  const Scalar _tmp149 = _tmp102 * _tmp109 * _tmp63 + _tmp115 * _tmp117 * _tmp63 -
                         _tmp118 * _tmp122 * _tmp63 - _tmp148 * _tmp91;
  const Scalar _tmp150 = Scalar(1.0) / (_tmp149);
  const Scalar _tmp151 =
      std::asinh(_tmp150 * (_tmp109 * _tmp137 * _tmp73 + _tmp117 * _tmp133 * _tmp73 +
                            _tmp118 * _tmp141 * _tmp73 + _tmp124 * _tmp139 * _tmp73 -
                            _tmp136 * _tmp147 + _tmp142 * _tmp144 * _tmp73));
  const Scalar _tmp152 = Scalar(9.6622558468725703) * _tmp149;
  const Scalar _tmp153 = _tmp94 * fh1;
  const Scalar _tmp154 =
      _tmp100 * _tmp108 * _tmp153 + _tmp114 * _tmp116 * _tmp153 + _tmp118 * _tmp121 + _tmp148;
  const Scalar _tmp155 = Scalar(1.0) / (_tmp154);
  const Scalar _tmp156 =
      std::asinh(_tmp155 * (-_tmp109 * _tmp129 * _tmp99 - _tmp113 * _tmp117 * _tmp129 +
                            _tmp118 * _tmp140 - _tmp124 * _tmp138 - _tmp143 * _tmp144 + _tmp147));
                ...
                Scalar(4.83288938413423) *
                    std::sqrt(Scalar(
                        ...
                        Scalar(0.13818785160942856) *
                            std::pow(Scalar(-Scalar(0.55661923802822921) * _tmp44 - 1),
                                     Scalar(2))))))) +
  ...
  _res(3, 0) =
      -_tmp157 *
          (Scalar(0.876505537412406) * _tmp155 + std::cosh(Scalar(1.0) * _tmp156) -
           std::cosh(
               ...
               (-_tmp156 * _tmp157 -
                Scalar(8.3885017487099702) *
                    std::sqrt(Scalar(
                        ...
                        std::pow(Scalar(-Scalar(0.11921079949155229) * _tmp80 - 1),
                                 Scalar(2))))))) +
