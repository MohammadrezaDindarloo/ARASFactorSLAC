...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl8(
  ...
  const Scalar _tmp60 = -_tmp39 * _tmp48 + _tmp43 * _tmp47 + _tmp47 * _tmp59;
  ...
  const Scalar _tmp64 = _tmp20 + _tmp38;
  ...
  const Scalar _tmp69 = _tmp51 * _tmp57;
  const Scalar _tmp70 = _tmp66 * _tmp67;
  const Scalar _tmp71 = -_tmp68 + _tmp69 * _tmp70;
  const Scalar _tmp72 = Scalar(1.0) / (_tmp47 * _tmp69 - _tmp48);
  const Scalar _tmp73 = _tmp71 * _tmp72;
  const Scalar _tmp74 = _tmp59 * _tmp70 - _tmp60 * _tmp73 + _tmp61 * _tmp70 - _tmp64 * _tmp68;
  const Scalar _tmp75 = Scalar(1.0) / (_tmp74);
  const Scalar _tmp76 = Scalar(1.0) * _tmp72;
  const Scalar _tmp77 = _tmp71 * _tmp75 * _tmp76;
  const Scalar _tmp78 = Scalar(1.0) * _tmp75;
  const Scalar _tmp79 = _tmp30 + Scalar(-2.5193355532036801);
  const Scalar _tmp80 = _tmp19 + Scalar(8.3885017487099702);
  ...
  const Scalar _tmp85 = _tmp69 * _tmp72;
  ...
  const Scalar _tmp90 = _tmp72 * (-_tmp47 * _tmp87 + _tmp47 * _tmp89);
  const Scalar _tmp91 = _tmp69 * _tmp89;
  const Scalar _tmp92 = -_tmp47 * _tmp91 + _tmp48 * _tmp87;
  const Scalar _tmp93 = _tmp85 * _tmp92 + _tmp91;
  ...
  const Scalar _tmp98 = _tmp96 * (-_tmp39 + _tmp97);
  const Scalar _tmp99 = _tmp69 * _tmp90 - _tmp89 - _tmp93 * _tmp98;
  const Scalar _tmp100 = _tmp86 + _tmp88;
  const Scalar _tmp101 = _tmp100 * _tmp68 - _tmp70 * _tmp91 - _tmp73 * _tmp92;
  const Scalar _tmp102 = -_tmp100 * _tmp70 - _tmp101 * _tmp98 + _tmp70 * _tmp89 - _tmp71 * _tmp90;
  const Scalar _tmp103 = Scalar(1.0) / (_tmp102);
  const Scalar _tmp104 = _tmp103 * _tmp74;
  const Scalar _tmp105 = _tmp102 * _tmp75;
  const Scalar _tmp106 = _tmp105 * (-_tmp104 * _tmp99 - _tmp59 + _tmp60 * _tmp85);
  const Scalar _tmp107 = _tmp106 + _tmp99;
  const Scalar _tmp108 = _tmp103 * _tmp70;
  const Scalar _tmp109 = _tmp103 * _tmp71;
  const Scalar _tmp110 = -_tmp107 * _tmp109 - _tmp69;
  const Scalar _tmp111 = _tmp47 * _tmp72;
  const Scalar _tmp112 = _tmp82 * fh1;
  const Scalar _tmp113 = _tmp76 * _tmp92;
  const Scalar _tmp114 = _tmp113 * _tmp98 - Scalar(1.0) * _tmp90;
  const Scalar _tmp115 = _tmp105 * (-_tmp104 * _tmp114 - _tmp60 * _tmp76);
  const Scalar _tmp116 = _tmp114 + _tmp115;
  const Scalar _tmp117 = -_tmp109 * _tmp116 + Scalar(1.0);
  const Scalar _tmp118 = _tmp83 * fh1;
  const Scalar _tmp119 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp120 = _tmp94 * _tmp98 + _tmp97;
  const Scalar _tmp121 = 0;
  const Scalar _tmp122 = _tmp109 * _tmp121;
  const Scalar _tmp123 = _tmp103 * _tmp121;
  const Scalar _tmp124 = -_tmp112 * _tmp58 * (_tmp107 * _tmp108 + _tmp110 * _tmp111 + Scalar(1.0)) -
                         _tmp118 * _tmp58 * (_tmp108 * _tmp116 + _tmp111 * _tmp117) -
                         _tmp119 * _tmp58 * (-_tmp111 * _tmp122 + _tmp123 * _tmp70) -
                         _tmp58 * _tmp84 * (-_tmp47 * _tmp77 + _tmp70 * _tmp78);
  const Scalar _tmp125 = Scalar(1.0) / (_tmp124);
  const Scalar _tmp126 = _tmp61 + _tmp95;
  const Scalar _tmp127 = _tmp126 * _tmp98;
  const Scalar _tmp128 = Scalar(1.0) / (-_tmp127 - _tmp64 + _tmp97);
  const Scalar _tmp129 = Scalar(1.0) * _tmp128;
  const Scalar _tmp130 = _tmp105 * _tmp129;
  const Scalar _tmp131 = -_tmp101 * _tmp78 + _tmp126 * _tmp130;
  const Scalar _tmp132 = Scalar(1.0) * _tmp96;
  const Scalar _tmp133 = _tmp101 * _tmp103;
  const Scalar _tmp134 = _tmp120 * _tmp128;
  const Scalar _tmp135 = -_tmp121 * _tmp133 - _tmp126 * _tmp134 + _tmp95;
  const Scalar _tmp136 = _tmp126 * _tmp128;
  const Scalar _tmp137 = _tmp106 * _tmp136 - _tmp107 * _tmp133 + _tmp93;
  const Scalar _tmp138 = -_tmp113 + _tmp115 * _tmp136 - _tmp116 * _tmp133;
  const Scalar _tmp139 = _tmp126 * _tmp96;
  const Scalar _tmp140 = _tmp37 * fh1;
  const Scalar _tmp141 = _tmp140 * _tmp82 + Scalar(3.29616) * _tmp24 + _tmp29 * fv1;
  const Scalar _tmp142 = _tmp96 * (_tmp127 * _tmp129 + Scalar(1.0));
  const Scalar _tmp143 = _tmp129 * _tmp98;
  const Scalar _tmp144 = -_tmp140 * _tmp83 - Scalar(3.29616) * _tmp15 - _tmp18 * fv1;
  const Scalar _tmp145 = std::asinh(
      _tmp125 * (Scalar(1.0) * _tmp112 * (_tmp106 * _tmp129 - _tmp132 * _tmp137) +
                 Scalar(1.0) * _tmp118 * (_tmp115 * _tmp129 - _tmp132 * _tmp138) +
                 Scalar(1.0) * _tmp119 * (-_tmp120 * _tmp129 - _tmp132 * _tmp135 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp141 * (_tmp129 * _tmp139 - _tmp129) +
                 Scalar(1.0) * _tmp144 * (-Scalar(1.0) * _tmp142 + _tmp143) +
                 Scalar(1.0) * _tmp84 * (_tmp130 - _tmp131 * _tmp132)));
  const Scalar _tmp146 = Scalar(9.6622558468725703) * _tmp124;
  const Scalar _tmp147 = _tmp110 * _tmp112 * _tmp72 + _tmp117 * _tmp118 * _tmp72 -
                         _tmp119 * _tmp122 * _tmp72 - _tmp77 * _tmp84;
  const Scalar _tmp148 = Scalar(1.0) / (_tmp147);
  const Scalar _tmp149 = _tmp129 * _tmp141;
  const Scalar _tmp150 =
      std::asinh(_tmp148 * (_tmp112 * _tmp137 * _tmp96 + _tmp118 * _tmp138 * _tmp96 +
                            _tmp119 * _tmp135 * _tmp96 + _tmp131 * _tmp84 * _tmp96 -
                            _tmp139 * _tmp149 + _tmp142 * _tmp144));
  const Scalar _tmp151 = Scalar(9.6622558468725703) * _tmp147;
  const Scalar _tmp152 = _tmp103 * _tmp107 * _tmp112 + _tmp103 * _tmp116 * _tmp118 +
                         _tmp119 * _tmp123 + _tmp78 * _tmp84;
  const Scalar _tmp153 = Scalar(1.0) / (_tmp152);
  const Scalar _tmp154 =
      std::asinh(_tmp153 * (-_tmp106 * _tmp112 * _tmp128 - _tmp115 * _tmp118 * _tmp128 +
                            _tmp119 * _tmp134 - _tmp130 * _tmp84 - _tmp143 * _tmp144 + _tmp149));
  ...
  _res(2, 0) =
      -_tmp151 *
          (Scalar(0.87679799777269396) * _tmp148 + std::cosh(Scalar(1.0) * _tmp150) -
           std::cosh(
               ...
               (-_tmp150 * _tmp151 -
                Scalar(8.3196563720703107) *
                    std::sqrt(Scalar(
                        ...
                        std::pow(Scalar(-Scalar(0.12019727201198747) * _tmp44 - 1),
                                 Scalar(2))))))) +
      _tmp87 + position_vector(2, 0);
  _res(3, 0) =
      _tmp100 -
      _tmp155 *
          (Scalar(0.86627065637365697) * _tmp153 + std::cosh(Scalar(1.0) * _tmp154) -
           std::cosh(
               Scalar(0.1034955) * _tmp153 *
               (-_tmp154 * _tmp155 -
                Scalar(4.83288938413423) *
                    std::sqrt(Scalar(
                        std::pow(Scalar(1 - Scalar(0.20691555724053495) * _tmp62), Scalar(2)) +
                        Scalar(0.13818785160942856) *
                            std::pow(Scalar(-Scalar(0.55661923802822921) * _tmp65 - 1),
                                     Scalar(2))))))) +
      position_vector(2, 0);
