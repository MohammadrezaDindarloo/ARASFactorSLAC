...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1WrtFh1Nl2(
  ...
  const Scalar _tmp54 = -Scalar(0.010999999999999999) * _tmp24 -
                        Scalar(0.010999999999999999) * _tmp6 + Scalar(-0.010999999999999999);
  const Scalar _tmp55 = Scalar(0.20999999999999999) * _tmp17 + Scalar(0.20999999999999999) * _tmp18;
  const Scalar _tmp56 = _tmp54 + _tmp55;
  const Scalar _tmp57 = _tmp53 + _tmp56;
  const Scalar _tmp58 = _tmp44 + Scalar(-4.7744369927459998);
  const Scalar _tmp59 = _tmp41 + Scalar(-2.7171519410699099);
  const Scalar _tmp60 = Scalar(1.0) / (_tmp59);
  const Scalar _tmp61 = _tmp58 * _tmp60;
  const Scalar _tmp62 = _tmp57 * _tmp61;
  const Scalar _tmp63 = -_tmp53;
  const Scalar _tmp64 = _tmp56 + _tmp63;
  const Scalar _tmp65 = _tmp50 * _tmp51;
  const Scalar _tmp66 = _tmp52 * _tmp61 - _tmp65;
  ...
  const Scalar _tmp70 = _tmp25 + _tmp32;
  ...
  const Scalar _tmp77 = _tmp54 - _tmp55;
  const Scalar _tmp78 = _tmp53 + _tmp77;
  const Scalar _tmp79 = _tmp76 * (-_tmp62 * _tmp74 + _tmp75 * _tmp78);
  const Scalar _tmp80 = -_tmp52 * _tmp62 + _tmp64 * _tmp65 - _tmp66 * _tmp79;
  ...
  const Scalar _tmp87 = _tmp76 * (_tmp57 * _tmp74 - _tmp74 * _tmp78);
  const Scalar _tmp88 = _tmp52 * _tmp57 - _tmp52 * _tmp64 - _tmp66 * _tmp87 - _tmp80 * _tmp86;
  ...
  const Scalar _tmp93 = _tmp92 * (_tmp40 * _tmp58 * _tmp91 - _tmp43 * _tmp59 * _tmp91);
  const Scalar _tmp94 = _tmp76 * (_tmp67 * _tmp74 - _tmp70 * _tmp75 + _tmp74 * _tmp93);
  const Scalar _tmp95 = _tmp61 * _tmp79 + _tmp62;
  const Scalar _tmp96 = -_tmp57 + _tmp61 * _tmp87 - _tmp86 * _tmp95;
  const Scalar _tmp97 = -_tmp45 * _tmp65 + _tmp48 * _tmp52 + _tmp52 * _tmp93 - _tmp66 * _tmp94;
  const Scalar _tmp98 = _tmp89 * _tmp97;
  const Scalar _tmp99 = Scalar(1.0) / (_tmp97);
  const Scalar _tmp100 = _tmp88 * _tmp99;
  const Scalar _tmp101 = _tmp100 * (_tmp61 * _tmp94 - _tmp93 - _tmp96 * _tmp98);
  const Scalar _tmp102 = _tmp101 + _tmp96;
  const Scalar _tmp103 = _tmp102 * _tmp89;
  const Scalar _tmp104 = _tmp66 * _tmp89;
  const Scalar _tmp105 = _tmp76 * (-_tmp102 * _tmp104 - _tmp61);
  ...
  const Scalar _tmp110 = _tmp109 * _tmp92 * (_tmp103 * _tmp52 + _tmp105 * _tmp74 + Scalar(1.0));
  ...
  const Scalar _tmp115 = _tmp66 * _tmp76;
  const Scalar _tmp116 = _tmp115 * _tmp74;
  const Scalar _tmp117 = _tmp107 * _tmp108;
  const Scalar _tmp118 = -_tmp109 * _tmp22 + _tmp117 * _tmp33;
  const Scalar _tmp119 = Scalar(1.0) * _tmp99;
  const Scalar _tmp120 = _tmp118 * _tmp92 * (-_tmp116 * _tmp119 + _tmp119 * _tmp52);
  const Scalar _tmp121 = Scalar(1.0) * _tmp83;
  const Scalar _tmp122 = _tmp121 * _tmp79 * _tmp85 - Scalar(1.0) * _tmp87;
  const Scalar _tmp123 = _tmp100 * (-_tmp122 * _tmp98 - Scalar(1.0) * _tmp94);
  const Scalar _tmp124 = _tmp122 + _tmp123;
  const Scalar _tmp125 = _tmp76 * (-_tmp104 * _tmp124 + Scalar(1.0));
  const Scalar _tmp126 = _tmp124 * _tmp89;
  const Scalar _tmp127 = _tmp117 * _tmp92 * (_tmp125 * _tmp74 + _tmp126 * _tmp52);
  const Scalar _tmp128 = -_tmp110 * fh1 -
                         _tmp111 * _tmp92 * (-_tmp114 * _tmp116 + _tmp114 * _tmp52) -
                         _tmp120 * fh1 - _tmp127 * fh1;
  const Scalar _tmp129 = Scalar(1.0) / (_tmp128);
  const Scalar _tmp130 = _tmp48 + _tmp82;
  const Scalar _tmp131 = _tmp130 * _tmp86;
  const Scalar _tmp132 = Scalar(1.0) / (-_tmp131 - _tmp45 + _tmp84);
  const Scalar _tmp133 = _tmp130 * _tmp132;
  const Scalar _tmp134 = _tmp80 * _tmp89;
  const Scalar _tmp135 = _tmp123 * _tmp133 - _tmp124 * _tmp134 - Scalar(1.0) * _tmp79;
  const Scalar _tmp136 = Scalar(1.0) * _tmp132;
  const Scalar _tmp137 = Scalar(1.0) * _tmp117 * (-_tmp121 * _tmp135 + _tmp123 * _tmp136);
  const Scalar _tmp138 = _tmp63 + _tmp77;
  const Scalar _tmp139 = _tmp138 * fh1;
  const Scalar _tmp140 = -_tmp117 * _tmp139 - Scalar(3.29616) * _tmp19 - _tmp22 * fv1;
  ...
  const Scalar _tmp144 = _tmp109 * _tmp139 + Scalar(3.29616) * _tmp29 + _tmp33 * fv1;
  const Scalar _tmp145 = _tmp130 * _tmp83;
  const Scalar _tmp146 = Scalar(1.0) * _tmp136 * _tmp145 - Scalar(1.0) * _tmp136;
  const Scalar _tmp147 = _tmp101 * _tmp133 - _tmp102 * _tmp134 + _tmp95;
  const Scalar _tmp148 = Scalar(1.0) * _tmp109 * (_tmp101 * _tmp136 - _tmp121 * _tmp147);
  const Scalar _tmp149 = _tmp112 * _tmp132;
  const Scalar _tmp150 = -_tmp113 * _tmp134 - _tmp130 * _tmp149 + _tmp82;
  const Scalar _tmp151 = _tmp100 * _tmp136;
  const Scalar _tmp152 = -_tmp119 * _tmp80 + _tmp130 * _tmp151;
  const Scalar _tmp153 = Scalar(1.0) * _tmp118;
  const Scalar _tmp154 = _tmp153 * (-_tmp121 * _tmp152 + _tmp151);
  const Scalar _tmp155 =
      Scalar(1.0) * _tmp111 * (-_tmp112 * _tmp136 - _tmp121 * _tmp150 + Scalar(1.0)) +
      _tmp137 * fh1 + _tmp140 * _tmp143 + _tmp144 * _tmp146 + _tmp148 * fh1 + _tmp154 * fh1;
  ...
  const Scalar _tmp162 = -_tmp110 - _tmp120 - _tmp127;
  ...
  const Scalar _tmp166 = _tmp109 * _tmp138;
  const Scalar _tmp167 = _tmp117 * _tmp138;
  const Scalar _tmp168 =
      (_tmp129 * (_tmp137 - _tmp143 * _tmp167 + _tmp146 * _tmp166 + _tmp148 + _tmp154) -
       _tmp155 * _tmp165) /
      std::sqrt(Scalar(std::pow(_tmp155, Scalar(2)) * _tmp164 + 1));
  const Scalar _tmp169 = _tmp109 * _tmp83;
  const Scalar _tmp170 = _tmp147 * _tmp169;
  const Scalar _tmp171 = _tmp136 * _tmp144;
  const Scalar _tmp172 = _tmp118 * _tmp152 * _tmp83;
  const Scalar _tmp173 = _tmp117 * _tmp135 * _tmp83;
  const Scalar _tmp174 = _tmp142 * _tmp83;
  const Scalar _tmp175 = _tmp111 * _tmp150 * _tmp83 + _tmp140 * _tmp174 - _tmp145 * _tmp171 +
                         _tmp170 * fh1 + _tmp172 * fh1 + _tmp173 * fh1;
  const Scalar _tmp176 = _tmp105 * _tmp109;
  const Scalar _tmp177 = _tmp117 * _tmp125;
  const Scalar _tmp178 = _tmp111 * _tmp114;
  const Scalar _tmp179 = _tmp153 * _tmp99;
  const Scalar _tmp180 = _tmp179 * fh1;
  const Scalar _tmp181 = -_tmp115 * _tmp178 - _tmp115 * _tmp180 + _tmp176 * fh1 + _tmp177 * fh1;
  ...
  const Scalar _tmp189 = -_tmp115 * _tmp179 + _tmp176 + _tmp177;
  ...
  const Scalar _tmp193 =
      (-_tmp175 * _tmp192 + _tmp182 * (-_tmp130 * _tmp136 * _tmp138 * _tmp169 - _tmp167 * _tmp174 +
                                       _tmp170 + _tmp172 + _tmp173)) /
      std::sqrt(Scalar(std::pow(_tmp175, Scalar(2)) * _tmp191 + 1));
  const Scalar _tmp194 = _tmp103 * _tmp109;
  const Scalar _tmp195 = _tmp117 * _tmp126;
  const Scalar _tmp196 = _tmp178 + _tmp180 + _tmp194 * fh1 + _tmp195 * fh1;
  const Scalar _tmp197 = Scalar(1.0) / (_tmp196);
  const Scalar _tmp198 = _tmp101 * _tmp109 * _tmp132;
  const Scalar _tmp199 = _tmp118 * _tmp151;
  const Scalar _tmp200 = _tmp117 * _tmp123 * _tmp132;
  const Scalar _tmp201 = _tmp111 * _tmp149 - _tmp140 * _tmp141 + _tmp171 - _tmp198 * fh1 -
                         _tmp199 * fh1 - _tmp200 * fh1;
  const Scalar _tmp202 = std::asinh(_tmp197 * _tmp201);
  const Scalar _tmp203 = _tmp179 + _tmp194 + _tmp195;
  const Scalar _tmp204 = Scalar(9.6622558468725703) * _tmp203;
  const Scalar _tmp205 = Scalar(9.6622558468725703) * _tmp196;
  const Scalar _tmp206 = std::pow(_tmp196, Scalar(-2));
  const Scalar _tmp207 = _tmp203 * _tmp206;
  const Scalar _tmp208 =
      (_tmp197 * (_tmp136 * _tmp166 + _tmp141 * _tmp167 - _tmp198 - _tmp199 - _tmp200) -
       _tmp201 * _tmp207) /
      std::sqrt(Scalar(std::pow(_tmp201, Scalar(2)) * _tmp206 + 1));
  const Scalar _tmp209 = Scalar(0.1034955) * _tmp197;
  ...
  _res(1, 0) =
      -_tmp157 *
          (-Scalar(0.86564762886483004) * _tmp165 + Scalar(1.0) * _tmp168 * std::sinh(_tmp161) -
           (-Scalar(0.1034955) * _tmp158 * _tmp165 +
            _tmp159 * (-_tmp156 * _tmp163 - _tmp157 * _tmp168)) *
               std::sinh(_tmp160)) -
      _tmp163 * (Scalar(0.86564762886483004) * _tmp129 - std::cosh(_tmp160) + std::cosh(_tmp161));
  _res(2, 0) =
      -_tmp185 *
          (-Scalar(0.876505537412406) * _tmp192 + Scalar(1.0) * _tmp193 * std::sinh(_tmp184) -
           (-Scalar(0.1034955) * _tmp186 * _tmp192 +
            _tmp187 * (-_tmp183 * _tmp190 - _tmp185 * _tmp193)) *
               std::sinh(_tmp188)) -
      _tmp190 * (Scalar(0.876505537412406) * _tmp182 + std::cosh(_tmp184) - std::cosh(_tmp188));
  _res(3, 0) =
      -_tmp204 * (Scalar(0.86627065637365697) * _tmp197 - std::cosh(_tmp211) + std::cosh(_tmp212)) -
      _tmp205 *
          (-Scalar(0.86627065637365697) * _tmp207 + Scalar(1.0) * _tmp208 * std::sinh(_tmp212) -
           (-Scalar(0.1034955) * _tmp207 * _tmp210 +
            _tmp209 * (-_tmp202 * _tmp204 - _tmp205 * _tmp208)) *
               std::sinh(_tmp211));
