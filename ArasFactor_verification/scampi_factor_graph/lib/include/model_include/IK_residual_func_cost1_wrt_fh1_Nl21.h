...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1WrtFh1Nl21(
  ...
  const Scalar _tmp65 = _tmp46 * _tmp50;
  const Scalar _tmp66 = -_tmp51 * _tmp62 + _tmp64 * _tmp65;
  const Scalar _tmp67 = Scalar(1.0) / (_tmp51 * _tmp61 - _tmp65);
  const Scalar _tmp68 = _tmp61 * _tmp67;
  const Scalar _tmp69 = _tmp62 + _tmp66 * _tmp68;
  const Scalar _tmp70 = Scalar(1.0) * _tmp58;
  const Scalar _tmp71 = -_tmp70;
  const Scalar _tmp72 = Scalar(1.0) / (_tmp44 + _tmp71);
  const Scalar _tmp73 = Scalar(1.0) * _tmp53;
  const Scalar _tmp74 = _tmp72 * (-_tmp47 + _tmp73);
  const Scalar _tmp75 = _tmp42 * _tmp51 - _tmp51 * _tmp64;
  const Scalar _tmp76 = -_tmp42 + _tmp68 * _tmp75 - _tmp69 * _tmp74;
  ...
  const Scalar _tmp82 = _tmp27 + _tmp57;
  ...
  const Scalar _tmp90 = -_tmp62 * _tmp86 - _tmp66 * _tmp89 + _tmp78 * _tmp87;
  const Scalar _tmp91 = _tmp42 * _tmp86 - _tmp74 * _tmp90 - _tmp75 * _tmp89 - _tmp78 * _tmp86;
  ...
  const Scalar _tmp96 = _tmp95 * (_tmp53 * _tmp60 * _tmp94 - _tmp55 * _tmp58 * _tmp94);
  const Scalar _tmp97 = _tmp44 * _tmp51 - _tmp47 * _tmp65 + _tmp51 * _tmp96;
  ...
  const Scalar _tmp109 = _tmp102 * _tmp106 - _tmp107 * _tmp108 + _tmp69;
  const Scalar _tmp110 = Scalar(1.0) * _tmp72;
  const Scalar _tmp111 = Scalar(1.0) * _tmp105;
  const Scalar _tmp112 = _tmp19 + Scalar(1.7965602546229);
  ...
  const Scalar _tmp119 = _tmp103 * _tmp117 - _tmp118 * _tmp90;
  const Scalar _tmp120 = _tmp113 * _tmp114;
  const Scalar _tmp121 = -_tmp115 * _tmp28 + _tmp120 * _tmp18;
  const Scalar _tmp122 = Scalar(1.0) * _tmp121 * (-_tmp110 * _tmp119 + _tmp117);
  const Scalar _tmp123 = Scalar(1.0) * _tmp67;
  const Scalar _tmp124 = _tmp123 * _tmp66;
  const Scalar _tmp125 = -_tmp123 * _tmp75 + _tmp124 * _tmp74;
  const Scalar _tmp126 = _tmp101 * (-_tmp123 * _tmp97 - _tmp125 * _tmp99);
  const Scalar _tmp127 = _tmp125 + _tmp126;
  const Scalar _tmp128 = _tmp106 * _tmp126 - _tmp108 * _tmp127 - _tmp124;
  const Scalar _tmp129 = Scalar(1.0) * _tmp120 * (-_tmp110 * _tmp128 + _tmp111 * _tmp126);
  const Scalar _tmp130 = _tmp63 + _tmp77;
  const Scalar _tmp131 = _tmp130 * fh1;
  const Scalar _tmp132 = Scalar(3.29616) * _tmp11 + _tmp115 * _tmp131 + _tmp18 * fv1;
  const Scalar _tmp133 = _tmp103 * _tmp72;
  const Scalar _tmp134 = Scalar(1.0) * _tmp111 * _tmp133 - Scalar(1.0) * _tmp111;
  const Scalar _tmp135 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp136 = _tmp70 * _tmp74 + _tmp73;
  const Scalar _tmp137 = _tmp105 * _tmp136;
  const Scalar _tmp138 = 0;
  const Scalar _tmp139 = -_tmp103 * _tmp137 - _tmp138 * _tmp90 + _tmp71;
  const Scalar _tmp140 = -_tmp120 * _tmp131 - Scalar(3.29616) * _tmp25 - _tmp28 * fv1;
  ...
  const Scalar _tmp144 =
      _tmp116 * fh1 + _tmp122 * fh1 + _tmp129 * fh1 + _tmp132 * _tmp134 +
      Scalar(1.0) * _tmp135 * (-_tmp110 * _tmp139 - _tmp111 * _tmp136 + Scalar(1.0)) +
      _tmp140 * _tmp143;
  const Scalar _tmp145 = _tmp51 * _tmp89;
  const Scalar _tmp146 = _tmp88 * _tmp92;
  const Scalar _tmp147 = _tmp67 * (-_tmp127 * _tmp146 + Scalar(1.0));
  const Scalar _tmp148 = _tmp86 * _tmp92;
  const Scalar _tmp149 = _tmp120 * _tmp95 * (_tmp127 * _tmp148 + _tmp147 * _tmp51);
  const Scalar _tmp150 = _tmp67 * (-_tmp107 * _tmp146 - _tmp61);
  const Scalar _tmp151 = _tmp115 * _tmp95 * (_tmp107 * _tmp148 + _tmp150 * _tmp51 + Scalar(1.0));
  const Scalar _tmp152 = _tmp121 * _tmp95 * (-_tmp118 * _tmp145 + _tmp118 * _tmp86);
  const Scalar _tmp153 = -_tmp135 * _tmp95 * (-_tmp138 * _tmp145 + _tmp138 * _tmp86) -
  ...
  const Scalar _tmp165 = _tmp115 * _tmp130;
  const Scalar _tmp166 = _tmp120 * _tmp130;
  const Scalar _tmp167 = (-_tmp144 * _tmp164 + _tmp154 * (_tmp116 + _tmp122 + _tmp129 +
                                                          _tmp134 * _tmp165 - _tmp143 * _tmp166)) /
                         std::sqrt(Scalar(std::pow(_tmp144, Scalar(2)) * _tmp163 + 1));
  const Scalar _tmp168 = _tmp120 * _tmp147;
  const Scalar _tmp169 = _tmp118 * _tmp121;
  const Scalar _tmp170 = _tmp169 * fh1;
  const Scalar _tmp171 = _tmp135 * _tmp138;
  const Scalar _tmp172 = _tmp115 * _tmp150;
  const Scalar _tmp173 = _tmp168 * fh1 - _tmp170 * _tmp89 - _tmp171 * _tmp89 + _tmp172 * fh1;
  const Scalar _tmp174 = Scalar(1.0) / (_tmp173);
  const Scalar _tmp175 = _tmp115 * _tmp72;
  const Scalar _tmp176 = _tmp109 * _tmp175;
  const Scalar _tmp177 = _tmp142 * _tmp72;
  const Scalar _tmp178 = _tmp119 * _tmp121 * _tmp72;
  const Scalar _tmp179 = _tmp120 * _tmp128 * _tmp72;
  const Scalar _tmp180 = _tmp111 * _tmp132;
  const Scalar _tmp181 = -_tmp133 * _tmp180 + _tmp135 * _tmp139 * _tmp72 + _tmp140 * _tmp177 +
                         _tmp176 * fh1 + _tmp178 * fh1 + _tmp179 * fh1;
  const Scalar _tmp182 = std::asinh(_tmp174 * _tmp181);
  const Scalar _tmp183 = Scalar(1.0) * _tmp182;
  const Scalar _tmp184 = std::pow(_tmp173, Scalar(-2));
  const Scalar _tmp185 = _tmp168 - _tmp169 * _tmp89 + _tmp172;
  const Scalar _tmp186 = _tmp184 * _tmp185;
  const Scalar _tmp187 = (_tmp174 * (-_tmp103 * _tmp111 * _tmp130 * _tmp175 - _tmp166 * _tmp177 +
                                     _tmp176 + _tmp178 + _tmp179) -
                          _tmp181 * _tmp186) /
                         std::sqrt(Scalar(std::pow(_tmp181, Scalar(2)) * _tmp184 + 1));
  const Scalar _tmp188 = Scalar(9.6622558468725703) * _tmp173;
          ...
          std::sqrt(
              Scalar(std::pow(Scalar(1 - Scalar(0.2094487793051498) * _tmp45), Scalar(2)) +
                     Scalar(0.32387954179207445) *
                         std::pow(Scalar(1 - Scalar(0.36803241838814449) * _tmp48), Scalar(2))));
  const Scalar _tmp190 = Scalar(9.6622558468725703) * _tmp185;
  const Scalar _tmp191 = Scalar(0.1034955) * _tmp174;
  const Scalar _tmp192 = _tmp189 * _tmp191;
  const Scalar _tmp193 = _tmp105 * _tmp120 * _tmp126;
  const Scalar _tmp194 = _tmp102 * _tmp105 * _tmp115;
  const Scalar _tmp195 = _tmp117 * _tmp121;
  const Scalar _tmp196 = _tmp135 * _tmp137 - _tmp140 * _tmp141 + _tmp180 - _tmp193 * fh1 -
                         _tmp194 * fh1 - _tmp195 * fh1;
  const Scalar _tmp197 = _tmp107 * _tmp115 * _tmp92;
  const Scalar _tmp198 = _tmp120 * _tmp127 * _tmp92;
  const Scalar _tmp199 = _tmp170 + _tmp171 + _tmp197 * fh1 + _tmp198 * fh1;
  ...
  const Scalar _tmp211 = (-_tmp196 * _tmp210 + _tmp200 * (_tmp111 * _tmp165 + _tmp141 * _tmp166 -
  ...
  _res(1, 0) =
      -_tmp157 *
          (-Scalar(0.876505537412406) * _tmp164 + Scalar(1.0) * _tmp167 * std::sinh(_tmp156) -
           (-Scalar(0.1034955) * _tmp158 * _tmp164 +
            _tmp159 * (-_tmp155 * _tmp162 - _tmp157 * _tmp167)) *
               std::sinh(_tmp160)) -
      _tmp162 * (Scalar(0.876505537412406) * _tmp154 + std::cosh(_tmp156) - std::cosh(_tmp160));
  _res(2, 0) =
      -_tmp188 *
          (-Scalar(0.86564762886483004) * _tmp186 + Scalar(1.0) * _tmp187 * std::sinh(_tmp183) -
           (-Scalar(0.1034955) * _tmp186 * _tmp189 +
            _tmp191 * (-_tmp182 * _tmp190 - _tmp187 * _tmp188)) *
               std::sinh(_tmp192)) -
      _tmp190 * (Scalar(0.86564762886483004) * _tmp174 + std::cosh(_tmp183) - std::cosh(_tmp192));
  _res(3, 0) =
      -_tmp203 *
