...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1WrtFh1Nl22(
  ...
  const Scalar _tmp79 = -_tmp45 * _tmp74 + _tmp49 * _tmp53 + _tmp53 * _tmp78;
  const Scalar _tmp80 = Scalar(1.0) / (_tmp53 * _tmp63 - _tmp74);
  const Scalar _tmp81 = _tmp73 * _tmp80;
  const Scalar _tmp82 = _tmp64 * _tmp71 - _tmp67 * _tmp72 + _tmp71 * _tmp78 - _tmp79 * _tmp81;
  ...
  const Scalar _tmp87 = _tmp43 * _tmp77 * (-_tmp53 * _tmp85 + _tmp71 * _tmp86);
  ...
  const Scalar _tmp91 = Scalar(0.20999999999999999) * _tmp13 - Scalar(0.20999999999999999) * _tmp14;
  ...
  const Scalar _tmp98 = -_tmp53 * _tmp97 + _tmp74 * _tmp95;
  const Scalar _tmp99 = -_tmp71 * _tmp97 + _tmp72 * _tmp93 - _tmp81 * _tmp98;
  const Scalar _tmp100 = Scalar(1.0) * _tmp55;
  const Scalar _tmp101 = -_tmp100;
  const Scalar _tmp102 = Scalar(1.0) / (_tmp101 + _tmp49);
  const Scalar _tmp103 = Scalar(1.0) * _tmp59;
  const Scalar _tmp104 = _tmp102 * (_tmp103 - _tmp45);
  const Scalar _tmp105 = -_tmp53 * _tmp95 + _tmp53 * _tmp96;
  const Scalar _tmp106 = -_tmp104 * _tmp99 - _tmp105 * _tmp81 - _tmp71 * _tmp93 + _tmp71 * _tmp96;
  const Scalar _tmp107 = Scalar(1.0) / (_tmp106);
  const Scalar _tmp108 = _tmp63 * _tmp80;
  const Scalar _tmp109 = _tmp108 * _tmp98 + _tmp97;
  const Scalar _tmp110 = -_tmp104 * _tmp109 + _tmp105 * _tmp108 - _tmp96;
  const Scalar _tmp111 = _tmp107 * _tmp82;
  const Scalar _tmp112 = _tmp106 * _tmp83;
  const Scalar _tmp113 = _tmp112 * (_tmp108 * _tmp79 - _tmp110 * _tmp111 - _tmp78);
  const Scalar _tmp114 = _tmp107 * (_tmp110 + _tmp113);
  const Scalar _tmp115 = _tmp80 * (-_tmp114 * _tmp73 - _tmp63);
  const Scalar _tmp116 = _tmp41 * _tmp77 * (_tmp114 * _tmp71 + _tmp115 * _tmp53 + Scalar(1.0));
  const Scalar _tmp117 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp118 = _tmp100 * _tmp104 + _tmp103;
  const Scalar _tmp119 = 0;
  const Scalar _tmp120 = _tmp84 * _tmp98;
  const Scalar _tmp121 = _tmp104 * _tmp120 - _tmp105 * _tmp84;
  const Scalar _tmp122 = _tmp112 * (-_tmp111 * _tmp121 - _tmp79 * _tmp84);
  const Scalar _tmp123 = _tmp107 * (_tmp121 + _tmp122);
  const Scalar _tmp124 = _tmp80 * (-_tmp123 * _tmp73 + Scalar(1.0));
  const Scalar _tmp125 = _tmp42 * _tmp77 * (_tmp123 * _tmp71 + _tmp124 * _tmp53);
  const Scalar _tmp126 = -_tmp116 * fh1 -
                         _tmp117 * _tmp77 * (-_tmp119 * _tmp53 * _tmp81 + _tmp119 * _tmp71) -
                         _tmp125 * fh1 - _tmp87 * fh1;
  const Scalar _tmp127 = std::pow(_tmp126, Scalar(-2));
  const Scalar _tmp128 = -_tmp116 - _tmp125 - _tmp87;
  const Scalar _tmp129 = _tmp127 * _tmp128;
  const Scalar _tmp130 = Scalar(1.0) / (_tmp126);
  const Scalar _tmp131 = _tmp101 + _tmp64;
  const Scalar _tmp132 = _tmp104 * _tmp131;
  const Scalar _tmp133 = Scalar(1.0) / (_tmp103 - _tmp132 - _tmp67);
  const Scalar _tmp134 = Scalar(1.0) * _tmp133;
  const Scalar _tmp135 = _tmp112 * _tmp134;
  const Scalar _tmp136 = _tmp131 * _tmp135 - _tmp86 * _tmp99;
  const Scalar _tmp137 = Scalar(1.0) * _tmp102;
  const Scalar _tmp138 = Scalar(1.0) * _tmp43;
  const Scalar _tmp139 = _tmp138 * (_tmp135 - _tmp136 * _tmp137);
  const Scalar _tmp140 = _tmp88 + _tmp94;
  const Scalar _tmp141 = _tmp140 * fh1;
  const Scalar _tmp142 = _tmp141 * _tmp41 + Scalar(3.29616) * _tmp15 + _tmp18 * fv1;
  const Scalar _tmp143 = _tmp102 * _tmp131;
  const Scalar _tmp144 = _tmp134 * _tmp143;
  const Scalar _tmp145 = -Scalar(1.0) * _tmp134 + Scalar(1.0) * _tmp144;
  const Scalar _tmp146 = _tmp131 * _tmp133;
  const Scalar _tmp147 = -_tmp120 + _tmp122 * _tmp146 - _tmp123 * _tmp99;
  const Scalar _tmp148 = Scalar(1.0) * _tmp42 * (_tmp122 * _tmp134 - _tmp137 * _tmp147);
  const Scalar _tmp149 = _tmp118 * _tmp133;
  const Scalar _tmp150 = _tmp101 - _tmp119 * _tmp99 - _tmp131 * _tmp149;
  const Scalar _tmp151 = -_tmp141 * _tmp42 - Scalar(3.29616) * _tmp25 - _tmp28 * fv1;
  const Scalar _tmp152 = _tmp132 * _tmp134 + Scalar(1.0);
  const Scalar _tmp153 = _tmp104 * _tmp134;
  const Scalar _tmp154 = -Scalar(1.0) * _tmp137 * _tmp152 + Scalar(1.0) * _tmp153;
  const Scalar _tmp155 = _tmp109 + _tmp113 * _tmp146 - _tmp114 * _tmp99;
  const Scalar _tmp156 = Scalar(1.0) * _tmp41 * (_tmp113 * _tmp134 - _tmp137 * _tmp155);
  const Scalar _tmp157 =
      Scalar(1.0) * _tmp117 * (-_tmp118 * _tmp134 - _tmp137 * _tmp150 + Scalar(1.0)) +
      _tmp139 * fh1 + _tmp142 * _tmp145 + _tmp148 * fh1 + _tmp151 * _tmp154 + _tmp156 * fh1;
  ...
  const Scalar _tmp164 = _tmp140 * _tmp42;
  const Scalar _tmp165 = _tmp140 * _tmp41;
  const Scalar _tmp166 = (-_tmp129 * _tmp157 + _tmp130 * (_tmp139 + _tmp145 * _tmp165 + _tmp148 -
                                                          _tmp154 * _tmp164 + _tmp156)) /
                         std::sqrt(Scalar(_tmp127 * std::pow(_tmp157, Scalar(2)) + 1));
  const Scalar _tmp167 = Scalar(1.0) * _tmp158;
  const Scalar _tmp168 = _tmp117 * _tmp119;
  const Scalar _tmp169 = _tmp115 * _tmp41;
  const Scalar _tmp170 = _tmp43 * _tmp85;
  const Scalar _tmp171 = _tmp124 * _tmp42;
  const Scalar _tmp172 = -_tmp168 * _tmp81 + _tmp169 * fh1 - _tmp170 * fh1 + _tmp171 * fh1;
  const Scalar _tmp173 = Scalar(1.0) / (_tmp172);
  const Scalar _tmp174 = _tmp102 * _tmp152;
  const Scalar _tmp175 = _tmp102 * _tmp155 * _tmp41;
  const Scalar _tmp176 = _tmp102 * _tmp136 * _tmp43;
  const Scalar _tmp177 = _tmp134 * _tmp142;
  const Scalar _tmp178 = _tmp102 * _tmp147 * _tmp42;
  const Scalar _tmp179 = _tmp102 * _tmp117 * _tmp150 - _tmp143 * _tmp177 + _tmp151 * _tmp174 +
  ...
  const Scalar _tmp186 = _tmp169 - _tmp170 + _tmp171;
  ...
  const Scalar _tmp190 =
      (_tmp173 * (-_tmp144 * _tmp165 - _tmp164 * _tmp174 + _tmp175 + _tmp176 + _tmp178) -
       _tmp179 * _tmp189) /
      std::sqrt(Scalar(std::pow(_tmp179, Scalar(2)) * _tmp188 + 1));
  const Scalar _tmp191 = _tmp123 * _tmp42;
  const Scalar _tmp192 = _tmp114 * _tmp41;
  const Scalar _tmp193 = _tmp138 * _tmp83;
  const Scalar _tmp194 = _tmp168 + _tmp191 * fh1 + _tmp192 * fh1 + _tmp193 * fh1;
  const Scalar _tmp195 = Scalar(1.0) / (_tmp194);
  const Scalar _tmp196 = _tmp122 * _tmp133 * _tmp42;
  const Scalar _tmp197 = _tmp113 * _tmp133 * _tmp41;
  const Scalar _tmp198 = _tmp135 * _tmp43;
  const Scalar _tmp199 = _tmp117 * _tmp149 - _tmp151 * _tmp153 + _tmp177 - _tmp196 * fh1 -
  ...
  const Scalar _tmp210 =
      (_tmp195 * (_tmp134 * _tmp165 + _tmp153 * _tmp164 - _tmp196 - _tmp197 - _tmp198) -
       _tmp199 * _tmp209) /
  ...
  _res(1, 0) =
      -Scalar(9.6622558468725703) * _tmp128 *
          (Scalar(0.86564762886483004) * _tmp130 - std::cosh(_tmp162) + std::cosh(_tmp167)) -
      _tmp163 *
          (-Scalar(0.86564762886483004) * _tmp129 + Scalar(1.0) * _tmp166 * std::sinh(_tmp167) -
           (-Scalar(0.1034955) * _tmp129 * _tmp160 +
            _tmp161 * (-_tmp128 * _tmp159 - _tmp163 * _tmp166)) *
               std::sinh(_tmp162));
  _res(2, 0) =
      -_tmp182 *
          (-Scalar(0.87679799777269396) * _tmp189 + Scalar(1.0) * _tmp190 * std::sinh(_tmp181) -
           (-Scalar(0.1034955) * _tmp183 * _tmp189 +
            _tmp184 * (-_tmp180 * _tmp187 - _tmp182 * _tmp190)) *
               std::sinh(_tmp185)) -
      _tmp187 * (Scalar(0.87679799777269396) * _tmp173 + std::cosh(_tmp181) - std::cosh(_tmp185));
  _res(3, 0) =
      -_tmp201 *
          (-Scalar(0.876505537412406) * _tmp209 + Scalar(1.0) * _tmp210 * std::sinh(_tmp205) -
           (-Scalar(0.1034955) * _tmp202 * _tmp209 +
            _tmp203 * (-_tmp200 * _tmp207 - _tmp201 * _tmp210)) *
               std::sinh(_tmp204)) -
      _tmp207 * (Scalar(0.876505537412406) * _tmp195 - std::cosh(_tmp204) + std::cosh(_tmp205));
