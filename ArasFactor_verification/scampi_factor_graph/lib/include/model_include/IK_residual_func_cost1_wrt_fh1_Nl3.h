...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1WrtFh1Nl3(
  ...
  const Scalar _tmp42 = _tmp41 + Scalar(8.3885017487099702);
  ...
  const Scalar _tmp49 = Scalar(0.20999999999999999) * _tmp17 + Scalar(0.20999999999999999) * _tmp18;
  const Scalar _tmp50 = -_tmp49;
  const Scalar _tmp51 = -Scalar(0.010999999999999999) * _tmp30 -
  ...
  const Scalar _tmp76 = -_tmp64 * _tmp72 + _tmp74 * _tmp75;
  const Scalar _tmp77 = Scalar(1.0) / (_tmp63 * _tmp72 - _tmp75);
  const Scalar _tmp78 = _tmp42 * _tmp47;
  const Scalar _tmp79 = _tmp48 * _tmp63 - _tmp78;
  const Scalar _tmp80 = _tmp77 * _tmp79;
  const Scalar _tmp81 = -_tmp48 * _tmp64 + _tmp54 * _tmp78 - _tmp76 * _tmp80;
  ...
  const Scalar _tmp87 = _tmp55 * _tmp72 - _tmp72 * _tmp74;
  const Scalar _tmp88 = -_tmp48 * _tmp54 + _tmp48 * _tmp55 - _tmp80 * _tmp87 - _tmp81 * _tmp86;
  ...
  const Scalar _tmp94 = _tmp77 * (-_tmp65 * _tmp75 + _tmp68 * _tmp72 + _tmp72 * _tmp93);
  const Scalar _tmp95 = _tmp63 * _tmp77;
  const Scalar _tmp96 = _tmp64 + _tmp76 * _tmp95;
  const Scalar _tmp97 = -_tmp55 - _tmp86 * _tmp96 + _tmp87 * _tmp95;
  const Scalar _tmp98 = _tmp40 * _tmp48 - _tmp44 * _tmp78 + _tmp48 * _tmp93 - _tmp79 * _tmp94;
  const Scalar _tmp99 = _tmp89 * _tmp98;
  const Scalar _tmp100 = Scalar(1.0) / (_tmp98);
  const Scalar _tmp101 = _tmp100 * _tmp88;
  const Scalar _tmp102 = _tmp101 * (_tmp63 * _tmp94 - _tmp93 - _tmp97 * _tmp99);
  const Scalar _tmp103 = _tmp102 + _tmp97;
  const Scalar _tmp104 = _tmp103 * _tmp89;
  const Scalar _tmp105 = _tmp79 * _tmp89;
  const Scalar _tmp106 = _tmp77 * (-_tmp103 * _tmp105 - _tmp63);
  const Scalar _tmp107 = _tmp34 + Scalar(1.9874742031097401);
  const Scalar _tmp108 = _tmp23 + Scalar(8.3196563720703107);
  const Scalar _tmp109 =
      std::pow(Scalar(std::pow(_tmp107, Scalar(2)) + std::pow(_tmp108, Scalar(2))),
               Scalar(Scalar(-1) / Scalar(2)));
  const Scalar _tmp110 = _tmp107 * _tmp109;
  const Scalar _tmp111 = _tmp110 * _tmp92 * (_tmp104 * _tmp48 + _tmp106 * _tmp72 + Scalar(1.0));
  ...
  const Scalar _tmp115 = _tmp101 * (-_tmp114 * _tmp99 - Scalar(1.0) * _tmp94);
  const Scalar _tmp116 = _tmp114 + _tmp115;
  const Scalar _tmp117 = _tmp77 * (-_tmp105 * _tmp116 + Scalar(1.0));
  const Scalar _tmp118 = _tmp116 * _tmp89;
  const Scalar _tmp119 = _tmp108 * _tmp109;
  const Scalar _tmp120 = _tmp119 * _tmp92 * (_tmp117 * _tmp72 + _tmp118 * _tmp48);
  ...
  const Scalar _tmp125 = _tmp72 * _tmp80;
  const Scalar _tmp126 = -_tmp110 * _tmp22 + _tmp119 * _tmp33;
  const Scalar _tmp127 = Scalar(1.0) * _tmp100;
  const Scalar _tmp128 = _tmp126 * _tmp92 * (-_tmp125 * _tmp127 + _tmp127 * _tmp48);
  const Scalar _tmp129 = -_tmp111 * fh1 - _tmp120 * fh1 -
                         _tmp121 * _tmp92 * (-_tmp124 * _tmp125 + _tmp124 * _tmp48) - _tmp128 * fh1;
  const Scalar _tmp130 = std::pow(_tmp129, Scalar(-2));
  const Scalar _tmp131 = -_tmp111 - _tmp120 - _tmp128;
  const Scalar _tmp132 = _tmp130 * _tmp131;
  const Scalar _tmp133 = _tmp40 + _tmp83;
  const Scalar _tmp134 = _tmp133 * _tmp86;
  const Scalar _tmp135 = Scalar(1.0) / (-_tmp134 - _tmp44 + _tmp85);
  const Scalar _tmp136 = Scalar(1.0) * _tmp135;
  const Scalar _tmp137 = _tmp81 * _tmp89;
  const Scalar _tmp138 = _tmp122 * _tmp135;
  const Scalar _tmp139 = -_tmp123 * _tmp137 - _tmp133 * _tmp138 + _tmp83;
  const Scalar _tmp140 = Scalar(1.0) * _tmp84;
  const Scalar _tmp141 = _tmp133 * _tmp135;
  const Scalar _tmp142 = -_tmp113 + _tmp115 * _tmp141 - _tmp116 * _tmp137;
  const Scalar _tmp143 = Scalar(1.0) * _tmp119 * (_tmp115 * _tmp136 - _tmp140 * _tmp142);
  const Scalar _tmp144 = _tmp50 + _tmp73;
  const Scalar _tmp145 = _tmp144 * fh1;
  const Scalar _tmp146 = -_tmp119 * _tmp145 - Scalar(3.29616) * _tmp19 - _tmp22 * fv1;
  const Scalar _tmp147 = _tmp136 * _tmp86;
  const Scalar _tmp148 = _tmp134 * _tmp136 + Scalar(1.0);
  const Scalar _tmp149 = -Scalar(1.0) * _tmp140 * _tmp148 + Scalar(1.0) * _tmp147;
  const Scalar _tmp150 = _tmp110 * _tmp145 + Scalar(3.29616) * _tmp28 + _tmp33 * fv1;
  const Scalar _tmp151 = _tmp133 * _tmp136;
  const Scalar _tmp152 = -Scalar(1.0) * _tmp136 + Scalar(1.0) * _tmp151 * _tmp84;
  const Scalar _tmp153 = _tmp102 * _tmp141 - _tmp103 * _tmp137 + _tmp96;
  const Scalar _tmp154 = Scalar(1.0) * _tmp110 * (_tmp102 * _tmp136 - _tmp140 * _tmp153);
  const Scalar _tmp155 = _tmp101 * _tmp136;
  const Scalar _tmp156 = _tmp101 * _tmp151 - _tmp127 * _tmp81;
  const Scalar _tmp157 = Scalar(1.0) * _tmp126 * (-_tmp140 * _tmp156 + _tmp155);
  const Scalar _tmp158 =
      Scalar(1.0) * _tmp121 * (-_tmp122 * _tmp136 - _tmp139 * _tmp140 + Scalar(1.0)) +
      _tmp143 * fh1 + _tmp146 * _tmp149 + _tmp150 * _tmp152 + _tmp154 * fh1 + _tmp157 * fh1;
  ...
  const Scalar _tmp162 = _tmp119 * _tmp144;
  const Scalar _tmp163 = _tmp110 * _tmp144;
  const Scalar _tmp164 = (-_tmp132 * _tmp158 + _tmp159 * (_tmp143 - _tmp149 * _tmp162 +
                                                          _tmp152 * _tmp163 + _tmp154 + _tmp157)) /
                         std::sqrt(Scalar(_tmp130 * std::pow(_tmp158, Scalar(2)) + 1));
  ...
  const Scalar _tmp167 = Scalar(0.1034955) * _tmp159;
  ...
  const Scalar _tmp172 = _tmp126 * _tmp127;
  const Scalar _tmp173 = _tmp172 * fh1;
  const Scalar _tmp174 = _tmp106 * _tmp110;
  const Scalar _tmp175 = _tmp170 * fh1 - _tmp171 * _tmp80 - _tmp173 * _tmp80 + _tmp174 * fh1;
  const Scalar _tmp176 = Scalar(9.6622558468725703) * _tmp175;
  const Scalar _tmp177 = std::pow(_tmp175, Scalar(-2));
  const Scalar _tmp178 = _tmp148 * _tmp84;
  const Scalar _tmp179 = _tmp126 * _tmp156 * _tmp84;
  const Scalar _tmp180 = _tmp136 * _tmp150;
  const Scalar _tmp181 = _tmp119 * _tmp142 * _tmp84;
  const Scalar _tmp182 = _tmp110 * _tmp84;
  const Scalar _tmp183 = _tmp153 * _tmp182;
  const Scalar _tmp184 = _tmp121 * _tmp139 * _tmp84 - _tmp133 * _tmp180 * _tmp84 +
                         _tmp146 * _tmp178 + _tmp179 * fh1 + _tmp181 * fh1 + _tmp183 * fh1;
  const Scalar _tmp185 = _tmp170 - _tmp172 * _tmp80 + _tmp174;
  const Scalar _tmp186 = _tmp177 * _tmp185;
  const Scalar _tmp187 = Scalar(1.0) / (_tmp175);
  const Scalar _tmp188 =
      (-_tmp184 * _tmp186 +
       _tmp187 * (-_tmp144 * _tmp151 * _tmp182 - _tmp162 * _tmp178 + _tmp179 + _tmp181 + _tmp183)) /
      std::sqrt(Scalar(_tmp177 * std::pow(_tmp184, Scalar(2)) + 1));
  const Scalar _tmp189 = std::asinh(_tmp184 * _tmp187);
  ...
  const Scalar _tmp195 = _tmp104 * _tmp110;
  const Scalar _tmp196 = _tmp118 * _tmp119;
  const Scalar _tmp197 = _tmp171 + _tmp173 + _tmp195 * fh1 + _tmp196 * fh1;
  const Scalar _tmp198 = Scalar(1.0) / (_tmp197);
  const Scalar _tmp199 = _tmp126 * _tmp155;
  const Scalar _tmp200 = _tmp115 * _tmp119 * _tmp135;
  const Scalar _tmp201 = _tmp102 * _tmp110 * _tmp135;
  const Scalar _tmp202 = _tmp121 * _tmp138 - _tmp146 * _tmp147 + _tmp180 - _tmp199 * fh1 -
  ...
  const Scalar _tmp208 =
      (_tmp198 * (_tmp136 * _tmp163 + _tmp147 * _tmp162 - _tmp199 - _tmp200 - _tmp201) -
       _tmp202 * _tmp207) /
  ...
  _res(1, 0) =
      -_tmp165 *
          (-Scalar(0.86564762886483004) * _tmp132 + Scalar(1.0) * _tmp164 * std::sinh(_tmp161) -
           (-Scalar(0.1034955) * _tmp132 * _tmp166 +
            _tmp167 * (-_tmp160 * _tmp169 - _tmp164 * _tmp165)) *
               std::sinh(_tmp168)) -
      _tmp169 * (Scalar(0.86564762886483004) * _tmp159 + std::cosh(_tmp161) - std::cosh(_tmp168));
  _res(2, 0) =
      -_tmp176 *
          (-Scalar(0.86627065637365697) * _tmp186 + Scalar(1.0) * _tmp188 * std::sinh(_tmp194) -
           (-Scalar(0.1034955) * _tmp186 * _tmp192 +
            _tmp191 * (-_tmp176 * _tmp188 - _tmp185 * _tmp190)) *
               std::sinh(_tmp193)) -
      Scalar(9.6622558468725703) * _tmp185 *
          (Scalar(0.86627065637365697) * _tmp187 - std::cosh(_tmp193) + std::cosh(_tmp194));
  _res(3, 0) =
      -_tmp209 *
          (-Scalar(0.876505537412406) * _tmp207 + Scalar(1.0) * _tmp208 * std::sinh(_tmp204) -
           (-Scalar(0.1034955) * _tmp207 * _tmp210 +
            _tmp211 * (-_tmp203 * _tmp213 - _tmp208 * _tmp209)) *
               std::sinh(_tmp212)) -
      _tmp213 * (Scalar(0.876505537412406) * _tmp198 + std::cosh(_tmp204) - std::cosh(_tmp212));
