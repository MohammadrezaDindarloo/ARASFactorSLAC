...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1WrtFh1Nl6(
  ...
  const Scalar _tmp64 = _tmp16 + _tmp58;
  ...
  const Scalar _tmp79 = Scalar(1.0) / (_tmp53 * _tmp76 - _tmp78);
  const Scalar _tmp80 = _tmp79 * (_tmp46 * _tmp53 - _tmp49 * _tmp78 + _tmp53 * _tmp74);
  const Scalar _tmp81 = -_tmp55 * _tmp75 + _tmp59 * _tmp63 + _tmp63 * _tmp74 - _tmp77 * _tmp80;
  const Scalar _tmp82 = Scalar(1.0) / (_tmp81);
  const Scalar _tmp83 = Scalar(1.0) * _tmp82;
  const Scalar _tmp84 = _tmp77 * _tmp79;
  const Scalar _tmp85 = _tmp44 * _tmp73 * (-_tmp53 * _tmp83 * _tmp84 + _tmp63 * _tmp83);
  ...
  const Scalar _tmp89 = Scalar(0.20999999999999999) * _tmp10 + Scalar(0.20999999999999999) * _tmp9;
  ...
  const Scalar _tmp95 = _tmp86 + _tmp93;
  const Scalar _tmp96 = _tmp79 * (_tmp53 * _tmp91 - _tmp53 * _tmp95);
  const Scalar _tmp97 = _tmp76 * _tmp91;
  const Scalar _tmp98 = _tmp79 * (-_tmp53 * _tmp97 + _tmp78 * _tmp95);
  const Scalar _tmp99 = _tmp75 * _tmp94 - _tmp76 * _tmp92 - _tmp77 * _tmp98;
  const Scalar _tmp100 = Scalar(1.0) * _tmp64;
  const Scalar _tmp101 = -_tmp100;
  const Scalar _tmp102 = Scalar(1.0) / (_tmp101 + _tmp46);
  const Scalar _tmp103 = Scalar(1.0) * _tmp67;
  const Scalar _tmp104 = _tmp103 - _tmp49;
  const Scalar _tmp105 = _tmp102 * _tmp104;
  const Scalar _tmp106 = -_tmp105 * _tmp99 - _tmp63 * _tmp94 - _tmp77 * _tmp96 + _tmp92;
  const Scalar _tmp107 = Scalar(1.0) / (_tmp106);
  const Scalar _tmp108 = _tmp76 * _tmp98 + _tmp97;
  const Scalar _tmp109 = -_tmp105 * _tmp108 + _tmp76 * _tmp96 - _tmp91;
  const Scalar _tmp110 = _tmp107 * _tmp81;
  const Scalar _tmp111 = _tmp106 * _tmp82;
  const Scalar _tmp112 = _tmp111 * (-_tmp109 * _tmp110 - _tmp74 + _tmp76 * _tmp80);
  const Scalar _tmp113 = _tmp109 + _tmp112;
  const Scalar _tmp114 = _tmp107 * _tmp113;
  const Scalar _tmp115 = _tmp107 * _tmp77;
  const Scalar _tmp116 = _tmp79 * (-_tmp113 * _tmp115 - _tmp76);
  const Scalar _tmp117 = _tmp42 * _tmp73 * (_tmp114 * _tmp63 + _tmp116 * _tmp53 + Scalar(1.0));
  const Scalar _tmp118 = Scalar(1.0) * _tmp102;
  const Scalar _tmp119 = _tmp104 * _tmp118 * _tmp98 - Scalar(1.0) * _tmp96;
  const Scalar _tmp120 = _tmp111 * (-_tmp110 * _tmp119 - Scalar(1.0) * _tmp80);
  const Scalar _tmp121 = _tmp119 + _tmp120;
  const Scalar _tmp122 = _tmp79 * (-_tmp115 * _tmp121 + Scalar(1.0));
  const Scalar _tmp123 = _tmp107 * _tmp121;
  const Scalar _tmp124 = _tmp43 * _tmp73 * (_tmp122 * _tmp53 + _tmp123 * _tmp63);
  const Scalar _tmp125 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp126 = _tmp100 * _tmp105 + _tmp103;
  const Scalar _tmp127 = 0;
  const Scalar _tmp128 = _tmp107 * _tmp127;
  const Scalar _tmp129 = _tmp115 * _tmp127 * _tmp79;
  const Scalar _tmp130 = -_tmp117 * fh1 - _tmp124 * fh1 -
                         _tmp125 * _tmp73 * (_tmp128 * _tmp63 - _tmp129 * _tmp53) - _tmp85 * fh1;
  const Scalar _tmp131 = Scalar(1.0) / (_tmp130);
  const Scalar _tmp132 = _tmp107 * _tmp99;
  const Scalar _tmp133 = _tmp101 + _tmp59;
  ...
  const Scalar _tmp137 = _tmp108 + _tmp112 * _tmp136 - _tmp113 * _tmp132;
  const Scalar _tmp138 = Scalar(1.0) * _tmp135;
  const Scalar _tmp139 = Scalar(1.0) * _tmp42 * (_tmp112 * _tmp138 - _tmp118 * _tmp137);
  const Scalar _tmp140 = _tmp86 + _tmp90;
  const Scalar _tmp141 = _tmp140 * fh1;
  const Scalar _tmp142 = _tmp141 * _tmp42 + Scalar(3.29616) * _tmp25 + _tmp28 * fv1;
  const Scalar _tmp143 = _tmp102 * _tmp133;
  const Scalar _tmp144 = _tmp138 * _tmp143;
  const Scalar _tmp145 = -Scalar(1.0) * _tmp138 + Scalar(1.0) * _tmp144;
  const Scalar _tmp146 = -Scalar(3.29616) * _tmp11 - _tmp141 * _tmp43 - _tmp17 * fv1;
  const Scalar _tmp147 = _tmp134 * _tmp138 + Scalar(1.0);
  const Scalar _tmp148 = _tmp105 * _tmp138;
  const Scalar _tmp149 = -Scalar(1.0) * _tmp118 * _tmp147 + Scalar(1.0) * _tmp148;
  const Scalar _tmp150 = _tmp111 * _tmp138;
  const Scalar _tmp151 = _tmp133 * _tmp150 - _tmp83 * _tmp99;
  const Scalar _tmp152 = Scalar(1.0) * _tmp44;
  const Scalar _tmp153 = _tmp152 * (-_tmp118 * _tmp151 + _tmp150);
  const Scalar _tmp154 = _tmp120 * _tmp136 - _tmp121 * _tmp132 - Scalar(1.0) * _tmp98;
  const Scalar _tmp155 = Scalar(1.0) * _tmp43 * (-_tmp118 * _tmp154 + _tmp120 * _tmp138);
  const Scalar _tmp156 = _tmp126 * _tmp135;
  const Scalar _tmp157 = _tmp101 - _tmp128 * _tmp99 - _tmp133 * _tmp156;
  const Scalar _tmp158 =
      Scalar(1.0) * _tmp125 * (-_tmp118 * _tmp157 - _tmp126 * _tmp138 + Scalar(1.0)) +
  ...
  const Scalar _tmp163 = -_tmp117 - _tmp124 - _tmp85;
  const Scalar _tmp164 = _tmp162 * _tmp163;
  const Scalar _tmp165 = Scalar(9.6622558468725703) * _tmp130;
  const Scalar _tmp166 = _tmp140 * _tmp43;
  const Scalar _tmp167 = _tmp140 * _tmp42;
  const Scalar _tmp168 =
      (_tmp131 * (_tmp139 + _tmp145 * _tmp167 - _tmp149 * _tmp166 + _tmp153 + _tmp155) -
       _tmp158 * _tmp164) /
  ...
  const Scalar _tmp172 = _tmp152 * _tmp82;
  const Scalar _tmp173 = _tmp172 * fh1;
  const Scalar _tmp174 = _tmp122 * _tmp43;
  const Scalar _tmp175 = _tmp116 * _tmp42;
  const Scalar _tmp176 = -_tmp125 * _tmp129 - _tmp173 * _tmp84 + _tmp174 * fh1 + _tmp175 * fh1;
  const Scalar _tmp177 = Scalar(1.0) / (_tmp176);
  const Scalar _tmp178 = _tmp138 * _tmp142;
  const Scalar _tmp179 = _tmp102 * _tmp154 * _tmp43;
  const Scalar _tmp180 = _tmp102 * _tmp151 * _tmp44;
  const Scalar _tmp181 = _tmp102 * _tmp147;
  const Scalar _tmp182 = _tmp102 * _tmp137 * _tmp42;
  const Scalar _tmp183 = _tmp102 * _tmp125 * _tmp157 - _tmp143 * _tmp178 + _tmp146 * _tmp181 +
  ...
  const Scalar _tmp190 = -_tmp172 * _tmp84 + _tmp174 + _tmp175;
  ...
  const Scalar _tmp194 =
      (_tmp177 * (-_tmp144 * _tmp167 - _tmp166 * _tmp181 + _tmp179 + _tmp180 + _tmp182) -
       _tmp183 * _tmp193) /
      std::sqrt(Scalar(std::pow(_tmp183, Scalar(2)) * _tmp192 + 1));
  const Scalar _tmp195 = _tmp123 * _tmp43;
  const Scalar _tmp196 = _tmp114 * _tmp42;
  const Scalar _tmp197 = _tmp125 * _tmp128 + _tmp173 + _tmp195 * fh1 + _tmp196 * fh1;
  const Scalar _tmp198 = Scalar(1.0) / (_tmp197);
  const Scalar _tmp199 = _tmp150 * _tmp44;
  const Scalar _tmp200 = _tmp120 * _tmp135 * _tmp43;
  const Scalar _tmp201 = _tmp112 * _tmp135 * _tmp42;
  const Scalar _tmp202 = _tmp125 * _tmp156 - _tmp146 * _tmp148 + _tmp178 - _tmp199 * fh1 -
  ...
  const Scalar _tmp213 =
      (_tmp198 * (_tmp138 * _tmp167 + _tmp148 * _tmp166 - _tmp199 - _tmp200 - _tmp201) -
       _tmp202 * _tmp212) /
  ...
  _res(1, 0) =
      -Scalar(9.6622558468725703) * _tmp163 *
          (Scalar(0.87679799777269396) * _tmp131 - std::cosh(_tmp170) + std::cosh(_tmp171)) -
      _tmp165 *
          (-Scalar(0.87679799777269396) * _tmp164 + Scalar(1.0) * _tmp168 * std::sinh(_tmp171) -
           (-Scalar(0.1034955) * _tmp161 * _tmp164 +
            _tmp169 * (-_tmp160 * _tmp163 - _tmp165 * _tmp168)) *
               std::sinh(_tmp170));
  _res(2, 0) =
      -_tmp185 *
          (-Scalar(0.86564762886483004) * _tmp193 + Scalar(1.0) * _tmp194 * std::sinh(_tmp189) -
           (-Scalar(0.1034955) * _tmp186 * _tmp193 +
            _tmp187 * (-_tmp184 * _tmp191 - _tmp185 * _tmp194)) *
               std::sinh(_tmp188)) -
      _tmp191 * (Scalar(0.86564762886483004) * _tmp177 - std::cosh(_tmp188) + std::cosh(_tmp189));
  _res(3, 0) =
      -_tmp204 *
