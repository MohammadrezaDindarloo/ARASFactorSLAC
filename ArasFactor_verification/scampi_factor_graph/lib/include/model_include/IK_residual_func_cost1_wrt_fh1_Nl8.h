...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1WrtFh1Nl8(
  ...
  const Scalar _tmp38 = _tmp28 + Scalar(-2.5193355532036801);
  const Scalar _tmp39 = _tmp18 + Scalar(8.3885017487099702);
  ...
  const Scalar _tmp59 = _tmp20 + _tmp50;
  ...
  const Scalar _tmp80 = _tmp79 * (-_tmp56 * _tmp61 * _tmp78 + _tmp58 * _tmp59 * _tmp78);
  const Scalar _tmp81 = _tmp66 * _tmp74 - _tmp69 * _tmp73 + _tmp74 * _tmp80;
  const Scalar _tmp82 = _tmp46 * _tmp64 - _tmp51 * _tmp55 + _tmp64 * _tmp80 - _tmp76 * _tmp81;
  const Scalar _tmp83 = Scalar(1.0) / (_tmp82);
  const Scalar _tmp84 = Scalar(1.0) * _tmp83;
  const Scalar _tmp85 = _tmp43 * _tmp79 * (_tmp64 * _tmp84 - _tmp74 * _tmp76 * _tmp84);
  const Scalar _tmp86 = Scalar(0.20999999999999999) * _tmp21 - Scalar(0.20999999999999999) * _tmp22;
  const Scalar _tmp87 = -Scalar(0.010999999999999999) * _tmp13 -
  ...
  const Scalar _tmp96 = _tmp74 * _tmp90 - _tmp74 * _tmp95;
  const Scalar _tmp97 = _tmp63 * _tmp90;
  const Scalar _tmp98 = _tmp73 * _tmp95 - _tmp74 * _tmp97;
  const Scalar _tmp99 = _tmp55 * _tmp93 - _tmp63 * _tmp91 - _tmp76 * _tmp98;
  const Scalar _tmp100 = Scalar(1.0) * _tmp56;
  const Scalar _tmp101 = -_tmp100;
  const Scalar _tmp102 = Scalar(1.0) / (_tmp101 + _tmp66);
  const Scalar _tmp103 = Scalar(1.0) * _tmp59;
  const Scalar _tmp104 = _tmp102 * (_tmp103 - _tmp69);
  const Scalar _tmp105 = -_tmp104 * _tmp99 - _tmp64 * _tmp93 - _tmp76 * _tmp96 + _tmp91;
  const Scalar _tmp106 = Scalar(1.0) / (_tmp105);
  const Scalar _tmp107 = _tmp63 * _tmp75;
  const Scalar _tmp108 = _tmp107 * _tmp98 + _tmp97;
  const Scalar _tmp109 = -_tmp104 * _tmp108 + _tmp107 * _tmp96 - _tmp90;
  const Scalar _tmp110 = _tmp106 * _tmp82;
  const Scalar _tmp111 = _tmp105 * _tmp83;
  const Scalar _tmp112 = _tmp111 * (_tmp107 * _tmp81 - _tmp109 * _tmp110 - _tmp80);
  const Scalar _tmp113 = _tmp109 + _tmp112;
  const Scalar _tmp114 = _tmp106 * _tmp113;
  const Scalar _tmp115 = _tmp106 * _tmp65;
  const Scalar _tmp116 = _tmp75 * (-_tmp113 * _tmp115 - _tmp63);
  const Scalar _tmp117 = _tmp41 * _tmp79 * (_tmp114 * _tmp64 + _tmp116 * _tmp74 + Scalar(1.0));
  const Scalar _tmp118 = Scalar(1.0) * _tmp75;
  const Scalar _tmp119 = _tmp118 * _tmp98;
  const Scalar _tmp120 = _tmp104 * _tmp119 - _tmp118 * _tmp96;
  const Scalar _tmp121 = _tmp111 * (-_tmp110 * _tmp120 - _tmp118 * _tmp81);
  const Scalar _tmp122 = _tmp120 + _tmp121;
  const Scalar _tmp123 = _tmp75 * (-_tmp115 * _tmp122 + Scalar(1.0));
  const Scalar _tmp124 = _tmp106 * _tmp122;
  const Scalar _tmp125 = _tmp42 * _tmp79 * (_tmp123 * _tmp74 + _tmp124 * _tmp64);
  const Scalar _tmp126 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp127 = _tmp100 * _tmp104 + _tmp103;
  const Scalar _tmp128 = 0;
  const Scalar _tmp129 = _tmp115 * _tmp128 * _tmp75;
  const Scalar _tmp130 = _tmp106 * _tmp128;
  const Scalar _tmp131 = -_tmp117 * fh1 - _tmp125 * fh1 -
                         _tmp126 * _tmp79 * (-_tmp129 * _tmp74 + _tmp130 * _tmp64) - _tmp85 * fh1;
  ...
  const Scalar _tmp138 = _tmp133 * _tmp137 - _tmp84 * _tmp99;
  const Scalar _tmp139 = Scalar(1.0) * _tmp102;
  const Scalar _tmp140 = Scalar(1.0) * _tmp43 * (_tmp137 - _tmp138 * _tmp139);
  const Scalar _tmp141 = _tmp127 * _tmp135;
  const Scalar _tmp142 = _tmp101 - _tmp130 * _tmp99 - _tmp133 * _tmp141;
  const Scalar _tmp143 = _tmp133 * _tmp135;
  const Scalar _tmp144 = _tmp106 * _tmp99;
  const Scalar _tmp145 = _tmp108 + _tmp112 * _tmp143 - _tmp113 * _tmp144;
  const Scalar _tmp146 = Scalar(1.0) * _tmp41 * (_tmp112 * _tmp136 - _tmp139 * _tmp145);
  const Scalar _tmp147 = -_tmp119 + _tmp121 * _tmp143 - _tmp122 * _tmp144;
  const Scalar _tmp148 = Scalar(1.0) * _tmp42 * (_tmp121 * _tmp136 - _tmp139 * _tmp147);
  const Scalar _tmp149 = _tmp86 + _tmp94;
  const Scalar _tmp150 = _tmp149 * fh1;
  const Scalar _tmp151 = _tmp150 * _tmp41 + Scalar(3.29616) * _tmp23 + _tmp27 * fv1;
  const Scalar _tmp152 = _tmp102 * _tmp133;
  const Scalar _tmp153 = _tmp136 * _tmp152;
  const Scalar _tmp154 = -Scalar(1.0) * _tmp136 + Scalar(1.0) * _tmp153;
  const Scalar _tmp155 = -Scalar(3.29616) * _tmp11 - _tmp150 * _tmp42 - _tmp17 * fv1;
  const Scalar _tmp156 = _tmp134 * _tmp136 + Scalar(1.0);
  const Scalar _tmp157 = _tmp104 * _tmp136;
  const Scalar _tmp158 = -Scalar(1.0) * _tmp139 * _tmp156 + Scalar(1.0) * _tmp157;
  const Scalar _tmp159 =
      Scalar(1.0) * _tmp126 * (-_tmp127 * _tmp136 - _tmp139 * _tmp142 + Scalar(1.0)) +
      _tmp140 * fh1 + _tmp146 * fh1 + _tmp148 * fh1 + _tmp151 * _tmp154 + _tmp155 * _tmp158;
  ...
  const Scalar _tmp166 = -_tmp117 - _tmp125 - _tmp85;
  ...
  const Scalar _tmp170 = _tmp149 * _tmp42;
  const Scalar _tmp171 = _tmp149 * _tmp41;
  const Scalar _tmp172 =
      (_tmp132 * (_tmp140 + _tmp146 + _tmp148 + _tmp154 * _tmp171 - _tmp158 * _tmp170) -
       _tmp159 * _tmp169) /
      std::sqrt(Scalar(std::pow(_tmp159, Scalar(2)) * _tmp168 + 1));
  const Scalar _tmp173 = _tmp43 * _tmp84;
  const Scalar _tmp174 = _tmp173 * fh1;
  const Scalar _tmp175 = _tmp116 * _tmp41;
  const Scalar _tmp176 = _tmp123 * _tmp42;
  const Scalar _tmp177 = -_tmp126 * _tmp129 - _tmp174 * _tmp76 + _tmp175 * fh1 + _tmp176 * fh1;
  const Scalar _tmp178 = Scalar(1.0) / (_tmp177);
  const Scalar _tmp179 = _tmp102 * _tmp147 * _tmp42;
  const Scalar _tmp180 = _tmp136 * _tmp151;
  const Scalar _tmp181 = _tmp102 * _tmp145 * _tmp41;
  const Scalar _tmp182 = _tmp102 * _tmp156;
  const Scalar _tmp183 = _tmp102 * _tmp138 * _tmp43;
  const Scalar _tmp184 = _tmp102 * _tmp126 * _tmp142 - _tmp152 * _tmp180 + _tmp155 * _tmp182 +
  ...
  const Scalar _tmp188 = -_tmp173 * _tmp76 + _tmp175 + _tmp176;
  const Scalar _tmp189 = _tmp187 * _tmp188;
  const Scalar _tmp190 =
      (_tmp178 * (-_tmp153 * _tmp171 - _tmp170 * _tmp182 + _tmp179 + _tmp181 + _tmp183) -
       _tmp184 * _tmp189) /
  ...
  const Scalar _tmp196 = _tmp121 * _tmp135 * _tmp42;
  const Scalar _tmp197 = _tmp112 * _tmp135 * _tmp41;
  const Scalar _tmp198 = _tmp137 * _tmp43;
  const Scalar _tmp199 = _tmp126 * _tmp141 - _tmp155 * _tmp157 + _tmp180 - _tmp196 * fh1 -
                         _tmp197 * fh1 - _tmp198 * fh1;
  const Scalar _tmp200 = _tmp114 * _tmp41;
  const Scalar _tmp201 = _tmp124 * _tmp42;
  const Scalar _tmp202 = _tmp126 * _tmp130 + _tmp174 + _tmp200 * fh1 + _tmp201 * fh1;
  ...
  const Scalar _tmp209 = (-_tmp199 * _tmp208 + _tmp203 * (_tmp136 * _tmp171 + _tmp157 * _tmp170 -
          ...
          std::sqrt(
              Scalar(std::pow(Scalar(1 - Scalar(0.20691555724053495) * _tmp47), Scalar(2)) +
                     Scalar(0.13818785160942856) *
                         std::pow(Scalar(-Scalar(0.55661923802822921) * _tmp52 - 1), Scalar(2))));
  ...
  _res(1, 0) =
      -_tmp162 *
          (-Scalar(0.86564762886483004) * _tmp169 + Scalar(1.0) * _tmp172 * std::sinh(_tmp161) -
           (-Scalar(0.1034955) * _tmp163 * _tmp169 +
            _tmp164 * (-_tmp160 * _tmp167 - _tmp162 * _tmp172)) *
               std::sinh(_tmp165)) -
      _tmp167 * (Scalar(0.86564762886483004) * _tmp132 + std::cosh(_tmp161) - std::cosh(_tmp165));
  _res(2, 0) =
      -Scalar(9.6622558468725703) * _tmp188 *
          (Scalar(0.87679799777269396) * _tmp178 + std::cosh(_tmp186) - std::cosh(_tmp194)) -
      _tmp195 *
          (-Scalar(0.87679799777269396) * _tmp189 + Scalar(1.0) * _tmp190 * std::sinh(_tmp186) -
           (-Scalar(0.1034955) * _tmp189 * _tmp192 +
            _tmp193 * (-_tmp188 * _tmp191 - _tmp190 * _tmp195)) *
               std::sinh(_tmp194));
  _res(3, 0) =
      -_tmp210 *
          (-Scalar(0.86627065637365697) * _tmp208 + Scalar(1.0) * _tmp209 * std::sinh(_tmp205) -
           (-Scalar(0.1034955) * _tmp208 * _tmp211 +
            _tmp212 * (-_tmp204 * _tmp214 - _tmp209 * _tmp210)) *
               std::sinh(_tmp213)) -
      _tmp214 * (Scalar(0.86627065637365697) * _tmp203 + std::cosh(_tmp205) - std::cosh(_tmp213));
