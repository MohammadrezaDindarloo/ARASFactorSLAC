...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1WrtFv1Nl15(
  ...
  const Scalar _tmp76 = Scalar(1.0) / (_tmp53 * _tmp72 - _tmp74);
  const Scalar _tmp77 = _tmp55 * _tmp76;
  const Scalar _tmp78 = _tmp45 * _tmp61 - _tmp54 * _tmp64 - _tmp75 * _tmp77;
  ...
  const Scalar _tmp84 = _tmp63 * _tmp72 - _tmp72 * _tmp73;
  const Scalar _tmp85 = -_tmp54 * _tmp61 + _tmp54 * _tmp63 - _tmp77 * _tmp84 - _tmp78 * _tmp83;
  ...
  const Scalar _tmp94 = -_tmp65 * _tmp74 + _tmp68 * _tmp72 + _tmp72 * _tmp93;
  const Scalar _tmp95 = _tmp36 * _tmp54 - _tmp41 * _tmp45 + _tmp54 * _tmp93 - _tmp77 * _tmp94;
  ...
  const Scalar _tmp112 = _tmp92 * (_tmp110 * _tmp54 - _tmp111 * _tmp72);
  const Scalar _tmp113 = _tmp53 * _tmp76;
  const Scalar _tmp114 = _tmp113 * _tmp75 + _tmp64;
  const Scalar _tmp115 = _tmp113 * _tmp84 - _tmp114 * _tmp83 - _tmp63;
  const Scalar _tmp116 = _tmp98 * (_tmp113 * _tmp94 - _tmp115 * _tmp96 - _tmp93);
  const Scalar _tmp117 = _tmp86 * (_tmp115 + _tmp116);
  const Scalar _tmp118 = -_tmp117 * _tmp55 - _tmp53;
  const Scalar _tmp119 = _tmp104 * _tmp105;
  const Scalar _tmp120 = _tmp119 * fh1;
  const Scalar _tmp121 = Scalar(1.0) * _tmp97;
  const Scalar _tmp122 = fh1 * (_tmp106 * _tmp19 - _tmp119 * _tmp30);
  const Scalar _tmp123 = -_tmp107 * _tmp92 * (_tmp100 * _tmp54 + _tmp101 * _tmp102) -
                         _tmp108 * _tmp112 -
                         _tmp120 * _tmp92 * (_tmp102 * _tmp118 + _tmp117 * _tmp54 + Scalar(1.0)) -
                         _tmp122 * _tmp92 * (_tmp121 * _tmp54 - _tmp121 * _tmp72 * _tmp77);
  const Scalar _tmp124 = Scalar(1.0) / (_tmp123);
  const Scalar _tmp125 = _tmp36 + _tmp80;
  ...
  const Scalar _tmp130 = -_tmp121 * _tmp78 + _tmp125 * _tmp129;
  const Scalar _tmp131 = Scalar(1.0) * _tmp81;
  const Scalar _tmp132 = fh1 * (_tmp56 + _tmp62);
  const Scalar _tmp133 = _tmp119 * _tmp132 + Scalar(3.29616) * _tmp13 + _tmp19 * fv1;
  const Scalar _tmp134 = _tmp125 * _tmp81;
  const Scalar _tmp135 = Scalar(1.0) * _tmp128 * _tmp134 - Scalar(1.0) * _tmp128;
  const Scalar _tmp136 = _tmp109 * _tmp127;
  const Scalar _tmp137 = _tmp81 * (-_tmp110 * _tmp78 - _tmp125 * _tmp136 + _tmp80);
  const Scalar _tmp138 = -Scalar(1.0) * _tmp109 * _tmp128 - Scalar(1.0) * _tmp137 + Scalar(1.0);
  const Scalar _tmp139 = -_tmp106 * _tmp132 - Scalar(3.29616) * _tmp25 - _tmp30 * fv1;
  const Scalar _tmp140 = _tmp81 * (_tmp126 * _tmp128 + Scalar(1.0));
  const Scalar _tmp141 = _tmp128 * _tmp83;
  const Scalar _tmp142 = -Scalar(1.0) * _tmp140 + Scalar(1.0) * _tmp141;
  const Scalar _tmp143 = _tmp125 * _tmp127;
  const Scalar _tmp144 = -_tmp100 * _tmp78 + _tmp143 * _tmp99 - _tmp88;
  const Scalar _tmp145 = _tmp114 + _tmp116 * _tmp143 - _tmp117 * _tmp78;
  const Scalar _tmp146 =
      Scalar(1.0) * _tmp107 * (_tmp128 * _tmp99 - _tmp131 * _tmp144) + _tmp108 * _tmp138 +
      Scalar(1.0) * _tmp120 * (_tmp116 * _tmp128 - _tmp131 * _tmp145) +
      Scalar(1.0) * _tmp122 * (_tmp129 - _tmp130 * _tmp131) + _tmp133 * _tmp135 + _tmp139 * _tmp142;
  ...
  const Scalar _tmp156 = _tmp26 + _tmp33 + _tmp34;
  const Scalar _tmp157 =
      (_tmp124 * (_tmp135 * _tmp19 - _tmp138 + _tmp142 * _tmp156) - _tmp146 * _tmp155) /
  ...
  const Scalar _tmp160 =
      _tmp101 * _tmp107 * _tmp76 + _tmp118 * _tmp120 * _tmp76 - _tmp158 * _tmp77 - _tmp159 * _tmp77;
  const Scalar _tmp161 = std::pow(_tmp160, Scalar(-2));
  const Scalar _tmp162 = _tmp111 * _tmp161;
  const Scalar _tmp163 = _tmp128 * _tmp133;
  const Scalar _tmp164 = _tmp107 * _tmp144 * _tmp81 + _tmp108 * _tmp137 +
                         _tmp120 * _tmp145 * _tmp81 + _tmp122 * _tmp130 * _tmp81 -
                         _tmp134 * _tmp163 + _tmp139 * _tmp140;
  ...
  const Scalar _tmp174 =
      (-_tmp162 * _tmp164 + _tmp165 * (-_tmp134 * _tmp173 - _tmp137 + _tmp140 * _tmp156)) /
      std::sqrt(Scalar(_tmp161 * std::pow(_tmp164, Scalar(2)) + 1));
  const Scalar _tmp175 = Scalar(1.0) * _tmp166;
  const Scalar _tmp176 = _tmp100 * _tmp107 + _tmp117 * _tmp120 + _tmp158 + _tmp159;
  const Scalar _tmp177 = Scalar(1.0) / (_tmp176);
  const Scalar _tmp178 = -_tmp107 * _tmp127 * _tmp99 + _tmp108 * _tmp136 -
                         _tmp116 * _tmp120 * _tmp127 - _tmp122 * _tmp129 - _tmp139 * _tmp141 +
                         _tmp163;
  ...
  const Scalar _tmp183 = (_tmp177 * (-_tmp136 - _tmp141 * _tmp156 + _tmp173) + _tmp178 * _tmp182) /
  ...
  _res(1, 0) =
      -_tmp149 *
          (-Scalar(0.876505537412406) * _tmp155 + Scalar(1.0) * _tmp157 * std::sinh(_tmp148) -
           (-Scalar(0.1034955) * _tmp150 * _tmp155 +
            _tmp151 * (-_tmp147 * _tmp153 - _tmp149 * _tmp157)) *
               std::sinh(_tmp152)) -
      _tmp153 * (Scalar(0.876505537412406) * _tmp124 + std::cosh(_tmp148) - std::cosh(_tmp152));
  _res(2, 0) =
      -_tmp167 *
          (-Scalar(0.86627065637365697) * _tmp162 + Scalar(1.0) * _tmp174 * std::sinh(_tmp175) -
           (-Scalar(0.1034955) * _tmp162 * _tmp168 +
            _tmp169 * (-_tmp166 * _tmp172 - _tmp167 * _tmp174)) *
               std::sinh(_tmp170)) -
      _tmp172 * (Scalar(0.86627065637365697) * _tmp165 - std::cosh(_tmp170) + std::cosh(_tmp175));
  _res(3, 0) =
      _tmp171 * (Scalar(0.87679799777269396) * _tmp177 + std::cosh(_tmp180) - std::cosh(_tmp187)) -
      _tmp184 *
          (Scalar(0.87679799777269396) * _tmp182 + Scalar(1.0) * _tmp183 * std::sinh(_tmp180) -
