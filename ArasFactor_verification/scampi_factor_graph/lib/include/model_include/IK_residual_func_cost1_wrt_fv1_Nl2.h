...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1WrtFv1Nl2(
  ...
  const Scalar _tmp37 = _tmp36 + Scalar(8.3885017487099702);
  ...
  const Scalar _tmp44 = _tmp13 + _tmp7;
  ...
  const Scalar _tmp57 = _tmp35 * _tmp42 - _tmp38 * _tmp43 + _tmp42 * _tmp56;
  const Scalar _tmp58 = _tmp47 * _tmp54;
  const Scalar _tmp59 = Scalar(1.0) / (_tmp42 * _tmp58 - _tmp43);
  ...
  const Scalar _tmp63 = Scalar(0.20999999999999999) * _tmp15 + Scalar(0.20999999999999999) * _tmp16;
  ...
  const Scalar _tmp92 = -_tmp68 * _tmp86 - _tmp69 * _tmp91 + _tmp88 * _tmp89;
  const Scalar _tmp93 = _tmp65 * _tmp86 - _tmp76 * _tmp92 - _tmp77 * _tmp91 - _tmp86 * _tmp88;
  const Scalar _tmp94 = Scalar(1.0) / (_tmp93);
  const Scalar _tmp95 = _tmp56 * _tmp86 - _tmp57 * _tmp91 - _tmp79 * _tmp89 + _tmp82 * _tmp86;
  const Scalar _tmp96 = _tmp94 * _tmp95;
  const Scalar _tmp97 = Scalar(1.0) / (_tmp95);
  const Scalar _tmp98 = _tmp93 * _tmp97;
  const Scalar _tmp99 = _tmp98 * (-_tmp56 + _tmp57 * _tmp60 - _tmp78 * _tmp96);
  const Scalar _tmp100 = _tmp78 + _tmp99;
  const Scalar _tmp101 = _tmp86 * _tmp94;
  const Scalar _tmp102 = _tmp90 * _tmp94;
  const Scalar _tmp103 = -_tmp100 * _tmp102 - _tmp58;
  const Scalar _tmp104 = _tmp42 * _tmp59;
  ...
  const Scalar _tmp122 = -_tmp117 * _tmp77 + _tmp121 * _tmp59 * _tmp69 * _tmp75;
  const Scalar _tmp123 = _tmp98 * (-_tmp117 * _tmp57 - _tmp122 * _tmp96);
  const Scalar _tmp124 = _tmp122 + _tmp123;
  const Scalar _tmp125 = -_tmp102 * _tmp124 + Scalar(1.0);
  const Scalar _tmp126 = _tmp119 * fh1;
  const Scalar _tmp127 = -_tmp109 * _tmp55 * (_tmp100 * _tmp101 + _tmp103 * _tmp104 + Scalar(1.0)) -
                         _tmp110 * _tmp115 -
                         _tmp120 * _tmp55 * (_tmp116 * _tmp86 - _tmp118 * _tmp42) -
                         _tmp126 * _tmp55 * (_tmp101 * _tmp124 + _tmp104 * _tmp125);
  const Scalar _tmp128 = Scalar(1.0) / (_tmp127);
  const Scalar _tmp129 = _tmp72 + _tmp82;
  const Scalar _tmp130 = _tmp129 * _tmp76;
  const Scalar _tmp131 = Scalar(1.0) / (-_tmp130 + _tmp74 - _tmp79);
  const Scalar _tmp132 = _tmp129 * _tmp131;
  const Scalar _tmp133 = _tmp92 * _tmp94;
  const Scalar _tmp134 = -_tmp117 * _tmp69 + _tmp123 * _tmp132 - _tmp124 * _tmp133;
  const Scalar _tmp135 = Scalar(1.0) * _tmp131;
  const Scalar _tmp136 = fh1 * (_tmp66 + _tmp87);
  const Scalar _tmp137 = -_tmp119 * _tmp136 - Scalar(3.29616) * _tmp17 - _tmp21 * fv1;
  const Scalar _tmp138 = _tmp135 * _tmp76;
  const Scalar _tmp139 = _tmp130 * _tmp135 + Scalar(1.0);
  const Scalar _tmp140 = -Scalar(1.0) * _tmp121 * _tmp139 + Scalar(1.0) * _tmp138;
  const Scalar _tmp141 = _tmp108 * _tmp136 + Scalar(3.29616) * _tmp28 + _tmp32 * fv1;
  const Scalar _tmp142 = _tmp129 * _tmp73;
  const Scalar _tmp143 = Scalar(1.0) * _tmp135 * _tmp142 - Scalar(1.0) * _tmp135;
  const Scalar _tmp144 = -_tmp100 * _tmp133 + _tmp132 * _tmp99 + _tmp70;
  const Scalar _tmp145 = _tmp111 * _tmp131;
  const Scalar _tmp146 = _tmp73 * (-_tmp112 * _tmp133 - _tmp129 * _tmp145 + _tmp72);
  const Scalar _tmp147 = -Scalar(1.0) * _tmp145 - Scalar(1.0) * _tmp146 + Scalar(1.0);
  const Scalar _tmp148 = _tmp135 * _tmp98;
  const Scalar _tmp149 = -_tmp116 * _tmp92 + _tmp129 * _tmp148;
  const Scalar _tmp150 = Scalar(1.0) * _tmp109 * (-_tmp121 * _tmp144 + _tmp135 * _tmp99) +
                         _tmp110 * _tmp147 +
                         Scalar(1.0) * _tmp120 * (-_tmp121 * _tmp149 + _tmp148) +
                         Scalar(1.0) * _tmp126 * (-_tmp121 * _tmp134 + _tmp123 * _tmp135) +
                         _tmp137 * _tmp140 + _tmp141 * _tmp143;
  const Scalar _tmp151 = std::asinh(_tmp128 * _tmp150);
  const Scalar _tmp152 = Scalar(1.0) * _tmp151;
  const Scalar _tmp153 = _tmp18 + _tmp44;
  const Scalar _tmp154 = std::pow(_tmp127, Scalar(-2));
  const Scalar _tmp155 = _tmp115 * _tmp154;
  const Scalar _tmp156 =
      (_tmp128 * (_tmp140 * _tmp153 + _tmp143 * _tmp32 - _tmp147) - _tmp150 * _tmp155) /
  ...
  const Scalar _tmp162 = _tmp135 * _tmp141;
  const Scalar _tmp163 = _tmp139 * _tmp73;
  const Scalar _tmp164 = _tmp109 * _tmp144 * _tmp73 + _tmp110 * _tmp146 +
                         _tmp120 * _tmp149 * _tmp73 + _tmp126 * _tmp134 * _tmp73 +
                         _tmp137 * _tmp163 - _tmp142 * _tmp162;
  const Scalar _tmp165 = _tmp110 * _tmp113;
  const Scalar _tmp166 = _tmp103 * _tmp109 * _tmp59 - _tmp118 * _tmp120 +
                         _tmp125 * _tmp126 * _tmp59 - _tmp165 * _tmp91;
  ...
  const Scalar _tmp171 = _tmp114 * _tmp170;
  const Scalar _tmp172 = _tmp135 * _tmp32;
  const Scalar _tmp173 =
      (-_tmp164 * _tmp171 + _tmp167 * (-_tmp142 * _tmp172 - _tmp146 + _tmp153 * _tmp163)) /
  ...
  const Scalar _tmp180 =
      _tmp100 * _tmp109 * _tmp94 + _tmp116 * _tmp120 + _tmp124 * _tmp126 * _tmp94 + _tmp165;
  const Scalar _tmp181 = Scalar(1.0) / (_tmp180);
  const Scalar _tmp182 = -_tmp109 * _tmp131 * _tmp99 + _tmp110 * _tmp145 - _tmp120 * _tmp148 -
                         _tmp123 * _tmp126 * _tmp131 - _tmp137 * _tmp138 + _tmp162;
  ...
  const Scalar _tmp191 = (_tmp181 * (-_tmp138 * _tmp153 - _tmp145 + _tmp172) + _tmp182 * _tmp190) /
                        ...
                        std::sqrt(Scalar(
                            ...
                            Scalar(0.057067943527034905) *
                                std::pow(Scalar(-Scalar(0.50315118477277876) * _tmp33 - 1),
                                         Scalar(2)))))));
  _res(1, 0) =
      -_tmp157 * (Scalar(0.86564762886483004) * _tmp128 + std::cosh(_tmp152) - std::cosh(_tmp161)) -
      _tmp158 *
  ...
  _res(2, 0) =
      -_tmp174 *
          (-Scalar(0.876505537412406) * _tmp171 + Scalar(1.0) * _tmp173 * std::sinh(_tmp169) -
           (-Scalar(0.1034955) * _tmp171 * _tmp175 +
            _tmp178 * (-_tmp168 * _tmp177 - _tmp173 * _tmp174)) *
               std::sinh(_tmp179)) -
      _tmp177 * (Scalar(0.876505537412406) * _tmp167 + std::cosh(_tmp169) - std::cosh(_tmp179));
  _res(3, 0) =
      _tmp176 * (Scalar(0.86627065637365697) * _tmp181 - std::cosh(_tmp187) + std::cosh(_tmp188)) -
      _tmp184 *
          (Scalar(0.86627065637365697) * _tmp190 + Scalar(1.0) * _tmp191 * std::sinh(_tmp188) -
           (Scalar(0.1034955) * _tmp185 * _tmp190 +
            _tmp186 * (_tmp176 * _tmp183 - _tmp184 * _tmp191)) *
               std::sinh(_tmp187));
