...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1WrtFv1Nl3(
  ...
  const Scalar _tmp37 = _tmp15 + _tmp19;
  ...
  const Scalar _tmp47 = _tmp24 + _tmp45;
  ...
  const Scalar _tmp52 = Scalar(1.0) / (-_tmp36 + _tmp48 - _tmp51);
  const Scalar _tmp53 = _tmp39 * _tmp50 + _tmp48;
  ...
  const Scalar _tmp64 = _tmp36 + position_vector(0, 0);
  ...
  const Scalar _tmp69 = _tmp46 + position_vector(0, 0);
  ...
  const Scalar _tmp75 = _tmp38 + position_vector(1, 0);
  const Scalar _tmp76 = _tmp75 + Scalar(-4.7744369927459998);
  const Scalar _tmp77 = _tmp47 + position_vector(0, 0);
  const Scalar _tmp78 = _tmp77 + Scalar(-2.7171519410699099);
  ...
  const Scalar _tmp84 = _tmp72 * _tmp73;
  ...
  const Scalar _tmp88 = _tmp67 * _tmp80 - _tmp87;
  const Scalar _tmp89 = _tmp86 * _tmp88;
  const Scalar _tmp90 = _tmp61 * _tmp87 - _tmp67 * _tmp81 - _tmp85 * _tmp89;
  const Scalar _tmp91 = _tmp68 * _tmp74 - _tmp74 * _tmp83;
  const Scalar _tmp92 = -_tmp50 * _tmp90 - _tmp61 * _tmp67 + _tmp67 * _tmp68 - _tmp89 * _tmp91;
  const Scalar _tmp93 = Scalar(1.0) / (_tmp92);
  const Scalar _tmp94 = _tmp90 * _tmp93;
  const Scalar _tmp95 = _tmp44 * (_tmp40 - _tmp42 * _tmp54 - _tmp55 * _tmp94);
  ...
  const Scalar _tmp99 = _tmp49 * _tmp85 * _tmp86 * _tmp98 - _tmp91 * _tmp97;
  ...
  const Scalar _tmp102 = _tmp100 * _tmp79;
  const Scalar _tmp103 = _tmp102 * (-_tmp101 * _tmp38 * _tmp78 + _tmp101 * _tmp47 * _tmp76);
  const Scalar _tmp104 = _tmp86 * (_tmp103 * _tmp74 + _tmp43 * _tmp74 - _tmp46 * _tmp84);
  const Scalar _tmp105 = _tmp103 * _tmp67 - _tmp104 * _tmp88 - _tmp36 * _tmp87 + _tmp41 * _tmp67;
  const Scalar _tmp106 = _tmp105 * _tmp93;
  const Scalar _tmp107 = Scalar(1.0) / (_tmp105);
  const Scalar _tmp108 = _tmp107 * _tmp92;
  const Scalar _tmp109 = _tmp108 * (-Scalar(1.0) * _tmp104 - _tmp106 * _tmp99);
  const Scalar _tmp110 = _tmp42 * _tmp52;
  const Scalar _tmp111 = _tmp109 + _tmp99;
  const Scalar _tmp112 = _tmp109 * _tmp110 - _tmp111 * _tmp94 - _tmp85 * _tmp97;
  const Scalar _tmp113 = Scalar(1.0) * _tmp52;
  const Scalar _tmp114 = _tmp33 + Scalar(1.9874742031097401);
  const Scalar _tmp115 = _tmp22 + Scalar(8.3196563720703107);
  ...
  const Scalar _tmp119 = fh1 * (_tmp57 + _tmp82);
  const Scalar _tmp120 = -_tmp117 * _tmp119 - Scalar(3.29616) * _tmp13 - _tmp21 * fv1;
  const Scalar _tmp121 = _tmp113 * _tmp50;
  const Scalar _tmp122 = _tmp113 * _tmp51 + Scalar(1.0);
  const Scalar _tmp123 = Scalar(1.0) * _tmp121 - Scalar(1.0) * _tmp122 * _tmp98;
  const Scalar _tmp124 = _tmp114 * _tmp116;
  const Scalar _tmp125 = _tmp119 * _tmp124 + Scalar(3.29616) * _tmp28 + _tmp32 * fv1;
  const Scalar _tmp126 = _tmp113 * _tmp42;
  const Scalar _tmp127 = -Scalar(1.0) * _tmp113 + Scalar(1.0) * _tmp126 * _tmp44;
  const Scalar _tmp128 = _tmp80 * _tmp86;
  const Scalar _tmp129 = _tmp128 * _tmp85 + _tmp81;
  const Scalar _tmp130 = _tmp128 * _tmp91 - _tmp129 * _tmp50 - _tmp68;
  const Scalar _tmp131 = _tmp108 * (-_tmp103 + _tmp104 * _tmp80 - _tmp106 * _tmp130);
  const Scalar _tmp132 = _tmp130 + _tmp131;
  const Scalar _tmp133 = _tmp110 * _tmp131 + _tmp129 - _tmp132 * _tmp94;
  const Scalar _tmp134 = _tmp124 * fh1;
  const Scalar _tmp135 = _tmp108 * _tmp113;
  const Scalar _tmp136 = Scalar(1.0) * _tmp107;
  const Scalar _tmp137 = _tmp108 * _tmp126 - _tmp136 * _tmp90;
  const Scalar _tmp138 = fh1 * (_tmp117 * _tmp32 - _tmp124 * _tmp21);
  const Scalar _tmp139 = Scalar(1.0) * _tmp118 * (_tmp109 * _tmp113 - _tmp112 * _tmp98) +
                         _tmp120 * _tmp123 + _tmp125 * _tmp127 +
                         Scalar(1.0) * _tmp134 * (_tmp113 * _tmp131 - _tmp133 * _tmp98) +
                         Scalar(1.0) * _tmp138 * (_tmp135 - _tmp137 * _tmp98) + _tmp35 * _tmp96;
  const Scalar _tmp140 = _tmp67 * _tmp93;
  const Scalar _tmp141 = _tmp88 * _tmp93;
  const Scalar _tmp142 = -_tmp132 * _tmp141 - _tmp80;
  const Scalar _tmp143 = _tmp74 * _tmp86;
  const Scalar _tmp144 = -_tmp111 * _tmp141 + Scalar(1.0);
  const Scalar _tmp145 = _tmp55 * _tmp93;
  const Scalar _tmp146 = _tmp145 * _tmp89;
  const Scalar _tmp147 = _tmp102 * (_tmp145 * _tmp67 - _tmp146 * _tmp74);
  const Scalar _tmp148 = -_tmp102 * _tmp118 * (_tmp111 * _tmp140 + _tmp143 * _tmp144) -
                         _tmp102 * _tmp134 * (_tmp132 * _tmp140 + _tmp142 * _tmp143 + Scalar(1.0)) -
                         _tmp102 * _tmp138 * (_tmp136 * _tmp67 - _tmp136 * _tmp74 * _tmp89) -
                         _tmp147 * _tmp35;
          ...
          std::sqrt(
              Scalar(std::pow(Scalar(1 - Scalar(0.2094487793051498) * _tmp75), Scalar(2)) +
                     Scalar(0.32387954179207445) *
                         std::pow(Scalar(1 - Scalar(0.36803241838814449) * _tmp77), Scalar(2))));
  ...
  const Scalar _tmp159 = _tmp14 + _tmp19 + _tmp7;
  const Scalar _tmp160 =
      (-_tmp139 * _tmp158 + _tmp149 * (_tmp123 * _tmp159 + _tmp127 * _tmp32 - _tmp96)) /
      std::sqrt(Scalar(std::pow(_tmp139, Scalar(2)) * _tmp157 + 1));
  const Scalar _tmp161 = _tmp145 * _tmp35;
  const Scalar _tmp162 = _tmp136 * _tmp138;
  const Scalar _tmp163 =
      _tmp118 * _tmp144 * _tmp86 + _tmp134 * _tmp142 * _tmp86 - _tmp161 * _tmp89 - _tmp162 * _tmp89;
  const Scalar _tmp164 = Scalar(1.0) / (_tmp163);
  const Scalar _tmp165 = _tmp122 * _tmp44;
  const Scalar _tmp166 = _tmp113 * _tmp125;
  const Scalar _tmp167 = _tmp42 * _tmp44;
  const Scalar _tmp168 = _tmp112 * _tmp118 * _tmp44 + _tmp120 * _tmp165 +
                         _tmp133 * _tmp134 * _tmp44 + _tmp137 * _tmp138 * _tmp44 -
                         _tmp166 * _tmp167 + _tmp35 * _tmp95;
  ...
  const Scalar _tmp173 = Scalar(0.1034955) * _tmp164;
  ...
  const Scalar _tmp179 = _tmp113 * _tmp32;
  const Scalar _tmp180 =
      (_tmp164 * (_tmp159 * _tmp165 - _tmp167 * _tmp179 - _tmp95) - _tmp168 * _tmp178) /
      std::sqrt(Scalar(std::pow(_tmp168, Scalar(2)) * _tmp177 + 1));
  const Scalar _tmp181 =
      _tmp111 * _tmp118 * _tmp93 + _tmp132 * _tmp134 * _tmp93 + _tmp161 + _tmp162;
  const Scalar _tmp182 = Scalar(9.6622558468725703) * _tmp181;
  const Scalar _tmp183 = Scalar(1.0) / (_tmp181);
  const Scalar _tmp184 = -_tmp109 * _tmp118 * _tmp52 - _tmp120 * _tmp121 -
                         _tmp131 * _tmp134 * _tmp52 - _tmp135 * _tmp138 + _tmp166 + _tmp35 * _tmp54;
  const Scalar _tmp185 = std::pow(_tmp181, Scalar(-2));
  const Scalar _tmp186 = _tmp145 * _tmp185;
  const Scalar _tmp187 = (_tmp183 * (-_tmp121 * _tmp159 + _tmp179 - _tmp54) + _tmp184 * _tmp186) /
                         std::sqrt(Scalar(std::pow(_tmp184, Scalar(2)) * _tmp185 + 1));
  const Scalar _tmp188 = std::asinh(_tmp183 * _tmp184);
  ...
  _res(1, 0) =
      -_tmp152 *
          (-Scalar(0.86564762886483004) * _tmp158 + Scalar(1.0) * _tmp160 * std::sinh(_tmp151) -
           (-Scalar(0.1034955) * _tmp153 * _tmp158 +
            _tmp154 * (-_tmp150 * _tmp156 - _tmp152 * _tmp160)) *
               std::sinh(_tmp155)) -
      _tmp156 * (Scalar(0.86564762886483004) * _tmp149 + std::cosh(_tmp151) - std::cosh(_tmp155));
  _res(2, 0) =
      -_tmp171 *
          (-Scalar(0.86627065637365697) * _tmp178 + Scalar(1.0) * _tmp180 * std::sinh(_tmp170) -
           (-Scalar(0.1034955) * _tmp172 * _tmp178 +
            _tmp173 * (-_tmp169 * _tmp176 - _tmp171 * _tmp180)) *
               std::sinh(_tmp174)) -
      _tmp176 * (Scalar(0.86627065637365697) * _tmp164 + std::cosh(_tmp170) - std::cosh(_tmp174));
  _res(3, 0) =
      _tmp175 * (Scalar(0.876505537412406) * _tmp183 - std::cosh(_tmp191) + std::cosh(_tmp192)) -
      _tmp182 * (Scalar(0.876505537412406) * _tmp186 + Scalar(1.0) * _tmp187 * std::sinh(_tmp192) -
                 (Scalar(0.1034955) * _tmp186 * _tmp190 +
                  _tmp189 * (_tmp175 * _tmp188 - _tmp182 * _tmp187)) *
                     std::sinh(_tmp191));
