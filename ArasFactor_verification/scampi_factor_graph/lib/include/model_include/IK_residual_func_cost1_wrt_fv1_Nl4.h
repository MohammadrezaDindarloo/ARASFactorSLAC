...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1WrtFv1Nl4(
  ...
  const Scalar _tmp35 = _tmp13 + _tmp7;
  const Scalar _tmp36 = _tmp19 + _tmp35;
  const Scalar _tmp37 = _tmp36 + position_vector(1, 0);
  const Scalar _tmp38 = _tmp37 + Scalar(-4.7744369927459998);
  ...
  const Scalar _tmp46 = -Scalar(0.010999999999999999) * _tmp29 -
  ...
  const Scalar _tmp63 = _tmp20 + _tmp7;
  ...
  const Scalar _tmp73 = _tmp54 * _tmp62 - _tmp71 * _tmp72;
  const Scalar _tmp74 = _tmp38 * _tmp43;
  const Scalar _tmp75 = _tmp44 * _tmp70 - _tmp74;
  const Scalar _tmp76 = Scalar(1.0) / (-_tmp62 + _tmp70 * _tmp72);
  const Scalar _tmp77 = _tmp75 * _tmp76;
  const Scalar _tmp78 = -_tmp50 * _tmp70 + _tmp52 * _tmp74 - _tmp73 * _tmp77;
  ...
  const Scalar _tmp85 = _tmp49 * _tmp72 - _tmp54 * _tmp72;
  const Scalar _tmp86 = -_tmp44 * _tmp52 + _tmp50 - _tmp77 * _tmp85 - _tmp78 * _tmp84;
  ...
  const Scalar _tmp92 = _tmp55 * _tmp72 - _tmp58 * _tmp62 + _tmp72 * _tmp91;
  const Scalar _tmp93 = _tmp70 * _tmp76;
  const Scalar _tmp94 = _tmp71 + _tmp73 * _tmp93;
  const Scalar _tmp95 = -_tmp49 - _tmp84 * _tmp94 + _tmp85 * _tmp93;
  const Scalar _tmp96 = _tmp36 * _tmp44 - _tmp40 * _tmp74 + _tmp44 * _tmp91 - _tmp77 * _tmp92;
  ...
  const Scalar _tmp102 = -_tmp101 * _tmp75 - _tmp70;
  const Scalar _tmp103 = _tmp72 * _tmp76;
  const Scalar _tmp104 = _tmp33 + Scalar(1.9874742031097401);
  const Scalar _tmp105 = _tmp22 + Scalar(8.3196563720703107);
  ...
  const Scalar _tmp116 = fh1 * (-_tmp107 * _tmp21 + _tmp115 * _tmp32);
  const Scalar _tmp117 = Scalar(1.0) * _tmp81;
  const Scalar _tmp118 = Scalar(1.0) * _tmp76;
  const Scalar _tmp119 = _tmp117 * _tmp73 * _tmp76 * _tmp83 - _tmp118 * _tmp85;
  const Scalar _tmp120 = _tmp99 * (-_tmp118 * _tmp92 - _tmp119 * _tmp97);
  const Scalar _tmp121 = _tmp87 * (_tmp119 + _tmp120);
  const Scalar _tmp122 = -_tmp121 * _tmp75 + Scalar(1.0);
  ...
  const Scalar _tmp126 = fh1 * (_tmp48 + _tmp53);
  const Scalar _tmp127 = -_tmp115 * _tmp126 - Scalar(3.29616) * _tmp17 - _tmp21 * fv1;
  const Scalar _tmp128 = _tmp36 + _tmp80;
  const Scalar _tmp129 = _tmp128 * _tmp84;
  const Scalar _tmp130 = Scalar(1.0) / (-_tmp129 - _tmp40 + _tmp82);
  ...
  const Scalar _tmp136 = -_tmp118 * _tmp73 + _tmp120 * _tmp135 - _tmp121 * _tmp78;
  const Scalar _tmp137 = _tmp107 * _tmp126 + Scalar(3.29616) * _tmp27 + _tmp32 * fv1;
  const Scalar _tmp138 = _tmp128 * _tmp81;
  const Scalar _tmp139 = Scalar(1.0) * _tmp131 * _tmp138 - Scalar(1.0) * _tmp131;
  const Scalar _tmp140 = _tmp131 * _tmp99;
  const Scalar _tmp141 = -_tmp114 * _tmp78 + _tmp128 * _tmp140;
  const Scalar _tmp142 = _tmp100 * _tmp135 - _tmp101 * _tmp78 + _tmp94;
  const Scalar _tmp143 = _tmp110 * _tmp130;
  const Scalar _tmp144 = _tmp81 * (-_tmp111 * _tmp78 - _tmp128 * _tmp143 + _tmp80);
  const Scalar _tmp145 = -Scalar(1.0) * _tmp110 * _tmp131 - Scalar(1.0) * _tmp144 + Scalar(1.0);
  const Scalar _tmp146 = Scalar(1.0) * _tmp108 * (_tmp100 * _tmp131 - _tmp117 * _tmp142) +
                         _tmp109 * _tmp145 +
                         Scalar(1.0) * _tmp116 * (-_tmp117 * _tmp141 + _tmp140) +
                         Scalar(1.0) * _tmp123 * (-_tmp117 * _tmp136 + _tmp120 * _tmp131) +
                         _tmp127 * _tmp134 + _tmp137 * _tmp139;
  ...
  const Scalar _tmp151 = _tmp18 + _tmp35;
  const Scalar _tmp152 =
      (_tmp125 * (_tmp134 * _tmp151 + _tmp139 * _tmp32 - _tmp145) - _tmp146 * _tmp150) /
  ...
  const Scalar _tmp154 =
      ...
      Scalar(4.83288938413423) *
          std::sqrt(
              Scalar(std::pow(Scalar(1 - Scalar(0.20691555724053495) * _tmp64), Scalar(2)) +
                     Scalar(0.13818785160942856) *
                         std::pow(Scalar(-Scalar(0.55661923802822921) * _tmp67 - 1), Scalar(2))));
  const Scalar _tmp155 = Scalar(9.6622558468725703) * _tmp113;
  const Scalar _tmp156 = Scalar(0.1034955) * _tmp125;
  const Scalar _tmp157 = _tmp154 * _tmp156;
  const Scalar _tmp158 = _tmp132 * _tmp81;
  const Scalar _tmp159 = _tmp131 * _tmp137;
  const Scalar _tmp160 = _tmp108 * _tmp142 * _tmp81 + _tmp109 * _tmp144 +
                         _tmp116 * _tmp141 * _tmp81 + _tmp123 * _tmp136 * _tmp81 +
                         _tmp127 * _tmp158 - _tmp138 * _tmp159;
  const Scalar _tmp161 = _tmp114 * _tmp116;
  const Scalar _tmp162 = _tmp109 * _tmp111;
  const Scalar _tmp163 =
      _tmp102 * _tmp108 * _tmp76 + _tmp122 * _tmp123 * _tmp76 - _tmp161 * _tmp77 - _tmp162 * _tmp77;
  const Scalar _tmp164 = Scalar(1.0) / (_tmp163);
  const Scalar _tmp165 = std::asinh(_tmp160 * _tmp164);
  const Scalar _tmp166 = Scalar(9.6622558468725703) * _tmp111;
  ...
  const Scalar _tmp170 = _tmp131 * _tmp32;
  const Scalar _tmp171 = _tmp111 * _tmp169 * _tmp77;
  const Scalar _tmp172 =
      (-_tmp160 * _tmp171 + _tmp164 * (-_tmp138 * _tmp170 - _tmp144 + _tmp151 * _tmp158)) /
  ...
  const Scalar _tmp177 = -_tmp100 * _tmp108 * _tmp130 + _tmp109 * _tmp143 - _tmp116 * _tmp140 -
                         _tmp120 * _tmp123 * _tmp130 - _tmp127 * _tmp133 + _tmp159;
  const Scalar _tmp178 = _tmp101 * _tmp108 + _tmp121 * _tmp123 + _tmp161 + _tmp162;
  ...
  const Scalar _tmp182 =
      ...
      Scalar(4.7744369927459998) *
          std::sqrt(
              Scalar(std::pow(Scalar(1 - Scalar(0.2094487793051498) * _tmp37), Scalar(2)) +
  ...
  const Scalar _tmp187 = (_tmp177 * _tmp186 + _tmp179 * (-_tmp133 * _tmp151 - _tmp143 + _tmp170)) /
  ...
  _res(1, 0) =
      -_tmp153 *
          (-Scalar(0.86627065637365697) * _tmp150 + Scalar(1.0) * _tmp152 * std::sinh(_tmp148) -
           (-Scalar(0.1034955) * _tmp150 * _tmp154 +
            _tmp156 * (-_tmp147 * _tmp155 - _tmp152 * _tmp153)) *
               std::sinh(_tmp157)) -
      _tmp155 * (Scalar(0.86627065637365697) * _tmp125 + std::cosh(_tmp148) - std::cosh(_tmp157));
  _res(2, 0) =
      -_tmp167 * (Scalar(0.876505537412406) * _tmp164 - std::cosh(_tmp175) + std::cosh(_tmp176)) -
      _tmp168 * (-Scalar(0.876505537412406) * _tmp171 + Scalar(1.0) * _tmp172 * std::sinh(_tmp176) -
                 (-Scalar(0.1034955) * _tmp171 * _tmp174 +
                  _tmp173 * (-_tmp165 * _tmp167 - _tmp168 * _tmp172)) *
                     std::sinh(_tmp175));
  _res(3, 0) =
      _tmp166 * (Scalar(0.86564762886483004) * _tmp179 - std::cosh(_tmp184) + std::cosh(_tmp188)) -
      _tmp181 *
          (Scalar(0.86564762886483004) * _tmp186 + Scalar(1.0) * _tmp187 * std::sinh(_tmp188) -
           (Scalar(0.1034955) * _tmp182 * _tmp186 +
            _tmp183 * (_tmp166 * _tmp180 - _tmp181 * _tmp187)) *
               std::sinh(_tmp184));
