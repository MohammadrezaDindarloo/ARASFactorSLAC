...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl1(
  ...
  const Scalar _tmp40 = _tmp11 + _tmp16;
  ...
  const Scalar _tmp51 = _tmp21 + _tmp44;
  ...
  const Scalar _tmp59 = Scalar(1.0) / (_tmp53);
  ...
  const Scalar _tmp67 = _tmp66 + Scalar(-4.83288938413423);
  ...
  const Scalar _tmp71 = _tmp61 * _tmp69 - _tmp62 * _tmp70 + _tmp65 * _tmp69;
  const Scalar _tmp72 = _tmp56 * _tmp59;
  const Scalar _tmp73 = _tmp49 * _tmp72 - _tmp50;
  const Scalar _tmp74 = Scalar(1.0) / (_tmp69 * _tmp72 - _tmp70);
  const Scalar _tmp75 = _tmp73 * _tmp74;
  const Scalar _tmp76 = _tmp41 * _tmp49 - _tmp45 * _tmp50 + _tmp49 * _tmp61 - _tmp71 * _tmp75;
  const Scalar _tmp77 = Scalar(1.0) / (_tmp76);
  const Scalar _tmp78 = Scalar(1.0) * _tmp77;
  const Scalar _tmp79 = _tmp69 * _tmp75;
  const Scalar _tmp80 = _tmp30 + Scalar(1.9874742031097401);
  const Scalar _tmp81 = _tmp19 + Scalar(8.3196563720703107);
  ...
  const Scalar _tmp85 = fh1 * (-_tmp18 * _tmp84 + _tmp29 * _tmp83);
  const Scalar _tmp86 = _tmp34 + _tmp38;
  const Scalar _tmp87 = _tmp36 + _tmp37;
  const Scalar _tmp88 = _tmp35 + _tmp87;
  const Scalar _tmp89 = -_tmp69 * _tmp86 + _tmp69 * _tmp88;
  const Scalar _tmp90 = _tmp34 + _tmp87;
  const Scalar _tmp91 = _tmp72 * _tmp88;
  const Scalar _tmp92 = -_tmp69 * _tmp91 + _tmp70 * _tmp86;
  const Scalar _tmp93 = -_tmp49 * _tmp91 + _tmp50 * _tmp90 - _tmp75 * _tmp92;
  ...
  const Scalar _tmp98 = _tmp97 * (-_tmp62 + _tmp94);
  const Scalar _tmp99 = _tmp49 * _tmp88 - _tmp49 * _tmp90 - _tmp75 * _tmp89 - _tmp93 * _tmp98;
  const Scalar _tmp100 = Scalar(1.0) / (_tmp99);
  const Scalar _tmp101 = Scalar(1.0) * _tmp74;
  const Scalar _tmp102 = _tmp101 * _tmp92;
  const Scalar _tmp103 = -_tmp101 * _tmp89 + _tmp102 * _tmp98;
  const Scalar _tmp104 = _tmp100 * _tmp76;
  const Scalar _tmp105 = _tmp77 * _tmp99;
  const Scalar _tmp106 = _tmp105 * (-_tmp101 * _tmp71 - _tmp103 * _tmp104);
  const Scalar _tmp107 = _tmp100 * (_tmp103 + _tmp106);
  const Scalar _tmp108 = -_tmp107 * _tmp73 + Scalar(1.0);
  const Scalar _tmp109 = _tmp69 * _tmp74;
  const Scalar _tmp110 = _tmp83 * fh1;
  const Scalar _tmp111 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp112 = _tmp94 + _tmp95 * _tmp98;
  const Scalar _tmp113 = 0;
  const Scalar _tmp114 = _tmp72 * _tmp74;
  const Scalar _tmp115 = _tmp114 * _tmp92 + _tmp91;
  const Scalar _tmp116 = _tmp114 * _tmp89 - _tmp115 * _tmp98 - _tmp88;
  const Scalar _tmp117 = _tmp105 * (-_tmp104 * _tmp116 + _tmp114 * _tmp71 - _tmp61);
  const Scalar _tmp118 = _tmp100 * (_tmp116 + _tmp117);
  const Scalar _tmp119 = -_tmp118 * _tmp73 - _tmp72;
  const Scalar _tmp120 = _tmp84 * fh1;
  const Scalar _tmp121 = -_tmp110 * _tmp60 * (_tmp107 * _tmp49 + _tmp108 * _tmp109) -
                         _tmp111 * _tmp60 * (_tmp113 * _tmp49 - _tmp113 * _tmp79) -
                         _tmp120 * _tmp60 * (_tmp109 * _tmp119 + _tmp118 * _tmp49 + Scalar(1.0)) -
                         _tmp60 * _tmp85 * (_tmp49 * _tmp78 - _tmp78 * _tmp79);
  const Scalar _tmp122 = Scalar(1.0) / (_tmp121);
  const Scalar _tmp123 = Scalar(6.347051629636093) *
  ...
  const Scalar _tmp124 = _tmp41 + _tmp96;
  const Scalar _tmp125 = _tmp124 * _tmp98;
  const Scalar _tmp126 = Scalar(1.0) / (-_tmp125 - _tmp45 + _tmp94);
  const Scalar _tmp127 = Scalar(1.0) * _tmp126;
  const Scalar _tmp128 = _tmp112 * _tmp126;
  const Scalar _tmp129 = -_tmp113 * _tmp93 - _tmp124 * _tmp128 + _tmp96;
  const Scalar _tmp130 = Scalar(1.0) * _tmp97;
  const Scalar _tmp131 = _tmp39 * fh1;
  const Scalar _tmp132 = -_tmp131 * _tmp83 - Scalar(3.29616) * _tmp15 - _tmp18 * fv1;
  const Scalar _tmp133 = _tmp125 * _tmp127 + Scalar(1.0);
  const Scalar _tmp134 = _tmp127 * _tmp98;
  const Scalar _tmp135 = _tmp124 * _tmp127;
  const Scalar _tmp136 = _tmp105 * _tmp135 - _tmp78 * _tmp93;
  const Scalar _tmp137 = _tmp105 * _tmp127;
  const Scalar _tmp138 = _tmp131 * _tmp84 + Scalar(3.29616) * _tmp26 + _tmp29 * fv1;
  const Scalar _tmp139 = _tmp124 * _tmp126;
  const Scalar _tmp140 = -_tmp102 + _tmp106 * _tmp139 - _tmp107 * _tmp93;
  const Scalar _tmp141 = Scalar(1.0) * fh1;
  const Scalar _tmp142 = _tmp115 + _tmp117 * _tmp139 - _tmp118 * _tmp93;
  const Scalar _tmp143 = std::asinh(
      _tmp122 * (Scalar(1.0) * _tmp111 * (-_tmp112 * _tmp127 - _tmp129 * _tmp130 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp132 * (-_tmp130 * _tmp133 + _tmp134) +
                 Scalar(1.0) * _tmp138 * (-_tmp127 + _tmp135 * _tmp97) +
                 _tmp141 * _tmp83 * (_tmp106 * _tmp127 - _tmp130 * _tmp140) +
                 _tmp141 * _tmp84 * (_tmp117 * _tmp127 - _tmp130 * _tmp142) +
                 Scalar(1.0) * _tmp85 * (-_tmp130 * _tmp136 + _tmp137)));
  ...
  const Scalar _tmp147 = _tmp78 * _tmp85;
  const Scalar _tmp148 =
      _tmp108 * _tmp145 * _tmp83 + _tmp119 * _tmp145 * _tmp84 - _tmp146 * _tmp75 - _tmp147 * _tmp75;
  const Scalar _tmp149 = Scalar(1.0) / (_tmp148);
  const Scalar _tmp150 = _tmp127 * _tmp138;
  const Scalar _tmp151 =
      std::asinh(_tmp149 * (_tmp110 * _tmp140 * _tmp97 + _tmp111 * _tmp129 * _tmp97 +
                            _tmp120 * _tmp142 * _tmp97 - _tmp124 * _tmp150 * _tmp97 +
                            _tmp132 * _tmp133 * _tmp97 + _tmp136 * _tmp85 * _tmp97));
  const Scalar _tmp152 = Scalar(23.356819799277336) *
                             std::pow(Scalar(1 - Scalar(0.20691555724053495) * _tmp66), Scalar(2)) +
  ...
  const Scalar _tmp154 = _tmp107 * _tmp110 + _tmp118 * _tmp120 + _tmp146 + _tmp147;
  const Scalar _tmp155 = Scalar(1.0) / (_tmp154);
  const Scalar _tmp156 = std::asinh(_tmp155 * (-_tmp106 * _tmp110 * _tmp126 + _tmp111 * _tmp128 -
                                               _tmp117 * _tmp120 * _tmp126 - _tmp132 * _tmp134 -
                                               _tmp137 * _tmp85 + _tmp150));
  const Scalar _tmp157 = Scalar(9.6622558468725703) * _tmp154;
  const Scalar _tmp158 = Scalar(22.795248597701466) *
                             std::pow(Scalar(1 - Scalar(0.2094487793051498) * _tmp42), Scalar(2)) +
                         Scalar(7.3829146708599787) *
                             std::pow(Scalar(1 - Scalar(0.36803241838814449) * _tmp46), Scalar(2));
  ...
  _res(1, 0) =
      _tmp144 *
          (-std::sinh(Scalar(1.0) * _tmp143) -
           std::sinh(Scalar(0.1034955) * _tmp122 * (-std::sqrt(_tmp123) - _tmp143 * _tmp144))) -
      Scalar(8.4690207536791995) *
          std::sqrt(Scalar(Scalar(0.013942273753185566) * _tmp123 +
  ...
  _res(2, 0) =
      _tmp153 *
          (-std::sinh(Scalar(1.0) * _tmp151) -
           std::sinh(Scalar(0.1034955) * _tmp149 * (-_tmp151 * _tmp153 - std::sqrt(_tmp152)))) -
      Scalar(8.3701287145205097) *
          std::sqrt(Scalar(Scalar(0.014273672465547484) * _tmp152 +
                           std::pow(Scalar(-Scalar(0.11947247576553975) * _tmp86 -
  ...
  _res(3, 0) =
      ...
      Scalar(8.3641088633305802) *
          std::sqrt(Scalar(Scalar(0.014294226073078949) * _tmp158 +
                           std::pow(Scalar(-Scalar(0.11955846299229073) * _tmp90 -
