...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl10(
  ...
  const Scalar _tmp53 = _tmp20 + _tmp38;
  ...
  const Scalar _tmp58 = _tmp32 + _tmp48;
  const Scalar _tmp59 = _tmp35 + _tmp47;
  const Scalar _tmp60 = _tmp26 + _tmp37;
  ...
  const Scalar _tmp70 = _tmp44 + Scalar(-4.83288938413423);
  const Scalar _tmp71 = _tmp40 + Scalar(1.7965602546229);
  const Scalar _tmp72 = Scalar(1.0) / (_tmp71);
  const Scalar _tmp73 = _tmp70 * _tmp72;
  const Scalar _tmp74 = _tmp52 * _tmp56;
  const Scalar _tmp75 = _tmp57 * _tmp73 - _tmp74;
  const Scalar _tmp76 = _tmp65 * _tmp66;
  const Scalar _tmp77 = Scalar(1.0) / (_tmp67 * _tmp73 - _tmp76);
  const Scalar _tmp78 = _tmp75 * _tmp77;
  const Scalar _tmp79 = _tmp59 * _tmp76 - _tmp68 * _tmp73;
  const Scalar _tmp80 = _tmp49 * _tmp73;
  const Scalar _tmp81 = -_tmp57 * _tmp80 + _tmp58 * _tmp74 - _tmp78 * _tmp79;
  ...
  const Scalar _tmp87 = _tmp49 * _tmp57 - _tmp57 * _tmp58 - _tmp69 * _tmp78 - _tmp81 * _tmp86;
  const Scalar _tmp88 = Scalar(1.0) / (_tmp87);
  const Scalar _tmp89 = _tmp82 * _tmp86 + _tmp85;
  const Scalar _tmp90 = 0;
  const Scalar _tmp91 = _tmp88 * _tmp90;
  const Scalar _tmp92 = _tmp67 * _tmp78;
  const Scalar _tmp93 =
  ...
  const Scalar _tmp96 = _tmp94 * (_tmp39 * _tmp70 * _tmp95 - _tmp43 * _tmp71 * _tmp95);
  const Scalar _tmp97 = _tmp73 * _tmp77;
  const Scalar _tmp98 = _tmp79 * _tmp97 + _tmp80;
  const Scalar _tmp99 = -_tmp49 + _tmp69 * _tmp97 - _tmp86 * _tmp98;
  const Scalar _tmp100 = -_tmp60 * _tmp76 + _tmp63 * _tmp67 + _tmp67 * _tmp96;
  const Scalar _tmp101 = -_tmp100 * _tmp78 + _tmp50 * _tmp57 - _tmp53 * _tmp74 + _tmp57 * _tmp96;
  ...
  const Scalar _tmp107 = _tmp57 * _tmp88;
  const Scalar _tmp108 = _tmp75 * _tmp88;
  const Scalar _tmp109 = -_tmp106 * _tmp108 - _tmp73;
  const Scalar _tmp110 = _tmp67 * _tmp77;
  const Scalar _tmp111 = _tmp28 + Scalar(-2.5193355532036801);
  ...
  const Scalar _tmp118 = fh1 * (-_tmp114 * _tmp17 + _tmp117 * _tmp27);
  const Scalar _tmp119 = Scalar(1.0) * _tmp77;
  const Scalar _tmp120 = _tmp119 * _tmp79;
  const Scalar _tmp121 = -_tmp119 * _tmp69 + _tmp120 * _tmp86;
  ...
  const Scalar _tmp126 = -_tmp115 * _tmp94 * (_tmp106 * _tmp107 + _tmp109 * _tmp110 + Scalar(1.0)) -
                         _tmp118 * _tmp94 * (_tmp116 * _tmp57 - _tmp116 * _tmp92) -
                         _tmp125 * _tmp94 * (_tmp107 * _tmp123 + _tmp110 * _tmp124) -
                         _tmp46 * _tmp94 * (_tmp57 * _tmp91 - _tmp91 * _tmp92);
  const Scalar _tmp127 = Scalar(1.0) / (_tmp126);
  const Scalar _tmp128 = _tmp50 + _tmp83;
  ...
  const Scalar _tmp133 = _tmp81 * _tmp88;
  const Scalar _tmp134 = _tmp84 * (-_tmp128 * _tmp132 - _tmp133 * _tmp90 + _tmp83);
  const Scalar _tmp135 = _tmp131 * _tmp86;
  const Scalar _tmp136 = _tmp84 * (_tmp129 * _tmp131 + Scalar(1.0));
  const Scalar _tmp137 = _tmp36 * fh1;
  const Scalar _tmp138 = -_tmp117 * _tmp137 - Scalar(3.29616) * _tmp14 - _tmp17 * fv1;
  const Scalar _tmp139 = _tmp128 * _tmp130;
  const Scalar _tmp140 = -_tmp120 + _tmp122 * _tmp139 - _tmp123 * _tmp133;
  const Scalar _tmp141 = Scalar(1.0) * _tmp84;
  const Scalar _tmp142 = _tmp105 * _tmp139 - _tmp106 * _tmp133 + _tmp98;
  const Scalar _tmp143 = _tmp128 * _tmp84;
  const Scalar _tmp144 = _tmp114 * _tmp137 + Scalar(3.29616) * _tmp23 + _tmp27 * fv1;
  const Scalar _tmp145 = _tmp104 * _tmp131;
  const Scalar _tmp146 = -_tmp116 * _tmp81 + _tmp128 * _tmp145;
  const Scalar _tmp147 = std::asinh(
      _tmp127 * (Scalar(1.0) * _tmp115 * (_tmp105 * _tmp131 - _tmp141 * _tmp142) +
                 Scalar(1.0) * _tmp118 * (-_tmp141 * _tmp146 + _tmp145) +
                 Scalar(1.0) * _tmp125 * (_tmp122 * _tmp131 - _tmp140 * _tmp141) +
                 Scalar(1.0) * _tmp138 * (_tmp135 - Scalar(1.0) * _tmp136) +
                 Scalar(1.0) * _tmp144 * (_tmp131 * _tmp143 - _tmp131) +
                 Scalar(1.0) * _tmp46 * (-_tmp131 * _tmp89 - Scalar(1.0) * _tmp134 + Scalar(1.0))));
  const Scalar _tmp148 = Scalar(9.6622558468725703) * _tmp126;
  const Scalar _tmp149 = _tmp46 * _tmp91;
  const Scalar _tmp150 = _tmp116 * _tmp118;
  const Scalar _tmp151 =
      _tmp109 * _tmp115 * _tmp77 + _tmp124 * _tmp125 * _tmp77 - _tmp149 * _tmp78 - _tmp150 * _tmp78;
  const Scalar _tmp152 = Scalar(1.0) / (_tmp151);
  const Scalar _tmp153 = _tmp84 * fh1;
  const Scalar _tmp154 = _tmp131 * _tmp144;
  const Scalar _tmp155 =
      std::asinh(_tmp152 * (_tmp114 * _tmp142 * _tmp153 + _tmp117 * _tmp140 * _tmp153 +
                            _tmp118 * _tmp146 * _tmp84 + _tmp134 * _tmp46 + _tmp136 * _tmp138 -
                            _tmp143 * _tmp154));
  ...
  const Scalar _tmp158 =
      _tmp106 * _tmp115 * _tmp88 + _tmp123 * _tmp125 * _tmp88 + _tmp149 + _tmp150;
  const Scalar _tmp159 = Scalar(1.0) / (_tmp158);
  const Scalar _tmp160 = std::asinh(_tmp159 * (-_tmp105 * _tmp115 * _tmp130 - _tmp118 * _tmp145 -
                                               _tmp122 * _tmp125 * _tmp130 + _tmp132 * _tmp46 -
                                               _tmp135 * _tmp138 + _tmp154));
  const Scalar _tmp161 = Scalar(22.795248597701466) *
                             std::pow(Scalar(1 - Scalar(0.2094487793051498) * _tmp51), Scalar(2)) +
  ...
  _res(1, 0) =
      ...
      Scalar(8.3701287145205097) *
          std::sqrt(Scalar(Scalar(0.014273672465547484) * _tmp45 +
                           std::pow(Scalar(-Scalar(0.11947247576553975) * _tmp49 -
                                           Scalar(0.11947247576553975) * position_vector(2, 0) + 1),
                                    Scalar(2))));
  _res(2, 0) =
      _tmp156 *
          (-std::sinh(Scalar(1.0) * _tmp155) -
           std::sinh(Scalar(0.1034955) * _tmp152 * (-_tmp155 * _tmp156 - std::sqrt(_tmp157)))) -
      Scalar(8.4718465805053693) *
          std::sqrt(Scalar(Scalar(0.013932974274013004) * _tmp157 +
                           std::pow(Scalar(-Scalar(0.11803802045956635) * _tmp59 -
                                           Scalar(0.11803802045956635) * position_vector(2, 0) + 1),
                                    Scalar(2))));
  _res(3, 0) =
      _tmp162 *
          (-std::sinh(Scalar(1.0) * _tmp160) -
           std::sinh(Scalar(0.1034955) * _tmp159 * (-_tmp160 * _tmp162 - std::sqrt(_tmp161)))) -
      Scalar(8.3641088633305802) *
          std::sqrt(Scalar(Scalar(0.014294226073078949) * _tmp161 +
                           std::pow(Scalar(-Scalar(0.11955846299229073) * _tmp58 -
