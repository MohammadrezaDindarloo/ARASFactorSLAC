...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl11(
  ...
  const Scalar _tmp64 = -_tmp48 * _tmp63 + _tmp57 * _tmp60;
  ...
  const Scalar _tmp71 = -_tmp56 * _tmp60 + _tmp63;
  const Scalar _tmp72 = Scalar(1.0) * _tmp58;
  const Scalar _tmp73 = _tmp58 * _tmp64 * _tmp66 * _tmp70 - _tmp71 * _tmp72;
  const Scalar _tmp74 = _tmp35 + _tmp61;
  const Scalar _tmp75 = _tmp26 + _tmp42;
  ...
  const Scalar _tmp86 = _tmp48 * _tmp62;
  const Scalar _tmp87 = -_tmp64 * _tmp85 + _tmp74 * _tmp83 - _tmp82 * _tmp86;
  const Scalar _tmp88 = _tmp66 * _tmp69;
  const Scalar _tmp89 = _tmp62 * _tmp82 - _tmp71 * _tmp85 - _tmp74 * _tmp82 - _tmp87 * _tmp88;
  ...
  const Scalar _tmp95 = _tmp49 * _tmp56 - _tmp52 * _tmp57 + _tmp56 * _tmp94;
  ...
  const Scalar _tmp104 = _tmp56 * _tmp58;
  const Scalar _tmp105 = _tmp82 * _tmp90;
  const Scalar _tmp106 = _tmp18 + Scalar(8.3885017487099702);
  ...
  const Scalar _tmp111 = _tmp48 * _tmp58;
  const Scalar _tmp112 = _tmp111 * _tmp64 + _tmp86;
  const Scalar _tmp113 = _tmp111 * _tmp71 - _tmp112 * _tmp88 - _tmp62;
  const Scalar _tmp114 = _tmp99 * (_tmp111 * _tmp95 - _tmp113 * _tmp97 - _tmp94);
  const Scalar _tmp115 = _tmp113 + _tmp114;
  const Scalar _tmp116 = -_tmp102 * _tmp115 - _tmp48;
  const Scalar _tmp117 = _tmp107 * _tmp108;
  const Scalar _tmp118 = _tmp117 * fh1;
  const Scalar _tmp119 = Scalar(1.0) * _tmp98;
  const Scalar _tmp120 = _tmp72 * _tmp84 * _tmp98;
  const Scalar _tmp121 = fh1 * (_tmp109 * _tmp27 - _tmp117 * _tmp17);
  const Scalar _tmp122 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp123 = _tmp65 + _tmp67 * _tmp88;
  ...
  const Scalar _tmp127 = -_tmp110 * _tmp93 * (_tmp101 * _tmp105 + _tmp103 * _tmp104) -
                         ...
                         _tmp121 * _tmp93 * (_tmp119 * _tmp82 - _tmp120 * _tmp56) -
                         _tmp122 * _tmp93 * (-_tmp104 * _tmp126 + _tmp125 * _tmp82);
  const Scalar _tmp128 = Scalar(1.0) / (_tmp127);
  const Scalar _tmp129 = _tmp68 + _tmp78;
  const Scalar _tmp130 = _tmp129 * _tmp88;
  const Scalar _tmp131 = Scalar(1.0) / (-_tmp130 + _tmp65 - _tmp75);
  ...
  const Scalar _tmp136 = -_tmp109 * _tmp135 - Scalar(3.29616) * _tmp11 - _tmp17 * fv1;
  const Scalar _tmp137 = _tmp123 * _tmp131;
  const Scalar _tmp138 = _tmp87 * _tmp90;
  const Scalar _tmp139 = -_tmp124 * _tmp138 - _tmp129 * _tmp137 + _tmp68;
  const Scalar _tmp140 = _tmp132 * _tmp99;
  const Scalar _tmp141 = -_tmp119 * _tmp87 + _tmp129 * _tmp140;
  const Scalar _tmp142 = _tmp129 * _tmp131;
  const Scalar _tmp143 = _tmp112 + _tmp114 * _tmp142 - _tmp115 * _tmp138;
  const Scalar _tmp144 = _tmp100 * _tmp142 - _tmp101 * _tmp138 - _tmp64 * _tmp72;
  const Scalar _tmp145 = _tmp129 * _tmp69;
  const Scalar _tmp146 = _tmp117 * _tmp135 + Scalar(3.29616) * _tmp23 + _tmp27 * fv1;
  const Scalar _tmp147 = std::asinh(
      _tmp128 * (Scalar(1.0) * _tmp110 * (_tmp100 * _tmp132 - _tmp144 * _tmp70) +
                 Scalar(1.0) * _tmp118 * (_tmp114 * _tmp132 - _tmp143 * _tmp70) +
                 Scalar(1.0) * _tmp121 * (_tmp140 - _tmp141 * _tmp70) +
                 Scalar(1.0) * _tmp122 * (-_tmp123 * _tmp132 - _tmp139 * _tmp70 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp136 * (_tmp133 - _tmp134 * _tmp70) +
                 Scalar(1.0) * _tmp146 * (_tmp132 * _tmp145 - _tmp132)));
  ...
  const Scalar _tmp150 = _tmp103 * _tmp110 * _tmp58 + _tmp116 * _tmp118 * _tmp58 -
                         _tmp120 * _tmp121 - _tmp122 * _tmp126 * _tmp58;
  const Scalar _tmp151 = Scalar(1.0) / (_tmp150);
  const Scalar _tmp152 = _tmp132 * _tmp146;
  const Scalar _tmp153 =
      std::asinh(_tmp151 * (_tmp110 * _tmp144 * _tmp69 + _tmp118 * _tmp143 * _tmp69 +
                            _tmp121 * _tmp141 * _tmp69 + _tmp122 * _tmp139 * _tmp69 +
                            _tmp134 * _tmp136 * _tmp69 - _tmp145 * _tmp152));
  ...
  const Scalar _tmp156 = _tmp101 * _tmp110 * _tmp90 + _tmp115 * _tmp118 * _tmp90 +
                         _tmp119 * _tmp121 + _tmp122 * _tmp125;
  const Scalar _tmp157 = Scalar(1.0) / (_tmp156);
  const Scalar _tmp158 =
      std::asinh(_tmp157 * (-_tmp100 * _tmp110 * _tmp131 - _tmp114 * _tmp118 * _tmp131 -
                            _tmp121 * _tmp140 + _tmp122 * _tmp137 - _tmp133 * _tmp136 + _tmp152));
  ...
  _res(1, 0) =
      ...
      Scalar(8.3701287145205097) *
          std::sqrt(Scalar(Scalar(0.014273672465547484) * _tmp149 +
                           std::pow(Scalar(-Scalar(0.11947247576553975) * _tmp62 -
