...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl13(
  ...
  const Scalar _tmp21 = _tmp10 * _tmp5;
  ...
  const Scalar _tmp71 = _tmp60 * _tmp69 - _tmp62 * _tmp70 + _tmp65 * _tmp69;
  const Scalar _tmp72 = _tmp51 * _tmp58;
  const Scalar _tmp73 = _tmp47 * _tmp72 - _tmp61;
  const Scalar _tmp74 = Scalar(1.0) / (_tmp69 * _tmp72 - _tmp70);
  const Scalar _tmp75 = _tmp73 * _tmp74;
  const Scalar _tmp76 = _tmp39 * _tmp47 - _tmp43 * _tmp61 + _tmp47 * _tmp60 - _tmp71 * _tmp75;
  const Scalar _tmp77 = Scalar(1.0) / (_tmp76);
  const Scalar _tmp78 = Scalar(1.0) * _tmp77;
  const Scalar _tmp79 = _tmp69 * _tmp75;
  const Scalar _tmp80 = _tmp29 + Scalar(-4.7744369927459998);
  const Scalar _tmp81 = _tmp19 + Scalar(-2.7171519410699099);
  ...
  const Scalar _tmp85 = fh1 * (_tmp18 * _tmp83 - _tmp28 * _tmp84);
  ...
  const Scalar _tmp93 = _tmp87 * _tmp92 + _tmp90;
  const Scalar _tmp94 = -_tmp33;
  const Scalar _tmp95 = _tmp36 + _tmp94;
  const Scalar _tmp96 = _tmp34 - _tmp35;
  const Scalar _tmp97 = _tmp94 + _tmp96;
  const Scalar _tmp98 = _tmp33 + _tmp96;
  const Scalar _tmp99 = _tmp72 * _tmp97;
  const Scalar _tmp100 = -_tmp69 * _tmp99 + _tmp70 * _tmp98;
  const Scalar _tmp101 = -_tmp100 * _tmp75 - _tmp47 * _tmp99 + _tmp61 * _tmp95;
  const Scalar _tmp102 = _tmp69 * _tmp97 - _tmp69 * _tmp98;
  const Scalar _tmp103 = -_tmp101 * _tmp92 - _tmp102 * _tmp75 - _tmp47 * _tmp95 + _tmp47 * _tmp97;
  const Scalar _tmp104 = Scalar(1.0) / (_tmp103);
  const Scalar _tmp105 = 0;
  const Scalar _tmp106 = Scalar(1.0) * _tmp74;
  const Scalar _tmp107 = Scalar(1.0) * _tmp89;
  const Scalar _tmp108 = _tmp100 * _tmp107 * _tmp74 * _tmp91 - _tmp102 * _tmp106;
  const Scalar _tmp109 = _tmp104 * _tmp76;
  const Scalar _tmp110 = _tmp103 * _tmp77;
  const Scalar _tmp111 = _tmp110 * (-_tmp106 * _tmp71 - _tmp108 * _tmp109);
  const Scalar _tmp112 = _tmp108 + _tmp111;
  const Scalar _tmp113 = _tmp104 * _tmp47;
  const Scalar _tmp114 = _tmp104 * _tmp73;
  const Scalar _tmp115 = -_tmp112 * _tmp114 + Scalar(1.0);
  const Scalar _tmp116 = _tmp69 * _tmp74;
  const Scalar _tmp117 = _tmp83 * fh1;
  const Scalar _tmp118 = _tmp72 * _tmp74;
  const Scalar _tmp119 = _tmp100 * _tmp118 + _tmp99;
  const Scalar _tmp120 = _tmp102 * _tmp118 - _tmp119 * _tmp92 - _tmp97;
  const Scalar _tmp121 = _tmp110 * (-_tmp109 * _tmp120 + _tmp118 * _tmp71 - _tmp60);
  const Scalar _tmp122 = _tmp120 + _tmp121;
  const Scalar _tmp123 = -_tmp114 * _tmp122 - _tmp72;
  const Scalar _tmp124 = _tmp84 * fh1;
  const Scalar _tmp125 = -_tmp117 * _tmp59 * (_tmp112 * _tmp113 + _tmp115 * _tmp116) -
                         _tmp124 * _tmp59 * (_tmp113 * _tmp122 + _tmp116 * _tmp123 + Scalar(1.0)) -
                         _tmp59 * _tmp85 * (_tmp47 * _tmp78 - _tmp78 * _tmp79) -
                         _tmp59 * _tmp86 * (_tmp105 * _tmp47 - _tmp105 * _tmp79);
  const Scalar _tmp126 = Scalar(1.0) / (_tmp125);
  const Scalar _tmp127 = _tmp101 * _tmp104;
  const Scalar _tmp128 = _tmp39 + _tmp88;
  const Scalar _tmp129 = _tmp128 * _tmp92;
  const Scalar _tmp130 = Scalar(1.0) / (-_tmp129 - _tmp43 + _tmp90);
  ...
  const Scalar _tmp135 = -_tmp101 * _tmp78 + _tmp128 * _tmp134;
  const Scalar _tmp136 = _tmp130 * _tmp93;
  const Scalar _tmp137 = -_tmp101 * _tmp105 - _tmp128 * _tmp136 + _tmp88;
  const Scalar _tmp138 = _tmp37 * fh1;
  const Scalar _tmp139 = -_tmp138 * _tmp83 - Scalar(3.29616) * _tmp23 - _tmp28 * fv1;
  const Scalar _tmp140 = _tmp129 * _tmp133 + Scalar(1.0);
  const Scalar _tmp141 = _tmp119 + _tmp121 * _tmp131 - _tmp122 * _tmp127;
  const Scalar _tmp142 = _tmp128 * _tmp89;
  const Scalar _tmp143 = Scalar(3.29616) * _tmp12 + _tmp138 * _tmp84 + _tmp18 * fv1;
  const Scalar _tmp144 = std::asinh(
      _tmp126 * (Scalar(1.0) * _tmp117 * (-_tmp107 * _tmp132 + _tmp111 * _tmp133) +
                 Scalar(1.0) * _tmp124 * (-_tmp107 * _tmp141 + _tmp121 * _tmp133) +
                 Scalar(1.0) * _tmp139 * (-_tmp107 * _tmp140 + _tmp133 * _tmp92) +
                 Scalar(1.0) * _tmp143 * (_tmp133 * _tmp142 - _tmp133) +
                 Scalar(1.0) * _tmp85 * (-_tmp107 * _tmp135 + _tmp134) +
                 Scalar(1.0) * _tmp86 * (-_tmp107 * _tmp137 - _tmp133 * _tmp93 + Scalar(1.0))));
  ...
  const Scalar _tmp148 = _tmp105 * _tmp86;
  const Scalar _tmp149 =
      _tmp115 * _tmp117 * _tmp74 + _tmp123 * _tmp124 * _tmp74 - _tmp147 * _tmp75 - _tmp148 * _tmp75;
  const Scalar _tmp150 = Scalar(1.0) / (_tmp149);
  const Scalar _tmp151 = _tmp139 * _tmp89;
  const Scalar _tmp152 = _tmp133 * _tmp143;
  const Scalar _tmp153 =
      std::asinh(_tmp150 * (_tmp117 * _tmp132 * _tmp89 + _tmp124 * _tmp141 * _tmp89 +
                            _tmp135 * _tmp85 * _tmp89 + _tmp137 * _tmp86 * _tmp89 +
                            _tmp140 * _tmp151 - _tmp142 * _tmp152));
  ...
  const Scalar _tmp156 =
      _tmp104 * _tmp112 * _tmp117 + _tmp104 * _tmp122 * _tmp124 + _tmp147 + _tmp148;
  ...
  const Scalar _tmp159 = std::asinh(
      _tmp157 * (-_tmp111 * _tmp117 * _tmp130 - _tmp121 * _tmp124 * _tmp130 -
                 _tmp133 * _tmp151 * _tmp91 - _tmp134 * _tmp85 + _tmp136 * _tmp86 + _tmp152));
  ...
  _res(1, 0) =
      _tmp145 *
          (-std::sinh(Scalar(1.0) * _tmp144) -
           std::sinh(Scalar(0.1034955) * _tmp126 * (-_tmp144 * _tmp145 - std::sqrt(_tmp146)))) -
