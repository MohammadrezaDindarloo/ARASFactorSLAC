...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl15(
  ...
  const Scalar _tmp63 = -_tmp49 * _tmp59 + _tmp61 * _tmp62;
  ...
  const Scalar _tmp67 = Scalar(1.0) * _tmp45;
  const Scalar _tmp68 = -_tmp67;
  const Scalar _tmp69 = Scalar(1.0) / (_tmp55 + _tmp68);
  const Scalar _tmp70 = Scalar(1.0) * _tmp69;
  const Scalar _tmp71 = _tmp38 * _tmp59 - _tmp59 * _tmp61;
  const Scalar _tmp72 = Scalar(1.0) * _tmp64;
  const Scalar _tmp73 = _tmp63 * _tmp64 * _tmp66 * _tmp70 - _tmp71 * _tmp72;
  const Scalar _tmp74 = _tmp37 + _tmp60;
  const Scalar _tmp75 = _tmp39 + _tmp50;
  const Scalar _tmp76 = _tmp75 + position_vector(0, 0);
  const Scalar _tmp77 = _tmp76 + Scalar(1.9874742031097401);
  const Scalar _tmp78 = _tmp44 + _tmp54;
  ...
  const Scalar _tmp84 = _tmp48 * _tmp82 - _tmp83;
  const Scalar _tmp85 = _tmp64 * _tmp84;
  const Scalar _tmp86 = -_tmp49 * _tmp82 - _tmp63 * _tmp85 + _tmp74 * _tmp83;
  const Scalar _tmp87 = _tmp66 * _tmp69;
  const Scalar _tmp88 = _tmp38 * _tmp82 - _tmp71 * _tmp85 - _tmp74 * _tmp82 - _tmp86 * _tmp87;
  ...
  const Scalar _tmp92 = _tmp43 * _tmp90;
  const Scalar _tmp93 = _tmp92 * (_tmp40 * _tmp47 * _tmp91 - _tmp42 * _tmp45 * _tmp91);
  const Scalar _tmp94 = -_tmp51 * _tmp62 + _tmp55 * _tmp59 + _tmp59 * _tmp93;
  ...
  const Scalar _tmp99 = _tmp98 * (-_tmp72 * _tmp94 - _tmp73 * _tmp96);
  ...
  const Scalar _tmp111 = _tmp65 + _tmp67 * _tmp87;
  const Scalar _tmp112 = 0;
  const Scalar _tmp113 = _tmp112 * _tmp89;
  const Scalar _tmp114 = _tmp101 * _tmp112;
  const Scalar _tmp115 = _tmp48 * _tmp64;
  const Scalar _tmp116 = _tmp115 * _tmp63 + _tmp49;
  const Scalar _tmp117 = _tmp115 * _tmp71 - _tmp116 * _tmp87 - _tmp38;
  const Scalar _tmp118 = _tmp98 * (_tmp115 * _tmp94 - _tmp117 * _tmp96 - _tmp93);
  const Scalar _tmp119 = _tmp117 + _tmp118;
  const Scalar _tmp120 = -_tmp101 * _tmp119 - _tmp48;
  const Scalar _tmp121 = _tmp106 * _tmp107;
  const Scalar _tmp122 = _tmp121 * fh1;
  const Scalar _tmp123 = Scalar(1.0) * _tmp97;
  const Scalar _tmp124 = fh1 * (_tmp108 * _tmp17 - _tmp121 * _tmp27);
  const Scalar _tmp125 = -_tmp109 * _tmp92 * (_tmp100 * _tmp104 + _tmp102 * _tmp103) -
                         _tmp110 * _tmp92 * (-_tmp103 * _tmp114 + _tmp113 * _tmp82) -
                         _tmp122 * _tmp92 * (_tmp103 * _tmp120 + _tmp104 * _tmp119 + Scalar(1.0)) -
                         _tmp124 * _tmp92 * (-_tmp123 * _tmp59 * _tmp85 + _tmp123 * _tmp82);
  const Scalar _tmp126 = Scalar(1.0) / (_tmp125);
  const Scalar _tmp127 = _tmp68 + _tmp78;
  const Scalar _tmp128 = _tmp127 * _tmp87;
  const Scalar _tmp129 = Scalar(1.0) / (-_tmp128 + _tmp65 - _tmp75);
  const Scalar _tmp130 = Scalar(1.0) * _tmp129;
  const Scalar _tmp131 = _tmp127 * _tmp130;
  const Scalar _tmp132 = -_tmp123 * _tmp86 + _tmp131 * _tmp98;
  const Scalar _tmp133 = _tmp130 * _tmp98;
  const Scalar _tmp134 = _tmp36 * fh1;
  const Scalar _tmp135 = Scalar(3.29616) * _tmp11 + _tmp121 * _tmp134 + _tmp17 * fv1;
  const Scalar _tmp136 = _tmp111 * _tmp129;
  const Scalar _tmp137 = -_tmp113 * _tmp86 - _tmp127 * _tmp136 + _tmp68;
  const Scalar _tmp138 = -_tmp108 * _tmp134 - Scalar(3.29616) * _tmp24 - _tmp27 * fv1;
  const Scalar _tmp139 = _tmp128 * _tmp130 + Scalar(1.0);
  const Scalar _tmp140 = _tmp130 * _tmp87;
  const Scalar _tmp141 = _tmp86 * _tmp89;
  const Scalar _tmp142 = _tmp127 * _tmp129;
  const Scalar _tmp143 = -_tmp100 * _tmp141 + _tmp142 * _tmp99 - _tmp63 * _tmp72;
  const Scalar _tmp144 = _tmp116 + _tmp118 * _tmp142 - _tmp119 * _tmp141;
  const Scalar _tmp145 = std::asinh(
      _tmp126 * (Scalar(1.0) * _tmp109 * (_tmp130 * _tmp99 - _tmp143 * _tmp70) +
                 Scalar(1.0) * _tmp110 * (-_tmp111 * _tmp130 - _tmp137 * _tmp70 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp122 * (_tmp118 * _tmp130 - _tmp144 * _tmp70) +
                 Scalar(1.0) * _tmp124 * (-_tmp132 * _tmp70 + _tmp133) +
                 Scalar(1.0) * _tmp135 * (-_tmp130 + _tmp131 * _tmp69) +
                 Scalar(1.0) * _tmp138 * (-_tmp139 * _tmp70 + _tmp140)));
  const Scalar _tmp146 = Scalar(6.347051629636093) *
  ...
  const Scalar _tmp148 = _tmp130 * _tmp135;
  const Scalar _tmp149 = _tmp123 * _tmp124;
  const Scalar _tmp150 = _tmp64 * fh1;
  const Scalar _tmp151 = _tmp102 * _tmp108 * _tmp150 - _tmp110 * _tmp114 * _tmp64 +
                         _tmp120 * _tmp121 * _tmp150 - _tmp149 * _tmp85;
  const Scalar _tmp152 = Scalar(1.0) / (_tmp151);
  const Scalar _tmp153 =
      std::asinh(_tmp152 * (_tmp109 * _tmp143 * _tmp69 + _tmp110 * _tmp137 * _tmp69 +
                            _tmp122 * _tmp144 * _tmp69 + _tmp124 * _tmp132 * _tmp69 -
                            _tmp127 * _tmp148 * _tmp69 + _tmp138 * _tmp139 * _tmp69));
  ...
  const Scalar _tmp156 = _tmp89 * fh1;
  const Scalar _tmp157 =
      _tmp100 * _tmp108 * _tmp156 + _tmp110 * _tmp113 + _tmp119 * _tmp121 * _tmp156 + _tmp149;
  const Scalar _tmp158 = Scalar(1.0) / (_tmp157);
  const Scalar _tmp159 = std::asinh(_tmp158 * (-_tmp109 * _tmp129 * _tmp99 + _tmp110 * _tmp136 -
                                               _tmp118 * _tmp122 * _tmp129 - _tmp124 * _tmp133 -
                                               _tmp138 * _tmp140 + _tmp148));
  ...
  _res(1, 0) =
      _tmp147 *
          (-std::sinh(Scalar(1.0) * _tmp145) -
           std::sinh(Scalar(0.1034955) * _tmp126 * (-_tmp145 * _tmp147 - std::sqrt(_tmp146)))) -
      Scalar(8.4690207536791995) *
          std::sqrt(Scalar(Scalar(0.013942273753185566) * _tmp146 +
