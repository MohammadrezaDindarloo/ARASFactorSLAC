...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl18(
  ...
  const Scalar _tmp53 = _tmp43 + _tmp6;
  ...
  const Scalar _tmp62 = _tmp47 * _tmp60;
  const Scalar _tmp63 = _tmp62 * (-_tmp40 * _tmp46 * _tmp61 + _tmp42 * _tmp44 * _tmp61);
  const Scalar _tmp64 = _tmp59 * (_tmp50 * _tmp58 - _tmp53 * _tmp57 + _tmp58 * _tmp63);
  const Scalar _tmp65 = _tmp35 - _tmp36;
  const Scalar _tmp66 = _tmp33 + _tmp65;
  const Scalar _tmp67 = _tmp34 + _tmp65;
  const Scalar _tmp68 = _tmp59 * (-_tmp58 * _tmp66 + _tmp58 * _tmp67);
  const Scalar _tmp69 = _tmp48 * _tmp67;
  const Scalar _tmp70 = _tmp59 * (_tmp57 * _tmp66 - _tmp58 * _tmp69);
  ...
  const Scalar _tmp77 = _tmp48 * _tmp68 - _tmp67 - _tmp71 * _tmp76;
  ...
  const Scalar _tmp88 = _tmp48 * _tmp87 - _tmp86;
  const Scalar _tmp89 = -_tmp69 * _tmp87 - _tmp70 * _tmp88 + _tmp78 * _tmp86;
  const Scalar _tmp90 = _tmp67 * _tmp87 - _tmp68 * _tmp88 - _tmp76 * _tmp89 - _tmp78 * _tmp87;
  const Scalar _tmp91 = Scalar(1.0) / (_tmp90);
  const Scalar _tmp92 = _tmp63 * _tmp87 - _tmp64 * _tmp88 + _tmp79 * _tmp87 - _tmp82 * _tmp86;
  const Scalar _tmp93 = _tmp91 * _tmp92;
  const Scalar _tmp94 = Scalar(1.0) / (_tmp92);
  const Scalar _tmp95 = _tmp90 * _tmp94;
  const Scalar _tmp96 = _tmp95 * (_tmp48 * _tmp64 - _tmp63 - _tmp77 * _tmp93);
  ...
  const Scalar _tmp102 = _tmp20 + Scalar(1.7965602546229);
  ...
  const Scalar _tmp108 = _tmp72 * _tmp76 + _tmp75;
  const Scalar _tmp109 = 0;
  const Scalar _tmp110 = _tmp109 * _tmp99;
  const Scalar _tmp111 = _tmp109 * _tmp91;
  const Scalar _tmp112 = Scalar(1.0) * _tmp70;
  const Scalar _tmp113 = _tmp112 * _tmp76 - Scalar(1.0) * _tmp68;
  const Scalar _tmp114 = _tmp95 * (-_tmp113 * _tmp93 - Scalar(1.0) * _tmp64);
  const Scalar _tmp115 = _tmp113 + _tmp114;
  const Scalar _tmp116 = -_tmp115 * _tmp99 + Scalar(1.0);
  const Scalar _tmp117 = _tmp103 * _tmp104;
  const Scalar _tmp118 = _tmp117 * fh1;
  const Scalar _tmp119 = Scalar(1.0) * _tmp94;
  const Scalar _tmp120 = fh1 * (-_tmp105 * _tmp29 + _tmp117 * _tmp19);
  const Scalar _tmp121 = -_tmp106 * _tmp62 * (_tmp100 * _tmp101 + _tmp97 * _tmp98 + Scalar(1.0)) -
                         _tmp107 * _tmp62 * (-_tmp101 * _tmp110 + _tmp111 * _tmp87) -
                         _tmp118 * _tmp62 * (_tmp101 * _tmp116 + _tmp115 * _tmp98) -
                         _tmp120 * _tmp62 * (-_tmp101 * _tmp119 * _tmp88 + _tmp119 * _tmp87);
  const Scalar _tmp122 = Scalar(1.0) / (_tmp121);
  const Scalar _tmp123 = _tmp38 * fh1;
  const Scalar _tmp124 = _tmp105 * _tmp123 + Scalar(3.29616) * _tmp12 + _tmp19 * fv1;
  const Scalar _tmp125 = _tmp73 + _tmp79;
  const Scalar _tmp126 = _tmp125 * _tmp76;
  const Scalar _tmp127 = Scalar(1.0) / (-_tmp126 + _tmp75 - _tmp82);
  const Scalar _tmp128 = Scalar(1.0) * _tmp127;
  const Scalar _tmp129 = _tmp125 * _tmp74;
  const Scalar _tmp130 = -_tmp117 * _tmp123 - Scalar(3.29616) * _tmp26 - _tmp29 * fv1;
  const Scalar _tmp131 = _tmp126 * _tmp128 + Scalar(1.0);
  const Scalar _tmp132 = Scalar(1.0) * _tmp74;
  const Scalar _tmp133 = _tmp128 * _tmp76;
  ...
  const Scalar _tmp137 = _tmp134 * _tmp96 - _tmp135 * _tmp97 + _tmp71;
  const Scalar _tmp138 = _tmp128 * _tmp95;
  const Scalar _tmp139 = -_tmp119 * _tmp89 + _tmp125 * _tmp138;
  const Scalar _tmp140 = _tmp108 * _tmp127;
  const Scalar _tmp141 = -_tmp109 * _tmp135 - _tmp125 * _tmp140 + _tmp73;
  const Scalar _tmp142 = std::asinh(
      _tmp122 * (Scalar(1.0) * _tmp106 * (_tmp128 * _tmp96 - _tmp132 * _tmp137) +
                 Scalar(1.0) * _tmp107 * (-_tmp108 * _tmp128 - _tmp132 * _tmp141 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp118 * (_tmp114 * _tmp128 - _tmp132 * _tmp136) +
                 Scalar(1.0) * _tmp120 * (-_tmp132 * _tmp139 + _tmp138) +
                 Scalar(1.0) * _tmp124 * (_tmp128 * _tmp129 - _tmp128) +
                 Scalar(1.0) * _tmp130 * (-_tmp131 * _tmp132 + _tmp133)));
  ...
  const Scalar _tmp146 = _tmp100 * _tmp106 * _tmp59 - _tmp107 * _tmp110 * _tmp59 +
                         _tmp116 * _tmp118 * _tmp59 - _tmp145 * _tmp59 * _tmp88;
  const Scalar _tmp147 = Scalar(1.0) / (_tmp146);
  const Scalar _tmp148 = _tmp124 * _tmp128;
  const Scalar _tmp149 =
      std::asinh(_tmp147 * (_tmp106 * _tmp137 * _tmp74 + _tmp107 * _tmp141 * _tmp74 +
                            _tmp118 * _tmp136 * _tmp74 + _tmp120 * _tmp139 * _tmp74 -
                            _tmp129 * _tmp148 + _tmp130 * _tmp131 * _tmp74));
  ...
  const Scalar _tmp152 =
      _tmp106 * _tmp91 * _tmp97 + _tmp107 * _tmp111 + _tmp115 * _tmp118 * _tmp91 + _tmp145;
  const Scalar _tmp153 = Scalar(1.0) / (_tmp152);
  const Scalar _tmp154 = std::asinh(_tmp153 * (-_tmp106 * _tmp127 * _tmp96 + _tmp107 * _tmp140 -
                                               _tmp114 * _tmp118 * _tmp127 - _tmp120 * _tmp138 -
                                               _tmp130 * _tmp133 + _tmp148));
