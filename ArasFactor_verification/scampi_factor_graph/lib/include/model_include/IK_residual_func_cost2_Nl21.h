...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl21(
  ...
  const Scalar _tmp52 = _tmp45 + _tmp8;
  ...
  const Scalar _tmp57 = _tmp47 + Scalar(-2.5193355532036801);
  const Scalar _tmp58 = Scalar(1.0) / (_tmp57);
  const Scalar _tmp59 = _tmp43 + Scalar(8.3885017487099702);
  const Scalar _tmp60 = _tmp58 * _tmp59;
  const Scalar _tmp61 = _tmp39 * _tmp60;
  const Scalar _tmp62 = _tmp32 + _tmp38;
  const Scalar _tmp63 = _tmp51 * _tmp55;
  const Scalar _tmp64 = -_tmp56 * _tmp61 + _tmp62 * _tmp63;
  const Scalar _tmp65 = Scalar(1.0) / (_tmp56 * _tmp60 - _tmp63);
  ...
  const Scalar _tmp72 = _tmp70 * (-_tmp52 + _tmp71);
  const Scalar _tmp73 = _tmp39 * _tmp56 - _tmp56 * _tmp62;
  const Scalar _tmp74 = -_tmp39 + _tmp66 * _tmp73 - _tmp67 * _tmp72;
  const Scalar _tmp75 = _tmp35 + _tmp37;
  const Scalar _tmp76 = _tmp17 + _tmp44;
  ...
  const Scalar _tmp87 = _tmp39 * _tmp83;
  const Scalar _tmp88 = -_tmp60 * _tmp87 - _tmp64 * _tmp86 + _tmp75 * _tmp84;
  const Scalar _tmp89 = -_tmp72 * _tmp88 - _tmp73 * _tmp86 - _tmp75 * _tmp83 + _tmp87;
  ...
  const Scalar _tmp94 = _tmp93 * (-_tmp42 * _tmp57 * _tmp92 + _tmp46 * _tmp59 * _tmp92);
  const Scalar _tmp95 = _tmp49 * _tmp56 - _tmp52 * _tmp63 + _tmp56 * _tmp94;
  ...
  const Scalar _tmp100 = _tmp99 * (_tmp66 * _tmp95 - _tmp74 * _tmp97 - _tmp94);
  const Scalar _tmp101 = _tmp69 + _tmp79;
  const Scalar _tmp102 = _tmp101 * _tmp72;
  const Scalar _tmp103 = Scalar(1.0) / (-_tmp102 + _tmp71 - _tmp76);
  const Scalar _tmp104 = _tmp101 * _tmp103;
  const Scalar _tmp105 = _tmp90 * (_tmp100 + _tmp74);
  const Scalar _tmp106 = _tmp100 * _tmp104 - _tmp105 * _tmp88 + _tmp67;
  const Scalar _tmp107 = Scalar(1.0) * _tmp70;
  const Scalar _tmp108 = Scalar(1.0) * _tmp103;
  const Scalar _tmp109 = _tmp19 + Scalar(1.7965602546229);
  const Scalar _tmp110 = _tmp29 + Scalar(-4.83288938413423);
  ...
  const Scalar _tmp116 = _tmp101 * _tmp114 - _tmp115 * _tmp88;
  const Scalar _tmp117 = _tmp110 * _tmp111;
  const Scalar _tmp118 = fh1 * (-_tmp112 * _tmp28 + _tmp117 * _tmp18);
  ...
  const Scalar _tmp122 = _tmp99 * (-_tmp119 * _tmp95 - _tmp121 * _tmp97);
  const Scalar _tmp123 = _tmp90 * (_tmp121 + _tmp122);
  const Scalar _tmp124 = _tmp104 * _tmp122 - _tmp120 - _tmp123 * _tmp88;
  const Scalar _tmp125 = _tmp117 * fh1;
  const Scalar _tmp126 = _tmp101 * _tmp70;
  const Scalar _tmp127 = _tmp36 * fh1;
  const Scalar _tmp128 = _tmp112 * _tmp127 + Scalar(3.29616) * _tmp15 + _tmp18 * fv1;
  const Scalar _tmp129 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp130 = _tmp68 * _tmp72 + _tmp71;
  const Scalar _tmp131 = _tmp103 * _tmp130;
  const Scalar _tmp132 = 0;
  const Scalar _tmp133 = _tmp70 * (-_tmp101 * _tmp131 - _tmp132 * _tmp88 + _tmp69);
  const Scalar _tmp134 = _tmp108 * _tmp72;
  const Scalar _tmp135 = _tmp70 * (_tmp102 * _tmp108 + Scalar(1.0));
  const Scalar _tmp136 = -_tmp117 * _tmp127 - Scalar(3.29616) * _tmp25 - _tmp28 * fv1;
  const Scalar _tmp137 = -_tmp123 * _tmp85 + Scalar(1.0);
  const Scalar _tmp138 = _tmp56 * _tmp65;
  const Scalar _tmp139 = -_tmp105 * _tmp85 - _tmp60;
  const Scalar _tmp140 = _tmp119 * _tmp85 * _tmp98;
  const Scalar _tmp141 = -_tmp113 * _tmp93 * (_tmp105 * _tmp83 + _tmp138 * _tmp139 + Scalar(1.0)) -
                         _tmp118 * _tmp93 * (_tmp115 * _tmp83 - _tmp140 * _tmp56) -
                         _tmp125 * _tmp93 * (_tmp123 * _tmp83 + _tmp137 * _tmp138) -
                         _tmp129 * _tmp93 * (-_tmp132 * _tmp56 * _tmp86 + _tmp132 * _tmp83);
  const Scalar _tmp142 = Scalar(1.0) / (_tmp141);
  const Scalar _tmp143 =
      std::asinh(_tmp142 * (Scalar(1.0) * _tmp113 * (_tmp100 * _tmp108 - _tmp106 * _tmp107) +
                            ...
                            Scalar(1.0) * _tmp129 *
                                (-_tmp108 * _tmp130 - Scalar(1.0) * _tmp133 + Scalar(1.0)) +
                            Scalar(1.0) * _tmp136 * (_tmp134 - Scalar(1.0) * _tmp135)));
  const Scalar _tmp144 = Scalar(9.6622558468725703) * _tmp141;
  const Scalar _tmp145 = _tmp129 * _tmp132;
  const Scalar _tmp146 = _tmp113 * _tmp139 * _tmp65 - _tmp118 * _tmp140 +
                         _tmp125 * _tmp137 * _tmp65 - _tmp145 * _tmp86;
  const Scalar _tmp147 = Scalar(1.0) / (_tmp146);
  const Scalar _tmp148 = Scalar(22.795248597701466) *
  ...
  const Scalar _tmp149 = _tmp108 * _tmp128;
  const Scalar _tmp150 =
      std::asinh(_tmp147 * (_tmp106 * _tmp113 * _tmp70 + _tmp116 * _tmp118 * _tmp70 +
                            _tmp124 * _tmp125 * _tmp70 - _tmp126 * _tmp149 + _tmp129 * _tmp133 +
                            _tmp135 * _tmp136));
  const Scalar _tmp151 = Scalar(9.6622558468725703) * _tmp146;
  const Scalar _tmp152 = _tmp105 * _tmp113 + _tmp115 * _tmp118 + _tmp123 * _tmp125 + _tmp145;
  const Scalar _tmp153 = Scalar(1.0) / (_tmp152);
  const Scalar _tmp154 =
      std::asinh(_tmp153 * (-_tmp100 * _tmp103 * _tmp113 - _tmp103 * _tmp122 * _tmp125 -
                            _tmp114 * _tmp118 + _tmp129 * _tmp131 - _tmp134 * _tmp136 + _tmp149));
  ...
  _res(0, 0) =
      ...
      Scalar(8.3701287145205097) *
          std::sqrt(Scalar(Scalar(0.014273672465547484) * _tmp30 +
                           std::pow(Scalar(-Scalar(0.11947247576553975) * _tmp36 -
                                           Scalar(0.11947247576553975) * position_vector(2, 0) + 1),
                                    Scalar(2))));
  _res(1, 0) =
      _tmp144 *
          (-std::sinh(Scalar(1.0) * _tmp143) -
           std::sinh(Scalar(0.1034955) * _tmp142 * (-_tmp143 * _tmp144 - std::sqrt(_tmp48)))) -
  ...
  _res(2, 0) =
      ...
      Scalar(8.3641088633305802) *
          std::sqrt(Scalar(Scalar(0.014294226073078949) * _tmp148 +
