...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl22(
  ...
  const Scalar _tmp53 = _tmp29 + _tmp40;
  const Scalar _tmp54 = _tmp53 + position_vector(1, 0);
  const Scalar _tmp55 = _tmp54 + Scalar(8.3196563720703107);
  const Scalar _tmp56 = _tmp52 + position_vector(0, 0);
  const Scalar _tmp57 = _tmp56 + Scalar(1.9874742031097401);
  ...
  const Scalar _tmp72 = -_tmp52 * _tmp59 + _tmp53 * _tmp60 + _tmp60 * _tmp71;
  const Scalar _tmp73 = _tmp63 * _tmp69;
  const Scalar _tmp74 = _tmp50 * _tmp73 - _tmp51;
  const Scalar _tmp75 = Scalar(1.0) / (-_tmp59 + _tmp60 * _tmp73);
  const Scalar _tmp76 = _tmp74 * _tmp75;
  const Scalar _tmp77 = _tmp42 * _tmp50 - _tmp46 * _tmp51 + _tmp50 * _tmp71 - _tmp72 * _tmp76;
  const Scalar _tmp78 = Scalar(1.0) / (_tmp77);
  const Scalar _tmp79 = Scalar(1.0) * _tmp78;
  const Scalar _tmp80 = _tmp60 * _tmp76;
  const Scalar _tmp81 = _tmp21 + Scalar(1.7965602546229);
  const Scalar _tmp82 = _tmp31 + Scalar(-4.83288938413423);
  ...
  const Scalar _tmp90 = -_tmp60 * _tmp88 + _tmp60 * _tmp89;
  const Scalar _tmp91 = _tmp73 * _tmp75;
  const Scalar _tmp92 = _tmp73 * _tmp89;
  const Scalar _tmp93 = _tmp59 * _tmp88 - _tmp60 * _tmp92;
  ...
  const Scalar _tmp98 = Scalar(1.0) / (_tmp53 + _tmp97);
  const Scalar _tmp99 = _tmp98 * (-_tmp52 + _tmp95);
  const Scalar _tmp100 = -_tmp89 + _tmp90 * _tmp91 - _tmp94 * _tmp99;
  const Scalar _tmp101 = _tmp34 + _tmp87;
  const Scalar _tmp102 = _tmp101 * _tmp51 - _tmp50 * _tmp92 - _tmp76 * _tmp93;
  const Scalar _tmp103 = -_tmp101 * _tmp50 - _tmp102 * _tmp99 + _tmp50 * _tmp89 - _tmp76 * _tmp90;
  ...
  const Scalar _tmp109 = _tmp104 * _tmp74;
  const Scalar _tmp110 = -_tmp108 * _tmp109 - _tmp73;
  const Scalar _tmp111 = _tmp60 * _tmp75;
  const Scalar _tmp112 = _tmp104 * _tmp50;
  const Scalar _tmp113 = _tmp84 * fh1;
  const Scalar _tmp114 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp115 = _tmp95 + _tmp96 * _tmp99;
  ...
  const Scalar _tmp120 = -_tmp118 * _tmp90 + _tmp119 * _tmp99;
  const Scalar _tmp121 = _tmp106 * (-_tmp105 * _tmp120 - _tmp118 * _tmp72);
  const Scalar _tmp122 = _tmp120 + _tmp121;
  const Scalar _tmp123 = -_tmp109 * _tmp122 + Scalar(1.0);
  const Scalar _tmp124 = _tmp85 * fh1;
  const Scalar _tmp125 = -_tmp113 * _tmp70 * (_tmp108 * _tmp112 + _tmp110 * _tmp111 + Scalar(1.0)) -
                         _tmp114 * _tmp70 * (_tmp117 * _tmp50 - _tmp117 * _tmp80) -
                         _tmp124 * _tmp70 * (_tmp111 * _tmp123 + _tmp112 * _tmp122) -
                         _tmp70 * _tmp86 * (_tmp50 * _tmp79 - _tmp79 * _tmp80);
  ...
  const Scalar _tmp128 = _tmp42 + _tmp97;
  const Scalar _tmp129 = _tmp128 * _tmp99;
  const Scalar _tmp130 = Scalar(1.0) / (-_tmp129 - _tmp46 + _tmp95);
  const Scalar _tmp131 = Scalar(1.0) * _tmp130;
  const Scalar _tmp132 = _tmp106 * _tmp131;
  const Scalar _tmp133 = -_tmp102 * _tmp79 + _tmp128 * _tmp132;
  const Scalar _tmp134 = Scalar(1.0) * _tmp98;
  const Scalar _tmp135 = _tmp128 * _tmp98;
  const Scalar _tmp136 = _tmp39 * fh1;
  const Scalar _tmp137 = _tmp136 * _tmp84 + Scalar(3.29616) * _tmp14 + _tmp20 * fv1;
  const Scalar _tmp138 = _tmp102 * _tmp104;
  const Scalar _tmp139 = _tmp128 * _tmp130;
  const Scalar _tmp140 = -_tmp119 + _tmp121 * _tmp139 - _tmp122 * _tmp138;
  const Scalar _tmp141 = _tmp115 * _tmp130;
  const Scalar _tmp142 = -_tmp116 * _tmp138 - _tmp128 * _tmp141 + _tmp97;
  const Scalar _tmp143 = _tmp129 * _tmp131 + Scalar(1.0);
  const Scalar _tmp144 = _tmp131 * _tmp99;
  const Scalar _tmp145 = -_tmp136 * _tmp85 - Scalar(3.29616) * _tmp27 - _tmp30 * fv1;
  const Scalar _tmp146 = _tmp107 * _tmp139 - _tmp108 * _tmp138 + _tmp94;
  const Scalar _tmp147 = std::asinh(
      _tmp126 * (Scalar(1.0) * _tmp113 * (_tmp107 * _tmp131 - _tmp134 * _tmp146) +
                 Scalar(1.0) * _tmp114 * (-_tmp115 * _tmp131 - _tmp134 * _tmp142 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp124 * (_tmp121 * _tmp131 - _tmp134 * _tmp140) +
                 Scalar(1.0) * _tmp137 * (_tmp131 * _tmp135 - _tmp131) +
                 Scalar(1.0) * _tmp145 * (-_tmp134 * _tmp143 + _tmp144) +
                 Scalar(1.0) * _tmp86 * (_tmp132 - _tmp133 * _tmp134)));
  const Scalar _tmp148 = Scalar(9.6622558468725703) * _tmp125;
  const Scalar _tmp149 = _tmp114 * _tmp117;
  const Scalar _tmp150 = _tmp79 * _tmp86;
  const Scalar _tmp151 =
      _tmp110 * _tmp113 * _tmp75 + _tmp123 * _tmp124 * _tmp75 - _tmp149 * _tmp76 - _tmp150 * _tmp76;
  const Scalar _tmp152 = Scalar(1.0) / (_tmp151);
  const Scalar _tmp153 = _tmp131 * _tmp137;
  const Scalar _tmp154 =
      std::asinh(_tmp152 * (_tmp113 * _tmp146 * _tmp98 + _tmp114 * _tmp142 * _tmp98 +
                            _tmp124 * _tmp140 * _tmp98 + _tmp133 * _tmp86 * _tmp98 -
                            _tmp135 * _tmp153 + _tmp143 * _tmp145 * _tmp98));
  const Scalar _tmp155 = Scalar(9.6622558468725703) * _tmp151;
  const Scalar _tmp156 =
      Scalar(69.216682149330126) *
          std::pow(Scalar(-Scalar(0.12019727201198747) * _tmp54 - 1), Scalar(2)) +
      Scalar(3.9500537080266964) *
          std::pow(Scalar(-Scalar(0.50315118477277876) * _tmp56 - 1), Scalar(2));
  const Scalar _tmp157 =
      _tmp104 * _tmp108 * _tmp113 + _tmp104 * _tmp122 * _tmp124 + _tmp149 + _tmp150;
  const Scalar _tmp158 = Scalar(1.0) / (_tmp157);
  const Scalar _tmp159 = std::asinh(_tmp158 * (-_tmp107 * _tmp113 * _tmp130 + _tmp114 * _tmp141 -
                                               _tmp121 * _tmp124 * _tmp130 - _tmp132 * _tmp86 -
                                               _tmp144 * _tmp145 + _tmp153));
  ...
  _res(0, 0) =
      ...
      Scalar(8.3701287145205097) *
          std::sqrt(Scalar(Scalar(0.014273672465547484) * _tmp32 +
                           std::pow(Scalar(-Scalar(0.11947247576553975) * _tmp39 -
  ...
  _res(3, 0) =
      ...
      Scalar(8.4690207536791995) *
          std::sqrt(Scalar(Scalar(0.013942273753185566) * _tmp160 +
                           std::pow(Scalar(-Scalar(0.11807740576920533) * _tmp101 -
