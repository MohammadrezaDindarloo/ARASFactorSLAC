...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl23(
  ...
  const Scalar _tmp38 = _tmp20 + Scalar(1.7965602546229);
  ...
  const Scalar _tmp43 = Scalar(3.29616) * _tmp13 + _tmp19 * fv1 + _tmp41 * _tmp42;
  ...
  const Scalar _tmp60 = _tmp53 + _tmp7;
  ...
  const Scalar _tmp65 = -Scalar(3.29616) * _tmp26 - _tmp29 * fv1 - _tmp42 * _tmp64;
  const Scalar _tmp66 = _tmp59 * _tmp62 + Scalar(1.0);
  ...
  const Scalar _tmp74 = _tmp60 + position_vector(0, 0);
  ...
  const Scalar _tmp79 = _tmp34 + _tmp35;
  ...
  const Scalar _tmp83 = _tmp55 + position_vector(0, 0);
  ...
  const Scalar _tmp88 = _tmp70 + _tmp79;
  const Scalar _tmp89 = _tmp51 + position_vector(1, 0);
  const Scalar _tmp90 = _tmp89 + Scalar(8.3885017487099702);
  const Scalar _tmp91 = _tmp54 + position_vector(0, 0);
  const Scalar _tmp92 = _tmp91 + Scalar(-2.5193355532036801);
  ...
  const Scalar _tmp96 = -_tmp87 * _tmp95 + _tmp88 * _tmp94;
  const Scalar _tmp97 = Scalar(1.0) / (_tmp86 * _tmp95 - _tmp94);
  const Scalar _tmp98 = -_tmp77 + _tmp78 * _tmp86;
  const Scalar _tmp99 = _tmp97 * _tmp98;
  const Scalar _tmp100 = _tmp71 * _tmp77 - _tmp78 * _tmp87 - _tmp96 * _tmp99;
  const Scalar _tmp101 = _tmp80 * _tmp95 - _tmp88 * _tmp95;
  const Scalar _tmp102 = -_tmp100 * _tmp58 - _tmp101 * _tmp99 - _tmp71 * _tmp78 + _tmp78 * _tmp80;
  const Scalar _tmp103 = Scalar(1.0) / (_tmp102);
  const Scalar _tmp104 = _tmp46 * _tmp58 + _tmp56;
  const Scalar _tmp105 = 0;
  const Scalar _tmp106 = _tmp104 * _tmp61;
  const Scalar _tmp107 = -_tmp100 * _tmp105 - _tmp106 * _tmp50 + _tmp47;
  ...
  const Scalar _tmp111 = _tmp110 * (-_tmp109 * _tmp45 * _tmp84 + _tmp109 * _tmp55 * _tmp82);
  const Scalar _tmp112 = _tmp111 * _tmp95 + _tmp51 * _tmp95 - _tmp54 * _tmp94;
  const Scalar _tmp113 = _tmp111 * _tmp78 - _tmp112 * _tmp99 + _tmp49 * _tmp78 - _tmp60 * _tmp77;
  const Scalar _tmp114 = Scalar(1.0) / (_tmp113);
  const Scalar _tmp115 = _tmp102 * _tmp114;
  const Scalar _tmp116 = _tmp115 * _tmp62;
  const Scalar _tmp117 = Scalar(1.0) * _tmp114;
  const Scalar _tmp118 = -_tmp100 * _tmp117 + _tmp116 * _tmp50;
  const Scalar _tmp119 = fh1 * (_tmp19 * _tmp64 - _tmp29 * _tmp41);
  const Scalar _tmp120 = Scalar(1.0) * _tmp97;
  const Scalar _tmp121 = -_tmp101 * _tmp120 + _tmp57 * _tmp67 * _tmp96 * _tmp97;
  const Scalar _tmp122 = _tmp103 * _tmp113;
  const Scalar _tmp123 = _tmp115 * (-_tmp112 * _tmp120 - _tmp121 * _tmp122);
  const Scalar _tmp124 = _tmp50 * _tmp61;
  const Scalar _tmp125 = _tmp103 * (_tmp121 + _tmp123);
  const Scalar _tmp126 = -_tmp100 * _tmp125 - _tmp120 * _tmp96 + _tmp123 * _tmp124;
  const Scalar _tmp127 = _tmp64 * fh1;
  const Scalar _tmp128 = _tmp86 * _tmp97;
  const Scalar _tmp129 = _tmp128 * _tmp96 + _tmp87;
  const Scalar _tmp130 = _tmp101 * _tmp128 - _tmp129 * _tmp58 - _tmp80;
  const Scalar _tmp131 = _tmp115 * (-_tmp111 + _tmp112 * _tmp128 - _tmp122 * _tmp130);
  const Scalar _tmp132 = _tmp103 * (_tmp130 + _tmp131);
  const Scalar _tmp133 = -_tmp100 * _tmp132 + _tmp124 * _tmp131 + _tmp129;
  const Scalar _tmp134 = _tmp41 * fh1;
  const Scalar _tmp135 = -_tmp132 * _tmp98 - _tmp86;
  const Scalar _tmp136 = _tmp95 * _tmp97;
  const Scalar _tmp137 = -_tmp125 * _tmp98 + Scalar(1.0);
  const Scalar _tmp138 = _tmp114 * _tmp120 * _tmp98;
  const Scalar _tmp139 = -_tmp110 * _tmp119 * (_tmp117 * _tmp78 - _tmp138 * _tmp95) -
                         _tmp110 * _tmp127 * (_tmp125 * _tmp78 + _tmp136 * _tmp137) -
                         _tmp110 * _tmp134 * (_tmp132 * _tmp78 + _tmp135 * _tmp136 + Scalar(1.0)) -
                         _tmp110 * _tmp69 * (_tmp105 * _tmp78 - _tmp105 * _tmp95 * _tmp99);
  const Scalar _tmp140 = Scalar(1.0) / (_tmp139);
  const Scalar _tmp141 = std::asinh(
      _tmp140 * (Scalar(1.0) * _tmp119 * (_tmp116 - _tmp118 * _tmp67) +
                 Scalar(1.0) * _tmp127 * (_tmp123 * _tmp62 - _tmp126 * _tmp67) +
                 Scalar(1.0) * _tmp134 * (_tmp131 * _tmp62 - _tmp133 * _tmp67) +
                 Scalar(1.0) * _tmp43 * (_tmp62 * _tmp63 - _tmp62) +
                 Scalar(1.0) * _tmp65 * (-_tmp66 * _tmp67 + _tmp68) +
                 Scalar(1.0) * _tmp69 * (-_tmp104 * _tmp62 - _tmp107 * _tmp67 + Scalar(1.0))));
  const Scalar _tmp142 = Scalar(22.795248597701466) *
                             std::pow(Scalar(1 - Scalar(0.2094487793051498) * _tmp81), Scalar(2)) +
                         Scalar(7.3829146708599787) *
                             std::pow(Scalar(1 - Scalar(0.36803241838814449) * _tmp83), Scalar(2));
  const Scalar _tmp143 = Scalar(9.6622558468725703) * _tmp139;
  const Scalar _tmp144 = _tmp105 * _tmp69;
  const Scalar _tmp145 = -_tmp119 * _tmp138 + _tmp127 * _tmp137 * _tmp97 +
                         _tmp134 * _tmp135 * _tmp97 - _tmp144 * _tmp99;
  const Scalar _tmp146 = Scalar(1.0) / (_tmp145);
  const Scalar _tmp147 = _tmp43 * _tmp62;
  const Scalar _tmp148 =
      std::asinh(_tmp146 * (_tmp107 * _tmp52 * _tmp69 + _tmp118 * _tmp119 * _tmp52 +
                            _tmp126 * _tmp127 * _tmp52 + _tmp133 * _tmp134 * _tmp52 -
                            _tmp147 * _tmp63 + _tmp52 * _tmp65 * _tmp66));
  const Scalar _tmp149 = Scalar(6.347051629636093) *
                             std::pow(Scalar(1 - Scalar(0.39693005512043167) * _tmp91), Scalar(2)) +
                         Scalar(70.366961588110229) *
                             std::pow(Scalar(-Scalar(0.11921079949155229) * _tmp89 - 1), Scalar(2));
  const Scalar _tmp150 = Scalar(9.6622558468725703) * _tmp145;
  const Scalar _tmp151 = _tmp117 * _tmp119 + _tmp125 * _tmp127 + _tmp132 * _tmp134 + _tmp144;
  const Scalar _tmp152 = Scalar(1.0) / (_tmp151);
  const Scalar _tmp153 =
      std::asinh(_tmp152 * (_tmp106 * _tmp69 - _tmp116 * _tmp119 - _tmp123 * _tmp127 * _tmp61 -
                            _tmp131 * _tmp134 * _tmp61 + _tmp147 - _tmp65 * _tmp68));
  const Scalar _tmp154 = Scalar(9.6622558468725703) * _tmp151;
  const Scalar _tmp155 =
      Scalar(69.216682149330126) *
          std::pow(Scalar(-Scalar(0.12019727201198747) * _tmp72 - 1), Scalar(2)) +
  ...
  _res(1, 0) =
      _tmp143 *
          (-std::sinh(Scalar(1.0) * _tmp141) -
           std::sinh(Scalar(0.1034955) * _tmp140 * (-_tmp141 * _tmp143 - std::sqrt(_tmp142)))) -
      Scalar(8.3641088633305802) *
          std::sqrt(Scalar(Scalar(0.014294226073078949) * _tmp142 +
                           std::pow(Scalar(-Scalar(0.11955846299229073) * _tmp80 -
                                           Scalar(0.11955846299229073) * position_vector(2, 0) + 1),
                                    Scalar(2))));
  _res(2, 0) =
      _tmp150 *
          (-std::sinh(Scalar(1.0) * _tmp148) -
           std::sinh(Scalar(0.1034955) * _tmp146 * (-_tmp148 * _tmp150 - std::sqrt(_tmp149)))) -
  ...
  _res(3, 0) =
      ...
      Scalar(8.4718465805053693) *
          std::sqrt(Scalar(Scalar(0.013932974274013004) * _tmp155 +
                           std::pow(Scalar(-Scalar(0.11803802045956635) * _tmp71 -
