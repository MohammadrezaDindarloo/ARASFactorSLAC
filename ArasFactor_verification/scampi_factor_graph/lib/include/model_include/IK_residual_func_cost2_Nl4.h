...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl4(
  ...
  const Scalar _tmp58 = _tmp21 + _tmp44;
  ...
  const Scalar _tmp66 = _tmp20 + _tmp28;
  ...
  const Scalar _tmp74 = _tmp43 * _tmp48;
  const Scalar _tmp75 = _tmp49 * _tmp70 - _tmp74;
  const Scalar _tmp76 = Scalar(1.0) / (-_tmp62 + _tmp70 * _tmp72);
  const Scalar _tmp77 = _tmp75 * _tmp76;
  const Scalar _tmp78 = -_tmp51 * _tmp70 + _tmp53 * _tmp74 - _tmp73 * _tmp77;
  ...
  const Scalar _tmp83 = _tmp82 * (-_tmp58 + _tmp79);
  const Scalar _tmp84 = _tmp76 * (_tmp50 * _tmp72 - _tmp54 * _tmp72);
  const Scalar _tmp85 = -_tmp49 * _tmp53 + _tmp51 - _tmp75 * _tmp84 - _tmp78 * _tmp83;
  const Scalar _tmp86 = Scalar(1.0) / (_tmp85);
  const Scalar _tmp87 =
      std::sqrt(Scalar(std::pow(_tmp65, Scalar(2)) + std::pow(_tmp68, Scalar(2))));
  const Scalar _tmp88 = Scalar(1.0) / (_tmp87);
  const Scalar _tmp89 = _tmp69 * _tmp87;
  const Scalar _tmp90 = _tmp89 * (-_tmp63 * _tmp68 * _tmp88 + _tmp65 * _tmp66 * _tmp88);
  const Scalar _tmp91 = _tmp55 * _tmp72 - _tmp58 * _tmp62 + _tmp72 * _tmp90;
  const Scalar _tmp92 = _tmp70 * _tmp76;
  const Scalar _tmp93 = _tmp71 + _tmp73 * _tmp92;
  const Scalar _tmp94 = -_tmp50 + _tmp70 * _tmp84 - _tmp83 * _tmp93;
  const Scalar _tmp95 = _tmp41 * _tmp49 - _tmp45 * _tmp74 + _tmp49 * _tmp90 - _tmp77 * _tmp91;
  ...
  const Scalar _tmp101 = -_tmp100 * _tmp75 - _tmp70;
  ...
  const Scalar _tmp111 = _tmp72 * _tmp77;
  ...
  const Scalar _tmp115 = Scalar(1.0) * _tmp76;
  const Scalar _tmp116 = _tmp115 * _tmp73;
  const Scalar _tmp117 = _tmp116 * _tmp83 - Scalar(1.0) * _tmp84;
  const Scalar _tmp118 = _tmp98 * (-_tmp115 * _tmp91 - _tmp117 * _tmp96);
  ...
  const Scalar _tmp122 = -_tmp107 * _tmp89 * (_tmp100 * _tmp49 + _tmp101 * _tmp102 + Scalar(1.0)) -
                         _tmp108 * _tmp89 * (-_tmp110 * _tmp111 + _tmp110 * _tmp49) -
                         _tmp114 * _tmp89 * (-_tmp111 * _tmp112 + _tmp112 * _tmp49) -
                         _tmp121 * _tmp89 * (_tmp102 * _tmp120 + _tmp119 * _tmp49);
  const Scalar _tmp123 = Scalar(1.0) / (_tmp122);
  const Scalar _tmp124 = _tmp39 * fh1;
  const Scalar _tmp125 = -_tmp113 * _tmp124 - Scalar(3.29616) * _tmp15 - _tmp18 * fv1;
  const Scalar _tmp126 = _tmp41 + _tmp81;
  const Scalar _tmp127 = _tmp126 * _tmp83;
  const Scalar _tmp128 = Scalar(1.0) / (-_tmp127 - _tmp45 + _tmp79);
  ...
  const Scalar _tmp134 = -_tmp116 + _tmp118 * _tmp133 - _tmp119 * _tmp78;
  const Scalar _tmp135 = _tmp106 * _tmp124 + Scalar(3.29616) * _tmp24 + _tmp29 * fv1;
  const Scalar _tmp136 = _tmp126 * _tmp82;
  const Scalar _tmp137 = _tmp129 * _tmp98;
  const Scalar _tmp138 = -_tmp112 * _tmp78 + _tmp126 * _tmp137;
  const Scalar _tmp139 = -_tmp100 * _tmp78 + _tmp133 * _tmp99 + _tmp93;
  const Scalar _tmp140 = _tmp109 * _tmp128;
  const Scalar _tmp141 = -_tmp110 * _tmp78 - _tmp126 * _tmp140 + _tmp81;
  const Scalar _tmp142 = std::asinh(
      _tmp123 * (Scalar(1.0) * _tmp107 * (_tmp129 * _tmp99 - _tmp131 * _tmp139) +
                 Scalar(1.0) * _tmp108 * (-_tmp109 * _tmp129 - _tmp131 * _tmp141 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp114 * (-_tmp131 * _tmp138 + _tmp137) +
                 Scalar(1.0) * _tmp121 * (_tmp118 * _tmp129 - _tmp131 * _tmp134) +
                 Scalar(1.0) * _tmp125 * (-_tmp130 * _tmp131 + _tmp132) +
                 Scalar(1.0) * _tmp135 * (_tmp129 * _tmp136 - _tmp129)));
  const Scalar _tmp143 = Scalar(23.356819799277336) *
  ...
  const Scalar _tmp148 =
      _tmp101 * _tmp107 * _tmp76 + _tmp120 * _tmp121 * _tmp76 - _tmp146 * _tmp77 - _tmp147 * _tmp77;
  const Scalar _tmp149 = Scalar(1.0) / (_tmp148);
  const Scalar _tmp150 =
      std::asinh(_tmp149 * (_tmp107 * _tmp139 * _tmp82 + _tmp108 * _tmp141 * _tmp82 +
                            _tmp114 * _tmp138 * _tmp82 + _tmp121 * _tmp134 * _tmp82 +
                            _tmp125 * _tmp130 * _tmp82 - _tmp136 * _tmp145));
  ...
  const Scalar _tmp153 = _tmp100 * _tmp107 + _tmp119 * _tmp121 + _tmp146 + _tmp147;
  const Scalar _tmp154 = Scalar(1.0) / (_tmp153);
  const Scalar _tmp155 =
      std::asinh(_tmp154 * (-_tmp107 * _tmp128 * _tmp99 + _tmp108 * _tmp140 - _tmp114 * _tmp137 -
                            _tmp118 * _tmp121 * _tmp128 - _tmp125 * _tmp132 + _tmp145));
  const Scalar _tmp156 = Scalar(22.795248597701466) *
  ...
  _res(1, 0) =
      _tmp144 *
          (-std::sinh(Scalar(1.0) * _tmp142) -
           std::sinh(Scalar(0.1034955) * _tmp123 * (-_tmp142 * _tmp144 - std::sqrt(_tmp143)))) -
      Scalar(8.3701287145205097) *
          std::sqrt(Scalar(Scalar(0.014273672465547484) * _tmp143 +
                           std::pow(Scalar(-Scalar(0.11947247576553975) * _tmp50 -
                                           Scalar(0.11947247576553975) * position_vector(2, 0) + 1),
                                    Scalar(2))));
  _res(2, 0) =
      _tmp152 *
          (-std::sinh(Scalar(1.0) * _tmp150) -
           std::sinh(Scalar(0.1034955) * _tmp149 * (-_tmp150 * _tmp152 - std::sqrt(_tmp151)))) -
      Scalar(8.4690207536791995) *
          std::sqrt(Scalar(Scalar(0.013942273753185566) * _tmp151 +
                           std::pow(Scalar(-Scalar(0.11807740576920533) * _tmp54 -
  ...
  _res(3, 0) =
      ...
      Scalar(8.3641088633305802) *
          std::sqrt(Scalar(Scalar(0.014294226073078949) * _tmp156 +
                           std::pow(Scalar(-Scalar(0.11955846299229073) * _tmp53 -
