...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl6(
  ...
  const Scalar _tmp33 = std::pow(Scalar(-_tmp25 + p_b(0, 0)), Scalar(2)) +
  ...
  const Scalar _tmp45 = std::pow(Scalar(-_tmp41 + p_a(0, 0)), Scalar(2)) +
  ...
  const Scalar _tmp67 = _tmp41 - p_a(0, 0);
  const Scalar _tmp68 = _tmp44 - p_a(1, 0);
  const Scalar _tmp69 =
      std::sqrt(Scalar(std::pow(_tmp67, Scalar(2)) + std::pow(_tmp68, Scalar(2))));
  const Scalar _tmp70 = Scalar(1.0) / (_tmp69);
  const Scalar _tmp71 = Scalar(1.0) / (_tmp67);
  const Scalar _tmp72 = _tmp69 * _tmp71;
  const Scalar _tmp73 = _tmp72 * (_tmp40 * _tmp68 * _tmp70 - _tmp43 * _tmp67 * _tmp70);
  const Scalar _tmp74 = _tmp62 * _tmp65;
  const Scalar _tmp75 = _tmp68 * _tmp71;
  const Scalar _tmp76 = _tmp66 * _tmp75 - _tmp74;
  const Scalar _tmp77 = _tmp56 + p_init0;
  const Scalar _tmp78 = _tmp77 - p_c(0, 0);
  const Scalar _tmp79 = _tmp54 + p_init1;
  ...
  const Scalar _tmp85 = _tmp84 * (_tmp54 * _tmp82 - _tmp56 * _tmp83 + _tmp73 * _tmp82);
  const Scalar _tmp86 = -_tmp47 * _tmp74 + _tmp52 * _tmp66 + _tmp66 * _tmp73 - _tmp76 * _tmp85;
  const Scalar _tmp87 = Scalar(1.0) / (_tmp86);
  const Scalar _tmp88 = _tmp10 + _tmp13;
  const Scalar _tmp89 = _tmp37 + _tmp88;
  const Scalar _tmp90 = _tmp38 * _tmp75;
  const Scalar _tmp91 = _tmp38 * _tmp82;
  const Scalar _tmp92 = _tmp7 + _tmp88;
  const Scalar _tmp93 = -_tmp75 * _tmp91 + _tmp83 * _tmp92;
  const Scalar _tmp94 = _tmp76 * _tmp84;
  const Scalar _tmp95 = -_tmp66 * _tmp90 + _tmp74 * _tmp89 - _tmp93 * _tmp94;
  const Scalar _tmp96 = -_tmp82 * _tmp92 + _tmp91;
  const Scalar _tmp97 = _tmp38 * _tmp66 - _tmp57 * _tmp95 - _tmp66 * _tmp89 - _tmp94 * _tmp96;
  const Scalar _tmp98 = _tmp87 * _tmp97;
  const Scalar _tmp99 = _tmp60 * _tmp98;
  const Scalar _tmp100 = Scalar(1.0) * _tmp87;
  const Scalar _tmp101 = _tmp53 * _tmp60;
  ...
  const Scalar _tmp105 = _tmp25 - p_b(0, 0);
  ...
  const Scalar _tmp109 = fh1 * (-_tmp107 * _tmp31 + _tmp108 * _tmp24);
  const Scalar _tmp110 = Scalar(1.0) * _tmp84;
  const Scalar _tmp111 = _tmp110 * _tmp93;
  const Scalar _tmp112 = -_tmp110 * _tmp96 + _tmp111 * _tmp57;
  const Scalar _tmp113 = Scalar(1.0) / (_tmp97);
  const Scalar _tmp114 = _tmp113 * _tmp86;
  const Scalar _tmp115 = _tmp98 * (-_tmp112 * _tmp114 - Scalar(1.0) * _tmp85);
  ...
  const Scalar _tmp121 = _tmp15 * fh1;
  const Scalar _tmp122 = _tmp107 * _tmp121 + Scalar(3.29616) * _tmp18 + _tmp24 * fv1;
  const Scalar _tmp123 = _tmp75 * _tmp84;
  const Scalar _tmp124 = _tmp123 * _tmp93 + _tmp90;
  const Scalar _tmp125 = _tmp123 * _tmp96 - _tmp124 * _tmp57 - _tmp38;
  const Scalar _tmp126 = _tmp98 * (-_tmp114 * _tmp125 - _tmp73 + _tmp75 * _tmp85);
  const Scalar _tmp127 = _tmp125 + _tmp126;
  const Scalar _tmp128 = _tmp116 * _tmp126 - _tmp118 * _tmp127 + _tmp124;
  const Scalar _tmp129 = _tmp107 * fh1;
  const Scalar _tmp130 = _tmp57 * _tmp60;
  const Scalar _tmp131 = _tmp58 * _tmp60 + Scalar(1.0);
  const Scalar _tmp132 = -_tmp108 * _tmp121 - Scalar(3.29616) * _tmp27 - _tmp31 * fv1;
  const Scalar _tmp133 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp134 = _tmp48 + _tmp49 * _tmp57;
  const Scalar _tmp135 = _tmp134 * _tmp59;
  const Scalar _tmp136 = 0;
  const Scalar _tmp137 = _tmp55 * (-_tmp118 * _tmp136 - _tmp135 * _tmp53 + _tmp50);
  const Scalar _tmp138 = _tmp113 * _tmp66;
  const Scalar _tmp139 = _tmp113 * _tmp76;
  const Scalar _tmp140 = -_tmp127 * _tmp139 - _tmp75;
  const Scalar _tmp141 = _tmp82 * _tmp84;
  const Scalar _tmp142 = _tmp82 * _tmp94;
  const Scalar _tmp143 = -_tmp117 * _tmp139 + Scalar(1.0);
  const Scalar _tmp144 = _tmp113 * _tmp136;
  const Scalar _tmp145 = -_tmp109 * _tmp72 * (-_tmp100 * _tmp142 + _tmp100 * _tmp66) -
                         _tmp120 * _tmp72 * (_tmp117 * _tmp138 + _tmp141 * _tmp143) -
                         _tmp129 * _tmp72 * (_tmp127 * _tmp138 + _tmp140 * _tmp141 + Scalar(1.0)) -
                         _tmp133 * _tmp72 * (-_tmp142 * _tmp144 + _tmp144 * _tmp66);
  const Scalar _tmp146 = Scalar(1.0) / (_tmp145);
  const Scalar _tmp147 =
      std::asinh(_tmp146 * (Scalar(1.0) * _tmp109 * (-_tmp102 * _tmp103 + _tmp99) +
                            Scalar(1.0) * _tmp120 * (-_tmp103 * _tmp119 + _tmp115 * _tmp60) +
                            Scalar(1.0) * _tmp122 * (_tmp101 * _tmp55 - _tmp60) +
                            Scalar(1.0) * _tmp129 * (-_tmp103 * _tmp128 + _tmp126 * _tmp60) +
                            Scalar(1.0) * _tmp132 * (-_tmp103 * _tmp131 + _tmp130) +
                            Scalar(1.0) * _tmp133 *
                                (-_tmp134 * _tmp60 - Scalar(1.0) * _tmp137 + Scalar(1.0))));
  const Scalar _tmp148 = Scalar(9.6622558468725703) * _tmp145;
  const Scalar _tmp149 = std::pow(Scalar(-_tmp77 + p_c(0, 0)), Scalar(2)) +
                         std::pow(Scalar(-_tmp79 + p_c(1, 0)), Scalar(2));
  const Scalar _tmp150 = _tmp100 * _tmp109;
  const Scalar _tmp151 = _tmp133 * _tmp144;
  const Scalar _tmp152 =
      _tmp120 * _tmp143 * _tmp84 + _tmp129 * _tmp140 * _tmp84 - _tmp150 * _tmp94 - _tmp151 * _tmp94;
  const Scalar _tmp153 = Scalar(1.0) / (_tmp152);
  const Scalar _tmp154 = _tmp122 * _tmp60;
  const Scalar _tmp155 =
      std::asinh(_tmp153 * (_tmp102 * _tmp109 * _tmp55 + _tmp119 * _tmp120 * _tmp55 +
                            _tmp128 * _tmp129 * _tmp55 + _tmp131 * _tmp132 * _tmp55 +
                            _tmp133 * _tmp137 - _tmp154 * _tmp53 * _tmp55));
  const Scalar _tmp156 = Scalar(9.6622558468725703) * _tmp152;
  const Scalar _tmp157 = std::pow(Scalar(-_tmp61 + p_d(1, 0)), Scalar(2)) +
                         std::pow(Scalar(-_tmp63 + p_d(0, 0)), Scalar(2));
  const Scalar _tmp158 =
      _tmp113 * _tmp117 * _tmp120 + _tmp113 * _tmp127 * _tmp129 + _tmp150 + _tmp151;
  const Scalar _tmp159 = Scalar(1.0) / (_tmp158);
  const Scalar _tmp160 = std::asinh(_tmp159 * (-_tmp109 * _tmp99 - _tmp115 * _tmp120 * _tmp59 -
                                               _tmp126 * _tmp129 * _tmp59 - _tmp130 * _tmp132 +
  ...
  _res(0, 0) =
      ...
      std::sqrt(Scalar(_tmp33 + std::pow(Scalar(-_tmp15 + p_b(2, 0) - p_init2), Scalar(2))));
  _res(1, 0) =
      _tmp148 *
          (-std::sinh(Scalar(1.0) * _tmp147) -
           std::sinh(Scalar(0.1034955) * _tmp146 * (-_tmp147 * _tmp148 - std::sqrt(_tmp45)))) -
      std::sqrt(Scalar(_tmp45 + std::pow(Scalar(-_tmp38 + p_a(2, 0) - p_init2), Scalar(2))));
  _res(2, 0) =
      _tmp156 *
          (-std::sinh(Scalar(1.0) * _tmp155) -
           std::sinh(Scalar(0.1034955) * _tmp153 * (-std::sqrt(_tmp149) - _tmp155 * _tmp156))) -
      std::sqrt(Scalar(_tmp149 + std::pow(Scalar(-_tmp92 + p_c(2, 0) - p_init2), Scalar(2))));
  _res(3, 0) =
      _tmp161 *
          (-std::sinh(Scalar(1.0) * _tmp160) -
           std::sinh(Scalar(0.1034955) * _tmp159 * (-std::sqrt(_tmp157) - _tmp160 * _tmp161))) -
      std::sqrt(Scalar(_tmp157 + std::pow(Scalar(-_tmp89 + p_d(2, 0) - p_init2), Scalar(2))));
