...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl8(
  ...
  const Scalar _tmp74 = _tmp63 * _tmp73 - _tmp72;
  const Scalar _tmp75 = _tmp64 * _tmp74;
  const Scalar _tmp76 = _tmp61 * _tmp73 - _tmp62 * _tmp75 + _tmp65 * _tmp73 - _tmp68 * _tmp72;
  const Scalar _tmp77 = Scalar(1.0) / (_tmp76);
  const Scalar _tmp78 = Scalar(1.0) * _tmp64;
  const Scalar _tmp79 = _tmp74 * _tmp77 * _tmp78;
  const Scalar _tmp80 = Scalar(1.0) * _tmp77;
  const Scalar _tmp81 = _tmp30 + Scalar(-2.5193355532036801);
  const Scalar _tmp82 = _tmp19 + Scalar(8.3885017487099702);
  ...
  const Scalar _tmp86 = fh1 * (-_tmp18 * _tmp84 + _tmp29 * _tmp85);
  ...
  const Scalar _tmp91 = -_tmp49 * _tmp89 + _tmp49 * _tmp90;
  const Scalar _tmp92 = _tmp63 * _tmp90;
  const Scalar _tmp93 = -_tmp49 * _tmp92 + _tmp50 * _tmp89;
  const Scalar _tmp94 = _tmp87 * _tmp93 + _tmp92;
  const Scalar _tmp95 = Scalar(1.0) * _tmp51;
  const Scalar _tmp96 = -_tmp95;
  const Scalar _tmp97 = Scalar(1.0) / (_tmp45 + _tmp96);
  const Scalar _tmp98 = Scalar(1.0) * _tmp54;
  const Scalar _tmp99 = _tmp97 * (-_tmp41 + _tmp98);
  const Scalar _tmp100 = _tmp87 * _tmp91 - _tmp90 - _tmp94 * _tmp99;
  const Scalar _tmp101 = _tmp73 * _tmp90;
  const Scalar _tmp102 = _tmp34 + _tmp88;
  const Scalar _tmp103 = -_tmp101 * _tmp63 + _tmp102 * _tmp72 - _tmp75 * _tmp93;
  const Scalar _tmp104 = _tmp101 - _tmp102 * _tmp73 - _tmp103 * _tmp99 - _tmp75 * _tmp91;
  const Scalar _tmp105 = Scalar(1.0) / (_tmp104);
  const Scalar _tmp106 = _tmp105 * _tmp76;
  const Scalar _tmp107 = _tmp104 * _tmp77;
  const Scalar _tmp108 = _tmp107 * (-_tmp100 * _tmp106 - _tmp61 + _tmp62 * _tmp87);
  const Scalar _tmp109 = _tmp100 + _tmp108;
  const Scalar _tmp110 = _tmp105 * _tmp73;
  const Scalar _tmp111 = _tmp105 * _tmp74;
  const Scalar _tmp112 = -_tmp109 * _tmp111 - _tmp63;
  const Scalar _tmp113 = _tmp49 * _tmp64;
  const Scalar _tmp114 = _tmp84 * fh1;
  const Scalar _tmp115 = _tmp78 * _tmp93;
  const Scalar _tmp116 = _tmp115 * _tmp99 - _tmp78 * _tmp91;
  const Scalar _tmp117 = _tmp107 * (-_tmp106 * _tmp116 - _tmp62 * _tmp78);
  const Scalar _tmp118 = _tmp116 + _tmp117;
  const Scalar _tmp119 = -_tmp111 * _tmp118 + Scalar(1.0);
  const Scalar _tmp120 = _tmp85 * fh1;
  const Scalar _tmp121 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp122 = _tmp95 * _tmp99 + _tmp98;
  const Scalar _tmp123 = 0;
  const Scalar _tmp124 = _tmp105 * _tmp123;
  const Scalar _tmp125 = -_tmp114 * _tmp60 * (_tmp109 * _tmp110 + _tmp112 * _tmp113 + Scalar(1.0)) -
                         _tmp120 * _tmp60 * (_tmp110 * _tmp118 + _tmp113 * _tmp119) -
                         _tmp121 * _tmp60 * (-_tmp124 * _tmp49 * _tmp75 + _tmp124 * _tmp73) -
                         _tmp60 * _tmp86 * (-_tmp49 * _tmp79 + _tmp73 * _tmp80);
  ...
  const Scalar _tmp128 = _tmp65 + _tmp96;
  const Scalar _tmp129 = _tmp128 * _tmp99;
  const Scalar _tmp130 = Scalar(1.0) / (-_tmp129 - _tmp68 + _tmp98);
  const Scalar _tmp131 = Scalar(1.0) * _tmp130;
  const Scalar _tmp132 = _tmp107 * _tmp131;
  const Scalar _tmp133 = -_tmp103 * _tmp80 + _tmp128 * _tmp132;
  const Scalar _tmp134 = Scalar(1.0) * _tmp97;
  const Scalar _tmp135 = _tmp103 * _tmp105;
  const Scalar _tmp136 = _tmp122 * _tmp130;
  const Scalar _tmp137 = -_tmp123 * _tmp135 - _tmp128 * _tmp136 + _tmp96;
  const Scalar _tmp138 = _tmp128 * _tmp130;
  const Scalar _tmp139 = _tmp108 * _tmp138 - _tmp109 * _tmp135 + _tmp94;
  const Scalar _tmp140 = -_tmp115 + _tmp117 * _tmp138 - _tmp118 * _tmp135;
  const Scalar _tmp141 = _tmp128 * _tmp97;
  const Scalar _tmp142 = _tmp39 * fh1;
  const Scalar _tmp143 = _tmp142 * _tmp84 + Scalar(3.29616) * _tmp24 + _tmp29 * fv1;
  const Scalar _tmp144 = _tmp129 * _tmp131 + Scalar(1.0);
  const Scalar _tmp145 = _tmp131 * _tmp99;
  const Scalar _tmp146 = -_tmp142 * _tmp85 - Scalar(3.29616) * _tmp15 - _tmp18 * fv1;
  const Scalar _tmp147 = std::asinh(
      _tmp126 * (Scalar(1.0) * _tmp114 * (_tmp108 * _tmp131 - _tmp134 * _tmp139) +
                 Scalar(1.0) * _tmp120 * (_tmp117 * _tmp131 - _tmp134 * _tmp140) +
                 Scalar(1.0) * _tmp121 * (-_tmp122 * _tmp131 - _tmp134 * _tmp137 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp143 * (_tmp131 * _tmp141 - _tmp131) +
                 Scalar(1.0) * _tmp146 * (-_tmp134 * _tmp144 + _tmp145) +
                 Scalar(1.0) * _tmp86 * (_tmp132 - _tmp133 * _tmp134)));
  const Scalar _tmp148 = Scalar(9.6622558468725703) * _tmp125;
  const Scalar _tmp149 = _tmp64 * fh1;
  const Scalar _tmp150 = _tmp121 * _tmp124;
  const Scalar _tmp151 =
      _tmp112 * _tmp149 * _tmp84 + _tmp119 * _tmp149 * _tmp85 - _tmp150 * _tmp75 - _tmp79 * _tmp86;
  const Scalar _tmp152 = Scalar(1.0) / (_tmp151);
  const Scalar _tmp153 = _tmp131 * _tmp143;
  const Scalar _tmp154 =
      std::asinh(_tmp152 * (_tmp114 * _tmp139 * _tmp97 + _tmp120 * _tmp140 * _tmp97 +
                            _tmp121 * _tmp137 * _tmp97 + _tmp133 * _tmp86 * _tmp97 -
                            _tmp141 * _tmp153 + _tmp144 * _tmp146 * _tmp97));
  ...
  const Scalar _tmp156 =
      ...
      Scalar(69.216682149330126) *
          std::pow(Scalar(-Scalar(0.12019727201198747) * _tmp46 - 1), Scalar(2));
  ...
  const Scalar _tmp158 =
      _tmp105 * _tmp109 * _tmp114 + _tmp105 * _tmp118 * _tmp120 + _tmp150 + _tmp80 * _tmp86;
  const Scalar _tmp159 = Scalar(1.0) / (_tmp158);
  const Scalar _tmp160 =
      std::asinh(_tmp159 * (-_tmp108 * _tmp114 * _tmp130 - _tmp117 * _tmp120 * _tmp130 +
                            _tmp121 * _tmp136 - _tmp132 * _tmp86 - _tmp145 * _tmp146 + _tmp153));
  ...
  _res(0, 0) =
      ...
      Scalar(8.4690207536791995) *
          std::sqrt(Scalar(Scalar(0.013942273753185566) * _tmp31 +
                           std::pow(Scalar(-Scalar(0.11807740576920533) * _tmp39 -
