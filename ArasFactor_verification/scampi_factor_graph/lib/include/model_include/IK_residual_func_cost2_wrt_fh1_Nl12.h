...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2WrtFh1Nl12(
  ...
  const Scalar _tmp81 = -_tmp44 * _tmp66 + _tmp48 * _tmp52 + _tmp52 * _tmp65 - _tmp76 * _tmp80;
  ...
  const Scalar _tmp96 = _tmp74 * _tmp91 - _tmp74 * _tmp95;
  const Scalar _tmp97 = _tmp77 * _tmp91;
  const Scalar _tmp98 = -_tmp74 * _tmp97 + _tmp75 * _tmp95;
  const Scalar _tmp99 = _tmp66 * _tmp94 - _tmp77 * _tmp92 - _tmp80 * _tmp98;
  ...
  const Scalar _tmp105 = -_tmp104 * _tmp99 - _tmp52 * _tmp94 - _tmp80 * _tmp96 + _tmp92;
  const Scalar _tmp106 = Scalar(1.0) / (_tmp105);
  const Scalar _tmp107 = Scalar(1.0) * _tmp78;
  const Scalar _tmp108 = _tmp107 * _tmp98;
  const Scalar _tmp109 = _tmp104 * _tmp108 - _tmp107 * _tmp96;
  const Scalar _tmp110 = _tmp106 * _tmp81;
  const Scalar _tmp111 = _tmp105 * _tmp82;
  const Scalar _tmp112 = _tmp111 * (-_tmp107 * _tmp76 - _tmp109 * _tmp110);
  const Scalar _tmp113 = _tmp106 * (_tmp109 + _tmp112);
  const Scalar _tmp114 = _tmp78 * (-_tmp113 * _tmp79 + Scalar(1.0));
  const Scalar _tmp115 = _tmp40 * _tmp64 * (_tmp113 * _tmp52 + _tmp114 * _tmp74);
  const Scalar _tmp116 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp117 = _tmp100 * _tmp104 + _tmp103;
  const Scalar _tmp118 = 0;
  const Scalar _tmp119 = _tmp77 * _tmp78;
  const Scalar _tmp120 = _tmp119 * _tmp98 + _tmp97;
  const Scalar _tmp121 = -_tmp104 * _tmp120 + _tmp119 * _tmp96 - _tmp91;
  const Scalar _tmp122 = _tmp111 * (-_tmp110 * _tmp121 + _tmp119 * _tmp76 - _tmp65);
  const Scalar _tmp123 = _tmp106 * (_tmp121 + _tmp122);
  const Scalar _tmp124 = _tmp78 * (-_tmp123 * _tmp79 - _tmp77);
  const Scalar _tmp125 = _tmp41 * _tmp64 * (_tmp123 * _tmp52 + _tmp124 * _tmp74 + Scalar(1.0));
  const Scalar _tmp126 = -_tmp115 * fh1 - _tmp116 * _tmp64 * (_tmp118 * _tmp52 - _tmp118 * _tmp84) -
                         _tmp125 * fh1 - _tmp85 * fh1;
  const Scalar _tmp127 = Scalar(1.0) / (_tmp126);
  const Scalar _tmp128 = _tmp101 + _tmp48;
  const Scalar _tmp129 = _tmp104 * _tmp128;
  const Scalar _tmp130 = Scalar(1.0) / (_tmp103 - _tmp129 - _tmp44);
  const Scalar _tmp131 = Scalar(1.0) * _tmp130;
  const Scalar _tmp132 = _tmp111 * _tmp131;
  const Scalar _tmp133 = _tmp128 * _tmp132 - _tmp83 * _tmp99;
  const Scalar _tmp134 = Scalar(1.0) * _tmp102;
  const Scalar _tmp135 = Scalar(1.0) * _tmp42 * (_tmp132 - _tmp133 * _tmp134);
  const Scalar _tmp136 = _tmp117 * _tmp130;
  const Scalar _tmp137 = _tmp102 * (_tmp101 - _tmp118 * _tmp99 - _tmp128 * _tmp136);
  const Scalar _tmp138 = _tmp128 * _tmp130;
  const Scalar _tmp139 = _tmp120 + _tmp122 * _tmp138 - _tmp123 * _tmp99;
  const Scalar _tmp140 = Scalar(1.0) * _tmp41 * (_tmp122 * _tmp131 - _tmp134 * _tmp139);
  const Scalar _tmp141 = -_tmp108 + _tmp112 * _tmp138 - _tmp113 * _tmp99;
  const Scalar _tmp142 = Scalar(1.0) * _tmp40 * (_tmp112 * _tmp131 - _tmp134 * _tmp141);
  const Scalar _tmp143 = _tmp86 + _tmp93;
  const Scalar _tmp144 = _tmp143 * fh1;
  const Scalar _tmp145 = Scalar(3.29616) * _tmp14 + _tmp144 * _tmp41 + _tmp17 * fv1;
  const Scalar _tmp146 = _tmp102 * _tmp128;
  const Scalar _tmp147 = Scalar(1.0) * _tmp131 * _tmp146 - Scalar(1.0) * _tmp131;
  const Scalar _tmp148 = -_tmp144 * _tmp40 - Scalar(3.29616) * _tmp24 - _tmp27 * fv1;
  const Scalar _tmp149 = _tmp104 * _tmp131;
  const Scalar _tmp150 = _tmp102 * (_tmp129 * _tmp131 + Scalar(1.0));
  const Scalar _tmp151 = Scalar(1.0) * _tmp149 - Scalar(1.0) * _tmp150;
  const Scalar _tmp152 =
      Scalar(1.0) * _tmp116 * (-_tmp117 * _tmp131 - Scalar(1.0) * _tmp137 + Scalar(1.0)) +
      _tmp135 * fh1 + _tmp140 * fh1 + _tmp142 * fh1 + _tmp145 * _tmp147 + _tmp148 * _tmp151;
  ...
  const Scalar _tmp159 = -_tmp115 - _tmp125 - _tmp85;
  ...
  const Scalar _tmp163 = _tmp143 * _tmp41;
  const Scalar _tmp164 = _tmp143 * _tmp40;
  const Scalar _tmp165 =
      (_tmp127 * (_tmp135 + _tmp140 + _tmp142 + _tmp147 * _tmp163 - _tmp151 * _tmp164) -
       _tmp152 * _tmp162) /
      std::sqrt(Scalar(std::pow(_tmp152, Scalar(2)) * _tmp161 + 1));
  const Scalar _tmp166 = _tmp102 * _tmp133 * _tmp42;
  const Scalar _tmp167 = _tmp102 * _tmp141 * _tmp40;
  const Scalar _tmp168 = _tmp131 * _tmp145;
  const Scalar _tmp169 = _tmp102 * _tmp41;
  const Scalar _tmp170 = _tmp139 * _tmp169;
  const Scalar _tmp171 = _tmp116 * _tmp137 - _tmp146 * _tmp168 + _tmp148 * _tmp150 + _tmp166 * fh1 +
                         _tmp167 * fh1 + _tmp170 * fh1;
  const Scalar _tmp172 = _tmp114 * _tmp40;
  const Scalar _tmp173 = _tmp124 * _tmp41;
  const Scalar _tmp174 = _tmp116 * _tmp118;
  const Scalar _tmp175 = _tmp42 * _tmp83;
  const Scalar _tmp176 = _tmp175 * fh1;
  const Scalar _tmp177 = _tmp172 * fh1 + _tmp173 * fh1 - _tmp174 * _tmp80 - _tmp176 * _tmp80;
  ...
  const Scalar _tmp185 = _tmp172 + _tmp173 - _tmp175 * _tmp80;
  ...
  const Scalar _tmp189 =
      (-_tmp171 * _tmp188 + _tmp178 * (-_tmp128 * _tmp131 * _tmp143 * _tmp169 - _tmp150 * _tmp164 +
                                       _tmp166 + _tmp167 + _tmp170)) /
      std::sqrt(Scalar(std::pow(_tmp171, Scalar(2)) * _tmp187 + 1));
  const Scalar _tmp190 = _tmp123 * _tmp41;
  const Scalar _tmp191 = _tmp113 * _tmp40;
  const Scalar _tmp192 = _tmp174 + _tmp176 + _tmp190 * fh1 + _tmp191 * fh1;
  const Scalar _tmp193 = _tmp122 * _tmp130 * _tmp41;
  const Scalar _tmp194 = _tmp112 * _tmp130 * _tmp40;
  const Scalar _tmp195 = _tmp132 * _tmp42;
  const Scalar _tmp196 = _tmp116 * _tmp136 - _tmp148 * _tmp149 + _tmp168 - _tmp193 * fh1 -
  ...
  const Scalar _tmp204 = _tmp175 + _tmp190 + _tmp191;
  const Scalar _tmp205 = _tmp203 * _tmp204;
  const Scalar _tmp206 = Scalar(9.6622558468725703) * _tmp192;
  const Scalar _tmp207 = (-_tmp196 * _tmp205 + _tmp197 * (_tmp131 * _tmp163 + _tmp149 * _tmp164 -
                                                          _tmp193 - _tmp194 - _tmp195)) /
                         std::sqrt(Scalar(std::pow(_tmp196, Scalar(2)) * _tmp203 + 1));
  ...
  _res(1, 0) = _tmp155 * (-Scalar(1.0) * _tmp165 * std::cosh(_tmp154) -
                          (-Scalar(0.1034955) * _tmp156 * _tmp162 +
                           _tmp157 * (-_tmp153 * _tmp160 - _tmp155 * _tmp165)) *
                              std::cosh(_tmp158)) +
               _tmp160 * (-std::sinh(_tmp154) - std::sinh(_tmp158));
  ...
  _res(3, 0) = Scalar(9.6622558468725703) * _tmp204 * (-std::sinh(_tmp202) - std::sinh(_tmp208)) +
               _tmp206 * (-Scalar(1.0) * _tmp207 * std::cosh(_tmp208) -
                          (-Scalar(0.1034955) * _tmp200 * _tmp205 +
                           _tmp201 * (-_tmp199 * _tmp204 - _tmp206 * _tmp207)) *
                              std::cosh(_tmp202));
