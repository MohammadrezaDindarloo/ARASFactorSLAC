...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2WrtFv1Nl12(
  ...
  const Scalar _tmp46 = _tmp19 + _tmp34;
  ...
  const Scalar _tmp65 = _tmp51 + _tmp55;
  ...
  const Scalar _tmp74 = _tmp44 + p_init1;
  const Scalar _tmp75 = _tmp74 - p_b(1, 0);
  const Scalar _tmp76 = _tmp46 + p_init0;
  ...
  const Scalar _tmp80 = _tmp53 + _tmp54;
  const Scalar _tmp81 = _tmp52 + _tmp80;
  const Scalar _tmp82 = _tmp75 * _tmp78;
  const Scalar _tmp83 = -_tmp73 * _tmp79 + _tmp81 * _tmp82;
  const Scalar _tmp84 = _tmp64 * _tmp72 - _tmp66;
  const Scalar _tmp85 = Scalar(1.0) / (_tmp72 * _tmp79 - _tmp82);
  const Scalar _tmp86 = _tmp84 * _tmp85;
  const Scalar _tmp87 = -_tmp64 * _tmp73 + _tmp65 * _tmp66 - _tmp83 * _tmp86;
  const Scalar _tmp88 = _tmp56 * _tmp79 - _tmp79 * _tmp81;
  const Scalar _tmp89 = -_tmp48 * _tmp87 + _tmp56 * _tmp64 - _tmp64 * _tmp65 - _tmp86 * _tmp88;
  const Scalar _tmp90 = Scalar(1.0) / (_tmp89);
  const Scalar _tmp91 = _tmp87 * _tmp90;
  const Scalar _tmp92 = _tmp43 + _tmp57;
  const Scalar _tmp93 = _tmp48 * _tmp92;
  const Scalar _tmp94 = Scalar(1.0) / (_tmp37 - _tmp60 - _tmp93);
  const Scalar _tmp95 = _tmp49 * _tmp94;
  const Scalar _tmp96 = _tmp45 * (_tmp43 - _tmp50 * _tmp91 - _tmp92 * _tmp95);
  ...
  const Scalar _tmp102 = _tmp101 * (_tmp100 * _tmp36 * _tmp68 - _tmp100 * _tmp41 * _tmp70);
  const Scalar _tmp103 = _tmp102 * _tmp79 + _tmp44 * _tmp79 - _tmp46 * _tmp82;
  const Scalar _tmp104 = _tmp102 * _tmp64 - _tmp103 * _tmp86 + _tmp57 * _tmp64 - _tmp60 * _tmp66;
  ...
  const Scalar _tmp109 = _tmp107 * _tmp92 - _tmp108 * _tmp87;
  const Scalar _tmp110 = Scalar(1.0) * _tmp45;
  const Scalar _tmp111 = _tmp21 - p_c(0, 0);
  const Scalar _tmp112 = _tmp32 - p_c(1, 0);
  ...
  const Scalar _tmp116 = fh1 * (_tmp114 * _tmp20 - _tmp115 * _tmp31);
  const Scalar _tmp117 = _tmp72 * _tmp85;
  const Scalar _tmp118 = _tmp117 * _tmp83 + _tmp73;
  const Scalar _tmp119 = _tmp117 * _tmp88 - _tmp118 * _tmp48 - _tmp56;
  const Scalar _tmp120 = _tmp104 * _tmp90;
  const Scalar _tmp121 = _tmp106 * (-_tmp102 + _tmp103 * _tmp117 - _tmp119 * _tmp120);
  const Scalar _tmp122 = _tmp92 * _tmp94;
  const Scalar _tmp123 = _tmp119 + _tmp121;
  const Scalar _tmp124 = _tmp118 + _tmp121 * _tmp122 - _tmp123 * _tmp91;
  const Scalar _tmp125 = _tmp115 * fh1;
  const Scalar _tmp126 = fh1 * (_tmp51 + _tmp80);
  const Scalar _tmp127 = -_tmp114 * _tmp126 - Scalar(3.29616) * _tmp27 - _tmp31 * fv1;
  const Scalar _tmp128 = _tmp93 * _tmp98 + Scalar(1.0);
  const Scalar _tmp129 = _tmp48 * _tmp98;
  const Scalar _tmp130 = -Scalar(1.0) * _tmp110 * _tmp128 + Scalar(1.0) * _tmp129;
  const Scalar _tmp131 = _tmp115 * _tmp126 + Scalar(3.29616) * _tmp17 + _tmp20 * fv1;
  const Scalar _tmp132 = _tmp45 * _tmp92;
  const Scalar _tmp133 = Scalar(1.0) * _tmp132 * _tmp98 - Scalar(1.0) * _tmp98;
  const Scalar _tmp134 = Scalar(1.0) * _tmp85;
  const Scalar _tmp135 = _tmp110 * _tmp47 * _tmp83 * _tmp85 - _tmp134 * _tmp88;
  const Scalar _tmp136 = _tmp106 * (-_tmp103 * _tmp134 - _tmp120 * _tmp135);
  const Scalar _tmp137 = _tmp135 + _tmp136;
  const Scalar _tmp138 = _tmp122 * _tmp136 - _tmp134 * _tmp83 - _tmp137 * _tmp91;
  const Scalar _tmp139 = _tmp114 * fh1;
  const Scalar _tmp140 = Scalar(1.0) * _tmp116 * (_tmp107 - _tmp109 * _tmp110) +
                         Scalar(1.0) * _tmp125 * (-_tmp110 * _tmp124 + _tmp121 * _tmp98) +
                         _tmp127 * _tmp130 + _tmp131 * _tmp133 +
                         Scalar(1.0) * _tmp139 * (-_tmp110 * _tmp138 + _tmp136 * _tmp98) +
                         _tmp33 * _tmp97;
  const Scalar _tmp141 = _tmp50 * _tmp90;
  const Scalar _tmp142 = _tmp79 * _tmp85;
  const Scalar _tmp143 = _tmp84 * _tmp90;
  const Scalar _tmp144 = _tmp143 * _tmp50;
  const Scalar _tmp145 = _tmp101 * (_tmp141 * _tmp64 - _tmp142 * _tmp144);
  const Scalar _tmp146 = -_tmp137 * _tmp143 + Scalar(1.0);
  const Scalar _tmp147 = _tmp64 * _tmp90;
  const Scalar _tmp148 = -_tmp123 * _tmp143 - _tmp72;
  const Scalar _tmp149 = -_tmp101 * _tmp116 * (_tmp108 * _tmp64 - _tmp108 * _tmp79 * _tmp86) -
                         _tmp101 * _tmp125 * (_tmp123 * _tmp147 + _tmp142 * _tmp148 + Scalar(1.0)) -
                         _tmp101 * _tmp139 * (_tmp137 * _tmp147 + _tmp142 * _tmp146) -
                         _tmp145 * _tmp33;
  const Scalar _tmp150 = Scalar(1.0) / (_tmp149);
  const Scalar _tmp151 = std::asinh(_tmp140 * _tmp150);
  const Scalar _tmp152 = Scalar(9.6622558468725703) * _tmp149;
  const Scalar _tmp153 =
      -_tmp151 * _tmp152 - std::sqrt(Scalar(std::pow(Scalar(-_tmp67 + p_a(1, 0)), Scalar(2)) +
  ...
  const Scalar _tmp157 = _tmp28 + _tmp38 + _tmp39;
  const Scalar _tmp158 =
      (-_tmp140 * _tmp155 + _tmp150 * (_tmp130 * _tmp157 + _tmp133 * _tmp20 - _tmp97)) /
  ...
  const Scalar _tmp162 = _tmp128 * _tmp45;
  const Scalar _tmp163 = _tmp131 * _tmp98;
  const Scalar _tmp164 = _tmp109 * _tmp116 * _tmp45 + _tmp124 * _tmp125 * _tmp45 +
                         _tmp127 * _tmp162 - _tmp132 * _tmp163 + _tmp138 * _tmp139 * _tmp45 +
                         _tmp33 * _tmp96;
  const Scalar _tmp165 = _tmp144 * _tmp85;
  const Scalar _tmp166 = _tmp108 * _tmp116;
  const Scalar _tmp167 =
      _tmp125 * _tmp148 * _tmp85 + _tmp139 * _tmp146 * _tmp85 - _tmp165 * _tmp33 - _tmp166 * _tmp86;
  ...
  const Scalar _tmp171 = _tmp20 * _tmp98;
  const Scalar _tmp172 = std::pow(_tmp167, Scalar(-2));
  const Scalar _tmp173 = _tmp165 * _tmp172;
  const Scalar _tmp174 =
      (-_tmp164 * _tmp173 + _tmp168 * (-_tmp132 * _tmp171 + _tmp157 * _tmp162 - _tmp96)) /
  ...
  const Scalar _tmp178 =
      -_tmp169 * _tmp176 - std::sqrt(Scalar(std::pow(Scalar(-_tmp74 + p_b(1, 0)), Scalar(2)) +
                                            std::pow(Scalar(-_tmp76 + p_b(0, 0)), Scalar(2))));
  const Scalar _tmp179 = _tmp177 * _tmp178;
  const Scalar _tmp180 = -_tmp107 * _tmp116 - _tmp121 * _tmp125 * _tmp94 - _tmp127 * _tmp129 -
                         _tmp136 * _tmp139 * _tmp94 + _tmp163 + _tmp33 * _tmp95;
  const Scalar _tmp181 =
      _tmp123 * _tmp125 * _tmp90 + _tmp137 * _tmp139 * _tmp90 + _tmp141 * _tmp33 + _tmp166;
  ...
  _res(1, 0) = _tmp152 * (-Scalar(1.0) * _tmp158 * std::cosh(_tmp161) -
                          (-Scalar(0.1034955) * _tmp153 * _tmp155 +
                           _tmp159 * (-_tmp151 * _tmp156 - _tmp152 * _tmp158)) *
                              std::cosh(_tmp160)) +
               _tmp156 * (-std::sinh(_tmp160) - std::sinh(_tmp161));
  _res(2, 0) = _tmp175 * (-std::sinh(_tmp170) - std::sinh(_tmp179)) +
               _tmp176 * (-Scalar(1.0) * _tmp174 * std::cosh(_tmp170) -
                          (-Scalar(0.1034955) * _tmp173 * _tmp178 +
                           _tmp177 * (-_tmp169 * _tmp175 - _tmp174 * _tmp176)) *
                              std::cosh(_tmp179));
