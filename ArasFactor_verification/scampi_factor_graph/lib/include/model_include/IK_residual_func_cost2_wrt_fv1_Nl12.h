...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2WrtFv1Nl12(
  ...
  const Scalar _tmp52 = _tmp22 + _tmp27 + _tmp34;
  ...
  const Scalar _tmp136 = Scalar(3.29616) * _tmp13 + _tmp135 * _tmp80 + _tmp19 * fv1;
  const Scalar _tmp137 = _tmp122 * _tmp97;
  const Scalar _tmp138 = Scalar(1.0) * _tmp125 * _tmp137 - Scalar(1.0) * _tmp125;
  const Scalar _tmp139 = -_tmp135 * _tmp79 - Scalar(3.29616) * _tmp25 - _tmp30 * fv1;
  ...
  const Scalar _tmp168 = _tmp112 * _tmp158 * _tmp167;
  const Scalar _tmp169 = _tmp125 * _tmp19;
  const Scalar _tmp170 =
      (-_tmp156 * _tmp168 + _tmp161 * (-_tmp130 - _tmp137 * _tmp169 + _tmp141 * _tmp153)) /
  ...
  const Scalar _tmp173 = Scalar(1.0) * _tmp162;
  ...
  const Scalar _tmp185 = (_tmp174 * _tmp184 + _tmp176 * (-_tmp129 - _tmp140 * _tmp153 + _tmp169)) /
  ...
  _res(1, 0) = _tmp146 * (-Scalar(1.0) * _tmp154 * std::cosh(_tmp145) -
                          (-Scalar(0.1034955) * _tmp147 * _tmp152 +
                           _tmp148 * (-_tmp144 * _tmp150 - _tmp146 * _tmp154)) *
                              std::cosh(_tmp149)) +
               _tmp150 * (-std::sinh(_tmp145) - std::sinh(_tmp149));
  _res(2, 0) = _tmp163 * (-Scalar(1.0) * _tmp170 * std::cosh(_tmp173) -
                          (-Scalar(0.1034955) * _tmp164 * _tmp168 +
                           _tmp165 * (-_tmp162 * _tmp172 - _tmp163 * _tmp170)) *
                              std::cosh(_tmp166)) +
               _tmp172 * (-std::sinh(_tmp166) - std::sinh(_tmp173));
  _res(3, 0) = -_tmp171 * (-std::sinh(_tmp178) - std::sinh(_tmp182)) +
               _tmp179 * (-Scalar(1.0) * _tmp185 * std::cosh(_tmp178) -
                          (Scalar(0.1034955) * _tmp180 * _tmp184 +
                           _tmp181 * (_tmp171 * _tmp177 - _tmp179 * _tmp185)) *
                              std::cosh(_tmp182));
