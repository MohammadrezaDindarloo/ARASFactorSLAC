...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2WrtFv1Nl4(
  ...
  const Scalar _tmp41 = _tmp40 + Scalar(-2.5193355532036801);
  ...
  const Scalar _tmp45 = _tmp20 + _tmp7;
  ...
  const Scalar _tmp49 = _tmp45 + position_vector(1, 0);
  ...
  const Scalar _tmp53 = Scalar(1.0) / (_tmp48);
  const Scalar _tmp54 = _tmp51 * _tmp53;
  const Scalar _tmp55 = _tmp54 * (-_tmp45 * _tmp48 * _tmp52 + _tmp46 * _tmp50 * _tmp52);
  const Scalar _tmp56 = _tmp35 * _tmp43 - _tmp39 * _tmp44 + _tmp43 * _tmp55;
  const Scalar _tmp57 = _tmp50 * _tmp53;
  const Scalar _tmp58 = Scalar(1.0) / (_tmp43 * _tmp57 - _tmp44);
  const Scalar _tmp59 = _tmp57 * _tmp58;
  const Scalar _tmp60 = Scalar(0.20999999999999999) * _tmp27 - Scalar(0.20999999999999999) * _tmp28;
  const Scalar _tmp61 = -_tmp60;
  const Scalar _tmp62 = -Scalar(0.010999999999999999) * _tmp25 -
  ...
  const Scalar _tmp69 = -_tmp43 * _tmp66 + _tmp44 * _tmp68;
  const Scalar _tmp70 = _tmp59 * _tmp69 + _tmp66;
  ...
  const Scalar _tmp77 = _tmp58 * (_tmp43 * _tmp65 - _tmp43 * _tmp68);
  const Scalar _tmp78 = _tmp57 * _tmp77 - _tmp65 - _tmp70 * _tmp76;
  const Scalar _tmp79 = _tmp13 + _tmp7;
  ...
  const Scalar _tmp83 = _tmp23 + _tmp38;
  ...
  const Scalar _tmp93 = -_tmp57 * _tmp88 - _tmp69 * _tmp92 + _tmp89 * _tmp90;
  const Scalar _tmp94 = -_tmp76 * _tmp93 - _tmp77 * _tmp91 - _tmp87 * _tmp89 + _tmp88;
  const Scalar _tmp95 = Scalar(1.0) / (_tmp94);
  const Scalar _tmp96 = _tmp55 * _tmp87 - _tmp56 * _tmp92 + _tmp80 * _tmp87 - _tmp83 * _tmp90;
  const Scalar _tmp97 = _tmp95 * _tmp96;
  const Scalar _tmp98 = Scalar(1.0) / (_tmp96);
  const Scalar _tmp99 = _tmp94 * _tmp98;
  const Scalar _tmp100 = _tmp99 * (-_tmp55 + _tmp56 * _tmp59 - _tmp78 * _tmp97);
  const Scalar _tmp101 = _tmp100 + _tmp78;
  const Scalar _tmp102 = _tmp87 * _tmp95;
  const Scalar _tmp103 = _tmp91 * _tmp95;
  const Scalar _tmp104 = -_tmp101 * _tmp103 - _tmp57;
  const Scalar _tmp105 = _tmp43 * _tmp58;
  ...
  const Scalar _tmp116 = _tmp54 * (_tmp114 * _tmp87 - _tmp115 * _tmp43);
  const Scalar _tmp117 = Scalar(1.0) * _tmp98;
  const Scalar _tmp118 = _tmp107 * _tmp108;
  const Scalar _tmp119 = fh1 * (-_tmp109 * _tmp21 + _tmp118 * _tmp32);
  const Scalar _tmp120 = Scalar(1.0) * _tmp73;
  const Scalar _tmp121 = _tmp120 * _tmp58 * _tmp69 * _tmp75 - Scalar(1.0) * _tmp77;
  const Scalar _tmp122 = Scalar(1.0) * _tmp58;
  const Scalar _tmp123 = _tmp99 * (-_tmp121 * _tmp97 - _tmp122 * _tmp56);
  ...
  const Scalar _tmp127 = -_tmp110 * _tmp54 * (_tmp101 * _tmp102 + _tmp104 * _tmp105 + Scalar(1.0)) -
                         _tmp111 * _tmp116 -
                         _tmp119 * _tmp54 * (-_tmp117 * _tmp43 * _tmp92 + _tmp117 * _tmp87) -
                         _tmp126 * _tmp54 * (_tmp102 * _tmp124 + _tmp105 * _tmp125);
  const Scalar _tmp128 = Scalar(1.0) / (_tmp127);
  const Scalar _tmp129 = fh1 * (_tmp61 + _tmp67);
  const Scalar _tmp130 = -_tmp118 * _tmp129 - Scalar(3.29616) * _tmp17 - _tmp21 * fv1;
  const Scalar _tmp131 = _tmp72 + _tmp80;
  const Scalar _tmp132 = _tmp131 * _tmp76;
  const Scalar _tmp133 = Scalar(1.0) / (-_tmp132 + _tmp74 - _tmp83);
  const Scalar _tmp134 = Scalar(1.0) * _tmp133;
  const Scalar _tmp135 = _tmp132 * _tmp134 + Scalar(1.0);
  const Scalar _tmp136 = _tmp134 * _tmp76;
  ...
  const Scalar _tmp140 = -_tmp122 * _tmp69 + _tmp123 * _tmp138 - _tmp124 * _tmp139;
  const Scalar _tmp141 = _tmp109 * _tmp129 + Scalar(3.29616) * _tmp29 + _tmp32 * fv1;
  const Scalar _tmp142 = _tmp131 * _tmp73;
  const Scalar _tmp143 = Scalar(1.0) * _tmp134 * _tmp142 - Scalar(1.0) * _tmp134;
  const Scalar _tmp144 = _tmp134 * _tmp99;
  const Scalar _tmp145 = -_tmp117 * _tmp93 + _tmp131 * _tmp144;
  const Scalar _tmp146 = _tmp100 * _tmp138 - _tmp101 * _tmp139 + _tmp70;
  const Scalar _tmp147 = _tmp112 * _tmp133;
  const Scalar _tmp148 = _tmp73 * (-_tmp113 * _tmp139 - _tmp131 * _tmp147 + _tmp72);
  const Scalar _tmp149 = -Scalar(1.0) * _tmp112 * _tmp134 - Scalar(1.0) * _tmp148 + Scalar(1.0);
  const Scalar _tmp150 = Scalar(1.0) * _tmp110 * (_tmp100 * _tmp134 - _tmp120 * _tmp146) +
                         _tmp111 * _tmp149 +
                         Scalar(1.0) * _tmp119 * (-_tmp120 * _tmp145 + _tmp144) +
                         Scalar(1.0) * _tmp126 * (-_tmp120 * _tmp140 + _tmp123 * _tmp134) +
                         _tmp130 * _tmp137 + _tmp141 * _tmp143;
  ...
  const Scalar _tmp160 = _tmp18 + _tmp79;
  const Scalar _tmp161 =
      (_tmp128 * (_tmp137 * _tmp160 + _tmp143 * _tmp32 - _tmp149) - _tmp150 * _tmp159) /
      std::sqrt(Scalar(std::pow(_tmp150, Scalar(2)) * _tmp158 + 1));
  const Scalar _tmp162 = _tmp135 * _tmp73;
  const Scalar _tmp163 = _tmp134 * _tmp141;
  const Scalar _tmp164 = _tmp110 * _tmp146 * _tmp73 + _tmp111 * _tmp148 +
                         _tmp119 * _tmp145 * _tmp73 + _tmp126 * _tmp140 * _tmp73 +
                         _tmp130 * _tmp162 - _tmp142 * _tmp163;
  const Scalar _tmp165 = _tmp117 * _tmp119;
  const Scalar _tmp166 = _tmp111 * _tmp114;
  const Scalar _tmp167 =
      _tmp104 * _tmp110 * _tmp58 + _tmp125 * _tmp126 * _tmp58 - _tmp165 * _tmp92 - _tmp166 * _tmp92;
  ...
  const Scalar _tmp178 = _tmp134 * _tmp32;
  const Scalar _tmp179 = _tmp115 * _tmp177;
  const Scalar _tmp180 =
      (-_tmp164 * _tmp179 + _tmp168 * (-_tmp142 * _tmp178 - _tmp148 + _tmp160 * _tmp162)) /
      std::sqrt(Scalar(std::pow(_tmp164, Scalar(2)) * _tmp177 + 1));
  const Scalar _tmp181 = -_tmp100 * _tmp110 * _tmp133 + _tmp111 * _tmp147 - _tmp119 * _tmp144 -
                         _tmp123 * _tmp126 * _tmp133 - _tmp130 * _tmp136 + _tmp163;
  const Scalar _tmp182 =
      _tmp101 * _tmp110 * _tmp95 + _tmp124 * _tmp126 * _tmp95 + _tmp165 + _tmp166;
  ...
  const Scalar _tmp192 = (_tmp181 * _tmp191 + _tmp183 * (-_tmp136 * _tmp160 - _tmp147 + _tmp178)) /
