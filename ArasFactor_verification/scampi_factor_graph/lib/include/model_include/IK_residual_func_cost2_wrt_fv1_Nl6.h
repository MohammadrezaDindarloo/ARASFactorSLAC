...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2WrtFv1Nl6(
  ...
  const Scalar _tmp37 = _tmp10 + _tmp35;
  ...
  const Scalar _tmp93 = _tmp78 * (-_tmp69 * _tmp91 + _tmp77 * _tmp92);
  const Scalar _tmp94 = _tmp68 * _tmp90 - _tmp69 * _tmp88 - _tmp70 * _tmp93;
  const Scalar _tmp95 = _tmp78 * (-_tmp76 * _tmp92 + _tmp91);
  const Scalar _tmp96 = -_tmp49 * _tmp94 - _tmp58 * _tmp90 - _tmp70 * _tmp95 + _tmp88;
  const Scalar _tmp97 = _tmp81 * _tmp96;
  const Scalar _tmp98 = _tmp52 * _tmp97;
  const Scalar _tmp99 = Scalar(1.0) * _tmp81;
  const Scalar _tmp100 = _tmp45 * _tmp98 - _tmp94 * _tmp99;
  const Scalar _tmp101 = Scalar(1.0) * _tmp47;
  const Scalar _tmp102 = _tmp33 - p_b(1, 0);
  const Scalar _tmp103 = _tmp21 - p_b(0, 0);
  ...
  const Scalar _tmp109 = _tmp108 * _tmp49 - Scalar(1.0) * _tmp95;
  const Scalar _tmp110 = Scalar(1.0) / (_tmp96);
  const Scalar _tmp111 = _tmp110 * _tmp80;
  const Scalar _tmp112 = _tmp97 * (-_tmp109 * _tmp111 - Scalar(1.0) * _tmp79);
  const Scalar _tmp113 = _tmp45 * _tmp51;
  const Scalar _tmp114 = _tmp109 + _tmp112;
  const Scalar _tmp115 = _tmp110 * _tmp94;
  const Scalar _tmp116 = -_tmp108 + _tmp112 * _tmp113 - _tmp114 * _tmp115;
  const Scalar _tmp117 = _tmp106 * fh1;
  const Scalar _tmp118 = fh1 * (_tmp82 + _tmp86);
  const Scalar _tmp119 = _tmp105 * _tmp118 + Scalar(3.29616) * _tmp17 + _tmp20 * fv1;
  const Scalar _tmp120 = _tmp45 * _tmp47;
  const Scalar _tmp121 = Scalar(1.0) * _tmp120 * _tmp52 - Scalar(1.0) * _tmp52;
  const Scalar _tmp122 = _tmp69 * _tmp87 + _tmp69 * _tmp93;
  const Scalar _tmp123 = -_tmp122 * _tmp49 + _tmp69 * _tmp95 - _tmp87;
  const Scalar _tmp124 = _tmp97 * (-_tmp111 * _tmp123 - _tmp67 + _tmp69 * _tmp79);
  const Scalar _tmp125 = _tmp123 + _tmp124;
  const Scalar _tmp126 = _tmp113 * _tmp124 - _tmp115 * _tmp125 + _tmp122;
  const Scalar _tmp127 = _tmp105 * fh1;
  const Scalar _tmp128 = -_tmp106 * _tmp118 - Scalar(3.29616) * _tmp27 - _tmp32 * fv1;
  const Scalar _tmp129 = _tmp49 * _tmp52;
  const Scalar _tmp130 = _tmp47 * (_tmp50 * _tmp52 + Scalar(1.0));
  const Scalar _tmp131 = Scalar(1.0) * _tmp129 - Scalar(1.0) * _tmp130;
  const Scalar _tmp132 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp133 = _tmp38 + _tmp42 * _tmp49;
  const Scalar _tmp134 = _tmp133 * _tmp51;
  const Scalar _tmp135 = 0;
  const Scalar _tmp136 = _tmp47 * (-_tmp115 * _tmp135 - _tmp134 * _tmp45 + _tmp43);
  const Scalar _tmp137 = -Scalar(1.0) * _tmp133 * _tmp52 - Scalar(1.0) * _tmp136 + Scalar(1.0);
  const Scalar _tmp138 = Scalar(1.0) * _tmp107 * (-_tmp100 * _tmp101 + _tmp98) +
                         Scalar(1.0) * _tmp117 * (-_tmp101 * _tmp116 + _tmp112 * _tmp52) +
                         _tmp119 * _tmp121 +
                         Scalar(1.0) * _tmp127 * (-_tmp101 * _tmp126 + _tmp124 * _tmp52) +
                         _tmp128 * _tmp131 + _tmp132 * _tmp137;
  const Scalar _tmp139 = _tmp110 * _tmp58;
  const Scalar _tmp140 = _tmp110 * _tmp70;
  const Scalar _tmp141 = -_tmp125 * _tmp140 - _tmp69;
  const Scalar _tmp142 = _tmp76 * _tmp78;
  const Scalar _tmp143 = -_tmp114 * _tmp140 + Scalar(1.0);
  const Scalar _tmp144 = _tmp135 * _tmp140;
  const Scalar _tmp145 = _tmp110 * _tmp135;
  const Scalar _tmp146 = _tmp66 * (-_tmp142 * _tmp144 + _tmp145 * _tmp58);
  const Scalar _tmp147 = -_tmp107 * _tmp66 * (-_tmp142 * _tmp70 * _tmp99 + _tmp58 * _tmp99) -
                         _tmp117 * _tmp66 * (_tmp114 * _tmp139 + _tmp142 * _tmp143) -
                         _tmp127 * _tmp66 * (_tmp125 * _tmp139 + _tmp141 * _tmp142 + Scalar(1.0)) -
                         _tmp132 * _tmp146;
  ...
  const Scalar _tmp153 = _tmp23 + _tmp28 + _tmp39;
  const Scalar _tmp154 =
      (-_tmp138 * _tmp152 + _tmp148 * (_tmp121 * _tmp20 + _tmp131 * _tmp153 - _tmp137)) /
      std::sqrt(Scalar(std::pow(_tmp138, Scalar(2)) * _tmp151 + 1));
  const Scalar _tmp155 = Scalar(9.6622558468725703) * _tmp147;
  const Scalar _tmp156 =
      -_tmp149 * _tmp155 - std::sqrt(Scalar(std::pow(Scalar(-_tmp59 + p_a(0, 0)), Scalar(2)) +
  ...
  const Scalar _tmp160 = _tmp107 * _tmp99;
  const Scalar _tmp161 = _tmp144 * _tmp78;
  const Scalar _tmp162 = _tmp117 * _tmp143 * _tmp78 + _tmp127 * _tmp141 * _tmp78 -
                         _tmp132 * _tmp161 - _tmp160 * _tmp70 * _tmp78;
  const Scalar _tmp163 = Scalar(1.0) / (_tmp162);
  const Scalar _tmp164 = _tmp119 * _tmp52;
  const Scalar _tmp165 = _tmp100 * _tmp107 * _tmp47 + _tmp116 * _tmp117 * _tmp47 -
                         _tmp120 * _tmp164 + _tmp126 * _tmp127 * _tmp47 + _tmp128 * _tmp130 +
                         _tmp132 * _tmp136;
  const Scalar _tmp166 = std::asinh(_tmp163 * _tmp165);
  const Scalar _tmp167 = Scalar(9.6622558468725703) * _tmp162;
  const Scalar _tmp168 =
      -_tmp166 * _tmp167 - std::sqrt(Scalar(std::pow(Scalar(-_tmp71 + p_c(0, 0)), Scalar(2)) +
  ...
  const Scalar _tmp173 = _tmp20 * _tmp52;
  const Scalar _tmp174 =
      (_tmp163 * (-_tmp120 * _tmp173 + _tmp130 * _tmp153 - _tmp136) - _tmp165 * _tmp172) /
      std::sqrt(Scalar(std::pow(_tmp165, Scalar(2)) * _tmp171 + 1));
  const Scalar _tmp175 = Scalar(9.6622558468725703) * _tmp161;
  const Scalar _tmp176 = Scalar(1.0) * _tmp166;
  const Scalar _tmp177 = -_tmp107 * _tmp98 - _tmp112 * _tmp117 * _tmp51 -
                         _tmp124 * _tmp127 * _tmp51 - _tmp128 * _tmp129 + _tmp132 * _tmp134 +
                         _tmp164;
  const Scalar _tmp178 =
      _tmp110 * _tmp114 * _tmp117 + _tmp110 * _tmp125 * _tmp127 + _tmp132 * _tmp145 + _tmp160;
  ...
  const Scalar _tmp182 =
      -_tmp180 * _tmp181 - std::sqrt(Scalar(std::pow(Scalar(-_tmp53 + p_d(1, 0)), Scalar(2)) +
  ...
  const Scalar _tmp186 = Scalar(9.6622558468725703) * _tmp145;
  const Scalar _tmp187 = std::pow(_tmp178, Scalar(-2));
  const Scalar _tmp188 = _tmp145 * _tmp187;
  const Scalar _tmp189 = (_tmp177 * _tmp188 + _tmp179 * (-_tmp129 * _tmp153 - _tmp134 + _tmp173)) /
  ...
  _res(2, 0) = _tmp167 * (-Scalar(1.0) * _tmp174 * std::cosh(_tmp176) -
                          (-Scalar(0.1034955) * _tmp168 * _tmp172 +
                           _tmp169 * (-_tmp166 * _tmp175 - _tmp167 * _tmp174)) *
                              std::cosh(_tmp170)) +
               _tmp175 * (-std::sinh(_tmp170) - std::sinh(_tmp176));
