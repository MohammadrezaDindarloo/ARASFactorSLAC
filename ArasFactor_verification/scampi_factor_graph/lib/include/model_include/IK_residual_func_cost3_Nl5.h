...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl5(
  ...
  const Scalar _tmp47 = _tmp30 * _tmp34;
  const Scalar _tmp48 = _tmp25 * _tmp26;
  const Scalar _tmp49 = -_tmp15 * _tmp48 + _tmp24 * _tmp27 + _tmp27 * _tmp46;
  const Scalar _tmp50 = _tmp38 * _tmp44;
  const Scalar _tmp51 = Scalar(1.0) / (_tmp27 * _tmp50 - _tmp48);
  const Scalar _tmp52 = _tmp35 * _tmp50 - _tmp47;
  const Scalar _tmp53 = _tmp51 * _tmp52;
  const Scalar _tmp54 = _tmp29 * _tmp35 - _tmp32 * _tmp47 + _tmp35 * _tmp46 - _tmp49 * _tmp53;
  const Scalar _tmp55 = Scalar(1.0) / (_tmp54);
  const Scalar _tmp56 = Scalar(1.0) * _tmp51;
  const Scalar _tmp57 = _tmp52 * _tmp55 * _tmp56;
  ...
  const Scalar _tmp76 = _tmp27 * _tmp72;
  const Scalar _tmp77 = _tmp48 * _tmp75 - _tmp50 * _tmp76;
  const Scalar _tmp78 = Scalar(1.0) * _tmp37;
  const Scalar _tmp79 = Scalar(1.0) * _tmp40;
  const Scalar _tmp80 = (-_tmp15 + _tmp79) / (_tmp24 - _tmp78);
  const Scalar _tmp81 = -_tmp27 * _tmp75 + _tmp76;
  const Scalar _tmp82 = -_tmp35 * _tmp74 - _tmp53 * _tmp81 + _tmp73 -
                        _tmp80 * (_tmp47 * _tmp74 - _tmp50 * _tmp73 - _tmp53 * _tmp77);
  const Scalar _tmp83 = Scalar(1.0) / (_tmp82);
  const Scalar _tmp84 = _tmp78 * _tmp80 + _tmp79;
  const Scalar _tmp85 = 0;
  const Scalar _tmp86 = _tmp56 * _tmp77 * _tmp80 - _tmp56 * _tmp81;
  const Scalar _tmp87 = _tmp54 * _tmp83;
  const Scalar _tmp88 = _tmp55 * _tmp82;
  const Scalar _tmp89 = _tmp86 + _tmp88 * (-_tmp49 * _tmp56 - _tmp86 * _tmp87);
  const Scalar _tmp90 = _tmp35 * _tmp83;
  const Scalar _tmp91 = _tmp52 * _tmp83;
  const Scalar _tmp92 = -_tmp89 * _tmp91 + Scalar(1.0);
  const Scalar _tmp93 = _tmp27 * _tmp51;
  const Scalar _tmp94 = _tmp45 * fh1;
  const Scalar _tmp95 = _tmp50 * _tmp51;
  const Scalar _tmp96 = -_tmp72 - _tmp80 * (_tmp50 * _tmp72 + _tmp77 * _tmp95) + _tmp81 * _tmp95;
  const Scalar _tmp97 = _tmp88 * (-_tmp46 + _tmp49 * _tmp95 - _tmp87 * _tmp96) + _tmp96;
  const Scalar _tmp98 = -_tmp50 - _tmp91 * _tmp97;
  const Scalar _tmp99 = _tmp67 * _tmp85;
  ...
  _res(1, 0) = std::exp(_tmp45 * _tmp66 * (-_tmp27 * _tmp57 + _tmp35 * _tmp58) +
                        _tmp45 * _tmp67 * (-_tmp27 * _tmp53 * _tmp85 + _tmp35 * _tmp85) +
                        _tmp64 * _tmp94 * (_tmp89 * _tmp90 + _tmp92 * _tmp93) +
                        _tmp65 * _tmp94 * (_tmp90 * _tmp97 + _tmp93 * _tmp98 + Scalar(1.0)));
  _res(2, 0) = std::exp(-_tmp100 * _tmp64 * _tmp92 - _tmp100 * _tmp65 * _tmp98 + _tmp53 * _tmp99 +
                        _tmp57 * _tmp66);
  _res(3, 0) =
      std::exp(-_tmp101 * _tmp64 * _tmp89 - _tmp101 * _tmp65 * _tmp97 - _tmp58 * _tmp66 - _tmp99);
