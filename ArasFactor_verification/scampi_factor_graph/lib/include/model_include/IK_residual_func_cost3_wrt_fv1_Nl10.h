...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl10(
  ...
  const Scalar _tmp22 = _tmp10 * _tmp4;
  ...
  const Scalar _tmp48 = -Scalar(0.010999999999999999) * _tmp13 -
  ...
  const Scalar _tmp96 = _tmp69 * _tmp75 * _tmp89;
  const Scalar _tmp97 = fh1 * (-_tmp82 * _tmp87 + _tmp84 * _tmp93);
  ...
  const Scalar _tmp102 = _tmp33 * (_tmp100 * _tmp67 - _tmp101 * _tmp43);
  ...
  _res(1, 0) =
      -_tmp102 * std::exp(_tmp102 * _tmp98 +
                          _tmp33 * _tmp88 * (_tmp77 * _tmp81 + _tmp79 * _tmp80 + Scalar(1.0)) +
                          _tmp33 * _tmp94 * (_tmp80 * _tmp92 + _tmp81 * _tmp91) +
                          _tmp33 * _tmp97 * (-_tmp43 * _tmp96 + _tmp67 * _tmp95));
  _res(2, 0) = -_tmp101 * std::exp(_tmp103 * _tmp70 - _tmp45 * _tmp79 * _tmp88 -
                                   _tmp45 * _tmp92 * _tmp94 + _tmp96 * _tmp97);
  _res(3, 0) = _tmp100 * std::exp(-_tmp103 - _tmp72 * _tmp77 * _tmp88 - _tmp72 * _tmp91 * _tmp94 -
                                  _tmp95 * _tmp97);
