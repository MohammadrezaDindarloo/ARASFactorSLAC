...
namespace gtsam
{
    ...
    class FK_factor_graph_cost4 : public NoiseModelFactorN<double, double, double, double, gtsam::Point3, gtsam::Point3, gtsam::Point3, gtsam::Point3, double, double, gtsam::Pose3>
    {
    ...
    public: 
        // Constructor
        FK_factor_graph_cost4(Key key1, Key key2, Key key3, Key key4, Key key5, Key key6, Key key7, Key key8, Key key9, Key key10, Key key11, gtsam::Vector4 distance_measure_, gtsam::Rot3 DeltaRot_, const SharedNoiseModel &model) 
        : NoiseModelFactorN<double, double, double, double, gtsam::Point3, gtsam::Point3, gtsam::Point3, gtsam::Point3, double, double, gtsam::Pose3>(model, key1, key2, key3, key4, key5, key6, key7, key8, key9, key10, key11), distance_measure(distance_measure_), DeltaRot(DeltaRot_) {}

        // Evaluate the error
        Vector evaluateError(const double &ofset0, const double &ofset1, const double &ofset2, const double &ofset3, const gtsam::Point3 &p_a, const gtsam::Point3 &p_b, const gtsam::Point3 &p_c, const gtsam::Point3 &p_d, const double &fh1, const double &fv1, const gtsam::Pose3 &TransformationMatrix,
                             OptionalMatrixType H1,
                             OptionalMatrixType H2,
                             OptionalMatrixType H3,
                             OptionalMatrixType H4,
    ...
    class FK_factor_graph_cost5 : public NoiseModelFactorN<double, double, double, double, gtsam::Point3, gtsam::Point3, gtsam::Point3, gtsam::Point3, double, double, gtsam::Pose3>
    {
    ...
    public: 
        // Constructor
        FK_factor_graph_cost5(Key key1, Key key2, Key key3, Key key4, Key key5, Key key6, Key key7, Key key8, Key key9, Key key10, Key key11, gtsam::Vector4 distance_measure_, gtsam::Rot3 DeltaRot_, const SharedNoiseModel &model) 
        : NoiseModelFactorN<double, double, double, double, gtsam::Point3, gtsam::Point3, gtsam::Point3, gtsam::Point3, double, double, gtsam::Pose3>(model, key1, key2, key3, key4, key5, key6, key7, key8, key9, key10, key11), distance_measure(distance_measure_), DeltaRot(DeltaRot_) {}
