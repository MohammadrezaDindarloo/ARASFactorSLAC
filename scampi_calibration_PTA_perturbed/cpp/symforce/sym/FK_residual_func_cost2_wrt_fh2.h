 ...
 *
 * Symbolic function: FK_residual_func_cost2_wrt_fh2
 *
 * Args:
 *     fh1: Scalar
 *     fv1: Scalar
...
Eigen::Matrix<Scalar, 4, 1> FkResidualFuncCost2WrtFh2(
          ...
          std::sqrt(Scalar(
              ...
              std::pow(
                  Scalar(Scalar(0.010999999999999999) * _tmp2 * _tmp7 +
                         ...
                         Scalar(0.20999999999999999) * _tmp8 - Scalar(0.20999999999999999) * _tmp9 +
                         p_b(1, 0) - position_vector(1, 0)),
                  Scalar(2))));
  const Scalar _tmp14 = _tmp0 * _tmp13;
  const Scalar _tmp15 = std::pow(fh2, Scalar(-2));
  const Scalar _tmp16 =
      std::pow(Scalar(_tmp15 * std::pow(fv2, Scalar(2)) + 1), Scalar(Scalar(-1) / Scalar(2)));
  ...
  _res(1, 0) =
      -Scalar(9.6622558468725703) * fh2 *
          (Scalar(1.0) * _tmp15 * _tmp16 * fv2 * std::cosh(_tmp17) -
