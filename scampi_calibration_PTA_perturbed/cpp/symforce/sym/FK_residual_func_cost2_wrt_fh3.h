 ...
 *
 * Symbolic function: FK_residual_func_cost2_wrt_fh3
 *
 * Args:
 *     fh1: Scalar
 *     fv1: Scalar
...
Eigen::Matrix<Scalar, 4, 1> FkResidualFuncCost2WrtFh3(
          ...
          std::sqrt(Scalar(
              ...
              std::pow(
                  Scalar(Scalar(0.010999999999999999) * _tmp2 * _tmp7 -
                         ...
                         Scalar(0.20999999999999999) * _tmp8 - Scalar(0.20999999999999999) * _tmp9 +
                         p_c(1, 0) - position_vector(1, 0)),
                  Scalar(2))));
  const Scalar _tmp14 = _tmp0 * _tmp13;
  const Scalar _tmp15 = std::pow(fh3, Scalar(-2));
  const Scalar _tmp16 =
      std::pow(Scalar(_tmp15 * std::pow(fv3, Scalar(2)) + 1), Scalar(Scalar(-1) / Scalar(2)));
  ...
  _res(2, 0) =
      -Scalar(9.6622558468725703) * fh3 *
          (Scalar(1.0) * _tmp15 * _tmp16 * fv3 * std::cosh(_tmp17) -
