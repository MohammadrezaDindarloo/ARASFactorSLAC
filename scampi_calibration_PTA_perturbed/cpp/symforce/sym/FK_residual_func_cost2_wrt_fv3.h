 ...
 *
 * Symbolic function: FK_residual_func_cost2_wrt_fv3
 *
 * Args:
 *     fh1: Scalar
 *     fv1: Scalar
...
Eigen::Matrix<Scalar, 4, 1> FkResidualFuncCost2WrtFv3(
  ...
  const Scalar _tmp0 = Scalar(1.0) / (fh3);
  ...
  const Scalar _tmp7 = 2 * _tmp1 * _tmp4;
  const Scalar _tmp8 = _tmp2 * _tmp6;
  const Scalar _tmp9 = std::asinh(_tmp0 * fv3);
  const Scalar _tmp10 = Scalar(9.6622558468725703) * fh3;
  const Scalar _tmp11 = Scalar(1.0) * _tmp0 /
                        std::sqrt(Scalar(1 + std::pow(fv3, Scalar(2)) / std::pow(fh3, Scalar(2))));
  ...
  _res(2, 0) =
      -_tmp10 *
      (-_tmp11 * std::cosh(Scalar(1.0) * _tmp9) +
       _tmp11 *
           std::cosh(Scalar(0.1034955) * _tmp0 *
                     (-_tmp10 * _tmp9 -
                      std::sqrt(Scalar(
                          std::pow(Scalar(Scalar(0.41999999999999998) * std::pow(_tmp1, Scalar(2)) +
                                          Scalar(0.010999999999999999) * _tmp1 * _tmp6 -
                                          Scalar(0.20999999999999999) * _tmp3 +
                                          Scalar(0.010999999999999999) * _tmp4 * _tmp5 -
                                          Scalar(0.20999999999999999) * _tmp7 +
                                          Scalar(0.20999999999999999) * _tmp8 + p_c(0, 0) -
                                          position_vector(0, 0)),
                                   Scalar(2)) +
                          std::pow(Scalar(Scalar(0.010999999999999999) * _tmp1 * _tmp5 -
                                          Scalar(0.20999999999999999) * _tmp3 +
                                          Scalar(0.41999999999999998) * std::pow(_tmp4, Scalar(2)) -
                                          Scalar(0.010999999999999999) * _tmp4 * _tmp6 -
                                          Scalar(0.20999999999999999) * _tmp7 -
                                          Scalar(0.20999999999999999) * _tmp8 + p_c(1, 0) -
                                          position_vector(1, 0)),
                                   Scalar(2)))))));
