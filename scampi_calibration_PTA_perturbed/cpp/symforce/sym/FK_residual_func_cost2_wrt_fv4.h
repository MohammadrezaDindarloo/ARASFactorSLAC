 ...
 *
 * Symbolic function: FK_residual_func_cost2_wrt_fv4
 *
 * Args:
 *     fh1: Scalar
 *     fv1: Scalar
...
Eigen::Matrix<Scalar, 4, 1> FkResidualFuncCost2WrtFv4(
  ...
  const Scalar _tmp1 = std::asinh(_tmp0 * fv4);
  const Scalar _tmp2 = Scalar(1.0) * _tmp0 /
                       std::sqrt(Scalar(1 + std::pow(fv4, Scalar(2)) / std::pow(fh4, Scalar(2))));
  ...
  const Scalar _tmp11 = 2 * _tmp4 * _tmp8;
  const Scalar _tmp12 = Scalar(9.6622558468725703) * fh4;
                     ...
                     (-_tmp1 * _tmp12 -
                      std::sqrt(Scalar(
                          std::pow(Scalar(-Scalar(0.20999999999999999) * _tmp10 +
                                          Scalar(0.20999999999999999) * _tmp11 -
                                          Scalar(0.41999999999999998) * std::pow(_tmp3, Scalar(2)) +
                                          Scalar(0.010999999999999999) * _tmp4 * _tmp7 +
                                          Scalar(0.20999999999999999) * _tmp5 +
                                          Scalar(0.010999999999999999) * _tmp8 * _tmp9 + p_d(0, 0) -
                                          position_vector(0, 0)),
                                   Scalar(2)) +
                          std::pow(Scalar(Scalar(0.20999999999999999) * _tmp10 +
                                          Scalar(0.20999999999999999) * _tmp11 +
                                          Scalar(0.010999999999999999) * _tmp4 * _tmp9 -
                                          Scalar(0.20999999999999999) * _tmp5 +
                                          Scalar(0.41999999999999998) * std::pow(_tmp6, Scalar(2)) -
                                          Scalar(0.010999999999999999) * _tmp7 * _tmp8 + p_d(1, 0) -
                                          position_vector(1, 0)),
                                   Scalar(2)))))));
