...
Eigen::Matrix<Scalar, 4, 1> FkResidualFuncCost3(
  ...
  const Scalar _tmp24 = _tmp23 - p_b(1, 0) + position_vector(1, 0);
  ...
  const Scalar _tmp28 = Scalar(0.20999999999999999) * _tmp19 + Scalar(0.20999999999999999) * _tmp2 +
  ...
  const Scalar _tmp47 = _tmp18 + _tmp36;
  ...
  const Scalar _tmp54 = _tmp11 + _tmp44;
  const Scalar _tmp55 = _tmp48 * _tmp51;
  const Scalar _tmp56 = -_tmp33 * _tmp53 + _tmp54 * _tmp55;
  const Scalar _tmp57 = _tmp33 * _tmp43 - _tmp46;
  const Scalar _tmp58 = Scalar(1.0) / (_tmp33 * _tmp52 - _tmp55);
  ...
  const Scalar _tmp64 = _tmp15 * _tmp43 - _tmp43 * _tmp45 - _tmp59 * _tmp63 -
                        _tmp62 * (-_tmp34 * _tmp43 + _tmp45 * _tmp46 - _tmp56 * _tmp59);
  ...
  const Scalar _tmp69 =
      std::sqrt(Scalar(std::pow(_tmp24, Scalar(2)) + std::pow(_tmp31, Scalar(2))));
  const Scalar _tmp70 = _tmp32 * _tmp69;
  const Scalar _tmp71 = Scalar(1.0) / (_tmp69);
  const Scalar _tmp72 = _tmp70 * (-_tmp23 * _tmp31 * _tmp71 + _tmp24 * _tmp30 * _tmp71);
  const Scalar _tmp73 = _tmp47 * _tmp52 - _tmp49 * _tmp55 + _tmp52 * _tmp72;
  const Scalar _tmp74 = _tmp33 * _tmp58;
  const Scalar _tmp75 = -_tmp15 - _tmp62 * (_tmp34 + _tmp56 * _tmp74) + _tmp63 * _tmp74;
  const Scalar _tmp76 = _tmp37 * _tmp43 - _tmp40 * _tmp46 + _tmp43 * _tmp72 - _tmp59 * _tmp73;
  ...
  const Scalar _tmp81 = _tmp43 * _tmp65;
  const Scalar _tmp82 = _tmp57 * _tmp65;
  const Scalar _tmp83 = -_tmp33 - _tmp80 * _tmp82;
  const Scalar _tmp84 = _tmp52 * _tmp58;
  const Scalar _tmp85 = _tmp26 + _tmp39;
  ...
  const Scalar _tmp93 = _tmp56 * _tmp62 * _tmp92 - _tmp63 * _tmp92;
  ...
  _res(1, 0) = std::exp(_tmp0 * _tmp70 * (_tmp43 * _tmp67 - _tmp67 * _tmp68) +
                        _tmp70 * _tmp98 * (_tmp43 * _tmp97 - _tmp68 * _tmp97) +
                        _tmp90 * _tmp91 * (_tmp80 * _tmp81 + _tmp83 * _tmp84 + Scalar(1.0)) +
                        _tmp91 * _tmp96 * (_tmp81 * _tmp94 + _tmp84 * _tmp95));
  _res(2, 0) = std::exp(-_tmp100 * _tmp83 * _tmp90 - _tmp100 * _tmp95 * _tmp96 + _tmp101 * _tmp59 +
                        _tmp59 * _tmp99);
  _res(3, 0) = std::exp(-_tmp101 - _tmp102 * _tmp80 * _tmp90 - _tmp102 * _tmp94 * _tmp96 - _tmp99);
