 ...
 *
 * Symbolic function: FK_residual_func_cost4_wrt_fh4
 *
 * Args:
 *     fh1: Scalar
 *     fv1: Scalar
...
Eigen::Matrix<Scalar, 4, 1> FkResidualFuncCost4WrtFh4(
  ...
  _res(3, 0) = fh4 / std::sqrt(Scalar(std::pow(fh4, Scalar(2)) + std::pow(fv4, Scalar(2))));
