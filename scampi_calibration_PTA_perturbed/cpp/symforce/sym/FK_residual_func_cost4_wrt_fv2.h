 ...
 *
 * Symbolic function: FK_residual_func_cost4_wrt_fv2
 *
 * Args:
 *     fh1: Scalar
 *     fv1: Scalar
...
Eigen::Matrix<Scalar, 4, 1> FkResidualFuncCost4WrtFv2(
  ...
  _res(1, 0) = fv2 / std::sqrt(Scalar(std::pow(fh2, Scalar(2)) + std::pow(fv2, Scalar(2))));
