 ...
 *
 * Symbolic function: FK_residual_func_cost4_wrt_fv3
 *
 * Args:
 *     fh1: Scalar
 *     fv1: Scalar
...
Eigen::Matrix<Scalar, 4, 1> FkResidualFuncCost4WrtFv3(
  ...
  _res(2, 0) = fv3 / std::sqrt(Scalar(std::pow(fh3, Scalar(2)) + std::pow(fv3, Scalar(2))));
