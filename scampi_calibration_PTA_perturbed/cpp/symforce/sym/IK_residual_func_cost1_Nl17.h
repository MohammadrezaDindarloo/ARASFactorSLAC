...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl17(
  ...
  const Scalar _tmp27 = Scalar(0.20999999999999999) * _tmp6 + Scalar(0.20999999999999999) * _tmp9;
  ...
  const Scalar _tmp70 = _tmp69 * (-_tmp38 * _tmp44 * _tmp68 + _tmp40 * _tmp42 * _tmp68);
  const Scalar _tmp71 = _tmp61 * _tmp65;
  const Scalar _tmp72 = _tmp59 * _tmp66 - _tmp62 * _tmp71 + _tmp66 * _tmp70;
  const Scalar _tmp73 = Scalar(1.0) / (_tmp46 * _tmp66 - _tmp71);
  const Scalar _tmp74 = _tmp46 * _tmp73;
  const Scalar _tmp75 = -_tmp32;
  ...
  const Scalar _tmp80 = -_tmp66 * _tmp79 + _tmp77;
  const Scalar _tmp81 = -_tmp46 * _tmp77 + _tmp71 * _tmp79;
  const Scalar _tmp82 = _tmp46 * _tmp76 + _tmp74 * _tmp81;
  ...
  const Scalar _tmp88 = _tmp74 * _tmp80 - _tmp76 - _tmp82 * _tmp87;
  const Scalar _tmp89 = _tmp56 * _tmp76;
  const Scalar _tmp90 = _tmp75 + _tmp78;
  const Scalar _tmp91 = _tmp58 * _tmp73;
  const Scalar _tmp92 = -_tmp46 * _tmp89 + _tmp57 * _tmp90 - _tmp81 * _tmp91;
  const Scalar _tmp93 = -_tmp56 * _tmp90 - _tmp80 * _tmp91 - _tmp87 * _tmp92 + _tmp89;
  const Scalar _tmp94 = Scalar(1.0) / (_tmp93);
  const Scalar _tmp95 = -_tmp48 * _tmp57 + _tmp52 * _tmp56 + _tmp56 * _tmp70 - _tmp72 * _tmp91;
  const Scalar _tmp96 = _tmp94 * _tmp95;
  const Scalar _tmp97 = Scalar(1.0) / (_tmp95);
  const Scalar _tmp98 = _tmp93 * _tmp97;
  const Scalar _tmp99 = _tmp98 * (-_tmp70 + _tmp72 * _tmp74 - _tmp88 * _tmp96);
  const Scalar _tmp100 = _tmp94 * (_tmp88 + _tmp99);
  ...
  const Scalar _tmp109 = _tmp66 * _tmp91;
  const Scalar _tmp110 = _tmp104 * _tmp105;
  const Scalar _tmp111 = fh1 * (-_tmp106 * _tmp29 + _tmp110 * _tmp19);
  const Scalar _tmp112 = Scalar(1.0) * _tmp73;
  const Scalar _tmp113 = _tmp112 * _tmp81;
  const Scalar _tmp114 = -_tmp112 * _tmp80 + _tmp113 * _tmp87;
  const Scalar _tmp115 = _tmp98 * (-_tmp112 * _tmp72 - _tmp114 * _tmp96);
  const Scalar _tmp116 = _tmp114 + _tmp115;
  const Scalar _tmp117 = _tmp116 * _tmp94;
  const Scalar _tmp118 = -_tmp117 * _tmp58 + Scalar(1.0);
  const Scalar _tmp119 = _tmp110 * fh1;
  const Scalar _tmp120 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp121 = _tmp83 * _tmp87 + _tmp86;
  const Scalar _tmp122 = 0;
  const Scalar _tmp123 = _tmp122 * _tmp94;
  const Scalar _tmp124 = -_tmp107 * _tmp69 * (_tmp100 * _tmp56 + _tmp101 * _tmp102 + Scalar(1.0)) -
                         _tmp111 * _tmp69 * (-_tmp108 * _tmp109 + _tmp108 * _tmp56) -
                         _tmp119 * _tmp69 * (_tmp102 * _tmp118 + _tmp117 * _tmp56) -
                         _tmp120 * _tmp69 * (-_tmp109 * _tmp123 + _tmp123 * _tmp56);
  const Scalar _tmp125 = Scalar(1.0) / (_tmp124);
  const Scalar _tmp126 = _tmp36 * fh1;
  const Scalar _tmp127 = _tmp106 * _tmp126 + Scalar(3.29616) * _tmp16 + _tmp19 * fv1;
  const Scalar _tmp128 = _tmp52 + _tmp84;
  const Scalar _tmp129 = _tmp128 * _tmp87;
  const Scalar _tmp130 = Scalar(1.0) / (-_tmp129 - _tmp48 + _tmp86);
  const Scalar _tmp131 = Scalar(1.0) * _tmp130;
  const Scalar _tmp132 = _tmp128 * _tmp131;
  const Scalar _tmp133 = _tmp128 * _tmp130;
  const Scalar _tmp134 = -_tmp100 * _tmp92 + _tmp133 * _tmp99 + _tmp82;
  const Scalar _tmp135 = Scalar(1.0) * _tmp85;
  const Scalar _tmp136 = -_tmp110 * _tmp126 - Scalar(3.29616) * _tmp25 - _tmp29 * fv1;
  const Scalar _tmp137 = _tmp85 * (_tmp129 * _tmp131 + Scalar(1.0));
  const Scalar _tmp138 = _tmp131 * _tmp87;
  const Scalar _tmp139 = _tmp92 * _tmp94;
  const Scalar _tmp140 = _tmp121 * _tmp130;
  const Scalar _tmp141 = -_tmp122 * _tmp139 - _tmp128 * _tmp140 + _tmp84;
  const Scalar _tmp142 = _tmp131 * _tmp98;
  const Scalar _tmp143 = -_tmp108 * _tmp92 + _tmp132 * _tmp98;
  const Scalar _tmp144 = -_tmp113 + _tmp115 * _tmp133 - _tmp116 * _tmp139;
  const Scalar _tmp145 = std::asinh(
      _tmp125 * (Scalar(1.0) * _tmp107 * (_tmp131 * _tmp99 - _tmp134 * _tmp135) +
                 Scalar(1.0) * _tmp111 * (-_tmp135 * _tmp143 + _tmp142) +
                 Scalar(1.0) * _tmp119 * (_tmp115 * _tmp131 - _tmp135 * _tmp144) +
                 Scalar(1.0) * _tmp120 * (-_tmp121 * _tmp131 - _tmp135 * _tmp141 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp127 * (-_tmp131 + _tmp132 * _tmp85) +
                 Scalar(1.0) * _tmp136 * (-Scalar(1.0) * _tmp137 + _tmp138)));
  const Scalar _tmp146 = Scalar(0.1034955) * _tmp125;
  const Scalar _tmp147 = Scalar(9.6622558468725703) * _tmp124;
  const Scalar _tmp148 = _tmp120 * _tmp123;
  const Scalar _tmp149 = _tmp108 * _tmp111;
  const Scalar _tmp150 =
      _tmp101 * _tmp107 * _tmp73 + _tmp118 * _tmp119 * _tmp73 - _tmp148 * _tmp91 - _tmp149 * _tmp91;
  const Scalar _tmp151 = Scalar(1.0) / (_tmp150);
  const Scalar _tmp152 = _tmp127 * _tmp131;
  const Scalar _tmp153 =
      std::asinh(_tmp151 * (_tmp107 * _tmp134 * _tmp85 + _tmp111 * _tmp143 * _tmp85 +
                            _tmp119 * _tmp144 * _tmp85 + _tmp120 * _tmp141 * _tmp85 -
                            _tmp128 * _tmp152 * _tmp85 + _tmp136 * _tmp137));
  const Scalar _tmp154 = Scalar(9.6622558468725703) * _tmp150;
  const Scalar _tmp155 = Scalar(0.1034955) * _tmp151;
  const Scalar _tmp156 = _tmp100 * _tmp107 + _tmp117 * _tmp119 + _tmp148 + _tmp149;
  const Scalar _tmp157 = Scalar(1.0) / (_tmp156);
  const Scalar _tmp158 = std::asinh(_tmp157 * (-_tmp107 * _tmp130 * _tmp99 - _tmp111 * _tmp142 -
                                               _tmp115 * _tmp119 * _tmp130 + _tmp120 * _tmp140 -
                                               _tmp136 * _tmp138 + _tmp152));
  ...
  _res(1, 0) =
      -_tmp147 *
          (_tmp146 * p_d(2, 0) + std::cosh(Scalar(1.0) * _tmp145) -
           std::cosh(_tmp146 *
                     (-_tmp145 * _tmp147 -
                      std::sqrt(Scalar(std::pow(Scalar(-_tmp39 + p_d(1, 0)), Scalar(2)) +
  ...
  _res(2, 0) =
      -_tmp154 *
          (_tmp155 * p_b(2, 0) + std::cosh(Scalar(1.0) * _tmp153) -
           std::cosh(_tmp155 *
                     (-_tmp153 * _tmp154 -
                      std::sqrt(Scalar(std::pow(Scalar(-_tmp60 + p_b(1, 0)), Scalar(2)) +
