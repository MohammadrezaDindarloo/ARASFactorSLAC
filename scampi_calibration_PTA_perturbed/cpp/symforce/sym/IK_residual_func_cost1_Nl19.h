...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl19(
  ...
  const Scalar _tmp63 = _tmp43 * _tmp49;
  const Scalar _tmp64 = _tmp10 + _tmp45;
  ...
  const Scalar _tmp77 = _tmp50 * _tmp62 - _tmp63;
  const Scalar _tmp78 = _tmp76 * _tmp77;
  const Scalar _tmp79 = -_tmp53 * _tmp62 + _tmp54 * _tmp63 - _tmp75 * _tmp78;
  ...
  const Scalar _tmp86 = -_tmp50 * _tmp54 + _tmp53 - _tmp78 * _tmp85 - _tmp79 * _tmp84;
  ...
  const Scalar _tmp94 = _tmp92 * (-_tmp55 * _tmp60 * _tmp93 + _tmp57 * _tmp58 * _tmp93);
  const Scalar _tmp95 = -_tmp64 * _tmp74 + _tmp67 * _tmp71 + _tmp71 * _tmp94;
  const Scalar _tmp96 = _tmp41 * _tmp50 - _tmp46 * _tmp63 + _tmp50 * _tmp94 - _tmp78 * _tmp95;
  const Scalar _tmp97 = Scalar(1.0) / (_tmp96);
  const Scalar _tmp98 = Scalar(1.0) * _tmp97;
  const Scalar _tmp99 = Scalar(1.0) * _tmp76;
  const Scalar _tmp100 = _tmp77 * _tmp97 * _tmp99;
  const Scalar _tmp101 = _tmp31 - p_d(1, 0);
  const Scalar _tmp102 = _tmp20 - p_d(0, 0);
  ...
  const Scalar _tmp106 = fh1 * (-_tmp104 * _tmp30 + _tmp105 * _tmp19);
  const Scalar _tmp107 = _tmp75 * _tmp99;
  const Scalar _tmp108 = _tmp107 * _tmp84 - _tmp85 * _tmp99;
  ...
  const Scalar _tmp113 = _tmp50 * _tmp87;
  const Scalar _tmp114 = _tmp77 * _tmp87;
  const Scalar _tmp115 = -_tmp112 * _tmp114 + Scalar(1.0);
  const Scalar _tmp116 = _tmp71 * _tmp76;
  const Scalar _tmp117 = _tmp105 * fh1;
  const Scalar _tmp118 = _tmp62 * _tmp76;
  const Scalar _tmp119 = _tmp118 * _tmp75 + _tmp52 * _tmp62;
  const Scalar _tmp120 = _tmp118 * _tmp85 - _tmp119 * _tmp84 - _tmp52;
  const Scalar _tmp121 = _tmp110 * (-_tmp109 * _tmp120 + _tmp118 * _tmp95 - _tmp94);
  const Scalar _tmp122 = _tmp120 + _tmp121;
  const Scalar _tmp123 = -_tmp114 * _tmp122 - _tmp62;
  const Scalar _tmp124 = _tmp104 * fh1;
  const Scalar _tmp125 = -_tmp106 * _tmp92 * (-_tmp100 * _tmp71 + _tmp50 * _tmp98) -
                         _tmp117 * _tmp92 * (_tmp112 * _tmp113 + _tmp115 * _tmp116) -
                         _tmp124 * _tmp92 * (_tmp113 * _tmp122 + _tmp116 * _tmp123 + Scalar(1.0)) -
                         _tmp39 * _tmp92 * (_tmp50 * _tmp90 - _tmp71 * _tmp78 * _tmp90);
  const Scalar _tmp126 = Scalar(1.0) / (_tmp125);
  const Scalar _tmp127 = _tmp41 + _tmp81;
  ...
  const Scalar _tmp133 = -_tmp107 + _tmp111 * _tmp132 - _tmp112 * _tmp131;
  const Scalar _tmp134 = Scalar(1.0) * _tmp82;
  const Scalar _tmp135 = _tmp129 * _tmp88;
  const Scalar _tmp136 = -_tmp127 * _tmp135 - _tmp131 * _tmp89 + _tmp81;
  const Scalar _tmp137 = _tmp38 * fh1;
  const Scalar _tmp138 = _tmp104 * _tmp137 + Scalar(3.29616) * _tmp16 + _tmp19 * fv1;
  const Scalar _tmp139 = _tmp127 * _tmp130;
  const Scalar _tmp140 = _tmp110 * _tmp130;
  const Scalar _tmp141 = _tmp110 * _tmp139 - _tmp79 * _tmp98;
  const Scalar _tmp142 = _tmp119 + _tmp121 * _tmp132 - _tmp122 * _tmp131;
  const Scalar _tmp143 = _tmp130 * _tmp84;
  const Scalar _tmp144 = _tmp82 * (_tmp128 * _tmp130 + Scalar(1.0));
  const Scalar _tmp145 = -_tmp105 * _tmp137 - Scalar(3.29616) * _tmp25 - _tmp30 * fv1;
  const Scalar _tmp146 = std::asinh(
      _tmp126 * (Scalar(1.0) * _tmp106 * (-_tmp134 * _tmp141 + _tmp140) +
                 Scalar(1.0) * _tmp117 * (_tmp111 * _tmp130 - _tmp133 * _tmp134) +
                 Scalar(1.0) * _tmp124 * (_tmp121 * _tmp130 - _tmp134 * _tmp142) +
                 Scalar(1.0) * _tmp138 * (-_tmp130 + _tmp139 * _tmp82) +
                 Scalar(1.0) * _tmp145 * (_tmp143 - Scalar(1.0) * _tmp144) +
                 Scalar(1.0) * _tmp39 * (-_tmp130 * _tmp88 - _tmp134 * _tmp136 + Scalar(1.0))));
  ...
  const Scalar _tmp150 = _tmp39 * _tmp90;
  const Scalar _tmp151 = -_tmp100 * _tmp106 + _tmp115 * _tmp117 * _tmp76 +
                         _tmp123 * _tmp124 * _tmp76 - _tmp150 * _tmp78;
  const Scalar _tmp152 = Scalar(1.0) / (_tmp151);
  const Scalar _tmp153 =
      std::asinh(_tmp152 * (_tmp106 * _tmp141 * _tmp82 + _tmp117 * _tmp133 * _tmp82 +
                            _tmp124 * _tmp142 * _tmp82 - _tmp127 * _tmp149 * _tmp82 +
                            _tmp136 * _tmp39 * _tmp82 + _tmp144 * _tmp145));
  const Scalar _tmp154 = Scalar(9.6622558468725703) * _tmp151;
  const Scalar _tmp155 = Scalar(0.1034955) * _tmp152;
  const Scalar _tmp156 =
      _tmp106 * _tmp98 + _tmp112 * _tmp117 * _tmp87 + _tmp122 * _tmp124 * _tmp87 + _tmp150;
  const Scalar _tmp157 = Scalar(1.0) / (_tmp156);
  const Scalar _tmp158 = std::asinh(_tmp157 * (-_tmp106 * _tmp140 - _tmp111 * _tmp117 * _tmp129 -
                                               _tmp121 * _tmp124 * _tmp129 + _tmp135 * _tmp39 -
