...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1WrtFv1Nl9(
  ...
  const Scalar _tmp47 = _tmp40 + _tmp7;
  ...
  const Scalar _tmp58 = _tmp36 * _tmp45 - _tmp41 * _tmp46 + _tmp45 * _tmp57;
  ...
  const Scalar _tmp70 = -_tmp45 * _tmp67 + _tmp46 * _tmp69;
  const Scalar _tmp71 = _tmp61 * _tmp70 + _tmp67;
  const Scalar _tmp72 = Scalar(1.0) * _tmp50;
  const Scalar _tmp73 = -_tmp72;
  const Scalar _tmp74 = Scalar(1.0) / (_tmp36 + _tmp73);
  const Scalar _tmp75 = Scalar(1.0) * _tmp47;
  const Scalar _tmp76 = _tmp74 * (-_tmp41 + _tmp75);
  const Scalar _tmp77 = _tmp45 * _tmp66 - _tmp45 * _tmp69;
  const Scalar _tmp78 = _tmp61 * _tmp77 - _tmp66 - _tmp71 * _tmp76;
  const Scalar _tmp79 = _tmp18 + _tmp39;
  ...
  const Scalar _tmp88 = _tmp59 * _tmp86 - _tmp87;
  const Scalar _tmp89 = _tmp60 * _tmp88;
  const Scalar _tmp90 = _tmp57 * _tmp86 - _tmp58 * _tmp89 - _tmp79 * _tmp87 + _tmp82 * _tmp86;
  const Scalar _tmp91 = _tmp63 - _tmp64;
  const Scalar _tmp92 = _tmp68 + _tmp91;
  const Scalar _tmp93 = _tmp66 * _tmp86;
  const Scalar _tmp94 = -_tmp59 * _tmp93 - _tmp70 * _tmp89 + _tmp87 * _tmp92;
  const Scalar _tmp95 = -_tmp76 * _tmp94 - _tmp77 * _tmp89 - _tmp86 * _tmp92 + _tmp93;
  ...
  const Scalar _tmp100 = _tmp99 * (-_tmp57 + _tmp58 * _tmp61 - _tmp78 * _tmp97);
  const Scalar _tmp101 = _tmp100 + _tmp78;
  const Scalar _tmp102 = _tmp86 * _tmp96;
  const Scalar _tmp103 = _tmp88 * _tmp96;
  const Scalar _tmp104 = -_tmp101 * _tmp103 - _tmp59;
  ...
  const Scalar _tmp113 = -_tmp111 * _tmp77 + _tmp112 * _tmp76;
  const Scalar _tmp114 = _tmp99 * (-_tmp111 * _tmp58 - _tmp113 * _tmp97);
  ...
  const Scalar _tmp123 = _tmp103 * _tmp121;
  const Scalar _tmp124 = _tmp56 * (-_tmp105 * _tmp123 + _tmp122 * _tmp86);
  const Scalar _tmp125 = Scalar(1.0) * _tmp98;
  const Scalar _tmp126 = fh1 * (-_tmp109 * _tmp31 + _tmp117 * _tmp19);
  const Scalar _tmp127 = -_tmp110 * _tmp56 * (_tmp101 * _tmp102 + _tmp104 * _tmp105 + Scalar(1.0)) -
                         _tmp118 * _tmp56 * (_tmp102 * _tmp115 + _tmp105 * _tmp116) -
                         _tmp119 * _tmp124 -
                         _tmp126 * _tmp56 * (-_tmp125 * _tmp45 * _tmp89 + _tmp125 * _tmp86);
  ...
  const Scalar _tmp135 = _tmp74 * (-_tmp121 * _tmp134 - _tmp130 * _tmp133 + _tmp73);
  const Scalar _tmp136 = -Scalar(1.0) * _tmp133 - Scalar(1.0) * _tmp135 + Scalar(1.0);
  const Scalar _tmp137 = fh1 * (_tmp62 + _tmp91);
  const Scalar _tmp138 = -_tmp117 * _tmp137 - Scalar(3.29616) * _tmp26 - _tmp31 * fv1;
  const Scalar _tmp139 = Scalar(1.0) * _tmp132;
  const Scalar _tmp140 = _tmp74 * (_tmp131 * _tmp139 + Scalar(1.0));
  const Scalar _tmp141 = _tmp139 * _tmp76;
  const Scalar _tmp142 = -Scalar(1.0) * _tmp140 + Scalar(1.0) * _tmp141;
  const Scalar _tmp143 = _tmp109 * _tmp137 + Scalar(3.29616) * _tmp12 + _tmp19 * fv1;
  const Scalar _tmp144 = _tmp130 * _tmp74;
  const Scalar _tmp145 = Scalar(1.0) * _tmp139 * _tmp144 - Scalar(1.0) * _tmp139;
  const Scalar _tmp146 = _tmp139 * _tmp99;
  const Scalar _tmp147 = -_tmp125 * _tmp94 + _tmp130 * _tmp146;
  const Scalar _tmp148 = Scalar(1.0) * _tmp74;
  const Scalar _tmp149 = _tmp130 * _tmp132;
  const Scalar _tmp150 = -_tmp112 + _tmp114 * _tmp149 - _tmp115 * _tmp134;
  const Scalar _tmp151 = _tmp100 * _tmp149 - _tmp101 * _tmp134 + _tmp71;
  const Scalar _tmp152 = Scalar(1.0) * _tmp110 * (_tmp100 * _tmp139 - _tmp148 * _tmp151) +
                         Scalar(1.0) * _tmp118 * (_tmp114 * _tmp139 - _tmp148 * _tmp150) +
                         _tmp119 * _tmp136 + Scalar(1.0) * _tmp126 * (_tmp146 - _tmp147 * _tmp148) +
                         _tmp138 * _tmp142 + _tmp143 * _tmp145;
  ...
  const Scalar _tmp159 = _tmp22 + _tmp27 + _tmp34;
  const Scalar _tmp160 = std::pow(_tmp127, Scalar(-2));
  const Scalar _tmp161 = _tmp124 * _tmp160;
  const Scalar _tmp162 =
      (_tmp128 * (-_tmp136 + _tmp142 * _tmp159 + _tmp145 * _tmp19) - _tmp152 * _tmp161) /
      std::sqrt(Scalar(std::pow(_tmp152, Scalar(2)) * _tmp160 + 1));
  const Scalar _tmp163 = Scalar(0.1034955) * _tmp161;
  const Scalar _tmp164 = _tmp139 * _tmp143;
  const Scalar _tmp165 = _tmp110 * _tmp151 * _tmp74 + _tmp118 * _tmp150 * _tmp74 +
                         _tmp119 * _tmp135 + _tmp126 * _tmp147 * _tmp74 + _tmp138 * _tmp140 -
                         _tmp144 * _tmp164;
  const Scalar _tmp166 = _tmp125 * _tmp126;
  const Scalar _tmp167 = _tmp123 * _tmp60;
  const Scalar _tmp168 = _tmp104 * _tmp110 * _tmp60 + _tmp116 * _tmp118 * _tmp60 -
                         _tmp119 * _tmp167 - _tmp166 * _tmp89;
  ...
  const Scalar _tmp172 = Scalar(0.1034955) * _tmp169;
  const Scalar _tmp173 = Scalar(9.6622558468725703) * _tmp168;
  const Scalar _tmp174 =
      -_tmp170 * _tmp173 - std::sqrt(Scalar(std::pow(Scalar(-_tmp37 + p_d(1, 0)), Scalar(2)) +
  ...
  const Scalar _tmp180 = _tmp139 * _tmp19;
  const Scalar _tmp181 =
      (-_tmp165 * _tmp178 + _tmp169 * (-_tmp135 + _tmp140 * _tmp159 - _tmp144 * _tmp180)) /
      std::sqrt(Scalar(std::pow(_tmp165, Scalar(2)) * _tmp177 + 1));
  const Scalar _tmp182 = -_tmp100 * _tmp110 * _tmp132 - _tmp114 * _tmp118 * _tmp132 +
                         _tmp119 * _tmp133 - _tmp126 * _tmp146 - _tmp138 * _tmp141 + _tmp164;
  const Scalar _tmp183 =
      _tmp101 * _tmp110 * _tmp96 + _tmp115 * _tmp118 * _tmp96 + _tmp119 * _tmp122 + _tmp166;
  ...
  const Scalar _tmp188 =
      -_tmp185 * _tmp187 - std::sqrt(Scalar(std::pow(Scalar(-_tmp80 + p_a(0, 0)), Scalar(2)) +
                                            std::pow(Scalar(-_tmp83 + p_a(1, 0)), Scalar(2))));
  const Scalar _tmp189 = Scalar(0.1034955) * _tmp184;
  const Scalar _tmp190 = _tmp188 * _tmp189;
  const Scalar _tmp191 = Scalar(9.6622558468725703) * _tmp122;
  ...
  const Scalar _tmp195 = (_tmp182 * _tmp193 + _tmp184 * (-_tmp133 - _tmp141 * _tmp159 + _tmp180)) /
  ...
  _res(1, 0) =
      -_tmp154 * (Scalar(1.0) * _tmp162 * std::sinh(_tmp157) - _tmp163 * p_c(2, 0) -
                  (_tmp129 * (-_tmp153 * _tmp158 - _tmp154 * _tmp162) - _tmp155 * _tmp163) *
                      std::sinh(_tmp156)) -
      _tmp158 * (_tmp129 * p_c(2, 0) - std::cosh(_tmp156) + std::cosh(_tmp157));
  _res(2, 0) =
      -_tmp173 * (-_tmp179 * p_d(2, 0) + Scalar(1.0) * _tmp181 * std::sinh(_tmp171) -
                  (_tmp172 * (-_tmp170 * _tmp176 - _tmp173 * _tmp181) - _tmp174 * _tmp179) *
                      std::sinh(_tmp175)) -
      _tmp176 * (_tmp172 * p_d(2, 0) + std::cosh(_tmp171) - std::cosh(_tmp175));
  _res(3, 0) = -_tmp187 * (_tmp194 * p_a(2, 0) + Scalar(1.0) * _tmp195 * std::sinh(_tmp186) -
                           (_tmp188 * _tmp194 + _tmp189 * (_tmp185 * _tmp191 - _tmp187 * _tmp195)) *
                               std::sinh(_tmp190)) +
               _tmp191 * (_tmp189 * p_a(2, 0) + std::cosh(_tmp186) - std::cosh(_tmp190));
