...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl16(
  ...
  const Scalar _tmp60 = _tmp44 - p_d(1, 0);
  const Scalar _tmp61 = _tmp41 - p_d(0, 0);
  ...
  const Scalar _tmp67 = -_tmp56 * _tmp63 + _tmp58 * _tmp64;
  ...
  const Scalar _tmp73 = _tmp71 * (-_tmp47 + _tmp72);
  const Scalar _tmp74 = -_tmp59 * _tmp66 + _tmp68 * _tmp73;
  const Scalar _tmp75 = _tmp26 + _tmp50;
  const Scalar _tmp76 = _tmp75 + p_init1;
  const Scalar _tmp77 = _tmp76 - p_b(1, 0);
  const Scalar _tmp78 = _tmp23 + _tmp46;
  ...
  const Scalar _tmp87 = _tmp57 + _tmp7;
  const Scalar _tmp88 = -_tmp63 * _tmp86 - _tmp67 * _tmp85 + _tmp83 * _tmp87;
  const Scalar _tmp89 = -_tmp59 * _tmp85 - _tmp73 * _tmp88 - _tmp82 * _tmp87 + _tmp86;
  ...
  const Scalar _tmp95 = -_tmp47 * _tmp64 + _tmp51 * _tmp55 + _tmp55 * _tmp94;
  ...
  const Scalar _tmp101 = _tmp70 + _tmp75;
  const Scalar _tmp102 = _tmp101 * _tmp73;
  const Scalar _tmp103 = Scalar(1.0) / (-_tmp102 + _tmp72 - _tmp78);
  const Scalar _tmp104 = _tmp101 * _tmp103;
  const Scalar _tmp105 = _tmp100 + _tmp74;
  const Scalar _tmp106 = _tmp88 * _tmp90;
  const Scalar _tmp107 = _tmp100 * _tmp104 - _tmp105 * _tmp106 - _tmp68;
  ...
  const Scalar _tmp119 = -_tmp101 * _tmp117 - _tmp106 * _tmp118 + _tmp70;
  const Scalar _tmp120 = _tmp15 * fh1;
  const Scalar _tmp121 = -_tmp113 * _tmp120 - Scalar(3.29616) * _tmp27 - _tmp31 * fv1;
  const Scalar _tmp122 = _tmp102 * _tmp109 + Scalar(1.0);
  const Scalar _tmp123 = _tmp109 * _tmp73;
  const Scalar _tmp124 = _tmp63 * _tmp65;
  const Scalar _tmp125 = _tmp124 * _tmp67 + _tmp38 * _tmp63;
  const Scalar _tmp126 = _tmp124 * _tmp59 - _tmp125 * _tmp73 - _tmp38;
  const Scalar _tmp127 = _tmp99 * (_tmp124 * _tmp95 - _tmp126 * _tmp97 - _tmp94);
  const Scalar _tmp128 = _tmp126 + _tmp127;
  const Scalar _tmp129 = _tmp104 * _tmp127 - _tmp106 * _tmp128 + _tmp125;
  const Scalar _tmp130 = _tmp110 * _tmp112;
  const Scalar _tmp131 = _tmp130 * fh1;
  const Scalar _tmp132 = _tmp120 * _tmp130 + Scalar(3.29616) * _tmp19 + _tmp24 * fv1;
  const Scalar _tmp133 = _tmp101 * _tmp109;
  const Scalar _tmp134 = _tmp109 * _tmp99;
  const Scalar _tmp135 = Scalar(1.0) * _tmp98;
  const Scalar _tmp136 = _tmp133 * _tmp99 - _tmp135 * _tmp88;
  const Scalar _tmp137 = fh1 * (_tmp113 * _tmp24 - _tmp130 * _tmp31);
  const Scalar _tmp138 = _tmp82 * _tmp90;
  const Scalar _tmp139 = _tmp84 * _tmp90;
  const Scalar _tmp140 = -_tmp128 * _tmp139 - _tmp63;
  const Scalar _tmp141 = _tmp55 * _tmp65;
  const Scalar _tmp142 = _tmp66 * _tmp84 * _tmp98;
  const Scalar _tmp143 = -_tmp105 * _tmp139 + Scalar(1.0);
  const Scalar _tmp144 = _tmp118 * _tmp90;
  const Scalar _tmp145 = -_tmp114 * _tmp93 * (_tmp105 * _tmp138 + _tmp141 * _tmp143) -
                         _tmp115 * _tmp93 * (-_tmp144 * _tmp55 * _tmp85 + _tmp144 * _tmp82) -
                         _tmp131 * _tmp93 * (_tmp128 * _tmp138 + _tmp140 * _tmp141 + Scalar(1.0)) -
                         _tmp137 * _tmp93 * (_tmp135 * _tmp82 - _tmp142 * _tmp55);
  const Scalar _tmp146 = Scalar(1.0) / (_tmp145);
  const Scalar _tmp147 = std::asinh(
      _tmp146 * (Scalar(1.0) * _tmp114 * (_tmp100 * _tmp109 - _tmp107 * _tmp108) +
                 Scalar(1.0) * _tmp115 * (-_tmp108 * _tmp119 - _tmp109 * _tmp116 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp121 * (-_tmp108 * _tmp122 + _tmp123) +
                 Scalar(1.0) * _tmp131 * (-_tmp108 * _tmp129 + _tmp109 * _tmp127) +
                 Scalar(1.0) * _tmp132 * (-_tmp109 + _tmp133 * _tmp71) +
                 Scalar(1.0) * _tmp137 * (-_tmp108 * _tmp136 + _tmp134)));
  const Scalar _tmp148 = Scalar(9.6622558468725703) * _tmp145;
  const Scalar _tmp149 = _tmp109 * _tmp132;
  const Scalar _tmp150 = _tmp115 * _tmp144;
  const Scalar _tmp151 = _tmp114 * _tmp143 * _tmp65 + _tmp131 * _tmp140 * _tmp65 -
                         _tmp137 * _tmp142 - _tmp150 * _tmp85;
  const Scalar _tmp152 = Scalar(1.0) / (_tmp151);
  const Scalar _tmp153 =
      std::asinh(_tmp152 * (-_tmp101 * _tmp149 * _tmp71 + _tmp107 * _tmp114 * _tmp71 +
                            _tmp115 * _tmp119 * _tmp71 + _tmp121 * _tmp122 * _tmp71 +
                            _tmp129 * _tmp131 * _tmp71 + _tmp136 * _tmp137 * _tmp71));
  const Scalar _tmp154 = Scalar(9.6622558468725703) * _tmp151;
  const Scalar _tmp155 = std::pow(Scalar(-_tmp48 + p_a(0, 0)), Scalar(2)) +
                         std::pow(Scalar(-_tmp52 + p_a(1, 0)), Scalar(2));
  const Scalar _tmp156 =
      _tmp105 * _tmp114 * _tmp90 + _tmp128 * _tmp131 * _tmp90 + _tmp135 * _tmp137 + _tmp150;
  const Scalar _tmp157 = Scalar(1.0) / (_tmp156);
  const Scalar _tmp158 =
      std::asinh(_tmp157 * (-_tmp100 * _tmp103 * _tmp114 - _tmp103 * _tmp127 * _tmp131 +
                            _tmp115 * _tmp117 - _tmp121 * _tmp123 - _tmp134 * _tmp137 + _tmp149));
  const Scalar _tmp159 = Scalar(9.6622558468725703) * _tmp156;
  const Scalar _tmp160 = std::pow(Scalar(-_tmp76 + p_b(1, 0)), Scalar(2)) +
  ...
  _res(2, 0) =
      ...
      std::sqrt(Scalar(_tmp155 + std::pow(Scalar(-_tmp58 + p_a(2, 0) - p_init2), Scalar(2))));
  _res(3, 0) =
      _tmp159 *
          (-std::sinh(Scalar(1.0) * _tmp158) -
           std::sinh(Scalar(0.1034955) * _tmp157 * (-_tmp158 * _tmp159 - std::sqrt(_tmp160)))) -
      std::sqrt(Scalar(_tmp160 + std::pow(Scalar(-_tmp87 + p_b(2, 0) - p_init2), Scalar(2))));
