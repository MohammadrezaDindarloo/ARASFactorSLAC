...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2WrtFv1Nl23(
  ...
  const Scalar _tmp43 = _tmp22 + _tmp29 + _tmp42;
  ...
  const Scalar _tmp74 = Scalar(0.20999999999999999) * _tmp11 - Scalar(0.20999999999999999) * _tmp12;
  const Scalar _tmp75 = -Scalar(0.010999999999999999) * _tmp15 -
                        Scalar(0.010999999999999999) * _tmp23 + Scalar(-0.010999999999999999);
  const Scalar _tmp76 = Scalar(0.20999999999999999) * _tmp25 + Scalar(0.20999999999999999) * _tmp26;
  ...
  const Scalar _tmp112 = _tmp20 - p_d(0, 0);
  ...
  const Scalar _tmp135 = _tmp47 * (-_tmp108 * _tmp134 - _tmp133 * _tmp44 + _tmp41);
  ...
  const Scalar _tmp140 = fh1 * (-_tmp114 * _tmp31 + _tmp116 * _tmp19);
  ...
  const Scalar _tmp148 = _tmp68 * (_tmp146 * _tmp94 - _tmp147 * _tmp59);
  const Scalar _tmp149 = _tmp103 * _tmp125 * _tmp96;
  const Scalar _tmp150 = -_tmp107 * _tmp142 - _tmp71;
  const Scalar _tmp151 = -_tmp115 * _tmp68 * (_tmp107 * _tmp145 + _tmp144 * _tmp150 + Scalar(1.0)) -
                         _tmp130 * _tmp68 * (_tmp128 * _tmp145 + _tmp143 * _tmp144) -
                         _tmp131 * _tmp148 -
                         _tmp140 * _tmp68 * (_tmp137 * _tmp94 - _tmp149 * _tmp59);
  ...
  const Scalar _tmp156 =
      -_tmp153 * _tmp155 - std::sqrt(Scalar(std::pow(Scalar(-_tmp61 + p_c(0, 0)), Scalar(2)) +
  ...
  const Scalar _tmp162 = _tmp148 * _tmp160;
  const Scalar _tmp163 =
      (-_tmp141 * _tmp162 + _tmp152 * (_tmp121 * _tmp161 + _tmp124 * _tmp19 - _tmp136)) /
      std::sqrt(Scalar(std::pow(_tmp141, Scalar(2)) * _tmp160 + 1));
  const Scalar _tmp164 = _tmp122 * _tmp53;
  const Scalar _tmp165 = _tmp119 * _tmp47;
  const Scalar _tmp166 = _tmp109 * _tmp115 * _tmp47 + _tmp118 * _tmp165 - _tmp123 * _tmp164 +
                         _tmp129 * _tmp130 * _tmp47 + _tmp131 * _tmp135 +
                         _tmp139 * _tmp140 * _tmp47;
  const Scalar _tmp167 = _tmp131 * _tmp146;
  const Scalar _tmp168 = _tmp115 * _tmp150 * _tmp72 + _tmp130 * _tmp143 * _tmp72 -
                         _tmp140 * _tmp149 - _tmp167 * _tmp97;
  ...
  const Scalar _tmp172 =
      -_tmp170 * _tmp171 - std::sqrt(Scalar(std::pow(Scalar(-_tmp54 + p_b(1, 0)), Scalar(2)) +
  ...
  const Scalar _tmp179 = _tmp19 * _tmp53;
  const Scalar _tmp180 =
      (-_tmp166 * _tmp176 + _tmp169 * (-_tmp123 * _tmp179 - _tmp135 + _tmp161 * _tmp165)) /
      std::sqrt(Scalar(std::pow(_tmp166, Scalar(2)) * _tmp175 + 1));
  const Scalar _tmp181 = Scalar(1.0) * _tmp170;
  const Scalar _tmp182 =
      _tmp100 * _tmp107 * _tmp115 + _tmp100 * _tmp128 * _tmp130 + _tmp137 * _tmp140 + _tmp167;
  const Scalar _tmp183 = Scalar(1.0) / (_tmp182);
  const Scalar _tmp184 = -_tmp105 * _tmp115 * _tmp52 - _tmp118 * _tmp120 -
                         _tmp127 * _tmp130 * _tmp52 + _tmp131 * _tmp133 - _tmp138 * _tmp140 +
                         _tmp164;
  ...
  const Scalar _tmp188 =
      -_tmp185 * _tmp187 - std::sqrt(Scalar(std::pow(Scalar(-_tmp88 + p_a(0, 0)), Scalar(2)) +
  ...
  const Scalar _tmp193 = (_tmp183 * (-_tmp120 * _tmp161 - _tmp133 + _tmp179) + _tmp184 * _tmp192) /
  ...
  _res(2, 0) = _tmp171 * (-Scalar(1.0) * _tmp180 * std::cosh(_tmp181) -
                          (-Scalar(0.1034955) * _tmp172 * _tmp176 +
                           _tmp173 * (-_tmp170 * _tmp178 - _tmp171 * _tmp180)) *
                              std::cosh(_tmp174)) +
               _tmp178 * (-std::sinh(_tmp174) - std::sinh(_tmp181));
