...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl2(
  ...
  const Scalar _tmp27 = Scalar(0.20999999999999999) * _tmp17 + Scalar(0.20999999999999999) * _tmp8;
  const Scalar _tmp28 =
  ...
  const Scalar _tmp32 = _tmp31 - p_b(0, 0) + p_init0;
  ...
  const Scalar _tmp36 = _tmp15 - _tmp7;
  const Scalar _tmp37 = _tmp18 + _tmp24;
  const Scalar _tmp38 = _tmp37 - p_c(1, 0) + p_init1;
  ...
  const Scalar _tmp65 = _tmp64 * (-_tmp37 * _tmp41 * _tmp63 + _tmp38 * _tmp40 * _tmp63);
  const Scalar _tmp66 = _tmp25 * _tmp34 - _tmp31 * _tmp44 + _tmp34 * _tmp65;
  const Scalar _tmp67 = _tmp43 * _tmp60 - _tmp61;
  const Scalar _tmp68 = _tmp45 * _tmp67;
  const Scalar _tmp69 = _tmp54 * _tmp60 - _tmp57 * _tmp61 + _tmp60 * _tmp65 - _tmp66 * _tmp68;
  const Scalar _tmp70 = _tmp16 * _tmp60;
  const Scalar _tmp71 = _tmp10 - _tmp14 + _tmp7;
  const Scalar _tmp72 = -_tmp46 * _tmp67 -
                        _tmp49 * (-_tmp43 * _tmp70 - _tmp50 * _tmp68 + _tmp61 * _tmp71) -
                        _tmp60 * _tmp71 + _tmp70;
  ...
  const Scalar _tmp79 = _tmp60 * _tmp73;
  const Scalar _tmp80 = _tmp67 * _tmp73;
  const Scalar _tmp81 = -_tmp78 * _tmp80 + Scalar(1.0);
  const Scalar _tmp82 = _tmp34 * _tmp45;
  const Scalar _tmp83 = _tmp30 + _tmp56;
  const Scalar _tmp84 = _tmp83 - p_a(0, 0) + p_init0;
  const Scalar _tmp85 = _tmp19 + _tmp53;
  const Scalar _tmp86 = _tmp85 - p_a(1, 0) + p_init1;
  ...
  const Scalar _tmp91 = _tmp47 * _tmp49 + _tmp48;
  const Scalar _tmp92 = 0;
  const Scalar _tmp93 = _tmp34 * _tmp68;
  const Scalar _tmp94 = -_tmp16 + _tmp43 * _tmp46 - _tmp49 * (_tmp16 * _tmp43 + _tmp43 * _tmp51);
  const Scalar _tmp95 = _tmp77 * (_tmp43 * _tmp75 - _tmp65 - _tmp74 * _tmp94) + _tmp94;
  const Scalar _tmp96 = -_tmp43 - _tmp80 * _tmp95;
  const Scalar _tmp97 = _tmp84 * _tmp87;
  const Scalar _tmp98 = _tmp97 * fh1;
  const Scalar _tmp99 = Scalar(1.0) * _tmp76;
  const Scalar _tmp100 = fh1 * (_tmp83 * _tmp88 - _tmp85 * _tmp97);
  const Scalar _tmp101 = _tmp90 * _tmp92;
  ...
  _res(1, 0) = std::exp(_tmp100 * _tmp64 * (_tmp60 * _tmp99 - _tmp93 * _tmp99) +
                        _tmp64 * _tmp89 * (_tmp78 * _tmp79 + _tmp81 * _tmp82) +
                        _tmp64 * _tmp90 * (_tmp60 * _tmp92 - _tmp92 * _tmp93) +
                        _tmp64 * _tmp98 * (_tmp79 * _tmp95 + _tmp82 * _tmp96 + Scalar(1.0)));
  _res(2, 0) = std::exp(_tmp101 * _tmp68 + _tmp102 * _tmp68 - _tmp45 * _tmp81 * _tmp89 -
                        _tmp45 * _tmp96 * _tmp98);
  _res(3, 0) = std::exp(-_tmp101 - _tmp102 - _tmp73 * _tmp78 * _tmp89 - _tmp73 * _tmp95 * _tmp98);
