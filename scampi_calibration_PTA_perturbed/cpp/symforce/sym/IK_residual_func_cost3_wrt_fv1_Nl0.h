...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl0(
  ...
  const Scalar _tmp40 = -_tmp15 * _tmp27 + _tmp24 * _tmp28 + _tmp28 * _tmp39;
  const Scalar _tmp41 = _tmp31 * _tmp37;
  const Scalar _tmp42 = Scalar(1.0) / (-_tmp27 + _tmp28 * _tmp41);
  ...
  const Scalar _tmp51 = -_tmp28 * _tmp50 + _tmp48;
  const Scalar _tmp52 = _tmp27 * _tmp50 - _tmp41 * _tmp48;
  ...
  const Scalar _tmp70 = -_tmp51 * _tmp69 -
                        _tmp55 * (-_tmp41 * _tmp66 - _tmp52 * _tmp69 + _tmp57 * _tmp67) -
                        _tmp57 * _tmp65 + _tmp66;
  const Scalar _tmp71 = Scalar(1.0) / (_tmp70);
  const Scalar _tmp72 = _tmp39 * _tmp65 - _tmp40 * _tmp69 + _tmp59 * _tmp65 - _tmp62 * _tmp67;
  ...
  const Scalar _tmp79 = _tmp28 * _tmp42;
  const Scalar _tmp80 = _tmp65 * _tmp71;
  const Scalar _tmp81 = _tmp32 + _tmp61;
  const Scalar _tmp82 = _tmp81 - p_a(0, 0) + p_init0;
  const Scalar _tmp83 = _tmp29 + _tmp58;
  ...
  const Scalar _tmp92 = _tmp38 * (-_tmp28 * _tmp91 + _tmp65 * _tmp90);
  const Scalar _tmp93 = _tmp41 * _tmp42;
  const Scalar _tmp94 = -_tmp47 + _tmp51 * _tmp93 - _tmp55 * (_tmp41 * _tmp47 + _tmp52 * _tmp93);
  const Scalar _tmp95 = _tmp75 * (-_tmp39 + _tmp40 * _tmp93 - _tmp73 * _tmp94) + _tmp94;
  const Scalar _tmp96 = -_tmp41 - _tmp77 * _tmp95;
  const Scalar _tmp97 = _tmp82 * _tmp85;
  const Scalar _tmp98 = _tmp43 * _tmp68 * _tmp74;
  const Scalar _tmp99 = Scalar(1.0) * _tmp74;
  const Scalar _tmp100 = fh1 * (_tmp81 * _tmp86 - _tmp83 * _tmp97);
  ...
  _res(0, 0) = 0;
  _res(1, 0) =
      -_tmp92 * std::exp(_tmp100 * _tmp38 * (-_tmp28 * _tmp98 + _tmp65 * _tmp99) +
                         _tmp86 * _tmp87 * (_tmp76 * _tmp80 + _tmp78 * _tmp79) +
                         _tmp87 * _tmp97 * (_tmp79 * _tmp96 + _tmp80 * _tmp95 + Scalar(1.0)) +
                         _tmp88 * _tmp92);
  _res(2, 0) = -_tmp91 * std::exp(_tmp100 * _tmp98 - _tmp101 * _tmp78 * _tmp86 -
                                  _tmp101 * _tmp96 * _tmp97 + _tmp102 * _tmp69);
  _res(3, 0) = _tmp90 * std::exp(-_tmp100 * _tmp99 - _tmp102 - _tmp103 * _tmp76 * _tmp86 -
