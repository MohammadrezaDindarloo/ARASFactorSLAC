...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl1(
  ...
  const Scalar _tmp63 = _tmp62 * (-_tmp41 * _tmp51 + _tmp51 * _tmp52);
  const Scalar _tmp64 = Scalar(1.0) * _tmp53;
  const Scalar _tmp65 = -_tmp64;
  const Scalar _tmp66 = Scalar(1.0) / (_tmp43 + _tmp65);
  const Scalar _tmp67 = Scalar(1.0) * _tmp56;
  const Scalar _tmp68 = _tmp66 * (-_tmp47 + _tmp67);
  const Scalar _tmp69 = _tmp52 * _tmp60;
  const Scalar _tmp70 = _tmp41 * _tmp61 - _tmp51 * _tmp69;
  ...
  const Scalar _tmp86 = -_tmp69 * _tmp82 - _tmp70 * _tmp85 + _tmp81 * _tmp84;
  const Scalar _tmp87 = _tmp52 * _tmp82 - _tmp63 * _tmp83 - _tmp68 * _tmp86 - _tmp82 * _tmp84;
  ...
  const Scalar _tmp92 = _tmp91 * (-_tmp53 * _tmp58 * _tmp90 + _tmp55 * _tmp56 * _tmp90);
  const Scalar _tmp93 = _tmp43 * _tmp51 - _tmp47 * _tmp61 + _tmp51 * _tmp92;
  const Scalar _tmp94 = -_tmp74 * _tmp81 + _tmp77 * _tmp82 + _tmp82 * _tmp92 - _tmp85 * _tmp93;
  const Scalar _tmp95 = _tmp88 * _tmp94;
  const Scalar _tmp96 = Scalar(1.0) / (_tmp94);
  const Scalar _tmp97 = _tmp87 * _tmp96;
  const Scalar _tmp98 = _tmp97 * (-_tmp71 * _tmp93 - _tmp73 * _tmp95);
  const Scalar _tmp99 = _tmp73 + _tmp98;
  const Scalar _tmp100 = _tmp83 * _tmp88;
  const Scalar _tmp101 = -_tmp100 * _tmp99 + Scalar(1.0);
  const Scalar _tmp102 = _tmp51 * _tmp62;
  ...
  const Scalar _tmp124 = -_tmp108 * _tmp91 * (_tmp101 * _tmp102 + _tmp103 * _tmp99) -
                         ...
                         _tmp118 * _tmp91 * (-_tmp117 * _tmp51 * _tmp85 + _tmp117 * _tmp82) -
                         _tmp119 * _tmp91 * (-_tmp102 * _tmp123 + _tmp122 * _tmp82);
  const Scalar _tmp125 = Scalar(1.0) / (_tmp124);
  const Scalar _tmp126 = _tmp65 + _tmp77;
  const Scalar _tmp127 = _tmp126 * _tmp68;
  const Scalar _tmp128 = Scalar(1.0) / (-_tmp127 + _tmp67 - _tmp74);
  const Scalar _tmp129 = Scalar(1.0) * _tmp128;
  const Scalar _tmp130 = _tmp126 * _tmp129;
  const Scalar _tmp131 = -_tmp117 * _tmp86 + _tmp130 * _tmp97;
  ...
  const Scalar _tmp136 = _tmp110 + _tmp112 * _tmp134 - _tmp113 * _tmp135;
  const Scalar _tmp137 = _tmp134 * _tmp98 - _tmp135 * _tmp99 - _tmp72;
  const Scalar _tmp138 = _tmp39 * fh1;
  const Scalar _tmp139 = _tmp115 * _tmp138 + Scalar(3.29616) * _tmp14 + _tmp20 * fv1;
  const Scalar _tmp140 = -_tmp107 * _tmp138 - Scalar(3.29616) * _tmp28 - _tmp31 * fv1;
  const Scalar _tmp141 = _tmp127 * _tmp129 + Scalar(1.0);
  const Scalar _tmp142 = _tmp129 * _tmp68;
  const Scalar _tmp143 = _tmp120 * _tmp128;
  const Scalar _tmp144 = -_tmp121 * _tmp135 - _tmp126 * _tmp143 + _tmp65;
  const Scalar _tmp145 = std::asinh(
      _tmp125 * (Scalar(1.0) * _tmp108 * (_tmp129 * _tmp98 - _tmp132 * _tmp137) +
                 Scalar(1.0) * _tmp116 * (_tmp112 * _tmp129 - _tmp132 * _tmp136) +
                 Scalar(1.0) * _tmp118 * (-_tmp131 * _tmp132 + _tmp133) +
                 Scalar(1.0) * _tmp119 * (-_tmp120 * _tmp129 - _tmp132 * _tmp144 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp139 * (-_tmp129 + _tmp130 * _tmp66) +
  ...
  const Scalar _tmp149 = _tmp101 * _tmp108 * _tmp62 + _tmp114 * _tmp116 * _tmp62 -
                         _tmp119 * _tmp123 * _tmp62 - _tmp148 * _tmp85;
  const Scalar _tmp150 = Scalar(1.0) / (_tmp149);
  const Scalar _tmp151 = _tmp129 * _tmp139;
  const Scalar _tmp152 =
      std::asinh(_tmp150 * (_tmp108 * _tmp137 * _tmp66 + _tmp116 * _tmp136 * _tmp66 +
                            _tmp118 * _tmp131 * _tmp66 + _tmp119 * _tmp144 * _tmp66 -
                            _tmp126 * _tmp151 * _tmp66 + _tmp140 * _tmp141 * _tmp66));
  const Scalar _tmp153 = Scalar(0.1034955) * _tmp150;
  const Scalar _tmp154 = Scalar(9.6622558468725703) * _tmp149;
  const Scalar _tmp155 =
      _tmp108 * _tmp88 * _tmp99 + _tmp113 * _tmp116 * _tmp88 + _tmp119 * _tmp122 + _tmp148;
  const Scalar _tmp156 = Scalar(1.0) / (_tmp155);
  const Scalar _tmp157 =
      std::asinh(_tmp156 * (-_tmp108 * _tmp128 * _tmp98 - _tmp112 * _tmp116 * _tmp128 -
                            _tmp118 * _tmp133 + _tmp119 * _tmp143 - _tmp140 * _tmp142 + _tmp151));
  ...
  _res(1, 0) =
      -_tmp146 *
          (_tmp147 * p_b(2, 0) + std::cosh(Scalar(1.0) * _tmp145) -
           std::cosh(_tmp147 *
                     (-_tmp145 * _tmp146 -
                      std::sqrt(Scalar(std::pow(Scalar(-_tmp54 + p_b(1, 0)), Scalar(2)) +
                                       std::pow(Scalar(-_tmp57 + p_b(0, 0)), Scalar(2))))))) +
      _tmp52 + p_init2;
  _res(2, 0) =
      -_tmp154 *
          (_tmp153 * p_d(2, 0) + std::cosh(Scalar(1.0) * _tmp152) -
           std::cosh(_tmp153 *
                     (-_tmp152 * _tmp154 -
