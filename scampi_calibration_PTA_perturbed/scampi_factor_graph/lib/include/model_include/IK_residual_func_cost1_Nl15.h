...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl15(
  ...
  const Scalar _tmp63 = _tmp44 + _tmp57;
  ...
  const Scalar _tmp73 = _tmp43 * _tmp48;
  const Scalar _tmp74 = Scalar(1.0) / (_tmp49 * _tmp62 - _tmp73);
  ...
  const Scalar _tmp96 = _tmp94 * (-_tmp54 * _tmp60 * _tmp95 + _tmp56 * _tmp58 * _tmp95);
  const Scalar _tmp97 = _tmp41 * _tmp49 - _tmp45 * _tmp73 + _tmp49 * _tmp96;
  const Scalar _tmp98 = Scalar(1.0) * _tmp74;
  const Scalar _tmp99 = Scalar(1.0) * _tmp83;
  const Scalar _tmp100 = -_tmp52 * _tmp98 + _tmp74 * _tmp79 * _tmp85 * _tmp99;
  const Scalar _tmp101 = -_tmp63 * _tmp71 + _tmp66 * _tmp70 + _tmp70 * _tmp96 - _tmp75 * _tmp97;
  ...
  const Scalar _tmp108 = _tmp72 * _tmp88;
  const Scalar _tmp109 = -_tmp106 * _tmp108 + Scalar(1.0);
  const Scalar _tmp110 = _tmp49 * _tmp74;
  const Scalar _tmp111 = _tmp20 - p_c(0, 0);
  const Scalar _tmp112 = _tmp30 - p_c(1, 0);
  ...
  const Scalar _tmp116 = _tmp62 * _tmp74;
  const Scalar _tmp117 = _tmp116 * _tmp79 + _tmp78;
  const Scalar _tmp118 = _tmp116 * _tmp52 - _tmp117 * _tmp86 - _tmp51;
  const Scalar _tmp119 = _tmp104 * (-_tmp102 * _tmp118 + _tmp116 * _tmp97 - _tmp96);
  const Scalar _tmp120 = _tmp118 + _tmp119;
  const Scalar _tmp121 = -_tmp108 * _tmp120 - _tmp62;
  const Scalar _tmp122 = _tmp111 * _tmp113;
  const Scalar _tmp123 = _tmp122 * fh1;
  const Scalar _tmp124 = Scalar(1.0) * _tmp103;
  const Scalar _tmp125 = fh1 * (_tmp114 * _tmp19 - _tmp122 * _tmp29);
  const Scalar _tmp126 = -_tmp115 * _tmp94 * (_tmp106 * _tmp107 + _tmp109 * _tmp110) -
                         _tmp123 * _tmp94 * (_tmp107 * _tmp120 + _tmp110 * _tmp121 + Scalar(1.0)) -
                         _tmp125 * _tmp94 * (_tmp124 * _tmp70 - _tmp124 * _tmp92) -
                         _tmp37 * _tmp94 * (_tmp70 * _tmp91 - _tmp91 * _tmp92);
  const Scalar _tmp127 = Scalar(1.0) / (_tmp126);
  const Scalar _tmp128 = Scalar(0.1034955) * _tmp127;
  const Scalar _tmp129 = _tmp36 * fh1;
  const Scalar _tmp130 = Scalar(3.29616) * _tmp12 + _tmp122 * _tmp129 + _tmp19 * fv1;
  const Scalar _tmp131 = _tmp66 + _tmp82;
  const Scalar _tmp132 = _tmp131 * _tmp86;
  const Scalar _tmp133 = Scalar(1.0) / (-_tmp132 - _tmp63 + _tmp84);
  const Scalar _tmp134 = Scalar(1.0) * _tmp133;
  const Scalar _tmp135 = _tmp131 * _tmp134;
  const Scalar _tmp136 = _tmp80 * _tmp88;
  const Scalar _tmp137 = _tmp131 * _tmp133;
  const Scalar _tmp138 = _tmp117 + _tmp119 * _tmp137 - _tmp120 * _tmp136;
  const Scalar _tmp139 = Scalar(1.0) * fh1;
  const Scalar _tmp140 = -_tmp114 * _tmp129 - Scalar(3.29616) * _tmp26 - _tmp29 * fv1;
  const Scalar _tmp141 = _tmp83 * (_tmp132 * _tmp134 + Scalar(1.0));
  const Scalar _tmp142 = _tmp134 * _tmp86;
  const Scalar _tmp143 = _tmp105 * _tmp137 - _tmp106 * _tmp136 - _tmp79 * _tmp98;
  const Scalar _tmp144 = _tmp104 * _tmp135 - _tmp124 * _tmp80;
  const Scalar _tmp145 = _tmp104 * _tmp134;
  const Scalar _tmp146 = _tmp133 * _tmp89;
  const Scalar _tmp147 = -_tmp131 * _tmp146 - _tmp136 * _tmp90 + _tmp82;
  const Scalar _tmp148 = std::asinh(
      _tmp127 * (_tmp114 * _tmp139 * (_tmp105 * _tmp134 - _tmp143 * _tmp99) +
                 _tmp122 * _tmp139 * (_tmp119 * _tmp134 - _tmp138 * _tmp99) +
                 Scalar(1.0) * _tmp125 * (-_tmp144 * _tmp99 + _tmp145) +
                 Scalar(1.0) * _tmp130 * (-_tmp134 + _tmp135 * _tmp83) +
                 Scalar(1.0) * _tmp140 * (-Scalar(1.0) * _tmp141 + _tmp142) +
                 Scalar(1.0) * _tmp37 * (-_tmp134 * _tmp89 - _tmp147 * _tmp99 + Scalar(1.0))));
  const Scalar _tmp149 = Scalar(9.6622558468725703) * _tmp126;
  const Scalar _tmp150 = _tmp37 * _tmp91;
  const Scalar _tmp151 = _tmp124 * _tmp125;
  const Scalar _tmp152 =
      _tmp109 * _tmp115 * _tmp74 + _tmp121 * _tmp123 * _tmp74 - _tmp150 * _tmp75 - _tmp151 * _tmp75;
  const Scalar _tmp153 = Scalar(1.0) / (_tmp152);
  const Scalar _tmp154 = Scalar(0.1034955) * _tmp153;
  const Scalar _tmp155 = _tmp130 * _tmp134;
  const Scalar _tmp156 =
      std::asinh(_tmp153 * (_tmp115 * _tmp143 * _tmp83 + _tmp123 * _tmp138 * _tmp83 +
                            _tmp125 * _tmp144 * _tmp83 - _tmp131 * _tmp155 * _tmp83 +
                            _tmp140 * _tmp141 + _tmp147 * _tmp37 * _tmp83));
  ...
  const Scalar _tmp160 =
      std::asinh(_tmp159 * (-_tmp105 * _tmp115 * _tmp133 - _tmp119 * _tmp123 * _tmp133 -
                            _tmp125 * _tmp145 - _tmp140 * _tmp142 + _tmp146 * _tmp37 + _tmp155));
  ...
  _res(1, 0) =
      -_tmp149 *
          (_tmp128 * p_b(2, 0) + std::cosh(Scalar(1.0) * _tmp148) -
           std::cosh(_tmp128 *
                     (-_tmp148 * _tmp149 -
  ...
  _res(2, 0) =
      -_tmp157 *
          (_tmp154 * p_d(2, 0) + std::cosh(Scalar(1.0) * _tmp156) -
           std::cosh(_tmp154 *
                     (-_tmp156 * _tmp157 -
  ...
  _res(3, 0) =
      -_tmp161 *
          (_tmp162 * p_a(2, 0) + std::cosh(Scalar(1.0) * _tmp160) -
           std::cosh(_tmp162 *
                     (-_tmp160 * _tmp161 -
