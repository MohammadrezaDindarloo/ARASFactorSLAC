...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl0(
  ...
  const Scalar _tmp28 = Scalar(0.20999999999999999) * _tmp23 + Scalar(0.20999999999999999) * _tmp9 +
  ...
  const Scalar _tmp58 = _tmp47 - p_b(1, 0);
  ...
  const Scalar _tmp64 = Scalar(1.0) / (-_tmp57 + _tmp61 * _tmp62);
  const Scalar _tmp65 = _tmp64 * (_tmp49 * _tmp57 - _tmp61 * _tmp63);
  const Scalar _tmp66 =
      std::sqrt(Scalar(std::pow(_tmp58, Scalar(2)) + std::pow(_tmp59, Scalar(2))));
  const Scalar _tmp67 = Scalar(1.0) / (_tmp66);
  const Scalar _tmp68 = _tmp60 * _tmp66;
  const Scalar _tmp69 = _tmp68 * (_tmp43 * _tmp58 * _tmp67 - _tmp46 * _tmp59 * _tmp67);
  const Scalar _tmp70 = -_tmp50 * _tmp57 + _tmp53 * _tmp62 + _tmp62 * _tmp69;
  const Scalar _tmp71 = Scalar(1.0) * _tmp64;
  const Scalar _tmp72 = -_tmp49 * _tmp62 + _tmp63;
  const Scalar _tmp73 = Scalar(1.0) * _tmp43;
  const Scalar _tmp74 = -_tmp50 + _tmp73;
  const Scalar _tmp75 = Scalar(1.0) * _tmp46;
  const Scalar _tmp76 = -_tmp75;
  const Scalar _tmp77 = Scalar(1.0) / (_tmp53 + _tmp76);
  const Scalar _tmp78 = Scalar(1.0) * _tmp77;
  const Scalar _tmp79 = _tmp65 * _tmp74 * _tmp78 - _tmp71 * _tmp72;
  const Scalar _tmp80 = _tmp15 + _tmp7;
  const Scalar _tmp81 = _tmp28 + _tmp33;
  ...
  const Scalar _tmp91 = _tmp61 * _tmp88 - _tmp90;
  const Scalar _tmp92 = -_tmp61 * _tmp89 - _tmp65 * _tmp91 + _tmp80 * _tmp90;
  const Scalar _tmp93 = _tmp74 * _tmp77;
  const Scalar _tmp94 = _tmp64 * _tmp91;
  const Scalar _tmp95 = -_tmp72 * _tmp94 - _tmp80 * _tmp88 + _tmp89 - _tmp92 * _tmp93;
  const Scalar _tmp96 = Scalar(1.0) / (_tmp95);
  const Scalar _tmp97 = _tmp69 * _tmp88 - _tmp70 * _tmp94 + _tmp81 * _tmp88 - _tmp84 * _tmp90;
  const Scalar _tmp98 = _tmp96 * _tmp97;
  const Scalar _tmp99 = Scalar(1.0) / (_tmp97);
  const Scalar _tmp100 = _tmp95 * _tmp99;
  const Scalar _tmp101 = _tmp100 * (-_tmp70 * _tmp71 - _tmp79 * _tmp98);
  const Scalar _tmp102 = _tmp101 + _tmp79;
  const Scalar _tmp103 = _tmp92 * _tmp96;
  const Scalar _tmp104 = _tmp76 + _tmp81;
  const Scalar _tmp105 = _tmp104 * _tmp93;
  const Scalar _tmp106 = Scalar(1.0) / (-_tmp105 + _tmp73 - _tmp84);
  const Scalar _tmp107 = _tmp104 * _tmp106;
  const Scalar _tmp108 = _tmp101 * _tmp107 - _tmp102 * _tmp103 - Scalar(1.0) * _tmp65;
  const Scalar _tmp109 = Scalar(1.0) * _tmp106;
  const Scalar _tmp110 = _tmp27 - p_a(0, 0);
  const Scalar _tmp111 = _tmp35 - p_a(1, 0);
  ...
  const Scalar _tmp115 = _tmp100 * _tmp109;
  const Scalar _tmp116 = Scalar(1.0) * _tmp99;
  const Scalar _tmp117 = _tmp104 * _tmp115 - _tmp116 * _tmp92;
  const Scalar _tmp118 = _tmp110 * _tmp112;
  const Scalar _tmp119 = fh1 * (_tmp113 * _tmp26 - _tmp118 * _tmp34);
  const Scalar _tmp120 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp121 = _tmp73 + _tmp75 * _tmp93;
  const Scalar _tmp122 = _tmp106 * _tmp121;
  const Scalar _tmp123 = 0;
  const Scalar _tmp124 = -_tmp103 * _tmp123 - _tmp104 * _tmp122 + _tmp76;
  const Scalar _tmp125 = _tmp61 * _tmp64;
  const Scalar _tmp126 = _tmp41 * _tmp61 + _tmp61 * _tmp65;
  const Scalar _tmp127 = _tmp125 * _tmp72 - _tmp126 * _tmp93 - _tmp41;
  const Scalar _tmp128 = _tmp100 * (_tmp125 * _tmp70 - _tmp127 * _tmp98 - _tmp69);
  const Scalar _tmp129 = _tmp127 + _tmp128;
  const Scalar _tmp130 = -_tmp103 * _tmp129 + _tmp107 * _tmp128 + _tmp126;
  const Scalar _tmp131 = _tmp118 * fh1;
  const Scalar _tmp132 = _tmp16 * fh1;
  const Scalar _tmp133 = _tmp118 * _tmp132 + Scalar(3.29616) * _tmp21 + _tmp26 * fv1;
  const Scalar _tmp134 = _tmp104 * _tmp77;
  const Scalar _tmp135 = -_tmp113 * _tmp132 - Scalar(3.29616) * _tmp30 - _tmp34 * fv1;
  const Scalar _tmp136 = _tmp105 * _tmp109 + Scalar(1.0);
  const Scalar _tmp137 = _tmp109 * _tmp93;
  const Scalar _tmp138 = _tmp91 * _tmp96;
  const Scalar _tmp139 = -_tmp102 * _tmp138 + Scalar(1.0);
  const Scalar _tmp140 = _tmp62 * _tmp64;
  const Scalar _tmp141 = _tmp88 * _tmp96;
  const Scalar _tmp142 = _tmp123 * _tmp96;
  const Scalar _tmp143 = -_tmp129 * _tmp138 - _tmp61;
  const Scalar _tmp144 = _tmp71 * _tmp91 * _tmp99;
  const Scalar _tmp145 = -_tmp114 * _tmp68 * (_tmp102 * _tmp141 + _tmp139 * _tmp140) -
                         _tmp119 * _tmp68 * (_tmp116 * _tmp88 - _tmp144 * _tmp62) -
                         _tmp120 * _tmp68 * (-_tmp142 * _tmp62 * _tmp94 + _tmp142 * _tmp88) -
                         _tmp131 * _tmp68 * (_tmp129 * _tmp141 + _tmp140 * _tmp143 + Scalar(1.0));
  const Scalar _tmp146 = Scalar(1.0) / (_tmp145);
  const Scalar _tmp147 = std::asinh(
      _tmp146 * (Scalar(1.0) * _tmp114 * (_tmp101 * _tmp109 - _tmp108 * _tmp78) +
                 Scalar(1.0) * _tmp119 * (_tmp115 - _tmp117 * _tmp78) +
                 Scalar(1.0) * _tmp120 * (-_tmp109 * _tmp121 - _tmp124 * _tmp78 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp131 * (_tmp109 * _tmp128 - _tmp130 * _tmp78) +
                 Scalar(1.0) * _tmp133 * (_tmp109 * _tmp134 - _tmp109) +
                 Scalar(1.0) * _tmp135 * (-_tmp136 * _tmp78 + _tmp137)));
  const Scalar _tmp148 = Scalar(9.6622558468725703) * _tmp145;
  const Scalar _tmp149 = _tmp120 * _tmp142;
  const Scalar _tmp150 = _tmp114 * _tmp139 * _tmp64 - _tmp119 * _tmp144 +
                         _tmp131 * _tmp143 * _tmp64 - _tmp149 * _tmp94;
  const Scalar _tmp151 = Scalar(1.0) / (_tmp150);
  const Scalar _tmp152 = _tmp109 * _tmp133;
  const Scalar _tmp153 =
      std::asinh(_tmp151 * (_tmp108 * _tmp114 * _tmp77 + _tmp117 * _tmp119 * _tmp77 +
                            _tmp120 * _tmp124 * _tmp77 + _tmp130 * _tmp131 * _tmp77 -
                            _tmp134 * _tmp152 + _tmp135 * _tmp136 * _tmp77));
  const Scalar _tmp154 = Scalar(9.6622558468725703) * _tmp150;
  const Scalar _tmp155 = std::pow(Scalar(-_tmp51 + p_c(0, 0)), Scalar(2)) +
                         std::pow(Scalar(-_tmp54 + p_c(1, 0)), Scalar(2));
  const Scalar _tmp156 = std::pow(Scalar(-_tmp82 + p_d(1, 0)), Scalar(2)) +
                         std::pow(Scalar(-_tmp85 + p_d(0, 0)), Scalar(2));
  const Scalar _tmp157 =
      _tmp102 * _tmp114 * _tmp96 + _tmp116 * _tmp119 + _tmp129 * _tmp131 * _tmp96 + _tmp149;
  const Scalar _tmp158 = Scalar(1.0) / (_tmp157);
  const Scalar _tmp159 =
      std::asinh(_tmp158 * (-_tmp101 * _tmp106 * _tmp114 - _tmp106 * _tmp128 * _tmp131 -
                            _tmp115 * _tmp119 + _tmp120 * _tmp122 - _tmp135 * _tmp137 + _tmp152));
  ...
  _res(1, 0) =
      ...
      std::sqrt(Scalar(_tmp48 + std::pow(Scalar(-_tmp41 + p_b(2, 0) - p_init2), Scalar(2))));
  _res(2, 0) =
      _tmp154 *
          (-std::sinh(Scalar(1.0) * _tmp153) -
           std::sinh(Scalar(0.1034955) * _tmp151 * (-_tmp153 * _tmp154 - std::sqrt(_tmp155)))) -
      std::sqrt(Scalar(_tmp155 + std::pow(Scalar(-_tmp49 + p_c(2, 0) - p_init2), Scalar(2))));
  _res(3, 0) =
      _tmp160 *
          (-std::sinh(Scalar(1.0) * _tmp159) -
           std::sinh(Scalar(0.1034955) * _tmp158 * (-std::sqrt(_tmp156) - _tmp159 * _tmp160))) -
      std::sqrt(Scalar(_tmp156 + std::pow(Scalar(-_tmp80 + p_d(2, 0) - p_init2), Scalar(2))));
