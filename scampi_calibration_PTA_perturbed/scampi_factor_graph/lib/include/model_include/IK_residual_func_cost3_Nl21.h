...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl21(
  ...
  const Scalar _tmp18 = _tmp17 - p_a(0, 0) + p_init0;
  ...
  const Scalar _tmp28 = _tmp27 - p_a(1, 0) + p_init1;
  ...
  const Scalar _tmp39 = _tmp30 * _tmp37 - _tmp38;
  const Scalar _tmp40 = _tmp11 + _tmp15;
  const Scalar _tmp41 = _tmp4 + _tmp40;
  const Scalar _tmp42 = _tmp41 - p_c(0, 0) + p_init0;
  const Scalar _tmp43 = _tmp20 + _tmp31;
  ...
  const Scalar _tmp52 = _tmp51 * (-_tmp32 * _tmp35 * _tmp50 + _tmp33 * _tmp34 * _tmp50);
  const Scalar _tmp53 = _tmp48 * (-_tmp41 * _tmp46 + _tmp43 * _tmp47 + _tmp47 * _tmp52);
  const Scalar _tmp54 = -_tmp17 * _tmp38 + _tmp27 * _tmp30 + _tmp30 * _tmp52 - _tmp39 * _tmp53;
  ...
  const Scalar _tmp59 = _tmp20 + _tmp26;
  const Scalar _tmp60 = _tmp59 - p_d(1, 0) + p_init1;
  const Scalar _tmp61 = _tmp40 + _tmp5;
  const Scalar _tmp62 = _tmp61 - p_d(0, 0) + p_init0;
  ...
  const Scalar _tmp75 = _tmp48 * (-_tmp47 * _tmp74 + _tmp73);
  const Scalar _tmp76 = _tmp48 * (-_tmp37 * _tmp73 + _tmp46 * _tmp74);
  const Scalar _tmp77 = Scalar(1.0) * _tmp32;
  const Scalar _tmp78 = Scalar(1.0) * _tmp34;
  const Scalar _tmp79 = (-_tmp41 + _tmp78) / (_tmp43 - _tmp77);
  const Scalar _tmp80 = -Scalar(1.0) * _tmp75 + Scalar(1.0) * _tmp76 * _tmp79;
  const Scalar _tmp81 = _tmp68 + _tmp69 - _tmp70;
  const Scalar _tmp82 = _tmp37 * _tmp72;
  const Scalar _tmp83 = _tmp30 * _tmp72 - _tmp30 * _tmp81 - _tmp39 * _tmp75 -
                        _tmp79 * (-_tmp30 * _tmp82 + _tmp38 * _tmp81 - _tmp39 * _tmp76);
  const Scalar _tmp84 = Scalar(1.0) / (_tmp83);
  const Scalar _tmp85 = _tmp54 * _tmp84;
  const Scalar _tmp86 = _tmp55 * _tmp83;
  const Scalar _tmp87 = _tmp80 + _tmp86 * (-Scalar(1.0) * _tmp53 - _tmp80 * _tmp85);
  const Scalar _tmp88 = _tmp30 * _tmp84;
  const Scalar _tmp89 = _tmp39 * _tmp84;
  const Scalar _tmp90 = -_tmp87 * _tmp89 + Scalar(1.0);
  const Scalar _tmp91 = _tmp65 * fh1;
  const Scalar _tmp92 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp93 = _tmp77 * _tmp79 + _tmp78;
  const Scalar _tmp94 = 0;
  const Scalar _tmp95 = _tmp37 * _tmp75 - _tmp72 - _tmp79 * (_tmp37 * _tmp76 + _tmp82);
  const Scalar _tmp96 = _tmp86 * (_tmp37 * _tmp53 - _tmp52 - _tmp85 * _tmp95) + _tmp95;
  const Scalar _tmp97 = -_tmp37 - _tmp89 * _tmp96;
  const Scalar _tmp98 = _tmp64 * fh1;
  const Scalar _tmp99 = _tmp56 * _tmp66;
  const Scalar _tmp100 = _tmp39 * _tmp48;
  ...
  _res(1, 0) = std::exp(_tmp51 * _tmp66 * (_tmp30 * _tmp56 - _tmp56 * _tmp58) +
                        _tmp51 * _tmp91 * (_tmp57 * _tmp90 + _tmp87 * _tmp88) +
                        _tmp51 * _tmp92 * (_tmp30 * _tmp94 - _tmp58 * _tmp94) +
                        _tmp51 * _tmp98 * (_tmp57 * _tmp97 + _tmp88 * _tmp96 + Scalar(1.0)));
  _res(2, 0) = std::exp(_tmp100 * _tmp101 + _tmp100 * _tmp99 - _tmp48 * _tmp90 * _tmp91 -
                        _tmp48 * _tmp97 * _tmp98);
  _res(3, 0) = std::exp(-_tmp101 - _tmp84 * _tmp87 * _tmp91 - _tmp84 * _tmp96 * _tmp98 - _tmp99);
