...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl11(
  ...
  const Scalar _tmp31 = _tmp30 - p_d(1, 0) + p_init1;
  const Scalar _tmp32 = _tmp11 - _tmp14;
  const Scalar _tmp33 = _tmp32 + _tmp8;
  const Scalar _tmp34 = _tmp33 - p_d(0, 0) + p_init0;
  ...
  const Scalar _tmp54 = _tmp36 * _tmp52 - _tmp53;
  ...
  const Scalar _tmp58 = Scalar(0.20999999999999999) * _tmp19 + Scalar(0.20999999999999999) * _tmp20;
  const Scalar _tmp59 = _tmp55 + _tmp57 - _tmp58;
  ...
  const Scalar _tmp65 = _tmp38 * (_tmp28 * _tmp63 - _tmp36 * _tmp64);
  const Scalar _tmp66 = _tmp38 * (-_tmp37 * _tmp63 + _tmp64);
  const Scalar _tmp67 = -_tmp42 * (-_tmp52 * _tmp62 + _tmp53 * _tmp59 - _tmp54 * _tmp65) -
                        _tmp52 * _tmp59 + _tmp52 * _tmp61 - _tmp54 * _tmp66;
  ...
  const Scalar _tmp74 = _tmp73 * (-_tmp39 * _tmp70 + _tmp52 * _tmp71);
  const Scalar _tmp75 = Scalar(1.0) / (_tmp72);
  const Scalar _tmp76 = _tmp73 * (-_tmp30 * _tmp34 * _tmp75 + _tmp31 * _tmp33 * _tmp75);
  const Scalar _tmp77 = _tmp38 * (-_tmp16 * _tmp28 + _tmp25 * _tmp37 + _tmp37 * _tmp76);
  const Scalar _tmp78 = -_tmp46 * _tmp53 + _tmp49 * _tmp52 + _tmp52 * _tmp76 - _tmp54 * _tmp77;
  const Scalar _tmp79 = Scalar(1.0) / (_tmp78);
  const Scalar _tmp80 = Scalar(1.0) * _tmp79;
  const Scalar _tmp81 = _tmp18 + _tmp48;
  const Scalar _tmp82 = _tmp81 - p_b(1, 0) + p_init1;
  const Scalar _tmp83 = _tmp15 + _tmp45;
  ...
  const Scalar _tmp89 = Scalar(1.0) * _tmp42 * _tmp65 - Scalar(1.0) * _tmp66;
  ...
  const Scalar _tmp93 = _tmp52 * _tmp68;
  const Scalar _tmp94 = -_tmp69 * _tmp92 + Scalar(1.0);
  const Scalar _tmp95 = _tmp73 * fh1;
  const Scalar _tmp96 = _tmp36 * _tmp66 - _tmp42 * (_tmp36 * _tmp65 + _tmp62) - _tmp61;
  const Scalar _tmp97 = _tmp91 * (_tmp36 * _tmp77 - _tmp76 - _tmp90 * _tmp96) + _tmp96;
  const Scalar _tmp98 = -_tmp36 - _tmp69 * _tmp97;
  const Scalar _tmp99 = _tmp38 * fh1;
  const Scalar _tmp100 = _tmp38 * _tmp70;
  const Scalar _tmp101 = _tmp80 * _tmp88;
  ...
  _res(1, 0) =
      -_tmp74 *
      std::exp(_tmp0 * _tmp74 + _tmp73 * _tmp88 * (-_tmp39 * _tmp54 * _tmp80 + _tmp52 * _tmp80) +
               _tmp86 * _tmp95 * (_tmp39 * _tmp98 + _tmp93 * _tmp97 + Scalar(1.0)) +
               _tmp87 * _tmp95 * (_tmp39 * _tmp94 + _tmp92 * _tmp93));
  _res(2, 0) = -_tmp100 * std::exp(_tmp0 * _tmp100 + _tmp101 * _tmp38 * _tmp54 -
                                   _tmp86 * _tmp98 * _tmp99 - _tmp87 * _tmp94 * _tmp99);
  _res(3, 0) = _tmp71 * std::exp(-_tmp0 * _tmp71 - _tmp101 - _tmp102 * _tmp86 * _tmp97 -
                                 _tmp102 * _tmp87 * _tmp92);
