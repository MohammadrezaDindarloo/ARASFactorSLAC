...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl3(
  ...
  const Scalar _tmp58 = _tmp57 - p_a(0, 0) + p_init0;
  const Scalar _tmp59 = _tmp14 + _tmp40;
  const Scalar _tmp60 = _tmp59 - p_a(1, 0) + p_init1;
  ...
  const Scalar _tmp67 = -Scalar(0.010999999999999999) * _tmp17 -
  ...
  const Scalar _tmp73 = -_tmp47 * _tmp71 + _tmp48 * _tmp72;
  const Scalar _tmp74 = Scalar(1.0) * _tmp33;
  const Scalar _tmp75 = Scalar(1.0) * _tmp30;
  const Scalar _tmp76 = (-_tmp44 + _tmp75) / (_tmp41 - _tmp74);
  const Scalar _tmp77 = _tmp47 * _tmp70 - _tmp47 * _tmp72;
  const Scalar _tmp78 = _tmp65 * _tmp77 - _tmp70 - _tmp76 * (_tmp65 * _tmp73 + _tmp71);
  const Scalar _tmp79 = -_tmp66 + _tmp69;
  const Scalar _tmp80 = _tmp27 * _tmp70 - _tmp27 * _tmp79 - _tmp53 * _tmp77 -
                        _tmp76 * (-_tmp27 * _tmp71 + _tmp28 * _tmp79 - _tmp53 * _tmp73);
  const Scalar _tmp81 = Scalar(1.0) / (_tmp80);
  const Scalar _tmp82 = _tmp54 * _tmp81;
  const Scalar _tmp83 = _tmp55 * _tmp80;
  const Scalar _tmp84 = _tmp78 + _tmp83 * (-_tmp39 + _tmp49 * _tmp65 - _tmp78 * _tmp82);
  const Scalar _tmp85 = _tmp27 * _tmp81;
  const Scalar _tmp86 = _tmp52 * _tmp81;
  const Scalar _tmp87 = -_tmp50 - _tmp84 * _tmp86;
  const Scalar _tmp88 = _tmp47 * _tmp51;
  ...
  const Scalar _tmp96 = _tmp73 * _tmp76 * _tmp95 - _tmp77 * _tmp95;
  const Scalar _tmp97 = _tmp83 * (-_tmp49 * _tmp95 - _tmp82 * _tmp96) + _tmp96;
  ...
  _res(1, 0) =
      -_tmp94 * std::exp(_tmp38 * _tmp64 * (_tmp27 * _tmp56 - _tmp47 * _tmp53 * _tmp56) +
                         _tmp38 * _tmp89 * (_tmp84 * _tmp85 + _tmp87 * _tmp88 + Scalar(1.0)) +
                         _tmp38 * _tmp99 * (_tmp85 * _tmp97 + _tmp88 * _tmp98) + _tmp90 * _tmp94);
  _res(2, 0) = -_tmp93 * std::exp(_tmp100 * _tmp53 + _tmp101 * _tmp53 - _tmp51 * _tmp87 * _tmp89 -
                                  _tmp51 * _tmp98 * _tmp99);
  _res(3, 0) =
