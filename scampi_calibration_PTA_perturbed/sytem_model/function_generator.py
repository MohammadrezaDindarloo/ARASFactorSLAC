...
def getCatenaryVariables(robot_state, robot_params, geometric_vars, cat_vars):
    ...
    # Compute the catenary variables from the robot's state and geometric parameters and ground truth sesors
def getCatenaryVariablesSensory(robot_state, robot_params, geometric_vars, cat_vars, axis_forces):
    gc = robot_params.g_c  # for the sake of clarity
...
class CableRobotParams:
    def __init__(self, g_c, f_g):
        self.f_g_ = f_g
        self.g_c_ = g_c
        self.p1_ = sf.Vector3(0, 0, 0)
        self.p2_ = sf.Vector3(0, 0, 0)
        self.p3_ = sf.Vector3(0, 0, 0)
        self.p4_ = sf.Vector3(0, 0, 0)
        self.b1_ = sf.Vector3(0, 0, 0)
        self.b2_ = sf.Vector3(0, 0, 0)
        self.b3_ = sf.Vector3(0, 0, 0)
        self.b4_ = sf.Vector3(0, 0, 0)
        self.r_to_cog_ = sf.Vector3(0, 0, 0)

    def setPulleyPoses(self, p1, p2, p3, p4):
        self.p1_ = sf.Vector3(p1)
        self.p2_ = sf.Vector3(p2)
        self.p3_ = sf.Vector3(p3)
        self.p4_ = sf.Vector3(p4)

    def setEEAnchors(self, b1, b2, b3, b4):
        self.b1_ = sf.Vector3(b1)
        self.b2_ = sf.Vector3(b2)
        self.b3_ = sf.Vector3(b3)
        self.b4_ = sf.Vector3(b4)

    def setCog(self, r_to_cog):
        self.r_to_cog_ = sf.Vector3(r_to_cog)
...
def fkSolver(rtation_init, params_, fk_result, force_vector, L_point_to_point):
    ...
    # these 8 forceh and forceh are the sensor forces that seperated in two vector
    fh1, fv1, fh2, fv2, fh3, fv3, fh4, fv4 = sf.symbols("fh1 fv1 fh2 fv2 fh3 fv3 fh4 fv4")
    axis_forces = [[fh1, fv1], [fh2, fv2], [fh3, fv3], [fh4, fv4]]
    ...
    getCableForces(fh1, fv1, state, params, geom_vars)
    getCatenaryVariables(state, params, geom_vars, cat_vars)
    getCatenaryVariablesSensory(state, params, geom_vars, cat_vars_sensory, axis_forces)

    residuals = [0] * (16)
    for i in range(len(params.ef_points)):
        fh = state.cable_forces[i][0]
        residuals[i] = cat_vars.yl_cat[i] - fh/gc * ( sf.cosh(gc/fh * (cat_vars.length[i] + cat_vars.c1[i])) - cat_vars.c2[i] )
        residuals[i+4] = cat_vars.lc_cat[i] - cat_vars_sensory.lc_cat[i]
        residuals[i+8] = sf.exp(-fh)
        residuals[i+12] = sf.sqrt(axis_forces[i][0]**2 + axis_forces[i][1]**2)- force_vector[i]
    ...
    cost_force_distrobution = sf.Vector4.symbolic("P")
    for i in range(4):
        cost_force_distrobution[i] = residuals[i+12]
    ...
    cost = cost_cat
    def FK_residual_func_cost2(fh1: sf.Symbol('fh1'), fv1: sf.Symbol('fv1'), fh2: sf.Symbol('fh2'), fv2: sf.Symbol('fv2'),
                       fh3: sf.Symbol('fh3'), fv3: sf.Symbol('fv3'), fh4: sf.Symbol('fh4'), fv4: sf.Symbol('fv4'),
                       p_a: sf.V3.symbolic('p_a'), p_b: sf.V3.symbolic('p_b'), p_c: sf.V3.symbolic("p_c"),  p_d: sf.V3.symbolic("p_d"),
                       DeltaRot: sf.Rot3.symbolic("DeltaRot"),
                       position_vector: sf.Vector3.symbolic("position_vector"),
                       rot_init_x: sf.Symbol("rot_init_x"), rot_init_y: sf.Symbol("rot_init_y"), rot_init_z: sf.Symbol("rot_init_z"), rot_init_w: sf.Symbol("rot_init_w"), 
    ...
    def FK_residual_func_cost2_wrt_DeltaRot(fh1: sf.Symbol('fh1'), fv1: sf.Symbol('fv1'), fh2: sf.Symbol('fh2'), fv2: sf.Symbol('fv2'),
                       fh3: sf.Symbol('fh3'), fv3: sf.Symbol('fv3'), fh4: sf.Symbol('fh4'), fv4: sf.Symbol('fv4'),
                       p_a: sf.V3.symbolic('p_a'), p_b: sf.V3.symbolic('p_b'), p_c: sf.V3.symbolic("p_c"),  p_d: sf.V3.symbolic("p_d"),
                       DeltaRot: sf.Rot3.symbolic("DeltaRot"),
                       position_vector: sf.Vector3.symbolic("position_vector"),
    ...
    def FK_residual_func_cost2_wrt_fh1(fh1: sf.Symbol('fh1'), fv1: sf.Symbol('fv1'), fh2: sf.Symbol('fh2'), fv2: sf.Symbol('fv2'),
                       fh3: sf.Symbol('fh3'), fv3: sf.Symbol('fv3'), fh4: sf.Symbol('fh4'), fv4: sf.Symbol('fv4'),
                       p_a: sf.V3.symbolic('p_a'), p_b: sf.V3.symbolic('p_b'), p_c: sf.V3.symbolic("p_c"),  p_d: sf.V3.symbolic("p_d"),
                       DeltaRot: sf.Rot3.symbolic("DeltaRot"),
                       position_vector: sf.Vector3.symbolic("position_vector"),
    ...
    def FK_residual_func_cost2_wrt_fv1(fh1: sf.Symbol('fh1'), fv1: sf.Symbol('fv1'), fh2: sf.Symbol('fh2'), fv2: sf.Symbol('fv2'),
                       fh3: sf.Symbol('fh3'), fv3: sf.Symbol('fv3'), fh4: sf.Symbol('fh4'), fv4: sf.Symbol('fv4'),
                       p_a: sf.V3.symbolic('p_a'), p_b: sf.V3.symbolic('p_b'), p_c: sf.V3.symbolic("p_c"),  p_d: sf.V3.symbolic("p_d"),
                       DeltaRot: sf.Rot3.symbolic("DeltaRot"),
                       position_vector: sf.Vector3.symbolic("position_vector"),
    ...
    def FK_residual_func_cost2_wrt_fh2(fh1: sf.Symbol('fh1'), fv1: sf.Symbol('fv1'), fh2: sf.Symbol('fh2'), fv2: sf.Symbol('fv2'),
                       fh3: sf.Symbol('fh3'), fv3: sf.Symbol('fv3'), fh4: sf.Symbol('fh4'), fv4: sf.Symbol('fv4'),
                       p_a: sf.V3.symbolic('p_a'), p_b: sf.V3.symbolic('p_b'), p_c: sf.V3.symbolic("p_c"),  p_d: sf.V3.symbolic("p_d"),
                       DeltaRot: sf.Rot3.symbolic("DeltaRot"),
                       position_vector: sf.Vector3.symbolic("position_vector"),
        ...
        diff_fh2 = cost.diff(fh2)
        return sf.V4(diff_fh2) 
    resedual_func_codegen = codegen.Codegen.function(func=FK_residual_func_cost2_wrt_fh2, config=codegen.CppConfig(),)
    resedual_func_codegen_data = resedual_func_codegen.generate_function(output_dir=out_put_save_directory)

    def FK_residual_func_cost2_wrt_fv2(fh1: sf.Symbol('fh1'), fv1: sf.Symbol('fv1'), fh2: sf.Symbol('fh2'), fv2: sf.Symbol('fv2'),
                       fh3: sf.Symbol('fh3'), fv3: sf.Symbol('fv3'), fh4: sf.Symbol('fh4'), fv4: sf.Symbol('fv4'),
                       p_a: sf.V3.symbolic('p_a'), p_b: sf.V3.symbolic('p_b'), p_c: sf.V3.symbolic("p_c"),  p_d: sf.V3.symbolic("p_d"),
                       DeltaRot: sf.Rot3.symbolic("DeltaRot"),
                       position_vector: sf.Vector3.symbolic("position_vector"),
        ...
        diff_fv2 = cost.diff(fv2)
        return sf.V4(diff_fv2) 
    resedual_func_codegen = codegen.Codegen.function(func=FK_residual_func_cost2_wrt_fv2, config=codegen.CppConfig(),)
    resedual_func_codegen_data = resedual_func_codegen.generate_function(output_dir=out_put_save_directory)

    def FK_residual_func_cost2_wrt_fh3(fh1: sf.Symbol('fh1'), fv1: sf.Symbol('fv1'), fh2: sf.Symbol('fh2'), fv2: sf.Symbol('fv2'),
                       fh3: sf.Symbol('fh3'), fv3: sf.Symbol('fv3'), fh4: sf.Symbol('fh4'), fv4: sf.Symbol('fv4'),
                       p_a: sf.V3.symbolic('p_a'), p_b: sf.V3.symbolic('p_b'), p_c: sf.V3.symbolic("p_c"),  p_d: sf.V3.symbolic("p_d"),
                       DeltaRot: sf.Rot3.symbolic("DeltaRot"),
                       position_vector: sf.Vector3.symbolic("position_vector"),
        ...
        diff_fh3 = cost.diff(fh3)
        return sf.V4(diff_fh3) 
    resedual_func_codegen = codegen.Codegen.function(func=FK_residual_func_cost2_wrt_fh3, config=codegen.CppConfig(),)
    resedual_func_codegen_data = resedual_func_codegen.generate_function(output_dir=out_put_save_directory)

    def FK_residual_func_cost2_wrt_fv3(fh1: sf.Symbol('fh1'), fv1: sf.Symbol('fv1'), fh2: sf.Symbol('fh2'), fv2: sf.Symbol('fv2'),
                       fh3: sf.Symbol('fh3'), fv3: sf.Symbol('fv3'), fh4: sf.Symbol('fh4'), fv4: sf.Symbol('fv4'),
                       p_a: sf.V3.symbolic('p_a'), p_b: sf.V3.symbolic('p_b'), p_c: sf.V3.symbolic("p_c"),  p_d: sf.V3.symbolic("p_d"),
                       DeltaRot: sf.Rot3.symbolic("DeltaRot"),
                       position_vector: sf.Vector3.symbolic("position_vector"),
        ...
        diff_fv3 = cost.diff(fv3)
        return sf.V4(diff_fv3) 
    resedual_func_codegen = codegen.Codegen.function(func=FK_residual_func_cost2_wrt_fv3, config=codegen.CppConfig(),)
    resedual_func_codegen_data = resedual_func_codegen.generate_function(output_dir=out_put_save_directory)

    def FK_residual_func_cost2_wrt_fh4(fh1: sf.Symbol('fh1'), fv1: sf.Symbol('fv1'), fh2: sf.Symbol('fh2'), fv2: sf.Symbol('fv2'),
                       fh3: sf.Symbol('fh3'), fv3: sf.Symbol('fv3'), fh4: sf.Symbol('fh4'), fv4: sf.Symbol('fv4'),
                       p_a: sf.V3.symbolic('p_a'), p_b: sf.V3.symbolic('p_b'), p_c: sf.V3.symbolic("p_c"),  p_d: sf.V3.symbolic("p_d"),
                       DeltaRot: sf.Rot3.symbolic("DeltaRot"),
                       position_vector: sf.Vector3.symbolic("position_vector"),
        ...
        diff_fh4 = cost.diff(fh4)
        return sf.V4(diff_fh4) 
    resedual_func_codegen = codegen.Codegen.function(func=FK_residual_func_cost2_wrt_fh4, config=codegen.CppConfig(),)
    resedual_func_codegen_data = resedual_func_codegen.generate_function(output_dir=out_put_save_directory)

    def FK_residual_func_cost2_wrt_fv4(fh1: sf.Symbol('fh1'), fv1: sf.Symbol('fv1'), fh2: sf.Symbol('fh2'), fv2: sf.Symbol('fv2'),
                       fh3: sf.Symbol('fh3'), fv3: sf.Symbol('fv3'), fh4: sf.Symbol('fh4'), fv4: sf.Symbol('fv4'),
                       p_a: sf.V3.symbolic('p_a'), p_b: sf.V3.symbolic('p_b'), p_c: sf.V3.symbolic("p_c"),  p_d: sf.V3.symbolic("p_d"),
                       DeltaRot: sf.Rot3.symbolic("DeltaRot"),
                       position_vector: sf.Vector3.symbolic("position_vector"),
        ...
        diff_fv4 = cost.diff(fv4)
        return sf.V4(diff_fv4) 
    resedual_func_codegen = codegen.Codegen.function(func=FK_residual_func_cost2_wrt_fv4, config=codegen.CppConfig(),)
    resedual_func_codegen_data = resedual_func_codegen.generate_function(output_dir=out_put_save_directory)

    def FK_residual_func_cost2_wrt_position_vector(fh1: sf.Symbol('fh1'), fv1: sf.Symbol('fv1'), fh2: sf.Symbol('fh2'), fv2: sf.Symbol('fv2'),
                       fh3: sf.Symbol('fh3'), fv3: sf.Symbol('fv3'), fh4: sf.Symbol('fh4'), fv4: sf.Symbol('fv4'),
                       p_a: sf.V3.symbolic('p_a'), p_b: sf.V3.symbolic('p_b'), p_c: sf.V3.symbolic("p_c"),  p_d: sf.V3.symbolic("p_d"),
                       DeltaRot: sf.Rot3.symbolic("DeltaRot"),
                       position_vector: sf.Vector3.symbolic("position_vector"),
    ...
    def FK_residual_func_cost2_wrt_pa(fh1: sf.Symbol('fh1'), fv1: sf.Symbol('fv1'), fh2: sf.Symbol('fh2'), fv2: sf.Symbol('fv2'),
                       fh3: sf.Symbol('fh3'), fv3: sf.Symbol('fv3'), fh4: sf.Symbol('fh4'), fv4: sf.Symbol('fv4'),
                       p_a: sf.V3.symbolic('p_a'), p_b: sf.V3.symbolic('p_b'), p_c: sf.V3.symbolic("p_c"),  p_d: sf.V3.symbolic("p_d"),
                       DeltaRot: sf.Rot3.symbolic("DeltaRot"),
                       position_vector: sf.Vector3.symbolic("position_vector"),
    ...
    def FK_residual_func_cost2_wrt_pb(fh1: sf.Symbol('fh1'), fv1: sf.Symbol('fv1'), fh2: sf.Symbol('fh2'), fv2: sf.Symbol('fv2'),
                       fh3: sf.Symbol('fh3'), fv3: sf.Symbol('fv3'), fh4: sf.Symbol('fh4'), fv4: sf.Symbol('fv4'),
                       p_a: sf.V3.symbolic('p_a'), p_b: sf.V3.symbolic('p_b'), p_c: sf.V3.symbolic("p_c"),  p_d: sf.V3.symbolic("p_d"),
                       DeltaRot: sf.Rot3.symbolic("DeltaRot"),
                       position_vector: sf.Vector3.symbolic("position_vector"),
    ...
    def FK_residual_func_cost2_wrt_pc(fh1: sf.Symbol('fh1'), fv1: sf.Symbol('fv1'), fh2: sf.Symbol('fh2'), fv2: sf.Symbol('fv2'),
                       fh3: sf.Symbol('fh3'), fv3: sf.Symbol('fv3'), fh4: sf.Symbol('fh4'), fv4: sf.Symbol('fv4'),
                       p_a: sf.V3.symbolic('p_a'), p_b: sf.V3.symbolic('p_b'), p_c: sf.V3.symbolic("p_c"),  p_d: sf.V3.symbolic("p_d"),
                       DeltaRot: sf.Rot3.symbolic("DeltaRot"),
                       position_vector: sf.Vector3.symbolic("position_vector"),
    ...
    def FK_residual_func_cost2_wrt_pd(fh1: sf.Symbol('fh1'), fv1: sf.Symbol('fv1'), fh2: sf.Symbol('fh2'), fv2: sf.Symbol('fv2'),
                       fh3: sf.Symbol('fh3'), fv3: sf.Symbol('fv3'), fh4: sf.Symbol('fh4'), fv4: sf.Symbol('fv4'),
                       p_a: sf.V3.symbolic('p_a'), p_b: sf.V3.symbolic('p_b'), p_c: sf.V3.symbolic("p_c"),  p_d: sf.V3.symbolic("p_d"),
                       DeltaRot: sf.Rot3.symbolic("DeltaRot"),
                       position_vector: sf.Vector3.symbolic("position_vector"),
    ...
    cost = cost_force_distrobution
    def FK_residual_func_cost4(fh1: sf.Symbol('fh1'), fv1: sf.Symbol('fv1'), fh2: sf.Symbol('fh2'), fv2: sf.Symbol('fv2'),
                       fh3: sf.Symbol('fh3'), fv3: sf.Symbol('fv3'), fh4: sf.Symbol('fh4'), fv4: sf.Symbol('fv4'),
                       F_GT0: sf.Symbol('F_GT0'), F_GT1: sf.Symbol('F_GT1'), F_GT2: sf.Symbol("F_GT2"), F_GT3: sf.Symbol("F_GT3"), 
                       epsilon: sf.Scalar = 0
                      ) -> sf.Vector4:
        return sf.V4(cost) 
    ...
    def FK_residual_func_cost4_wrt_fh1(fh1: sf.Symbol('fh1'), fv1: sf.Symbol('fv1'), fh2: sf.Symbol('fh2'), fv2: sf.Symbol('fv2'),
                       fh3: sf.Symbol('fh3'), fv3: sf.Symbol('fv3'), fh4: sf.Symbol('fh4'), fv4: sf.Symbol('fv4'),
                       F_GT0: sf.Symbol('F_GT0'), F_GT1: sf.Symbol('F_GT1'), F_GT2: sf.Symbol("F_GT2"), F_GT3: sf.Symbol("F_GT3"), 
                       epsilon: sf.Scalar = 0
                      ) -> sf.Vector4:
    ...
    def FK_residual_func_cost4_wrt_fv1(fh1: sf.Symbol('fh1'), fv1: sf.Symbol('fv1'), fh2: sf.Symbol('fh2'), fv2: sf.Symbol('fv2'),
                       fh3: sf.Symbol('fh3'), fv3: sf.Symbol('fv3'), fh4: sf.Symbol('fh4'), fv4: sf.Symbol('fv4'),
                       F_GT0: sf.Symbol('F_GT0'), F_GT1: sf.Symbol('F_GT1'), F_GT2: sf.Symbol("F_GT2"), F_GT3: sf.Symbol("F_GT3"), 
                       epsilon: sf.Scalar = 0
                      ) -> sf.Vector4:
    ...
    def FK_residual_func_cost4_wrt_fh2(fh1: sf.Symbol('fh1'), fv1: sf.Symbol('fv1'), fh2: sf.Symbol('fh2'), fv2: sf.Symbol('fv2'),
                       fh3: sf.Symbol('fh3'), fv3: sf.Symbol('fv3'), fh4: sf.Symbol('fh4'), fv4: sf.Symbol('fv4'),
                       F_GT0: sf.Symbol('F_GT0'), F_GT1: sf.Symbol('F_GT1'), F_GT2: sf.Symbol("F_GT2"), F_GT3: sf.Symbol("F_GT3"), 
                       epsilon: sf.Scalar = 0
                      ) -> sf.Vector4:
        diff_fh2 = cost.diff(fh2)
        return sf.V4(diff_fh2)
    resedual_func_codegen = codegen.Codegen.function(func=FK_residual_func_cost4_wrt_fh2, config=codegen.CppConfig(),)
    resedual_func_codegen_data = resedual_func_codegen.generate_function(output_dir=out_put_save_directory)

    def FK_residual_func_cost4_wrt_fv2(fh1: sf.Symbol('fh1'), fv1: sf.Symbol('fv1'), fh2: sf.Symbol('fh2'), fv2: sf.Symbol('fv2'),
                       fh3: sf.Symbol('fh3'), fv3: sf.Symbol('fv3'), fh4: sf.Symbol('fh4'), fv4: sf.Symbol('fv4'),
                       F_GT0: sf.Symbol('F_GT0'), F_GT1: sf.Symbol('F_GT1'), F_GT2: sf.Symbol("F_GT2"), F_GT3: sf.Symbol("F_GT3"), 
                       epsilon: sf.Scalar = 0
                      ) -> sf.Vector4:
        diff_fv2 = cost.diff(fv2)
        return sf.V4(diff_fv2)
    resedual_func_codegen = codegen.Codegen.function(func=FK_residual_func_cost4_wrt_fv2, config=codegen.CppConfig(),)
    resedual_func_codegen_data = resedual_func_codegen.generate_function(output_dir=out_put_save_directory)

    def FK_residual_func_cost4_wrt_fh3(fh1: sf.Symbol('fh1'), fv1: sf.Symbol('fv1'), fh2: sf.Symbol('fh2'), fv2: sf.Symbol('fv2'),
                       fh3: sf.Symbol('fh3'), fv3: sf.Symbol('fv3'), fh4: sf.Symbol('fh4'), fv4: sf.Symbol('fv4'),
                       F_GT0: sf.Symbol('F_GT0'), F_GT1: sf.Symbol('F_GT1'), F_GT2: sf.Symbol("F_GT2"), F_GT3: sf.Symbol("F_GT3"), 
                       epsilon: sf.Scalar = 0
                      ) -> sf.Vector4:
        diff_fh3 = cost.diff(fh3)
        return sf.V4(diff_fh3)
    resedual_func_codegen = codegen.Codegen.function(func=FK_residual_func_cost4_wrt_fh3, config=codegen.CppConfig(),)
    resedual_func_codegen_data = resedual_func_codegen.generate_function(output_dir=out_put_save_directory)

    def FK_residual_func_cost4_wrt_fv3(fh1: sf.Symbol('fh1'), fv1: sf.Symbol('fv1'), fh2: sf.Symbol('fh2'), fv2: sf.Symbol('fv2'),
                       fh3: sf.Symbol('fh3'), fv3: sf.Symbol('fv3'), fh4: sf.Symbol('fh4'), fv4: sf.Symbol('fv4'),
                       F_GT0: sf.Symbol('F_GT0'), F_GT1: sf.Symbol('F_GT1'), F_GT2: sf.Symbol("F_GT2"), F_GT3: sf.Symbol("F_GT3"), 
                       epsilon: sf.Scalar = 0
                      ) -> sf.Vector4:
        diff_fv3 = cost.diff(fv3)
        return sf.V4(diff_fv3)
    resedual_func_codegen = codegen.Codegen.function(func=FK_residual_func_cost4_wrt_fv3, config=codegen.CppConfig(),)
    resedual_func_codegen_data = resedual_func_codegen.generate_function(output_dir=out_put_save_directory)

    def FK_residual_func_cost4_wrt_fh4(fh1: sf.Symbol('fh1'), fv1: sf.Symbol('fv1'), fh2: sf.Symbol('fh2'), fv2: sf.Symbol('fv2'),
                       fh3: sf.Symbol('fh3'), fv3: sf.Symbol('fv3'), fh4: sf.Symbol('fh4'), fv4: sf.Symbol('fv4'),
                       F_GT0: sf.Symbol('F_GT0'), F_GT1: sf.Symbol('F_GT1'), F_GT2: sf.Symbol("F_GT2"), F_GT3: sf.Symbol("F_GT3"), 
                       epsilon: sf.Scalar = 0
                      ) -> sf.Vector4:
        diff_fh4 = cost.diff(fh4)
        return sf.V4(diff_fh4)
    resedual_func_codegen = codegen.Codegen.function(func=FK_residual_func_cost4_wrt_fh4, config=codegen.CppConfig(),)
    resedual_func_codegen_data = resedual_func_codegen.generate_function(output_dir=out_put_save_directory)

    def FK_residual_func_cost4_wrt_fv4(fh1: sf.Symbol('fh1'), fv1: sf.Symbol('fv1'), fh2: sf.Symbol('fh2'), fv2: sf.Symbol('fv2'),
                       fh3: sf.Symbol('fh3'), fv3: sf.Symbol('fv3'), fh4: sf.Symbol('fh4'), fv4: sf.Symbol('fv4'),
                       F_GT0: sf.Symbol('F_GT0'), F_GT1: sf.Symbol('F_GT1'), F_GT2: sf.Symbol("F_GT2"), F_GT3: sf.Symbol("F_GT3"), 
                       epsilon: sf.Scalar = 0
                      ) -> sf.Vector4:
        diff_fv4 = cost.diff(fv4)
        return sf.V4(diff_fv4)
    resedual_func_codegen = codegen.Codegen.function(func=FK_residual_func_cost4_wrt_fv4, config=codegen.CppConfig(),)
    resedual_func_codegen_data = resedual_func_codegen.generate_function(output_dir=out_put_save_directory)
    print("-------------cost_force_distrobution header files generated FK-----")
