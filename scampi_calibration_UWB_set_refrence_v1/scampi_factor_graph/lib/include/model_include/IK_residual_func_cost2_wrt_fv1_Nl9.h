...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2WrtFv1Nl9(
  ...
  const Scalar _tmp57 = _tmp36 * _tmp44 - _tmp40 * _tmp45 + _tmp44 * _tmp56;
  const Scalar _tmp58 = _tmp51 * _tmp54;
  const Scalar _tmp59 = Scalar(1.0) / (_tmp44 * _tmp58 - _tmp45);
  const Scalar _tmp60 = _tmp58 * _tmp59;
  const Scalar _tmp61 = Scalar(0.20999999999999999) * _tmp23 + Scalar(0.20999999999999999) * _tmp24;
  const Scalar _tmp62 = -Scalar(0.010999999999999999) * _tmp16 -
  ...
  const Scalar _tmp90 = _tmp58 * _tmp89 - _tmp88;
  const Scalar _tmp91 = _tmp59 * _tmp90;
  const Scalar _tmp92 = _tmp65 * _tmp89;
  const Scalar _tmp93 = -_tmp58 * _tmp92 - _tmp69 * _tmp91 + _tmp80 * _tmp88;
  const Scalar _tmp94 = -_tmp76 * _tmp93 - _tmp77 * _tmp91 - _tmp80 * _tmp89 + _tmp92;
  const Scalar _tmp95 = Scalar(1.0) / (_tmp94);
  const Scalar _tmp96 = _tmp56 * _tmp89 - _tmp57 * _tmp91 - _tmp81 * _tmp88 + _tmp84 * _tmp89;
  const Scalar _tmp97 = _tmp95 * _tmp96;
  const Scalar _tmp98 = Scalar(1.0) / (_tmp96);
  const Scalar _tmp99 = _tmp94 * _tmp98;
  const Scalar _tmp100 = _tmp99 * (-_tmp56 + _tmp57 * _tmp60 - _tmp78 * _tmp97);
  ...
  const Scalar _tmp105 = _tmp44 * _tmp59;
  const Scalar _tmp106 = _tmp32 - p_b(1, 0);
  const Scalar _tmp107 = _tmp21 - p_b(0, 0);
  ...
  const Scalar _tmp113 = _tmp111 * _tmp59 * _tmp69 * _tmp75 - _tmp112 * _tmp77;
  const Scalar _tmp114 = _tmp99 * (-_tmp112 * _tmp57 - _tmp113 * _tmp97);
  ...
  const Scalar _tmp124 = _tmp55 * (-_tmp105 * _tmp123 + _tmp122 * _tmp89);
  const Scalar _tmp125 = Scalar(1.0) * _tmp98;
  const Scalar _tmp126 = fh1 * (-_tmp109 * _tmp31 + _tmp117 * _tmp20);
  const Scalar _tmp127 = -_tmp110 * _tmp55 * (_tmp101 * _tmp102 + _tmp104 * _tmp105 + Scalar(1.0)) -
                         _tmp118 * _tmp55 * (_tmp102 * _tmp115 + _tmp105 * _tmp116) -
                         _tmp119 * _tmp124 -
                         _tmp126 * _tmp55 * (-_tmp125 * _tmp44 * _tmp91 + _tmp125 * _tmp89);
  const Scalar _tmp128 = Scalar(1.0) / (_tmp127);
  const Scalar _tmp129 = _tmp72 + _tmp84;
  ...
  const Scalar _tmp134 = _tmp73 * (-_tmp121 * _tmp133 - _tmp129 * _tmp132 + _tmp72);
  const Scalar _tmp135 = -Scalar(1.0) * _tmp132 - Scalar(1.0) * _tmp134 + Scalar(1.0);
  const Scalar _tmp136 = fh1 * (_tmp64 + _tmp79);
  const Scalar _tmp137 = -_tmp117 * _tmp136 - Scalar(3.29616) * _tmp25 - _tmp31 * fv1;
  const Scalar _tmp138 = Scalar(1.0) * _tmp131;
  const Scalar _tmp139 = _tmp130 * _tmp138 + Scalar(1.0);
  const Scalar _tmp140 = _tmp138 * _tmp76;
  const Scalar _tmp141 = -Scalar(1.0) * _tmp111 * _tmp139 + Scalar(1.0) * _tmp140;
  const Scalar _tmp142 = _tmp109 * _tmp136 + Scalar(3.29616) * _tmp14 + _tmp20 * fv1;
  const Scalar _tmp143 = _tmp129 * _tmp73;
  const Scalar _tmp144 = Scalar(1.0) * _tmp138 * _tmp143 - Scalar(1.0) * _tmp138;
  const Scalar _tmp145 = _tmp138 * _tmp99;
  const Scalar _tmp146 = -_tmp125 * _tmp93 + _tmp129 * _tmp145;
  const Scalar _tmp147 = _tmp129 * _tmp131;
  const Scalar _tmp148 = -_tmp112 * _tmp69 + _tmp114 * _tmp147 - _tmp115 * _tmp133;
  const Scalar _tmp149 = _tmp100 * _tmp147 - _tmp101 * _tmp133 + _tmp70;
  const Scalar _tmp150 = Scalar(1.0) * _tmp110 * (_tmp100 * _tmp138 - _tmp111 * _tmp149) +
                         Scalar(1.0) * _tmp118 * (-_tmp111 * _tmp148 + _tmp114 * _tmp138) +
                         _tmp119 * _tmp135 +
                         Scalar(1.0) * _tmp126 * (-_tmp111 * _tmp146 + _tmp145) +
                         _tmp137 * _tmp141 + _tmp142 * _tmp144;
  const Scalar _tmp151 = std::asinh(_tmp128 * _tmp150);
  const Scalar _tmp152 = Scalar(1.0) * _tmp151;
  const Scalar _tmp153 = _tmp26 + _tmp29 + _tmp34;
  const Scalar _tmp154 = std::pow(_tmp127, Scalar(-2));
  const Scalar _tmp155 = _tmp124 * _tmp154;
  const Scalar _tmp156 =
      (_tmp128 * (-_tmp135 + _tmp141 * _tmp153 + _tmp144 * _tmp20) - _tmp150 * _tmp155) /
      std::sqrt(Scalar(std::pow(_tmp150, Scalar(2)) * _tmp154 + 1));
  const Scalar _tmp157 = Scalar(9.6622558468725703) * _tmp127;
  const Scalar _tmp158 =
      -_tmp151 * _tmp157 - std::sqrt(Scalar(std::pow(Scalar(-_tmp47 + p_c(0, 0)), Scalar(2)) +
                                            std::pow(Scalar(-_tmp50 + p_c(1, 0)), Scalar(2))));
  const Scalar _tmp159 = Scalar(0.1034955) * _tmp128;
  const Scalar _tmp160 = _tmp158 * _tmp159;
  const Scalar _tmp161 = Scalar(9.6622558468725703) * _tmp124;
  const Scalar _tmp162 = _tmp138 * _tmp142;
  const Scalar _tmp163 = _tmp139 * _tmp73;
  const Scalar _tmp164 = _tmp110 * _tmp149 * _tmp73 + _tmp118 * _tmp148 * _tmp73 +
                         _tmp119 * _tmp134 + _tmp126 * _tmp146 * _tmp73 + _tmp137 * _tmp163 -
                         _tmp143 * _tmp162;
  const Scalar _tmp165 = _tmp125 * _tmp126;
  const Scalar _tmp166 = _tmp123 * _tmp59;
  const Scalar _tmp167 = _tmp104 * _tmp110 * _tmp59 + _tmp116 * _tmp118 * _tmp59 -
                         _tmp119 * _tmp166 - _tmp165 * _tmp91;
  ...
  const Scalar _tmp171 =
      -_tmp169 * _tmp170 - std::sqrt(Scalar(std::pow(Scalar(-_tmp37 + p_d(1, 0)), Scalar(2)) +
  ...
  const Scalar _tmp177 = _tmp138 * _tmp20;
  const Scalar _tmp178 =
      (-_tmp164 * _tmp175 + _tmp168 * (-_tmp134 - _tmp143 * _tmp177 + _tmp153 * _tmp163)) /
      std::sqrt(Scalar(std::pow(_tmp164, Scalar(2)) * _tmp174 + 1));
  const Scalar _tmp179 = Scalar(1.0) * _tmp169;
  const Scalar _tmp180 = -_tmp100 * _tmp110 * _tmp131 - _tmp114 * _tmp118 * _tmp131 +
                         _tmp119 * _tmp132 - _tmp126 * _tmp145 - _tmp137 * _tmp140 + _tmp162;
  const Scalar _tmp181 =
      _tmp101 * _tmp110 * _tmp95 + _tmp115 * _tmp118 * _tmp95 + _tmp119 * _tmp122 + _tmp165;
  ...
  const Scalar _tmp185 =
      -_tmp183 * _tmp184 - std::sqrt(Scalar(std::pow(Scalar(-_tmp82 + p_a(0, 0)), Scalar(2)) +
                                            std::pow(Scalar(-_tmp85 + p_a(1, 0)), Scalar(2))));
  const Scalar _tmp186 = std::pow(_tmp181, Scalar(-2));
  const Scalar _tmp187 = _tmp122 * _tmp186;
  const Scalar _tmp188 = (_tmp180 * _tmp187 + _tmp182 * (-_tmp132 - _tmp140 * _tmp153 + _tmp177)) /
                         std::sqrt(Scalar(std::pow(_tmp180, Scalar(2)) * _tmp186 + 1));
  const Scalar _tmp189 = Scalar(9.6622558468725703) * _tmp122;
