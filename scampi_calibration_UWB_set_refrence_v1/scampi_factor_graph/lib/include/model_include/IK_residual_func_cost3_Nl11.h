...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl11(
  ...
  const Scalar _tmp48 = Scalar(0.20999999999999999) * _tmp19 + Scalar(0.20999999999999999) * _tmp20;
  const Scalar _tmp49 = _tmp45 + _tmp47 - _tmp48;
  const Scalar _tmp50 = -_tmp8;
  const Scalar _tmp51 = _tmp32 + _tmp50;
  const Scalar _tmp52 = _tmp51 - p_a(0, 0) + p_init0;
  const Scalar _tmp53 = _tmp21 - _tmp23;
  const Scalar _tmp54 = _tmp29 + _tmp53;
  const Scalar _tmp55 = _tmp54 - p_a(1, 0) + p_init1;
  ...
  const Scalar _tmp59 = _tmp45 + _tmp48;
  const Scalar _tmp60 = _tmp47 + _tmp59;
  const Scalar _tmp61 = _tmp36 * _tmp60;
  const Scalar _tmp62 = _tmp36 * _tmp58 - _tmp57;
  const Scalar _tmp63 = _tmp46 + _tmp59;
  const Scalar _tmp64 = _tmp37 * _tmp60;
  const Scalar _tmp65 = _tmp38 * (_tmp28 * _tmp63 - _tmp36 * _tmp64);
  const Scalar _tmp66 = _tmp38 * (-_tmp37 * _tmp63 + _tmp64);
  const Scalar _tmp67 = -_tmp42 * (_tmp49 * _tmp57 - _tmp58 * _tmp61 - _tmp62 * _tmp65) -
                        _tmp49 * _tmp58 + _tmp58 * _tmp60 - _tmp62 * _tmp66;
  ...
  const Scalar _tmp76 = _tmp38 * (-_tmp16 * _tmp28 + _tmp25 * _tmp37 + _tmp37 * _tmp75);
  const Scalar _tmp77 = -_tmp51 * _tmp57 + _tmp54 * _tmp58 + _tmp58 * _tmp75 - _tmp62 * _tmp76;
  const Scalar _tmp78 = Scalar(1.0) / (_tmp77);
  const Scalar _tmp79 = Scalar(1.0) * _tmp78;
  const Scalar _tmp80 = _tmp18 + _tmp53;
  const Scalar _tmp81 = _tmp80 - p_b(1, 0) + p_init1;
  const Scalar _tmp82 = _tmp15 + _tmp50;
  const Scalar _tmp83 = _tmp82 - p_b(0, 0) + p_init0;
  ...
  const Scalar _tmp87 = fh1 * (-_tmp80 * _tmp85 + _tmp82 * _tmp86);
  const Scalar _tmp88 = Scalar(1.0) * _tmp42 * _tmp65 - Scalar(1.0) * _tmp66;
  ...
  const Scalar _tmp92 = _tmp58 * _tmp68;
  const Scalar _tmp93 = -_tmp69 * _tmp91 + Scalar(1.0);
  const Scalar _tmp94 = _tmp86 * fh1;
  const Scalar _tmp95 = _tmp36 * _tmp66 - _tmp42 * (_tmp36 * _tmp65 + _tmp61) - _tmp60;
  const Scalar _tmp96 = _tmp90 * (_tmp36 * _tmp76 - _tmp75 - _tmp89 * _tmp95) + _tmp95;
  const Scalar _tmp97 = -_tmp36 - _tmp69 * _tmp96;
  const Scalar _tmp98 = _tmp85 * fh1;
  ...
  _res(1, 0) = std::exp(_tmp0 * _tmp73 * (-_tmp39 * _tmp70 + _tmp58 * _tmp71) +
                        _tmp73 * _tmp87 * (-_tmp39 * _tmp62 * _tmp79 + _tmp58 * _tmp79) +
                        _tmp73 * _tmp94 * (_tmp39 * _tmp93 + _tmp91 * _tmp92) +
                        _tmp73 * _tmp98 * (_tmp39 * _tmp97 + _tmp92 * _tmp96 + Scalar(1.0)));
  _res(2, 0) = std::exp(_tmp0 * _tmp38 * _tmp70 + _tmp38 * _tmp62 * _tmp99 -
                        _tmp38 * _tmp93 * _tmp94 - _tmp38 * _tmp97 * _tmp98);
  _res(3, 0) =
