...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl6(
  ...
  const Scalar _tmp18 = _tmp17 - p_a(1, 0) + p_init1;
  ...
  const Scalar _tmp28 = _tmp27 - p_a(0, 0) + p_init0;
  ...
  const Scalar _tmp38 = _tmp37 - p_c(0, 0) + p_init0;
  const Scalar _tmp39 = _tmp12 + _tmp15;
  const Scalar _tmp40 = _tmp39 + _tmp8;
  const Scalar _tmp41 = _tmp40 - p_c(1, 0) + p_init1;
  ...
  const Scalar _tmp45 = _tmp31 + _tmp32 + _tmp33;
  const Scalar _tmp46 = _tmp41 * _tmp42;
  const Scalar _tmp47 = -_tmp30 * _tmp44 + _tmp45 * _tmp46;
  const Scalar _tmp48 = Scalar(1.0) / (_tmp30 * _tmp43 - _tmp46);
  const Scalar _tmp49 = _tmp30 * _tmp48;
  const Scalar _tmp50 = Scalar(1.0) * _tmp17;
  const Scalar _tmp51 = Scalar(1.0) * _tmp27;
  const Scalar _tmp52 = (-_tmp37 + _tmp51) / (_tmp40 - _tmp50);
  const Scalar _tmp53 = -_tmp43 * _tmp45 + _tmp44;
  const Scalar _tmp54 = -_tmp35 + _tmp49 * _tmp53 - _tmp52 * (_tmp30 * _tmp35 + _tmp47 * _tmp49);
  ...
  const Scalar _tmp62 = _tmp31 + _tmp34;
  const Scalar _tmp63 = _tmp56 * _tmp59;
  const Scalar _tmp64 = _tmp30 * _tmp60 - _tmp63;
  const Scalar _tmp65 = _tmp48 * _tmp64;
  const Scalar _tmp66 = -_tmp52 * (-_tmp30 * _tmp61 - _tmp47 * _tmp65 + _tmp62 * _tmp63) -
                        _tmp53 * _tmp65 - _tmp60 * _tmp62 + _tmp61;
  const Scalar _tmp67 = Scalar(1.0) / (_tmp66);
  const Scalar _tmp68 =
      std::sqrt(Scalar(std::pow(_tmp18, Scalar(2)) + std::pow(_tmp28, Scalar(2))));
  const Scalar _tmp69 = Scalar(1.0) / (_tmp68);
  const Scalar _tmp70 = _tmp29 * _tmp68;
  const Scalar _tmp71 = _tmp70 * (-_tmp17 * _tmp28 * _tmp69 + _tmp18 * _tmp27 * _tmp69);
  const Scalar _tmp72 = -_tmp37 * _tmp46 + _tmp40 * _tmp43 + _tmp43 * _tmp71;
  ...
  const Scalar _tmp77 = _tmp54 + _tmp76 * (_tmp49 * _tmp72 - _tmp54 * _tmp74 - _tmp71);
  const Scalar _tmp78 = _tmp60 * _tmp67;
  const Scalar _tmp79 = _tmp64 * _tmp67;
  const Scalar _tmp80 = -_tmp30 - _tmp77 * _tmp79;
  const Scalar _tmp81 = _tmp43 * _tmp48;
  const Scalar _tmp82 = _tmp16 + _tmp8;
  const Scalar _tmp83 = _tmp82 - p_b(1, 0) + p_init1;
  const Scalar _tmp84 = _tmp20 + _tmp36;
  ...
  _res(1, 0) = std::exp(_tmp70 * _tmp88 * (_tmp77 * _tmp78 + _tmp80 * _tmp81 + Scalar(1.0)) +
                        _tmp70 * _tmp91 * (-_tmp43 * _tmp65 * _tmp89 + _tmp60 * _tmp89) +
                        _tmp70 * _tmp96 * (_tmp78 * _tmp94 + _tmp81 * _tmp95) +
                        _tmp70 * _tmp97 * (-_tmp100 * _tmp81 + _tmp101 * _tmp60));
  _res(2, 0) = std::exp(_tmp100 * _tmp48 * _tmp97 + _tmp102 * _tmp65 - _tmp48 * _tmp80 * _tmp88 -
                        _tmp48 * _tmp95 * _tmp96);
  _res(3, 0) =
      std::exp(-_tmp101 * _tmp97 - _tmp102 - _tmp67 * _tmp77 * _tmp88 - _tmp67 * _tmp94 * _tmp96);
