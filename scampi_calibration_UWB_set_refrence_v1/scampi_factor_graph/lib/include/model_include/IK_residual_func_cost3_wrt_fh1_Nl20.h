...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl20(
  ...
  const Scalar _tmp27 = _tmp26 - p_b(0, 0) + p_init0;
  ...
  const Scalar _tmp32 = _tmp31 - p_a(0, 0) + p_init0;
  const Scalar _tmp33 = -_tmp8;
  const Scalar _tmp34 = _tmp15 + _tmp33;
  const Scalar _tmp35 = _tmp34 - p_a(1, 0) + p_init1;
  ...
  const Scalar _tmp41 = Scalar(1.0) * _tmp26;
  const Scalar _tmp42 = Scalar(1.0) * _tmp16;
  const Scalar _tmp43 = (-_tmp31 + _tmp41) / (_tmp34 - _tmp42);
  ...
  const Scalar _tmp61 = _tmp29 * _tmp57 - _tmp60;
  const Scalar _tmp62 = -_tmp46 + _tmp49;
  const Scalar _tmp63 = _tmp29 * _tmp50;
  const Scalar _tmp64 = _tmp39 * (-_tmp37 * _tmp63 + _tmp38 * _tmp62);
  const Scalar _tmp65 = _tmp39 * (_tmp37 * _tmp50 - _tmp37 * _tmp62);
  const Scalar _tmp66 = -_tmp43 * (-_tmp29 * _tmp58 + _tmp59 * _tmp60 - _tmp61 * _tmp64) -
                        _tmp57 * _tmp59 + _tmp58 - _tmp61 * _tmp65;
  ...
  const Scalar _tmp73 = Scalar(1.0) * _tmp43 * _tmp64 - Scalar(1.0) * _tmp65;
  const Scalar _tmp74 = Scalar(1.0) / (_tmp71);
  const Scalar _tmp75 = _tmp72 * (-_tmp16 * _tmp27 * _tmp74 + _tmp17 * _tmp26 * _tmp74);
  const Scalar _tmp76 = _tmp39 * (-_tmp31 * _tmp38 + _tmp34 * _tmp37 + _tmp37 * _tmp75);
  const Scalar _tmp77 = -_tmp51 * _tmp60 + _tmp54 * _tmp57 + _tmp57 * _tmp75 - _tmp61 * _tmp76;
  const Scalar _tmp78 = _tmp67 * _tmp77;
  const Scalar _tmp79 = Scalar(1.0) / (_tmp77);
  const Scalar _tmp80 = _tmp66 * _tmp79;
  const Scalar _tmp81 = _tmp73 + _tmp80 * (-_tmp73 * _tmp78 - Scalar(1.0) * _tmp76);
  const Scalar _tmp82 = -_tmp68 * _tmp81 + Scalar(1.0);
  const Scalar _tmp83 = _tmp67 * _tmp81;
  const Scalar _tmp84 = _tmp33 + _tmp53;
  const Scalar _tmp85 = _tmp84 - p_d(1, 0) + p_init1;
  const Scalar _tmp86 = _tmp18 + _tmp30;
  ...
  const Scalar _tmp90 = _tmp72 * _tmp89 * (_tmp40 * _tmp82 + _tmp57 * _tmp83);
  const Scalar _tmp91 = _tmp87 * _tmp88;
  const Scalar _tmp92 = -_tmp84 * _tmp91 + _tmp86 * _tmp89;
  const Scalar _tmp93 = Scalar(1.0) * _tmp79;
  const Scalar _tmp94 = _tmp72 * _tmp92 * (-_tmp40 * _tmp61 * _tmp93 + _tmp57 * _tmp93);
  const Scalar _tmp95 = _tmp29 * _tmp65 - _tmp43 * (_tmp29 * _tmp64 + _tmp63) - _tmp50;
  const Scalar _tmp96 = _tmp80 * (_tmp29 * _tmp76 - _tmp75 - _tmp78 * _tmp95) + _tmp95;
  const Scalar _tmp97 = -_tmp29 - _tmp68 * _tmp96;
  const Scalar _tmp98 = _tmp67 * _tmp96;
  const Scalar _tmp99 = _tmp72 * _tmp91 * (_tmp40 * _tmp97 + _tmp57 * _tmp98 + Scalar(1.0));
  const Scalar _tmp100 = _tmp92 * _tmp93;
  const Scalar _tmp101 = _tmp100 * fh1;
  const Scalar _tmp102 = _tmp39 * _tmp61;
  const Scalar _tmp103 = _tmp39 * _tmp82 * _tmp89;
  const Scalar _tmp104 = _tmp39 * _tmp91 * _tmp97;
  ...
  _res(1, 0) = -(-_tmp90 - _tmp94 - _tmp99) *
               std::exp(_tmp0 * _tmp72 * (-_tmp40 * _tmp69 + _tmp57 * _tmp70) + _tmp90 * fh1 +
                        _tmp94 * fh1 + _tmp99 * fh1);
  _res(2, 0) =
      -(-_tmp100 * _tmp102 + _tmp103 + _tmp104) *
      std::exp(_tmp0 * _tmp39 * _tmp69 + _tmp101 * _tmp102 - _tmp103 * fh1 - _tmp104 * fh1);
  _res(3, 0) = -(_tmp100 + _tmp105 + _tmp106) *
               std::exp(-_tmp0 * _tmp70 - _tmp101 - _tmp105 * fh1 - _tmp106 * fh1);
