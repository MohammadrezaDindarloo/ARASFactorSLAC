...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl7(
  ...
  const Scalar _tmp16 = _tmp15 - p_b(1, 0) + p_init1;
  ...
  const Scalar _tmp31 = _tmp17 + _tmp24;
  ...
  const Scalar _tmp50 = _tmp33 + _tmp42;
  ...
  const Scalar _tmp59 = -_tmp37 + _tmp38 * _tmp58;
  const Scalar _tmp60 = Scalar(1.0) / (_tmp55 * _tmp58 - _tmp56);
  const Scalar _tmp61 = _tmp59 * _tmp60;
  const Scalar _tmp62 = -_tmp31 * _tmp37 + _tmp34 * _tmp38 + _tmp38 * _tmp49 - _tmp57 * _tmp61;
  const Scalar _tmp63 = Scalar(1.0) / (_tmp62);
  const Scalar _tmp64 = Scalar(1.0) * _tmp63;
  const Scalar _tmp65 = _tmp55 * _tmp61;
  const Scalar _tmp66 = _tmp30 * _tmp48 * (_tmp38 * _tmp64 - _tmp64 * _tmp65);
  ...
  const Scalar _tmp74 = -_tmp55 * _tmp73 + _tmp56 * _tmp71;
  const Scalar _tmp75 = _tmp58 * _tmp60;
  const Scalar _tmp76 = Scalar(1.0) * _tmp43;
  const Scalar _tmp77 = Scalar(1.0) * _tmp40;
  const Scalar _tmp78 = (-_tmp52 + _tmp77) / (_tmp50 - _tmp76);
  const Scalar _tmp79 = -_tmp55 * _tmp71 + _tmp55 * _tmp72;
  const Scalar _tmp80 = -_tmp72 + _tmp75 * _tmp79 - _tmp78 * (_tmp73 + _tmp74 * _tmp75);
  const Scalar _tmp81 = _tmp38 * _tmp72;
  const Scalar _tmp82 = _tmp67 + _tmp68 + _tmp69;
  const Scalar _tmp83 = -_tmp38 * _tmp82 - _tmp61 * _tmp79 -
                        _tmp78 * (_tmp37 * _tmp82 - _tmp58 * _tmp81 - _tmp61 * _tmp74) + _tmp81;
  const Scalar _tmp84 = Scalar(1.0) / (_tmp83);
  const Scalar _tmp85 = _tmp62 * _tmp84;
  const Scalar _tmp86 = _tmp63 * _tmp83;
  const Scalar _tmp87 = _tmp80 + _tmp86 * (-_tmp49 + _tmp57 * _tmp75 - _tmp80 * _tmp85);
  const Scalar _tmp88 = _tmp59 * _tmp84;
  const Scalar _tmp89 = _tmp60 * (-_tmp58 - _tmp87 * _tmp88);
  const Scalar _tmp90 = _tmp84 * _tmp87;
  const Scalar _tmp91 = _tmp28 * _tmp48 * (_tmp38 * _tmp90 + _tmp55 * _tmp89 + Scalar(1.0));
  ...
  const Scalar _tmp96 = _tmp74 * _tmp78 * _tmp95 - _tmp79 * _tmp95;
  const Scalar _tmp97 = _tmp86 * (-_tmp57 * _tmp95 - _tmp85 * _tmp96) + _tmp96;
  const Scalar _tmp98 = _tmp60 * (-_tmp88 * _tmp97 + Scalar(1.0));
  const Scalar _tmp99 = _tmp84 * _tmp97;
  const Scalar _tmp100 = _tmp29 * _tmp48 * (_tmp38 * _tmp99 + _tmp55 * _tmp98);
  const Scalar _tmp101 = _tmp30 * _tmp64;
  const Scalar _tmp102 = _tmp101 * fh1;
  const Scalar _tmp103 = _tmp29 * _tmp98;
  ...
  _res(1, 0) = -(-_tmp100 - _tmp66 - _tmp91) *
               std::exp(_tmp100 * fh1 + _tmp48 * _tmp92 * (_tmp38 * _tmp94 - _tmp65 * _tmp94) +
                        _tmp66 * fh1 + _tmp91 * fh1);
  _res(2, 0) = -(-_tmp101 * _tmp61 + _tmp103 + _tmp104) *
               std::exp(_tmp102 * _tmp61 - _tmp103 * fh1 - _tmp104 * fh1 + _tmp105 * _tmp61);
  _res(3, 0) =
