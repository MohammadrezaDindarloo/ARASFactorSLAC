...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl9(
  ...
  const Scalar _tmp30 = _tmp18 + _tmp24;
  const Scalar _tmp31 = _tmp30 - p_c(0, 0) + p_init0;
  ...
  const Scalar _tmp40 = _tmp15 * _tmp28 - _tmp25 * _tmp29 + _tmp28 * _tmp39;
  ...
  const Scalar _tmp52 = -_tmp28 * _tmp49 + _tmp29 * _tmp51;
  ...
  const Scalar _tmp56 = _tmp28 * _tmp48 - _tmp28 * _tmp51;
  const Scalar _tmp57 = _tmp43 * _tmp56 - _tmp48 - _tmp55 * (_tmp43 * _tmp52 + _tmp49);
  ...
  const Scalar _tmp69 = _tmp39 * _tmp65 - _tmp40 * _tmp68 - _tmp59 * _tmp66 + _tmp62 * _tmp65;
  const Scalar _tmp70 = _tmp45 - _tmp46 + _tmp50;
  const Scalar _tmp71 = _tmp48 * _tmp65;
  const Scalar _tmp72 = -_tmp55 * (-_tmp41 * _tmp71 - _tmp52 * _tmp68 + _tmp66 * _tmp70) -
                        _tmp56 * _tmp68 - _tmp65 * _tmp70 + _tmp71;
  const Scalar _tmp73 = Scalar(1.0) / (_tmp72);
  const Scalar _tmp74 = _tmp69 * _tmp73;
  const Scalar _tmp75 = Scalar(1.0) / (_tmp69);
  const Scalar _tmp76 = _tmp72 * _tmp75;
  const Scalar _tmp77 = _tmp57 + _tmp76 * (-_tmp39 + _tmp40 * _tmp43 - _tmp57 * _tmp74);
  const Scalar _tmp78 = _tmp65 * _tmp73;
  const Scalar _tmp79 = _tmp67 * _tmp73;
  const Scalar _tmp80 = -_tmp41 - _tmp77 * _tmp79;
  const Scalar _tmp81 = _tmp28 * _tmp42;
  ...
  const Scalar _tmp88 = _tmp38 * _tmp87 * (_tmp77 * _tmp78 + _tmp80 * _tmp81 + Scalar(1.0));
  const Scalar _tmp89 = Scalar(1.0) * _tmp42;
  const Scalar _tmp90 = _tmp52 * _tmp55 * _tmp89 - _tmp56 * _tmp89;
  const Scalar _tmp91 = _tmp76 * (-_tmp40 * _tmp89 - _tmp74 * _tmp90) + _tmp90;
  const Scalar _tmp92 = -_tmp79 * _tmp91 + Scalar(1.0);
  const Scalar _tmp93 = _tmp83 * _tmp86;
  const Scalar _tmp94 = _tmp38 * _tmp93 * (_tmp78 * _tmp91 + _tmp81 * _tmp92);
  ...
  const Scalar _tmp100 = -_tmp82 * _tmp87 + _tmp84 * _tmp93;
  const Scalar _tmp101 = Scalar(1.0) * _tmp75;
  const Scalar _tmp102 = _tmp100 * _tmp38 * (-_tmp101 * _tmp28 * _tmp68 + _tmp101 * _tmp65);
  const Scalar _tmp103 = _tmp42 * _tmp80 * _tmp87;
  const Scalar _tmp104 = _tmp42 * _tmp92 * _tmp93;
  const Scalar _tmp105 = _tmp100 * _tmp101;
  const Scalar _tmp106 = _tmp105 * fh1;
  const Scalar _tmp107 = _tmp73 * _tmp91 * _tmp93;
  const Scalar _tmp108 = _tmp73 * _tmp77 * _tmp87;

  // Output terms (1)
  Eigen::Matrix<Scalar, 4, 1> _res;

  _res(0, 0) = -std::exp(-fh1);
  _res(1, 0) = -(-_tmp102 - _tmp88 - _tmp94) *
               std::exp(_tmp102 * fh1 + _tmp38 * _tmp95 * (_tmp65 * _tmp98 - _tmp81 * _tmp99) +
                        _tmp88 * fh1 + _tmp94 * fh1);
  _res(2, 0) =
      -(_tmp103 + _tmp104 - _tmp105 * _tmp68) *
      std::exp(-_tmp103 * fh1 - _tmp104 * fh1 + _tmp106 * _tmp68 + _tmp42 * _tmp95 * _tmp99);
  _res(3, 0) = -(_tmp105 + _tmp107 + _tmp108) *
               std::exp(-_tmp106 - _tmp107 * fh1 - _tmp108 * fh1 - _tmp95 * _tmp98);
