...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl9(
  ...
  const Scalar _tmp68 = _tmp39 * _tmp64 - _tmp40 * _tmp67 - _tmp58 * _tmp65 + _tmp61 * _tmp64;
  const Scalar _tmp69 = -_tmp46 + _tmp49;
  const Scalar _tmp70 = _tmp47 * _tmp64;
  const Scalar _tmp71 = -_tmp54 * (-_tmp41 * _tmp70 - _tmp51 * _tmp67 + _tmp65 * _tmp69) -
                        _tmp55 * _tmp67 - _tmp64 * _tmp69 + _tmp70;
  ...
  const Scalar _tmp98 = _tmp38 * (_tmp64 * _tmp96 - _tmp80 * _tmp97);
  ...
  const Scalar _tmp103 = _tmp42 * _tmp97;
  ...
  _res(0, 0) = 0;
  _res(1, 0) =
      -_tmp98 * std::exp(_tmp100 * _tmp38 * (-_tmp28 * _tmp67 * _tmp99 + _tmp64 * _tmp99) +
                         _tmp86 * _tmp87 * (_tmp76 * _tmp77 + _tmp79 * _tmp80 + Scalar(1.0)) +
                         _tmp87 * _tmp92 * (_tmp77 * _tmp90 + _tmp80 * _tmp91) + _tmp93 * _tmp98);
  _res(2, 0) = -_tmp103 * std::exp(-_tmp101 * _tmp79 * _tmp86 - _tmp101 * _tmp91 * _tmp92 +
                                   _tmp102 * _tmp67 + _tmp103 * _tmp93);
  _res(3, 0) = _tmp96 * std::exp(-_tmp102 - _tmp104 * _tmp76 * _tmp86 - _tmp104 * _tmp90 * _tmp92 -
                                 _tmp93 * _tmp96);
