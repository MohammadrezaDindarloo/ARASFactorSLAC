...
Eigen::Matrix<Scalar, 4, 3> FkResidualFuncCost4WrtPb(
  ...
  const Scalar _tmp11 = -Scalar(0.20999999999999999) * _tmp1 -
                        ...
                        p_b(0, 0) - position_vector(0, 0) + Scalar(-0.20999999999999999);
  ...
  const Scalar _tmp16 =
      ...
      Scalar(0.20999999999999999) * _tmp3 - Scalar(0.20999999999999999) * _tmp9 + p_b(1, 0) -
      position_vector(1, 0);
  ...
  _res(1, 1) = _tmp16 * _tmp17;
  _res(1, 2) = _tmp15 * _tmp17;
