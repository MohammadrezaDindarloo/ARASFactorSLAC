...
Eigen::Matrix<Scalar, 4, 3> FkResidualFuncCost4WrtPc(
  ...
  const Scalar _tmp11 = -Scalar(0.20999999999999999) * _tmp1 +
                        ...
                        p_c(0, 0) - position_vector(0, 0) + Scalar(-0.20999999999999999);
  ...
  const Scalar _tmp15 = Scalar(0.010999999999999999) * _tmp1 +
                        ...
                        Scalar(0.20999999999999999) * _tmp8 + p_c(2, 0) - position_vector(2, 0);
  const Scalar _tmp16 =
      ...
      Scalar(0.20999999999999999) * _tmp3 - Scalar(0.20999999999999999) * _tmp9 + p_c(1, 0) -
      position_vector(1, 0);
  ...
  _res(2, 0) = _tmp11 * _tmp17;
  _res(2, 1) = _tmp16 * _tmp17;
  _res(2, 2) = _tmp15 * _tmp17;
