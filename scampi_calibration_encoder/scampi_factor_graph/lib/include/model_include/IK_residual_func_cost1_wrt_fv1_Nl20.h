...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1WrtFv1Nl20(
  ...
  const Scalar _tmp45 = _tmp24 + _tmp39;
  ...
  const Scalar _tmp59 = _tmp23 + _tmp24 + _tmp29;
  ...
  const Scalar _tmp68 = -Scalar(0.010999999999999999) * _tmp22 -
  ...
  const Scalar _tmp74 = _tmp53 * _tmp71;
  const Scalar _tmp75 = -_tmp67;
  const Scalar _tmp76 = _tmp70 + _tmp75;
  const Scalar _tmp77 = _tmp44 * _tmp71;
  const Scalar _tmp78 = _tmp55 * (-_tmp53 * _tmp77 + _tmp54 * _tmp76);
  const Scalar _tmp79 = _tmp63 * _tmp73 - _tmp64 * _tmp74 - _tmp65 * _tmp78;
  const Scalar _tmp80 = Scalar(1.0) * _tmp46;
  const Scalar _tmp81 = -_tmp80;
  const Scalar _tmp82 = Scalar(1.0) / (_tmp40 + _tmp81);
  const Scalar _tmp83 = Scalar(1.0) * _tmp49;
  const Scalar _tmp84 = _tmp82 * (-_tmp36 + _tmp83);
  const Scalar _tmp85 = -_tmp44 * _tmp76 + _tmp77;
  const Scalar _tmp86 = _tmp64 * _tmp71 - _tmp64 * _tmp73 - _tmp66 * _tmp85 - _tmp79 * _tmp84;
  ...
  const Scalar _tmp93 = _tmp92 * (-_tmp44 * _tmp90 + _tmp64 * _tmp89);
  const Scalar _tmp94 = Scalar(1.0) * _tmp55;
  const Scalar _tmp95 = Scalar(1.0) * _tmp78;
  const Scalar _tmp96 = _tmp84 * _tmp95 - _tmp85 * _tmp94;
  const Scalar _tmp97 = Scalar(1.0) / (_tmp91);
  const Scalar _tmp98 = _tmp92 * (-_tmp46 * _tmp51 * _tmp97 + _tmp48 * _tmp49 * _tmp97);
  const Scalar _tmp99 = -_tmp36 * _tmp54 + _tmp40 * _tmp44 + _tmp44 * _tmp98;
  const Scalar _tmp100 = -_tmp56 * _tmp63 + _tmp59 * _tmp64 + _tmp64 * _tmp98 - _tmp66 * _tmp99;
  ...
  const Scalar _tmp105 = _tmp87 * (_tmp104 + _tmp96);
  const Scalar _tmp106 = -_tmp105 * _tmp65 + Scalar(1.0);
  const Scalar _tmp107 = _tmp44 * _tmp55;
  ...
  const Scalar _tmp115 = fh1 * (_tmp111 * _tmp20 - _tmp114 * _tmp31);
  const Scalar _tmp116 = _tmp53 * _tmp55;
  const Scalar _tmp117 = _tmp53 * _tmp78 + _tmp74;
  const Scalar _tmp118 = _tmp116 * _tmp85 - _tmp117 * _tmp84 - _tmp71;
  const Scalar _tmp119 = _tmp103 * (-_tmp101 * _tmp118 + _tmp116 * _tmp99 - _tmp98);
  const Scalar _tmp120 = _tmp87 * (_tmp118 + _tmp119);
  const Scalar _tmp121 = -_tmp120 * _tmp65 - _tmp53;
  const Scalar _tmp122 = _tmp114 * fh1;
  const Scalar _tmp123 = -_tmp112 * _tmp92 * (_tmp105 * _tmp64 + _tmp106 * _tmp107) -
                         _tmp115 * _tmp92 * (-_tmp113 * _tmp44 * _tmp66 + _tmp113 * _tmp64) -
                         _tmp122 * _tmp92 * (_tmp107 * _tmp121 + _tmp120 * _tmp64 + Scalar(1.0)) -
                         _tmp34 * _tmp93;
  ...
  const Scalar _tmp127 = _tmp59 + _tmp81;
  ...
  const Scalar _tmp131 = _tmp117 + _tmp119 * _tmp130 - _tmp120 * _tmp79;
  const Scalar _tmp132 = Scalar(1.0) * _tmp82;
  const Scalar _tmp133 = Scalar(1.0) * _tmp129;
  const Scalar _tmp134 = fh1 * (_tmp72 + _tmp75);
  const Scalar _tmp135 = _tmp114 * _tmp134 + Scalar(3.29616) * _tmp13 + _tmp20 * fv1;
  const Scalar _tmp136 = _tmp127 * _tmp82;
  const Scalar _tmp137 = Scalar(1.0) * _tmp133 * _tmp136 - Scalar(1.0) * _tmp133;
  const Scalar _tmp138 = _tmp129 * _tmp88;
  const Scalar _tmp139 = _tmp82 * (-_tmp127 * _tmp138 - _tmp79 * _tmp89 + _tmp81);
  const Scalar _tmp140 = -Scalar(1.0) * _tmp133 * _tmp88 - Scalar(1.0) * _tmp139 + Scalar(1.0);
  const Scalar _tmp141 = _tmp103 * _tmp133;
  const Scalar _tmp142 = -_tmp113 * _tmp79 + _tmp127 * _tmp141;
  const Scalar _tmp143 = -_tmp111 * _tmp134 - Scalar(3.29616) * _tmp27 - _tmp31 * fv1;
  const Scalar _tmp144 = _tmp133 * _tmp84;
  const Scalar _tmp145 = _tmp128 * _tmp133 + Scalar(1.0);
  const Scalar _tmp146 = -Scalar(1.0) * _tmp132 * _tmp145 + Scalar(1.0) * _tmp144;
  const Scalar _tmp147 = _tmp104 * _tmp130 - _tmp105 * _tmp79 - _tmp95;
  const Scalar _tmp148 = Scalar(1.0) * _tmp112 * (_tmp104 * _tmp133 - _tmp132 * _tmp147) +
                         Scalar(1.0) * _tmp115 * (-_tmp132 * _tmp142 + _tmp141) +
                         Scalar(1.0) * _tmp122 * (_tmp119 * _tmp133 - _tmp131 * _tmp132) +
                         _tmp135 * _tmp137 + _tmp140 * _tmp34 + _tmp143 * _tmp146;
  ...
  const Scalar _tmp152 = _tmp28 + _tmp45;
  const Scalar _tmp153 =
      (-_tmp125 * _tmp148 + _tmp149 * (_tmp137 * _tmp20 - _tmp140 + _tmp146 * _tmp152)) /
      std::sqrt(Scalar(_tmp124 * std::pow(_tmp148, Scalar(2)) + 1));
  const Scalar _tmp154 = Scalar(9.6622558468725703) * _tmp123;
  const Scalar _tmp155 =
      -_tmp150 * _tmp154 - std::sqrt(Scalar(std::pow(Scalar(-_tmp47 + p_b(1, 0)), Scalar(2)) +
  ...
  const Scalar _tmp160 = _tmp145 * _tmp82;
  const Scalar _tmp161 = _tmp112 * _tmp147 * _tmp82 + _tmp115 * _tmp142 * _tmp82 +
                         _tmp122 * _tmp131 * _tmp82 - _tmp136 * _tmp159 + _tmp139 * _tmp34 +
                         _tmp143 * _tmp160;
  const Scalar _tmp162 = _tmp113 * _tmp115;
  const Scalar _tmp163 = _tmp34 * _tmp89;
  const Scalar _tmp164 =
      _tmp106 * _tmp112 * _tmp55 + _tmp121 * _tmp122 * _tmp55 - _tmp162 * _tmp66 - _tmp163 * _tmp66;
  ...
  const Scalar _tmp168 =
      -_tmp166 * _tmp167 - std::sqrt(Scalar(std::pow(Scalar(-_tmp37 + p_a(0, 0)), Scalar(2)) +
  ...
  const Scalar _tmp173 = _tmp172 * _tmp66;
  const Scalar _tmp174 = _tmp133 * _tmp20;
  const Scalar _tmp175 =
      (-_tmp161 * _tmp170 + _tmp165 * (-_tmp136 * _tmp174 - _tmp139 + _tmp152 * _tmp160)) /
  ...
  const Scalar _tmp179 = -_tmp104 * _tmp112 * _tmp129 - _tmp115 * _tmp141 -
                         _tmp119 * _tmp122 * _tmp129 + _tmp138 * _tmp34 - _tmp143 * _tmp144 +
                         _tmp159;
  const Scalar _tmp180 = _tmp105 * _tmp112 + _tmp120 * _tmp122 + _tmp162 + _tmp163;
  ...
  const Scalar _tmp185 =
      -_tmp182 * _tmp184 - std::sqrt(Scalar(std::pow(Scalar(-_tmp57 + p_c(0, 0)), Scalar(2)) +
  ...
  const Scalar _tmp191 = (_tmp179 * _tmp189 + _tmp181 * (-_tmp138 - _tmp144 * _tmp152 + _tmp174)) /
  ...
  _res(1, 0) =
      -_tmp154 * (-_tmp126 * p_b(2, 0) + Scalar(1.0) * _tmp153 * std::sinh(_tmp151) -
                  (-_tmp126 * _tmp155 + _tmp156 * (-_tmp150 * _tmp158 - _tmp153 * _tmp154)) *
                      std::sinh(_tmp157)) -
      _tmp158 * (_tmp156 * p_b(2, 0) + std::cosh(_tmp151) - std::cosh(_tmp157));
  _res(2, 0) =
      -_tmp167 * (-_tmp171 * p_a(2, 0) + Scalar(1.0) * _tmp175 * std::sinh(_tmp178) -
                  (-_tmp168 * _tmp171 + _tmp176 * (-_tmp166 * _tmp173 - _tmp167 * _tmp175)) *
                      std::sinh(_tmp177)) -
      _tmp173 * (_tmp176 * p_a(2, 0) - std::cosh(_tmp177) + std::cosh(_tmp178));
  _res(3, 0) = _tmp172 * (_tmp186 * p_c(2, 0) + std::cosh(_tmp183) - std::cosh(_tmp187)) -
               _tmp184 * (_tmp190 * p_c(2, 0) + Scalar(1.0) * _tmp191 * std::sinh(_tmp183) -
