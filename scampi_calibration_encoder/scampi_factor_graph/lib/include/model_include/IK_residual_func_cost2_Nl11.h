...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl11(
  ...
  const Scalar _tmp39 = _tmp13 + _tmp9;
  ...
  const Scalar _tmp53 = _tmp26 + _tmp31;
  ...
  const Scalar _tmp58 = _tmp47 - p_d(1, 0);
  const Scalar _tmp59 = _tmp44 - p_d(0, 0);
  ...
  const Scalar _tmp75 = _tmp14 + _tmp38;
  const Scalar _tmp76 = _tmp40 * _tmp61;
  const Scalar _tmp77 = _tmp39 + _tmp6;
  const Scalar _tmp78 = _tmp57 * _tmp77 - _tmp62 * _tmp76;
  const Scalar _tmp79 = -_tmp71 * _tmp76 + _tmp72 * _tmp75 - _tmp74 * _tmp78;
  ...
  const Scalar _tmp84 = _tmp82 * (-_tmp50 + _tmp83);
  const Scalar _tmp85 = _tmp40 * _tmp62 - _tmp62 * _tmp77;
  const Scalar _tmp86 = _tmp40 * _tmp71 - _tmp71 * _tmp75 - _tmp74 * _tmp85 - _tmp79 * _tmp84;
  ...
  const Scalar _tmp93 = _tmp91 * (_tmp43 * _tmp58 * _tmp92 - _tmp46 * _tmp59 * _tmp92);
  const Scalar _tmp94 = -_tmp50 * _tmp57 + _tmp53 * _tmp62 + _tmp62 * _tmp93;
  const Scalar _tmp95 = -_tmp64 * _tmp72 + _tmp67 * _tmp71 + _tmp71 * _tmp93 - _tmp74 * _tmp94;
  const Scalar _tmp96 = Scalar(1.0) / (_tmp95);
  const Scalar _tmp97 = Scalar(1.0) * _tmp96;
  const Scalar _tmp98 = Scalar(1.0) * _tmp63;
  const Scalar _tmp99 = _tmp73 * _tmp96 * _tmp98;
  const Scalar _tmp100 = _tmp33 - p_b(1, 0);
  const Scalar _tmp101 = _tmp25 - p_b(0, 0);
  ...
  const Scalar _tmp105 = fh1 * (-_tmp103 * _tmp32 + _tmp104 * _tmp24);
  const Scalar _tmp106 = _tmp78 * _tmp98;
  const Scalar _tmp107 = _tmp106 * _tmp84 - _tmp85 * _tmp98;
  const Scalar _tmp108 = _tmp87 * _tmp95;
  const Scalar _tmp109 = _tmp86 * _tmp96;
  const Scalar _tmp110 = _tmp109 * (-_tmp107 * _tmp108 - _tmp94 * _tmp98);
  const Scalar _tmp111 = _tmp107 + _tmp110;
  const Scalar _tmp112 = _tmp71 * _tmp87;
  const Scalar _tmp113 = _tmp73 * _tmp87;
  const Scalar _tmp114 = -_tmp111 * _tmp113 + Scalar(1.0);
  const Scalar _tmp115 = _tmp62 * _tmp63;
  const Scalar _tmp116 = _tmp104 * fh1;
  const Scalar _tmp117 = _tmp61 * _tmp63;
  const Scalar _tmp118 = _tmp117 * _tmp78 + _tmp76;
  const Scalar _tmp119 = _tmp117 * _tmp85 - _tmp118 * _tmp84 - _tmp40;
  const Scalar _tmp120 = _tmp109 * (-_tmp108 * _tmp119 + _tmp117 * _tmp94 - _tmp93);
  const Scalar _tmp121 = _tmp119 + _tmp120;
  const Scalar _tmp122 = -_tmp113 * _tmp121 - _tmp61;
  const Scalar _tmp123 = _tmp103 * fh1;
  const Scalar _tmp124 = -_tmp105 * _tmp91 * (-_tmp62 * _tmp99 + _tmp71 * _tmp97) -
                         _tmp116 * _tmp91 * (_tmp111 * _tmp112 + _tmp114 * _tmp115) -
                         _tmp123 * _tmp91 * (_tmp112 * _tmp121 + _tmp115 * _tmp122 + Scalar(1.0)) -
                         _tmp49 * _tmp91 * (-_tmp62 * _tmp74 * _tmp89 + _tmp71 * _tmp89);
  const Scalar _tmp125 = Scalar(1.0) / (_tmp124);
  const Scalar _tmp126 = _tmp15 * fh1;
  const Scalar _tmp127 = _tmp103 * _tmp126 + Scalar(3.29616) * _tmp18 + _tmp24 * fv1;
  const Scalar _tmp128 = _tmp67 + _tmp81;
  const Scalar _tmp129 = _tmp128 * _tmp84;
  const Scalar _tmp130 = Scalar(1.0) / (-_tmp129 - _tmp64 + _tmp83);
  const Scalar _tmp131 = Scalar(1.0) * _tmp130;
  const Scalar _tmp132 = _tmp128 * _tmp82;
  const Scalar _tmp133 = _tmp130 * _tmp88;
  const Scalar _tmp134 = -_tmp128 * _tmp133 - _tmp79 * _tmp89 + _tmp81;
  const Scalar _tmp135 = Scalar(1.0) * _tmp82;
  const Scalar _tmp136 = _tmp109 * _tmp131;
  const Scalar _tmp137 = _tmp128 * _tmp136 - _tmp79 * _tmp97;
  const Scalar _tmp138 = _tmp128 * _tmp130;
  const Scalar _tmp139 = _tmp79 * _tmp87;
  const Scalar _tmp140 = -_tmp106 + _tmp110 * _tmp138 - _tmp111 * _tmp139;
  const Scalar _tmp141 = _tmp131 * _tmp84;
  const Scalar _tmp142 = _tmp129 * _tmp131 + Scalar(1.0);
  const Scalar _tmp143 = -_tmp104 * _tmp126 - Scalar(3.29616) * _tmp28 - _tmp32 * fv1;
  const Scalar _tmp144 = _tmp118 + _tmp120 * _tmp138 - _tmp121 * _tmp139;
  const Scalar _tmp145 = std::asinh(
      _tmp125 * (Scalar(1.0) * _tmp105 * (-_tmp135 * _tmp137 + _tmp136) +
                 Scalar(1.0) * _tmp116 * (_tmp110 * _tmp131 - _tmp135 * _tmp140) +
                 Scalar(1.0) * _tmp123 * (_tmp120 * _tmp131 - _tmp135 * _tmp144) +
                 Scalar(1.0) * _tmp127 * (_tmp131 * _tmp132 - _tmp131) +
                 Scalar(1.0) * _tmp143 * (-_tmp135 * _tmp142 + _tmp141) +
                 Scalar(1.0) * _tmp49 * (-_tmp131 * _tmp88 - _tmp134 * _tmp135 + Scalar(1.0))));
  const Scalar _tmp146 = Scalar(9.6622558468725703) * _tmp124;
  const Scalar _tmp147 = _tmp49 * _tmp89;
  const Scalar _tmp148 = -_tmp105 * _tmp99 + _tmp114 * _tmp116 * _tmp63 +
                         _tmp122 * _tmp123 * _tmp63 - _tmp147 * _tmp74;
  const Scalar _tmp149 = Scalar(1.0) / (_tmp148);
  const Scalar _tmp150 = std::pow(Scalar(-_tmp51 + p_c(0, 0)), Scalar(2)) +
                         std::pow(Scalar(-_tmp54 + p_c(1, 0)), Scalar(2));
  const Scalar _tmp151 = _tmp127 * _tmp131;
  const Scalar _tmp152 =
      std::asinh(_tmp149 * (_tmp105 * _tmp137 * _tmp82 + _tmp116 * _tmp140 * _tmp82 +
                            _tmp123 * _tmp144 * _tmp82 - _tmp132 * _tmp151 +
                            _tmp134 * _tmp49 * _tmp82 + _tmp142 * _tmp143 * _tmp82));
  const Scalar _tmp153 = Scalar(9.6622558468725703) * _tmp148;
  const Scalar _tmp154 = std::pow(Scalar(-_tmp65 + p_a(0, 0)), Scalar(2)) +
                         std::pow(Scalar(-_tmp68 + p_a(1, 0)), Scalar(2));
  const Scalar _tmp155 =
      _tmp105 * _tmp97 + _tmp111 * _tmp116 * _tmp87 + _tmp121 * _tmp123 * _tmp87 + _tmp147;
  const Scalar _tmp156 = Scalar(1.0) / (_tmp155);
  const Scalar _tmp157 = std::asinh(_tmp156 * (-_tmp105 * _tmp136 - _tmp110 * _tmp116 * _tmp130 -
                                               _tmp120 * _tmp123 * _tmp130 + _tmp133 * _tmp49 -
  ...
  _res(2, 0) =
      ...
      std::sqrt(Scalar(_tmp150 + std::pow(Scalar(-_tmp77 + p_c(2, 0) - p_init2), Scalar(2))));
  _res(3, 0) =
      _tmp158 *
          (-std::sinh(Scalar(1.0) * _tmp157) -
           std::sinh(Scalar(0.1034955) * _tmp156 * (-std::sqrt(_tmp154) - _tmp157 * _tmp158))) -
      std::sqrt(Scalar(_tmp154 + std::pow(Scalar(-_tmp75 + p_a(2, 0) - p_init2), Scalar(2))));
