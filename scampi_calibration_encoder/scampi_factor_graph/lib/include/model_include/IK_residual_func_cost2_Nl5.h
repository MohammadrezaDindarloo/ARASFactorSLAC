...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl5(
  ...
  const Scalar _tmp47 = std::pow(Scalar(-_tmp44 + p_d(0, 0)), Scalar(2)) +
                        std::pow(Scalar(-_tmp46 + p_d(1, 0)), Scalar(2));
  const Scalar _tmp48 = _tmp46 - p_d(1, 0);
  const Scalar _tmp49 = _tmp44 - p_d(0, 0);
  ...
  const Scalar _tmp56 = _tmp18 + _tmp25;
  ...
  const Scalar _tmp62 = _tmp51 * _tmp60 - _tmp61;
  const Scalar _tmp63 =
      std::sqrt(Scalar(std::pow(_tmp48, Scalar(2)) + std::pow(_tmp49, Scalar(2))));
  const Scalar _tmp64 = Scalar(1.0) / (_tmp63);
  const Scalar _tmp65 = _tmp50 * _tmp63;
  const Scalar _tmp66 = _tmp65 * (_tmp43 * _tmp48 * _tmp64 - _tmp45 * _tmp49 * _tmp64);
  const Scalar _tmp67 = _tmp18 + _tmp42;
  const Scalar _tmp68 = _tmp67 + p_init0;
  const Scalar _tmp69 = _tmp68 - p_c(0, 0);
  const Scalar _tmp70 = _tmp28 + _tmp52;
  ...
  const Scalar _tmp76 = Scalar(1.0) / (_tmp51 * _tmp75 - _tmp74);
  const Scalar _tmp77 = _tmp76 * (_tmp66 * _tmp75 - _tmp67 * _tmp74 + _tmp70 * _tmp75);
  const Scalar _tmp78 = _tmp53 * _tmp60 - _tmp56 * _tmp61 + _tmp60 * _tmp66 - _tmp62 * _tmp77;
  const Scalar _tmp79 = Scalar(1.0) / (_tmp78);
  const Scalar _tmp80 = Scalar(1.0) * _tmp79;
  const Scalar _tmp81 = _tmp75 * _tmp76;
  const Scalar _tmp82 = _tmp27 - p_a(0, 0);
  const Scalar _tmp83 = _tmp35 - p_a(1, 0);
  ...
  const Scalar _tmp87 = fh1 * (_tmp26 * _tmp85 - _tmp34 * _tmp86);
  const Scalar _tmp88 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp89 = _tmp41 * _tmp60;
  const Scalar _tmp90 = _tmp15 + _tmp7;
  const Scalar _tmp91 = _tmp40 + _tmp7;
  const Scalar _tmp92 = _tmp41 * _tmp51;
  const Scalar _tmp93 = _tmp76 * (_tmp74 * _tmp91 - _tmp75 * _tmp92);
  const Scalar _tmp94 = -_tmp51 * _tmp89 + _tmp61 * _tmp90 - _tmp62 * _tmp93;
  const Scalar _tmp95 = Scalar(1.0) * _tmp45;
  const Scalar _tmp96 = -_tmp95;
  const Scalar _tmp97 = Scalar(1.0) / (_tmp70 + _tmp96);
  const Scalar _tmp98 = Scalar(1.0) * _tmp43;
  const Scalar _tmp99 = -_tmp67 + _tmp98;
  const Scalar _tmp100 = _tmp97 * _tmp99;
  const Scalar _tmp101 = _tmp76 * (_tmp41 * _tmp75 - _tmp75 * _tmp91);
  const Scalar _tmp102 = -_tmp100 * _tmp94 - _tmp101 * _tmp62 - _tmp60 * _tmp90 + _tmp89;
  ...
  const Scalar _tmp107 = _tmp103 * _tmp62;
  const Scalar _tmp108 = _tmp105 * _tmp107;
  const Scalar _tmp109 = Scalar(1.0) * _tmp97;
  const Scalar _tmp110 = -Scalar(1.0) * _tmp101 + _tmp109 * _tmp93 * _tmp99;
  const Scalar _tmp111 = _tmp103 * _tmp78;
  const Scalar _tmp112 = _tmp102 * _tmp79;
  const Scalar _tmp113 = _tmp112 * (-_tmp110 * _tmp111 - Scalar(1.0) * _tmp77);
  const Scalar _tmp114 = _tmp110 + _tmp113;
  const Scalar _tmp115 = _tmp103 * _tmp60;
  const Scalar _tmp116 = -_tmp107 * _tmp114 + Scalar(1.0);
  const Scalar _tmp117 = _tmp85 * fh1;
  const Scalar _tmp118 = _tmp51 * _tmp93 + _tmp92;
  const Scalar _tmp119 = -_tmp100 * _tmp118 + _tmp101 * _tmp51 - _tmp41;
  const Scalar _tmp120 = _tmp112 * (-_tmp111 * _tmp119 + _tmp51 * _tmp77 - _tmp66);
  const Scalar _tmp121 = _tmp119 + _tmp120;
  const Scalar _tmp122 = -_tmp107 * _tmp121 - _tmp51;
  const Scalar _tmp123 = _tmp86 * fh1;
  const Scalar _tmp124 = -_tmp117 * _tmp65 * (_tmp114 * _tmp115 + _tmp116 * _tmp81) -
                         _tmp123 * _tmp65 * (_tmp115 * _tmp121 + _tmp122 * _tmp81 + Scalar(1.0)) -
                         _tmp65 * _tmp87 * (_tmp60 * _tmp80 - _tmp62 * _tmp80 * _tmp81) -
                         _tmp65 * _tmp88 * (_tmp106 * _tmp60 - _tmp108 * _tmp81);
  const Scalar _tmp125 = Scalar(1.0) / (_tmp124);
  const Scalar _tmp126 = _tmp53 + _tmp96;
  const Scalar _tmp127 = _tmp100 * _tmp126;
  const Scalar _tmp128 = Scalar(1.0) / (-_tmp127 - _tmp56 + _tmp98);
  const Scalar _tmp129 = _tmp104 * _tmp128;
  const Scalar _tmp130 = _tmp103 * _tmp94;
  const Scalar _tmp131 = -_tmp105 * _tmp130 - _tmp126 * _tmp129 + _tmp96;
  const Scalar _tmp132 = Scalar(1.0) * _tmp128;
  const Scalar _tmp133 = _tmp126 * _tmp128;
  const Scalar _tmp134 = _tmp118 + _tmp120 * _tmp133 - _tmp121 * _tmp130;
  const Scalar _tmp135 = Scalar(1.0) * fh1;
  const Scalar _tmp136 = _tmp112 * _tmp132;
  const Scalar _tmp137 = _tmp126 * _tmp136 - _tmp80 * _tmp94;
  const Scalar _tmp138 = _tmp16 * fh1;
  const Scalar _tmp139 = _tmp138 * _tmp86 + Scalar(3.29616) * _tmp20 + _tmp26 * fv1;
  const Scalar _tmp140 = _tmp126 * _tmp97;
  const Scalar _tmp141 = _tmp113 * _tmp133 - _tmp114 * _tmp130 - Scalar(1.0) * _tmp93;
  const Scalar _tmp142 = -_tmp138 * _tmp85 - Scalar(3.29616) * _tmp30 - _tmp34 * fv1;
  const Scalar _tmp143 = _tmp127 * _tmp132 + Scalar(1.0);
  const Scalar _tmp144 = _tmp100 * _tmp132;
  const Scalar _tmp145 = std::asinh(
      _tmp125 * (_tmp135 * _tmp85 * (-_tmp109 * _tmp141 + _tmp113 * _tmp132) +
                 _tmp135 * _tmp86 * (-_tmp109 * _tmp134 + _tmp120 * _tmp132) +
                 Scalar(1.0) * _tmp139 * (_tmp132 * _tmp140 - _tmp132) +
                 Scalar(1.0) * _tmp142 * (-_tmp109 * _tmp143 + _tmp144) +
                 Scalar(1.0) * _tmp87 * (-_tmp109 * _tmp137 + _tmp136) +
                 Scalar(1.0) * _tmp88 * (-_tmp104 * _tmp132 - _tmp109 * _tmp131 + Scalar(1.0))));
  const Scalar _tmp146 = Scalar(9.6622558468725703) * _tmp124;
  const Scalar _tmp147 = std::pow(Scalar(-_tmp68 + p_c(0, 0)), Scalar(2)) +
                         std::pow(Scalar(-_tmp71 + p_c(1, 0)), Scalar(2));
  const Scalar _tmp148 = _tmp132 * _tmp139;
  const Scalar _tmp149 = _tmp80 * _tmp87;
  const Scalar _tmp150 = -_tmp108 * _tmp76 * _tmp88 + _tmp116 * _tmp117 * _tmp76 +
                         _tmp122 * _tmp123 * _tmp76 - _tmp149 * _tmp62 * _tmp76;
  const Scalar _tmp151 = Scalar(1.0) / (_tmp150);
  const Scalar _tmp152 =
      std::asinh(_tmp151 * (_tmp117 * _tmp141 * _tmp97 + _tmp123 * _tmp134 * _tmp97 +
                            _tmp131 * _tmp88 * _tmp97 + _tmp137 * _tmp87 * _tmp97 -
                            _tmp140 * _tmp148 + _tmp142 * _tmp143 * _tmp97));
  const Scalar _tmp153 = Scalar(9.6622558468725703) * _tmp150;
  const Scalar _tmp154 = std::pow(Scalar(-_tmp54 + p_b(1, 0)), Scalar(2)) +
                         std::pow(Scalar(-_tmp57 + p_b(0, 0)), Scalar(2));
  const Scalar _tmp155 =
      _tmp103 * _tmp114 * _tmp117 + _tmp103 * _tmp121 * _tmp123 + _tmp106 * _tmp88 + _tmp149;
  const Scalar _tmp156 = Scalar(1.0) / (_tmp155);
  const Scalar _tmp157 =
      std::asinh(_tmp156 * (-_tmp113 * _tmp117 * _tmp128 - _tmp120 * _tmp123 * _tmp128 +
                            _tmp129 * _tmp88 - _tmp136 * _tmp87 - _tmp142 * _tmp144 + _tmp148));
  ...
  _res(1, 0) =
      _tmp146 *
          (-std::sinh(Scalar(1.0) * _tmp145) -
           std::sinh(Scalar(0.1034955) * _tmp125 * (-_tmp145 * _tmp146 - std::sqrt(_tmp47)))) -
      std::sqrt(Scalar(_tmp47 + std::pow(Scalar(-_tmp41 + p_d(2, 0) - p_init2), Scalar(2))));
  _res(2, 0) =
      _tmp153 *
          (-std::sinh(Scalar(1.0) * _tmp152) -
           std::sinh(Scalar(0.1034955) * _tmp151 * (-std::sqrt(_tmp147) - _tmp152 * _tmp153))) -
      std::sqrt(Scalar(_tmp147 + std::pow(Scalar(-_tmp91 + p_c(2, 0) - p_init2), Scalar(2))));
  _res(3, 0) =
      _tmp158 *
          (-std::sinh(Scalar(1.0) * _tmp157) -
           std::sinh(Scalar(0.1034955) * _tmp156 * (-std::sqrt(_tmp154) - _tmp157 * _tmp158))) -
      std::sqrt(Scalar(_tmp154 + std::pow(Scalar(-_tmp90 + p_b(2, 0) - p_init2), Scalar(2))));
