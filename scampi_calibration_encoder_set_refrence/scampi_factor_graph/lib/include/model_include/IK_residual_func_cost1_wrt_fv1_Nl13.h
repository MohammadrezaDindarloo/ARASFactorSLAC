...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1WrtFv1Nl13(
  ...
  const Scalar _tmp50 = _tmp23 + _tmp28 + _tmp34;
  const Scalar _tmp51 = _tmp50 + p_init1;
  const Scalar _tmp52 = _tmp51 - p_d(1, 0);
  const Scalar _tmp53 = _tmp19 + _tmp39;
  ...
  const Scalar _tmp77 = _tmp59 * (-_tmp58 * _tmp66 + _tmp69);
  const Scalar _tmp78 = _tmp45 * _tmp77 - _tmp68 - _tmp71 * _tmp76;
  const Scalar _tmp79 = _tmp30 + _tmp33;
  const Scalar _tmp80 = _tmp79 + p_init1;
  const Scalar _tmp81 = _tmp80 - p_b(1, 0);
  const Scalar _tmp82 = _tmp40 + _tmp8;
  ...
  const Scalar _tmp90 = _tmp61 + _tmp67;
  const Scalar _tmp91 = -_tmp45 * _tmp87 - _tmp70 * _tmp89 + _tmp88 * _tmp90;
  const Scalar _tmp92 = -_tmp76 * _tmp91 - _tmp77 * _tmp89 - _tmp86 * _tmp90 + _tmp87;
  const Scalar _tmp93 = Scalar(1.0) / (_tmp92);
  const Scalar _tmp94 = _tmp49 * _tmp86 - _tmp60 * _tmp89 + _tmp79 * _tmp86 - _tmp82 * _tmp88;
  const Scalar _tmp95 = _tmp93 * _tmp94;
  const Scalar _tmp96 = Scalar(1.0) / (_tmp94);
  const Scalar _tmp97 = _tmp92 * _tmp96;
  const Scalar _tmp98 = _tmp97 * (_tmp45 * _tmp60 - _tmp49 - _tmp78 * _tmp95);
  const Scalar _tmp99 = _tmp78 + _tmp98;
  const Scalar _tmp100 = _tmp89 * _tmp93;
  const Scalar _tmp101 = -_tmp100 * _tmp99 - _tmp45;
  const Scalar _tmp102 = _tmp58 * _tmp59;
  const Scalar _tmp103 = _tmp86 * _tmp93;
  ...
  const Scalar _tmp110 = _tmp72 * _tmp76 + _tmp75;
  const Scalar _tmp111 = 0;
  const Scalar _tmp112 = _tmp100 * _tmp111;
  const Scalar _tmp113 = _tmp111 * _tmp93;
  const Scalar _tmp114 = _tmp48 * (-_tmp102 * _tmp112 + _tmp113 * _tmp86);
  const Scalar _tmp115 = Scalar(1.0) * _tmp96;
  const Scalar _tmp116 = _tmp105 * _tmp106;
  const Scalar _tmp117 = fh1 * (-_tmp107 * _tmp31 + _tmp116 * _tmp20);
  const Scalar _tmp118 = Scalar(1.0) * _tmp70;
  const Scalar _tmp119 = _tmp118 * _tmp76 - Scalar(1.0) * _tmp77;
  const Scalar _tmp120 = _tmp97 * (-_tmp119 * _tmp95 - Scalar(1.0) * _tmp60);
  const Scalar _tmp121 = _tmp119 + _tmp120;
  const Scalar _tmp122 = -_tmp100 * _tmp121 + Scalar(1.0);
  const Scalar _tmp123 = _tmp116 * fh1;
  const Scalar _tmp124 = -_tmp108 * _tmp48 * (_tmp101 * _tmp102 + _tmp103 * _tmp99 + Scalar(1.0)) -
                         _tmp109 * _tmp114 -
                         _tmp117 * _tmp48 * (-_tmp102 * _tmp115 * _tmp89 + _tmp115 * _tmp86) -
                         _tmp123 * _tmp48 * (_tmp102 * _tmp122 + _tmp103 * _tmp121);
  ...
  const Scalar _tmp134 = _tmp74 * (-_tmp111 * _tmp133 - _tmp129 * _tmp132 + _tmp73);
  ...
  const Scalar _tmp138 = -_tmp133 * _tmp99 + _tmp137 * _tmp98 + _tmp71;
  const Scalar _tmp139 = Scalar(1.0) * _tmp74;
  const Scalar _tmp140 = _tmp136 * _tmp97;
  const Scalar _tmp141 = -_tmp115 * _tmp91 + _tmp129 * _tmp140;
  const Scalar _tmp142 = -_tmp118 + _tmp120 * _tmp137 - _tmp121 * _tmp133;
  const Scalar _tmp143 = fh1 * (_tmp61 + _tmp65);
  const Scalar _tmp144 = -_tmp116 * _tmp143 - Scalar(3.29616) * _tmp26 - _tmp31 * fv1;
  const Scalar _tmp145 = _tmp74 * (_tmp130 * _tmp136 + Scalar(1.0));
  const Scalar _tmp146 = _tmp136 * _tmp76;
  const Scalar _tmp147 = -Scalar(1.0) * _tmp145 + Scalar(1.0) * _tmp146;
  const Scalar _tmp148 = _tmp107 * _tmp143 + Scalar(3.29616) * _tmp13 + _tmp20 * fv1;
  const Scalar _tmp149 = _tmp129 * _tmp74;
  const Scalar _tmp150 = Scalar(1.0) * _tmp136 * _tmp149 - Scalar(1.0) * _tmp136;
  const Scalar _tmp151 = Scalar(1.0) * _tmp108 * (_tmp136 * _tmp98 - _tmp138 * _tmp139) +
                         _tmp109 * _tmp135 +
                         Scalar(1.0) * _tmp117 * (-_tmp139 * _tmp141 + _tmp140) +
                         Scalar(1.0) * _tmp123 * (_tmp120 * _tmp136 - _tmp139 * _tmp142) +
  ...
  const Scalar _tmp154 =
      -_tmp152 * _tmp153 - std::sqrt(Scalar(std::pow(Scalar(-_tmp37 + p_a(1, 0)), Scalar(2)) +
  ...
  const Scalar _tmp158 =
      (-_tmp126 * _tmp151 + _tmp128 * (-_tmp135 + _tmp147 * _tmp157 + _tmp150 * _tmp20)) /
      std::sqrt(Scalar(_tmp125 * std::pow(_tmp151, Scalar(2)) + 1));
  const Scalar _tmp159 = Scalar(9.6622558468725703) * _tmp114;
  const Scalar _tmp160 = Scalar(1.0) * _tmp152;
  const Scalar _tmp161 = _tmp115 * _tmp117;
  const Scalar _tmp162 = _tmp112 * _tmp59;
  const Scalar _tmp163 = _tmp101 * _tmp108 * _tmp59 - _tmp109 * _tmp162 +
                         _tmp122 * _tmp123 * _tmp59 - _tmp161 * _tmp59 * _tmp89;
  const Scalar _tmp164 = Scalar(1.0) / (_tmp163);
  const Scalar _tmp165 = _tmp136 * _tmp148;
  const Scalar _tmp166 = _tmp108 * _tmp138 * _tmp74 + _tmp109 * _tmp134 +
                         _tmp117 * _tmp141 * _tmp74 + _tmp123 * _tmp142 * _tmp74 +
                         _tmp144 * _tmp145 - _tmp149 * _tmp165;
  ...
  const Scalar _tmp171 = _tmp136 * _tmp20;
  const Scalar _tmp172 =
      (_tmp164 * (-_tmp134 + _tmp145 * _tmp157 - _tmp149 * _tmp171) - _tmp166 * _tmp170) /
  ...
  const Scalar _tmp176 =
      -_tmp167 * _tmp173 - std::sqrt(Scalar(std::pow(Scalar(-_tmp51 + p_d(1, 0)), Scalar(2)) +
                                            std::pow(Scalar(-_tmp54 + p_d(0, 0)), Scalar(2))));
  const Scalar _tmp177 = Scalar(0.1034955) * _tmp170;
  const Scalar _tmp178 = _tmp175 * _tmp176;
  const Scalar _tmp179 = _tmp93 * fh1;
  const Scalar _tmp180 =
      _tmp107 * _tmp179 * _tmp99 + _tmp109 * _tmp113 + _tmp116 * _tmp121 * _tmp179 + _tmp161;
  const Scalar _tmp181 = Scalar(1.0) / (_tmp180);
  const Scalar _tmp182 = -_tmp108 * _tmp131 * _tmp98 + _tmp109 * _tmp132 - _tmp117 * _tmp140 -
                         _tmp120 * _tmp123 * _tmp131 - _tmp144 * _tmp146 + _tmp165;
  const Scalar _tmp183 = std::asinh(_tmp181 * _tmp182);
  const Scalar _tmp184 = Scalar(9.6622558468725703) * _tmp180;
  const Scalar _tmp185 =
      -_tmp183 * _tmp184 - std::sqrt(Scalar(std::pow(Scalar(-_tmp80 + p_b(1, 0)), Scalar(2)) +
                                            std::pow(Scalar(-_tmp83 + p_b(0, 0)), Scalar(2))));
  const Scalar _tmp186 = std::pow(_tmp180, Scalar(-2));
  const Scalar _tmp187 = _tmp113 * _tmp186;
  const Scalar _tmp188 = Scalar(0.1034955) * _tmp187;
  const Scalar _tmp189 = Scalar(9.6622558468725703) * _tmp113;
  const Scalar _tmp190 = (_tmp181 * (-_tmp132 - _tmp146 * _tmp157 + _tmp171) + _tmp182 * _tmp187) /
  ...
  _res(1, 0) =
      -_tmp153 * (-_tmp127 * p_a(2, 0) + Scalar(1.0) * _tmp158 * std::sinh(_tmp160) -
                  (-_tmp127 * _tmp154 + _tmp155 * (-_tmp152 * _tmp159 - _tmp153 * _tmp158)) *
                      std::sinh(_tmp156)) -
      _tmp159 * (_tmp155 * p_a(2, 0) - std::cosh(_tmp156) + std::cosh(_tmp160));
  _res(2, 0) =
      -_tmp173 * (Scalar(1.0) * _tmp172 * std::sinh(_tmp168) - _tmp177 * p_d(2, 0) -
                  (_tmp175 * (-_tmp167 * _tmp174 - _tmp172 * _tmp173) - _tmp176 * _tmp177) *
                      std::sinh(_tmp178)) -
      _tmp174 * (_tmp175 * p_d(2, 0) + std::cosh(_tmp168) - std::cosh(_tmp178));
  _res(3, 0) = -_tmp184 * (_tmp188 * p_b(2, 0) + Scalar(1.0) * _tmp190 * std::sinh(_tmp193) -
                           (_tmp185 * _tmp188 + _tmp191 * (_tmp183 * _tmp189 - _tmp184 * _tmp190)) *
                               std::sinh(_tmp192)) +
               _tmp189 * (_tmp191 * p_b(2, 0) - std::cosh(_tmp192) + std::cosh(_tmp193));
