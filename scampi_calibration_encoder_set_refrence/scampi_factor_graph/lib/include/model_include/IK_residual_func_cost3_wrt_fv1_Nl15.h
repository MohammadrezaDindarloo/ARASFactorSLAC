...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl15(
  ...
  const Scalar _tmp30 = -Scalar(0.010999999999999999) * _tmp18 -
  ...
  const Scalar _tmp55 = _tmp47 * _tmp53 - _tmp54;
  const Scalar _tmp56 = _tmp17 * _tmp28;
  const Scalar _tmp57 = Scalar(1.0) / (_tmp29 * _tmp47 - _tmp56);
  const Scalar _tmp58 = _tmp55 * _tmp57;
  const Scalar _tmp59 = _tmp32 + _tmp35;
  const Scalar _tmp60 = _tmp36 * _tmp47;
  const Scalar _tmp61 = _tmp34 * _tmp56 - _tmp37 * _tmp47;
  const Scalar _tmp62 = Scalar(1.0) * _tmp41;
  const Scalar _tmp63 = Scalar(1.0) * _tmp44;
  const Scalar _tmp64 = (-_tmp26 + _tmp63) / (_tmp16 - _tmp62);
  const Scalar _tmp65 = _tmp36 * _tmp53 - _tmp38 * _tmp58 - _tmp53 * _tmp59 -
                        _tmp64 * (-_tmp53 * _tmp60 + _tmp54 * _tmp59 - _tmp58 * _tmp61);
  ...
  const Scalar _tmp72 = _tmp71 * (-_tmp29 * _tmp69 + _tmp53 * _tmp68);
  const Scalar _tmp73 = Scalar(1.0) / (_tmp70);
  const Scalar _tmp74 = _tmp71 * (-_tmp41 * _tmp45 * _tmp73 + _tmp42 * _tmp44 * _tmp73);
  const Scalar _tmp75 = _tmp16 * _tmp29 - _tmp26 * _tmp56 + _tmp29 * _tmp74;
  const Scalar _tmp76 = Scalar(1.0) * _tmp57;
  const Scalar _tmp77 = -_tmp38 * _tmp76 + _tmp61 * _tmp64 * _tmp76;
  const Scalar _tmp78 = -_tmp48 * _tmp54 + _tmp50 * _tmp53 + _tmp53 * _tmp74 - _tmp58 * _tmp75;
  ...
  const Scalar _tmp83 = _tmp53 * _tmp66;
  const Scalar _tmp84 = _tmp55 * _tmp66;
  const Scalar _tmp85 = -_tmp82 * _tmp84 + Scalar(1.0);
  const Scalar _tmp86 = _tmp29 * _tmp57;
  const Scalar _tmp87 = _tmp19 + _tmp25;
  const Scalar _tmp88 = _tmp87 - p_c(0, 0) + p_init0;
  const Scalar _tmp89 = _tmp40 + _tmp5;
  const Scalar _tmp90 = _tmp89 - p_c(1, 0) + p_init1;
  ...
  const Scalar _tmp94 = _tmp47 * _tmp57;
  const Scalar _tmp95 = -_tmp36 + _tmp38 * _tmp94 - _tmp64 * (_tmp60 + _tmp61 * _tmp94);
  const Scalar _tmp96 = _tmp81 * (-_tmp74 + _tmp75 * _tmp94 - _tmp79 * _tmp95) + _tmp95;
  const Scalar _tmp97 = -_tmp47 - _tmp84 * _tmp96;
  ...
  _res(1, 0) =
      -_tmp72 *
      std::exp(_tmp0 * _tmp72 + _tmp101 * _tmp71 * (-_tmp100 * _tmp29 * _tmp58 + _tmp100 * _tmp53) +
               _tmp71 * _tmp93 * (_tmp82 * _tmp83 + _tmp85 * _tmp86) +
               _tmp71 * _tmp99 * (_tmp83 * _tmp96 + _tmp86 * _tmp97 + Scalar(1.0)));
  _res(2, 0) = -_tmp69 * std::exp(_tmp102 * _tmp58 + _tmp103 * _tmp58 - _tmp57 * _tmp85 * _tmp93 -
                                  _tmp57 * _tmp97 * _tmp99);
  _res(3, 0) =
      _tmp68 * std::exp(-_tmp102 - _tmp103 - _tmp66 * _tmp82 * _tmp93 - _tmp66 * _tmp96 * _tmp99);
