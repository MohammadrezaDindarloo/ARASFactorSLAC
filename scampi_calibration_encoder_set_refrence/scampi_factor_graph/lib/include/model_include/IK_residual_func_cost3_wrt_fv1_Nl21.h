...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl21(
  ...
  const Scalar _tmp39 = _tmp20 + _tmp33;
  ...
  const Scalar _tmp48 = -_tmp31 * _tmp37 + _tmp34 * _tmp38 + _tmp38 * _tmp47;
  const Scalar _tmp49 = _tmp40 * _tmp45;
  const Scalar _tmp50 = Scalar(1.0) / (-_tmp37 + _tmp38 * _tmp49);
  const Scalar _tmp51 = _tmp27 * _tmp28;
  const Scalar _tmp52 = _tmp29 * _tmp49 - _tmp51;
  const Scalar _tmp53 = _tmp50 * _tmp52;
  const Scalar _tmp54 = -_tmp16 * _tmp51 + _tmp26 * _tmp29 + _tmp29 * _tmp47 - _tmp48 * _tmp53;
  ...
  const Scalar _tmp61 = _tmp30 + _tmp5;
  ...
  const Scalar _tmp75 = -_tmp38 * _tmp74 + _tmp73;
  const Scalar _tmp76 = _tmp37 * _tmp74 - _tmp49 * _tmp73;
  const Scalar _tmp77 = Scalar(1.0) * _tmp39;
  const Scalar _tmp78 = Scalar(1.0) * _tmp41;
  const Scalar _tmp79 = (-_tmp31 + _tmp78) / (_tmp34 - _tmp77);
  const Scalar _tmp80 = -_tmp57 * _tmp75 + _tmp57 * _tmp76 * _tmp79;
  const Scalar _tmp81 = _tmp68 + _tmp69 - _tmp70;
  const Scalar _tmp82 = _tmp49 * _tmp72;
  const Scalar _tmp83 = _tmp29 * _tmp72 - _tmp29 * _tmp81 - _tmp53 * _tmp75 -
                        _tmp79 * (-_tmp29 * _tmp82 + _tmp51 * _tmp81 - _tmp53 * _tmp76);
  const Scalar _tmp84 = Scalar(1.0) / (_tmp83);
  const Scalar _tmp85 = _tmp54 * _tmp84;
  const Scalar _tmp86 = _tmp55 * _tmp83;
  const Scalar _tmp87 = _tmp80 + _tmp86 * (-_tmp48 * _tmp57 - _tmp80 * _tmp85);
  const Scalar _tmp88 = _tmp29 * _tmp84;
  const Scalar _tmp89 = _tmp52 * _tmp84;
  const Scalar _tmp90 = -_tmp87 * _tmp89 + Scalar(1.0);
  const Scalar _tmp91 = _tmp38 * _tmp50;
  const Scalar _tmp92 = _tmp46 * fh1;
  const Scalar _tmp93 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp94 = _tmp77 * _tmp79 + _tmp78;
  const Scalar _tmp95 = 0;
  const Scalar _tmp96 = _tmp53 * _tmp95;
  const Scalar _tmp97 = _tmp46 * (_tmp29 * _tmp95 - _tmp38 * _tmp96);
  const Scalar _tmp98 = _tmp49 * _tmp50;
  const Scalar _tmp99 = -_tmp72 + _tmp75 * _tmp98 - _tmp79 * (_tmp76 * _tmp98 + _tmp82);
  const Scalar _tmp100 = _tmp86 * (-_tmp47 + _tmp48 * _tmp98 - _tmp85 * _tmp99) + _tmp99;
  const Scalar _tmp101 = -_tmp100 * _tmp89 - _tmp49;
  ...
  _res(0, 0) = 0;
  _res(1, 0) =
      -_tmp97 * std::exp(_tmp46 * _tmp66 * (_tmp29 * _tmp56 - _tmp38 * _tmp58) +
                         _tmp64 * _tmp92 * (_tmp100 * _tmp88 + _tmp101 * _tmp91 + Scalar(1.0)) +
                         _tmp65 * _tmp92 * (_tmp87 * _tmp88 + _tmp90 * _tmp91) + _tmp93 * _tmp97);
  _res(2, 0) = -_tmp96 * std::exp(-_tmp101 * _tmp102 * _tmp64 - _tmp102 * _tmp65 * _tmp90 +
                                  _tmp103 * _tmp53 + _tmp58 * _tmp66);
  _res(3, 0) = _tmp95 * std::exp(-_tmp100 * _tmp104 * _tmp64 - _tmp103 - _tmp104 * _tmp65 * _tmp87 -
                                 _tmp56 * _tmp66);
