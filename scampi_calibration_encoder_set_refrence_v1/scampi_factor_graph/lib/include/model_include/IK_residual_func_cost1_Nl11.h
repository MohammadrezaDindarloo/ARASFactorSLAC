...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl11(
  ...
  const Scalar _tmp33 = -Scalar(0.010999999999999999) * _tmp22 -
  ...
  const Scalar _tmp45 = _tmp30 - p_b(1, 0);
  const Scalar _tmp46 = _tmp20 - p_b(0, 0);
  const Scalar _tmp47 = std::pow(Scalar(std::pow(_tmp45, Scalar(2)) + std::pow(_tmp46, Scalar(2))),
                                 Scalar(Scalar(-1) / Scalar(2)));
  const Scalar _tmp48 = _tmp46 * _tmp47;
  const Scalar _tmp49 = _tmp36 * fh1;
  const Scalar _tmp50 = Scalar(3.29616) * _tmp13 + _tmp19 * fv1 + _tmp48 * _tmp49;
  const Scalar _tmp51 = Scalar(1.0) * _tmp39;
  const Scalar _tmp52 = _tmp18 + _tmp37;
  const Scalar _tmp53 = Scalar(1.0) * _tmp43;
  const Scalar _tmp54 = -_tmp53;
  const Scalar _tmp55 = _tmp28 + _tmp41;
  const Scalar _tmp56 = _tmp54 + _tmp55;
  const Scalar _tmp57 = _tmp21 + _tmp42;
  ...
  const Scalar _tmp93 = -_tmp82 * _tmp92 + _tmp84 * _tmp90;
  const Scalar _tmp94 = -_tmp75 + _tmp76 * _tmp82;
  const Scalar _tmp95 = Scalar(1.0) / (_tmp82 * _tmp91 - _tmp90);
  const Scalar _tmp96 = _tmp94 * _tmp95;
  const Scalar _tmp97 = _tmp69 * _tmp75 - _tmp76 * _tmp83 - _tmp93 * _tmp96;
  const Scalar _tmp98 = -_tmp84 * _tmp91 + _tmp92;
  const Scalar _tmp99 = -_tmp60 * _tmp97 - _tmp69 * _tmp76 + _tmp76 * _tmp78 - _tmp96 * _tmp98;
  ...
  const Scalar _tmp108 = _tmp107 * (_tmp106 * _tmp39 * _tmp79 - _tmp106 * _tmp43 * _tmp80);
  const Scalar _tmp109 = _tmp108 * _tmp91 + _tmp57 * _tmp91 - _tmp59 * _tmp90;
  const Scalar _tmp110 = _tmp108 * _tmp76 - _tmp109 * _tmp96 - _tmp52 * _tmp75 + _tmp55 * _tmp76;
  ...
  const Scalar _tmp117 = fh1 * (_tmp116 * _tmp19 - _tmp29 * _tmp48);
  const Scalar _tmp118 = Scalar(1.0) * _tmp95;
  const Scalar _tmp119 = _tmp118 * _tmp93;
  const Scalar _tmp120 = -_tmp118 * _tmp98 + _tmp119 * _tmp60;
  const Scalar _tmp121 = _tmp100 * _tmp110;
  const Scalar _tmp122 = _tmp113 * (-_tmp109 * _tmp118 - _tmp120 * _tmp121);
  const Scalar _tmp123 = _tmp56 * _tmp62;
  const Scalar _tmp124 = _tmp120 + _tmp122;
  const Scalar _tmp125 = -_tmp101 * _tmp124 - _tmp119 + _tmp122 * _tmp123;
  const Scalar _tmp126 = _tmp116 * fh1;
  const Scalar _tmp127 = _tmp60 * _tmp63;
  const Scalar _tmp128 = _tmp61 * _tmp63 + Scalar(1.0);
  const Scalar _tmp129 = -_tmp116 * _tmp49 - Scalar(3.29616) * _tmp26 - _tmp29 * fv1;
  const Scalar _tmp130 = _tmp82 * _tmp95;
  const Scalar _tmp131 = _tmp130 * _tmp93 + _tmp83;
  const Scalar _tmp132 = _tmp130 * _tmp98 - _tmp131 * _tmp60 - _tmp78;
  const Scalar _tmp133 = _tmp113 * (-_tmp108 + _tmp109 * _tmp130 - _tmp121 * _tmp132);
  const Scalar _tmp134 = _tmp132 + _tmp133;
  const Scalar _tmp135 = -_tmp101 * _tmp134 + _tmp123 * _tmp133 + _tmp131;
  ...
  const Scalar _tmp141 = _tmp111 * _tmp118 * _tmp94;
  const Scalar _tmp142 = _tmp100 * _tmp76;
  const Scalar _tmp143 = -_tmp124 * _tmp138 + Scalar(1.0);
  const Scalar _tmp144 = -_tmp134 * _tmp138 - _tmp82;
  const Scalar _tmp145 = -_tmp107 * _tmp117 * (_tmp112 * _tmp76 - _tmp141 * _tmp91) -
                         _tmp107 * _tmp126 * (_tmp124 * _tmp142 + _tmp137 * _tmp143) -
                         _tmp107 * _tmp136 * (_tmp134 * _tmp142 + _tmp137 * _tmp144 + Scalar(1.0)) -
                         _tmp107 * _tmp65 * (-_tmp137 * _tmp139 + _tmp140 * _tmp76);
  const Scalar _tmp146 = Scalar(1.0) / (_tmp145);
  const Scalar _tmp147 = std::asinh(
      _tmp146 * (Scalar(1.0) * _tmp117 * (-_tmp104 * _tmp115 + _tmp114) +
                 Scalar(1.0) * _tmp126 * (-_tmp104 * _tmp125 + _tmp122 * _tmp63) +
                 Scalar(1.0) * _tmp129 * (-_tmp104 * _tmp128 + _tmp127) +
  ...
  const Scalar _tmp150 = -_tmp117 * _tmp141 + _tmp126 * _tmp143 * _tmp95 +
  ...
  const Scalar _tmp154 =
      std::asinh(_tmp151 * (_tmp103 * _tmp58 * _tmp65 + _tmp115 * _tmp117 * _tmp58 +
                            _tmp125 * _tmp126 * _tmp58 + _tmp128 * _tmp129 * _tmp58 +
                            _tmp135 * _tmp136 * _tmp58 - _tmp153 * _tmp64));
  const Scalar _tmp155 = Scalar(9.6622558468725703) * _tmp150;
  const Scalar _tmp156 = _tmp100 * _tmp124 * _tmp126 + _tmp100 * _tmp134 * _tmp136 +
                         _tmp112 * _tmp117 + _tmp140 * _tmp65;
  const Scalar _tmp157 = Scalar(1.0) / (_tmp156);
  const Scalar _tmp158 = Scalar(0.1034955) * _tmp157;
  const Scalar _tmp159 =
      std::asinh(_tmp157 * (_tmp102 * _tmp65 - _tmp114 * _tmp117 - _tmp122 * _tmp126 * _tmp62 -
                            _tmp127 * _tmp129 - _tmp133 * _tmp136 * _tmp62 + _tmp153));
