...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl18(
  ...
  const Scalar _tmp55 = _tmp42 + _tmp51;
  ...
  const Scalar _tmp75 = _tmp49 + p_init0;
  ...
  const Scalar _tmp81 = _tmp65 * _tmp68;
  const Scalar _tmp82 = Scalar(1.0) / (_tmp69 * _tmp78 - _tmp81);
  const Scalar _tmp83 = _tmp80 * _tmp82;
  const Scalar _tmp84 = _tmp47 * _tmp63;
  const Scalar _tmp85 = _tmp33 + _tmp70;
  const Scalar _tmp86 = _tmp63 * _tmp78;
  const Scalar _tmp87 = _tmp82 * (-_tmp69 * _tmp86 + _tmp71 * _tmp81);
  const Scalar _tmp88 = -_tmp78 * _tmp84 + _tmp79 * _tmp85 - _tmp80 * _tmp87;
  const Scalar _tmp89 = -_tmp47 * _tmp85 - _tmp59 * _tmp88 - _tmp72 * _tmp83 + _tmp84;
  const Scalar _tmp90 = Scalar(1.0) / (_tmp89);
  const Scalar _tmp91 = _tmp61 * _tmp90;
  const Scalar _tmp92 = _tmp69 * _tmp82;
  const Scalar _tmp93 = _tmp80 * _tmp90;
  ...
  const Scalar _tmp98 = _tmp96 * (_tmp49 * _tmp74 * _tmp97 - _tmp52 * _tmp76 * _tmp97);
  const Scalar _tmp99 = _tmp55 * _tmp69 - _tmp57 * _tmp81 + _tmp69 * _tmp98;
  const Scalar _tmp100 = _tmp78 * _tmp82;
  const Scalar _tmp101 = _tmp78 * _tmp87 + _tmp86;
  const Scalar _tmp102 = _tmp100 * _tmp72 - _tmp101 * _tmp59 - _tmp63;
  const Scalar _tmp103 = -_tmp39 * _tmp79 + _tmp43 * _tmp47 + _tmp47 * _tmp98 - _tmp83 * _tmp99;
  ...
  const Scalar _tmp109 = _tmp47 * _tmp90;
  const Scalar _tmp110 = -_tmp108 * _tmp93 - _tmp78;
  const Scalar _tmp111 = _tmp31 - p_d(1, 0);
  ...
  const Scalar _tmp121 = -_tmp119 * _tmp72 + _tmp120 * _tmp58 * _tmp87;
  const Scalar _tmp122 = _tmp106 * (-_tmp104 * _tmp121 - _tmp119 * _tmp99);
  const Scalar _tmp123 = _tmp121 + _tmp122;
  const Scalar _tmp124 = -_tmp123 * _tmp93 + Scalar(1.0);
  const Scalar _tmp125 = _tmp117 * fh1;
  const Scalar _tmp126 = -_tmp115 * _tmp96 * (_tmp108 * _tmp109 + _tmp110 * _tmp92 + Scalar(1.0)) -
                         _tmp118 * _tmp96 * (_tmp116 * _tmp47 - _tmp116 * _tmp69 * _tmp83) -
                         _tmp125 * _tmp96 * (_tmp109 * _tmp123 + _tmp124 * _tmp92) -
                         _tmp38 * _tmp96 * (_tmp47 * _tmp91 - _tmp92 * _tmp94);
  ...
  const Scalar _tmp131 = Scalar(1.0) / (-_tmp130 - _tmp39 + _tmp50);
  ...
  const Scalar _tmp136 = -_tmp117 * _tmp135 - Scalar(3.29616) * _tmp26 - _tmp30 * fv1;
  const Scalar _tmp137 = _tmp129 * _tmp132;
  const Scalar _tmp138 = _tmp114 * _tmp135 + Scalar(3.29616) * _tmp14 + _tmp20 * fv1;
  const Scalar _tmp139 = _tmp88 * _tmp90;
  const Scalar _tmp140 = _tmp129 * _tmp131;
  const Scalar _tmp141 = _tmp101 + _tmp107 * _tmp140 - _tmp108 * _tmp139;
  const Scalar _tmp142 = Scalar(1.0) * fh1;
  const Scalar _tmp143 = _tmp106 * _tmp132;
  const Scalar _tmp144 = _tmp106 * _tmp137 - _tmp116 * _tmp88;
  const Scalar _tmp145 = _tmp122 * _tmp140 - _tmp123 * _tmp139 - Scalar(1.0) * _tmp87;
  const Scalar _tmp146 = _tmp131 * _tmp60;
  const Scalar _tmp147 = -_tmp129 * _tmp146 - _tmp139 * _tmp61 + _tmp54;
  const Scalar _tmp148 = std::asinh(
      _tmp127 * (_tmp114 * _tmp142 * (_tmp107 * _tmp132 - _tmp120 * _tmp141) +
                 _tmp117 * _tmp142 * (-_tmp120 * _tmp145 + _tmp122 * _tmp132) +
                 Scalar(1.0) * _tmp118 * (-_tmp120 * _tmp144 + _tmp143) +
                 Scalar(1.0) * _tmp136 * (-_tmp120 * _tmp133 + _tmp134) +
                 Scalar(1.0) * _tmp138 * (-_tmp132 + _tmp137 * _tmp56) +
                 Scalar(1.0) * _tmp38 * (-_tmp120 * _tmp147 - _tmp132 * _tmp60 + Scalar(1.0))));
  const Scalar _tmp149 = Scalar(9.6622558468725703) * _tmp126;
  const Scalar _tmp150 = _tmp82 * fh1;
  const Scalar _tmp151 = _tmp116 * _tmp118;
  const Scalar _tmp152 = _tmp110 * _tmp114 * _tmp150 + _tmp117 * _tmp124 * _tmp150 -
                         _tmp151 * _tmp83 - _tmp38 * _tmp82 * _tmp94;
  const Scalar _tmp153 = Scalar(1.0) / (_tmp152);
  const Scalar _tmp154 = _tmp132 * _tmp138;
  const Scalar _tmp155 =
      std::asinh(_tmp153 * (_tmp115 * _tmp141 * _tmp56 + _tmp118 * _tmp144 * _tmp56 +
                            _tmp125 * _tmp145 * _tmp56 - _tmp129 * _tmp154 * _tmp56 +
                            _tmp133 * _tmp136 * _tmp56 + _tmp147 * _tmp38 * _tmp56));
  const Scalar _tmp156 = Scalar(9.6622558468725703) * _tmp152;
  const Scalar _tmp157 = Scalar(0.1034955) * _tmp153;
  const Scalar _tmp158 =
      _tmp108 * _tmp115 * _tmp90 + _tmp123 * _tmp125 * _tmp90 + _tmp151 + _tmp38 * _tmp91;
  const Scalar _tmp159 = Scalar(1.0) / (_tmp158);
  const Scalar _tmp160 = std::asinh(_tmp159 * (-_tmp107 * _tmp115 * _tmp131 - _tmp118 * _tmp143 -
                                               _tmp122 * _tmp125 * _tmp131 - _tmp134 * _tmp136 +
                                               _tmp146 * _tmp38 + _tmp154));
  ...
  _res(1, 0) =
      -_tmp149 *
          (_tmp128 * p_a(2, 0) + std::cosh(Scalar(1.0) * _tmp148) -
           std::cosh(_tmp128 *
                     (-_tmp148 * _tmp149 -
                      std::sqrt(Scalar(std::pow(Scalar(-_tmp73 + p_a(1, 0)), Scalar(2)) +
  ...
  _res(3, 0) =
      -_tmp161 *
          (_tmp162 * p_c(2, 0) + std::cosh(Scalar(1.0) * _tmp160) -
           std::cosh(_tmp162 *
                     (-_tmp160 * _tmp161 -
                      std::sqrt(Scalar(std::pow(Scalar(-_tmp40 + p_c(0, 0)), Scalar(2)) +
