...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1WrtFv1Nl5(
  ...
  const Scalar _tmp35 = _tmp26 + _tmp31;
  ...
  const Scalar _tmp51 = _tmp20 + _tmp8;
  ...
  const Scalar _tmp57 = _tmp39 + _tmp8;
  ...
  const Scalar _tmp66 = _tmp47 * _tmp65 - _tmp57 * _tmp64 + _tmp60 * _tmp65;
  const Scalar _tmp67 = _tmp38 * _tmp45;
  const Scalar _tmp68 = Scalar(1.0) / (-_tmp64 + _tmp65 * _tmp67);
  const Scalar _tmp69 = _tmp55 * _tmp67 - _tmp56;
  const Scalar _tmp70 = _tmp68 * _tmp69;
  const Scalar _tmp71 = _tmp47 * _tmp55 + _tmp48 * _tmp55 - _tmp51 * _tmp56 - _tmp66 * _tmp70;
  ...
  const Scalar _tmp84 = -Scalar(0.010999999999999999) * _tmp25 -
  ...
  const Scalar _tmp91 = _tmp82 + _tmp86;
  const Scalar _tmp92 = _tmp67 * _tmp87;
  const Scalar _tmp93 = _tmp64 * _tmp91 - _tmp65 * _tmp92;
  const Scalar _tmp94 = _tmp56 * _tmp90 - _tmp67 * _tmp88 - _tmp70 * _tmp93;
  ...
  const Scalar _tmp102 = -_tmp100 * _tmp94 - _tmp101 * _tmp69 - _tmp55 * _tmp90 + _tmp88;
  const Scalar _tmp103 = Scalar(1.0) / (_tmp102);
  const Scalar _tmp104 = _tmp100 * _tmp95 + _tmp98;
  const Scalar _tmp105 = 0;
  const Scalar _tmp106 = _tmp46 * (_tmp105 * _tmp55 - _tmp105 * _tmp74);
  const Scalar _tmp107 = Scalar(1.0) * _tmp68;
  const Scalar _tmp108 = Scalar(1.0) * _tmp97;
  const Scalar _tmp109 = -Scalar(1.0) * _tmp101 + _tmp108 * _tmp68 * _tmp93 * _tmp99;
  const Scalar _tmp110 = _tmp103 * _tmp71;
  const Scalar _tmp111 = _tmp102 * _tmp72;
  const Scalar _tmp112 = _tmp111 * (-_tmp107 * _tmp66 - _tmp109 * _tmp110);
  const Scalar _tmp113 = _tmp103 * (_tmp109 + _tmp112);
  const Scalar _tmp114 = -_tmp113 * _tmp69 + Scalar(1.0);
  const Scalar _tmp115 = _tmp65 * _tmp68;
  const Scalar _tmp116 = _tmp78 * fh1;
  const Scalar _tmp117 = _tmp67 * _tmp68;
  const Scalar _tmp118 = _tmp117 * _tmp93 + _tmp92;
  const Scalar _tmp119 = -_tmp100 * _tmp118 + _tmp101 * _tmp67 - _tmp87;
  const Scalar _tmp120 = _tmp111 * (-_tmp110 * _tmp119 + _tmp117 * _tmp66 - _tmp47);
  const Scalar _tmp121 = _tmp103 * (_tmp119 + _tmp120);
  const Scalar _tmp122 = -_tmp121 * _tmp69 - _tmp67;
  const Scalar _tmp123 = _tmp79 * fh1;
  const Scalar _tmp124 = -_tmp106 * _tmp81 -
                         _tmp116 * _tmp46 * (_tmp113 * _tmp55 + _tmp114 * _tmp115) -
                         _tmp123 * _tmp46 * (_tmp115 * _tmp122 + _tmp121 * _tmp55 + Scalar(1.0)) -
                         _tmp46 * _tmp80 * (_tmp55 * _tmp73 - _tmp73 * _tmp74);
  const Scalar _tmp125 = Scalar(1.0) / (_tmp124);
  const Scalar _tmp126 = _tmp48 + _tmp96;
  const Scalar _tmp127 = _tmp100 * _tmp126;
  const Scalar _tmp128 = Scalar(1.0) / (-_tmp127 - _tmp51 + _tmp98);
  const Scalar _tmp129 = _tmp104 * _tmp128;
  const Scalar _tmp130 = _tmp97 * (-_tmp105 * _tmp94 - _tmp126 * _tmp129 + _tmp96);
  const Scalar _tmp131 = -Scalar(1.0) * _tmp129 - Scalar(1.0) * _tmp130 + Scalar(1.0);
  const Scalar _tmp132 = _tmp126 * _tmp128;
  const Scalar _tmp133 = _tmp118 + _tmp120 * _tmp132 - _tmp121 * _tmp94;
  const Scalar _tmp134 = Scalar(1.0) * _tmp128;
  const Scalar _tmp135 = _tmp111 * _tmp134;
  const Scalar _tmp136 = _tmp126 * _tmp135 - _tmp73 * _tmp94;
  const Scalar _tmp137 = fh1 * (_tmp83 + _tmp89);
  const Scalar _tmp138 = _tmp137 * _tmp79 + Scalar(3.29616) * _tmp14 + _tmp21 * fv1;
  const Scalar _tmp139 = _tmp126 * _tmp97;
  const Scalar _tmp140 = Scalar(1.0) * _tmp134 * _tmp139 - Scalar(1.0) * _tmp134;
  const Scalar _tmp141 = -_tmp107 * _tmp93 + _tmp112 * _tmp132 - _tmp113 * _tmp94;
  const Scalar _tmp142 = -_tmp137 * _tmp78 - Scalar(3.29616) * _tmp29 - _tmp33 * fv1;
  const Scalar _tmp143 = _tmp127 * _tmp134 + Scalar(1.0);
  const Scalar _tmp144 = _tmp100 * _tmp134;
  const Scalar _tmp145 = -Scalar(1.0) * _tmp108 * _tmp143 + Scalar(1.0) * _tmp144;
  const Scalar _tmp146 = Scalar(1.0) * _tmp116 * (-_tmp108 * _tmp141 + _tmp112 * _tmp134) +
                         Scalar(1.0) * _tmp123 * (-_tmp108 * _tmp133 + _tmp120 * _tmp134) +
                         _tmp131 * _tmp81 + _tmp138 * _tmp140 + _tmp142 * _tmp145 +
                         Scalar(1.0) * _tmp80 * (-_tmp108 * _tmp136 + _tmp135);
  ...
  const Scalar _tmp151 = _tmp23 + _tmp26 + _tmp30;
  const Scalar _tmp152 =
      (_tmp125 * (-_tmp131 + _tmp140 * _tmp21 + _tmp145 * _tmp151) - _tmp146 * _tmp150) /
  ...
  const Scalar _tmp155 =
      -_tmp147 * _tmp154 - std::sqrt(Scalar(std::pow(Scalar(-_tmp37 + p_d(1, 0)), Scalar(2)) +
  ...
  const Scalar _tmp161 = _tmp116 * _tmp141 * _tmp97 + _tmp123 * _tmp133 * _tmp97 +
                         _tmp130 * _tmp81 + _tmp136 * _tmp80 * _tmp97 - _tmp139 * _tmp159 +
                         _tmp142 * _tmp160;
  const Scalar _tmp162 = _tmp105 * _tmp81;
  const Scalar _tmp163 = _tmp73 * _tmp80;
  const Scalar _tmp164 =
      _tmp114 * _tmp116 * _tmp68 + _tmp122 * _tmp123 * _tmp68 - _tmp162 * _tmp70 - _tmp163 * _tmp70;
  ...
  const Scalar _tmp168 = Scalar(0.1034955) * _tmp165;
  const Scalar _tmp169 = Scalar(9.6622558468725703) * _tmp164;
  const Scalar _tmp170 =
      -_tmp166 * _tmp169 - std::sqrt(Scalar(std::pow(Scalar(-_tmp58 + p_c(0, 0)), Scalar(2)) +
                                            std::pow(Scalar(-_tmp61 + p_c(1, 0)), Scalar(2))));
  const Scalar _tmp171 = _tmp168 * _tmp170;
  const Scalar _tmp172 = Scalar(9.6622558468725703) * _tmp105;
  const Scalar _tmp173 = _tmp172 * _tmp70;
  const Scalar _tmp174 = std::pow(_tmp164, Scalar(-2));
  const Scalar _tmp175 = _tmp105 * _tmp174 * _tmp70;
  const Scalar _tmp176 = Scalar(0.1034955) * _tmp175;
  const Scalar _tmp177 = _tmp134 * _tmp21;
  const Scalar _tmp178 =
      (-_tmp161 * _tmp175 + _tmp165 * (-_tmp130 - _tmp139 * _tmp177 + _tmp151 * _tmp160)) /
      std::sqrt(Scalar(std::pow(_tmp161, Scalar(2)) * _tmp174 + 1));
  const Scalar _tmp179 = _tmp113 * _tmp116 + _tmp121 * _tmp123 + _tmp162 + _tmp163;
  const Scalar _tmp180 = Scalar(1.0) / (_tmp179);
  const Scalar _tmp181 = -_tmp112 * _tmp116 * _tmp128 - _tmp120 * _tmp123 * _tmp128 +
                         _tmp129 * _tmp81 - _tmp135 * _tmp80 - _tmp142 * _tmp144 + _tmp159;
  ...
  const Scalar _tmp186 =
      -_tmp182 * _tmp185 - std::sqrt(Scalar(std::pow(Scalar(-_tmp49 + p_b(1, 0)), Scalar(2)) +
  ...
  const Scalar _tmp190 = (_tmp180 * (-_tmp129 - _tmp144 * _tmp151 + _tmp177) + _tmp181 * _tmp189) /
  ...
  _res(1, 0) =
      -_tmp154 * (Scalar(1.0) * _tmp152 * std::sinh(_tmp148) - _tmp153 * p_d(2, 0) -
                  (-_tmp153 * _tmp155 + _tmp156 * (-_tmp147 * _tmp158 - _tmp152 * _tmp154)) *
                      std::sinh(_tmp157)) -
      _tmp158 * (_tmp156 * p_d(2, 0) + std::cosh(_tmp148) - std::cosh(_tmp157));
  _res(2, 0) =
      -_tmp169 * (-_tmp176 * p_c(2, 0) + Scalar(1.0) * _tmp178 * std::sinh(_tmp167) -
                  (_tmp168 * (-_tmp166 * _tmp173 - _tmp169 * _tmp178) - _tmp170 * _tmp176) *
                      std::sinh(_tmp171)) -
      _tmp173 * (_tmp168 * p_c(2, 0) + std::cosh(_tmp167) - std::cosh(_tmp171));
