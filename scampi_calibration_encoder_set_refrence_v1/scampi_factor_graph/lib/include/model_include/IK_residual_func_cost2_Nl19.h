...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl19(
  ...
  const Scalar _tmp31 = _tmp3 - _tmp7;
  ...
  const Scalar _tmp41 = -_tmp30 + _tmp32;
  ...
  const Scalar _tmp64 = _tmp44 * _tmp49;
  const Scalar _tmp65 = _tmp18 + _tmp25;
  const Scalar _tmp66 = _tmp65 + p_init0;
  const Scalar _tmp67 = _tmp66 - p_c(0, 0);
  const Scalar _tmp68 = _tmp28 + _tmp33;
  ...
  const Scalar _tmp74 = _tmp53 + _tmp8;
  ...
  const Scalar _tmp78 = _tmp50 * _tmp62 - _tmp64;
  const Scalar _tmp79 = _tmp77 * _tmp78;
  const Scalar _tmp80 = -_tmp50 * _tmp63 + _tmp54 * _tmp64 - _tmp76 * _tmp79;
  ...
  const Scalar _tmp87 = -_tmp72 * _tmp74 + _tmp73;
  const Scalar _tmp88 = _tmp50 * _tmp52 - _tmp50 * _tmp54 - _tmp79 * _tmp87 - _tmp80 * _tmp86;
  ...
  const Scalar _tmp96 = _tmp94 * (-_tmp55 * _tmp60 * _tmp95 + _tmp57 * _tmp58 * _tmp95);
  const Scalar _tmp97 = -_tmp65 * _tmp75 + _tmp68 * _tmp72 + _tmp72 * _tmp96;
  const Scalar _tmp98 = _tmp42 * _tmp50 - _tmp46 * _tmp64 + _tmp50 * _tmp96 - _tmp79 * _tmp97;
  ...
  const Scalar _tmp110 = -_tmp101 * _tmp87 + _tmp109 * _tmp76 * _tmp77 * _tmp85;
  const Scalar _tmp111 = _tmp89 * _tmp98;
  const Scalar _tmp112 = _tmp88 * _tmp99;
  const Scalar _tmp113 = _tmp112 * (-_tmp101 * _tmp97 - _tmp110 * _tmp111);
  const Scalar _tmp114 = _tmp110 + _tmp113;
  const Scalar _tmp115 = _tmp50 * _tmp89;
  const Scalar _tmp116 = _tmp78 * _tmp89;
  const Scalar _tmp117 = -_tmp114 * _tmp116 + Scalar(1.0);
  const Scalar _tmp118 = _tmp72 * _tmp77;
  const Scalar _tmp119 = _tmp107 * fh1;
  const Scalar _tmp120 = _tmp62 * _tmp77;
  const Scalar _tmp121 = _tmp120 * _tmp76 + _tmp63;
  const Scalar _tmp122 = _tmp120 * _tmp87 - _tmp121 * _tmp86 - _tmp52;
  const Scalar _tmp123 = _tmp112 * (-_tmp111 * _tmp122 + _tmp120 * _tmp97 - _tmp96);
  const Scalar _tmp124 = _tmp122 + _tmp123;
  const Scalar _tmp125 = -_tmp116 * _tmp124 - _tmp62;
  const Scalar _tmp126 = _tmp106 * fh1;
  const Scalar _tmp127 = -_tmp108 * _tmp94 * (_tmp100 * _tmp50 - _tmp102 * _tmp72) -
                         _tmp119 * _tmp94 * (_tmp114 * _tmp115 + _tmp117 * _tmp118) -
                         _tmp126 * _tmp94 * (_tmp115 * _tmp124 + _tmp118 * _tmp125 + Scalar(1.0)) -
                         _tmp40 * _tmp94 * (_tmp50 * _tmp92 - _tmp72 * _tmp79 * _tmp92);
  const Scalar _tmp128 = Scalar(1.0) / (_tmp127);
  const Scalar _tmp129 = _tmp42 + _tmp82;
  const Scalar _tmp130 = _tmp129 * _tmp86;
  const Scalar _tmp131 = Scalar(1.0) / (-_tmp130 - _tmp46 + _tmp84);
  const Scalar _tmp132 = Scalar(1.0) * _tmp131;
  const Scalar _tmp133 = _tmp80 * _tmp89;
  const Scalar _tmp134 = _tmp129 * _tmp131;
  const Scalar _tmp135 = -_tmp101 * _tmp76 + _tmp113 * _tmp134 - _tmp114 * _tmp133;
  const Scalar _tmp136 = Scalar(1.0) * fh1;
  const Scalar _tmp137 = _tmp131 * _tmp90;
  const Scalar _tmp138 = -_tmp129 * _tmp137 - _tmp133 * _tmp91 + _tmp82;
  const Scalar _tmp139 = _tmp16 * fh1;
  const Scalar _tmp140 = _tmp106 * _tmp139 + Scalar(3.29616) * _tmp20 + _tmp26 * fv1;
  const Scalar _tmp141 = _tmp129 * _tmp83;
  const Scalar _tmp142 = _tmp112 * _tmp132;
  const Scalar _tmp143 = -_tmp100 * _tmp80 + _tmp129 * _tmp142;
  const Scalar _tmp144 = _tmp121 + _tmp123 * _tmp134 - _tmp124 * _tmp133;
  const Scalar _tmp145 = _tmp130 * _tmp132 + Scalar(1.0);
  const Scalar _tmp146 = -_tmp107 * _tmp139 - Scalar(3.29616) * _tmp31 - _tmp34 * fv1;
  const Scalar _tmp147 = std::asinh(
      _tmp128 * (_tmp106 * _tmp136 * (-_tmp109 * _tmp144 + _tmp123 * _tmp132) +
                 _tmp107 * _tmp136 * (-_tmp109 * _tmp135 + _tmp113 * _tmp132) +
                 Scalar(1.0) * _tmp108 * (-_tmp109 * _tmp143 + _tmp142) +
                 Scalar(1.0) * _tmp140 * (_tmp132 * _tmp141 - _tmp132) +
                 Scalar(1.0) * _tmp146 * (-_tmp109 * _tmp145 + _tmp132 * _tmp86) +
                 Scalar(1.0) * _tmp40 * (-_tmp109 * _tmp138 - _tmp132 * _tmp90 + Scalar(1.0))));
  const Scalar _tmp148 = Scalar(9.6622558468725703) * _tmp127;
  const Scalar _tmp149 = std::pow(Scalar(-_tmp56 + p_a(1, 0)), Scalar(2)) +
                         std::pow(Scalar(-_tmp59 + p_a(0, 0)), Scalar(2));
  const Scalar _tmp150 = std::pow(Scalar(-_tmp66 + p_c(0, 0)), Scalar(2)) +
                         std::pow(Scalar(-_tmp69 + p_c(1, 0)), Scalar(2));
  const Scalar _tmp151 = _tmp146 * _tmp83;
  const Scalar _tmp152 = _tmp132 * _tmp140;
  const Scalar _tmp153 = _tmp83 * fh1;
  const Scalar _tmp154 = _tmp40 * _tmp92;
  const Scalar _tmp155 = -_tmp102 * _tmp108 + _tmp117 * _tmp119 * _tmp77 +
                         _tmp125 * _tmp126 * _tmp77 - _tmp154 * _tmp79;
  const Scalar _tmp156 = Scalar(1.0) / (_tmp155);
  const Scalar _tmp157 =
      std::asinh(_tmp156 * (_tmp106 * _tmp144 * _tmp153 + _tmp107 * _tmp135 * _tmp153 +
                            _tmp108 * _tmp143 * _tmp83 + _tmp138 * _tmp40 * _tmp83 -
                            _tmp141 * _tmp152 + _tmp145 * _tmp151));
  const Scalar _tmp158 = Scalar(9.6622558468725703) * _tmp155;
  const Scalar _tmp159 = std::pow(Scalar(-_tmp43 + p_b(1, 0)), Scalar(2)) +
                         std::pow(Scalar(-_tmp47 + p_b(0, 0)), Scalar(2));
  const Scalar _tmp160 =
      _tmp100 * _tmp108 + _tmp114 * _tmp119 * _tmp89 + _tmp124 * _tmp126 * _tmp89 + _tmp154;
  const Scalar _tmp161 = Scalar(1.0) / (_tmp160);
  const Scalar _tmp162 = std::asinh(
      _tmp161 * (-_tmp108 * _tmp142 - _tmp113 * _tmp119 * _tmp131 - _tmp123 * _tmp126 * _tmp131 -
                 _tmp132 * _tmp151 * _tmp85 + _tmp137 * _tmp40 + _tmp152));
  ...
  _res(1, 0) =
      _tmp148 *
          (-std::sinh(Scalar(1.0) * _tmp147) -
           std::sinh(Scalar(0.1034955) * _tmp128 * (-_tmp147 * _tmp148 - std::sqrt(_tmp149)))) -
      std::sqrt(Scalar(_tmp149 + std::pow(Scalar(-_tmp52 + p_a(2, 0) - p_init2), Scalar(2))));
  _res(2, 0) =
      _tmp158 *
          (-std::sinh(Scalar(1.0) * _tmp157) -
           std::sinh(Scalar(0.1034955) * _tmp156 * (-std::sqrt(_tmp150) - _tmp157 * _tmp158))) -
      std::sqrt(Scalar(_tmp150 + std::pow(Scalar(-_tmp74 + p_c(2, 0) - p_init2), Scalar(2))));
  _res(3, 0) =
      _tmp163 *
          (-std::sinh(Scalar(1.0) * _tmp162) -
           std::sinh(Scalar(0.1034955) * _tmp161 * (-std::sqrt(_tmp159) - _tmp162 * _tmp163))) -
      std::sqrt(Scalar(_tmp159 + std::pow(Scalar(-_tmp54 + p_b(2, 0) - p_init2), Scalar(2))));
