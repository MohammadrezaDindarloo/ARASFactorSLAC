...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl21(
  ...
  const Scalar _tmp30 = Scalar(0.20999999999999999) * _tmp19 + Scalar(0.20999999999999999) * _tmp8 +
  ...
  const Scalar _tmp71 = Scalar(1.0) / (-_tmp56 + _tmp57 * _tmp70);
  const Scalar _tmp72 = _tmp45 * _tmp46;
  const Scalar _tmp73 = _tmp47 * _tmp70 - _tmp72;
  const Scalar _tmp74 = _tmp71 * _tmp73;
  const Scalar _tmp75 = -_tmp39 * _tmp72 + _tmp43 * _tmp47 + _tmp47 * _tmp68 - _tmp69 * _tmp74;
  const Scalar _tmp76 = Scalar(1.0) / (_tmp75);
  const Scalar _tmp77 = Scalar(1.0) * _tmp76;
  const Scalar _tmp78 = Scalar(1.0) * _tmp71;
  const Scalar _tmp79 = _tmp73 * _tmp76 * _tmp78;
  const Scalar _tmp80 = _tmp33 - p_d(1, 0);
  const Scalar _tmp81 = _tmp25 - p_d(0, 0);
  ...
  const Scalar _tmp100 = _tmp14 + _tmp86;
  const Scalar _tmp101 = _tmp47 * _tmp88;
  const Scalar _tmp102 = _tmp100 * _tmp72 - _tmp101 * _tmp70 - _tmp74 * _tmp97;
  const Scalar _tmp103 = -_tmp100 * _tmp47 + _tmp101 - _tmp102 * _tmp95 - _tmp74 * _tmp90;
  const Scalar _tmp104 = Scalar(1.0) / (_tmp103);
  const Scalar _tmp105 = _tmp104 * _tmp75;
  const Scalar _tmp106 = _tmp103 * _tmp76;
  const Scalar _tmp107 = _tmp106 * (-_tmp105 * _tmp99 - _tmp69 * _tmp78);
  const Scalar _tmp108 = _tmp107 + _tmp99;
  const Scalar _tmp109 = _tmp104 * _tmp47;
  const Scalar _tmp110 = _tmp104 * _tmp73;
  const Scalar _tmp111 = -_tmp108 * _tmp110 + Scalar(1.0);
  const Scalar _tmp112 = _tmp57 * _tmp71;
  const Scalar _tmp113 = _tmp84 * fh1;
  const Scalar _tmp114 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp115 = _tmp91 * _tmp95 + _tmp94;
  const Scalar _tmp116 = 0;
  const Scalar _tmp117 = _tmp110 * _tmp116;
  const Scalar _tmp118 = _tmp104 * _tmp116;
  const Scalar _tmp119 = _tmp70 * _tmp71;
  const Scalar _tmp120 = _tmp119 * _tmp97 + _tmp96;
  const Scalar _tmp121 = _tmp119 * _tmp90 - _tmp120 * _tmp95 - _tmp88;
  const Scalar _tmp122 = _tmp106 * (-_tmp105 * _tmp121 + _tmp119 * _tmp69 - _tmp68);
  const Scalar _tmp123 = _tmp121 + _tmp122;
  const Scalar _tmp124 = -_tmp110 * _tmp123 - _tmp70;
  const Scalar _tmp125 = _tmp83 * fh1;
  const Scalar _tmp126 = -_tmp113 * _tmp67 * (_tmp108 * _tmp109 + _tmp111 * _tmp112) -
                         _tmp114 * _tmp67 * (-_tmp112 * _tmp117 + _tmp118 * _tmp47) -
                         _tmp125 * _tmp67 * (_tmp109 * _tmp123 + _tmp112 * _tmp124 + Scalar(1.0)) -
                         _tmp67 * _tmp85 * (_tmp47 * _tmp77 - _tmp57 * _tmp79);
  const Scalar _tmp127 = Scalar(1.0) / (_tmp126);
  const Scalar _tmp128 = _tmp43 + _tmp92;
  const Scalar _tmp129 = _tmp128 * _tmp95;
  const Scalar _tmp130 = Scalar(1.0) / (-_tmp129 - _tmp39 + _tmp94);
  ...
  const Scalar _tmp135 = Scalar(1.0) * _tmp93;
  const Scalar _tmp136 = _tmp115 * _tmp130;
  const Scalar _tmp137 = -_tmp116 * _tmp132 - _tmp128 * _tmp136 + _tmp92;
  const Scalar _tmp138 = _tmp107 * _tmp133 - _tmp108 * _tmp132 - _tmp98;
  const Scalar _tmp139 = _tmp131 * _tmp95;
  const Scalar _tmp140 = _tmp93 * (_tmp129 * _tmp131 + Scalar(1.0));
  const Scalar _tmp141 = _tmp15 * fh1;
  const Scalar _tmp142 = -_tmp141 * _tmp84 - Scalar(3.29616) * _tmp28 - _tmp32 * fv1;
  const Scalar _tmp143 = _tmp128 * _tmp131;
  const Scalar _tmp144 = -_tmp102 * _tmp77 + _tmp106 * _tmp143;
  const Scalar _tmp145 = _tmp106 * _tmp131;
  const Scalar _tmp146 = _tmp141 * _tmp83 + Scalar(3.29616) * _tmp21 + _tmp24 * fv1;
  const Scalar _tmp147 = std::asinh(
      _tmp127 * (Scalar(1.0) * _tmp113 * (_tmp107 * _tmp131 - _tmp135 * _tmp138) +
                 ...
                 Scalar(1.0) * _tmp146 * (-_tmp131 + _tmp143 * _tmp93) +
                 Scalar(1.0) * _tmp85 * (-_tmp135 * _tmp144 + _tmp145)));
  const Scalar _tmp148 = Scalar(9.6622558468725703) * _tmp126;
  const Scalar _tmp149 = std::pow(Scalar(-_tmp59 + p_b(1, 0)), Scalar(2)) +
                         std::pow(Scalar(-_tmp62 + p_b(0, 0)), Scalar(2));
  const Scalar _tmp150 = _tmp111 * _tmp113 * _tmp71 - _tmp114 * _tmp117 * _tmp71 +
                         _tmp124 * _tmp125 * _tmp71 - _tmp79 * _tmp85;
  const Scalar _tmp151 = Scalar(1.0) / (_tmp150);
  const Scalar _tmp152 = _tmp131 * _tmp146;
  const Scalar _tmp153 =
      std::asinh(_tmp151 * (_tmp113 * _tmp138 * _tmp93 + _tmp114 * _tmp137 * _tmp93 +
                            _tmp125 * _tmp134 * _tmp93 - _tmp128 * _tmp152 * _tmp93 +
                            _tmp140 * _tmp142 + _tmp144 * _tmp85 * _tmp93));
  const Scalar _tmp154 = Scalar(9.6622558468725703) * _tmp150;
  const Scalar _tmp155 = std::pow(Scalar(-_tmp50 + p_c(0, 0)), Scalar(2)) +
                         std::pow(Scalar(-_tmp53 + p_c(1, 0)), Scalar(2));
  const Scalar _tmp156 = std::pow(Scalar(-_tmp40 + p_a(0, 0)), Scalar(2)) +
                         std::pow(Scalar(-_tmp44 + p_a(1, 0)), Scalar(2));
  const Scalar _tmp157 = _tmp104 * _tmp108 * _tmp113 + _tmp104 * _tmp123 * _tmp125 +
                         _tmp114 * _tmp118 + _tmp77 * _tmp85;
  const Scalar _tmp158 = Scalar(1.0) / (_tmp157);
  const Scalar _tmp159 = std::asinh(_tmp158 * (-_tmp107 * _tmp113 * _tmp130 + _tmp114 * _tmp136 -
                                               _tmp122 * _tmp125 * _tmp130 - _tmp139 * _tmp142 -
                                               _tmp145 * _tmp85 + _tmp152));
  ...
  _res(1, 0) =
      ...
      std::sqrt(Scalar(_tmp149 + std::pow(Scalar(-_tmp88 + p_b(2, 0) - p_init2), Scalar(2))));
  _res(2, 0) =
      _tmp154 *
          (-std::sinh(Scalar(1.0) * _tmp153) -
           std::sinh(Scalar(0.1034955) * _tmp151 * (-_tmp153 * _tmp154 - std::sqrt(_tmp155)))) -
      std::sqrt(Scalar(_tmp155 + std::pow(Scalar(-_tmp89 + p_c(2, 0) - p_init2), Scalar(2))));
  _res(3, 0) =
      _tmp160 *
          (-std::sinh(Scalar(1.0) * _tmp159) -
           std::sinh(Scalar(0.1034955) * _tmp158 * (-std::sqrt(_tmp156) - _tmp159 * _tmp160))) -
      std::sqrt(Scalar(_tmp156 + std::pow(Scalar(-_tmp100 + p_a(2, 0) - p_init2), Scalar(2))));
