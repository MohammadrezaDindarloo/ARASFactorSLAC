...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2WrtFv1Nl2(
  ...
  const Scalar _tmp41 = -Scalar(0.010999999999999999) * _tmp25 -
  ...
  const Scalar _tmp45 = -Scalar(3.29616) * _tmp29 - _tmp33 * fv1 - _tmp38 * _tmp44;
  const Scalar _tmp46 = _tmp23 + _tmp26;
  const Scalar _tmp47 = _tmp31 + _tmp46;
  const Scalar _tmp48 = Scalar(1.0) * _tmp47;
  const Scalar _tmp49 = -_tmp48;
  const Scalar _tmp50 = _tmp23 + _tmp32;
  const Scalar _tmp51 = Scalar(1.0) / (_tmp49 + _tmp50);
  const Scalar _tmp52 = _tmp15 + _tmp19;
  const Scalar _tmp53 = _tmp52 + _tmp9;
  const Scalar _tmp54 = _tmp24 + _tmp26 + _tmp31;
  ...
  const Scalar _tmp87 = _tmp39 + _tmp43;
  ...
  const Scalar _tmp101 = _tmp40 + _tmp85;
  ...
  const Scalar _tmp111 = _tmp104 * (_tmp109 + _tmp92);
  const Scalar _tmp112 = -_tmp102 * _tmp111 + _tmp109 * _tmp110 + _tmp90;
  const Scalar _tmp113 = Scalar(1.0) * _tmp51;
  const Scalar _tmp114 = _tmp35 * _tmp37;
  ...
  const Scalar _tmp121 = _tmp51 * (-_tmp118 * _tmp55 - _tmp119 * _tmp120 + _tmp49);
  const Scalar _tmp122 = -Scalar(1.0) * _tmp118 - Scalar(1.0) * _tmp121 + Scalar(1.0);
  const Scalar _tmp123 = _tmp114 * _tmp44 + Scalar(3.29616) * _tmp14 + _tmp21 * fv1;
  ...
  const Scalar _tmp130 = _tmp110 * _tmp128 - _tmp120 * _tmp129 - _tmp126;
  const Scalar _tmp131 = _tmp108 * _tmp62;
  const Scalar _tmp132 = Scalar(1.0) * _tmp107;
  const Scalar _tmp133 = -_tmp102 * _tmp132 + _tmp131 * _tmp55;
  const Scalar _tmp134 = fh1 * (-_tmp114 * _tmp33 + _tmp21 * _tmp38);
  const Scalar _tmp135 = _tmp114 * _tmp115 * (_tmp109 * _tmp62 - _tmp112 * _tmp113) +
                         _tmp115 * _tmp38 * (-_tmp113 * _tmp130 + _tmp128 * _tmp62) +
                         _tmp116 * _tmp122 + _tmp123 * _tmp125 +
                         Scalar(1.0) * _tmp134 * (-_tmp113 * _tmp133 + _tmp131) + _tmp45 * _tmp65;
  const Scalar _tmp136 = _tmp104 * _tmp129;
  const Scalar _tmp137 = -_tmp100 * _tmp136 + Scalar(1.0);
  const Scalar _tmp138 = _tmp77 * _tmp83;
  const Scalar _tmp139 = _tmp38 * fh1;
  const Scalar _tmp140 = _tmp104 * _tmp119;
  const Scalar _tmp141 = _tmp100 * _tmp138;
  const Scalar _tmp142 = _tmp81 * (-_tmp140 * _tmp141 + _tmp140 * _tmp98);
  const Scalar _tmp143 = -_tmp100 * _tmp111 - _tmp71;
  const Scalar _tmp144 = _tmp114 * fh1;
  const Scalar _tmp145 = -_tmp116 * _tmp142 -
                         _tmp134 * _tmp81 * (-_tmp132 * _tmp141 + _tmp132 * _tmp98) -
                         _tmp139 * _tmp81 * (_tmp136 * _tmp98 + _tmp137 * _tmp138) -
                         _tmp144 * _tmp81 * (_tmp111 * _tmp98 + _tmp138 * _tmp143 + Scalar(1.0));
  const Scalar _tmp146 = Scalar(1.0) / (_tmp145);
  const Scalar _tmp147 = std::asinh(_tmp135 * _tmp146);
  const Scalar _tmp148 = Scalar(9.6622558468725703) * _tmp145;
  const Scalar _tmp149 =
      -_tmp147 * _tmp148 - std::sqrt(Scalar(std::pow(Scalar(-_tmp66 + p_c(1, 0)), Scalar(2)) +
  ...
  const Scalar _tmp156 = _tmp30 + _tmp46;
  const Scalar _tmp157 =
      (-_tmp135 * _tmp155 + _tmp146 * (-_tmp122 + _tmp125 * _tmp21 + _tmp156 * _tmp65)) /
      std::sqrt(Scalar(std::pow(_tmp135, Scalar(2)) * _tmp154 + 1));
  const Scalar _tmp158 = _tmp116 * _tmp140;
  const Scalar _tmp159 = _tmp100 * _tmp83;
  const Scalar _tmp160 = _tmp132 * _tmp134;
  const Scalar _tmp161 = _tmp137 * _tmp139 * _tmp83 + _tmp143 * _tmp144 * _tmp83 -
                         _tmp158 * _tmp159 - _tmp159 * _tmp160;
  const Scalar _tmp162 = Scalar(1.0) / (_tmp161);
  const Scalar _tmp163 = _tmp123 * _tmp62;
  const Scalar _tmp164 = _tmp112 * _tmp144 * _tmp51 + _tmp116 * _tmp121 - _tmp124 * _tmp163 +
                         _tmp130 * _tmp139 * _tmp51 + _tmp133 * _tmp134 * _tmp51 + _tmp45 * _tmp63;
  const Scalar _tmp165 = std::asinh(_tmp162 * _tmp164);
  const Scalar _tmp166 = Scalar(9.6622558468725703) * _tmp161;
  const Scalar _tmp167 =
      -_tmp165 * _tmp166 - std::sqrt(Scalar(std::pow(Scalar(-_tmp72 + p_b(1, 0)), Scalar(2)) +
  ...
  const Scalar _tmp171 = Scalar(9.6622558468725703) * _tmp140;
  const Scalar _tmp172 = _tmp159 * _tmp171;
  const Scalar _tmp173 = std::pow(_tmp161, Scalar(-2));
  const Scalar _tmp174 = _tmp140 * _tmp159 * _tmp173;
  const Scalar _tmp175 = _tmp21 * _tmp62;
  const Scalar _tmp176 =
      (_tmp162 * (-_tmp121 - _tmp124 * _tmp175 + _tmp156 * _tmp63) - _tmp164 * _tmp174) /
      std::sqrt(Scalar(std::pow(_tmp164, Scalar(2)) * _tmp173 + 1));
  const Scalar _tmp177 = -_tmp109 * _tmp144 * _tmp61 + _tmp116 * _tmp118 -
                         _tmp128 * _tmp139 * _tmp61 - _tmp131 * _tmp134 + _tmp163 - _tmp45 * _tmp64;
  const Scalar _tmp178 = _tmp111 * _tmp144 + _tmp136 * _tmp139 + _tmp158 + _tmp160;
  ...
  const Scalar _tmp182 =
      -_tmp180 * _tmp181 - std::sqrt(Scalar(std::pow(Scalar(-_tmp93 + p_d(1, 0)), Scalar(2)) +
  ...
  const Scalar _tmp188 = (_tmp177 * _tmp187 + _tmp179 * (-_tmp118 - _tmp156 * _tmp64 + _tmp175)) /
