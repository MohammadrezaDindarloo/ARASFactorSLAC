...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl17(
  ...
  const Scalar _tmp38 = _tmp17 * _tmp27;
  ...
  const Scalar _tmp43 = _tmp42 * (-_tmp30 * _tmp35 * _tmp41 + _tmp31 * _tmp34 * _tmp41);
  const Scalar _tmp44 = _tmp16 * _tmp28 - _tmp25 * _tmp38 + _tmp28 * _tmp43;
  ...
  const Scalar _tmp53 = _tmp28 * _tmp50 - _tmp28 * _tmp52;
  const Scalar _tmp54 = _tmp37 * _tmp50;
  const Scalar _tmp55 = -_tmp28 * _tmp54 + _tmp38 * _tmp52;
  const Scalar _tmp56 = Scalar(1.0) * _tmp30;
  const Scalar _tmp57 = Scalar(1.0) * _tmp34;
  const Scalar _tmp58 = (-_tmp25 + _tmp57) / (_tmp16 - _tmp56);
  const Scalar _tmp59 = _tmp45 * _tmp53 - _tmp50 - _tmp58 * (_tmp45 * _tmp55 + _tmp54);
  const Scalar _tmp60 = _tmp24 + _tmp32;
  const Scalar _tmp61 = _tmp60 - p_a(0, 0) + p_init0;
  const Scalar _tmp62 = _tmp29 + _tmp5;
  ...
  const Scalar _tmp68 = _tmp37 * _tmp65 - _tmp67;
  const Scalar _tmp69 = _tmp39 * _tmp68;
  const Scalar _tmp70 = _tmp50 * _tmp65 - _tmp53 * _tmp69 -
                        _tmp58 * (-_tmp54 * _tmp65 - _tmp55 * _tmp69 + _tmp66 * _tmp67) -
                        _tmp65 * _tmp66;
  const Scalar _tmp71 = Scalar(1.0) / (_tmp70);
  const Scalar _tmp72 = _tmp43 * _tmp65 - _tmp44 * _tmp69 - _tmp60 * _tmp67 + _tmp62 * _tmp65;
  ...
  const Scalar _tmp78 = _tmp39 * (-_tmp37 - _tmp76 * _tmp77);
  const Scalar _tmp79 = _tmp71 * _tmp76;
  const Scalar _tmp80 = _tmp19 + _tmp33;
  const Scalar _tmp81 = _tmp80 - p_c(0, 0) + p_init0;
  const Scalar _tmp82 = _tmp15 + _tmp4;
  const Scalar _tmp83 = _tmp82 - p_c(1, 0) + p_init1;
  const Scalar _tmp84 = std::pow(Scalar(std::pow(_tmp81, Scalar(2)) + std::pow(_tmp83, Scalar(2))),
                                 Scalar(Scalar(-1) / Scalar(2)));
  const Scalar _tmp85 = _tmp81 * _tmp84;
  const Scalar _tmp86 = _tmp42 * _tmp85 * (_tmp28 * _tmp78 + _tmp65 * _tmp79 + Scalar(1.0));
  const Scalar _tmp87 = _tmp83 * _tmp84;
  const Scalar _tmp88 = _tmp80 * _tmp87 - _tmp82 * _tmp85;
  const Scalar _tmp89 = Scalar(1.0) * _tmp74;
  const Scalar _tmp90 = _tmp28 * _tmp69;
  const Scalar _tmp91 = _tmp42 * _tmp88 * (_tmp65 * _tmp89 - _tmp89 * _tmp90);
  const Scalar _tmp92 = Scalar(1.0) * _tmp39;
  const Scalar _tmp93 = -_tmp53 * _tmp92 + _tmp55 * _tmp58 * _tmp92;
  const Scalar _tmp94 = _tmp75 * (-_tmp44 * _tmp92 - _tmp73 * _tmp93) + _tmp93;
  const Scalar _tmp95 = _tmp39 * (-_tmp77 * _tmp94 + Scalar(1.0));
  const Scalar _tmp96 = _tmp71 * _tmp94;
  const Scalar _tmp97 = _tmp42 * _tmp87 * (_tmp28 * _tmp95 + _tmp65 * _tmp96);
  ...
  const Scalar _tmp103 = _tmp88 * _tmp89;
  ...
  _res(1, 0) = -(-_tmp86 - _tmp91 - _tmp97) *
               std::exp(_tmp42 * _tmp98 * (_tmp100 * _tmp65 - _tmp100 * _tmp90) + _tmp86 * fh1 +
                        _tmp91 * fh1 + _tmp97 * fh1);
  _res(2, 0) = -(_tmp101 - _tmp103 * _tmp69 + _tmp105) *
               std::exp(-_tmp101 * fh1 + _tmp102 * _tmp69 + _tmp104 * _tmp69 - _tmp105 * fh1);
  _res(3, 0) =
