...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl19(
  ...
  const Scalar _tmp71 = _tmp70 * (_tmp35 * _tmp67 - _tmp52 * _tmp68);
  const Scalar _tmp72 = Scalar(1.0) / (_tmp69);
  const Scalar _tmp73 = _tmp70 * (-_tmp38 * _tmp42 * _tmp72 + _tmp39 * _tmp41 * _tmp72);
  const Scalar _tmp74 = -_tmp47 * _tmp55 + _tmp49 * _tmp52 + _tmp52 * _tmp73;
  const Scalar _tmp75 = _tmp25 * _tmp35 - _tmp32 * _tmp46 + _tmp35 * _tmp73 - _tmp59 * _tmp74;
  const Scalar _tmp76 = Scalar(1.0) / (_tmp75);
  const Scalar _tmp77 = Scalar(1.0) * _tmp76;
  const Scalar _tmp78 = _tmp18 + _tmp37;
  const Scalar _tmp79 = _tmp78 - p_d(1, 0) + p_init1;
  const Scalar _tmp80 = _tmp27 + _tmp40;
  const Scalar _tmp81 = _tmp80 - p_d(0, 0) + p_init0;
  ...
  const Scalar _tmp87 = _tmp56 * _tmp62 * _tmp86 - _tmp63 * _tmp86;
  ...
  const Scalar _tmp96 = _tmp44 * _tmp57;
  const Scalar _tmp97 = -_tmp16 - _tmp62 * (_tmp45 + _tmp56 * _tmp96) + _tmp63 * _tmp96;
  const Scalar _tmp98 = _tmp89 * (-_tmp73 + _tmp74 * _tmp96 - _tmp88 * _tmp97) + _tmp97;
  const Scalar _tmp99 = -_tmp44 - _tmp92 * _tmp98;
  ...
  _res(1, 0) =
      -_tmp71 * std::exp(_tmp0 * _tmp71 +
                         ...
                         _tmp70 * _tmp85 * (_tmp35 * _tmp77 - _tmp52 * _tmp59 * _tmp77) +
  ...
  _res(3, 0) =
      _tmp67 * std::exp(-_tmp100 * _tmp65 * _tmp98 - _tmp101 - _tmp102 - _tmp65 * _tmp90 * _tmp95);
