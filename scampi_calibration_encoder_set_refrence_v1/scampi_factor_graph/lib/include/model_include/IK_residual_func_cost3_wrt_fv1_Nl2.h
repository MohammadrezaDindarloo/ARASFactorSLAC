...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl2(
  ...
  const Scalar _tmp16 = _tmp15 - p_c(1, 0) + p_init1;
  ...
  const Scalar _tmp25 = _tmp24 - p_c(0, 0) + p_init0;
  ...
  const Scalar _tmp30 = _tmp29 - p_b(1, 0) + p_init1;
  ...
  const Scalar _tmp36 = _tmp30 * _tmp34;
  ...
  const Scalar _tmp44 = _tmp35 * _tmp42 - _tmp35 * _tmp43;
  const Scalar _tmp45 = _tmp37 * _tmp44;
  const Scalar _tmp46 = Scalar(1.0) * _tmp15;
  const Scalar _tmp47 = Scalar(1.0) * _tmp24;
  const Scalar _tmp48 = (-_tmp32 + _tmp47) / (_tmp29 - _tmp46);
  const Scalar _tmp49 = _tmp27 * _tmp42;
  const Scalar _tmp50 = -_tmp35 * _tmp49 + _tmp36 * _tmp43;
  const Scalar _tmp51 = _tmp37 * _tmp50;
  const Scalar _tmp52 = -Scalar(1.0) * _tmp45 + Scalar(1.0) * _tmp48 * _tmp51;
  ...
  const Scalar _tmp62 = _tmp27 * _tmp60 - _tmp61;
  const Scalar _tmp63 = _tmp37 * _tmp62;
  const Scalar _tmp64 = _tmp38 + _tmp39 - _tmp40;
  const Scalar _tmp65 = _tmp42 * _tmp60 - _tmp44 * _tmp63 -
                        _tmp48 * (-_tmp49 * _tmp60 - _tmp50 * _tmp63 + _tmp61 * _tmp64) -
                        _tmp60 * _tmp64;
  ...
  const Scalar _tmp70 = _tmp69 * (-_tmp15 * _tmp25 * _tmp68 + _tmp16 * _tmp24 * _tmp68);
  const Scalar _tmp71 = _tmp37 * (_tmp29 * _tmp35 - _tmp32 * _tmp36 + _tmp35 * _tmp70);
  const Scalar _tmp72 = _tmp54 * _tmp60 - _tmp57 * _tmp61 + _tmp60 * _tmp70 - _tmp62 * _tmp71;
  const Scalar _tmp73 = _tmp66 * _tmp72;
  const Scalar _tmp74 = Scalar(1.0) / (_tmp72);
  const Scalar _tmp75 = _tmp65 * _tmp74;
  const Scalar _tmp76 = _tmp52 + _tmp75 * (-_tmp52 * _tmp73 - Scalar(1.0) * _tmp71);
  const Scalar _tmp77 = _tmp60 * _tmp66;
  const Scalar _tmp78 = _tmp62 * _tmp66;
  const Scalar _tmp79 = -_tmp76 * _tmp78 + Scalar(1.0);
  const Scalar _tmp80 = _tmp35 * _tmp37;
  const Scalar _tmp81 = _tmp31 + _tmp56;
  const Scalar _tmp82 = _tmp81 - p_a(0, 0) + p_init0;
  const Scalar _tmp83 = _tmp28 + _tmp53;
  ...
  const Scalar _tmp89 = _tmp46 * _tmp48 + _tmp47;
  const Scalar _tmp90 = 0;
  const Scalar _tmp91 = _tmp63 * _tmp90;
  const Scalar _tmp92 = _tmp69 * (-_tmp35 * _tmp91 + _tmp60 * _tmp90);
  const Scalar _tmp93 = _tmp27 * _tmp45 - _tmp42 - _tmp48 * (_tmp27 * _tmp51 + _tmp49);
  const Scalar _tmp94 = _tmp75 * (_tmp27 * _tmp71 - _tmp70 - _tmp73 * _tmp93) + _tmp93;
  const Scalar _tmp95 = -_tmp27 - _tmp78 * _tmp94;
  ...
  const Scalar _tmp100 = _tmp37 * fh1;
  ...
  _res(0, 0) = 0;
  _res(1, 0) =
      -_tmp92 * std::exp(_tmp69 * _tmp98 * (-_tmp35 * _tmp63 * _tmp97 + _tmp60 * _tmp97) +
                         _tmp86 * _tmp87 * (_tmp76 * _tmp77 + _tmp79 * _tmp80) +
                         _tmp87 * _tmp96 * (_tmp77 * _tmp94 + _tmp80 * _tmp95 + Scalar(1.0)) +
                         _tmp88 * _tmp92);
  _res(2, 0) = -_tmp91 * std::exp(-_tmp100 * _tmp79 * _tmp86 - _tmp100 * _tmp95 * _tmp96 +
                                  _tmp101 * _tmp63 + _tmp63 * _tmp99);
  _res(3, 0) =
      _tmp90 * std::exp(-_tmp101 - _tmp102 * _tmp76 * _tmp86 - _tmp102 * _tmp94 * _tmp96 - _tmp99);
