...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl4(
  ...
  const Scalar _tmp53 = -_tmp29 * _tmp52 + _tmp51;
  const Scalar _tmp54 = _tmp41 * _tmp52 - _tmp43 * _tmp51;
  ...
  const Scalar _tmp58 = _tmp45 * _tmp53 - _tmp50 - _tmp57 * (_tmp43 * _tmp50 + _tmp45 * _tmp54);
  const Scalar _tmp59 = _tmp18 + _tmp25;
  ...
  const Scalar _tmp68 = _tmp40 * _tmp65 - _tmp42 * _tmp67 - _tmp59 * _tmp64 + _tmp61 * _tmp65;
  const Scalar _tmp69 = _tmp50 * _tmp65;
  const Scalar _tmp70 = _tmp46 + _tmp49;
  const Scalar _tmp71 = -_tmp53 * _tmp67 -
                        _tmp57 * (-_tmp43 * _tmp69 - _tmp54 * _tmp67 + _tmp64 * _tmp70) -
                        _tmp65 * _tmp70 + _tmp69;
  ...
  const Scalar _tmp76 = _tmp58 + _tmp75 * (-_tmp40 + _tmp42 * _tmp45 - _tmp58 * _tmp73);
  ...
  const Scalar _tmp81 = _tmp19 + _tmp33;
  const Scalar _tmp82 = _tmp81 - p_a(0, 0) + p_init0;
  const Scalar _tmp83 = _tmp30 + _tmp5;
  ...
  const Scalar _tmp89 = -_tmp53 * _tmp88 + _tmp54 * _tmp57 * _tmp88;
  const Scalar _tmp90 = _tmp75 * (-_tmp42 * _tmp88 - _tmp73 * _tmp89) + _tmp89;
  ...
  const Scalar _tmp97 = _tmp55 * _tmp57 + _tmp56;
  const Scalar _tmp98 = 0;
  const Scalar _tmp99 = _tmp72 * _tmp98;
  const Scalar _tmp100 = _tmp78 * _tmp98;
  const Scalar _tmp101 = _tmp39 * (-_tmp100 * _tmp80 + _tmp65 * _tmp99);
  ...
  _res(1, 0) =
      -_tmp101 * std::exp(_tmp101 * _tmp96 +
                          ...
                          _tmp39 * _tmp93 * (_tmp77 * _tmp90 + _tmp80 * _tmp91) +
                          _tmp39 * _tmp95 * (-_tmp29 * _tmp67 * _tmp94 + _tmp65 * _tmp94));
  _res(2, 0) = -_tmp103 * std::exp(_tmp102 * _tmp67 + _tmp103 * _tmp96 - _tmp44 * _tmp79 * _tmp87 -
                                   _tmp44 * _tmp91 * _tmp93);
  _res(3, 0) = _tmp99 * std::exp(-_tmp102 - _tmp72 * _tmp76 * _tmp87 - _tmp72 * _tmp90 * _tmp93 -
                                 _tmp96 * _tmp99);
