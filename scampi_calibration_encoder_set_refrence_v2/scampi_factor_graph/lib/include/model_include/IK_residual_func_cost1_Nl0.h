...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl0(
  ...
  const Scalar _tmp63 = _tmp41 * _tmp51 - _tmp52 * _tmp62;
  const Scalar _tmp64 = Scalar(1.0) / (-_tmp51 + _tmp52 * _tmp61);
  ...
  const Scalar _tmp70 = _tmp69 * (-_tmp54 * _tmp59 * _tmp68 + _tmp56 * _tmp57 * _tmp68);
  const Scalar _tmp71 = -_tmp43 * _tmp51 + _tmp47 * _tmp52 + _tmp52 * _tmp70;
  const Scalar _tmp72 = -_tmp41 * _tmp52 + _tmp52 * _tmp53;
  const Scalar _tmp73 = Scalar(1.0) * _tmp54;
  const Scalar _tmp74 = -_tmp73;
  const Scalar _tmp75 = Scalar(1.0) / (_tmp47 + _tmp74);
  ...
  const Scalar _tmp80 = _tmp34 + _tmp38;
  const Scalar _tmp81 = _tmp23 + _tmp46;
  const Scalar _tmp82 = _tmp81 + p_init1;
  const Scalar _tmp83 = _tmp82 - p_d(1, 0);
  const Scalar _tmp84 = _tmp19 + _tmp9;
  ...
  const Scalar _tmp92 = -_tmp62 * _tmp88 - _tmp63 * _tmp91 + _tmp80 * _tmp89;
  const Scalar _tmp93 = _tmp53 * _tmp88 - _tmp72 * _tmp91 - _tmp78 * _tmp92 - _tmp80 * _tmp88;
  const Scalar _tmp94 = Scalar(1.0) / (_tmp93);
  const Scalar _tmp95 = _tmp70 * _tmp88 - _tmp71 * _tmp91 + _tmp81 * _tmp88 - _tmp84 * _tmp89;
  const Scalar _tmp96 = _tmp94 * _tmp95;
  const Scalar _tmp97 = Scalar(1.0) / (_tmp95);
  const Scalar _tmp98 = _tmp93 * _tmp97;
  const Scalar _tmp99 = _tmp98 * (-_tmp65 * _tmp71 - _tmp79 * _tmp96);
  const Scalar _tmp100 = _tmp79 + _tmp99;
  const Scalar _tmp101 = _tmp92 * _tmp94;
  const Scalar _tmp102 = _tmp74 + _tmp81;
  const Scalar _tmp103 = _tmp102 * _tmp78;
  const Scalar _tmp104 = Scalar(1.0) / (-_tmp103 + _tmp76 - _tmp84);
  ...
  const Scalar _tmp109 = _tmp21 - p_a(0, 0);
  const Scalar _tmp110 = _tmp32 - p_a(1, 0);
  ...
  const Scalar _tmp123 = -_tmp101 * _tmp122 - _tmp102 * _tmp121 + _tmp74;
  const Scalar _tmp124 = _tmp61 * _tmp64;
  const Scalar _tmp125 = _tmp124 * _tmp63 + _tmp62;
  const Scalar _tmp126 = _tmp124 * _tmp72 - _tmp125 * _tmp78 - _tmp53;
  const Scalar _tmp127 = _tmp98 * (_tmp124 * _tmp71 - _tmp126 * _tmp96 - _tmp70);
  ...
  const Scalar _tmp132 = _tmp117 * _tmp131 + Scalar(3.29616) * _tmp17 + _tmp20 * fv1;
  const Scalar _tmp133 = _tmp102 * _tmp75;
  const Scalar _tmp134 = -_tmp112 * _tmp131 - Scalar(3.29616) * _tmp28 - _tmp31 * fv1;
  const Scalar _tmp135 = _tmp103 * _tmp108 + Scalar(1.0);
  const Scalar _tmp136 = _tmp90 * _tmp94;
  const Scalar _tmp137 = -_tmp100 * _tmp136 + Scalar(1.0);
  const Scalar _tmp138 = _tmp52 * _tmp64;
  const Scalar _tmp139 = _tmp88 * _tmp94;
  const Scalar _tmp140 = _tmp122 * _tmp94;
  const Scalar _tmp141 = -_tmp128 * _tmp136 - _tmp61;
  const Scalar _tmp142 = _tmp65 * _tmp90 * _tmp97;
  const Scalar _tmp143 = -_tmp113 * _tmp69 * (_tmp100 * _tmp139 + _tmp137 * _tmp138) -
                         _tmp118 * _tmp69 * (_tmp115 * _tmp88 - _tmp142 * _tmp52) -
                         _tmp119 * _tmp69 * (-_tmp140 * _tmp52 * _tmp91 + _tmp140 * _tmp88) -
                         _tmp130 * _tmp69 * (_tmp128 * _tmp139 + _tmp138 * _tmp141 + Scalar(1.0));
  ...
  const Scalar _tmp145 = std::asinh(
      _tmp144 * (Scalar(1.0) * _tmp113 * (-_tmp106 * _tmp107 + _tmp108 * _tmp99) +
                 ...
                 Scalar(1.0) * _tmp119 * (-_tmp107 * _tmp123 - _tmp108 * _tmp120 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp130 * (-_tmp107 * _tmp129 + _tmp108 * _tmp127) +
                 Scalar(1.0) * _tmp132 * (_tmp108 * _tmp133 - _tmp108) +
                 Scalar(1.0) * _tmp134 * (-_tmp107 * _tmp135 + _tmp108 * _tmp78)));
  const Scalar _tmp146 = Scalar(9.6622558468725703) * _tmp143;
  const Scalar _tmp147 = Scalar(0.1034955) * _tmp144;
  const Scalar _tmp148 = _tmp119 * _tmp140;
  const Scalar _tmp149 = _tmp113 * _tmp137 * _tmp64 - _tmp118 * _tmp142 +
                         _tmp130 * _tmp141 * _tmp64 - _tmp148 * _tmp91;
  const Scalar _tmp150 = Scalar(1.0) / (_tmp149);
  const Scalar _tmp151 = _tmp108 * _tmp132;
  const Scalar _tmp152 = _tmp134 * _tmp75;
  const Scalar _tmp153 =
      std::asinh(_tmp150 * (_tmp106 * _tmp113 * _tmp75 + _tmp116 * _tmp118 * _tmp75 +
                            _tmp119 * _tmp123 * _tmp75 + _tmp129 * _tmp130 * _tmp75 -
                            _tmp133 * _tmp151 + _tmp135 * _tmp152));
  const Scalar _tmp154 = Scalar(0.1034955) * _tmp150;
  const Scalar _tmp155 = Scalar(9.6622558468725703) * _tmp149;
  const Scalar _tmp156 =
      _tmp100 * _tmp113 * _tmp94 + _tmp115 * _tmp118 + _tmp128 * _tmp130 * _tmp94 + _tmp148;
  const Scalar _tmp157 = Scalar(1.0) / (_tmp156);
  const Scalar _tmp158 = std::asinh(
      _tmp157 * (-_tmp104 * _tmp113 * _tmp99 - _tmp104 * _tmp127 * _tmp130 -
                 _tmp108 * _tmp152 * _tmp77 - _tmp114 * _tmp118 + _tmp119 * _tmp121 + _tmp151));
  ...
  _res(1, 0) =
      -_tmp146 *
          (_tmp147 * p_b(2, 0) + std::cosh(Scalar(1.0) * _tmp145) -
           std::cosh(_tmp147 *
                     (-_tmp145 * _tmp146 -
                      std::sqrt(Scalar(std::pow(Scalar(-_tmp55 + p_b(1, 0)), Scalar(2)) +
  ...
  _res(3, 0) =
      -_tmp159 *
          (_tmp160 * p_d(2, 0) + std::cosh(Scalar(1.0) * _tmp158) -
           std::cosh(_tmp160 *
                     (-_tmp158 * _tmp159 -
                      std::sqrt(Scalar(std::pow(Scalar(-_tmp82 + p_d(1, 0)), Scalar(2)) +
