...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1WrtFv1Nl19(
  ...
  const Scalar _tmp56 = _tmp22 + _tmp29 + _tmp41;
  const Scalar _tmp57 = _tmp56 + p_init1;
  const Scalar _tmp58 = _tmp57 - p_a(1, 0);
  const Scalar _tmp59 = _tmp18 + _tmp46;
  ...
  const Scalar _tmp64 = _tmp45 * _tmp51;
  const Scalar _tmp65 = _tmp47 + _tmp9;
  const Scalar _tmp66 = _tmp65 + p_init0;
  const Scalar _tmp67 = _tmp66 - p_c(0, 0);
  const Scalar _tmp68 = _tmp21 + _tmp30;
  ...
  const Scalar _tmp74 = _tmp35 + _tmp54;
  ...
  const Scalar _tmp78 = _tmp52 * _tmp63 - _tmp64;
  const Scalar _tmp79 = _tmp77 * _tmp78;
  const Scalar _tmp80 = -_tmp53 * _tmp63 + _tmp55 * _tmp64 - _tmp76 * _tmp79;
  ...
  const Scalar _tmp85 = _tmp83 * (-_tmp65 + _tmp84);
  const Scalar _tmp86 = -_tmp72 * _tmp74 + _tmp73;
  const Scalar _tmp87 = -_tmp52 * _tmp55 + _tmp53 - _tmp79 * _tmp86 - _tmp80 * _tmp85;
  ...
  const Scalar _tmp94 = _tmp93 * (_tmp52 * _tmp90 - _tmp72 * _tmp91);
  const Scalar _tmp95 = Scalar(1.0) / (_tmp92);
  const Scalar _tmp96 = _tmp93 * (-_tmp56 * _tmp61 * _tmp95 + _tmp58 * _tmp59 * _tmp95);
  const Scalar _tmp97 = -_tmp65 * _tmp75 + _tmp68 * _tmp72 + _tmp72 * _tmp96;
  const Scalar _tmp98 = _tmp43 * _tmp52 - _tmp48 * _tmp64 + _tmp52 * _tmp96 - _tmp79 * _tmp97;
  const Scalar _tmp99 = Scalar(1.0) / (_tmp98);
  const Scalar _tmp100 = Scalar(1.0) * _tmp99;
  const Scalar _tmp101 = Scalar(1.0) * _tmp77;
  const Scalar _tmp102 = _tmp101 * _tmp78 * _tmp99;
  const Scalar _tmp103 = _tmp32 - p_d(1, 0);
  const Scalar _tmp104 = _tmp20 - p_d(0, 0);
  ...
  const Scalar _tmp108 = fh1 * (-_tmp106 * _tmp31 + _tmp107 * _tmp19);
  const Scalar _tmp109 = _tmp101 * _tmp76;
  const Scalar _tmp110 = -_tmp101 * _tmp86 + _tmp109 * _tmp85;
  const Scalar _tmp111 = _tmp88 * _tmp98;
  const Scalar _tmp112 = _tmp87 * _tmp99;
  const Scalar _tmp113 = _tmp112 * (-_tmp101 * _tmp97 - _tmp110 * _tmp111);
  ...
  const Scalar _tmp119 = _tmp118 * _tmp76 + _tmp40 * _tmp63;
  ...
  const Scalar _tmp123 = -_tmp122 * _tmp78 - _tmp63;
  const Scalar _tmp124 = _tmp106 * fh1;
  const Scalar _tmp125 = -_tmp108 * _tmp93 * (_tmp100 * _tmp52 - _tmp102 * _tmp72) -
                         _tmp117 * _tmp93 * (_tmp114 * _tmp52 + _tmp115 * _tmp116) -
                         _tmp124 * _tmp93 * (_tmp116 * _tmp123 + _tmp122 * _tmp52 + Scalar(1.0)) -
                         _tmp34 * _tmp94;
  const Scalar _tmp126 = Scalar(1.0) / (_tmp125);
  const Scalar _tmp127 = _tmp43 + _tmp82;
  ...
  const Scalar _tmp132 = -_tmp109 + _tmp113 * _tmp131 - _tmp114 * _tmp80;
  const Scalar _tmp133 = Scalar(1.0) * _tmp83;
  const Scalar _tmp134 = _tmp129 * _tmp89;
  const Scalar _tmp135 = _tmp83 * (-_tmp127 * _tmp134 - _tmp80 * _tmp90 + _tmp82);
  const Scalar _tmp136 = -Scalar(1.0) * _tmp130 * _tmp89 - Scalar(1.0) * _tmp135 + Scalar(1.0);
  const Scalar _tmp137 = fh1 * (_tmp35 + _tmp39);
  const Scalar _tmp138 = _tmp106 * _tmp137 + Scalar(3.29616) * _tmp13 + _tmp19 * fv1;
  ...
  const Scalar _tmp142 = -_tmp100 * _tmp80 + _tmp127 * _tmp141;
  const Scalar _tmp143 = _tmp119 + _tmp121 * _tmp131 - _tmp122 * _tmp80;
  const Scalar _tmp144 = -_tmp107 * _tmp137 - Scalar(3.29616) * _tmp27 - _tmp31 * fv1;
  const Scalar _tmp145 = _tmp130 * _tmp85;
  const Scalar _tmp146 = _tmp83 * (_tmp128 * _tmp130 + Scalar(1.0));
  const Scalar _tmp147 = Scalar(1.0) * _tmp145 - Scalar(1.0) * _tmp146;
  const Scalar _tmp148 = Scalar(1.0) * _tmp108 * (-_tmp133 * _tmp142 + _tmp141) +
                         Scalar(1.0) * _tmp117 * (_tmp113 * _tmp130 - _tmp132 * _tmp133) +
                         Scalar(1.0) * _tmp124 * (_tmp121 * _tmp130 - _tmp133 * _tmp143) +
                         _tmp136 * _tmp34 + _tmp138 * _tmp140 + _tmp144 * _tmp147;
  const Scalar _tmp149 = std::asinh(_tmp126 * _tmp148);
  const Scalar _tmp150 = Scalar(1.0) * _tmp149;
  const Scalar _tmp151 = _tmp28 + _tmp42;
  const Scalar _tmp152 = std::pow(_tmp125, Scalar(-2));
  const Scalar _tmp153 = _tmp152 * _tmp94;
  const Scalar _tmp154 =
      (_tmp126 * (-_tmp136 + _tmp140 * _tmp19 + _tmp147 * _tmp151) - _tmp148 * _tmp153) /
  ...
  const Scalar _tmp157 =
      -_tmp149 * _tmp156 - std::sqrt(Scalar(std::pow(Scalar(-_tmp57 + p_a(1, 0)), Scalar(2)) +
                                            std::pow(Scalar(-_tmp60 + p_a(0, 0)), Scalar(2))));
  const Scalar _tmp158 = Scalar(0.1034955) * _tmp126;
  const Scalar _tmp159 = _tmp157 * _tmp158;
  const Scalar _tmp160 = Scalar(9.6622558468725703) * _tmp94;
  const Scalar _tmp161 = _tmp130 * _tmp138;
  const Scalar _tmp162 = _tmp83 * fh1;
  const Scalar _tmp163 = _tmp106 * _tmp143 * _tmp162 + _tmp107 * _tmp132 * _tmp162 +
                         _tmp108 * _tmp142 * _tmp83 + _tmp135 * _tmp34 - _tmp139 * _tmp161 +
                         _tmp144 * _tmp146;
  const Scalar _tmp164 = _tmp34 * _tmp90;
  const Scalar _tmp165 = -_tmp102 * _tmp108 + _tmp115 * _tmp117 * _tmp77 +
                         _tmp123 * _tmp124 * _tmp77 - _tmp164 * _tmp79;
  ...
  const Scalar _tmp169 =
      -_tmp167 * _tmp168 - std::sqrt(Scalar(std::pow(Scalar(-_tmp66 + p_c(0, 0)), Scalar(2)) +
  ...
  const Scalar _tmp178 = _tmp130 * _tmp19;
  const Scalar _tmp179 =
      (-_tmp163 * _tmp176 + _tmp166 * (-_tmp135 - _tmp139 * _tmp178 + _tmp146 * _tmp151)) /
      std::sqrt(Scalar(std::pow(_tmp163, Scalar(2)) * _tmp175 + 1));
  const Scalar _tmp180 = _tmp100 * _tmp108 + _tmp114 * _tmp117 + _tmp122 * _tmp124 + _tmp164;
  const Scalar _tmp181 = Scalar(1.0) / (_tmp180);
  const Scalar _tmp182 = -_tmp108 * _tmp141 - _tmp113 * _tmp117 * _tmp129 -
                         _tmp121 * _tmp124 * _tmp129 + _tmp134 * _tmp34 - _tmp144 * _tmp145 +
                         _tmp161;
  ...
  const Scalar _tmp186 =
      -_tmp183 * _tmp185 - std::sqrt(Scalar(std::pow(Scalar(-_tmp44 + p_b(1, 0)), Scalar(2)) +
  ...
  const Scalar _tmp191 = (_tmp181 * (-_tmp134 - _tmp145 * _tmp151 + _tmp178) + _tmp182 * _tmp190) /
  ...
  _res(1, 0) =
      -_tmp156 * (Scalar(1.0) * _tmp154 * std::sinh(_tmp150) - _tmp155 * p_a(2, 0) -
                  (-_tmp155 * _tmp157 + _tmp158 * (-_tmp149 * _tmp160 - _tmp154 * _tmp156)) *
                      std::sinh(_tmp159)) -
      _tmp160 * (_tmp158 * p_a(2, 0) + std::cosh(_tmp150) - std::cosh(_tmp159));
  _res(2, 0) =
      -_tmp168 * (-_tmp177 * p_c(2, 0) + Scalar(1.0) * _tmp179 * std::sinh(_tmp172) -
                  (-_tmp169 * _tmp177 + _tmp170 * (-_tmp167 * _tmp174 - _tmp168 * _tmp179)) *
                      std::sinh(_tmp171)) -
      _tmp174 * (_tmp170 * p_c(2, 0) - std::cosh(_tmp171) + std::cosh(_tmp172));
  _res(3, 0) = _tmp173 * (_tmp187 * p_b(2, 0) + std::cosh(_tmp184) - std::cosh(_tmp188)) -
               _tmp185 * (Scalar(1.0) * _tmp191 * std::sinh(_tmp184) + _tmp192 * p_b(2, 0) -
                          (_tmp186 * _tmp192 + _tmp187 * (_tmp173 * _tmp183 - _tmp185 * _tmp191)) *
                              std::sinh(_tmp188));
