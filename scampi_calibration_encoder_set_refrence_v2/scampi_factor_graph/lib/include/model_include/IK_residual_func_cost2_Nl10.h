...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl10(
  ...
  const Scalar _tmp46 = std::pow(Scalar(-_tmp41 + p_d(0, 0)), Scalar(2)) +
                        std::pow(Scalar(-_tmp45 + p_d(1, 0)), Scalar(2));
  const Scalar _tmp47 = _tmp45 - p_d(1, 0);
  const Scalar _tmp48 = _tmp41 - p_d(0, 0);
  ...
  const Scalar _tmp60 = _tmp50 * _tmp59 - _tmp58;
  ...
  const Scalar _tmp65 = _tmp62 + _tmp8;
  const Scalar _tmp66 = _tmp24 + _tmp38;
  const Scalar _tmp67 = _tmp66 + p_init0;
  const Scalar _tmp68 = _tmp67 - p_a(0, 0);
  const Scalar _tmp69 = _tmp31 + _tmp42;
  ...
  const Scalar _tmp75 = _tmp50 * _tmp63;
  const Scalar _tmp76 = _tmp65 * _tmp73 - _tmp74 * _tmp75;
  const Scalar _tmp77 = Scalar(1.0) / (_tmp50 * _tmp74 - _tmp73);
  const Scalar _tmp78 = _tmp60 * _tmp77;
  const Scalar _tmp79 = -_tmp50 * _tmp64 + _tmp58 * _tmp61 - _tmp76 * _tmp78;
  ...
  const Scalar _tmp85 = _tmp63 * _tmp74 - _tmp65 * _tmp74;
  const Scalar _tmp86 = -_tmp59 * _tmp61 + _tmp64 - _tmp78 * _tmp85 - _tmp79 * _tmp84;
  ...
  const Scalar _tmp90 = _tmp49 * _tmp88;
  const Scalar _tmp91 = _tmp90 * (_tmp40 * _tmp47 * _tmp89 - _tmp44 * _tmp48 * _tmp89);
  const Scalar _tmp92 = -_tmp66 * _tmp73 + _tmp69 * _tmp74 + _tmp74 * _tmp91;
  const Scalar _tmp93 = _tmp50 * _tmp77;
  const Scalar _tmp94 = _tmp75 + _tmp76 * _tmp93;
  const Scalar _tmp95 = -_tmp63 - _tmp84 * _tmp94 + _tmp85 * _tmp93;
  const Scalar _tmp96 = -_tmp51 * _tmp58 + _tmp54 * _tmp59 + _tmp59 * _tmp91 - _tmp78 * _tmp92;
  ...
  const Scalar _tmp102 = -_tmp101 * _tmp60 - _tmp50;
  const Scalar _tmp103 = _tmp74 * _tmp77;
  const Scalar _tmp104 = _tmp33 - p_b(1, 0);
  const Scalar _tmp105 = _tmp26 - p_b(0, 0);
  ...
  const Scalar _tmp114 = -_tmp113 * _tmp60 + Scalar(1.0);
  const Scalar _tmp115 = _tmp104 * _tmp106;
  const Scalar _tmp116 = _tmp115 * fh1;
  const Scalar _tmp117 = Scalar(1.0) * _tmp98;
  const Scalar _tmp118 = _tmp109 * _tmp60 * _tmp98;
  const Scalar _tmp119 = fh1 * (-_tmp107 * _tmp32 + _tmp115 * _tmp25);
  const Scalar _tmp120 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp121 = _tmp80 * _tmp84 + _tmp83;
  const Scalar _tmp122 = 0;
  const Scalar _tmp123 = -_tmp108 * _tmp90 * (_tmp101 * _tmp59 + _tmp102 * _tmp103 + Scalar(1.0)) -
                         _tmp116 * _tmp90 * (_tmp103 * _tmp114 + _tmp113 * _tmp59) -
                         _tmp119 * _tmp90 * (_tmp117 * _tmp59 - _tmp118 * _tmp74) -
                         _tmp120 * _tmp90 * (_tmp122 * _tmp59 - _tmp122 * _tmp74 * _tmp78);
  const Scalar _tmp124 = Scalar(1.0) / (_tmp123);
  const Scalar _tmp125 = _tmp54 + _tmp81;
  ...
  const Scalar _tmp130 = -_tmp122 * _tmp79 - _tmp125 * _tmp129 + _tmp81;
  const Scalar _tmp131 = Scalar(1.0) * _tmp82;
  const Scalar _tmp132 = _tmp16 * fh1;
  const Scalar _tmp133 = _tmp107 * _tmp132 + Scalar(3.29616) * _tmp19 + _tmp25 * fv1;
  const Scalar _tmp134 = _tmp125 * _tmp82;
  const Scalar _tmp135 = _tmp128 * _tmp99;
  const Scalar _tmp136 = -_tmp117 * _tmp79 + _tmp125 * _tmp135;
  const Scalar _tmp137 = _tmp128 * _tmp84;
  const Scalar _tmp138 = _tmp126 * _tmp128 + Scalar(1.0);
  const Scalar _tmp139 = -_tmp115 * _tmp132 - Scalar(3.29616) * _tmp29 - _tmp32 * fv1;
  const Scalar _tmp140 = _tmp125 * _tmp127;
  const Scalar _tmp141 = -_tmp110 + _tmp112 * _tmp140 - _tmp113 * _tmp79;
  const Scalar _tmp142 = _tmp100 * _tmp140 - _tmp101 * _tmp79 + _tmp94;
  const Scalar _tmp143 = std::asinh(
      _tmp124 * (Scalar(1.0) * _tmp108 * (_tmp100 * _tmp128 - _tmp131 * _tmp142) +
                 Scalar(1.0) * _tmp116 * (_tmp112 * _tmp128 - _tmp131 * _tmp141) +
                 Scalar(1.0) * _tmp119 * (-_tmp131 * _tmp136 + _tmp135) +
                 Scalar(1.0) * _tmp120 * (-_tmp121 * _tmp128 - _tmp130 * _tmp131 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp133 * (_tmp128 * _tmp134 - _tmp128) +
                 Scalar(1.0) * _tmp139 * (-_tmp131 * _tmp138 + _tmp137)));
  ...
  const Scalar _tmp149 =
      std::asinh(_tmp148 * (_tmp108 * _tmp142 * _tmp82 + _tmp116 * _tmp141 * _tmp82 +
                            _tmp119 * _tmp136 * _tmp82 + _tmp120 * _tmp130 * _tmp82 -
                            _tmp134 * _tmp145 + _tmp138 * _tmp139 * _tmp82));
  const Scalar _tmp150 = Scalar(9.6622558468725703) * _tmp147;
  const Scalar _tmp151 = std::pow(Scalar(-_tmp67 + p_a(0, 0)), Scalar(2)) +
                         std::pow(Scalar(-_tmp70 + p_a(1, 0)), Scalar(2));
  const Scalar _tmp152 = std::pow(Scalar(-_tmp52 + p_c(0, 0)), Scalar(2)) +
                         std::pow(Scalar(-_tmp55 + p_c(1, 0)), Scalar(2));
  const Scalar _tmp153 = _tmp101 * _tmp108 + _tmp113 * _tmp116 + _tmp117 * _tmp119 + _tmp146;
  const Scalar _tmp154 = Scalar(1.0) / (_tmp153);
  const Scalar _tmp155 =
      std::asinh(_tmp154 * (-_tmp100 * _tmp108 * _tmp127 - _tmp112 * _tmp116 * _tmp127 -
                            _tmp119 * _tmp135 + _tmp120 * _tmp129 - _tmp137 * _tmp139 + _tmp145));
  ...
  _res(1, 0) =
      ...
      std::sqrt(Scalar(_tmp46 + std::pow(Scalar(-_tmp63 + p_d(2, 0) - p_init2), Scalar(2))));
  _res(2, 0) =
      _tmp150 *
          (-std::sinh(Scalar(1.0) * _tmp149) -
           std::sinh(Scalar(0.1034955) * _tmp148 * (-_tmp149 * _tmp150 - std::sqrt(_tmp151)))) -
      std::sqrt(Scalar(_tmp151 + std::pow(Scalar(-_tmp65 + p_a(2, 0) - p_init2), Scalar(2))));
  _res(3, 0) =
      _tmp156 *
          (-std::sinh(Scalar(1.0) * _tmp155) -
           std::sinh(Scalar(0.1034955) * _tmp154 * (-std::sqrt(_tmp152) - _tmp155 * _tmp156))) -
      std::sqrt(Scalar(_tmp152 + std::pow(Scalar(-_tmp61 + p_c(2, 0) - p_init2), Scalar(2))));
