...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl7(
  ...
  const Scalar _tmp60 = _tmp31 - p_b(1, 0);
  const Scalar _tmp61 = _tmp20 - p_b(0, 0);
  ...
  const Scalar _tmp65 = -Scalar(3.29616) * _tmp26 - _tmp30 * fv1 - _tmp63 * _tmp64;
  const Scalar _tmp66 = _tmp48 * _tmp50;
  const Scalar _tmp67 = _tmp61 * _tmp62;
  const Scalar _tmp68 = Scalar(3.29616) * _tmp13 + _tmp19 * fv1 + _tmp64 * _tmp67;
  ...
  const Scalar _tmp79 = _tmp36 + _tmp69;
  ...
  const Scalar _tmp102 = _tmp33 + _tmp70;
  ...
  const Scalar _tmp131 = fh1 * (_tmp19 * _tmp63 - _tmp30 * _tmp67);
  ...
  const Scalar _tmp150 = _tmp120 * _tmp144 * _tmp88 + _tmp127 * _tmp139 * _tmp88 -
                         _tmp131 * _tmp137 - _tmp132 * _tmp142 * _tmp88;
  const Scalar _tmp151 = Scalar(1.0) / (_tmp150);
  const Scalar _tmp152 = _tmp56 * _tmp68;
  const Scalar _tmp153 =
      std::asinh(_tmp151 * (_tmp119 * _tmp120 * _tmp50 + _tmp126 * _tmp127 * _tmp50 +
                            _tmp130 * _tmp131 * _tmp50 + _tmp132 * _tmp136 * _tmp50 -
                            _tmp152 * _tmp66 + _tmp50 * _tmp57 * _tmp65));
  ...
  const Scalar _tmp158 =
      std::asinh(_tmp157 * (-_tmp115 * _tmp120 * _tmp55 - _tmp124 * _tmp127 * _tmp55 -
                            _tmp128 * _tmp131 + _tmp132 * _tmp135 + _tmp152 - _tmp59 * _tmp65));
