...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl23(
  ...
  const Scalar _tmp52 = _tmp29 * _tmp50 - _tmp41 * _tmp48;
  const Scalar _tmp53 = Scalar(1.0) * _tmp33;
  const Scalar _tmp54 = Scalar(1.0) * _tmp31;
  const Scalar _tmp55 = (-_tmp25 + _tmp54) / (_tmp16 - _tmp53);
  ...
  const Scalar _tmp70 = -_tmp51 * _tmp69 -
                        _tmp55 * (-_tmp41 * _tmp67 - _tmp52 * _tmp69 + _tmp57 * _tmp65) -
                        _tmp57 * _tmp66 + _tmp67;
  const Scalar _tmp71 = Scalar(1.0) / (_tmp70);
  const Scalar _tmp72 = _tmp39 * _tmp66 - _tmp40 * _tmp69 - _tmp59 * _tmp65 + _tmp62 * _tmp66;
  ...
  const Scalar _tmp81 = _tmp4 + _tmp61;
  const Scalar _tmp82 = _tmp81 - p_d(1, 0) + p_init1;
  const Scalar _tmp83 = _tmp30 + _tmp58;
  const Scalar _tmp84 = _tmp83 - p_d(0, 0) + p_init0;
  ...
  const Scalar _tmp94 = _tmp84 * _tmp85;
  const Scalar _tmp95 = fh1 * (-_tmp81 * _tmp94 + _tmp83 * _tmp86);
  const Scalar _tmp96 = _tmp41 * _tmp42;
  const Scalar _tmp97 = -_tmp47 + _tmp51 * _tmp96 - _tmp55 * (_tmp41 * _tmp47 + _tmp52 * _tmp96);
  const Scalar _tmp98 = _tmp75 * (-_tmp39 + _tmp40 * _tmp96 - _tmp73 * _tmp97) + _tmp97;
  const Scalar _tmp99 = -_tmp41 - _tmp77 * _tmp98;
  ...
  _res(1, 0) = std::exp(_tmp100 * _tmp38 * (_tmp79 * _tmp99 + _tmp80 * _tmp98 + Scalar(1.0)) +
                        _tmp38 * _tmp87 * (_tmp76 * _tmp80 + _tmp78 * _tmp79) +
                        _tmp38 * _tmp88 * (_tmp66 * _tmp92 - _tmp79 * _tmp91) +
                        _tmp38 * _tmp95 * (-_tmp28 * _tmp69 * _tmp93 + _tmp66 * _tmp93));
  _res(2, 0) = std::exp(-_tmp100 * _tmp42 * _tmp99 + _tmp101 * _tmp69 - _tmp42 * _tmp78 * _tmp87 +
                        _tmp42 * _tmp88 * _tmp91);
  _res(3, 0) =
      std::exp(-_tmp100 * _tmp71 * _tmp98 - _tmp101 - _tmp71 * _tmp76 * _tmp87 - _tmp88 * _tmp92);
