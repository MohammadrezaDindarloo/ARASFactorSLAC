...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl13(
  ...
  const Scalar _tmp36 = _tmp35 - p_d(1, 0) + p_init1;
  const Scalar _tmp37 = _tmp23 + _tmp24;
  const Scalar _tmp38 = _tmp20 + _tmp37;
  const Scalar _tmp39 = _tmp38 - p_d(0, 0) + p_init0;
  ...
  const Scalar _tmp43 = _tmp33 * _tmp41 + _tmp35 * _tmp41 - _tmp38 * _tmp42;
  const Scalar _tmp44 = Scalar(1.0) / (_tmp29 * _tmp41 - _tmp42);
  ...
  const Scalar _tmp54 = -_tmp41 * _tmp53 + _tmp42 * _tmp50;
  ...
  const Scalar _tmp58 = -_tmp41 * _tmp50 + _tmp41 * _tmp52;
  const Scalar _tmp59 = _tmp45 * _tmp58 - _tmp52 - _tmp57 * (_tmp45 * _tmp54 + _tmp53);
  const Scalar _tmp60 = _tmp15 + _tmp7;
  const Scalar _tmp61 = _tmp60 - p_b(1, 0) + p_init1;
  const Scalar _tmp62 = _tmp19 + _tmp25;
  ...
  const Scalar _tmp67 = _tmp29 * _tmp65 - _tmp66;
  const Scalar _tmp68 = _tmp44 * _tmp67;
  const Scalar _tmp69 = _tmp47 + _tmp51;
  const Scalar _tmp70 = _tmp52 * _tmp65 -
                        _tmp57 * (-_tmp53 * _tmp65 - _tmp54 * _tmp68 + _tmp66 * _tmp69) -
                        _tmp58 * _tmp68 - _tmp65 * _tmp69;
  const Scalar _tmp71 = Scalar(1.0) / (_tmp70);
  const Scalar _tmp72 = _tmp33 * _tmp65 - _tmp43 * _tmp68 + _tmp60 * _tmp65 - _tmp62 * _tmp66;
  const Scalar _tmp73 = _tmp71 * _tmp72;
  const Scalar _tmp74 = Scalar(1.0) / (_tmp72);
  const Scalar _tmp75 = _tmp70 * _tmp74;
  const Scalar _tmp76 = _tmp59 + _tmp75 * (-_tmp33 + _tmp43 * _tmp45 - _tmp59 * _tmp73);
  const Scalar _tmp77 = _tmp67 * _tmp71;
  const Scalar _tmp78 = -_tmp29 - _tmp76 * _tmp77;
  const Scalar _tmp79 = _tmp41 * _tmp44;
  const Scalar _tmp80 = _tmp71 * _tmp76;
  const Scalar _tmp81 = _tmp19 + _tmp37;
  const Scalar _tmp82 = _tmp81 - p_c(0, 0) + p_init0;
  const Scalar _tmp83 = _tmp34 + _tmp7;
  ...
  const Scalar _tmp87 = _tmp32 * _tmp86 * (_tmp65 * _tmp80 + _tmp78 * _tmp79 + Scalar(1.0));
  const Scalar _tmp88 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp89 = _tmp55 * _tmp57 + _tmp56;
  const Scalar _tmp90 = 0;
  const Scalar _tmp91 = _tmp77 * _tmp90;
  const Scalar _tmp92 = _tmp71 * _tmp90;
  const Scalar _tmp93 = _tmp84 * _tmp85;
  const Scalar _tmp94 = _tmp81 * _tmp93 - _tmp83 * _tmp86;
  const Scalar _tmp95 = Scalar(1.0) * _tmp74;
  const Scalar _tmp96 = _tmp32 * _tmp94 * (-_tmp41 * _tmp68 * _tmp95 + _tmp65 * _tmp95);
  const Scalar _tmp97 = Scalar(1.0) * _tmp44;
  const Scalar _tmp98 = _tmp54 * _tmp57 * _tmp97 - _tmp58 * _tmp97;
  const Scalar _tmp99 = _tmp75 * (-_tmp43 * _tmp97 - _tmp73 * _tmp98) + _tmp98;
  const Scalar _tmp100 = -_tmp77 * _tmp99 + Scalar(1.0);
  const Scalar _tmp101 = _tmp71 * _tmp99;
  const Scalar _tmp102 = _tmp32 * _tmp93 * (_tmp100 * _tmp79 + _tmp101 * _tmp65);
  const Scalar _tmp103 = _tmp94 * _tmp95;
  const Scalar _tmp104 = _tmp103 * fh1;
  const Scalar _tmp105 = _tmp100 * _tmp44 * _tmp93;
  const Scalar _tmp106 = _tmp44 * _tmp78 * _tmp86;
  ...
  _res(1, 0) = -(-_tmp102 - _tmp87 - _tmp96) *
               std::exp(_tmp102 * fh1 + _tmp32 * _tmp88 * (_tmp65 * _tmp92 - _tmp79 * _tmp91) +
                        _tmp87 * fh1 + _tmp96 * fh1);
  _res(2, 0) =
      -(-_tmp103 * _tmp68 + _tmp105 + _tmp106) *
      std::exp(_tmp104 * _tmp68 - _tmp105 * fh1 - _tmp106 * fh1 + _tmp44 * _tmp88 * _tmp91);
  _res(3, 0) = -(_tmp103 + _tmp107 + _tmp108) *
               std::exp(-_tmp104 - _tmp107 * fh1 - _tmp108 * fh1 - _tmp88 * _tmp92);
