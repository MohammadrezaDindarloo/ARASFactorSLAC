...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl2(
  ...
  const Scalar _tmp45 = _tmp17 * _tmp28;
  const Scalar _tmp46 = _tmp15 + _tmp6;
  const Scalar _tmp47 = _tmp46 - p_c(1, 0) + p_init1;
  ...
  const Scalar _tmp52 = _tmp29 * _tmp51 - _tmp45;
  const Scalar _tmp53 = _tmp37 * _tmp41;
  const Scalar _tmp54 = Scalar(1.0) / (_tmp42 * _tmp51 - _tmp53);
  const Scalar _tmp55 = _tmp52 * _tmp54;
  const Scalar _tmp56 = _tmp30 + _tmp31 - _tmp32;
  const Scalar _tmp57 = _tmp34 * _tmp51;
  const Scalar _tmp58 = -_tmp42 * _tmp57 + _tmp43 * _tmp53;
  ...
  const Scalar _tmp62 = _tmp29 * _tmp34 - _tmp29 * _tmp56 - _tmp44 * _tmp55 -
                        _tmp61 * (-_tmp29 * _tmp57 + _tmp45 * _tmp56 - _tmp55 * _tmp58);
  const Scalar _tmp63 = Scalar(1.0) / (_tmp62);
  const Scalar _tmp64 = _tmp44 * _tmp54;
  const Scalar _tmp65 = _tmp54 * _tmp58;
  const Scalar _tmp66 = Scalar(1.0) * _tmp61 * _tmp65 - Scalar(1.0) * _tmp64;
  const Scalar _tmp67 =
      std::sqrt(Scalar(std::pow(_tmp47, Scalar(2)) + std::pow(_tmp49, Scalar(2))));
  const Scalar _tmp68 = Scalar(1.0) / (_tmp67);
  const Scalar _tmp69 = _tmp50 * _tmp67;
  const Scalar _tmp70 = _tmp69 * (-_tmp46 * _tmp49 * _tmp68 + _tmp47 * _tmp48 * _tmp68);
  const Scalar _tmp71 = _tmp54 * (_tmp36 * _tmp42 - _tmp39 * _tmp53 + _tmp42 * _tmp70);
  const Scalar _tmp72 = _tmp16 * _tmp29 - _tmp26 * _tmp45 + _tmp29 * _tmp70 - _tmp52 * _tmp71;
  const Scalar _tmp73 = _tmp63 * _tmp72;
  const Scalar _tmp74 = Scalar(1.0) / (_tmp72);
  const Scalar _tmp75 = _tmp62 * _tmp74;
  const Scalar _tmp76 = _tmp66 + _tmp75 * (-_tmp66 * _tmp73 - Scalar(1.0) * _tmp71);
  const Scalar _tmp77 = _tmp63 * _tmp76;
  const Scalar _tmp78 = _tmp52 * _tmp63;
  const Scalar _tmp79 = -_tmp76 * _tmp78 + Scalar(1.0);
  const Scalar _tmp80 = _tmp42 * _tmp54;
  const Scalar _tmp81 = _tmp20 + _tmp38;
  const Scalar _tmp82 = _tmp81 - p_a(0, 0) + p_init0;
  const Scalar _tmp83 = _tmp35 + _tmp7;
  ...
  const Scalar _tmp87 = _tmp69 * _tmp86 * (_tmp29 * _tmp77 + _tmp79 * _tmp80);
  const Scalar _tmp88 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp89 = _tmp59 * _tmp61 + _tmp60;
  const Scalar _tmp90 = 0;
  const Scalar _tmp91 = _tmp42 * _tmp55;
  const Scalar _tmp92 = -_tmp34 + _tmp51 * _tmp64 - _tmp61 * (_tmp51 * _tmp65 + _tmp57);
  const Scalar _tmp93 = _tmp75 * (_tmp51 * _tmp71 - _tmp70 - _tmp73 * _tmp92) + _tmp92;
  const Scalar _tmp94 = _tmp63 * _tmp93;
  const Scalar _tmp95 = -_tmp51 - _tmp78 * _tmp93;
  const Scalar _tmp96 = _tmp82 * _tmp85;
  const Scalar _tmp97 = _tmp69 * _tmp96 * (_tmp29 * _tmp94 + _tmp80 * _tmp95 + Scalar(1.0));
  const Scalar _tmp98 = _tmp81 * _tmp86 - _tmp83 * _tmp96;
  const Scalar _tmp99 = Scalar(1.0) * _tmp74;
  const Scalar _tmp100 = _tmp69 * _tmp98 * (_tmp29 * _tmp99 - _tmp91 * _tmp99);
  const Scalar _tmp101 = _tmp88 * _tmp90;
  const Scalar _tmp102 = _tmp54 * _tmp79 * _tmp86;
  const Scalar _tmp103 = _tmp54 * _tmp95 * _tmp96;
  ...
  _res(1, 0) = -(-_tmp100 - _tmp87 - _tmp97) *
               std::exp(_tmp100 * fh1 + _tmp69 * _tmp88 * (_tmp29 * _tmp90 - _tmp90 * _tmp91) +
                        _tmp87 * fh1 + _tmp97 * fh1);
  _res(2, 0) = -(_tmp102 + _tmp103 - _tmp104 * _tmp55) *
               std::exp(_tmp101 * _tmp55 - _tmp102 * fh1 - _tmp103 * fh1 + _tmp105 * _tmp55);
  _res(3, 0) =
