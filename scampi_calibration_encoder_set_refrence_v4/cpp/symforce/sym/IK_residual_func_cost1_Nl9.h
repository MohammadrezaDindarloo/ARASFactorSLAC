...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl9(
  ...
  const Scalar _tmp42 = _tmp22 + _tmp29;
  ...
  const Scalar _tmp50 = _tmp47 * (_tmp41 - _tmp49);
  const Scalar _tmp51 = _tmp41 + _tmp43 * _tmp50;
  const Scalar _tmp52 = _tmp18 + _tmp48;
  const Scalar _tmp53 = _tmp23 + _tmp45;
  const Scalar _tmp54 = _tmp44 + _tmp53;
  const Scalar _tmp55 = _tmp50 * _tmp54;
  const Scalar _tmp56 = Scalar(1.0) / (_tmp41 - _tmp52 - _tmp55);
  const Scalar _tmp57 = Scalar(1.0) * _tmp56;
  const Scalar _tmp58 = 0;
  const Scalar _tmp59 = -_tmp33;
  const Scalar _tmp60 = _tmp36 + _tmp59;
  const Scalar _tmp61 = _tmp52 + p_init0;
  ...
  const Scalar _tmp84 = _tmp68 * _tmp74 - _tmp75 * _tmp83;
  const Scalar _tmp85 = Scalar(1.0) / (-_tmp74 + _tmp75 * _tmp82);
  const Scalar _tmp86 = _tmp62 * _tmp65;
  const Scalar _tmp87 = -_tmp66 + _tmp82 * _tmp86;
  const Scalar _tmp88 = _tmp85 * _tmp87;
  const Scalar _tmp89 = _tmp76 * _tmp86;
  const Scalar _tmp90 = _tmp60 * _tmp66 - _tmp82 * _tmp89 - _tmp84 * _tmp88;
  const Scalar _tmp91 = -_tmp68 * _tmp75 + _tmp75 * _tmp76;
  const Scalar _tmp92 = -_tmp50 * _tmp90 - _tmp60 * _tmp86 - _tmp88 * _tmp91 + _tmp89;
  const Scalar _tmp93 = Scalar(1.0) / (_tmp92);
  const Scalar _tmp94 = _tmp90 * _tmp93;
  const Scalar _tmp95 = _tmp51 * _tmp56;
  const Scalar _tmp96 = _tmp44 - _tmp54 * _tmp95 - _tmp58 * _tmp94;
  const Scalar _tmp97 = Scalar(1.0) * _tmp47;
  const Scalar _tmp98 = _tmp55 * _tmp57 + Scalar(1.0);
  const Scalar _tmp99 = _tmp50 * _tmp57;
  const Scalar _tmp100 = _tmp31 - p_b(1, 0);
  const Scalar _tmp101 = _tmp20 - p_b(0, 0);
  const Scalar _tmp102 =
      std::pow(Scalar(std::pow(_tmp100, Scalar(2)) + std::pow(_tmp101, Scalar(2))),
               Scalar(Scalar(-1) / Scalar(2)));
  const Scalar _tmp103 = _tmp100 * _tmp102;
  const Scalar _tmp104 = _tmp37 * fh1;
  const Scalar _tmp105 = -_tmp103 * _tmp104 - Scalar(5.1796800000000003) * _tmp27 - _tmp30 * fv1;
  const Scalar _tmp106 = _tmp47 * _tmp54;
  const Scalar _tmp107 = _tmp101 * _tmp102;
  const Scalar _tmp108 = _tmp104 * _tmp107 + Scalar(5.1796800000000003) * _tmp13 + _tmp19 * fv1;
  ...
  const Scalar _tmp111 = _tmp109 * _tmp81;
  const Scalar _tmp112 = _tmp111 * (_tmp110 * _tmp40 * _tmp78 - _tmp110 * _tmp42 * _tmp80);
  const Scalar _tmp113 = _tmp112 * _tmp75 + _tmp46 * _tmp75 - _tmp49 * _tmp74;
  const Scalar _tmp114 = _tmp112 * _tmp86 - _tmp113 * _tmp88 - _tmp52 * _tmp66 + _tmp53 * _tmp86;
  const Scalar _tmp115 = Scalar(1.0) / (_tmp114);
  const Scalar _tmp116 = Scalar(1.0) * _tmp115;
  const Scalar _tmp117 = _tmp115 * _tmp92;
  const Scalar _tmp118 = _tmp117 * _tmp57;
  const Scalar _tmp119 = -_tmp116 * _tmp90 + _tmp118 * _tmp54;
  const Scalar _tmp120 = fh1 * (_tmp103 * _tmp19 - _tmp107 * _tmp30);
  const Scalar _tmp121 = Scalar(1.0) * _tmp85;
  const Scalar _tmp122 = _tmp121 * _tmp84;
  const Scalar _tmp123 = -_tmp121 * _tmp91 + _tmp122 * _tmp50;
  const Scalar _tmp124 = _tmp114 * _tmp93;
  const Scalar _tmp125 = _tmp117 * (-_tmp113 * _tmp121 - _tmp123 * _tmp124);
  const Scalar _tmp126 = _tmp54 * _tmp56;
  const Scalar _tmp127 = _tmp123 + _tmp125;
  const Scalar _tmp128 = -_tmp122 + _tmp125 * _tmp126 - _tmp127 * _tmp94;
  const Scalar _tmp129 = _tmp103 * fh1;
  const Scalar _tmp130 = _tmp82 * _tmp85;
  const Scalar _tmp131 = _tmp130 * _tmp84 + _tmp83;
  const Scalar _tmp132 = _tmp130 * _tmp91 - _tmp131 * _tmp50 - _tmp76;
  const Scalar _tmp133 = _tmp117 * (-_tmp112 + _tmp113 * _tmp130 - _tmp124 * _tmp132);
  const Scalar _tmp134 = _tmp132 + _tmp133;
  const Scalar _tmp135 = _tmp126 * _tmp133 + _tmp131 - _tmp134 * _tmp94;
  const Scalar _tmp136 = _tmp107 * fh1;
  const Scalar _tmp137 = _tmp86 * _tmp93;
  const Scalar _tmp138 = _tmp87 * _tmp93;
  const Scalar _tmp139 = -_tmp134 * _tmp138 - _tmp82;
  const Scalar _tmp140 = _tmp75 * _tmp85;
  const Scalar _tmp141 = -_tmp127 * _tmp138 + Scalar(1.0);
  const Scalar _tmp142 = _tmp58 * _tmp93;
  const Scalar _tmp143 = _tmp138 * _tmp58;
  const Scalar _tmp144 = -_tmp111 * _tmp120 * (-_tmp116 * _tmp75 * _tmp88 + _tmp116 * _tmp86) -
                         _tmp111 * _tmp129 * (_tmp127 * _tmp137 + _tmp140 * _tmp141) -
                         _tmp111 * _tmp136 * (_tmp134 * _tmp137 + _tmp139 * _tmp140 + Scalar(1.0)) -
                         _tmp111 * _tmp38 * (-_tmp140 * _tmp143 + _tmp142 * _tmp86);
  const Scalar _tmp145 = Scalar(1.0) / (_tmp144);
  const Scalar _tmp146 = std::asinh(
      _tmp145 * (Scalar(1.0) * _tmp105 * (-_tmp97 * _tmp98 + _tmp99) +
                 Scalar(1.0) * _tmp108 * (_tmp106 * _tmp57 - _tmp57) +
                 Scalar(1.0) * _tmp120 * (_tmp118 - _tmp119 * _tmp97) +
                 Scalar(1.0) * _tmp129 * (_tmp125 * _tmp57 - _tmp128 * _tmp97) +
                 Scalar(1.0) * _tmp136 * (_tmp133 * _tmp57 - _tmp135 * _tmp97) +
                 Scalar(1.0) * _tmp38 * (-_tmp51 * _tmp57 - _tmp96 * _tmp97 + Scalar(1.0))));
  const Scalar _tmp147 = Scalar(0.1034955) * _tmp145;
  const Scalar _tmp148 = Scalar(9.6622558468725703) * _tmp144;
  const Scalar _tmp149 = _tmp108 * _tmp57;
  const Scalar _tmp150 = _tmp116 * _tmp120;
  const Scalar _tmp151 = _tmp129 * _tmp141 * _tmp85 + _tmp136 * _tmp139 * _tmp85 -
                         _tmp143 * _tmp38 * _tmp85 - _tmp150 * _tmp88;
  const Scalar _tmp152 = Scalar(1.0) / (_tmp151);
  const Scalar _tmp153 =
      std::asinh(_tmp152 * (_tmp105 * _tmp47 * _tmp98 - _tmp106 * _tmp149 +
                            _tmp119 * _tmp120 * _tmp47 + _tmp128 * _tmp129 * _tmp47 +
                            _tmp135 * _tmp136 * _tmp47 + _tmp38 * _tmp47 * _tmp96));
  const Scalar _tmp154 = Scalar(0.1034955) * _tmp152;
  const Scalar _tmp155 = Scalar(9.6622558468725703) * _tmp151;
  const Scalar _tmp156 =
      _tmp127 * _tmp129 * _tmp93 + _tmp134 * _tmp136 * _tmp93 + _tmp142 * _tmp38 + _tmp150;
  const Scalar _tmp157 = Scalar(1.0) / (_tmp156);
  const Scalar _tmp158 =
      std::asinh(_tmp157 * (-_tmp105 * _tmp99 - _tmp118 * _tmp120 - _tmp125 * _tmp129 * _tmp56 -
                            _tmp133 * _tmp136 * _tmp56 + _tmp149 + _tmp38 * _tmp95));
  ...
  _res(1, 0) =
      -_tmp148 *
          (_tmp147 * p_c(2, 0) + std::cosh(Scalar(1.0) * _tmp146) -
           std::cosh(_tmp147 *
                     (-_tmp146 * _tmp148 -
                      std::sqrt(Scalar(std::pow(Scalar(-_tmp77 + p_c(1, 0)), Scalar(2)) +
                                       std::pow(Scalar(-_tmp79 + p_c(0, 0)), Scalar(2))))))) +
      _tmp76 + p_init2;
  _res(2, 0) =
      -_tmp155 *
          (_tmp154 * p_d(2, 0) + std::cosh(Scalar(1.0) * _tmp153) -
           std::cosh(_tmp154 *
                     (-_tmp153 * _tmp155 -
                      std::sqrt(Scalar(std::pow(Scalar(-_tmp69 + p_d(1, 0)), Scalar(2)) +
  ...
  _res(3, 0) =
      -_tmp159 *
          (_tmp160 * p_a(2, 0) + std::cosh(Scalar(1.0) * _tmp158) -
           std::cosh(_tmp160 *
                     (-_tmp158 * _tmp159 -
                      std::sqrt(Scalar(std::pow(Scalar(-_tmp61 + p_a(0, 0)), Scalar(2)) +
