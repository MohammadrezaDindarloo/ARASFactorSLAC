...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl7(
  ...
  const Scalar _tmp49 = _tmp26 + _tmp43;
  ...
  const Scalar _tmp60 = _tmp33 - p_b(1, 0);
  const Scalar _tmp61 = _tmp25 - p_b(0, 0);
  ...
  const Scalar _tmp65 = -Scalar(5.1796800000000003) * _tmp28 - _tmp32 * fv1 - _tmp63 * _tmp64;
  const Scalar _tmp66 = _tmp48 * _tmp50;
  const Scalar _tmp67 = _tmp61 * _tmp62;
  const Scalar _tmp68 = Scalar(5.1796800000000003) * _tmp18 + _tmp24 * fv1 + _tmp64 * _tmp67;
  ...
  const Scalar _tmp131 = fh1 * (_tmp24 * _tmp63 - _tmp32 * _tmp67);
  const Scalar _tmp132 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp133 = _tmp40 + _tmp45 * _tmp53;
  const Scalar _tmp134 = 0;
  const Scalar _tmp135 = _tmp133 * _tmp55;
  const Scalar _tmp136 = -_tmp118 * _tmp134 - _tmp135 * _tmp48 + _tmp46;
  ...
  const Scalar _tmp147 = std::asinh(
      _tmp146 * (Scalar(1.0) * _tmp120 * (_tmp115 * _tmp56 - _tmp119 * _tmp58) +
                 ...
                 Scalar(1.0) * _tmp132 * (-_tmp133 * _tmp56 - _tmp136 * _tmp58 + Scalar(1.0)) +
  ...
  const Scalar _tmp154 =
      std::asinh(_tmp152 * (_tmp119 * _tmp120 * _tmp50 + _tmp126 * _tmp127 * _tmp50 +
                            _tmp130 * _tmp131 * _tmp50 + _tmp132 * _tmp136 * _tmp50 -
                            _tmp153 * _tmp66 + _tmp50 * _tmp57 * _tmp65));
