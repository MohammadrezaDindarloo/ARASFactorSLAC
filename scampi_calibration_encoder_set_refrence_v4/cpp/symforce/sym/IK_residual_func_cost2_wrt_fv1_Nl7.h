...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2WrtFv1Nl7(
  ...
  const Scalar _tmp35 = _tmp21 - p_b(0, 0);
  ...
  const Scalar _tmp39 = -Scalar(0.010999999999999999) * _tmp16 -
  ...
  const Scalar _tmp43 = -Scalar(5.1796800000000003) * _tmp27 - _tmp31 * fv1 - _tmp37 * _tmp42;
  ...
  const Scalar _tmp48 = _tmp24 + _tmp44;
  ...
  const Scalar _tmp54 = _tmp19 + _tmp9;
  const Scalar _tmp55 = _tmp22 + _tmp24 + _tmp29;
  const Scalar _tmp56 = _tmp47 + _tmp55;
  const Scalar _tmp57 = _tmp51 + _tmp9;
  const Scalar _tmp58 = _tmp53 - _tmp57;
  const Scalar _tmp59 = _tmp50 * _tmp58;
  const Scalar _tmp60 = _tmp56 * _tmp59;
  const Scalar _tmp61 = Scalar(1.0) / (_tmp53 - _tmp54 - _tmp60);
  const Scalar _tmp62 = Scalar(1.0) * _tmp61;
  const Scalar _tmp63 = _tmp50 * (_tmp60 * _tmp62 + Scalar(1.0));
  ...
  const Scalar _tmp67 = Scalar(5.1796800000000003) * _tmp14 + _tmp20 * fv1 + _tmp42 * _tmp66;
  const Scalar _tmp68 = _tmp50 * _tmp56;
  const Scalar _tmp69 = Scalar(1.0) * _tmp62 * _tmp68 - Scalar(1.0) * _tmp62;
  const Scalar _tmp70 = -_tmp38;
  ...
  const Scalar _tmp75 = _tmp57 + p_init0;
  ...
  const Scalar _tmp80 = _tmp41 + _tmp70;
  ...
  const Scalar _tmp93 = _tmp58 * _tmp88 * _tmp89 * _tmp92 - _tmp90 * _tmp91;
  const Scalar _tmp94 = _tmp54 + p_init0;
  const Scalar _tmp95 = _tmp94 - p_c(0, 0);
  const Scalar _tmp96 = _tmp55 + p_init1;
  ...
  const Scalar _tmp104 = _tmp38 + _tmp71;
  const Scalar _tmp105 = _tmp100 * _tmp104 - _tmp102 * _tmp88 - _tmp103 * _tmp86;
  const Scalar _tmp106 = -_tmp102 * _tmp91 + _tmp103 - _tmp104 * _tmp99 - _tmp105 * _tmp59;
  ...
  const Scalar _tmp112 = _tmp111 * _tmp79 + _tmp49 * _tmp79 - _tmp57 * _tmp78;
  const Scalar _tmp113 = -_tmp100 * _tmp54 - _tmp102 * _tmp112 + _tmp111 * _tmp99 + _tmp55 * _tmp99;
  ...
  const Scalar _tmp118 = _tmp56 * _tmp61;
  ...
  const Scalar _tmp125 = _tmp123 * _tmp91 - _tmp124 * _tmp59 - _tmp80;
  ...
  const Scalar _tmp129 = _tmp66 * fh1;
  const Scalar _tmp130 = _tmp116 * _tmp62;
  const Scalar _tmp131 = Scalar(1.0) * _tmp115;
  const Scalar _tmp132 = -_tmp105 * _tmp131 + _tmp130 * _tmp56;
  const Scalar _tmp133 = fh1 * (_tmp20 * _tmp37 - _tmp31 * _tmp66);
  const Scalar _tmp134 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp135 = _tmp46 * _tmp59 + _tmp53;
  const Scalar _tmp136 = _tmp135 * _tmp61;
  const Scalar _tmp137 = 0;
  const Scalar _tmp138 = _tmp50 * (-_tmp120 * _tmp137 - _tmp136 * _tmp56 + _tmp47);
  const Scalar _tmp139 = -Scalar(1.0) * _tmp136 - Scalar(1.0) * _tmp138 + Scalar(1.0);
  const Scalar _tmp140 = Scalar(1.0) * _tmp122 * (_tmp117 * _tmp62 - _tmp121 * _tmp92) +
                         Scalar(1.0) * _tmp129 * (_tmp126 * _tmp62 - _tmp128 * _tmp92) +
                         Scalar(1.0) * _tmp133 * (_tmp130 - _tmp132 * _tmp92) + _tmp134 * _tmp139 +
                         _tmp43 * _tmp65 + _tmp67 * _tmp69;
  ...
  const Scalar _tmp154 = _tmp28 + _tmp48;
  const Scalar _tmp155 = std::pow(_tmp150, Scalar(-2));
  const Scalar _tmp156 = _tmp148 * _tmp155;
  const Scalar _tmp157 =
      (-_tmp140 * _tmp156 + _tmp151 * (-_tmp139 + _tmp154 * _tmp65 + _tmp20 * _tmp69)) /
      std::sqrt(Scalar(std::pow(_tmp140, Scalar(2)) * _tmp155 + 1));
  const Scalar _tmp158 = Scalar(9.6622558468725703) * _tmp150;
  const Scalar _tmp159 =
      -_tmp152 * _tmp158 - std::sqrt(Scalar(std::pow(Scalar(-_tmp81 + p_a(1, 0)), Scalar(2)) +
                                            std::pow(Scalar(-_tmp83 + p_a(0, 0)), Scalar(2))));
  const Scalar _tmp160 = Scalar(9.6622558468725703) * _tmp148;
  const Scalar _tmp161 = Scalar(0.1034955) * _tmp151;
  const Scalar _tmp162 = _tmp159 * _tmp161;
  const Scalar _tmp163 = _tmp134 * _tmp146;
  const Scalar _tmp164 = -_tmp102 * _tmp163 + _tmp122 * _tmp149 * _tmp89 +
                         _tmp129 * _tmp143 * _tmp89 - _tmp133 * _tmp141;
  const Scalar _tmp165 = Scalar(1.0) / (_tmp164);
  const Scalar _tmp166 = _tmp62 * _tmp67;
  const Scalar _tmp167 = _tmp121 * _tmp122 * _tmp50 + _tmp128 * _tmp129 * _tmp50 +
                         _tmp132 * _tmp133 * _tmp50 + _tmp134 * _tmp138 - _tmp166 * _tmp68 +
                         _tmp43 * _tmp63;
  const Scalar _tmp168 = std::asinh(_tmp165 * _tmp167);
  const Scalar _tmp169 = Scalar(9.6622558468725703) * _tmp164;
  const Scalar _tmp170 =
      -_tmp168 * _tmp169 - std::sqrt(Scalar(std::pow(Scalar(-_tmp73 + p_d(1, 0)), Scalar(2)) +
  ...
  const Scalar _tmp177 = _tmp20 * _tmp62;
  const Scalar _tmp178 = _tmp147 * _tmp176;
  const Scalar _tmp179 =
      (_tmp165 * (-_tmp138 + _tmp154 * _tmp63 - _tmp177 * _tmp68) - _tmp167 * _tmp178) /
      std::sqrt(Scalar(std::pow(_tmp167, Scalar(2)) * _tmp176 + 1));
  const Scalar _tmp180 =
      _tmp107 * _tmp119 * _tmp122 + _tmp107 * _tmp127 * _tmp129 + _tmp131 * _tmp133 + _tmp163;
  const Scalar _tmp181 = Scalar(1.0) / (_tmp180);
  const Scalar _tmp182 = -_tmp117 * _tmp122 * _tmp61 - _tmp126 * _tmp129 * _tmp61 -
                         _tmp130 * _tmp133 + _tmp134 * _tmp136 + _tmp166 - _tmp43 * _tmp64;
  ...
  const Scalar _tmp186 =
      -_tmp183 * _tmp185 - std::sqrt(Scalar(std::pow(Scalar(-_tmp94 + p_c(0, 0)), Scalar(2)) +
  ...
  const Scalar _tmp191 = (_tmp181 * (-_tmp136 - _tmp154 * _tmp64 + _tmp177) + _tmp182 * _tmp190) /
