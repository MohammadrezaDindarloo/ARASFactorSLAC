...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl18(
  ...
  const Scalar _tmp29 = -Scalar(0.20999999999999999) * _tmp10 + Scalar(0.20999999999999999) * _tmp8;
  ...
  const Scalar _tmp36 = _tmp35 - p_b(1, 0) + p_init1;
  const Scalar _tmp37 = _tmp11 - _tmp14;
  const Scalar _tmp38 = _tmp37 + _tmp5;
  const Scalar _tmp39 = _tmp38 - p_b(0, 0) + p_init0;
  ...
  const Scalar _tmp46 = _tmp45 - p_a(1, 0) + p_init1;
  ...
  const Scalar _tmp55 = _tmp28 * _tmp51 - _tmp54;
  ...
  const Scalar _tmp60 = -_tmp41 * _tmp59 + _tmp42 * _tmp52;
  const Scalar _tmp61 = Scalar(1.0) * _tmp45;
  const Scalar _tmp62 = Scalar(1.0) * _tmp48;
  const Scalar _tmp63 = (-_tmp38 + _tmp62) / (_tmp35 - _tmp61);
  const Scalar _tmp64 = -_tmp28 * _tmp58 - _tmp43 * _tmp56 + _tmp57 -
                        _tmp63 * (-_tmp51 * _tmp57 + _tmp54 * _tmp58 - _tmp56 * _tmp60);
  ...
  const Scalar _tmp69 = _tmp41 * _tmp53;
  const Scalar _tmp70 = _tmp55 * _tmp65;
  ...
  const Scalar _tmp75 = _tmp73 * (-_tmp45 * _tmp49 * _tmp74 + _tmp46 * _tmp48 * _tmp74);
  const Scalar _tmp76 = _tmp35 * _tmp41 - _tmp38 * _tmp52 + _tmp41 * _tmp75;
  const Scalar _tmp77 = _tmp51 * _tmp53;
  const Scalar _tmp78 = -_tmp33 + _tmp43 * _tmp77 - _tmp63 * (_tmp59 + _tmp60 * _tmp77);
  const Scalar _tmp79 = -_tmp16 * _tmp54 + _tmp25 * _tmp28 + _tmp28 * _tmp75 - _tmp56 * _tmp76;
  ...
  const Scalar _tmp84 = _tmp28 * _tmp65;
  const Scalar _tmp85 = -_tmp51 - _tmp70 * _tmp83;
  const Scalar _tmp86 = _tmp19 + _tmp44;
  const Scalar _tmp87 = _tmp86 - p_d(1, 0) + p_init1;
  const Scalar _tmp88 = _tmp15 + _tmp47;
  ...
  const Scalar _tmp95 = _tmp55 * _tmp81 * _tmp94;
  const Scalar _tmp96 = _tmp87 * _tmp90;
  const Scalar _tmp97 = fh1 * (-_tmp86 * _tmp91 + _tmp88 * _tmp96);
  const Scalar _tmp98 = -_tmp43 * _tmp94 + _tmp60 * _tmp63 * _tmp94;
  const Scalar _tmp99 = _tmp82 * (-_tmp76 * _tmp94 - _tmp80 * _tmp98) + _tmp98;
  ...
  _res(1, 0) = std::exp(_tmp0 * _tmp73 * (_tmp28 * _tmp68 - _tmp69 * _tmp71) +
                        _tmp101 * _tmp73 * (_tmp100 * _tmp69 + _tmp84 * _tmp99) +
                        _tmp73 * _tmp92 * (_tmp69 * _tmp85 + _tmp83 * _tmp84 + Scalar(1.0)) +
                        _tmp73 * _tmp97 * (_tmp28 * _tmp93 - _tmp41 * _tmp95));
  _res(2, 0) = std::exp(_tmp0 * _tmp53 * _tmp71 - _tmp100 * _tmp101 * _tmp53 -
                        _tmp53 * _tmp85 * _tmp92 + _tmp95 * _tmp97);
  _res(3, 0) = std::exp(-_tmp0 * _tmp68 - _tmp101 * _tmp65 * _tmp99 - _tmp65 * _tmp83 * _tmp92 -
                        _tmp93 * _tmp97);
