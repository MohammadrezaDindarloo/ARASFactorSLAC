...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl3(
  ...
  const Scalar _tmp25 = _tmp24 - p_b(0, 0) + p_init0;
  ...
  const Scalar _tmp42 = _tmp41 - p_d(1, 0) + p_init1;
  const Scalar _tmp43 = -_tmp18;
  const Scalar _tmp44 = _tmp29 + _tmp43;
  const Scalar _tmp45 = _tmp44 - p_d(0, 0) + p_init0;
  ...
  const Scalar _tmp52 = _tmp27 * _tmp50 - _tmp28;
  ...
  const Scalar _tmp58 = _tmp23 + _tmp43;
  const Scalar _tmp59 = _tmp58 - p_a(0, 0) + p_init0;
  const Scalar _tmp60 = _tmp14 + _tmp40;
  const Scalar _tmp61 = _tmp60 - p_a(1, 0) + p_init1;
  ...
  const Scalar _tmp68 = -Scalar(0.010999999999999999) * _tmp17 -
  ...
  const Scalar _tmp74 = -_tmp47 * _tmp72 + _tmp48 * _tmp73;
  const Scalar _tmp75 = Scalar(1.0) * _tmp33;
  const Scalar _tmp76 = Scalar(1.0) * _tmp30;
  const Scalar _tmp77 = (-_tmp44 + _tmp76) / (_tmp41 - _tmp75);
  const Scalar _tmp78 = _tmp47 * _tmp71 - _tmp47 * _tmp73;
  const Scalar _tmp79 = _tmp66 * _tmp78 - _tmp71 - _tmp77 * (_tmp66 * _tmp74 + _tmp72);
  const Scalar _tmp80 = -_tmp67 + _tmp70;
  const Scalar _tmp81 = _tmp27 * _tmp71 - _tmp27 * _tmp80 - _tmp53 * _tmp78 -
                        _tmp77 * (-_tmp27 * _tmp72 + _tmp28 * _tmp80 - _tmp53 * _tmp74);
  const Scalar _tmp82 = Scalar(1.0) / (_tmp81);
  const Scalar _tmp83 = _tmp54 * _tmp82;
  const Scalar _tmp84 = _tmp55 * _tmp81;
  const Scalar _tmp85 = _tmp79 + _tmp84 * (-_tmp39 + _tmp49 * _tmp66 - _tmp79 * _tmp83);
  const Scalar _tmp86 = _tmp27 * _tmp82;
  const Scalar _tmp87 = _tmp52 * _tmp82;
  const Scalar _tmp88 = -_tmp50 - _tmp85 * _tmp87;
  const Scalar _tmp89 = _tmp47 * _tmp51;
  const Scalar _tmp90 = _tmp38 * fh1;
  const Scalar _tmp91 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp92 = _tmp75 * _tmp77 + _tmp76;
  const Scalar _tmp93 = 0;
  const Scalar _tmp94 = Scalar(1.0) * _tmp51;
  const Scalar _tmp95 = _tmp74 * _tmp77 * _tmp94 - _tmp78 * _tmp94;
  const Scalar _tmp96 = _tmp84 * (-_tmp49 * _tmp94 - _tmp83 * _tmp95) + _tmp95;
  const Scalar _tmp97 = -_tmp87 * _tmp96 + Scalar(1.0);
  const Scalar _tmp98 = _tmp56 * _tmp65;
  ...
  _res(1, 0) = std::exp(_tmp38 * _tmp65 * (_tmp27 * _tmp56 - _tmp56 * _tmp57) +
                        _tmp38 * _tmp91 * (_tmp27 * _tmp93 - _tmp57 * _tmp93) +
                        _tmp63 * _tmp90 * (_tmp86 * _tmp96 + _tmp89 * _tmp97) +
                        _tmp64 * _tmp90 * (_tmp85 * _tmp86 + _tmp88 * _tmp89 + Scalar(1.0)));
  _res(2, 0) = std::exp(_tmp100 * _tmp53 + _tmp53 * _tmp98 - _tmp63 * _tmp97 * _tmp99 -
                        _tmp64 * _tmp88 * _tmp99);
  _res(3, 0) = std::exp(-_tmp100 - _tmp101 * _tmp63 * _tmp96 - _tmp101 * _tmp64 * _tmp85 - _tmp98);
