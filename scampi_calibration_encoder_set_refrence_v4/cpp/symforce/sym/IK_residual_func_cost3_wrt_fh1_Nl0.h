...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl0(
  ...
  const Scalar _tmp41 = -_tmp16 * _tmp28 + _tmp25 * _tmp29 + _tmp29 * _tmp40;
  const Scalar _tmp42 = _tmp32 * _tmp38;
  const Scalar _tmp43 = Scalar(1.0) / (-_tmp28 + _tmp29 * _tmp42);
  ...
  const Scalar _tmp50 = _tmp45 + _tmp47;
  const Scalar _tmp51 = _tmp46 + _tmp50;
  const Scalar _tmp52 = -_tmp29 * _tmp51 + _tmp49;
  const Scalar _tmp53 = _tmp28 * _tmp51 - _tmp42 * _tmp49;
  ...
  const Scalar _tmp57 = -_tmp44 * _tmp52 + _tmp44 * _tmp53 * _tmp56;
  const Scalar _tmp58 = -_tmp46 + _tmp50;
  ...
  const Scalar _tmp64 = _tmp63 - p_d(0, 0) + p_init0;
  ...
  const Scalar _tmp88 = _tmp39 * _tmp87 * (_tmp66 * _tmp81 + _tmp79 * _tmp80);
  ...
  const Scalar _tmp93 = -_tmp48 + _tmp52 * _tmp92 - _tmp56 * (_tmp42 * _tmp48 + _tmp53 * _tmp92);
  const Scalar _tmp94 = _tmp76 * (-_tmp40 + _tmp41 * _tmp92 - _tmp74 * _tmp93) + _tmp93;
  const Scalar _tmp95 = _tmp72 * _tmp94;
  const Scalar _tmp96 = -_tmp42 - _tmp78 * _tmp94;
  const Scalar _tmp97 = _tmp83 * _tmp86;
  const Scalar _tmp98 = _tmp39 * _tmp97 * (_tmp66 * _tmp95 + _tmp80 * _tmp96 + Scalar(1.0));
  const Scalar _tmp99 = _tmp82 * _tmp87 - _tmp84 * _tmp97;
  const Scalar _tmp100 = _tmp44 * _tmp69 * _tmp75;
  const Scalar _tmp101 = Scalar(1.0) * _tmp75;
  const Scalar _tmp102 = _tmp39 * _tmp99 * (-_tmp100 * _tmp29 + _tmp101 * _tmp66);
  const Scalar _tmp103 = _tmp43 * _tmp79 * _tmp87;
  const Scalar _tmp104 = _tmp43 * _tmp96 * _tmp97;
  ...
  _res(1, 0) =
      ...
      std::exp(_tmp102 * fh1 + _tmp39 * _tmp89 * (-_tmp29 * _tmp70 * _tmp91 + _tmp66 * _tmp91) +
               _tmp88 * fh1 + _tmp98 * fh1);
  _res(2, 0) = -(_tmp103 + _tmp104 - _tmp106) *
               std::exp(-_tmp103 * fh1 - _tmp104 * fh1 + _tmp105 * _tmp70 + _tmp106 * fh1);
  _res(3, 0) = -(_tmp107 + _tmp108 + _tmp109) *
               std::exp(-_tmp105 - _tmp107 * fh1 - _tmp108 * fh1 - _tmp109 * fh1);
