...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl18(
  ...
  const Scalar _tmp18 = _tmp17 - p_c(0, 0) + p_init0;
  ...
  const Scalar _tmp22 = _tmp12 * _tmp9;
  const Scalar _tmp23 =
  ...
  const Scalar _tmp27 = _tmp26 - p_c(1, 0) + p_init1;
  ...
  const Scalar _tmp31 = -Scalar(0.010999999999999999) * _tmp19 -
  ...
  const Scalar _tmp37 = _tmp36 - p_b(1, 0) + p_init1;
  const Scalar _tmp38 = _tmp11 - _tmp15;
  const Scalar _tmp39 = _tmp38 + _tmp5;
  const Scalar _tmp40 = _tmp39 - p_b(0, 0) + p_init0;
  const Scalar _tmp41 = std::pow(Scalar(std::pow(_tmp37, Scalar(2)) + std::pow(_tmp40, Scalar(2))),
                                 Scalar(Scalar(-1) / Scalar(2)));
  const Scalar _tmp42 = _tmp40 * _tmp41;
  const Scalar _tmp43 = _tmp30 + _tmp33;
  const Scalar _tmp44 = _tmp34 * _tmp42 - _tmp42 * _tmp43;
  const Scalar _tmp45 = _tmp23 - _tmp24;
  const Scalar _tmp46 = _tmp35 + _tmp45;
  const Scalar _tmp47 = _tmp46 - p_a(1, 0) + p_init1;
  const Scalar _tmp48 = -_tmp5;
  const Scalar _tmp49 = _tmp38 + _tmp48;
  const Scalar _tmp50 = _tmp49 - p_a(0, 0) + p_init0;
  const Scalar _tmp51 = Scalar(1.0) / (_tmp50);
  const Scalar _tmp52 = _tmp47 * _tmp51;
  const Scalar _tmp53 = _tmp27 * _tmp28;
  const Scalar _tmp54 = _tmp29 * _tmp52 - _tmp53;
  const Scalar _tmp55 = _tmp37 * _tmp41;
  const Scalar _tmp56 = Scalar(1.0) / (_tmp42 * _tmp52 - _tmp55);
  const Scalar _tmp57 = _tmp54 * _tmp56;
  const Scalar _tmp58 = _tmp29 * _tmp34;
  const Scalar _tmp59 = _tmp30 + _tmp31 + _tmp32;
  const Scalar _tmp60 = _tmp34 * _tmp52;
  const Scalar _tmp61 = -_tmp42 * _tmp60 + _tmp43 * _tmp55;
  const Scalar _tmp62 = Scalar(1.0) * _tmp46;
  const Scalar _tmp63 = Scalar(1.0) * _tmp49;
  const Scalar _tmp64 = (-_tmp39 + _tmp63) / (_tmp36 - _tmp62);
  const Scalar _tmp65 = -_tmp29 * _tmp59 - _tmp44 * _tmp57 + _tmp58 -
                        _tmp64 * (-_tmp52 * _tmp58 + _tmp53 * _tmp59 - _tmp57 * _tmp61);
  ...
  const Scalar _tmp70 = _tmp42 * _tmp56;
  const Scalar _tmp71 = _tmp54 * _tmp66;
  ...
  const Scalar _tmp76 = _tmp74 * (-_tmp46 * _tmp50 * _tmp75 + _tmp47 * _tmp49 * _tmp75);
  const Scalar _tmp77 = _tmp36 * _tmp42 - _tmp39 * _tmp55 + _tmp42 * _tmp76;
  const Scalar _tmp78 = _tmp52 * _tmp56;
  const Scalar _tmp79 = -_tmp34 + _tmp44 * _tmp78 - _tmp64 * (_tmp60 + _tmp61 * _tmp78);
  const Scalar _tmp80 = -_tmp17 * _tmp53 + _tmp26 * _tmp29 + _tmp29 * _tmp76 - _tmp57 * _tmp77;
  ...
  const Scalar _tmp86 = -_tmp52 - _tmp71 * _tmp84;
  const Scalar _tmp87 = _tmp20 + _tmp45;
  const Scalar _tmp88 = _tmp87 - p_d(1, 0) + p_init1;
  const Scalar _tmp89 = _tmp16 + _tmp48;
  const Scalar _tmp90 = _tmp89 - p_d(0, 0) + p_init0;
  const Scalar _tmp91 = std::pow(Scalar(std::pow(_tmp88, Scalar(2)) + std::pow(_tmp90, Scalar(2))),
                                 Scalar(Scalar(-1) / Scalar(2)));
  const Scalar _tmp92 = _tmp90 * _tmp91;
  const Scalar _tmp93 = _tmp74 * _tmp92 * (_tmp29 * _tmp85 + _tmp70 * _tmp86 + Scalar(1.0));
  const Scalar _tmp94 = _tmp88 * _tmp91;
  const Scalar _tmp95 = -_tmp87 * _tmp92 + _tmp89 * _tmp94;
  const Scalar _tmp96 = Scalar(1.0) * _tmp82;
  const Scalar _tmp97 = _tmp74 * _tmp95 * (_tmp29 * _tmp96 - _tmp42 * _tmp57 * _tmp96);
  const Scalar _tmp98 = Scalar(1.0) * _tmp56;
  const Scalar _tmp99 = -_tmp44 * _tmp98 + _tmp61 * _tmp64 * _tmp98;
  const Scalar _tmp100 = _tmp83 * (-_tmp77 * _tmp98 - _tmp81 * _tmp99) + _tmp99;
  const Scalar _tmp101 = _tmp100 * _tmp66;
  const Scalar _tmp102 = -_tmp100 * _tmp71 + Scalar(1.0);
  const Scalar _tmp103 = _tmp74 * _tmp94 * (_tmp101 * _tmp29 + _tmp102 * _tmp70);
  const Scalar _tmp104 = _tmp102 * _tmp56 * _tmp94;
  const Scalar _tmp105 = _tmp95 * _tmp96;
  const Scalar _tmp106 = _tmp105 * fh1;
  const Scalar _tmp107 = _tmp56 * _tmp86 * _tmp92;
  const Scalar _tmp108 = _tmp101 * _tmp94;
  const Scalar _tmp109 = _tmp85 * _tmp92;

  // Output terms (1)
  Eigen::Matrix<Scalar, 4, 1> _res;

  _res(0, 0) = -std::exp(-fh1);
  _res(1, 0) = -(-_tmp103 - _tmp93 - _tmp97) *
               std::exp(_tmp0 * _tmp74 * (_tmp29 * _tmp69 - _tmp70 * _tmp72) + _tmp103 * fh1 +
                        _tmp93 * fh1 + _tmp97 * fh1);
  _res(2, 0) = -(_tmp104 - _tmp105 * _tmp57 + _tmp107) *
               std::exp(_tmp0 * _tmp56 * _tmp72 - _tmp104 * fh1 + _tmp106 * _tmp57 - _tmp107 * fh1);
  _res(3, 0) = -(_tmp105 + _tmp108 + _tmp109) *
               std::exp(-_tmp0 * _tmp69 - _tmp106 - _tmp108 * fh1 - _tmp109 * fh1);
