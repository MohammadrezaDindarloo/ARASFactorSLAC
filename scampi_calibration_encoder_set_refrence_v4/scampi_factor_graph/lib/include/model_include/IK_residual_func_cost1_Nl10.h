...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl10(
  ...
  const Scalar _tmp53 = _tmp18 + _tmp42;
  ...
  const Scalar _tmp63 = _tmp62 * (_tmp52 * _tmp60 - _tmp53 * _tmp61 + _tmp56 * _tmp60);
  const Scalar _tmp64 = -_tmp32;
  const Scalar _tmp65 = _tmp33 + _tmp34;
  const Scalar _tmp66 = _tmp64 + _tmp65;
  const Scalar _tmp67 = _tmp35 + _tmp64;
  const Scalar _tmp68 = _tmp60 * _tmp66 - _tmp60 * _tmp67;
  const Scalar _tmp69 = _tmp48 * _tmp62;
  const Scalar _tmp70 = _tmp48 * _tmp66;
  const Scalar _tmp71 = -_tmp60 * _tmp70 + _tmp61 * _tmp67;
  const Scalar _tmp72 = _tmp69 * _tmp71 + _tmp70;
  ...
  const Scalar _tmp79 = -_tmp66 + _tmp68 * _tmp69 - _tmp72 * _tmp78;
  const Scalar _tmp80 = _tmp32 + _tmp65;
  const Scalar _tmp81 = _tmp43 + _tmp7;
  const Scalar _tmp82 = _tmp81 + p_init0;
  const Scalar _tmp83 = _tmp82 - p_c(0, 0);
  const Scalar _tmp84 = _tmp21 + _tmp38;
  ...
  const Scalar _tmp93 = _tmp66 * _tmp89 - _tmp68 * _tmp91 - _tmp78 * _tmp92 - _tmp80 * _tmp89;
  const Scalar _tmp94 = Scalar(1.0) / (_tmp93);
  const Scalar _tmp95 = _tmp52 * _tmp89 - _tmp63 * _tmp90 - _tmp81 * _tmp88 + _tmp84 * _tmp89;
  const Scalar _tmp96 = _tmp94 * _tmp95;
  const Scalar _tmp97 = Scalar(1.0) / (_tmp95);
  const Scalar _tmp98 = _tmp93 * _tmp97;
  const Scalar _tmp99 = _tmp98 * (_tmp48 * _tmp63 - _tmp52 - _tmp79 * _tmp96);
  ...
  const Scalar _tmp105 = _tmp30 - p_b(1, 0);
  ...
  const Scalar _tmp110 = Scalar(1.0) * _tmp62;
  const Scalar _tmp111 = Scalar(1.0) * _tmp75;
  const Scalar _tmp112 = -_tmp110 * _tmp68 + _tmp111 * _tmp62 * _tmp71 * _tmp77;
  const Scalar _tmp113 = _tmp98 * (-_tmp112 * _tmp96 - Scalar(1.0) * _tmp63);
  ...
  const Scalar _tmp125 = -_tmp109 * _tmp51 * (_tmp100 * _tmp104 + _tmp102 * _tmp103 + Scalar(1.0)) -
                         ...
                         _tmp120 * _tmp51 * (_tmp118 * _tmp89 - _tmp119 * _tmp60) -
                         _tmp121 * _tmp51 * (-_tmp124 * _tmp60 * _tmp91 + _tmp124 * _tmp89);
  ...
  const Scalar _tmp135 = -_tmp118 * _tmp92 + _tmp127 * _tmp134;
  const Scalar _tmp136 = _tmp36 * fh1;
  const Scalar _tmp137 = _tmp108 * _tmp136 + Scalar(5.1796800000000003) * _tmp13 + _tmp19 * fv1;
  const Scalar _tmp138 = _tmp127 * _tmp75;
  const Scalar _tmp139 = _tmp127 * _tmp129;
  const Scalar _tmp140 = -_tmp110 * _tmp71 + _tmp113 * _tmp139 - _tmp114 * _tmp131;
  const Scalar _tmp141 = _tmp130 * _tmp78;
  const Scalar _tmp142 = _tmp128 * _tmp130 + Scalar(1.0);
  const Scalar _tmp143 = -_tmp116 * _tmp136 - Scalar(5.1796800000000003) * _tmp26 - _tmp29 * fv1;
  const Scalar _tmp144 = -_tmp100 * _tmp131 + _tmp139 * _tmp99 + _tmp72;
  const Scalar _tmp145 = std::asinh(
      _tmp126 * (Scalar(1.0) * _tmp109 * (-_tmp111 * _tmp144 + _tmp130 * _tmp99) +
                 Scalar(1.0) * _tmp117 * (-_tmp111 * _tmp140 + _tmp113 * _tmp130) +
                 Scalar(1.0) * _tmp120 * (-_tmp111 * _tmp135 + _tmp134) +
                 Scalar(1.0) * _tmp121 * (-_tmp111 * _tmp133 - _tmp122 * _tmp130 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp137 * (_tmp130 * _tmp138 - _tmp130) +
                 Scalar(1.0) * _tmp143 * (-_tmp111 * _tmp142 + _tmp141)));
  ...
  const Scalar _tmp149 = _tmp102 * _tmp109 * _tmp62 + _tmp115 * _tmp117 * _tmp62 -
                         _tmp119 * _tmp120 - _tmp148 * _tmp91;
  const Scalar _tmp150 = Scalar(1.0) / (_tmp149);
  const Scalar _tmp151 = Scalar(0.1034955) * _tmp150;
  const Scalar _tmp152 = _tmp130 * _tmp137;
  const Scalar _tmp153 =
      std::asinh(_tmp150 * (_tmp109 * _tmp144 * _tmp75 + _tmp117 * _tmp140 * _tmp75 +
                            _tmp120 * _tmp135 * _tmp75 + _tmp121 * _tmp133 * _tmp75 -
                            _tmp138 * _tmp152 + _tmp142 * _tmp143 * _tmp75));
  ...
  const Scalar _tmp157 =
      std::asinh(_tmp156 * (-_tmp109 * _tmp129 * _tmp99 - _tmp113 * _tmp117 * _tmp129 -
                            _tmp120 * _tmp134 + _tmp121 * _tmp132 - _tmp141 * _tmp143 + _tmp152));
  ...
  _res(2, 0) =
      -_tmp154 *
          (_tmp151 * p_a(2, 0) + std::cosh(Scalar(1.0) * _tmp153) -
           std::cosh(_tmp151 *
                     (-_tmp153 * _tmp154 -
  ...
  _res(3, 0) =
      -_tmp158 *
          (_tmp159 * p_c(2, 0) + std::cosh(Scalar(1.0) * _tmp157) -
           std::cosh(_tmp159 *
                     (-_tmp157 * _tmp158 -
