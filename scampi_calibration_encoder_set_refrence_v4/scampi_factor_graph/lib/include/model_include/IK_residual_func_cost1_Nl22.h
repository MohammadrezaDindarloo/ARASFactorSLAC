...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl22(
  ...
  const Scalar _tmp36 = Scalar(0.20999999999999999) * _tmp11 - Scalar(0.20999999999999999) * _tmp14;
  ...
  const Scalar _tmp60 = _tmp30 + _tmp42;
  ...
  const Scalar _tmp67 = _tmp24 + _tmp43;
  ...
  const Scalar _tmp76 = Scalar(1.0) / (_tmp64 * _tmp74 - _tmp75);
  const Scalar _tmp77 = _tmp46 * _tmp51;
  const Scalar _tmp78 = _tmp52 * _tmp74 - _tmp77;
  const Scalar _tmp79 = _tmp76 * _tmp78;
  const Scalar _tmp80 = _tmp56 * _tmp75 - _tmp65 * _tmp74;
  const Scalar _tmp81 = -_tmp53 * _tmp74 + _tmp55 * _tmp77 - _tmp79 * _tmp80;
  ...
  const Scalar _tmp87 = -_tmp52 * _tmp55 + _tmp53 - _tmp66 * _tmp79 - _tmp81 * _tmp86;
  const Scalar _tmp88 = Scalar(1.0) / (_tmp87);
  const Scalar _tmp89 = _tmp82 * _tmp86 + _tmp85;
  const Scalar _tmp90 = 0;
  const Scalar _tmp91 = _tmp64 * _tmp79;
  const Scalar _tmp92 =
  ...
  const Scalar _tmp95 = _tmp93 * (-_tmp67 * _tmp72 * _tmp94 + _tmp69 * _tmp70 * _tmp94);
  const Scalar _tmp96 = _tmp74 * _tmp76;
  const Scalar _tmp97 = _tmp41 * _tmp74 + _tmp80 * _tmp96;
  const Scalar _tmp98 = -_tmp41 + _tmp66 * _tmp96 - _tmp86 * _tmp97;
  const Scalar _tmp99 = -_tmp57 * _tmp75 + _tmp60 * _tmp64 + _tmp64 * _tmp95;
  const Scalar _tmp100 = _tmp44 * _tmp52 - _tmp48 * _tmp77 + _tmp52 * _tmp95 - _tmp79 * _tmp99;
  ...
  const Scalar _tmp105 = _tmp88 * (_tmp104 + _tmp98);
  const Scalar _tmp106 = -_tmp105 * _tmp78 - _tmp74;
  const Scalar _tmp107 = _tmp64 * _tmp76;
  const Scalar _tmp108 = _tmp32 - p_d(1, 0);
  const Scalar _tmp109 = _tmp22 - p_d(0, 0);
  ...
  const Scalar _tmp115 = fh1 * (-_tmp111 * _tmp31 + _tmp114 * _tmp21);
  const Scalar _tmp116 = Scalar(1.0) * _tmp76;
  const Scalar _tmp117 = _tmp116 * _tmp80;
  const Scalar _tmp118 = -_tmp116 * _tmp66 + _tmp117 * _tmp86;
  ...
  const Scalar _tmp123 = -_tmp112 * _tmp93 * (_tmp105 * _tmp52 + _tmp106 * _tmp107 + Scalar(1.0)) -
                         _tmp115 * _tmp93 * (_tmp113 * _tmp52 - _tmp113 * _tmp91) -
                         _tmp122 * _tmp93 * (_tmp107 * _tmp121 + _tmp120 * _tmp52) -
                         _tmp39 * _tmp93 * (_tmp52 * _tmp90 - _tmp90 * _tmp91);
  const Scalar _tmp124 = Scalar(1.0) / (_tmp123);
  const Scalar _tmp125 = Scalar(0.1034955) * _tmp124;
  ...
  const Scalar _tmp131 = -_tmp113 * _tmp81 + _tmp126 * _tmp130;
  const Scalar _tmp132 = Scalar(1.0) * _tmp84;
  const Scalar _tmp133 = _tmp38 * fh1;
  const Scalar _tmp134 = _tmp111 * _tmp133 + Scalar(5.1796800000000003) * _tmp15 + _tmp21 * fv1;
  const Scalar _tmp135 = _tmp126 * _tmp84;
  const Scalar _tmp136 = _tmp128 * _tmp89;
  const Scalar _tmp137 = -_tmp126 * _tmp136 - _tmp81 * _tmp90 + _tmp83;
  const Scalar _tmp138 = _tmp126 * _tmp128;
  const Scalar _tmp139 = -_tmp117 + _tmp119 * _tmp138 - _tmp120 * _tmp81;
  const Scalar _tmp140 = _tmp104 * _tmp138 - _tmp105 * _tmp81 + _tmp97;
  const Scalar _tmp141 = _tmp129 * _tmp86;
  const Scalar _tmp142 = _tmp127 * _tmp129 + Scalar(1.0);
  const Scalar _tmp143 = -_tmp114 * _tmp133 - Scalar(5.1796800000000003) * _tmp28 - _tmp31 * fv1;
  const Scalar _tmp144 = std::asinh(
      _tmp124 * (Scalar(1.0) * _tmp112 * (_tmp104 * _tmp129 - _tmp132 * _tmp140) +
                 Scalar(1.0) * _tmp115 * (_tmp130 - _tmp131 * _tmp132) +
                 Scalar(1.0) * _tmp122 * (_tmp119 * _tmp129 - _tmp132 * _tmp139) +
                 Scalar(1.0) * _tmp134 * (_tmp129 * _tmp135 - _tmp129) +
                 Scalar(1.0) * _tmp143 * (-_tmp132 * _tmp142 + _tmp141) +
                 Scalar(1.0) * _tmp39 * (-_tmp129 * _tmp89 - _tmp132 * _tmp137 + Scalar(1.0))));
  ...
  const Scalar _tmp148 =
      _tmp106 * _tmp112 * _tmp76 + _tmp121 * _tmp122 * _tmp76 - _tmp146 * _tmp79 - _tmp147 * _tmp79;
  const Scalar _tmp149 = Scalar(1.0) / (_tmp148);
  const Scalar _tmp150 = Scalar(0.1034955) * _tmp149;
  const Scalar _tmp151 = _tmp129 * _tmp134;
  const Scalar _tmp152 =
      std::asinh(_tmp149 * (_tmp112 * _tmp140 * _tmp84 + _tmp115 * _tmp131 * _tmp84 +
                            _tmp122 * _tmp139 * _tmp84 - _tmp135 * _tmp151 +
                            _tmp137 * _tmp39 * _tmp84 + _tmp142 * _tmp143 * _tmp84));
  const Scalar _tmp153 = Scalar(9.6622558468725703) * _tmp148;
  const Scalar _tmp154 = _tmp105 * _tmp112 + _tmp120 * _tmp122 + _tmp146 + _tmp147;
  const Scalar _tmp155 = Scalar(1.0) / (_tmp154);
  const Scalar _tmp156 = std::asinh(_tmp155 * (-_tmp104 * _tmp112 * _tmp128 - _tmp115 * _tmp130 -
                                               _tmp119 * _tmp122 * _tmp128 + _tmp136 * _tmp39 -
  ...
  _res(1, 0) =
      -_tmp145 *
          (_tmp125 * p_c(2, 0) + std::cosh(Scalar(1.0) * _tmp144) -
           std::cosh(_tmp125 *
                     (-_tmp144 * _tmp145 -
                      std::sqrt(Scalar(std::pow(Scalar(-_tmp68 + p_c(1, 0)), Scalar(2)) +
                                       std::pow(Scalar(-_tmp71 + p_c(0, 0)), Scalar(2))))))) +
      _tmp41 + p_init2;
  _res(2, 0) =
      -_tmp153 *
          (_tmp150 * p_a(2, 0) + std::cosh(Scalar(1.0) * _tmp152) -
           std::cosh(_tmp150 *
                     (-_tmp152 * _tmp153 -
  ...
  _res(3, 0) =
      -_tmp157 *
          (_tmp158 * p_b(2, 0) + std::cosh(Scalar(1.0) * _tmp156) -
           std::cosh(_tmp158 *
                     (-_tmp156 * _tmp157 -
                      std::sqrt(Scalar(std::pow(Scalar(-_tmp45 + p_b(1, 0)), Scalar(2)) +
