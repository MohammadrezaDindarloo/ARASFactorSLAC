...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2WrtFv1Nl1(
  ...
  const Scalar _tmp23 = 1 - 2 * std::pow(_tmp10, Scalar(2));
  ...
  const Scalar _tmp41 = _tmp20 + _tmp8;
  const Scalar _tmp42 = Scalar(1.0) * _tmp41;
  const Scalar _tmp43 = _tmp16 + _tmp19;
  const Scalar _tmp44 = _tmp43 + _tmp8;
  const Scalar _tmp45 = _tmp24 + _tmp32;
  const Scalar _tmp46 = Scalar(1.0) / (_tmp37 + _tmp45);
  const Scalar _tmp47 = _tmp43 + _tmp9;
  const Scalar _tmp48 = _tmp46 * (_tmp42 - _tmp47);
  const Scalar _tmp49 = _tmp40 * _tmp48;
  const Scalar _tmp50 = Scalar(1.0) / (_tmp42 - _tmp44 - _tmp49);
  const Scalar _tmp51 = Scalar(1.0) * _tmp50;
  const Scalar _tmp52 = _tmp44 + p_init0;
  const Scalar _tmp53 = _tmp52 - p_c(0, 0);
  const Scalar _tmp54 = _tmp39 + p_init1;
  ...
  const Scalar _tmp59 = _tmp35 + p_init1;
  ...
  const Scalar _tmp67 = _tmp66 * (-_tmp35 * _tmp62 * _tmp64 + _tmp41 * _tmp60 * _tmp64);
  ...
  const Scalar _tmp75 = _tmp45 * _tmp73 - _tmp47 * _tmp74 + _tmp67 * _tmp73;
  ...
  const Scalar _tmp80 = _tmp39 * _tmp58 - _tmp44 * _tmp57 + _tmp58 * _tmp67 - _tmp75 * _tmp79;
  const Scalar _tmp81 = Scalar(1.0) / (_tmp80);
  const Scalar _tmp82 = Scalar(0.20999999999999999) * _tmp12 - Scalar(0.20999999999999999) * _tmp14;
  const Scalar _tmp83 = -_tmp82;
  const Scalar _tmp84 =
      -Scalar(0.010999999999999999) * _tmp23 - Scalar(0.010999999999999999) * _tmp5;
  const Scalar _tmp85 = Scalar(0.20999999999999999) * _tmp26 + Scalar(0.20999999999999999) * _tmp27;
  ...
  const Scalar _tmp91 = _tmp77 * (-_tmp73 * _tmp87 + _tmp90);
  const Scalar _tmp92 = _tmp58 * _tmp89;
  const Scalar _tmp93 = _tmp82 + _tmp86;
  const Scalar _tmp94 = _tmp74 * _tmp87 - _tmp76 * _tmp90;
  const Scalar _tmp95 = _tmp57 * _tmp93 - _tmp76 * _tmp92 - _tmp79 * _tmp94;
  const Scalar _tmp96 = -_tmp48 * _tmp95 - _tmp58 * _tmp93 - _tmp78 * _tmp91 + _tmp92;
  ...
  const Scalar _tmp109 = _tmp108 * _tmp94 + _tmp76 * _tmp89;
  const Scalar _tmp110 = -_tmp109 * _tmp48 + _tmp76 * _tmp91 - _tmp89;
  const Scalar _tmp111 = Scalar(1.0) / (_tmp96);
  const Scalar _tmp112 = _tmp111 * _tmp80;
  const Scalar _tmp113 = _tmp97 * (_tmp108 * _tmp75 - _tmp110 * _tmp112 - _tmp67);
  ...
  const Scalar _tmp121 = _tmp120 * _tmp48 - Scalar(1.0) * _tmp91;
  const Scalar _tmp122 = _tmp97 * (-_tmp112 * _tmp121 - _tmp119 * _tmp75);
  const Scalar _tmp123 = _tmp121 + _tmp122;
  const Scalar _tmp124 = _tmp114 * _tmp122 - _tmp116 * _tmp123 - _tmp120;
  const Scalar _tmp125 = _tmp105 * fh1;
  const Scalar _tmp126 = fh1 * (_tmp83 + _tmp88);
  const Scalar _tmp127 = -_tmp105 * _tmp126 - Scalar(5.1796800000000003) * _tmp28 - _tmp33 * fv1;
  const Scalar _tmp128 = _tmp46 * (_tmp49 * _tmp51 + Scalar(1.0));
  const Scalar _tmp129 = _tmp48 * _tmp51;
  const Scalar _tmp130 = -Scalar(1.0) * _tmp128 + Scalar(1.0) * _tmp129;
  const Scalar _tmp131 = _tmp106 * _tmp126 + Scalar(5.1796800000000003) * _tmp15 + _tmp21 * fv1;
  const Scalar _tmp132 = _tmp40 * _tmp46;
  const Scalar _tmp133 = Scalar(1.0) * _tmp132 * _tmp51 - Scalar(1.0) * _tmp51;
  const Scalar _tmp134 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp135 = _tmp36 * _tmp48 + _tmp42;
  const Scalar _tmp136 = _tmp135 * _tmp50;
  const Scalar _tmp137 = 0;
  const Scalar _tmp138 = _tmp46 * (-_tmp116 * _tmp137 - _tmp136 * _tmp40 + _tmp37);
  ...
  const Scalar _tmp141 = _tmp111 * _tmp78;
  const Scalar _tmp142 = -_tmp123 * _tmp141 + Scalar(1.0);
  const Scalar _tmp143 = _tmp73 * _tmp77;
  const Scalar _tmp144 = _tmp111 * _tmp58;
  const Scalar _tmp145 = -_tmp115 * _tmp141 - _tmp76;
  const Scalar _tmp146 = _tmp111 * _tmp137;
  const Scalar _tmp147 = _tmp137 * _tmp141;
  const Scalar _tmp148 = _tmp66 * (-_tmp143 * _tmp147 + _tmp146 * _tmp58);
  const Scalar _tmp149 = -_tmp107 * _tmp66 * (_tmp58 * _tmp99 - _tmp73 * _tmp79 * _tmp99) -
                         _tmp118 * _tmp66 * (_tmp115 * _tmp144 + _tmp143 * _tmp145 + Scalar(1.0)) -
                         _tmp125 * _tmp66 * (_tmp123 * _tmp144 + _tmp142 * _tmp143) -
                         _tmp134 * _tmp148;
  ...
  const Scalar _tmp154 =
      -_tmp151 * _tmp153 - std::sqrt(Scalar(std::pow(Scalar(-_tmp59 + p_b(1, 0)), Scalar(2)) +
  ...
  const Scalar _tmp160 = _tmp29 + _tmp38;
  const Scalar _tmp161 =
      (-_tmp140 * _tmp159 + _tmp150 * (_tmp130 * _tmp160 + _tmp133 * _tmp21 - _tmp139)) /
      std::sqrt(Scalar(std::pow(_tmp140, Scalar(2)) * _tmp158 + 1));
  const Scalar _tmp162 = _tmp107 * _tmp99;
  const Scalar _tmp163 = _tmp147 * _tmp77;
  const Scalar _tmp164 = _tmp118 * _tmp145 * _tmp77 + _tmp125 * _tmp142 * _tmp77 -
                         _tmp134 * _tmp163 - _tmp162 * _tmp79;
  const Scalar _tmp165 = Scalar(1.0) / (_tmp164);
  const Scalar _tmp166 = _tmp131 * _tmp51;
  const Scalar _tmp167 = _tmp100 * _tmp107 * _tmp46 + _tmp117 * _tmp118 * _tmp46 +
                         _tmp124 * _tmp125 * _tmp46 + _tmp127 * _tmp128 - _tmp132 * _tmp166 +
                         _tmp134 * _tmp138;
  ...
  const Scalar _tmp172 = _tmp21 * _tmp51;
  const Scalar _tmp173 =
      (_tmp165 * (_tmp128 * _tmp160 - _tmp132 * _tmp172 - _tmp138) - _tmp167 * _tmp171) /
      std::sqrt(Scalar(std::pow(_tmp167, Scalar(2)) * _tmp170 + 1));
  const Scalar _tmp174 = Scalar(9.6622558468725703) * _tmp164;
  const Scalar _tmp175 =
      -_tmp168 * _tmp174 - std::sqrt(Scalar(std::pow(Scalar(-_tmp68 + p_d(1, 0)), Scalar(2)) +
  ...
  const Scalar _tmp179 =
      _tmp111 * _tmp115 * _tmp118 + _tmp111 * _tmp123 * _tmp125 + _tmp134 * _tmp146 + _tmp162;
  const Scalar _tmp180 = Scalar(1.0) / (_tmp179);
  const Scalar _tmp181 = -_tmp107 * _tmp98 - _tmp113 * _tmp118 * _tmp50 -
                         _tmp122 * _tmp125 * _tmp50 - _tmp127 * _tmp129 + _tmp134 * _tmp136 +
                         _tmp166;
  ...
  const Scalar _tmp185 =
      -_tmp182 * _tmp184 - std::sqrt(Scalar(std::pow(Scalar(-_tmp52 + p_c(0, 0)), Scalar(2)) +
                                            std::pow(Scalar(-_tmp54 + p_c(1, 0)), Scalar(2))));
  const Scalar _tmp186 = Scalar(0.1034955) * _tmp180;
  const Scalar _tmp187 = _tmp185 * _tmp186;
  const Scalar _tmp188 = Scalar(9.6622558468725703) * _tmp146;
  const Scalar _tmp189 = std::pow(_tmp179, Scalar(-2));
  const Scalar _tmp190 = _tmp146 * _tmp189;
  const Scalar _tmp191 = (_tmp180 * (-_tmp129 * _tmp160 - _tmp136 + _tmp172) + _tmp181 * _tmp190) /
  ...
  _res(2, 0) = _tmp174 * (-Scalar(1.0) * _tmp173 * std::cosh(_tmp169) -
                          (-Scalar(0.1034955) * _tmp171 * _tmp175 +
                           _tmp177 * (-_tmp168 * _tmp176 - _tmp173 * _tmp174)) *
                              std::cosh(_tmp178)) +
               _tmp176 * (-std::sinh(_tmp169) - std::sinh(_tmp178));
