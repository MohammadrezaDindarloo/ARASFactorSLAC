...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2WrtFv1Nl15(
  ...
  const Scalar _tmp66 = -Scalar(5.1796800000000003) * _tmp26 - _tmp31 * fv1 - _tmp41 * _tmp65;
  const Scalar _tmp67 = _tmp57 * (_tmp60 * _tmp62 + Scalar(1.0));
  ...
  const Scalar _tmp74 = _tmp58 + p_init0;
  ...
  const Scalar _tmp103 = _tmp101 * _tmp86;
  const Scalar _tmp104 = _tmp103 * (_tmp102 * _tmp44 * _tmp83 - _tmp102 * _tmp49 * _tmp85);
  const Scalar _tmp105 = _tmp98 * _tmp99;
  const Scalar _tmp106 = _tmp104 * _tmp77 + _tmp56 * _tmp77 - _tmp58 * _tmp88;
  const Scalar _tmp107 = _tmp100 * _tmp87 - _tmp105;
  const Scalar _tmp108 = _tmp107 * _tmp89;
  const Scalar _tmp109 =
      _tmp100 * _tmp104 + _tmp100 * _tmp54 - _tmp105 * _tmp47 - _tmp106 * _tmp108;
  const Scalar _tmp110 = _tmp70 + _tmp78;
  const Scalar _tmp111 = -_tmp100 * _tmp91 + _tmp105 * _tmp110 - _tmp108 * _tmp92;
  const Scalar _tmp112 =
      -_tmp100 * _tmp110 + _tmp100 * _tmp79 - _tmp108 * _tmp81 - _tmp111 * _tmp59;
  ...
  const Scalar _tmp117 = _tmp116 * (-_tmp104 + _tmp106 * _tmp90 - _tmp114 * _tmp94);
  const Scalar _tmp118 = _tmp117 + _tmp94;
  const Scalar _tmp119 = _tmp111 * _tmp113;
  const Scalar _tmp120 = _tmp55 * _tmp61;
  const Scalar _tmp121 = _tmp117 * _tmp120 - _tmp118 * _tmp119 + _tmp93;
  const Scalar _tmp122 = Scalar(1.0) * _tmp57;
  const Scalar _tmp123 = _tmp36 * fh1;
  const Scalar _tmp124 = Scalar(1.0) * _tmp89;
  const Scalar _tmp125 = _tmp124 * _tmp92;
  const Scalar _tmp126 = -_tmp124 * _tmp81 + _tmp125 * _tmp59;
  const Scalar _tmp127 = _tmp116 * (-_tmp106 * _tmp124 - _tmp114 * _tmp126);
  const Scalar _tmp128 = _tmp126 + _tmp127;
  const Scalar _tmp129 = -_tmp119 * _tmp128 + _tmp120 * _tmp127 - _tmp125;
  const Scalar _tmp130 = _tmp65 * fh1;
  const Scalar _tmp131 = Scalar(1.0) * _tmp115;
  const Scalar _tmp132 = _tmp116 * _tmp62;
  const Scalar _tmp133 = -_tmp111 * _tmp131 + _tmp132 * _tmp55;
  const Scalar _tmp134 = fh1 * (_tmp20 * _tmp65 - _tmp31 * _tmp36);
  const Scalar _tmp135 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp136 = _tmp45 + _tmp50 * _tmp59;
  const Scalar _tmp137 = _tmp136 * _tmp61;
  const Scalar _tmp138 = 0;
  const Scalar _tmp139 = _tmp57 * (-_tmp119 * _tmp138 - _tmp137 * _tmp55 + _tmp51);
  const Scalar _tmp140 = -Scalar(1.0) * _tmp137 - Scalar(1.0) * _tmp139 + Scalar(1.0);
  const Scalar _tmp141 = Scalar(1.0) * _tmp123 * (_tmp117 * _tmp62 - _tmp121 * _tmp122) +
                         Scalar(1.0) * _tmp130 * (-_tmp122 * _tmp129 + _tmp127 * _tmp62) +
                         Scalar(1.0) * _tmp134 * (-_tmp122 * _tmp133 + _tmp132) +
                         _tmp135 * _tmp140 + _tmp42 * _tmp64 + _tmp66 * _tmp69;
  const Scalar _tmp142 = _tmp77 * _tmp89;
  const Scalar _tmp143 = _tmp107 * _tmp113;
  const Scalar _tmp144 = _tmp138 * _tmp143;
  const Scalar _tmp145 = _tmp113 * _tmp138;
  const Scalar _tmp146 = _tmp103 * (_tmp100 * _tmp145 - _tmp142 * _tmp144);
  const Scalar _tmp147 = _tmp100 * _tmp113;
  const Scalar _tmp148 = -_tmp128 * _tmp143 + Scalar(1.0);
  const Scalar _tmp149 = -_tmp118 * _tmp143 - _tmp87;
  const Scalar _tmp150 = _tmp107 * _tmp115 * _tmp124;
  const Scalar _tmp151 =
      -_tmp103 * _tmp123 * (_tmp118 * _tmp147 + _tmp142 * _tmp149 + Scalar(1.0)) -
      _tmp103 * _tmp130 * (_tmp128 * _tmp147 + _tmp142 * _tmp148) -
      _tmp103 * _tmp134 * (_tmp100 * _tmp131 - _tmp150 * _tmp77) - _tmp135 * _tmp146;
  ...
  const Scalar _tmp155 =
      -_tmp153 * _tmp154 - std::sqrt(Scalar(std::pow(Scalar(-_tmp82 + p_b(1, 0)), Scalar(2)) +
  ...
  const Scalar _tmp159 = _tmp27 + _tmp48 + _tmp52;
  const Scalar _tmp160 = _tmp146 * _tmp158;
  const Scalar _tmp161 =
      (-_tmp141 * _tmp160 + _tmp152 * (-_tmp140 + _tmp159 * _tmp69 + _tmp20 * _tmp64)) /
      std::sqrt(Scalar(std::pow(_tmp141, Scalar(2)) * _tmp158 + 1));
  const Scalar _tmp162 = Scalar(9.6622558468725703) * _tmp146;
  const Scalar _tmp163 = Scalar(1.0) * _tmp153;
  const Scalar _tmp164 = _tmp144 * _tmp89;
  const Scalar _tmp165 = _tmp123 * _tmp149 * _tmp89 + _tmp130 * _tmp148 * _tmp89 -
                         _tmp134 * _tmp150 - _tmp135 * _tmp164;
  const Scalar _tmp166 = Scalar(1.0) / (_tmp165);
  const Scalar _tmp167 = _tmp42 * _tmp62;
  const Scalar _tmp168 = _tmp121 * _tmp123 * _tmp57 + _tmp129 * _tmp130 * _tmp57 +
                         _tmp133 * _tmp134 * _tmp57 + _tmp135 * _tmp139 - _tmp167 * _tmp63 +
                         _tmp66 * _tmp67;
  const Scalar _tmp169 = std::asinh(_tmp166 * _tmp168);
  const Scalar _tmp170 = Scalar(9.6622558468725703) * _tmp165;
  const Scalar _tmp171 =
      -_tmp169 * _tmp170 - std::sqrt(Scalar(std::pow(Scalar(-_tmp72 + p_d(1, 0)), Scalar(2)) +
  ...
  const Scalar _tmp175 = _tmp20 * _tmp62;
  const Scalar _tmp176 =
      (_tmp166 * (-_tmp139 + _tmp159 * _tmp67 - _tmp175 * _tmp63) - _tmp168 * _tmp173) /
  ...
  const Scalar _tmp180 = -_tmp117 * _tmp123 * _tmp61 - _tmp127 * _tmp130 * _tmp61 -
                         _tmp132 * _tmp134 + _tmp135 * _tmp137 + _tmp167 - _tmp66 * _tmp68;
  const Scalar _tmp181 = _tmp113 * _tmp118 * _tmp123 + _tmp113 * _tmp128 * _tmp130 +
                         _tmp131 * _tmp134 + _tmp135 * _tmp145;
  ...
  _res(1, 0) = _tmp154 * (-Scalar(1.0) * _tmp161 * std::cosh(_tmp163) -
                          (-Scalar(0.1034955) * _tmp155 * _tmp160 +
                           _tmp156 * (-_tmp153 * _tmp162 - _tmp154 * _tmp161)) *
                              std::cosh(_tmp157)) +
               _tmp162 * (-std::sinh(_tmp157) - std::sinh(_tmp163));
  _res(2, 0) = _tmp170 * (-Scalar(1.0) * _tmp176 * std::cosh(_tmp179) -
                          (-Scalar(0.1034955) * _tmp171 * _tmp173 +
                           _tmp177 * (-_tmp169 * _tmp174 - _tmp170 * _tmp176)) *
                              std::cosh(_tmp178)) +
