...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl12(
  ...
  const Scalar _tmp12 = _tmp6 * _tmp9;
  ...
  const Scalar _tmp19 = -Scalar(0.20999999999999999) * _tmp10 + Scalar(0.20999999999999999) * _tmp7;
  const Scalar _tmp20 = _tmp1 * _tmp9;
  const Scalar _tmp21 = _tmp13 * _tmp6;
  const Scalar _tmp22 =
  ...
  const Scalar _tmp33 = Scalar(0.20999999999999999) * _tmp12 + Scalar(0.20999999999999999) * _tmp14;
  const Scalar _tmp34 = _tmp32 - _tmp33;
  const Scalar _tmp35 = _tmp31 + _tmp34;
  const Scalar _tmp36 = _tmp29 * _tmp35;
  const Scalar _tmp37 = _tmp31 + _tmp32 + _tmp33;
  const Scalar _tmp38 = _tmp18 * _tmp28;
  const Scalar _tmp39 = -_tmp5;
  const Scalar _tmp40 = _tmp16 + _tmp39;
  const Scalar _tmp41 = _tmp40 - p_a(1, 0) + p_init1;
  ...
  const Scalar _tmp57 = Scalar(1.0) / (_tmp46 * _tmp55 - _tmp56);
  const Scalar _tmp58 = _tmp35 * _tmp46;
  const Scalar _tmp59 = _tmp30 + _tmp34;
  const Scalar _tmp60 = _tmp57 * (-_tmp55 * _tmp58 + _tmp56 * _tmp59);
  const Scalar _tmp61 = Scalar(1.0) * _tmp40;
  const Scalar _tmp62 = Scalar(1.0) * _tmp43;
  const Scalar _tmp63 = (-_tmp52 + _tmp62) / (_tmp49 - _tmp61);
  const Scalar _tmp64 = _tmp57 * (_tmp35 * _tmp55 - _tmp55 * _tmp59);
  const Scalar _tmp65 = -_tmp29 * _tmp37 + _tmp36 - _tmp47 * _tmp64 -
                        _tmp63 * (-_tmp36 * _tmp46 + _tmp37 * _tmp38 - _tmp47 * _tmp60);
  ...
  const Scalar _tmp71 = _tmp47 * _tmp66;
  ...
  const Scalar _tmp76 = _tmp74 * (-_tmp40 * _tmp44 * _tmp75 + _tmp41 * _tmp43 * _tmp75);
  const Scalar _tmp77 = _tmp57 * (_tmp49 * _tmp55 - _tmp52 * _tmp56 + _tmp55 * _tmp76);
  const Scalar _tmp78 = _tmp17 * _tmp29 - _tmp26 * _tmp38 + _tmp29 * _tmp76 - _tmp47 * _tmp77;
  const Scalar _tmp79 = Scalar(1.0) / (_tmp78);
  const Scalar _tmp80 = Scalar(1.0) * _tmp79;
  const Scalar _tmp81 = _tmp19 + _tmp51;
  const Scalar _tmp82 = _tmp81 - p_c(0, 0) + p_init0;
  const Scalar _tmp83 = _tmp48 + _tmp5;
  const Scalar _tmp84 = _tmp83 - p_c(1, 0) + p_init1;
  ...
  const Scalar _tmp89 = Scalar(1.0) * _tmp60 * _tmp63 - Scalar(1.0) * _tmp64;
  const Scalar _tmp90 = _tmp66 * _tmp78;
  const Scalar _tmp91 = _tmp65 * _tmp79;
  const Scalar _tmp92 = _tmp89 + _tmp91 * (-Scalar(1.0) * _tmp77 - _tmp89 * _tmp90);
  const Scalar _tmp93 = -_tmp71 * _tmp92 + Scalar(1.0);
  const Scalar _tmp94 = _tmp29 * _tmp66;
  const Scalar _tmp95 = _tmp74 * fh1;
  const Scalar _tmp96 = -_tmp35 + _tmp46 * _tmp64 - _tmp63 * (_tmp46 * _tmp60 + _tmp58);
  const Scalar _tmp97 = _tmp91 * (_tmp46 * _tmp77 - _tmp76 - _tmp90 * _tmp96) + _tmp96;
  const Scalar _tmp98 = -_tmp46 - _tmp71 * _tmp97;
  const Scalar _tmp99 = _tmp80 * _tmp88;
  ...
  _res(1, 0) = std::exp(_tmp0 * _tmp74 * (_tmp29 * _tmp69 - _tmp70 * _tmp72) +
                        _tmp74 * _tmp88 * (_tmp29 * _tmp80 - _tmp47 * _tmp70 * _tmp80) +
                        _tmp86 * _tmp95 * (_tmp70 * _tmp93 + _tmp92 * _tmp94) +
                        _tmp87 * _tmp95 * (_tmp70 * _tmp98 + _tmp94 * _tmp97 + Scalar(1.0)));
  _res(2, 0) = std::exp(_tmp0 * _tmp57 * _tmp72 - _tmp100 * _tmp86 * _tmp93 -
                        _tmp100 * _tmp87 * _tmp98 + _tmp47 * _tmp57 * _tmp99);
  _res(3, 0) =
      std::exp(-_tmp0 * _tmp69 - _tmp101 * _tmp86 * _tmp92 - _tmp101 * _tmp87 * _tmp97 - _tmp99);
