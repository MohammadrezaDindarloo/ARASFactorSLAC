...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl14(
  ...
  const Scalar _tmp94 = Scalar(1.0) * _tmp48 * _tmp51 - Scalar(1.0) * _tmp53;
  const Scalar _tmp95 = _tmp76 * (-Scalar(1.0) * _tmp72 - _tmp74 * _tmp94) + _tmp94;
  ...
  _res(1, 0) = std::exp(_tmp100 * _tmp70 * (-_tmp42 * _tmp64 * _tmp99 + _tmp61 * _tmp99) +
                        _tmp70 * _tmp88 * (_tmp77 * _tmp81 + _tmp79 * _tmp80 + Scalar(1.0)) +
                        _tmp70 * _tmp89 * (_tmp61 * _tmp92 - _tmp80 * _tmp93) +
                        _tmp70 * _tmp98 * (_tmp80 * _tmp96 + _tmp81 * _tmp95));
  _res(2, 0) = std::exp(_tmp101 * _tmp64 - _tmp44 * _tmp79 * _tmp88 + _tmp44 * _tmp89 * _tmp93 -
                        _tmp44 * _tmp96 * _tmp98);
  _res(3, 0) =
      std::exp(-_tmp101 - _tmp67 * _tmp77 * _tmp88 - _tmp67 * _tmp95 * _tmp98 - _tmp89 * _tmp92);
