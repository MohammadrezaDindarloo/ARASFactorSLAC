...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl20(
  ...
  const Scalar _tmp26 = _tmp25 - p_c(0, 0) + p_init0;
  ...
  const Scalar _tmp32 = _tmp31 - p_c(1, 0) + p_init1;
  ...
  const Scalar _tmp46 = _tmp12 - _tmp15 + _tmp9;
  const Scalar _tmp47 = -_tmp22 + _tmp23;
  ...
  const Scalar _tmp52 = _tmp51 - p_a(1, 0) + p_init1;
  ...
  const Scalar _tmp57 = -_tmp45 * _tmp56 + _tmp46 * _tmp54;
  const Scalar _tmp58 = Scalar(1.0) / (_tmp45 * _tmp55 - _tmp54);
  const Scalar _tmp59 = _tmp34 * _tmp45 - _tmp37;
  const Scalar _tmp60 = _tmp58 * _tmp59;
  const Scalar _tmp61 = Scalar(1.0) * _tmp39;
  const Scalar _tmp62 = Scalar(1.0) * _tmp42;
  const Scalar _tmp63 = (-_tmp48 + _tmp62) / (_tmp51 - _tmp61);
  const Scalar _tmp64 = -_tmp46 * _tmp55 + _tmp56;
  const Scalar _tmp65 = -_tmp34 * _tmp36 + _tmp35 - _tmp60 * _tmp64 -
                        _tmp63 * (-_tmp35 * _tmp45 + _tmp36 * _tmp37 - _tmp57 * _tmp60);
  ...
  const Scalar _tmp73 = _tmp57 * _tmp63 * _tmp72 - _tmp64 * _tmp72;
  const Scalar _tmp74 = Scalar(1.0) / (_tmp70);
  const Scalar _tmp75 = _tmp71 * (-_tmp39 * _tmp43 * _tmp74 + _tmp40 * _tmp42 * _tmp74);
  const Scalar _tmp76 = -_tmp48 * _tmp54 + _tmp51 * _tmp55 + _tmp55 * _tmp75;
  const Scalar _tmp77 = -_tmp25 * _tmp37 + _tmp31 * _tmp34 + _tmp34 * _tmp75 - _tmp60 * _tmp76;
  ...
  const Scalar _tmp84 = _tmp55 * _tmp58;
  const Scalar _tmp85 = _tmp34 * _tmp66;
  const Scalar _tmp86 = _tmp30 + _tmp50;
  const Scalar _tmp87 = _tmp86 - p_d(1, 0) + p_init1;
  const Scalar _tmp88 = _tmp20 + _tmp47;
  ...
  const Scalar _tmp97 = -_tmp17 - _tmp63 * (_tmp17 * _tmp45 + _tmp57 * _tmp96) + _tmp64 * _tmp96;
  const Scalar _tmp98 = _tmp80 * (-_tmp75 + _tmp76 * _tmp96 - _tmp78 * _tmp97) + _tmp97;
  const Scalar _tmp99 = -_tmp45 - _tmp82 * _tmp98;
  ...
  _res(1, 0) = std::exp(_tmp0 * _tmp71 * (_tmp34 * _tmp68 - _tmp68 * _tmp69) +
                        _tmp71 * _tmp95 * (_tmp34 * _tmp93 - _tmp69 * _tmp93) +
                        _tmp91 * _tmp92 * (_tmp81 * _tmp85 + _tmp83 * _tmp84) +
                        _tmp92 * _tmp94 * (_tmp84 * _tmp99 + _tmp85 * _tmp98 + Scalar(1.0)));
  _res(2, 0) = std::exp(_tmp100 * _tmp60 - _tmp101 * _tmp83 * _tmp91 - _tmp101 * _tmp94 * _tmp99 +
                        _tmp102 * _tmp60);
  _res(3, 0) = std::exp(-_tmp100 - _tmp102 - _tmp103 * _tmp81 * _tmp91 - _tmp103 * _tmp94 * _tmp98);
