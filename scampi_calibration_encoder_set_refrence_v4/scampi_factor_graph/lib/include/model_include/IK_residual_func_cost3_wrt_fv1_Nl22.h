...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl22(
  ...
  const Scalar _tmp35 = -_tmp14 + _tmp5;
  ...
  const Scalar _tmp40 = _tmp39 - p_a(0, 0) + p_init0;
  ...
  const Scalar _tmp64 = -_tmp33 * _tmp36 + _tmp34 - _tmp47 * _tmp59 -
                        _tmp63 * (-_tmp34 * _tmp54 + _tmp36 * _tmp55 - _tmp59 * _tmp60);
  ...
  const Scalar _tmp70 = _tmp56 * _tmp65;
  ...
  const Scalar _tmp74 = _tmp73 * (_tmp33 * _tmp68 - _tmp69 * _tmp71);
  const Scalar _tmp75 = Scalar(1.0) / (_tmp72);
  const Scalar _tmp76 = _tmp73 * (-_tmp49 * _tmp52 * _tmp75 + _tmp50 * _tmp51 * _tmp75);
  const Scalar _tmp77 = _tmp54 * _tmp58;
  const Scalar _tmp78 = -_tmp15 + _tmp47 * _tmp77 - _tmp63 * (_tmp15 * _tmp54 + _tmp60 * _tmp77);
  const Scalar _tmp79 = -_tmp39 * _tmp57 + _tmp42 * _tmp45 + _tmp45 * _tmp76;
  const Scalar _tmp80 = _tmp23 * _tmp33 - _tmp30 * _tmp55 + _tmp33 * _tmp76 - _tmp59 * _tmp79;
  const Scalar _tmp81 = _tmp65 * _tmp80;
  const Scalar _tmp82 = Scalar(1.0) / (_tmp80);
  const Scalar _tmp83 = _tmp64 * _tmp82;
  const Scalar _tmp84 = _tmp78 + _tmp83 * (-_tmp76 + _tmp77 * _tmp79 - _tmp78 * _tmp81);
  const Scalar _tmp85 = _tmp33 * _tmp65;
  const Scalar _tmp86 = -_tmp54 - _tmp70 * _tmp84;
  const Scalar _tmp87 = _tmp41 + _tmp48;
  const Scalar _tmp88 = _tmp87 - p_d(1, 0) + p_init1;
  const Scalar _tmp89 = _tmp25 + _tmp38;
  ...
  const Scalar _tmp94 = Scalar(1.0) * _tmp82;
  const Scalar _tmp95 = _tmp88 * _tmp91;
  const Scalar _tmp96 = fh1 * (-_tmp87 * _tmp92 + _tmp89 * _tmp95);
  const Scalar _tmp97 = Scalar(1.0) * _tmp58;
  const Scalar _tmp98 = -_tmp47 * _tmp97 + _tmp60 * _tmp63 * _tmp97;
  const Scalar _tmp99 = _tmp83 * (-_tmp79 * _tmp97 - _tmp81 * _tmp98) + _tmp98;
  const Scalar _tmp100 = -_tmp70 * _tmp99 + Scalar(1.0);
  const Scalar _tmp101 = _tmp95 * fh1;
  const Scalar _tmp102 = _tmp58 * _tmp71;
  ...
  _res(0, 0) = 0;
  _res(1, 0) =
      -_tmp74 * std::exp(_tmp0 * _tmp74 + _tmp101 * _tmp73 * (_tmp100 * _tmp69 + _tmp85 * _tmp99) +
                         _tmp73 * _tmp93 * (_tmp69 * _tmp86 + _tmp84 * _tmp85 + Scalar(1.0)) +
                         _tmp73 * _tmp96 * (_tmp33 * _tmp94 - _tmp45 * _tmp59 * _tmp94));
  _res(2, 0) = -_tmp102 * std::exp(_tmp0 * _tmp102 - _tmp100 * _tmp101 * _tmp58 + _tmp103 * _tmp59 -
                                   _tmp58 * _tmp86 * _tmp93);
  _res(3, 0) = _tmp68 * std::exp(-_tmp0 * _tmp68 - _tmp101 * _tmp65 * _tmp99 - _tmp103 -
                                 _tmp65 * _tmp84 * _tmp93);
