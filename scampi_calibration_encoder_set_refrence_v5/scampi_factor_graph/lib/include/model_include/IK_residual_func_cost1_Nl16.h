...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl16(
  ...
  const Scalar _tmp73 = -_tmp54 * _tmp65 + _tmp67 * _tmp72;
  const Scalar _tmp74 = _tmp28 + _tmp44;
  const Scalar _tmp75 = _tmp74 + p_init1;
  const Scalar _tmp76 = _tmp75 - p_b(1, 0);
  const Scalar _tmp77 = _tmp40 + _tmp7;
  ...
  const Scalar _tmp83 = _tmp62 * _tmp81 - _tmp82;
  const Scalar _tmp84 = _tmp64 * _tmp83;
  const Scalar _tmp85 = _tmp32 + _tmp52;
  const Scalar _tmp86 = _tmp38 * _tmp62;
  const Scalar _tmp87 = -_tmp66 * _tmp84 - _tmp81 * _tmp86 + _tmp82 * _tmp85;
  const Scalar _tmp88 = _tmp38 * _tmp81 - _tmp54 * _tmp84 - _tmp72 * _tmp87 - _tmp81 * _tmp85;
  ...
  const Scalar _tmp94 = -_tmp41 * _tmp63 + _tmp46 * _tmp50 + _tmp50 * _tmp93;
  const Scalar _tmp95 = _tmp74 * _tmp81 - _tmp77 * _tmp82 + _tmp81 * _tmp93 - _tmp84 * _tmp94;
  ...
  const Scalar _tmp102 = Scalar(1.0) / (-_tmp101 + _tmp71 - _tmp77);
  const Scalar _tmp103 = _tmp100 * _tmp102;
  const Scalar _tmp104 = _tmp73 + _tmp99;
  ...
  const Scalar _tmp118 = -_tmp100 * _tmp116 - _tmp105 * _tmp117 + _tmp69;
  const Scalar _tmp119 = _tmp36 * fh1;
  const Scalar _tmp120 = -_tmp112 * _tmp119 - Scalar(3.29616) * _tmp26 - _tmp29 * fv1;
  const Scalar _tmp121 = _tmp101 * _tmp108 + Scalar(1.0);
  const Scalar _tmp122 = _tmp108 * _tmp72;
  const Scalar _tmp123 = _tmp62 * _tmp64;
  const Scalar _tmp124 = _tmp123 * _tmp66 + _tmp86;
  const Scalar _tmp125 = _tmp123 * _tmp54 - _tmp124 * _tmp72 - _tmp38;
  const Scalar _tmp126 = _tmp98 * (_tmp123 * _tmp94 - _tmp125 * _tmp96 - _tmp93);
  const Scalar _tmp127 = _tmp125 + _tmp126;
  const Scalar _tmp128 = _tmp103 * _tmp126 - _tmp105 * _tmp127 + _tmp124;
  const Scalar _tmp129 = _tmp109 * _tmp111;
  const Scalar _tmp130 = _tmp129 * fh1;
  const Scalar _tmp131 = _tmp119 * _tmp129 + Scalar(3.29616) * _tmp13 + _tmp19 * fv1;
  const Scalar _tmp132 = _tmp100 * _tmp70;
  const Scalar _tmp133 = _tmp108 * _tmp98;
  const Scalar _tmp134 = Scalar(1.0) * _tmp97;
  const Scalar _tmp135 = _tmp100 * _tmp133 - _tmp134 * _tmp87;
  const Scalar _tmp136 = fh1 * (_tmp112 * _tmp19 - _tmp129 * _tmp29);
  const Scalar _tmp137 = _tmp81 * _tmp89;
  const Scalar _tmp138 = _tmp83 * _tmp89;
  const Scalar _tmp139 = -_tmp127 * _tmp138 - _tmp62;
  const Scalar _tmp140 = _tmp50 * _tmp64;
  const Scalar _tmp141 = _tmp65 * _tmp83 * _tmp97;
  const Scalar _tmp142 = -_tmp104 * _tmp138 + Scalar(1.0);
  const Scalar _tmp143 = _tmp117 * _tmp89;
  const Scalar _tmp144 = -_tmp113 * _tmp92 * (_tmp104 * _tmp137 + _tmp140 * _tmp142) -
                         _tmp114 * _tmp92 * (-_tmp143 * _tmp50 * _tmp84 + _tmp143 * _tmp81) -
                         _tmp130 * _tmp92 * (_tmp127 * _tmp137 + _tmp139 * _tmp140 + Scalar(1.0)) -
                         _tmp136 * _tmp92 * (_tmp134 * _tmp81 - _tmp141 * _tmp50);
  const Scalar _tmp145 = Scalar(1.0) / (_tmp144);
  const Scalar _tmp146 = std::asinh(
      _tmp145 * (Scalar(1.0) * _tmp113 * (-_tmp106 * _tmp107 + _tmp108 * _tmp99) +
                 Scalar(1.0) * _tmp114 * (-_tmp107 * _tmp118 - _tmp108 * _tmp115 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp120 * (-_tmp107 * _tmp121 + _tmp122) +
                 Scalar(1.0) * _tmp130 * (-_tmp107 * _tmp128 + _tmp108 * _tmp126) +
                 Scalar(1.0) * _tmp131 * (_tmp108 * _tmp132 - _tmp108) +
                 Scalar(1.0) * _tmp136 * (-_tmp107 * _tmp135 + _tmp133)));
  const Scalar _tmp147 = Scalar(9.6622558468725703) * _tmp144;
  const Scalar _tmp148 = Scalar(0.1034955) * _tmp145;
  const Scalar _tmp149 = _tmp114 * _tmp143;
  const Scalar _tmp150 = _tmp113 * _tmp142 * _tmp64 + _tmp130 * _tmp139 * _tmp64 -
                         _tmp136 * _tmp141 - _tmp149 * _tmp84;
  const Scalar _tmp151 = Scalar(1.0) / (_tmp150);
  const Scalar _tmp152 = Scalar(0.1034955) * _tmp151;
  const Scalar _tmp153 = _tmp108 * _tmp131;
  const Scalar _tmp154 =
      std::asinh(_tmp151 * (_tmp106 * _tmp113 * _tmp70 + _tmp114 * _tmp118 * _tmp70 +
                            _tmp120 * _tmp121 * _tmp70 + _tmp128 * _tmp130 * _tmp70 -
                            _tmp132 * _tmp153 + _tmp135 * _tmp136 * _tmp70));
  const Scalar _tmp155 = Scalar(9.6622558468725703) * _tmp150;
  const Scalar _tmp156 =
      _tmp104 * _tmp113 * _tmp89 + _tmp127 * _tmp130 * _tmp89 + _tmp134 * _tmp136 + _tmp149;
  const Scalar _tmp157 = Scalar(1.0) / (_tmp156);
  const Scalar _tmp158 =
      std::asinh(_tmp157 * (-_tmp102 * _tmp113 * _tmp99 - _tmp102 * _tmp126 * _tmp130 +
                            _tmp114 * _tmp116 - _tmp120 * _tmp122 - _tmp133 * _tmp136 + _tmp153));
  ...
  _res(1, 0) =
      -_tmp147 *
          (_tmp148 * p_d(2, 0) + std::cosh(Scalar(1.0) * _tmp146) -
           std::cosh(_tmp148 *
                     (-_tmp146 * _tmp147 -
                      std::sqrt(Scalar(std::pow(Scalar(-_tmp56 + p_d(1, 0)), Scalar(2)) +
  ...
  _res(3, 0) =
      -_tmp159 *
          (_tmp160 * p_b(2, 0) + std::cosh(Scalar(1.0) * _tmp158) -
           std::cosh(_tmp160 *
                     (-_tmp158 * _tmp159 -
                      std::sqrt(Scalar(std::pow(Scalar(-_tmp75 + p_b(1, 0)), Scalar(2)) +
                                       std::pow(Scalar(-_tmp78 + p_b(0, 0)), Scalar(2))))))) +
      _tmp85 + p_init2;
