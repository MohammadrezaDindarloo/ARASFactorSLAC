...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1WrtFv1Nl21(
  ...
  const Scalar _tmp49 = _tmp22 + _tmp31;
  ...
  const Scalar _tmp66 = -_tmp46 * _tmp53 + _tmp49 * _tmp54 + _tmp54 * _tmp65;
  const Scalar _tmp67 = _tmp57 * _tmp63;
  const Scalar _tmp68 = Scalar(1.0) / (-_tmp53 + _tmp54 * _tmp67);
  const Scalar _tmp69 = _tmp43 * _tmp44;
  const Scalar _tmp70 = _tmp45 * _tmp67 - _tmp69;
  const Scalar _tmp71 = _tmp68 * _tmp70;
  const Scalar _tmp72 = -_tmp36 * _tmp69 + _tmp41 * _tmp45 + _tmp45 * _tmp65 - _tmp66 * _tmp71;
  const Scalar _tmp73 = Scalar(1.0) / (_tmp72);
  const Scalar _tmp74 = Scalar(1.0) * _tmp73;
  const Scalar _tmp75 = Scalar(1.0) * _tmp68;
  const Scalar _tmp76 = _tmp70 * _tmp73 * _tmp75;
  const Scalar _tmp77 = _tmp33 - p_d(1, 0);
  const Scalar _tmp78 = _tmp21 - p_d(0, 0);
  ...
  const Scalar _tmp82 = fh1 * (_tmp20 * _tmp81 - _tmp32 * _tmp80);
  ...
  const Scalar _tmp90 = _tmp54 * _tmp87 - _tmp54 * _tmp89;
  const Scalar _tmp91 = _tmp67 * _tmp87;
  const Scalar _tmp92 = _tmp53 * _tmp89 - _tmp54 * _tmp91;
  const Scalar _tmp93 = _tmp75 * _tmp92;
  const Scalar _tmp94 = Scalar(1.0) * _tmp55;
  const Scalar _tmp95 = -_tmp94;
  const Scalar _tmp96 = Scalar(1.0) / (_tmp49 + _tmp95);
  const Scalar _tmp97 = Scalar(1.0) * _tmp58;
  const Scalar _tmp98 = _tmp96 * (-_tmp46 + _tmp97);
  const Scalar _tmp99 = -_tmp75 * _tmp90 + _tmp93 * _tmp98;
  const Scalar _tmp100 = -_tmp83;
  const Scalar _tmp101 = _tmp100 + _tmp86;
  const Scalar _tmp102 = _tmp101 * _tmp69 - _tmp45 * _tmp91 - _tmp71 * _tmp92;
  const Scalar _tmp103 = -_tmp101 * _tmp45 - _tmp102 * _tmp98 + _tmp45 * _tmp87 - _tmp71 * _tmp90;
  const Scalar _tmp104 = Scalar(1.0) / (_tmp103);
  const Scalar _tmp105 = _tmp104 * _tmp72;
  const Scalar _tmp106 = _tmp103 * _tmp73;
  const Scalar _tmp107 = _tmp106 * (-_tmp105 * _tmp99 - _tmp66 * _tmp75);
  const Scalar _tmp108 = _tmp107 + _tmp99;
  const Scalar _tmp109 = _tmp104 * _tmp45;
  const Scalar _tmp110 = _tmp104 * _tmp70;
  const Scalar _tmp111 = -_tmp108 * _tmp110 + Scalar(1.0);
  const Scalar _tmp112 = _tmp54 * _tmp68;
  ...
  const Scalar _tmp118 = _tmp64 * (_tmp116 * _tmp45 - _tmp117 * _tmp54);
  const Scalar _tmp119 = _tmp67 * _tmp68;
  const Scalar _tmp120 = _tmp119 * _tmp92 + _tmp91;
  const Scalar _tmp121 = _tmp119 * _tmp90 - _tmp120 * _tmp98 - _tmp87;
  const Scalar _tmp122 = _tmp106 * (-_tmp105 * _tmp121 + _tmp119 * _tmp66 - _tmp65);
  const Scalar _tmp123 = _tmp121 + _tmp122;
  const Scalar _tmp124 = -_tmp110 * _tmp123 - _tmp67;
  const Scalar _tmp125 = _tmp80 * fh1;
  const Scalar _tmp126 = -_tmp113 * _tmp64 * (_tmp108 * _tmp109 + _tmp111 * _tmp112) -
                         _tmp114 * _tmp118 -
                         _tmp125 * _tmp64 * (_tmp109 * _tmp123 + _tmp112 * _tmp124 + Scalar(1.0)) -
                         _tmp64 * _tmp82 * (_tmp45 * _tmp74 - _tmp54 * _tmp76);
  const Scalar _tmp127 = Scalar(1.0) / (_tmp126);
  const Scalar _tmp128 = _tmp41 + _tmp95;
  const Scalar _tmp129 = _tmp128 * _tmp98;
  const Scalar _tmp130 = Scalar(1.0) / (-_tmp129 - _tmp36 + _tmp97);
  ...
  const Scalar _tmp137 = _tmp115 * _tmp130;
  const Scalar _tmp138 = _tmp96 * (-_tmp102 * _tmp116 - _tmp128 * _tmp137 + _tmp95);
  const Scalar _tmp139 = -Scalar(1.0) * _tmp115 * _tmp131 - Scalar(1.0) * _tmp138 + Scalar(1.0);
  const Scalar _tmp140 = _tmp107 * _tmp133 - _tmp108 * _tmp132 - _tmp93;
  const Scalar _tmp141 = fh1 * (_tmp100 + _tmp88);
  const Scalar _tmp142 = -_tmp141 * _tmp81 - Scalar(3.29616) * _tmp26 - _tmp32 * fv1;
  const Scalar _tmp143 = _tmp131 * _tmp98;
  const Scalar _tmp144 = _tmp96 * (_tmp129 * _tmp131 + Scalar(1.0));
  const Scalar _tmp145 = Scalar(1.0) * _tmp143 - Scalar(1.0) * _tmp144;
  const Scalar _tmp146 = _tmp106 * _tmp131;
  const Scalar _tmp147 = -_tmp102 * _tmp74 + _tmp128 * _tmp146;
  const Scalar _tmp148 = Scalar(3.29616) * _tmp14 + _tmp141 * _tmp80 + _tmp20 * fv1;
  const Scalar _tmp149 = _tmp128 * _tmp96;
  const Scalar _tmp150 = Scalar(1.0) * _tmp131 * _tmp149 - Scalar(1.0) * _tmp131;
  const Scalar _tmp151 =
      _tmp114 * _tmp139 + _tmp136 * _tmp80 * (_tmp122 * _tmp131 - _tmp134 * _tmp135) +
      _tmp136 * _tmp81 * (_tmp107 * _tmp131 - _tmp135 * _tmp140) + _tmp142 * _tmp145 +
      _tmp148 * _tmp150 + Scalar(1.0) * _tmp82 * (-_tmp135 * _tmp147 + _tmp146);
  const Scalar _tmp152 = std::asinh(_tmp127 * _tmp151);
  const Scalar _tmp153 = Scalar(9.6622558468725703) * _tmp126;
  const Scalar _tmp154 =
      -_tmp152 * _tmp153 - std::sqrt(Scalar(std::pow(Scalar(-_tmp56 + p_b(1, 0)), Scalar(2)) +
  ...
  const Scalar _tmp158 = Scalar(9.6622558468725703) * _tmp118;
  ...
  const Scalar _tmp162 =
      (_tmp127 * (-_tmp139 + _tmp145 * _tmp161 + _tmp150 * _tmp20) - _tmp151 * _tmp160) /
      std::sqrt(Scalar(std::pow(_tmp151, Scalar(2)) * _tmp159 + 1));
  const Scalar _tmp163 = Scalar(0.1034955) * _tmp160;
  const Scalar _tmp164 = _tmp114 * _tmp116;
  const Scalar _tmp165 =
      _tmp111 * _tmp113 * _tmp68 + _tmp124 * _tmp125 * _tmp68 - _tmp164 * _tmp71 - _tmp76 * _tmp82;
  const Scalar _tmp166 = Scalar(1.0) / (_tmp165);
  const Scalar _tmp167 = _tmp131 * _tmp148;
  const Scalar _tmp168 = _tmp113 * _tmp140 * _tmp96 + _tmp114 * _tmp138 +
                         _tmp125 * _tmp134 * _tmp96 + _tmp142 * _tmp144 +
                         _tmp147 * _tmp82 * _tmp96 - _tmp149 * _tmp167;
  const Scalar _tmp169 = std::asinh(_tmp166 * _tmp168);
  const Scalar _tmp170 = Scalar(9.6622558468725703) * _tmp165;
  const Scalar _tmp171 =
      -_tmp169 * _tmp170 - std::sqrt(Scalar(std::pow(Scalar(-_tmp47 + p_c(0, 0)), Scalar(2)) +
  ...
  const Scalar _tmp179 = Scalar(0.1034955) * _tmp178;
  const Scalar _tmp180 = _tmp131 * _tmp20;
  const Scalar _tmp181 =
      (_tmp166 * (-_tmp138 + _tmp144 * _tmp161 - _tmp149 * _tmp180) - _tmp168 * _tmp178) /
      std::sqrt(Scalar(std::pow(_tmp168, Scalar(2)) * _tmp177 + 1));
  const Scalar _tmp182 = -_tmp107 * _tmp113 * _tmp130 + _tmp114 * _tmp137 -
                         _tmp122 * _tmp125 * _tmp130 - _tmp142 * _tmp143 - _tmp146 * _tmp82 +
                         _tmp167;
  const Scalar _tmp183 =
      _tmp104 * _tmp108 * _tmp113 + _tmp104 * _tmp123 * _tmp125 + _tmp164 + _tmp74 * _tmp82;
  ...
  const Scalar _tmp187 =
      -_tmp185 * _tmp186 - std::sqrt(Scalar(std::pow(Scalar(-_tmp37 + p_a(0, 0)), Scalar(2)) +
  ...
  const Scalar _tmp193 = (_tmp182 * _tmp192 + _tmp184 * (-_tmp137 - _tmp143 * _tmp161 + _tmp180)) /
  ...
  _res(1, 0) =
      -_tmp153 * (Scalar(1.0) * _tmp162 * std::sinh(_tmp157) - _tmp163 * p_b(2, 0) -
                  (-_tmp154 * _tmp163 + _tmp155 * (-_tmp152 * _tmp158 - _tmp153 * _tmp162)) *
                      std::sinh(_tmp156)) -
      _tmp158 * (_tmp155 * p_b(2, 0) - std::cosh(_tmp156) + std::cosh(_tmp157));
  _res(2, 0) =
      -_tmp170 * (-_tmp179 * p_c(2, 0) + Scalar(1.0) * _tmp181 * std::sinh(_tmp174) -
                  (-_tmp171 * _tmp179 + _tmp172 * (-_tmp169 * _tmp176 - _tmp170 * _tmp181)) *
                      std::sinh(_tmp173)) -
      _tmp176 * (_tmp172 * p_c(2, 0) - std::cosh(_tmp173) + std::cosh(_tmp174));
  _res(3, 0) = _tmp175 * (_tmp188 * p_a(2, 0) - std::cosh(_tmp189) + std::cosh(_tmp190)) -
               _tmp186 * (Scalar(1.0) * _tmp193 * std::sinh(_tmp190) + _tmp194 * p_a(2, 0) -
                          (_tmp187 * _tmp194 + _tmp188 * (_tmp175 * _tmp185 - _tmp186 * _tmp193)) *
                              std::sinh(_tmp189));
