...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1WrtFv1Nl3(
  ...
  const Scalar _tmp70 = _tmp35 * _tmp42 - _tmp38 * _tmp43 + _tmp42 * _tmp56 - _tmp58 * _tmp69;
  ...
  const Scalar _tmp81 = -Scalar(0.010999999999999999) * _tmp23 -
  ...
  const Scalar _tmp88 = _tmp68 * (-_tmp57 * _tmp87 + _tmp66 * _tmp86);
  const Scalar _tmp89 = _tmp57 * _tmp84 + _tmp57 * _tmp88;
  const Scalar _tmp90 = Scalar(1.0) * _tmp49;
  const Scalar _tmp91 = -_tmp90;
  const Scalar _tmp92 = Scalar(1.0) / (_tmp59 + _tmp91);
  const Scalar _tmp93 = Scalar(1.0) * _tmp45;
  const Scalar _tmp94 = -_tmp62 + _tmp93;
  const Scalar _tmp95 = _tmp92 * _tmp94;
  const Scalar _tmp96 = _tmp68 * (-_tmp67 * _tmp86 + _tmp87);
  const Scalar _tmp97 = _tmp57 * _tmp96 - _tmp84 - _tmp89 * _tmp95;
  const Scalar _tmp98 = _tmp42 * _tmp84;
  const Scalar _tmp99 = -_tmp80;
  const Scalar _tmp100 = _tmp83 + _tmp99;
  const Scalar _tmp101 = _tmp100 * _tmp43 - _tmp57 * _tmp98 - _tmp58 * _tmp88;
  const Scalar _tmp102 = -_tmp100 * _tmp42 - _tmp101 * _tmp95 - _tmp58 * _tmp96 + _tmp98;
  const Scalar _tmp103 = Scalar(1.0) / (_tmp102);
  const Scalar _tmp104 = _tmp103 * _tmp70;
  const Scalar _tmp105 = _tmp102 * _tmp71;
  const Scalar _tmp106 = _tmp105 * (-_tmp104 * _tmp97 - _tmp56 + _tmp57 * _tmp69);
  const Scalar _tmp107 = _tmp106 + _tmp97;
  const Scalar _tmp108 = _tmp103 * _tmp42;
  const Scalar _tmp109 = _tmp103 * _tmp58;
  const Scalar _tmp110 = -_tmp107 * _tmp109 - _tmp57;
  const Scalar _tmp111 = _tmp78 * fh1;
  const Scalar _tmp112 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp113 = _tmp90 * _tmp95 + _tmp93;
  const Scalar _tmp114 = 0;
  const Scalar _tmp115 = _tmp109 * _tmp114;
  const Scalar _tmp116 = _tmp103 * _tmp114;
  const Scalar _tmp117 = _tmp55 * (-_tmp115 * _tmp73 + _tmp116 * _tmp42);
  const Scalar _tmp118 = Scalar(1.0) * _tmp92;
  const Scalar _tmp119 = _tmp118 * _tmp88 * _tmp94 - Scalar(1.0) * _tmp96;
  const Scalar _tmp120 = _tmp105 * (-_tmp104 * _tmp119 - Scalar(1.0) * _tmp69);
  const Scalar _tmp121 = _tmp119 + _tmp120;
  const Scalar _tmp122 = -_tmp109 * _tmp121 + Scalar(1.0);
  const Scalar _tmp123 = _tmp77 * fh1;
  const Scalar _tmp124 = -_tmp111 * _tmp55 * (_tmp107 * _tmp108 + _tmp110 * _tmp73 + Scalar(1.0)) -
                         _tmp112 * _tmp117 -
                         _tmp123 * _tmp55 * (_tmp108 * _tmp121 + _tmp122 * _tmp73) -
                         _tmp55 * _tmp79 * (_tmp42 * _tmp72 - _tmp58 * _tmp72 * _tmp73);
  const Scalar _tmp125 = Scalar(1.0) / (_tmp124);
  const Scalar _tmp126 = _tmp35 + _tmp91;
  const Scalar _tmp127 = _tmp126 * _tmp95;
  const Scalar _tmp128 = Scalar(1.0) / (-_tmp127 - _tmp38 + _tmp93);
  const Scalar _tmp129 = _tmp113 * _tmp128;
  const Scalar _tmp130 = _tmp92 * (-_tmp101 * _tmp116 - _tmp126 * _tmp129 + _tmp91);
  const Scalar _tmp131 = -Scalar(1.0) * _tmp129 - Scalar(1.0) * _tmp130 + Scalar(1.0);
  const Scalar _tmp132 = Scalar(1.0) * _tmp128;
  const Scalar _tmp133 = _tmp101 * _tmp103;
  const Scalar _tmp134 = _tmp126 * _tmp128;
  const Scalar _tmp135 = _tmp120 * _tmp134 - _tmp121 * _tmp133 - Scalar(1.0) * _tmp88;
  const Scalar _tmp136 = fh1 * (_tmp85 + _tmp99);
  const Scalar _tmp137 = -_tmp136 * _tmp77 - Scalar(3.29616) * _tmp29 - _tmp33 * fv1;
  const Scalar _tmp138 = _tmp92 * (_tmp127 * _tmp132 + Scalar(1.0));
  const Scalar _tmp139 = _tmp132 * _tmp95;
  const Scalar _tmp140 = -Scalar(1.0) * _tmp138 + Scalar(1.0) * _tmp139;
  const Scalar _tmp141 = _tmp106 * _tmp134 - _tmp107 * _tmp133 + _tmp89;
  const Scalar _tmp142 = _tmp136 * _tmp78 + Scalar(3.29616) * _tmp14 + _tmp21 * fv1;
  const Scalar _tmp143 = _tmp126 * _tmp92;
  const Scalar _tmp144 = Scalar(1.0) * _tmp132 * _tmp143 - Scalar(1.0) * _tmp132;
  const Scalar _tmp145 = _tmp105 * _tmp132;
  const Scalar _tmp146 = -_tmp101 * _tmp72 + _tmp126 * _tmp145;
  const Scalar _tmp147 =
      Scalar(1.0) * _tmp111 * (_tmp106 * _tmp132 - _tmp118 * _tmp141) + _tmp112 * _tmp131 +
      Scalar(1.0) * _tmp123 * (-_tmp118 * _tmp135 + _tmp120 * _tmp132) + _tmp137 * _tmp140 +
      _tmp142 * _tmp144 + Scalar(1.0) * _tmp79 * (-_tmp118 * _tmp146 + _tmp145);
  ...
  const Scalar _tmp152 =
      -_tmp148 * _tmp151 - std::sqrt(Scalar(std::pow(Scalar(-_tmp46 + p_c(0, 0)), Scalar(2)) +
  ...
  const Scalar _tmp155 = _tmp30 + _tmp48;
  const Scalar _tmp156 = std::pow(_tmp124, Scalar(-2));
  const Scalar _tmp157 = _tmp117 * _tmp156;
  const Scalar _tmp158 =
      (_tmp125 * (-_tmp131 + _tmp140 * _tmp155 + _tmp144 * _tmp21) - _tmp147 * _tmp157) /
      std::sqrt(Scalar(std::pow(_tmp147, Scalar(2)) * _tmp156 + 1));
  const Scalar _tmp159 = Scalar(0.1034955) * _tmp157;
  const Scalar _tmp160 = _tmp72 * _tmp79;
  const Scalar _tmp161 = _tmp115 * _tmp68;
  const Scalar _tmp162 = _tmp110 * _tmp111 * _tmp68 - _tmp112 * _tmp161 +
                         _tmp122 * _tmp123 * _tmp68 - _tmp160 * _tmp58 * _tmp68;
  const Scalar _tmp163 = Scalar(1.0) / (_tmp162);
  const Scalar _tmp164 = Scalar(0.1034955) * _tmp163;
  const Scalar _tmp165 = _tmp132 * _tmp142;
  const Scalar _tmp166 = _tmp111 * _tmp141 * _tmp92 + _tmp112 * _tmp130 +
                         _tmp123 * _tmp135 * _tmp92 + _tmp137 * _tmp138 - _tmp143 * _tmp165 +
                         _tmp146 * _tmp79 * _tmp92;
  const Scalar _tmp167 = std::asinh(_tmp163 * _tmp166);
  const Scalar _tmp168 = Scalar(9.6622558468725703) * _tmp162;
  const Scalar _tmp169 =
      -_tmp167 * _tmp168 - std::sqrt(Scalar(std::pow(Scalar(-_tmp60 + p_d(1, 0)), Scalar(2)) +
  ...
  const Scalar _tmp174 = _tmp161 * _tmp173;
  const Scalar _tmp175 = Scalar(0.1034955) * _tmp174;
  const Scalar _tmp176 = _tmp132 * _tmp21;
  const Scalar _tmp177 =
      (_tmp163 * (-_tmp130 + _tmp138 * _tmp155 - _tmp143 * _tmp176) - _tmp166 * _tmp174) /
      std::sqrt(Scalar(std::pow(_tmp166, Scalar(2)) * _tmp173 + 1));
  const Scalar _tmp178 =
      _tmp103 * _tmp107 * _tmp111 + _tmp103 * _tmp121 * _tmp123 + _tmp112 * _tmp116 + _tmp160;
  const Scalar _tmp179 = Scalar(9.6622558468725703) * _tmp178;
  const Scalar _tmp180 = std::pow(_tmp178, Scalar(-2));
  const Scalar _tmp181 = -_tmp106 * _tmp111 * _tmp128 + _tmp112 * _tmp129 -
                         _tmp120 * _tmp123 * _tmp128 - _tmp137 * _tmp139 - _tmp145 * _tmp79 +
                         _tmp165;
  const Scalar _tmp182 = _tmp116 * _tmp180;
  const Scalar _tmp183 = Scalar(1.0) / (_tmp178);
  const Scalar _tmp184 = (_tmp181 * _tmp182 + _tmp183 * (-_tmp129 - _tmp139 * _tmp155 + _tmp176)) /
                         std::sqrt(Scalar(_tmp180 * std::pow(_tmp181, Scalar(2)) + 1));
  const Scalar _tmp185 = std::asinh(_tmp181 * _tmp183);
  const Scalar _tmp186 = Scalar(9.6622558468725703) * _tmp116;
  const Scalar _tmp187 = Scalar(0.1034955) * _tmp183;
  const Scalar _tmp188 =
      -_tmp179 * _tmp185 - std::sqrt(Scalar(std::pow(Scalar(-_tmp36 + p_b(1, 0)), Scalar(2)) +
                                            std::pow(Scalar(-_tmp39 + p_b(0, 0)), Scalar(2))));
  const Scalar _tmp189 = Scalar(0.1034955) * _tmp182;
  const Scalar _tmp190 = _tmp187 * _tmp188;
  ...
  _res(1, 0) =
      -_tmp151 * (Scalar(1.0) * _tmp158 * std::sinh(_tmp149) - _tmp159 * p_c(2, 0) -
                  (_tmp150 * (-_tmp148 * _tmp154 - _tmp151 * _tmp158) - _tmp152 * _tmp159) *
                      std::sinh(_tmp153)) -
      _tmp154 * (_tmp150 * p_c(2, 0) + std::cosh(_tmp149) - std::cosh(_tmp153));
  _res(2, 0) =
      -_tmp168 * (-_tmp175 * p_d(2, 0) + Scalar(1.0) * _tmp177 * std::sinh(_tmp171) -
                  (_tmp164 * (-_tmp167 * _tmp172 - _tmp168 * _tmp177) - _tmp169 * _tmp175) *
                      std::sinh(_tmp170)) -
      _tmp172 * (_tmp164 * p_d(2, 0) - std::cosh(_tmp170) + std::cosh(_tmp171));
  _res(3, 0) =
      -_tmp179 * (Scalar(1.0) * _tmp184 * std::sinh(_tmp191) + _tmp189 * p_b(2, 0) -
                  (_tmp187 * (-_tmp179 * _tmp184 + _tmp185 * _tmp186) + _tmp188 * _tmp189) *
                      std::sinh(_tmp190)) +
      _tmp186 * (_tmp187 * p_b(2, 0) - std::cosh(_tmp190) + std::cosh(_tmp191));
