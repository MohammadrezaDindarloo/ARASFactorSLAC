...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl14(
  ...
  const Scalar _tmp32 = _tmp31 - p_b(1, 0) + p_init1;
  const Scalar _tmp33 = _tmp15 + _tmp4;
  const Scalar _tmp34 = _tmp33 - p_b(0, 0) + p_init0;
  ...
  const Scalar _tmp43 = _tmp39 + _tmp40 + _tmp42;
  const Scalar _tmp44 = _tmp36 * _tmp43;
  const Scalar _tmp45 = _tmp39 - _tmp40;
  const Scalar _tmp46 = _tmp42 + _tmp45;
  const Scalar _tmp47 = _tmp38 * (-_tmp29 * _tmp44 + _tmp37 * _tmp46);
  const Scalar _tmp48 = Scalar(1.0) * _tmp31;
  const Scalar _tmp49 = Scalar(1.0) * _tmp33;
  const Scalar _tmp50 = (-_tmp16 + _tmp49) / (_tmp26 - _tmp48);
  const Scalar _tmp51 = _tmp38 * (_tmp29 * _tmp43 - _tmp29 * _tmp46);
  const Scalar _tmp52 = _tmp36 * _tmp51 - _tmp43 - _tmp50 * (_tmp36 * _tmp47 + _tmp44);
  const Scalar _tmp53 = _tmp19 + _tmp25;
  const Scalar _tmp54 = _tmp53 - p_d(1, 0) + p_init1;
  const Scalar _tmp55 = _tmp11 + _tmp14;
  const Scalar _tmp56 = _tmp5 + _tmp55;
  const Scalar _tmp57 = _tmp56 - p_d(0, 0) + p_init0;
  ...
  const Scalar _tmp62 = _tmp41 + _tmp45;
  const Scalar _tmp63 = _tmp43 * _tmp59;
  const Scalar _tmp64 = -_tmp50 * (-_tmp36 * _tmp63 - _tmp47 * _tmp61 + _tmp60 * _tmp62) -
                        _tmp51 * _tmp61 - _tmp59 * _tmp62 + _tmp63;
  ...
  const Scalar _tmp68 = _tmp35 * _tmp66;
  const Scalar _tmp69 = _tmp68 * (-_tmp31 * _tmp34 * _tmp67 + _tmp32 * _tmp33 * _tmp67);
  const Scalar _tmp70 = _tmp38 * (-_tmp16 * _tmp37 + _tmp26 * _tmp29 + _tmp29 * _tmp69);
  const Scalar _tmp71 = _tmp53 * _tmp59 - _tmp56 * _tmp60 + _tmp59 * _tmp69 - _tmp61 * _tmp70;
  const Scalar _tmp72 = _tmp65 * _tmp71;
  const Scalar _tmp73 = Scalar(1.0) / (_tmp71);
  const Scalar _tmp74 = _tmp64 * _tmp73;
  const Scalar _tmp75 = _tmp52 + _tmp74 * (_tmp36 * _tmp70 - _tmp52 * _tmp72 - _tmp69);
  const Scalar _tmp76 = _tmp61 * _tmp65;
  const Scalar _tmp77 = _tmp38 * (-_tmp36 - _tmp75 * _tmp76);
  const Scalar _tmp78 = _tmp65 * _tmp75;
  const Scalar _tmp79 = _tmp4 + _tmp55;
  const Scalar _tmp80 = _tmp79 - p_c(0, 0) + p_init0;
  const Scalar _tmp81 = _tmp19 + _tmp30;
  const Scalar _tmp82 = _tmp81 - p_c(1, 0) + p_init1;
  ...
  const Scalar _tmp87 = _tmp48 * _tmp50 + _tmp49;
  const Scalar _tmp88 = 0;
  const Scalar _tmp89 = _tmp65 * _tmp88;
  const Scalar _tmp90 = _tmp38 * _tmp76 * _tmp88;
  const Scalar _tmp91 = Scalar(1.0) * _tmp47 * _tmp50 - Scalar(1.0) * _tmp51;
  const Scalar _tmp92 = _tmp74 * (-Scalar(1.0) * _tmp70 - _tmp72 * _tmp91) + _tmp91;
  const Scalar _tmp93 = _tmp65 * _tmp92;
  const Scalar _tmp94 = _tmp38 * (-_tmp76 * _tmp92 + Scalar(1.0));
  const Scalar _tmp95 = _tmp82 * _tmp83;
  const Scalar _tmp96 = _tmp68 * _tmp95 * (_tmp29 * _tmp94 + _tmp59 * _tmp93);
  const Scalar _tmp97 = _tmp79 * _tmp95 - _tmp81 * _tmp84;
  const Scalar _tmp98 = Scalar(1.0) * _tmp73;
  const Scalar _tmp99 = _tmp38 * _tmp61;
  const Scalar _tmp100 = _tmp68 * _tmp97 * (-_tmp29 * _tmp98 * _tmp99 + _tmp59 * _tmp98);
  const Scalar _tmp101 = _tmp94 * _tmp95;
  const Scalar _tmp102 = _tmp97 * _tmp98;
  const Scalar _tmp103 = _tmp102 * fh1;
  const Scalar _tmp104 = _tmp77 * _tmp84;
  const Scalar _tmp105 = _tmp93 * _tmp95;
  const Scalar _tmp106 = _tmp78 * _tmp84;

  // Output terms (1)
  Eigen::Matrix<Scalar, 4, 1> _res;

  _res(0, 0) = -std::exp(-fh1);
  _res(1, 0) = -(-_tmp100 - _tmp85 - _tmp96) *
               std::exp(_tmp100 * fh1 + _tmp68 * _tmp86 * (-_tmp29 * _tmp90 + _tmp59 * _tmp89) +
                        _tmp85 * fh1 + _tmp96 * fh1);
  _res(2, 0) = -(_tmp101 - _tmp102 * _tmp99 + _tmp104) *
               std::exp(-_tmp101 * fh1 + _tmp103 * _tmp99 - _tmp104 * fh1 + _tmp86 * _tmp90);
  _res(3, 0) = -(_tmp102 + _tmp105 + _tmp106) *
               std::exp(-_tmp103 - _tmp105 * fh1 - _tmp106 * fh1 - _tmp86 * _tmp89);
