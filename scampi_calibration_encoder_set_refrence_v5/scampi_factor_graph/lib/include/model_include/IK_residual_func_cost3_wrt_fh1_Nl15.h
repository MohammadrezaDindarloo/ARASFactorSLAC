...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl15(
  ...
  const Scalar _tmp43 = (-_tmp25 + _tmp42) / (_tmp16 - _tmp41);
  ...
  const Scalar _tmp54 = -_tmp28 * _tmp50 + _tmp53;
  const Scalar _tmp55 = _tmp24 + _tmp33;
  const Scalar _tmp56 = _tmp55 - p_a(0, 0) + p_init0;
  const Scalar _tmp57 = _tmp15 + _tmp29;
  ...
  const Scalar _tmp62 = _tmp38 * _tmp60 - _tmp61;
  const Scalar _tmp63 = _tmp40 * _tmp62;
  const Scalar _tmp64 = _tmp49 + _tmp51;
  const Scalar _tmp65 = _tmp52 * _tmp60;
  const Scalar _tmp66 = -_tmp38 * _tmp53 + _tmp39 * _tmp50;
  const Scalar _tmp67 = -_tmp43 * (-_tmp38 * _tmp65 + _tmp61 * _tmp64 - _tmp63 * _tmp66) -
                        _tmp54 * _tmp63 - _tmp60 * _tmp64 + _tmp65;
  ...
  const Scalar _tmp75 = _tmp73 * (-_tmp31 * _tmp36 * _tmp74 + _tmp32 * _tmp35 * _tmp74);
  const Scalar _tmp76 = _tmp16 * _tmp28 - _tmp25 * _tmp39 + _tmp28 * _tmp75;
  const Scalar _tmp77 = Scalar(1.0) * _tmp40;
  const Scalar _tmp78 = _tmp43 * _tmp66 * _tmp77 - _tmp54 * _tmp77;
  ...
  const Scalar _tmp85 = _tmp40 * (-_tmp69 * _tmp83 + Scalar(1.0));
  const Scalar _tmp86 = _tmp18 + _tmp34;
  const Scalar _tmp87 = _tmp86 - p_c(0, 0) + p_init0;
  const Scalar _tmp88 = _tmp30 + _tmp5;
  ...
  const Scalar _tmp92 = _tmp73 * _tmp91 * (_tmp28 * _tmp85 + _tmp60 * _tmp84);
  const Scalar _tmp93 = _tmp38 * _tmp40;
  const Scalar _tmp94 = -_tmp43 * (_tmp38 * _tmp52 + _tmp66 * _tmp93) - _tmp52 + _tmp54 * _tmp93;
  const Scalar _tmp95 = _tmp82 * (-_tmp75 + _tmp76 * _tmp93 - _tmp80 * _tmp94) + _tmp94;
  const Scalar _tmp96 = _tmp40 * (-_tmp38 - _tmp69 * _tmp95);
  const Scalar _tmp97 = _tmp68 * _tmp95;
  const Scalar _tmp98 = _tmp87 * _tmp90;
  const Scalar _tmp99 = _tmp73 * _tmp98 * (_tmp28 * _tmp96 + _tmp60 * _tmp97 + Scalar(1.0));
  const Scalar _tmp100 = _tmp86 * _tmp91 - _tmp88 * _tmp98;
  const Scalar _tmp101 = Scalar(1.0) * _tmp81;
  const Scalar _tmp102 = _tmp100 * _tmp73 * (-_tmp101 * _tmp28 * _tmp63 + _tmp101 * _tmp60);
  ...
  _res(1, 0) = -(-_tmp102 - _tmp92 - _tmp99) *
               std::exp(_tmp0 * _tmp73 * (-_tmp28 * _tmp70 + _tmp60 * _tmp71) + _tmp102 * fh1 +
                        _tmp92 * fh1 + _tmp99 * fh1);
  _res(2, 0) = -(-_tmp103 * _tmp63 + _tmp105 + _tmp106) *
               std::exp(_tmp0 * _tmp70 + _tmp104 * _tmp63 - _tmp105 * fh1 - _tmp106 * fh1);
