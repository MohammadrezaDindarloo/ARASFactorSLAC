...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl12(
  ...
  const Scalar _tmp19 = -Scalar(0.20999999999999999) * _tmp11 + Scalar(0.20999999999999999) * _tmp8;
  ...
  const Scalar _tmp37 = _tmp18 * _tmp28;
  ...
  const Scalar _tmp47 = _tmp29 * _tmp45 - _tmp37;
  ...
  const Scalar _tmp58 = _tmp30 + _tmp34;
  const Scalar _tmp59 = _tmp57 * (-_tmp46 * _tmp55 + _tmp56 * _tmp58);
  const Scalar _tmp60 = Scalar(1.0) * _tmp39;
  const Scalar _tmp61 = Scalar(1.0) * _tmp42;
  const Scalar _tmp62 = (-_tmp52 + _tmp61) / (_tmp49 - _tmp60);
  const Scalar _tmp63 = _tmp57 * (_tmp35 * _tmp55 - _tmp55 * _tmp58);
  const Scalar _tmp64 = _tmp29 * _tmp35 - _tmp29 * _tmp36 - _tmp47 * _tmp63 -
                        _tmp62 * (-_tmp29 * _tmp46 + _tmp36 * _tmp37 - _tmp47 * _tmp59);
  ...
  const Scalar _tmp74 = _tmp73 * (_tmp29 * _tmp68 - _tmp69 * _tmp71);
  const Scalar _tmp75 = Scalar(1.0) / (_tmp72);
  const Scalar _tmp76 = _tmp73 * (-_tmp39 * _tmp43 * _tmp75 + _tmp40 * _tmp42 * _tmp75);
  const Scalar _tmp77 = _tmp57 * (_tmp49 * _tmp55 - _tmp52 * _tmp56 + _tmp55 * _tmp76);
  const Scalar _tmp78 = _tmp17 * _tmp29 - _tmp26 * _tmp37 + _tmp29 * _tmp76 - _tmp47 * _tmp77;
  ...
  const Scalar _tmp89 = Scalar(1.0) * _tmp59 * _tmp62 - Scalar(1.0) * _tmp63;
  const Scalar _tmp90 = _tmp65 * _tmp78;
  const Scalar _tmp91 = _tmp64 * _tmp79;
  const Scalar _tmp92 = _tmp89 + _tmp91 * (-Scalar(1.0) * _tmp77 - _tmp89 * _tmp90);
  const Scalar _tmp93 = -_tmp70 * _tmp92 + Scalar(1.0);
  const Scalar _tmp94 = _tmp29 * _tmp65;
  const Scalar _tmp95 = _tmp73 * fh1;
  const Scalar _tmp96 = -_tmp35 + _tmp45 * _tmp63 - _tmp62 * (_tmp45 * _tmp59 + _tmp46);
  const Scalar _tmp97 = _tmp91 * (_tmp45 * _tmp77 - _tmp76 - _tmp90 * _tmp96) + _tmp96;
  const Scalar _tmp98 = -_tmp45 - _tmp70 * _tmp97;
  const Scalar _tmp99 = _tmp57 * _tmp71;
  ...
  _res(1, 0) =
      -_tmp74 *
      std::exp(_tmp0 * _tmp74 + _tmp73 * _tmp88 * (_tmp29 * _tmp80 - _tmp47 * _tmp69 * _tmp80) +
               _tmp86 * _tmp95 * (_tmp69 * _tmp93 + _tmp92 * _tmp94) +
               _tmp87 * _tmp95 * (_tmp69 * _tmp98 + _tmp94 * _tmp97 + Scalar(1.0)));
  _res(2, 0) = -_tmp99 * std::exp(_tmp0 * _tmp99 + _tmp100 * _tmp47 * _tmp57 -
                                  _tmp101 * _tmp86 * _tmp93 - _tmp101 * _tmp87 * _tmp98);
  _res(3, 0) = _tmp68 * std::exp(-_tmp0 * _tmp68 - _tmp100 - _tmp102 * _tmp86 * _tmp92 -
                                 _tmp102 * _tmp87 * _tmp97);
