...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl12(
  ...
  const Scalar _tmp47 = _tmp28 + _tmp42;
  const Scalar _tmp48 = Scalar(1.0) / (_tmp46 + _tmp47);
  const Scalar _tmp49 = _tmp39 + _tmp7;
  ...
  const Scalar _tmp65 = _tmp32 + _tmp55;
  ...
  const Scalar _tmp80 = _tmp35 + _tmp54;
  ...
  const Scalar _tmp108 = _tmp106 * _tmp91 - _tmp107 * _tmp86;
  const Scalar _tmp109 = _tmp20 - p_c(0, 0);
  const Scalar _tmp110 = _tmp30 - p_c(1, 0);
  ...
  const Scalar _tmp114 = fh1 * (_tmp112 * _tmp19 - _tmp113 * _tmp29);
  const Scalar _tmp115 = _tmp72 * _tmp84;
  const Scalar _tmp116 = _tmp115 * _tmp82 + _tmp73;
  const Scalar _tmp117 = _tmp115 * _tmp87 - _tmp116 * _tmp51 - _tmp56;
  ...
  const Scalar _tmp122 = _tmp116 + _tmp119 * _tmp120 - _tmp121 * _tmp90;
  const Scalar _tmp123 = _tmp113 * fh1;
  const Scalar _tmp124 = _tmp36 * fh1;
  const Scalar _tmp125 = -_tmp112 * _tmp124 - Scalar(3.29616) * _tmp25 - _tmp29 * fv1;
  const Scalar _tmp126 = _tmp92 * _tmp97 + Scalar(1.0);
  const Scalar _tmp127 = _tmp113 * _tmp124 + Scalar(3.29616) * _tmp12 + _tmp19 * fv1;
  const Scalar _tmp128 = _tmp48 * _tmp91;
  const Scalar _tmp129 = Scalar(1.0) * _tmp84;
  const Scalar _tmp130 = -_tmp129 * _tmp87 + _tmp50 * _tmp82 * _tmp84 * _tmp96;
  const Scalar _tmp131 = _tmp105 * (-_tmp102 * _tmp129 - _tmp118 * _tmp130);
  const Scalar _tmp132 = _tmp130 + _tmp131;
  const Scalar _tmp133 = _tmp120 * _tmp131 - _tmp129 * _tmp82 - _tmp132 * _tmp90;
  const Scalar _tmp134 = _tmp112 * fh1;
  const Scalar _tmp135 = _tmp53 * _tmp89;
  const Scalar _tmp136 = _tmp79 * _tmp84;
  const Scalar _tmp137 = _tmp83 * _tmp89;
  const Scalar _tmp138 = _tmp137 * _tmp53;
  const Scalar _tmp139 = _tmp104 * _tmp129 * _tmp83;
  const Scalar _tmp140 = -_tmp132 * _tmp137 + Scalar(1.0);
  const Scalar _tmp141 = _tmp64 * _tmp89;
  const Scalar _tmp142 = -_tmp121 * _tmp137 - _tmp72;
  const Scalar _tmp143 = -_tmp100 * _tmp114 * (_tmp107 * _tmp64 - _tmp139 * _tmp79) -
                         _tmp100 * _tmp123 * (_tmp121 * _tmp141 + _tmp136 * _tmp142 + Scalar(1.0)) -
                         _tmp100 * _tmp134 * (_tmp132 * _tmp141 + _tmp136 * _tmp140) -
                         _tmp100 * _tmp37 * (_tmp135 * _tmp64 - _tmp136 * _tmp138);
  const Scalar _tmp144 = Scalar(1.0) / (_tmp143);
  const Scalar _tmp145 = std::asinh(
      _tmp144 * (Scalar(1.0) * _tmp114 * (_tmp106 - _tmp108 * _tmp96) +
                 Scalar(1.0) * _tmp123 * (_tmp119 * _tmp97 - _tmp122 * _tmp96) +
                 Scalar(1.0) * _tmp125 * (-_tmp126 * _tmp96 + _tmp51 * _tmp97) +
                 Scalar(1.0) * _tmp127 * (_tmp128 * _tmp97 - _tmp97) +
                 Scalar(1.0) * _tmp134 * (_tmp131 * _tmp97 - _tmp133 * _tmp96) +
                 Scalar(1.0) * _tmp37 * (-_tmp52 * _tmp97 - _tmp95 * _tmp96 + Scalar(1.0))));
  const Scalar _tmp146 = Scalar(0.1034955) * _tmp144;
  const Scalar _tmp147 = Scalar(9.6622558468725703) * _tmp143;
  const Scalar _tmp148 = _tmp125 * _tmp48;
  const Scalar _tmp149 = _tmp127 * _tmp97;
  const Scalar _tmp150 = -_tmp114 * _tmp139 + _tmp123 * _tmp142 * _tmp84 +
                         _tmp134 * _tmp140 * _tmp84 - _tmp138 * _tmp37 * _tmp84;
  const Scalar _tmp151 = Scalar(1.0) / (_tmp150);
  const Scalar _tmp152 = std::asinh(
      _tmp151 * (_tmp108 * _tmp114 * _tmp48 + _tmp122 * _tmp123 * _tmp48 + _tmp126 * _tmp148 -
                 _tmp128 * _tmp149 + _tmp133 * _tmp134 * _tmp48 + _tmp37 * _tmp48 * _tmp95));
  const Scalar _tmp153 = Scalar(0.1034955) * _tmp151;
  const Scalar _tmp154 = Scalar(9.6622558468725703) * _tmp150;
  const Scalar _tmp155 = _tmp107 * _tmp114 + _tmp121 * _tmp123 * _tmp89 +
                         _tmp132 * _tmp134 * _tmp89 + _tmp135 * _tmp37;
  const Scalar _tmp156 = Scalar(1.0) / (_tmp155);
  const Scalar _tmp157 = std::asinh(
      _tmp156 * (-_tmp106 * _tmp114 - _tmp119 * _tmp123 * _tmp93 - _tmp131 * _tmp134 * _tmp93 -
                 _tmp148 * _tmp50 * _tmp97 + _tmp149 + _tmp37 * _tmp94));
  ...
  _res(1, 0) =
      -_tmp147 *
          (_tmp146 * p_a(2, 0) + std::cosh(Scalar(1.0) * _tmp145) -
           std::cosh(_tmp146 *
                     (-_tmp145 * _tmp147 -
                      std::sqrt(Scalar(std::pow(Scalar(-_tmp67 + p_a(1, 0)), Scalar(2)) +
                                       std::pow(Scalar(-_tmp69 + p_a(0, 0)), Scalar(2))))))) +
      _tmp56 + p_init2;
  _res(2, 0) =
      -_tmp154 *
          (_tmp153 * p_b(2, 0) + std::cosh(Scalar(1.0) * _tmp152) -
           std::cosh(_tmp153 *
                     (-_tmp152 * _tmp154 -
                      std::sqrt(Scalar(std::pow(Scalar(-_tmp74 + p_b(1, 0)), Scalar(2)) +
                                       std::pow(Scalar(-_tmp76 + p_b(0, 0)), Scalar(2))))))) +
      _tmp80 + p_init2;
  _res(3, 0) =
      -_tmp159 *
          (_tmp158 * p_d(2, 0) + std::cosh(Scalar(1.0) * _tmp157) -
           std::cosh(_tmp158 *
                     (-_tmp157 * _tmp159 -
                      std::sqrt(Scalar(std::pow(Scalar(-_tmp58 + p_d(1, 0)), Scalar(2)) +
