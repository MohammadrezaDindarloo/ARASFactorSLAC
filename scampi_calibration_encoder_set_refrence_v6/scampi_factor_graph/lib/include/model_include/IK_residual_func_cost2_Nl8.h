...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl8(
  ...
  const Scalar _tmp45 = std::pow(Scalar(-_tmp41 + p_c(0, 0)), Scalar(2)) +
  ...
  const Scalar _tmp60 = _tmp44 - p_c(1, 0);
  const Scalar _tmp61 = _tmp41 - p_c(0, 0);
  const Scalar _tmp62 = Scalar(1.0) / (_tmp61);
  const Scalar _tmp63 = _tmp60 * _tmp62;
  const Scalar _tmp64 = _tmp55 * _tmp56;
  const Scalar _tmp65 = Scalar(1.0) / (_tmp57 * _tmp63 - _tmp64);
  const Scalar _tmp66 = _tmp63 * _tmp65;
  const Scalar _tmp67 = _tmp65 * (_tmp47 * _tmp64 - _tmp58 * _tmp63);
  const Scalar _tmp68 = _tmp39 * _tmp63;
  const Scalar _tmp69 = _tmp63 * _tmp67 + _tmp68;
  const Scalar _tmp70 = Scalar(1.0) * _tmp43;
  const Scalar _tmp71 = -_tmp70;
  const Scalar _tmp72 = Scalar(1.0) / (_tmp53 + _tmp71);
  const Scalar _tmp73 = Scalar(1.0) * _tmp40;
  const Scalar _tmp74 = _tmp72 * (-_tmp49 + _tmp73);
  const Scalar _tmp75 = -_tmp39 + _tmp59 * _tmp66 - _tmp69 * _tmp74;
  const Scalar _tmp76 = _tmp42 + _tmp52;
  const Scalar _tmp77 = _tmp76 + p_init1;
  const Scalar _tmp78 = _tmp77 - p_d(1, 0);
  const Scalar _tmp79 = _tmp18 + _tmp48;
  ...
  const Scalar _tmp84 = _tmp38 + _tmp46;
  const Scalar _tmp85 = _tmp78 * _tmp82;
  const Scalar _tmp86 = _tmp63 * _tmp83 - _tmp85;
  const Scalar _tmp87 = _tmp65 * _tmp86;
  const Scalar _tmp88 = -_tmp67 * _tmp86 - _tmp68 * _tmp83 + _tmp84 * _tmp85;
  const Scalar _tmp89 = _tmp39 * _tmp83 - _tmp59 * _tmp87 - _tmp74 * _tmp88 - _tmp83 * _tmp84;
  ...
  const Scalar _tmp94 = _tmp93 * (_tmp40 * _tmp60 * _tmp92 - _tmp43 * _tmp61 * _tmp92);
  const Scalar _tmp95 = -_tmp49 * _tmp64 + _tmp53 * _tmp57 + _tmp57 * _tmp94;
  ...
  const Scalar _tmp104 = -_tmp101 * _tmp103 - _tmp63;
  const Scalar _tmp105 = _tmp57 * _tmp65;
  const Scalar _tmp106 = _tmp33 - p_b(1, 0);
  const Scalar _tmp107 = _tmp26 - p_b(0, 0);
  ...
  const Scalar _tmp112 = _tmp70 * _tmp74 + _tmp73;
  ...
  const Scalar _tmp118 = fh1 * (-_tmp109 * _tmp32 + _tmp117 * _tmp25);
  const Scalar _tmp119 = Scalar(1.0) * _tmp67;
  const Scalar _tmp120 = Scalar(1.0) * _tmp65;
  const Scalar _tmp121 = _tmp119 * _tmp74 - _tmp120 * _tmp59;
  const Scalar _tmp122 = _tmp99 * (-_tmp120 * _tmp95 - _tmp121 * _tmp97);
  const Scalar _tmp123 = _tmp121 + _tmp122;
  const Scalar _tmp124 = -_tmp103 * _tmp123 + Scalar(1.0);
  const Scalar _tmp125 = _tmp117 * fh1;
  const Scalar _tmp126 = -_tmp110 * _tmp93 * (_tmp101 * _tmp102 + _tmp104 * _tmp105 + Scalar(1.0)) -
                         _tmp111 * _tmp93 * (-_tmp105 * _tmp114 + _tmp115 * _tmp83) -
                         _tmp118 * _tmp93 * (-_tmp116 * _tmp57 * _tmp87 + _tmp116 * _tmp83) -
                         _tmp125 * _tmp93 * (_tmp102 * _tmp123 + _tmp105 * _tmp124);
  const Scalar _tmp127 = Scalar(1.0) / (_tmp126);
  const Scalar _tmp128 = _tmp88 * _tmp90;
  const Scalar _tmp129 = _tmp71 + _tmp76;
  const Scalar _tmp130 = _tmp129 * _tmp74;
  const Scalar _tmp131 = Scalar(1.0) / (-_tmp130 + _tmp73 - _tmp79);
  const Scalar _tmp132 = _tmp129 * _tmp131;
  const Scalar _tmp133 = _tmp100 * _tmp132 - _tmp101 * _tmp128 + _tmp69;
  const Scalar _tmp134 = Scalar(1.0) * _tmp72;
  const Scalar _tmp135 = Scalar(1.0) * _tmp131;
  const Scalar _tmp136 = _tmp112 * _tmp131;
  const Scalar _tmp137 = _tmp72 * (-_tmp113 * _tmp128 - _tmp129 * _tmp136 + _tmp71);
  const Scalar _tmp138 = _tmp135 * _tmp99;
  const Scalar _tmp139 = _tmp129 * _tmp135;
  const Scalar _tmp140 = -_tmp116 * _tmp88 + _tmp139 * _tmp99;
  const Scalar _tmp141 = -_tmp119 + _tmp122 * _tmp132 - _tmp123 * _tmp128;
  const Scalar _tmp142 = _tmp15 * fh1;
  const Scalar _tmp143 = _tmp109 * _tmp142 + Scalar(3.29616) * _tmp22 + _tmp25 * fv1;
  const Scalar _tmp144 = _tmp135 * _tmp74;
  const Scalar _tmp145 = _tmp130 * _tmp135 + Scalar(1.0);
  const Scalar _tmp146 = -_tmp117 * _tmp142 - Scalar(3.29616) * _tmp29 - _tmp32 * fv1;
  const Scalar _tmp147 =
      std::asinh(_tmp127 * (Scalar(1.0) * _tmp110 * (_tmp100 * _tmp135 - _tmp133 * _tmp134) +
                            Scalar(1.0) * _tmp111 *
                                (-_tmp112 * _tmp135 - Scalar(1.0) * _tmp137 + Scalar(1.0)) +
                            Scalar(1.0) * _tmp118 * (-_tmp134 * _tmp140 + _tmp138) +
                            Scalar(1.0) * _tmp125 * (_tmp122 * _tmp135 - _tmp134 * _tmp141) +
                            Scalar(1.0) * _tmp143 * (-_tmp135 + _tmp139 * _tmp72) +
                            Scalar(1.0) * _tmp146 * (-_tmp134 * _tmp145 + _tmp144)));
  const Scalar _tmp148 = Scalar(9.6622558468725703) * _tmp126;
  const Scalar _tmp149 = std::pow(Scalar(-_tmp50 + p_a(0, 0)), Scalar(2)) +
                         std::pow(Scalar(-_tmp54 + p_a(1, 0)), Scalar(2));
  const Scalar _tmp150 = _tmp116 * _tmp118;
  const Scalar _tmp151 = _tmp104 * _tmp110 * _tmp65 - _tmp111 * _tmp114 * _tmp65 +
                         _tmp124 * _tmp125 * _tmp65 - _tmp150 * _tmp87;
  const Scalar _tmp152 = Scalar(1.0) / (_tmp151);
  const Scalar _tmp153 = _tmp135 * _tmp143;
  const Scalar _tmp154 =
      std::asinh(_tmp152 * (_tmp110 * _tmp133 * _tmp72 + _tmp111 * _tmp137 +
                            _tmp118 * _tmp140 * _tmp72 + _tmp125 * _tmp141 * _tmp72 -
                            _tmp129 * _tmp153 * _tmp72 + _tmp145 * _tmp146 * _tmp72));
  const Scalar _tmp155 = Scalar(9.6622558468725703) * _tmp151;
  const Scalar _tmp156 = std::pow(Scalar(-_tmp77 + p_d(1, 0)), Scalar(2)) +
                         std::pow(Scalar(-_tmp80 + p_d(0, 0)), Scalar(2));
  const Scalar _tmp157 =
      _tmp101 * _tmp110 * _tmp90 + _tmp111 * _tmp115 + _tmp123 * _tmp125 * _tmp90 + _tmp150;
  const Scalar _tmp158 = Scalar(1.0) / (_tmp157);
  const Scalar _tmp159 =
      std::asinh(_tmp158 * (-_tmp100 * _tmp110 * _tmp131 + _tmp111 * _tmp136 - _tmp118 * _tmp138 -
                            _tmp122 * _tmp125 * _tmp131 - _tmp144 * _tmp146 + _tmp153));
  ...
  _res(1, 0) =
      ...
      std::sqrt(Scalar(_tmp45 + std::pow(Scalar(-_tmp39 + p_c(2, 0) - p_init2), Scalar(2))));
  _res(2, 0) =
      _tmp155 *
          (-std::sinh(Scalar(1.0) * _tmp154) -
           std::sinh(Scalar(0.1034955) * _tmp152 * (-std::sqrt(_tmp149) - _tmp154 * _tmp155))) -
      std::sqrt(Scalar(_tmp149 + std::pow(Scalar(-_tmp47 + p_a(2, 0) - p_init2), Scalar(2))));
  _res(3, 0) =
      _tmp160 *
          (-std::sinh(Scalar(1.0) * _tmp159) -
           std::sinh(Scalar(0.1034955) * _tmp158 * (-std::sqrt(_tmp156) - _tmp159 * _tmp160))) -
      std::sqrt(Scalar(_tmp156 + std::pow(Scalar(-_tmp84 + p_d(2, 0) - p_init2), Scalar(2))));
