...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2WrtFv1Nl8(
  ...
  const Scalar _tmp25 = Scalar(0.20999999999999999) * _tmp5 + Scalar(0.20999999999999999) * _tmp8;
  ...
  const Scalar _tmp37 = -Scalar(0.010999999999999999) * _tmp11 -
  ...
  const Scalar _tmp46 = _tmp24 + _tmp30 + _tmp45;
  ...
  const Scalar _tmp58 = _tmp19 + _tmp9;
  ...
  const Scalar _tmp85 = _tmp36 + _tmp51;
  const Scalar _tmp86 = _tmp79 * _tmp83;
  const Scalar _tmp87 = _tmp62 * _tmp84 - _tmp86;
  const Scalar _tmp88 = _tmp64 * _tmp87;
  const Scalar _tmp89 = -_tmp66 * _tmp88 - _tmp67 * _tmp84 + _tmp85 * _tmp86;
  const Scalar _tmp90 = _tmp52 * _tmp84 - _tmp54 * _tmp88 - _tmp74 * _tmp89 - _tmp84 * _tmp85;
  ...
  const Scalar _tmp97 = _tmp77 * _tmp84 - _tmp80 * _tmp86 + _tmp84 * _tmp95 - _tmp88 * _tmp96;
  const Scalar _tmp98 = _tmp91 * _tmp97;
  const Scalar _tmp99 = Scalar(1.0) / (_tmp97);
  const Scalar _tmp100 = _tmp90 * _tmp99;
  const Scalar _tmp101 = _tmp100 * (_tmp65 * _tmp96 - _tmp75 * _tmp98 - _tmp95);
  ...
  const Scalar _tmp108 = _tmp21 - p_b(0, 0);
  ...
  const Scalar _tmp113 = _tmp69 * _tmp74 + _tmp72;
  const Scalar _tmp114 = 0;
  const Scalar _tmp115 = _tmp114 * _tmp88;
  const Scalar _tmp116 = _tmp94 * (_tmp114 * _tmp84 - _tmp115 * _tmp50);
  const Scalar _tmp117 = Scalar(1.0) * _tmp99;
  const Scalar _tmp118 = _tmp107 * _tmp109;
  const Scalar _tmp119 = fh1 * (-_tmp110 * _tmp32 + _tmp118 * _tmp20);
  const Scalar _tmp120 = Scalar(1.0) * _tmp71;
  const Scalar _tmp121 = Scalar(1.0) * _tmp64;
  const Scalar _tmp122 = _tmp120 * _tmp64 * _tmp66 * _tmp73 - _tmp121 * _tmp54;
  const Scalar _tmp123 = _tmp100 * (-_tmp121 * _tmp96 - _tmp122 * _tmp98);
  const Scalar _tmp124 = _tmp122 + _tmp123;
  const Scalar _tmp125 = -_tmp104 * _tmp124 + Scalar(1.0);
  const Scalar _tmp126 = _tmp118 * fh1;
  const Scalar _tmp127 = -_tmp111 * _tmp94 * (_tmp102 * _tmp103 + _tmp105 * _tmp106 + Scalar(1.0)) -
                         _tmp112 * _tmp116 -
                         _tmp119 * _tmp94 * (-_tmp117 * _tmp50 * _tmp88 + _tmp117 * _tmp84) -
                         _tmp126 * _tmp94 * (_tmp103 * _tmp124 + _tmp106 * _tmp125);
  const Scalar _tmp128 = Scalar(1.0) / (_tmp127);
  const Scalar _tmp129 = _tmp89 * _tmp91;
  const Scalar _tmp130 = _tmp70 + _tmp77;
  const Scalar _tmp131 = _tmp130 * _tmp74;
  const Scalar _tmp132 = Scalar(1.0) / (-_tmp131 + _tmp72 - _tmp80);
  const Scalar _tmp133 = _tmp130 * _tmp132;
  const Scalar _tmp134 = _tmp101 * _tmp133 - _tmp102 * _tmp129 + _tmp68;
  const Scalar _tmp135 = Scalar(1.0) * _tmp132;
  const Scalar _tmp136 = Scalar(1.0) * fh1;
  const Scalar _tmp137 = _tmp113 * _tmp132;
  const Scalar _tmp138 = _tmp71 * (-_tmp114 * _tmp89 - _tmp130 * _tmp137 + _tmp70);
  const Scalar _tmp139 = -Scalar(1.0) * _tmp113 * _tmp135 - Scalar(1.0) * _tmp138 + Scalar(1.0);
  const Scalar _tmp140 = _tmp100 * _tmp135;
  const Scalar _tmp141 = _tmp130 * _tmp135;
  const Scalar _tmp142 = _tmp100 * _tmp141 - _tmp117 * _tmp89;
  const Scalar _tmp143 = -_tmp121 * _tmp66 + _tmp123 * _tmp133 - _tmp124 * _tmp129;
  const Scalar _tmp144 = fh1 * (_tmp35 + _tmp39);
  const Scalar _tmp145 = _tmp110 * _tmp144 + Scalar(3.29616) * _tmp17 + _tmp20 * fv1;
  const Scalar _tmp146 = -Scalar(1.0) * _tmp135 + Scalar(1.0) * _tmp141 * _tmp71;
  const Scalar _tmp147 = -_tmp118 * _tmp144 - Scalar(3.29616) * _tmp28 - _tmp32 * fv1;
  const Scalar _tmp148 = _tmp135 * _tmp74;
  const Scalar _tmp149 = _tmp71 * (_tmp131 * _tmp135 + Scalar(1.0));
  const Scalar _tmp150 = Scalar(1.0) * _tmp148 - Scalar(1.0) * _tmp149;
  const Scalar _tmp151 = _tmp110 * _tmp136 * (_tmp101 * _tmp135 - _tmp120 * _tmp134) +
                         _tmp112 * _tmp139 +
                         _tmp118 * _tmp136 * (-_tmp120 * _tmp143 + _tmp123 * _tmp135) +
                         Scalar(1.0) * _tmp119 * (-_tmp120 * _tmp142 + _tmp140) +
                         _tmp145 * _tmp146 + _tmp147 * _tmp150;
  const Scalar _tmp152 = std::asinh(_tmp128 * _tmp151);
  const Scalar _tmp153 = Scalar(1.0) * _tmp152;
  const Scalar _tmp154 = _tmp29 + _tmp76;
  const Scalar _tmp155 = std::pow(_tmp127, Scalar(-2));
  const Scalar _tmp156 = _tmp116 * _tmp155;
  const Scalar _tmp157 =
      (_tmp128 * (-_tmp139 + _tmp146 * _tmp20 + _tmp150 * _tmp154) - _tmp151 * _tmp156) /
      std::sqrt(Scalar(std::pow(_tmp151, Scalar(2)) * _tmp155 + 1));
  const Scalar _tmp158 = Scalar(9.6622558468725703) * _tmp127;
  const Scalar _tmp159 =
      -_tmp152 * _tmp158 - std::sqrt(Scalar(std::pow(Scalar(-_tmp56 + p_c(1, 0)), Scalar(2)) +
                                            std::pow(Scalar(-_tmp59 + p_c(0, 0)), Scalar(2))));
  const Scalar _tmp160 = Scalar(9.6622558468725703) * _tmp116;
  const Scalar _tmp161 = Scalar(0.1034955) * _tmp128;
  const Scalar _tmp162 = _tmp159 * _tmp161;
  const Scalar _tmp163 = _tmp135 * _tmp145;
  const Scalar _tmp164 = _tmp130 * _tmp71;
  const Scalar _tmp165 = _tmp111 * _tmp134 * _tmp71 + _tmp112 * _tmp138 +
                         _tmp119 * _tmp142 * _tmp71 + _tmp126 * _tmp143 * _tmp71 +
                         _tmp147 * _tmp149 - _tmp163 * _tmp164;
  const Scalar _tmp166 = _tmp112 * _tmp114;
  const Scalar _tmp167 = _tmp117 * _tmp119;
  const Scalar _tmp168 = _tmp64 * fh1;
  const Scalar _tmp169 = _tmp105 * _tmp110 * _tmp168 + _tmp118 * _tmp125 * _tmp168 -
                         _tmp166 * _tmp88 - _tmp167 * _tmp88;
  ...
  const Scalar _tmp178 = Scalar(9.6622558468725703) * _tmp114;
  const Scalar _tmp179 = _tmp178 * _tmp88;
  const Scalar _tmp180 = _tmp135 * _tmp20;
  const Scalar _tmp181 =
      (-_tmp165 * _tmp177 + _tmp170 * (-_tmp138 + _tmp149 * _tmp154 - _tmp164 * _tmp180)) /
      std::sqrt(Scalar(std::pow(_tmp165, Scalar(2)) * _tmp176 + 1));
  const Scalar _tmp182 = Scalar(1.0) * _tmp171;
  const Scalar _tmp183 = -_tmp101 * _tmp111 * _tmp132 + _tmp112 * _tmp137 - _tmp119 * _tmp140 -
                         _tmp123 * _tmp126 * _tmp132 - _tmp147 * _tmp148 + _tmp163;
  const Scalar _tmp184 =
      _tmp102 * _tmp111 * _tmp91 + _tmp124 * _tmp126 * _tmp91 + _tmp166 + _tmp167;
  ...
  const Scalar _tmp188 =
      -_tmp186 * _tmp187 - std::sqrt(Scalar(std::pow(Scalar(-_tmp78 + p_d(1, 0)), Scalar(2)) +
  ...
  const Scalar _tmp194 = (_tmp183 * _tmp193 + _tmp185 * (-_tmp137 - _tmp148 * _tmp154 + _tmp180)) /
  ...
  _res(2, 0) = _tmp172 * (-Scalar(1.0) * _tmp181 * std::cosh(_tmp182) -
                          (-Scalar(0.1034955) * _tmp173 * _tmp177 +
                           _tmp174 * (-_tmp171 * _tmp179 - _tmp172 * _tmp181)) *
                              std::cosh(_tmp175)) +
               _tmp179 * (-std::sinh(_tmp175) - std::sinh(_tmp182));
  _res(3, 0) = -_tmp178 * (-std::sinh(_tmp190) - std::sinh(_tmp191)) +
               _tmp187 * (-Scalar(1.0) * _tmp194 * std::cosh(_tmp191) -
                          (Scalar(0.1034955) * _tmp188 * _tmp193 +
                           _tmp189 * (_tmp178 * _tmp186 - _tmp187 * _tmp194)) *
                              std::cosh(_tmp190));
