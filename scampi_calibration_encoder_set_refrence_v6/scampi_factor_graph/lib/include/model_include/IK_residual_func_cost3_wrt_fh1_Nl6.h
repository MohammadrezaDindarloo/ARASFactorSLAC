...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl6(
  ...
  const Scalar _tmp47 = _tmp46 - p_c(0, 0) + p_init0;
  const Scalar _tmp48 = _tmp13 + _tmp9;
  ...
  const Scalar _tmp57 = Scalar(1.0) / (_tmp43 * _tmp52 - _tmp55);
  const Scalar _tmp58 = _tmp27 * _tmp43 - _tmp35;
  const Scalar _tmp59 = _tmp57 * _tmp58;
  const Scalar _tmp60 = Scalar(1.0) * _tmp37;
  const Scalar _tmp61 = Scalar(1.0) * _tmp40;
  const Scalar _tmp62 = (-_tmp46 + _tmp61) / (_tmp49 - _tmp60);
  const Scalar _tmp63 = -_tmp52 * _tmp54 + _tmp53;
  const Scalar _tmp64 = _tmp27 * _tmp32 - _tmp27 * _tmp34 - _tmp59 * _tmp63 -
                        _tmp62 * (-_tmp27 * _tmp44 + _tmp34 * _tmp35 - _tmp56 * _tmp59);
  const Scalar _tmp65 = Scalar(1.0) / (_tmp64);
  const Scalar _tmp66 = _tmp56 * _tmp57;
  const Scalar _tmp67 = _tmp57 * _tmp63;
  const Scalar _tmp68 = -_tmp32 + _tmp43 * _tmp67 - _tmp62 * (_tmp43 * _tmp66 + _tmp44);
  const Scalar _tmp69 =
      std::sqrt(Scalar(std::pow(_tmp38, Scalar(2)) + std::pow(_tmp41, Scalar(2))));
  const Scalar _tmp70 = Scalar(1.0) / (_tmp69);
  const Scalar _tmp71 = _tmp42 * _tmp69;
  const Scalar _tmp72 = _tmp71 * (-_tmp37 * _tmp41 * _tmp70 + _tmp38 * _tmp40 * _tmp70);
  const Scalar _tmp73 = _tmp57 * (-_tmp46 * _tmp55 + _tmp49 * _tmp52 + _tmp52 * _tmp72);
  const Scalar _tmp74 = _tmp15 * _tmp27 - _tmp24 * _tmp35 + _tmp27 * _tmp72 - _tmp58 * _tmp73;
  const Scalar _tmp75 = _tmp65 * _tmp74;
  const Scalar _tmp76 = Scalar(1.0) / (_tmp74);
  const Scalar _tmp77 = _tmp64 * _tmp76;
  const Scalar _tmp78 = _tmp68 + _tmp77 * (_tmp43 * _tmp73 - _tmp68 * _tmp75 - _tmp72);
  const Scalar _tmp79 = _tmp65 * _tmp78;
  const Scalar _tmp80 = _tmp58 * _tmp65;
  const Scalar _tmp81 = -_tmp43 - _tmp78 * _tmp80;
  const Scalar _tmp82 = _tmp52 * _tmp57;
  const Scalar _tmp83 = _tmp36 + _tmp48;
  const Scalar _tmp84 = _tmp83 - p_b(1, 0) + p_init1;
  const Scalar _tmp85 = _tmp39 + _tmp45;
  const Scalar _tmp86 = _tmp85 - p_b(0, 0) + p_init0;
  const Scalar _tmp87 = std::pow(Scalar(std::pow(_tmp84, Scalar(2)) + std::pow(_tmp86, Scalar(2))),
                                 Scalar(Scalar(-1) / Scalar(2)));
  const Scalar _tmp88 = _tmp86 * _tmp87;
  const Scalar _tmp89 = _tmp71 * _tmp88 * (_tmp27 * _tmp79 + _tmp81 * _tmp82 + Scalar(1.0));
  ...
  const Scalar _tmp94 = _tmp71 * _tmp91 * (_tmp27 * _tmp92 - _tmp92 * _tmp93);
  const Scalar _tmp95 = Scalar(1.0) * _tmp62 * _tmp66 - Scalar(1.0) * _tmp67;
  const Scalar _tmp96 = _tmp77 * (-Scalar(1.0) * _tmp73 - _tmp75 * _tmp95) + _tmp95;
  const Scalar _tmp97 = _tmp65 * _tmp96;
  const Scalar _tmp98 = -_tmp80 * _tmp96 + Scalar(1.0);
  const Scalar _tmp99 = _tmp71 * _tmp90 * (_tmp27 * _tmp97 + _tmp82 * _tmp98);
  const Scalar _tmp100 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp101 = _tmp60 * _tmp62 + _tmp61;
  const Scalar _tmp102 = 0;
  const Scalar _tmp103 = _tmp57 * _tmp81 * _tmp88;
  const Scalar _tmp104 = _tmp57 * _tmp90 * _tmp98;
  const Scalar _tmp105 = _tmp91 * _tmp92;
  const Scalar _tmp106 = _tmp105 * fh1;
  const Scalar _tmp107 = _tmp100 * _tmp102;
  const Scalar _tmp108 = _tmp79 * _tmp88;
  const Scalar _tmp109 = _tmp90 * _tmp97;

  // Output terms (1)
  Eigen::Matrix<Scalar, 4, 1> _res;

  _res(0, 0) = -std::exp(-fh1);
  _res(1, 0) = -(-_tmp89 - _tmp94 - _tmp99) *
               std::exp(_tmp100 * _tmp71 * (_tmp102 * _tmp27 - _tmp102 * _tmp93) + _tmp89 * fh1 +
                        _tmp94 * fh1 + _tmp99 * fh1);
  _res(2, 0) = -(_tmp103 + _tmp104 - _tmp105 * _tmp59) *
               std::exp(-_tmp103 * fh1 - _tmp104 * fh1 + _tmp106 * _tmp59 + _tmp107 * _tmp59);
  _res(3, 0) =
      -(_tmp105 + _tmp108 + _tmp109) * std::exp(-_tmp106 - _tmp107 - _tmp108 * fh1 - _tmp109 * fh1);
