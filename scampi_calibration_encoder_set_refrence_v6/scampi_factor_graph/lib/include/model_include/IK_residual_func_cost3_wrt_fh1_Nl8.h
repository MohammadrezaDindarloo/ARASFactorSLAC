...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl8(
  ...
  const Scalar _tmp20 = _tmp5 * _tmp9;
  const Scalar _tmp21 =
  ...
  const Scalar _tmp33 = _tmp29 - _tmp30;
  const Scalar _tmp34 = _tmp31 + _tmp33;
  const Scalar _tmp35 = -_tmp31 + _tmp33;
  const Scalar _tmp36 = -_tmp18;
  const Scalar _tmp37 = _tmp24 + _tmp36;
  const Scalar _tmp38 = _tmp37 - p_a(0, 0) + p_init0;
  ...
  const Scalar _tmp48 = _tmp47 - p_c(1, 0) + p_init1;
  ...
  const Scalar _tmp57 = _tmp28 * _tmp53 - _tmp56;
  const Scalar _tmp58 = _tmp55 * _tmp57;
  const Scalar _tmp59 = _tmp32 * _tmp53;
  const Scalar _tmp60 = _tmp35 * _tmp54 - _tmp44 * _tmp53;
  const Scalar _tmp61 = Scalar(1.0) * _tmp47;
  const Scalar _tmp62 = Scalar(1.0) * _tmp50;
  const Scalar _tmp63 = (-_tmp37 + _tmp62) / (_tmp40 - _tmp61);
  const Scalar _tmp64 = _tmp28 * _tmp32 - _tmp28 * _tmp34 - _tmp45 * _tmp58 -
                        _tmp63 * (-_tmp28 * _tmp59 + _tmp34 * _tmp56 - _tmp58 * _tmp60);
  const Scalar _tmp65 = Scalar(1.0) / (_tmp64);
  const Scalar _tmp66 = _tmp53 * _tmp55;
  const Scalar _tmp67 = -_tmp32 + _tmp45 * _tmp66 - _tmp63 * (_tmp59 + _tmp60 * _tmp66);
  const Scalar _tmp68 =
      std::sqrt(Scalar(std::pow(_tmp48, Scalar(2)) + std::pow(_tmp51, Scalar(2))));
  const Scalar _tmp69 = Scalar(1.0) / (_tmp68);
  const Scalar _tmp70 = _tmp52 * _tmp68;
  const Scalar _tmp71 = _tmp70 * (-_tmp47 * _tmp51 * _tmp69 + _tmp48 * _tmp50 * _tmp69);
  const Scalar _tmp72 = -_tmp37 * _tmp54 + _tmp40 * _tmp43 + _tmp43 * _tmp71;
  const Scalar _tmp73 = _tmp16 * _tmp28 - _tmp25 * _tmp56 + _tmp28 * _tmp71 - _tmp58 * _tmp72;
  const Scalar _tmp74 = _tmp65 * _tmp73;
  const Scalar _tmp75 = Scalar(1.0) / (_tmp73);
  const Scalar _tmp76 = _tmp64 * _tmp75;
  const Scalar _tmp77 = _tmp67 + _tmp76 * (_tmp66 * _tmp72 - _tmp67 * _tmp74 - _tmp71);
  const Scalar _tmp78 = _tmp65 * _tmp77;
  const Scalar _tmp79 = _tmp57 * _tmp65;
  const Scalar _tmp80 = _tmp55 * (-_tmp53 - _tmp77 * _tmp79);
  const Scalar _tmp81 = _tmp39 + _tmp46;
  const Scalar _tmp82 = _tmp81 - p_b(1, 0) + p_init1;
  const Scalar _tmp83 = _tmp36 + _tmp49;
  ...
  const Scalar _tmp87 = _tmp70 * _tmp86 * (_tmp28 * _tmp78 + _tmp43 * _tmp80 + Scalar(1.0));
  ...
  const Scalar _tmp92 = -_tmp81 * _tmp86 + _tmp83 * _tmp91;
  const Scalar _tmp93 = Scalar(1.0) * _tmp55;
  const Scalar _tmp94 = _tmp57 * _tmp75 * _tmp93;
  const Scalar _tmp95 = Scalar(1.0) * _tmp75;
  const Scalar _tmp96 = _tmp70 * _tmp92 * (_tmp28 * _tmp95 - _tmp43 * _tmp94);
  const Scalar _tmp97 = -_tmp45 * _tmp93 + _tmp60 * _tmp63 * _tmp93;
  const Scalar _tmp98 = _tmp76 * (-_tmp72 * _tmp93 - _tmp74 * _tmp97) + _tmp97;
  const Scalar _tmp99 = _tmp55 * (-_tmp79 * _tmp98 + Scalar(1.0));
  const Scalar _tmp100 = _tmp65 * _tmp98;
  const Scalar _tmp101 = _tmp70 * _tmp91 * (_tmp100 * _tmp28 + _tmp43 * _tmp99);
  const Scalar _tmp102 = _tmp88 * _tmp90;
  const Scalar _tmp103 = _tmp92 * _tmp94;
  const Scalar _tmp104 = _tmp80 * _tmp86;
  const Scalar _tmp105 = _tmp91 * _tmp99;
  const Scalar _tmp106 = _tmp78 * _tmp86;
  const Scalar _tmp107 = _tmp100 * _tmp91;
  const Scalar _tmp108 = _tmp92 * _tmp95;
  ...
  _res(1, 0) =
      -(-_tmp101 - _tmp87 - _tmp96) *
      std::exp(_tmp101 * fh1 + _tmp70 * _tmp88 * (_tmp28 * _tmp90 - _tmp43 * _tmp58 * _tmp90) +
               _tmp87 * fh1 + _tmp96 * fh1);
  _res(2, 0) = -(-_tmp103 + _tmp104 + _tmp105) *
               std::exp(_tmp102 * _tmp58 + _tmp103 * fh1 - _tmp104 * fh1 - _tmp105 * fh1);
  _res(3, 0) = -(_tmp106 + _tmp107 + _tmp108) *
               std::exp(-_tmp102 - _tmp106 * fh1 - _tmp107 * fh1 - _tmp108 * fh1);
