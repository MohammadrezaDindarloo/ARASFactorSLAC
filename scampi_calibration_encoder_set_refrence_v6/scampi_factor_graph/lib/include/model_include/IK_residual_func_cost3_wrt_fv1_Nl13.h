...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl13(
  ...
  const Scalar _tmp35 = _tmp34 - p_d(1, 0) + p_init1;
  const Scalar _tmp36 = _tmp23 + _tmp24;
  const Scalar _tmp37 = _tmp20 + _tmp36;
  const Scalar _tmp38 = _tmp37 - p_d(0, 0) + p_init0;
  ...
  const Scalar _tmp42 = _tmp33 * _tmp40 + _tmp34 * _tmp40 - _tmp37 * _tmp41;
  const Scalar _tmp43 = Scalar(1.0) / (_tmp29 * _tmp40 - _tmp41);
  ...
  const Scalar _tmp56 = (-_tmp37 + _tmp55) / (_tmp34 - _tmp54);
  const Scalar _tmp57 = -_tmp40 * _tmp49 + _tmp40 * _tmp51;
  ...
  const Scalar _tmp92 = _tmp32 * (-_tmp40 * _tmp91 + _tmp65 * _tmp90);
  ...
  const Scalar _tmp96 = Scalar(1.0) * _tmp43;
  const Scalar _tmp97 = _tmp53 * _tmp56 * _tmp96 - _tmp57 * _tmp96;
  const Scalar _tmp98 = _tmp75 * (-_tmp42 * _tmp96 - _tmp73 * _tmp97) + _tmp97;
  ...
  _res(1, 0) =
      -_tmp92 *
      std::exp(_tmp100 * _tmp32 * (_tmp79 * _tmp99 + _tmp80 * _tmp98) +
               _tmp32 * _tmp87 * (_tmp76 * _tmp80 + _tmp78 * _tmp79 + Scalar(1.0)) +
               _tmp32 * _tmp95 * (-_tmp40 * _tmp68 * _tmp93 + _tmp65 * _tmp93) + _tmp88 * _tmp92);
  _res(2, 0) = -_tmp91 * std::exp(-_tmp100 * _tmp43 * _tmp99 + _tmp101 * _tmp68 + _tmp102 * _tmp68 -
                                  _tmp43 * _tmp78 * _tmp87);
  _res(3, 0) =
      _tmp90 * std::exp(-_tmp100 * _tmp71 * _tmp98 - _tmp101 - _tmp102 - _tmp71 * _tmp76 * _tmp87);
