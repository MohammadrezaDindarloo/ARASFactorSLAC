...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl16(
  ...
  const Scalar _tmp58 = _tmp57 - p_b(0, 0) + p_init0;
  ...
  const Scalar _tmp62 = _tmp44 * _tmp60 - _tmp61;
  const Scalar _tmp63 = _tmp46 * _tmp62;
  const Scalar _tmp64 = _tmp15 * _tmp60;
  const Scalar _tmp65 = _tmp10 + _tmp13 + _tmp36;
  const Scalar _tmp66 = -_tmp38 * _tmp63 -
                        _tmp51 * (-_tmp44 * _tmp64 - _tmp48 * _tmp63 + _tmp61 * _tmp65) -
                        _tmp60 * _tmp65 + _tmp64;
  ...
  const Scalar _tmp71 = _tmp70 * (-_tmp39 * _tmp42 * _tmp69 + _tmp40 * _tmp41 * _tmp69);
  const Scalar _tmp72 = -_tmp24 * _tmp45 + _tmp31 * _tmp34 + _tmp34 * _tmp71;
  const Scalar _tmp73 = _tmp54 * _tmp60 - _tmp57 * _tmp61 + _tmp60 * _tmp71 - _tmp63 * _tmp72;
  const Scalar _tmp74 = _tmp67 * _tmp73;
  const Scalar _tmp75 = Scalar(1.0) / (_tmp73);
  const Scalar _tmp76 = _tmp66 * _tmp75;
  const Scalar _tmp77 = _tmp52 + _tmp76 * (_tmp47 * _tmp72 - _tmp52 * _tmp74 - _tmp71);
  ...
  const Scalar _tmp82 = _tmp18 + _tmp56;
  const Scalar _tmp83 = _tmp82 - p_c(0, 0) + p_init0;
  const Scalar _tmp84 = _tmp26 + _tmp53;
  ...
  const Scalar _tmp90 = _tmp62 * _tmp75 * _tmp89;
  ...
  const Scalar _tmp95 = _tmp76 * (-_tmp72 * _tmp89 - _tmp74 * _tmp94) + _tmp94;
  ...
  const Scalar _tmp101 = _tmp70 * (-_tmp100 * _tmp34 + _tmp60 * _tmp99);
  ...
  _res(0, 0) = 0;
  _res(1, 0) = -_tmp101 *
               std::exp(_tmp101 * _tmp97 + _tmp70 * _tmp93 * (-_tmp34 * _tmp90 + _tmp60 * _tmp91) +
                        _tmp87 * _tmp88 * (_tmp77 * _tmp78 + _tmp80 * _tmp81 + Scalar(1.0)) +
                        _tmp88 * _tmp92 * (_tmp78 * _tmp95 + _tmp81 * _tmp96));
  _res(2, 0) = -_tmp100 * std::exp(-_tmp102 * _tmp80 * _tmp87 - _tmp102 * _tmp92 * _tmp96 +
                                   _tmp103 * _tmp63 + _tmp90 * _tmp93);
  _res(3, 0) = _tmp99 * std::exp(-_tmp103 - _tmp104 * _tmp77 * _tmp87 - _tmp104 * _tmp92 * _tmp95 -
                                 _tmp91 * _tmp93);
