...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl2(
  ...
  const Scalar _tmp52 = _tmp25 + _tmp29;
  ...
  const Scalar _tmp61 = _tmp50 * _tmp60 - _tmp51;
  const Scalar _tmp62 = _tmp24 + _tmp52;
  const Scalar _tmp63 = _tmp62 + p_init1;
  const Scalar _tmp64 = _tmp63 - p_b(1, 0);
  const Scalar _tmp65 = _tmp19 + _tmp7;
  ...
  const Scalar _tmp72 = _tmp35 + _tmp40;
  const Scalar _tmp73 = _tmp71 * (_tmp41 * _tmp69 - _tmp69 * _tmp72);
  const Scalar _tmp74 = _tmp34 + _tmp38;
  const Scalar _tmp75 = _tmp41 * _tmp60;
  const Scalar _tmp76 = _tmp71 * (-_tmp69 * _tmp75 + _tmp70 * _tmp72);
  const Scalar _tmp77 = -_tmp50 * _tmp75 + _tmp51 * _tmp74 - _tmp61 * _tmp76;
  ...
  const Scalar _tmp84 = _tmp41 * _tmp50 - _tmp50 * _tmp74 - _tmp61 * _tmp73 - _tmp77 * _tmp83;
  const Scalar _tmp85 = Scalar(1.0) / (_tmp84);
  const Scalar _tmp86 = Scalar(1.0) * _tmp80;
  const Scalar _tmp87 = -Scalar(1.0) * _tmp73 + _tmp76 * _tmp82 * _tmp86;
  const Scalar _tmp88 =
      std::sqrt(Scalar(std::pow(_tmp55, Scalar(2)) + std::pow(_tmp58, Scalar(2))));
  const Scalar _tmp89 = Scalar(1.0) / (_tmp88);
  const Scalar _tmp90 = _tmp59 * _tmp88;
  const Scalar _tmp91 = _tmp90 * (-_tmp53 * _tmp58 * _tmp89 + _tmp55 * _tmp56 * _tmp89);
  const Scalar _tmp92 = _tmp71 * (_tmp62 * _tmp69 - _tmp65 * _tmp70 + _tmp69 * _tmp91);
  const Scalar _tmp93 = _tmp42 * _tmp50 - _tmp46 * _tmp51 + _tmp50 * _tmp91 - _tmp61 * _tmp92;
  ...
  const Scalar _tmp99 = -_tmp61 * _tmp98 + Scalar(1.0);
  const Scalar _tmp100 = _tmp69 * _tmp71;
  ...
  const Scalar _tmp109 = _tmp100 * _tmp61;
  const Scalar _tmp110 = _tmp60 * _tmp76 + _tmp75;
  const Scalar _tmp111 = -_tmp110 * _tmp83 - _tmp41 + _tmp60 * _tmp73;
  const Scalar _tmp112 = _tmp96 * (-_tmp111 * _tmp94 + _tmp60 * _tmp92 - _tmp91);
  const Scalar _tmp113 = _tmp85 * (_tmp111 + _tmp112);
  const Scalar _tmp114 = -_tmp113 * _tmp61 - _tmp60;
  const Scalar _tmp115 = _tmp101 * _tmp103;
  const Scalar _tmp116 = _tmp115 * fh1;
  const Scalar _tmp117 = Scalar(1.0) * _tmp95;
  const Scalar _tmp118 = fh1 * (_tmp104 * _tmp20 - _tmp115 * _tmp31);
  const Scalar _tmp119 = -_tmp105 * _tmp90 * (_tmp100 * _tmp99 + _tmp50 * _tmp98) -
                         _tmp106 * _tmp90 * (-_tmp108 * _tmp109 + _tmp108 * _tmp50) -
                         _tmp116 * _tmp90 * (_tmp100 * _tmp114 + _tmp113 * _tmp50 + Scalar(1.0)) -
                         _tmp118 * _tmp90 * (-_tmp109 * _tmp117 + _tmp117 * _tmp50);
  const Scalar _tmp120 = Scalar(1.0) / (_tmp119);
  const Scalar _tmp121 = Scalar(0.1034955) * _tmp120;
  const Scalar _tmp122 = _tmp42 + _tmp79;
  const Scalar _tmp123 = _tmp122 * _tmp83;
  const Scalar _tmp124 = Scalar(1.0) / (-_tmp123 - _tmp46 + _tmp81);
  const Scalar _tmp125 = Scalar(1.0) * _tmp124;
  const Scalar _tmp126 = _tmp122 * _tmp124;
  const Scalar _tmp127 = _tmp110 + _tmp112 * _tmp126 - _tmp113 * _tmp77;
  const Scalar _tmp128 = _tmp107 * _tmp124;
  const Scalar _tmp129 = -_tmp108 * _tmp77 - _tmp122 * _tmp128 + _tmp79;
  const Scalar _tmp130 = _tmp39 * fh1;
  const Scalar _tmp131 = _tmp115 * _tmp130 + Scalar(5.1796800000000003) * _tmp13 + _tmp20 * fv1;
  const Scalar _tmp132 = _tmp122 * _tmp80;
  const Scalar _tmp133 = -_tmp104 * _tmp130 - Scalar(5.1796800000000003) * _tmp28 - _tmp31 * fv1;
  const Scalar _tmp134 = _tmp123 * _tmp125 + Scalar(1.0);
  const Scalar _tmp135 = _tmp125 * _tmp83;
  const Scalar _tmp136 = _tmp126 * _tmp97 - Scalar(1.0) * _tmp76 - _tmp77 * _tmp98;
  const Scalar _tmp137 = _tmp125 * _tmp96;
  const Scalar _tmp138 = -_tmp117 * _tmp77 + _tmp122 * _tmp137;
  const Scalar _tmp139 = std::asinh(
      _tmp120 * (Scalar(1.0) * _tmp105 * (_tmp125 * _tmp97 - _tmp136 * _tmp86) +
                 Scalar(1.0) * _tmp106 * (-_tmp107 * _tmp125 - _tmp129 * _tmp86 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp116 * (_tmp112 * _tmp125 - _tmp127 * _tmp86) +
                 Scalar(1.0) * _tmp118 * (_tmp137 - _tmp138 * _tmp86) +
                 Scalar(1.0) * _tmp131 * (_tmp125 * _tmp132 - _tmp125) +
                 Scalar(1.0) * _tmp133 * (-_tmp134 * _tmp86 + _tmp135)));
  const Scalar _tmp140 = Scalar(9.6622558468725703) * _tmp119;
  const Scalar _tmp141 = _tmp106 * _tmp108;
  const Scalar _tmp142 = _tmp61 * _tmp71;
  const Scalar _tmp143 = _tmp117 * _tmp118;
  const Scalar _tmp144 = _tmp105 * _tmp71 * _tmp99 + _tmp114 * _tmp116 * _tmp71 -
                         _tmp141 * _tmp142 - _tmp142 * _tmp143;
  const Scalar _tmp145 = Scalar(1.0) / (_tmp144);
  const Scalar _tmp146 = _tmp125 * _tmp131;
  const Scalar _tmp147 =
      std::asinh(_tmp145 * (_tmp105 * _tmp136 * _tmp80 + _tmp106 * _tmp129 * _tmp80 +
                            _tmp116 * _tmp127 * _tmp80 + _tmp118 * _tmp138 * _tmp80 -
                            _tmp132 * _tmp146 + _tmp133 * _tmp134 * _tmp80));
  const Scalar _tmp148 = Scalar(9.6622558468725703) * _tmp144;
  const Scalar _tmp149 = Scalar(0.1034955) * _tmp145;
  const Scalar _tmp150 = _tmp105 * _tmp98 + _tmp113 * _tmp116 + _tmp141 + _tmp143;
  const Scalar _tmp151 = Scalar(1.0) / (_tmp150);
  const Scalar _tmp152 = Scalar(0.1034955) * _tmp151;
  const Scalar _tmp153 = std::asinh(_tmp151 * (-_tmp105 * _tmp124 * _tmp97 + _tmp106 * _tmp128 -
                                               _tmp112 * _tmp116 * _tmp124 - _tmp118 * _tmp137 -
  ...
  _res(1, 0) =
      -_tmp140 *
          (_tmp121 * p_c(2, 0) + std::cosh(Scalar(1.0) * _tmp139) -
           std::cosh(_tmp121 *
                     (-_tmp139 * _tmp140 -
                      std::sqrt(Scalar(std::pow(Scalar(-_tmp54 + p_c(1, 0)), Scalar(2)) +
  ...
  _res(2, 0) =
      -_tmp148 *
          (_tmp149 * p_b(2, 0) + std::cosh(Scalar(1.0) * _tmp147) -
           std::cosh(_tmp149 *
                     (-_tmp147 * _tmp148 -
                      std::sqrt(Scalar(std::pow(Scalar(-_tmp63 + p_b(1, 0)), Scalar(2)) +
                                       std::pow(Scalar(-_tmp66 + p_b(0, 0)), Scalar(2))))))) +
      _tmp72 + p_init2;
  _res(3, 0) =
      -_tmp154 *
          (_tmp152 * p_d(2, 0) + std::cosh(Scalar(1.0) * _tmp153) -
           std::cosh(_tmp152 *
                     (-_tmp153 * _tmp154 -
                      std::sqrt(Scalar(std::pow(Scalar(-_tmp43 + p_d(1, 0)), Scalar(2)) +
