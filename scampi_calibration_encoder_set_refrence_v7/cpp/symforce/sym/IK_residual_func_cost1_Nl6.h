...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl6(
  ...
  const Scalar _tmp39 = -_tmp13 + _tmp18;
  const Scalar _tmp40 = _tmp39 + _tmp9;
  const Scalar _tmp41 = _tmp10 + _tmp39;
  ...
  const Scalar _tmp52 = _tmp19 + _tmp9;
  ...
  const Scalar _tmp91 = _tmp81 * _tmp88;
  const Scalar _tmp92 = _tmp33 + _tmp37;
  const Scalar _tmp93 = -_tmp74 * _tmp91 + _tmp82 * _tmp92;
  const Scalar _tmp94 = _tmp75 * _tmp83;
  const Scalar _tmp95 = -_tmp63 * _tmp90 + _tmp73 * _tmp89 - _tmp93 * _tmp94;
  const Scalar _tmp96 = -_tmp81 * _tmp92 + _tmp91;
  const Scalar _tmp97 = -_tmp54 * _tmp95 + _tmp63 * _tmp88 - _tmp63 * _tmp89 - _tmp94 * _tmp96;
  const Scalar _tmp98 = _tmp86 * _tmp97;
  const Scalar _tmp99 = _tmp57 * _tmp98;
  const Scalar _tmp100 = Scalar(1.0) * _tmp86;
  const Scalar _tmp101 = _tmp49 * _tmp57;
  const Scalar _tmp102 = -_tmp100 * _tmp95 + _tmp101 * _tmp98;
  const Scalar _tmp103 = Scalar(1.0) * _tmp51;
  const Scalar _tmp104 = _tmp31 - p_b(1, 0);
  ...
  const Scalar _tmp109 = fh1 * (-_tmp107 * _tmp30 + _tmp108 * _tmp20);
  const Scalar _tmp110 = Scalar(1.0) * _tmp83;
  const Scalar _tmp111 = _tmp103 * _tmp53 * _tmp83 * _tmp93 - _tmp110 * _tmp96;
  const Scalar _tmp112 = Scalar(1.0) / (_tmp97);
  const Scalar _tmp113 = _tmp112 * _tmp85;
  const Scalar _tmp114 = _tmp98 * (-_tmp111 * _tmp113 - Scalar(1.0) * _tmp84);
  const Scalar _tmp115 = _tmp49 * _tmp56;
  const Scalar _tmp116 = _tmp111 + _tmp114;
  const Scalar _tmp117 = _tmp112 * _tmp95;
  const Scalar _tmp118 = -_tmp110 * _tmp93 + _tmp114 * _tmp115 - _tmp116 * _tmp117;
  const Scalar _tmp119 = _tmp108 * fh1;
  const Scalar _tmp120 = _tmp38 * fh1;
  const Scalar _tmp121 = _tmp107 * _tmp120 + Scalar(5.1796800000000003) * _tmp17 + _tmp20 * fv1;
  const Scalar _tmp122 = _tmp74 * _tmp83;
  const Scalar _tmp123 = _tmp122 * _tmp93 + _tmp90;
  const Scalar _tmp124 = _tmp122 * _tmp96 - _tmp123 * _tmp54 - _tmp88;
  const Scalar _tmp125 = _tmp98 * (-_tmp113 * _tmp124 - _tmp72 + _tmp74 * _tmp84);
  const Scalar _tmp126 = _tmp124 + _tmp125;
  const Scalar _tmp127 = _tmp115 * _tmp125 - _tmp117 * _tmp126 + _tmp123;
  const Scalar _tmp128 = _tmp107 * fh1;
  const Scalar _tmp129 = _tmp54 * _tmp57;
  const Scalar _tmp130 = _tmp55 * _tmp57 + Scalar(1.0);
  const Scalar _tmp131 = -_tmp108 * _tmp120 - Scalar(5.1796800000000003) * _tmp25 - _tmp30 * fv1;
  const Scalar _tmp132 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp133 = _tmp42 + _tmp45 * _tmp54;
  const Scalar _tmp134 = _tmp133 * _tmp56;
  const Scalar _tmp135 = 0;
  const Scalar _tmp136 = _tmp51 * (-_tmp117 * _tmp135 - _tmp134 * _tmp49 + _tmp46);
  const Scalar _tmp137 = _tmp112 * _tmp63;
  const Scalar _tmp138 = _tmp112 * _tmp75;
  const Scalar _tmp139 = -_tmp126 * _tmp138 - _tmp74;
  const Scalar _tmp140 = _tmp81 * _tmp83;
  const Scalar _tmp141 = _tmp81 * _tmp94;
  const Scalar _tmp142 = -_tmp116 * _tmp138 + Scalar(1.0);
  const Scalar _tmp143 = _tmp112 * _tmp135;
  const Scalar _tmp144 = -_tmp109 * _tmp71 * (-_tmp100 * _tmp141 + _tmp100 * _tmp63) -
                         _tmp119 * _tmp71 * (_tmp116 * _tmp137 + _tmp140 * _tmp142) -
                         _tmp128 * _tmp71 * (_tmp126 * _tmp137 + _tmp139 * _tmp140 + Scalar(1.0)) -
                         _tmp132 * _tmp71 * (-_tmp141 * _tmp143 + _tmp143 * _tmp63);
  const Scalar _tmp145 = Scalar(1.0) / (_tmp144);
  const Scalar _tmp146 =
      std::asinh(_tmp145 * (Scalar(1.0) * _tmp109 * (-_tmp102 * _tmp103 + _tmp99) +
                            Scalar(1.0) * _tmp119 * (-_tmp103 * _tmp118 + _tmp114 * _tmp57) +
                            Scalar(1.0) * _tmp121 * (_tmp101 * _tmp51 - _tmp57) +
                            Scalar(1.0) * _tmp128 * (-_tmp103 * _tmp127 + _tmp125 * _tmp57) +
                            Scalar(1.0) * _tmp131 * (-_tmp103 * _tmp130 + _tmp129) +
                            Scalar(1.0) * _tmp132 *
                                (-_tmp133 * _tmp57 - Scalar(1.0) * _tmp136 + Scalar(1.0))));
  ...
  const Scalar _tmp150 = _tmp132 * _tmp143;
  const Scalar _tmp151 =
      _tmp119 * _tmp142 * _tmp83 + _tmp128 * _tmp139 * _tmp83 - _tmp149 * _tmp94 - _tmp150 * _tmp94;
  const Scalar _tmp152 = Scalar(1.0) / (_tmp151);
  const Scalar _tmp153 = _tmp121 * _tmp57;
  const Scalar _tmp154 =
      std::asinh(_tmp152 * (_tmp102 * _tmp109 * _tmp51 + _tmp118 * _tmp119 * _tmp51 +
                            _tmp127 * _tmp128 * _tmp51 + _tmp130 * _tmp131 * _tmp51 +
                            _tmp132 * _tmp136 - _tmp153 * _tmp49 * _tmp51));
  const Scalar _tmp155 = Scalar(0.1034955) * _tmp152;
  const Scalar _tmp156 = Scalar(9.6622558468725703) * _tmp151;
  const Scalar _tmp157 =
      _tmp112 * _tmp116 * _tmp119 + _tmp112 * _tmp126 * _tmp128 + _tmp149 + _tmp150;
  const Scalar _tmp158 = Scalar(1.0) / (_tmp157);
  const Scalar _tmp159 = std::asinh(_tmp158 * (-_tmp109 * _tmp99 - _tmp114 * _tmp119 * _tmp56 -
                                               _tmp125 * _tmp128 * _tmp56 - _tmp129 * _tmp131 +
                                               _tmp132 * _tmp134 + _tmp153));
  ...
  _res(2, 0) =
      -_tmp156 *
          (_tmp155 * p_c(2, 0) + std::cosh(Scalar(1.0) * _tmp154) -
           std::cosh(_tmp155 *
                     (-_tmp154 * _tmp156 -
                      std::sqrt(Scalar(std::pow(Scalar(-_tmp76 + p_c(0, 0)), Scalar(2)) +
