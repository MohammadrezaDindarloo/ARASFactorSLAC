...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1WrtFv1Nl22(
  ...
  const Scalar _tmp54 = _tmp23 + _tmp24 + _tmp29;
  const Scalar _tmp55 = _tmp54 + p_init1;
  const Scalar _tmp56 = _tmp55 - p_c(1, 0);
  const Scalar _tmp57 = _tmp19 + _tmp7;
  ...
  const Scalar _tmp62 = _tmp44 * _tmp49;
  const Scalar _tmp63 = _tmp50 * _tmp61 - _tmp62;
  const Scalar _tmp64 = _tmp45 + _tmp8;
  const Scalar _tmp65 = _tmp64 + p_init0;
  const Scalar _tmp66 = _tmp65 - p_a(0, 0);
  const Scalar _tmp67 = _tmp30 + _tmp40;
  ...
  const Scalar _tmp77 = _tmp73 * (-_tmp71 * _tmp75 + _tmp76);
  const Scalar _tmp78 = _tmp73 * (-_tmp61 * _tmp76 + _tmp72 * _tmp75);
  const Scalar _tmp79 = -_tmp51 * _tmp61 + _tmp53 * _tmp62 - _tmp63 * _tmp78;
  ...
  const Scalar _tmp86 = -_tmp50 * _tmp53 + _tmp51 - _tmp63 * _tmp77 - _tmp79 * _tmp85;
  const Scalar _tmp87 = Scalar(1.0) / (_tmp86);
  const Scalar _tmp88 = _tmp80 * _tmp85 + _tmp83;
  const Scalar _tmp89 = 0;
  const Scalar _tmp90 = _tmp71 * _tmp73;
  ...
  const Scalar _tmp94 = _tmp93 * (_tmp50 * _tmp89 - _tmp89 * _tmp91);
  const Scalar _tmp95 = Scalar(1.0) / (_tmp92);
  const Scalar _tmp96 = _tmp93 * (-_tmp54 * _tmp59 * _tmp95 + _tmp56 * _tmp57 * _tmp95);
  const Scalar _tmp97 = _tmp39 * _tmp61 + _tmp61 * _tmp78;
  const Scalar _tmp98 = -_tmp39 + _tmp61 * _tmp77 - _tmp85 * _tmp97;
  const Scalar _tmp99 = _tmp73 * (-_tmp64 * _tmp72 + _tmp67 * _tmp71 + _tmp71 * _tmp96);
  const Scalar _tmp100 = _tmp42 * _tmp50 - _tmp46 * _tmp62 + _tmp50 * _tmp96 - _tmp63 * _tmp99;
  const Scalar _tmp101 = _tmp100 * _tmp87;
  const Scalar _tmp102 = Scalar(1.0) / (_tmp100);
  const Scalar _tmp103 = _tmp102 * _tmp86;
  const Scalar _tmp104 = _tmp103 * (-_tmp101 * _tmp98 + _tmp61 * _tmp99 - _tmp96);
  const Scalar _tmp105 = _tmp87 * (_tmp104 + _tmp98);
  const Scalar _tmp106 = -_tmp105 * _tmp63 - _tmp61;
  const Scalar _tmp107 = _tmp32 - p_d(1, 0);
  ...
  const Scalar _tmp114 = fh1 * (-_tmp110 * _tmp31 + _tmp113 * _tmp20);
  const Scalar _tmp115 = Scalar(1.0) * _tmp82;
  const Scalar _tmp116 = _tmp115 * _tmp78 * _tmp84 - Scalar(1.0) * _tmp77;
  const Scalar _tmp117 = _tmp103 * (-_tmp101 * _tmp116 - Scalar(1.0) * _tmp99);
  const Scalar _tmp118 = _tmp87 * (_tmp116 + _tmp117);
  const Scalar _tmp119 = -_tmp118 * _tmp63 + Scalar(1.0);
  const Scalar _tmp120 = _tmp113 * fh1;
  const Scalar _tmp121 = -_tmp111 * _tmp93 * (_tmp105 * _tmp50 + _tmp106 * _tmp90 + Scalar(1.0)) -
                         _tmp114 * _tmp93 * (_tmp112 * _tmp50 - _tmp112 * _tmp91) -
                         _tmp120 * _tmp93 * (_tmp118 * _tmp50 + _tmp119 * _tmp90) - _tmp34 * _tmp94;
  ...
  const Scalar _tmp129 = -_tmp112 * _tmp79 + _tmp124 * _tmp128;
  const Scalar _tmp130 = fh1 * (_tmp38 + _tmp74);
  const Scalar _tmp131 = _tmp110 * _tmp130 + Scalar(5.1796800000000003) * _tmp13 + _tmp20 * fv1;
  const Scalar _tmp132 = _tmp124 * _tmp82;
  const Scalar _tmp133 = Scalar(1.0) * _tmp127 * _tmp132 - Scalar(1.0) * _tmp127;
  const Scalar _tmp134 = _tmp126 * _tmp88;
  const Scalar _tmp135 = _tmp82 * (-_tmp124 * _tmp134 - _tmp79 * _tmp89 + _tmp81);
  const Scalar _tmp136 = -Scalar(1.0) * _tmp127 * _tmp88 - Scalar(1.0) * _tmp135 + Scalar(1.0);
  const Scalar _tmp137 = _tmp124 * _tmp126;
  const Scalar _tmp138 = _tmp117 * _tmp137 - _tmp118 * _tmp79 - Scalar(1.0) * _tmp78;
  const Scalar _tmp139 = _tmp104 * _tmp137 - _tmp105 * _tmp79 + _tmp97;
  const Scalar _tmp140 = -_tmp113 * _tmp130 - Scalar(5.1796800000000003) * _tmp27 - _tmp31 * fv1;
  const Scalar _tmp141 = _tmp127 * _tmp85;
  const Scalar _tmp142 = _tmp82 * (_tmp125 * _tmp127 + Scalar(1.0));
  const Scalar _tmp143 = Scalar(1.0) * _tmp141 - Scalar(1.0) * _tmp142;
  const Scalar _tmp144 = Scalar(1.0) * _tmp111 * (_tmp104 * _tmp127 - _tmp115 * _tmp139) +
                         Scalar(1.0) * _tmp114 * (-_tmp115 * _tmp129 + _tmp128) +
                         Scalar(1.0) * _tmp120 * (-_tmp115 * _tmp138 + _tmp117 * _tmp127) +
                         _tmp131 * _tmp133 + _tmp136 * _tmp34 + _tmp140 * _tmp143;
  const Scalar _tmp145 = std::asinh(_tmp122 * _tmp144);
  const Scalar _tmp146 = Scalar(9.6622558468725703) * _tmp121;
  const Scalar _tmp147 =
      -_tmp145 * _tmp146 - std::sqrt(Scalar(std::pow(Scalar(-_tmp55 + p_c(1, 0)), Scalar(2)) +
  ...
  const Scalar _tmp173 = _tmp127 * _tmp20;
  const Scalar _tmp174 =
      (_tmp160 * (-_tmp132 * _tmp173 - _tmp135 + _tmp142 * _tmp151) - _tmp163 * _tmp172) /
      std::sqrt(Scalar(std::pow(_tmp163, Scalar(2)) * _tmp171 + 1));
  const Scalar _tmp175 = Scalar(0.1034955) * _tmp172;
  const Scalar _tmp176 = _tmp105 * _tmp111 + _tmp118 * _tmp120 + _tmp156 + _tmp158;
  const Scalar _tmp177 = Scalar(1.0) / (_tmp176);
  const Scalar _tmp178 = -_tmp104 * _tmp111 * _tmp126 - _tmp114 * _tmp128 -
                         _tmp117 * _tmp120 * _tmp126 + _tmp134 * _tmp34 - _tmp140 * _tmp141 +
                         _tmp162;
  const Scalar _tmp179 = std::asinh(_tmp177 * _tmp178);
  const Scalar _tmp180 = Scalar(9.6622558468725703) * _tmp176;
  const Scalar _tmp181 =
      -_tmp179 * _tmp180 - std::sqrt(Scalar(std::pow(Scalar(-_tmp43 + p_b(1, 0)), Scalar(2)) +
  ...
  const Scalar _tmp188 = (_tmp177 * (-_tmp134 - _tmp141 * _tmp151 + _tmp173) + _tmp178 * _tmp186) /
  ...
  _res(1, 0) =
      -_tmp146 * (Scalar(1.0) * _tmp154 * std::sinh(_tmp149) - _tmp155 * p_c(2, 0) -
                  (_tmp123 * (-_tmp145 * _tmp150 - _tmp146 * _tmp154) - _tmp147 * _tmp155) *
                      std::sinh(_tmp148)) -
      _tmp150 * (_tmp123 * p_c(2, 0) - std::cosh(_tmp148) + std::cosh(_tmp149));
  _res(2, 0) =
      -_tmp165 * (Scalar(1.0) * _tmp174 * std::sinh(_tmp168) - _tmp175 * p_a(2, 0) -
                  (_tmp161 * (-_tmp164 * _tmp170 - _tmp165 * _tmp174) - _tmp166 * _tmp175) *
                      std::sinh(_tmp167)) -
      _tmp170 * (_tmp161 * p_a(2, 0) - std::cosh(_tmp167) + std::cosh(_tmp168));
  _res(3, 0) = _tmp169 * (_tmp182 * p_b(2, 0) - std::cosh(_tmp183) + std::cosh(_tmp184)) -
               _tmp180 * (_tmp187 * p_b(2, 0) + Scalar(1.0) * _tmp188 * std::sinh(_tmp184) -
                          (_tmp181 * _tmp187 + _tmp182 * (_tmp169 * _tmp179 - _tmp180 * _tmp188)) *
                              std::sinh(_tmp183));
