...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl4(
  ...
  const Scalar _tmp51 = _tmp30 + _tmp48;
  ...
  const Scalar _tmp56 = Scalar(1.0) / (_tmp43 - _tmp44 - _tmp55);
  const Scalar _tmp57 = Scalar(1.0) * _tmp56;
  const Scalar _tmp58 = _tmp44 + p_init0;
  ...
  const Scalar _tmp67 = _tmp42 + p_init0;
  const Scalar _tmp68 = _tmp67 - p_d(0, 0);
  const Scalar _tmp69 = Scalar(1.0) / (_tmp68);
  const Scalar _tmp70 = _tmp66 * _tmp69;
  const Scalar _tmp71 = -_tmp63 + _tmp64 * _tmp70;
  const Scalar _tmp72 = _tmp51 + p_init1;
  const Scalar _tmp73 = _tmp72 - p_b(1, 0);
  const Scalar _tmp74 = _tmp53 + p_init0;
  ...
  const Scalar _tmp79 = Scalar(1.0) / (_tmp70 * _tmp77 - _tmp78);
  const Scalar _tmp80 =
  ...
  const Scalar _tmp83 = _tmp82 * (_tmp42 * _tmp66 * _tmp81 - _tmp45 * _tmp68 * _tmp81);
  const Scalar _tmp84 = _tmp79 * (_tmp51 * _tmp77 - _tmp53 * _tmp78 + _tmp77 * _tmp83);
  const Scalar _tmp85 = -_tmp44 * _tmp63 + _tmp49 * _tmp64 + _tmp64 * _tmp83 - _tmp71 * _tmp84;
  const Scalar _tmp86 = Scalar(1.0) / (_tmp85);
  const Scalar _tmp87 = _tmp16 + _tmp7;
  const Scalar _tmp88 = _tmp11 + _tmp15;
  const Scalar _tmp89 = _tmp7 + _tmp88;
  const Scalar _tmp90 = _tmp70 * _tmp87;
  const Scalar _tmp91 = _tmp8 + _tmp88;
  const Scalar _tmp92 = _tmp77 * _tmp87;
  const Scalar _tmp93 = _tmp79 * (-_tmp70 * _tmp92 + _tmp78 * _tmp91);
  const Scalar _tmp94 = _tmp63 * _tmp89 - _tmp64 * _tmp90 - _tmp71 * _tmp93;
  const Scalar _tmp95 = _tmp79 * (-_tmp77 * _tmp91 + _tmp92);
  const Scalar _tmp96 = -_tmp54 * _tmp94 + _tmp64 * _tmp87 - _tmp64 * _tmp89 - _tmp71 * _tmp95;
  const Scalar _tmp97 = _tmp86 * _tmp96;
  const Scalar _tmp98 = _tmp57 * _tmp97;
  const Scalar _tmp99 = Scalar(1.0) * _tmp86;
  const Scalar _tmp100 = _tmp50 * _tmp98 - _tmp94 * _tmp99;
  const Scalar _tmp101 = Scalar(1.0) * _tmp52;
  const Scalar _tmp102 = _tmp28 - p_a(0, 0);
  const Scalar _tmp103 = _tmp36 - p_a(1, 0);
  ...
  const Scalar _tmp107 = fh1 * (_tmp105 * _tmp27 - _tmp106 * _tmp35);
  const Scalar _tmp108 = _tmp43 + _tmp46 * _tmp54;
  ...
  const Scalar _tmp113 = -_tmp109 * _tmp50 - _tmp112 * _tmp94 + _tmp47;
  const Scalar _tmp114 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp115 = _tmp17 * fh1;
  const Scalar _tmp116 = -_tmp105 * _tmp115 - Scalar(5.1796800000000003) * _tmp31 - _tmp35 * fv1;
  const Scalar _tmp117 = _tmp52 * (_tmp55 * _tmp57 + Scalar(1.0));
  const Scalar _tmp118 = _tmp54 * _tmp57;
  const Scalar _tmp119 = Scalar(1.0) * _tmp93;
  const Scalar _tmp120 = _tmp119 * _tmp54 - Scalar(1.0) * _tmp95;
  const Scalar _tmp121 = _tmp110 * _tmp85;
  const Scalar _tmp122 = _tmp97 * (-_tmp120 * _tmp121 - Scalar(1.0) * _tmp84);
  const Scalar _tmp123 = _tmp120 + _tmp122;
  const Scalar _tmp124 = _tmp110 * _tmp94;
  const Scalar _tmp125 = _tmp50 * _tmp56;
  const Scalar _tmp126 = -_tmp119 + _tmp122 * _tmp125 - _tmp123 * _tmp124;
  const Scalar _tmp127 = _tmp105 * fh1;
  const Scalar _tmp128 = _tmp70 * _tmp93 + _tmp90;
  const Scalar _tmp129 = -_tmp128 * _tmp54 + _tmp70 * _tmp95 - _tmp87;
  const Scalar _tmp130 = _tmp97 * (-_tmp121 * _tmp129 + _tmp70 * _tmp84 - _tmp83);
  const Scalar _tmp131 = _tmp129 + _tmp130;
  const Scalar _tmp132 = -_tmp124 * _tmp131 + _tmp125 * _tmp130 + _tmp128;
  const Scalar _tmp133 = _tmp106 * fh1;
  const Scalar _tmp134 = _tmp106 * _tmp115 + Scalar(5.1796800000000003) * _tmp21 + _tmp27 * fv1;
  const Scalar _tmp135 = _tmp50 * _tmp52;
  const Scalar _tmp136 = _tmp110 * _tmp64;
  const Scalar _tmp137 = _tmp110 * _tmp71;
  const Scalar _tmp138 = -_tmp131 * _tmp137 - _tmp70;
  const Scalar _tmp139 = _tmp77 * _tmp79;
  const Scalar _tmp140 = -_tmp123 * _tmp137 + Scalar(1.0);
  const Scalar _tmp141 = _tmp111 * _tmp137;
  const Scalar _tmp142 = -_tmp107 * _tmp82 * (-_tmp139 * _tmp71 * _tmp99 + _tmp64 * _tmp99) -
                         _tmp114 * _tmp82 * (_tmp112 * _tmp64 - _tmp139 * _tmp141) -
                         _tmp127 * _tmp82 * (_tmp123 * _tmp136 + _tmp139 * _tmp140) -
                         _tmp133 * _tmp82 * (_tmp131 * _tmp136 + _tmp138 * _tmp139 + Scalar(1.0));
  const Scalar _tmp143 = Scalar(1.0) / (_tmp142);
  const Scalar _tmp144 = std::asinh(
      _tmp143 * (Scalar(1.0) * _tmp107 * (-_tmp100 * _tmp101 + _tmp98) +
                 Scalar(1.0) * _tmp114 * (-_tmp101 * _tmp113 - _tmp108 * _tmp57 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp116 * (-Scalar(1.0) * _tmp117 + _tmp118) +
                 Scalar(1.0) * _tmp127 * (-_tmp101 * _tmp126 + _tmp122 * _tmp57) +
                 Scalar(1.0) * _tmp133 * (-_tmp101 * _tmp132 + _tmp130 * _tmp57) +
                 Scalar(1.0) * _tmp134 * (_tmp135 * _tmp57 - _tmp57)));
  const Scalar _tmp145 = Scalar(9.6622558468725703) * _tmp142;
  const Scalar _tmp146 = std::pow(Scalar(-_tmp65 + p_d(1, 0)), Scalar(2)) +
                         std::pow(Scalar(-_tmp67 + p_d(0, 0)), Scalar(2));
  const Scalar _tmp147 = std::pow(Scalar(-_tmp72 + p_b(1, 0)), Scalar(2)) +
                         std::pow(Scalar(-_tmp74 + p_b(0, 0)), Scalar(2));
  const Scalar _tmp148 = _tmp107 * _tmp99;
  const Scalar _tmp149 = -_tmp114 * _tmp141 * _tmp79 + _tmp127 * _tmp140 * _tmp79 +
                         _tmp133 * _tmp138 * _tmp79 - _tmp148 * _tmp71 * _tmp79;
  const Scalar _tmp150 = Scalar(1.0) / (_tmp149);
  const Scalar _tmp151 = _tmp134 * _tmp57;
  const Scalar _tmp152 = std::asinh(
      _tmp150 * (_tmp100 * _tmp107 * _tmp52 + _tmp113 * _tmp114 * _tmp52 + _tmp116 * _tmp117 +
                 _tmp126 * _tmp127 * _tmp52 + _tmp132 * _tmp133 * _tmp52 - _tmp135 * _tmp151));
  const Scalar _tmp153 = Scalar(9.6622558468725703) * _tmp149;
  const Scalar _tmp154 =
      _tmp110 * _tmp123 * _tmp127 + _tmp110 * _tmp131 * _tmp133 + _tmp112 * _tmp114 + _tmp148;
  const Scalar _tmp155 = Scalar(1.0) / (_tmp154);
  const Scalar _tmp156 =
      std::asinh(_tmp155 * (-_tmp107 * _tmp98 + _tmp109 * _tmp114 - _tmp116 * _tmp118 -
                            _tmp122 * _tmp127 * _tmp56 - _tmp130 * _tmp133 * _tmp56 + _tmp151));
  const Scalar _tmp157 = Scalar(9.6622558468725703) * _tmp154;
  const Scalar _tmp158 = std::pow(Scalar(-_tmp58 + p_c(0, 0)), Scalar(2)) +
  ...
  _res(1, 0) =
      ...
      std::sqrt(Scalar(_tmp146 + std::pow(Scalar(-_tmp87 + p_d(2, 0) - p_init2), Scalar(2))));
  _res(2, 0) =
      _tmp153 *
          (-std::sinh(Scalar(1.0) * _tmp152) -
           std::sinh(Scalar(0.1034955) * _tmp150 * (-std::sqrt(_tmp147) - _tmp152 * _tmp153))) -
      std::sqrt(Scalar(_tmp147 + std::pow(Scalar(-_tmp91 + p_b(2, 0) - p_init2), Scalar(2))));
  _res(3, 0) =
      _tmp157 *
          (-std::sinh(Scalar(1.0) * _tmp156) -
           std::sinh(Scalar(0.1034955) * _tmp155 * (-_tmp156 * _tmp157 - std::sqrt(_tmp158)))) -
      std::sqrt(Scalar(_tmp158 + std::pow(Scalar(-_tmp89 + p_c(2, 0) - p_init2), Scalar(2))));
